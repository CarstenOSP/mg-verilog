...
wire   [10:0] tmp_242_cast_fu_333_p3;
...
sparsemux_17_3_64_1_1_U123(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.din4(llike_4_q0),.din5(llike_5_q0),.din6(llike_6_q0),.din7(llike_7_q0),.def(p_fu_367_p17),.sel(trunc_ln20_reg_730),.dout(p_fu_367_p19));
...
sparsemux_17_3_64_1_1_x_U124(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.din4(llike_4_q0),.din5(llike_5_q0),.din6(llike_6_q0),.din7(llike_7_q0),.def(p_33_fu_441_p17),.sel(trunc_ln20_reg_730),.dout(p_33_fu_441_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_78_reg_865 <= grp_fu_2068_p_dout0;
    end
end
always @ (*) begin
...
assign and_ln42_fu_550_p2 = (or_ln42_fu_526_p2 & grp_fu_2068_p_dout0);
...
assign grp_fu_2068_p_din0 = grp_fu_293_p0;
assign grp_fu_2068_p_din1 = grp_fu_293_p1;
...
assign tmp_242_cast_fu_333_p3 = {{8'd139}, {tmp_s_fu_323_p4}};
...
assign zext_ln41_fu_341_p1 = tmp_242_cast_fu_333_p3;
