module viterbi_viterbi_Pipeline_L_state (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p_8,t_1,llike_1_address0,llike_1_ce0,llike_1_q0,zext_ln52,transition_address0,transition_ce0,transition_q0,zext_ln52_2,llike_address0,llike_ce0,llike_q0,min_s_6_out,min_s_6_out_ap_vld,grp_fu_299_p_din0,grp_fu_299_p_din1,grp_fu_299_p_opcode,grp_fu_299_p_dout0,grp_fu_299_p_ce,grp_fu_700_p_din0,grp_fu_700_p_din1,grp_fu_700_p_opcode,grp_fu_700_p_dout0,grp_fu_700_p_ce); 
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_1_reg_649 <= grp_fu_299_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        p_reg_635 <= grp_fu_299_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp_6_reg_674 <= grp_fu_700_p_dout0;
    end
end
always @ (*) begin
...
assign and_ln55_fu_404_p2 = (or_ln55_fu_380_p2 & grp_fu_700_p_dout0);
...
assign grp_fu_299_p_din0 = grp_fu_172_p0;
assign grp_fu_299_p_din1 = grp_fu_172_p1;
assign grp_fu_299_p_opcode = 2'd0;
assign grp_fu_700_p_ce = 1'b1;
assign grp_fu_700_p_din0 = grp_fu_176_p0;
assign grp_fu_700_p_din1 = grp_fu_176_p1;
...
assign lshr_ln8_2_fu_210_p4 = {{ap_sig_allocacmp_s[5:1]}};
...
assign tmp_s_fu_220_p3 = {{t_1}, {lshr_ln8_2_fu_210_p4}};
