...
reg   [6:0] v12_5_reg_667;
wire   [0:0] tmp_fu_323_p3;
wire   [4:0] tmp_24_cast_fu_331_p4;
reg   [4:0] tmp_24_cast_reg_678;
wire   [3:0] tmp_28_fu_380_p4;
reg   [3:0] tmp_28_reg_693;
reg   [2:0] tmp_35_reg_708;
reg   [0:0] tmp_13_reg_718;
...
wire   [11:0] tmp_25_fu_341_p3;
wire   [11:0] add_ln_fu_354_p4;
wire   [11:0] tmp_31_fu_389_p4;
wire   [11:0] add_ln1_fu_403_p4;
wire   [11:0] tmp_39_fu_443_p5;
wire   [11:0] add_ln2_fu_457_p6;
wire   [11:0] tmp_48_fu_483_p4;
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        reg_301 <= grp_fu_605_p_dout0;
        reg_306 <= grp_fu_609_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_13_reg_718 <= v12_5_reg_667[32'd1];
        tmp_28_reg_693 <= {{v12_5_reg_667[5:2]}};
        tmp_35_reg_708 <= {{v12_5_reg_667[5:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_24_cast_reg_678 <= {{ap_sig_allocacmp_v12_5[5:1]}};
        tmp_reg_674 <= ap_sig_allocacmp_v12_5[32'd6];
        ...
        v12_5_reg_667 <= ap_sig_allocacmp_v12_5;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v14_reg_795 <= v10_0_q1;
        v18_reg_800 <= grp_fu_613_p_dout0;
        v21_reg_840 <= v10_1_q1;
        v24_reg_805 <= grp_fu_617_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v30_reg_860 <= grp_fu_613_p_dout0;
        v36_reg_865 <= grp_fu_617_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v31_reg_925 <= grp_fu_605_p_dout0;
        v37_reg_930 <= grp_fu_609_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v42_reg_905 <= grp_fu_613_p_dout0;
        v48_reg_910 <= grp_fu_617_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v54_reg_915 <= grp_fu_613_p_dout0;
        v60_reg_920 <= grp_fu_617_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v55_reg_935 <= grp_fu_605_p_dout0;
        v61_reg_940 <= grp_fu_609_p_dout0;
    end
end
always @ (*) begin
...
assign add_ln1_fu_403_p4 = {{{tmp_28_fu_380_p4}, {2'd3}}, {zext_ln41}};
assign add_ln2_fu_457_p6 = {{{{{tmp_35_reg_708}, {1'd1}}, {tmp_13_reg_718}}, {1'd1}}, {zext_ln41}};
assign add_ln3_fu_496_p4 = {{{tmp_35_reg_708}, {3'd7}}, {zext_ln41}};
assign add_ln42_fu_369_p2 = (ap_sig_allocacmp_v12_5 + 7'd8);
assign add_ln_fu_354_p4 = {{{tmp_24_cast_fu_331_p4}, {1'd1}}, {zext_ln41}};
...
assign grp_fu_605_p_din0 = grp_fu_277_p0;
assign grp_fu_605_p_din1 = grp_fu_277_p1;
assign grp_fu_605_p_opcode = 2'd0;
assign grp_fu_609_p_ce = 1'b1;
assign grp_fu_609_p_din0 = grp_fu_281_p0;
assign grp_fu_609_p_din1 = grp_fu_281_p1;
assign grp_fu_609_p_opcode = 2'd0;
assign grp_fu_613_p_ce = 1'b1;
assign grp_fu_613_p_din0 = grp_fu_285_p0;
assign grp_fu_613_p_din1 = v17;
assign grp_fu_617_p_ce = 1'b1;
assign grp_fu_617_p_din0 = grp_fu_289_p0;
assign grp_fu_617_p_din1 = v17;
assign or_ln58_1_fu_514_p3 = {{tmp_28_reg_693}, {1'd1}};
assign or_ln72_1_fu_537_p4 = {{{tmp_35_reg_708}, {1'd1}}, {tmp_13_reg_718}};
assign or_ln86_1_fu_551_p3 = {{tmp_35_reg_708}, {2'd3}};
assign tmp_24_cast_fu_331_p4 = {{ap_sig_allocacmp_v12_5[5:1]}};
assign tmp_25_fu_341_p3 = {{tmp_24_cast_fu_331_p4}, {v11_cast_fu_311_p1}};
assign tmp_28_fu_380_p4 = {{v12_5_reg_667[5:2]}};
assign tmp_31_fu_389_p4 = {{{tmp_28_fu_380_p4}, {1'd1}}, {v11_cast_reg_660}};
assign tmp_39_fu_443_p5 = {{{{tmp_35_reg_708}, {1'd1}}, {tmp_13_reg_718}}, {v11_cast_reg_660}};
assign tmp_48_fu_483_p4 = {{{tmp_35_reg_708}, {2'd3}}, {v11_cast_reg_660}};
assign tmp_fu_323_p3 = ap_sig_allocacmp_v12_5[32'd6];
