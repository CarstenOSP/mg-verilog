...
urem_10ns_9ns_10_14_1_U819(.clk(ap_clk),.reset(ap_rst),.din0(add_ln249_reg_421),.din1(grp_fu_282_p1),.ce(1'b1),.dout(grp_fu_282_p2));
backprop_mul_10ns_12ns_21_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 10 ),.din1_WIDTH( 12 ),.dout_WIDTH( 21 ))
mul_10ns_12ns_21_1_1_U820(.din0(mul_ln249_fu_290_p0),.din1(mul_ln249_fu_290_p1),.dout(mul_ln249_fu_290_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U821(.din0(v153_fu_340_p2),.din1(v153_fu_340_p4),.din2(v153_fu_340_p6),.din3(v153_fu_340_p8),.def(v153_fu_340_p9),.sel(trunc_ln249_1_reg_428_pp0_iter1_reg),.dout(v153_fu_340_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v148_fu_84 <= grp_fu_5240_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v152_reg_443 <= grp_fu_5258_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v154_reg_473 <= grp_fu_5240_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v155_reg_480 <= grp_fu_5258_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v148_load_1 = grp_fu_5240_p_dout0;
    end else begin
...
assign grp_fu_5240_p_din0 = grp_fu_172_p0;
assign grp_fu_5240_p_din1 = grp_fu_172_p1;
assign grp_fu_5240_p_opcode = grp_fu_172_opcode;
assign grp_fu_5258_p_ce = 1'b1;
assign grp_fu_5258_p_din0 = grp_fu_176_p0;
assign grp_fu_5258_p_din1 = grp_fu_176_p1;
