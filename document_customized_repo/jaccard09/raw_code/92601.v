...
buff_C_out_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_address0),.ce0(buff_C_out_ce0),.we0(buff_C_out_we0),.d0(buff_C_out_d0),.q0(buff_C_out_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_address1),.ce1(buff_C_out_ce1),.we1(buff_C_out_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_d1),.q1(buff_C_out_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 512 ),.AddressWidth( 9 ))
buff_C_out_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_1_address0),.ce0(buff_C_out_1_ce0),.we0(buff_C_out_1_we0),.d0(buff_C_out_1_d0),.q0(buff_C_out_1_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_1_address1),.ce1(buff_C_out_1_ce1),.we1(buff_C_out_1_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_1_d1),.q1(buff_C_out_1_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 512 ),.AddressWidth( 9 ))
buff_C_out_2_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_2_address0),.ce0(buff_C_out_2_ce0),.we0(buff_C_out_2_we0),.d0(buff_C_out_2_d0),.q0(buff_C_out_2_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_2_address1),.ce1(buff_C_out_2_ce1),.we1(buff_C_out_2_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_2_d1),.q1(buff_C_out_2_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 512 ),.AddressWidth( 9 ))
buff_C_out_3_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_3_address0),.ce0(buff_C_out_3_ce0),.we0(buff_C_out_3_we0),.d0(buff_C_out_3_d0),.q0(buff_C_out_3_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_3_address1),.ce1(buff_C_out_3_ce1),.we1(buff_C_out_3_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_3_d1),.q1(buff_C_out_3_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 512 ),.AddressWidth( 9 ))
buff_C_out_4_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_4_address0),.ce0(buff_C_out_4_ce0),.we0(buff_C_out_4_we0),.d0(buff_C_out_4_d0),.q0(buff_C_out_4_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_4_address1),.ce1(buff_C_out_4_ce1),.we1(buff_C_out_4_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_4_d1),.q1(buff_C_out_4_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 512 ),.AddressWidth( 9 ))
buff_C_out_5_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_5_address0),.ce0(buff_C_out_5_ce0),.we0(buff_C_out_5_we0),.d0(buff_C_out_5_d0),.q0(buff_C_out_5_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_5_address1),.ce1(buff_C_out_5_ce1),.we1(buff_C_out_5_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_5_d1),.q1(buff_C_out_5_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 512 ),.AddressWidth( 9 ))
buff_C_out_6_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_6_address0),.ce0(buff_C_out_6_ce0),.we0(buff_C_out_6_we0),.d0(buff_C_out_6_d0),.q0(buff_C_out_6_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_6_address1),.ce1(buff_C_out_6_ce1),.we1(buff_C_out_6_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_6_d1),.q1(buff_C_out_6_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 512 ),.AddressWidth( 9 ))
buff_C_out_7_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_7_address0),.ce0(buff_C_out_7_ce0),.we0(buff_C_out_7_we0),.d0(buff_C_out_7_d0),.q0(buff_C_out_7_q0),.address1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_7_address1),.ce1(buff_C_out_7_ce1),.we1(buff_C_out_7_we1),.d1(grp_syrk_Pipeline_lp4_fu_356_buff_C_out_7_d1),.q1(buff_C_out_7_q1));
...
fadd_32ns_32ns_32_7_full_dsp_1_U127(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_416_p0),.din1(grp_fu_416_p1),.ce(grp_fu_416_ce),.dout(grp_fu_416_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U128(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_420_p0),.din1(grp_fu_420_p1),.ce(grp_fu_420_ce),.dout(grp_fu_420_p2));
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((grp_syrk_Pipeline_lp4_fu_356_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state6))) begin
