...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_10_fu_238_p1;
wire   [1:0] tmp_10_fu_238_p3;
wire  signed [1:0] tmp_10_fu_238_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_7_2_64_1_1_U252(.din0(mux_case_03162_reload),.din1(mux_case_13267_reload),.din2(mux_case_23372_reload),.def(tmp_10_fu_238_p7),.sel(select_ln72_reg_298),.dout(tmp_10_fu_238_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul_i3_reg_323 <= grp_fu_5428_p_dout0;
        tmp_10_reg_318 <= tmp_10_fu_238_p9;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_5428_p_ce = 1'b1;
assign grp_fu_5428_p_din0 = activations2_load_reg_313;
assign grp_fu_5428_p_din1 = tmp_10_reg_318;
