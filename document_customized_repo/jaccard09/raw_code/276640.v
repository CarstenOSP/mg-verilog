module backprop_backprop_Pipeline_label_16 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_253103,mux_case_15299,mux_case_05195,mux_case_02857_reload,mux_case_12961_reload,mux_case_23065_reload,empty,v7_address0,v7_ce0,v7_q0,v116_reload,mux_case_13273_reload,v116_2_reload,mux_case_253101_out,mux_case_253101_out_ap_vld,mux_case_15297_out,mux_case_15297_out_ap_vld,mux_case_05193_out,mux_case_05193_out_ap_vld,grp_fu_2129_p_din0,grp_fu_2129_p_din1,grp_fu_2129_p_opcode,grp_fu_2129_p_dout0,grp_fu_2129_p_ce,grp_fu_2137_p_din0,grp_fu_2137_p_din1,grp_fu_2137_p_dout0,grp_fu_2137_p_ce); 
...
sparsemux_7_2_64_1_1_U368(.din0(mux_case_02857_reload),.din1(mux_case_12961_reload),.din2(mux_case_23065_reload),.def(v94_fu_251_p7),.sel(v93_1_reg_403_pp0_iter1_reg),.dout(v94_fu_251_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U369(.din0(v116_reload),.din1(mux_case_13273_reload),.din2(v116_2_reload),.def(v98_fu_294_p7),.sel(v93_1_reg_403_pp0_iter8_reg),.dout(v98_fu_294_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v13_reg_453 <= grp_fu_2137_p_dout0;
...
assign bitcast_ln172_fu_272_p1 = grp_fu_2129_p_dout0;
assign grp_fu_2129_p_ce = 1'b1;
assign grp_fu_2129_p_din0 = v94_fu_251_p9;
assign grp_fu_2129_p_din1 = v95_fu_268_p1;
assign grp_fu_2129_p_opcode = 2'd1;
assign grp_fu_2137_p_ce = 1'b1;
assign grp_fu_2137_p_din0 = v97_fu_316_p1;
assign grp_fu_2137_p_din1 = v98_reg_443;
