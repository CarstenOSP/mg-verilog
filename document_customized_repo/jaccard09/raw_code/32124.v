module backprop_backprop_Pipeline_VITIS_LOOP_18_14 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_24070,mux_case_13966,mux_case_03862,activations3_i,activations3_o,activations3_o_ap_vld,activations3_2_i,activations3_2_o,activations3_2_o_ap_vld,activations3_1_i,activations3_1_o,activations3_1_o_ap_vld,mux_case_24068_out,mux_case_24068_out_ap_vld,mux_case_13964_out,mux_case_13964_out_ap_vld,mux_case_03860_out,mux_case_03860_out_ap_vld,grp_fu_8514_p_din0,grp_fu_8514_p_din1,grp_fu_8514_p_opcode,grp_fu_8514_p_dout0,grp_fu_8514_p_ce,grp_fu_8518_p_din0,grp_fu_8518_p_din1,grp_fu_8518_p_opcode,grp_fu_8518_p_dout0,grp_fu_8518_p_ce,grp_fu_8566_p_din0,grp_fu_8566_p_din1,grp_fu_8566_p_dout0,grp_fu_8566_p_ce,grp_fu_8618_p_din0,grp_fu_8618_p_din1,grp_fu_8618_p_dout0,grp_fu_8618_p_ce,grp_fu_8622_p_din0,grp_fu_8622_p_din1,grp_fu_8622_p_dout0,grp_fu_8622_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_24070;
input  [63:0] mux_case_13966;
input  [63:0] mux_case_03862;
...
output  [63:0] mux_case_24068_out;
output   mux_case_24068_out_ap_vld;
output  [63:0] mux_case_13964_out;
output   mux_case_13964_out_ap_vld;
output  [63:0] mux_case_03860_out;
output   mux_case_03860_out_ap_vld;
...
reg mux_case_24068_out_ap_vld;
reg mux_case_13964_out_ap_vld;
reg mux_case_03860_out_ap_vld;
...
reg   [63:0] mux_case_13964_fu_74;
reg   [63:0] mux_case_24068_fu_78;
...
#0 i_fu_66 = 2'd0;
#0 mux_case_03860_fu_70 = 64'd0;
#0 mux_case_13964_fu_74 = 64'd0;
#0 mux_case_24068_fu_78 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U394(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_s_fu_222_p7),.sel(ap_sig_allocacmp_i_10),.dout(tmp_s_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_24068_fu_78 <= mux_case_24070;
        end else if ((1'b1 == ap_condition_1279)) begin
            mux_case_24068_fu_78 <= dactivations3_reg_366;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_i2_reg_378 <= grp_fu_8518_p_dout0;
        ...
        dactivations3_reg_366 <= grp_fu_8566_p_dout0;
        ...
        sub_i1_reg_361 <= grp_fu_8514_p_dout0;
        tmp_33_reg_373 <= grp_fu_8622_p_dout0;
...
always @ (*) begin
    if (((i_10_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_1_o = grp_fu_8618_p_dout0;
    end else begin
...
always @ (*) begin
    if ((~(i_10_reg_332_pp0_iter87_reg == 2'd0) & ~(i_10_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_2_o = grp_fu_8618_p_dout0;
    end else begin
...
always @ (*) begin
    if (((i_10_reg_332_pp0_iter87_reg == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_o = grp_fu_8618_p_dout0;
    end else begin
...
always @ (*) begin
    if (((icmp_ln18_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        mux_case_03860_out_ap_vld = 1'b1;
    end else begin
        mux_case_03860_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((icmp_ln18_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        mux_case_13964_out_ap_vld = 1'b1;
    end else begin
        mux_case_13964_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((icmp_ln18_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        mux_case_24068_out_ap_vld = 1'b1;
    end else begin
        mux_case_24068_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    case (ap_CS_fsm)
...
assign grp_fu_8514_p_din1 = tmp_s_reg_340;
assign grp_fu_8514_p_opcode = 2'd1;
assign grp_fu_8518_p_ce = 1'b1;
assign grp_fu_8518_p_din0 = tmp_33_reg_373;
assign grp_fu_8518_p_din1 = 64'd4607182418800017408;
assign grp_fu_8518_p_opcode = 2'd0;
assign grp_fu_8566_p_ce = 1'b1;
assign grp_fu_8566_p_din0 = tmp_s_reg_340_pp0_iter8_reg;
assign grp_fu_8566_p_din1 = sub_i1_reg_361;
assign grp_fu_8618_p_ce = 1'b1;
assign grp_fu_8618_p_din0 = 64'd4607182418800017408;
assign grp_fu_8618_p_din1 = add_i2_reg_378;
assign grp_fu_8622_p_ce = 1'b1;
assign grp_fu_8622_p_din0 = 64'd0;
assign grp_fu_8622_p_din1 = bitcast_ln20_1_fu_275_p1;
assign icmp_ln18_fu_210_p2 = ((ap_sig_allocacmp_i_10 == 2'd3) ? 1'b1 : 1'b0);
assign mux_case_03860_out = mux_case_03860_fu_70;
assign mux_case_13964_out = mux_case_13964_fu_74;
assign mux_case_24068_out = mux_case_24068_fu_78;
