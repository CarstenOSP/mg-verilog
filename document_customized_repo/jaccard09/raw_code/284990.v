module backprop_backprop_Pipeline_label_33_label_34 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v11_address0,v11_ce0,v11_q0,v11_1_address0,v11_1_ce0,v11_1_q0,v11_2_address0,v11_2_ce0,v11_2_q0,v11_3_address0,v11_3_ce0,v11_3_q0,v1_address0,v1_ce0,v1_we0,v1_d0,v1_q0,v183_out,v183_out_ap_vld,grp_fu_3856_p_din0,grp_fu_3856_p_din1,grp_fu_3856_p_opcode,grp_fu_3856_p_dout0,grp_fu_3856_p_ce); 
...
dmul_64ns_64ns_64_7_max_dsp_1_U901(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_170_p0),.din1(grp_fu_170_p1),.ce(1'b1),.dout(grp_fu_170_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U902(.din0(v11_q0),.din1(v11_1_q0),.din2(v11_2_q0),.din3(v11_3_q0),.def(v184_fu_317_p9),.sel(trunc_ln296_reg_398),.dout(v184_fu_317_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v181_fu_78 <= grp_fu_3856_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v187_reg_453 <= grp_fu_3856_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v181_load_1 = grp_fu_3856_p_dout0;
    end else begin
...
assign grp_fu_3856_p_din0 = grp_fu_166_p0;
assign grp_fu_3856_p_din1 = grp_fu_166_p1;
assign grp_fu_3856_p_opcode = grp_fu_166_opcode;
