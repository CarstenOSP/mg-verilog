...
sparsemux_33_4_32_1_1_U119(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.din4(W_4_q0),.din5(W_5_q0),.din6(W_6_q0),.din7(W_7_q0),.din8(W_8_q0),.din9(W_9_q0),.din10(W_10_q0),.din11(W_11_q0),.din12(W_12_q0),.din13(W_13_q0),.din14(W_14_q0),.din15(W_15_q0),.def(tmp_s_fu_521_p33),.sel(trunc_ln128_reg_766),.dout(tmp_s_fu_521_p35));
...
assign A_16_out = B_1_fu_160;
assign B_9_out = B_fu_144;
assign C_11_out = C_reg_862;
assign C_1_fu_638_p3 = {{trunc_ln130_1_fu_624_p1}, {lshr_ln130_1_fu_628_p4}};
assign D_16_out = D_3_reg_856;
assign E_9_out = E_fu_140;
