...
wire   [11:0] tmp_59_fu_534_p3;
reg   [11:0] tmp_59_reg_734;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_34_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_34_out_ap_vld;
...
wire   [63:0] tmp_87_cast_fu_406_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_3_reg_659[11 : 4] <= tmp_87_cast_fu_406_p1[11 : 4];
        tmp_s_reg_654[11 : 4] <= tmp_s_fu_398_p3[11 : 4];
        zext_ln19_reg_664[7 : 0] <= zext_ln19_fu_411_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_34_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_34_loc_fu_108 <= grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_34_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        tmp_59_reg_734[11 : 4] <= tmp_59_fu_534_p3[11 : 4];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_34_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_34_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_34_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        llike_address0_local = llike_addr_3_reg_659;
...
assign tmp_59_fu_534_p3 = {{trunc_ln50_fu_530_p1}, {4'd0}};
assign tmp_60_fu_486_p3 = {{t_2_reg_622}, {lshr_ln7_reg_687}};
assign tmp_87_cast_fu_406_p1 = tmp_s_fu_398_p3;
...
assign zext_ln33_fu_492_p1 = tmp_60_fu_486_p3;
assign zext_ln50_fu_568_p1 = t_3_reg_718;
assign zext_ln52_1_fu_547_p1 = store_forwarded_fu_132;
assign zext_ln52_fu_542_p1 = tmp_59_fu_534_p3;
always @ (posedge ap_clk) begin
    tmp_s_reg_654[3:0] <= 4'b0000;
    llike_addr_3_reg_659[3:0] <= 4'b0000;
    zext_ln19_reg_664[11:8] <= 4'b0000;
    tmp_59_reg_734[3:0] <= 4'b0000;
end
endmodule 