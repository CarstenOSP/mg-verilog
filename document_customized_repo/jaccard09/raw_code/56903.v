...
sparsemux_7_2_64_1_1_U134(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_3_fu_222_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_3_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_i2_reg_378 <= grp_fu_3243_p_dout0;
        ...
        dactivations3_reg_366 <= grp_fu_3247_p_dout0;
        ...
        sub_i1_reg_361 <= grp_fu_3239_p_dout0;
        ...
        tmp_4_reg_373 <= grp_fu_3259_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((i_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_1_o = grp_fu_3255_p_dout0;
    end else begin
...
always @ (*) begin
    if ((~(i_reg_332_pp0_iter87_reg == 2'd0) & ~(i_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_2_o = grp_fu_3255_p_dout0;
    end else begin
...
always @ (*) begin
    if (((i_reg_332_pp0_iter87_reg == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_o = grp_fu_3255_p_dout0;
    end else begin
