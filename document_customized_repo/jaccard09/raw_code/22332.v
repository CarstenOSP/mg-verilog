...
wire   [10:0] j_fu_142_p2;
reg   [10:0] j_reg_175;
wire   [10:0] add9_fu_148_p2;
reg   [10:0] add9_reg_180;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add9_reg_180 <= add9_fu_148_p2;
        j_reg_175 <= j_fu_142_p2;
    end
end
always @ (*) begin
...
assign add9_fu_148_p2 = (j_fu_142_p2 + stop);
