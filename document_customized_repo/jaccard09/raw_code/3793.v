module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,B_16_reload,B_4_reload,D_16_reload,E_16_reload,E_4_reload,W_address0,W_ce0,W_q0,W_4_address0,W_4_ce0,W_4_q0,W_8_address0,W_8_ce0,W_8_q0,W_12_address0,W_12_ce0,W_12_q0,W_1_address0,W_1_ce0,W_1_q0,W_5_address0,W_5_ce0,W_5_q0,W_9_address0,W_9_ce0,W_9_q0,W_13_address0,W_13_ce0,W_13_q0,W_2_address0,W_2_ce0,W_2_q0,W_6_address0,W_6_ce0,W_6_q0,W_10_address0,W_10_ce0,W_10_q0,W_14_address0,W_14_ce0,W_14_q0,W_3_address0,W_3_ce0,W_3_q0,W_7_address0,W_7_ce0,W_7_q0,W_11_address0,W_11_ce0,W_11_q0,W_15_address0,W_15_ce0,W_15_q0,A_17_out,A_17_out_ap_vld,B_5_out,B_5_out_ap_vld,C_15_out,C_15_out_ap_vld,D_17_out,D_17_out_ap_vld,E_5_out,E_5_out_ap_vld); 
...
wire   [31:0] tmp_9_fu_601_p11;
reg   [31:0] tmp_9_reg_1163;
wire   [31:0] tmp_s_fu_625_p11;
...
wire   [31:0] tmp_7_fu_497_p9;
wire   [3:0] trunc_ln124_fu_494_p1;
wire   [31:0] or_ln126_fu_521_p2;
wire   [31:0] and_ln126_fu_527_p2;
wire   [31:0] and_ln126_1_fu_533_p2;
wire   [31:0] tmp_7_fu_497_p11;
wire   [31:0] or_ln126_1_fu_539_p2;
wire   [31:0] tmp_8_fu_571_p9;
wire   [31:0] tmp_8_fu_571_p11;
wire   [31:0] tmp_9_fu_601_p9;
wire   [31:0] tmp_s_fu_625_p9;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [3:0] tmp_7_fu_497_p1;
wire   [3:0] tmp_7_fu_497_p3;
wire  signed [3:0] tmp_7_fu_497_p5;
wire  signed [3:0] tmp_7_fu_497_p7;
wire   [3:0] tmp_8_fu_571_p1;
wire   [3:0] tmp_8_fu_571_p3;
wire  signed [3:0] tmp_8_fu_571_p5;
wire  signed [3:0] tmp_8_fu_571_p7;
wire   [3:0] tmp_9_fu_601_p1;
wire   [3:0] tmp_9_fu_601_p3;
wire  signed [3:0] tmp_9_fu_601_p5;
wire  signed [3:0] tmp_9_fu_601_p7;
wire   [3:0] tmp_s_fu_625_p1;
wire   [3:0] tmp_s_fu_625_p3;
wire  signed [3:0] tmp_s_fu_625_p5;
wire  signed [3:0] tmp_s_fu_625_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 5'd1;
...
sparsemux_9_4_32_1_1_U84(.din0(W_q0),.din1(W_4_q0),.din2(W_8_q0),.din3(W_12_q0),.def(tmp_7_fu_497_p9),.sel(trunc_ln124_fu_494_p1),.dout(tmp_7_fu_497_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U85(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.def(tmp_8_fu_571_p9),.sel(trunc_ln124_fu_494_p1),.dout(tmp_8_fu_571_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U86(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.def(tmp_9_fu_601_p9),.sel(trunc_ln124_fu_494_p1),.dout(tmp_9_fu_601_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U87(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.def(tmp_s_fu_625_p9),.sel(trunc_ln124_fu_494_p1),.dout(tmp_s_fu_625_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_9_reg_1163 <= tmp_9_fu_601_p11;
        tmp_s_reg_1168 <= tmp_s_fu_625_p11;
...
assign add_ln126_13_fu_949_p2 = (or_ln126_10_fu_943_p3 + tmp_s_reg_1168);
assign add_ln126_14_fu_954_p2 = (add_ln126_13_fu_949_p2 + or_ln126_9_reg_1220);
assign add_ln126_1_fu_545_p2 = ($signed(32'd2400959708) + $signed(tmp_7_fu_497_p11));
...
assign add_ln126_5_fu_595_p2 = (E_5_fu_120 + tmp_8_fu_571_p11);
...
assign add_ln126_9_fu_754_p2 = (E_6_load_1_reg_1131 + tmp_9_reg_1163);
...
assign tmp_7_fu_497_p9 = 'bx;
assign tmp_8_fu_571_p9 = 'bx;
assign tmp_9_fu_601_p9 = 'bx;
assign tmp_s_fu_625_p9 = 'bx;
