...
wire   [31:0] tmp_1_fu_364_p13;
reg   [31:0] tmp_1_reg_894;
wire   [31:0] tmp_s_fu_392_p13;
reg   [31:0] tmp_s_reg_899;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [6:0] tmp_1_fu_364_p1;
wire  signed [6:0] tmp_1_fu_364_p3;
wire  signed [6:0] tmp_1_fu_364_p5;
wire  signed [6:0] tmp_1_fu_364_p7;
wire  signed [6:0] tmp_1_fu_364_p9;
wire   [6:0] tmp_s_fu_392_p1;
wire  signed [6:0] tmp_s_fu_392_p3;
wire  signed [6:0] tmp_s_fu_392_p5;
wire  signed [6:0] tmp_s_fu_392_p7;
wire  signed [6:0] tmp_s_fu_392_p9;
...
sparsemux_11_7_32_1_1_U190(.din0(W_60_load_1_reload),.din1(W_64_load_1_reload),.din2(W_68_load_1_reload),.din3(W_72_load_1_reload),.din4(W_76_load_1_reload),.def(tmp_1_fu_364_p11),.sel(ap_sig_allocacmp_i_1),.dout(tmp_1_fu_364_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_7_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 7'h3C ),.din0_WIDTH( 32 ),.CASE1( 7'h40 ),.din1_WIDTH( 32 ),.CASE2( 7'h44 ),.din2_WIDTH( 32 ),.CASE3( 7'h48 ),.din3_WIDTH( 32 ),.CASE4( 7'h4C ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 7 ),.dout_WIDTH( 32 ))
sparsemux_11_7_32_1_1_U191(.din0(W_61_load_1_reload),.din1(W_65_load_1_reload),.din2(W_69_load_1_reload),.din3(W_73_load_1_reload),.din4(W_77_load_reload),.def(tmp_s_fu_392_p11),.sel(ap_sig_allocacmp_i_1),.dout(tmp_s_fu_392_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_7_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 7'h3C ),.din0_WIDTH( 32 ),.CASE1( 7'h40 ),.din1_WIDTH( 32 ),.CASE2( 7'h44 ),.din2_WIDTH( 32 ),.CASE3( 7'h48 ),.din3_WIDTH( 32 ),.CASE4( 7'h4C ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 7 ),.dout_WIDTH( 32 ))
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_894 <= tmp_1_fu_364_p13;
        tmp_2_reg_904 <= tmp_2_fu_420_p13;
        tmp_3_reg_909 <= tmp_3_fu_448_p13;
        tmp_s_reg_899 <= tmp_s_fu_392_p13;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln130_1_fu_525_p2 = ($signed(tmp_1_reg_894) + $signed(32'd3395469782));
assign add_ln130_2_fu_530_p2 = (add_ln130_1_fu_525_p2 + or_ln1_fu_517_p3);
assign add_ln130_4_fu_637_p2 = (tmp_s_reg_899 + xor_ln130_3_fu_632_p2);
