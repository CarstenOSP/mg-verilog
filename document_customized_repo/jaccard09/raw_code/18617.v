...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ctx_ret_reg_227 <= grp_aes_expandEncKey_fu_605_p_dout0_0;
        icmp_ln137_reg_218 <= icmp_ln137_fu_151_p2;
        rcon_reg_232 <= grp_aes_expandEncKey_fu_605_p_dout0_1;
    end
end
always @ (*) begin
...
assign grp_aes_expandEncKey_fu_605_p_din1 = ap_sig_allocacmp_ctx5_load_1;
assign grp_aes_expandEncKey_fu_605_p_din2 = 10'd512;
assign grp_aes_expandEncKey_fu_605_p_din3 = ap_sig_allocacmp_rcon_0_load;
