...
wire   [5:0] tmp_s_fu_416_p1;
wire   [5:0] tmp_s_fu_416_p3;
wire   [5:0] tmp_s_fu_416_p5;
wire   [5:0] tmp_s_fu_416_p7;
wire   [5:0] tmp_s_fu_416_p9;
wire   [5:0] tmp_s_fu_416_p11;
wire  signed [5:0] tmp_s_fu_416_p13;
wire  signed [5:0] tmp_s_fu_416_p15;
wire  signed [5:0] tmp_s_fu_416_p17;
wire  signed [5:0] tmp_s_fu_416_p19;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_21_6_32_1_1_U116(.din0(W_20_load_4),.din1(W_22_load_4),.din2(W_24_load_4),.din3(W_26_load_4),.din4(W_28_load_4),.din5(W_30_load_4),.din6(W_32_load_4),.din7(W_34_load_4),.din8(W_36_load_4),.din9(W_38_load_4),.def(tmp_1_fu_378_p21),.sel(i_2_fu_142),.dout(tmp_1_fu_378_p23));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_21_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h16 ),.din1_WIDTH( 32 ),.CASE2( 6'h18 ),.din2_WIDTH( 32 ),.CASE3( 6'h1A ),.din3_WIDTH( 32 ),.CASE4( 6'h1C ),.din4_WIDTH( 32 ),.CASE5( 6'h1E ),.din5_WIDTH( 32 ),.CASE6( 6'h20 ),.din6_WIDTH( 32 ),.CASE7( 6'h22 ),.din7_WIDTH( 32 ),.CASE8( 6'h24 ),.din8_WIDTH( 32 ),.CASE9( 6'h26 ),.din9_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_21_6_32_1_1_U117(.din0(W_21_load_4),.din1(W_23_load_4),.din2(W_25_load_4),.din3(W_27_load_4),.din4(W_29_load_4),.din5(W_31_load_4),.din6(W_33_load_4),.din7(W_35_load_4),.din8(W_37_load_4),.din9(W_39_load_4),.def(tmp_s_fu_416_p21),.sel(i_2_fu_142),.dout(tmp_s_fu_416_p23));
...
assign add_ln122_5_fu_611_p2 = (tmp_s_reg_833 + 32'd1859775393);
