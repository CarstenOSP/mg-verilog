...
wire   [0:0] first_iter_2_fu_235_p2;
reg   [0:0] first_iter_2_reg_386;
reg   [5:0] tmp2_addr_reg_390;
reg   [5:0] tmp2_addr_reg_390_pp0_iter1_reg;
wire   [4:0] lshr_ln6_3_fu_246_p4;
reg   [4:0] lshr_ln6_3_reg_395;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] buff_x_load_reg_415;
reg   [31:0] buff_x_1_load_reg_425;
reg   [31:0] arrayidx67_promoted_reg_430;
reg   [31:0] buff_B_load_reg_435;
reg   [31:0] buff_B_load_1_reg_440;
reg   [31:0] mul62_1_reg_445;
wire    ap_CS_fsm_pp0_stage7;
wire    ap_block_pp0_stage7_11001;
wire    ap_CS_fsm_pp0_stage11;
wire    ap_block_pp0_stage11_11001;
reg   [31:0] mul65_1_reg_455;
...
wire   [63:0] zext_ln33_2_fu_288_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln33_1_fu_301_p1;
reg   [6:0] j_fu_60;
wire   [6:0] add_ln32_fu_314_p2;
wire    ap_loop_init;
...
wire   [11:0] add_ln31_1_fu_189_p2;
...
wire   [6:0] add_ln31_fu_201_p2;
wire   [11:0] tmp_5_fu_272_p3;
wire   [11:0] zext_ln33_fu_279_p1;
wire   [11:0] add_ln33_fu_282_p2;
wire   [11:0] tmp_9_fu_293_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_540)) begin
            add6815_fu_72 <= arrayidx67_promoted_reg_430;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add6815_fu_72 <= reg_159;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_183_p2 == 1'd0))) begin
            i_2_fu_64 <= select_ln31_fu_223_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_183_p2 == 1'd0))) begin
            indvar_flatten15_fu_68 <= add_ln31_1_fu_189_p2;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_60 <= 7'd0;
    end else if (((icmp_ln31_reg_370 == 1'd0) & (1'b0 == ap_block_pp0_stage14_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        j_fu_60 <= add_ln32_fu_314_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx67_promoted_reg_430 <= tmp2_q0;
        buff_B_load_1_reg_440 <= buff_B_q0;
        buff_B_load_reg_435 <= buff_B_q1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        first_iter_2_reg_386 <= first_iter_2_fu_235_p2;
        icmp_ln31_reg_370 <= icmp_ln31_fu_183_p2;
        lshr_ln6_3_reg_395 <= {{select_ln6_fu_215_p3[5:1]}};
        select_ln6_reg_374 <= select_ln6_fu_215_p3;
        tmp2_addr_reg_390 <= zext_ln31_fu_241_p1;
        tmp2_addr_reg_390_pp0_iter1_reg <= tmp2_addr_reg_390;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul62_1_reg_445 <= grp_fu_167_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage11_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        mul65_1_reg_455 <= grp_fu_167_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage14_11001) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        tmp_1_reg_460 <= add_ln32_fu_314_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln31_reg_370 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage8) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
            grp_fu_149_p0 = mul62_1_reg_445;
        end else if (((1'b0 == ap_block_pp0_stage7) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
            grp_fu_149_p0 = reg_153;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_149_p0 = buff_B_load_1_reg_440;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_149_p0 = buff_B_load_reg_435;
        end else begin
            grp_fu_149_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_address0_local = tmp2_addr_reg_390_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_address0_local = tmp2_addr_reg_390;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1_reg_460 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_we0_local = 1'b1;
    end else begin
        tmp2_we0_local = 1'b0;
    end
...
assign add_ln31_1_fu_189_p2 = (ap_sig_allocacmp_indvar_flatten15_load + 12'd1);
assign add_ln31_fu_201_p2 = (ap_sig_allocacmp_i_2_load + 7'd1);
assign add_ln32_fu_314_p2 = (select_ln6_reg_374 + 7'd2);
assign add_ln33_fu_282_p2 = (tmp_5_fu_272_p3 + zext_ln33_fu_279_p1);
...
always @ (*) begin
    ap_condition_540 = ((icmp_ln31_reg_370 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_2_reg_386 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_B_address0 = zext_ln33_1_fu_301_p1;
assign buff_B_address1 = zext_ln33_2_fu_288_p1;
...
assign first_iter_2_fu_235_p2 = ((select_ln6_fu_215_p3 == 7'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln31_fu_183_p2 = ((ap_sig_allocacmp_indvar_flatten15_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_3_fu_246_p4 = {{select_ln6_fu_215_p3[5:1]}};
assign select_ln31_fu_223_p3 = ((tmp_fu_207_p3[0:0] == 1'b1) ? add_ln31_fu_201_p2 : ap_sig_allocacmp_i_2_load);
...
assign tmp2_d0 = reg_159;
assign tmp2_we0 = tmp2_we0_local;
assign tmp_5_fu_272_p3 = {{empty_reg_380}, {6'd0}};
assign tmp_9_fu_293_p4 = {{{empty_reg_380}, {lshr_ln6_3_reg_395}}, {1'd1}};
assign tmp_fu_207_p3 = ap_sig_allocacmp_j_load[32'd6];
assign zext_ln31_fu_241_p1 = select_ln31_fu_223_p3;
assign zext_ln33_1_fu_301_p1 = tmp_9_fu_293_p4;
assign zext_ln33_2_fu_288_p1 = add_ln33_fu_282_p2;
assign zext_ln33_fu_279_p1 = select_ln6_reg_374;
assign zext_ln6_fu_256_p1 = lshr_ln6_3_fu_246_p4;
endmodule 