...
wire   [31:0] tmp_5_fu_1014_p11;
reg   [31:0] tmp_5_reg_1441;
wire   [31:0] tmp_8_fu_1037_p11;
reg   [31:0] tmp_8_reg_1446;
...
reg   [9:0] indvar_flatten13_fu_174;
...
wire   [31:0] tmp_5_fu_1014_p9;
wire   [31:0] tmp_8_fu_1037_p9;
...
wire   [1:0] tmp_5_fu_1014_p1;
wire   [1:0] tmp_5_fu_1014_p3;
wire  signed [1:0] tmp_5_fu_1014_p5;
wire  signed [1:0] tmp_5_fu_1014_p7;
wire   [1:0] tmp_8_fu_1037_p1;
wire   [1:0] tmp_8_fu_1037_p3;
wire  signed [1:0] tmp_8_fu_1037_p5;
wire  signed [1:0] tmp_8_fu_1037_p7;
...
#0 j_fu_166 = 7'd0;
#0 i_fu_170 = 7'd0;
#0 indvar_flatten13_fu_174 = 10'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_9_2_32_1_1_U878(.din0(buff_C_out_q0),.din1(buff_C_out_1_q0),.din2(buff_C_out_2_q0),.din3(buff_C_out_3_q0),.def(tmp_2_fu_991_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_2_fu_991_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U879(.din0(buff_C_out_4_q0),.din1(buff_C_out_5_q0),.din2(buff_C_out_6_q0),.din3(buff_C_out_7_q0),.def(tmp_5_fu_1014_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_5_fu_1014_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U880(.din0(buff_C_out_8_q0),.din1(buff_C_out_9_q0),.din2(buff_C_out_10_q0),.din3(buff_C_out_11_q0),.def(tmp_8_fu_1037_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_8_fu_1037_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U881(.din0(buff_C_out_12_q0),.din1(buff_C_out_13_q0),.din2(buff_C_out_14_q0),.din3(buff_C_out_15_q0),.def(tmp_6_fu_1060_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_6_fu_1060_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U882(.din0(buff_C_out_16_q0),.din1(buff_C_out_17_q0),.din2(buff_C_out_18_q0),.din3(buff_C_out_19_q0),.def(tmp_7_fu_1083_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_7_fu_1083_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U883(.din0(buff_C_out_20_q0),.din1(buff_C_out_21_q0),.din2(buff_C_out_22_q0),.din3(buff_C_out_23_q0),.def(tmp_10_fu_1106_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_10_fu_1106_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U884(.din0(buff_C_out_24_q0),.din1(buff_C_out_25_q0),.din2(buff_C_out_26_q0),.din3(buff_C_out_27_q0),.def(tmp_11_fu_1129_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_11_fu_1129_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U885(.din0(buff_C_out_28_q0),.din1(buff_C_out_29_q0),.din2(buff_C_out_30_q0),.din3(buff_C_out_31_q0),.def(tmp_12_fu_1152_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_12_fu_1152_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln38_fu_676_p2 == 1'd0))) begin
            indvar_flatten13_fu_174 <= add_ln38_1_fu_682_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten13_fu_174 <= 10'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_5_reg_1441 <= tmp_5_fu_1014_p11;
        tmp_6_reg_1451 <= tmp_6_fu_1060_p11;
        tmp_7_reg_1456 <= tmp_7_fu_1083_p11;
        tmp_8_reg_1446 <= tmp_8_fu_1037_p11;
    end
end
always @ (*) begin
...
assign add_ln38_1_fu_682_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 10'd1);
...
assign bitcast_ln41_1_fu_1179_p1 = tmp_5_reg_1441;
assign bitcast_ln41_2_fu_1183_p1 = tmp_8_reg_1446;
...
assign icmp_ln38_fu_676_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 10'd512) ? 1'b1 : 1'b0);
...
assign lshr_ln5_8_fu_733_p4 = {{select_ln5_fu_713_p3[5:3]}};
assign or_ln39_1_fu_845_p4 = {{{tmp_4_fu_831_p4}, {1'd1}}, {trunc_ln39_fu_841_p1}};
assign or_ln39_2_fu_865_p3 = {{tmp_4_fu_831_p4}, {2'd3}};
assign or_ln39_3_fu_887_p4 = {{{lshr_ln5_8_fu_733_p4}, {1'd1}}, {trunc_ln39_1_fu_883_p1}};
assign or_ln39_4_fu_915_p5 = {{{{lshr_ln5_8_fu_733_p4}, {1'd1}}, {tmp_9_fu_907_p3}}, {1'd1}};
assign or_ln39_5_fu_937_p4 = {{{lshr_ln5_8_fu_733_p4}, {2'd3}}, {trunc_ln39_fu_841_p1}};
assign or_ln39_6_fu_957_p3 = {{lshr_ln5_8_fu_733_p4}, {3'd7}};
