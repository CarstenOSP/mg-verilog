module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,temp_83,temp_82,C,C_90,C_89,W_40_load_4,W_44_load_4,W_48_load_4,W_52_load_4,W_56_load_4,W_41_load_4,W_45_load_4,W_49_load_4,W_53_load_4,W_57_load_4,W_42_load_4,W_46_load_4,W_50_load_4,W_54_load_4,W_58_load_4,W_43_load_4,W_47_load_4,W_51_load_4,W_55_load_4,W_59_load_4,A_out,A_out_ap_vld,B_42_out,B_42_out_ap_vld,C_91_out,C_91_out_ap_vld,D_51_out,D_51_out_ap_vld,E_28_out,E_28_out_ap_vld); 
...
sparsemux_11_6_32_1_1_U90(.din0(W_40_load_4),.din1(W_44_load_4),.din2(W_48_load_4),.din3(W_52_load_4),.din4(W_56_load_4),.def(tmp_s_fu_364_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_s_fu_364_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h2C ),.din1_WIDTH( 32 ),.CASE2( 6'h30 ),.din2_WIDTH( 32 ),.CASE3( 6'h34 ),.din3_WIDTH( 32 ),.CASE4( 6'h38 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U91(.din0(W_41_load_4),.din1(W_45_load_4),.din2(W_49_load_4),.din3(W_53_load_4),.din4(W_57_load_4),.def(tmp_4_fu_392_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_4_fu_392_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h2C ),.din1_WIDTH( 32 ),.CASE2( 6'h30 ),.din2_WIDTH( 32 ),.CASE3( 6'h34 ),.din3_WIDTH( 32 ),.CASE4( 6'h38 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U92(.din0(W_42_load_4),.din1(W_46_load_4),.din2(W_50_load_4),.din3(W_54_load_4),.din4(W_58_load_4),.def(tmp_5_fu_420_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_5_fu_420_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h2C ),.din1_WIDTH( 32 ),.CASE2( 6'h30 ),.din2_WIDTH( 32 ),.CASE3( 6'h34 ),.din3_WIDTH( 32 ),.CASE4( 6'h38 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U93(.din0(W_43_load_4),.din1(W_47_load_4),.din2(W_51_load_4),.din3(W_55_load_4),.din4(W_59_load_4),.def(tmp_6_fu_448_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_6_fu_448_p13));
...
assign lshr_ln5_fu_495_p4 = {{B_5_fu_132[31:27]}};
...
assign or_ln126_2_fu_529_p3 = {{trunc_ln126_fu_491_p1}, {lshr_ln5_fu_495_p4}};
