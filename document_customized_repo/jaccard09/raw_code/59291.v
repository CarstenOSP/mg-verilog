...
reg   [7:0] b_idx_reg_506;
wire    ap_CS_fsm_state5;
wire   [7:0] empty_23_fu_315_p2;
reg   [7:0] empty_23_reg_515;
reg   [7:0] SEQB_load_reg_531;
wire    ap_CS_fsm_state6;
wire   [14:0] empty_24_fu_355_p2;
reg   [14:0] empty_24_reg_536;
wire   [14:0] empty_25_fu_368_p2;
reg   [14:0] empty_25_reg_541;
reg   [31:0] M_load_reg_546;
wire   [2:0] grp_needwun_Pipeline_trace_fu_194_ap_return;
reg   [2:0] targetBlock_reg_551;
wire    ap_CS_fsm_state9;
wire   [31:0] or_ln65_4_fu_382_p3;
wire    ap_CS_fsm_state10;
wire   [31:0] or_ln65_6_fu_390_p3;
wire   [31:0] or_ln65_8_fu_398_p3;
wire   [31:0] or_ln65_s_fu_414_p5;
wire   [31:0] or_ln65_3_fu_426_p3;
wire   [31:0] or_ln65_1_fu_434_p3;
wire   [31:0] zext_ln62_fu_442_p1;
wire   [31:0] or_ln65_2_fu_456_p3;
wire   [0:0] icmp_ln83_fu_474_p2;
reg   [0:0] icmp_ln83_reg_595;
...
wire   [14:0] grp_needwun_Pipeline_init_row_fu_182_M_address1;
wire    grp_needwun_Pipeline_init_row_fu_182_M_ce1;
wire    grp_needwun_Pipeline_init_row_fu_182_M_we1;
wire   [31:0] grp_needwun_Pipeline_init_row_fu_182_M_d1;
...
wire   [14:0] grp_needwun_Pipeline_init_col_fu_188_M_address1;
wire    grp_needwun_Pipeline_init_col_fu_188_M_ce1;
wire    grp_needwun_Pipeline_init_col_fu_188_M_we1;
wire   [31:0] grp_needwun_Pipeline_init_col_fu_188_M_d1;
...
wire   [7:0] grp_needwun_Pipeline_pad_a_fu_224_alignedA_address1;
wire    grp_needwun_Pipeline_pad_a_fu_224_alignedA_ce1;
wire    grp_needwun_Pipeline_pad_a_fu_224_alignedA_we1;
wire   [7:0] grp_needwun_Pipeline_pad_a_fu_224_alignedA_d1;
...
wire   [7:0] grp_needwun_Pipeline_pad_b_fu_232_alignedB_address1;
wire    grp_needwun_Pipeline_pad_b_fu_232_alignedB_ce1;
wire    grp_needwun_Pipeline_pad_b_fu_232_alignedB_we1;
wire   [7:0] grp_needwun_Pipeline_pad_b_fu_232_alignedB_d1;
...
wire   [14:0] empty_22_fu_304_p2;
wire   [14:0] p_shl9_fu_348_p3;
wire   [14:0] p_cast2_fu_345_p1;
...
wire   [30:0] tmp_7_fu_446_p4;
wire   [23:0] tmp_6_fu_464_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_needwun_Pipeline_pad_a_fu_224_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state12) & (icmp_ln83_reg_595 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        if ((targetBlock_reg_551 == 3'd0)) begin
            b_str_idx_reg_160 <= zext_ln62_fu_442_p1;
        end else if ((targetBlock_reg_551 == 3'd7)) begin
            b_str_idx_reg_160 <= or_ln65_2_fu_456_p3;
        end else if ((targetBlock_reg_551 == 3'd6)) begin
            b_str_idx_reg_160 <= or_ln65_4_fu_382_p3;
        end else if ((targetBlock_reg_551 == 3'd5)) begin
            b_str_idx_reg_160 <= or_ln65_6_fu_390_p3;
        end else if ((targetBlock_reg_551 == 3'd4)) begin
            b_str_idx_reg_160 <= or_ln65_8_fu_398_p3;
        end else if ((targetBlock_reg_551 == 3'd3)) begin
            b_str_idx_reg_160 <= or_ln65_s_fu_414_p5;
        end else if ((targetBlock_reg_551 == 3'd2)) begin
            b_str_idx_reg_160 <= or_ln65_3_fu_426_p3;
        end else if ((targetBlock_reg_551 == 3'd1)) begin
            b_str_idx_reg_160 <= or_ln65_1_fu_434_p3;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        M_load_reg_546 <= M_q0;
        SEQB_load_reg_531 <= SEQB_q0;
        empty_24_reg_536 <= empty_24_fu_355_p2;
        empty_25_reg_541 <= empty_25_fu_368_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_needwun_Pipeline_trace_fu_194_a_str_idx_0_0_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        a_str_idx_0_0_loc_fu_126 <= grp_needwun_Pipeline_trace_fu_194_a_str_idx_0_0_out;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        b_idx_reg_506 <= b_idx_1_fu_118;
        empty_23_reg_515 <= empty_23_fu_315_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_needwun_Pipeline_trace_fu_194_b_str_idx_6_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        b_str_idx_6_loc_fu_130 <= grp_needwun_Pipeline_trace_fu_194_b_str_idx_6_out;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        icmp_ln83_reg_595 <= icmp_ln83_fu_474_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        targetBlock_reg_551 <= grp_needwun_Pipeline_trace_fu_194_ap_return;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        M_address0 = p_cast8_fu_310_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        M_address1 = grp_needwun_Pipeline_fill_in_fu_210_M_address1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        M_address1 = grp_needwun_Pipeline_init_col_fu_188_M_address1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_address1 = grp_needwun_Pipeline_init_row_fu_182_M_address1;
    end else begin
        M_address1 = 'bx;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        M_ce1 = grp_needwun_Pipeline_init_col_fu_188_M_ce1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_ce1 = grp_needwun_Pipeline_init_row_fu_182_M_ce1;
    end else begin
        M_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        M_d1 = grp_needwun_Pipeline_init_col_fu_188_M_d1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_d1 = grp_needwun_Pipeline_init_row_fu_182_M_d1;
    end else begin
        M_d1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        M_we1 = grp_needwun_Pipeline_init_col_fu_188_M_we1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_we1 = grp_needwun_Pipeline_init_row_fu_182_M_we1;
    end else begin
        M_we1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        SEQB_address0 = p_cast9_fu_321_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        alignedA_ce1 = grp_needwun_Pipeline_pad_a_fu_224_alignedA_ce1;
    end else begin
        alignedA_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        alignedA_we1 = grp_needwun_Pipeline_pad_a_fu_224_alignedA_we1;
    end else begin
        alignedA_we1 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (icmp_ln83_reg_595 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (icmp_ln83_reg_595 == 1'd1))) begin
        alignedB_we1 = grp_needwun_Pipeline_pad_b_fu_232_alignedB_we1;
    end else begin
        alignedB_we1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((grp_needwun_Pipeline_pad_a_fu_224_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((grp_needwun_Pipeline_fill_in_fu_210_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state8))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end
        ...
        ap_ST_fsm_state12 : begin
            if (((grp_needwun_Pipeline_pad_a_fu_224_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
...
assign alignedA_address1 = grp_needwun_Pipeline_pad_a_fu_224_alignedA_address1;
assign alignedA_d1 = grp_needwun_Pipeline_pad_a_fu_224_alignedA_d1;
assign alignedB_address1 = grp_needwun_Pipeline_pad_b_fu_232_alignedB_address1;
assign alignedB_d1 = grp_needwun_Pipeline_pad_b_fu_232_alignedB_d1;
...
always @ (*) begin
    ap_block_state13_on_subcall_done = ((grp_needwun_Pipeline_pad_b_fu_232_ap_done == 1'b0) & (icmp_ln83_reg_595 == 1'd1));
end
assign b_idx_1_cast_fu_342_p1 = b_idx_reg_506;
assign empty_22_fu_304_p2 = (empty_fu_298_p2 + 15'd129);
assign empty_23_fu_315_p2 = ($signed(b_idx_1_fu_118) + $signed(8'd255));
assign empty_24_fu_355_p2 = (p_shl9_fu_348_p3 + p_cast2_fu_345_p1);
assign empty_25_fu_368_p2 = (p_shl_fu_361_p3 + b_idx_1_cast_fu_342_p1);
...
assign icmp_ln83_fu_474_p2 = (($signed(tmp_6_fu_464_p4) < $signed(24'd1)) ? 1'b1 : 1'b0);
assign indvar_cast_fu_286_p1 = indvar_fu_122;
assign or_ln65_1_fu_434_p3 = {{grp_fu_249_p4}, {3'd7}};
assign or_ln65_2_fu_456_p3 = {{tmp_7_fu_446_p4}, {1'd1}};
assign or_ln65_3_fu_426_p3 = {{grp_fu_249_p4}, {3'd6}};
assign or_ln65_4_fu_382_p3 = {{grp_fu_240_p4}, {2'd2}};
assign or_ln65_6_fu_390_p3 = {{grp_fu_240_p4}, {2'd3}};
assign or_ln65_8_fu_398_p3 = {{grp_fu_249_p4}, {3'd4}};
assign or_ln65_s_fu_414_p5 = {{{{grp_fu_249_p4}, {1'd1}}, {tmp_fu_406_p3}}, {1'd1}};
assign p_cast2_fu_345_p1 = empty_23_reg_515;
assign p_cast8_fu_310_p1 = empty_22_fu_304_p2;
assign p_cast9_fu_321_p1 = empty_23_fu_315_p2;
assign p_shl8_fu_290_p3 = {{indvar_fu_122}, {7'd0}};
assign p_shl9_fu_348_p3 = {{empty_23_reg_515}, {7'd0}};
assign p_shl_fu_361_p3 = {{b_idx_reg_506}, {7'd0}};
assign ptr_d0 = grp_needwun_Pipeline_fill_in_fu_210_ptr_d0;
assign tmp_6_fu_464_p4 = {{b_str_idx_reg_160[31:8]}};
assign tmp_7_fu_446_p4 = {{a_str_idx_0_0_loc_fu_126[31:1]}};
assign tmp_fu_406_p3 = a_str_idx_0_0_loc_fu_126[32'd1];
assign zext_ln62_fu_442_p1 = b_str_idx_6_loc_fu_130;
endmodule 