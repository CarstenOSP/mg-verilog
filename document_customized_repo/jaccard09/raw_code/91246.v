...
sparsemux_17_3_32_1_1_U232(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.din4(tmp1_4_q0),.din5(tmp1_5_q0),.din6(tmp1_6_q0),.din7(tmp1_7_q0),.def(tmp_1_fu_621_p17),.sel(trunc_ln26_1_reg_774),.dout(tmp_1_fu_621_p19));
(* dissolve_hierarchy = "yes" *) atax_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U233(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.din4(buff_A_4_q0),.din5(buff_A_5_q0),.din6(buff_A_6_q0),.din7(buff_A_7_q0),.def(tmp_3_fu_660_p17),.sel(trunc_ln27_reg_819),.dout(tmp_3_fu_660_p19));
(* dissolve_hierarchy = "yes" *) atax_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U234(.din0(buff_y_out_q1),.din1(buff_y_out_1_q1),.din2(buff_y_out_2_q1),.din3(buff_y_out_3_q1),.din4(buff_y_out_4_q1),.din5(buff_y_out_5_q1),.din6(buff_y_out_6_q1),.din7(buff_y_out_7_q1),.def(tmp_2_fu_710_p17),.sel(trunc_ln27_reg_819_pp0_iter5_reg),.dout(tmp_2_fu_710_p19));
...
assign grp_fu_2021_p_din0 = tmp_2_reg_928;
assign grp_fu_2021_p_din1 = mul1_reg_933;
assign grp_fu_2021_p_opcode = 2'd0;
assign grp_fu_2025_p_ce = 1'b1;
assign grp_fu_2025_p_din0 = tmp_3_reg_875;
assign grp_fu_2025_p_din1 = tmp_1_reg_870;
