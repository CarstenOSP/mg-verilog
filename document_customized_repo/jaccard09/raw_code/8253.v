module sha_stream_sha_transform_Pipeline_trans_lp6 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_55_reload,B_53_reload,C_58_reload,D_55_reload,E_53_reload,W_address0,W_ce0,W_q0,W_address1,W_ce1,W_q1,W_4_address0,W_4_ce0,W_4_q0,W_4_address1,W_4_ce1,W_4_q1,W_8_address0,W_8_ce0,W_8_q0,W_8_address1,W_8_ce1,W_8_q1,W_12_address0,W_12_ce0,W_12_q0,W_12_address1,W_12_ce1,W_12_q1,W_1_address0,W_1_ce0,W_1_q0,W_1_address1,W_1_ce1,W_1_q1,W_5_address0,W_5_ce0,W_5_q0,W_5_address1,W_5_ce1,W_5_q1,W_9_address0,W_9_ce0,W_9_q0,W_9_address1,W_9_ce1,W_9_q1,W_13_address0,W_13_ce0,W_13_q0,W_13_address1,W_13_ce1,W_13_q1,W_2_address0,W_2_ce0,W_2_q0,W_2_address1,W_2_ce1,W_2_q1,W_6_address0,W_6_ce0,W_6_q0,W_6_address1,W_6_ce1,W_6_q1,W_10_address0,W_10_ce0,W_10_q0,W_10_address1,W_10_ce1,W_10_q1,W_14_address0,W_14_ce0,W_14_q0,W_14_address1,W_14_ce1,W_14_q1,W_3_address0,W_3_ce0,W_3_q0,W_3_address1,W_3_ce1,W_3_q1,W_7_address0,W_7_ce0,W_7_q0,W_7_address1,W_7_ce1,W_7_q1,W_11_address0,W_11_ce0,W_11_q0,W_11_address1,W_11_ce1,W_11_q1,W_15_address0,W_15_ce0,W_15_q0,W_15_address1,W_15_ce1,W_15_q1,C_50_out,C_50_out_ap_vld,temp_5_out,temp_5_out_ap_vld,C_51_out,C_51_out_ap_vld,temp_6_out,temp_6_out_ap_vld,C_52_out,C_52_out_ap_vld); 
...
input  [31:0] B_53_reload;
input  [31:0] C_58_reload;
input  [31:0] D_55_reload;
input  [31:0] E_53_reload;
...
reg    W_15_ce1_local;
reg    W_15_ce0_local;
wire   [2:0] lshr_ln100_7_fu_650_p4;
wire   [6:0] add_ln128_fu_680_p2;
wire   [2:0] lshr_ln100_8_fu_692_p4;
wire   [6:0] add_ln128_1_fu_710_p2;
wire   [2:0] lshr_ln100_9_fu_716_p4;
wire   [6:0] add_ln128_2_fu_734_p2;
wire   [2:0] lshr_ln100_s_fu_740_p4;
wire   [6:0] add_ln128_3_fu_758_p2;
wire   [2:0] lshr_ln100_1_fu_764_p4;
...
wire   [4:0] lshr_ln5_fu_1023_p4;
wire   [31:0] or_ln3_fu_1033_p3;
...
sparsemux_9_4_32_1_1_U116(.din0(W_q1),.din1(W_4_q1),.din2(W_8_q1),.din3(W_12_q1),.def(tmp_s_fu_794_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_s_fu_794_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U117(.din0(W_1_q1),.din1(W_5_q1),.din2(W_9_q1),.din3(W_13_q1),.def(tmp_1_fu_855_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_1_fu_855_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U118(.din0(W_2_q1),.din1(W_6_q1),.din2(W_10_q1),.din3(W_14_q1),.def(tmp_2_fu_878_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_2_fu_878_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U119(.din0(W_3_q1),.din1(W_7_q1),.din2(W_11_q1),.din3(W_15_q1),.def(tmp_3_fu_901_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_3_fu_901_p11));
...
sparsemux_9_4_32_1_1_U120(.din0(W_q0),.din1(W_4_q0),.din2(W_8_q0),.din3(W_12_q0),.def(tmp_4_fu_924_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_4_fu_924_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'hC ),.din0_WIDTH( 32 ),.CASE1( 4'h0 ),.din1_WIDTH( 32 ),.CASE2( 4'h4 ),.din2_WIDTH( 32 ),.CASE3( 4'h8 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U121(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.def(tmp_5_fu_947_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_5_fu_947_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'hC ),.din0_WIDTH( 32 ),.CASE1( 4'h0 ),.din1_WIDTH( 32 ),.CASE2( 4'h4 ),.din2_WIDTH( 32 ),.CASE3( 4'h8 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U122(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.def(tmp_6_fu_970_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_6_fu_970_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'hC ),.din0_WIDTH( 32 ),.CASE1( 4'h0 ),.din1_WIDTH( 32 ),.CASE2( 4'h4 ),.din2_WIDTH( 32 ),.CASE3( 4'h8 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U123(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.def(tmp_7_fu_993_p9),.sel(trunc_ln15_reg_1649),.dout(tmp_7_fu_993_p11));
...
assign C_50_out = C_4_reg_1937;
assign C_51_out = C_5_reg_1972;
assign C_52_out = C_6_fu_1269_p3;
...
assign add_ln130_2_fu_1041_p2 = (add_ln130_1_reg_1836 + or_ln3_fu_1033_p3);
...
assign lshr_ln100_1_fu_764_p4 = {{add_ln128_3_fu_758_p2[6:4]}};
assign lshr_ln100_7_fu_650_p4 = {{ap_sig_allocacmp_i_1[6:4]}};
assign lshr_ln100_8_fu_692_p4 = {{add_ln128_fu_680_p2[6:4]}};
assign lshr_ln100_9_fu_716_p4 = {{add_ln128_1_fu_710_p2[6:4]}};
assign lshr_ln100_s_fu_740_p4 = {{add_ln128_2_fu_734_p2[6:4]}};
...
assign lshr_ln5_fu_1023_p4 = {{B_1_fu_136[31:27]}};
...
assign or_ln3_fu_1033_p3 = {{trunc_ln130_fu_1019_p1}, {lshr_ln5_fu_1023_p4}};
...
assign zext_ln100_1_fu_702_p1 = lshr_ln100_8_fu_692_p4;
assign zext_ln100_2_fu_726_p1 = lshr_ln100_9_fu_716_p4;
assign zext_ln100_3_fu_750_p1 = lshr_ln100_s_fu_740_p4;
assign zext_ln100_4_fu_774_p1 = lshr_ln100_1_fu_764_p4;
assign zext_ln100_fu_660_p1 = lshr_ln100_7_fu_650_p4;
endmodule 