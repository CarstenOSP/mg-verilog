...
reg   [31:0] buff_s_out_1_load_reg_214;
reg    ap_block_pp0_stage1_11001;
reg   [31:0] buff_q_out_1_load_reg_219;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln5_fu_146_p1;
reg   [6:0] i_fu_50;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_q_out_1_load_reg_219 <= buff_q_out_1_q0;
        buff_s_out_1_load_reg_214 <= buff_s_out_1_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s_out_din_local = bitcast_ln36_1_fu_175_p1;
    end else if (((tmp_reg_190 == 1'd0) & (1'b0 == ap_block_pp0_stage1_01001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        s_out_din_local = bitcast_ln36_fu_165_p1;
    end else begin
        s_out_din_local = 'bx;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = (((tmp_reg_190 == 1'd0) & (q_out_full_n == 1'b0)) | ((tmp_reg_190 == 1'd0) & (s_out_full_n == 1'b0)));
end
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((q_out_full_n == 1'b0) | (s_out_full_n == 1'b0));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage0;
assign ap_ready = ap_ready_sig;
assign bitcast_ln36_1_fu_175_p1 = buff_s_out_1_load_reg_214;
assign bitcast_ln36_fu_165_p1 = buff_s_out_q0;
assign bitcast_ln37_1_fu_179_p1 = buff_q_out_1_load_reg_219;
assign bitcast_ln37_fu_170_p1 = buff_q_out_q0;
assign buff_q_out_1_address0 = zext_ln5_fu_146_p1;
assign buff_q_out_1_ce0 = buff_q_out_1_ce0_local;
assign buff_q_out_address0 = zext_ln5_fu_146_p1;
assign buff_q_out_ce0 = buff_q_out_ce0_local;
assign buff_s_out_1_address0 = zext_ln5_fu_146_p1;
assign buff_s_out_1_ce0 = buff_s_out_1_ce0_local;
assign buff_s_out_address0 = zext_ln5_fu_146_p1;
assign buff_s_out_ce0 = buff_s_out_ce0_local;
assign lshr_ln5_5_fu_136_p4 = {{ap_sig_allocacmp_i_1[5:1]}};
...
assign zext_ln5_fu_146_p1 = lshr_ln5_5_fu_136_p4;
endmodule 