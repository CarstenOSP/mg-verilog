module backprop_backprop_Pipeline_VITIS_LOOP_66_1 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,output_difference_2_promoted,output_difference_0_promoted,output_difference_1_promoted,mux_case_25495,mux_case_15390,mux_case_05285,mux_case_04658_reload,mux_case_14762_reload,mux_case_24866_reload,mul_ln66,training_targets_0_address0,training_targets_0_ce0,training_targets_0_q0,training_targets_1_address0,training_targets_1_ce0,training_targets_1_q0,mux_case_04970_reload,mux_case_15074_reload,mux_case_25178_reload,output_difference_out,output_difference_out_ap_vld,output_difference_1_out,output_difference_1_out_ap_vld,output_difference_2_out,output_difference_2_out_ap_vld,mux_case_25493_out,mux_case_25493_out_ap_vld,mux_case_15388_out,mux_case_15388_out_ap_vld,mux_case_05283_out,mux_case_05283_out_ap_vld,grp_fu_5721_p_din0,grp_fu_5721_p_din1,grp_fu_5721_p_opcode,grp_fu_5721_p_dout0,grp_fu_5721_p_ce,grp_fu_5737_p_din0,grp_fu_5737_p_din1,grp_fu_5737_p_dout0,grp_fu_5737_p_ce); 
...
input  [63:0] mux_case_25495;
input  [63:0] mux_case_15390;
input  [63:0] mux_case_05285;
input  [63:0] mux_case_04658_reload;
input  [63:0] mux_case_14762_reload;
input  [63:0] mux_case_24866_reload;
input  [8:0] mul_ln66;
...
input  [63:0] mux_case_04970_reload;
input  [63:0] mux_case_15074_reload;
input  [63:0] mux_case_25178_reload;
...
output  [63:0] mux_case_25493_out;
output   mux_case_25493_out_ap_vld;
output  [63:0] mux_case_15388_out;
output   mux_case_15388_out_ap_vld;
output  [63:0] mux_case_05283_out;
output   mux_case_05283_out_ap_vld;
...
reg mux_case_25493_out_ap_vld;
reg mux_case_15388_out_ap_vld;
reg mux_case_05283_out_ap_vld;
...
reg   [1:0] i_7_reg_567;
reg   [1:0] i_7_reg_567_pp0_iter1_reg;
reg   [1:0] i_7_reg_567_pp0_iter2_reg;
reg   [1:0] i_7_reg_567_pp0_iter3_reg;
reg   [1:0] i_7_reg_567_pp0_iter4_reg;
reg   [1:0] i_7_reg_567_pp0_iter5_reg;
reg   [1:0] i_7_reg_567_pp0_iter6_reg;
reg   [1:0] i_7_reg_567_pp0_iter7_reg;
reg   [1:0] i_7_reg_567_pp0_iter8_reg;
reg   [1:0] i_7_reg_567_pp0_iter9_reg;
reg   [1:0] i_7_reg_567_pp0_iter10_reg;
reg   [1:0] i_7_reg_567_pp0_iter11_reg;
reg   [1:0] i_7_reg_567_pp0_iter12_reg;
reg   [1:0] i_7_reg_567_pp0_iter13_reg;
reg   [1:0] i_7_reg_567_pp0_iter14_reg;
reg   [1:0] i_7_reg_567_pp0_iter15_reg;
reg   [1:0] i_7_reg_567_pp0_iter16_reg;
...
reg   [63:0] mux_case_05283_fu_100;
...
reg   [63:0] mux_case_15388_fu_104;
reg   [63:0] mux_case_25493_fu_108;
...
#0 i_fu_96 = 2'd0;
#0 mux_case_05283_fu_100 = 64'd0;
#0 mux_case_15388_fu_104 = 64'd0;
#0 mux_case_25493_fu_108 = 64'd0;
...
sparsemux_7_2_64_1_1_U254(.din0(mux_case_04658_reload),.din1(mux_case_14762_reload),.din2(mux_case_24866_reload),.def(tmp_9_fu_370_p7),.sel(i_7_reg_567_pp0_iter1_reg),.dout(tmp_9_fu_370_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U255(.din0(mux_case_04970_reload),.din1(mux_case_15074_reload),.din2(mux_case_25178_reload),.def(tmp_s_fu_413_p7),.sel(i_7_reg_567_pp0_iter8_reg),.dout(tmp_s_fu_413_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_05283_fu_100 <= mux_case_05285;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_7_reg_567_pp0_iter16_reg == 2'd0))) begin
            mux_case_05283_fu_100 <= mul5_i_reg_627;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_15388_fu_104 <= mux_case_15390;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_7_reg_567_pp0_iter16_reg == 2'd1))) begin
            mux_case_15388_fu_104 <= mul5_i_reg_627;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_25493_fu_108 <= mux_case_25495;
        end else if ((1'b1 == ap_condition_627)) begin
            mux_case_25493_fu_108 <= mul5_i_reg_627;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_7_reg_567_pp0_iter10_reg <= i_7_reg_567_pp0_iter9_reg;
        i_7_reg_567_pp0_iter11_reg <= i_7_reg_567_pp0_iter10_reg;
        i_7_reg_567_pp0_iter12_reg <= i_7_reg_567_pp0_iter11_reg;
        i_7_reg_567_pp0_iter13_reg <= i_7_reg_567_pp0_iter12_reg;
        i_7_reg_567_pp0_iter14_reg <= i_7_reg_567_pp0_iter13_reg;
        i_7_reg_567_pp0_iter15_reg <= i_7_reg_567_pp0_iter14_reg;
        i_7_reg_567_pp0_iter16_reg <= i_7_reg_567_pp0_iter15_reg;
        i_7_reg_567_pp0_iter2_reg <= i_7_reg_567_pp0_iter1_reg;
        i_7_reg_567_pp0_iter3_reg <= i_7_reg_567_pp0_iter2_reg;
        i_7_reg_567_pp0_iter4_reg <= i_7_reg_567_pp0_iter3_reg;
        i_7_reg_567_pp0_iter5_reg <= i_7_reg_567_pp0_iter4_reg;
        i_7_reg_567_pp0_iter6_reg <= i_7_reg_567_pp0_iter5_reg;
        i_7_reg_567_pp0_iter7_reg <= i_7_reg_567_pp0_iter6_reg;
        i_7_reg_567_pp0_iter8_reg <= i_7_reg_567_pp0_iter7_reg;
        i_7_reg_567_pp0_iter9_reg <= i_7_reg_567_pp0_iter8_reg;
        ...
        mul5_i_reg_627 <= grp_fu_5737_p_dout0;
        tmp_s_reg_617 <= tmp_s_fu_413_p9;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_7_reg_567 <= ap_sig_allocacmp_i_7;
        i_7_reg_567_pp0_iter1_reg <= i_7_reg_567;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_573_pp0_iter15_reg == 1'd1))) begin
        mux_case_05283_out_ap_vld = 1'b1;
    end else begin
        mux_case_05283_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_573_pp0_iter15_reg == 1'd1))) begin
        mux_case_15388_out_ap_vld = 1'b1;
    end else begin
        mux_case_15388_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_573_pp0_iter15_reg == 1'd1))) begin
        mux_case_25493_out_ap_vld = 1'b1;
    end else begin
        mux_case_25493_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_573_pp0_iter15_reg == 1'd1))) begin
...
assign add_ln66_fu_322_p2 = (ap_sig_allocacmp_i_7 + 2'd1);
...
always @ (*) begin
    ap_condition_627 = (~(i_7_reg_567_pp0_iter16_reg == 2'd1) & ~(i_7_reg_567_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
...
assign bitcast_ln67_1_fu_391_p1 = grp_fu_5721_p_dout0;
...
assign grp_fu_5721_p_din0 = tmp_9_fu_370_p9;
assign grp_fu_5721_p_din1 = bitcast_ln67_fu_387_p1;
assign grp_fu_5721_p_opcode = 2'd1;
assign grp_fu_5737_p_ce = 1'b1;
assign grp_fu_5737_p_din0 = bitcast_ln67_2_fu_435_p1;
assign grp_fu_5737_p_din1 = tmp_s_reg_617;
assign icmp_ln66_fu_316_p2 = ((ap_sig_allocacmp_i_7 == 2'd3) ? 1'b1 : 1'b0);
assign lshr_ln5_fu_342_p4 = {{add_ln67_fu_332_p2[8:1]}};
assign mux_case_05283_out = mux_case_05283_fu_100;
assign mux_case_15388_out = mux_case_15388_fu_104;
assign mux_case_25493_out = mux_case_25493_fu_108;
...
assign zext_ln67_1_fu_352_p1 = lshr_ln5_fu_342_p4;
assign zext_ln67_fu_328_p1 = ap_sig_allocacmp_i_7;
endmodule 