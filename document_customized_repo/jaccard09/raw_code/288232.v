module backprop_backprop_Pipeline_label_17_label_18 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v19_address0,v19_ce0,v19_q0,mux_case_01937_reload,mux_case_12041_reload,mux_case_22145_reload,empty,v7_address0,v7_ce0,v7_q0,v75,v75_3,v75_4,v10_address0,v10_ce0,v10_we0,v10_d0,grp_fu_3529_p_din0,grp_fu_3529_p_din1,grp_fu_3529_p_opcode,grp_fu_3529_p_dout0,grp_fu_3529_p_ce,grp_fu_3547_p_din0,grp_fu_3547_p_din1,grp_fu_3547_p_dout0,grp_fu_3547_p_ce,grp_fu_3551_p_din0,grp_fu_3551_p_din1,grp_fu_3551_p_dout0,grp_fu_3551_p_ce); 
...
sparsemux_7_2_64_1_1_U309(.din0(mux_case_01937_reload),.din1(mux_case_12041_reload),.din2(mux_case_22145_reload),.def(v103_fu_261_p7),.sel(select_ln177_reg_457_pp0_iter3_reg),.dout(v103_fu_261_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U310(.din0(v75),.din1(v75_3),.din2(v75_4),.def(v107_fu_304_p7),.sel(select_ln177_reg_457_pp0_iter10_reg),.dout(v107_fu_304_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v108_reg_520 <= grp_fu_3547_p_dout0;
        v109_reg_525 <= grp_fu_3551_p_dout0;
...
assign bitcast_ln183_fu_282_p1 = grp_fu_3529_p_dout0;
assign grp_fu_3529_p_ce = 1'b1;
assign grp_fu_3529_p_din0 = v103_fu_261_p9;
assign grp_fu_3529_p_din1 = v104_fu_278_p1;
assign grp_fu_3529_p_opcode = 2'd1;
assign grp_fu_3547_p_ce = 1'b1;
assign grp_fu_3547_p_din0 = v106_fu_326_p1;
assign grp_fu_3547_p_din1 = v107_reg_495;
assign grp_fu_3551_p_ce = 1'b1;
assign grp_fu_3551_p_din0 = v101_reg_515;
assign grp_fu_3551_p_din1 = v108_reg_520;
