...
dadddsub_64ns_64ns_64_8_full_dsp_1_U380(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_82_p0),.din1(grp_fu_82_p1),.opcode(grp_fu_82_opcode),.ce(1'b1),.dout(grp_fu_82_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U381(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_86_p0),.din1(grp_fu_86_p1),.ce(1'b1),.dout(grp_fu_86_p2));
