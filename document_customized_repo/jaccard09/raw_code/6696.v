...
wire   [4:0] trunc_ln8_fu_778_p1;
reg   [4:0] trunc_ln8_reg_2712;
wire   [31:0] tmp_7_fu_782_p9;
reg   [31:0] tmp_7_reg_2724;
wire   [31:0] tmp_8_fu_802_p9;
reg   [31:0] tmp_8_reg_2729;
wire   [31:0] tmp_9_fu_822_p9;
reg   [31:0] tmp_9_reg_2734;
wire   [31:0] tmp_s_fu_842_p9;
reg   [31:0] tmp_s_reg_2739;
wire   [0:0] icmp_ln124_fu_880_p2;
wire   [31:0] tmp_1_fu_886_p9;
reg   [31:0] tmp_1_reg_2748;
...
reg    W_23_ce0_local;
reg    W_31_ce0_local;
wire   [31:0] tmp_7_fu_782_p7;
wire   [31:0] tmp_8_fu_802_p7;
wire   [31:0] tmp_9_fu_822_p7;
wire   [31:0] tmp_s_fu_842_p7;
wire   [2:0] tmp_21_fu_862_p4;
wire   [5:0] or_ln1_fu_872_p3;
wire   [31:0] tmp_1_fu_886_p7;
...
wire   [0:0] tmp_2_fu_993_p3;
wire   [5:0] add_ln124_2_fu_1008_p2;
wire   [0:0] tmp_3_fu_1014_p3;
wire   [5:0] add_ln124_3_fu_1029_p2;
wire   [0:0] tmp_4_fu_1035_p3;
wire   [5:0] add_ln124_4_fu_1050_p2;
wire   [0:0] tmp_5_fu_1056_p3;
wire   [5:0] add_ln124_5_fu_1071_p2;
wire   [0:0] tmp_6_fu_1077_p3;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [4:0] tmp_7_fu_782_p1;
wire  signed [4:0] tmp_7_fu_782_p3;
wire  signed [4:0] tmp_7_fu_782_p5;
wire   [4:0] tmp_8_fu_802_p1;
wire  signed [4:0] tmp_8_fu_802_p3;
wire  signed [4:0] tmp_8_fu_802_p5;
wire   [4:0] tmp_9_fu_822_p1;
wire  signed [4:0] tmp_9_fu_822_p3;
wire  signed [4:0] tmp_9_fu_822_p5;
wire   [4:0] tmp_s_fu_842_p1;
wire  signed [4:0] tmp_s_fu_842_p3;
wire  signed [4:0] tmp_s_fu_842_p5;
wire   [4:0] tmp_1_fu_886_p1;
wire  signed [4:0] tmp_1_fu_886_p3;
wire  signed [4:0] tmp_1_fu_886_p5;
...
sparsemux_7_5_32_1_1_U122(.din0(W_8_load_5),.din1(W_16_load_5),.din2(W_24_load_4),.def(tmp_7_fu_782_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_7_fu_782_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U123(.din0(W_9_load_5),.din1(W_17_load_5),.din2(W_25_load_4),.def(tmp_8_fu_802_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_8_fu_802_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U124(.din0(W_10_load_5),.din1(W_18_load_5),.din2(W_26_load_4),.def(tmp_9_fu_822_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_9_fu_822_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U125(.din0(W_11_load_5),.din1(W_19_load_5),.din2(W_27_load_4),.def(tmp_s_fu_842_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_s_fu_842_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U126(.din0(W_12_load_5),.din1(W_20_load_4),.din2(W_28_load_4),.def(tmp_1_fu_886_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_1_fu_886_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U127(.din0(W_13_load_5),.din1(W_21_load_4),.din2(W_29_load_4),.def(tmp_10_fu_906_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_10_fu_906_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U128(.din0(W_14_load_5),.din1(W_22_load_4),.din2(W_30_load_4),.def(tmp_11_fu_926_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_11_fu_926_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U129(.din0(W_15_load_5),.din1(W_23_load_4),.din2(W_31_load_4),.def(tmp_12_fu_946_p7),.sel(trunc_ln8_fu_778_p1),.dout(tmp_12_fu_946_p9));
...
sparsemux_7_5_32_1_1_U130(.din0(W_q0),.din1(W_16_q0),.din2(W_24_q0),.def(tmp_13_fu_1303_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_13_fu_1303_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h18 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U131(.din0(W_1_q0),.din1(W_17_q0),.din2(W_25_q0),.def(tmp_14_fu_1322_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_14_fu_1322_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h18 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U132(.din0(W_2_q0),.din1(W_18_q0),.din2(W_26_q0),.def(tmp_15_fu_1341_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_15_fu_1341_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h18 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U133(.din0(W_3_q0),.din1(W_19_q0),.din2(W_27_q0),.def(tmp_16_fu_1360_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_16_fu_1360_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h18 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U134(.din0(W_4_q0),.din1(W_20_q0),.din2(W_28_q0),.def(tmp_17_fu_1379_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_17_fu_1379_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h18 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U135(.din0(W_5_q0),.din1(W_21_q0),.din2(W_29_q0),.def(tmp_18_fu_1398_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_18_fu_1398_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h18 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U136(.din0(W_6_q0),.din1(W_22_q0),.din2(W_30_q0),.def(tmp_19_fu_1417_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_19_fu_1417_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h18 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U137(.din0(W_7_q0),.din1(W_23_q0),.din2(W_31_q0),.def(tmp_20_fu_1436_p7),.sel(trunc_ln8_reg_2712),.dout(tmp_20_fu_1436_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_2748 <= tmp_1_fu_886_p9;
        tmp_7_reg_2724 <= tmp_7_fu_782_p9;
        tmp_8_reg_2729 <= tmp_8_fu_802_p9;
        tmp_9_reg_2734 <= tmp_9_fu_822_p9;
        tmp_s_reg_2739 <= tmp_s_fu_842_p9;
        trunc_ln8_reg_2712 <= trunc_ln8_fu_778_p1;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln126_12_fu_1633_p2 = (tmp_s_reg_2739 + or_ln126_9_reg_3028);
...
assign add_ln126_17_fu_1298_p2 = (C_20_fu_1268_p3 + tmp_1_reg_2748);
assign add_ln126_18_fu_1682_p2 = ($signed(add_ln126_17_reg_2948) + $signed(32'd2400959708));
assign add_ln126_1_fu_1195_p2 = ($signed(32'd2400959708) + $signed(tmp_7_reg_2724));
...
assign add_ln126_4_fu_1491_p2 = (or_ln126_4_fu_1485_p2 + tmp_8_reg_2729);
...
assign add_ln126_8_fu_1592_p2 = (tmp_9_reg_2734 + or_ln126_7_fu_1586_p2);
...
assign tmp_2_fu_993_p3 = add_ln124_1_fu_987_p2[32'd5];
assign tmp_3_fu_1014_p3 = add_ln124_2_fu_1008_p2[32'd5];
assign tmp_4_fu_1035_p3 = add_ln124_3_fu_1029_p2[32'd5];
assign tmp_5_fu_1056_p3 = add_ln124_4_fu_1050_p2[32'd5];
assign tmp_6_fu_1077_p3 = add_ln124_5_fu_1071_p2[32'd5];
assign tmp_7_fu_782_p7 = 'bx;
assign tmp_8_fu_802_p7 = 'bx;
assign tmp_9_fu_822_p7 = 'bx;
assign tmp_fu_972_p3 = add_ln124_fu_966_p2[32'd5];
assign tmp_s_fu_842_p7 = 'bx;
...
assign trunc_ln8_fu_778_p1 = ap_sig_allocacmp_i_2[4:0];
assign zext_ln100_1_fu_1001_p1 = tmp_2_fu_993_p3;
assign zext_ln100_2_fu_1022_p1 = tmp_3_fu_1014_p3;
assign zext_ln100_3_fu_1043_p1 = tmp_4_fu_1035_p3;
assign zext_ln100_4_fu_1064_p1 = tmp_5_fu_1056_p3;
assign zext_ln100_5_fu_1085_p1 = tmp_6_fu_1077_p3;
