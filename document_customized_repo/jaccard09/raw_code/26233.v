...
wire   [10:0] j_fu_86_p2;
reg   [10:0] j_reg_119;
wire   [10:0] add9_fu_92_p2;
reg   [10:0] add9_reg_124;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add9_reg_124 <= add9_fu_92_p2;
        j_reg_119 <= j_fu_86_p2;
    end
end
always @ (*) begin
...
assign add9_fu_92_p2 = (j_fu_86_p2 + stop);
