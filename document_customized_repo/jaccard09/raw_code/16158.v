...
wire   [10:0] tmp_24_fu_821_p3;
reg   [10:0] tmp_24_reg_1095;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_478_min_p_14_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_478_min_p_14_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_501_min_s_4_out;
wire    grp_viterbi_Pipeline_L_end_fu_501_min_s_4_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_515_min_s_10_out;
wire    grp_viterbi_Pipeline_L_state_fu_515_min_s_10_out_ap_vld;
...
wire   [63:0] tmp_38_cast_fu_619_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_2_reg_985[10 : 3] <= tmp_38_cast_fu_619_p1[10 : 3];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_24_reg_1095[10 : 3] <= tmp_24_fu_821_p3[10 : 3];
        trunc_ln50_1_reg_1105 <= trunc_ln50_1_fu_833_p1;
        trunc_ln52_reg_1109 <= trunc_ln52_fu_844_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_478_min_p_14_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_14_loc_fu_134 <= grp_viterbi_Pipeline_L_prev_state_fu_478_min_p_14_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_515_min_s_10_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state44))) begin
        min_s_10_loc_fu_126 <= grp_viterbi_Pipeline_L_state_fu_515_min_s_10_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_501_min_s_4_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_4_loc_fu_130 <= grp_viterbi_Pipeline_L_end_fu_501_min_s_4_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_14_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_14_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_14_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_4_d0 = min_p_14_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_5_d0 = min_p_14_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_6_d0 = min_p_14_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_7_d0 = min_p_14_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
assign tmp_24_fu_821_p3 = {{trunc_ln50_reg_1079}, {3'd0}};
assign tmp_25_fu_751_p3 = {{t_2_reg_950}, {lshr_ln7_reg_1027}};
assign tmp_2_fu_624_p3 = ((trunc_ln18_fu_603_p1[0:0] == 1'b1) ? obs_1_q0 : obs_0_q0);
assign tmp_38_cast_fu_619_p1 = tmp_s_fu_611_p3;
...
assign zext_ln33_fu_757_p1 = tmp_25_fu_751_p3;
assign zext_ln52_1_fu_858_p1 = lshr_ln52_1_fu_848_p4;
assign zext_ln52_2_fu_828_p1 = tmp_24_fu_821_p3;
