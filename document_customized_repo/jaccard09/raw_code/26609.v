...
reg   [63:0] empty_175_fu_136;
reg   [63:0] empty_176_fu_140;
...
#0 i_fu_128 = 2'd0;
#0 empty_174_fu_132 = 64'd0;
#0 empty_175_fu_136 = 64'd0;
#0 empty_176_fu_140 = 64'd0;
...
sparsemux_7_2_64_1_1_U309(.din0(mux_case_08898_reload),.din1(mux_case_189102_reload),.din2(mux_case_291106_reload),.def(tmp_25_fu_550_p7),.sel(i_11_reg_743_pp0_iter1_reg),.dout(tmp_25_fu_550_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U310(.din0(mux_case_092110_reload),.din1(mux_case_193114_reload),.din2(mux_case_294118_reload),.def(tmp_26_fu_589_p7),.sel(i_11_reg_743_pp0_iter8_reg),.dout(tmp_26_fu_589_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            empty_176_fu_140 <= empty_36;
        end else if ((1'b1 == ap_condition_738)) begin
            empty_176_fu_140 <= mul5_i_reg_828;
        end
    end
end
always @ (posedge ap_clk) begin
...
assign p_out = empty_176_fu_140;
assign p_out1 = empty_175_fu_136;
assign p_out2 = empty_174_fu_132;
