...
wire   [0:0] icmp_ln58_1_fu_604_p2;
...
wire   [7:0] tmp_1_fu_616_p33;
wire   [7:0] tmp_1_fu_616_p35;
wire   [7:0] tmp_2_fu_726_p33;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [4:0] tmp_1_fu_616_p1;
wire   [4:0] tmp_1_fu_616_p3;
wire   [4:0] tmp_1_fu_616_p5;
wire   [4:0] tmp_1_fu_616_p7;
wire   [4:0] tmp_1_fu_616_p9;
wire   [4:0] tmp_1_fu_616_p11;
wire   [4:0] tmp_1_fu_616_p13;
wire   [4:0] tmp_1_fu_616_p15;
wire   [4:0] tmp_1_fu_616_p17;
wire   [4:0] tmp_1_fu_616_p19;
wire   [4:0] tmp_1_fu_616_p21;
wire   [4:0] tmp_1_fu_616_p23;
wire   [4:0] tmp_1_fu_616_p25;
wire   [4:0] tmp_1_fu_616_p27;
wire   [4:0] tmp_1_fu_616_p29;
wire  signed [4:0] tmp_1_fu_616_p31;
wire   [3:0] tmp_2_fu_726_p1;
wire   [3:0] tmp_2_fu_726_p3;
wire   [3:0] tmp_2_fu_726_p5;
wire   [3:0] tmp_2_fu_726_p7;
wire   [3:0] tmp_2_fu_726_p9;
wire   [3:0] tmp_2_fu_726_p11;
wire   [3:0] tmp_2_fu_726_p13;
wire   [3:0] tmp_2_fu_726_p15;
wire  signed [3:0] tmp_2_fu_726_p17;
wire  signed [3:0] tmp_2_fu_726_p19;
wire  signed [3:0] tmp_2_fu_726_p21;
wire  signed [3:0] tmp_2_fu_726_p23;
wire  signed [3:0] tmp_2_fu_726_p25;
wire  signed [3:0] tmp_2_fu_726_p27;
wire  signed [3:0] tmp_2_fu_726_p29;
wire  signed [3:0] tmp_2_fu_726_p31;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_33_5_8_1_1_U70(.din0(buf_0_i),.din1(buf_1_i),.din2(buf_2_i),.din3(buf_3_i),.din4(buf_4_i),.din5(buf_5_i),.din6(buf_6_i),.din7(buf_7_i),.din8(buf_8_i),.din9(buf_9_i),.din10(buf_10_i),.din11(buf_11_i),.din12(buf_12_i),.din13(buf_13_i),.din14(buf_14_i),.din15(buf_15_i),.def(tmp_1_fu_616_p33),.sel(ap_sig_allocacmp_i_3),.dout(tmp_1_fu_616_p35));
...
sparsemux_33_4_8_1_1_U71(.din0(sbox_0_q0),.din1(sbox_1_q0),.din2(sbox_2_q0),.din3(sbox_3_q0),.din4(sbox_4_q0),.din5(sbox_5_q0),.din6(sbox_6_q0),.din7(sbox_7_q0),.din8(sbox_8_q0),.din9(sbox_9_q0),.din10(sbox_10_q0),.din11(sbox_11_q0),.din12(sbox_12_q0),.din13(sbox_13_q0),.din14(sbox_14_q0),.din15(sbox_15_q0),.def(tmp_2_fu_726_p33),.sel(trunc_ln58_reg_828_pp0_iter1_reg),.dout(tmp_2_fu_726_p35));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln58_1_fu_604_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_predicate_pred349_state3 <= (i_3_reg_820 == 5'd15);
        ap_predicate_pred356_state3 <= (i_3_reg_820 == 5'd14);
        ap_predicate_pred362_state3 <= (i_3_reg_820 == 5'd13);
        ap_predicate_pred368_state3 <= (i_3_reg_820 == 5'd12);
        ap_predicate_pred374_state3 <= (i_3_reg_820 == 5'd11);
        ap_predicate_pred380_state3 <= (i_3_reg_820 == 5'd10);
        ap_predicate_pred386_state3 <= (i_3_reg_820 == 5'd9);
        ap_predicate_pred392_state3 <= (i_3_reg_820 == 5'd8);
        ap_predicate_pred398_state3 <= (i_3_reg_820 == 5'd7);
        ap_predicate_pred404_state3 <= (i_3_reg_820 == 5'd6);
        ap_predicate_pred410_state3 <= (i_3_reg_820 == 5'd5);
        ap_predicate_pred416_state3 <= (i_3_reg_820 == 5'd4);
        ap_predicate_pred422_state3 <= (i_3_reg_820 == 5'd3);
        ap_predicate_pred428_state3 <= (i_3_reg_820 == 5'd2);
        ap_predicate_pred434_state3 <= (i_3_reg_820 == 5'd1);
        ap_predicate_pred467_state3 <= (~(i_3_reg_820 == 5'd1) & ~(i_3_reg_820 == 5'd2) & ~(i_3_reg_820 == 5'd3) & ~(i_3_reg_820 == 5'd4) & ~(i_3_reg_820 == 5'd5) & ~(i_3_reg_820 == 5'd6) & ~(i_3_reg_820 == 5'd7) & ~(i_3_reg_820 == 5'd8) & ~(i_3_reg_820 == 5'd9) & ~(i_3_reg_820 == 5'd10) & ~(i_3_reg_820 == 5'd11) & ~(i_3_reg_820 == 5'd12) & ~(i_3_reg_820 == 5'd13) & ~(i_3_reg_820 == 5'd14) & ~(i_3_reg_820 == 5'd15));
        i_3_reg_820 <= ap_sig_allocacmp_i_3;
        lshr_ln58_1_reg_833 <= {{tmp_1_fu_616_p35[7:4]}};
        trunc_ln58_reg_828 <= trunc_ln58_fu_688_p1;
        trunc_ln58_reg_828_pp0_iter1_reg <= trunc_ln58_reg_828;
    end
end
always @ (*) begin
    if (((icmp_ln58_1_fu_604_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln58_fu_610_p2 = ($signed(ap_sig_allocacmp_i_3) + $signed(5'd31));
...
assign icmp_ln58_1_fu_604_p2 = ((ap_sig_allocacmp_i_3 == 5'd0) ? 1'b1 : 1'b0);
...
assign tmp_1_fu_616_p33 = 'bx;
assign tmp_2_fu_726_p33 = 'bx;
assign trunc_ln58_fu_688_p1 = tmp_1_fu_616_p35[3:0];
assign zext_ln58_fu_707_p1 = lshr_ln58_1_reg_833;
endmodule 