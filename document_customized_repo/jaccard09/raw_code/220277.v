...
wire   [7:0] trunc_ln55_6_fu_331_p1;
reg   [7:0] trunc_ln55_6_reg_491;
reg   [7:0] trunc_ln55_6_reg_491_pp0_iter2_reg;
reg   [7:0] trunc_ln55_6_reg_491_pp0_iter3_reg;
...
sparsemux_17_3_32_1_1_U277(.din0(v3_q0),.din1(v3_1_q0),.din2(v3_2_q0),.din3(v3_3_q0),.din4(v3_4_q0),.din5(v3_5_q0),.din6(v3_6_q0),.din7(v3_7_q0),.def(v26_fu_343_p17),.sel(v26_fu_343_p18),.dout(v26_fu_343_p19));
(* dissolve_hierarchy = "yes" *) SgdLR_sw_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U278(.din0(v28_fu_406_p2),.din1(v28_fu_406_p4),.din2(v28_fu_406_p6),.din3(v28_fu_406_p8),.def(v28_fu_406_p9),.sel(trunc_ln55_s_reg_496_pp0_iter4_reg),.dout(v28_fu_406_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln55_fu_289_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            v25_3_fu_96 <= add_ln55_fu_295_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_v25 = v25_3_fu_96;
    end
end
always @ (*) begin
...
assign lshr_ln55_7_fu_301_p4 = {{ap_sig_allocacmp_v25[9:3]}};
assign trunc_ln55_6_fu_331_p1 = v25_reg_440[7:0];
...
assign zext_ln55_6_fu_311_p1 = lshr_ln55_7_fu_301_p4;
assign zext_ln55_fu_383_p1 = trunc_ln55_6_reg_491_pp0_iter3_reg;
endmodule 