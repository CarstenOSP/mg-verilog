...
wire   [31:0] zext_ln104_13_cast_fu_370_p1;
reg   [31:0] store_forwarded105_fu_94;
wire   [31:0] xor_ln108_2_fu_696_p2;
wire   [31:0] zext_ln104_8_cast_fu_374_p1;
reg   [31:0] store_forwarded108_fu_98;
wire   [31:0] xor_ln108_17_fu_791_p2;
wire   [31:0] zext_ln104_14_cast_fu_378_p1;
reg   [31:0] store_forwarded111_fu_102;
wire   [31:0] xor_ln108_5_fu_715_p2;
wire   [31:0] zext_ln104_9_cast_fu_382_p1;
reg   [31:0] store_forwarded114_fu_106;
wire   [31:0] xor_ln108_23_fu_829_p2;
wire   [31:0] zext_ln104_15_cast_fu_386_p1;
reg   [31:0] store_forwarded117_fu_110;
wire   [31:0] xor_ln108_8_fu_734_p2;
wire   [31:0] zext_ln104_10_cast_fu_390_p1;
reg   [31:0] store_forwarded120_fu_114;
wire   [31:0] xor_ln108_11_fu_753_p2;
wire   [31:0] zext_ln104_11_cast_fu_394_p1;
reg   [31:0] store_forwarded123_fu_118;
wire   [31:0] xor_ln108_14_fu_772_p2;
wire   [31:0] zext_ln104_12_cast_fu_398_p1;
reg    W_2_ce1_local;
reg    W_2_we0_local;
reg    W_2_ce0_local;
reg    W_ce1_local;
...
#0 store_forwarded105_fu_94 = 32'd0;
#0 store_forwarded108_fu_98 = 32'd0;
#0 store_forwarded111_fu_102 = 32'd0;
#0 store_forwarded114_fu_106 = 32'd0;
#0 store_forwarded117_fu_110 = 32'd0;
#0 store_forwarded120_fu_114 = 32'd0;
#0 store_forwarded123_fu_118 = 32'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded105_fu_94 <= zext_ln104_8_cast_fu_374_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded105_fu_94 <= xor_ln108_2_fu_696_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded108_fu_98 <= zext_ln104_14_cast_fu_378_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded108_fu_98 <= xor_ln108_17_fu_791_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded111_fu_102 <= zext_ln104_9_cast_fu_382_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded111_fu_102 <= xor_ln108_5_fu_715_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded114_fu_106 <= zext_ln104_15_cast_fu_386_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded114_fu_106 <= xor_ln108_23_fu_829_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded117_fu_110 <= zext_ln104_10_cast_fu_390_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded117_fu_110 <= xor_ln108_8_fu_734_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded120_fu_114 <= zext_ln104_11_cast_fu_394_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded120_fu_114 <= xor_ln108_11_fu_753_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded123_fu_118 <= zext_ln104_12_cast_fu_398_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded123_fu_118 <= xor_ln108_14_fu_772_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            store_forwarded_fu_90 <= zext_ln104_13_cast_fu_370_p1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            store_forwarded_fu_90 <= xor_ln108_20_fu_810_p2;
        end
    end
end
always @ (posedge ap_clk) begin
...
assign xor_ln108_10_fu_747_p2 = (xor_ln108_9_fu_741_p2 ^ xor_ln108_2_fu_696_p2);
assign xor_ln108_11_fu_753_p2 = (xor_ln108_10_fu_747_p2 ^ store_forwarded120_fu_114);
assign xor_ln108_12_fu_760_p2 = (xor_ln108_5_fu_715_p2 ^ W_6_q1);
assign xor_ln108_13_fu_766_p2 = (xor_ln108_12_fu_760_p2 ^ W_4_q1);
assign xor_ln108_14_fu_772_p2 = (xor_ln108_13_fu_766_p2 ^ store_forwarded123_fu_118);
assign xor_ln108_15_fu_779_p2 = (store_forwarded105_fu_94 ^ W_6_q1);
assign xor_ln108_16_fu_785_p2 = (xor_ln108_15_fu_779_p2 ^ xor_ln108_11_fu_753_p2);
assign xor_ln108_17_fu_791_p2 = (xor_ln108_16_fu_785_p2 ^ store_forwarded108_fu_98);
assign xor_ln108_18_fu_798_p2 = (xor_ln108_8_fu_734_p2 ^ W_7_q1);
assign xor_ln108_19_fu_804_p2 = (xor_ln108_18_fu_798_p2 ^ W_5_q1);
assign xor_ln108_1_fu_690_p2 = (xor_ln108_fu_684_p2 ^ store_forwarded_fu_90);
assign xor_ln108_20_fu_810_p2 = (xor_ln108_19_fu_804_p2 ^ store_forwarded_fu_90);
assign xor_ln108_21_fu_817_p2 = (store_forwarded111_fu_102 ^ W_7_q1);
assign xor_ln108_22_fu_823_p2 = (xor_ln108_21_fu_817_p2 ^ xor_ln108_14_fu_772_p2);
assign xor_ln108_23_fu_829_p2 = (xor_ln108_22_fu_823_p2 ^ store_forwarded114_fu_106);
assign xor_ln108_2_fu_696_p2 = (xor_ln108_1_fu_690_p2 ^ store_forwarded105_fu_94);
assign xor_ln108_3_fu_703_p2 = (W_3_q1 ^ W_1_q1);
assign xor_ln108_4_fu_709_p2 = (xor_ln108_3_fu_703_p2 ^ store_forwarded108_fu_98);
assign xor_ln108_5_fu_715_p2 = (xor_ln108_4_fu_709_p2 ^ store_forwarded111_fu_102);
assign xor_ln108_6_fu_722_p2 = (store_forwarded114_fu_106 ^ W_4_q1);
assign xor_ln108_7_fu_728_p2 = (xor_ln108_6_fu_722_p2 ^ W_2_q1);
assign xor_ln108_8_fu_734_p2 = (xor_ln108_7_fu_728_p2 ^ store_forwarded117_fu_110);
assign xor_ln108_9_fu_741_p2 = (W_5_q1 ^ W_3_q1);
assign xor_ln108_fu_684_p2 = (W_q1 ^ W_2_q1);
assign zext_ln104_10_cast_fu_390_p1 = zext_ln104_10;
assign zext_ln104_11_cast_fu_394_p1 = zext_ln104_11;
assign zext_ln104_12_cast_fu_398_p1 = zext_ln104_12;
assign zext_ln104_13_cast_fu_370_p1 = zext_ln104_13;
assign zext_ln104_14_cast_fu_378_p1 = zext_ln104_14;
assign zext_ln104_15_cast_fu_386_p1 = zext_ln104_15;
assign zext_ln104_8_cast_fu_374_p1 = zext_ln104_8;
assign zext_ln104_9_cast_fu_382_p1 = zext_ln104_9;
