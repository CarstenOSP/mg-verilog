...
sparsemux_7_2_64_1_1_U2409(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_s_fu_187_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_s_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_0975984_fu_68 <= grp_fu_25357_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_1976988_fu_72 <= grp_fu_25357_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_2977992_fu_76 <= grp_fu_25357_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_424_reg_328 <= grp_fu_25361_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_25357_p_din0 = tmp_424_reg_328;
assign grp_fu_25357_p_din1 = sum_reload;
assign grp_fu_25361_p_ce = 1'b1;
assign grp_fu_25361_p_din0 = 64'd0;
assign grp_fu_25361_p_din1 = bitcast_ln12_1_fu_240_p1;
