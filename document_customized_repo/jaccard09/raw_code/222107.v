...
sparsemux_17_3_32_1_1_U764(.din0(v9_fu_347_p2),.din1(v9_fu_347_p4),.din2(v9_fu_347_p6),.din3(v9_fu_347_p8),.din4(v9_fu_347_p10),.din5(v9_fu_347_p12),.din6(v9_fu_347_p14),.din7(v9_fu_347_p16),.def(v9_fu_347_p17),.sel(trunc_ln29_6_reg_421),.dout(v9_fu_347_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v0_load_16_reg_476 <= v0_q0;
        v9_reg_471 <= v9_fu_347_p19;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v11_reg_486 <= grp_fu_5179_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        v13_reg_496 <= grp_fu_2056_p_dout0;
    end
end
always @ (*) begin
...
assign add_ln35_6_fu_297_p3 = {{tmp_9_fu_287_p4}, {ap_sig_allocacmp_v8_5}};
