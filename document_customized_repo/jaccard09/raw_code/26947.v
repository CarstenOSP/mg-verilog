...
wire   [0:0] tmp_39_fu_351_p3;
reg   [0:0] tmp_39_reg_736_pp0_iter1_reg;
reg   [0:0] tmp_39_reg_736_pp0_iter2_reg;
reg   [0:0] tmp_39_reg_736_pp0_iter3_reg;
reg   [0:0] tmp_39_reg_736_pp0_iter4_reg;
reg   [63:0] llike_1_load_reg_760;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
wire   [63:0] tmp_7_fu_406_p11;
reg   [63:0] tmp_7_reg_765;
wire   [63:0] tmp_2_fu_468_p11;
reg   [63:0] tmp_2_reg_775;
reg   [63:0] llike_load_2_reg_780;
...
reg   [63:0] p_reg_795;
reg   [63:0] min_p_19_reg_802;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3_11001;
reg   [63:0] p_8_reg_809;
wire   [0:0] and_ln29_1_fu_571_p2;
reg   [0:0] and_ln29_1_reg_816;
wire   [63:0] min_p_21_fu_577_p3;
reg   [63:0] min_p_21_reg_821;
reg   [0:0] tmp_45_reg_828;
...
wire   [63:0] tmp_7_fu_406_p2;
wire   [63:0] tmp_7_fu_406_p4;
wire   [63:0] tmp_7_fu_406_p6;
wire   [63:0] tmp_7_fu_406_p8;
wire   [63:0] tmp_7_fu_406_p9;
wire   [5:0] lshr_ln8_4_fu_429_p4;
wire   [12:0] zext_ln26_1_fu_438_p1;
wire   [12:0] add_ln26_fu_442_p2;
wire   [63:0] tmp_2_fu_468_p2;
wire   [63:0] tmp_2_fu_468_p4;
wire   [63:0] tmp_2_fu_468_p6;
wire   [63:0] tmp_2_fu_468_p8;
wire   [63:0] tmp_2_fu_468_p9;
wire    ap_block_pp0_stage4;
wire   [63:0] bitcast_ln29_fu_495_p1;
wire   [63:0] bitcast_ln29_1_fu_512_p1;
wire   [10:0] tmp_40_fu_498_p4;
wire   [51:0] trunc_ln29_fu_508_p1;
wire   [0:0] icmp_ln29_1_fu_535_p2;
wire   [0:0] icmp_ln29_fu_529_p2;
wire   [10:0] tmp_41_fu_515_p4;
...
wire   [1:0] tmp_7_fu_406_p1;
wire   [1:0] tmp_7_fu_406_p3;
wire  signed [1:0] tmp_7_fu_406_p5;
wire  signed [1:0] tmp_7_fu_406_p7;
wire   [1:0] tmp_2_fu_468_p1;
wire   [1:0] tmp_2_fu_468_p3;
wire  signed [1:0] tmp_2_fu_468_p5;
wire  signed [1:0] tmp_2_fu_468_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 5'd1;
...
sparsemux_9_2_64_1_1_U21(.din0(tmp_7_fu_406_p2),.din1(tmp_7_fu_406_p4),.din2(tmp_7_fu_406_p6),.din3(tmp_7_fu_406_p8),.def(tmp_7_fu_406_p9),.sel(empty_10),.dout(tmp_7_fu_406_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U22(.din0(tmp_2_fu_468_p2),.din1(tmp_2_fu_468_p4),.din2(tmp_2_fu_468_p6),.din3(tmp_2_fu_468_p8),.def(tmp_2_fu_468_p9),.sel(empty_10),.dout(tmp_2_fu_468_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_fu_104 <= min_p_18;
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (tmp_39_reg_736_pp0_iter4_reg == 1'd0))) begin
        min_p_fu_104 <= min_p_23_fu_665_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_39_fu_351_p3 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        add1_reg_785 <= grp_fu_593_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add52_1_reg_790 <= grp_fu_593_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_ln25_reg_731 <= add_ln25_fu_345_p2;
        tmp_39_reg_736 <= add_ln25_fu_345_p2[32'd6];
        tmp_39_reg_736_pp0_iter1_reg <= tmp_39_reg_736;
        tmp_39_reg_736_pp0_iter2_reg <= tmp_39_reg_736_pp0_iter1_reg;
        tmp_39_reg_736_pp0_iter3_reg <= tmp_39_reg_736_pp0_iter2_reg;
        tmp_39_reg_736_pp0_iter4_reg <= tmp_39_reg_736_pp0_iter3_reg;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_2_reg_775 <= tmp_2_fu_468_p11;
        tmp_7_reg_765 <= tmp_7_fu_406_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        llike_load_2_reg_780 <= llike_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        min_p_19_reg_802 <= min_p_fu_104;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_21_reg_821 <= min_p_21_fu_577_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        p_8_reg_809 <= grp_fu_593_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_reg_795 <= grp_fu_593_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_45_reg_828 <= grp_fu_1349_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_39_reg_736 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_39_reg_736_pp0_iter3_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        grp_fu_281_p0 = llike_load_2_reg_780;
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        ...
        grp_fu_281_p1 = tmp_2_reg_775;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_281_p1 = tmp_7_reg_765;
    end else begin
        grp_fu_281_p1 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_285_p1 = min_p_21_fu_577_p3;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter4_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_39_reg_736_pp0_iter3_reg == 1'd1))) begin
...
assign and_ln29_3_fu_660_p2 = (tmp_45_reg_828 & and_ln29_2_fu_654_p2);
assign and_ln29_fu_565_p2 = (or_ln29_fu_541_p2 & grp_fu_1349_p_dout0);
...
assign bitcast_ln29_1_fu_512_p1 = min_p_19_reg_802;
assign bitcast_ln29_2_fu_584_p1 = p_8_reg_809;
assign bitcast_ln29_3_fu_601_p1 = min_p_21_reg_821;
assign bitcast_ln29_fu_495_p1 = p_reg_795;
assign grp_fu_1349_p_ce = 1'b1;
assign grp_fu_1349_p_din0 = grp_fu_285_p0;
assign grp_fu_1349_p_din1 = grp_fu_285_p1;
assign grp_fu_1349_p_opcode = 5'd4;
assign grp_fu_593_p_ce = 1'b1;
assign grp_fu_593_p_din0 = grp_fu_281_p0;
assign grp_fu_593_p_din1 = grp_fu_281_p1;
assign grp_fu_593_p_opcode = 2'd0;
assign icmp_ln29_1_fu_535_p2 = ((trunc_ln29_fu_508_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_2_fu_547_p2 = ((tmp_41_fu_515_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_3_fu_553_p2 = ((trunc_ln29_1_fu_525_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_4_fu_618_p2 = ((tmp_43_fu_587_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_5_fu_624_p2 = ((trunc_ln29_2_fu_597_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_6_fu_636_p2 = ((tmp_44_fu_604_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_7_fu_642_p2 = ((trunc_ln29_3_fu_614_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_fu_529_p2 = ((tmp_40_fu_498_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign lshr_ln8_4_fu_429_p4 = {{add_ln25_reg_731[6:1]}};
assign min_p_21_fu_577_p3 = ((and_ln29_1_reg_816[0:0] == 1'b1) ? p_reg_795 : min_p_19_reg_802);
assign min_p_22_out = ((and_ln29_1_reg_816[0:0] == 1'b1) ? p_reg_795 : min_p_19_reg_802);
assign min_p_23_fu_665_p3 = ((and_ln29_3_fu_660_p2[0:0] == 1'b1) ? p_8_reg_809 : min_p_21_reg_821);
...
assign tmp_2_fu_468_p2 = transition_0_q0;
assign tmp_2_fu_468_p4 = transition_1_q0;
assign tmp_2_fu_468_p6 = transition_2_q0;
assign tmp_2_fu_468_p8 = transition_3_q0;
assign tmp_2_fu_468_p9 = 'bx;
assign tmp_39_fu_351_p3 = add_ln25_fu_345_p2[32'd6];
assign tmp_40_fu_498_p4 = {{bitcast_ln29_fu_495_p1[62:52]}};
assign tmp_41_fu_515_p4 = {{bitcast_ln29_1_fu_512_p1[62:52]}};
assign tmp_43_fu_587_p4 = {{bitcast_ln29_2_fu_584_p1[62:52]}};
assign tmp_44_fu_604_p4 = {{bitcast_ln29_3_fu_601_p1[62:52]}};
assign tmp_7_fu_406_p2 = transition_0_q1;
assign tmp_7_fu_406_p4 = transition_1_q1;
assign tmp_7_fu_406_p6 = transition_2_q1;
assign tmp_7_fu_406_p8 = transition_3_q1;
assign tmp_7_fu_406_p9 = 'bx;
assign tmp_s_fu_316_p3 = {{empty_9}, {lshr_ln7_1_fu_306_p4}};
...
assign zext_ln26_1_fu_438_p1 = lshr_ln8_4_fu_429_p4;
