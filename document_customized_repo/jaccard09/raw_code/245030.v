module atax_atax_Pipeline_label_0_label_1 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v124_address0,v124_ce0,v124_q0,v124_1_address0,v124_1_ce0,v124_1_q0,v113_address0,v113_ce0,v113_q0,v113_address1,v113_ce1,v113_q1,v116_address0,v116_ce0,v116_we0,v116_d0,v116_q0,v116_address1,v116_ce1,v116_we1,v116_d1,v116_q1,grp_fu_114_p_din0,grp_fu_114_p_din1,grp_fu_114_p_opcode,grp_fu_114_p_dout0,grp_fu_114_p_ce,grp_fu_118_p_din0,grp_fu_118_p_din1,grp_fu_118_p_dout0,grp_fu_118_p_ce); 
...
wire   [11:0] tmp_2_fu_500_p4;
wire   [5:0] or_ln1_fu_513_p4;
wire   [5:0] or_ln2_fu_526_p3;
wire   [0:0] icmp_ln31_fu_548_p2;
wire   [31:0] v6_fu_541_p3;
wire   [11:0] tmp_4_fu_561_p5;
wire   [11:0] tmp_5_fu_575_p4;
wire   [5:0] or_ln3_fu_588_p4;
wire   [11:0] tmp_7_fu_611_p5;
wire   [11:0] tmp_9_fu_625_p6;
wire   [11:0] tmp_10_fu_646_p5;
wire   [11:0] tmp_11_fu_660_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_3_reg_897 <= {{select_ln26_fu_366_p3[5:2]}};
        tmp_6_reg_913 <= {{select_ln26_fu_366_p3[5:3]}};
        tmp_6_reg_913_pp0_iter1_reg <= tmp_6_reg_913;
        tmp_8_reg_931 <= select_ln26_fu_366_p3[32'd1];
        tmp_8_reg_931_pp0_iter1_reg <= tmp_8_reg_931;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        v47_reg_1163 <= grp_fu_118_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        v11_reg_1062 <= grp_fu_118_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        v17_reg_1077 <= grp_fu_118_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v23_reg_1092 <= grp_fu_118_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v29_reg_1107 <= grp_fu_118_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v35_reg_1122 <= grp_fu_118_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v36_reg_1188 <= grp_fu_114_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v41_reg_1142 <= grp_fu_118_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v42_reg_1193 <= grp_fu_114_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v48_reg_1198 <= grp_fu_114_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v53_reg_1178 <= grp_fu_118_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_114_p_din0 = grp_fu_286_p0;
assign grp_fu_114_p_din1 = grp_fu_286_p1;
assign grp_fu_114_p_opcode = 2'd0;
assign grp_fu_118_p_ce = 1'b1;
assign grp_fu_118_p_din0 = grp_fu_290_p0;
assign grp_fu_118_p_din1 = v3_reg_977;
...
assign or_ln1_fu_513_p4 = {{{tmp_3_reg_897}, {1'd1}}, {trunc_ln46_reg_905}};
assign or_ln2_fu_526_p3 = {{tmp_3_reg_897}, {2'd3}};
assign or_ln3_fu_588_p4 = {{{tmp_6_reg_913}, {1'd1}}, {trunc_ln60_reg_925}};
assign or_ln4_fu_722_p5 = {{{{tmp_6_reg_913_pp0_iter1_reg}, {1'd1}}, {tmp_8_reg_931_pp0_iter1_reg}}, {1'd1}};
assign or_ln5_fu_745_p4 = {{{tmp_6_reg_913_pp0_iter1_reg}, {2'd3}}, {trunc_ln46_reg_905_pp0_iter1_reg}};
assign or_ln6_fu_758_p3 = {{tmp_6_reg_913_pp0_iter1_reg}, {3'd7}};
assign or_ln_fu_415_p3 = {{tmp_s_fu_405_p4}, {1'd1}};
assign select_ln26_fu_366_p3 = ((tmp_1_fu_358_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_v49_load);
assign select_ln27_fu_374_p3 = ((tmp_1_fu_358_p3[0:0] == 1'b1) ? add_ln27_fu_352_p2 : ap_sig_allocacmp_v4_load);
assign tmp_10_fu_646_p5 = {{{{trunc_ln33_reg_859}, {tmp_6_reg_913}}, {2'd3}}, {trunc_ln46_reg_905}};
assign tmp_11_fu_660_p4 = {{{trunc_ln33_reg_859}, {tmp_6_reg_913}}, {3'd7}};
assign tmp_1_fu_358_p3 = ap_sig_allocacmp_v49_load[32'd6];
assign tmp_2_fu_500_p4 = {{{trunc_ln33_reg_859}, {tmp_s_reg_886}}, {1'd1}};
assign tmp_4_fu_561_p5 = {{{{trunc_ln33_reg_859}, {tmp_3_reg_897}}, {1'd1}}, {trunc_ln46_reg_905}};
assign tmp_5_fu_575_p4 = {{{trunc_ln33_reg_859}, {tmp_3_reg_897}}, {2'd3}};
assign tmp_7_fu_611_p5 = {{{{trunc_ln33_reg_859}, {tmp_6_reg_913}}, {1'd1}}, {trunc_ln60_reg_925}};
assign tmp_9_fu_625_p6 = {{{{{trunc_ln33_reg_859}, {tmp_6_reg_913}}, {1'd1}}, {tmp_8_reg_931}}, {1'd1}};
...
assign zext_ln40_fu_508_p1 = tmp_2_fu_500_p4;
assign zext_ln46_fu_521_p1 = or_ln1_fu_513_p4;
assign zext_ln47_fu_570_p1 = tmp_4_fu_561_p5;
assign zext_ln53_fu_533_p1 = or_ln2_fu_526_p3;
assign zext_ln54_fu_583_p1 = tmp_5_fu_575_p4;
assign zext_ln60_fu_596_p1 = or_ln3_fu_588_p4;
assign zext_ln61_fu_620_p1 = tmp_7_fu_611_p5;
assign zext_ln67_fu_732_p1 = or_ln4_fu_722_p5;
assign zext_ln68_fu_636_p1 = tmp_9_fu_625_p6;
assign zext_ln74_fu_753_p1 = or_ln5_fu_745_p4;
assign zext_ln75_fu_655_p1 = tmp_10_fu_646_p5;
assign zext_ln82_fu_765_p1 = or_ln6_fu_758_p3;
assign zext_ln83_fu_668_p1 = tmp_11_fu_660_p4;
always @ (posedge ap_clk) begin
