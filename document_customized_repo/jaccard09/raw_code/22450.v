module aes256_encrypt_ecb_aes256_encrypt_ecb_Pipeline_addkey (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buf_1_address0,buf_1_ce0,buf_1_we0,buf_1_d0,buf_1_address1,buf_1_ce1,buf_1_q1,buf_0_address0,buf_0_ce0,buf_0_we0,buf_0_d0,buf_0_address1,buf_0_ce1,buf_0_q1,ctx_ret1); 
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln66_s_reg_193 <= {{add_ln66_fu_108_p2[3:1]}};
...
assign add_ln66_fu_108_p2 = ($signed(ap_sig_allocacmp_i_9) + $signed(5'd31));
...
assign icmp_ln66_fu_98_p2 = ((ap_sig_allocacmp_i_9 == 5'd0) ? 1'b1 : 1'b0);
assign lshr_ln66_fu_149_p2 = ctx_ret1 >> zext_ln66_fu_145_p1;
...
assign trunc_ln66_fu_104_p1 = ap_sig_allocacmp_i_9[0:0];
assign xor_ln66_fu_165_p2 = (trunc_ln66_2_reg_203 ^ select_ln66_fu_158_p3);
assign zext_ln66_1_fu_133_p1 = lshr_ln66_s_reg_193;
