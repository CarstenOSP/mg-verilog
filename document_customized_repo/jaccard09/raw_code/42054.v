module bfs (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,nodes_address0,nodes_ce0,nodes_q0,edges_address0,edges_ce0,edges_q0,starting_node,level_address0,level_ce0,level_we0,level_d0,level_q0,level_counts_address0,level_counts_ce0,level_counts_we0,level_counts_d0,level_counts_q0); 
...
wire   [63:0] e_fu_283_p1;
reg   [63:0] e_reg_348;
wire    ap_CS_fsm_state4;
reg   [63:0] tmp_end_reg_353;
...
wire   [0:0] icmp_ln33_1_fu_253_p2;
wire   [0:0] and_ln33_fu_237_p2;
wire   [63:0] zext_ln18_fu_278_p1;
reg   [7:0] q_out_fu_72;
wire   [7:0] q_out_1_fu_262_p2;
reg   [8:0] dummy_fu_76;
...
wire   [0:0] icmp_ln33_3_fu_231_p2;
wire   [8:0] zext_ln32_1_fu_215_p1;
wire   [8:0] add_ln33_fu_243_p2;
wire   [63:0] zext_ln33_fu_249_p1;
reg   [4:0] ap_NS_fsm;
...
bfs_bfs_Pipeline_loop_neighbors grp_bfs_Pipeline_loop_neighbors_fu_154(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_bfs_Pipeline_loop_neighbors_fu_154_ap_start),.ap_done(grp_bfs_Pipeline_loop_neighbors_fu_154_ap_done),.ap_idle(grp_bfs_Pipeline_loop_neighbors_fu_154_ap_idle),.ap_ready(grp_bfs_Pipeline_loop_neighbors_fu_154_ap_ready),.empty(e_reg_348),.level_address0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_address0),.level_ce0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_ce0),.level_we0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_we0),.level_d0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_d0),.level_q0(level_q0),.zext_ln18(n_reg_338),.tmp_end(tmp_end_reg_353),.edges_address0(grp_bfs_Pipeline_loop_neighbors_fu_154_edges_address0),.edges_ce0(grp_bfs_Pipeline_loop_neighbors_fu_154_edges_ce0),.edges_q0(edges_q0),.level_counts_address0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_counts_address0),.level_counts_ce0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_counts_ce0),.level_counts_we0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_counts_we0),.level_counts_d0(grp_bfs_Pipeline_loop_neighbors_fu_154_level_counts_d0),.level_counts_q0(level_counts_q0),.queue_address0(grp_bfs_Pipeline_loop_neighbors_fu_154_queue_address0),.queue_ce0(grp_bfs_Pipeline_loop_neighbors_fu_154_queue_ce0),.queue_we0(grp_bfs_Pipeline_loop_neighbors_fu_154_queue_we0),.queue_d0(grp_bfs_Pipeline_loop_neighbors_fu_154_queue_d0),.q_in_2_out_i(q_in_fu_68),.q_in_2_out_o(grp_bfs_Pipeline_loop_neighbors_fu_154_q_in_2_out_o),.q_in_2_out_o_ap_vld(grp_bfs_Pipeline_loop_neighbors_fu_154_q_in_2_out_o_ap_vld));
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        dummy_fu_76 <= 9'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (((icmp_ln33_fu_219_p2 == 1'd0) & (1'd0 == and_ln33_fu_237_p2) & (icmp_ln32_fu_192_p2 == 1'd0)) | ((icmp_ln33_1_fu_253_p2 == 1'd0) & (icmp_ln33_fu_219_p2 == 1'd1) & (icmp_ln32_fu_192_p2 == 1'd0))))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        q_out_fu_72 <= q_out_1_fu_262_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        e_reg_348 <= e_fu_283_p1;
        tmp_end_reg_353 <= {{nodes_q0[127:64]}};
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ((icmp_ln32_fu_192_p2 == 1'd1) | (((1'd1 == and_ln33_fu_237_p2) & (icmp_ln33_fu_219_p2 == 1'd0)) | ((icmp_ln33_1_fu_253_p2 == 1'd1) & (icmp_ln33_fu_219_p2 == 1'd1)))))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        queue_address0_local = zext_ln32_fu_210_p1;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((grp_bfs_Pipeline_loop_neighbors_fu_154_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end
...
assign add_ln33_fu_243_p2 = (zext_ln32_1_fu_215_p1 + 9'd1);
assign and_ln33_fu_237_p2 = (icmp_ln33_3_fu_231_p2 & icmp_ln33_2_fu_225_p2);
...
assign e_fu_283_p1 = nodes_q0[63:0];
...
assign icmp_ln33_1_fu_253_p2 = ((q_in_fu_68 == zext_ln33_fu_249_p1) ? 1'b1 : 1'b0);
assign icmp_ln33_2_fu_225_p2 = ((q_in_fu_68 == 64'd0) ? 1'b1 : 1'b0);
assign icmp_ln33_3_fu_231_p2 = ((q_out_fu_72 == 8'd255) ? 1'b1 : 1'b0);
assign icmp_ln33_fu_219_p2 = ((q_in_fu_68 > zext_ln32_fu_210_p1) ? 1'b1 : 1'b0);
assign nodes_address0 = zext_ln18_fu_278_p1;
assign nodes_ce0 = nodes_ce0_local;
assign q_out_1_fu_262_p2 = (q_out_fu_72 + 8'd1);
assign trunc_ln14_fu_169_p1 = starting_node[7:0];
assign zext_ln18_fu_278_p1 = queue_q0;
assign zext_ln32_1_fu_215_p1 = q_out_fu_72;
assign zext_ln32_fu_210_p1 = q_out_fu_72;
assign zext_ln33_fu_249_p1 = add_ln33_fu_243_p2;
endmodule 