...
reg   [12:0] indvar_flatten28_fu_58;
...
wire   [4:0] lshr_ln5_2_fu_211_p4;
wire   [10:0] tmp_5_fu_221_p3;
reg    ap_done_reg;
...
#0 j_fu_50 = 7'd0;
#0 i_fu_54 = 7'd0;
#0 indvar_flatten28_fu_58 = 13'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln29_fu_152_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten28_fu_58 <= add_ln29_1_fu_158_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten28_fu_58 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_340 <= grp_fu_164_p_dout0;
        ...
        mul1_reg_330 <= grp_fu_168_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten28_load = indvar_flatten28_fu_58;
    end
end
always @ (*) begin
...
assign add_ln29_1_fu_158_p2 = (ap_sig_allocacmp_indvar_flatten28_load + 13'd1);
...
assign grp_fu_164_p_din0 = select_ln32_1_reg_335;
assign grp_fu_164_p_din1 = mul1_reg_330;
assign grp_fu_164_p_opcode = 2'd0;
assign grp_fu_168_p_ce = 1'b1;
assign grp_fu_168_p_din0 = select_ln32_reg_325;
assign grp_fu_168_p_din1 = beta;
assign icmp_ln29_fu_152_p2 = ((ap_sig_allocacmp_indvar_flatten28_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln30_fu_181_p2 = ((j_fu_50 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_211_p4 = {{select_ln5_fu_187_p3[5:1]}};
