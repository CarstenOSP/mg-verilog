module backprop_backprop_Pipeline_VITIS_LOOP_18_12 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_22652,mux_case_12548,mux_case_02444,activations3_i,activations3_o,activations3_o_ap_vld,activations3_2_i,activations3_2_o,activations3_2_o_ap_vld,activations3_1_i,activations3_1_o,activations3_1_o_ap_vld,mux_case_22650_out,mux_case_22650_out_ap_vld,mux_case_12546_out,mux_case_12546_out_ap_vld,mux_case_02442_out,mux_case_02442_out_ap_vld,grp_fu_2842_p_din0,grp_fu_2842_p_din1,grp_fu_2842_p_opcode,grp_fu_2842_p_dout0,grp_fu_2842_p_ce,grp_fu_2846_p_din0,grp_fu_2846_p_din1,grp_fu_2846_p_opcode,grp_fu_2846_p_dout0,grp_fu_2846_p_ce,grp_fu_2874_p_din0,grp_fu_2874_p_din1,grp_fu_2874_p_dout0,grp_fu_2874_p_ce,grp_fu_3014_p_din0,grp_fu_3014_p_din1,grp_fu_3014_p_dout0,grp_fu_3014_p_ce,grp_fu_3018_p_din0,grp_fu_3018_p_din1,grp_fu_3018_p_dout0,grp_fu_3018_p_ce); 
...
sparsemux_7_2_64_1_1_U278(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_2_fu_222_p7),.sel(ap_sig_allocacmp_i_15),.dout(tmp_2_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_i2_reg_378 <= grp_fu_2846_p_dout0;
        ...
        dactivations3_reg_366 <= grp_fu_2874_p_dout0;
        ...
        sub_i1_reg_361 <= grp_fu_2842_p_dout0;
        ...
        tmp_3_reg_373 <= grp_fu_3018_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((i_15_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_1_o = grp_fu_3014_p_dout0;
    end else begin
...
always @ (*) begin
    if ((~(i_15_reg_332_pp0_iter87_reg == 2'd0) & ~(i_15_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_2_o = grp_fu_3014_p_dout0;
    end else begin
...
always @ (*) begin
    if (((i_15_reg_332_pp0_iter87_reg == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_o = grp_fu_3014_p_dout0;
    end else begin
...
assign grp_fu_2842_p_din0 = 64'd4607182418800017408;
assign grp_fu_2842_p_din1 = tmp_2_reg_340;
assign grp_fu_2842_p_opcode = 2'd1;
assign grp_fu_2846_p_ce = 1'b1;
assign grp_fu_2846_p_din0 = tmp_3_reg_373;
assign grp_fu_2846_p_din1 = 64'd4607182418800017408;
assign grp_fu_2846_p_opcode = 2'd0;
assign grp_fu_2874_p_ce = 1'b1;
assign grp_fu_2874_p_din0 = tmp_2_reg_340_pp0_iter8_reg;
assign grp_fu_2874_p_din1 = sub_i1_reg_361;
assign grp_fu_3014_p_ce = 1'b1;
assign grp_fu_3014_p_din0 = 64'd4607182418800017408;
assign grp_fu_3014_p_din1 = add_i2_reg_378;
assign grp_fu_3018_p_ce = 1'b1;
assign grp_fu_3018_p_din0 = 64'd0;
assign grp_fu_3018_p_din1 = bitcast_ln20_1_fu_275_p1;
