module backprop_backprop_Pipeline_label_13 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_253123,mux_case_152119,mux_case_051115,v18_i,v18_o,v18_o_ap_vld,v18_2_i,v18_2_o,v18_2_o_ap_vld,v18_1_i,v18_1_o,v18_1_o_ap_vld,v107_3_out,v107_3_out_ap_vld,mux_case_152117_out,mux_case_152117_out_ap_vld,v107_out,v107_out_ap_vld,grp_fu_2385_p_din0,grp_fu_2385_p_din1,grp_fu_2385_p_opcode,grp_fu_2385_p_dout0,grp_fu_2385_p_ce,grp_fu_2389_p_din0,grp_fu_2389_p_din1,grp_fu_2389_p_opcode,grp_fu_2389_p_dout0,grp_fu_2389_p_ce,grp_fu_2397_p_din0,grp_fu_2397_p_din1,grp_fu_2397_p_dout0,grp_fu_2397_p_ce,grp_fu_5055_p_din0,grp_fu_5055_p_din1,grp_fu_5055_p_dout0,grp_fu_5055_p_ce,grp_fu_5059_p_din0,grp_fu_5059_p_din1,grp_fu_5059_p_dout0,grp_fu_5059_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_253123;
input  [63:0] mux_case_152119;
input  [63:0] mux_case_051115;
input  [63:0] v18_i;
output  [63:0] v18_o;
output   v18_o_ap_vld;
input  [63:0] v18_2_i;
...
output  [63:0] mux_case_152117_out;
output   mux_case_152117_out_ap_vld;
...
output  [0:0] grp_fu_2389_p_opcode;
...
output  [63:0] grp_fu_5055_p_din0;
output  [63:0] grp_fu_5055_p_din1;
input  [63:0] grp_fu_5055_p_dout0;
output   grp_fu_5055_p_ce;
output  [63:0] grp_fu_5059_p_din0;
output  [63:0] grp_fu_5059_p_din1;
input  [63:0] grp_fu_5059_p_dout0;
...
reg mux_case_152117_out_ap_vld;
reg v107_out_ap_vld;
...
reg   [63:0] mux_case_152117_fu_74;
...
#0 v72_fu_66 = 2'd0;
#0 v107_fu_70 = 64'd0;
#0 mux_case_152117_fu_74 = 64'd0;
#0 v107_3_fu_78 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U157(.din0(v18_i),.din1(v18_1_i),.din2(v18_2_i),.def(v73_fu_222_p7),.sel(ap_sig_allocacmp_v72_1),.dout(v73_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v74_reg_361 <= grp_fu_2385_p_dout0;
        v75_reg_366 <= grp_fu_2397_p_dout0;
        v77_reg_373 <= grp_fu_5059_p_dout0;
        v78_reg_378 <= grp_fu_2389_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        mux_case_152117_out_ap_vld = 1'b1;
    end else begin
        mux_case_152117_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
...
assign grp_fu_2385_p_din0 = 64'd4607182418800017408;
assign grp_fu_2385_p_din1 = v73_reg_340;
assign grp_fu_2385_p_opcode = 2'd1;
assign grp_fu_2389_p_ce = 1'b1;
assign grp_fu_2389_p_din0 = v77_reg_373;
assign grp_fu_2389_p_din1 = 64'd4607182418800017408;
assign grp_fu_2389_p_opcode = 2'd0;
assign grp_fu_2397_p_ce = 1'b1;
assign grp_fu_2397_p_din0 = v73_reg_340_pp0_iter8_reg;
assign grp_fu_2397_p_din1 = v74_reg_361;
assign grp_fu_5055_p_ce = 1'b1;
assign grp_fu_5055_p_din0 = 64'd4607182418800017408;
assign grp_fu_5055_p_din1 = v78_reg_378;
assign grp_fu_5059_p_ce = 1'b1;
assign grp_fu_5059_p_din0 = 64'd0;
assign grp_fu_5059_p_din1 = v76_fu_275_p1;
assign icmp_ln139_fu_210_p2 = ((ap_sig_allocacmp_v72_1 == 2'd3) ? 1'b1 : 1'b0);
assign mux_case_152117_out = mux_case_152117_fu_74;
