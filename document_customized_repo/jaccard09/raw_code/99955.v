...
wire   [5:0] trunc_ln5_fu_471_p1;
reg   [5:0] trunc_ln5_reg_600;
reg   [5:0] trunc_ln5_reg_600_pp0_iter2_reg;
reg   [5:0] trunc_ln5_reg_600_pp0_iter3_reg;
reg   [5:0] trunc_ln5_reg_600_pp0_iter4_reg;
...
fadd_32ns_32ns_32_7_full_dsp_1_U33(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_1_load_reg_783),.din1(mul74_1_reg_748),.ce(1'b1),.dout(grp_fu_340_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U34(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_2_load_reg_788),.din1(mul74_2_reg_753),.ce(1'b1),.dout(grp_fu_344_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U35(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_3_load_reg_793),.din1(mul74_3_reg_758),.ce(1'b1),.dout(grp_fu_348_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U36(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_4_load_reg_798),.din1(mul74_4_reg_763),.ce(1'b1),.dout(grp_fu_352_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U37(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_5_load_reg_803),.din1(mul74_5_reg_768),.ce(1'b1),.dout(grp_fu_356_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U38(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_6_load_reg_808),.din1(mul74_6_reg_773),.ce(1'b1),.dout(grp_fu_360_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U39(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_7_load_reg_813),.din1(mul74_7_reg_778),.ce(1'b1),.dout(grp_fu_364_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U41(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_1_load_reg_655),.din1(beta),.ce(1'b1),.dout(grp_fu_372_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U42(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_2_load_reg_660),.din1(beta),.ce(1'b1),.dout(grp_fu_376_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U43(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_3_load_reg_665),.din1(beta),.ce(1'b1),.dout(grp_fu_380_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U44(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_load_1_reg_670),.din1(beta),.ce(1'b1),.dout(grp_fu_384_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U45(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_1_load_1_reg_675),.din1(beta),.ce(1'b1),.dout(grp_fu_388_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U46(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_2_load_1_reg_680),.din1(beta),.ce(1'b1),.dout(grp_fu_392_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U47(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_3_load_1_reg_685),.din1(beta),.ce(1'b1),.dout(grp_fu_396_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_818 <= grp_fu_206_p_dout0;
        ...
        mul1_reg_738 <= grp_fu_210_p_dout0;
        ...
        trunc_ln5_reg_600_pp0_iter2_reg <= trunc_ln5_reg_600;
        trunc_ln5_reg_600_pp0_iter3_reg <= trunc_ln5_reg_600_pp0_iter2_reg;
        trunc_ln5_reg_600_pp0_iter4_reg <= trunc_ln5_reg_600_pp0_iter3_reg;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln5_reg_600 <= trunc_ln5_fu_471_p1;
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_206_p_din0 = buff_C_out_load_reg_743;
assign grp_fu_206_p_din1 = mul1_reg_738;
assign grp_fu_206_p_opcode = 2'd0;
assign grp_fu_210_p_ce = 1'b1;
assign grp_fu_210_p_din0 = buff_B_load_reg_650;
...
assign tmp_8_fu_545_p3 = {{trunc_ln5_reg_600_pp0_iter4_reg}, {lshr_ln5_3_reg_605_pp0_iter4_reg}};
assign tmp_9_fu_495_p3 = {{trunc_ln5_fu_471_p1}, {lshr_ln5_4_fu_485_p4}};
assign tmp_fu_447_p3 = j_fu_82[32'd6];
assign tmp_s_fu_511_p4 = {{{trunc_ln5_fu_471_p1}, {lshr_ln5_3_fu_475_p4}}, {1'd1}};
assign trunc_ln5_fu_471_p1 = select_ln29_fu_463_p3[5:0];
