...
wire   [4:0] lshr_ln6_5_fu_310_p4;
reg   [4:0] lshr_ln6_5_reg_517;
wire   [3:0] tmp_1_fu_326_p4;
reg   [3:0] tmp_1_reg_532;
wire   [0:0] trunc_ln31_fu_375_p1;
reg   [0:0] trunc_ln31_reg_547;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [0:0] trunc_ln31_reg_547_pp0_iter1_reg;
reg   [4:0] tmp2_addr_reg_552;
reg   [4:0] tmp2_addr_reg_552_pp0_iter1_reg;
reg   [4:0] tmp2_1_addr_reg_557;
reg   [4:0] tmp2_1_addr_reg_557_pp0_iter1_reg;
reg   [31:0] buff_x_load_reg_572;
reg   [31:0] buff_x_1_load_reg_577;
reg   [31:0] buff_x_load_1_reg_592;
reg   [31:0] buff_x_1_load_1_reg_597;
wire   [31:0] select_ln33_fu_428_p3;
reg   [31:0] select_ln33_reg_602;
reg   [31:0] buff_B_load_reg_607;
reg   [31:0] buff_B_1_load_reg_612;
reg   [31:0] buff_B_load_1_reg_617;
reg   [31:0] buff_B_1_load_1_reg_622;
...
wire   [63:0] zext_ln33_2_fu_417_p1;
reg   [6:0] j_1_fu_68;
wire   [6:0] add_ln32_fu_443_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_1_load;
reg   [6:0] i_2_fu_72;
wire   [6:0] select_ln31_fu_364_p3;
reg   [10:0] indvar_flatten_fu_76;
wire   [10:0] add_ln31_1_fu_279_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten_load;
reg   [31:0] add6815_fu_80;
...
wire   [6:0] add_ln31_fu_358_p2;
wire   [4:0] lshr_ln6_2_fu_379_p4;
wire   [5:0] empty_fu_371_p1;
wire   [10:0] tmp_s_fu_395_p3;
...
#0 add6815_fu_80 = 32'd0;
#0 ap_done_reg = 1'b0;
end
gesummv_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U177(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_216_p0),.din1(grp_fu_216_p1),.ce(1'b1),.dout(grp_fu_216_p2));
gesummv_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U178(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_220_p0),.din1(grp_fu_220_p1),.ce(1'b1),.dout(grp_fu_220_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_770)) begin
            add6815_fu_80 <= select_ln33_reg_602;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add6815_fu_80 <= reg_248;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_2_fu_72 <= 7'd0;
    end else if (((icmp_ln31_reg_499 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_2_fu_72 <= select_ln31_fu_364_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_273_p2 == 1'd0))) begin
            indvar_flatten_fu_76 <= add_ln31_1_fu_279_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_1_fu_68 <= 7'd0;
    end else if (((icmp_ln31_reg_499 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_1_fu_68 <= add_ln32_fu_443_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        buff_B_1_load_1_reg_622 <= buff_B_1_q0;
        buff_B_1_load_reg_612 <= buff_B_1_q1;
        buff_B_load_1_reg_617 <= buff_B_q0;
        buff_B_load_reg_607 <= buff_B_q1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln31_reg_499 <= icmp_ln31_fu_273_p2;
        lshr_ln6_5_reg_517 <= {{select_ln6_fu_296_p3[5:1]}};
        select_ln6_reg_508 <= select_ln6_fu_296_p3;
        tmp_1_reg_532 <= {{select_ln6_fu_296_p3[5:2]}};
        tmp_reg_503 <= ap_sig_allocacmp_j_1_load[32'd6];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage24_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage24)) | ((1'b0 == ap_block_pp0_stage17_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17)) | ((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9)))) begin
        reg_248 <= grp_fu_216_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        select_ln33_reg_602 <= select_ln33_fu_428_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_1_addr_reg_557 <= zext_ln6_fu_389_p1;
        tmp2_1_addr_reg_557_pp0_iter1_reg <= tmp2_1_addr_reg_557;
        tmp2_addr_reg_552 <= zext_ln6_fu_389_p1;
        tmp2_addr_reg_552_pp0_iter1_reg <= tmp2_addr_reg_552;
        trunc_ln31_reg_547 <= trunc_ln31_fu_375_p1;
        trunc_ln31_reg_547_pp0_iter1_reg <= trunc_ln31_reg_547;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_3_reg_632 <= add_ln32_fu_443_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln31_reg_499 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage10) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
            ...
            grp_fu_220_p0 = buff_B_1_load_1_reg_622;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_220_p0 = buff_B_load_1_reg_617;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_220_p0 = buff_B_1_load_reg_612;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_220_p0 = buff_B_load_reg_607;
        end else begin
            grp_fu_220_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_1_address0_local = tmp2_1_addr_reg_557_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_1_address0_local = zext_ln6_fu_389_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_3_reg_632 == 1'd1) & (trunc_ln31_reg_547_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_address0_local = tmp2_addr_reg_552_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_address0_local = zext_ln6_fu_389_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_3_reg_632 == 1'd1) & (trunc_ln31_reg_547_pp0_iter1_reg == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_we0_local = 1'b1;
    end else begin
        tmp2_we0_local = 1'b0;
    end
...
assign add_ln31_1_fu_279_p2 = (ap_sig_allocacmp_indvar_flatten_load + 11'd1);
assign add_ln31_fu_358_p2 = (i_2_fu_72 + 7'd1);
assign add_ln32_fu_443_p2 = (select_ln6_reg_508 + 7'd4);
...
always @ (*) begin
    ap_condition_770 = ((icmp_ln31_reg_499 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_0_reg_513 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_B_1_address0 = zext_ln33_2_fu_417_p1;
assign buff_B_1_address1 = zext_ln33_1_fu_402_p1;
assign buff_B_1_ce0 = buff_B_1_ce0_local;
assign buff_B_1_ce1 = buff_B_1_ce1_local;
assign buff_B_address0 = zext_ln33_2_fu_417_p1;
assign buff_B_address1 = zext_ln33_1_fu_402_p1;
assign buff_B_ce0 = buff_B_ce0_local;
assign buff_B_ce1 = buff_B_ce1_local;
assign buff_x_1_address0 = zext_ln33_fu_344_p1;
...
assign buff_x_address0 = zext_ln33_fu_344_p1;
assign buff_x_address1 = zext_ln6_1_fu_320_p1;
assign buff_x_ce0 = buff_x_ce0_local;
assign buff_x_ce1 = buff_x_ce1_local;
assign empty_fu_371_p1 = select_ln31_fu_364_p3[5:0];
assign first_iter_0_fu_304_p2 = ((select_ln6_fu_296_p3 == 7'd0) ? 1'b1 : 1'b0);
assign icmp_ln31_fu_273_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln6_2_fu_379_p4 = {{select_ln31_fu_364_p3[5:1]}};
assign lshr_ln6_5_fu_310_p4 = {{select_ln6_fu_296_p3[5:1]}};
assign or_ln_fu_336_p3 = {{tmp_1_fu_326_p4}, {1'd1}};
assign select_ln31_fu_364_p3 = ((tmp_reg_503[0:0] == 1'b1) ? add_ln31_fu_358_p2 : i_2_fu_72);
assign select_ln33_fu_428_p3 = ((trunc_ln31_reg_547[0:0] == 1'b1) ? tmp2_1_q0 : tmp2_q0);
assign select_ln6_fu_296_p3 = ((tmp_fu_288_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_1_load);
assign tmp2_1_address0 = tmp2_1_address0_local;
assign tmp2_1_ce0 = tmp2_1_ce0_local;
assign tmp2_1_d0 = reg_248;
assign tmp2_1_we0 = tmp2_1_we0_local;
assign tmp2_address0 = tmp2_address0_local;
assign tmp2_ce0 = tmp2_ce0_local;
assign tmp2_d0 = reg_248;
...
assign tmp_fu_288_p3 = ap_sig_allocacmp_j_1_load[32'd6];
assign tmp_s_fu_395_p3 = {{empty_fu_371_p1}, {lshr_ln6_5_reg_517}};
assign trunc_ln31_fu_375_p1 = select_ln31_fu_364_p3[0:0];
assign zext_ln33_1_fu_402_p1 = tmp_s_fu_395_p3;
assign zext_ln33_2_fu_417_p1 = tmp_2_fu_408_p4;
assign zext_ln33_fu_344_p1 = or_ln_fu_336_p3;
assign zext_ln6_1_fu_320_p1 = lshr_ln6_5_fu_310_p4;
assign zext_ln6_fu_389_p1 = lshr_ln6_2_fu_379_p4;
endmodule 