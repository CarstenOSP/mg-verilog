...
reg   [63:0] zext_ln45_reg_316_pp0_iter9_reg;
reg   [63:0] zext_ln45_reg_316_pp0_iter10_reg;
reg   [63:0] zext_ln45_reg_316_pp0_iter11_reg;
reg   [63:0] zext_ln45_reg_316_pp0_iter12_reg;
reg   [63:0] zext_ln45_reg_316_pp0_iter13_reg;
reg   [31:0] buff_D_load_reg_334;
reg   [31:0] buff_D_1_load_reg_339;
reg   [31:0] mux_case_041_reg_354;
...
reg   [6:0] j_fu_58;
wire   [6:0] add_ln44_fu_269_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_62;
wire   [6:0] select_ln43_fu_233_p3;
reg   [11:0] indvar_flatten35_fu_66;
...
wire   [6:0] add_ln43_fu_211_p2;
wire   [6:0] select_ln6_fu_225_p3;
wire   [5:0] trunc_ln6_fu_241_p1;
wire   [4:0] lshr_ln6_6_fu_245_p4;
wire   [10:0] tmp_s_fu_255_p3;
reg    ap_done_reg;
...
#0 j_fu_58 = 7'd0;
#0 i_fu_62 = 7'd0;
#0 indvar_flatten35_fu_66 = 12'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln43_fu_188_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten35_fu_66 <= add_ln43_1_fu_194_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten35_fu_66 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            j_fu_58 <= add_ln44_fu_269_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add127_1_reg_379 <= grp_fu_1162_p_dout0;
        add2_reg_374 <= grp_fu_1154_p_dout0;
        ...
        mul126_1_reg_369 <= grp_fu_1166_p_dout0;
        mul3_reg_359 <= grp_fu_1158_p_dout0;
        mux_case_041_reg_354 <= tmp2_q0;
        tmp2_1_load_reg_364 <= tmp2_1_q0;
        zext_ln45_reg_316_pp0_iter10_reg[10 : 0] <= zext_ln45_reg_316_pp0_iter9_reg[10 : 0];
        zext_ln45_reg_316_pp0_iter11_reg[10 : 0] <= zext_ln45_reg_316_pp0_iter10_reg[10 : 0];
        zext_ln45_reg_316_pp0_iter12_reg[10 : 0] <= zext_ln45_reg_316_pp0_iter11_reg[10 : 0];
        zext_ln45_reg_316_pp0_iter13_reg[10 : 0] <= zext_ln45_reg_316_pp0_iter12_reg[10 : 0];
        zext_ln45_reg_316_pp0_iter2_reg[10 : 0] <= zext_ln45_reg_316[10 : 0];
        ...
        zext_ln45_reg_316_pp0_iter9_reg[10 : 0] <= zext_ln45_reg_316_pp0_iter8_reg[10 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln45_reg_316[10 : 0] <= zext_ln45_fu_263_p1[10 : 0];
    end
end
always @ (*) begin
...
assign add_ln43_1_fu_194_p2 = (ap_sig_allocacmp_indvar_flatten35_load + 12'd1);
assign add_ln43_fu_211_p2 = (i_fu_62 + 7'd1);
assign add_ln44_fu_269_p2 = (select_ln6_fu_225_p3 + 7'd2);
...
assign buff_D_1_address0 = zext_ln45_fu_263_p1;
assign buff_D_1_ce0 = buff_D_1_ce0_local;
assign buff_D_address0 = zext_ln45_fu_263_p1;
assign buff_D_ce0 = buff_D_ce0_local;
assign buff_E_out_1_address0 = zext_ln45_reg_316_pp0_iter13_reg;
...
assign buff_E_out_address0 = zext_ln45_reg_316_pp0_iter13_reg;
...
assign grp_fu_1154_p_din0 = mux_case_041_reg_354;
assign grp_fu_1154_p_din1 = mul3_reg_359;
assign grp_fu_1154_p_opcode = 2'd0;
assign grp_fu_1158_p_ce = 1'b1;
assign grp_fu_1158_p_din0 = buff_D_load_reg_334;
assign grp_fu_1158_p_din1 = beta;
assign grp_fu_1162_p_ce = 1'b1;
assign grp_fu_1162_p_din0 = tmp2_1_load_reg_364;
assign grp_fu_1162_p_din1 = mul126_1_reg_369;
assign grp_fu_1162_p_opcode = 2'd0;
assign grp_fu_1166_p_ce = 1'b1;
assign grp_fu_1166_p_din0 = buff_D_1_load_reg_339;
assign grp_fu_1166_p_din1 = beta;
assign icmp_ln43_fu_188_p2 = ((ap_sig_allocacmp_indvar_flatten35_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_6_fu_245_p4 = {{select_ln6_fu_225_p3[5:1]}};
assign select_ln43_fu_233_p3 = ((tmp_fu_217_p3[0:0] == 1'b1) ? add_ln43_fu_211_p2 : i_fu_62);
assign select_ln6_fu_225_p3 = ((tmp_fu_217_p3[0:0] == 1'b1) ? 7'd0 : j_fu_58);
assign tmp2_1_address0 = zext_ln45_reg_316_pp0_iter4_reg;
assign tmp2_1_ce0 = tmp2_1_ce0_local;
assign tmp2_address0 = zext_ln45_reg_316_pp0_iter4_reg;
assign tmp2_ce0 = tmp2_ce0_local;
assign tmp_fu_217_p3 = j_fu_58[32'd6];
assign tmp_s_fu_255_p3 = {{trunc_ln6_fu_241_p1}, {lshr_ln6_6_fu_245_p4}};
assign trunc_ln6_fu_241_p1 = select_ln43_fu_233_p3[5:0];
assign zext_ln45_fu_263_p1 = tmp_s_fu_255_p3;
always @ (posedge ap_clk) begin
    ...
    zext_ln45_reg_316_pp0_iter9_reg[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
    zext_ln45_reg_316_pp0_iter10_reg[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
    zext_ln45_reg_316_pp0_iter11_reg[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
    zext_ln45_reg_316_pp0_iter12_reg[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
    zext_ln45_reg_316_pp0_iter13_reg[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
end
endmodule 