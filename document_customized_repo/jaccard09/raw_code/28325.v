...
reg   [1:0] i_9_reg_743;
reg   [1:0] i_9_reg_743_pp0_iter1_reg;
reg   [1:0] i_9_reg_743_pp0_iter2_reg;
reg   [1:0] i_9_reg_743_pp0_iter3_reg;
reg   [1:0] i_9_reg_743_pp0_iter4_reg;
reg   [1:0] i_9_reg_743_pp0_iter5_reg;
reg   [1:0] i_9_reg_743_pp0_iter6_reg;
reg   [1:0] i_9_reg_743_pp0_iter7_reg;
reg   [1:0] i_9_reg_743_pp0_iter8_reg;
reg   [1:0] i_9_reg_743_pp0_iter9_reg;
reg   [1:0] i_9_reg_743_pp0_iter10_reg;
reg   [1:0] i_9_reg_743_pp0_iter11_reg;
reg   [1:0] i_9_reg_743_pp0_iter12_reg;
reg   [1:0] i_9_reg_743_pp0_iter13_reg;
reg   [1:0] i_9_reg_743_pp0_iter14_reg;
reg   [1:0] i_9_reg_743_pp0_iter15_reg;
reg   [1:0] i_9_reg_743_pp0_iter16_reg;
...
sparsemux_17_3_64_1_1_U308(.din0(tmp_s_fu_511_p2),.din1(tmp_s_fu_511_p4),.din2(tmp_s_fu_511_p6),.din3(tmp_s_fu_511_p8),.din4(tmp_s_fu_511_p10),.din5(tmp_s_fu_511_p12),.din6(tmp_s_fu_511_p14),.din7(tmp_s_fu_511_p16),.def(tmp_s_fu_511_p17),.sel(trunc_ln67_reg_753),.dout(tmp_s_fu_511_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U309(.din0(mux_case_08898_reload),.din1(mux_case_189102_reload),.din2(mux_case_291106_reload),.def(tmp_25_fu_550_p7),.sel(i_9_reg_743_pp0_iter1_reg),.dout(tmp_25_fu_550_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U310(.din0(mux_case_092110_reload),.din1(mux_case_193114_reload),.din2(mux_case_294118_reload),.def(tmp_26_fu_589_p7),.sel(i_9_reg_743_pp0_iter8_reg),.dout(tmp_26_fu_589_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_9_reg_743_pp0_iter16_reg == 2'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_9_reg_743_pp0_iter16_reg == 2'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_9_reg_743_pp0_iter10_reg <= i_9_reg_743_pp0_iter9_reg;
        i_9_reg_743_pp0_iter11_reg <= i_9_reg_743_pp0_iter10_reg;
        i_9_reg_743_pp0_iter12_reg <= i_9_reg_743_pp0_iter11_reg;
        i_9_reg_743_pp0_iter13_reg <= i_9_reg_743_pp0_iter12_reg;
        i_9_reg_743_pp0_iter14_reg <= i_9_reg_743_pp0_iter13_reg;
        i_9_reg_743_pp0_iter15_reg <= i_9_reg_743_pp0_iter14_reg;
        i_9_reg_743_pp0_iter16_reg <= i_9_reg_743_pp0_iter15_reg;
        i_9_reg_743_pp0_iter2_reg <= i_9_reg_743_pp0_iter1_reg;
        i_9_reg_743_pp0_iter3_reg <= i_9_reg_743_pp0_iter2_reg;
        i_9_reg_743_pp0_iter4_reg <= i_9_reg_743_pp0_iter3_reg;
        i_9_reg_743_pp0_iter5_reg <= i_9_reg_743_pp0_iter4_reg;
        i_9_reg_743_pp0_iter6_reg <= i_9_reg_743_pp0_iter5_reg;
        i_9_reg_743_pp0_iter7_reg <= i_9_reg_743_pp0_iter6_reg;
        i_9_reg_743_pp0_iter8_reg <= i_9_reg_743_pp0_iter7_reg;
        i_9_reg_743_pp0_iter9_reg <= i_9_reg_743_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_9_reg_743 <= ap_sig_allocacmp_i_9;
        i_9_reg_743_pp0_iter1_reg <= i_9_reg_743;
...
assign add_ln66_fu_432_p2 = (ap_sig_allocacmp_i_9 + 2'd1);
...
always @ (*) begin
    ap_condition_738 = (~(i_9_reg_743_pp0_iter16_reg == 2'd1) & ~(i_9_reg_743_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
...
assign icmp_ln66_fu_426_p2 = ((ap_sig_allocacmp_i_9 == 2'd3) ? 1'b1 : 1'b0);
...
assign zext_ln67_1_fu_462_p1 = lshr_ln7_fu_452_p4;
assign zext_ln67_fu_438_p1 = ap_sig_allocacmp_i_9;
endmodule 