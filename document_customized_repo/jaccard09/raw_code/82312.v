...
sparsemux_17_3_32_1_1_U30(.din0(b_0_q0),.din1(b_1_q0),.din2(b_2_q0),.din3(b_3_q0),.din4(b_4_q0),.din5(b_5_q0),.din6(b_6_q0),.din7(b_7_q0),.def(tmp_1_fu_466_p17),.sel(trunc_ln57_reg_660),.dout(tmp_1_fu_466_p19));
...
sparsemux_17_3_32_1_1_U31(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.din4(bucket_4_q0),.din5(bucket_5_q0),.din6(bucket_6_q0),.din7(bucket_7_q0),.def(tmp_2_fu_551_p17),.sel(empty_23_reg_655_pp0_iter1_reg),.dout(tmp_2_fu_551_p19));
...
assign ashr_ln57_fu_508_p2 = $signed(tmp_1_reg_705) >>> zext_ln50_cast_reg_624;
