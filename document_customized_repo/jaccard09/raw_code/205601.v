...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln1_reg_421 <= {{ap_sig_allocacmp_v8_9[9:7]}};
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln33_fu_255_p2 = (ap_sig_allocacmp_v8_9 + 11'd1);
assign add_ln_fu_297_p3 = {{tmp_fu_287_p4}, {ap_sig_allocacmp_v8_9}};
...
assign icmp_ln33_fu_249_p2 = ((ap_sig_allocacmp_v8_9 == 11'd1024) ? 1'b1 : 1'b0);
assign tmp_fu_287_p4 = {{v5[12:1]}};
assign trunc_ln33_fu_261_p1 = ap_sig_allocacmp_v8_9[6:0];
