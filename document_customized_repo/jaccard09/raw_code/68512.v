...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_373_min_s_2_out;
wire    grp_viterbi_Pipeline_L_end_fu_373_min_s_2_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_381_min_s_6_out;
wire    grp_viterbi_Pipeline_L_state_fu_381_min_s_6_out_ap_vld;
...
llike_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_address0),.ce0(llike_ce0),.we0(llike_we0),.d0(llike_d0),.q0(llike_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_343_llike_address1),.ce1(llike_ce1),.q1(llike_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 4480 ),.AddressWidth( 13 ))
llike_1_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_1_address0),.ce0(llike_1_ce0),.we0(llike_1_we0),.d0(llike_1_d0),.q0(llike_1_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_343_llike_1_address1),.ce1(llike_1_ce1),.q1(llike_1_q1));
...
viterbi_viterbi_Pipeline_L_end grp_viterbi_Pipeline_L_end_fu_373(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_viterbi_Pipeline_L_end_fu_373_ap_start),.ap_done(grp_viterbi_Pipeline_L_end_fu_373_ap_done),.ap_idle(grp_viterbi_Pipeline_L_end_fu_373_ap_idle),.ap_ready(grp_viterbi_Pipeline_L_end_fu_373_ap_ready),.min_p(reg_405),.llike_1_address0(grp_viterbi_Pipeline_L_end_fu_373_llike_1_address0),.llike_1_ce0(grp_viterbi_Pipeline_L_end_fu_373_llike_1_ce0),.llike_1_q0(llike_1_q0),.llike_address0(grp_viterbi_Pipeline_L_end_fu_373_llike_address0),.llike_ce0(grp_viterbi_Pipeline_L_end_fu_373_llike_ce0),.llike_q0(llike_q0),.min_s_2_out(grp_viterbi_Pipeline_L_end_fu_373_min_s_2_out),.min_s_2_out_ap_vld(grp_viterbi_Pipeline_L_end_fu_373_min_s_2_out_ap_vld),.grp_fu_733_p_din0(grp_viterbi_Pipeline_L_end_fu_373_grp_fu_733_p_din0),.grp_fu_733_p_din1(grp_viterbi_Pipeline_L_end_fu_373_grp_fu_733_p_din1),.grp_fu_733_p_opcode(grp_viterbi_Pipeline_L_end_fu_373_grp_fu_733_p_opcode),.grp_fu_733_p_dout0(grp_fu_733_p2),.grp_fu_733_p_ce(grp_viterbi_Pipeline_L_end_fu_373_grp_fu_733_p_ce));
viterbi_viterbi_Pipeline_L_state grp_viterbi_Pipeline_L_state_fu_381(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_viterbi_Pipeline_L_state_fu_381_ap_start),.ap_done(grp_viterbi_Pipeline_L_state_fu_381_ap_done),.ap_idle(grp_viterbi_Pipeline_L_state_fu_381_ap_idle),.ap_ready(grp_viterbi_Pipeline_L_state_fu_381_ap_ready),.min_p_139(min_p_138_reg_728),.t_1(trunc_ln50_reg_652),.llike_1_address0(grp_viterbi_Pipeline_L_state_fu_381_llike_1_address0),.llike_1_ce0(grp_viterbi_Pipeline_L_state_fu_381_llike_1_ce0),.llike_1_q0(llike_1_q0),.zext_ln52_2(lshr_ln52_1_reg_698),.transition_0_address0(grp_viterbi_Pipeline_L_state_fu_381_transition_0_address0),.transition_0_ce0(grp_viterbi_Pipeline_L_state_fu_381_transition_0_ce0),.transition_0_q0(transition_0_q0),.transition_1_address0(grp_viterbi_Pipeline_L_state_fu_381_transition_1_address0),.transition_1_ce0(grp_viterbi_Pipeline_L_state_fu_381_transition_1_ce0),.transition_1_q0(transition_1_q0),.transition_2_address0(grp_viterbi_Pipeline_L_state_fu_381_transition_2_address0),.transition_2_ce0(grp_viterbi_Pipeline_L_state_fu_381_transition_2_ce0),.transition_2_q0(transition_2_q0),.transition_3_address0(grp_viterbi_Pipeline_L_state_fu_381_transition_3_address0),.transition_3_ce0(grp_viterbi_Pipeline_L_state_fu_381_transition_3_ce0),.transition_3_q0(transition_3_q0),.empty(trunc_ln52_reg_692),.zext_ln52_3(tmp_s_reg_678),.llike_address0(grp_viterbi_Pipeline_L_state_fu_381_llike_address0),.llike_ce0(grp_viterbi_Pipeline_L_state_fu_381_llike_ce0),.llike_q0(llike_q0),.min_s_6_out(grp_viterbi_Pipeline_L_state_fu_381_min_s_6_out),.min_s_6_out_ap_vld(grp_viterbi_Pipeline_L_state_fu_381_min_s_6_out_ap_vld),.grp_fu_401_p_din0(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_401_p_din0),.grp_fu_401_p_din1(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_401_p_din1),.grp_fu_401_p_opcode(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_401_p_opcode),.grp_fu_401_p_dout0(grp_fu_401_p2),.grp_fu_401_p_ce(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_401_p_ce),.grp_fu_733_p_din0(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_733_p_din0),.grp_fu_733_p_din1(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_733_p_din1),.grp_fu_733_p_opcode(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_733_p_opcode),.grp_fu_733_p_dout0(grp_fu_733_p2),.grp_fu_733_p_ce(grp_viterbi_Pipeline_L_state_fu_381_grp_fu_733_p_ce));
viterbi_dadd_64ns_64ns_64_8_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 8 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dadd_64ns_64ns_64_8_full_dsp_1_U126(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_401_p0),.din1(grp_fu_401_p1),.ce(grp_fu_401_ce),.dout(grp_fu_401_p2));
...
sparsemux_9_2_8_1_1_x_U127(.din0(path_0_q0),.din1(path_1_q0),.din2(path_2_q0),.din3(path_3_q0),.def(tmp_67_fu_488_p9),.sel(tmp_67_fu_488_p10),.dout(tmp_67_fu_488_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U128(.din0(tmp_68_fu_550_p2),.din1(tmp_68_fu_550_p4),.din2(tmp_68_fu_550_p6),.din3(tmp_68_fu_550_p8),.def(tmp_68_fu_550_p9),.sel(trunc_ln52_reg_692),.dout(tmp_68_fu_550_p11));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U129(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_733_p0),.din1(grp_fu_733_p1),.ce(grp_fu_733_ce),.opcode(grp_fu_733_opcode),.dout(grp_fu_733_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state22)) begin
        min_p_138_reg_728 <= grp_fu_401_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_373_min_s_2_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state10))) begin
        min_s_2_loc_fu_128 <= grp_viterbi_Pipeline_L_end_fu_373_min_s_2_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_381_min_s_6_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state24))) begin
        min_s_6_loc_fu_124 <= grp_viterbi_Pipeline_L_state_fu_381_min_s_6_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        path_3_d0_local = min_s_6_loc_fu_124;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        path_3_d0_local = min_s_2_loc_fu_128;
    end else begin
        path_3_d0_local = 'bx;
    end
end
...
assign transition_0_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_343_transition_0_address1;
assign transition_1_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_343_transition_1_address1;
assign transition_2_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_343_transition_2_address1;
assign transition_3_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_343_transition_3_address1;
