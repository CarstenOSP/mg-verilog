...
input  [8:0] mul_ln168;
input  [63:0] empty_2038;
input  [63:0] empty_2039;
input  [63:0] empty_2040;
input  [63:0] empty_2041;
input  [63:0] empty_2042;
input  [63:0] empty_2043;
input  [63:0] empty_2044;
input  [63:0] empty_2045;
input  [63:0] empty_2046;
input  [63:0] empty_2047;
input  [63:0] empty_2048;
input  [63:0] empty_2049;
input  [63:0] empty_2050;
input  [63:0] empty_2051;
input  [63:0] empty_2052;
input  [63:0] empty_2053;
input  [63:0] empty_2054;
input  [63:0] empty_2055;
input  [63:0] empty_2056;
input  [63:0] empty_2057;
input  [63:0] empty_2058;
input  [63:0] empty_2059;
input  [63:0] empty_2060;
input  [63:0] empty_2061;
input  [63:0] empty_2062;
input  [63:0] empty_2063;
input  [63:0] empty_2064;
input  [63:0] empty_2065;
input  [63:0] empty_2066;
input  [63:0] empty_2067;
input  [63:0] empty_2068;
input  [63:0] empty_2069;
input  [63:0] empty_2070;
input  [63:0] empty_2071;
input  [63:0] empty_2072;
input  [63:0] empty_2073;
input  [63:0] empty_2074;
input  [63:0] empty_2075;
input  [63:0] empty_2076;
input  [63:0] empty_2077;
input  [63:0] empty_2078;
input  [63:0] empty_2079;
input  [63:0] empty_2080;
input  [63:0] empty_2081;
input  [63:0] empty_2082;
input  [63:0] empty_2083;
input  [63:0] empty_2084;
input  [63:0] empty_2085;
input  [63:0] empty_2086;
input  [63:0] empty_2087;
input  [63:0] empty_2088;
input  [63:0] empty_2089;
input  [63:0] empty_2090;
input  [63:0] empty_2091;
input  [63:0] empty_2092;
input  [63:0] empty_2093;
input  [63:0] empty_2094;
input  [63:0] empty_2095;
input  [63:0] empty_2096;
input  [63:0] empty_2097;
input  [63:0] empty_2098;
input  [63:0] empty_2099;
input  [63:0] empty_2100;
input  [63:0] empty_2101;
input  [63:0] empty_2102;
input  [63:0] empty_2103;
input  [63:0] empty_2104;
input  [63:0] empty_2105;
input  [63:0] empty_2106;
input  [63:0] empty_2107;
input  [63:0] empty_2108;
input  [63:0] empty_2109;
input  [63:0] empty_2110;
input  [63:0] empty_2111;
input  [63:0] empty_2112;
input  [63:0] empty_2113;
input  [63:0] empty_2114;
input  [63:0] empty_2115;
input  [63:0] empty_2116;
input  [63:0] empty_2117;
input  [63:0] empty_2118;
input  [63:0] empty_2119;
input  [63:0] empty_2120;
input  [63:0] empty_2121;
input  [63:0] empty_2122;
input  [63:0] empty_2123;
input  [63:0] empty_2124;
input  [63:0] empty_2125;
input  [63:0] empty_2126;
input  [63:0] empty_2127;
input  [63:0] empty_2128;
input  [63:0] empty_2129;
input  [63:0] empty_2130;
input  [63:0] empty_2131;
input  [63:0] empty_2132;
input  [63:0] empty_2133;
input  [63:0] empty_2134;
input  [63:0] empty_2135;
input  [63:0] empty_2136;
input  [63:0] empty_2137;
input  [63:0] empty_2138;
input  [63:0] empty_2139;
input  [63:0] empty_2140;
input  [63:0] empty_2141;
input  [63:0] empty_2142;
input  [63:0] empty_2143;
input  [63:0] empty_2144;
input  [63:0] empty_2145;
input  [63:0] empty_2146;
input  [63:0] empty_2147;
input  [63:0] empty_2148;
input  [63:0] empty_2149;
input  [63:0] empty_2150;
...
sparsemux_979_9_64_1_1_U1141(.din0(empty_2038),.din1(empty_2039),.din2(empty_2040),.din3(empty_2041),.din4(empty_2042),.din5(empty_2043),.din6(empty_2044),.din7(empty_2045),.din8(empty_2046),.din9(empty_2047),.din10(empty_2048),.din11(empty_2049),.din12(empty_2050),.din13(empty_2051),.din14(empty_2052),.din15(empty_2053),.din16(empty_2054),.din17(empty_2055),.din18(empty_2056),.din19(empty_2057),.din20(empty_2058),.din21(empty_2059),.din22(empty_2060),.din23(empty_2061),.din24(empty_2062),.din25(empty_2063),.din26(empty_2064),.din27(empty_2065),.din28(empty_2066),.din29(empty_2067),.din30(empty_2068),.din31(empty_2069),.din32(empty_2070),.din33(empty_2071),.din34(empty_2072),.din35(empty_2073),.din36(empty_2074),.din37(empty_2075),.din38(empty_2076),.din39(empty_2077),.din40(empty_2078),.din41(empty_2079),.din42(empty_2080),.din43(empty_2081),.din44(empty_2082),.din45(empty_2083),.din46(empty_2084),.din47(empty_2085),.din48(empty_2086),.din49(empty_2087),.din50(empty_2088),.din51(empty_2089),.din52(empty_2090),.din53(empty_2091),.din54(empty_2092),.din55(empty_2093),.din56(empty_2094),.din57(empty_2095),.din58(empty_2096),.din59(empty_2097),.din60(empty_2098),.din61(empty_2099),.din62(empty_2100),.din63(empty_2101),.din64(empty_2102),.din65(empty_2103),.din66(empty_2104),.din67(empty_2105),.din68(empty_2106),.din69(empty_2107),.din70(empty_2108),.din71(empty_2109),.din72(empty_2110),.din73(empty_2111),.din74(empty_2112),.din75(empty_2113),.din76(empty_2114),.din77(empty_2115),.din78(empty_2116),.din79(empty_2117),.din80(empty_2118),.din81(empty_2119),.din82(empty_2120),.din83(empty_2121),.din84(empty_2122),.din85(empty_2123),.din86(empty_2124),.din87(empty_2125),.din88(empty_2126),.din89(empty_2127),.din90(empty_2128),.din91(empty_2129),.din92(empty_2130),.din93(empty_2131),.din94(empty_2132),.din95(empty_2133),.din96(empty_2134),.din97(empty_2135),.din98(empty_2136),.din99(empty_2137),.din100(empty_2138),.din101(empty_2139),.din102(empty_2140),.din103(empty_2141),.din104(empty_2142),.din105(empty_2143),.din106(empty_2144),.din107(empty_2145),.din108(empty_2146),.din109(empty_2147),.din110(empty_2148),.din111(empty_2149),.din112(empty_2150),.din113(empty_2151),.din114(empty_2152),.din115(empty_2153),.din116(empty_2154),.din117(empty_2155),.din118(empty_2156),.din119(empty_2157),.din120(empty_2158),.din121(empty_2159),.din122(empty_2160),.din123(empty_2161),.din124(empty_2162),.din125(empty_2163),.din126(empty_2164),.din127(empty_2165),.din128(empty_2166),.din129(empty_2167),.din130(empty_2168),.din131(empty_2169),.din132(empty_2170),.din133(empty_2171),.din134(empty_2172),.din135(empty_2173),.din136(empty_2174),.din137(empty_2175),.din138(empty_2176),.din139(empty_2177),.din140(empty_2178),.din141(empty_2179),.din142(empty_2180),.din143(empty_2181),.din144(empty_2182),.din145(empty_2183),.din146(empty_2184),.din147(empty_2185),.din148(empty_2186),.din149(empty_2187),.din150(empty_2188),.din151(empty_2189),.din152(empty_2190),.din153(empty_2191),.din154(empty_2192),.din155(empty_2193),.din156(empty_2194),.din157(empty_2195),.din158(empty_2196),.din159(empty_2197),.din160(empty_2198),.din161(empty_2199),.din162(empty_2200),.din163(empty_2201),.din164(empty_2202),.din165(empty_2203),.din166(empty_2204),.din167(empty_2205),.din168(empty_2206),.din169(empty_2207),.din170(empty_2208),.din171(empty_2209),.din172(empty_2210),.din173(empty_2211),.din174(empty_2212),.din175(empty_2213),.din176(empty_2214),.din177(empty_2215),.din178(empty_2216),.din179(empty_2217),.din180(empty_2218),.din181(empty_2219),.din182(empty_2220),.din183(empty_2221),.din184(empty_2222),.din185(empty_2223),.din186(empty_2224),.din187(empty_2225),.din188(empty_2226),.din189(empty_2227),.din190(empty_2228),.din191(empty_2229),.din192(empty_2230),.din193(empty_2231),.din194(empty_2232),.din195(empty_2233),.din196(empty_2234),.din197(empty_2235),.din198(empty_2236),.din199(empty_2237),.din200(empty_2238),.din201(empty_2239),.din202(empty_2240),.din203(empty_2241),.din204(empty_2242),.din205(empty_2243),.din206(empty_2244),.din207(empty_2245),.din208(empty_2246),.din209(empty_2247),.din210(empty_2248),.din211(empty_2249),.din212(empty_2250),.din213(empty_2251),.din214(empty_2252),.din215(empty_2253),.din216(empty_2254),.din217(empty_2255),.din218(empty_2256),.din219(empty_2257),.din220(empty_2258),.din221(empty_2259),.din222(empty_2260),.din223(empty_2261),.din224(empty_2262),.din225(empty_2263),.din226(empty_2264),.din227(empty_2265),.din228(empty_2266),.din229(empty_2267),.din230(empty_2268),.din231(empty_2269),.din232(empty_2270),.din233(empty_2271),.din234(empty_2272),.din235(empty_2273),.din236(empty_2274),.din237(empty_2275),.din238(empty_2276),.din239(empty_2277),.din240(empty_2278),.din241(empty_2279),.din242(empty_2280),.din243(empty_2281),.din244(empty_2282),.din245(empty_2283),.din246(empty_2284),.din247(empty_2285),.din248(empty_2286),.din249(empty_2287),.din250(empty_2288),.din251(empty_2289),.din252(empty_2290),.din253(empty_2291),.din254(empty_2292),.din255(empty_2293),.din256(empty_2294),.din257(empty_2295),.din258(empty_2296),.din259(empty_2297),.din260(empty_2298),.din261(empty_2299),.din262(empty_2300),.din263(empty_2301),.din264(empty_2302),.din265(empty_2303),.din266(empty_2304),.din267(empty_2305),.din268(empty_2306),.din269(empty_2307),.din270(empty_2308),.din271(empty_2309),.din272(empty_2310),.din273(empty_2311),.din274(empty_2312),.din275(empty_2313),.din276(empty_2314),.din277(empty_2315),.din278(empty_2316),.din279(empty_2317),.din280(empty_2318),.din281(empty_2319),.din282(empty_2320),.din283(empty_2321),.din284(empty_2322),.din285(empty_2323),.din286(empty_2324),.din287(empty_2325),.din288(empty_2326),.din289(empty_2327),.din290(empty_2328),.din291(empty_2329),.din292(empty_2330),.din293(empty_2331),.din294(empty_2332),.din295(empty_2333),.din296(empty_2334),.din297(empty_2335),.din298(empty_2336),.din299(empty_2337),.din300(empty_2338),.din301(empty_2339),.din302(empty_2340),.din303(empty_2341),.din304(empty_2342),.din305(empty_2343),.din306(empty_2344),.din307(empty_2345),.din308(empty_2346),.din309(empty_2347),.din310(empty_2348),.din311(empty_2349),.din312(empty_2350),.din313(empty_2351),.din314(empty_2352),.din315(empty_2353),.din316(empty_2354),.din317(empty_2355),.din318(empty_2356),.din319(empty_2357),.din320(empty_2358),.din321(empty_2359),.din322(empty_2360),.din323(empty_2361),.din324(empty_2362),.din325(empty_2363),.din326(empty_2364),.din327(empty_2365),.din328(empty_2366),.din329(empty_2367),.din330(empty_2368),.din331(empty_2369),.din332(empty_2370),.din333(empty_2371),.din334(empty_2372),.din335(empty_2373),.din336(empty_2374),.din337(empty_2375),.din338(empty_2376),.din339(empty_2377),.din340(empty_2378),.din341(empty_2379),.din342(empty_2380),.din343(empty_2381),.din344(empty_2382),.din345(empty_2383),.din346(empty_2384),.din347(empty_2385),.din348(empty_2386),.din349(empty_2387),.din350(empty_2388),.din351(empty_2389),.din352(empty_2390),.din353(empty_2391),.din354(empty_2392),.din355(empty_2393),.din356(empty_2394),.din357(empty_2395),.din358(empty_2396),.din359(empty_2397),.din360(empty_2398),.din361(empty_2399),.din362(empty_2400),.din363(empty_2401),.din364(empty_2402),.din365(empty_2403),.din366(empty_2404),.din367(empty_2405),.din368(empty_2406),.din369(empty_2407),.din370(empty_2408),.din371(empty_2409),.din372(empty_2410),.din373(empty_2411),.din374(empty_2412),.din375(empty_2413),.din376(empty_2414),.din377(empty_2415),.din378(empty_2416),.din379(empty_2417),.din380(empty_2418),.din381(empty_2419),.din382(empty_2420),.din383(empty_2421),.din384(empty_2422),.din385(empty_2423),.din386(empty_2424),.din387(empty_2425),.din388(empty_2426),.din389(empty_2427),.din390(empty_2428),.din391(empty_2429),.din392(empty_2430),.din393(empty_2431),.din394(empty_2432),.din395(empty_2433),.din396(empty_2434),.din397(empty_2435),.din398(empty_2436),.din399(empty_2437),.din400(empty_2438),.din401(empty_2439),.din402(empty_2440),.din403(empty_2441),.din404(empty_2442),.din405(empty_2443),.din406(empty_2444),.din407(empty_2445),.din408(empty_2446),.din409(empty_2447),.din410(empty_2448),.din411(empty_2449),.din412(empty_2450),.din413(empty_2451),.din414(empty_2452),.din415(empty_2453),.din416(empty_2454),.din417(empty_2455),.din418(empty_2456),.din419(empty_2457),.din420(empty_2458),.din421(empty_2459),.din422(empty_2460),.din423(empty_2461),.din424(empty_2462),.din425(empty_2463),.din426(empty_2464),.din427(empty_2465),.din428(empty_2466),.din429(empty_2467),.din430(empty_2468),.din431(empty_2469),.din432(empty_2470),.din433(empty_2471),.din434(empty_2472),.din435(empty_2473),.din436(empty_2474),.din437(empty_2475),.din438(empty_2476),.din439(empty_2477),.din440(empty_2478),.din441(empty_2479),.din442(empty_2480),.din443(empty_2481),.din444(empty_2482),.din445(empty_2483),.din446(empty_2484),.din447(empty_2485),.din448(empty_2486),.din449(empty_2487),.din450(empty_2488),.din451(empty_2489),.din452(empty_2490),.din453(empty_2491),.din454(empty_2492),.din455(empty_2493),.din456(empty_2494),.din457(empty_2495),.din458(empty_2496),.din459(empty_2497),.din460(empty_2498),.din461(empty_2499),.din462(empty_2500),.din463(empty_2501),.din464(empty_2502),.din465(empty_2503),.din466(empty_2504),.din467(empty_2505),.din468(empty_2506),.din469(empty_2507),.din470(empty_2508),.din471(empty_2509),.din472(empty_2510),.din473(empty_2511),.din474(empty_2512),.din475(empty_2513),.din476(empty_2514),.din477(empty_2515),.din478(empty_2516),.din479(empty_2517),.din480(empty_2518),.din481(empty_2519),.din482(empty_2520),.din483(empty_2521),.din484(empty_2522),.din485(empty_2523),.din486(empty_2524),.din487(empty_2525),.din488(empty),.def(v95_fu_5115_p979),.sel(v95_fu_5115_p980),.dout(v95_fu_5115_p981));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U1142(.din0(v14_5_reload),.din1(v14_10_reload),.din2(v14_3_reload),.def(v94_fu_6590_p7),.sel(v93_1_reg_9188_pp0_iter1_reg),.dout(v94_fu_6590_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U1143(.din0(v15_5_reload),.din1(v15_10_reload),.din2(v15_3_reload),.def(v98_fu_6629_p7),.sel(v93_1_reg_9188_pp0_iter8_reg),.dout(v98_fu_6629_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v13_7_reg_9229 <= grp_fu_28807_p_dout0;
...
always @ (*) begin
    ap_condition_3442 = (~(v93_1_reg_9188_pp0_iter16_reg == 2'd1) & ~(v93_1_reg_9188_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
...
assign bit_sel5_fu_6611_p3 = bitcast_ln172_fu_6607_p1[64'd63];
assign bitcast_ln172_fu_6607_p1 = grp_fu_68358_p_dout0;
assign grp_fu_28807_p_ce = 1'b1;
assign grp_fu_28807_p_din0 = v97_fu_6651_p1;
assign grp_fu_28807_p_din1 = v98_reg_9219;
assign grp_fu_68358_p_ce = 1'b1;
assign grp_fu_68358_p_din0 = v94_fu_6590_p9;
assign grp_fu_68358_p_din1 = v95_reg_9199;
assign grp_fu_68358_p_opcode = 2'd1;
...
assign xor_ln172_fu_6619_p2 = (bit_sel5_fu_6611_p3 ^ 1'd1);
