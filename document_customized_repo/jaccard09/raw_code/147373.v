...
reg   [0:0] tmp_reg_601;
wire   [6:0] select_ln6_fu_408_p3;
reg   [6:0] select_ln6_reg_606;
wire   [0:0] first_iter_2_fu_416_p2;
reg   [0:0] first_iter_2_reg_611;
wire   [3:0] lshr_ln6_3_fu_422_p4;
reg   [3:0] lshr_ln6_3_reg_615;
wire   [2:0] tmp_7_fu_440_p4;
reg   [2:0] tmp_7_reg_640;
reg   [5:0] tmp2_addr_reg_665;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] tmp2_addr_reg_665_pp0_iter1_reg;
reg   [31:0] buff_x_load_reg_690;
reg   [31:0] buff_x_1_load_reg_695;
reg   [31:0] buff_x_2_load_reg_700;
reg   [31:0] buff_x_3_load_reg_705;
reg   [31:0] buff_x_load_1_reg_730;
reg   [31:0] buff_x_1_load_1_reg_735;
reg   [31:0] buff_x_2_load_1_reg_740;
reg   [31:0] buff_x_3_load_1_reg_745;
reg   [31:0] arrayidx67_promoted_reg_750;
reg   [31:0] buff_B_load_reg_755;
reg   [31:0] buff_B_1_load_reg_760;
reg   [31:0] buff_B_2_load_reg_765;
reg   [31:0] buff_B_3_load_reg_770;
reg   [31:0] buff_B_load_1_reg_775;
reg   [31:0] buff_B_1_load_1_reg_780;
reg   [31:0] buff_B_2_load_1_reg_785;
reg   [31:0] buff_B_3_load_1_reg_790;
reg   [31:0] mul65_7_reg_800;
wire    ap_CS_fsm_pp0_stage21;
wire    ap_block_pp0_stage21_11001;
reg   [0:0] tmp_1_reg_805;
wire    ap_block_pp0_stage56_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln6_fu_432_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln33_fu_458_p1;
wire   [63:0] zext_ln31_fu_491_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln33_1_fu_503_p1;
wire   [63:0] zext_ln33_2_fu_520_p1;
reg   [6:0] j_fu_76;
wire   [6:0] add_ln32_fu_541_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_2_fu_80;
wire   [6:0] select_ln31_fu_480_p3;
reg   [9:0] indvar_flatten15_fu_84;
wire   [9:0] add_ln31_1_fu_391_p2;
reg   [9:0] ap_sig_allocacmp_indvar_flatten15_load;
reg   [31:0] add6815_fu_88;
...
wire   [3:0] or_ln_fu_450_p3;
wire   [6:0] add_ln31_fu_474_p2;
wire   [5:0] empty_fu_487_p1;
wire   [9:0] tmp_6_fu_496_p3;
wire   [9:0] tmp_8_fu_511_p4;
...
#0 j_fu_76 = 7'd0;
#0 i_2_fu_80 = 7'd0;
#0 indvar_flatten15_fu_84 = 10'd0;
#0 add6815_fu_88 = 32'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_1198)) begin
            add6815_fu_88 <= arrayidx67_promoted_reg_750;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add6815_fu_88 <= reg_361;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_2_fu_80 <= 7'd0;
    end else if (((icmp_ln31_reg_597 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_2_fu_80 <= select_ln31_fu_480_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_385_p2 == 1'd0))) begin
            indvar_flatten15_fu_84 <= add_ln31_1_fu_391_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten15_fu_84 <= 10'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_76 <= 7'd0;
    end else if (((icmp_ln31_reg_597 == 1'd0) & (1'b0 == ap_block_pp0_stage56_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage56))) begin
        j_fu_76 <= add_ln32_fu_541_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx67_promoted_reg_750 <= tmp2_q0;
        buff_B_1_load_1_reg_780 <= buff_B_1_q0;
        buff_B_1_load_reg_760 <= buff_B_1_q1;
        buff_B_2_load_1_reg_785 <= buff_B_2_q0;
        buff_B_2_load_reg_765 <= buff_B_2_q1;
        buff_B_3_load_1_reg_790 <= buff_B_3_q0;
        buff_B_3_load_reg_770 <= buff_B_3_q1;
        buff_B_load_1_reg_775 <= buff_B_q0;
        buff_B_load_reg_755 <= buff_B_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_x_1_load_1_reg_735 <= buff_x_1_q0;
        buff_x_1_load_reg_695 <= buff_x_1_q1;
        buff_x_2_load_1_reg_740 <= buff_x_2_q0;
        buff_x_2_load_reg_700 <= buff_x_2_q1;
        buff_x_3_load_1_reg_745 <= buff_x_3_q0;
        buff_x_3_load_reg_705 <= buff_x_3_q1;
        buff_x_load_1_reg_730 <= buff_x_q0;
        buff_x_load_reg_690 <= buff_x_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_2_reg_611 <= first_iter_2_fu_416_p2;
        icmp_ln31_reg_597 <= icmp_ln31_fu_385_p2;
        lshr_ln6_3_reg_615 <= {{select_ln6_fu_408_p3[5:2]}};
        select_ln6_reg_606 <= select_ln6_fu_408_p3;
        tmp_7_reg_640 <= {{select_ln6_fu_408_p3[5:3]}};
        tmp_reg_601 <= ap_sig_allocacmp_j_load[32'd6];
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage21_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage21))) begin
        mul65_7_reg_800 <= grp_fu_197_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage52_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage52)) | ((1'b0 == ap_block_pp0_stage45_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage45)) | ((1'b0 == ap_block_pp0_stage38_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage38)) | ((1'b0 == ap_block_pp0_stage31_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage31)) | ((1'b0 == ap_block_pp0_stage24_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage24)) | ((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9)) | ((1'b0 == ap_block_pp0_stage17_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17)))) begin
        reg_361 <= grp_fu_193_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_addr_reg_665 <= zext_ln31_fu_491_p1;
        tmp2_addr_reg_665_pp0_iter1_reg <= tmp2_addr_reg_665;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage56_11001) & (1'b1 == ap_CS_fsm_pp0_stage56))) begin
        tmp_1_reg_805 <= add_ln32_fu_541_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln31_reg_597 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3)) | ((1'b0 == ap_block_pp0_stage53) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage53)) | ((1'b0 == ap_block_pp0_stage46) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage46)) | ((1'b0 == ap_block_pp0_stage39) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage39)) | ((1'b0 == ap_block_pp0_stage32) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage32)) | ((1'b0 == ap_block_pp0_stage25) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage25)) | ((1'b0 == ap_block_pp0_stage18) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage18)))) begin
        grp_fu_311_p0 = reg_361;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        grp_fu_311_p0 = add6815_fu_88;
    end else begin
        grp_fu_311_p0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage17) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17))) begin
        ...
        grp_fu_315_p0 = reg_349;
    end else if (((1'b0 == ap_block_pp0_stage15) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
        grp_fu_315_p0 = reg_343;
    end else if (((1'b0 == ap_block_pp0_stage14) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        grp_fu_315_p0 = buff_B_3_load_1_reg_790;
    end else if (((1'b0 == ap_block_pp0_stage13) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage13))) begin
        grp_fu_315_p0 = buff_B_2_load_1_reg_785;
    end else if (((1'b0 == ap_block_pp0_stage12) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage12))) begin
        grp_fu_315_p0 = buff_B_1_load_1_reg_780;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        grp_fu_315_p0 = buff_B_load_1_reg_775;
    end else if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        grp_fu_315_p0 = reg_337;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_315_p0 = reg_331;
    end else if (((1'b0 == ap_block_pp0_stage8) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        grp_fu_315_p0 = reg_325;
        ...
        grp_fu_315_p0 = reg_319;
    end else if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        grp_fu_315_p0 = buff_B_3_load_reg_770;
    end else if (((1'b0 == ap_block_pp0_stage5) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        grp_fu_315_p0 = buff_B_2_load_reg_765;
    end else if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        grp_fu_315_p0 = buff_B_1_load_reg_760;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_315_p0 = buff_B_load_reg_755;
    end else begin
        grp_fu_315_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage18) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage18))) begin
        grp_fu_315_p1 = buff_x_3_load_1_reg_745;
    end else if (((1'b0 == ap_block_pp0_stage17) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17))) begin
        grp_fu_315_p1 = buff_x_2_load_1_reg_740;
    end else if (((1'b0 == ap_block_pp0_stage16) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage16))) begin
        grp_fu_315_p1 = buff_x_1_load_1_reg_735;
    end else if (((1'b0 == ap_block_pp0_stage15) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
        grp_fu_315_p1 = buff_x_load_1_reg_730;
    end else if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        grp_fu_315_p1 = buff_x_3_load_reg_705;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_315_p1 = buff_x_2_load_reg_700;
    end else if (((1'b0 == ap_block_pp0_stage8) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        grp_fu_315_p1 = buff_x_1_load_reg_695;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        grp_fu_315_p1 = buff_x_load_reg_690;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_address0_local = tmp2_addr_reg_665_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_address0_local = zext_ln31_fu_491_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1_reg_805 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_we0_local = 1'b1;
    end else begin
        tmp2_we0_local = 1'b0;
    end
...
assign add_ln31_1_fu_391_p2 = (ap_sig_allocacmp_indvar_flatten15_load + 10'd1);
assign add_ln31_fu_474_p2 = (i_2_fu_80 + 7'd1);
assign add_ln32_fu_541_p2 = (select_ln6_reg_606 + 7'd8);
...
always @ (*) begin
    ap_condition_1198 = ((icmp_ln31_reg_597 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_2_reg_611 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_B_1_address0 = zext_ln33_2_fu_520_p1;
assign buff_B_1_address1 = zext_ln33_1_fu_503_p1;
assign buff_B_1_ce0 = buff_B_1_ce0_local;
assign buff_B_1_ce1 = buff_B_1_ce1_local;
assign buff_B_2_address0 = zext_ln33_2_fu_520_p1;
assign buff_B_2_address1 = zext_ln33_1_fu_503_p1;
assign buff_B_2_ce0 = buff_B_2_ce0_local;
assign buff_B_2_ce1 = buff_B_2_ce1_local;
assign buff_B_3_address0 = zext_ln33_2_fu_520_p1;
assign buff_B_3_address1 = zext_ln33_1_fu_503_p1;
assign buff_B_3_ce0 = buff_B_3_ce0_local;
assign buff_B_3_ce1 = buff_B_3_ce1_local;
assign buff_B_address0 = zext_ln33_2_fu_520_p1;
assign buff_B_address1 = zext_ln33_1_fu_503_p1;
assign buff_B_ce0 = buff_B_ce0_local;
assign buff_B_ce1 = buff_B_ce1_local;
assign buff_x_1_address0 = zext_ln33_fu_458_p1;
assign buff_x_1_address1 = zext_ln6_fu_432_p1;
assign buff_x_1_ce0 = buff_x_1_ce0_local;
assign buff_x_1_ce1 = buff_x_1_ce1_local;
assign buff_x_2_address0 = zext_ln33_fu_458_p1;
assign buff_x_2_address1 = zext_ln6_fu_432_p1;
assign buff_x_2_ce0 = buff_x_2_ce0_local;
assign buff_x_2_ce1 = buff_x_2_ce1_local;
assign buff_x_3_address0 = zext_ln33_fu_458_p1;
assign buff_x_3_address1 = zext_ln6_fu_432_p1;
assign buff_x_3_ce0 = buff_x_3_ce0_local;
assign buff_x_3_ce1 = buff_x_3_ce1_local;
assign buff_x_address0 = zext_ln33_fu_458_p1;
assign buff_x_address1 = zext_ln6_fu_432_p1;
assign buff_x_ce0 = buff_x_ce0_local;
assign buff_x_ce1 = buff_x_ce1_local;
assign empty_fu_487_p1 = select_ln31_fu_480_p3[5:0];
assign first_iter_2_fu_416_p2 = ((select_ln6_fu_408_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_193_p_ce = 1'b1;
assign grp_fu_193_p_din0 = grp_fu_311_p0;
assign grp_fu_193_p_din1 = grp_fu_311_p1;
assign grp_fu_193_p_opcode = 2'd0;
assign grp_fu_197_p_ce = 1'b1;
assign grp_fu_197_p_din0 = grp_fu_315_p0;
assign grp_fu_197_p_din1 = grp_fu_315_p1;
assign icmp_ln31_fu_385_p2 = ((ap_sig_allocacmp_indvar_flatten15_load == 10'd512) ? 1'b1 : 1'b0);
assign lshr_ln6_3_fu_422_p4 = {{select_ln6_fu_408_p3[5:2]}};
assign or_ln_fu_450_p3 = {{tmp_7_fu_440_p4}, {1'd1}};
assign select_ln31_fu_480_p3 = ((tmp_reg_601[0:0] == 1'b1) ? add_ln31_fu_474_p2 : i_2_fu_80);
assign select_ln6_fu_408_p3 = ((tmp_fu_400_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp2_address0 = tmp2_address0_local;
assign tmp2_ce0 = tmp2_ce0_local;
assign tmp2_d0 = reg_361;
assign tmp2_we0 = tmp2_we0_local;
assign tmp_6_fu_496_p3 = {{empty_fu_487_p1}, {lshr_ln6_3_reg_615}};
assign tmp_7_fu_440_p4 = {{select_ln6_fu_408_p3[5:3]}};
assign tmp_8_fu_511_p4 = {{{empty_fu_487_p1}, {tmp_7_reg_640}}, {1'd1}};
assign tmp_fu_400_p3 = ap_sig_allocacmp_j_load[32'd6];
assign zext_ln31_fu_491_p1 = select_ln31_fu_480_p3;
assign zext_ln33_1_fu_503_p1 = tmp_6_fu_496_p3;
assign zext_ln33_2_fu_520_p1 = tmp_8_fu_511_p4;
assign zext_ln33_fu_458_p1 = or_ln_fu_450_p3;
assign zext_ln6_fu_432_p1 = lshr_ln6_3_fu_422_p4;
endmodule 