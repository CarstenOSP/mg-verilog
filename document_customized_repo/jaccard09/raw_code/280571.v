module backprop_backprop_Pipeline_label_17_label_18 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v19_address0,v19_ce0,v19_q0,mux_case_01634_reload,mux_case_11738_reload,mux_case_21842_reload,mul_ln168,v7_0_address0,v7_0_ce0,v7_0_q0,v7_1_address0,v7_1_ce0,v7_1_q0,v116_reload,mux_case_12050_reload,v116_2_reload,v10_address0,v10_ce0,v10_we0,v10_d0,grp_fu_2680_p_din0,grp_fu_2680_p_din1,grp_fu_2680_p_opcode,grp_fu_2680_p_dout0,grp_fu_2680_p_ce,grp_fu_2688_p_din0,grp_fu_2688_p_din1,grp_fu_2688_p_dout0,grp_fu_2688_p_ce,grp_fu_2692_p_din0,grp_fu_2692_p_din1,grp_fu_2692_p_dout0,grp_fu_2692_p_ce); 
...
sparsemux_7_2_64_1_1_U257(.din0(mux_case_01634_reload),.din1(mux_case_11738_reload),.din2(mux_case_21842_reload),.def(v103_fu_302_p7),.sel(select_ln177_reg_498_pp0_iter3_reg),.dout(v103_fu_302_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U258(.din0(v116_reload),.din1(mux_case_12050_reload),.din2(v116_2_reload),.def(v107_fu_345_p7),.sel(select_ln177_reg_498_pp0_iter10_reg),.dout(v107_fu_345_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v108_reg_571 <= grp_fu_2688_p_dout0;
        v109_reg_576 <= grp_fu_2692_p_dout0;
...
assign bitcast_ln183_fu_323_p1 = grp_fu_2680_p_dout0;
assign grp_fu_2680_p_ce = 1'b1;
assign grp_fu_2680_p_din0 = v103_fu_302_p9;
assign grp_fu_2680_p_din1 = v104_fu_319_p1;
assign grp_fu_2680_p_opcode = 2'd1;
assign grp_fu_2688_p_ce = 1'b1;
assign grp_fu_2688_p_din0 = v106_fu_367_p1;
assign grp_fu_2688_p_din1 = v107_reg_546;
assign grp_fu_2692_p_ce = 1'b1;
assign grp_fu_2692_p_din0 = v101_reg_566;
assign grp_fu_2692_p_din1 = v108_reg_571;
