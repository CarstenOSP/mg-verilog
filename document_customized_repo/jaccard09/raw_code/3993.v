...
wire   [31:0] grp_sha_transform_Pipeline_trans_lp5_fu_1951_D_40_out;
wire    grp_sha_transform_Pipeline_trans_lp5_fu_1951_D_40_out_ap_vld;
wire   [31:0] grp_sha_transform_Pipeline_trans_lp5_fu_1951_A_40_out;
wire    grp_sha_transform_Pipeline_trans_lp5_fu_1951_A_40_out_ap_vld;
wire   [31:0] grp_sha_transform_Pipeline_trans_lp5_fu_1951_C_32_out;
wire    grp_sha_transform_Pipeline_trans_lp5_fu_1951_C_32_out_ap_vld;
...
wire   [31:0] grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_35_out;
wire    grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_35_out_ap_vld;
wire   [31:0] grp_sha_transform_Pipeline_trans_lp6_fu_2009_temp_2_out;
wire    grp_sha_transform_Pipeline_trans_lp6_fu_2009_temp_2_out_ap_vld;
wire   [31:0] grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_36_out;
wire    grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_36_out_ap_vld;
wire   [31:0] grp_sha_transform_Pipeline_trans_lp6_fu_2009_temp_3_out;
wire    grp_sha_transform_Pipeline_trans_lp6_fu_2009_temp_3_out_ap_vld;
wire   [31:0] grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_37_out;
wire    grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_37_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state18) & (grp_sha_transform_Pipeline_trans_lp5_fu_1951_A_40_out_ap_vld == 1'b1))) begin
        A_40_loc_fu_82 <= grp_sha_transform_Pipeline_trans_lp5_fu_1951_A_40_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state18) & (grp_sha_transform_Pipeline_trans_lp5_fu_1951_C_32_out_ap_vld == 1'b1))) begin
        C_32_loc_fu_78 <= grp_sha_transform_Pipeline_trans_lp5_fu_1951_C_32_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_37_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state20))) begin
        C_37_loc_fu_58 <= grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_37_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state15) | ((1'b1 == ap_CS_fsm_state18) & (grp_sha_transform_Pipeline_trans_lp5_fu_1951_ap_done == 1'b1)))) begin
        reg_2395 <= W_42_q0;
        reg_2402 <= W_40_q0;
        reg_2409 <= W_43_q0;
        reg_2416 <= W_41_q0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state17) | ((1'b1 == ap_CS_fsm_state18) & (grp_sha_transform_Pipeline_trans_lp5_fu_1951_ap_done == 1'b1)))) begin
        reg_2423 <= W_48_q0;
        reg_2429 <= W_56_q0;
        reg_2435 <= W_49_q0;
        reg_2441 <= W_57_q0;
...
always @ (posedge ap_clk) begin
    if (((grp_sha_transform_Pipeline_trans_lp6_fu_2009_temp_3_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state20))) begin
        temp_3_loc_fu_62 <= grp_sha_transform_Pipeline_trans_lp6_fu_2009_temp_3_out;
    end
end
always @ (*) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state18 : begin
            if (((1'b1 == ap_CS_fsm_state18) & (grp_sha_transform_Pipeline_trans_lp5_fu_1951_ap_done == 1'b1))) begin
...
assign add_ln133_fu_2723_p2 = (sha_info_digest_0_i + temp_3_loc_fu_62);
assign add_ln134_fu_2734_p2 = (sha_info_digest_1_i + grp_sha_transform_Pipeline_trans_lp6_fu_2009_temp_2_out);
assign add_ln135_fu_2745_p2 = (sha_info_digest_2_i + C_37_loc_fu_58);
assign add_ln136_fu_2756_p2 = (sha_info_digest_3_i + grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_36_out);
assign add_ln137_fu_2767_p2 = (sha_info_digest_4_i + grp_sha_transform_Pipeline_trans_lp6_fu_2009_C_35_out);
