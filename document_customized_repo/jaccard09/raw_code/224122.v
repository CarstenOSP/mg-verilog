...
wire   [12:0] add_ln28_fu_203_p2;
reg   [12:0] add_ln28_reg_278;
wire    ap_CS_fsm_state3;
wire   [0:0] xor_ln43_fu_228_p2;
reg   [0:0] xor_ln43_reg_283;
wire    ap_CS_fsm_state5;
wire   [30:0] trunc_ln43_fu_234_p1;
reg   [30:0] trunc_ln43_reg_288;
wire    ap_CS_fsm_state6;
wire   [31:0] grp_fu_166_p2;
reg   [31:0] v16_reg_298;
wire    ap_CS_fsm_state15;
wire    ap_CS_fsm_state31;
reg   [31:0] v1_load_reg_308;
wire    ap_CS_fsm_state32;
wire   [31:0] grp_fu_158_p2;
reg   [31:0] v18_reg_313;
...
wire   [31:0] bitcast_ln43_fu_216_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln28_fu_197_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        v4_fu_76 <= 3'd0;
    end else if (((icmp_ln28_fu_197_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        v4_fu_76 <= v4_2_reg_270;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_SgdLR_sw_Pipeline_label_4_fu_146_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state49))) begin
        v5_reg_101 <= add_ln28_reg_278;
    end else if (((icmp_ln27_fu_185_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        v5_reg_101 <= 13'd0;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln28_reg_278 <= add_ln28_fu_203_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        trunc_ln43_reg_288 <= trunc_ln43_fu_234_p1;
        xor_ln43_reg_283 <= xor_ln43_fu_228_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        v16_reg_298 <= grp_fu_166_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state38)) begin
        v18_reg_313 <= grp_fu_158_p2;
...
always @ (*) begin
    if (((icmp_ln27_fu_185_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state49)) begin
        ...
        grp_fu_153_p0 = v18_reg_313;
    end else if ((1'b1 == ap_CS_fsm_state16)) begin
        grp_fu_153_p0 = v16_reg_298;
    end else begin
        grp_fu_153_p0 = 'bx;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln28_fu_197_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_SgdLR_sw_Pipeline_label_2_fu_113_ap_done == 1'b1))) begin
...
assign add_ln28_fu_203_p2 = (v5_reg_101 + 13'd1);
...
assign bit_sel_fu_220_p3 = bitcast_ln43_fu_216_p1[32'd31];
assign bitcast_ln43_fu_216_p1 = grp_SgdLR_sw_Pipeline_label_2_fu_113_v6_out;
...
assign icmp_ln27_fu_185_p2 = ((v4_fu_76 == 3'd5) ? 1'b1 : 1'b0);
assign icmp_ln28_fu_197_p2 = ((v5_reg_101 == 13'd4500) ? 1'b1 : 1'b0);
assign trunc_ln43_fu_234_p1 = bitcast_ln43_fu_216_p1[30:0];
assign v1_address0 = zext_ln28_fu_249_p1;
assign v1_ce0 = v1_ce0_local;
assign v2_address1 = grp_SgdLR_sw_Pipeline_label_4_fu_146_v2_address1;
assign v2_d0 = grp_SgdLR_sw_Pipeline_label_4_fu_146_v2_d0;
assign v4_2_fu_191_p2 = (v4_fu_76 + 3'd1);
assign xor_ln43_fu_228_p2 = (bit_sel_fu_220_p3 ^ 1'd1);
assign xor_ln_fu_238_p3 = {{xor_ln43_reg_283}, {trunc_ln43_reg_288}};
assign zext_ln28_fu_249_p1 = v5_reg_101;
endmodule 