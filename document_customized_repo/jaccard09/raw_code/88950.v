...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln38_fu_306_p2 == 1'd0))) begin
            indvar_flatten13_fu_116 <= add_ln38_1_fu_312_p2;
...
assign add_ln38_1_fu_312_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 10'd1);
...
assign icmp_ln38_fu_306_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 10'd512) ? 1'b1 : 1'b0);
