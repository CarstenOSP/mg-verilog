module SgdLR_sw_SgdLR_sw_Pipeline_label_27 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v2_0_address0,v2_0_ce0,v2_0_q0,v2_1_address0,v2_1_ce0,v2_1_q0,zext_ln33_8,v0_0_address0,v0_0_ce0,v0_0_q0,v0_1_address0,v0_1_ce0,v0_1_q0,v6_out,v6_out_ap_vld,grp_fu_1100_p_din0,grp_fu_1100_p_din1,grp_fu_1100_p_opcode,grp_fu_1100_p_dout0,grp_fu_1100_p_ce,grp_fu_2621_p_din0,grp_fu_2621_p_din1,grp_fu_2621_p_dout0,grp_fu_2621_p_ce); 
...
wire   [23:0] zext_ln33_8_cast_fu_137_p1;
reg   [23:0] zext_ln33_8_cast_reg_269;
reg   [10:0] v8_1_reg_274;
...
reg   [8:0] lshr_ln29_s_reg_300;
reg   [8:0] lshr_ln29_s_reg_300_pp0_iter2_reg;
...
wire   [23:0] add_ln35_1_fu_175_p2;
...
urem_24ns_23ns_24_28_1_U92(.clk(ap_clk),.reset(ap_rst),.din0(add_ln35_fu_164_p2),.din1(grp_fu_169_p1),.ce(1'b1),.dout(grp_fu_169_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        v8_1_reg_274 <= v8_fu_60;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        lshr_ln29_s_reg_300 <= {{v8_1_reg_274[9:1]}};
        lshr_ln29_s_reg_300_pp0_iter2_reg <= lshr_ln29_s_reg_300;
        ...
        zext_ln33_8_cast_reg_269[22 : 0] <= zext_ln33_8_cast_fu_137_p1[22 : 0];
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln33_fu_187_p2 = (v8_1_reg_274 + 11'd1);
assign add_ln35_1_fu_175_p2 = ($signed(add_ln35_fu_164_p2) + $signed(24'd14473216));
assign add_ln35_fu_164_p2 = (zext_ln33_fu_160_p1 + zext_ln33_8_cast_reg_269);
...
assign icmp_ln35_fu_181_p2 = ((add_ln35_1_fu_175_p2 < 24'd2304000) ? 1'b1 : 1'b0);
...
assign trunc_ln33_fu_192_p1 = v8_1_reg_274[0:0];
...
assign zext_ln29_fu_209_p1 = lshr_ln29_s_reg_300_pp0_iter2_reg;
assign zext_ln33_8_cast_fu_137_p1 = zext_ln33_8;
assign zext_ln33_fu_160_p1 = v8_fu_60;
assign zext_ln35_fu_221_p1 = grp_fu_169_p2;
always @ (posedge ap_clk) begin
    zext_ln33_8_cast_reg_269[23] <= 1'b0;
end
endmodule 