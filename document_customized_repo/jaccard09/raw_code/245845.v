...
wire   [0:0] tmp_5_fu_243_p3;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_CS_fsm_state2;
reg   [6:0] v112_1_reg_363;
reg   [0:0] tmp_5_reg_369;
wire   [0:0] icmp_ln166_fu_305_p2;
wire   [63:0] zext_ln164_fu_251_p1;
wire   [63:0] zext_ln164_1_fu_270_p1;
wire   [63:0] zext_ln165_fu_300_p1;
wire   [63:0] zext_ln165_1_fu_328_p1;
wire   [63:0] zext_ln165_2_fu_341_p1;
reg   [6:0] v112_fu_76;
wire   [6:0] add_ln164_fu_346_p2;
wire    ap_loop_init;
...
wire   [2:0] lshr_ln_fu_260_p4;
wire   [4:0] tmp_fu_282_p4;
wire   [5:0] or_ln_fu_292_p3;
wire   [2:0] trunc_ln164_fu_256_p1;
wire   [3:0] tmp_s_fu_311_p4;
wire   [5:0] or_ln164_1_fu_320_p3;
wire   [5:0] or_ln164_2_fu_333_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        v112_fu_76 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_5_reg_369 == 1'd0))) begin
        v112_fu_76 <= add_ln164_fu_346_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_5_reg_369 <= ap_sig_allocacmp_v112_1[32'd6];
        v112_1_reg_363 <= ap_sig_allocacmp_v112_1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((tmp_5_fu_243_p3 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_5_reg_369 == 1'd0))) begin
        v117_address0_local = zext_ln165_2_fu_341_p1;
    end else if (((tmp_5_fu_243_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        v117_address0_local = zext_ln165_fu_300_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_5_reg_369 == 1'd0))) begin
        v117_address1_local = zext_ln165_1_fu_328_p1;
    end else if (((tmp_5_fu_243_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        v117_address1_local = zext_ln164_fu_251_p1;
    end else begin
        v117_address1_local = 'bx;
    end
end
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state2) & (tmp_5_reg_369 == 1'd0)) | ((tmp_5_fu_243_p3 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1)))) begin
        v117_ce0_local = 1'b1;
    end else begin
        v117_ce0_local = 1'b0;
    end
...
always @ (*) begin
    if (((tmp_5_fu_243_p3 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln166_fu_305_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((tmp_5_fu_243_p3 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln166_fu_305_p2 == 1'd0))) begin
...
assign add_ln164_fu_346_p2 = (v112_1_reg_363 + 7'd4);
...
assign icmp_ln166_fu_305_p2 = ((trunc_ln164_fu_256_p1 == 3'd0) ? 1'b1 : 1'b0);
assign lshr_ln_fu_260_p4 = {{ap_sig_allocacmp_v112_1[5:3]}};
assign or_ln164_1_fu_320_p3 = {{tmp_s_fu_311_p4}, {2'd2}};
assign or_ln164_2_fu_333_p3 = {{tmp_s_fu_311_p4}, {2'd3}};
assign or_ln_fu_292_p3 = {{tmp_fu_282_p4}, {1'd1}};
assign tmp_5_fu_243_p3 = ap_sig_allocacmp_v112_1[32'd6];
assign tmp_fu_282_p4 = {{ap_sig_allocacmp_v112_1[5:1]}};
assign tmp_s_fu_311_p4 = {{v112_1_reg_363[5:2]}};
assign trunc_ln164_fu_256_p1 = ap_sig_allocacmp_v112_1[2:0];
...
assign zext_ln164_fu_251_p1 = ap_sig_allocacmp_v112_1;
assign zext_ln165_1_fu_328_p1 = or_ln164_1_fu_320_p3;
assign zext_ln165_2_fu_341_p1 = or_ln164_2_fu_333_p3;
assign zext_ln165_fu_300_p1 = or_ln_fu_292_p3;
endmodule 