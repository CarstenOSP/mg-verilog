...
sparsemux_9_2_32_1_1_U513(.din0(buff_E_out_q0),.din1(buff_E_out_1_q0),.din2(buff_E_out_2_q0),.din3(buff_E_out_3_q0),.def(tmp_2_fu_258_p9),.sel(trunc_ln51_1_reg_310),.dout(tmp_2_fu_258_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln50_fu_157_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten554_fu_76 <= add_ln50_1_fu_163_p2;
...
assign add_ln50_1_fu_163_p2 = (ap_sig_allocacmp_indvar_flatten554_load + 13'd1);
...
assign icmp_ln50_fu_157_p2 = ((ap_sig_allocacmp_indvar_flatten554_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln51_fu_186_p2 = ((j_fu_68 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_6_fu_216_p4 = {{select_ln6_fu_192_p3[5:2]}};
...
assign tmp_s_fu_226_p3 = {{trunc_ln51_fu_208_p1}, {lshr_ln6_6_fu_216_p4}};
