module backprop_backprop_Pipeline_VITIS_LOOP_8_1 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,activations3_load_2,activations3_1_load_2,activations3_2_load_2,sum_out,sum_out_ap_vld,grp_fu_5581_p_din0,grp_fu_5581_p_din1,grp_fu_5581_p_opcode,grp_fu_5581_p_dout0,grp_fu_5581_p_ce,grp_fu_5765_p_din0,grp_fu_5765_p_din1,grp_fu_5765_p_dout0,grp_fu_5765_p_ce); 
...
sparsemux_7_2_64_1_1_U556(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_89_fu_121_p7),.sel(ap_sig_allocacmp_i_8),.dout(tmp_89_fu_121_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_90_reg_226 <= grp_fu_5765_p_dout0;
...
assign grp_fu_5765_p_din1 = bitcast_ln9_1_fu_174_p1;
