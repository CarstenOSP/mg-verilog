...
wire   [31:0] grp_sha_transform_Pipeline_trans_lp3_fu_343_C_86_out;
wire    grp_sha_transform_Pipeline_trans_lp3_fu_343_C_86_out_ap_vld;
...
wire   [31:0] grp_sha_transform_Pipeline_trans_lp4_fu_361_C_80_out;
wire    grp_sha_transform_Pipeline_trans_lp4_fu_361_C_80_out_ap_vld;
...
wire   [31:0] grp_sha_transform_Pipeline_trans_lp5_fu_379_C_66_out;
wire    grp_sha_transform_Pipeline_trans_lp5_fu_379_C_66_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((grp_sha_transform_Pipeline_trans_lp5_fu_379_C_66_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state17))) begin
        C_66_loc_fu_82 <= grp_sha_transform_Pipeline_trans_lp5_fu_379_C_66_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_sha_transform_Pipeline_trans_lp4_fu_361_C_80_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state15))) begin
        C_80_loc_fu_102 <= grp_sha_transform_Pipeline_trans_lp4_fu_361_C_80_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_sha_transform_Pipeline_trans_lp3_fu_343_C_86_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state13))) begin
        C_86_loc_fu_122 <= grp_sha_transform_Pipeline_trans_lp3_fu_343_C_86_out;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln135_fu_537_p2 = (sha_info_digest_2_i + grp_sha_transform_Pipeline_trans_lp6_fu_397_C_52_out);
