...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_551_min_s_2_out;
wire    grp_viterbi_Pipeline_L_end_fu_551_min_s_2_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_589_min_s_6_out;
wire    grp_viterbi_Pipeline_L_state_fu_589_min_s_6_out_ap_vld;
...
sparsemux_9_2_8_1_1_x_U253(.din0(path_0_q0),.din1(path_1_q0),.din2(path_2_q0),.din3(path_3_q0),.def(tmp_67_fu_724_p9),.sel(tmp_67_fu_724_p10),.dout(tmp_67_fu_724_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U254(.din0(tmp_68_fu_786_p2),.din1(tmp_68_fu_786_p4),.din2(tmp_68_fu_786_p6),.din3(tmp_68_fu_786_p8),.def(tmp_68_fu_786_p9),.sel(trunc_ln52_reg_927),.dout(tmp_68_fu_786_p11));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U255(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_968_p0),.din1(grp_fu_968_p1),.ce(grp_fu_968_ce),.opcode(grp_fu_968_opcode),.dout(grp_fu_968_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state22)) begin
        min_p_138_reg_963 <= grp_fu_639_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & (grp_viterbi_Pipeline_L_end_fu_551_min_s_2_out_ap_vld == 1'b1))) begin
        min_s_2_loc_fu_126 <= grp_viterbi_Pipeline_L_end_fu_551_min_s_2_out;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state24) & (grp_viterbi_Pipeline_L_state_fu_589_min_s_6_out_ap_vld == 1'b1))) begin
        min_s_6_loc_fu_122 <= grp_viterbi_Pipeline_L_state_fu_589_min_s_6_out;
    end
end
always @ (posedge ap_clk) begin
...
assign transition_0_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_491_transition_0_address1;
assign transition_1_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_491_transition_1_address1;
assign transition_2_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_491_transition_2_address1;
assign transition_3_address1 = grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_491_transition_3_address1;
