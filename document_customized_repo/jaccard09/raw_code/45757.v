...
wire   [10:0] tmp_204_cast_fu_335_p3;
...
sparsemux_17_3_64_1_1_U35(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.din4(llike_4_q0),.din5(llike_5_q0),.din6(llike_6_q0),.din7(llike_7_q0),.def(p_35_fu_408_p17),.sel(trunc_ln15_reg_1020),.dout(p_35_fu_408_p19));
...
sparsemux_17_3_64_1_1_U36(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.din4(llike_4_q0),.din5(llike_5_q0),.din6(llike_6_q0),.din7(llike_7_q0),.def(p_36_fu_447_p17),.sel(trunc_ln15_reg_1020),.dout(p_36_fu_447_p19));
...
sparsemux_17_3_64_1_1_U37(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.din4(llike_4_q0),.din5(llike_5_q0),.din6(llike_6_q0),.din7(llike_7_q0),.def(p_37_fu_521_p17),.sel(trunc_ln15_reg_1020),.dout(p_37_fu_521_p19));
...
assign icmp_ln42_10_fu_788_p2 = ((tmp_7_fu_756_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign icmp_ln42_6_fu_700_p2 = ((tmp_4_fu_668_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_7_fu_706_p2 = ((trunc_ln42_3_fu_678_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_8_fu_770_p2 = ((tmp_6_fu_739_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign tmp_204_cast_fu_335_p3 = {{8'd139}, {tmp_s_fu_325_p4}};
assign tmp_3_fu_651_p4 = {{bitcast_ln42_2_fu_648_p1[62:52]}};
assign tmp_4_fu_668_p4 = {{bitcast_ln42_3_fu_665_p1[62:52]}};
assign tmp_6_fu_739_p4 = {{bitcast_ln42_4_fu_736_p1[62:52]}};
assign tmp_7_fu_756_p4 = {{bitcast_ln42_5_fu_753_p1[62:52]}};
...
assign zext_ln41_fu_343_p1 = tmp_204_cast_fu_335_p3;
