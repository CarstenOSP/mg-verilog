...
sparsemux_7_2_64_1_1_U254(.din0(mux_case_04658_reload),.din1(mux_case_14762_reload),.din2(mux_case_24866_reload),.def(tmp_9_fu_370_p7),.sel(i_9_reg_567_pp0_iter1_reg),.dout(tmp_9_fu_370_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U255(.din0(mux_case_04970_reload),.din1(mux_case_15074_reload),.din2(mux_case_25178_reload),.def(tmp_s_fu_413_p7),.sel(i_9_reg_567_pp0_iter8_reg),.dout(tmp_s_fu_413_p9));
...
always @ (*) begin
    ap_condition_627 = (~(i_9_reg_567_pp0_iter16_reg == 2'd1) & ~(i_9_reg_567_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
