...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        v65_reg_532 <= grp_fu_2495_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v18_10_out_o = grp_fu_2477_p_dout0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v18_11_out_o = grp_fu_2477_p_dout0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v18_9_out_o = grp_fu_2477_p_dout0;
    end else begin
...
assign grp_fu_2477_p_din0 = select_ln122_1_fu_328_p3;
assign grp_fu_2477_p_din1 = v65_reg_532;
assign grp_fu_2477_p_opcode = 2'd0;
assign grp_fu_2495_p_ce = 1'b1;
assign grp_fu_2495_p_din0 = v63_fu_300_p1;
assign grp_fu_2495_p_din1 = v64_reg_522;
