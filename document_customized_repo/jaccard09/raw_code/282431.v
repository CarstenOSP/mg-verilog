...
sparsemux_17_3_64_1_1_U216(.din0(v118_fu_551_p2),.din1(v118_fu_551_p4),.din2(v118_fu_551_p6),.din3(v118_fu_551_p8),.din4(v118_fu_551_p10),.din5(v118_fu_551_p12),.din6(v118_fu_551_p14),.din7(v118_fu_551_p16),.def(v118_fu_551_p17),.sel(v118_fu_551_p18),.dout(v118_fu_551_p19));
backprop_urem_8ns_6ns_8_12_1 #(.ID( 1 ),.NUM_STAGE( 12 ),.din0_WIDTH( 8 ),.din1_WIDTH( 6 ),.dout_WIDTH( 8 ))
urem_8ns_6ns_8_12_1_U217(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_596_p0),.din1(grp_fu_596_p1),.ce(1'b1),.dout(grp_fu_596_p2));
backprop_urem_8ns_6ns_8_12_1 #(.ID( 1 ),.NUM_STAGE( 12 ),.din0_WIDTH( 8 ),.din1_WIDTH( 6 ),.dout_WIDTH( 8 ))
urem_8ns_6ns_8_12_1_U218(.clk(ap_clk),.reset(ap_rst),.din0(add_ln199_1_reg_917),.din1(grp_fu_612_p1),.ce(1'b1),.dout(grp_fu_612_p2));
backprop_mul_8ns_10ns_17_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 8 ),.din1_WIDTH( 10 ),.dout_WIDTH( 17 ))
mul_8ns_10ns_17_1_1_U219(.din0(mul_ln199_fu_632_p0),.din1(mul_ln199_fu_632_p1),.dout(mul_ln199_fu_632_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U220(.din0(v118_1_fu_680_p2),.din1(v118_1_fu_680_p4),.din2(v118_1_fu_680_p6),.din3(v118_1_fu_680_p8),.din4(v118_1_fu_680_p10),.din5(v118_1_fu_680_p12),.din6(v118_1_fu_680_p14),.din7(v118_1_fu_680_p16),.def(v118_1_fu_680_p17),.sel(v118_1_fu_680_p18),.dout(v118_1_fu_680_p19));
backprop_mul_8ns_10ns_17_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 8 ),.din1_WIDTH( 10 ),.dout_WIDTH( 17 ))
mul_8ns_10ns_17_1_1_U221(.din0(mul_ln199_1_fu_735_p0),.din1(mul_ln199_1_fu_735_p1),.dout(mul_ln199_1_fu_735_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U222(.din0(v118_2_fu_783_p2),.din1(v118_2_fu_783_p4),.din2(v118_2_fu_783_p6),.din3(v118_2_fu_783_p8),.din4(v118_2_fu_783_p10),.din5(v118_2_fu_783_p12),.din6(v118_2_fu_783_p14),.din7(v118_2_fu_783_p16),.def(v118_2_fu_783_p17),.sel(v118_2_fu_783_p18),.dout(v118_2_fu_783_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        v121_4_reg_1033 <= grp_fu_2369_p_dout0;
...
assign grp_fu_2365_p_din0 = grp_fu_418_p0;
assign grp_fu_2365_p_din1 = grp_fu_418_p1;
assign grp_fu_2365_p_opcode = 2'd0;
assign grp_fu_2369_p_ce = 1'b1;
assign grp_fu_2369_p_din0 = v121_3_reg_1018_pp0_iter10_reg;
assign grp_fu_2369_p_din1 = v119_1_reg_1023;
assign grp_fu_2369_p_opcode = 2'd0;
assign grp_fu_2373_p_ce = 1'b1;
assign grp_fu_2373_p_din0 = grp_fu_427_p0;
assign grp_fu_2373_p_din1 = grp_fu_427_p1;
assign grp_fu_2377_p_ce = 1'b1;
assign grp_fu_2377_p_din0 = grp_fu_431_p0;
assign grp_fu_2377_p_din1 = grp_fu_431_p1;
