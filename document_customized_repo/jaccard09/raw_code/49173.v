...
reg   [0:0] tmp_8_reg_622;
reg    ap_condition_exit_pp0_iter0_stage4;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [5:0] s_reg_584;
wire   [1:0] trunc_ln16_fu_219_p1;
reg   [1:0] trunc_ln16_reg_590;
...
reg   [63:0] min_p_133_reg_653;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [63:0] p_64_fu_317_p11;
reg   [63:0] p_64_reg_660;
...
wire   [63:0] min_p_135_fu_436_p3;
reg   [63:0] min_p_135_reg_678;
reg   [0:0] tmp_7_reg_685;
...
wire  signed [1:0] p_64_fu_317_p1;
wire   [1:0] p_64_fu_317_p3;
wire   [1:0] p_64_fu_317_p5;
wire  signed [1:0] p_64_fu_317_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 5'd1;
...
sparsemux_9_2_64_1_1_U30(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(p_fu_263_p9),.sel(trunc_ln16_reg_590),.dout(p_fu_263_p11));
...
sparsemux_9_2_64_1_1_U31(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(p_64_fu_317_p9),.sel(trunc_ln16_reg_590),.dout(p_64_fu_317_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        min_p_1_fu_84 <= min_p_137_fu_533_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_s_6_fu_92 <= 6'd1;
    end else if (((tmp_8_reg_622 == 1'd0) & (1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_8_reg_622 <= add_ln40_fu_249_p2[32'd6];
        trunc_ln16_reg_590 <= trunc_ln16_fu_219_p1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        min_p_133_reg_653 <= min_p_1_fu_84;
        p_64_reg_660 <= p_64_fu_317_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        min_p_135_reg_678 <= min_p_135_fu_436_p3;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_7_reg_685 <= grp_fu_552_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_8_reg_622 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_193_p1 = min_p_135_fu_436_p3;
        end else if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (tmp_8_reg_622 == 1'd1) & (1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
assign add_ln40_fu_249_p2 = (zext_ln16_fu_215_p1 + 7'd1);
...
assign and_ln42_3_fu_528_p2 = (tmp_7_reg_685 & and_ln42_2_fu_522_p2);
assign and_ln42_fu_410_p2 = (or_ln42_fu_386_p2 & grp_fu_552_p_dout0);
...
assign bitcast_ln42_1_fu_357_p1 = min_p_133_reg_653;
assign bitcast_ln42_2_fu_452_p1 = p_64_reg_660;
assign bitcast_ln42_3_fu_469_p1 = min_p_135_reg_678;
assign bitcast_ln42_fu_340_p1 = p_reg_626;
assign grp_fu_552_p_ce = 1'b1;
assign grp_fu_552_p_din0 = grp_fu_193_p0;
assign grp_fu_552_p_din1 = grp_fu_193_p1;
assign grp_fu_552_p_opcode = 5'd4;
assign icmp_ln42_1_fu_380_p2 = ((trunc_ln42_fu_353_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_2_fu_392_p2 = ((tmp_3_fu_360_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_3_fu_398_p2 = ((trunc_ln42_1_fu_370_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_4_fu_486_p2 = ((tmp_5_fu_455_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_5_fu_492_p2 = ((trunc_ln42_2_fu_465_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_6_fu_504_p2 = ((tmp_6_fu_472_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_7_fu_510_p2 = ((trunc_ln42_3_fu_482_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_fu_374_p2 = ((tmp_fu_343_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign min_p_135_fu_436_p3 = ((and_ln42_1_reg_667[0:0] == 1'b1) ? p_reg_626 : min_p_133_reg_653);
assign min_p_137_fu_533_p3 = ((and_ln42_3_fu_528_p2[0:0] == 1'b1) ? p_64_reg_660 : min_p_135_reg_678);
...
assign p_64_fu_317_p9 = 'bx;
assign p_fu_263_p9 = 'bx;
assign tmp_239_cast_fu_233_p3 = {{8'd139}, {tmp_s_fu_223_p4}};
assign tmp_3_fu_360_p4 = {{bitcast_ln42_1_fu_357_p1[62:52]}};
assign tmp_5_fu_455_p4 = {{bitcast_ln42_2_fu_452_p1[62:52]}};
assign tmp_6_fu_472_p4 = {{bitcast_ln42_3_fu_469_p1[62:52]}};
assign tmp_fu_343_p4 = {{bitcast_ln42_fu_340_p1[62:52]}};
assign tmp_s_fu_223_p4 = {{ap_sig_allocacmp_s[5:2]}};
assign trunc_ln16_fu_219_p1 = ap_sig_allocacmp_s[1:0];
