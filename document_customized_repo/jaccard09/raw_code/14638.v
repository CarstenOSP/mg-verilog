...
reg   [8:0] bucket_3_addr_3_reg_972;
...
reg   [8:0] bucket_3_addr_reg_1026;
...
reg   [8:0] bucket_3_addr_4_reg_1065;
...
reg   [8:0] bucket_3_addr_5_reg_1109;
...
sparsemux_9_2_32_1_1_x_U33(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.def(tmp_1_fu_530_p9),.sel(trunc_ln72_reg_952),.dout(tmp_1_fu_530_p11));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_9_2_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_x_U34(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.def(tmp_3_fu_633_p9),.sel(trunc_ln72_9_reg_1006),.dout(tmp_3_fu_633_p11));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_9_2_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_x_U35(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.def(tmp_5_fu_746_p9),.sel(trunc_ln72_11_reg_1045),.dout(tmp_5_fu_746_p11));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_9_2_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_x_U36(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.def(tmp_7_fu_806_p9),.sel(trunc_ln72_13_reg_1070),.dout(tmp_7_fu_806_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln72_6_reg_1123 <= {{tmp_7_fu_806_p11[10:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_3_addr_5_reg_1109 <= zext_ln72_11_fu_799_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        bucket_3_addr_3_reg_972 <= zext_ln72_8_fu_509_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        bucket_3_addr_reg_1026 <= zext_ln72_9_fu_625_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        ...
        bucket_3_addr_4_reg_1065 <= zext_ln72_10_fu_712_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        lshr_ln72_1_reg_991 <= {{tmp_1_fu_530_p11[10:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        lshr_ln72_5_reg_1040 <= {{tmp_3_fu_633_p11[10:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        lshr_ln72_9_reg_1089 <= {{tmp_5_fu_746_p11[10:2]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        bucket_3_address0_local = bucket_3_addr_5_reg_1109;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        bucket_3_address0_local = zext_ln72_11_fu_799_p1;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        bucket_3_address0_local = bucket_3_addr_4_reg_1065;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        bucket_3_address0_local = zext_ln72_10_fu_712_p1;
    end else if (((1'b0 == ap_block_pp0_stage8) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        bucket_3_address0_local = bucket_3_addr_reg_1026;
    end else if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        bucket_3_address0_local = zext_ln72_9_fu_625_p1;
    end else if (((1'b0 == ap_block_pp0_stage5) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        bucket_3_address0_local = bucket_3_addr_3_reg_972;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
assign add_ln70_fu_489_p2 = (zext_ln68_2_fu_479_p1 + shl_ln1_fu_482_p3);
assign add_ln73_2_fu_677_p2 = (tmp_3_reg_1031 + 32'd1);
assign add_ln73_4_fu_790_p2 = (tmp_5_reg_1080 + 32'd1);
assign add_ln73_5_fu_850_p2 = (tmp_7_reg_1114 + 32'd1);
...
assign shl_ln1_fu_482_p3 = {{trunc_ln70_reg_940}, {9'd0}};
...
assign trunc_ln72_10_fu_656_p1 = tmp_3_fu_633_p11[1:0];
assign trunc_ln72_11_fu_698_p1 = add_ln70_4_fu_693_p2[1:0];
assign trunc_ln72_12_fu_769_p1 = tmp_5_fu_746_p11[1:0];
assign trunc_ln72_13_fu_732_p1 = add_ln70_5_fu_727_p2[1:0];
assign trunc_ln72_14_fu_829_p1 = tmp_7_fu_806_p11[1:0];
assign trunc_ln72_8_fu_553_p1 = tmp_1_fu_530_p11[1:0];
