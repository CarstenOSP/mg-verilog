...
sparsemux_9_4_32_1_1_U114(.din0(W_q0),.din1(W_4_q0),.din2(W_8_q0),.din3(W_12_q0),.def(tmp_s_fu_497_p9),.sel(trunc_ln128_fu_494_p1),.dout(tmp_s_fu_497_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U115(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.def(tmp_1_fu_559_p9),.sel(trunc_ln128_fu_494_p1),.dout(tmp_1_fu_559_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U116(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.def(tmp_2_fu_583_p9),.sel(trunc_ln128_fu_494_p1),.dout(tmp_2_fu_583_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U117(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.def(tmp_3_fu_607_p9),.sel(trunc_ln128_fu_494_p1),.dout(tmp_3_fu_607_p11));
...
assign A_31_out = B_1_fu_128;
assign B_24_out = B_fu_124;
assign C_2_fu_825_p3 = {{trunc_ln130_7_fu_811_p1}, {lshr_ln130_7_fu_815_p4}};
assign C_30_out = E_2_fu_132;
...
assign D_31_out = E_1_fu_120;
assign E_24_out = E_fu_116;
...
assign or_ln2_fu_648_p3 = {{trunc_ln130_fu_634_p1}, {lshr_ln6_fu_638_p4}};
