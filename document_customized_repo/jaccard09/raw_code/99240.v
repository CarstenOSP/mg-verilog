...
wire   [4:0] tmp_3_fu_503_p4;
wire   [9:0] tmp_5_fu_512_p4;
...
sparsemux_9_2_32_1_1_U216(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.def(tmp_1_fu_449_p9),.sel(trunc_ln29_1_reg_662),.dout(tmp_1_fu_449_p11));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U217(.din0(buff_A_q1),.din1(buff_A_1_q1),.din2(buff_A_2_q1),.din3(buff_A_3_q1),.def(tmp_2_fu_537_p9),.sel(trunc_ln29_1_reg_662),.dout(tmp_2_fu_537_p11));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U218(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.def(tmp_4_fu_560_p9),.sel(trunc_ln29_1_reg_662),.dout(tmp_4_fu_560_p11));
...
assign tmp_3_fu_503_p4 = {{select_ln6_reg_646[5:1]}};
assign tmp_4_fu_560_p9 = 'bx;
assign tmp_5_fu_512_p4 = {{{tmp_3_fu_503_p4}, {1'd1}}, {lshr_ln6_2_reg_669}};
...
assign zext_ln31_1_fu_521_p1 = tmp_5_fu_512_p4;
