module ss_sort_ss_sort_Pipeline_hist_1_hist_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,a_address0,a_ce0,a_q0,a_address1,a_ce1,a_q1,zext_ln50,bucket_address0,bucket_ce0,bucket_we0,bucket_d0,bucket_q0); 
...
wire   [9:0] thr_add23_fu_266_p2;
reg   [9:0] thr_add23_reg_410;
wire    ap_block_pp0_stage3_11001;
wire   [1:0] trunc_ln57_fu_276_p1;
reg   [1:0] trunc_ln57_reg_415;
reg   [10:0] bucket_addr_159_reg_420;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        bucket_addr_159_reg_420 <= zext_ln58_fu_296_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        thr_add23_reg_410 <= thr_add23_fu_266_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        bucket_address0_local = bucket_addr_159_reg_420;
...
assign add_ln56_1_fu_249_p4 = {{{empty_reg_378}, {tmp_17_fu_241_p3}}, {1'd1}};
assign add_ln56_fu_230_p2 = (zext_ln55_fu_226_p1 + tmp_s_fu_219_p3);
...
assign ashr_ln57_1_fu_301_p2 = $signed(a_load_1_reg_405) >>> zext_ln50_cast_reg_358;
assign ashr_ln57_fu_272_p2 = $signed(a_load_reg_400) >>> zext_ln50_cast_reg_358;
...
assign thr_add23_fu_266_p2 = (blockID_cast1_cast_fu_263_p1 + 10'd1);
assign tmp_17_fu_241_p3 = select_ln52_fu_213_p3[32'd1];
...
assign zext_ln55_1_fu_280_p1 = thr_add23_reg_410;
