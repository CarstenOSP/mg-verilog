module SgdLR_sw_SgdLR_sw_Pipeline_label_24 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v2_0_address0,v2_0_ce0,v2_0_q0,v2_1_address0,v2_1_ce0,v2_1_q0,tmp_28,v0_address0,v0_ce0,v0_q0,v6_out,v6_out_ap_vld,grp_fu_313_p_din0,grp_fu_313_p_din1,grp_fu_313_p_opcode,grp_fu_313_p_dout0,grp_fu_313_p_ce,grp_fu_755_p_din0,grp_fu_755_p_din1,grp_fu_755_p_dout0,grp_fu_755_p_ce); 
...
wire   [22:0] add_ln35_2_fu_151_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v8_2_reg_226 <= ap_sig_allocacmp_v8_2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v11_reg_271 <= grp_fu_755_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        v13_reg_281 <= grp_fu_313_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_v8_2 = v8_fu_58;
    end
end
always @ (*) begin
...
assign add_ln33_fu_166_p2 = (v8_2_reg_226 + 11'd1);
assign add_ln35_2_fu_151_p4 = {{{tmp_28}, {1'd1}}, {ap_sig_allocacmp_v8_2}};
...
assign grp_fu_313_p_din0 = v12_fu_54;
assign grp_fu_313_p_din1 = v11_reg_271;
assign grp_fu_313_p_opcode = 2'd0;
assign grp_fu_755_p_ce = 1'b1;
assign grp_fu_755_p_din0 = v9_fu_191_p1;
assign grp_fu_755_p_din1 = v10_fu_195_p1;
assign icmp_ln33_fu_135_p2 = ((ap_sig_allocacmp_v8_2 == 11'd1024) ? 1'b1 : 1'b0);
assign select_ln34_fu_178_p3 = ((tmp_fu_171_p3[0:0] == 1'b1) ? v2_1_q0 : v2_0_q0);
assign tmp_fu_171_p3 = v8_2_reg_226[32'd9];
...
assign zext_ln35_fu_161_p1 = add_ln35_2_fu_151_p4;
endmodule 