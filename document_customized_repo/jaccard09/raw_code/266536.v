...
output   v19_1_ce0;
input  [63:0] v19_1_q0;
input  [63:0] mux_case_040124_reload;
input  [63:0] mux_case_141128_reload;
input  [63:0] mux_case_242132_reload;
input  [8:0] empty;
output  [8:0] v7_address0;
output   v7_ce0;
input  [63:0] v7_q0;
input  [63:0] v116_reload;
input  [63:0] mux_case_144140_reload;
...
sparsemux_7_2_64_1_1_U285(.din0(mux_case_040124_reload),.din1(mux_case_141128_reload),.din2(mux_case_242132_reload),.def(v103_fu_280_p7),.sel(select_ln177_reg_498_pp0_iter3_reg),.dout(v103_fu_280_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U286(.din0(v116_reload),.din1(mux_case_144140_reload),.din2(v116_2_reload),.def(v107_fu_323_p7),.sel(select_ln177_reg_498_pp0_iter10_reg),.dout(v107_fu_323_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v108_reg_571 <= grp_fu_3072_p_dout0;
        v109_reg_576 <= grp_fu_3076_p_dout0;
...
assign bitcast_ln183_fu_301_p1 = grp_fu_3060_p_dout0;
assign grp_fu_3060_p_ce = 1'b1;
assign grp_fu_3060_p_din0 = v103_fu_280_p9;
assign grp_fu_3060_p_din1 = v104_fu_297_p1;
assign grp_fu_3060_p_opcode = 2'd1;
assign grp_fu_3072_p_ce = 1'b1;
assign grp_fu_3072_p_din0 = v106_fu_345_p1;
assign grp_fu_3072_p_din1 = v107_reg_536;
assign grp_fu_3076_p_ce = 1'b1;
assign grp_fu_3076_p_din0 = v101_reg_566;
assign grp_fu_3076_p_din1 = v108_reg_571;
...
assign lshr_ln7_fu_374_p4 = {{select_ln177_1_fu_359_p3[5:1]}};
...
assign zext_ln177_fu_384_p1 = lshr_ln7_fu_374_p4;
