...
wire   [0:0] trunc_ln14_1_fu_565_p1;
reg   [0:0] trunc_ln14_1_reg_710;
wire   [63:0] zext_ln16_fu_587_p1;
reg   [63:0] zext_ln16_reg_714;
reg   [9:0] buff_C_addr_reg_754;
reg   [9:0] buff_C_1_addr_reg_759;
reg   [9:0] buff_C_2_addr_reg_764;
reg   [9:0] buff_C_3_addr_reg_769;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln20_fu_615_p1;
reg   [6:0] j_fu_106;
wire   [6:0] add_ln15_fu_635_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_110;
wire   [6:0] select_ln14_fu_553_p3;
reg   [11:0] indvar_flatten_fu_114;
wire   [11:0] add_ln14_1_fu_514_p2;
...
wire   [31:0] bitcast_ln16_fu_651_p1;
reg    buff_A0_ce0_local;
reg    buff_A0_1_we0_local;
wire   [31:0] bitcast_ln16_1_fu_668_p1;
...
wire   [31:0] bitcast_ln18_fu_657_p1;
reg    buff_B0_ce0_local;
reg    buff_B0_1_we0_local;
wire   [31:0] bitcast_ln18_1_fu_674_p1;
reg    buff_B0_1_ce0_local;
reg    buff_C_we0_local;
wire   [31:0] bitcast_ln20_fu_662_p1;
reg    buff_C_ce0_local;
reg    buff_C_2_we0_local;
wire   [31:0] bitcast_ln20_1_fu_679_p1;
reg    buff_C_2_ce0_local;
reg    buff_C_1_we0_local;
reg    buff_C_1_ce0_local;
reg    buff_C_3_we0_local;
reg    buff_C_3_ce0_local;
wire   [0:0] tmp_3_fu_537_p3;
wire   [6:0] add_ln14_fu_531_p2;
wire   [6:0] select_ln5_fu_545_p3;
wire   [5:0] trunc_ln14_fu_561_p1;
wire   [4:0] lshr_ln5_2_fu_569_p4;
wire   [10:0] tmp_fu_579_p3;
wire   [4:0] tmp_1_fu_597_p4;
wire   [9:0] tmp_2_fu_607_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_fu_110 <= select_ln14_fu_553_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln14_fu_508_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten_fu_114 <= add_ln14_1_fu_514_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        buff_C_1_addr_reg_759 <= zext_ln20_fu_615_p1;
        buff_C_2_addr_reg_764 <= zext_ln20_fu_615_p1;
        buff_C_3_addr_reg_769 <= zext_ln20_fu_615_p1;
        buff_C_addr_reg_754 <= zext_ln20_fu_615_p1;
        trunc_ln14_1_reg_710 <= trunc_ln14_1_fu_565_p1;
        zext_ln16_reg_714[10 : 0] <= zext_ln16_fu_587_p1[10 : 0];
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln14_fu_508_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((trunc_ln14_1_reg_710 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((trunc_ln14_1_reg_710 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((trunc_ln14_1_fu_565_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((trunc_ln14_1_fu_565_p1 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign A_0_address0 = zext_ln16_fu_587_p1;
assign A_0_ce0 = A_0_ce0_local;
assign A_1_address0 = zext_ln16_fu_587_p1;
assign A_1_ce0 = A_1_ce0_local;
assign B_0_address0 = zext_ln16_fu_587_p1;
assign B_0_ce0 = B_0_ce0_local;
assign B_1_address0 = zext_ln16_fu_587_p1;
assign B_1_ce0 = B_1_ce0_local;
assign C_0_address0 = zext_ln16_fu_587_p1;
assign C_0_ce0 = C_0_ce0_local;
assign C_1_address0 = zext_ln16_fu_587_p1;
assign C_1_ce0 = C_1_ce0_local;
assign add_ln14_1_fu_514_p2 = (ap_sig_allocacmp_indvar_flatten_load + 12'd1);
assign add_ln14_fu_531_p2 = (i_fu_110 + 7'd1);
assign add_ln15_fu_635_p2 = (select_ln5_fu_545_p3 + 7'd2);
...
assign bitcast_ln16_1_fu_668_p1 = A_1_q0;
assign bitcast_ln16_fu_651_p1 = A_0_q0;
assign bitcast_ln18_1_fu_674_p1 = B_1_q0;
assign bitcast_ln18_fu_657_p1 = B_0_q0;
assign bitcast_ln20_1_fu_679_p1 = C_1_q0;
assign bitcast_ln20_fu_662_p1 = C_0_q0;
assign buff_A0_1_address0 = zext_ln16_reg_714;
assign buff_A0_1_ce0 = buff_A0_1_ce0_local;
assign buff_A0_1_d0 = bitcast_ln16_1_fu_668_p1;
assign buff_A0_1_we0 = buff_A0_1_we0_local;
assign buff_A0_address0 = zext_ln16_reg_714;
assign buff_A0_ce0 = buff_A0_ce0_local;
assign buff_A0_d0 = bitcast_ln16_fu_651_p1;
assign buff_A0_we0 = buff_A0_we0_local;
assign buff_A1_1_address0 = zext_ln16_reg_714;
assign buff_A1_1_ce0 = buff_A1_1_ce0_local;
assign buff_A1_1_d0 = bitcast_ln16_1_fu_668_p1;
assign buff_A1_1_we0 = buff_A1_1_we0_local;
assign buff_A1_address0 = zext_ln16_reg_714;
assign buff_A1_ce0 = buff_A1_ce0_local;
assign buff_A1_d0 = bitcast_ln16_fu_651_p1;
assign buff_A1_we0 = buff_A1_we0_local;
assign buff_B0_1_address0 = zext_ln16_reg_714;
assign buff_B0_1_ce0 = buff_B0_1_ce0_local;
assign buff_B0_1_d0 = bitcast_ln18_1_fu_674_p1;
assign buff_B0_1_we0 = buff_B0_1_we0_local;
assign buff_B0_address0 = zext_ln16_reg_714;
assign buff_B0_ce0 = buff_B0_ce0_local;
assign buff_B0_d0 = bitcast_ln18_fu_657_p1;
assign buff_B0_we0 = buff_B0_we0_local;
assign buff_C_1_address0 = buff_C_1_addr_reg_759;
assign buff_C_1_ce0 = buff_C_1_ce0_local;
assign buff_C_1_d0 = bitcast_ln20_fu_662_p1;
assign buff_C_1_we0 = buff_C_1_we0_local;
assign buff_C_2_address0 = buff_C_2_addr_reg_764;
assign buff_C_2_ce0 = buff_C_2_ce0_local;
assign buff_C_2_d0 = bitcast_ln20_1_fu_679_p1;
assign buff_C_2_we0 = buff_C_2_we0_local;
assign buff_C_3_address0 = buff_C_3_addr_reg_769;
assign buff_C_3_ce0 = buff_C_3_ce0_local;
assign buff_C_3_d0 = bitcast_ln20_1_fu_679_p1;
assign buff_C_3_we0 = buff_C_3_we0_local;
assign buff_C_address0 = buff_C_addr_reg_754;
assign buff_C_ce0 = buff_C_ce0_local;
assign buff_C_d0 = bitcast_ln20_fu_662_p1;
assign buff_C_we0 = buff_C_we0_local;
assign buff_D_out_1_address0 = zext_ln20_fu_615_p1;
assign buff_D_out_1_ce0 = buff_D_out_1_ce0_local;
assign buff_D_out_1_d0 = 32'd0;
assign buff_D_out_1_we0 = buff_D_out_1_we0_local;
assign buff_D_out_2_address0 = zext_ln20_fu_615_p1;
assign buff_D_out_2_ce0 = buff_D_out_2_ce0_local;
assign buff_D_out_2_d0 = 32'd0;
assign buff_D_out_2_we0 = buff_D_out_2_we0_local;
assign buff_D_out_3_address0 = zext_ln20_fu_615_p1;
assign buff_D_out_3_ce0 = buff_D_out_3_ce0_local;
assign buff_D_out_3_d0 = 32'd0;
assign buff_D_out_3_we0 = buff_D_out_3_we0_local;
assign buff_D_out_address0 = zext_ln20_fu_615_p1;
assign buff_D_out_ce0 = buff_D_out_ce0_local;
assign buff_D_out_d0 = 32'd0;
assign buff_D_out_we0 = buff_D_out_we0_local;
assign icmp_ln14_fu_508_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_569_p4 = {{select_ln5_fu_545_p3[5:1]}};
assign select_ln14_fu_553_p3 = ((tmp_3_fu_537_p3[0:0] == 1'b1) ? add_ln14_fu_531_p2 : i_fu_110);
assign select_ln5_fu_545_p3 = ((tmp_3_fu_537_p3[0:0] == 1'b1) ? 7'd0 : j_fu_106);
assign tmp1_1_address0 = zext_ln20_fu_615_p1;
assign tmp1_1_ce0 = tmp1_1_ce0_local;
assign tmp1_1_d0 = 32'd0;
assign tmp1_1_we0 = tmp1_1_we0_local;
assign tmp1_2_address0 = zext_ln20_fu_615_p1;
assign tmp1_2_ce0 = tmp1_2_ce0_local;
assign tmp1_2_d0 = 32'd0;
assign tmp1_2_we0 = tmp1_2_we0_local;
assign tmp1_3_address0 = zext_ln20_fu_615_p1;
assign tmp1_3_ce0 = tmp1_3_ce0_local;
assign tmp1_3_d0 = 32'd0;
assign tmp1_3_we0 = tmp1_3_we0_local;
assign tmp1_address0 = zext_ln20_fu_615_p1;
assign tmp1_ce0 = tmp1_ce0_local;
assign tmp1_d0 = 32'd0;
assign tmp1_we0 = tmp1_we0_local;
assign tmp2_1_address0 = zext_ln20_fu_615_p1;
assign tmp2_1_ce0 = tmp2_1_ce0_local;
assign tmp2_1_d0 = 32'd0;
assign tmp2_1_we0 = tmp2_1_we0_local;
assign tmp2_2_address0 = zext_ln20_fu_615_p1;
assign tmp2_2_ce0 = tmp2_2_ce0_local;
assign tmp2_2_d0 = 32'd0;
assign tmp2_2_we0 = tmp2_2_we0_local;
assign tmp2_3_address0 = zext_ln20_fu_615_p1;
assign tmp2_3_ce0 = tmp2_3_ce0_local;
assign tmp2_3_d0 = 32'd0;
assign tmp2_3_we0 = tmp2_3_we0_local;
assign tmp2_address0 = zext_ln20_fu_615_p1;
assign tmp2_ce0 = tmp2_ce0_local;
assign tmp2_d0 = 32'd0;
assign tmp2_we0 = tmp2_we0_local;
assign tmp_1_fu_597_p4 = {{select_ln14_fu_553_p3[5:1]}};
assign tmp_2_fu_607_p3 = {{tmp_1_fu_597_p4}, {lshr_ln5_2_fu_569_p4}};
assign tmp_3_fu_537_p3 = j_fu_106[32'd6];
assign tmp_fu_579_p3 = {{trunc_ln14_fu_561_p1}, {lshr_ln5_2_fu_569_p4}};
assign trunc_ln14_1_fu_565_p1 = select_ln14_fu_553_p3[0:0];
assign trunc_ln14_fu_561_p1 = select_ln14_fu_553_p3[5:0];
assign zext_ln16_fu_587_p1 = tmp_fu_579_p3;
assign zext_ln20_fu_615_p1 = tmp_2_fu_607_p3;
always @ (posedge ap_clk) begin
    zext_ln16_reg_714[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
end
endmodule 