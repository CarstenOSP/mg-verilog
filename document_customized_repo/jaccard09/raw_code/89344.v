...
sparsemux_9_3_32_1_1_U66(.din0(buff_x_q0),.din1(buff_x_2_q0),.din2(buff_x_4_q0),.din3(buff_x_6_q0),.def(tmp_5_fu_673_p9),.sel(trunc_ln32_fu_652_p1),.dout(tmp_5_fu_673_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U67(.din0(buff_x_1_q0),.din1(buff_x_3_q0),.din2(buff_x_5_q0),.din3(buff_x_7_q0),.def(tmp_7_fu_697_p9),.sel(trunc_ln32_fu_652_p1),.dout(tmp_7_fu_697_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U68(.din0(buff_B_q0),.din1(buff_B_2_q0),.din2(buff_B_4_q0),.din3(buff_B_6_q0),.def(tmp_4_fu_721_p9),.sel(trunc_ln32_reg_945),.dout(tmp_4_fu_721_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U69(.din0(buff_B_1_q0),.din1(buff_B_3_q0),.din2(buff_B_5_q0),.din3(buff_B_7_q0),.def(tmp_6_fu_744_p9),.sel(trunc_ln32_reg_945),.dout(tmp_6_fu_744_p11));
