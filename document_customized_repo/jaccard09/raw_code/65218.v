...
wire   [11:0] tmp_38_fu_534_p3;
reg   [11:0] tmp_38_reg_734;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_22_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_22_out_ap_vld;
...
wire   [63:0] tmp_53_cast_fu_406_p1;
...
dcmp_64ns_64ns_1_2_no_dsp_1_U51(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_754_p0),.din1(grp_fu_754_p1),.ce(grp_fu_754_ce),.opcode(grp_fu_754_opcode),.dout(grp_fu_754_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_3_reg_659[11 : 4] <= tmp_53_cast_fu_406_p1[11 : 4];
        tmp_s_reg_654[11 : 4] <= tmp_s_fu_398_p3[11 : 4];
        zext_ln19_reg_664[7 : 0] <= zext_ln19_fu_411_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_22_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_22_loc_fu_108 <= grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_22_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        tmp_38_reg_734[11 : 4] <= tmp_38_fu_534_p3[11 : 4];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_22_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_22_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_22_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
assign tmp_38_fu_534_p3 = {{trunc_ln50_fu_530_p1}, {4'd0}};
assign tmp_39_fu_486_p3 = {{t_2_reg_622}, {lshr_ln7_reg_687}};
assign tmp_53_cast_fu_406_p1 = tmp_s_fu_398_p3;
