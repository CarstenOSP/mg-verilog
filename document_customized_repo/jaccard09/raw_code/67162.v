...
reg   [0:0] icmp_ln132_reg_363;
reg    ap_condition_exit_pp0_iter0_stage6;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [6:0] i_reg_357;
wire   [0:0] icmp_ln132_fu_235_p2;
reg   [0:0] icmp_ln132_reg_363_pp0_iter1_reg;
reg   [0:0] icmp_ln132_reg_363_pp0_iter2_reg;
reg   [0:0] icmp_ln132_reg_363_pp0_iter3_reg;
wire   [63:0] tmp_fu_281_p19;
reg   [63:0] tmp_reg_407;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] biases1_addr_reg_412;
reg   [5:0] biases1_addr_reg_412_pp0_iter1_reg;
reg   [5:0] biases1_addr_reg_412_pp0_iter2_reg;
reg   [63:0] mul_reg_417;
reg   [63:0] biases1_load_reg_422;
wire   [63:0] bitcast_ln133_fu_321_p1;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [63:0] grp_fu_213_p2;
reg   [63:0] sub1_reg_432;
reg   [63:0] mul1_reg_439;
...
wire   [63:0] zext_ln132_fu_274_p1;
wire    ap_block_pp0_stage1;
reg   [63:0] bias_norm_1_fu_82;
...
wire   [63:0] bitcast_ln133_1_fu_325_p1;
reg   [63:0] grp_fu_213_p0;
reg   [63:0] grp_fu_213_p1;
wire    ap_block_pp0_stage2;
reg   [63:0] grp_fu_217_p0;
reg   [63:0] grp_fu_217_p1;
wire   [2:0] lshr_ln1_fu_247_p4;
wire   [63:0] tmp_fu_281_p17;
wire   [2:0] tmp_fu_281_p18;
...
wire   [2:0] tmp_fu_281_p5;
wire   [2:0] tmp_fu_281_p7;
wire  signed [2:0] tmp_fu_281_p9;
wire  signed [2:0] tmp_fu_281_p11;
wire  signed [2:0] tmp_fu_281_p13;
wire  signed [2:0] tmp_fu_281_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 7'd1;
...
#0 bias_norm_1_fu_82 = 64'd0;
#0 i_1_fu_86 = 7'd0;
#0 ap_done_reg = 1'b0;
end
backprop_dadddsub_64ns_64ns_64_8_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 8 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dadddsub_64ns_64ns_64_8_full_dsp_1_U389(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_213_p0),.din1(grp_fu_213_p1),.opcode(grp_fu_213_opcode),.ce(1'b1),.dout(grp_fu_213_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U391(.din0(d_biases1_0_q0),.din1(d_biases1_1_q0),.din2(d_biases1_2_q0),.din3(d_biases1_3_q0),.din4(d_biases1_4_q0),.din5(d_biases1_5_q0),.din6(d_biases1_6_q0),.din7(d_biases1_7_q0),.def(tmp_fu_281_p17),.sel(tmp_fu_281_p18),.dout(tmp_fu_281_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        bias_norm_1_fu_82 <= 64'd0;
    end else if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        bias_norm_1_fu_82 <= grp_fu_213_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln132_fu_235_p2 == 1'd0))) begin
            i_1_fu_86 <= add_ln132_fu_241_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        biases1_addr_reg_412 <= zext_ln132_fu_274_p1;
        biases1_addr_reg_412_pp0_iter1_reg <= biases1_addr_reg_412;
        biases1_addr_reg_412_pp0_iter2_reg <= biases1_addr_reg_412_pp0_iter1_reg;
        tmp_reg_407 <= tmp_fu_281_p19;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        biases1_load_reg_422 <= biases1_q0;
        mul_reg_417 <= grp_fu_581_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_reg_357 <= ap_sig_allocacmp_i;
        icmp_ln132_reg_363 <= icmp_ln132_fu_235_p2;
        icmp_ln132_reg_363_pp0_iter1_reg <= icmp_ln132_reg_363;
        icmp_ln132_reg_363_pp0_iter2_reg <= icmp_ln132_reg_363_pp0_iter1_reg;
        icmp_ln132_reg_363_pp0_iter3_reg <= icmp_ln132_reg_363_pp0_iter2_reg;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        mul1_reg_439 <= grp_fu_581_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        sub1_reg_432 <= grp_fu_213_p2;
    end
end
always @ (*) begin
    if (((icmp_ln132_reg_363 == 1'd1) & (1'b0 == ap_block_pp0_stage6_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_subdone) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (icmp_ln132_reg_363_pp0_iter3_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ap_sig_allocacmp_bias_norm_1_load = grp_fu_213_p2;
    end else begin
        ap_sig_allocacmp_bias_norm_1_load = bias_norm_1_fu_82;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_loop_exit_ready_pp0_iter3_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (icmp_ln132_reg_363_pp0_iter3_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        biases1_address0_local = biases1_addr_reg_412_pp0_iter2_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        biases1_address0_local = biases1_addr_reg_412;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_213_p0 = ap_sig_allocacmp_bias_norm_1_load;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_213_p0 = bitcast_ln133_fu_321_p1;
    end else begin
        grp_fu_213_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_213_p1 = mul1_reg_439;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_213_p1 = mul_reg_417;
    end else begin
        grp_fu_213_p1 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_217_p0 = sub1_reg_432;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_217_p0 = tmp_reg_407;
    end else begin
        grp_fu_217_p0 = 'bx;
    end
end
...
assign add_ln132_fu_241_p2 = (ap_sig_allocacmp_i + 7'd1);
...
assign bias_norm_1_out = bias_norm_1_fu_82;
assign biases1_address0 = biases1_address0_local;
assign biases1_ce0 = biases1_ce0_local;
assign biases1_d0 = bitcast_ln133_1_fu_325_p1;
assign biases1_we0 = biases1_we0_local;
assign bitcast_ln133_1_fu_325_p1 = sub1_reg_432;
assign bitcast_ln133_fu_321_p1 = biases1_load_reg_422;
assign d_biases1_0_address0 = zext_ln121_fu_257_p1;
assign d_biases1_0_ce0 = d_biases1_0_ce0_local;
assign d_biases1_1_address0 = zext_ln121_fu_257_p1;
assign d_biases1_1_ce0 = d_biases1_1_ce0_local;
assign d_biases1_2_address0 = zext_ln121_fu_257_p1;
assign d_biases1_2_ce0 = d_biases1_2_ce0_local;
assign d_biases1_3_address0 = zext_ln121_fu_257_p1;
assign d_biases1_3_ce0 = d_biases1_3_ce0_local;
assign d_biases1_4_address0 = zext_ln121_fu_257_p1;
assign d_biases1_4_ce0 = d_biases1_4_ce0_local;
assign d_biases1_5_address0 = zext_ln121_fu_257_p1;
assign d_biases1_5_ce0 = d_biases1_5_ce0_local;
assign d_biases1_6_address0 = zext_ln121_fu_257_p1;
assign d_biases1_6_ce0 = d_biases1_6_ce0_local;
assign d_biases1_7_address0 = zext_ln121_fu_257_p1;
assign d_biases1_7_ce0 = d_biases1_7_ce0_local;
assign grp_fu_581_p_ce = 1'b1;
assign grp_fu_581_p_din0 = grp_fu_217_p0;
assign grp_fu_581_p_din1 = grp_fu_217_p1;
assign icmp_ln132_fu_235_p2 = ((ap_sig_allocacmp_i == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln1_fu_247_p4 = {{ap_sig_allocacmp_i[5:3]}};
assign tmp_fu_281_p17 = 'bx;
assign tmp_fu_281_p18 = i_reg_357[2:0];
assign zext_ln121_fu_257_p1 = lshr_ln1_fu_247_p4;
assign zext_ln132_fu_274_p1 = i_reg_357;
endmodule 