...
wire  signed [2:0] tmp_1_fu_715_p5;
wire  signed [2:0] tmp_1_fu_715_p7;
...
sparsemux_9_3_32_1_1_U933(.din0(tmp1_q0),.din1(tmp1_2_q0),.din2(tmp1_4_q0),.din3(tmp1_6_q0),.def(tmp_1_fu_715_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_1_fu_715_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U934(.din0(tmp2_q0),.din1(tmp2_2_q0),.din2(tmp2_4_q0),.din3(tmp2_6_q0),.def(tmp_2_fu_738_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_2_fu_738_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U935(.din0(tmp1_1_q0),.din1(tmp1_3_q0),.din2(tmp1_5_q0),.din3(tmp1_7_q0),.def(tmp_4_fu_761_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_4_fu_761_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U936(.din0(tmp2_1_q0),.din1(tmp2_3_q0),.din2(tmp2_5_q0),.din3(tmp2_7_q0),.def(tmp_5_fu_784_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_5_fu_784_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U937(.din0(buff_C_q0),.din1(buff_C_2_q0),.din2(buff_C_4_q0),.din3(buff_C_6_q0),.def(tmp_3_fu_807_p9),.sel(trunc_ln46_1_reg_884_pp0_iter4_reg),.dout(tmp_3_fu_807_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U938(.din0(buff_C_1_q0),.din1(buff_C_3_q0),.din2(buff_C_5_q0),.din3(buff_C_7_q0),.def(tmp_6_fu_830_p9),.sel(trunc_ln46_1_reg_884_pp0_iter4_reg),.dout(tmp_6_fu_830_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add135_1_reg_1074 <= grp_fu_708_p_dout0;
        add141_1_reg_1092 <= grp_fu_716_p_dout0;
        add2_reg_1064 <= grp_fu_704_p_dout0;
        add3_reg_1084 <= grp_fu_712_p_dout0;
        ...
        mul140_1_reg_1079 <= grp_fu_964_p_dout0;
        mul4_reg_1069 <= grp_fu_960_p_dout0;
        tmp_1_reg_994 <= tmp_1_fu_715_p11;
...
assign grp_fu_704_p_din0 = tmp_1_reg_994;
assign grp_fu_704_p_din1 = tmp_2_reg_999;
assign grp_fu_704_p_opcode = 2'd0;
assign grp_fu_708_p_ce = 1'b1;
assign grp_fu_708_p_din0 = tmp_4_reg_1004;
assign grp_fu_708_p_din1 = tmp_5_reg_1009;
assign grp_fu_708_p_opcode = 2'd0;
assign grp_fu_712_p_ce = 1'b1;
assign grp_fu_712_p_din0 = add2_reg_1064;
assign grp_fu_712_p_din1 = mul4_reg_1069;
assign grp_fu_712_p_opcode = 2'd0;
assign grp_fu_716_p_ce = 1'b1;
assign grp_fu_716_p_din0 = add135_1_reg_1074;
assign grp_fu_716_p_din1 = mul140_1_reg_1079;
assign grp_fu_716_p_opcode = 2'd0;
assign grp_fu_960_p_ce = 1'b1;
assign grp_fu_960_p_din0 = tmp_3_reg_1054;
assign grp_fu_960_p_din1 = beta;
assign grp_fu_964_p_ce = 1'b1;
assign grp_fu_964_p_din0 = tmp_6_reg_1059;
