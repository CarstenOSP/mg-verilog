...
sparsemux_9_3_32_1_1_U14(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_s_fu_361_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_s_fu_361_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U15(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_1_fu_385_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_1_fu_385_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        i_1_fu_116 <= add_ln124_fu_568_p2;
    end
end
always @ (posedge ap_clk) begin
...
assign A_out = B_3_fu_112;
assign B_42_out = B_fu_108;
assign B_5_fu_482_p2 = (add_ln126_fu_476_p2 + add_ln126_2_fu_470_p2);
assign C_6_fu_560_p3 = {{trunc_ln126_3_fu_546_p1}, {lshr_ln126_3_fu_550_p4}};
assign D_4_fu_502_p3 = {{trunc_ln126_1_fu_488_p1}, {lshr_ln126_1_fu_492_p4}};
assign D_out = E_4_fu_104;
assign E_28_out = E_fu_100;
assign E_47_out = D_fu_120;
...
assign add_ln124_fu_568_p2 = (i_reg_689 + 6'd2);
...
assign icmp_ln124_fu_326_p2 = ((ap_sig_allocacmp_i < 6'd60) ? 1'b1 : 1'b0);
assign lshr_ln126_1_fu_492_p4 = {{B_fu_108[31:2]}};
assign lshr_ln126_3_fu_550_p4 = {{B_3_fu_112[31:2]}};
assign lshr_ln5_fu_332_p4 = {{ap_sig_allocacmp_i[5:3]}};
assign lshr_ln6_fu_425_p4 = {{B_3_fu_112[31:27]}};
assign or_ln126_1_fu_451_p2 = (and_ln126_fu_440_p2 | and_ln126_1_fu_446_p2);
assign or_ln126_2_fu_457_p3 = {{trunc_ln126_fu_421_p1}, {lshr_ln6_fu_425_p4}};
...
assign trunc_ln100_fu_358_p1 = i_reg_689[2:0];
...
assign zext_ln100_fu_342_p1 = lshr_ln5_fu_332_p4;
endmodule 