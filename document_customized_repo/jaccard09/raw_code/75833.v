...
reg   [5:0] tmp_44_reg_1777;
reg   [5:0] tmp_44_reg_1777_pp0_iter11_reg;
reg   [5:0] tmp_44_reg_1777_pp0_iter12_reg;
...
wire   [20:0] tmp_45_fu_1082_p1;
wire  signed [20:0] grp_fu_1690_p3;
wire   [6:0] tmp_45_fu_1082_p4;
wire   [20:0] tmp_46_fu_1106_p1;
wire  signed [20:0] grp_fu_1699_p3;
wire   [6:0] tmp_46_fu_1106_p4;
wire   [20:0] tmp_47_fu_1130_p1;
wire  signed [20:0] grp_fu_1708_p3;
wire   [6:0] tmp_47_fu_1130_p4;
wire   [20:0] tmp_48_fu_1154_p1;
wire  signed [20:0] grp_fu_1717_p3;
wire   [6:0] tmp_48_fu_1154_p4;
wire   [20:0] tmp_49_fu_1178_p1;
wire  signed [20:0] grp_fu_1726_p3;
wire   [6:0] tmp_49_fu_1178_p4;
wire   [20:0] tmp_50_fu_1202_p1;
wire  signed [20:0] grp_fu_1735_p3;
wire   [6:0] tmp_50_fu_1202_p4;
wire   [20:0] tmp_51_fu_1226_p1;
wire  signed [20:0] grp_fu_1744_p3;
wire   [6:0] tmp_51_fu_1226_p4;
...
wire   [9:0] zext_ln172_8_fu_1042_p1;
...
urem_9ns_5ns_4_13_1_U773(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1031_p0),.din1(grp_fu_1031_p1),.ce(1'b1),.dout(grp_fu_1031_p2));
fft1D_512_mul_9ns_11ns_19_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 9 ),.din1_WIDTH( 11 ),.dout_WIDTH( 19 ))
mul_9ns_11ns_19_1_1_U774(.din0(mul_ln172_1_fu_1048_p0),.din1(mul_ln172_1_fu_1048_p1),.dout(mul_ln172_1_fu_1048_p2));
...
sparsemux_23_4_64_1_1_U775(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_s_fu_1250_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_s_fu_1250_p25));
...
sparsemux_23_4_64_1_1_U776(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_20_fu_1301_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_20_fu_1301_p25));
...
sparsemux_23_4_64_1_1_U777(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_21_fu_1352_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_21_fu_1352_p25));
...
sparsemux_23_4_64_1_1_U778(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_22_fu_1403_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_22_fu_1403_p25));
...
sparsemux_23_4_64_1_1_U779(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_23_fu_1454_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_23_fu_1454_p25));
...
sparsemux_23_4_64_1_1_U780(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_24_fu_1505_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_24_fu_1505_p25));
...
sparsemux_23_4_64_1_1_U781(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_25_fu_1556_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_25_fu_1556_p25));
...
sparsemux_23_4_64_1_1_U782(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.din5(smem_5_q0),.din6(smem_6_q0),.din7(smem_7_q0),.din8(smem_8_q0),.din9(smem_9_q0),.din10(smem_10_q0),.def(tmp_26_fu_1607_p23),.sel(trunc_ln172_reg_1782_pp0_iter13_reg),.dout(tmp_26_fu_1607_p25));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U783(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1690_p0),.din1(grp_fu_1690_p1),.din2(grp_fu_1690_p2),.ce(1'b1),.dout(grp_fu_1690_p3));
fft1D_512_am_addmul_9ns_4ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 4 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_4ns_11ns_21_4_1_U784(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1699_p0),.din1(grp_fu_1699_p1),.din2(grp_fu_1699_p2),.ce(1'b1),.dout(grp_fu_1699_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U785(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1708_p0),.din1(grp_fu_1708_p1),.din2(grp_fu_1708_p2),.ce(1'b1),.dout(grp_fu_1708_p3));
fft1D_512_am_addmul_9ns_5ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 5 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_5ns_11ns_21_4_1_U786(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1717_p0),.din1(grp_fu_1717_p1),.din2(grp_fu_1717_p2),.ce(1'b1),.dout(grp_fu_1717_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U787(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1726_p0),.din1(grp_fu_1726_p1),.din2(grp_fu_1726_p2),.ce(1'b1),.dout(grp_fu_1726_p3));
fft1D_512_am_addmul_9ns_5ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 5 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_5ns_11ns_21_4_1_U788(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1735_p0),.din1(grp_fu_1735_p1),.din2(grp_fu_1735_p2),.ce(1'b1),.dout(grp_fu_1735_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U789(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1744_p0),.din1(grp_fu_1744_p1),.din2(grp_fu_1744_p2),.ce(1'b1),.dout(grp_fu_1744_p3));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_44_reg_1777 <= {{mul_ln172_1_fu_1048_p2[18:13]}};
        tmp_44_reg_1777_pp0_iter11_reg <= tmp_44_reg_1777;
        tmp_44_reg_1777_pp0_iter12_reg <= tmp_44_reg_1777_pp0_iter11_reg;
...
assign tmp_45_fu_1082_p1 = grp_fu_1690_p3;
assign tmp_45_fu_1082_p4 = {{tmp_45_fu_1082_p1[20:14]}};
assign tmp_46_fu_1106_p1 = grp_fu_1699_p3;
assign tmp_46_fu_1106_p4 = {{tmp_46_fu_1106_p1[20:14]}};
assign tmp_47_fu_1130_p1 = grp_fu_1708_p3;
assign tmp_47_fu_1130_p4 = {{tmp_47_fu_1130_p1[20:14]}};
assign tmp_48_fu_1154_p1 = grp_fu_1717_p3;
assign tmp_48_fu_1154_p4 = {{tmp_48_fu_1154_p1[20:14]}};
assign tmp_49_fu_1178_p1 = grp_fu_1726_p3;
assign tmp_49_fu_1178_p4 = {{tmp_49_fu_1178_p1[20:14]}};
assign tmp_50_fu_1202_p1 = grp_fu_1735_p3;
assign tmp_50_fu_1202_p4 = {{tmp_50_fu_1202_p1[20:14]}};
assign tmp_51_fu_1226_p1 = grp_fu_1744_p3;
assign tmp_51_fu_1226_p4 = {{tmp_51_fu_1226_p1[20:14]}};
...
assign zext_ln172_1_fu_1068_p1 = tmp_44_reg_1777_pp0_iter12_reg;
assign zext_ln172_8_fu_1042_p1 = offset_1_reg_1770_pp0_iter9_reg;
assign zext_ln314_fu_1666_p1 = shl_ln314_fu_1661_p2;
assign zext_ln315_1_fu_1682_p1 = or_ln_fu_1674_p3;
assign zext_ln315_fu_1091_p1 = tmp_45_fu_1082_p4;
assign zext_ln316_fu_1115_p1 = tmp_46_fu_1106_p4;
assign zext_ln317_fu_1139_p1 = tmp_47_fu_1130_p4;
assign zext_ln318_fu_1163_p1 = tmp_48_fu_1154_p4;
assign zext_ln319_fu_1187_p1 = tmp_49_fu_1178_p4;
assign zext_ln320_fu_1211_p1 = tmp_50_fu_1202_p4;
assign zext_ln321_fu_1235_p1 = tmp_51_fu_1226_p4;
endmodule 