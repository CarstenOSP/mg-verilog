...
sparsemux_17_5_32_1_1_U172(.din0(W_load_6),.din1(W_4_load_6),.din2(W_8_load_7),.din3(W_12_load_7),.din4(W_16_load_7),.din5(W_20_load_6),.din6(W_24_load_6),.din7(W_28_load_6),.def(tmp_4_fu_1014_p17),.sel(trunc_ln15_fu_952_p1),.dout(tmp_4_fu_1014_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h1C ),.din0_WIDTH( 32 ),.CASE1( 5'h0 ),.din1_WIDTH( 32 ),.CASE2( 5'h4 ),.din2_WIDTH( 32 ),.CASE3( 5'h8 ),.din3_WIDTH( 32 ),.CASE4( 5'hC ),.din4_WIDTH( 32 ),.CASE5( 5'h10 ),.din5_WIDTH( 32 ),.CASE6( 5'h14 ),.din6_WIDTH( 32 ),.CASE7( 5'h18 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U173(.din0(W_1_load_6),.din1(W_5_load_6),.din2(W_9_load_7),.din3(W_13_load_7),.din4(W_17_load_7),.din5(W_21_load_6),.din6(W_25_load_6),.din7(W_29_load_6),.def(tmp_5_fu_1054_p17),.sel(trunc_ln15_fu_952_p1),.dout(tmp_5_fu_1054_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h1C ),.din0_WIDTH( 32 ),.CASE1( 5'h0 ),.din1_WIDTH( 32 ),.CASE2( 5'h4 ),.din2_WIDTH( 32 ),.CASE3( 5'h8 ),.din3_WIDTH( 32 ),.CASE4( 5'hC ),.din4_WIDTH( 32 ),.CASE5( 5'h10 ),.din5_WIDTH( 32 ),.CASE6( 5'h14 ),.din6_WIDTH( 32 ),.CASE7( 5'h18 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U174(.din0(W_2_load_6),.din1(W_6_load_6),.din2(W_10_load_7),.din3(W_14_load_7),.din4(W_18_load_7),.din5(W_22_load_6),.din6(W_26_load_6),.din7(W_30_load_6),.def(tmp_6_fu_1094_p17),.sel(trunc_ln15_fu_952_p1),.dout(tmp_6_fu_1094_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h1C ),.din0_WIDTH( 32 ),.CASE1( 5'h0 ),.din1_WIDTH( 32 ),.CASE2( 5'h4 ),.din2_WIDTH( 32 ),.CASE3( 5'h8 ),.din3_WIDTH( 32 ),.CASE4( 5'hC ),.din4_WIDTH( 32 ),.CASE5( 5'h10 ),.din5_WIDTH( 32 ),.CASE6( 5'h14 ),.din6_WIDTH( 32 ),.CASE7( 5'h18 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U175(.din0(W_3_load_6),.din1(W_7_load_6),.din2(W_11_load_7),.din3(W_15_load_7),.din4(W_19_load_7),.din5(W_23_load_6),.din6(W_27_load_6),.din7(W_31_load_6),.def(tmp_7_fu_1134_p17),.sel(trunc_ln15_fu_952_p1),.dout(tmp_7_fu_1134_p19));
...
sparsemux_17_5_32_1_1_U176(.din0(W_q0),.din1(W_4_q0),.din2(W_8_q0),.din3(W_12_q0),.din4(W_16_q0),.din5(W_20_q0),.din6(W_24_q0),.din7(W_28_q0),.def(tmp_s_fu_1174_p17),.sel(trunc_ln15_reg_2010),.dout(tmp_s_fu_1174_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U177(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.din4(W_17_q0),.din5(W_21_q0),.din6(W_25_q0),.din7(W_29_q0),.def(tmp_1_fu_1213_p17),.sel(trunc_ln15_reg_2010),.dout(tmp_1_fu_1213_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U178(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.din4(W_18_q0),.din5(W_22_q0),.din6(W_26_q0),.din7(W_30_q0),.def(tmp_2_fu_1252_p17),.sel(trunc_ln15_reg_2010),.dout(tmp_2_fu_1252_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U179(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.din4(W_19_q0),.din5(W_23_q0),.din6(W_27_q0),.din7(W_31_q0),.def(tmp_3_fu_1291_p17),.sel(trunc_ln15_reg_2010),.dout(tmp_3_fu_1291_p19));
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln128_reg_2178 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        C_26_out_ap_vld = 1'b1;
    end else begin
        C_26_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln128_reg_2178 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
...
assign C_26_out = C_4_reg_2283;
assign C_27_out = C_5_reg_2321;
assign C_28_out = {{trunc_ln130_7_reg_2305}, {lshr_ln130_7_reg_2310}};
...
assign add_ln130_2_fu_1384_p2 = (add_ln130_1_fu_1379_p2 + or_ln2_fu_1371_p3);
...
assign or_ln2_fu_1371_p3 = {{trunc_ln130_fu_1345_p1}, {lshr_ln6_fu_1349_p4}};
...
assign temp_6_out = temp_2_reg_2315;
assign temp_7_fu_1953_p2 = (add_ln130_29_reg_2431 + add_ln130_30_fu_1949_p2);
assign temp_7_out = (add_ln130_12_fu_1650_p2 + or_ln130_6_fu_1644_p3);
