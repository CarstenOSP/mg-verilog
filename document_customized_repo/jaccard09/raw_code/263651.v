module backprop_backprop_Pipeline_label_25_label_26 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,phi_mul316,v6_address0,v6_ce0,v6_q0,v9_address0,v9_ce0,v9_q0,v12_address0,v12_ce0,v12_we0,v12_d0,grp_fu_5588_p_din0,grp_fu_5588_p_din1,grp_fu_5588_p_dout0,grp_fu_5588_p_ce); 
...
wire    ap_loop_init;
reg   [3:0] v140_fu_58;
reg   [9:0] indvar_flatten148_fu_62;
wire   [9:0] add_ln233_fu_139_p2;
reg   [9:0] ap_sig_allocacmp_indvar_flatten148_load;
reg    v6_ce0_local;
reg    v9_ce0_local;
reg    v12_we0_local;
reg    v12_ce0_local;
...
#0 v142_fu_54 = 7'd0;
#0 v140_fu_58 = 4'd0;
#0 indvar_flatten148_fu_62 = 10'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln233_fu_133_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten148_fu_62 <= add_ln233_fu_139_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten148_fu_62 <= 10'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v143_reg_303 <= v9_q0;
        v144_reg_313 <= grp_fu_5588_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_indvar_flatten148_load = 10'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten148_load = indvar_flatten148_fu_62;
    end
end
always @ (*) begin
...
assign add_ln233_fu_139_p2 = (ap_sig_allocacmp_indvar_flatten148_load + 10'd1);
assign add_ln234_fu_203_p2 = (zext_ln233_fu_200_p1 + phi_mul316);
...
assign grp_fu_5588_p_din0 = v141_fu_233_p1;
assign grp_fu_5588_p_din1 = v143_reg_303;
assign icmp_ln233_fu_133_p2 = ((ap_sig_allocacmp_indvar_flatten148_load == 10'd832) ? 1'b1 : 1'b0);
