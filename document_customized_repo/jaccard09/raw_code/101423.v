module gesummv_gesummv_Pipeline_lp3_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_B_address0,buff_B_ce0,buff_B_q0,buff_B_address1,buff_B_ce1,buff_B_q1,beta,p_reload261,p_reload259,p_reload257,p_reload255,p_reload253,p_reload251,p_reload249,p_reload247,p_reload245,p_reload243,p_reload241,p_reload239,p_reload237,p_reload235,p_reload233,p_reload231,p_reload229,p_reload227,p_reload225,p_reload223,p_reload221,p_reload219,p_reload217,p_reload215,p_reload213,p_reload211,p_reload209,p_reload207,p_reload205,p_reload203,p_reload201,p_reload199,p_reload260,p_reload258,p_reload256,p_reload254,p_reload252,p_reload250,p_reload248,p_reload246,p_reload244,p_reload242,p_reload240,p_reload238,p_reload236,p_reload234,p_reload232,p_reload230,p_reload228,p_reload226,p_reload224,p_reload222,p_reload220,p_reload218,p_reload216,p_reload214,p_reload212,p_reload210,p_reload208,p_reload206,p_reload204,p_reload202,p_reload200,p_reload,tmp2_address0,tmp2_ce0,tmp2_we0,tmp2_d0,tmp2_q0); 
...
reg   [5:0] tmp2_addr_reg_1209;
reg   [5:0] tmp2_addr_reg_1209_pp0_iter1_reg;
...
reg   [31:0] arrayidx67_promoted_reg_1234;
reg   [31:0] buff_B_load_reg_1239;
reg   [31:0] buff_B_load_1_reg_1244;
reg   [31:0] mul62_1_reg_1249;
wire    ap_CS_fsm_pp0_stage7;
wire    ap_block_pp0_stage7_11001;
wire    ap_CS_fsm_pp0_stage11;
wire    ap_block_pp0_stage11_11001;
reg   [31:0] mul65_1_reg_1259;
reg   [0:0] tmp_6_reg_1264;
wire    ap_block_pp0_stage14_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln31_fu_789_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln33_2_fu_1096_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln33_1_fu_1119_p1;
reg   [6:0] j_fu_250;
wire   [6:0] add_ln32_fu_1132_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_2_fu_254;
wire   [6:0] select_ln31_fu_771_p3;
reg   [6:0] ap_sig_allocacmp_i_2_load;
reg   [11:0] indvar_flatten134_fu_258;
wire   [11:0] add_ln31_1_fu_737_p2;
reg   [11:0] ap_sig_allocacmp_indvar_flatten134_load;
reg   [31:0] add6815_fu_262;
...
wire   [6:0] add_ln31_fu_749_p2;
wire   [31:0] tmp_fu_798_p65;
wire   [5:0] trunc_ln32_fu_794_p1;
wire   [31:0] tmp_1_fu_934_p65;
wire   [11:0] tmp_3_fu_1080_p3;
wire   [11:0] zext_ln33_fu_1087_p1;
wire   [11:0] add_ln33_fu_1090_p2;
...
#0 j_fu_250 = 7'd0;
#0 i_2_fu_254 = 7'd0;
#0 indvar_flatten134_fu_258 = 12'd0;
#0 add6815_fu_262 = 32'd0;
#0 ap_done_reg = 1'b0;
end
gesummv_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U460(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_693_p0),.din1(grp_fu_693_p1),.ce(1'b1),.dout(grp_fu_693_p2));
gesummv_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U461(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_697_p0),.din1(grp_fu_697_p1),.ce(1'b1),.dout(grp_fu_697_p2));
...
sparsemux_65_6_32_1_1_U462(.din0(p_reload261),.din1(p_reload259),.din2(p_reload257),.din3(p_reload255),.din4(p_reload253),.din5(p_reload251),.din6(p_reload249),.din7(p_reload247),.din8(p_reload245),.din9(p_reload243),.din10(p_reload241),.din11(p_reload239),.din12(p_reload237),.din13(p_reload235),.din14(p_reload233),.din15(p_reload231),.din16(p_reload229),.din17(p_reload227),.din18(p_reload225),.din19(p_reload223),.din20(p_reload221),.din21(p_reload219),.din22(p_reload217),.din23(p_reload215),.din24(p_reload213),.din25(p_reload211),.din26(p_reload209),.din27(p_reload207),.din28(p_reload205),.din29(p_reload203),.din30(p_reload201),.din31(p_reload199),.def(tmp_fu_798_p65),.sel(trunc_ln32_fu_794_p1),.dout(tmp_fu_798_p67));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_65_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h2 ),.din1_WIDTH( 32 ),.CASE2( 6'h4 ),.din2_WIDTH( 32 ),.CASE3( 6'h6 ),.din3_WIDTH( 32 ),.CASE4( 6'h8 ),.din4_WIDTH( 32 ),.CASE5( 6'hA ),.din5_WIDTH( 32 ),.CASE6( 6'hC ),.din6_WIDTH( 32 ),.CASE7( 6'hE ),.din7_WIDTH( 32 ),.CASE8( 6'h10 ),.din8_WIDTH( 32 ),.CASE9( 6'h12 ),.din9_WIDTH( 32 ),.CASE10( 6'h14 ),.din10_WIDTH( 32 ),.CASE11( 6'h16 ),.din11_WIDTH( 32 ),.CASE12( 6'h18 ),.din12_WIDTH( 32 ),.CASE13( 6'h1A ),.din13_WIDTH( 32 ),.CASE14( 6'h1C ),.din14_WIDTH( 32 ),.CASE15( 6'h1E ),.din15_WIDTH( 32 ),.CASE16( 6'h20 ),.din16_WIDTH( 32 ),.CASE17( 6'h22 ),.din17_WIDTH( 32 ),.CASE18( 6'h24 ),.din18_WIDTH( 32 ),.CASE19( 6'h26 ),.din19_WIDTH( 32 ),.CASE20( 6'h28 ),.din20_WIDTH( 32 ),.CASE21( 6'h2A ),.din21_WIDTH( 32 ),.CASE22( 6'h2C ),.din22_WIDTH( 32 ),.CASE23( 6'h2E ),.din23_WIDTH( 32 ),.CASE24( 6'h30 ),.din24_WIDTH( 32 ),.CASE25( 6'h32 ),.din25_WIDTH( 32 ),.CASE26( 6'h34 ),.din26_WIDTH( 32 ),.CASE27( 6'h36 ),.din27_WIDTH( 32 ),.CASE28( 6'h38 ),.din28_WIDTH( 32 ),.CASE29( 6'h3A ),.din29_WIDTH( 32 ),.CASE30( 6'h3C ),.din30_WIDTH( 32 ),.CASE31( 6'h3E ),.din31_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_65_6_32_1_1_U463(.din0(p_reload260),.din1(p_reload258),.din2(p_reload256),.din3(p_reload254),.din4(p_reload252),.din5(p_reload250),.din6(p_reload248),.din7(p_reload246),.din8(p_reload244),.din9(p_reload242),.din10(p_reload240),.din11(p_reload238),.din12(p_reload236),.din13(p_reload234),.din14(p_reload232),.din15(p_reload230),.din16(p_reload228),.din17(p_reload226),.din18(p_reload224),.din19(p_reload222),.din20(p_reload220),.din21(p_reload218),.din22(p_reload216),.din23(p_reload214),.din24(p_reload212),.din25(p_reload210),.din26(p_reload208),.din27(p_reload206),.din28(p_reload204),.din29(p_reload202),.din30(p_reload200),.din31(p_reload),.def(tmp_1_fu_934_p65),.sel(trunc_ln32_fu_794_p1),.dout(tmp_1_fu_934_p67));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_793)) begin
            add6815_fu_262 <= arrayidx67_promoted_reg_1234;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add6815_fu_262 <= reg_707;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_731_p2 == 1'd0))) begin
            i_2_fu_254 <= select_ln31_fu_771_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_731_p2 == 1'd0))) begin
            indvar_flatten134_fu_258 <= add_ln31_1_fu_737_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten134_fu_258 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_250 <= 7'd0;
    end else if (((icmp_ln31_reg_1188 == 1'd0) & (1'b0 == ap_block_pp0_stage14_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        j_fu_250 <= add_ln32_fu_1132_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx67_promoted_reg_1234 <= tmp2_q0;
        buff_B_load_1_reg_1244 <= buff_B_q0;
        buff_B_load_reg_1239 <= buff_B_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln31_reg_1188 <= icmp_ln31_fu_731_p2;
        select_ln6_reg_1192 <= select_ln6_fu_763_p3;
        tmp2_addr_reg_1209 <= zext_ln31_fu_789_p1;
        tmp2_addr_reg_1209_pp0_iter1_reg <= tmp2_addr_reg_1209;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul62_1_reg_1249 <= grp_fu_697_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage11_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        mul65_1_reg_1259 <= grp_fu_697_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage14_11001) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        tmp_6_reg_1264 <= add_ln32_fu_1132_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln31_reg_1188 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_i_2_load = i_2_fu_254;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten134_load = 12'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten134_load = indvar_flatten134_fu_258;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_693_p1 = mul65_1_reg_1259;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage8) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
            grp_fu_697_p0 = mul62_1_reg_1249;
        end else if (((1'b0 == ap_block_pp0_stage7) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
            grp_fu_697_p0 = reg_701;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_697_p0 = buff_B_load_1_reg_1244;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_697_p0 = buff_B_load_reg_1239;
        end else begin
            grp_fu_697_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_address0_local = tmp2_addr_reg_1209_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_address0_local = tmp2_addr_reg_1209;
    end else begin
...
assign add_ln31_1_fu_737_p2 = (ap_sig_allocacmp_indvar_flatten134_load + 12'd1);
assign add_ln31_fu_749_p2 = (ap_sig_allocacmp_i_2_load + 7'd1);
assign add_ln32_fu_1132_p2 = (select_ln6_reg_1192 + 7'd2);
assign add_ln33_fu_1090_p2 = (tmp_3_fu_1080_p3 + zext_ln33_fu_1087_p1);
...
always @ (*) begin
    ap_condition_793 = ((icmp_ln31_reg_1188 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_1205 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_B_address0 = zext_ln33_1_fu_1119_p1;
assign buff_B_address1 = zext_ln33_2_fu_1096_p1;
assign buff_B_ce0 = buff_B_ce0_local;
assign buff_B_ce1 = buff_B_ce1_local;
assign empty_fu_779_p1 = select_ln31_fu_771_p3[5:0];
assign first_iter_1_fu_783_p2 = ((select_ln6_fu_763_p3 == 7'd0) ? 1'b1 : 1'b0);
assign icmp_ln31_fu_731_p2 = ((ap_sig_allocacmp_indvar_flatten134_load == 12'd2048) ? 1'b1 : 1'b0);
assign select_ln31_fu_771_p3 = ((tmp_2_fu_755_p3[0:0] == 1'b1) ? add_ln31_fu_749_p2 : ap_sig_allocacmp_i_2_load);
...
assign trunc_ln32_fu_794_p1 = select_ln6_fu_763_p3[5:0];
assign zext_ln31_fu_789_p1 = select_ln31_fu_771_p3;
assign zext_ln33_1_fu_1119_p1 = tmp_5_fu_1110_p4;
assign zext_ln33_2_fu_1096_p1 = add_ln33_fu_1090_p2;
assign zext_ln33_fu_1087_p1 = select_ln6_reg_1192;
endmodule 