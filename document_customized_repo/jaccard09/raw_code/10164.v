...
output  [31:0] C_56_out;
output   C_56_out_ap_vld;
reg ap_idle;
reg C_54_out_ap_vld;
...
wire   [4:0] lshr_ln5_fu_2385_p4;
wire   [31:0] add_ln130_1_fu_2415_p2;
wire   [31:0] or_ln3_fu_2407_p3;
...
sparsemux_33_6_32_1_1_U214(.din0(W_load_2),.din1(W_4_load_2),.din2(W_8_load_2),.din3(W_12_load_2),.din4(W_16_load_2),.din5(W_20_load_2),.din6(W_24_load_2),.din7(W_28_load_2),.din8(W_32_load_2),.din9(W_36_load_2),.din10(W_40_load_2),.din11(W_44_load_2),.din12(W_48_load_2),.din13(W_52_load_2),.din14(W_56_load_2),.din15(W_60_load_2),.def(tmp_4_fu_1794_p33),.sel(trunc_ln14_fu_1702_p1),.dout(tmp_4_fu_1794_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h3C ),.din0_WIDTH( 32 ),.CASE1( 6'h0 ),.din1_WIDTH( 32 ),.CASE2( 6'h4 ),.din2_WIDTH( 32 ),.CASE3( 6'h8 ),.din3_WIDTH( 32 ),.CASE4( 6'hC ),.din4_WIDTH( 32 ),.CASE5( 6'h10 ),.din5_WIDTH( 32 ),.CASE6( 6'h14 ),.din6_WIDTH( 32 ),.CASE7( 6'h18 ),.din7_WIDTH( 32 ),.CASE8( 6'h1C ),.din8_WIDTH( 32 ),.CASE9( 6'h20 ),.din9_WIDTH( 32 ),.CASE10( 6'h24 ),.din10_WIDTH( 32 ),.CASE11( 6'h28 ),.din11_WIDTH( 32 ),.CASE12( 6'h2C ),.din12_WIDTH( 32 ),.CASE13( 6'h30 ),.din13_WIDTH( 32 ),.CASE14( 6'h34 ),.din14_WIDTH( 32 ),.CASE15( 6'h38 ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U215(.din0(W_1_load_2),.din1(W_5_load_2),.din2(W_9_load_2),.din3(W_13_load_2),.din4(W_17_load_2),.din5(W_21_load_2),.din6(W_25_load_2),.din7(W_29_load_2),.din8(W_33_load_2),.din9(W_37_load_2),.din10(W_41_load_2),.din11(W_45_load_2),.din12(W_49_load_2),.din13(W_53_load_2),.din14(W_57_load_2),.din15(W_61_load_2),.def(tmp_5_fu_1866_p33),.sel(trunc_ln14_fu_1702_p1),.dout(tmp_5_fu_1866_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h3C ),.din0_WIDTH( 32 ),.CASE1( 6'h0 ),.din1_WIDTH( 32 ),.CASE2( 6'h4 ),.din2_WIDTH( 32 ),.CASE3( 6'h8 ),.din3_WIDTH( 32 ),.CASE4( 6'hC ),.din4_WIDTH( 32 ),.CASE5( 6'h10 ),.din5_WIDTH( 32 ),.CASE6( 6'h14 ),.din6_WIDTH( 32 ),.CASE7( 6'h18 ),.din7_WIDTH( 32 ),.CASE8( 6'h1C ),.din8_WIDTH( 32 ),.CASE9( 6'h20 ),.din9_WIDTH( 32 ),.CASE10( 6'h24 ),.din10_WIDTH( 32 ),.CASE11( 6'h28 ),.din11_WIDTH( 32 ),.CASE12( 6'h2C ),.din12_WIDTH( 32 ),.CASE13( 6'h30 ),.din13_WIDTH( 32 ),.CASE14( 6'h34 ),.din14_WIDTH( 32 ),.CASE15( 6'h38 ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U216(.din0(W_2_load_2),.din1(W_6_load_2),.din2(W_10_load_2),.din3(W_14_load_2),.din4(W_18_load_2),.din5(W_22_load_2),.din6(W_26_load_2),.din7(W_30_load_2),.din8(W_34_load_2),.din9(W_38_load_2),.din10(W_42_load_2),.din11(W_46_load_2),.din12(W_50_load_2),.din13(W_54_load_2),.din14(W_58_load_2),.din15(W_62_load_2),.def(tmp_6_fu_1938_p33),.sel(trunc_ln14_fu_1702_p1),.dout(tmp_6_fu_1938_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h3C ),.din0_WIDTH( 32 ),.CASE1( 6'h0 ),.din1_WIDTH( 32 ),.CASE2( 6'h4 ),.din2_WIDTH( 32 ),.CASE3( 6'h8 ),.din3_WIDTH( 32 ),.CASE4( 6'hC ),.din4_WIDTH( 32 ),.CASE5( 6'h10 ),.din5_WIDTH( 32 ),.CASE6( 6'h14 ),.din6_WIDTH( 32 ),.CASE7( 6'h18 ),.din7_WIDTH( 32 ),.CASE8( 6'h1C ),.din8_WIDTH( 32 ),.CASE9( 6'h20 ),.din9_WIDTH( 32 ),.CASE10( 6'h24 ),.din10_WIDTH( 32 ),.CASE11( 6'h28 ),.din11_WIDTH( 32 ),.CASE12( 6'h2C ),.din12_WIDTH( 32 ),.CASE13( 6'h30 ),.din13_WIDTH( 32 ),.CASE14( 6'h34 ),.din14_WIDTH( 32 ),.CASE15( 6'h38 ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U217(.din0(W_3_load_2),.din1(W_7_load_2),.din2(W_11_load_2),.din3(W_15_load_2),.din4(W_19_load_2),.din5(W_23_load_2),.din6(W_27_load_2),.din7(W_31_load_2),.din8(W_35_load_2),.din9(W_39_load_2),.din10(W_43_load_2),.din11(W_47_load_2),.din12(W_51_load_2),.din13(W_55_load_2),.din14(W_59_load_2),.din15(W_63_load_2),.def(tmp_7_fu_2010_p33),.sel(trunc_ln14_fu_1702_p1),.dout(tmp_7_fu_2010_p35));
...
sparsemux_33_6_32_1_1_U218(.din0(W_q0),.din1(W_4_q0),.din2(W_8_q0),.din3(W_12_q0),.din4(W_16_q0),.din5(W_20_q0),.din6(W_24_q0),.din7(W_28_q0),.din8(W_32_q0),.din9(W_36_q0),.din10(W_40_q0),.din11(W_44_q0),.din12(W_48_q0),.din13(W_52_q0),.din14(W_56_q0),.din15(W_60_q0),.def(tmp_s_fu_2082_p33),.sel(trunc_ln14_reg_3045),.dout(tmp_s_fu_2082_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h4 ),.din1_WIDTH( 32 ),.CASE2( 6'h8 ),.din2_WIDTH( 32 ),.CASE3( 6'hC ),.din3_WIDTH( 32 ),.CASE4( 6'h10 ),.din4_WIDTH( 32 ),.CASE5( 6'h14 ),.din5_WIDTH( 32 ),.CASE6( 6'h18 ),.din6_WIDTH( 32 ),.CASE7( 6'h1C ),.din7_WIDTH( 32 ),.CASE8( 6'h20 ),.din8_WIDTH( 32 ),.CASE9( 6'h24 ),.din9_WIDTH( 32 ),.CASE10( 6'h28 ),.din10_WIDTH( 32 ),.CASE11( 6'h2C ),.din11_WIDTH( 32 ),.CASE12( 6'h30 ),.din12_WIDTH( 32 ),.CASE13( 6'h34 ),.din13_WIDTH( 32 ),.CASE14( 6'h38 ),.din14_WIDTH( 32 ),.CASE15( 6'h3C ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U219(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.din4(W_17_q0),.din5(W_21_q0),.din6(W_25_q0),.din7(W_29_q0),.din8(W_33_q0),.din9(W_37_q0),.din10(W_41_q0),.din11(W_45_q0),.din12(W_49_q0),.din13(W_53_q0),.din14(W_57_q0),.din15(W_61_q0),.def(tmp_1_fu_2153_p33),.sel(trunc_ln14_reg_3045),.dout(tmp_1_fu_2153_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h4 ),.din1_WIDTH( 32 ),.CASE2( 6'h8 ),.din2_WIDTH( 32 ),.CASE3( 6'hC ),.din3_WIDTH( 32 ),.CASE4( 6'h10 ),.din4_WIDTH( 32 ),.CASE5( 6'h14 ),.din5_WIDTH( 32 ),.CASE6( 6'h18 ),.din6_WIDTH( 32 ),.CASE7( 6'h1C ),.din7_WIDTH( 32 ),.CASE8( 6'h20 ),.din8_WIDTH( 32 ),.CASE9( 6'h24 ),.din9_WIDTH( 32 ),.CASE10( 6'h28 ),.din10_WIDTH( 32 ),.CASE11( 6'h2C ),.din11_WIDTH( 32 ),.CASE12( 6'h30 ),.din12_WIDTH( 32 ),.CASE13( 6'h34 ),.din13_WIDTH( 32 ),.CASE14( 6'h38 ),.din14_WIDTH( 32 ),.CASE15( 6'h3C ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U220(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.din4(W_18_q0),.din5(W_22_q0),.din6(W_26_q0),.din7(W_30_q0),.din8(W_34_q0),.din9(W_38_q0),.din10(W_42_q0),.din11(W_46_q0),.din12(W_50_q0),.din13(W_54_q0),.din14(W_58_q0),.din15(W_62_q0),.def(tmp_2_fu_2224_p33),.sel(trunc_ln14_reg_3045),.dout(tmp_2_fu_2224_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h4 ),.din1_WIDTH( 32 ),.CASE2( 6'h8 ),.din2_WIDTH( 32 ),.CASE3( 6'hC ),.din3_WIDTH( 32 ),.CASE4( 6'h10 ),.din4_WIDTH( 32 ),.CASE5( 6'h14 ),.din5_WIDTH( 32 ),.CASE6( 6'h18 ),.din6_WIDTH( 32 ),.CASE7( 6'h1C ),.din7_WIDTH( 32 ),.CASE8( 6'h20 ),.din8_WIDTH( 32 ),.CASE9( 6'h24 ),.din9_WIDTH( 32 ),.CASE10( 6'h28 ),.din10_WIDTH( 32 ),.CASE11( 6'h2C ),.din11_WIDTH( 32 ),.CASE12( 6'h30 ),.din12_WIDTH( 32 ),.CASE13( 6'h34 ),.din13_WIDTH( 32 ),.CASE14( 6'h38 ),.din14_WIDTH( 32 ),.CASE15( 6'h3C ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U221(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.din4(W_19_q0),.din5(W_23_q0),.din6(W_27_q0),.din7(W_31_q0),.din8(W_35_q0),.din9(W_39_q0),.din10(W_43_q0),.din11(W_47_q0),.din12(W_51_q0),.din13(W_55_q0),.din14(W_59_q0),.din15(W_63_q0),.def(tmp_3_fu_2295_p33),.sel(trunc_ln14_reg_3045),.dout(tmp_3_fu_2295_p35));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln14_reg_3045 <= trunc_ln14_fu_1702_p1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln128_reg_3373 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        C_56_out_ap_vld = 1'b1;
    end else begin
        C_56_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
...
assign C_54_out = C_4_reg_3478;
assign C_55_out = C_5_reg_3516;
assign C_56_out = {{trunc_ln130_7_reg_3500}, {lshr_ln130_7_reg_3505}};
...
assign add_ln130_2_fu_2420_p2 = (add_ln130_1_fu_2415_p2 + or_ln3_fu_2407_p3);
...
assign lshr_ln5_fu_2385_p4 = {{B_1_fu_376[31:27]}};
...
assign or_ln3_fu_2407_p3 = {{trunc_ln130_fu_2381_p1}, {lshr_ln5_fu_2385_p4}};
...
assign temp_2_out = temp_2_reg_3510;
assign temp_3_fu_2690_p2 = (add_ln130_12_fu_2686_p2 + or_ln130_6_fu_2680_p3);
assign temp_3_out = (add_ln130_12_fu_2686_p2 + or_ln130_6_fu_2680_p3);
