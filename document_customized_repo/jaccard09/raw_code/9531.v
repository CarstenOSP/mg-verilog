module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_13_reload,B_4_reload,E_12_reload,D_13_reload,E_5_reload,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,W_2_address0,W_2_ce0,W_2_q0,W_3_address0,W_3_ce0,W_3_q0,B_13_out,B_13_out_ap_vld,B_8_out,B_8_out_ap_vld,D_15_out,D_15_out_ap_vld,E_13_out,E_13_out_ap_vld,E_8_out,E_8_out_ap_vld); 
...
wire   [31:0] tmp_s_fu_303_p11;
reg   [31:0] tmp_s_reg_538;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_s_fu_303_p1;
wire   [1:0] tmp_s_fu_303_p3;
wire  signed [1:0] tmp_s_fu_303_p5;
wire  signed [1:0] tmp_s_fu_303_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U38(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.def(tmp_s_fu_303_p9),.sel(trunc_ln100_reg_513),.dout(tmp_s_fu_303_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_s_reg_538 <= tmp_s_fu_303_p11;
...
assign B_13_out = A_fu_110;
assign B_8_out = B_fu_94;
assign C_3_fu_387_p3 = {{trunc_ln126_1_fu_373_p1}, {lshr_ln126_1_fu_377_p4}};
assign D_15_out = D_6_reg_548;
assign E_13_out = E_4_reg_543;
assign E_8_out = E_fu_90;
...
assign add_ln126_1_fu_362_p2 = (or_ln126_1_fu_356_p2 + tmp_s_reg_538);
