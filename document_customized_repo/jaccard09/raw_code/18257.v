...
stencil3d_stencil3d_Pipeline_loop_height_loop_col_loop_row grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_ap_start),.ap_done(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_ap_done),.ap_idle(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_ap_idle),.ap_ready(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_ap_ready),.orig_address0(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_orig_address0),.orig_ce0(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_orig_ce0),.orig_q0(orig_q0),.orig_address1(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_orig_address1),.orig_ce1(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_orig_ce1),.orig_q1(orig_q1),.C_load(C_load_reg_107),.C_load_1(C_load_1_reg_112),.sol_address0(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_sol_address0),.sol_ce0(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_sol_ce0),.sol_we0(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_sol_we0),.sol_d0(grp_stencil3d_Pipeline_loop_height_loop_col_loop_row_fu_85_sol_d0));
