...
wire   [3:0] grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_address1;
wire    grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_ce1;
...
wire   [3:0] grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_1_address1;
wire    grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_1_ce1;
...
wire   [3:0] grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_2_address1;
wire    grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_2_ce1;
...
wire   [3:0] grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_3_address1;
wire    grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_3_ce1;
...
buff_A_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_A_address0),.ce0(buff_A_ce0),.we0(buff_A_we0),.d0(grp_bicg_Pipeline_lprd_2_fu_404_buff_A_d0),.q0(buff_A_q0));
bicg_buff_A_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 1024 ),.AddressWidth( 10 ))
buff_A_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_A_1_address0),.ce0(buff_A_1_ce0),.we0(buff_A_1_we0),.d0(grp_bicg_Pipeline_lprd_2_fu_404_buff_A_1_d0),.q0(buff_A_1_q0));
bicg_buff_A_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 1024 ),.AddressWidth( 10 ))
buff_A_2_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_A_2_address0),.ce0(buff_A_2_ce0),.we0(buff_A_2_we0),.d0(grp_bicg_Pipeline_lprd_2_fu_404_buff_A_2_d0),.q0(buff_A_2_q0));
bicg_buff_A_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 1024 ),.AddressWidth( 10 ))
buff_A_3_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_A_3_address0),.ce0(buff_A_3_ce0),.we0(buff_A_3_we0),.d0(grp_bicg_Pipeline_lprd_2_fu_404_buff_A_3_d0),.q0(buff_A_3_q0));
bicg_buff_p_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
buff_p_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_p_address0),.ce0(buff_p_ce0),.we0(buff_p_we0_local),.d0(bitcast_ln14_fu_515_p1),.q0(buff_p_q0));
bicg_buff_p_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
buff_p_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_p_1_address0),.ce0(buff_p_1_ce0),.we0(buff_p_1_we0_local),.d0(bitcast_ln14_fu_515_p1),.q0(buff_p_1_q0));
bicg_buff_p_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
buff_p_2_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_p_2_address0),.ce0(buff_p_2_ce0),.we0(buff_p_2_we0_local),.d0(bitcast_ln14_fu_515_p1),.q0(buff_p_2_q0));
bicg_buff_p_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
buff_p_3_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_p_3_address0),.ce0(buff_p_3_ce0),.we0(buff_p_3_we0_local),.d0(bitcast_ln14_fu_515_p1),.q0(buff_p_3_q0));
bicg_buff_p_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
...
buff_s_out_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_s_out_address0),.ce0(buff_s_out_ce0),.we0(buff_s_out_we0),.d0(buff_s_out_d0),.q0(buff_s_out_q0),.address1(grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_address1),.ce1(buff_s_out_ce1),.q1(buff_s_out_q1));
bicg_buff_s_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
buff_s_out_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_s_out_1_address0),.ce0(buff_s_out_1_ce0),.we0(buff_s_out_1_we0),.d0(buff_s_out_1_d0),.q0(buff_s_out_1_q0),.address1(grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_1_address1),.ce1(buff_s_out_1_ce1),.q1(buff_s_out_1_q1));
bicg_buff_s_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
buff_s_out_2_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_s_out_2_address0),.ce0(buff_s_out_2_ce0),.we0(buff_s_out_2_we0),.d0(buff_s_out_2_d0),.q0(buff_s_out_2_q0),.address1(grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_2_address1),.ce1(buff_s_out_2_ce1),.q1(buff_s_out_2_q1));
bicg_buff_s_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
buff_s_out_3_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_s_out_3_address0),.ce0(buff_s_out_3_ce0),.we0(buff_s_out_3_we0),.d0(buff_s_out_3_d0),.q0(buff_s_out_3_q0),.address1(grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_3_address1),.ce1(buff_s_out_3_ce1),.q1(buff_s_out_3_q1));
bicg_buff_p_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 16 ),.AddressWidth( 4 ))
...
fadd_32ns_32ns_32_7_full_dsp_1_U61(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_571_p0),.din1(grp_fu_571_p1),.ce(grp_fu_571_ce),.dout(grp_fu_571_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U62(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_575_p0),.din1(grp_fu_575_p1),.ce(grp_fu_575_ce),.dout(grp_fu_575_p2));
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        buff_s_out_1_ce1 = grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_1_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        buff_s_out_2_ce1 = grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_2_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        buff_s_out_3_ce1 = grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_3_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        buff_s_out_ce1 = grp_bicg_Pipeline_lp1_lp2_fu_388_buff_s_out_ce1;
    end else begin
        buff_s_out_ce1 = 1'b0;
    end
end
