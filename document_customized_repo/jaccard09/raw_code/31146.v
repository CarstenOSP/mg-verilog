...
dmul_64ns_64ns_64_7_max_dsp_1_U381(.clk(ap_clk),.reset(ap_rst),.din0(tmp_51_reg_804),.din1(p_reload),.ce(1'b1),.dout(grp_fu_480_p2));
...
always @ (*) begin
    ap_condition_504 = (~(trunc_ln73_reg_793_pp0_iter8_reg == 3'd2) & ~(trunc_ln73_reg_793_pp0_iter8_reg == 3'd0) & ~(trunc_ln73_reg_793_pp0_iter8_reg == 3'd4));
end
