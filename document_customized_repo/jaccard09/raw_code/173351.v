...
reg   [7:0] v114_1_reg_168;
wire   [14:0] mul_ln175_fu_135_p2;
reg   [14:0] mul_ln175_reg_178;
wire   [0:0] trunc_ln168_fu_146_p1;
reg   [0:0] trunc_ln168_reg_183;
wire    ap_CS_fsm_state3;
wire   [0:0] cmp11_fu_150_p2;
reg   [0:0] cmp11_reg_188;
...
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_0_address0;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_0_ce0;
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_0_address1;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_0_ce1;
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_1_address0;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_1_ce0;
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_1_address1;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_v227_1_ce1;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_193_p_din0;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_193_p_din1;
wire   [1:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_193_p_opcode;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_193_p_ce;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_197_p_din0;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_197_p_din1;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_197_p_ce;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_201_p_din0;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_201_p_din1;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_201_p_ce;
reg    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_ap_start_reg;
wire    ap_CS_fsm_state4;
reg   [7:0] v114_fu_60;
wire   [7:0] add_ln168_fu_115_p2;
reg    ap_block_state2;
reg    v236_write_local;
wire   [6:0] lshr_ln_fu_121_p4;
wire   [6:0] mul_ln175_fu_135_p0;
wire   [8:0] mul_ln175_fu_135_p1;
reg    grp_fu_193_ce;
reg    grp_fu_197_ce;
reg    grp_fu_201_ce;
reg   [3:0] ap_NS_fsm;
...
wire   [14:0] mul_ln175_fu_135_p00;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 4'd1;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        v114_fu_60 <= 8'd0;
    end else if (((1'b0 == ap_block_state2) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln168_fu_109_p2 == 1'd0))) begin
        v114_fu_60 <= add_ln168_fu_115_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        cmp11_reg_188 <= cmp11_fu_150_p2;
        trunc_ln168_reg_183 <= trunc_ln168_fu_146_p1;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        mul_ln175_reg_178 <= mul_ln175_fu_135_p2;
        v114_1_reg_168 <= v114_fu_60;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_state2) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln168_fu_109_p2 == 1'd1)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_state2) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln168_fu_109_p2 == 1'd1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_193_ce = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_193_p_ce;
    end else begin
        grp_fu_193_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_197_ce = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_197_p_ce;
    end else begin
        grp_fu_197_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_201_ce = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_201_p_ce;
    end else begin
        grp_fu_201_ce = 1'b1;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln168_fu_109_p2 == 1'd1))) begin
...
assign add_ln168_fu_115_p2 = (v114_fu_60 + 8'd1);
assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];
assign ap_CS_fsm_state2 = ap_CS_fsm[32'd1];
assign ap_CS_fsm_state3 = ap_CS_fsm[32'd2];
assign ap_CS_fsm_state4 = ap_CS_fsm[32'd3];
always @ (*) begin
    ap_block_state2 = ((v236_full_n == 1'b0) & (icmp_ln168_fu_109_p2 == 1'd1));
end
assign cmp11_fu_150_p2 = ((v114_1_reg_168 == 8'd0) ? 1'b1 : 1'b0);
assign grp_fu_176_p_ce = grp_fu_193_ce;
assign grp_fu_176_p_din0 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_193_p_din0;
assign grp_fu_176_p_din1 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_193_p_din1;
assign grp_fu_176_p_opcode = 2'd0;
assign grp_fu_180_p_ce = grp_fu_197_ce;
assign grp_fu_180_p_din0 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_197_p_din0;
assign grp_fu_180_p_din1 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_197_p_din1;
assign grp_fu_184_p_ce = grp_fu_201_ce;
assign grp_fu_184_p_din0 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_201_p_din0;
assign grp_fu_184_p_din1 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_78_grp_fu_201_p_din1;
...
assign icmp_ln168_fu_109_p2 = ((v114_fu_60 == 8'd210) ? 1'b1 : 1'b0);
assign lshr_ln_fu_121_p4 = {{v114_fu_60[7:1]}};
assign mul_ln175_fu_135_p0 = mul_ln175_fu_135_p00;
assign mul_ln175_fu_135_p00 = lshr_ln_fu_121_p4;
assign mul_ln175_fu_135_p1 = 15'd190;
assign trunc_ln168_fu_146_p1 = v114_1_reg_168[0:0];
