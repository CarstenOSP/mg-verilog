...
reg   [63:0] empty_934_fu_360;
reg   [63:0] empty_935_fu_364;
...
#0 i_fu_352 = 2'd0;
#0 empty_933_fu_356 = 64'd0;
#0 empty_934_fu_360 = 64'd0;
#0 empty_935_fu_364 = 64'd0;
...
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U1753(.din0(mux_case_01210712125_reload),.din1(mux_case_11210812129_reload),.din2(mux_case_21210912133_reload),.def(tmp_108_fu_2045_p7),.sel(i_11_reg_2199_pp0_iter8_reg),.dout(tmp_108_fu_2045_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            empty_935_fu_364 <= empty_31;
        end else if ((1'b1 == ap_condition_1690)) begin
            empty_935_fu_364 <= mul5_i_reg_2564;
        end
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_26923_p_din1 = tmp_108_reg_2554;
...
assign p_out = empty_935_fu_364;
assign p_out1 = empty_934_fu_360;
assign p_out2 = empty_933_fu_356;
