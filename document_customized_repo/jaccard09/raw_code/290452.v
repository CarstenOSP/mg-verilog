...
output  [1:0] grp_fu_25046_p_opcode;
...
sparsemux_7_2_64_1_1_U2273(.din0(v14_3_reload),.din1(v14_4_reload),.din2(v14_5_reload),.def(v112_fu_287_p7),.sel(select_ln190_reg_516),.dout(v112_fu_287_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U2274(.din0(v15_3_reload),.din1(v15_4_reload),.din2(v15_5_reload),.def(v116_fu_385_p7),.sel(select_ln190_reg_516_pp0_iter1_reg),.dout(v116_fu_385_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln190_fu_224_p2 == 1'd0))) begin
            indvar_flatten12_fu_96 <= add_ln190_fu_230_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            v120_fu_84 <= grp_fu_25046_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v117_reg_588 <= grp_fu_63102_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v119_reg_598 <= grp_fu_63102_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v122_reg_623 <= grp_fu_25046_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        v124_reg_628 <= grp_fu_63102_p_dout0;
    end
end
always @ (*) begin
...
assign add_ln190_fu_230_p2 = (ap_sig_allocacmp_indvar_flatten12_load + 8'd1);
...
assign bit_sel_fu_367_p3 = bitcast_ln196_fu_363_p1[64'd63];
assign bitcast_ln196_fu_363_p1 = grp_fu_25046_p_dout0;
assign grp_fu_25046_p_ce = 1'b1;
assign grp_fu_25046_p_din0 = grp_fu_193_p0;
assign grp_fu_25046_p_din1 = grp_fu_193_p1;
assign grp_fu_25046_p_opcode = grp_fu_193_opcode;
assign grp_fu_63102_p_ce = 1'b1;
assign grp_fu_63102_p_din0 = grp_fu_197_p0;
assign grp_fu_63102_p_din1 = grp_fu_197_p1;
assign icmp_ln190_fu_224_p2 = ((ap_sig_allocacmp_indvar_flatten12_load == 8'd192) ? 1'b1 : 1'b0);
...
assign xor_ln196_fu_375_p2 = (bit_sel_fu_367_p3 ^ 1'd1);
