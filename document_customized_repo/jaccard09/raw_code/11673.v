...
reg    W_14_ce0_local;
reg    W_15_ce0_local;
wire   [2:0] lshr_ln100_1_fu_480_p4;
...
sparsemux_33_4_32_1_1_U70(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.din4(W_4_q0),.din5(W_5_q0),.din6(W_6_q0),.din7(W_7_q0),.din8(W_8_q0),.din9(W_9_q0),.din10(W_10_q0),.din11(W_11_q0),.din12(W_12_q0),.din13(W_13_q0),.din14(W_14_q0),.din15(W_15_q0),.def(tmp_s_fu_521_p33),.sel(trunc_ln128_reg_766),.dout(tmp_s_fu_521_p35));
...
assign lshr_ln100_1_fu_480_p4 = {{ap_sig_allocacmp_i_1[6:4]}};
assign lshr_ln130_1_fu_628_p4 = {{ap_sig_allocacmp_B_load_1[31:2]}};
assign lshr_ln7_fu_667_p4 = {{B_1_fu_160[31:27]}};
assign or_ln2_fu_677_p3 = {{trunc_ln130_fu_663_p1}, {lshr_ln7_fu_667_p4}};
