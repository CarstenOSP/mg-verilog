module backprop_backprop_Pipeline_label_13 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_23167,mux_case_13063,mux_case_02959,v18_i,v18_o,v18_o_ap_vld,v18_2_i,v18_2_o,v18_2_o_ap_vld,v18_1_i,v18_1_o,v18_1_o_ap_vld,v116_2_out,v116_2_out_ap_vld,mux_case_13061_out,mux_case_13061_out_ap_vld,v116_out,v116_out_ap_vld,grp_fu_3427_p_din0,grp_fu_3427_p_din1,grp_fu_3427_p_opcode,grp_fu_3427_p_dout0,grp_fu_3427_p_ce,grp_fu_3431_p_din0,grp_fu_3431_p_din1,grp_fu_3431_p_opcode,grp_fu_3431_p_dout0,grp_fu_3431_p_ce,grp_fu_3435_p_din0,grp_fu_3435_p_din1,grp_fu_3435_p_dout0,grp_fu_3435_p_ce,grp_fu_6982_p_din0,grp_fu_6982_p_din1,grp_fu_6982_p_dout0,grp_fu_6982_p_ce,grp_fu_6986_p_din0,grp_fu_6986_p_din1,grp_fu_6986_p_dout0,grp_fu_6986_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_23167;
input  [63:0] mux_case_13063;
input  [63:0] mux_case_02959;
input  [63:0] v18_i;
output  [63:0] v18_o;
output   v18_o_ap_vld;
input  [63:0] v18_2_i;
...
output  [63:0] mux_case_13061_out;
output   mux_case_13061_out_ap_vld;
...
#0 v72_fu_66 = 2'd0;
#0 v116_fu_70 = 64'd0;
#0 mux_case_13061_fu_74 = 64'd0;
#0 v116_2_fu_78 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U275(.din0(v18_i),.din1(v18_1_i),.din2(v18_2_i),.def(v73_fu_222_p7),.sel(ap_sig_allocacmp_v72_1),.dout(v73_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v74_reg_361 <= grp_fu_3427_p_dout0;
        v75_reg_366 <= grp_fu_3435_p_dout0;
        v77_reg_373 <= grp_fu_6986_p_dout0;
        v78_reg_378 <= grp_fu_3431_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        mux_case_13061_out_ap_vld = 1'b1;
    end else begin
        mux_case_13061_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
