...
wire   [0:0] icmp_ln168_fu_155_p2;
wire   [2:0] trunc_ln168_fu_167_p1;
reg   [2:0] trunc_ln168_reg_217;
wire   [4:0] lshr_ln_fu_171_p4;
reg   [4:0] lshr_ln_reg_222;
wire   [12:0] mul_ln175_fu_185_p2;
reg   [12:0] mul_ln175_reg_227;
wire   [0:0] cmp11_fu_191_p2;
reg   [0:0] cmp11_reg_232;
...
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_v225_1_address0;
...
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_v225_1_address1;
...
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_v225_0_address0;
...
wire   [14:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_v225_0_address1;
...
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_237_p_din0;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_237_p_din1;
wire   [1:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_237_p_opcode;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_237_p_ce;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_241_p_din0;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_241_p_din1;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_241_p_ce;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_245_p_din0;
wire   [31:0] grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_245_p_din1;
wire    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_245_p_ce;
reg    grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
reg   [7:0] v114_fu_84;
wire   [7:0] add_ln168_fu_161_p2;
reg    ap_block_state2;
reg    v236_write_local;
wire   [4:0] mul_ln175_fu_185_p0;
wire   [8:0] mul_ln175_fu_185_p1;
reg    grp_fu_237_ce;
reg    grp_fu_241_ce;
reg    grp_fu_245_ce;
reg   [3:0] ap_NS_fsm;
...
wire   [12:0] mul_ln175_fu_185_p00;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 4'd1;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        v114_fu_84 <= 8'd0;
    end else if (((1'b0 == ap_block_state2) & (icmp_ln168_fu_155_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        v114_fu_84 <= add_ln168_fu_161_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        cmp11_reg_232 <= cmp11_fu_191_p2;
        lshr_ln_reg_222 <= {{v114_fu_84[7:3]}};
        mul_ln175_reg_227 <= mul_ln175_fu_185_p2;
        trunc_ln168_reg_217 <= trunc_ln168_fu_167_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_state2) & (icmp_ln168_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_state2) & (icmp_ln168_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_237_ce = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_237_p_ce;
    end else begin
        grp_fu_237_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_241_ce = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_241_p_ce;
    end else begin
        grp_fu_241_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_245_ce = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_245_p_ce;
    end else begin
        grp_fu_245_ce = 1'b1;
    end
end
always @ (*) begin
    if (((icmp_ln168_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln168_fu_161_p2 = (v114_fu_84 + 8'd1);
assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];
assign ap_CS_fsm_state2 = ap_CS_fsm[32'd1];
assign ap_CS_fsm_state3 = ap_CS_fsm[32'd2];
assign ap_CS_fsm_state4 = ap_CS_fsm[32'd3];
always @ (*) begin
    ap_block_state2 = ((icmp_ln168_fu_155_p2 == 1'd1) & (v236_full_n == 1'b0));
end
assign cmp11_fu_191_p2 = ((v114_fu_84 == 8'd0) ? 1'b1 : 1'b0);
assign grp_fu_184_p_ce = grp_fu_237_ce;
assign grp_fu_184_p_din0 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_237_p_din0;
assign grp_fu_184_p_din1 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_237_p_din1;
assign grp_fu_184_p_opcode = 2'd0;
assign grp_fu_188_p_ce = grp_fu_241_ce;
assign grp_fu_188_p_din0 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_241_p_din0;
assign grp_fu_188_p_din1 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_241_p_din1;
assign grp_fu_192_p_ce = grp_fu_245_ce;
assign grp_fu_192_p_din0 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_245_p_din0;
assign grp_fu_192_p_din1 = grp_kernel_2mm_node1_Pipeline_label_4_label_5_fu_102_grp_fu_245_p_din1;
...
assign icmp_ln168_fu_155_p2 = ((v114_fu_84 == 8'd210) ? 1'b1 : 1'b0);
assign lshr_ln_fu_171_p4 = {{v114_fu_84[7:3]}};
assign mul_ln175_fu_185_p0 = mul_ln175_fu_185_p00;
assign mul_ln175_fu_185_p00 = lshr_ln_fu_171_p4;
assign mul_ln175_fu_185_p1 = 13'd190;
assign trunc_ln168_fu_167_p1 = v114_fu_84[2:0];
