...
reg   [63:0] empty_250_fu_168;
reg   [63:0] empty_251_fu_172;
...
#0 i_fu_160 = 2'd0;
#0 empty_249_fu_164 = 64'd0;
#0 empty_250_fu_168 = 64'd0;
#0 empty_251_fu_172 = 64'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            empty_251_fu_172 <= empty_34;
        end else if ((1'b1 == ap_condition_874)) begin
            empty_251_fu_172 <= mul5_i_reg_1076;
        end
    end
end
always @ (posedge ap_clk) begin
...
assign p_out = empty_251_fu_172;
assign p_out1 = empty_250_fu_168;
assign p_out2 = empty_249_fu_164;
