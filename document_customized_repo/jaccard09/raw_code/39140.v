...
wire   [6:0] indvars_iv_next173_fu_208_p2;
reg   [6:0] indvars_iv_next173_reg_351;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        r_fu_74 <= indvars_iv_next173_fu_208_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        indvars_iv_next173_reg_351 <= indvars_iv_next173_fu_208_p2;
        r_1_reg_343 <= r_fu_74;
...
assign indvars_iv_next173_fu_208_p2 = (r_fu_74 + 7'd1);
