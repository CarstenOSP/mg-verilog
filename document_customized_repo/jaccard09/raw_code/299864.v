module backprop_backprop_Pipeline_label_41 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v5_0_i,v5_0_o,v5_0_o_ap_vld,v5_2_i,v5_2_o,v5_2_o_ap_vld,v5_1_i,v5_1_o,v5_1_o_ap_vld,mux_case_0248254_reload,mux_case_1249258_reload,mux_case_2250262_reload,v227_out,v227_out_ap_vld,grp_fu_8113_p_din0,grp_fu_8113_p_din1,grp_fu_8113_p_opcode,grp_fu_8113_p_dout0,grp_fu_8113_p_ce,grp_fu_8129_p_din0,grp_fu_8129_p_din1,grp_fu_8129_p_dout0,grp_fu_8129_p_ce); 
...
input  [63:0] mux_case_0248254_reload;
input  [63:0] mux_case_1249258_reload;
input  [63:0] mux_case_2250262_reload;
output  [63:0] v227_out;
output   v227_out_ap_vld;
output  [63:0] grp_fu_8113_p_din0;
output  [63:0] grp_fu_8113_p_din1;
output  [1:0] grp_fu_8113_p_opcode;
...
sparsemux_7_2_64_1_1_U1490(.din0(mux_case_0248254_reload),.din1(mux_case_1249258_reload),.din2(mux_case_2250262_reload),.def(v228_fu_156_p7),.sel(ap_sig_allocacmp_v226_1),.dout(v228_fu_156_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U1491(.din0(v230_fu_193_p2),.din1(v230_fu_193_p4),.din2(v230_fu_193_p6),.def(v230_fu_193_p7),.sel(v226_1_reg_252),.dout(v230_fu_193_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        v225_fu_56 <= grp_fu_8113_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v229_reg_272 <= grp_fu_8129_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v231_reg_277 <= grp_fu_8113_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v232_reg_283 <= grp_fu_8129_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_v225_load_1 = grp_fu_8113_p_dout0;
    end else begin
...
assign bitcast_ln368_fu_217_p1 = grp_fu_8113_p_dout0;
assign grp_fu_8113_p_ce = 1'b1;
assign grp_fu_8113_p_din0 = grp_fu_128_p0;
assign grp_fu_8113_p_din1 = grp_fu_128_p1;
assign grp_fu_8113_p_opcode = grp_fu_128_opcode;
assign grp_fu_8129_p_ce = 1'b1;
assign grp_fu_8129_p_din0 = grp_fu_132_p0;
assign grp_fu_8129_p_din1 = grp_fu_132_p1;
