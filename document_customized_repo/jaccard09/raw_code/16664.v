...
wire   [11:0] tmp_97_fu_729_p3;
reg   [11:0] tmp_97_reg_1005;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_435_min_s_18_out;
wire    grp_viterbi_Pipeline_L_state_fu_435_min_s_18_out_ap_vld;
...
wire   [63:0] tmp_138_cast_fu_535_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_5_reg_895[11 : 4] <= tmp_138_cast_fu_535_p1[11 : 4];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_97_reg_1005[11 : 4] <= tmp_97_fu_729_p3[11 : 4];
...
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_435_min_s_18_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state44))) begin
        min_s_18_loc_fu_120 <= grp_viterbi_Pipeline_L_state_fu_435_min_s_18_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_425_min_s_8_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_8_loc_fu_124 <= grp_viterbi_Pipeline_L_end_fu_425_min_s_8_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        llike_address0_local = llike_addr_5_reg_895;
...
assign tmp_138_cast_fu_535_p1 = tmp_s_fu_527_p3;
assign tmp_15_fu_540_p3 = ((trunc_ln18_fu_519_p1[0:0] == 1'b1) ? obs_1_q0 : obs_0_q0);
assign tmp_97_fu_729_p3 = {{trunc_ln50_reg_989}, {4'd0}};
assign tmp_98_fu_667_p3 = {{t_2_reg_860}, {lshr_ln7_reg_937}};
...
assign zext_ln33_fu_673_p1 = tmp_98_fu_667_p3;
assign zext_ln52_1_fu_766_p1 = lshr_ln52_1_fu_756_p4;
assign zext_ln52_2_fu_736_p1 = tmp_97_fu_729_p3;
...
always @ (posedge ap_clk) begin
    ...
    llike_addr_5_reg_895[3:0] <= 4'b0000;
    conv32_udiv_cast_reg_905[10:7] <= 4'b0000;
    tmp_97_reg_1005[3:0] <= 4'b0000;
end
endmodule 