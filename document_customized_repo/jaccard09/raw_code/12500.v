...
wire   [31:0] tmp_4_fu_390_p13;
reg   [31:0] tmp_4_reg_943;
wire   [31:0] tmp_5_fu_418_p13;
reg   [31:0] tmp_5_reg_948;
wire   [31:0] tmp_6_fu_446_p13;
reg   [31:0] tmp_6_reg_953;
reg   [31:0] E_5_load_reg_958;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] E_6_load_reg_963;
reg   [31:0] B_5_load_reg_969;
wire   [31:0] temp_4_fu_552_p2;
reg   [31:0] temp_4_reg_975;
...
wire   [31:0] C_9_fu_631_p3;
reg   [31:0] C_9_reg_1026;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3_11001;
wire   [31:0] E_9_fu_668_p3;
reg   [31:0] E_9_reg_1032;
...
reg   [31:0] E_5_fu_118;
wire   [31:0] D_5_fu_688_p3;
reg   [31:0] E_6_fu_122;
wire   [31:0] C_5_fu_732_p3;
reg   [31:0] B_1_fu_126;
wire   [31:0] B_9_fu_797_p2;
reg   [31:0] B_5_fu_130;
wire   [31:0] A_7_fu_852_p2;
reg   [4:0] i_1_fu_134;
wire   [4:0] add_ln116_fu_838_p2;
reg   [4:0] ap_sig_allocacmp_i;
wire    ap_block_pp0_stage0_01001;
wire   [31:0] tmp_s_fu_362_p11;
wire   [31:0] tmp_4_fu_390_p11;
wire   [31:0] tmp_5_fu_418_p11;
wire   [31:0] tmp_6_fu_446_p11;
...
wire   [4:0] tmp_4_fu_390_p1;
wire   [4:0] tmp_4_fu_390_p3;
wire   [4:0] tmp_4_fu_390_p5;
wire   [4:0] tmp_4_fu_390_p7;
wire  signed [4:0] tmp_4_fu_390_p9;
wire   [4:0] tmp_5_fu_418_p1;
wire   [4:0] tmp_5_fu_418_p3;
wire   [4:0] tmp_5_fu_418_p5;
wire   [4:0] tmp_5_fu_418_p7;
wire  signed [4:0] tmp_5_fu_418_p9;
wire   [4:0] tmp_6_fu_446_p1;
wire   [4:0] tmp_6_fu_446_p3;
wire   [4:0] tmp_6_fu_446_p5;
wire   [4:0] tmp_6_fu_446_p7;
wire  signed [4:0] tmp_6_fu_446_p9;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 7'd1;
...
sparsemux_11_5_32_1_1_U100(.din0(W),.din1(W_4),.din2(W_8),.din3(W_12),.din4(W_32_reload),.def(tmp_s_fu_362_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_s_fu_362_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_11_5_32_1_1_U101(.din0(W_1),.din1(W_5),.din2(W_9),.din3(W_13),.din4(W_33_reload),.def(tmp_4_fu_390_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_4_fu_390_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_11_5_32_1_1_U102(.din0(W_2),.din1(W_6),.din2(W_10),.din3(W_14),.din4(W_34_reload),.def(tmp_5_fu_418_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_5_fu_418_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_11_5_32_1_1_U103(.din0(W_3),.din1(W_7),.din2(W_11),.din3(W_15),.din4(W_35_reload),.def(tmp_6_fu_446_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_6_fu_446_p13));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        B_5_load_reg_969 <= B_5_fu_130;
        E_5_load_reg_958 <= E_5_fu_118;
        E_6_load_reg_963 <= E_6_fu_122;
        lshr_ln118_1_reg_986 <= {{B_1_fu_126[31:2]}};
        lshr_ln118_2_reg_996 <= {{temp_4_fu_552_p2[31:27]}};
        lshr_ln118_3_reg_1006 <= {{B_5_fu_130[31:2]}};
        lshr_ln118_5_reg_1016 <= {{temp_4_fu_552_p2[31:2]}};
        temp_4_reg_975 <= temp_4_fu_552_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        C_9_reg_1026 <= C_9_fu_631_p3;
        E_9_reg_1032 <= E_9_fu_668_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_4_reg_943 <= tmp_4_fu_390_p13;
        tmp_5_reg_948 <= tmp_5_fu_418_p13;
        tmp_6_reg_953 <= tmp_6_fu_446_p13;
        tmp_s_reg_938 <= tmp_s_fu_362_p13;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        lshr_ln118_6_reg_1062 <= {{B_9_fu_797_p2[31:27]}};
...
assign A_7_fu_852_p2 = (add_ln118_14_reg_1067 + add_ln118_12_fu_848_p2);
assign B_1_out = B_1_fu_126;
assign B_9_fu_797_p2 = (add_ln118_10_reg_1052 + add_ln118_8_fu_792_p2);
assign C_51_out = E_6_fu_122;
assign C_5_fu_732_p3 = {{trunc_ln118_7_fu_718_p1}, {lshr_ln118_7_fu_722_p4}};
assign C_9_fu_631_p3 = {{trunc_ln118_1_reg_981}, {lshr_ln118_1_reg_986}};
assign D_51_out = E_5_fu_118;
assign D_5_fu_688_p3 = {{trunc_ln118_5_reg_1011}, {lshr_ln118_5_reg_1016}};
assign E_1_out = E_1_fu_114;
assign E_9_fu_668_p3 = {{trunc_ln118_3_reg_1001}, {lshr_ln118_3_reg_1006}};
assign add_ln116_fu_838_p2 = (i_reg_929 + 5'd4);
assign add_ln118_10_fu_767_p2 = (add_ln118_9_fu_761_p2 + E_6_load_reg_963);
assign add_ln118_12_fu_848_p2 = (C_9_reg_1026 + tmp_6_reg_953);
...
assign add_ln118_4_fu_658_p2 = (tmp_4_reg_943 + or_ln118_2_fu_652_p2);
assign add_ln118_5_fu_620_p2 = (or_ln118_4_fu_614_p3 + 32'd1518500249);
assign add_ln118_6_fu_626_p2 = (add_ln118_5_fu_620_p2 + E_5_load_reg_958);
assign add_ln118_8_fu_792_p2 = (or_ln118_3_fu_786_p2 + tmp_5_reg_948);
assign add_ln118_9_fu_761_p2 = (or_ln118_7_fu_755_p3 + 32'd1518500249);
assign add_ln118_fu_546_p2 = (or_ln118_fu_521_p2 + E_1_fu_114);
assign and_ln118_1_fu_515_p2 = (xor_ln118_fu_503_p2 & E_5_fu_118);
assign and_ln118_2_fu_642_p2 = (C_9_fu_631_p3 & B_5_load_reg_969);
assign and_ln118_3_fu_647_p2 = (xor_ln118_1_fu_637_p2 & E_6_load_reg_963);
assign and_ln118_4_fu_777_p2 = (temp_4_reg_975 & E_9_reg_1032);
assign and_ln118_5_fu_781_p2 = (xor_ln118_2_fu_772_p2 & C_9_reg_1026);
assign and_ln118_6_fu_700_p2 = (temp_5_fu_663_p2 & D_5_fu_688_p3);
assign and_ln118_7_fu_706_p2 = (xor_ln118_3_fu_694_p2 & E_9_fu_668_p3);
assign and_ln118_fu_509_p2 = (E_6_fu_122 & B_1_fu_126);
...
assign lshr_ln_fu_493_p4 = {{B_5_fu_130[31:27]}};
...
assign temp_4_fu_552_p2 = (add_ln118_fu_546_p2 + add_ln118_2_fu_540_p2);
assign temp_5_fu_663_p2 = (add_ln118_6_reg_1021 + add_ln118_4_fu_658_p2);
assign tmp_4_fu_390_p11 = 'bx;
assign tmp_5_fu_418_p11 = 'bx;
assign tmp_6_fu_446_p11 = 'bx;
assign tmp_s_fu_362_p11 = 'bx;
assign trunc_ln118_1_fu_558_p1 = B_1_fu_126[1:0];
assign trunc_ln118_2_fu_572_p1 = temp_4_fu_552_p2[26:0];
assign trunc_ln118_3_fu_586_p1 = B_5_fu_130[1:0];
assign trunc_ln118_4_fu_674_p1 = temp_5_fu_663_p2[26:0];
assign trunc_ln118_5_fu_600_p1 = temp_4_fu_552_p2[1:0];
assign trunc_ln118_6_fu_802_p1 = B_9_fu_797_p2[26:0];
assign trunc_ln118_7_fu_718_p1 = temp_5_fu_663_p2[1:0];
assign trunc_ln118_fu_489_p1 = B_5_fu_130[26:0];
assign xor_ln118_1_fu_637_p2 = (32'd4294967295 ^ B_5_load_reg_969);
assign xor_ln118_2_fu_772_p2 = (temp_4_reg_975 ^ 32'd4294967295);
