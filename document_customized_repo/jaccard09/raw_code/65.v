...
wire   [31:0] tmp_1_fu_1143_p17;
wire   [31:0] tmp_2_fu_1182_p17;
wire   [31:0] tmp_3_fu_1221_p17;
wire   [31:0] tmp_fu_1104_p19;
wire   [31:0] tmp_2_fu_1182_p19;
wire   [31:0] tmp_1_fu_1143_p19;
wire   [31:0] tmp_3_fu_1221_p19;
wire   [31:0] xor_ln108_1_fu_1266_p2;
wire   [31:0] xor_ln108_fu_1260_p2;
wire   [31:0] tmp_4_fu_1286_p17;
wire   [31:0] tmp_5_fu_1325_p17;
wire   [31:0] tmp_6_fu_1364_p17;
wire   [31:0] tmp_7_fu_1403_p17;
wire   [31:0] tmp_4_fu_1286_p19;
wire   [31:0] tmp_6_fu_1364_p19;
wire   [31:0] tmp_5_fu_1325_p19;
wire   [31:0] tmp_7_fu_1403_p19;
...
wire  signed [3:0] tmp_1_fu_1143_p1;
wire  signed [3:0] tmp_1_fu_1143_p3;
wire  signed [3:0] tmp_1_fu_1143_p5;
wire  signed [3:0] tmp_1_fu_1143_p7;
wire   [3:0] tmp_1_fu_1143_p9;
wire   [3:0] tmp_1_fu_1143_p11;
wire   [3:0] tmp_1_fu_1143_p13;
wire   [3:0] tmp_1_fu_1143_p15;
wire  signed [3:0] tmp_2_fu_1182_p1;
wire   [3:0] tmp_2_fu_1182_p3;
wire   [3:0] tmp_2_fu_1182_p5;
wire   [3:0] tmp_2_fu_1182_p7;
wire   [3:0] tmp_2_fu_1182_p9;
wire  signed [3:0] tmp_2_fu_1182_p11;
wire  signed [3:0] tmp_2_fu_1182_p13;
wire  signed [3:0] tmp_2_fu_1182_p15;
wire   [3:0] tmp_3_fu_1221_p1;
wire   [3:0] tmp_3_fu_1221_p3;
wire   [3:0] tmp_3_fu_1221_p5;
wire   [3:0] tmp_3_fu_1221_p7;
wire  signed [3:0] tmp_3_fu_1221_p9;
wire  signed [3:0] tmp_3_fu_1221_p11;
wire  signed [3:0] tmp_3_fu_1221_p13;
wire  signed [3:0] tmp_3_fu_1221_p15;
wire   [3:0] tmp_4_fu_1286_p1;
wire   [3:0] tmp_4_fu_1286_p3;
wire   [3:0] tmp_4_fu_1286_p5;
wire  signed [3:0] tmp_4_fu_1286_p7;
wire  signed [3:0] tmp_4_fu_1286_p9;
wire  signed [3:0] tmp_4_fu_1286_p11;
wire  signed [3:0] tmp_4_fu_1286_p13;
wire   [3:0] tmp_4_fu_1286_p15;
wire  signed [3:0] tmp_5_fu_1325_p1;
wire  signed [3:0] tmp_5_fu_1325_p3;
wire  signed [3:0] tmp_5_fu_1325_p5;
wire  signed [3:0] tmp_5_fu_1325_p7;
wire   [3:0] tmp_5_fu_1325_p9;
wire   [3:0] tmp_5_fu_1325_p11;
wire   [3:0] tmp_5_fu_1325_p13;
wire   [3:0] tmp_5_fu_1325_p15;
wire  signed [3:0] tmp_6_fu_1364_p1;
wire   [3:0] tmp_6_fu_1364_p3;
wire   [3:0] tmp_6_fu_1364_p5;
wire   [3:0] tmp_6_fu_1364_p7;
wire   [3:0] tmp_6_fu_1364_p9;
wire  signed [3:0] tmp_6_fu_1364_p11;
wire  signed [3:0] tmp_6_fu_1364_p13;
wire  signed [3:0] tmp_6_fu_1364_p15;
wire   [3:0] tmp_7_fu_1403_p1;
wire   [3:0] tmp_7_fu_1403_p3;
wire   [3:0] tmp_7_fu_1403_p5;
wire   [3:0] tmp_7_fu_1403_p7;
wire  signed [3:0] tmp_7_fu_1403_p9;
wire  signed [3:0] tmp_7_fu_1403_p11;
wire  signed [3:0] tmp_7_fu_1403_p13;
wire  signed [3:0] tmp_7_fu_1403_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 2'd1;
...
sparsemux_17_4_32_1_1_U7(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.din4(W_8_q0),.din5(W_10_q0),.din6(W_12_q0),.din7(W_14_q0),.def(tmp_1_fu_1143_p17),.sel(trunc_ln106_1_reg_1493),.dout(tmp_1_fu_1143_p19));
...
sparsemux_17_4_32_1_1_U8(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.din4(W_8_q0),.din5(W_10_q0),.din6(W_12_q0),.din7(W_14_q0),.def(tmp_2_fu_1182_p17),.sel(trunc_ln106_1_reg_1493),.dout(tmp_2_fu_1182_p19));
...
sparsemux_17_4_32_1_1_U9(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.din4(W_8_q0),.din5(W_10_q0),.din6(W_12_q0),.din7(W_14_q0),.def(tmp_3_fu_1221_p17),.sel(trunc_ln106_1_reg_1493),.dout(tmp_3_fu_1221_p19));
...
sparsemux_17_4_32_1_1_U10(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.din4(W_8_q0),.din5(W_10_q0),.din6(W_12_q0),.din7(W_14_q0),.def(tmp_4_fu_1286_p17),.sel(trunc_ln106_1_reg_1493),.dout(tmp_4_fu_1286_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h8 ),.din0_WIDTH( 32 ),.CASE1( 4'hA ),.din1_WIDTH( 32 ),.CASE2( 4'hC ),.din2_WIDTH( 32 ),.CASE3( 4'hE ),.din3_WIDTH( 32 ),.CASE4( 4'h0 ),.din4_WIDTH( 32 ),.CASE5( 4'h2 ),.din5_WIDTH( 32 ),.CASE6( 4'h4 ),.din6_WIDTH( 32 ),.CASE7( 4'h6 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_17_4_32_1_1_U11(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.din4(W_9_q0),.din5(W_11_q0),.din6(W_13_q0),.din7(W_15_q0),.def(tmp_5_fu_1325_p17),.sel(trunc_ln106_1_reg_1493),.dout(tmp_5_fu_1325_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'hE ),.din0_WIDTH( 32 ),.CASE1( 4'h0 ),.din1_WIDTH( 32 ),.CASE2( 4'h2 ),.din2_WIDTH( 32 ),.CASE3( 4'h4 ),.din3_WIDTH( 32 ),.CASE4( 4'h6 ),.din4_WIDTH( 32 ),.CASE5( 4'h8 ),.din5_WIDTH( 32 ),.CASE6( 4'hA ),.din6_WIDTH( 32 ),.CASE7( 4'hC ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_17_4_32_1_1_U12(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.din4(W_9_q0),.din5(W_11_q0),.din6(W_13_q0),.din7(W_15_q0),.def(tmp_6_fu_1364_p17),.sel(trunc_ln106_1_reg_1493),.dout(tmp_6_fu_1364_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h2 ),.din1_WIDTH( 32 ),.CASE2( 4'h4 ),.din2_WIDTH( 32 ),.CASE3( 4'h6 ),.din3_WIDTH( 32 ),.CASE4( 4'h8 ),.din4_WIDTH( 32 ),.CASE5( 4'hA ),.din5_WIDTH( 32 ),.CASE6( 4'hC ),.din6_WIDTH( 32 ),.CASE7( 4'hE ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_17_4_32_1_1_U13(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.din4(W_9_q0),.din5(W_11_q0),.din6(W_13_q0),.din7(W_15_q0),.def(tmp_7_fu_1403_p17),.sel(trunc_ln106_1_reg_1493),.dout(tmp_7_fu_1403_p19));
...
assign tmp_1_fu_1143_p17 = 'bx;
assign tmp_2_fu_1182_p17 = 'bx;
assign tmp_3_fu_1221_p17 = 'bx;
assign tmp_4_fu_1286_p17 = 'bx;
assign tmp_5_fu_1325_p17 = 'bx;
assign tmp_6_fu_1364_p17 = 'bx;
assign tmp_7_fu_1403_p17 = 'bx;
...
assign xor_ln108_1_fu_1266_p2 = (tmp_3_fu_1221_p19 ^ tmp_1_fu_1143_p19);
assign xor_ln108_2_fu_1272_p2 = (xor_ln108_fu_1260_p2 ^ xor_ln108_1_fu_1266_p2);
assign xor_ln108_3_fu_1442_p2 = (tmp_6_fu_1364_p19 ^ tmp_4_fu_1286_p19);
assign xor_ln108_4_fu_1448_p2 = (tmp_7_fu_1403_p19 ^ tmp_5_fu_1325_p19);
assign xor_ln108_5_fu_1454_p2 = (xor_ln108_4_fu_1448_p2 ^ xor_ln108_3_fu_1442_p2);
assign xor_ln108_fu_1260_p2 = (tmp_fu_1104_p19 ^ tmp_2_fu_1182_p19);
