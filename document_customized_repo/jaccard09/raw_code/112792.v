...
wire   [1:0] trunc_ln50_fu_285_p1;
reg   [1:0] trunc_ln50_reg_424;
wire   [31:0] tmp_s_fu_345_p11;
reg   [31:0] tmp_s_reg_470;
wire   [31:0] tmp_2_fu_368_p11;
reg   [31:0] tmp_2_reg_475;
wire   [63:0] zext_ln52_fu_317_p1;
reg   [6:0] j_fu_84;
wire   [6:0] add_ln51_fu_329_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_88;
wire   [6:0] select_ln50_fu_277_p3;
reg   [11:0] indvar_flatten20_fu_92;
wire   [11:0] add_ln50_1_fu_238_p2;
reg   [11:0] ap_sig_allocacmp_indvar_flatten20_load;
wire   [31:0] bitcast_ln52_fu_391_p1;
reg    ap_block_pp0_stage0_01001;
reg    E_out_0_write_local;
wire   [31:0] bitcast_ln52_1_fu_395_p1;
...
wire   [6:0] add_ln50_fu_255_p2;
wire   [6:0] select_ln6_fu_269_p3;
wire   [3:0] tmp_1_fu_299_p4;
wire   [4:0] lshr_ln6_7_fu_289_p4;
wire   [8:0] tmp_3_fu_309_p3;
wire   [31:0] tmp_s_fu_345_p9;
wire   [31:0] tmp_2_fu_368_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_s_fu_345_p1;
wire   [1:0] tmp_s_fu_345_p3;
wire  signed [1:0] tmp_s_fu_345_p5;
wire  signed [1:0] tmp_s_fu_345_p7;
wire   [1:0] tmp_2_fu_368_p1;
wire   [1:0] tmp_2_fu_368_p3;
wire  signed [1:0] tmp_2_fu_368_p5;
wire  signed [1:0] tmp_2_fu_368_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U850(.din0(buff_E_out_q0),.din1(buff_E_out_1_q0),.din2(buff_E_out_2_q0),.din3(buff_E_out_3_q0),.def(tmp_s_fu_345_p9),.sel(trunc_ln50_reg_424),.dout(tmp_s_fu_345_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U851(.din0(buff_E_out_4_q0),.din1(buff_E_out_5_q0),.din2(buff_E_out_6_q0),.din3(buff_E_out_7_q0),.def(tmp_2_fu_368_p9),.sel(trunc_ln50_reg_424),.dout(tmp_2_fu_368_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_fu_88 <= select_ln50_fu_277_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln50_fu_232_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten20_fu_92 <= add_ln50_1_fu_238_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln50_reg_424 <= trunc_ln50_fu_285_p1;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        tmp_2_reg_475 <= tmp_2_fu_368_p11;
        tmp_s_reg_470 <= tmp_s_fu_345_p11;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln50_fu_232_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign E_out_0_din = bitcast_ln52_fu_391_p1;
assign E_out_0_write = E_out_0_write_local;
assign E_out_1_din = bitcast_ln52_1_fu_395_p1;
assign E_out_1_write = E_out_1_write_local;
assign add_ln50_1_fu_238_p2 = (ap_sig_allocacmp_indvar_flatten20_load + 12'd1);
assign add_ln50_fu_255_p2 = (i_fu_88 + 7'd1);
assign add_ln51_fu_329_p2 = (select_ln6_fu_269_p3 + 7'd2);
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter3 = ((1'b0 == E_out_1_full_n) | (1'b0 == E_out_0_full_n));
end
...
assign bitcast_ln52_1_fu_395_p1 = tmp_2_reg_475;
assign bitcast_ln52_fu_391_p1 = tmp_s_reg_470;
assign buff_E_out_1_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_1_ce0 = buff_E_out_1_ce0_local;
assign buff_E_out_2_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_2_ce0 = buff_E_out_2_ce0_local;
assign buff_E_out_3_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_3_ce0 = buff_E_out_3_ce0_local;
assign buff_E_out_4_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_4_ce0 = buff_E_out_4_ce0_local;
assign buff_E_out_5_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_5_ce0 = buff_E_out_5_ce0_local;
assign buff_E_out_6_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_6_ce0 = buff_E_out_6_ce0_local;
assign buff_E_out_7_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_7_ce0 = buff_E_out_7_ce0_local;
assign buff_E_out_address0 = zext_ln52_fu_317_p1;
assign buff_E_out_ce0 = buff_E_out_ce0_local;
assign icmp_ln50_fu_232_p2 = ((ap_sig_allocacmp_indvar_flatten20_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_7_fu_289_p4 = {{select_ln6_fu_269_p3[5:1]}};
assign select_ln50_fu_277_p3 = ((tmp_fu_261_p3[0:0] == 1'b1) ? add_ln50_fu_255_p2 : i_fu_88);
assign select_ln6_fu_269_p3 = ((tmp_fu_261_p3[0:0] == 1'b1) ? 7'd0 : j_fu_84);
assign tmp_1_fu_299_p4 = {{select_ln50_fu_277_p3[5:2]}};
assign tmp_2_fu_368_p9 = 'bx;
assign tmp_3_fu_309_p3 = {{tmp_1_fu_299_p4}, {lshr_ln6_7_fu_289_p4}};
assign tmp_fu_261_p3 = j_fu_84[32'd6];
assign tmp_s_fu_345_p9 = 'bx;
assign trunc_ln50_fu_285_p1 = select_ln50_fu_277_p3[1:0];
assign zext_ln52_fu_317_p1 = tmp_3_fu_309_p3;
endmodule 