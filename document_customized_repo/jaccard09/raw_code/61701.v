...
wire   [9:0] grp_gemm_Pipeline_inner_fu_149_m1_0_address1;
wire    grp_gemm_Pipeline_inner_fu_149_m1_0_ce1;
...
wire   [9:0] grp_gemm_Pipeline_inner_fu_149_m1_1_address1;
wire    grp_gemm_Pipeline_inner_fu_149_m1_1_ce1;
wire   [9:0] grp_gemm_Pipeline_inner_fu_149_m1_2_address0;
wire    grp_gemm_Pipeline_inner_fu_149_m1_2_ce0;
wire   [9:0] grp_gemm_Pipeline_inner_fu_149_m1_2_address1;
wire    grp_gemm_Pipeline_inner_fu_149_m1_2_ce1;
wire   [9:0] grp_gemm_Pipeline_inner_fu_149_m1_3_address0;
wire    grp_gemm_Pipeline_inner_fu_149_m1_3_ce0;
wire   [9:0] grp_gemm_Pipeline_inner_fu_149_m1_3_address1;
wire    grp_gemm_Pipeline_inner_fu_149_m1_3_ce1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln9_fu_198_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_78 <= 7'd0;
    end else if (((icmp_ln9_fu_198_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln8_fu_182_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_reg_138 <= 7'd0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((icmp_ln8_fu_182_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln9_fu_198_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
...
assign m1_0_address1 = grp_gemm_Pipeline_inner_fu_149_m1_0_address1;
assign m1_0_ce0 = grp_gemm_Pipeline_inner_fu_149_m1_0_ce0;
assign m1_0_ce1 = grp_gemm_Pipeline_inner_fu_149_m1_0_ce1;
assign m1_1_address0 = grp_gemm_Pipeline_inner_fu_149_m1_1_address0;
assign m1_1_address1 = grp_gemm_Pipeline_inner_fu_149_m1_1_address1;
assign m1_1_ce0 = grp_gemm_Pipeline_inner_fu_149_m1_1_ce0;
assign m1_1_ce1 = grp_gemm_Pipeline_inner_fu_149_m1_1_ce1;
assign m1_2_address0 = grp_gemm_Pipeline_inner_fu_149_m1_2_address0;
assign m1_2_address1 = grp_gemm_Pipeline_inner_fu_149_m1_2_address1;
assign m1_2_ce0 = grp_gemm_Pipeline_inner_fu_149_m1_2_ce0;
assign m1_2_ce1 = grp_gemm_Pipeline_inner_fu_149_m1_2_ce1;
assign m1_3_address0 = grp_gemm_Pipeline_inner_fu_149_m1_3_address0;
assign m1_3_address1 = grp_gemm_Pipeline_inner_fu_149_m1_3_address1;
assign m1_3_ce0 = grp_gemm_Pipeline_inner_fu_149_m1_3_ce0;
assign m1_3_ce1 = grp_gemm_Pipeline_inner_fu_149_m1_3_ce1;
