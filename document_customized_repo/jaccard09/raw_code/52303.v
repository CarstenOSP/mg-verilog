...
reg   [6:0] i_6_reg_1187;
reg   [6:0] i_6_reg_1187_pp0_iter1_reg;
reg   [6:0] i_6_reg_1187_pp0_iter2_reg;
reg   [6:0] i_6_reg_1187_pp0_iter3_reg;
reg   [6:0] i_6_reg_1187_pp0_iter4_reg;
reg   [6:0] i_6_reg_1187_pp0_iter5_reg;
reg   [6:0] i_6_reg_1187_pp0_iter6_reg;
reg   [6:0] i_6_reg_1187_pp0_iter7_reg;
reg   [6:0] i_6_reg_1187_pp0_iter8_reg;
...
sparsemux_17_4_64_1_1_x_U586(.din0(activations2_q0),.din1(activations2_2_q0),.din2(activations2_4_q0),.din3(activations2_6_q0),.din4(activations2_8_q0),.din5(activations2_10_q0),.din6(activations2_12_q0),.din7(activations2_14_q0),.def(tmp_s_fu_920_p17),.sel(trunc_ln73_fu_917_p1),.dout(tmp_s_fu_920_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_4_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h2 ),.din1_WIDTH( 64 ),.CASE2( 4'h4 ),.din2_WIDTH( 64 ),.CASE3( 4'h6 ),.din3_WIDTH( 64 ),.CASE4( 4'h8 ),.din4_WIDTH( 64 ),.CASE5( 4'hA ),.din5_WIDTH( 64 ),.CASE6( 4'hC ),.din6_WIDTH( 64 ),.CASE7( 4'hE ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_17_4_64_1_1_x_U587(.din0(activations2_1_q0),.din1(activations2_3_q0),.din2(activations2_5_q0),.din3(activations2_7_q0),.din4(activations2_9_q0),.din5(activations2_11_q0),.din6(activations2_13_q0),.din7(activations2_15_q0),.def(tmp_51_fu_960_p17),.sel(trunc_ln73_fu_917_p1),.dout(tmp_51_fu_960_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_6_reg_1187 <= ap_sig_allocacmp_i_6;
        i_6_reg_1187_pp0_iter1_reg <= i_6_reg_1187;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_6_reg_1187_pp0_iter2_reg <= i_6_reg_1187_pp0_iter1_reg;
        i_6_reg_1187_pp0_iter3_reg <= i_6_reg_1187_pp0_iter2_reg;
        i_6_reg_1187_pp0_iter4_reg <= i_6_reg_1187_pp0_iter3_reg;
        i_6_reg_1187_pp0_iter5_reg <= i_6_reg_1187_pp0_iter4_reg;
        i_6_reg_1187_pp0_iter6_reg <= i_6_reg_1187_pp0_iter5_reg;
        i_6_reg_1187_pp0_iter7_reg <= i_6_reg_1187_pp0_iter6_reg;
        i_6_reg_1187_pp0_iter8_reg <= i_6_reg_1187_pp0_iter7_reg;
        mul_16_i_reg_1308 <= grp_fu_5693_p_dout0;
        mul_1_1_i_reg_1344 <= grp_fu_5705_p_dout0;
        mul_1_2_i_reg_1356 <= grp_fu_5709_p_dout0;
        mul_1_i_reg_1332 <= grp_fu_5701_p_dout0;
        mul_2_i_reg_1320 <= grp_fu_5697_p_dout0;
        mul_i3_reg_1296 <= grp_fu_5689_p_dout0;
...
assign add_ln73_fu_906_p2 = (ap_sig_allocacmp_i_6 + 7'd2);
...
assign lshr_ln8_fu_876_p4 = {{ap_sig_allocacmp_i_6[5:4]}};
assign lshr_ln9_fu_1020_p4 = {{sub_ln75_fu_1014_p2[7:4]}};
...
assign tmp_fu_868_p3 = ap_sig_allocacmp_i_6[32'd6];
assign tmp_s_fu_920_p17 = 'bx;
assign trunc_ln73_fu_917_p1 = i_6_reg_1187[3:0];
assign trunc_ln75_fu_1003_p1 = i_6_reg_1187_pp0_iter8_reg[5:0];
assign zext_ln72_fu_886_p1 = lshr_ln8_fu_876_p4;
assign zext_ln75_1_fu_1030_p1 = lshr_ln9_fu_1020_p4;
...
assign zext_ln75_fu_1000_p1 = i_6_reg_1187_pp0_iter8_reg;
endmodule 