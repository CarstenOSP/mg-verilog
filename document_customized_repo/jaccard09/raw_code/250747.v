...
reg   [17:0] mul_ln32_reg_95;
wire    ap_CS_fsm_state2;
reg   [31:0] v357_load_reg_100;
wire   [31:0] v8_fu_81_p1;
reg   [31:0] v8_reg_105;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        mul_ln32_reg_95 <= mul_ln32_fu_75_p2;
        v357_load_reg_100 <= v357_q0;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        v8_reg_105 <= v8_fu_81_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((grp_kernel_atax_node1_Pipeline_label_0_fu_57_ap_done == 1'b0) | (v350_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((grp_kernel_atax_node1_Pipeline_label_0_fu_57_ap_done == 1'b0) | (v350_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign v8_fu_81_p1 = v357_load_reg_100;
endmodule 