...
needwun_needwun_Pipeline_pad_a grp_needwun_Pipeline_pad_a_fu_198(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_needwun_Pipeline_pad_a_fu_198_ap_start),.ap_done(grp_needwun_Pipeline_pad_a_fu_198_ap_done),.ap_idle(grp_needwun_Pipeline_pad_a_fu_198_ap_idle),.ap_ready(grp_needwun_Pipeline_pad_a_fu_198_ap_ready),.sext_ln83(b_str_idx_reg_114),.alignedA_0_address0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_0_address0),.alignedA_0_ce0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_0_ce0),.alignedA_0_we0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_0_we0),.alignedA_0_d0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_0_d0),.alignedA_1_address0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_1_address0),.alignedA_1_ce0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_1_ce0),.alignedA_1_we0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_1_we0),.alignedA_1_d0(grp_needwun_Pipeline_pad_a_fu_198_alignedA_1_d0));
needwun_needwun_Pipeline_pad_b grp_needwun_Pipeline_pad_b_fu_208(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_needwun_Pipeline_pad_b_fu_208_ap_start),.ap_done(grp_needwun_Pipeline_pad_b_fu_208_ap_done),.ap_idle(grp_needwun_Pipeline_pad_b_fu_208_ap_idle),.ap_ready(grp_needwun_Pipeline_pad_b_fu_208_ap_ready),.sext_ln83(b_str_idx_reg_114),.alignedB_0_address0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_0_address0),.alignedB_0_ce0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_0_ce0),.alignedB_0_we0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_0_we0),.alignedB_0_d0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_0_d0),.alignedB_1_address0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_1_address0),.alignedB_1_ce0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_1_ce0),.alignedB_1_we0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_1_we0),.alignedB_1_d0(grp_needwun_Pipeline_pad_b_fu_208_alignedB_1_d0));
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state10) & (icmp_ln83_fu_332_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) & (icmp_ln83_reg_392 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (grp_needwun_Pipeline_fill_out_fill_in_fu_152_ap_done == 1'b1))) begin
...
always @ (*) begin
    ap_block_state11_on_subcall_done = (((grp_needwun_Pipeline_pad_b_fu_208_ap_done == 1'b0) & (icmp_ln83_reg_392 == 1'd1)) | ((grp_needwun_Pipeline_pad_a_fu_198_ap_done == 1'b0) & (icmp_ln83_reg_392 == 1'd1)));
end
...
assign or_ln65_1_fu_314_p3 = {{tmp_3_fu_304_p4}, {1'd1}};
...
assign tmp_3_fu_304_p4 = {{a_str_idx_0_0_loc_fu_106[31:1]}};
