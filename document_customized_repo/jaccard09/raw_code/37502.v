...
wire   [4:0] indvars_iv_next73_dup_fu_328_p2;
reg   [4:0] indvars_iv_next73_dup_reg_797;
wire   [4:0] select_ln36_fu_379_p3;
reg   [4:0] select_ln36_reg_802;
wire   [3:0] k_mid2_fu_390_p3;
reg   [3:0] k_mid2_reg_813;
wire   [4:0] indvars_iv_next73_mid2_fu_402_p3;
reg   [4:0] indvars_iv_next73_mid2_reg_823;
wire   [4:0] select_ln37_fu_409_p3;
reg   [4:0] select_ln37_reg_829;
wire   [4:0] tmp2_fu_414_p2;
reg   [4:0] tmp2_reg_837;
...
reg   [31:0] orig_load_244_reg_875;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3_11001;
reg   [31:0] orig_load_247_reg_880;
wire   [9:0] empty_10_fu_567_p2;
reg   [9:0] empty_10_reg_895;
wire   [9:0] empty_11_fu_577_p2;
reg   [9:0] empty_11_reg_900;
...
reg   [4:0] i_fu_82;
reg   [12:0] indvar_flatten14_fu_86;
...
wire   [4:0] indvars_iv_next7324_fu_361_p2;
wire   [4:0] indvars_iv_next8617_fu_373_p2;
wire   [0:0] empty_fu_386_p2;
wire   [4:0] indvars_iv_next73_mid1_fu_397_p2;
wire   [4:0] select_ln11_1_fu_366_p3;
wire   [13:0] add_ln4_fu_420_p4;
...
wire   [13:0] tmp_1_fu_496_p4;
wire   [13:0] add_ln44_3_fu_533_p2;
wire  signed [5:0] tmp_cast_cast_fu_556_p3;
wire   [9:0] tmp_cast_cast_cast_fu_563_p1;
wire   [9:0] tmp_s_fu_549_p3;
wire  signed [9:0] tmp1_cast_fu_573_p1;
wire   [13:0] add_ln_fu_583_p4;
wire   [13:0] add_ln1_fu_595_p3;
wire   [31:0] add_ln48_2_fu_607_p2;
wire   [13:0] add_ln2_fu_618_p3;
wire   [13:0] add_ln3_fu_629_p4;
...
#0 k_fu_70 = 4'd0;
#0 j_fu_74 = 5'd0;
#0 indvar_flatten_fu_78 = 8'd0;
#0 i_fu_82 = 5'd0;
#0 indvar_flatten14_fu_86 = 13'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln36_fu_275_p2 == 1'd0))) begin
            indvar_flatten14_fu_86 <= add_ln36_fu_281_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten14_fu_86 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln36_fu_275_p2 == 1'd0))) begin
            indvar_flatten_fu_78 <= select_ln37_1_fu_340_p3;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        indvars_iv_next73_mid2_reg_823 <= indvars_iv_next73_mid2_fu_402_p3;
        k_mid2_reg_813 <= k_mid2_fu_390_p3;
        select_ln36_reg_802 <= select_ln36_fu_379_p3;
        select_ln37_reg_829 <= select_ln37_fu_409_p3;
        tmp2_reg_837 <= tmp2_fu_414_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        empty_10_reg_895 <= empty_10_fu_567_p2;
        empty_11_reg_900 <= empty_11_fu_577_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        indvars_iv_next73_dup_reg_797 <= indvars_iv_next73_dup_fu_328_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        orig_load_244_reg_875 <= orig_q1;
        orig_load_247_reg_880 <= orig_q0;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln1_fu_595_p3 = {{empty_10_fu_567_p2}, {k_mid2_reg_813}};
assign add_ln2_fu_618_p3 = {{empty_11_reg_900}, {k_mid2_reg_813}};
assign add_ln36_fu_281_p2 = (ap_sig_allocacmp_indvar_flatten14_load + 13'd1);
assign add_ln37_fu_334_p2 = (ap_sig_allocacmp_indvar_flatten_load + 8'd1);
assign add_ln3_fu_629_p4 = {{{select_ln36_reg_802}, {indvars_iv_next73_mid2_reg_823}}, {k_mid2_reg_813}};
assign add_ln40_1_fu_658_p3 = {{empty_10_reg_895}, {add_ln44_reg_847}};
assign add_ln41_1_fu_669_p3 = {{empty_11_reg_900}, {add_ln44_reg_847}};
assign add_ln42_1_fu_484_p4 = {{{select_ln36_reg_802}, {indvars_iv_next73_mid2_reg_823}}, {add_ln44_reg_847}};
assign add_ln43_1_fu_507_p4 = {{{select_ln36_reg_802}, {tmp2_reg_837}}, {add_ln44_reg_847}};
...
assign add_ln44_3_fu_533_p2 = (zext_ln44_1_fu_529_p1 + tmp_1_fu_496_p4);
assign add_ln44_fu_435_p2 = (k_mid2_fu_390_p3 + 4'd1);
assign add_ln45_1_fu_471_p4 = {{{select_ln36_reg_802}, {select_ln37_reg_829}}, {add_ln45_fu_466_p2}};
assign add_ln45_fu_466_p2 = ($signed(k_mid2_reg_813) + $signed(4'd15));
...
assign add_ln48_2_fu_607_p2 = ($signed(reg_237) + $signed(orig_load_244_reg_875));
...
assign add_ln48_9_fu_647_p2 = (add_ln48_8_fu_641_p2 + orig_load_247_reg_880);
assign add_ln48_fu_652_p0 = reg_237;
assign add_ln48_fu_652_p2 = (add_ln48_fu_652_p0 + orig_q0);
assign add_ln4_fu_420_p4 = {{{select_ln36_fu_379_p3}, {tmp2_fu_414_p2}}, {k_mid2_fu_390_p3}};
assign add_ln_fu_583_p4 = {{{select_ln36_reg_802}, {select_ln37_reg_829}}, {k_mid2_reg_813}};
...
assign empty_10_fu_567_p2 = (tmp_cast_cast_cast_fu_563_p1 + tmp_s_fu_549_p3);
assign empty_11_fu_577_p2 = ($signed(tmp1_cast_fu_573_p1) + $signed(tmp_s_fu_549_p3));
assign empty_fu_386_p2 = (icmp_ln37_reg_777 | and_ln11_reg_790);
assign icmp_ln36_fu_275_p2 = ((ap_sig_allocacmp_indvar_flatten14_load == 13'd6300) ? 1'b1 : 1'b0);
assign icmp_ln37_fu_296_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 8'd210) ? 1'b1 : 1'b0);
assign icmp_ln38_fu_316_p2 = ((ap_sig_allocacmp_k_load == 4'd15) ? 1'b1 : 1'b0);
assign indvars_iv_next7324_fu_361_p2 = (j_load_reg_772 + 5'd1);
assign indvars_iv_next73_dup_fu_328_p2 = (select_ln11_fu_302_p3 + 5'd1);
assign indvars_iv_next73_mid1_fu_397_p2 = (select_ln11_reg_784 + 5'd2);
assign indvars_iv_next73_mid2_fu_402_p3 = ((and_ln11_reg_790[0:0] == 1'b1) ? indvars_iv_next73_mid1_fu_397_p2 : select_ln11_1_fu_366_p3);
assign indvars_iv_next8617_fu_373_p2 = (i_fu_82 + 5'd1);
assign k_mid2_fu_390_p3 = ((empty_fu_386_p2[0:0] == 1'b1) ? 4'd1 : k_load_reg_767);
...
assign select_ln11_1_fu_366_p3 = ((icmp_ln37_reg_777[0:0] == 1'b1) ? 5'd2 : indvars_iv_next7324_fu_361_p2);
assign select_ln11_fu_302_p3 = ((icmp_ln37_fu_296_p2[0:0] == 1'b1) ? 5'd1 : ap_sig_allocacmp_j_load);
assign select_ln36_fu_379_p3 = ((icmp_ln37_reg_777[0:0] == 1'b1) ? indvars_iv_next8617_fu_373_p2 : i_fu_82);
assign select_ln37_1_fu_340_p3 = ((icmp_ln37_fu_296_p2[0:0] == 1'b1) ? 8'd1 : add_ln37_fu_334_p2);
assign select_ln37_fu_409_p3 = ((and_ln11_reg_790[0:0] == 1'b1) ? indvars_iv_next73_dup_reg_797 : select_ln11_reg_784);
assign sol_address0 = sol_address0_local;
assign sol_ce0 = sol_ce0_local;
assign sol_d0 = sol_d0_local;
assign sol_we0 = sol_we0_local;
assign tmp1_cast_fu_573_p1 = tmp_cast_cast_fu_556_p3;
assign tmp2_fu_414_p2 = ($signed(select_ln37_fu_409_p3) + $signed(5'd31));
assign tmp_1_fu_496_p4 = {{{select_ln36_reg_802}, {select_ln37_reg_829}}, {4'd0}};
assign tmp_cast_cast_cast_fu_563_p1 = $unsigned(tmp_cast_cast_fu_556_p3);
assign tmp_cast_cast_fu_556_p3 = {{1'd1}, {select_ln37_reg_829}};
assign tmp_s_fu_549_p3 = {{select_ln36_reg_802}, {5'd0}};
assign trunc_ln44_fu_525_p1 = add_ln44_2_fu_519_p2[3:0];
assign xor_ln11_fu_310_p2 = (icmp_ln37_fu_296_p2 ^ 1'd1);
assign zext_ln38_fu_504_p1 = k_mid2_reg_813;
assign zext_ln39_fu_590_p1 = add_ln_fu_583_p4;
assign zext_ln40_1_fu_664_p1 = add_ln40_1_fu_658_p3;
assign zext_ln40_fu_602_p1 = add_ln1_fu_595_p3;
assign zext_ln41_1_fu_675_p1 = add_ln41_1_fu_669_p3;
assign zext_ln41_fu_624_p1 = add_ln2_fu_618_p3;
assign zext_ln42_1_fu_491_p1 = add_ln42_1_fu_484_p4;
assign zext_ln42_fu_636_p1 = add_ln3_fu_629_p4;
assign zext_ln43_1_fu_514_p1 = add_ln43_1_fu_507_p4;
assign zext_ln43_fu_430_p1 = add_ln4_fu_420_p4;
