...
wire   [9:0] thr_add178_fu_594_p2;
reg   [9:0] thr_add178_reg_918;
...
reg   [7:0] bucket_7_addr_7_reg_963;
...
sparsemux_9_3_32_1_1_U9(.din0(a_0_q0),.din1(a_2_q0),.din2(a_4_q0),.din3(a_6_q0),.def(tmp_s_fu_545_p9),.sel(trunc_ln57_reg_862),.dout(tmp_s_fu_545_p11));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        bucket_7_addr_7_reg_963 <= zext_ln52_fu_634_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        thr_add178_reg_918 <= thr_add178_fu_594_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        bucket_7_address0_local = bucket_7_addr_7_reg_963;
    end else if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
assign thr_add178_fu_594_p2 = (blockID_cast2_cast3_fu_591_p1 + 10'd1);
...
assign zext_ln55_1_fu_608_p1 = thr_add178_reg_918;
