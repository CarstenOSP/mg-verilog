...
wire   [31:0] i_9_fu_364_p2;
reg   [31:0] i_9_reg_505;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_8_reg_444 <= ap_sig_allocacmp_i_8;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln21_reg_501 == 1'd0))) begin
        ap_sig_allocacmp_i_8 = i_9_reg_505;
    end else begin
...
assign i_9_fu_364_p2 = (i_8_reg_444 + 32'd1);
...
assign zext_ln20_fu_341_p1 = ap_sig_allocacmp_i_8;
