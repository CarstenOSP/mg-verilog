...
input  [63:0] output_difference_idx120_val182;
input  [63:0] output_difference_idx119_val179;
input  [63:0] output_difference_idx_val176;
input  [63:0] mux_case_0141150_reload;
input  [63:0] mux_case_1142154_reload;
input  [63:0] mux_case_2143158_reload;
input  [8:0] mul_ln66;
...
input  [63:0] mux_case_0144162_reload;
input  [63:0] mux_case_1145166_reload;
input  [63:0] mux_case_2146170_reload;
...
output  [63:0] output_difference_idx120_val180_out;
output   output_difference_idx120_val180_out_ap_vld;
output  [63:0] output_difference_idx119_val177_out;
output   output_difference_idx119_val177_out_ap_vld;
output  [63:0] output_difference_idx_val174_out;
output   output_difference_idx_val174_out_ap_vld;
...
reg output_difference_idx120_val180_out_ap_vld;
reg output_difference_idx119_val177_out_ap_vld;
reg output_difference_idx_val174_out_ap_vld;
...
reg   [1:0] i_10_reg_951;
reg   [1:0] i_10_reg_951_pp0_iter1_reg;
reg   [1:0] i_10_reg_951_pp0_iter2_reg;
reg   [1:0] i_10_reg_951_pp0_iter3_reg;
reg   [1:0] i_10_reg_951_pp0_iter4_reg;
reg   [1:0] i_10_reg_951_pp0_iter5_reg;
reg   [1:0] i_10_reg_951_pp0_iter6_reg;
reg   [1:0] i_10_reg_951_pp0_iter7_reg;
reg   [1:0] i_10_reg_951_pp0_iter8_reg;
reg   [1:0] i_10_reg_951_pp0_iter9_reg;
reg   [1:0] i_10_reg_951_pp0_iter10_reg;
reg   [1:0] i_10_reg_951_pp0_iter11_reg;
reg   [1:0] i_10_reg_951_pp0_iter12_reg;
reg   [1:0] i_10_reg_951_pp0_iter13_reg;
reg   [1:0] i_10_reg_951_pp0_iter14_reg;
reg   [1:0] i_10_reg_951_pp0_iter15_reg;
reg   [1:0] i_10_reg_951_pp0_iter16_reg;
...
wire   [63:0] tmp_29_fu_687_p35;
reg   [63:0] tmp_29_reg_1046;
...
wire   [63:0] tmp_30_fu_797_p9;
reg   [63:0] tmp_30_reg_1066;
...
reg   [63:0] output_difference_idx_val174_fu_164;
...
reg   [63:0] output_difference_idx119_val177_fu_168;
reg   [63:0] output_difference_idx120_val180_fu_172;
...
wire   [63:0] tmp_29_fu_687_p2;
wire   [63:0] tmp_29_fu_687_p4;
wire   [63:0] tmp_29_fu_687_p6;
wire   [63:0] tmp_29_fu_687_p8;
wire   [63:0] tmp_29_fu_687_p10;
wire   [63:0] tmp_29_fu_687_p12;
wire   [63:0] tmp_29_fu_687_p14;
wire   [63:0] tmp_29_fu_687_p16;
wire   [63:0] tmp_29_fu_687_p18;
wire   [63:0] tmp_29_fu_687_p20;
wire   [63:0] tmp_29_fu_687_p22;
wire   [63:0] tmp_29_fu_687_p24;
wire   [63:0] tmp_29_fu_687_p26;
wire   [63:0] tmp_29_fu_687_p28;
wire   [63:0] tmp_29_fu_687_p30;
wire   [63:0] tmp_29_fu_687_p32;
wire   [63:0] tmp_29_fu_687_p33;
wire   [63:0] tmp_s_fu_758_p7;
wire   [63:0] bitcast_ln67_16_fu_775_p1;
wire   [0:0] bit_sel5_fu_779_p3;
wire   [63:0] tmp_30_fu_797_p7;
...
wire   [3:0] tmp_29_fu_687_p1;
wire   [3:0] tmp_29_fu_687_p3;
wire   [3:0] tmp_29_fu_687_p5;
wire   [3:0] tmp_29_fu_687_p7;
wire   [3:0] tmp_29_fu_687_p9;
wire   [3:0] tmp_29_fu_687_p11;
wire   [3:0] tmp_29_fu_687_p13;
wire   [3:0] tmp_29_fu_687_p15;
wire  signed [3:0] tmp_29_fu_687_p17;
wire  signed [3:0] tmp_29_fu_687_p19;
wire  signed [3:0] tmp_29_fu_687_p21;
wire  signed [3:0] tmp_29_fu_687_p23;
wire  signed [3:0] tmp_29_fu_687_p25;
wire  signed [3:0] tmp_29_fu_687_p27;
wire  signed [3:0] tmp_29_fu_687_p29;
wire  signed [3:0] tmp_29_fu_687_p31;
wire   [1:0] tmp_s_fu_758_p1;
wire   [1:0] tmp_s_fu_758_p3;
wire  signed [1:0] tmp_s_fu_758_p5;
wire   [1:0] tmp_30_fu_797_p1;
wire   [1:0] tmp_30_fu_797_p3;
wire  signed [1:0] tmp_30_fu_797_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 i_fu_160 = 2'd0;
#0 output_difference_idx_val174_fu_164 = 64'd0;
#0 output_difference_idx119_val177_fu_168 = 64'd0;
#0 output_difference_idx120_val180_fu_172 = 64'd0;
...
sparsemux_33_4_64_1_1_U508(.din0(tmp_29_fu_687_p2),.din1(tmp_29_fu_687_p4),.din2(tmp_29_fu_687_p6),.din3(tmp_29_fu_687_p8),.din4(tmp_29_fu_687_p10),.din5(tmp_29_fu_687_p12),.din6(tmp_29_fu_687_p14),.din7(tmp_29_fu_687_p16),.din8(tmp_29_fu_687_p18),.din9(tmp_29_fu_687_p20),.din10(tmp_29_fu_687_p22),.din11(tmp_29_fu_687_p24),.din12(tmp_29_fu_687_p26),.din13(tmp_29_fu_687_p28),.din14(tmp_29_fu_687_p30),.din15(tmp_29_fu_687_p32),.def(tmp_29_fu_687_p33),.sel(trunc_ln67_reg_961),.dout(tmp_29_fu_687_p35));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U509(.din0(mux_case_0141150_reload),.din1(mux_case_1142154_reload),.din2(mux_case_2143158_reload),.def(tmp_s_fu_758_p7),.sel(i_10_reg_951_pp0_iter1_reg),.dout(tmp_s_fu_758_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U510(.din0(mux_case_0144162_reload),.din1(mux_case_1145166_reload),.din2(mux_case_2146170_reload),.def(tmp_30_fu_797_p7),.sel(i_10_reg_951_pp0_iter8_reg),.dout(tmp_30_fu_797_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_10_reg_951_pp0_iter16_reg == 2'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_10_reg_951_pp0_iter16_reg == 2'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            output_difference_idx119_val177_fu_168 <= output_difference_idx119_val179;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_10_reg_951_pp0_iter16_reg == 2'd1))) begin
            output_difference_idx119_val177_fu_168 <= mul5_i_reg_1076;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            output_difference_idx120_val180_fu_172 <= output_difference_idx120_val182;
        end else if ((1'b1 == ap_condition_874)) begin
            output_difference_idx120_val180_fu_172 <= mul5_i_reg_1076;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            output_difference_idx_val174_fu_164 <= output_difference_idx_val176;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_10_reg_951_pp0_iter16_reg == 2'd0))) begin
            output_difference_idx_val174_fu_164 <= mul5_i_reg_1076;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_10_reg_951_pp0_iter10_reg <= i_10_reg_951_pp0_iter9_reg;
        i_10_reg_951_pp0_iter11_reg <= i_10_reg_951_pp0_iter10_reg;
        i_10_reg_951_pp0_iter12_reg <= i_10_reg_951_pp0_iter11_reg;
        i_10_reg_951_pp0_iter13_reg <= i_10_reg_951_pp0_iter12_reg;
        i_10_reg_951_pp0_iter14_reg <= i_10_reg_951_pp0_iter13_reg;
        i_10_reg_951_pp0_iter15_reg <= i_10_reg_951_pp0_iter14_reg;
        i_10_reg_951_pp0_iter16_reg <= i_10_reg_951_pp0_iter15_reg;
        i_10_reg_951_pp0_iter2_reg <= i_10_reg_951_pp0_iter1_reg;
        i_10_reg_951_pp0_iter3_reg <= i_10_reg_951_pp0_iter2_reg;
        i_10_reg_951_pp0_iter4_reg <= i_10_reg_951_pp0_iter3_reg;
        i_10_reg_951_pp0_iter5_reg <= i_10_reg_951_pp0_iter4_reg;
        i_10_reg_951_pp0_iter6_reg <= i_10_reg_951_pp0_iter5_reg;
        i_10_reg_951_pp0_iter7_reg <= i_10_reg_951_pp0_iter6_reg;
        i_10_reg_951_pp0_iter8_reg <= i_10_reg_951_pp0_iter7_reg;
        i_10_reg_951_pp0_iter9_reg <= i_10_reg_951_pp0_iter8_reg;
        ...
        tmp_30_reg_1066 <= tmp_30_fu_797_p9;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_10_reg_951 <= ap_sig_allocacmp_i_10;
        i_10_reg_951_pp0_iter1_reg <= i_10_reg_951;
        icmp_ln66_reg_957 <= icmp_ln66_fu_562_p2;
        icmp_ln66_reg_957_pp0_iter1_reg <= icmp_ln66_reg_957;
        tmp_29_reg_1046 <= tmp_29_fu_687_p35;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_957_pp0_iter15_reg == 1'd1))) begin
        output_difference_idx119_val177_out_ap_vld = 1'b1;
    end else begin
        output_difference_idx119_val177_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_957_pp0_iter15_reg == 1'd1))) begin
        output_difference_idx120_val180_out_ap_vld = 1'b1;
    end else begin
        output_difference_idx120_val180_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_957_pp0_iter15_reg == 1'd1))) begin
        output_difference_idx_val174_out_ap_vld = 1'b1;
    end else begin
        output_difference_idx_val174_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_957_pp0_iter15_reg == 1'd1))) begin
...
assign add_ln66_fu_568_p2 = (ap_sig_allocacmp_i_10 + 2'd1);
...
always @ (*) begin
    ap_condition_874 = (~(i_10_reg_951_pp0_iter16_reg == 2'd1) & ~(i_10_reg_951_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
...
assign grp_fu_3932_p_din1 = tmp_30_reg_1066;
assign grp_fu_5581_p_ce = 1'b1;
assign grp_fu_5581_p_din0 = tmp_s_fu_758_p9;
assign grp_fu_5581_p_din1 = tmp_29_reg_1046;
assign grp_fu_5581_p_opcode = 2'd1;
assign icmp_ln66_fu_562_p2 = ((ap_sig_allocacmp_i_10 == 2'd3) ? 1'b1 : 1'b0);
...
assign output_difference_idx119_val177_out = output_difference_idx119_val177_fu_168;
assign output_difference_idx120_val180_out = output_difference_idx120_val180_fu_172;
assign output_difference_idx_val174_out = output_difference_idx_val174_fu_164;
assign output_difference_out = output_difference_fu_176;
assign tmp_29_fu_687_p10 = training_targets_4_q0;
assign tmp_29_fu_687_p12 = training_targets_5_q0;
assign tmp_29_fu_687_p14 = training_targets_6_q0;
assign tmp_29_fu_687_p16 = training_targets_7_q0;
assign tmp_29_fu_687_p18 = training_targets_8_q0;
assign tmp_29_fu_687_p2 = training_targets_0_q0;
assign tmp_29_fu_687_p20 = training_targets_9_q0;
assign tmp_29_fu_687_p22 = training_targets_10_q0;
assign tmp_29_fu_687_p24 = training_targets_11_q0;
assign tmp_29_fu_687_p26 = training_targets_12_q0;
assign tmp_29_fu_687_p28 = training_targets_13_q0;
assign tmp_29_fu_687_p30 = training_targets_14_q0;
assign tmp_29_fu_687_p32 = training_targets_15_q0;
assign tmp_29_fu_687_p33 = 'bx;
assign tmp_29_fu_687_p4 = training_targets_1_q0;
assign tmp_29_fu_687_p6 = training_targets_2_q0;
assign tmp_29_fu_687_p8 = training_targets_3_q0;
assign tmp_30_fu_797_p7 = 'bx;
...
assign zext_ln66_fu_574_p1 = ap_sig_allocacmp_i_10;
