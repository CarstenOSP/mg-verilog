...
reg   [3:0] select_ln113_reg_785;
wire   [2:0] trunc_ln114_fu_530_p1;
reg   [2:0] trunc_ln114_reg_791;
reg   [2:0] trunc_ln114_reg_791_pp0_iter1_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter2_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter3_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter4_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter5_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter6_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter7_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter8_reg;
reg   [2:0] trunc_ln114_reg_791_pp0_iter9_reg;
wire   [3:0] lshr_ln_fu_534_p4;
reg   [3:0] lshr_ln_reg_797;
wire   [2:0] empty_fu_585_p1;
reg   [2:0] empty_reg_842;
wire   [63:0] tmp_65_fu_621_p11;
reg   [63:0] tmp_65_reg_887;
reg   [63:0] tmp_65_reg_887_pp0_iter2_reg;
wire   [6:0] add_ln115_fu_644_p2;
reg   [6:0] add_ln115_reg_892;
reg   [6:0] add_ln115_reg_892_pp0_iter2_reg;
reg   [6:0] add_ln115_reg_892_pp0_iter3_reg;
reg   [6:0] add_ln115_reg_892_pp0_iter4_reg;
reg   [6:0] add_ln115_reg_892_pp0_iter5_reg;
reg   [6:0] add_ln115_reg_892_pp0_iter6_reg;
reg   [6:0] add_ln115_reg_892_pp0_iter7_reg;
reg   [6:0] add_ln115_reg_892_pp0_iter8_reg;
reg   [6:0] add_ln115_reg_892_pp0_iter9_reg;
wire   [63:0] tmp_66_fu_650_p11;
reg   [63:0] tmp_66_reg_897;
reg   [63:0] tmp_66_reg_897_pp0_iter2_reg;
wire   [63:0] tmp_64_fu_705_p19;
reg   [63:0] tmp_64_reg_902;
reg   [63:0] mul_i5_reg_908;
reg   [63:0] mul_1_i2_reg_916;
wire   [63:0] zext_ln112_fu_544_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] p_cast26_fu_599_p1;
wire   [63:0] zext_ln115_fu_744_p1;
reg   [6:0] j_fu_126;
wire   [6:0] add_ln114_fu_556_p2;
wire    ap_loop_init;
...
wire   [11:0] zext_ln113_fu_577_p1;
wire   [11:0] arrayidx10_sum_fu_580_p2;
wire   [8:0] tmp_s_fu_589_p4;
wire   [63:0] tmp_65_fu_621_p9;
wire   [6:0] zext_ln112_1_fu_618_p1;
wire   [6:0] p_udiv_fu_611_p3;
wire   [63:0] tmp_66_fu_650_p9;
wire   [63:0] tmp_64_fu_705_p2;
wire   [63:0] tmp_64_fu_705_p4;
wire   [63:0] tmp_64_fu_705_p6;
wire   [63:0] tmp_64_fu_705_p8;
wire   [63:0] tmp_64_fu_705_p10;
wire   [63:0] tmp_64_fu_705_p12;
wire   [63:0] tmp_64_fu_705_p14;
wire   [63:0] tmp_64_fu_705_p16;
wire   [63:0] tmp_64_fu_705_p17;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_65_fu_621_p1;
wire   [2:0] tmp_65_fu_621_p3;
wire  signed [2:0] tmp_65_fu_621_p5;
wire  signed [2:0] tmp_65_fu_621_p7;
wire   [2:0] tmp_66_fu_650_p1;
wire   [2:0] tmp_66_fu_650_p3;
wire  signed [2:0] tmp_66_fu_650_p5;
wire  signed [2:0] tmp_66_fu_650_p7;
wire   [2:0] tmp_64_fu_705_p1;
wire   [2:0] tmp_64_fu_705_p3;
wire   [2:0] tmp_64_fu_705_p5;
wire   [2:0] tmp_64_fu_705_p7;
wire  signed [2:0] tmp_64_fu_705_p9;
wire  signed [2:0] tmp_64_fu_705_p11;
wire  signed [2:0] tmp_64_fu_705_p13;
wire  signed [2:0] tmp_64_fu_705_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_3_64_1_1_U507(.din0(oracle_activations1_q0),.din1(oracle_activations1_2_q0),.din2(oracle_activations1_4_q0),.din3(oracle_activations1_6_q0),.def(tmp_65_fu_621_p9),.sel(trunc_ln114_reg_791),.dout(tmp_65_fu_621_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h2 ),.din1_WIDTH( 64 ),.CASE2( 3'h4 ),.din2_WIDTH( 64 ),.CASE3( 3'h6 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_9_3_64_1_1_U508(.din0(oracle_activations1_1_q0),.din1(oracle_activations1_3_q0),.din2(oracle_activations1_5_q0),.din3(oracle_activations1_7_q0),.def(tmp_66_fu_650_p9),.sel(trunc_ln114_reg_791),.dout(tmp_66_fu_650_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U509(.din0(tmp_64_fu_705_p2),.din1(tmp_64_fu_705_p4),.din2(tmp_64_fu_705_p6),.din3(tmp_64_fu_705_p8),.din4(tmp_64_fu_705_p10),.din5(tmp_64_fu_705_p12),.din6(tmp_64_fu_705_p14),.din7(tmp_64_fu_705_p16),.def(tmp_64_fu_705_p17),.sel(empty_reg_842),.dout(tmp_64_fu_705_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_ln115_reg_892 <= add_ln115_fu_644_p2;
        ap_loop_exit_ready_pp0_iter1_reg <= ap_loop_exit_ready;
        ap_loop_exit_ready_pp0_iter2_reg <= ap_loop_exit_ready_pp0_iter1_reg;
        empty_reg_842 <= empty_fu_585_p1;
        lshr_ln_reg_797 <= {{select_ln112_fu_508_p3[6:3]}};
        select_ln113_reg_785 <= select_ln113_fu_522_p3;
        tmp_65_reg_887 <= tmp_65_fu_621_p11;
        tmp_66_reg_897 <= tmp_66_fu_650_p11;
        trunc_ln114_reg_791 <= trunc_ln114_fu_530_p1;
        trunc_ln114_reg_791_pp0_iter1_reg <= trunc_ln114_reg_791;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_ln115_reg_892_pp0_iter2_reg <= add_ln115_reg_892;
        add_ln115_reg_892_pp0_iter3_reg <= add_ln115_reg_892_pp0_iter2_reg;
        add_ln115_reg_892_pp0_iter4_reg <= add_ln115_reg_892_pp0_iter3_reg;
        add_ln115_reg_892_pp0_iter5_reg <= add_ln115_reg_892_pp0_iter4_reg;
        add_ln115_reg_892_pp0_iter6_reg <= add_ln115_reg_892_pp0_iter5_reg;
        add_ln115_reg_892_pp0_iter7_reg <= add_ln115_reg_892_pp0_iter6_reg;
        add_ln115_reg_892_pp0_iter8_reg <= add_ln115_reg_892_pp0_iter7_reg;
        add_ln115_reg_892_pp0_iter9_reg <= add_ln115_reg_892_pp0_iter8_reg;
        ...
        mul_1_i2_reg_916 <= grp_fu_4233_p_dout0;
        mul_i5_reg_908 <= grp_fu_2684_p_dout0;
        tmp_64_reg_902 <= tmp_64_fu_705_p19;
        tmp_65_reg_887_pp0_iter2_reg <= tmp_65_reg_887;
        tmp_66_reg_897_pp0_iter2_reg <= tmp_66_reg_897;
        trunc_ln114_reg_791_pp0_iter2_reg <= trunc_ln114_reg_791_pp0_iter1_reg;
        trunc_ln114_reg_791_pp0_iter3_reg <= trunc_ln114_reg_791_pp0_iter2_reg;
        trunc_ln114_reg_791_pp0_iter4_reg <= trunc_ln114_reg_791_pp0_iter3_reg;
        trunc_ln114_reg_791_pp0_iter5_reg <= trunc_ln114_reg_791_pp0_iter4_reg;
        trunc_ln114_reg_791_pp0_iter6_reg <= trunc_ln114_reg_791_pp0_iter5_reg;
        trunc_ln114_reg_791_pp0_iter7_reg <= trunc_ln114_reg_791_pp0_iter6_reg;
        trunc_ln114_reg_791_pp0_iter8_reg <= trunc_ln114_reg_791_pp0_iter7_reg;
        trunc_ln114_reg_791_pp0_iter9_reg <= trunc_ln114_reg_791_pp0_iter8_reg;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln114_reg_791_pp0_iter9_reg == 3'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln114_reg_791_pp0_iter9_reg == 3'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln114_reg_791_pp0_iter9_reg == 3'd4))) begin
...
always @ (*) begin
    if ((~(trunc_ln114_reg_791_pp0_iter9_reg == 3'd0) & ~(trunc_ln114_reg_791_pp0_iter9_reg == 3'd2) & ~(trunc_ln114_reg_791_pp0_iter9_reg == 3'd4) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1))) begin
...
assign add_ln114_fu_556_p2 = (select_ln112_fu_508_p3 + 7'd2);
assign add_ln115_fu_644_p2 = (zext_ln112_1_fu_618_p1 + p_udiv_fu_611_p3);
...
assign arrayidx10_sum_fu_580_p2 = (zext_ln113_fu_577_p1 + phi_mul);
assign delta_weights1_1_address0 = zext_ln115_fu_744_p1;
...
assign delta_weights1_2_address0 = zext_ln115_fu_744_p1;
...
assign delta_weights1_3_address0 = zext_ln115_fu_744_p1;
...
assign delta_weights1_4_address0 = zext_ln115_fu_744_p1;
...
assign delta_weights1_5_address0 = zext_ln115_fu_744_p1;
...
assign delta_weights1_6_address0 = zext_ln115_fu_744_p1;
...
assign delta_weights1_7_address0 = zext_ln115_fu_744_p1;
...
assign delta_weights1_address0 = zext_ln115_fu_744_p1;
...
assign empty_fu_585_p1 = arrayidx10_sum_fu_580_p2[2:0];
assign grp_fu_2684_p_ce = 1'b1;
assign grp_fu_2684_p_din0 = tmp_64_reg_902;
assign grp_fu_2684_p_din1 = tmp_65_reg_887_pp0_iter2_reg;
assign grp_fu_4233_p_ce = 1'b1;
assign grp_fu_4233_p_din0 = tmp_64_reg_902;
assign grp_fu_4233_p_din1 = tmp_66_reg_897_pp0_iter2_reg;
assign icmp_ln113_fu_482_p2 = ((ap_sig_allocacmp_indvar_flatten19_load == 9'd416) ? 1'b1 : 1'b0);
assign lshr_ln_fu_534_p4 = {{select_ln112_fu_508_p3[6:3]}};
assign oracle_activations1_1_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_1_ce0 = oracle_activations1_1_ce0_local;
assign oracle_activations1_2_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_2_ce0 = oracle_activations1_2_ce0_local;
assign oracle_activations1_3_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_3_ce0 = oracle_activations1_3_ce0_local;
assign oracle_activations1_4_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_4_ce0 = oracle_activations1_4_ce0_local;
assign oracle_activations1_5_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_5_ce0 = oracle_activations1_5_ce0_local;
assign oracle_activations1_6_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_6_ce0 = oracle_activations1_6_ce0_local;
assign oracle_activations1_7_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_7_ce0 = oracle_activations1_7_ce0_local;
assign oracle_activations1_address0 = zext_ln112_fu_544_p1;
assign oracle_activations1_ce0 = oracle_activations1_ce0_local;
assign p_cast26_fu_599_p1 = tmp_s_fu_589_p4;
assign p_udiv_fu_611_p3 = {{select_ln113_reg_785}, {3'd0}};
...
assign tmp_64_fu_705_p10 = training_data_4_q0;
assign tmp_64_fu_705_p12 = training_data_5_q0;
assign tmp_64_fu_705_p14 = training_data_6_q0;
assign tmp_64_fu_705_p16 = training_data_7_q0;
assign tmp_64_fu_705_p17 = 'bx;
assign tmp_64_fu_705_p2 = training_data_0_q0;
assign tmp_64_fu_705_p4 = training_data_1_q0;
assign tmp_64_fu_705_p6 = training_data_2_q0;
assign tmp_64_fu_705_p8 = training_data_3_q0;
assign tmp_65_fu_621_p9 = 'bx;
assign tmp_66_fu_650_p9 = 'bx;
assign tmp_fu_500_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_s_fu_589_p4 = {{arrayidx10_sum_fu_580_p2[11:3]}};
assign training_data_0_address0 = p_cast26_fu_599_p1;
assign training_data_0_ce0 = training_data_0_ce0_local;
assign training_data_1_address0 = p_cast26_fu_599_p1;
assign training_data_1_ce0 = training_data_1_ce0_local;
assign training_data_2_address0 = p_cast26_fu_599_p1;
assign training_data_2_ce0 = training_data_2_ce0_local;
assign training_data_3_address0 = p_cast26_fu_599_p1;
assign training_data_3_ce0 = training_data_3_ce0_local;
assign training_data_4_address0 = p_cast26_fu_599_p1;
assign training_data_4_ce0 = training_data_4_ce0_local;
assign training_data_5_address0 = p_cast26_fu_599_p1;
assign training_data_5_ce0 = training_data_5_ce0_local;
assign training_data_6_address0 = p_cast26_fu_599_p1;
assign training_data_6_ce0 = training_data_6_ce0_local;
assign training_data_7_address0 = p_cast26_fu_599_p1;
assign training_data_7_ce0 = training_data_7_ce0_local;
assign trunc_ln114_fu_530_p1 = select_ln112_fu_508_p3[2:0];
assign zext_ln112_1_fu_618_p1 = lshr_ln_reg_797;
assign zext_ln112_fu_544_p1 = lshr_ln_fu_534_p4;
assign zext_ln113_fu_577_p1 = select_ln113_reg_785;
assign zext_ln115_fu_744_p1 = add_ln115_reg_892_pp0_iter9_reg;
endmodule 