module sha_stream_sha_transform_Pipeline_trans_lp3 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A,B,C,D,E,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,B_23_out,B_23_out_ap_vld,B_2_out,B_2_out_ap_vld,D_23_out,D_23_out_ap_vld,E_23_out,E_23_out_ap_vld,E_2_out,E_2_out_ap_vld); 
...
reg   [31:0] E_24_reg_472;
reg   [31:0] D_15_reg_478;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        D_15_reg_478 <= C_17_fu_90;
        E_24_reg_472 <= D_12_fu_86;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln116_reg_448_pp0_iter2_reg == 1'd0))) begin
        ap_sig_allocacmp_B_2_load = A_12_fu_94;
    end else begin
...
assign A_15_fu_377_p2 = (add_ln118_2_reg_483 + add_ln118_fu_371_p2);
assign B_23_out = A_12_fu_94;
assign B_2_out = B_2_fu_78;
assign C_2_fu_324_p3 = {{trunc_ln118_1_fu_310_p1}, {lshr_ln118_1_fu_314_p4}};
assign D_23_out = D_15_reg_478;
assign E_23_out = E_24_reg_472;
...
assign and_ln118_1_fu_287_p2 = (xor_ln118_fu_275_p2 & D_12_fu_86);
assign and_ln118_fu_281_p2 = (ap_sig_allocacmp_B_2_load & C_17_fu_90);
...
assign lshr_ln3_fu_353_p4 = {{A_12_fu_94[31:27]}};
...
assign trunc_ln118_fu_349_p1 = A_12_fu_94[26:0];
