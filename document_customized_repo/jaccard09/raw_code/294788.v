...
reg   [0:0] tmp_320_reg_1244;
reg   [0:0] tmp_320_reg_1244_pp0_iter1_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter2_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter3_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter4_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter5_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter6_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter7_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter8_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter9_reg;
reg   [0:0] tmp_320_reg_1244_pp0_iter10_reg;
reg   [2:0] lshr_ln113_3_reg_1248;
reg   [2:0] lshr_ln113_3_reg_1248_pp0_iter1_reg;
reg   [2:0] lshr_ln113_3_reg_1248_pp0_iter2_reg;
...
sparsemux_17_3_32_1_1_U316(.din0(empty_266),.din1(empty_267),.din2(empty_268),.din3(empty_269),.din4(empty_270),.din5(empty_271),.din6(empty_272),.din7(empty_273),.def(v75_fu_856_p17),.sel(v75_fu_856_p18),.dout(v75_fu_856_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U317(.din0(empty_274),.din1(empty_275),.din2(empty_276),.din3(empty_277),.din4(empty_278),.din5(empty_279),.din6(empty_280),.din7(empty_281),.def(v83_fu_896_p17),.sel(v83_fu_896_p18),.dout(v83_fu_896_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U318(.din0(empty_282),.din1(empty_283),.din2(empty_284),.din3(empty_285),.din4(empty_286),.din5(empty_287),.din6(empty_288),.din7(empty_289),.def(v91_fu_936_p17),.sel(v91_fu_936_p18),.dout(v91_fu_936_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U319(.din0(empty_290),.din1(empty_291),.din2(empty_292),.din3(empty_293),.din4(empty_294),.din5(empty_295),.din6(empty_296),.din7(empty_297),.def(v99_fu_976_p17),.sel(v99_fu_976_p18),.dout(v99_fu_976_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U320(.din0(empty_298),.din1(empty_299),.din2(empty_300),.din3(empty_301),.din4(empty_302),.din5(empty_303),.din6(empty_304),.din7(empty_305),.def(v107_fu_1016_p17),.sel(v107_fu_1016_p18),.dout(v107_fu_1016_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U321(.din0(empty_306),.din1(empty_307),.din2(empty_308),.din3(empty_309),.din4(empty_310),.din5(empty_311),.din6(empty_312),.din7(empty_313),.def(v115_fu_1056_p17),.sel(v115_fu_1056_p18),.dout(v115_fu_1056_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U322(.din0(empty_314),.din1(empty_315),.din2(empty_316),.din3(empty_317),.din4(empty_318),.din5(empty_319),.din6(empty_320),.din7(empty_321),.def(v123_fu_1096_p17),.sel(v123_fu_1096_p18),.dout(v123_fu_1096_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U323(.din0(empty_322),.din1(empty_323),.din2(empty_324),.din3(empty_325),.din4(empty_326),.din5(empty_327),.din6(empty_328),.din7(empty),.def(v131_fu_1136_p17),.sel(v131_fu_1136_p18),.dout(v131_fu_1136_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln113_3_reg_1248_pp0_iter2_reg <= lshr_ln113_3_reg_1248_pp0_iter1_reg;
        tmp_320_reg_1244_pp0_iter10_reg <= tmp_320_reg_1244_pp0_iter9_reg;
        tmp_320_reg_1244_pp0_iter2_reg <= tmp_320_reg_1244_pp0_iter1_reg;
        tmp_320_reg_1244_pp0_iter3_reg <= tmp_320_reg_1244_pp0_iter2_reg;
        tmp_320_reg_1244_pp0_iter4_reg <= tmp_320_reg_1244_pp0_iter3_reg;
        tmp_320_reg_1244_pp0_iter5_reg <= tmp_320_reg_1244_pp0_iter4_reg;
        tmp_320_reg_1244_pp0_iter6_reg <= tmp_320_reg_1244_pp0_iter5_reg;
        tmp_320_reg_1244_pp0_iter7_reg <= tmp_320_reg_1244_pp0_iter6_reg;
        tmp_320_reg_1244_pp0_iter8_reg <= tmp_320_reg_1244_pp0_iter7_reg;
        tmp_320_reg_1244_pp0_iter9_reg <= tmp_320_reg_1244_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln113_3_reg_1248 <= {{ap_sig_allocacmp_v68[5:3]}};
        lshr_ln113_3_reg_1248_pp0_iter1_reg <= lshr_ln113_3_reg_1248;
        tmp_320_reg_1244 <= ap_sig_allocacmp_v68[32'd6];
        tmp_320_reg_1244_pp0_iter1_reg <= tmp_320_reg_1244;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter11_reg == 1'b1) & (tmp_320_reg_1244_pp0_iter10_reg == 1'd1))) begin
...
assign v70_3_out = v66_fu_208;
assign v71_fu_1190_p3 = ((icmp_ln115_reg_1253[0:0] == 1'b1) ? v69_3 : v66_fu_208);
...
assign zext_ln113_fu_1209_p1 = lshr_ln113_3_reg_1248_pp0_iter2_reg;
endmodule 