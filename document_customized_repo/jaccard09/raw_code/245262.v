...
wire    grp_atax_node1_fu_234_v58_we1;
wire   [31:0] grp_atax_node1_fu_234_v58_d1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        v124_we1 = grp_atax_node1_fu_234_v58_we1;
    end else begin
        v124_we1 = 1'b0;
    end
end
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_atax_node1_fu_234_ap_done == 1'b1))) begin
