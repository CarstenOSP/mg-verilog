...
wire   [6:0] add_ln8_fu_287_p2;
reg   [6:0] add_ln8_reg_378;
wire    ap_CS_fsm_state2;
wire   [5:0] trunc_ln8_fu_293_p1;
reg   [5:0] trunc_ln8_reg_383;
wire   [6:0] add_ln9_fu_303_p2;
reg   [6:0] add_ln9_reg_392;
wire    ap_CS_fsm_state3;
wire   [2:0] trunc_ln9_fu_309_p1;
reg   [2:0] trunc_ln9_reg_397;
reg   [2:0] lshr_ln_reg_402;
...
wire   [0:0] icmp_ln9_fu_297_p2;
wire    ap_CS_fsm_state4;
wire   [63:0] zext_ln17_fu_338_p1;
reg   [6:0] i_fu_110;
reg    prod_6_we0_local;
wire   [63:0] bitcast_ln17_fu_350_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln9_fu_297_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_110 <= 7'd0;
    end else if (((icmp_ln9_fu_297_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        i_fu_110 <= add_ln8_reg_378;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        j_reg_222 <= add_ln9_reg_392;
    end else if (((icmp_ln8_fu_281_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_reg_222 <= 7'd0;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        add_ln8_reg_378 <= add_ln8_fu_287_p2;
        trunc_ln8_reg_383 <= trunc_ln8_fu_293_p1;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln9_reg_392 <= add_ln9_fu_303_p2;
        lshr_ln_reg_402 <= {{j_reg_222[5:3]}};
        trunc_ln9_reg_397 <= trunc_ln9_fu_309_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln8_fu_281_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd2) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd3) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd4) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd5) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd6) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((trunc_ln9_reg_397 == 3'd7) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln9_fu_297_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
...
assign add_ln1_fu_332_p3 = {{trunc_ln8_reg_383}, {lshr_ln_reg_402}};
assign add_ln8_fu_287_p2 = (i_fu_110 + 7'd1);
assign add_ln9_fu_303_p2 = (j_reg_222 + 7'd1);
assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];
assign ap_CS_fsm_state2 = ap_CS_fsm[32'd1];
assign ap_CS_fsm_state3 = ap_CS_fsm[32'd2];
assign ap_CS_fsm_state4 = ap_CS_fsm[32'd3];
assign ap_CS_fsm_state5 = ap_CS_fsm[32'd4];
assign bitcast_ln17_fu_350_p1 = grp_gemm_Pipeline_inner_fu_233_sum_out;
assign grp_gemm_Pipeline_inner_fu_233_ap_start = grp_gemm_Pipeline_inner_fu_233_ap_start_reg;
assign icmp_ln8_fu_281_p2 = ((i_fu_110 == 7'd64) ? 1'b1 : 1'b0);
assign icmp_ln9_fu_297_p2 = ((j_reg_222 == 7'd64) ? 1'b1 : 1'b0);
...
assign prod_0_address0 = zext_ln17_fu_338_p1;
assign prod_0_ce0 = prod_0_ce0_local;
assign prod_0_d0 = bitcast_ln17_fu_350_p1;
assign prod_0_we0 = prod_0_we0_local;
assign prod_1_address0 = zext_ln17_fu_338_p1;
assign prod_1_ce0 = prod_1_ce0_local;
assign prod_1_d0 = bitcast_ln17_fu_350_p1;
assign prod_1_we0 = prod_1_we0_local;
assign prod_2_address0 = zext_ln17_fu_338_p1;
assign prod_2_ce0 = prod_2_ce0_local;
assign prod_2_d0 = bitcast_ln17_fu_350_p1;
assign prod_2_we0 = prod_2_we0_local;
assign prod_3_address0 = zext_ln17_fu_338_p1;
assign prod_3_ce0 = prod_3_ce0_local;
assign prod_3_d0 = bitcast_ln17_fu_350_p1;
assign prod_3_we0 = prod_3_we0_local;
assign prod_4_address0 = zext_ln17_fu_338_p1;
assign prod_4_ce0 = prod_4_ce0_local;
assign prod_4_d0 = bitcast_ln17_fu_350_p1;
assign prod_4_we0 = prod_4_we0_local;
assign prod_5_address0 = zext_ln17_fu_338_p1;
assign prod_5_ce0 = prod_5_ce0_local;
assign prod_5_d0 = bitcast_ln17_fu_350_p1;
assign prod_5_we0 = prod_5_we0_local;
assign prod_6_address0 = zext_ln17_fu_338_p1;
assign prod_6_ce0 = prod_6_ce0_local;
assign prod_6_d0 = bitcast_ln17_fu_350_p1;
assign prod_6_we0 = prod_6_we0_local;
assign prod_7_address0 = zext_ln17_fu_338_p1;
assign prod_7_ce0 = prod_7_ce0_local;
assign prod_7_d0 = bitcast_ln17_fu_350_p1;
assign prod_7_we0 = prod_7_we0_local;
assign trunc_ln8_fu_293_p1 = i_fu_110[5:0];
assign trunc_ln9_fu_309_p1 = j_reg_222[2:0];
assign zext_ln17_fu_338_p1 = add_ln1_fu_332_p3;
endmodule 