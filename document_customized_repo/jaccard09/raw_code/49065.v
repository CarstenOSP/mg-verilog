...
wire   [4:0] indvars_iv_next259_dup_fu_273_p2;
reg   [4:0] indvars_iv_next259_dup_reg_625;
wire   [4:0] select_ln36_fu_324_p3;
reg   [4:0] select_ln36_reg_630;
wire   [3:0] k_mid2_fu_335_p3;
reg   [3:0] k_mid2_reg_638;
wire   [4:0] indvars_iv_next259_mid2_fu_347_p3;
reg   [4:0] indvars_iv_next259_mid2_reg_647;
wire   [4:0] select_ln37_fu_354_p3;
reg   [4:0] select_ln37_reg_652;
wire   [9:0] empty_11_fu_444_p2;
reg   [9:0] empty_11_reg_669;
reg   [31:0] orig_load_963_reg_679;
reg   [31:0] orig_load_964_reg_699;
...
reg   [4:0] i_fu_80;
reg   [13:0] indvar_flatten14_fu_84;
...
wire   [4:0] indvars_iv_next25927_fu_306_p2;
wire   [4:0] indvars_iv_next27320_fu_318_p2;
wire   [0:0] empty_fu_331_p2;
wire   [4:0] indvars_iv_next259_mid1_fu_342_p2;
wire   [4:0] select_ln11_1_fu_311_p3;
wire   [4:0] tmp2_fu_359_p2;
wire   [13:0] add_ln4_fu_365_p4;
wire   [13:0] add_ln44_1_fu_386_p4;
wire  signed [5:0] tmp_cast_cast_fu_423_p3;
wire   [9:0] tmp_cast_cast_cast_fu_430_p1;
wire   [9:0] tmp_s_fu_416_p3;
wire  signed [9:0] tmp1_cast_fu_440_p1;
wire   [9:0] empty_10_fu_434_p2;
wire   [13:0] add_ln1_fu_450_p3;
wire   [3:0] add_ln45_fu_462_p2;
wire   [13:0] add_ln45_1_fu_467_p4;
wire   [13:0] add_ln2_fu_480_p3;
wire   [13:0] add_ln3_fu_491_p4;
wire   [13:0] add_ln_fu_503_p4;
...
#0 i_fu_80 = 5'd0;
#0 indvar_flatten14_fu_84 = 14'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln36_fu_220_p2 == 1'd0))) begin
            indvar_flatten14_fu_84 <= add_ln36_fu_226_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten14_fu_84 <= 14'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln36_fu_220_p2 == 1'd0))) begin
            indvar_flatten_fu_76 <= select_ln37_1_fu_285_p3;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        indvars_iv_next259_dup_reg_625 <= indvars_iv_next259_dup_fu_273_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        indvars_iv_next259_mid2_reg_647 <= indvars_iv_next259_mid2_fu_347_p3;
        k_mid2_reg_638 <= k_mid2_fu_335_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        empty_11_reg_669 <= empty_11_fu_444_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        orig_load_963_reg_679 <= orig_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        orig_load_964_reg_699 <= orig_q1;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln1_fu_450_p3 = {{empty_10_fu_434_p2}, {k_mid2_reg_638}};
assign add_ln2_fu_480_p3 = {{empty_11_reg_669}, {k_mid2_reg_638}};
assign add_ln36_fu_226_p2 = (ap_sig_allocacmp_indvar_flatten14_load + 14'd1);
assign add_ln37_fu_279_p2 = (ap_sig_allocacmp_indvar_flatten_load + 9'd1);
assign add_ln3_fu_491_p4 = {{{select_ln36_reg_630}, {indvars_iv_next259_mid2_reg_647}}, {k_mid2_reg_638}};
assign add_ln44_1_fu_386_p4 = {{{select_ln36_fu_324_p3}, {select_ln37_fu_354_p3}}, {add_ln44_fu_380_p2}};
assign add_ln44_fu_380_p2 = (k_mid2_fu_335_p3 + 4'd1);
assign add_ln45_1_fu_467_p4 = {{{select_ln36_reg_630}, {select_ln37_reg_652}}, {add_ln45_fu_462_p2}};
assign add_ln45_fu_462_p2 = ($signed(k_mid2_reg_638) + $signed(4'd15));
assign add_ln48_1_fu_531_p2 = (add_ln48_reg_714 + reg_182);
assign add_ln48_2_fu_521_p2 = (orig_load_963_reg_679 + orig_load_964_reg_699);
...
assign add_ln4_fu_365_p4 = {{{select_ln36_fu_324_p3}, {tmp2_fu_359_p2}}, {k_mid2_fu_335_p3}};
assign add_ln_fu_503_p4 = {{{select_ln36_reg_630}, {select_ln37_reg_652}}, {k_mid2_reg_638}};
...
assign empty_10_fu_434_p2 = (tmp_cast_cast_cast_fu_430_p1 + tmp_s_fu_416_p3);
assign empty_11_fu_444_p2 = ($signed(tmp1_cast_fu_440_p1) + $signed(tmp_s_fu_416_p3));
assign empty_fu_331_p2 = (icmp_ln37_reg_605 | and_ln11_reg_618);
assign icmp_ln36_fu_220_p2 = ((ap_sig_allocacmp_indvar_flatten14_load == 14'd12600) ? 1'b1 : 1'b0);
assign icmp_ln37_fu_241_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 9'd420) ? 1'b1 : 1'b0);
assign icmp_ln38_fu_261_p2 = ((ap_sig_allocacmp_k_load == 4'd15) ? 1'b1 : 1'b0);
assign indvars_iv_next25927_fu_306_p2 = (j_load_reg_600 + 5'd1);
assign indvars_iv_next259_dup_fu_273_p2 = (select_ln11_fu_247_p3 + 5'd1);
assign indvars_iv_next259_mid1_fu_342_p2 = (select_ln11_reg_612 + 5'd2);
assign indvars_iv_next259_mid2_fu_347_p3 = ((and_ln11_reg_618[0:0] == 1'b1) ? indvars_iv_next259_mid1_fu_342_p2 : select_ln11_1_fu_311_p3);
assign indvars_iv_next27320_fu_318_p2 = (i_fu_80 + 5'd1);
assign k_mid2_fu_335_p3 = ((empty_fu_331_p2[0:0] == 1'b1) ? 4'd1 : k_load_reg_595);
...
assign select_ln11_1_fu_311_p3 = ((icmp_ln37_reg_605[0:0] == 1'b1) ? 5'd2 : indvars_iv_next25927_fu_306_p2);
assign select_ln11_fu_247_p3 = ((icmp_ln37_fu_241_p2[0:0] == 1'b1) ? 5'd1 : ap_sig_allocacmp_j_load);
assign select_ln36_fu_324_p3 = ((icmp_ln37_reg_605[0:0] == 1'b1) ? indvars_iv_next27320_fu_318_p2 : i_fu_80);
assign select_ln37_1_fu_285_p3 = ((icmp_ln37_fu_241_p2[0:0] == 1'b1) ? 9'd1 : add_ln37_fu_279_p2);
assign select_ln37_fu_354_p3 = ((and_ln11_reg_618[0:0] == 1'b1) ? indvars_iv_next259_dup_reg_625 : select_ln11_reg_612);
...
assign tmp1_cast_fu_440_p1 = tmp_cast_cast_fu_423_p3;
assign tmp2_fu_359_p2 = ($signed(select_ln37_fu_354_p3) + $signed(5'd31));
assign tmp_cast_cast_cast_fu_430_p1 = $unsigned(tmp_cast_cast_fu_423_p3);
assign tmp_cast_cast_fu_423_p3 = {{1'd1}, {select_ln37_reg_652}};
assign tmp_s_fu_416_p3 = {{select_ln36_reg_630}, {5'd0}};
assign xor_ln11_fu_255_p2 = (icmp_ln37_fu_241_p2 ^ 1'd1);
assign zext_ln39_fu_510_p1 = add_ln_fu_503_p4;
assign zext_ln40_fu_457_p1 = add_ln1_fu_450_p3;
assign zext_ln41_fu_486_p1 = add_ln2_fu_480_p3;
assign zext_ln42_fu_498_p1 = add_ln3_fu_491_p4;
assign zext_ln43_fu_375_p1 = add_ln4_fu_365_p4;
