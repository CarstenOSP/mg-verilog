...
wire   [12:0] tmp_230_fu_947_p3;
reg   [12:0] tmp_230_reg_1303;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_546_min_p_98_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_546_min_p_98_out_ap_vld;
...
wire   [12:0] grp_viterbi_Pipeline_L_end_fu_567_llike_address1;
wire    grp_viterbi_Pipeline_L_end_fu_567_llike_ce1;
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_567_min_s_16_out;
wire    grp_viterbi_Pipeline_L_end_fu_567_min_s_16_out_ap_vld;
...
wire   [12:0] grp_viterbi_Pipeline_L_state_fu_575_llike_address1;
wire    grp_viterbi_Pipeline_L_state_fu_575_llike_ce1;
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_575_min_s_34_out;
wire    grp_viterbi_Pipeline_L_state_fu_575_min_s_34_out_ap_vld;
...
sparsemux_9_2_8_1_1_U134(.din0(obs_0_q0),.din1(obs_1_q0),.din2(obs_2_q0),.din3(obs_3_q0),.def(tmp_31_fu_684_p9),.sel(tmp_31_fu_684_p10),.dout(tmp_31_fu_684_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U135(.din0(tmp_32_fu_800_p2),.din1(tmp_32_fu_800_p4),.din2(tmp_32_fu_800_p6),.din3(tmp_32_fu_800_p8),.def(tmp_32_fu_800_p9),.sel(tmp_32_fu_800_p10),.dout(tmp_32_fu_800_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U136(.din0(tmp_33_fu_864_p2),.din1(tmp_33_fu_864_p4),.din2(tmp_33_fu_864_p6),.din3(tmp_33_fu_864_p8),.def(tmp_33_fu_864_p9),.sel(empty_28_reg_1178),.dout(tmp_33_fu_864_p11));
...
sparsemux_9_2_8_1_1_U137(.din0(path_0_q0),.din1(path_1_q0),.din2(path_2_q0),.din3(path_3_q0),.def(tmp_65_fu_962_p9),.sel(tmp_65_fu_962_p10),.dout(tmp_65_fu_962_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U138(.din0(tmp_66_fu_1024_p2),.din1(tmp_66_fu_1024_p4),.din2(tmp_66_fu_1024_p6),.din3(tmp_66_fu_1024_p8),.def(tmp_66_fu_1024_p9),.sel(trunc_ln52_reg_1317),.dout(tmp_66_fu_1024_p11));
viterbi_dadd_64ns_64ns_64_8_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 8 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dadd_64ns_64ns_64_8_full_dsp_1_U139(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1353_p0),.din1(grp_fu_1353_p1),.ce(grp_fu_1353_ce),.dout(grp_fu_1353_p2));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U140(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1357_p0),.din1(grp_fu_1357_p1),.ce(grp_fu_1357_ce),.opcode(grp_fu_1357_opcode),.dout(grp_fu_1357_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_17_reg_1173[12 : 5] <= tmp_373_cast_fu_679_p1[12 : 5];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_230_reg_1303[12 : 5] <= tmp_230_fu_947_p3[12 : 5];
        trunc_ln50_1_reg_1313 <= trunc_ln50_1_fu_959_p1;
        trunc_ln52_reg_1317 <= trunc_ln52_fu_986_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_546_min_p_98_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_98_loc_fu_158 <= grp_viterbi_Pipeline_L_prev_state_fu_546_min_p_98_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_567_min_s_16_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_16_loc_fu_154 <= grp_viterbi_Pipeline_L_end_fu_567_min_s_16_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_575_min_s_34_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state44))) begin
        min_s_34_loc_fu_150 <= grp_viterbi_Pipeline_L_state_fu_575_min_s_34_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_98_loc_fu_158;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        llike_address1 = grp_viterbi_Pipeline_L_state_fu_575_llike_address1;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        llike_address1 = grp_viterbi_Pipeline_L_end_fu_567_llike_address1;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        llike_address1 = grp_viterbi_Pipeline_L_prev_state_fu_546_llike_address1;
    end else begin
        llike_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        llike_ce1 = grp_viterbi_Pipeline_L_state_fu_575_llike_ce1;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        llike_ce1 = grp_viterbi_Pipeline_L_end_fu_567_llike_ce1;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state45)) begin
        path_3_d0_local = min_s_34_loc_fu_150;
    end else if ((1'b1 == ap_CS_fsm_state31)) begin
        path_3_d0_local = min_s_16_loc_fu_154;
    end else begin
        path_3_d0_local = 'bx;
    end
end
...
assign tmp_230_fu_947_p3 = {{trunc_ln50_reg_1277}, {5'd0}};
assign tmp_231_fu_887_p3 = {{t_2_reg_1128}, {lshr_ln7_reg_1225}};
...
assign tmp_373_cast_fu_679_p1 = tmp_s_fu_671_p3;
...
assign zext_ln33_fu_893_p1 = tmp_231_fu_887_p3;
assign zext_ln52_1_fu_1000_p1 = lshr_ln52_1_fu_990_p4;
assign zext_ln52_2_fu_954_p1 = tmp_230_fu_947_p3;
