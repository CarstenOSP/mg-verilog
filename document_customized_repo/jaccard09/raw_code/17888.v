...
wire   [9:0] tmp_24_fu_822_p3;
reg   [9:0] tmp_24_reg_1022;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_535_min_p_14_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_535_min_p_14_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_563_min_s_2_out;
wire    grp_viterbi_Pipeline_L_end_fu_563_min_s_2_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_585_min_s_6_out;
wire    grp_viterbi_Pipeline_L_state_fu_585_min_s_6_out_ap_vld;
...
wire   [63:0] tmp_36_cast_fu_670_p1;
...
dcmp_64ns_64ns_1_2_no_dsp_1_U105(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1042_p0),.din1(grp_fu_1042_p1),.ce(grp_fu_1042_ce),.opcode(grp_fu_1042_opcode),.dout(grp_fu_1042_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state31)) begin
        store_forwarded_fu_204 <= min_s_2_loc_fu_128;
    end else if ((1'b1 == ap_CS_fsm_state44)) begin
        store_forwarded_fu_204 <= min_s_6_loc_fu_124;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_2_reg_947[9 : 2] <= tmp_36_cast_fu_670_p1[9 : 2];
        tmp_s_reg_942[9 : 2] <= tmp_s_fu_662_p3[9 : 2];
        zext_ln19_reg_952[7 : 0] <= zext_ln19_fu_675_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_535_min_p_14_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_14_loc_fu_132 <= grp_viterbi_Pipeline_L_prev_state_fu_535_min_p_14_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_563_min_s_2_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_2_loc_fu_128 <= grp_viterbi_Pipeline_L_end_fu_563_min_s_2_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_585_min_s_6_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state43))) begin
        min_s_6_loc_fu_124 <= grp_viterbi_Pipeline_L_state_fu_585_min_s_6_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        tmp_24_reg_1022[9 : 2] <= tmp_24_fu_822_p3[9 : 2];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        path_d0_local = min_s_6_loc_fu_124;
    end else if ((1'b1 == ap_CS_fsm_state31)) begin
        path_d0_local = min_s_2_loc_fu_128;
    end else begin
        path_d0_local = 'bx;
    end
end
...
assign tmp_24_fu_822_p3 = {{trunc_ln50_fu_818_p1}, {2'd0}};
assign tmp_25_fu_750_p3 = {{t_2_reg_910}, {lshr_ln7_reg_975}};
assign tmp_36_cast_fu_670_p1 = tmp_s_fu_662_p3;
assign tmp_fu_807_p3 = t_1_fu_200[32'd8];
assign tmp_s_fu_662_p3 = {{empty_fu_657_p2}, {2'd0}};
assign transition_address1 = grp_viterbi_Pipeline_L_prev_state_fu_535_transition_address1;
