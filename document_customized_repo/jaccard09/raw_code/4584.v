module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_13_reload,B_4_reload,C_11_reload,D_13_reload,E_4_reload,W_8_load_5,W_10_load_5,W_12_load_5,W_14_load_5,W_16_load_5,W_18_load_5,W_20_load_4,W_22_load_4,W_24_load_4,W_26_load_4,W_9_load_5,W_11_load_5,W_13_load_5,W_15_load_5,W_17_load_5,W_19_load_5,W_21_load_4,W_23_load_4,W_25_load_4,W_27_load_4,A_14_out,A_14_out_ap_vld,B_6_out,B_6_out_ap_vld,E_13_out,E_13_out_ap_vld,D_14_out,D_14_out_ap_vld,E_7_out,E_7_out_ap_vld); 
...
wire   [31:0] tmp_7_fu_384_p23;
reg   [31:0] tmp_7_reg_858;
wire   [31:0] tmp_8_fu_422_p23;
reg   [31:0] tmp_8_reg_863;
...
wire   [31:0] tmp_7_fu_384_p21;
wire   [4:0] trunc_ln100_fu_380_p1;
wire   [31:0] tmp_8_fu_422_p21;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [4:0] tmp_7_fu_384_p1;
wire   [4:0] tmp_7_fu_384_p3;
wire   [4:0] tmp_7_fu_384_p5;
wire   [4:0] tmp_7_fu_384_p7;
wire  signed [4:0] tmp_7_fu_384_p9;
wire  signed [4:0] tmp_7_fu_384_p11;
wire  signed [4:0] tmp_7_fu_384_p13;
wire  signed [4:0] tmp_7_fu_384_p15;
wire  signed [4:0] tmp_7_fu_384_p17;
wire  signed [4:0] tmp_7_fu_384_p19;
wire   [4:0] tmp_8_fu_422_p1;
wire   [4:0] tmp_8_fu_422_p3;
wire   [4:0] tmp_8_fu_422_p5;
wire   [4:0] tmp_8_fu_422_p7;
wire  signed [4:0] tmp_8_fu_422_p9;
wire  signed [4:0] tmp_8_fu_422_p11;
wire  signed [4:0] tmp_8_fu_422_p13;
wire  signed [4:0] tmp_8_fu_422_p15;
wire  signed [4:0] tmp_8_fu_422_p17;
wire  signed [4:0] tmp_8_fu_422_p19;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_21_5_32_1_1_U122(.din0(W_8_load_5),.din1(W_10_load_5),.din2(W_12_load_5),.din3(W_14_load_5),.din4(W_16_load_5),.din5(W_18_load_5),.din6(W_20_load_4),.din7(W_22_load_4),.din8(W_24_load_4),.din9(W_26_load_4),.def(tmp_7_fu_384_p21),.sel(trunc_ln100_fu_380_p1),.dout(tmp_7_fu_384_p23));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_21_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'hA ),.din1_WIDTH( 32 ),.CASE2( 5'hC ),.din2_WIDTH( 32 ),.CASE3( 5'hE ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h12 ),.din5_WIDTH( 32 ),.CASE6( 5'h14 ),.din6_WIDTH( 32 ),.CASE7( 5'h16 ),.din7_WIDTH( 32 ),.CASE8( 5'h18 ),.din8_WIDTH( 32 ),.CASE9( 5'h1A ),.din9_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_21_5_32_1_1_U123(.din0(W_9_load_5),.din1(W_11_load_5),.din2(W_13_load_5),.din3(W_15_load_5),.din4(W_17_load_5),.din5(W_19_load_5),.din6(W_21_load_4),.din7(W_23_load_4),.din8(W_25_load_4),.din9(W_27_load_4),.def(tmp_8_fu_422_p21),.sel(trunc_ln100_fu_380_p1),.dout(tmp_8_fu_422_p23));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_7_reg_858 <= tmp_7_fu_384_p23;
        tmp_8_reg_863 <= tmp_8_fu_422_p23;
    end
end
always @ (*) begin
...
assign add_ln126_5_fu_639_p2 = (or_ln126_6_fu_633_p3 + tmp_8_reg_863);
...
assign tmp_7_fu_384_p21 = 'bx;
assign tmp_8_fu_422_p21 = 'bx;
