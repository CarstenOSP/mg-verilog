...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_983_min_s_8_out;
wire    grp_viterbi_Pipeline_L_end_fu_983_min_s_8_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_1021_min_s_18_out;
wire    grp_viterbi_Pipeline_L_state_fu_1021_min_s_18_out_ap_vld;
...
wire   [63:0] tmp_240_cast_fu_1149_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_169_reg_1603 <= curr_reg_876[32'd5];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_2_reg_1561[8 : 1] <= tmp_240_cast_fu_1149_p1[8 : 1];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state44) & (grp_viterbi_Pipeline_L_state_fu_1021_min_s_18_out_ap_vld == 1'b1))) begin
        min_s_18_loc_fu_174 <= grp_viterbi_Pipeline_L_state_fu_1021_min_s_18_out;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state30) & (grp_viterbi_Pipeline_L_end_fu_983_min_s_8_out_ap_vld == 1'b1))) begin
        min_s_8_loc_fu_178 <= grp_viterbi_Pipeline_L_end_fu_983_min_s_8_out;
    end
end
always @ (posedge ap_clk) begin
...
assign tmp_162_fu_1279_p3 = {{t_2_reg_1526}, {tmp_169_reg_1603}};
assign tmp_240_cast_fu_1149_p1 = tmp_s_fu_1141_p3;
...
assign zext_ln33_fu_1285_p1 = tmp_162_fu_1279_p3;
