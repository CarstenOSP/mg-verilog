...
wire   [4:0] tmp_40_fu_1152_p4;
reg   [4:0] tmp_40_reg_1723;
...
wire   [63:0] tmp_37_fu_1493_p11;
reg   [63:0] tmp_37_reg_1980;
wire   [63:0] tmp_38_fu_1516_p11;
reg   [63:0] tmp_38_reg_1985;
...
wire   [9:0] zext_ln172_8_fu_1352_p1;
...
wire   [63:0] tmp_37_fu_1493_p9;
wire   [63:0] tmp_38_fu_1516_p9;
reg    ap_done_reg;
...
wire   [1:0] tmp_37_fu_1493_p1;
wire   [1:0] tmp_37_fu_1493_p3;
wire  signed [1:0] tmp_37_fu_1493_p5;
wire  signed [1:0] tmp_37_fu_1493_p7;
wire   [1:0] tmp_38_fu_1516_p1;
wire   [1:0] tmp_38_fu_1516_p3;
wire  signed [1:0] tmp_38_fu_1516_p5;
wire  signed [1:0] tmp_38_fu_1516_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 8'd1;
...
sparsemux_9_2_64_1_1_U162(.din0(smem_q1),.din1(smem_1_q1),.din2(smem_2_q1),.din3(smem_3_q1),.def(grp_fu_802_p9),.sel(trunc_ln172_reg_1567),.dout(grp_fu_802_p11));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U163(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.def(grp_fu_825_p9),.sel(trunc_ln172_3_reg_1603),.dout(grp_fu_825_p11));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U164(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.def(grp_fu_848_p9),.sel(trunc_ln172_reg_1567),.dout(grp_fu_848_p11));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U165(.din0(smem_q1),.din1(smem_1_q1),.din2(smem_2_q1),.din3(smem_3_q1),.def(grp_fu_871_p9),.sel(trunc_ln172_3_reg_1603),.dout(grp_fu_871_p11));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U166(.din0(smem_q1),.din1(smem_1_q1),.din2(smem_2_q1),.din3(smem_3_q1),.def(tmp_37_fu_1493_p9),.sel(trunc_ln172_3_reg_1603),.dout(tmp_37_fu_1493_p11));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U167(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.def(tmp_38_fu_1516_p9),.sel(trunc_ln172_3_reg_1603),.dout(tmp_38_fu_1516_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        lshr_ln20_reg_1780 <= {{add_ln200_fu_1236_p2[9:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_37_reg_1980 <= tmp_37_fu_1493_p11;
        tmp_38_reg_1985 <= tmp_38_fu_1516_p11;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_40_reg_1723 <= {{tid_reg_1546[5:1]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        DATA_x_1_d0_local = tmp_38_reg_1985;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        DATA_x_1_d1_local = tmp_37_reg_1980;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
...
assign add_ln198_1_fu_1390_p2 = (zext_ln172_8_fu_1352_p1 + 10'd48);
...
assign add_ln200_1_fu_1429_p2 = (zext_ln172_8_fu_1352_p1 + 10'd56);
...
assign lshr_ln17_fu_1134_p4 = {{add_ln197_fu_1129_p2[8:2]}};
assign lshr_ln18_fu_1195_p4 = {{add_ln198_fu_1189_p2[9:2]}};
...
assign lshr_ln19_fu_1218_p4 = {{add_ln199_fu_1213_p2[8:2]}};
assign lshr_ln_fu_1111_p4 = {{add_ln196_fu_1106_p2[8:2]}};
assign mul_ln191_1_fu_1004_p5 = {{{{tmp_39_fu_994_p4}, {3'd4}}, {tmp_39_fu_994_p4}}, {2'd2}};
...
assign or_ln10_fu_1177_p3 = {{trunc_ln193_reg_1671}, {2'd2}};
assign or_ln11_fu_1252_p3 = {{trunc_ln193_reg_1671}, {2'd1}};
assign or_ln12_fu_1294_p3 = {{trunc_ln193_reg_1671}, {2'd3}};
assign or_ln194_1_fu_1355_p3 = {{tmp_40_reg_1723}, {3'd6}};
assign or_ln197_1_fu_1469_p3 = {{tmp_40_reg_1723}, {3'd5}};
assign or_ln198_1_fu_1481_p3 = {{tmp_40_reg_1723}, {3'd7}};
assign shl_ln193_1_fu_1161_p3 = {{tmp_40_fu_1152_p4}, {3'd4}};
...
assign tmp_37_fu_1493_p9 = 'bx;
assign tmp_38_fu_1516_p9 = 'bx;
assign tmp_39_fu_994_p4 = {{ap_sig_allocacmp_tid[2:1]}};
assign tmp_40_fu_1152_p4 = {{tid_reg_1546[5:1]}};
...
assign zext_ln172_8_fu_1352_p1 = offset_4_reg_1593;
...
assign zext_ln194_2_fu_1184_p1 = or_ln10_fu_1177_p3;
...
assign zext_ln196_fu_1121_p1 = lshr_ln_fu_1111_p4;
assign zext_ln197_1_fu_1382_p1 = lshr_ln197_1_fu_1372_p4;
assign zext_ln197_2_fu_1259_p1 = or_ln11_fu_1252_p3;
assign zext_ln197_3_fu_1476_p1 = or_ln197_1_fu_1469_p3;
assign zext_ln197_fu_1144_p1 = lshr_ln17_fu_1134_p4;
assign zext_ln198_1_fu_1406_p1 = lshr_ln198_1_fu_1396_p4;
assign zext_ln198_2_fu_1301_p1 = or_ln12_fu_1294_p3;
assign zext_ln198_3_fu_1488_p1 = or_ln198_1_fu_1481_p3;
assign zext_ln198_fu_1205_p1 = lshr_ln18_fu_1195_p4;
assign zext_ln199_1_fu_1445_p1 = lshr_ln199_1_reg_1920;
assign zext_ln199_fu_1228_p1 = lshr_ln19_fu_1218_p4;
assign zext_ln200_1_fu_1452_p1 = lshr_ln200_1_reg_1925;
assign zext_ln200_fu_1264_p1 = lshr_ln20_reg_1780;
always @ (posedge ap_clk) begin
