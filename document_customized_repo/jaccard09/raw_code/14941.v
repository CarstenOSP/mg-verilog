...
sparsemux_17_3_32_1_1_U111(.din0(b_0_q0),.din1(b_1_q0),.din2(b_2_q0),.din3(b_3_q0),.din4(b_4_q0),.din5(b_5_q0),.din6(b_6_q0),.din7(b_7_q0),.def(tmp_7_fu_586_p17),.sel(trunc_ln70_reg_798),.dout(tmp_7_fu_586_p19));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U112(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.din4(bucket_4_q0),.din5(bucket_5_q0),.din6(bucket_6_q0),.din7(bucket_7_q0),.def(tmp_8_fu_675_p17),.sel(trunc_ln72_reg_856),.dout(tmp_8_fu_675_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        lshr_ln72_3_reg_915 <= {{tmp_8_fu_675_p19[10:3]}};
...
assign trunc_ln72_1_fu_714_p1 = tmp_8_fu_675_p19[2:0];
