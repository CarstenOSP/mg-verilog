module aes256_encrypt_ecb_aes256_encrypt_ecb_Pipeline_addkey3 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buf_3_address0,buf_3_ce0,buf_3_we0,buf_3_d0,buf_3_address1,buf_3_ce1,buf_3_q1,buf_2_address0,buf_2_ce0,buf_2_we0,buf_2_d0,buf_2_address1,buf_2_ce1,buf_2_q1,buf_1_address0,buf_1_ce0,buf_1_we0,buf_1_d0,buf_1_address1,buf_1_ce1,buf_1_q1,buf_0_address0,buf_0_ce0,buf_0_we0,buf_0_d0,buf_0_address1,buf_0_ce1,buf_0_q1,ctx_ret); 
...
reg    buf_3_we0_local;
reg    buf_3_ce0_local;
wire   [6:0] shl_ln2_fu_192_p3;
wire   [767:0] zext_ln66_fu_199_p1;
wire   [767:0] lshr_ln66_fu_203_p2;
wire   [7:0] tmp_3_fu_212_p9;
wire   [7:0] tmp_3_fu_212_p11;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_3_fu_212_p1;
wire  signed [1:0] tmp_3_fu_212_p3;
wire  signed [1:0] tmp_3_fu_212_p5;
wire   [1:0] tmp_3_fu_212_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_8_1_1_x_U66(.din0(buf_0_q1),.din1(buf_1_q1),.din2(buf_2_q1),.din3(buf_3_q1),.def(tmp_3_fu_212_p9),.sel(trunc_ln66_reg_260_pp0_iter1_reg),.dout(tmp_3_fu_212_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln3_reg_265 <= {{add_ln66_fu_160_p2[3:2]}};
...
assign add_ln66_fu_160_p2 = ($signed(ap_sig_allocacmp_i_6) + $signed(5'd31));
...
assign buf_0_d0 = xor_ln66_fu_235_p2;
...
assign buf_1_d0 = xor_ln66_fu_235_p2;
...
assign buf_2_d0 = xor_ln66_fu_235_p2;
...
assign buf_3_d0 = xor_ln66_fu_235_p2;
assign buf_3_we0 = buf_3_we0_local;
assign icmp_ln66_fu_150_p2 = ((ap_sig_allocacmp_i_6 == 5'd0) ? 1'b1 : 1'b0);
assign lshr_ln66_fu_203_p2 = ctx_ret >> zext_ln66_fu_199_p1;
assign shl_ln2_fu_192_p3 = {{trunc_ln66_1_reg_270}, {3'd0}};
assign tmp_3_fu_212_p9 = 'bx;
assign trunc_ln66_1_fu_176_p1 = add_ln66_fu_160_p2[3:0];
assign trunc_ln66_2_fu_208_p1 = lshr_ln66_fu_203_p2[7:0];
assign trunc_ln66_fu_156_p1 = ap_sig_allocacmp_i_6[1:0];
assign xor_ln66_fu_235_p2 = (trunc_ln66_2_reg_275 ^ tmp_3_fu_212_p11);
assign zext_ln66_1_fu_185_p1 = lshr_ln3_reg_265;
assign zext_ln66_fu_199_p1 = shl_ln2_fu_192_p3;
endmodule 