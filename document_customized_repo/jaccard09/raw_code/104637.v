...
wire   [31:0] tmp_5_fu_660_p19;
reg   [31:0] tmp_5_reg_875;
...
wire   [31:0] tmp_4_fu_710_p19;
reg   [31:0] tmp_4_reg_928;
...
wire   [8:0] tmp_7_fu_585_p3;
wire   [31:0] tmp_1_fu_621_p17;
wire   [31:0] tmp_5_fu_660_p17;
wire   [31:0] tmp_4_fu_710_p17;
reg    ap_done_reg;
...
wire   [2:0] tmp_5_fu_660_p1;
wire   [2:0] tmp_5_fu_660_p3;
wire   [2:0] tmp_5_fu_660_p5;
wire   [2:0] tmp_5_fu_660_p7;
wire  signed [2:0] tmp_5_fu_660_p9;
wire  signed [2:0] tmp_5_fu_660_p11;
wire  signed [2:0] tmp_5_fu_660_p13;
wire  signed [2:0] tmp_5_fu_660_p15;
wire   [2:0] tmp_4_fu_710_p1;
wire   [2:0] tmp_4_fu_710_p3;
wire   [2:0] tmp_4_fu_710_p5;
wire   [2:0] tmp_4_fu_710_p7;
wire  signed [2:0] tmp_4_fu_710_p9;
wire  signed [2:0] tmp_4_fu_710_p11;
wire  signed [2:0] tmp_4_fu_710_p13;
wire  signed [2:0] tmp_4_fu_710_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U50(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.din4(tmp1_4_q0),.din5(tmp1_5_q0),.din6(tmp1_6_q0),.din7(tmp1_7_q0),.def(tmp_1_fu_621_p17),.sel(trunc_ln26_1_reg_774),.dout(tmp_1_fu_621_p19));
(* dissolve_hierarchy = "yes" *) atax_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U51(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.din4(buff_A_4_q0),.din5(buff_A_5_q0),.din6(buff_A_6_q0),.din7(buff_A_7_q0),.def(tmp_5_fu_660_p17),.sel(trunc_ln27_reg_819),.dout(tmp_5_fu_660_p19));
(* dissolve_hierarchy = "yes" *) atax_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U52(.din0(buff_y_out_q1),.din1(buff_y_out_1_q1),.din2(buff_y_out_2_q1),.din3(buff_y_out_3_q1),.din4(buff_y_out_4_q1),.din5(buff_y_out_5_q1),.din6(buff_y_out_6_q1),.din7(buff_y_out_7_q1),.def(tmp_4_fu_710_p17),.sel(trunc_ln27_reg_819_pp0_iter5_reg),.dout(tmp_4_fu_710_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_4_reg_928 <= tmp_4_fu_710_p19;
        tmp_5_reg_875 <= tmp_5_fu_660_p19;
...
assign tmp_4_fu_710_p17 = 'bx;
assign tmp_5_fu_660_p17 = 'bx;
assign tmp_7_fu_585_p3 = {{trunc_ln26_fu_541_p1}, {lshr_ln5_6_fu_575_p4}};
...
assign zext_ln28_fu_593_p1 = tmp_7_fu_585_p3;
