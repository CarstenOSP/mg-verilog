module bicg_bicg_Pipeline_lpwr (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,s_out_din,s_out_full_n,s_out_write,q_out_din,q_out_full_n,q_out_write,buff_s_out_address0,buff_s_out_ce0,buff_s_out_q0,buff_q_out_address0,buff_q_out_ce0,buff_q_out_q0,buff_q_out_1_address0,buff_q_out_1_ce0,buff_q_out_1_q0,buff_q_out_2_address0,buff_q_out_2_ce0,buff_q_out_2_q0,buff_q_out_3_address0,buff_q_out_3_ce0,buff_q_out_3_q0,buff_q_out_4_address0,buff_q_out_4_ce0,buff_q_out_4_q0,buff_q_out_5_address0,buff_q_out_5_ce0,buff_q_out_5_q0,buff_q_out_6_address0,buff_q_out_6_ce0,buff_q_out_6_q0,buff_q_out_7_address0,buff_q_out_7_ce0,buff_q_out_7_q0); 
...
wire   [31:0] tmp_5_fu_269_p19;
reg   [31:0] tmp_5_reg_380;
...
wire   [2:0] lshr_ln5_5_fu_235_p4;
wire   [31:0] tmp_5_fu_269_p17;
wire   [2:0] tmp_5_fu_269_p18;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_5_fu_269_p1;
wire   [2:0] tmp_5_fu_269_p3;
wire   [2:0] tmp_5_fu_269_p5;
wire   [2:0] tmp_5_fu_269_p7;
wire  signed [2:0] tmp_5_fu_269_p9;
wire  signed [2:0] tmp_5_fu_269_p11;
wire  signed [2:0] tmp_5_fu_269_p13;
wire  signed [2:0] tmp_5_fu_269_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U1890(.din0(buff_q_out_q0),.din1(buff_q_out_1_q0),.din2(buff_q_out_2_q0),.din3(buff_q_out_3_q0),.din4(buff_q_out_4_q0),.din5(buff_q_out_5_q0),.din6(buff_q_out_6_q0),.din7(buff_q_out_7_q0),.def(tmp_5_fu_269_p17),.sel(tmp_5_fu_269_p18),.dout(tmp_5_fu_269_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_5_reg_380 <= tmp_5_fu_269_p19;
    end
end
always @ (*) begin
...
assign bitcast_ln36_fu_309_p1 = buff_s_out_q0;
assign bitcast_ln37_fu_314_p1 = tmp_5_reg_380;
assign buff_q_out_1_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_1_ce0 = buff_q_out_1_ce0_local;
assign buff_q_out_2_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_2_ce0 = buff_q_out_2_ce0_local;
assign buff_q_out_3_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_3_ce0 = buff_q_out_3_ce0_local;
assign buff_q_out_4_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_4_ce0 = buff_q_out_4_ce0_local;
assign buff_q_out_5_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_5_ce0 = buff_q_out_5_ce0_local;
assign buff_q_out_6_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_6_ce0 = buff_q_out_6_ce0_local;
assign buff_q_out_7_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_7_ce0 = buff_q_out_7_ce0_local;
assign buff_q_out_address0 = zext_ln5_fu_245_p1;
assign buff_q_out_ce0 = buff_q_out_ce0_local;
assign buff_s_out_address0 = zext_ln35_fu_262_p1;
assign buff_s_out_ce0 = buff_s_out_ce0_local;
assign icmp_ln35_fu_223_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_5_fu_235_p4 = {{ap_sig_allocacmp_i_1[5:3]}};
assign q_out_din = bitcast_ln37_fu_314_p1;
assign q_out_write = q_out_write_local;
assign s_out_din = bitcast_ln36_fu_309_p1;
assign s_out_write = s_out_write_local;
assign tmp_5_fu_269_p17 = 'bx;
assign tmp_5_fu_269_p18 = i_1_reg_325[2:0];
assign zext_ln35_fu_262_p1 = i_1_reg_325;
assign zext_ln5_fu_245_p1 = lshr_ln5_5_fu_235_p4;
endmodule 