...
reg   [31:0] E_42_reg_839;
reg   [0:0] icmp_ln116_reg_846;
wire   [31:0] tmp_8_fu_376_p23;
reg   [31:0] tmp_8_reg_850;
wire   [31:0] tmp_9_fu_414_p23;
reg   [31:0] tmp_9_reg_855;
reg   [31:0] E_40_load_reg_860;
wire    ap_block_pp0_stage2_11001;
wire   [31:0] B_39_fu_526_p2;
reg   [31:0] B_39_reg_865;
...
reg   [31:0] E_40_fu_128;
wire   [31:0] D_9_fu_546_p3;
reg   [31:0] B_1_fu_132;
reg   [31:0] B_37_fu_136;
wire   [31:0] A_8_fu_662_p2;
reg   [4:0] i_1_fu_140;
...
wire   [31:0] tmp_8_fu_376_p21;
wire   [31:0] tmp_9_fu_414_p21;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [4:0] tmp_8_fu_376_p1;
wire   [4:0] tmp_8_fu_376_p3;
wire   [4:0] tmp_8_fu_376_p5;
wire   [4:0] tmp_8_fu_376_p7;
wire   [4:0] tmp_8_fu_376_p9;
wire   [4:0] tmp_8_fu_376_p11;
wire   [4:0] tmp_8_fu_376_p13;
wire   [4:0] tmp_8_fu_376_p15;
wire  signed [4:0] tmp_8_fu_376_p17;
wire  signed [4:0] tmp_8_fu_376_p19;
wire   [4:0] tmp_9_fu_414_p1;
wire   [4:0] tmp_9_fu_414_p3;
wire   [4:0] tmp_9_fu_414_p5;
wire   [4:0] tmp_9_fu_414_p7;
wire   [4:0] tmp_9_fu_414_p9;
wire   [4:0] tmp_9_fu_414_p11;
wire   [4:0] tmp_9_fu_414_p13;
wire   [4:0] tmp_9_fu_414_p15;
wire  signed [4:0] tmp_9_fu_414_p17;
wire  signed [4:0] tmp_9_fu_414_p19;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_21_5_32_1_1_U51(.din0(W_load_4),.din1(W_2_load_4),.din2(W_4_load_4),.din3(W_6_load_4),.din4(W_8_load_4),.din5(W_10_load_4),.din6(W_12_load_4),.din7(W_14_load_4),.din8(W_16_load_4),.din9(W_18_load_4),.def(tmp_8_fu_376_p21),.sel(i_1_fu_140),.dout(tmp_8_fu_376_p23));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_21_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h2 ),.din1_WIDTH( 32 ),.CASE2( 5'h4 ),.din2_WIDTH( 32 ),.CASE3( 5'h6 ),.din3_WIDTH( 32 ),.CASE4( 5'h8 ),.din4_WIDTH( 32 ),.CASE5( 5'hA ),.din5_WIDTH( 32 ),.CASE6( 5'hC ),.din6_WIDTH( 32 ),.CASE7( 5'hE ),.din7_WIDTH( 32 ),.CASE8( 5'h10 ),.din8_WIDTH( 32 ),.CASE9( 5'h12 ),.din9_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_21_5_32_1_1_U52(.din0(W_1_load_4),.din1(W_3_load_4),.din2(W_5_load_4),.din3(W_7_load_4),.din4(W_9_load_4),.din5(W_11_load_4),.din6(W_13_load_4),.din7(W_15_load_4),.din8(W_17_load_4),.din9(W_19_load_4),.def(tmp_9_fu_414_p21),.sel(i_1_fu_140),.dout(tmp_9_fu_414_p23));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        B_39_reg_865 <= B_39_fu_526_p2;
        E_40_load_reg_860 <= E_40_fu_128;
        lshr_ln118_2_reg_875 <= {{B_39_fu_526_p2[31:27]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_8_reg_850 <= tmp_8_fu_376_p23;
        tmp_9_reg_855 <= tmp_9_fu_414_p23;
    end
end
always @ (*) begin
...
assign A_42_out = B_37_fu_136;
assign A_8_fu_662_p2 = (add_ln118_6_reg_885 + add_ln118_4_fu_658_p2);
assign B_1_out = B_1_fu_132;
assign B_39_fu_526_p2 = (add_ln118_fu_520_p2 + add_ln118_2_fu_514_p2);
assign C_3_fu_605_p3 = {{trunc_ln118_3_fu_591_p1}, {lshr_ln118_3_fu_595_p4}};
assign D_42_out = E_40_fu_128;
assign D_9_fu_546_p3 = {{trunc_ln118_1_fu_532_p1}, {lshr_ln118_1_fu_536_p4}};
assign E_2_out = E_2_fu_124;
assign E_42_out = D_6_fu_144;
assign add_ln116_fu_644_p2 = (i_reg_834 + 5'd2);
assign add_ln118_1_fu_509_p2 = (tmp_8_reg_850 + 32'd1518500249);
assign add_ln118_2_fu_514_p2 = (add_ln118_1_fu_509_p2 + or_ln118_1_fu_501_p3);
assign add_ln118_4_fu_658_p2 = (E_40_load_reg_860 + or_ln118_2_reg_880);
assign add_ln118_5_fu_633_p2 = (tmp_9_reg_855 + 32'd1518500249);
assign add_ln118_6_fu_638_p2 = (or_ln118_4_fu_627_p3 + add_ln118_5_fu_633_p2);
assign add_ln118_fu_520_p2 = (or_ln118_fu_495_p2 + E_2_fu_124);
assign and_ln118_1_fu_489_p2 = (xor_ln118_fu_478_p2 & E_40_fu_128);
assign and_ln118_2_fu_574_p2 = (D_9_fu_546_p3 & B_37_fu_136);
assign and_ln118_3_fu_580_p2 = (xor_ln118_1_fu_568_p2 & E_42_reg_839);
assign and_ln118_fu_484_p2 = (E_42_reg_839 & B_1_fu_132);
...
assign lshr_ln118_3_fu_595_p4 = {{B_37_fu_136[31:2]}};
assign lshr_ln2_fu_468_p4 = {{B_37_fu_136[31:27]}};
...
assign tmp_8_fu_376_p21 = 'bx;
assign tmp_9_fu_414_p21 = 'bx;
assign trunc_ln118_1_fu_532_p1 = B_1_fu_132[1:0];
assign trunc_ln118_2_fu_554_p1 = B_39_fu_526_p2[26:0];
assign trunc_ln118_3_fu_591_p1 = B_37_fu_136[1:0];
assign trunc_ln118_fu_464_p1 = B_37_fu_136[26:0];
assign xor_ln118_1_fu_568_p2 = (32'd4294967295 ^ B_37_fu_136);
