module backprop_backprop_Pipeline_VITIS_LOOP_11_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_2210228,mux_case_1209224,mux_case_0208220,activations3_load_2,activations3_1_load_2,activations3_2_load_2,sum_reload,mux_case_2210226_out,mux_case_2210226_out_ap_vld,mux_case_1209222_out,mux_case_1209222_out_ap_vld,mux_case_0208218_out,mux_case_0208218_out_ap_vld,grp_fu_8469_p_din0,grp_fu_8469_p_din1,grp_fu_8469_p_dout0,grp_fu_8469_p_ce,grp_fu_8473_p_din0,grp_fu_8473_p_din1,grp_fu_8473_p_dout0,grp_fu_8473_p_ce); 
...
wire   [63:0] tmp_71_fu_187_p7;
wire   [63:0] tmp_71_fu_187_p9;
...
wire   [1:0] tmp_71_fu_187_p1;
wire   [1:0] tmp_71_fu_187_p3;
wire  signed [1:0] tmp_71_fu_187_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_7_2_64_1_1_U802(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_71_fu_187_p7),.sel(ap_sig_allocacmp_i_15),.dout(tmp_71_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_0208218_fu_68 <= grp_fu_8469_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_1209222_fu_72 <= grp_fu_8469_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_2210226_fu_76 <= grp_fu_8469_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_s_reg_328 <= grp_fu_8473_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign bitcast_ln12_fu_207_p1 = tmp_71_fu_187_p9;
assign grp_fu_8469_p_ce = 1'b1;
assign grp_fu_8469_p_din0 = tmp_s_reg_328;
assign grp_fu_8469_p_din1 = sum_reload;
assign grp_fu_8473_p_ce = 1'b1;
assign grp_fu_8473_p_din0 = 64'd0;
assign grp_fu_8473_p_din1 = bitcast_ln12_1_fu_240_p1;
