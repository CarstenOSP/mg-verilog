module sha_stream_sha_transform_Pipeline_trans_lp6 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_17_reload,B_7_reload,E_15_reload,D_17_reload,E_8_reload,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,A_19_out,A_19_out_ap_vld,B_10_out,B_10_out_ap_vld,C_13_out,C_13_out_ap_vld,D_19_out,D_19_out_ap_vld,E_10_out,E_10_out_ap_vld); 
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln128_fu_222_p2 == 1'd1))) begin
...
assign A_19_out = B_1_fu_86;
assign B_10_out = B_fu_82;
assign C_13_out = E_2_fu_94;
...
assign D_19_out = E_1_fu_78;
assign E_10_out = E_fu_74;
...
assign add_ln130_1_fu_287_p2 = ($signed(or_ln1_fu_279_p3) + $signed(32'd3395469782));
...
assign or_ln1_fu_279_p3 = {{trunc_ln130_fu_265_p1}, {lshr_ln6_fu_269_p4}};
