module gesummv_gesummv_Pipeline_lp3_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_B_address0,buff_B_ce0,buff_B_q0,buff_B_address1,buff_B_ce1,buff_B_q1,beta,buff_x_address0,buff_x_ce0,buff_x_q0,buff_x_address1,buff_x_ce1,buff_x_q1,tmp2_address0,tmp2_ce0,tmp2_we0,tmp2_d0,tmp2_q0); 
...
wire   [4:0] tmp_3_fu_250_p4;
reg   [4:0] tmp_3_reg_411;
...
reg   [11:0] indvar_flatten7_fu_68;
...
#0 j_fu_60 = 7'd0;
#0 i_2_fu_64 = 7'd0;
#0 indvar_flatten7_fu_68 = 12'd0;
#0 add6815_fu_72 = 32'd0;
#0 ap_done_reg = 1'b0;
end
gesummv_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U591(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_144_p0),.din1(grp_fu_144_p1),.ce(1'b1),.dout(grp_fu_144_p2));
gesummv_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U592(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_148_p0),.din1(grp_fu_148_p1),.ce(1'b1),.dout(grp_fu_148_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_182_p2 == 1'd0))) begin
            indvar_flatten7_fu_68 <= add_ln31_1_fu_188_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten7_fu_68 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_3_reg_411 <= {{select_ln6_fu_214_p3[5:1]}};
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul62_1_reg_456 <= grp_fu_148_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage11_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        mul65_1_reg_466 <= grp_fu_148_p2;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln31_1_fu_188_p2 = (ap_sig_allocacmp_indvar_flatten7_load + 12'd1);
assign add_ln31_fu_200_p2 = (ap_sig_allocacmp_i_2_load + 7'd1);
assign add_ln32_fu_325_p2 = (select_ln6_reg_385 + 7'd2);
assign add_ln33_fu_293_p2 = (tmp_2_fu_283_p3 + zext_ln33_1_fu_290_p1);
...
always @ (*) begin
    ap_condition_524 = ((icmp_ln31_reg_381 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_397 == 1'd1));
end
...
assign icmp_ln31_fu_182_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 12'd2048) ? 1'b1 : 1'b0);
assign or_ln1_fu_260_p3 = {{tmp_3_fu_250_p4}, {1'd1}};
...
assign tmp_2_fu_283_p3 = {{empty_reg_391}, {6'd0}};
assign tmp_3_fu_250_p4 = {{select_ln6_fu_214_p3[5:1]}};
assign tmp_4_fu_304_p4 = {{{empty_reg_391}, {tmp_3_reg_411}}, {1'd1}};
...
assign zext_ln33_2_fu_312_p1 = tmp_4_fu_304_p4;
