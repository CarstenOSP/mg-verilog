...
wire   [10:0] tmp_257_fu_823_p3;
reg   [10:0] tmp_257_reg_1099;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_130_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_130_out_ap_vld;
...
wire   [10:0] grp_viterbi_Pipeline_L_end_fu_503_llike_address1;
wire    grp_viterbi_Pipeline_L_end_fu_503_llike_ce1;
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_503_min_s_32_out;
wire    grp_viterbi_Pipeline_L_end_fu_503_min_s_32_out_ap_vld;
...
wire   [10:0] grp_viterbi_Pipeline_L_state_fu_517_llike_address1;
wire    grp_viterbi_Pipeline_L_state_fu_517_llike_ce1;
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_517_min_s_66_out;
wire    grp_viterbi_Pipeline_L_state_fu_517_min_s_66_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_5_reg_989[10 : 3] <= tmp_381_cast_fu_621_p1[10 : 3];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_257_reg_1099[10 : 3] <= tmp_257_fu_823_p3[10 : 3];
        trunc_ln50_1_reg_1109 <= trunc_ln50_1_fu_835_p1;
        trunc_ln52_reg_1113 <= trunc_ln52_fu_846_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_130_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_130_loc_fu_134 <= grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_130_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_503_min_s_32_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_32_loc_fu_130 <= grp_viterbi_Pipeline_L_end_fu_503_min_s_32_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_517_min_s_66_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state44))) begin
        min_s_66_loc_fu_126 <= grp_viterbi_Pipeline_L_state_fu_517_min_s_66_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        llike_1_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_1_address1;
    end else begin
        llike_1_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_130_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        llike_2_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_2_address1;
    end else begin
        llike_2_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_130_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        llike_3_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_3_address1;
    end else begin
        llike_3_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_130_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        llike_4_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_4_address1;
    end else begin
        llike_4_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_4_d0 = min_p_130_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        llike_5_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_5_address1;
    end else begin
        llike_5_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_5_d0 = min_p_130_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        llike_6_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_6_address1;
    end else begin
        llike_6_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_6_d0 = min_p_130_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        llike_7_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_7_address1;
    end else begin
        llike_7_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_7_d0 = min_p_130_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        llike_address0_local = llike_addr_5_reg_989;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        llike_address1 = grp_viterbi_Pipeline_L_state_fu_517_llike_address1;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        llike_address1 = grp_viterbi_Pipeline_L_end_fu_503_llike_address1;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        llike_address1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_address1;
    end else begin
        llike_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        llike_ce1 = grp_viterbi_Pipeline_L_state_fu_517_llike_ce1;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        llike_ce1 = grp_viterbi_Pipeline_L_end_fu_503_llike_ce1;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        llike_ce1 = grp_viterbi_Pipeline_L_prev_state_fu_480_llike_ce1;
    end else begin
        llike_ce1 = 1'b0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state45)) begin
        path_1_d0_local = min_s_66_loc_fu_126;
    end else if ((1'b1 == ap_CS_fsm_state31)) begin
        path_1_d0_local = min_s_32_loc_fu_130;
    end else begin
        path_1_d0_local = 'bx;
    end
end
...
assign path_0_d0 = min_s_66_loc_fu_126;
...
assign tmp_257_fu_823_p3 = {{trunc_ln50_reg_1083}, {3'd0}};
assign tmp_258_fu_753_p3 = {{t_2_reg_954}, {lshr_ln7_reg_1031}};
assign tmp_31_fu_626_p3 = ((trunc_ln18_fu_605_p1[0:0] == 1'b1) ? obs_1_q0 : obs_0_q0);
assign tmp_381_cast_fu_621_p1 = tmp_s_fu_613_p3;
...
assign zext_ln33_fu_759_p1 = tmp_258_fu_753_p3;
assign zext_ln52_1_fu_860_p1 = lshr_ln52_1_fu_850_p4;
assign zext_ln52_2_fu_830_p1 = tmp_257_fu_823_p3;
...
always @ (posedge ap_clk) begin
    ...
    llike_addr_5_reg_989[2:0] <= 3'b000;
    conv32_udiv_cast_reg_999[10:7] <= 4'b0000;
    tmp_257_reg_1099[2:0] <= 3'b000;
end
endmodule 