module viterbi_viterbi_Pipeline_L_end (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p,llike_address0,llike_ce0,llike_q0,llike_1_address0,llike_1_ce0,llike_1_q0,min_s_out,min_s_out_ap_vld,grp_fu_364_p_din0,grp_fu_364_p_din1,grp_fu_364_p_opcode,grp_fu_364_p_dout0,grp_fu_364_p_ce); 
...
output  [4:0] grp_fu_364_p_opcode;
input  [0:0] grp_fu_364_p_dout0;
...
wire   [12:0] tmp_577_cast_fu_145_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_134_reg_389 <= grp_fu_364_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_364_p_din0 = p_fu_169_p3;
assign grp_fu_364_p_din1 = min_p_1_fu_56;
assign grp_fu_364_p_opcode = 5'd4;
...
assign tmp_577_cast_fu_145_p3 = {{8'd139}, {tmp_s_fu_135_p4}};
...
assign zext_ln41_fu_153_p1 = tmp_577_cast_fu_145_p3;
