...
wire   [10:0] tmp_425_cast_fu_257_p3;
...
sparsemux_17_3_64_1_1_U32(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.din4(llike_4_q0),.din5(llike_5_q0),.din6(llike_6_q0),.din7(llike_7_q0),.def(p_fu_280_p17),.sel(p_fu_280_p18),.dout(p_fu_280_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_552 <= grp_fu_226_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_226_p_din0 = p_reg_524;
assign grp_fu_226_p_din1 = min_p_1_fu_90;
assign grp_fu_226_p_opcode = 5'd4;
...
assign tmp_425_cast_fu_257_p3 = {{8'd139}, {tmp_s_fu_247_p4}};
...
assign zext_ln41_fu_265_p1 = tmp_425_cast_fu_257_p3;
