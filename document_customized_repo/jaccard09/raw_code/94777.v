...
wire   [0:0] trunc_ln32_fu_99_p1;
reg   [0:0] trunc_ln32_reg_146;
wire   [31:0] select_ln33_fu_124_p3;
reg   [31:0] select_ln33_reg_161;
wire   [63:0] zext_ln5_fu_113_p1;
reg   [6:0] i_fu_42;
wire   [6:0] add_ln32_fu_93_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i_1;
wire   [31:0] bitcast_ln33_fu_131_p1;
reg    ap_block_pp0_stage0_01001;
reg    y_out_write_local;
reg    buff_y_out_ce0_local;
reg    buff_y_out_1_ce0_local;
wire   [4:0] lshr_ln5_1_fu_103_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln32_fu_87_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_42 <= add_ln32_fu_93_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        select_ln33_reg_161 <= select_ln33_fu_124_p3;
        trunc_ln32_reg_146 <= trunc_ln32_fu_99_p1;
    end
end
always @ (*) begin
    if (((icmp_ln32_fu_87_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln32_fu_93_p2 = (ap_sig_allocacmp_i_1 + 7'd1);
...
assign bitcast_ln33_fu_131_p1 = select_ln33_reg_161;
assign buff_y_out_1_address0 = zext_ln5_fu_113_p1;
assign buff_y_out_1_ce0 = buff_y_out_1_ce0_local;
assign buff_y_out_address0 = zext_ln5_fu_113_p1;
assign buff_y_out_ce0 = buff_y_out_ce0_local;
assign icmp_ln32_fu_87_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_1_fu_103_p4 = {{ap_sig_allocacmp_i_1[5:1]}};
assign select_ln33_fu_124_p3 = ((trunc_ln32_reg_146[0:0] == 1'b1) ? buff_y_out_1_q0 : buff_y_out_q0);
assign trunc_ln32_fu_99_p1 = ap_sig_allocacmp_i_1[0:0];
assign y_out_din = bitcast_ln33_fu_131_p1;
assign y_out_write = y_out_write_local;
assign zext_ln5_fu_113_p1 = lshr_ln5_1_fu_103_p4;
endmodule 