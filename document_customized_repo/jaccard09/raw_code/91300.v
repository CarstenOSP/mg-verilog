...
reg   [12:0] indvar_flatten28_fu_104;
...
#0 j_fu_96 = 7'd0;
#0 i_fu_100 = 7'd0;
#0 indvar_flatten28_fu_104 = 13'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U80(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.din4(buff_B_4_q0),.din5(buff_B_5_q0),.din6(buff_B_6_q0),.din7(buff_B_7_q0),.def(tmp_1_fu_485_p17),.sel(trunc_ln30_1_reg_593),.dout(tmp_1_fu_485_p19));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U81(.din0(buff_C_out_q1),.din1(buff_C_out_1_q1),.din2(buff_C_out_2_q1),.din3(buff_C_out_3_q1),.din4(buff_C_out_4_q1),.din5(buff_C_out_5_q1),.din6(buff_C_out_6_q1),.din7(buff_C_out_7_q1),.def(tmp_2_fu_524_p17),.sel(trunc_ln30_1_reg_593_pp0_iter5_reg),.dout(tmp_2_fu_524_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln29_fu_380_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten28_fu_104 <= add_ln29_1_fu_386_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten28_fu_104 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul1_reg_704 <= grp_fu_420_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten28_load = indvar_flatten28_fu_104;
    end
end
always @ (*) begin
...
assign add_ln29_1_fu_386_p2 = (ap_sig_allocacmp_indvar_flatten28_load + 13'd1);
...
assign grp_fu_416_p_din1 = mul1_reg_704;
...
assign icmp_ln29_fu_380_p2 = ((ap_sig_allocacmp_indvar_flatten28_load == 13'd4096) ? 1'b1 : 1'b0);
