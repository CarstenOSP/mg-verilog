...
output  [63:0] grp_fu_6186_p_din0;
output  [63:0] grp_fu_6186_p_din1;
input  [63:0] grp_fu_6186_p_dout0;
...
sparsemux_7_2_64_1_1_U529(.din0(mux_case_03476_reload),.din1(mux_case_13580_reload),.din2(mux_case_23684_reload),.def(v228_fu_156_p7),.sel(ap_sig_allocacmp_v226_1),.dout(v228_fu_156_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U530(.din0(v230_fu_193_p2),.din1(v230_fu_193_p4),.din2(v230_fu_193_p6),.def(v230_fu_193_p7),.sel(v226_1_reg_252),.dout(v230_fu_193_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        v225_fu_56 <= grp_fu_2924_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v229_reg_272 <= grp_fu_6186_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v231_reg_277 <= grp_fu_2924_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v232_reg_283 <= grp_fu_6186_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_v225_load_1 = grp_fu_2924_p_dout0;
    end else begin
...
assign bitcast_ln368_fu_217_p1 = grp_fu_2924_p_dout0;
assign grp_fu_2924_p_ce = 1'b1;
assign grp_fu_2924_p_din0 = grp_fu_128_p0;
assign grp_fu_2924_p_din1 = grp_fu_128_p1;
assign grp_fu_2924_p_opcode = grp_fu_128_opcode;
assign grp_fu_6186_p_ce = 1'b1;
assign grp_fu_6186_p_din0 = grp_fu_132_p0;
assign grp_fu_6186_p_din1 = grp_fu_132_p1;
