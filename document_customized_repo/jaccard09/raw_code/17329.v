...
wire   [31:0] i_5_fu_140_p2;
reg   [31:0] i_5_reg_243;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_4_reg_200 <= ap_sig_allocacmp_i_4;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln21_reg_234 == 1'd0))) begin
        ap_sig_allocacmp_i_4 = i_5_reg_243;
    end else begin
...
assign i_5_fu_140_p2 = (i_4_reg_200 + 32'd1);
...
assign zext_ln20_fu_125_p1 = ap_sig_allocacmp_i_4;
endmodule 