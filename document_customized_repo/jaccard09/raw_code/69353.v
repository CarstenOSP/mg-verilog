module backprop_backprop_Pipeline_VITIS_LOOP_11_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_28198,mux_case_18094,mux_case_07990,activations3_load,activations3_1_load,activations3_2_load,sum_reload,mux_case_28196_out,mux_case_28196_out_ap_vld,mux_case_18092_out,mux_case_18092_out_ap_vld,mux_case_07988_out,mux_case_07988_out_ap_vld,grp_fu_6992_p_din0,grp_fu_6992_p_din1,grp_fu_6992_p_dout0,grp_fu_6992_p_ce,grp_fu_6996_p_din0,grp_fu_6996_p_din1,grp_fu_6996_p_dout0,grp_fu_6996_p_ce); 
...
wire   [63:0] tmp_34_fu_187_p7;
wire   [63:0] tmp_34_fu_187_p9;
...
wire   [1:0] tmp_34_fu_187_p1;
wire   [1:0] tmp_34_fu_187_p3;
wire  signed [1:0] tmp_34_fu_187_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_7_2_64_1_1_U1082(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_34_fu_187_p7),.sel(ap_sig_allocacmp_i_16),.dout(tmp_34_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_07988_fu_68 <= grp_fu_6992_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_18092_fu_72 <= grp_fu_6992_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_28196_fu_76 <= grp_fu_6992_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_35_reg_328 <= grp_fu_6996_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign bitcast_ln12_fu_207_p1 = tmp_34_fu_187_p9;
assign grp_fu_6992_p_ce = 1'b1;
assign grp_fu_6992_p_din0 = tmp_35_reg_328;
assign grp_fu_6992_p_din1 = sum_reload;
assign grp_fu_6996_p_ce = 1'b1;
assign grp_fu_6996_p_din0 = 64'd0;
assign grp_fu_6996_p_din1 = bitcast_ln12_1_fu_240_p1;
