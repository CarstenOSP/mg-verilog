...
reg   [0:0] tmp_384_reg_1244;
reg   [0:0] tmp_384_reg_1244_pp0_iter1_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter2_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter3_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter4_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter5_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter6_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter7_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter8_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter9_reg;
reg   [0:0] tmp_384_reg_1244_pp0_iter10_reg;
reg   [2:0] lshr_ln113_2_reg_1248;
reg   [2:0] lshr_ln113_2_reg_1248_pp0_iter1_reg;
reg   [2:0] lshr_ln113_2_reg_1248_pp0_iter2_reg;
...
sparsemux_17_3_32_1_1_U217(.din0(empty_329),.din1(empty_330),.din2(empty_331),.din3(empty_332),.din4(empty_333),.din5(empty_334),.din6(empty_335),.din7(empty_336),.def(v75_fu_856_p17),.sel(v75_fu_856_p18),.dout(v75_fu_856_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U218(.din0(empty_337),.din1(empty_338),.din2(empty_339),.din3(empty_340),.din4(empty_341),.din5(empty_342),.din6(empty_343),.din7(empty_344),.def(v83_fu_896_p17),.sel(v83_fu_896_p18),.dout(v83_fu_896_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U219(.din0(empty_345),.din1(empty_346),.din2(empty_347),.din3(empty_348),.din4(empty_349),.din5(empty_350),.din6(empty_351),.din7(empty_352),.def(v91_fu_936_p17),.sel(v91_fu_936_p18),.dout(v91_fu_936_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U220(.din0(empty_353),.din1(empty_354),.din2(empty_355),.din3(empty_356),.din4(empty_357),.din5(empty_358),.din6(empty_359),.din7(empty_360),.def(v99_fu_976_p17),.sel(v99_fu_976_p18),.dout(v99_fu_976_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U221(.din0(empty_361),.din1(empty_362),.din2(empty_363),.din3(empty_364),.din4(empty_365),.din5(empty_366),.din6(empty_367),.din7(empty_368),.def(v107_fu_1016_p17),.sel(v107_fu_1016_p18),.dout(v107_fu_1016_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U222(.din0(empty_369),.din1(empty_370),.din2(empty_371),.din3(empty_372),.din4(empty_373),.din5(empty_374),.din6(empty_375),.din7(empty_376),.def(v115_fu_1056_p17),.sel(v115_fu_1056_p18),.dout(v115_fu_1056_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U223(.din0(empty_377),.din1(empty_378),.din2(empty_379),.din3(empty_380),.din4(empty_381),.din5(empty_382),.din6(empty_383),.din7(empty_384),.def(v123_fu_1096_p17),.sel(v123_fu_1096_p18),.dout(v123_fu_1096_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U224(.din0(empty_385),.din1(empty_386),.din2(empty_387),.din3(empty_388),.din4(empty_389),.din5(empty_390),.din6(empty_391),.din7(empty),.def(v131_fu_1136_p17),.sel(v131_fu_1136_p18),.dout(v131_fu_1136_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln113_2_reg_1248_pp0_iter2_reg <= lshr_ln113_2_reg_1248_pp0_iter1_reg;
        tmp_384_reg_1244_pp0_iter10_reg <= tmp_384_reg_1244_pp0_iter9_reg;
        tmp_384_reg_1244_pp0_iter2_reg <= tmp_384_reg_1244_pp0_iter1_reg;
        tmp_384_reg_1244_pp0_iter3_reg <= tmp_384_reg_1244_pp0_iter2_reg;
        tmp_384_reg_1244_pp0_iter4_reg <= tmp_384_reg_1244_pp0_iter3_reg;
        tmp_384_reg_1244_pp0_iter5_reg <= tmp_384_reg_1244_pp0_iter4_reg;
        tmp_384_reg_1244_pp0_iter6_reg <= tmp_384_reg_1244_pp0_iter5_reg;
        tmp_384_reg_1244_pp0_iter7_reg <= tmp_384_reg_1244_pp0_iter6_reg;
        tmp_384_reg_1244_pp0_iter8_reg <= tmp_384_reg_1244_pp0_iter7_reg;
        tmp_384_reg_1244_pp0_iter9_reg <= tmp_384_reg_1244_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln113_2_reg_1248 <= {{ap_sig_allocacmp_v68[5:3]}};
        lshr_ln113_2_reg_1248_pp0_iter1_reg <= lshr_ln113_2_reg_1248;
        tmp_384_reg_1244 <= ap_sig_allocacmp_v68[32'd6];
        tmp_384_reg_1244_pp0_iter1_reg <= tmp_384_reg_1244;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter11_reg == 1'b1) & (tmp_384_reg_1244_pp0_iter10_reg == 1'd1))) begin
...
assign v71_fu_1190_p3 = ((icmp_ln115_reg_1253[0:0] == 1'b1) ? v69_2 : v66_fu_208);
...
assign zext_ln113_fu_1209_p1 = lshr_ln113_2_reg_1248_pp0_iter2_reg;
endmodule 