module viterbi_viterbi_Pipeline_L_prev_state (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p_4,empty_8,llike_1_address0,llike_1_ce0,llike_1_q0,empty_9,transition_address0,transition_ce0,transition_q0,transition_address1,transition_ce1,transition_q1,bitcast_ln24,empty,llike_address0,llike_ce0,llike_q0,min_p_133_out,min_p_133_out_ap_vld,grp_fu_252_p_din0,grp_fu_252_p_din1,grp_fu_252_p_opcode,grp_fu_252_p_dout0,grp_fu_252_p_ce,grp_fu_528_p_din0,grp_fu_528_p_din1,grp_fu_528_p_opcode,grp_fu_528_p_dout0,grp_fu_528_p_ce); 
...
wire   [0:0] tmp_6_fu_245_p3;
reg   [0:0] tmp_6_reg_536_pp0_iter1_reg;
reg   [0:0] tmp_6_reg_536_pp0_iter2_reg;
reg   [0:0] tmp_6_reg_536_pp0_iter3_reg;
reg   [0:0] tmp_6_reg_536_pp0_iter4_reg;
reg   [63:0] llike_1_load_reg_545;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [63:0] transition_load_reg_550;
reg   [63:0] transition_load_1_reg_560;
...
reg   [63:0] p_reg_590;
reg   [63:0] min_p_1_reg_597;
reg   [63:0] p_1_reg_604;
wire   [0:0] and_ln29_1_fu_392_p2;
reg   [0:0] and_ln29_1_reg_611;
wire   [63:0] min_p_3_fu_398_p3;
reg   [63:0] min_p_3_reg_616;
reg   [0:0] tmp_9_reg_623;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_fu_82 <= min_p_4;
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (tmp_6_reg_536_pp0_iter4_reg == 1'd0))) begin
        min_p_fu_82 <= min_p_6_fu_486_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_6_fu_245_p3 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        add1_reg_580 <= grp_fu_252_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add52_1_reg_585 <= grp_fu_252_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_ln25_reg_531 <= add_ln25_fu_239_p2;
        tmp_6_reg_536 <= add_ln25_fu_239_p2[32'd6];
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        min_p_1_reg_597 <= min_p_fu_82;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_3_reg_616 <= min_p_3_fu_398_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        p_1_reg_604 <= grp_fu_252_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_reg_590 <= grp_fu_252_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_9_reg_623 <= grp_fu_528_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        transition_load_1_reg_560 <= transition_q0;
        transition_load_reg_550 <= transition_q1;
    end
end
always @ (*) begin
    if (((tmp_6_reg_536 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_6_reg_536_pp0_iter3_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_182_p1 = min_p_3_fu_398_p3;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter4_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_6_reg_536_pp0_iter3_reg == 1'd1))) begin
...
assign add_ln27_1_fu_257_p3 = {{trunc_ln27_fu_253_p1}, {empty_9}};
assign add_ln_fu_226_p3 = {{ap_sig_allocacmp_prev_1}, {empty_9}};
...
assign and_ln29_3_fu_481_p2 = (tmp_9_reg_623 & and_ln29_2_fu_475_p2);
assign and_ln29_fu_386_p2 = (or_ln29_fu_362_p2 & grp_fu_528_p_dout0);
...
assign bitcast_ln27_1_fu_308_p1 = transition_load_1_reg_560;
assign bitcast_ln27_fu_304_p1 = transition_load_reg_550;
assign bitcast_ln29_1_fu_333_p1 = min_p_1_reg_597;
assign bitcast_ln29_2_fu_405_p1 = p_1_reg_604;
assign bitcast_ln29_3_fu_422_p1 = min_p_3_reg_616;
assign bitcast_ln29_fu_316_p1 = p_reg_590;
assign grp_fu_252_p_ce = 1'b1;
assign grp_fu_252_p_din0 = grp_fu_178_p0;
assign grp_fu_252_p_din1 = grp_fu_178_p1;
assign grp_fu_252_p_opcode = 2'd0;
assign grp_fu_528_p_ce = 1'b1;
assign grp_fu_528_p_din0 = grp_fu_182_p0;
assign grp_fu_528_p_din1 = grp_fu_182_p1;
assign grp_fu_528_p_opcode = 5'd4;
assign icmp_ln29_1_fu_356_p2 = ((trunc_ln29_fu_329_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_2_fu_368_p2 = ((tmp_4_fu_336_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_3_fu_374_p2 = ((trunc_ln29_1_fu_346_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_4_fu_439_p2 = ((tmp_7_fu_408_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_5_fu_445_p2 = ((trunc_ln29_2_fu_418_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_6_fu_457_p2 = ((tmp_8_fu_425_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_7_fu_463_p2 = ((trunc_ln29_3_fu_435_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_fu_350_p2 = ((tmp_3_fu_319_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign min_p_133_out = ((and_ln29_1_reg_611[0:0] == 1'b1) ? p_reg_590 : min_p_1_reg_597);
assign min_p_3_fu_398_p3 = ((and_ln29_1_reg_611[0:0] == 1'b1) ? p_reg_590 : min_p_1_reg_597);
assign min_p_6_fu_486_p3 = ((and_ln29_3_fu_481_p2[0:0] == 1'b1) ? p_1_reg_604 : min_p_3_reg_616);
...
assign tmp_3_fu_319_p4 = {{bitcast_ln29_fu_316_p1[62:52]}};
assign tmp_4_fu_336_p4 = {{bitcast_ln29_1_fu_333_p1[62:52]}};
assign tmp_6_fu_245_p3 = add_ln25_fu_239_p2[32'd6];
assign tmp_7_fu_408_p4 = {{bitcast_ln29_2_fu_405_p1[62:52]}};
assign tmp_8_fu_425_p4 = {{bitcast_ln29_3_fu_422_p1[62:52]}};
assign tmp_s_fu_213_p3 = {{empty_8}, {lshr_ln7_1_fu_203_p4}};
