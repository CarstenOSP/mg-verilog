...
reg    ap_ready_int;
reg   [10:0] v25_2_reg_371;
wire    ap_block_pp0_stage0_11001;
reg   [8:0] lshr_ln2_reg_421;
reg   [8:0] lshr_ln2_reg_421_pp0_iter2_reg;
reg   [8:0] lshr_ln2_reg_421_pp0_iter3_reg;
...
reg    v2_1_ce0_local;
wire   [6:0] lshr_ln55_1_fu_250_p4;
...
sparsemux_9_3_32_1_1_U27(.din0(v3_q0),.din1(v3_2_q0),.din2(v3_4_q0),.din3(v3_6_q0),.def(v26_fu_295_p9),.sel(trunc_ln55_fu_283_p1),.dout(v26_fu_295_p11));
(* dissolve_hierarchy = "yes" *) SgdLR_sw_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U28(.din0(v3_1_q0),.din1(v3_3_q0),.din2(v3_5_q0),.din3(v3_7_q0),.def(v26_1_fu_319_p9),.sel(trunc_ln55_fu_283_p1),.dout(v26_1_fu_319_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln2_reg_421_pp0_iter2_reg <= lshr_ln2_reg_421;
        lshr_ln2_reg_421_pp0_iter3_reg <= lshr_ln2_reg_421_pp0_iter2_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln2_reg_421 <= {{v25_2_reg_371[9:1]}};
        v25_2_reg_371 <= ap_sig_allocacmp_v25_2;
...
assign add_ln55_fu_272_p2 = (ap_sig_allocacmp_v25_2 + 11'd2);
...
assign grp_fu_579_p_din0 = v28_2_fu_352_p1;
assign grp_fu_579_p_din1 = v27_1_reg_458;
assign grp_fu_579_p_opcode = 2'd0;
assign lshr_ln55_1_fu_250_p4 = {{ap_sig_allocacmp_v25_2[9:3]}};
assign tmp_fu_242_p3 = ap_sig_allocacmp_v25_2[32'd10];
assign trunc_ln55_fu_283_p1 = v25_2_reg_371[2:0];
assign v26_1_fu_319_p9 = 'bx;
assign v26_fu_295_p9 = 'bx;
assign v28_2_fu_352_p1 = v2_1_load_reg_463;
...
assign zext_ln55_1_fu_260_p1 = lshr_ln55_1_fu_250_p4;
assign zext_ln55_fu_343_p1 = lshr_ln2_reg_421_pp0_iter3_reg;
endmodule 