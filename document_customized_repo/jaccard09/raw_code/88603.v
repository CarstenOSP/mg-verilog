...
wire   [3:0] lshr_ln5_6_fu_509_p4;
reg   [3:0] lshr_ln5_6_reg_668;
reg   [3:0] lshr_ln5_6_reg_668_pp0_iter1_reg;
wire   [2:0] tmp_6_fu_534_p4;
reg   [2:0] tmp_6_reg_693;
reg   [2:0] tmp_6_reg_693_pp0_iter1_reg;
reg   [2:0] tmp_6_reg_693_pp0_iter2_reg;
...
wire   [9:0] tmp_5_fu_519_p3;
wire   [9:0] tmp_7_fu_544_p4;
...
#0 j_fu_90 = 7'd0;
#0 i_fu_94 = 7'd0;
#0 indvar_flatten8_fu_98 = 10'd0;
#0 ap_done_reg = 1'b0;
end
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U29(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_358_p0),.din1(grp_fu_358_p1),.ce(1'b1),.dout(grp_fu_358_p2));
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U30(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_362_p0),.din1(grp_fu_362_p1),.ce(1'b1),.dout(grp_fu_362_p2));
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U31(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_366_p0),.din1(grp_fu_366_p1),.ce(1'b1),.dout(grp_fu_366_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U33(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_374_p0),.din1(grp_fu_374_p1),.ce(1'b1),.dout(grp_fu_374_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U34(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_378_p0),.din1(grp_fu_378_p1),.ce(1'b1),.dout(grp_fu_378_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U35(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_382_p0),.din1(grp_fu_382_p1),.ce(1'b1),.dout(grp_fu_382_p2));
(* dissolve_hierarchy = "yes" *) atax_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U36(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_1_fu_486_p9),.sel(trunc_ln26_1_reg_635),.dout(tmp_1_fu_486_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln26_fu_404_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln26_fu_404_p2 == 1'd0))) begin
            indvar_flatten8_fu_98 <= add_ln26_1_fu_410_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten8_fu_98 <= 10'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        j_fu_90 <= add_ln27_fu_561_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add1_reg_878 <= grp_fu_466_p_dout0;
        add58_1_reg_883 <= grp_fu_358_p2;
        add58_2_reg_888 <= grp_fu_362_p2;
        add58_3_reg_893 <= grp_fu_366_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add58_4_reg_898 <= grp_fu_466_p_dout0;
        add58_5_reg_903 <= grp_fu_358_p2;
        add58_6_reg_908 <= grp_fu_362_p2;
        add58_7_reg_913 <= grp_fu_366_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln5_6_reg_668 <= {{select_ln5_fu_480_p3[5:2]}};
        lshr_ln5_6_reg_668_pp0_iter1_reg <= lshr_ln5_6_reg_668;
        tmp_1_reg_660 <= tmp_1_fu_486_p11;
        tmp_1_reg_660_pp0_iter1_reg <= tmp_1_reg_660;
        tmp_6_reg_693 <= {{select_ln5_fu_480_p3[5:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_reg_624 <= ap_sig_allocacmp_j_load[32'd6];
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        mul57_4_reg_838 <= grp_fu_470_p_dout0;
        mul57_5_reg_843 <= grp_fu_374_p2;
        mul57_6_reg_848 <= grp_fu_378_p2;
        mul57_7_reg_853 <= grp_fu_382_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mul1_reg_798 <= grp_fu_470_p_dout0;
        mul57_1_reg_823 <= grp_fu_374_p2;
        mul57_2_reg_828 <= grp_fu_378_p2;
        mul57_3_reg_833 <= grp_fu_382_p2;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten8_load = indvar_flatten8_fu_98;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln26_1_fu_410_p2 = (ap_sig_allocacmp_indvar_flatten8_load + 10'd1);
...
assign grp_fu_466_p_din0 = grp_fu_354_p0;
assign grp_fu_466_p_din1 = grp_fu_354_p1;
assign grp_fu_466_p_opcode = 2'd0;
assign grp_fu_470_p_ce = 1'b1;
assign grp_fu_470_p_din0 = grp_fu_370_p0;
assign grp_fu_470_p_din1 = grp_fu_370_p1;
assign icmp_ln26_fu_404_p2 = ((ap_sig_allocacmp_indvar_flatten8_load == 10'd512) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_452_p4 = {{select_ln26_fu_436_p3[5:2]}};
assign lshr_ln5_6_fu_509_p4 = {{select_ln5_fu_480_p3[5:2]}};
assign or_ln_fu_579_p3 = {{tmp_6_reg_693_pp0_iter2_reg}, {1'd1}};
assign select_ln26_fu_436_p3 = ((tmp_fu_428_p3[0:0] == 1'b1) ? add_ln26_fu_422_p2 : ap_sig_allocacmp_i_load);
assign select_ln5_fu_480_p3 = ((tmp_reg_624[0:0] == 1'b1) ? 7'd0 : j_load_reg_619);
...
assign tmp_5_fu_519_p3 = {{trunc_ln26_reg_629}, {lshr_ln5_6_fu_509_p4}};
assign tmp_6_fu_534_p4 = {{select_ln5_fu_480_p3[5:3]}};
assign tmp_7_fu_544_p4 = {{{trunc_ln26_reg_629}, {tmp_6_fu_534_p4}}, {1'd1}};
assign tmp_fu_428_p3 = ap_sig_allocacmp_j_load[32'd6];
assign trunc_ln26_1_fu_448_p1 = select_ln26_fu_436_p3[1:0];
assign trunc_ln26_fu_444_p1 = select_ln26_fu_436_p3[5:0];
assign zext_ln28_1_fu_526_p1 = tmp_5_fu_519_p3;
assign zext_ln28_2_fu_553_p1 = tmp_7_fu_544_p4;
assign zext_ln28_fu_586_p1 = or_ln_fu_579_p3;
assign zext_ln5_1_fu_572_p1 = lshr_ln5_6_reg_668_pp0_iter1_reg;
