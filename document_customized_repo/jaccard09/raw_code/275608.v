...
reg   [0:0] tmp_256_reg_1248;
reg   [0:0] tmp_256_reg_1248_pp0_iter1_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter2_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter3_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter4_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter5_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter6_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter7_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter8_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter9_reg;
reg   [0:0] tmp_256_reg_1248_pp0_iter10_reg;
reg   [2:0] lshr_ln113_5_reg_1252;
reg   [2:0] lshr_ln113_5_reg_1252_pp0_iter1_reg;
reg   [2:0] lshr_ln113_5_reg_1252_pp0_iter2_reg;
...
sparsemux_17_6_32_1_1_U514(.din0(empty_201),.din1(empty_202),.din2(empty_203),.din3(empty_204),.din4(empty_205),.din5(empty_206),.din6(empty_207),.din7(empty_208),.def(v75_fu_860_p17),.sel(trunc_ln112_fu_840_p1),.dout(v75_fu_860_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U515(.din0(empty_209),.din1(empty_210),.din2(empty_211),.din3(empty_212),.din4(empty_213),.din5(empty_214),.din6(empty_215),.din7(empty_216),.def(v83_fu_900_p17),.sel(trunc_ln112_fu_840_p1),.dout(v83_fu_900_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U516(.din0(empty_217),.din1(empty_218),.din2(empty_219),.din3(empty_220),.din4(empty_221),.din5(empty_222),.din6(empty_223),.din7(empty_224),.def(v91_fu_940_p17),.sel(trunc_ln112_fu_840_p1),.dout(v91_fu_940_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U517(.din0(empty_225),.din1(empty_226),.din2(empty_227),.din3(empty_228),.din4(empty_229),.din5(empty_230),.din6(empty_231),.din7(empty_232),.def(v99_fu_980_p17),.sel(trunc_ln112_fu_840_p1),.dout(v99_fu_980_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U518(.din0(empty_233),.din1(empty_234),.din2(empty_235),.din3(empty_236),.din4(empty_237),.din5(empty_238),.din6(empty_239),.din7(empty_240),.def(v107_fu_1020_p17),.sel(trunc_ln112_fu_840_p1),.dout(v107_fu_1020_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U519(.din0(empty_241),.din1(empty_242),.din2(empty_243),.din3(empty_244),.din4(empty_245),.din5(empty_246),.din6(empty_247),.din7(empty_248),.def(v115_fu_1060_p17),.sel(trunc_ln112_fu_840_p1),.dout(v115_fu_1060_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U520(.din0(empty_249),.din1(empty_250),.din2(empty_251),.din3(empty_252),.din4(empty_253),.din5(empty_254),.din6(empty_255),.din7(empty_256),.def(v123_fu_1100_p17),.sel(trunc_ln112_fu_840_p1),.dout(v123_fu_1100_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U521(.din0(empty_257),.din1(empty_258),.din2(empty_259),.din3(empty_260),.din4(empty_261),.din5(empty_262),.din6(empty_263),.din7(empty),.def(v131_fu_1140_p17),.sel(trunc_ln112_fu_840_p1),.dout(v131_fu_1140_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln113_5_reg_1252_pp0_iter2_reg <= lshr_ln113_5_reg_1252_pp0_iter1_reg;
        tmp_256_reg_1248_pp0_iter10_reg <= tmp_256_reg_1248_pp0_iter9_reg;
        tmp_256_reg_1248_pp0_iter2_reg <= tmp_256_reg_1248_pp0_iter1_reg;
        tmp_256_reg_1248_pp0_iter3_reg <= tmp_256_reg_1248_pp0_iter2_reg;
        tmp_256_reg_1248_pp0_iter4_reg <= tmp_256_reg_1248_pp0_iter3_reg;
        tmp_256_reg_1248_pp0_iter5_reg <= tmp_256_reg_1248_pp0_iter4_reg;
        tmp_256_reg_1248_pp0_iter6_reg <= tmp_256_reg_1248_pp0_iter5_reg;
        tmp_256_reg_1248_pp0_iter7_reg <= tmp_256_reg_1248_pp0_iter6_reg;
        tmp_256_reg_1248_pp0_iter8_reg <= tmp_256_reg_1248_pp0_iter7_reg;
        tmp_256_reg_1248_pp0_iter9_reg <= tmp_256_reg_1248_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln113_5_reg_1252 <= {{ap_sig_allocacmp_v68[5:3]}};
        lshr_ln113_5_reg_1252_pp0_iter1_reg <= lshr_ln113_5_reg_1252;
        tmp_256_reg_1248 <= ap_sig_allocacmp_v68[32'd6];
        tmp_256_reg_1248_pp0_iter1_reg <= tmp_256_reg_1248;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter11_reg == 1'b1) & (tmp_256_reg_1248_pp0_iter10_reg == 1'd1))) begin
...
assign v70_20_out = v66_fu_208;
assign v71_fu_1194_p3 = ((icmp_ln115_reg_1257[0:0] == 1'b1) ? v69_5 : v66_fu_208);
assign v75_fu_860_p17 = 'bx;
assign v83_fu_900_p17 = 'bx;
assign v91_fu_940_p17 = 'bx;
assign v99_fu_980_p17 = 'bx;
assign zext_ln113_fu_1213_p1 = lshr_ln113_5_reg_1252_pp0_iter2_reg;
endmodule 