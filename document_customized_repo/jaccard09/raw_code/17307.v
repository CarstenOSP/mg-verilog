...
ms_mergesort_ms_mergesort_Pipeline_mergesort_label2 grp_ms_mergesort_Pipeline_mergesort_label2_fu_42(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_ap_start),.ap_done(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_ap_done),.ap_idle(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_ap_idle),.ap_ready(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_ap_ready),.empty(m_2_reg_99),.a_address0(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_a_address0),.a_ce0(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_a_ce0),.a_we0(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_a_we0),.a_d0(grp_ms_mergesort_Pipeline_mergesort_label2_fu_42_a_d0),.a_q0(a_q0),.m(m_fu_38));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        m_2_reg_99[31 : 1] <= m_2_fu_75_p2[31 : 1];
    end
end
always @ (*) begin
