...
sparsemux_9_3_32_1_1_U50(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_s_fu_361_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_s_fu_361_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U51(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_1_fu_385_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_1_fu_385_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_1_reg_753 <= tmp_1_fu_385_p11;
...
assign D_21_out = E_4_fu_104;
assign D_4_fu_502_p3 = {{trunc_ln126_1_fu_488_p1}, {lshr_ln126_1_fu_492_p4}};
assign E_12_out = E_fu_100;
assign E_19_out = D_fu_120;
...
assign add_ln126_5_fu_598_p2 = (or_ln126_6_fu_592_p3 + tmp_1_reg_753);
