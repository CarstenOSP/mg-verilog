...
wire   [0:0] icmp_ln47_fu_223_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [6:0] trunc_ln47_fu_235_p1;
...
reg   [2:0] trunc_ln_reg_303;
reg   [2:0] trunc_ln_reg_303_pp0_iter1_reg;
reg   [2:0] trunc_ln_reg_303_pp0_iter2_reg;
reg   [2:0] trunc_ln_reg_303_pp0_iter3_reg;
reg   [2:0] trunc_ln_reg_303_pp0_iter4_reg;
reg   [2:0] trunc_ln_reg_303_pp0_iter5_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln47_fu_223_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            v19_fu_78 <= add_ln47_fu_229_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln47_reg_298 <= trunc_ln47_fu_235_p1;
        trunc_ln47_reg_298_pp0_iter1_reg <= trunc_ln47_reg_298;
        trunc_ln_reg_303 <= {{ap_sig_allocacmp_v19_17[9:7]}};
        trunc_ln_reg_303_pp0_iter1_reg <= trunc_ln_reg_303;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        trunc_ln_reg_303_pp0_iter2_reg <= trunc_ln_reg_303_pp0_iter1_reg;
        trunc_ln_reg_303_pp0_iter3_reg <= trunc_ln_reg_303_pp0_iter2_reg;
        trunc_ln_reg_303_pp0_iter4_reg <= trunc_ln_reg_303_pp0_iter3_reg;
        trunc_ln_reg_303_pp0_iter5_reg <= trunc_ln_reg_303_pp0_iter4_reg;
        v24_reg_322 <= grp_fu_5105_p_dout0;
    end
end
always @ (*) begin
    if (((icmp_ln47_fu_223_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_v19_17 = v19_fu_78;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd1))) begin
        v3_1_we0_local = 1'b1;
    end else begin
        v3_1_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd2))) begin
        v3_2_we0_local = 1'b1;
    end else begin
        v3_2_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd3))) begin
        v3_3_we0_local = 1'b1;
    end else begin
        v3_3_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd4))) begin
        v3_4_we0_local = 1'b1;
    end else begin
        v3_4_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd5))) begin
        v3_5_we0_local = 1'b1;
    end else begin
        v3_5_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd6))) begin
        v3_6_we0_local = 1'b1;
    end else begin
        v3_6_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd7))) begin
        v3_7_we0_local = 1'b1;
    end else begin
        v3_7_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (trunc_ln_reg_303_pp0_iter5_reg == 3'd0))) begin
        v3_we0_local = 1'b1;
    end else begin
        v3_we0_local = 1'b0;
    end
...
assign add_ln1_fu_249_p3 = {{lshr_ln}, {ap_sig_allocacmp_v19_17}};
assign add_ln47_fu_229_p2 = (ap_sig_allocacmp_v19_17 + 11'd1);
...
assign grp_fu_5105_p_din0 = v22;
assign grp_fu_5105_p_din1 = v23_fu_267_p1;
assign icmp_ln47_fu_223_p2 = ((ap_sig_allocacmp_v19_17 == 11'd1024) ? 1'b1 : 1'b0);
assign trunc_ln47_fu_235_p1 = ap_sig_allocacmp_v19_17[6:0];
...
assign zext_ln51_fu_257_p1 = add_ln1_fu_249_p3;
endmodule 