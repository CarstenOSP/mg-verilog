...
sparsemux_7_2_64_1_1_U366(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_s_fu_187_p7),.sel(ap_sig_allocacmp_i_17),.dout(tmp_s_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_59_reg_328 <= grp_fu_3648_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_3644_p_din0 = tmp_59_reg_328;
