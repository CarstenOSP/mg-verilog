...
reg   [9:0] tmp1_3_addr_reg_708;
reg   [9:0] tmp1_3_addr_reg_708_pp0_iter1_reg;
...
wire   [31:0] tmp_65_fu_555_p11;
reg   [31:0] tmp_65_reg_762;
wire   [31:0] tmp_66_fu_579_p11;
reg   [31:0] tmp_66_reg_767;
...
wire   [63:0] tmp_68_cast_fu_452_p1;
...
wire   [0:0] empty_1049_fu_402_p2;
wire   [6:0] add_ln33_fu_396_p2;
wire   [5:0] trunc_ln33_fu_392_p1;
wire   [3:0] lshr_ln10_1_fu_434_p4;
wire   [9:0] tmp_68_fu_444_p3;
wire   [5:0] trunc_ln33_1_fu_413_p1;
wire   [9:0] tmp_69_fu_460_p3;
wire   [3:0] lshr_ln10_3_fu_476_p4;
wire   [9:0] tmp_71_fu_486_p3;
wire   [31:0] tmp_fu_529_p9;
wire    ap_block_pp0_stage3;
wire   [31:0] tmp_65_fu_555_p9;
wire   [1:0] tmp_65_fu_555_p10;
wire   [31:0] tmp_66_fu_579_p9;
reg    ap_done_reg;
...
wire   [1:0] tmp_65_fu_555_p1;
wire   [1:0] tmp_65_fu_555_p3;
wire  signed [1:0] tmp_65_fu_555_p5;
wire  signed [1:0] tmp_65_fu_555_p7;
wire   [1:0] tmp_66_fu_579_p1;
wire   [1:0] tmp_66_fu_579_p3;
wire  signed [1:0] tmp_66_fu_579_p5;
wire  signed [1:0] tmp_66_fu_579_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 8'd1;
...
sparsemux_9_2_32_1_1_U299(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_fu_529_p9),.sel(trunc_ln33_2_reg_687),.dout(tmp_fu_529_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U300(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.def(tmp_65_fu_555_p9),.sel(tmp_65_fu_555_p10),.dout(tmp_65_fu_555_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U301(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.def(tmp_66_fu_579_p9),.sel(trunc_ln33_2_reg_687),.dout(tmp_66_fu_579_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_1_fu_96 <= select_ln32_fu_385_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        add_reg_782 <= grp_fu_82014_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp1_1_addr_1_reg_698 <= tmp_68_cast_fu_452_p1;
        tmp1_1_addr_1_reg_698_pp0_iter1_reg <= tmp1_1_addr_1_reg_698;
        tmp1_2_addr_1_reg_703 <= tmp_68_cast_fu_452_p1;
        tmp1_2_addr_1_reg_703_pp0_iter1_reg <= tmp1_2_addr_1_reg_703;
        tmp1_3_addr_reg_708 <= tmp_68_cast_fu_452_p1;
        tmp1_3_addr_reg_708_pp0_iter1_reg <= tmp1_3_addr_reg_708;
        tmp1_addr_1_reg_693 <= tmp_68_cast_fu_452_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul_reg_772 <= grp_fu_82018_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp_65_reg_762 <= tmp_65_fu_555_p11;
        tmp_66_reg_767 <= tmp_66_fu_579_p11;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        ...
        tmp1_1_address0_local = tmp_68_cast_fu_452_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        ...
        tmp1_2_address0_local = tmp_68_cast_fu_452_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        tmp1_3_address0_local = tmp1_3_addr_reg_708_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp1_3_address0_local = tmp_68_cast_fu_452_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        ...
        tmp1_address0_local = tmp_68_cast_fu_452_p1;
    end else begin
...
assign add_ln32_fu_372_p2 = (i_1_fu_96 + 7'd1);
...
assign empty_1049_fu_402_p2 = (icmp_ln33_reg_665 | and_ln10_reg_672);
assign first_iter_1_fu_424_p2 = ((k_mid2_fu_406_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_82014_p_ce = 1'b1;
assign grp_fu_82014_p_din0 = empty_fu_104;
assign grp_fu_82014_p_din1 = mul_reg_772;
assign grp_fu_82014_p_opcode = 2'd0;
assign grp_fu_82018_p_ce = 1'b1;
assign grp_fu_82018_p_din0 = tmp_65_reg_762;
assign grp_fu_82018_p_din1 = tmp_66_reg_767;
...
assign k_mid2_fu_406_p3 = ((empty_1049_fu_402_p2[0:0] == 1'b1) ? 7'd0 : k_load_reg_660);
...
assign select_ln32_fu_385_p3 = ((icmp_ln33_reg_665[0:0] == 1'b1) ? add_ln32_fu_372_p2 : i_1_fu_96);
...
assign tmp_65_fu_555_p10 = k_mid2_reg_678[1:0];
assign tmp_65_fu_555_p9 = 'bx;
assign tmp_66_fu_579_p9 = 'bx;
assign tmp_68_cast_fu_452_p1 = tmp_68_fu_444_p3;
assign tmp_68_fu_444_p3 = {{trunc_ln33_fu_392_p1}, {lshr_ln10_1_fu_434_p4}};
assign tmp_69_fu_460_p3 = {{trunc_ln33_1_fu_413_p1}, {lshr_ln10_1_fu_434_p4}};
assign tmp_71_fu_486_p3 = {{trunc_ln33_fu_392_p1}, {lshr_ln10_3_fu_476_p4}};
...
assign zext_ln35_1_fu_494_p1 = tmp_71_fu_486_p3;
assign zext_ln35_fu_468_p1 = tmp_69_fu_460_p3;
endmodule 