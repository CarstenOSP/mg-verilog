module sha_stream_sha_transform_Pipeline_trans_lp6 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_25_reload,B_11_reload,C_25_reload,D_25_reload,E_11_reload,W_address0,W_ce0,W_q0,W_address1,W_ce1,W_q1,W_1_address0,W_1_ce0,W_1_q0,W_1_address1,W_1_ce1,W_1_q1,A_27_out,A_27_out_ap_vld,B_16_out,B_16_out_ap_vld,C_27_out,C_27_out_ap_vld,D_27_out,D_27_out_ap_vld,E_16_out,E_16_out_ap_vld); 
...
assign B_16_out = B_fu_88;
assign C_27_out = E_2_fu_96;
...
assign add_ln130_1_fu_337_p2 = ($signed(or_ln3_fu_329_p3) + $signed(32'd3395469782));
...
assign or_ln100_3_fu_284_p3 = {{tmp_s_fu_274_p4}, {1'd1}};
...
assign or_ln3_fu_329_p3 = {{trunc_ln130_fu_315_p1}, {lshr_ln6_fu_319_p4}};
...
assign zext_ln100_1_fu_292_p1 = or_ln100_3_fu_284_p3;
