...
delta_weights1_U(.clk(ap_clk),.reset(ap_rst),.address0(delta_weights1_address0),.ce0(delta_weights1_ce0),.we0(delta_weights1_we0),.d0(grp_get_delta_matrix_weights1_66_67_1_fu_1594_delta_weights1_0_d0),.q0(delta_weights1_q0),.address1(grp_get_delta_matrix_weights1_66_67_1_fu_1594_delta_weights1_0_address1),.ce1(delta_weights1_ce1),.we1(delta_weights1_we1),.d1(grp_get_delta_matrix_weights1_66_67_1_fu_1594_delta_weights1_0_d1));
backprop_delta_weights1_RAM_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 416 ),.AddressWidth( 9 ))
delta_weights1_1_U(.clk(ap_clk),.reset(ap_rst),.address0(delta_weights1_1_address0),.ce0(delta_weights1_1_ce0),.we0(delta_weights1_1_we0),.d0(grp_get_delta_matrix_weights1_66_67_1_fu_1594_delta_weights1_1_d0),.q0(delta_weights1_1_q0),.address1(grp_get_delta_matrix_weights1_66_67_1_fu_1594_delta_weights1_1_address1),.ce1(delta_weights1_1_ce1),.we1(delta_weights1_1_we1),.d1(grp_get_delta_matrix_weights1_66_67_1_fu_1594_delta_weights1_1_d1));
backprop_delta_weights2_RAM_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 2048 ),.AddressWidth( 11 ))
delta_weights2_U(.clk(ap_clk),.reset(ap_rst),.address0(delta_weights2_address0),.ce0(delta_weights2_ce0),.we0(delta_weights2_we0),.d0(grp_get_delta_matrix_weights2_fu_1570_delta_weights2_0_d0),.q0(delta_weights2_q0),.address1(grp_get_delta_matrix_weights2_fu_1570_delta_weights2_0_address1),.ce1(delta_weights2_ce1),.we1(delta_weights2_we1),.d1(grp_get_delta_matrix_weights2_fu_1570_delta_weights2_0_d1));
backprop_delta_weights2_RAM_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 2048 ),.AddressWidth( 11 ))
delta_weights2_1_U(.clk(ap_clk),.reset(ap_rst),.address0(delta_weights2_1_address0),.ce0(delta_weights2_1_ce0),.we0(delta_weights2_1_we0),.d0(grp_get_delta_matrix_weights2_fu_1570_delta_weights2_1_d0),.q0(delta_weights2_1_q0),.address1(grp_get_delta_matrix_weights2_fu_1570_delta_weights2_1_address1),.ce1(delta_weights2_1_ce1),.we1(delta_weights2_1_we1),.d1(grp_get_delta_matrix_weights2_fu_1570_delta_weights2_1_d1));
...
backprop_activations2_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 32 ),.AddressWidth( 5 ))
oracle_activations1_U(.clk(ap_clk),.reset(ap_rst),.address0(oracle_activations1_address0),.ce0(oracle_activations1_ce0),.we0(oracle_activations1_we0),.d0(grp_get_oracle_activations1_64_65_1_fu_1580_oracle_activations_0_d0),.q0(oracle_activations1_q0),.address1(grp_get_delta_matrix_weights1_66_67_1_fu_1594_output_difference_0_address1),.ce1(oracle_activations1_ce1),.q1(oracle_activations1_q1));
backprop_activations2_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 32 ),.AddressWidth( 5 ))
oracle_activations1_1_U(.clk(ap_clk),.reset(ap_rst),.address0(oracle_activations1_1_address0),.ce0(oracle_activations1_1_ce0),.we0(oracle_activations1_1_we0),.d0(grp_get_oracle_activations1_64_65_1_fu_1580_oracle_activations_1_d0),.q0(oracle_activations1_1_q0),.address1(grp_get_delta_matrix_weights1_66_67_1_fu_1594_output_difference_1_address1),.ce1(oracle_activations1_1_ce1),.q1(oracle_activations1_1_q1));
