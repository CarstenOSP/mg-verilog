...
sparsemux_21_5_32_1_1_U51(.din0(W_load_4),.din1(W_2_load_4),.din2(W_4_load_4),.din3(W_6_load_4),.din4(W_8_load_4),.din5(W_10_load_4),.din6(W_12_load_4),.din7(W_14_load_4),.din8(W_16_load_4),.din9(W_18_load_4),.def(tmp_9_fu_376_p21),.sel(i_1_fu_140),.dout(tmp_9_fu_376_p23));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_21_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h2 ),.din1_WIDTH( 32 ),.CASE2( 5'h4 ),.din2_WIDTH( 32 ),.CASE3( 5'h6 ),.din3_WIDTH( 32 ),.CASE4( 5'h8 ),.din4_WIDTH( 32 ),.CASE5( 5'hA ),.din5_WIDTH( 32 ),.CASE6( 5'hC ),.din6_WIDTH( 32 ),.CASE7( 5'hE ),.din7_WIDTH( 32 ),.CASE8( 5'h10 ),.din8_WIDTH( 32 ),.CASE9( 5'h12 ),.din9_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_21_5_32_1_1_U52(.din0(W_1_load_4),.din1(W_3_load_4),.din2(W_5_load_4),.din3(W_7_load_4),.din4(W_9_load_4),.din5(W_11_load_4),.din6(W_13_load_4),.din7(W_15_load_4),.din8(W_17_load_4),.din9(W_19_load_4),.def(tmp_s_fu_414_p21),.sel(i_1_fu_140),.dout(tmp_s_fu_414_p23));
