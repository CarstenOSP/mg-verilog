...
wire   [63:0] tmp_132_fu_1060_p11;
reg   [63:0] tmp_132_reg_1394;
wire   [63:0] tmp_133_fu_1083_p11;
reg   [63:0] tmp_133_reg_1399;
wire   [63:0] tmp_134_fu_1106_p11;
reg   [63:0] tmp_134_reg_1404;
wire   [63:0] tmp_135_fu_1129_p11;
reg   [63:0] tmp_135_reg_1409;
...
wire   [63:0] tmp_132_fu_1060_p9;
wire   [63:0] tmp_133_fu_1083_p9;
wire   [63:0] tmp_134_fu_1106_p9;
wire   [63:0] tmp_135_fu_1129_p9;
wire   [7:0] add_ln2_fu_1152_p3;
reg    ap_done_reg;
...
wire   [3:0] tmp_132_fu_1060_p1;
wire   [3:0] tmp_132_fu_1060_p3;
wire  signed [3:0] tmp_132_fu_1060_p5;
wire  signed [3:0] tmp_132_fu_1060_p7;
wire   [3:0] tmp_133_fu_1083_p1;
wire   [3:0] tmp_133_fu_1083_p3;
wire  signed [3:0] tmp_133_fu_1083_p5;
wire  signed [3:0] tmp_133_fu_1083_p7;
wire   [3:0] tmp_134_fu_1106_p1;
wire   [3:0] tmp_134_fu_1106_p3;
wire  signed [3:0] tmp_134_fu_1106_p5;
wire  signed [3:0] tmp_134_fu_1106_p7;
wire   [3:0] tmp_135_fu_1129_p1;
wire   [3:0] tmp_135_fu_1129_p3;
wire  signed [3:0] tmp_135_fu_1129_p5;
wire  signed [3:0] tmp_135_fu_1129_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_33_4_64_1_1_U756(.din0(activations1_q0),.din1(activations1_1_q0),.din2(activations1_2_q0),.din3(activations1_3_q0),.din4(activations1_4_q0),.din5(activations1_5_q0),.din6(activations1_6_q0),.din7(activations1_7_q0),.din8(activations1_8_q0),.din9(activations1_9_q0),.din10(activations1_10_q0),.din11(activations1_11_q0),.din12(activations1_12_q0),.din13(activations1_13_q0),.din14(activations1_14_q0),.din15(activations1_15_q0),.def(tmp_s_fu_989_p33),.sel(trunc_ln93_reg_1203),.dout(tmp_s_fu_989_p35));
...
sparsemux_9_4_64_1_1_U757(.din0(oracle_activations2_q0),.din1(oracle_activations2_4_q0),.din2(oracle_activations2_8_q0),.din3(oracle_activations2_12_q0),.def(tmp_132_fu_1060_p9),.sel(trunc_ln94_reg_1288),.dout(tmp_132_fu_1060_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_4_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h4 ),.din1_WIDTH( 64 ),.CASE2( 4'h8 ),.din2_WIDTH( 64 ),.CASE3( 4'hC ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_9_4_64_1_1_U758(.din0(oracle_activations2_1_q0),.din1(oracle_activations2_5_q0),.din2(oracle_activations2_9_q0),.din3(oracle_activations2_13_q0),.def(tmp_133_fu_1083_p9),.sel(trunc_ln94_reg_1288),.dout(tmp_133_fu_1083_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_4_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h4 ),.din1_WIDTH( 64 ),.CASE2( 4'h8 ),.din2_WIDTH( 64 ),.CASE3( 4'hC ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_9_4_64_1_1_U759(.din0(oracle_activations2_2_q0),.din1(oracle_activations2_6_q0),.din2(oracle_activations2_10_q0),.din3(oracle_activations2_14_q0),.def(tmp_134_fu_1106_p9),.sel(trunc_ln94_reg_1288),.dout(tmp_134_fu_1106_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_4_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h4 ),.din1_WIDTH( 64 ),.CASE2( 4'h8 ),.din2_WIDTH( 64 ),.CASE3( 4'hC ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_9_4_64_1_1_U760(.din0(oracle_activations2_3_q0),.din1(oracle_activations2_7_q0),.din2(oracle_activations2_11_q0),.din3(oracle_activations2_15_q0),.def(tmp_135_fu_1129_p9),.sel(trunc_ln94_reg_1288),.dout(tmp_135_fu_1129_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_132_reg_1394 <= tmp_132_fu_1060_p11;
        tmp_133_reg_1399 <= tmp_133_fu_1083_p11;
        tmp_134_reg_1404 <= tmp_134_fu_1106_p11;
        tmp_135_reg_1409 <= tmp_135_fu_1129_p11;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul_1_i1_reg_1422 <= grp_fu_5629_p_dout0;
        mul_2_i1_reg_1430 <= grp_fu_5633_p_dout0;
        mul_3_i1_reg_1438 <= grp_fu_5637_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter9 == 1'b1) & (trunc_ln94_reg_1288_pp0_iter8_reg == 4'd8))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter9 == 1'b1) & (trunc_ln94_reg_1288_pp0_iter8_reg == 4'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter9 == 1'b1) & (trunc_ln94_reg_1288_pp0_iter8_reg == 4'd4))) begin
...
assign add_ln2_fu_1152_p3 = {{trunc_ln95_reg_1321_pp0_iter8_reg}, {lshr_ln92_1_reg_1296_pp0_iter8_reg}};
...
assign grp_fu_3932_p_din1 = tmp_132_reg_1394;
assign grp_fu_5629_p_ce = 1'b1;
assign grp_fu_5629_p_din0 = tmp_s_reg_1386;
assign grp_fu_5629_p_din1 = tmp_133_reg_1399;
assign grp_fu_5633_p_ce = 1'b1;
assign grp_fu_5633_p_din0 = tmp_s_reg_1386;
assign grp_fu_5633_p_din1 = tmp_134_reg_1404;
assign grp_fu_5637_p_ce = 1'b1;
assign grp_fu_5637_p_din0 = tmp_s_reg_1386;
assign grp_fu_5637_p_din1 = tmp_135_reg_1409;
...
assign select_ln92_fu_874_p3 = ((tmp_fu_866_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign select_ln93_fu_888_p3 = ((tmp_fu_866_p3[0:0] == 1'b1) ? add_ln93_1_fu_882_p2 : ap_sig_allocacmp_i_load);
assign tmp_132_fu_1060_p9 = 'bx;
assign tmp_133_fu_1083_p9 = 'bx;
assign tmp_134_fu_1106_p9 = 'bx;
assign tmp_135_fu_1129_p9 = 'bx;
assign tmp_fu_866_p3 = ap_sig_allocacmp_j_load[32'd6];
...
assign zext_ln95_fu_1158_p1 = add_ln2_fu_1152_p3;
endmodule 