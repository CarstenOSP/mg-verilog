module sha_stream_sha_transform_Pipeline_trans_lp3 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A,B,C,D,E,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,W_2_address0,W_2_ce0,W_2_q0,W_3_address0,W_3_ce0,W_3_q0,B_15_out,B_15_out_ap_vld,B_2_out,B_2_out_ap_vld,D_15_out,D_15_out_ap_vld,E_15_out,E_15_out_ap_vld,E_2_out,E_2_out_ap_vld); 
...
reg   [31:0] E_11_reg_542;
reg   [31:0] D_10_reg_548;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        D_10_reg_548 <= C_9_fu_106;
        E_11_reg_542 <= D_7_fu_102;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln116_reg_508_pp0_iter2_reg == 1'd0))) begin
        ap_sig_allocacmp_B_2_load = A_8_fu_110;
    end else begin
...
assign A_11_fu_437_p2 = (add_ln118_2_reg_553 + add_ln118_fu_431_p2);
assign B_15_out = A_8_fu_110;
assign B_2_out = B_2_fu_94;
assign C_2_fu_384_p3 = {{trunc_ln118_1_fu_370_p1}, {lshr_ln118_1_fu_374_p4}};
assign D_15_out = D_10_reg_548;
assign E_15_out = E_11_reg_542;
...
assign and_ln118_1_fu_347_p2 = (xor_ln118_fu_335_p2 & D_7_fu_102);
assign and_ln118_fu_341_p2 = (ap_sig_allocacmp_B_2_load & C_9_fu_106);
...
assign lshr_ln3_fu_413_p4 = {{A_8_fu_110[31:27]}};
...
assign trunc_ln118_fu_409_p1 = A_8_fu_110[26:0];
