...
sparsemux_7_2_64_1_1_U528(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_s_fu_121_p7),.sel(ap_sig_allocacmp_i_14),.dout(tmp_s_fu_121_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_32_reg_226 <= grp_fu_3688_p_dout0;
...
assign grp_fu_3556_p_din1 = tmp_32_reg_226;
