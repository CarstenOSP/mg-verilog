...
wire   [63:0] tmp_16_fu_792_p11;
reg   [63:0] tmp_16_reg_1053;
wire   [9:0] add_ln24_fu_828_p2;
reg   [9:0] add_ln24_reg_1058;
wire    ap_CS_fsm_state15;
wire   [63:0] tmp_17_fu_856_p11;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_524_min_p_161_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_524_min_p_161_out_ap_vld;
...
wire   [63:0] tmp_369_cast_fu_671_p1;
...
wire   [7:0] tmp_15_fu_676_p9;
wire   [1:0] tmp_15_fu_676_p10;
wire   [7:0] tmp_15_fu_676_p11;
...
wire   [63:0] tmp_16_fu_792_p9;
wire   [1:0] tmp_16_fu_792_p10;
wire   [5:0] trunc_ln24_fu_816_p1;
wire   [9:0] shl_ln_fu_820_p3;
wire   [63:0] tmp_17_fu_856_p2;
wire   [63:0] tmp_17_fu_856_p4;
wire   [63:0] tmp_17_fu_856_p6;
wire   [63:0] tmp_17_fu_856_p8;
wire   [63:0] tmp_17_fu_856_p9;
wire   [10:0] tmp_294_fu_879_p3;
reg    grp_fu_593_ce;
...
wire   [1:0] tmp_15_fu_676_p1;
wire   [1:0] tmp_15_fu_676_p3;
wire  signed [1:0] tmp_15_fu_676_p5;
wire  signed [1:0] tmp_15_fu_676_p7;
wire   [1:0] tmp_16_fu_792_p1;
wire   [1:0] tmp_16_fu_792_p3;
wire  signed [1:0] tmp_16_fu_792_p5;
wire  signed [1:0] tmp_16_fu_792_p7;
wire   [1:0] tmp_17_fu_856_p1;
wire   [1:0] tmp_17_fu_856_p3;
wire  signed [1:0] tmp_17_fu_856_p5;
wire  signed [1:0] tmp_17_fu_856_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 33'd1;
...
llike_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_address0),.ce0(llike_ce0),.we0(llike_we0),.d0(llike_d0),.q0(llike_q0),.address1(grp_viterbi_Pipeline_L_backtrack_fu_565_llike_address1),.ce1(llike_ce1),.q1(llike_q1));
viterbi_llike_RAM_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
...
dadd_64ns_64ns_64_8_full_dsp_1_U175(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_593_p0),.din1(grp_fu_593_p1),.ce(grp_fu_593_ce),.dout(grp_fu_593_p2));
...
sparsemux_9_2_8_1_1_x_U176(.din0(obs_0_q0),.din1(obs_1_q0),.din2(obs_2_q0),.din3(obs_3_q0),.def(tmp_15_fu_676_p9),.sel(tmp_15_fu_676_p10),.dout(tmp_15_fu_676_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U177(.din0(tmp_16_fu_792_p2),.din1(tmp_16_fu_792_p4),.din2(tmp_16_fu_792_p6),.din3(tmp_16_fu_792_p8),.def(tmp_16_fu_792_p9),.sel(tmp_16_fu_792_p10),.dout(tmp_16_fu_792_p11));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U178(.din0(tmp_17_fu_856_p2),.din1(tmp_17_fu_856_p4),.din2(tmp_17_fu_856_p6),.din3(tmp_17_fu_856_p8),.def(tmp_17_fu_856_p9),.sel(empty_27_reg_996),.dout(tmp_17_fu_856_p11));
viterbi_dadd_64ns_64ns_64_8_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 8 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dadd_64ns_64ns_64_8_full_dsp_1_U179(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1089_p0),.din1(grp_fu_1089_p1),.ce(grp_fu_1089_ce),.dout(grp_fu_1089_p2));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U180(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1093_p0),.din1(grp_fu_1093_p1),.ce(grp_fu_1093_ce),.opcode(grp_fu_1093_opcode),.dout(grp_fu_1093_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_16_reg_1053 <= tmp_16_fu_792_p11;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_3_reg_991[10 : 3] <= tmp_369_cast_fu_671_p1[10 : 3];
...
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_524_min_p_161_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_161_loc_fu_156 <= grp_viterbi_Pipeline_L_prev_state_fu_524_min_p_161_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        tmp_17_reg_1083 <= tmp_17_fu_856_p11;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        grp_fu_593_p1 = tmp_17_reg_1083;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        grp_fu_593_p1 = tmp_16_reg_1053;
    end else begin
        grp_fu_593_p1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_161_loc_fu_156;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_161_loc_fu_156;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_161_loc_fu_156;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_4_d0 = min_p_161_loc_fu_156;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_5_d0 = min_p_161_loc_fu_156;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_6_d0 = min_p_161_loc_fu_156;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_7_d0 = min_p_161_loc_fu_156;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state27)) begin
        ...
        llike_address0_local = llike_addr_3_reg_991;
...
assign conv32_udiv_fu_704_p4 = {{tmp_15_fu_676_p11[7:2]}};
...
assign empty_27_fu_700_p1 = tmp_15_fu_676_p11[1:0];
...
assign tmp_15_fu_676_p10 = t_fu_148[1:0];
assign tmp_15_fu_676_p9 = 'bx;
assign tmp_16_fu_792_p10 = curr_reg_480[1:0];
assign tmp_16_fu_792_p2 = transition_0_q0;
assign tmp_16_fu_792_p4 = transition_1_q0;
assign tmp_16_fu_792_p6 = transition_2_q0;
assign tmp_16_fu_792_p8 = transition_3_q0;
assign tmp_16_fu_792_p9 = 'bx;
assign tmp_17_fu_856_p2 = emission_0_q0;
assign tmp_17_fu_856_p4 = emission_1_q0;
assign tmp_17_fu_856_p6 = emission_2_q0;
assign tmp_17_fu_856_p8 = emission_3_q0;
assign tmp_17_fu_856_p9 = 'bx;
assign tmp_294_fu_879_p3 = {{t_2_reg_953}, {lshr_ln7_reg_1043}};
assign tmp_369_cast_fu_671_p1 = tmp_s_fu_663_p3;
...
assign zext_ln33_fu_885_p1 = tmp_294_fu_879_p3;
assign zext_ln6_fu_647_p1 = lshr_ln6_fu_637_p4;
always @ (posedge ap_clk) begin
    tmp_s_reg_986[2:0] <= 3'b000;
    llike_addr_3_reg_991[2:0] <= 3'b000;
