...
wire   [0:0] first_iter_2_fu_254_p2;
reg   [0:0] first_iter_2_reg_436;
wire   [4:0] lshr_ln5_4_fu_260_p4;
reg   [4:0] lshr_ln5_4_reg_440;
wire   [3:0] tmp_6_fu_276_p4;
reg   [3:0] tmp_6_reg_455;
reg   [5:0] buff_q_out_addr_reg_470;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] buff_q_out_addr_reg_470_pp0_iter1_reg;
reg   [31:0] buff_p_load_reg_485;
reg   [31:0] buff_p_1_load_reg_490;
reg   [31:0] buff_p_load_1_reg_505;
reg   [31:0] buff_p_1_load_1_reg_510;
reg   [31:0] buff_q_out_load_reg_515;
...
reg   [31:0] mul61_1_reg_550;
reg   [31:0] mul61_2_reg_555;
wire    ap_CS_fsm_pp0_stage8;
wire    ap_block_pp0_stage8_11001;
reg   [31:0] mul61_3_reg_560;
...
wire   [63:0] zext_ln29_fu_325_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln31_1_fu_337_p1;
wire   [63:0] zext_ln31_2_fu_352_p1;
reg   [6:0] j_fu_62;
wire   [6:0] add_ln30_fu_371_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_fu_66;
wire   [6:0] select_ln29_fu_314_p3;
reg   [10:0] indvar_flatten14_fu_70;
wire   [10:0] add_ln29_1_fu_229_p2;
...
wire   [10:0] tmp_5_fu_330_p3;
wire   [10:0] tmp_7_fu_343_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        if ((1'b1 == ap_condition_705)) begin
            empty_fu_74 <= buff_q_out_load_reg_515;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_fu_66 <= 7'd0;
    end else if (((icmp_ln29_reg_422 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_fu_66 <= select_ln29_fu_314_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln29_fu_223_p2 == 1'd0))) begin
            indvar_flatten14_fu_70 <= add_ln29_1_fu_229_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_62 <= 7'd0;
    end else if (((icmp_ln29_reg_422 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_fu_62 <= add_ln30_fu_371_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        buff_q_out_load_reg_515 <= buff_q_out_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_p_1_load_1_reg_510 <= buff_p_1_q0;
        buff_p_1_load_reg_490 <= buff_p_1_q1;
        buff_p_load_1_reg_505 <= buff_p_q0;
        buff_p_load_reg_485 <= buff_p_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_q_out_addr_reg_470 <= zext_ln29_fu_325_p1;
        buff_q_out_addr_reg_470_pp0_iter1_reg <= buff_q_out_addr_reg_470;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_2_reg_436 <= first_iter_2_fu_254_p2;
        icmp_ln29_reg_422 <= icmp_ln29_fu_223_p2;
        lshr_ln5_4_reg_440 <= {{select_ln5_fu_246_p3[5:1]}};
        select_ln5_reg_431 <= select_ln5_fu_246_p3;
        tmp_6_reg_455 <= {{select_ln5_fu_246_p3[5:2]}};
        tmp_reg_426 <= ap_sig_allocacmp_j_load[32'd6];
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul1_reg_540 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul61_1_reg_550 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        mul61_2_reg_555 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        mul61_3_reg_560 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5)) | ((1'b0 == ap_block_pp0_stage27_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage27)) | ((1'b0 == ap_block_pp0_stage20_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage20)) | ((1'b0 == ap_block_pp0_stage13_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage13)))) begin
        reg_199 <= grp_fu_127_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_1_reg_565 <= add_ln30_fu_371_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln29_reg_422 == 1'd1) & (1'b0 == ap_block_pp0_stage6_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_q_out_address0_local = buff_q_out_addr_reg_470_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_q_out_address0_local = zext_ln29_fu_325_p1;
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage28) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
            grp_fu_191_p1 = mul61_3_reg_560;
        end else if (((1'b0 == ap_block_pp0_stage21) & (1'b1 == ap_CS_fsm_pp0_stage21))) begin
            grp_fu_191_p1 = mul61_2_reg_555;
        end else if (((1'b0 == ap_block_pp0_stage14) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
            grp_fu_191_p1 = mul61_1_reg_550;
        end else if (((1'b0 == ap_block_pp0_stage7) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
            grp_fu_191_p1 = mul1_reg_540;
        end else begin
            grp_fu_191_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
            grp_fu_195_p1 = buff_p_1_load_1_reg_510;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_195_p1 = buff_p_load_1_reg_505;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_195_p1 = buff_p_1_load_reg_490;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_195_p1 = buff_p_load_reg_485;
        end else begin
            grp_fu_195_p1 = 'bx;
        end
    end else begin
...
assign add_ln29_1_fu_229_p2 = (ap_sig_allocacmp_indvar_flatten14_load + 11'd1);
assign add_ln29_fu_308_p2 = (i_fu_66 + 7'd1);
assign add_ln30_fu_371_p2 = (select_ln5_reg_431 + 7'd4);
...
always @ (*) begin
    ap_condition_705 = ((icmp_ln29_reg_422 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_2_reg_436 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage6;
assign ap_ready = ap_ready_sig;
assign buff_A_1_address0 = zext_ln31_2_fu_352_p1;
assign buff_A_1_address1 = zext_ln31_1_fu_337_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_1_ce1 = buff_A_1_ce1_local;
assign buff_A_address0 = zext_ln31_2_fu_352_p1;
assign buff_A_address1 = zext_ln31_1_fu_337_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_A_ce1 = buff_A_ce1_local;
assign buff_p_1_address0 = zext_ln31_fu_294_p1;
assign buff_p_1_address1 = zext_ln5_fu_270_p1;
assign buff_p_1_ce0 = buff_p_1_ce0_local;
assign buff_p_1_ce1 = buff_p_1_ce1_local;
assign buff_p_address0 = zext_ln31_fu_294_p1;
assign buff_p_address1 = zext_ln5_fu_270_p1;
...
assign buff_q_out_d0 = reg_199;
assign buff_q_out_we0 = buff_q_out_we0_local;
assign empty_10_fu_321_p1 = select_ln29_fu_314_p3[5:0];
assign first_iter_2_fu_254_p2 = ((select_ln5_fu_246_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_127_p_ce = 1'b1;
assign grp_fu_127_p_din0 = grp_fu_191_p0;
assign grp_fu_127_p_din1 = grp_fu_191_p1;
assign grp_fu_127_p_opcode = 2'd0;
assign grp_fu_131_p_ce = 1'b1;
assign grp_fu_131_p_din0 = grp_fu_195_p0;
assign grp_fu_131_p_din1 = grp_fu_195_p1;
assign icmp_ln29_fu_223_p2 = ((ap_sig_allocacmp_indvar_flatten14_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln5_4_fu_260_p4 = {{select_ln5_fu_246_p3[5:1]}};
assign or_ln_fu_286_p3 = {{tmp_6_fu_276_p4}, {1'd1}};
assign select_ln29_fu_314_p3 = ((tmp_reg_426[0:0] == 1'b1) ? add_ln29_fu_308_p2 : i_fu_66);
assign select_ln5_fu_246_p3 = ((tmp_fu_238_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp_5_fu_330_p3 = {{empty_10_fu_321_p1}, {lshr_ln5_4_reg_440}};
assign tmp_6_fu_276_p4 = {{select_ln5_fu_246_p3[5:2]}};
assign tmp_7_fu_343_p4 = {{{empty_10_fu_321_p1}, {tmp_6_reg_455}}, {1'd1}};
assign tmp_fu_238_p3 = ap_sig_allocacmp_j_load[32'd6];
assign zext_ln29_fu_325_p1 = select_ln29_fu_314_p3;
assign zext_ln31_1_fu_337_p1 = tmp_5_fu_330_p3;
assign zext_ln31_2_fu_352_p1 = tmp_7_fu_343_p4;
assign zext_ln31_fu_294_p1 = or_ln_fu_286_p3;
