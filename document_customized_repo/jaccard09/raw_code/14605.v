...
reg   [31:0] b_load_128_reg_405;
wire   [9:0] thr_add15_fu_266_p2;
reg   [9:0] thr_add15_reg_410;
...
reg   [10:0] bucket_addr_159_reg_430;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        b_load_128_reg_405 <= b_q0;
        b_load_reg_400 <= b_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        bucket_addr_159_reg_430 <= zext_ln58_1_fu_333_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        thr_add15_reg_410 <= thr_add15_fu_266_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        bucket_address0_local = bucket_addr_159_reg_430;
...
assign add_ln56_3_fu_249_p4 = {{{empty_reg_378}, {tmp_16_fu_241_p3}}, {1'd1}};
...
assign ashr_ln57_1_fu_301_p2 = $signed(b_load_128_reg_405) >>> zext_ln50_cast_reg_358;
...
assign thr_add15_fu_266_p2 = (blockID_1_cast2_cast_fu_263_p1 + 10'd1);
assign tmp_16_fu_241_p3 = select_ln52_fu_213_p3[32'd1];
...
assign zext_ln55_fu_280_p1 = thr_add15_reg_410;
