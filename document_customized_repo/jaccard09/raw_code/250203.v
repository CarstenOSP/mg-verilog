...
wire   [2:0] lshr_ln_fu_422_p4;
reg   [2:0] lshr_ln_reg_663;
reg   [2:0] lshr_ln_reg_663_pp0_iter1_reg;
reg   [2:0] lshr_ln_reg_663_pp0_iter2_reg;
...
fadd_32ns_32ns_32_7_full_dsp_1_U211(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_323_p0),.din1(grp_fu_323_p1),.ce(1'b1),.dout(grp_fu_323_p2));
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U212(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_327_p0),.din1(grp_fu_327_p1),.ce(1'b1),.dout(grp_fu_327_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U215(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_339_p0),.din1(v3_2_reg_713),.ce(1'b1),.dout(grp_fu_339_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U216(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_343_p0),.din1(v3_2_reg_713),.ce(1'b1),.dout(grp_fu_343_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln_reg_663 <= {{select_ln26_fu_397_p3[5:3]}};
        lshr_ln_reg_663_pp0_iter1_reg <= lshr_ln_reg_663;
        lshr_ln_reg_663_pp0_iter2_reg <= lshr_ln_reg_663_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        v35_reg_886 <= grp_fu_117_p_dout0;
        v41_reg_891 <= grp_fu_121_p_dout0;
        v47_reg_896 <= grp_fu_339_p2;
        v53_reg_901 <= grp_fu_343_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v11_reg_841 <= grp_fu_117_p_dout0;
        v17_reg_846 <= grp_fu_121_p_dout0;
        v23_reg_851 <= grp_fu_339_p2;
        v29_reg_856 <= grp_fu_343_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v12_reg_961 <= grp_fu_109_p_dout0;
        v18_reg_966 <= grp_fu_113_p_dout0;
        v24_reg_971 <= grp_fu_323_p2;
        v30_reg_976 <= grp_fu_327_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v36_reg_981 <= grp_fu_109_p_dout0;
        v42_reg_986 <= grp_fu_113_p_dout0;
        v48_reg_991 <= grp_fu_323_p2;
        v54_reg_996 <= grp_fu_327_p2;
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_109_p_din0 = grp_fu_315_p0;
assign grp_fu_109_p_din1 = grp_fu_315_p1;
assign grp_fu_109_p_opcode = 2'd0;
assign grp_fu_113_p_ce = 1'b1;
assign grp_fu_113_p_din0 = grp_fu_319_p0;
assign grp_fu_113_p_din1 = grp_fu_319_p1;
assign grp_fu_113_p_opcode = 2'd0;
assign grp_fu_117_p_ce = 1'b1;
assign grp_fu_117_p_din0 = grp_fu_331_p0;
assign grp_fu_117_p_din1 = v3_2_reg_713;
assign grp_fu_121_p_ce = 1'b1;
assign grp_fu_121_p_din0 = grp_fu_335_p0;
assign grp_fu_121_p_din1 = v3_2_reg_713;
...
assign lshr_ln_fu_422_p4 = {{select_ln26_fu_397_p3[5:3]}};
assign or_ln_fu_542_p3 = {{lshr_ln_reg_663_pp0_iter2_reg}, {1'd1}};
...
assign tmp_fu_432_p3 = {{trunc_ln27_fu_413_p1}, {lshr_ln_fu_422_p4}};
