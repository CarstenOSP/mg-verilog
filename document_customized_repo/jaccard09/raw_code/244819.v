module atax_atax_node0_Pipeline_label_13 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v7_reload,zext_ln33_1,v113_address0,v113_ce0,v113_q0,v113_address1,v113_ce1,v113_q1,v6_1,v116_address0,v116_ce0,v116_we0,v116_d0,v116_q0,v116_address1,v116_ce1,v116_we1,v116_d1,v116_q1,lshr_ln,v7_1_out_i,v7_1_out_o,v7_1_out_o_ap_vld,grp_fu_243_p_din0,grp_fu_243_p_din1,grp_fu_243_p_opcode,grp_fu_243_p_dout0,grp_fu_243_p_ce,grp_fu_247_p_din0,grp_fu_247_p_din1,grp_fu_247_p_dout0,grp_fu_247_p_ce); 
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        v53_reg_1011 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v11_reg_906 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        v17_reg_921 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        v23_reg_936 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v29_reg_951 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v35_reg_966 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v36_reg_1021 <= grp_fu_243_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v41_reg_981 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v42_reg_1026 <= grp_fu_243_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v47_reg_991 <= grp_fu_247_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v48_reg_1031 <= grp_fu_243_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v54_reg_1036 <= grp_fu_243_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_243_p_din0 = grp_fu_266_p0;
assign grp_fu_243_p_din1 = grp_fu_266_p1;
assign grp_fu_243_p_opcode = 2'd0;
assign grp_fu_247_p_ce = 1'b1;
assign grp_fu_247_p_din0 = grp_fu_270_p0;
assign grp_fu_247_p_din1 = grp_fu_270_p1;
assign icmp_ln31_fu_369_p2 = ((v5_reg_731 == 7'd0) ? 1'b1 : 1'b0);
assign or_ln39_1_fu_339_p3 = {{tmp_s_fu_329_p4}, {1'd1}};
assign or_ln46_1_fu_383_p3 = {{tmp_12_fu_374_p4}, {2'd2}};
assign or_ln53_1_fu_412_p3 = {{tmp_12_fu_374_p4}, {2'd3}};
assign or_ln60_1_fu_466_p3 = {{tmp_15_fu_457_p4}, {3'd4}};
assign or_ln67_1_fu_502_p5 = {{{{tmp_15_fu_457_p4}, {1'd1}}, {tmp_5_fu_495_p3}}, {1'd1}};
assign or_ln74_1_fu_550_p3 = {{tmp_15_reg_826}, {3'd6}};
assign or_ln82_1_fu_653_p3 = {{tmp_15_reg_826_pp0_iter1_reg}, {3'd7}};
assign tmp_11_fu_352_p5 = {{{{lshr_ln}, {1'd1}}, {tmp_s_fu_329_p4}}, {1'd1}};
assign tmp_12_fu_374_p4 = {{v5_reg_731[5:2]}};
assign tmp_13_fu_396_p5 = {{{{lshr_ln}, {1'd1}}, {tmp_12_fu_374_p4}}, {2'd2}};
assign tmp_14_fu_425_p5 = {{{{lshr_ln}, {1'd1}}, {tmp_12_fu_374_p4}}, {2'd3}};
assign tmp_15_fu_457_p4 = {{v5_reg_731[5:3]}};
assign tmp_16_fu_479_p5 = {{{{lshr_ln}, {1'd1}}, {tmp_15_fu_457_p4}}, {3'd4}};
assign tmp_17_fu_519_p7 = {{{{{{lshr_ln}, {1'd1}}, {tmp_15_fu_457_p4}}, {1'd1}}, {tmp_5_fu_495_p3}}, {1'd1}};
assign tmp_18_fu_562_p5 = {{{{lshr_ln}, {1'd1}}, {tmp_15_reg_826}}, {3'd6}};
assign tmp_19_fu_577_p5 = {{{{lshr_ln}, {1'd1}}, {tmp_15_reg_826}}, {3'd7}};
...
assign v8_fu_445_p3 = ((icmp_ln31_reg_765[0:0] == 1'b1) ? v6_1 : v7_1_out_i);
...
assign zext_ln82_fu_660_p1 = or_ln82_1_fu_653_p3;
