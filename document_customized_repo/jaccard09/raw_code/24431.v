...
wire   [10:0] tmp_148_fu_823_p3;
reg   [10:0] tmp_148_reg_1099;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_74_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_74_out_ap_vld;
...
wire   [63:0] tmp_216_cast_fu_621_p1;
...
viterbi_dadd_64ns_64ns_64_8_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 8 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dadd_64ns_64ns_64_8_full_dsp_1_U81(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1144_p0),.din1(grp_fu_1144_p1),.ce(grp_fu_1144_ce),.dout(grp_fu_1144_p2));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U82(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1148_p0),.din1(grp_fu_1148_p1),.ce(grp_fu_1148_ce),.opcode(grp_fu_1148_opcode),.dout(grp_fu_1148_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_5_reg_989[10 : 3] <= tmp_216_cast_fu_621_p1[10 : 3];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_148_reg_1099[10 : 3] <= tmp_148_fu_823_p3[10 : 3];
        trunc_ln50_1_reg_1109 <= trunc_ln50_1_fu_835_p1;
        trunc_ln52_reg_1113 <= trunc_ln52_fu_846_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_74_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_74_loc_fu_134 <= grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_74_out;
    end
end
always @ (posedge ap_clk) begin
...
assign tmp_148_fu_823_p3 = {{trunc_ln50_reg_1083}, {3'd0}};
assign tmp_149_fu_753_p3 = {{t_2_reg_954}, {lshr_ln7_reg_1031}};
assign tmp_216_cast_fu_621_p1 = tmp_s_fu_613_p3;
...
assign zext_ln33_fu_759_p1 = tmp_149_fu_753_p3;
assign zext_ln52_1_fu_860_p1 = lshr_ln52_1_fu_850_p4;
assign zext_ln52_2_fu_830_p1 = tmp_148_fu_823_p3;
