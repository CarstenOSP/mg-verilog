module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_17_reload,B_4_reload,C_15_reload,D_17_reload,E_4_reload,W_8_load_5,W_12_load_5,W_16_load_5,W_20_load_4,W_24_load_4,W_9_load_5,W_13_load_5,W_17_load_5,W_21_load_4,W_25_load_4,W_10_load_5,W_14_load_5,W_18_load_5,W_22_load_4,W_26_load_4,W_11_load_5,W_15_load_5,W_19_load_5,W_23_load_4,W_27_load_4,A_18_out,A_18_out_ap_vld,B_6_out,B_6_out_ap_vld,C_16_out,C_16_out_ap_vld,D_18_out,D_18_out_ap_vld,E_6_out,E_6_out_ap_vld); 
...
wire   [31:0] tmp_6_fu_370_p13;
reg   [31:0] tmp_6_reg_945;
wire   [31:0] tmp_7_fu_398_p13;
reg   [31:0] tmp_7_reg_950;
wire   [31:0] tmp_8_fu_426_p13;
reg   [31:0] tmp_8_reg_955;
wire   [31:0] tmp_9_fu_454_p13;
reg   [31:0] tmp_9_reg_960;
reg   [31:0] E_5_load_1_reg_965;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] E_6_load_reg_970;
...
wire   [31:0] tmp_6_fu_370_p11;
wire   [4:0] trunc_ln124_fu_366_p1;
wire   [31:0] tmp_7_fu_398_p11;
wire   [31:0] tmp_8_fu_426_p11;
wire   [31:0] tmp_9_fu_454_p11;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [4:0] tmp_6_fu_370_p1;
wire   [4:0] tmp_6_fu_370_p3;
wire  signed [4:0] tmp_6_fu_370_p5;
wire  signed [4:0] tmp_6_fu_370_p7;
wire  signed [4:0] tmp_6_fu_370_p9;
wire   [4:0] tmp_7_fu_398_p1;
wire   [4:0] tmp_7_fu_398_p3;
wire  signed [4:0] tmp_7_fu_398_p5;
wire  signed [4:0] tmp_7_fu_398_p7;
wire  signed [4:0] tmp_7_fu_398_p9;
wire   [4:0] tmp_8_fu_426_p1;
wire   [4:0] tmp_8_fu_426_p3;
wire  signed [4:0] tmp_8_fu_426_p5;
wire  signed [4:0] tmp_8_fu_426_p7;
wire  signed [4:0] tmp_8_fu_426_p9;
wire   [4:0] tmp_9_fu_454_p1;
wire   [4:0] tmp_9_fu_454_p3;
wire  signed [4:0] tmp_9_fu_454_p5;
wire  signed [4:0] tmp_9_fu_454_p7;
wire  signed [4:0] tmp_9_fu_454_p9;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 7'd1;
...
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'hC ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.CASE3( 5'h14 ),.din3_WIDTH( 32 ),.CASE4( 5'h18 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_11_5_32_1_1_U122(.din0(W_8_load_5),.din1(W_12_load_5),.din2(W_16_load_5),.din3(W_20_load_4),.din4(W_24_load_4),.def(tmp_6_fu_370_p11),.sel(trunc_ln124_fu_366_p1),.dout(tmp_6_fu_370_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'hC ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.CASE3( 5'h14 ),.din3_WIDTH( 32 ),.CASE4( 5'h18 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_11_5_32_1_1_U123(.din0(W_9_load_5),.din1(W_13_load_5),.din2(W_17_load_5),.din3(W_21_load_4),.din4(W_25_load_4),.def(tmp_7_fu_398_p11),.sel(trunc_ln124_fu_366_p1),.dout(tmp_7_fu_398_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'hC ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.CASE3( 5'h14 ),.din3_WIDTH( 32 ),.CASE4( 5'h18 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_11_5_32_1_1_U124(.din0(W_10_load_5),.din1(W_14_load_5),.din2(W_18_load_5),.din3(W_22_load_4),.din4(W_26_load_4),.def(tmp_8_fu_426_p11),.sel(trunc_ln124_fu_366_p1),.dout(tmp_8_fu_426_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'hC ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.CASE3( 5'h14 ),.din3_WIDTH( 32 ),.CASE4( 5'h18 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_11_5_32_1_1_U125(.din0(W_11_load_5),.din1(W_15_load_5),.din2(W_19_load_5),.din3(W_23_load_4),.din4(W_27_load_4),.def(tmp_9_fu_454_p11),.sel(trunc_ln124_fu_366_p1),.dout(tmp_9_fu_454_p13));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_6_reg_945 <= tmp_6_fu_370_p13;
        tmp_7_reg_950 <= tmp_7_fu_398_p13;
        tmp_8_reg_955 <= tmp_8_fu_426_p13;
        tmp_9_reg_960 <= tmp_9_fu_454_p13;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln126_13_fu_834_p2 = (tmp_9_reg_960 + or_ln126_9_reg_1055);
assign add_ln126_14_fu_838_p2 = (or_ln126_10_fu_828_p3 + add_ln126_13_fu_834_p2);
assign add_ln126_1_fu_543_p2 = ($signed(32'd2400959708) + $signed(tmp_6_reg_945));
assign add_ln126_2_fu_548_p2 = (or_ln126_2_fu_535_p3 + add_ln126_1_fu_543_p2);
assign add_ln126_4_fu_666_p2 = (or_ln126_4_fu_660_p2 + tmp_7_reg_950);
...
assign add_ln126_8_fu_799_p2 = (tmp_8_reg_955 + or_ln126_7_fu_793_p2);
assign add_ln126_9_fu_769_p2 = ($signed(32'd2400959708) + $signed(E_6_load_reg_970));
...
assign and_ln126_3_fu_655_p2 = (E_6_load_reg_970 & C_7_fu_639_p3);
...
assign or_ln126_3_fu_645_p2 = (E_6_load_reg_970 | C_7_fu_639_p3);
...
assign tmp_6_fu_370_p11 = 'bx;
assign tmp_7_fu_398_p11 = 'bx;
assign tmp_8_fu_426_p11 = 'bx;
assign tmp_9_fu_454_p11 = 'bx;
