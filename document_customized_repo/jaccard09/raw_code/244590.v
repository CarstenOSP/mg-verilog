...
wire   [9:0] tmp_2_fu_474_p4;
wire   [9:0] tmp_5_fu_509_p4;
wire   [9:0] tmp_7_fu_523_p4;
wire   [9:0] tmp_10_fu_563_p4;
wire   [9:0] tmp_14_fu_576_p6;
wire   [9:0] tmp_17_fu_602_p4;
wire   [9:0] tmp_19_fu_615_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_11_fu_439_p3 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        lshr_ln1_reg_790 <= {{v60_3_reg_769[5:2]}};
        tmp_12_reg_814 <= v60_3_reg_769[32'd1];
        tmp_8_reg_805 <= {{v60_3_reg_769[5:3]}};
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
        reg_417 <= grp_fu_497_p_dout0;
        reg_424 <= grp_fu_501_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_11_reg_776 <= ap_sig_allocacmp_v60_3[32'd6];
        tmp_11_reg_776_pp0_iter1_reg <= tmp_11_reg_776;
        tmp_11_reg_776_pp0_iter2_reg <= tmp_11_reg_776_pp0_iter1_reg;
        tmp_11_reg_776_pp0_iter3_reg <= tmp_11_reg_776_pp0_iter2_reg;
        ...
        v60_3_reg_769 <= ap_sig_allocacmp_v60_3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v102_reg_1033 <= grp_fu_505_p_dout0;
        v108_reg_1038 <= grp_fu_509_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v103_reg_1043 <= grp_fu_497_p_dout0;
        v109_reg_1048 <= grp_fu_501_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v66_reg_958 <= grp_fu_505_p_dout0;
        v72_reg_963 <= grp_fu_509_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v78_reg_1013 <= grp_fu_505_p_dout0;
        v84_reg_1018 <= grp_fu_509_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v90_reg_1023 <= grp_fu_505_p_dout0;
        v96_reg_1028 <= grp_fu_509_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_11_reg_776 == 1'd1) & (1'b0 == ap_block_pp0_stage3_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter3 == 1'b1) & (tmp_11_reg_776_pp0_iter3_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_v60_3 = v60_fu_98;
    end
end
always @ (*) begin
...
assign add_ln98_fu_489_p2 = (ap_sig_allocacmp_v60_3 + 7'd8);
...
assign grp_fu_497_p_din0 = grp_fu_393_p0;
assign grp_fu_497_p_din1 = grp_fu_393_p1;
assign grp_fu_497_p_opcode = 2'd0;
assign grp_fu_501_p_ce = 1'b1;
assign grp_fu_501_p_din0 = grp_fu_397_p0;
assign grp_fu_501_p_din1 = grp_fu_397_p1;
assign grp_fu_501_p_opcode = 2'd0;
assign grp_fu_505_p_ce = 1'b1;
assign grp_fu_505_p_din0 = grp_fu_401_p0;
assign grp_fu_505_p_din1 = v65;
assign grp_fu_509_p_ce = 1'b1;
assign grp_fu_509_p_din0 = grp_fu_405_p0;
assign grp_fu_509_p_din1 = v65;
assign lshr_ln1_fu_500_p4 = {{v60_3_reg_769[5:2]}};
assign or_ln128_1_fu_639_p3 = {{tmp_8_reg_805}, {1'd1}};
assign tmp_10_fu_563_p4 = {{{tmp_8_reg_805}, {3'd4}}, {lshr_ln}};
assign tmp_11_fu_439_p3 = ap_sig_allocacmp_v60_3[32'd6];
assign tmp_14_fu_576_p6 = {{{{{tmp_8_reg_805}, {1'd1}}, {tmp_12_reg_814}}, {1'd1}}, {lshr_ln}};
assign tmp_17_fu_602_p4 = {{{tmp_8_reg_805}, {3'd6}}, {lshr_ln}};
assign tmp_19_fu_615_p4 = {{{tmp_8_reg_805}, {3'd7}}, {lshr_ln}};
assign tmp_1_fu_464_p4 = {{ap_sig_allocacmp_v60_3[5:1]}};
...
assign trunc_ln98_fu_447_p1 = ap_sig_allocacmp_v60_3[5:0];
...
assign zext_ln138_fu_587_p1 = tmp_14_fu_576_p6;
assign zext_ln145_fu_610_p1 = tmp_17_fu_602_p4;
assign zext_ln152_fu_623_p1 = tmp_19_fu_615_p4;
