...
reg   [1:0] i_12_reg_631;
reg   [1:0] i_12_reg_631_pp0_iter1_reg;
reg   [1:0] i_12_reg_631_pp0_iter2_reg;
reg   [1:0] i_12_reg_631_pp0_iter3_reg;
reg   [1:0] i_12_reg_631_pp0_iter4_reg;
reg   [1:0] i_12_reg_631_pp0_iter5_reg;
reg   [1:0] i_12_reg_631_pp0_iter6_reg;
reg   [1:0] i_12_reg_631_pp0_iter7_reg;
reg   [1:0] i_12_reg_631_pp0_iter8_reg;
reg   [1:0] i_12_reg_631_pp0_iter9_reg;
reg   [1:0] i_12_reg_631_pp0_iter10_reg;
reg   [1:0] i_12_reg_631_pp0_iter11_reg;
reg   [1:0] i_12_reg_631_pp0_iter12_reg;
reg   [1:0] i_12_reg_631_pp0_iter13_reg;
reg   [1:0] i_12_reg_631_pp0_iter14_reg;
reg   [1:0] i_12_reg_631_pp0_iter15_reg;
reg   [1:0] i_12_reg_631_pp0_iter16_reg;
...
sparsemux_7_2_64_1_1_U247(.din0(mux_case_02332_reload),.din1(mux_case_12436_reload),.din2(mux_case_22540_reload),.def(tmp_22_fu_438_p7),.sel(i_12_reg_631_pp0_iter1_reg),.dout(tmp_22_fu_438_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U248(.din0(mux_case_02644_reload),.din1(mux_case_12748_reload),.din2(mux_case_22852_reload),.def(tmp_24_fu_477_p7),.sel(i_12_reg_631_pp0_iter8_reg),.dout(tmp_24_fu_477_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_12_reg_631_pp0_iter16_reg == 2'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_12_reg_631_pp0_iter16_reg == 2'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_12_reg_631_pp0_iter10_reg <= i_12_reg_631_pp0_iter9_reg;
        i_12_reg_631_pp0_iter11_reg <= i_12_reg_631_pp0_iter10_reg;
        i_12_reg_631_pp0_iter12_reg <= i_12_reg_631_pp0_iter11_reg;
        i_12_reg_631_pp0_iter13_reg <= i_12_reg_631_pp0_iter12_reg;
        i_12_reg_631_pp0_iter14_reg <= i_12_reg_631_pp0_iter13_reg;
        i_12_reg_631_pp0_iter15_reg <= i_12_reg_631_pp0_iter14_reg;
        i_12_reg_631_pp0_iter16_reg <= i_12_reg_631_pp0_iter15_reg;
        i_12_reg_631_pp0_iter2_reg <= i_12_reg_631_pp0_iter1_reg;
        i_12_reg_631_pp0_iter3_reg <= i_12_reg_631_pp0_iter2_reg;
        i_12_reg_631_pp0_iter4_reg <= i_12_reg_631_pp0_iter3_reg;
        i_12_reg_631_pp0_iter5_reg <= i_12_reg_631_pp0_iter4_reg;
        i_12_reg_631_pp0_iter6_reg <= i_12_reg_631_pp0_iter5_reg;
        i_12_reg_631_pp0_iter7_reg <= i_12_reg_631_pp0_iter6_reg;
        i_12_reg_631_pp0_iter8_reg <= i_12_reg_631_pp0_iter7_reg;
        i_12_reg_631_pp0_iter9_reg <= i_12_reg_631_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_12_reg_631 <= ap_sig_allocacmp_i_12;
        i_12_reg_631_pp0_iter1_reg <= i_12_reg_631;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_i_12 = i_fu_104;
    end
end
always @ (*) begin
...
assign add_ln66_fu_356_p2 = (ap_sig_allocacmp_i_12 + 2'd1);
...
always @ (*) begin
    ap_condition_666 = (~(i_12_reg_631_pp0_iter16_reg == 2'd1) & ~(i_12_reg_631_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
...
assign icmp_ln66_fu_350_p2 = ((ap_sig_allocacmp_i_12 == 2'd3) ? 1'b1 : 1'b0);
...
assign zext_ln66_fu_362_p1 = ap_sig_allocacmp_i_12;
assign zext_ln67_fu_386_p1 = lshr_ln7_fu_376_p4;
endmodule 