...
reg    ap_ready_int;
wire   [63:0] zext_ln59_1_fu_286_p1;
...
wire   [63:0] empty_161_fu_375_p3;
reg   [63:0] v18_4_fu_86;
wire   [63:0] empty_160_fu_361_p3;
reg   [63:0] v18_5_fu_90;
wire   [63:0] empty_fu_347_p3;
wire    ap_block_pp0_stage0_01001;
reg    v20_2_we0_local;
wire   [1:0] trunc_ln59_fu_252_p1;
reg    v20_2_ce0_local;
reg    v20_1_we0_local;
reg    v20_1_ce0_local;
reg    v20_we0_local;
...
reg    v20_3_ce0_local;
reg    v19_we0_local;
wire   [0:0] trunc_ln59_1_fu_256_p1;
reg    v19_ce0_local;
reg    v19_1_we0_local;
reg    v19_1_ce0_local;
wire   [4:0] lshr_ln_fu_260_p4;
wire   [3:0] lshr_ln59_1_fu_276_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            v18_3_fu_82 <= empty_161_fu_375_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            v18_4_fu_86 <= empty_160_fu_361_p3;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((icmp_ln59_fu_240_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln59_1_fu_256_p1 == 1'd1))) begin
...
always @ (*) begin
    if (((icmp_ln59_fu_240_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln59_1_fu_256_p1 == 1'd0))) begin
        v19_we0_local = 1'b1;
    end else begin
        v19_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln59_fu_240_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln59_fu_252_p1 == 2'd1))) begin
...
always @ (*) begin
    if (((icmp_ln59_fu_240_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln59_fu_252_p1 == 2'd2))) begin
...
always @ (*) begin
    if (((icmp_ln59_fu_240_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln59_fu_252_p1 == 2'd3))) begin
...
always @ (*) begin
    if (((icmp_ln59_fu_240_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln59_fu_252_p1 == 2'd0))) begin
        v20_we0_local = 1'b1;
    end else begin
        v20_we0_local = 1'b0;
    end
...
assign empty_160_fu_361_p3 = ((and_ln63_fu_355_p2[0:0] == 1'b1) ? 64'd0 : v18_4_fu_86);
assign empty_161_fu_375_p3 = ((and_ln63_1_fu_369_p2[0:0] == 1'b1) ? 64'd0 : v18_3_fu_82);
...
assign lshr_ln59_1_fu_276_p4 = {{v22_fu_78[5:2]}};
assign lshr_ln_fu_260_p4 = {{v22_fu_78[5:1]}};
...
assign trunc_ln59_1_fu_256_p1 = v22_fu_78[0:0];
assign trunc_ln59_fu_252_p1 = v22_fu_78[1:0];
