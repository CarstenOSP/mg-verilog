module SgdLR_sw_SgdLR_sw_Pipeline_label_38 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v3_address0,v3_ce0,v3_we0,v3_d0,v3_address1,v3_ce1,v3_we1,v3_d1,tmp_10,v0_address0,v0_ce0,v0_q0,v0_address1,v0_ce1,v0_q1,v22_3,v5_3,grp_fu_1772_p_din0,grp_fu_1772_p_din1,grp_fu_1772_p_dout0,grp_fu_1772_p_ce,grp_fu_1776_p_din0,grp_fu_1776_p_din1,grp_fu_1776_p_dout0,grp_fu_1776_p_ce); 
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
        reg_190 <= grp_fu_1772_p_dout0;
        reg_195 <= grp_fu_1776_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln51_fu_220_p2 = (zext_ln47_1_fu_216_p1 + tmp_10);
...
assign grp_fu_1772_p_din0 = v22_3;
assign grp_fu_1772_p_din1 = grp_fu_174_p1;
assign grp_fu_1776_p_ce = 1'b1;
assign grp_fu_1776_p_din0 = v22_3;
assign grp_fu_1776_p_din1 = grp_fu_178_p1;
