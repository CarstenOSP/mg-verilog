...
wire   [4:0] lshr_ln6_4_fu_294_p4;
reg   [4:0] lshr_ln6_4_reg_479;
wire   [3:0] tmp_6_fu_310_p4;
reg   [3:0] tmp_6_reg_494;
reg   [5:0] tmp2_addr_reg_509;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] tmp2_addr_reg_509_pp0_iter1_reg;
reg   [31:0] buff_x_load_reg_524;
reg   [31:0] buff_x_1_load_reg_529;
reg   [31:0] buff_x_load_1_reg_544;
reg   [31:0] buff_x_1_load_1_reg_549;
reg   [31:0] arrayidx67_promoted_reg_554;
reg   [31:0] buff_B_load_reg_559;
reg   [31:0] buff_B_1_load_reg_564;
reg   [31:0] buff_B_load_1_reg_569;
reg   [31:0] buff_B_1_load_1_reg_574;
...
wire   [63:0] zext_ln31_fu_359_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln33_1_fu_371_p1;
wire   [63:0] zext_ln33_2_fu_386_p1;
reg   [6:0] j_fu_66;
wire   [6:0] add_ln32_fu_405_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_2_fu_70;
wire   [6:0] select_ln31_fu_348_p3;
reg   [10:0] indvar_flatten7_fu_74;
wire   [10:0] add_ln31_1_fu_263_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten7_load;
reg   [31:0] add6815_fu_78;
...
wire   [4:0] or_ln1_fu_320_p3;
wire   [6:0] add_ln31_fu_342_p2;
wire   [5:0] empty_fu_355_p1;
wire   [10:0] tmp_5_fu_364_p3;
wire   [10:0] tmp_7_fu_377_p4;
...
#0 add6815_fu_78 = 32'd0;
#0 ap_done_reg = 1'b0;
end
gesummv_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U593(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_201_p0),.din1(grp_fu_201_p1),.ce(1'b1),.dout(grp_fu_201_p2));
gesummv_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U594(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_205_p0),.din1(grp_fu_205_p1),.ce(1'b1),.dout(grp_fu_205_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_729)) begin
            add6815_fu_78 <= arrayidx67_promoted_reg_554;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add6815_fu_78 <= reg_233;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_2_fu_70 <= 7'd0;
    end else if (((icmp_ln31_reg_461 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_2_fu_70 <= select_ln31_fu_348_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_257_p2 == 1'd0))) begin
            indvar_flatten7_fu_74 <= add_ln31_1_fu_263_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_66 <= 7'd0;
    end else if (((icmp_ln31_reg_461 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_fu_66 <= add_ln32_fu_405_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx67_promoted_reg_554 <= tmp2_q0;
        buff_B_1_load_1_reg_574 <= buff_B_1_q0;
        buff_B_1_load_reg_564 <= buff_B_1_q1;
        buff_B_load_1_reg_569 <= buff_B_q0;
        buff_B_load_reg_559 <= buff_B_q1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln31_reg_461 <= icmp_ln31_fu_257_p2;
        lshr_ln6_4_reg_479 <= {{select_ln6_fu_280_p3[5:1]}};
        select_ln6_reg_470 <= select_ln6_fu_280_p3;
        tmp_6_reg_494 <= {{select_ln6_fu_280_p3[5:2]}};
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage24_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage24)) | ((1'b0 == ap_block_pp0_stage17_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17)) | ((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9)))) begin
        reg_233 <= grp_fu_201_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_addr_reg_509 <= zext_ln31_fu_359_p1;
        tmp2_addr_reg_509_pp0_iter1_reg <= tmp2_addr_reg_509;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_1_reg_584 <= add_ln32_fu_405_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln31_reg_461 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage10) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
            ...
            grp_fu_205_p0 = buff_B_1_load_1_reg_574;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_205_p0 = buff_B_load_1_reg_569;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_205_p0 = buff_B_1_load_reg_564;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_205_p0 = buff_B_load_reg_559;
        end else begin
            grp_fu_205_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_address0_local = tmp2_addr_reg_509_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_address0_local = zext_ln31_fu_359_p1;
    end else begin
...
assign add_ln31_1_fu_263_p2 = (ap_sig_allocacmp_indvar_flatten7_load + 11'd1);
assign add_ln31_fu_342_p2 = (i_2_fu_70 + 7'd1);
assign add_ln32_fu_405_p2 = (select_ln6_reg_470 + 7'd4);
...
always @ (*) begin
    ap_condition_729 = ((icmp_ln31_reg_461 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_475 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_B_1_address0 = zext_ln33_2_fu_386_p1;
assign buff_B_1_address1 = zext_ln33_1_fu_371_p1;
assign buff_B_1_ce0 = buff_B_1_ce0_local;
assign buff_B_1_ce1 = buff_B_1_ce1_local;
assign buff_B_address0 = zext_ln33_2_fu_386_p1;
assign buff_B_address1 = zext_ln33_1_fu_371_p1;
assign buff_B_ce0 = buff_B_ce0_local;
assign buff_B_ce1 = buff_B_ce1_local;
assign buff_x_1_address0 = zext_ln33_fu_328_p1;
assign buff_x_1_address1 = zext_ln6_fu_304_p1;
assign buff_x_1_ce0 = buff_x_1_ce0_local;
assign buff_x_1_ce1 = buff_x_1_ce1_local;
assign buff_x_address0 = zext_ln33_fu_328_p1;
assign buff_x_address1 = zext_ln6_fu_304_p1;
assign buff_x_ce0 = buff_x_ce0_local;
assign buff_x_ce1 = buff_x_ce1_local;
assign empty_fu_355_p1 = select_ln31_fu_348_p3[5:0];
assign first_iter_1_fu_288_p2 = ((select_ln6_fu_280_p3 == 7'd0) ? 1'b1 : 1'b0);
assign icmp_ln31_fu_257_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln6_4_fu_294_p4 = {{select_ln6_fu_280_p3[5:1]}};
assign or_ln1_fu_320_p3 = {{tmp_6_fu_310_p4}, {1'd1}};
assign select_ln31_fu_348_p3 = ((tmp_reg_465[0:0] == 1'b1) ? add_ln31_fu_342_p2 : i_2_fu_70);
...
assign tmp2_d0 = reg_233;
assign tmp2_we0 = tmp2_we0_local;
assign tmp_5_fu_364_p3 = {{empty_fu_355_p1}, {lshr_ln6_4_reg_479}};
assign tmp_6_fu_310_p4 = {{select_ln6_fu_280_p3[5:2]}};
assign tmp_7_fu_377_p4 = {{{empty_fu_355_p1}, {tmp_6_reg_494}}, {1'd1}};
assign tmp_fu_272_p3 = ap_sig_allocacmp_j_load[32'd6];
assign zext_ln31_fu_359_p1 = select_ln31_fu_348_p3;
assign zext_ln33_1_fu_371_p1 = tmp_5_fu_364_p3;
assign zext_ln33_2_fu_386_p1 = tmp_7_fu_377_p4;
assign zext_ln33_fu_328_p1 = or_ln1_fu_320_p3;
assign zext_ln6_fu_304_p1 = lshr_ln6_4_fu_294_p4;
endmodule 