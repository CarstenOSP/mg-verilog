module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,temp_83,temp_82,C,C_90,C_89,W_56_reload,W_60_reload,W_64_reload,W_68_reload,W_72_reload,W_57_reload,W_61_reload,W_65_reload,W_69_reload,W_73_reload,W_58_reload,W_62_reload,W_66_reload,W_70_reload,W_74_reload,W_59_reload,W_63_reload,W_67_reload,W_71_reload,W_75_reload,A_out,A_out_ap_vld,B_42_out,B_42_out_ap_vld,C_91_out,C_91_out_ap_vld,D_51_out,D_51_out_ap_vld,E_28_out,E_28_out_ap_vld); 
...
sparsemux_11_6_32_1_1_U107(.din0(W_56_reload),.din1(W_60_reload),.din2(W_64_reload),.din3(W_68_reload),.din4(W_72_reload),.def(tmp_s_fu_364_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_s_fu_364_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h2C ),.din1_WIDTH( 32 ),.CASE2( 6'h30 ),.din2_WIDTH( 32 ),.CASE3( 6'h34 ),.din3_WIDTH( 32 ),.CASE4( 6'h38 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U108(.din0(W_57_reload),.din1(W_61_reload),.din2(W_65_reload),.din3(W_69_reload),.din4(W_73_reload),.def(tmp_4_fu_392_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_4_fu_392_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h2C ),.din1_WIDTH( 32 ),.CASE2( 6'h30 ),.din2_WIDTH( 32 ),.CASE3( 6'h34 ),.din3_WIDTH( 32 ),.CASE4( 6'h38 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U109(.din0(W_58_reload),.din1(W_62_reload),.din2(W_66_reload),.din3(W_70_reload),.din4(W_74_reload),.def(tmp_5_fu_420_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_5_fu_420_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h2C ),.din1_WIDTH( 32 ),.CASE2( 6'h30 ),.din2_WIDTH( 32 ),.CASE3( 6'h34 ),.din3_WIDTH( 32 ),.CASE4( 6'h38 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U110(.din0(W_59_reload),.din1(W_63_reload),.din2(W_67_reload),.din3(W_71_reload),.din4(W_75_reload),.def(tmp_6_fu_448_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_6_fu_448_p13));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_1_fu_136 <= add_ln124_fu_838_p2;
    end
end
always @ (posedge ap_clk) begin
...
assign A_out = B_5_fu_132;
assign B_42_out = B_fu_124;
assign B_9_fu_798_p2 = (add_ln126_10_reg_1054 + add_ln126_8_fu_793_p2);
assign C_8_fu_734_p3 = {{trunc_ln126_7_fu_720_p1}, {lshr_ln126_7_fu_724_p4}};
assign C_91_out = E_6_fu_128;
assign C_9_fu_633_p3 = {{trunc_ln126_1_reg_981}, {lshr_ln126_1_reg_986}};
assign D_51_out = E_5_fu_120;
assign D_fu_690_p3 = {{trunc_ln126_5_reg_1011}, {lshr_ln126_5_reg_1016}};
assign E_28_out = E_fu_116;
assign E_9_fu_670_p3 = {{trunc_ln126_3_reg_1001}, {lshr_ln126_3_reg_1006}};
assign add_ln124_fu_838_p2 = (i_reg_930 + 6'd4);
assign add_ln126_10_fu_768_p2 = (or_ln126_s_fu_757_p3 + add_ln126_9_fu_763_p2);
assign add_ln126_12_fu_848_p2 = ($signed(C_9_reg_1026) + $signed(32'd2400959708));
...
assign and_ln126_3_fu_649_p2 = (E_6_load_1_reg_964 & C_9_fu_633_p3);
assign and_ln126_4_fu_778_p2 = (temp_4_reg_976 & or_ln126_5_fu_774_p2);
assign and_ln126_5_fu_783_p2 = (E_9_reg_1033 & C_9_reg_1026);
...
assign icmp_ln124_fu_358_p2 = ((ap_sig_allocacmp_i == 6'd60) ? 1'b1 : 1'b0);
...
assign or_ln126_3_fu_639_p2 = (E_6_load_1_reg_964 | C_9_fu_633_p3);
assign or_ln126_4_fu_654_p2 = (and_ln126_3_fu_649_p2 | and_ln126_2_fu_644_p2);
assign or_ln126_5_fu_774_p2 = (E_9_reg_1033 | C_9_reg_1026);
