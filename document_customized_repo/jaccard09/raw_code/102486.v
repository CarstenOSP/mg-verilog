...
wire   [3:0] lshr_ln5_3_fu_343_p4;
reg   [3:0] lshr_ln5_3_reg_432;
reg   [3:0] lshr_ln5_3_reg_432_pp0_iter2_reg;
reg   [3:0] lshr_ln5_3_reg_432_pp0_iter3_reg;
reg   [3:0] lshr_ln5_3_reg_432_pp0_iter4_reg;
...
fadd_32ns_32ns_32_7_full_dsp_1_U15(.clk(ap_clk),.reset(ap_rst),.din0(buff_s_out_1_load_reg_524),.din1(mul_1_reg_509),.ce(1'b1),.dout(grp_fu_211_p2));
bicg_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U16(.clk(ap_clk),.reset(ap_rst),.din0(buff_s_out_2_load_reg_529),.din1(mul_2_reg_514),.ce(1'b1),.dout(grp_fu_215_p2));
bicg_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U17(.clk(ap_clk),.reset(ap_rst),.din0(buff_s_out_3_load_reg_534),.din1(mul_3_reg_519),.ce(1'b1),.dout(grp_fu_219_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U19(.clk(ap_clk),.reset(ap_rst),.din0(buff_A_1_load_reg_460),.din1(buff_r_load_reg_447),.ce(1'b1),.dout(grp_fu_227_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U20(.clk(ap_clk),.reset(ap_rst),.din0(buff_A_load_1_reg_465),.din1(buff_r_load_reg_447),.ce(1'b1),.dout(grp_fu_231_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U21(.clk(ap_clk),.reset(ap_rst),.din0(buff_A_1_load_1_reg_470),.din1(buff_r_load_reg_447),.ce(1'b1),.dout(grp_fu_235_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        add_reg_539 <= grp_fu_143_p_dout0;
        ...
        lshr_ln5_3_reg_432_pp0_iter2_reg <= lshr_ln5_3_reg_432;
        lshr_ln5_3_reg_432_pp0_iter3_reg <= lshr_ln5_3_reg_432_pp0_iter2_reg;
        lshr_ln5_3_reg_432_pp0_iter4_reg <= lshr_ln5_3_reg_432_pp0_iter3_reg;
        mul_1_reg_509 <= grp_fu_227_p2;
        mul_2_reg_514 <= grp_fu_231_p2;
        mul_3_reg_519 <= grp_fu_235_p2;
        mul_reg_504 <= grp_fu_147_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln5_3_reg_432 <= {{select_ln5_fu_294_p3[5:2]}};
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_143_p_din0 = buff_s_out_load_reg_499;
assign grp_fu_143_p_din1 = mul_reg_504;
assign grp_fu_143_p_opcode = 2'd0;
assign grp_fu_147_p_ce = 1'b1;
assign grp_fu_147_p_din0 = buff_A_load_reg_455;
assign grp_fu_147_p_din1 = buff_r_load_reg_447;
assign icmp_ln23_fu_257_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_319_p4 = {{select_ln5_fu_294_p3[5:1]}};
assign lshr_ln5_3_fu_343_p4 = {{select_ln5_fu_294_p3[5:2]}};
...
assign tmp_2_fu_329_p3 = {{trunc_ln23_fu_310_p1}, {lshr_ln5_2_fu_319_p4}};
assign tmp_4_fu_353_p4 = {{{trunc_ln23_fu_310_p1}, {lshr_ln5_3_fu_343_p4}}, {1'd1}};
...
assign zext_ln5_fu_385_p1 = lshr_ln5_3_reg_432_pp0_iter4_reg;
endmodule 