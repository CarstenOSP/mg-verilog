...
wire   [31:0] tmp_3_fu_676_p11;
reg   [31:0] tmp_3_reg_908;
wire   [31:0] tmp_4_fu_699_p11;
...
reg   [31:0] tmp_2_reg_966;
reg   [31:0] mul_reg_971;
wire   [31:0] grp_fu_482_p2;
reg   [31:0] mul_1_reg_976;
wire   [31:0] tmp_5_fu_756_p11;
reg   [31:0] tmp_5_reg_981;
...
wire   [8:0] tmp_8_fu_601_p3;
wire   [31:0] tmp_fu_637_p17;
wire   [31:0] tmp_3_fu_676_p9;
wire   [31:0] tmp_4_fu_699_p9;
wire   [31:0] tmp_2_fu_733_p9;
wire   [31:0] tmp_5_fu_756_p9;
reg    ap_done_reg;
...
wire   [2:0] tmp_3_fu_676_p1;
wire   [2:0] tmp_3_fu_676_p3;
wire  signed [2:0] tmp_3_fu_676_p5;
wire  signed [2:0] tmp_3_fu_676_p7;
wire   [2:0] tmp_4_fu_699_p1;
wire   [2:0] tmp_4_fu_699_p3;
wire  signed [2:0] tmp_4_fu_699_p5;
wire  signed [2:0] tmp_4_fu_699_p7;
wire   [2:0] tmp_2_fu_733_p1;
wire   [2:0] tmp_2_fu_733_p3;
wire  signed [2:0] tmp_2_fu_733_p5;
wire  signed [2:0] tmp_2_fu_733_p7;
wire   [2:0] tmp_5_fu_756_p1;
wire   [2:0] tmp_5_fu_756_p3;
wire  signed [2:0] tmp_5_fu_756_p5;
wire  signed [2:0] tmp_5_fu_756_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
fadd_32ns_32ns_32_7_full_dsp_1_U19(.clk(ap_clk),.reset(ap_rst),.din0(tmp_5_reg_981),.din1(mul_1_reg_976),.ce(1'b1),.dout(grp_fu_474_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U21(.clk(ap_clk),.reset(ap_rst),.din0(tmp_4_reg_913),.din1(tmp_reg_902),.ce(1'b1),.dout(grp_fu_482_p2));
...
sparsemux_9_3_32_1_1_U23(.din0(buff_A_q0),.din1(buff_A_2_q0),.din2(buff_A_4_q0),.din3(buff_A_6_q0),.def(tmp_3_fu_676_p9),.sel(trunc_ln24_reg_849),.dout(tmp_3_fu_676_p11));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U24(.din0(buff_A_1_q0),.din1(buff_A_3_q0),.din2(buff_A_5_q0),.din3(buff_A_7_q0),.def(tmp_4_fu_699_p9),.sel(trunc_ln24_reg_849),.dout(tmp_4_fu_699_p11));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U25(.din0(buff_s_out_q1),.din1(buff_s_out_2_q1),.din2(buff_s_out_4_q1),.din3(buff_s_out_6_q1),.def(tmp_2_fu_733_p9),.sel(trunc_ln24_reg_849_pp0_iter5_reg),.dout(tmp_2_fu_733_p11));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U26(.din0(buff_s_out_1_q1),.din1(buff_s_out_3_q1),.din2(buff_s_out_5_q1),.din3(buff_s_out_7_q1),.def(tmp_5_fu_756_p9),.sel(trunc_ln24_reg_849_pp0_iter5_reg),.dout(tmp_5_fu_756_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_1_reg_994 <= grp_fu_474_p2;
        add_reg_986 <= grp_fu_934_p_dout0;
        ...
        buff_s_out_1_addr_reg_942 <= zext_ln5_fu_722_p1;
        ...
        buff_s_out_2_addr_reg_924 <= zext_ln5_fu_722_p1;
        ...
        buff_s_out_3_addr_reg_948 <= zext_ln5_fu_722_p1;
        ...
        buff_s_out_4_addr_reg_930 <= zext_ln5_fu_722_p1;
        ...
        buff_s_out_5_addr_reg_954 <= zext_ln5_fu_722_p1;
        ...
        buff_s_out_6_addr_reg_936 <= zext_ln5_fu_722_p1;
        ...
        buff_s_out_7_addr_reg_960 <= zext_ln5_fu_722_p1;
        ...
        buff_s_out_addr_reg_918 <= zext_ln5_fu_722_p1;
        ...
        mul_1_reg_976 <= grp_fu_482_p2;
        mul_reg_971 <= grp_fu_938_p_dout0;
        tmp_2_reg_966 <= tmp_2_fu_733_p11;
        tmp_3_reg_908 <= tmp_3_fu_676_p11;
        tmp_4_reg_913 <= tmp_4_fu_699_p11;
        tmp_5_reg_981 <= tmp_5_fu_756_p11;
...
assign buff_r_1_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_1_ce0 = buff_r_1_ce0_local;
assign buff_r_2_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_2_ce0 = buff_r_2_ce0_local;
assign buff_r_3_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_3_ce0 = buff_r_3_ce0_local;
assign buff_r_4_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_4_ce0 = buff_r_4_ce0_local;
assign buff_r_5_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_5_ce0 = buff_r_5_ce0_local;
assign buff_r_6_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_6_ce0 = buff_r_6_ce0_local;
assign buff_r_7_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_7_ce0 = buff_r_7_ce0_local;
assign buff_r_address0 = zext_ln5_1_fu_575_p1;
assign buff_r_ce0 = buff_r_ce0_local;
assign buff_s_out_1_address0 = buff_s_out_1_addr_reg_942_pp0_iter13_reg;
assign buff_s_out_1_address1 = zext_ln5_fu_722_p1;
...
assign buff_s_out_2_address1 = zext_ln5_fu_722_p1;
...
assign buff_s_out_3_address1 = zext_ln5_fu_722_p1;
...
assign buff_s_out_4_address1 = zext_ln5_fu_722_p1;
...
assign buff_s_out_5_address1 = zext_ln5_fu_722_p1;
...
assign buff_s_out_6_address1 = zext_ln5_fu_722_p1;
...
assign buff_s_out_7_address1 = zext_ln5_fu_722_p1;
...
assign buff_s_out_address1 = zext_ln5_fu_722_p1;
...
assign grp_fu_934_p_din0 = tmp_2_reg_966;
assign grp_fu_934_p_din1 = mul_reg_971;
assign grp_fu_934_p_opcode = 2'd0;
assign grp_fu_938_p_ce = 1'b1;
assign grp_fu_938_p_din0 = tmp_3_reg_908;
assign grp_fu_938_p_din1 = tmp_reg_902;
...
assign tmp_2_fu_733_p9 = 'bx;
assign tmp_3_fu_676_p9 = 'bx;
assign tmp_4_fu_699_p9 = 'bx;
assign tmp_5_fu_756_p9 = 'bx;
assign tmp_8_fu_601_p3 = {{trunc_ln23_fu_557_p1}, {lshr_ln5_3_fu_591_p4}};
...
assign zext_ln25_fu_609_p1 = tmp_8_fu_601_p3;
assign zext_ln5_1_fu_575_p1 = lshr_ln5_1_fu_565_p4;
assign zext_ln5_fu_722_p1 = lshr_ln5_3_reg_857_pp0_iter4_reg;
endmodule 