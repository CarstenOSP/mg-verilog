...
wire   [31:0] tmp_2_fu_197_p11;
reg   [31:0] tmp_2_reg_272;
...
wire   [31:0] tmp_2_fu_197_p9;
wire   [1:0] tmp_2_fu_197_p10;
reg    ap_done_reg;
...
wire   [1:0] tmp_2_fu_197_p3;
wire  signed [1:0] tmp_2_fu_197_p5;
wire  signed [1:0] tmp_2_fu_197_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U984(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.def(tmp_2_fu_197_p9),.sel(tmp_2_fu_197_p10),.dout(tmp_2_fu_197_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_272 <= tmp_2_fu_197_p11;
    end
end
always @ (*) begin
...
assign bitcast_ln37_fu_226_p1 = tmp_2_reg_272;
...
assign tmp_2_fu_197_p10 = i_1_reg_237[1:0];
assign tmp_2_fu_197_p9 = 'bx;
