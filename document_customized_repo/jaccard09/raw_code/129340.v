...
output  [31:0] tmp1_d0;
input  [31:0] tmp1_q0;
output  [31:0] grp_fu_2413_p_din0;
output  [31:0] grp_fu_2413_p_din1;
output  [1:0] grp_fu_2413_p_opcode;
input  [31:0] grp_fu_2413_p_dout0;
output   grp_fu_2413_p_ce;
output  [31:0] grp_fu_2417_p_din0;
output  [31:0] grp_fu_2417_p_din1;
input  [31:0] grp_fu_2417_p_dout0;
output   grp_fu_2417_p_ce;
reg ap_idle;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add_reg_354 <= grp_fu_2413_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        mul3_reg_329 <= grp_fu_2417_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul_reg_344 <= grp_fu_2417_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_2413_p_din0 = add16_fu_58;
assign grp_fu_2413_p_din1 = mul3_reg_329;
assign grp_fu_2413_p_opcode = 2'd0;
assign grp_fu_2417_p_ce = 1'b1;
assign grp_fu_2417_p_din0 = grp_fu_110_p0;
assign grp_fu_2417_p_din1 = grp_fu_110_p1;
