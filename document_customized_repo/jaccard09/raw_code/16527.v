...
wire   [0:0] icmp_ln58_1_fu_208_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [5:0] sbox_0_address0;
wire   [7:0] sbox_0_q0;
wire   [5:0] sbox_1_address0;
wire   [7:0] sbox_1_q0;
wire   [5:0] sbox_2_address0;
wire   [7:0] sbox_2_q0;
wire   [5:0] sbox_3_address0;
wire   [7:0] sbox_3_q0;
...
wire   [1:0] trunc_ln58_2_fu_270_p1;
reg   [1:0] trunc_ln58_2_reg_359;
wire   [63:0] zext_ln58_fu_234_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln58_2_fu_284_p1;
reg   [4:0] i_fu_76;
...
wire   [1:0] lshr_ln58_2_fu_224_p4;
wire   [7:0] tmp_1_fu_247_p9;
wire   [7:0] tmp_1_fu_247_p11;
wire   [5:0] lshr_ln58_3_fu_274_p4;
wire   [7:0] tmp_2_fu_292_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_1_fu_247_p1;
wire  signed [1:0] tmp_1_fu_247_p3;
wire  signed [1:0] tmp_1_fu_247_p5;
wire   [1:0] tmp_1_fu_247_p7;
wire   [1:0] tmp_2_fu_292_p1;
wire   [1:0] tmp_2_fu_292_p3;
wire  signed [1:0] tmp_2_fu_292_p5;
wire  signed [1:0] tmp_2_fu_292_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_8_1_1_x_U38(.din0(buf_0_q1),.din1(buf_1_q1),.din2(buf_2_q1),.din3(buf_3_q1),.def(tmp_1_fu_247_p9),.sel(trunc_ln58_reg_330),.dout(tmp_1_fu_247_p11));
...
sparsemux_9_2_8_1_1_U39(.din0(sbox_0_q0),.din1(sbox_1_q0),.din2(sbox_2_q0),.din3(sbox_3_q0),.def(tmp_2_fu_292_p9),.sel(trunc_ln58_2_reg_359),.dout(tmp_2_fu_292_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln58_1_fu_208_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln58_2_reg_359 <= trunc_ln58_2_fu_270_p1;
        trunc_ln58_reg_330 <= trunc_ln58_fu_214_p1;
        trunc_ln58_reg_330_pp0_iter1_reg <= trunc_ln58_reg_330;
    end
end
always @ (*) begin
    if (((icmp_ln58_1_fu_208_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln58_fu_218_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(5'd31));
...
assign buf_0_d0 = tmp_2_fu_292_p11;
...
assign buf_1_d0 = tmp_2_fu_292_p11;
...
assign buf_2_d0 = tmp_2_fu_292_p11;
...
assign buf_3_d0 = tmp_2_fu_292_p11;
assign buf_3_we0 = buf_3_we0_local;
assign icmp_ln58_1_fu_208_p2 = ((ap_sig_allocacmp_i_4 == 5'd0) ? 1'b1 : 1'b0);
assign lshr_ln58_2_fu_224_p4 = {{add_ln58_fu_218_p2[3:2]}};
assign lshr_ln58_3_fu_274_p4 = {{tmp_1_fu_247_p11[7:2]}};
assign sbox_0_address0 = zext_ln58_2_fu_284_p1;
assign sbox_1_address0 = zext_ln58_2_fu_284_p1;
assign sbox_2_address0 = zext_ln58_2_fu_284_p1;
assign sbox_3_address0 = zext_ln58_2_fu_284_p1;
assign tmp_1_fu_247_p9 = 'bx;
assign tmp_2_fu_292_p9 = 'bx;
assign trunc_ln58_2_fu_270_p1 = tmp_1_fu_247_p11[1:0];
assign trunc_ln58_fu_214_p1 = ap_sig_allocacmp_i_4[1:0];
assign zext_ln58_2_fu_284_p1 = lshr_ln58_3_fu_274_p4;
assign zext_ln58_fu_234_p1 = lshr_ln58_2_fu_224_p4;
endmodule 