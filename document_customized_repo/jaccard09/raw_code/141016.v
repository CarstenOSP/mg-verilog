...
wire   [31:0] tmp_2_fu_242_p19;
reg   [31:0] tmp_2_reg_341;
...
wire   [2:0] lshr_ln5_3_fu_215_p4;
wire   [31:0] tmp_2_fu_242_p17;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_2_fu_242_p1;
wire   [2:0] tmp_2_fu_242_p3;
wire   [2:0] tmp_2_fu_242_p5;
wire   [2:0] tmp_2_fu_242_p7;
wire  signed [2:0] tmp_2_fu_242_p9;
wire  signed [2:0] tmp_2_fu_242_p11;
wire  signed [2:0] tmp_2_fu_242_p13;
wire  signed [2:0] tmp_2_fu_242_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U46(.din0(buff_y_out_q0),.din1(buff_y_out_1_q0),.din2(buff_y_out_2_q0),.din3(buff_y_out_3_q0),.din4(buff_y_out_4_q0),.din5(buff_y_out_5_q0),.din6(buff_y_out_6_q0),.din7(buff_y_out_7_q0),.def(tmp_2_fu_242_p17),.sel(trunc_ln32_reg_296),.dout(tmp_2_fu_242_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_341 <= tmp_2_fu_242_p19;
...
assign bitcast_ln33_fu_281_p1 = tmp_2_reg_341;
...
assign lshr_ln5_3_fu_215_p4 = {{ap_sig_allocacmp_i_1[5:3]}};
assign tmp_2_fu_242_p17 = 'bx;
...
assign zext_ln5_fu_225_p1 = lshr_ln5_3_fu_215_p4;
endmodule 