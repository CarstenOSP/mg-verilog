...
dmul_64ns_64ns_64_7_max_dsp_1_U755(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_779_p0),.din1(grp_fu_779_p1),.ce(1'b1),.dout(grp_fu_779_p2));
...
sparsemux_129_6_64_1_1_U756(.din0(p_reload329),.din1(p_reload328),.din2(p_reload327),.din3(p_reload326),.din4(p_reload325),.din5(p_reload324),.din6(p_reload323),.din7(p_reload322),.din8(p_reload321),.din9(p_reload320),.din10(p_reload319),.din11(p_reload318),.din12(p_reload317),.din13(p_reload316),.din14(p_reload315),.din15(p_reload314),.din16(p_reload313),.din17(p_reload312),.din18(p_reload311),.din19(p_reload310),.din20(p_reload309),.din21(p_reload308),.din22(p_reload307),.din23(p_reload306),.din24(p_reload305),.din25(p_reload304),.din26(p_reload303),.din27(p_reload302),.din28(p_reload301),.din29(p_reload300),.din30(p_reload299),.din31(p_reload298),.din32(p_reload297),.din33(p_reload296),.din34(p_reload295),.din35(p_reload294),.din36(p_reload293),.din37(p_reload292),.din38(p_reload291),.din39(p_reload290),.din40(p_reload289),.din41(p_reload288),.din42(p_reload287),.din43(p_reload286),.din44(p_reload285),.din45(p_reload284),.din46(p_reload283),.din47(p_reload282),.din48(p_reload281),.din49(p_reload280),.din50(p_reload279),.din51(p_reload278),.din52(p_reload277),.din53(p_reload276),.din54(p_reload275),.din55(p_reload274),.din56(p_reload273),.din57(p_reload272),.din58(p_reload271),.din59(p_reload270),.din60(p_reload269),.din61(p_reload268),.din62(p_reload267),.din63(p_reload),.def(v162_fu_835_p129),.sel(v162_fu_835_p130),.dout(v162_fu_835_p131));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U757(.din0(v164_fu_1120_p2),.din1(v164_fu_1120_p4),.din2(v164_fu_1120_p6),.din3(v164_fu_1120_p8),.def(v164_fu_1120_p9),.sel(trunc_ln264_reg_1182),.dout(v164_fu_1120_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v159_fu_324 <= grp_fu_3224_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v165_reg_1222 <= grp_fu_3224_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_v159_load_1 = grp_fu_3224_p_dout0;
    end else begin
...
assign grp_fu_3224_p_din0 = grp_fu_775_p0;
assign grp_fu_3224_p_din1 = grp_fu_775_p1;
assign grp_fu_3224_p_opcode = grp_fu_775_opcode;
assign icmp_ln264_fu_797_p2 = ((ap_sig_allocacmp_v160_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln1_fu_817_p4 = {{ap_sig_allocacmp_v160_1[5:2]}};
...
assign zext_ln265_fu_827_p1 = lshr_ln1_fu_817_p4;
endmodule 