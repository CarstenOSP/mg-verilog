module sha_stream_sha_transform_Pipeline_trans_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_76_reload,B_6_reload,C_76_reload,D_77_reload,E_6_reload,W_36_load_1,W_20_load_1,W_37_load_1,W_21_load_1,W_38_load_1,W_22_load_1,W_39_load_1,W_23_load_1,W_40_load_1,W_24_load_1,W_41_load_1,W_25_load_1,W_42_load_1,W_26_load_1,W_43_load_1,W_27_load_1,W_44_load_1,W_28_load_1,W_45_load_1,W_29_load_1,W_46_load_1,W_30_load_1,W_47_load_1,W_31_load_1,W_48_load_1,W_32_load_1,W_49_load_1,W_33_load_1,W_50_load_1,W_34_load_1,W_51_load_1,W_35_load_1,E_23_out,E_23_out_ap_vld,B_23_out,B_23_out_ap_vld,D_78_out,D_78_out_ap_vld,A_77_out,A_77_out_ap_vld,C_77_out,C_77_out_ap_vld); 
...
output   ap_idle;
output   ap_ready;
input  [31:0] A_76_reload;
input  [31:0] B_6_reload;
input  [31:0] C_76_reload;
input  [31:0] D_77_reload;
...
output  [31:0] D_78_out;
output   D_78_out_ap_vld;
output  [31:0] A_77_out;
output   A_77_out_ap_vld;
output  [31:0] C_77_out;
output   C_77_out_ap_vld;
reg ap_idle;
reg E_23_out_ap_vld;
reg B_23_out_ap_vld;
reg D_78_out_ap_vld;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln120_reg_1870 == 1'd0) & (1'b0 == ap_block_pp0_stage7_11001) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        C_77_out_ap_vld = 1'b1;
    end else begin
        C_77_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln120_reg_1870 == 1'd0) & (1'b0 == ap_block_pp0_stage7_11001) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        D_78_out_ap_vld = 1'b1;
    end else begin
        D_78_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln120_reg_1870 == 1'd0) & (1'b0 == ap_block_pp0_stage7_11001) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
...
assign A_77_out = temp_3_fu_904_p2;
assign B_23_out = temp_2_reg_2034;
...
assign D_78_out = C_5_reg_2009;
assign E_23_out = C_4_reg_1970;
...
assign lshr_ln2_fu_626_p4 = {{B_1_fu_148[31:27]}};
