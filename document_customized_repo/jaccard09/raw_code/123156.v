...
sparsemux_17_3_32_1_1_U56(.din0(buff_q_out_q0),.din1(buff_q_out_1_q0),.din2(buff_q_out_2_q0),.din3(buff_q_out_3_q0),.din4(buff_q_out_4_q0),.din5(buff_q_out_5_q0),.din6(buff_q_out_6_q0),.din7(buff_q_out_7_q0),.def(tmp_1_fu_576_p17),.sel(trunc_ln29_reg_790),.dout(tmp_1_fu_576_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U57(.din0(buff_p_q0),.din1(buff_p_1_q0),.din2(buff_p_2_q0),.din3(buff_p_3_q0),.din4(buff_p_4_q0),.din5(buff_p_5_q0),.din6(buff_p_6_q0),.din7(buff_p_7_q0),.def(tmp_3_fu_636_p17),.sel(tmp_3_fu_636_p18),.dout(tmp_3_fu_636_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U58(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.din4(buff_A_4_q0),.din5(buff_A_5_q0),.din6(buff_A_6_q0),.din7(buff_A_7_q0),.def(tmp_2_fu_692_p17),.sel(trunc_ln30_reg_885),.dout(tmp_2_fu_692_p19));
...
assign grp_fu_938_p_din0 = tmp_2_reg_939;
assign grp_fu_938_p_din1 = tmp_3_reg_930;
