...
reg   [0:0] first_iter_1_reg_505;
wire   [1:0] trunc_ln29_fu_345_p1;
reg   [1:0] trunc_ln29_reg_509;
reg   [1:0] trunc_ln29_reg_509_pp0_iter1_reg;
reg   [3:0] buff_q_out_addr_reg_514;
reg   [3:0] buff_q_out_addr_reg_514_pp0_iter1_reg;
reg   [3:0] buff_q_out_1_addr_reg_519;
reg   [3:0] buff_q_out_1_addr_reg_519_pp0_iter1_reg;
reg   [3:0] buff_q_out_2_addr_reg_524;
reg   [3:0] buff_q_out_2_addr_reg_524_pp0_iter1_reg;
reg   [3:0] buff_q_out_3_addr_reg_529;
reg   [3:0] buff_q_out_3_addr_reg_529_pp0_iter1_reg;
wire   [3:0] lshr_ln5_6_fu_367_p4;
reg   [3:0] lshr_ln5_6_reg_534;
wire   [31:0] tmp_1_fu_395_p11;
reg   [31:0] tmp_1_reg_559;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] buff_p_load_reg_584;
reg   [31:0] buff_p_1_load_reg_589;
reg   [31:0] buff_p_2_load_reg_594;
reg   [31:0] buff_p_3_load_reg_599;
...
reg   [31:0] mul61_1_reg_634;
reg   [31:0] mul61_2_reg_639;
wire    ap_CS_fsm_pp0_stage8;
wire    ap_block_pp0_stage8_11001;
reg   [31:0] mul61_3_reg_644;
wire    ap_CS_fsm_pp0_stage9;
wire    ap_block_pp0_stage9_11001;
reg   [0:0] tmp_2_reg_649;
wire    ap_block_pp0_stage28_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln5_fu_359_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln5_1_fu_377_p1;
wire   [63:0] zext_ln31_fu_424_p1;
wire    ap_block_pp0_stage1;
reg   [6:0] j_fu_80;
wire   [6:0] add_ln30_fu_440_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_fu_84;
wire   [6:0] select_ln29_fu_327_p3;
reg   [6:0] ap_sig_allocacmp_i_load;
reg   [10:0] indvar_flatten7_fu_88;
wire   [10:0] add_ln29_1_fu_293_p2;
...
sparsemux_9_2_32_1_1_U30(.din0(buff_q_out_q0),.din1(buff_q_out_1_q0),.din2(buff_q_out_2_q0),.din3(buff_q_out_3_q0),.def(tmp_1_fu_395_p9),.sel(trunc_ln29_reg_509),.dout(tmp_1_fu_395_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_80 <= 7'd0;
    end else if (((icmp_ln29_reg_491 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_fu_80 <= add_ln30_fu_440_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_p_1_load_reg_589 <= buff_p_1_q0;
        buff_p_2_load_reg_594 <= buff_p_2_q0;
        buff_p_3_load_reg_599 <= buff_p_3_q0;
        buff_p_load_reg_584 <= buff_p_q0;
        tmp_1_reg_559 <= tmp_1_fu_395_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        buff_q_out_1_addr_reg_519 <= zext_ln5_fu_359_p1;
        buff_q_out_1_addr_reg_519_pp0_iter1_reg <= buff_q_out_1_addr_reg_519;
        buff_q_out_2_addr_reg_524 <= zext_ln5_fu_359_p1;
        buff_q_out_2_addr_reg_524_pp0_iter1_reg <= buff_q_out_2_addr_reg_524;
        buff_q_out_3_addr_reg_529 <= zext_ln5_fu_359_p1;
        buff_q_out_3_addr_reg_529_pp0_iter1_reg <= buff_q_out_3_addr_reg_529;
        buff_q_out_addr_reg_514 <= zext_ln5_fu_359_p1;
        buff_q_out_addr_reg_514_pp0_iter1_reg <= buff_q_out_addr_reg_514;
        empty_12_reg_500 <= empty_12_fu_335_p1;
        first_iter_1_reg_505 <= first_iter_1_fu_339_p2;
        icmp_ln29_reg_491 <= icmp_ln29_fu_287_p2;
        lshr_ln5_6_reg_534 <= {{select_ln5_fu_319_p3[5:2]}};
        select_ln5_reg_495 <= select_ln5_fu_319_p3;
        trunc_ln29_reg_509 <= trunc_ln29_fu_345_p1;
        trunc_ln29_reg_509_pp0_iter1_reg <= trunc_ln29_reg_509;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul1_reg_624 <= grp_fu_575_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul61_1_reg_634 <= grp_fu_575_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        mul61_2_reg_639 <= grp_fu_575_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        mul61_3_reg_644 <= grp_fu_575_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_2_reg_649 <= add_ln30_fu_440_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln29_reg_491 == 1'd1) & (1'b0 == ap_block_pp0_stage6_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_q_out_1_address0_local = buff_q_out_1_addr_reg_519_pp0_iter1_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_649 == 1'd1) & (trunc_ln29_reg_509_pp0_iter1_reg == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_q_out_2_address0_local = buff_q_out_2_addr_reg_524_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_649 == 1'd1) & (trunc_ln29_reg_509_pp0_iter1_reg == 2'd2) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_q_out_3_address0_local = buff_q_out_3_addr_reg_529_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_649 == 1'd1) & (trunc_ln29_reg_509_pp0_iter1_reg == 2'd3) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_q_out_address0_local = buff_q_out_addr_reg_514_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_649 == 1'd1) & (trunc_ln29_reg_509_pp0_iter1_reg == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage28) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
            grp_fu_252_p1 = mul61_3_reg_644;
        end else if (((1'b0 == ap_block_pp0_stage21) & (1'b1 == ap_CS_fsm_pp0_stage21))) begin
            grp_fu_252_p1 = mul61_2_reg_639;
        end else if (((1'b0 == ap_block_pp0_stage14) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
            grp_fu_252_p1 = mul61_1_reg_634;
        end else if (((1'b0 == ap_block_pp0_stage7) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
            grp_fu_252_p1 = mul1_reg_624;
        end else begin
            grp_fu_252_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
            grp_fu_256_p1 = buff_p_3_load_reg_599;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_256_p1 = buff_p_2_load_reg_594;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_256_p1 = buff_p_1_load_reg_589;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_256_p1 = buff_p_load_reg_584;
        end else begin
            grp_fu_256_p1 = 'bx;
        end
    end else begin
...
assign add_ln29_1_fu_293_p2 = (ap_sig_allocacmp_indvar_flatten7_load + 11'd1);
assign add_ln29_fu_305_p2 = (ap_sig_allocacmp_i_load + 7'd1);
assign add_ln30_fu_440_p2 = (select_ln5_reg_495 + 7'd4);
...
always @ (*) begin
    ap_condition_780 = ((icmp_ln29_reg_491 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_505 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage6;
assign ap_ready = ap_ready_sig;
assign buff_A_1_address0 = zext_ln31_fu_424_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_2_address0 = zext_ln31_fu_424_p1;
assign buff_A_2_ce0 = buff_A_2_ce0_local;
assign buff_A_3_address0 = zext_ln31_fu_424_p1;
assign buff_A_3_ce0 = buff_A_3_ce0_local;
assign buff_A_address0 = zext_ln31_fu_424_p1;
...
assign icmp_ln29_fu_287_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 11'd1024) ? 1'b1 : 1'b0);
