...
wire   [4:0] lshr_ln6_3_fu_180_p4;
reg   [4:0] lshr_ln6_3_reg_260;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        lshr_ln6_3_reg_260 <= {{ap_sig_allocacmp_j_1[5:1]}};
    end
end
always @ (*) begin
...
assign lshr_ln6_3_fu_180_p4 = {{ap_sig_allocacmp_j_1[5:1]}};
assign tmp_1_fu_172_p3 = ap_sig_allocacmp_j_1[32'd6];
assign tmp_2_fu_215_p3 = {{lshr_ln6}, {lshr_ln6_3_reg_260}};
assign tmp_reg_248 = empty;
assign tmp_s_fu_190_p3 = {{i}, {lshr_ln6_3_fu_180_p4}};
