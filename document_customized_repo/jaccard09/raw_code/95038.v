...
buff_A_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_A_address0),.ce0(buff_A_ce0),.we0(buff_A_we0),.d0(grp_atax_Pipeline_lprd_2_fu_197_buff_A_d0),.q0(buff_A_q0));
atax_buff_A_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 2048 ),.AddressWidth( 11 ))
buff_A_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_A_1_address0),.ce0(buff_A_1_ce0),.we0(buff_A_1_we0),.d0(grp_atax_Pipeline_lprd_2_fu_197_buff_A_1_d0),.q0(buff_A_1_q0));
...
buff_y_out_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_y_out_address0),.ce0(buff_y_out_ce0),.we0(buff_y_out_we0),.d0(buff_y_out_d0),.q0(buff_y_out_q0),.address1(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_address1),.ce1(buff_y_out_ce1),.q1(buff_y_out_q1));
atax_buff_y_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 32 ),.AddressWidth( 5 ))
buff_y_out_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_y_out_1_address0),.ce0(buff_y_out_1_ce0),.we0(buff_y_out_1_we0),.d0(buff_y_out_1_d0),.q0(buff_y_out_1_q0),.address1(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_1_address1),.ce1(buff_y_out_1_ce1),.q1(buff_y_out_1_q1));
atax_buff_x_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 32 ),.AddressWidth( 5 ))
...
atax_atax_Pipeline_lp3_lp4 grp_atax_Pipeline_lp3_lp4_fu_208(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_atax_Pipeline_lp3_lp4_fu_208_ap_start),.ap_done(grp_atax_Pipeline_lp3_lp4_fu_208_ap_done),.ap_idle(grp_atax_Pipeline_lp3_lp4_fu_208_ap_idle),.ap_ready(grp_atax_Pipeline_lp3_lp4_fu_208_ap_ready),.tmp1_address0(grp_atax_Pipeline_lp3_lp4_fu_208_tmp1_address0),.tmp1_ce0(grp_atax_Pipeline_lp3_lp4_fu_208_tmp1_ce0),.tmp1_q0(tmp1_q0),.tmp1_1_address0(grp_atax_Pipeline_lp3_lp4_fu_208_tmp1_1_address0),.tmp1_1_ce0(grp_atax_Pipeline_lp3_lp4_fu_208_tmp1_1_ce0),.tmp1_1_q0(tmp1_1_q0),.buff_A_address0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_A_address0),.buff_A_ce0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_A_ce0),.buff_A_q0(buff_A_q0),.buff_A_1_address0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_A_1_address0),.buff_A_1_ce0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_A_1_ce0),.buff_A_1_q0(buff_A_1_q0),.buff_y_out_address0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_address0),.buff_y_out_ce0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_ce0),.buff_y_out_we0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_we0),.buff_y_out_d0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_d0),.buff_y_out_address1(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_address1),.buff_y_out_ce1(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_ce1),.buff_y_out_q1(buff_y_out_q1),.buff_y_out_1_address0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_1_address0),.buff_y_out_1_ce0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_1_ce0),.buff_y_out_1_we0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_1_we0),.buff_y_out_1_d0(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_1_d0),.buff_y_out_1_address1(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_1_address1),.buff_y_out_1_ce1(grp_atax_Pipeline_lp3_lp4_fu_208_buff_y_out_1_ce1),.buff_y_out_1_q1(buff_y_out_1_q1),.grp_fu_318_p_din0(grp_atax_Pipeline_lp3_lp4_fu_208_grp_fu_318_p_din0),.grp_fu_318_p_din1(grp_atax_Pipeline_lp3_lp4_fu_208_grp_fu_318_p_din1),.grp_fu_318_p_opcode(grp_atax_Pipeline_lp3_lp4_fu_208_grp_fu_318_p_opcode),.grp_fu_318_p_dout0(grp_fu_318_p2),.grp_fu_318_p_ce(grp_atax_Pipeline_lp3_lp4_fu_208_grp_fu_318_p_ce),.grp_fu_322_p_din0(grp_atax_Pipeline_lp3_lp4_fu_208_grp_fu_322_p_din0),.grp_fu_322_p_din1(grp_atax_Pipeline_lp3_lp4_fu_208_grp_fu_322_p_din1),.grp_fu_322_p_dout0(grp_fu_322_p2),.grp_fu_322_p_ce(grp_atax_Pipeline_lp3_lp4_fu_208_grp_fu_322_p_ce));
...
fadd_32ns_32ns_32_7_full_dsp_1_U25(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_318_p0),.din1(grp_fu_318_p1),.ce(grp_fu_318_ce),.dout(grp_fu_318_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U26(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_322_p0),.din1(grp_fu_322_p1),.ce(grp_fu_322_ce),.dout(grp_fu_322_p2));
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_atax_Pipeline_lprd_2_fu_197_ap_done == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end
