...
dmul_64ns_64ns_64_7_max_dsp_1_U1306(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1242_p0),.din1(grp_fu_1242_p1),.ce(1'b1),.dout(grp_fu_1242_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U1307(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1246_p0),.din1(grp_fu_1246_p1),.ce(1'b1),.dout(grp_fu_1246_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U1308(.clk(ap_clk),.reset(ap_rst),.din0(reg_1350),.din1(v138_reg_3863),.ce(1'b1),.dout(grp_fu_1250_p2));
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter16 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7) & (1'b0 == ap_block_pp0_stage7_11001))) begin
        v136_126_reg_3868 <= grp_fu_5016_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_5012_p_din0 = grp_fu_1233_p0;
assign grp_fu_5012_p_din1 = grp_fu_1233_p1;
assign grp_fu_5012_p_opcode = 2'd0;
assign grp_fu_5016_p_ce = 1'b1;
assign grp_fu_5016_p_din0 = grp_fu_1238_p0;
assign grp_fu_5016_p_din1 = grp_fu_1238_p1;
