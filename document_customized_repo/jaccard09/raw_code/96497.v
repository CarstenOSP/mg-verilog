...
wire   [0:0] first_iter_1_fu_416_p2;
reg   [0:0] first_iter_1_reg_611;
wire   [3:0] lshr_ln6_1_fu_422_p4;
reg   [3:0] lshr_ln6_1_reg_615;
wire   [2:0] tmp_3_fu_440_p4;
reg   [2:0] tmp_3_reg_640;
reg   [5:0] tmp1_addr_reg_665;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] tmp1_addr_reg_665_pp0_iter1_reg;
...
reg   [31:0] arrayidx45_promoted_reg_750;
reg   [31:0] buff_A_load_reg_755;
reg   [31:0] buff_A_1_load_reg_760;
reg   [31:0] buff_A_2_load_reg_765;
reg   [31:0] buff_A_3_load_reg_770;
reg   [31:0] buff_A_load_1_reg_775;
reg   [31:0] buff_A_1_load_1_reg_780;
reg   [31:0] buff_A_2_load_1_reg_785;
reg   [31:0] buff_A_3_load_1_reg_790;
reg   [31:0] mul43_7_reg_800;
wire    ap_CS_fsm_pp0_stage21;
wire    ap_block_pp0_stage21_11001;
reg   [0:0] tmp_5_reg_805;
wire    ap_block_pp0_stage56_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln6_fu_432_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln27_fu_458_p1;
wire   [63:0] zext_ln25_fu_491_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln27_1_fu_503_p1;
wire   [63:0] zext_ln27_2_fu_520_p1;
reg   [6:0] j_fu_76;
wire   [6:0] add_ln26_fu_541_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_1_fu_80;
wire   [6:0] select_ln25_fu_480_p3;
reg   [9:0] indvar_flatten8_fu_84;
wire   [9:0] add_ln25_1_fu_391_p2;
reg   [9:0] ap_sig_allocacmp_indvar_flatten8_load;
reg   [31:0] add16_fu_88;
...
wire   [6:0] add_ln25_fu_474_p2;
wire   [5:0] empty_fu_487_p1;
wire   [9:0] tmp_2_fu_496_p3;
wire   [9:0] tmp_4_fu_511_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_1198)) begin
            add16_fu_88 <= arrayidx45_promoted_reg_750;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_1_fu_80 <= 7'd0;
    end else if (((icmp_ln25_reg_597 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_1_fu_80 <= select_ln25_fu_480_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln25_fu_385_p2 == 1'd0))) begin
            indvar_flatten8_fu_84 <= add_ln25_1_fu_391_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten8_fu_84 <= 10'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_76 <= 7'd0;
    end else if (((icmp_ln25_reg_597 == 1'd0) & (1'b0 == ap_block_pp0_stage56_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage56))) begin
        j_fu_76 <= add_ln26_fu_541_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx45_promoted_reg_750 <= tmp1_q0;
        buff_A_1_load_1_reg_780 <= buff_A_1_q0;
        buff_A_1_load_reg_760 <= buff_A_1_q1;
        buff_A_2_load_1_reg_785 <= buff_A_2_q0;
        buff_A_2_load_reg_765 <= buff_A_2_q1;
        buff_A_3_load_1_reg_790 <= buff_A_3_q0;
        buff_A_3_load_reg_770 <= buff_A_3_q1;
        buff_A_load_1_reg_775 <= buff_A_q0;
        buff_A_load_reg_755 <= buff_A_q1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_1_reg_611 <= first_iter_1_fu_416_p2;
        icmp_ln25_reg_597 <= icmp_ln25_fu_385_p2;
        lshr_ln6_1_reg_615 <= {{select_ln6_fu_408_p3[5:2]}};
        select_ln6_reg_606 <= select_ln6_fu_408_p3;
        tmp_3_reg_640 <= {{select_ln6_fu_408_p3[5:3]}};
        tmp_reg_601 <= ap_sig_allocacmp_j_load[32'd6];
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage21_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage21))) begin
        mul43_7_reg_800 <= grp_fu_197_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp1_addr_reg_665 <= zext_ln25_fu_491_p1;
        tmp1_addr_reg_665_pp0_iter1_reg <= tmp1_addr_reg_665;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage56_11001) & (1'b1 == ap_CS_fsm_pp0_stage56))) begin
        tmp_5_reg_805 <= add_ln26_fu_541_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln25_reg_597 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage17) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17))) begin
        ...
        grp_fu_315_p0 = buff_A_3_load_1_reg_790;
    end else if (((1'b0 == ap_block_pp0_stage13) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage13))) begin
        grp_fu_315_p0 = buff_A_2_load_1_reg_785;
    end else if (((1'b0 == ap_block_pp0_stage12) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage12))) begin
        grp_fu_315_p0 = buff_A_1_load_1_reg_780;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        grp_fu_315_p0 = buff_A_load_1_reg_775;
        ...
        grp_fu_315_p0 = buff_A_3_load_reg_770;
    end else if (((1'b0 == ap_block_pp0_stage5) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        grp_fu_315_p0 = buff_A_2_load_reg_765;
    end else if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        grp_fu_315_p0 = buff_A_1_load_reg_760;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_315_p0 = buff_A_load_reg_755;
    end else begin
        grp_fu_315_p0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_address0_local = tmp1_addr_reg_665_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp1_address0_local = zext_ln25_fu_491_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_5_reg_805 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_we0_local = 1'b1;
    end else begin
        tmp1_we0_local = 1'b0;
    end
...
assign add_ln25_1_fu_391_p2 = (ap_sig_allocacmp_indvar_flatten8_load + 10'd1);
assign add_ln25_fu_474_p2 = (i_1_fu_80 + 7'd1);
assign add_ln26_fu_541_p2 = (select_ln6_reg_606 + 7'd8);
...
always @ (*) begin
    ap_condition_1198 = ((icmp_ln25_reg_597 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_611 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_A_1_address0 = zext_ln27_2_fu_520_p1;
assign buff_A_1_address1 = zext_ln27_1_fu_503_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_1_ce1 = buff_A_1_ce1_local;
assign buff_A_2_address0 = zext_ln27_2_fu_520_p1;
assign buff_A_2_address1 = zext_ln27_1_fu_503_p1;
assign buff_A_2_ce0 = buff_A_2_ce0_local;
assign buff_A_2_ce1 = buff_A_2_ce1_local;
assign buff_A_3_address0 = zext_ln27_2_fu_520_p1;
assign buff_A_3_address1 = zext_ln27_1_fu_503_p1;
assign buff_A_3_ce0 = buff_A_3_ce0_local;
assign buff_A_3_ce1 = buff_A_3_ce1_local;
assign buff_A_address0 = zext_ln27_2_fu_520_p1;
assign buff_A_address1 = zext_ln27_1_fu_503_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_A_ce1 = buff_A_ce1_local;
assign buff_x_1_address0 = zext_ln27_fu_458_p1;
assign buff_x_1_address1 = zext_ln6_fu_432_p1;
assign buff_x_1_ce0 = buff_x_1_ce0_local;
assign buff_x_1_ce1 = buff_x_1_ce1_local;
assign buff_x_2_address0 = zext_ln27_fu_458_p1;
assign buff_x_2_address1 = zext_ln6_fu_432_p1;
assign buff_x_2_ce0 = buff_x_2_ce0_local;
assign buff_x_2_ce1 = buff_x_2_ce1_local;
assign buff_x_3_address0 = zext_ln27_fu_458_p1;
assign buff_x_3_address1 = zext_ln6_fu_432_p1;
assign buff_x_3_ce0 = buff_x_3_ce0_local;
assign buff_x_3_ce1 = buff_x_3_ce1_local;
assign buff_x_address0 = zext_ln27_fu_458_p1;
assign buff_x_address1 = zext_ln6_fu_432_p1;
assign buff_x_ce0 = buff_x_ce0_local;
assign buff_x_ce1 = buff_x_ce1_local;
assign empty_fu_487_p1 = select_ln25_fu_480_p3[5:0];
assign first_iter_1_fu_416_p2 = ((select_ln6_fu_408_p3 == 7'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln25_fu_385_p2 = ((ap_sig_allocacmp_indvar_flatten8_load == 10'd512) ? 1'b1 : 1'b0);
assign lshr_ln6_1_fu_422_p4 = {{select_ln6_fu_408_p3[5:2]}};
assign or_ln_fu_450_p3 = {{tmp_3_fu_440_p4}, {1'd1}};
assign select_ln25_fu_480_p3 = ((tmp_reg_601[0:0] == 1'b1) ? add_ln25_fu_474_p2 : i_1_fu_80);
...
assign tmp1_d0 = reg_361;
assign tmp1_we0 = tmp1_we0_local;
assign tmp_2_fu_496_p3 = {{empty_fu_487_p1}, {lshr_ln6_1_reg_615}};
assign tmp_3_fu_440_p4 = {{select_ln6_fu_408_p3[5:3]}};
assign tmp_4_fu_511_p4 = {{{empty_fu_487_p1}, {tmp_3_reg_640}}, {1'd1}};
assign tmp_fu_400_p3 = ap_sig_allocacmp_j_load[32'd6];
assign zext_ln25_fu_491_p1 = select_ln25_fu_480_p3;
assign zext_ln27_1_fu_503_p1 = tmp_2_fu_496_p3;
assign zext_ln27_2_fu_520_p1 = tmp_4_fu_511_p4;
assign zext_ln27_fu_458_p1 = or_ln_fu_450_p3;
assign zext_ln6_fu_432_p1 = lshr_ln6_1_fu_422_p4;
endmodule 