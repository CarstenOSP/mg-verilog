...
sparsemux_7_2_64_1_1_U126(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_7_fu_187_p7),.sel(ap_sig_allocacmp_i_16),.dout(tmp_7_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_0202211_fu_68 <= grp_fu_3173_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_1203215_fu_72 <= grp_fu_3173_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_2204219_fu_76 <= grp_fu_3173_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_8_reg_328 <= grp_fu_3177_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_3173_p_din0 = tmp_8_reg_328;
assign grp_fu_3173_p_din1 = sum_reload;
assign grp_fu_3177_p_ce = 1'b1;
assign grp_fu_3177_p_din0 = 64'd0;
assign grp_fu_3177_p_din1 = bitcast_ln12_1_fu_240_p1;
