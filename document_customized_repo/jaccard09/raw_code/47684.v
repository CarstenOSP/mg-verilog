...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_14_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_14_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_278_min_s_4_out;
wire    grp_viterbi_Pipeline_L_end_fu_278_min_s_4_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_286_min_s_10_out;
wire    grp_viterbi_Pipeline_L_state_fu_286_min_s_10_out_ap_vld;
...
wire   [63:0] tmp_32_cast_fu_357_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_2_reg_605[12 : 5] <= tmp_32_cast_fu_357_p1[12 : 5];
        tmp_s_reg_600[12 : 5] <= tmp_s_fu_349_p3[12 : 5];
        zext_ln19_reg_610[7 : 0] <= zext_ln19_fu_362_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_14_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_14_loc_fu_100 <= grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_14_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_286_min_s_10_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state43))) begin
        min_s_10_loc_fu_92 <= grp_viterbi_Pipeline_L_state_fu_286_min_s_10_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_278_min_s_4_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_4_loc_fu_96 <= grp_viterbi_Pipeline_L_end_fu_278_min_s_4_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        tmp_19_reg_680[12 : 5] <= tmp_19_fu_481_p3[12 : 5];
...
assign tmp_19_fu_481_p3 = {{trunc_ln50_fu_477_p1}, {5'd0}};
assign tmp_20_fu_437_p3 = {{t_2_reg_568}, {lshr_ln7_reg_633}};
assign tmp_32_cast_fu_357_p1 = tmp_s_fu_349_p3;
