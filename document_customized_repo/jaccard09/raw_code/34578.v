...
sparsemux_7_2_64_1_1_U285(.din0(mux_case_02029_reload),.din1(mux_case_12133_reload),.din2(mux_case_22237_reload),.def(tmp_8_fu_329_p7),.sel(i_15_reg_526_pp0_iter1_reg),.dout(tmp_8_fu_329_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U286(.din0(mux_case_02341_reload),.din1(mux_case_12445_reload),.din2(mux_case_22549_reload),.def(tmp_9_fu_372_p7),.sel(i_15_reg_526_pp0_iter8_reg),.dout(tmp_9_fu_372_p9));
...
assign grp_fu_3151_p_din1 = tmp_9_reg_566;
assign grp_fu_3291_p_ce = 1'b1;
assign grp_fu_3291_p_din0 = tmp_8_fu_329_p9;
