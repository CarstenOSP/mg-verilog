...
fadd_32ns_32ns_32_7_full_dsp_1_U1107(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_144_p0),.din1(grp_fu_144_p1),.ce(1'b1),.dout(grp_fu_144_p2));
gesummv_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U1108(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_148_p0),.din1(grp_fu_148_p1),.ce(1'b1),.dout(grp_fu_148_p2));
...
assign or_ln_fu_260_p3 = {{tmp_5_fu_250_p4}, {1'd1}};
...
assign zext_ln33_fu_268_p1 = or_ln_fu_260_p3;
endmodule 