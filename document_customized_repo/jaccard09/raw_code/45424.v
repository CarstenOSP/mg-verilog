...
dmul_64ns_64ns_64_7_max_dsp_1_U139(.clk(ap_clk),.reset(ap_rst),.din0(activations2_1_load_reg_483),.din1(p_reload114),.ce(1'b1),.dout(grp_fu_298_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U140(.clk(ap_clk),.reset(ap_rst),.din0(activations2_1_load_reg_483),.din1(p_reload113),.ce(1'b1),.dout(grp_fu_302_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U141(.clk(ap_clk),.reset(ap_rst),.din0(activations2_1_load_reg_483),.din1(p_reload),.ce(1'b1),.dout(grp_fu_306_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U142(.clk(ap_clk),.reset(ap_rst),.din0(activations2_load_1_reg_490),.din1(p_reload114),.ce(1'b1),.dout(grp_fu_310_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U143(.clk(ap_clk),.reset(ap_rst),.din0(activations2_load_1_reg_490),.din1(p_reload113),.ce(1'b1),.dout(grp_fu_314_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U144(.clk(ap_clk),.reset(ap_rst),.din0(activations2_load_1_reg_490),.din1(p_reload),.ce(1'b1),.dout(grp_fu_318_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul_1_1_i_reg_524 <= grp_fu_302_p2;
        mul_1_2_i_reg_529 <= grp_fu_306_p2;
        mul_1_i_reg_519 <= grp_fu_298_p2;
        mul_216_i_reg_514 <= grp_fu_2913_p_dout0;
        mul_2_1_i_reg_539 <= grp_fu_314_p2;
        mul_2_2_i_reg_544 <= grp_fu_318_p2;
        mul_2_i_reg_534 <= grp_fu_310_p2;
...
assign p_cast27_fu_384_p1 = tmp_17_fu_376_p3;
assign tmp_17_fu_376_p3 = {{tmp_s_fu_366_p4}, {1'd1}};
