...
sparsemux_9_3_32_1_1_U524(.din0(tmp1_q0),.din1(tmp1_2_q0),.din2(tmp1_4_q0),.din3(tmp1_6_q0),.def(tmp_2_fu_715_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_2_fu_715_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U525(.din0(tmp2_q0),.din1(tmp2_2_q0),.din2(tmp2_4_q0),.din3(tmp2_6_q0),.def(tmp_3_fu_738_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_3_fu_738_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U526(.din0(tmp1_1_q0),.din1(tmp1_3_q0),.din2(tmp1_5_q0),.din3(tmp1_7_q0),.def(tmp_5_fu_761_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_5_fu_761_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U527(.din0(tmp2_1_q0),.din1(tmp2_3_q0),.din2(tmp2_5_q0),.din3(tmp2_7_q0),.def(tmp_6_fu_784_p9),.sel(trunc_ln46_1_reg_884),.dout(tmp_6_fu_784_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U528(.din0(buff_C_q0),.din1(buff_C_2_q0),.din2(buff_C_4_q0),.din3(buff_C_6_q0),.def(tmp_4_fu_807_p9),.sel(trunc_ln46_1_reg_884_pp0_iter4_reg),.dout(tmp_4_fu_807_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U529(.din0(buff_C_1_q0),.din1(buff_C_3_q0),.din2(buff_C_5_q0),.din3(buff_C_7_q0),.def(tmp_7_fu_830_p9),.sel(trunc_ln46_1_reg_884_pp0_iter4_reg),.dout(tmp_7_fu_830_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add135_1_reg_1074 <= grp_fu_644_p_dout0;
        add141_1_reg_1092 <= grp_fu_652_p_dout0;
        add2_reg_1064 <= grp_fu_640_p_dout0;
        add3_reg_1084 <= grp_fu_648_p_dout0;
        ...
        mul140_1_reg_1079 <= grp_fu_900_p_dout0;
        mul4_reg_1069 <= grp_fu_896_p_dout0;
...
assign grp_fu_644_p_din0 = tmp_5_reg_1004;
assign grp_fu_644_p_din1 = tmp_6_reg_1009;
assign grp_fu_644_p_opcode = 2'd0;
assign grp_fu_648_p_ce = 1'b1;
assign grp_fu_648_p_din0 = add2_reg_1064;
assign grp_fu_648_p_din1 = mul4_reg_1069;
assign grp_fu_648_p_opcode = 2'd0;
assign grp_fu_652_p_ce = 1'b1;
assign grp_fu_652_p_din0 = add135_1_reg_1074;
assign grp_fu_652_p_din1 = mul140_1_reg_1079;
assign grp_fu_652_p_opcode = 2'd0;
assign grp_fu_896_p_ce = 1'b1;
assign grp_fu_896_p_din0 = tmp_4_reg_1054;
assign grp_fu_896_p_din1 = beta;
assign grp_fu_900_p_ce = 1'b1;
assign grp_fu_900_p_din0 = tmp_7_reg_1059;
assign grp_fu_900_p_din1 = beta;
assign icmp_ln45_fu_600_p2 = ((ap_sig_allocacmp_indvar_flatten20_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln5_3_fu_661_p4 = {{select_ln5_fu_637_p3[5:3]}};
...
assign tmp_s_fu_671_p3 = {{trunc_ln46_fu_653_p1}, {lshr_ln5_3_fu_661_p4}};
