...
wire   [7:0] tmp_15_fu_212_p9;
wire   [7:0] tmp_15_fu_212_p11;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_15_fu_212_p1;
wire  signed [1:0] tmp_15_fu_212_p3;
wire  signed [1:0] tmp_15_fu_212_p5;
wire   [1:0] tmp_15_fu_212_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_8_1_1_x_U75(.din0(buf_0_q1),.din1(buf_1_q1),.din2(buf_2_q1),.din3(buf_3_q1),.def(tmp_15_fu_212_p9),.sel(trunc_ln66_reg_260_pp0_iter1_reg),.dout(tmp_15_fu_212_p11));
...
assign xor_ln66_fu_235_p2 = (trunc_ln66_2_reg_275 ^ tmp_15_fu_212_p11);
