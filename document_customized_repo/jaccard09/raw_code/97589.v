...
wire   [3:0] lshr_ln5_6_fu_147_p4;
wire   [31:0] tmp_1_fu_170_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_1_fu_170_p1;
wire   [1:0] tmp_1_fu_170_p3;
wire  signed [1:0] tmp_1_fu_170_p5;
wire  signed [1:0] tmp_1_fu_170_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U1005(.din0(buff_y_out_q0),.din1(buff_y_out_1_q0),.din2(buff_y_out_2_q0),.din3(buff_y_out_3_q0),.def(tmp_1_fu_170_p9),.sel(trunc_ln32_reg_208),.dout(tmp_1_fu_170_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_233 <= tmp_1_fu_170_p11;
...
assign bitcast_ln33_fu_193_p1 = tmp_1_reg_233;
...
assign lshr_ln5_6_fu_147_p4 = {{ap_sig_allocacmp_i_1[5:2]}};
assign tmp_1_fu_170_p9 = 'bx;
...
assign zext_ln5_fu_157_p1 = lshr_ln5_6_fu_147_p4;
endmodule 