...
reg   [9:0] bucket_0_addr_17_reg_515;
reg   [9:0] bucket_1_addr_17_reg_520;
wire   [31:0] tmp_5_fu_313_p3;
reg   [31:0] tmp_5_reg_525;
wire    ap_CS_fsm_state2;
reg   [31:0] bucket_0_load_reg_545;
reg   [31:0] bucket_1_load_reg_550;
reg   [31:0] bucket_0_load_17_reg_555;
reg   [31:0] bucket_1_load_17_reg_560;
reg   [9:0] bucket_0_addr_18_reg_565;
reg   [9:0] bucket_1_addr_18_reg_570;
reg   [9:0] bucket_0_addr_19_reg_575;
reg   [9:0] bucket_1_addr_19_reg_580;
reg   [31:0] bucket_0_load_18_reg_585;
wire    ap_CS_fsm_state3;
reg   [31:0] bucket_1_load_18_reg_590;
reg   [31:0] bucket_0_load_19_reg_595;
reg   [31:0] bucket_1_load_19_reg_600;
reg   [9:0] bucket_0_addr_20_reg_605;
reg   [9:0] bucket_1_addr_20_reg_610;
reg   [9:0] bucket_0_addr_21_reg_615;
reg   [9:0] bucket_1_addr_21_reg_620;
reg   [31:0] bucket_0_load_20_reg_625;
wire    ap_CS_fsm_state4;
reg   [31:0] bucket_1_load_20_reg_630;
reg   [31:0] bucket_0_load_21_reg_635;
reg   [31:0] bucket_1_load_21_reg_640;
reg   [9:0] bucket_0_addr_22_reg_645;
reg   [9:0] bucket_1_addr_22_reg_650;
reg   [9:0] bucket_0_addr_23_reg_655;
reg   [9:0] bucket_1_addr_23_reg_660;
...
wire   [5:0] lshr_ln6_fu_260_p4;
wire   [9:0] p_udiv_fu_280_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        bucket_0_addr_17_reg_515[9 : 3] <= zext_ln37_1_fu_302_p1[9 : 3];
        bucket_0_addr_reg_505[9 : 3] <= zext_ln37_fu_288_p1[9 : 3];
        bucket_1_addr_17_reg_520[9 : 3] <= zext_ln37_1_fu_302_p1[9 : 3];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        bucket_0_addr_18_reg_565[9 : 3] <= zext_ln37_2_fu_327_p1[9 : 3];
        bucket_0_addr_19_reg_575[9 : 3] <= zext_ln37_3_fu_340_p1[9 : 3];
        bucket_0_load_17_reg_555 <= bucket_0_q0;
        bucket_0_load_reg_545 <= bucket_0_q1;
        bucket_1_addr_18_reg_570[9 : 3] <= zext_ln37_2_fu_327_p1[9 : 3];
        bucket_1_addr_19_reg_580[9 : 3] <= zext_ln37_3_fu_340_p1[9 : 3];
        bucket_1_load_17_reg_560 <= bucket_1_q0;
        bucket_1_load_reg_550 <= bucket_1_q1;
        tmp_5_reg_525 <= tmp_5_fu_313_p3;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_0_addr_20_reg_605[9 : 3] <= zext_ln37_4_fu_353_p1[9 : 3];
        bucket_0_addr_21_reg_615[9 : 3] <= zext_ln37_5_fu_366_p1[9 : 3];
        bucket_0_load_18_reg_585 <= bucket_0_q1;
        bucket_0_load_19_reg_595 <= bucket_0_q0;
        bucket_1_addr_20_reg_610[9 : 3] <= zext_ln37_4_fu_353_p1[9 : 3];
        bucket_1_addr_21_reg_620[9 : 3] <= zext_ln37_5_fu_366_p1[9 : 3];
        bucket_1_load_18_reg_590 <= bucket_1_q1;
        bucket_1_load_19_reg_600 <= bucket_1_q0;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_0_addr_22_reg_645[9 : 3] <= zext_ln37_6_fu_379_p1[9 : 3];
        bucket_0_addr_23_reg_655[9 : 3] <= zext_ln37_7_fu_392_p1[9 : 3];
        bucket_0_load_20_reg_625 <= bucket_0_q1;
        bucket_0_load_21_reg_635 <= bucket_0_q0;
        bucket_1_addr_22_reg_650[9 : 3] <= zext_ln37_6_fu_379_p1[9 : 3];
        bucket_1_addr_23_reg_660[9 : 3] <= zext_ln37_7_fu_392_p1[9 : 3];
        bucket_1_load_20_reg_630 <= bucket_1_q1;
        bucket_1_load_21_reg_640 <= bucket_1_q0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_0_address0_local = bucket_0_addr_23_reg_655;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        bucket_0_address0_local = bucket_0_addr_21_reg_615;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        bucket_0_address0_local = bucket_0_addr_19_reg_575;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        bucket_0_address0_local = bucket_0_addr_17_reg_515;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_0_address1_local = bucket_0_addr_22_reg_645;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        bucket_0_address1_local = bucket_0_addr_20_reg_605;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        bucket_0_address1_local = bucket_0_addr_18_reg_565;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_1_address0_local = bucket_1_addr_23_reg_660;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        bucket_1_address0_local = bucket_1_addr_21_reg_620;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        bucket_1_address0_local = bucket_1_addr_19_reg_580;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        bucket_1_address0_local = bucket_1_addr_17_reg_520;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_1_address1_local = bucket_1_addr_22_reg_650;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        bucket_1_address1_local = bucket_1_addr_20_reg_610;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        bucket_1_address1_local = bucket_1_addr_18_reg_570;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
...
assign add_ln37_10_fu_442_p2 = (bucket_0_load_21_reg_635 + tmp_5_reg_525);
assign add_ln37_11_fu_446_p2 = (bucket_1_load_21_reg_640 + tmp_5_reg_525);
assign add_ln37_12_fu_450_p2 = (bucket_0_q1 + tmp_5_reg_525);
assign add_ln37_13_fu_455_p2 = (bucket_1_q1 + tmp_5_reg_525);
assign add_ln37_14_fu_460_p2 = (bucket_0_q0 + tmp_5_reg_525);
assign add_ln37_15_fu_465_p2 = (bucket_1_q0 + tmp_5_reg_525);
assign add_ln37_1_fu_403_p2 = (bucket_1_load_reg_550 + tmp_5_reg_525);
assign add_ln37_2_fu_408_p2 = (bucket_0_load_17_reg_555 + tmp_5_reg_525);
assign add_ln37_3_fu_413_p2 = (bucket_1_load_17_reg_560 + tmp_5_reg_525);
assign add_ln37_4_fu_418_p2 = (bucket_0_load_18_reg_585 + tmp_5_reg_525);
assign add_ln37_5_fu_422_p2 = (bucket_1_load_18_reg_590 + tmp_5_reg_525);
assign add_ln37_6_fu_426_p2 = (bucket_0_load_19_reg_595 + tmp_5_reg_525);
assign add_ln37_7_fu_430_p2 = (bucket_1_load_19_reg_600 + tmp_5_reg_525);
assign add_ln37_8_fu_434_p2 = (bucket_0_load_20_reg_625 + tmp_5_reg_525);
assign add_ln37_9_fu_438_p2 = (bucket_1_load_20_reg_630 + tmp_5_reg_525);
assign add_ln37_fu_398_p2 = (bucket_0_load_reg_545 + tmp_5_reg_525);
...
assign lshr_ln6_fu_260_p4 = {{ap_sig_allocacmp_radixID_2[6:1]}};
...
assign p_udiv_fu_280_p3 = {{empty_fu_276_p1}, {3'd0}};
...
assign tmp_5_fu_313_p3 = ((trunc_ln34_reg_480[0:0] == 1'b1) ? sum_1_q0 : sum_0_q0);
assign trunc_ln34_fu_256_p1 = ap_sig_allocacmp_radixID_2[0:0];
assign zext_ln33_fu_270_p1 = lshr_ln6_fu_260_p4;
...
assign zext_ln37_fu_288_p1 = p_udiv_fu_280_p3;
always @ (posedge ap_clk) begin
    bucket_0_addr_reg_505[2:0] <= 3'b000;
    bucket_1_addr_reg_510[2:0] <= 3'b000;
    bucket_0_addr_17_reg_515[2:0] <= 3'b001;
    bucket_1_addr_17_reg_520[2:0] <= 3'b001;
    bucket_0_addr_18_reg_565[2:0] <= 3'b010;
    bucket_1_addr_18_reg_570[2:0] <= 3'b010;
    bucket_0_addr_19_reg_575[2:0] <= 3'b011;
    bucket_1_addr_19_reg_580[2:0] <= 3'b011;
    bucket_0_addr_20_reg_605[2:0] <= 3'b100;
    bucket_1_addr_20_reg_610[2:0] <= 3'b100;
    bucket_0_addr_21_reg_615[2:0] <= 3'b101;
    bucket_1_addr_21_reg_620[2:0] <= 3'b101;
    bucket_0_addr_22_reg_645[2:0] <= 3'b110;
    bucket_1_addr_22_reg_650[2:0] <= 3'b110;
    bucket_0_addr_23_reg_655[2:0] <= 3'b111;
    bucket_1_addr_23_reg_660[2:0] <= 3'b111;
end
endmodule 