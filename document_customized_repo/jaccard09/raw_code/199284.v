...
wire   [7:0] trunc_ln33_16_fu_246_p1;
wire   [7:0] lshr_ln_fu_268_p4;
wire   [10:0] tmp_fu_282_p4;
wire   [9:0] zext_ln35_3_fu_278_p1;
wire   [20:0] add_ln_fu_292_p3;
...
sparsemux_9_2_32_1_1_U3(.din0(v9_fu_329_p2),.din1(v9_fu_329_p4),.din2(v9_fu_329_p6),.din3(v9_fu_329_p8),.def(v9_fu_329_p9),.sel(trunc_ln_reg_427),.dout(v9_fu_329_p11));
(* dissolve_hierarchy = "yes" *) SgdLR_sw_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U4(.din0(v10_fu_368_p2),.din1(v10_fu_368_p4),.din2(v10_fu_368_p6),.din3(v10_fu_368_p8),.def(v10_fu_368_p9),.sel(trunc_ln33_reg_422),.dout(v10_fu_368_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln_reg_427 <= {{ap_sig_allocacmp_v8_10[9:8]}};
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln33_fu_236_p2 = (ap_sig_allocacmp_v8_10 + 11'd1);
assign add_ln_fu_292_p3 = {{tmp_fu_282_p4}, {zext_ln35_3_fu_278_p1}};
...
assign icmp_ln33_fu_230_p2 = ((ap_sig_allocacmp_v8_10 == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln_fu_268_p4 = {{ap_sig_allocacmp_v8_10[9:2]}};
assign tmp_fu_282_p4 = {{v5[12:2]}};
assign trunc_ln33_16_fu_246_p1 = ap_sig_allocacmp_v8_10[7:0];
assign trunc_ln33_fu_242_p1 = ap_sig_allocacmp_v8_10[1:0];
...
assign zext_ln29_fu_250_p1 = trunc_ln33_16_fu_246_p1;
assign zext_ln35_3_fu_278_p1 = lshr_ln_fu_268_p4;
assign zext_ln35_fu_300_p1 = add_ln_fu_292_p3;
endmodule 