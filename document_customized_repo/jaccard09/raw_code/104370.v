...
wire   [10:0] tmp_9_fu_331_p3;
wire   [10:0] tmp_s_fu_345_p4;
wire   [9:0] tmp_8_fu_377_p3;
reg    ap_done_reg;
...
fadd_32ns_32ns_32_7_full_dsp_1_U23(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_1_load_reg_523),.din1(mul74_1_reg_508),.ce(1'b1),.dout(grp_fu_208_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U24(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_2_load_reg_528),.din1(mul74_2_reg_513),.ce(1'b1),.dout(grp_fu_212_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U25(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_3_load_reg_533),.din1(mul74_3_reg_518),.ce(1'b1),.dout(grp_fu_216_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U27(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_1_load_reg_459),.din1(beta),.ce(1'b1),.dout(grp_fu_224_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U28(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_load_1_reg_464),.din1(beta),.ce(1'b1),.dout(grp_fu_228_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U29(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_1_load_1_reg_469),.din1(beta),.ce(1'b1),.dout(grp_fu_232_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_538 <= grp_fu_156_p_dout0;
        ...
        mul1_reg_498 <= grp_fu_160_p_dout0;
...
assign grp_fu_156_p_din0 = buff_C_out_load_reg_503;
assign grp_fu_156_p_din1 = mul1_reg_498;
assign grp_fu_156_p_opcode = 2'd0;
assign grp_fu_160_p_ce = 1'b1;
assign grp_fu_160_p_din0 = buff_B_load_reg_454;
assign grp_fu_160_p_din1 = beta;
...
assign tmp_8_fu_377_p3 = {{trunc_ln5_reg_424_pp0_iter4_reg}, {lshr_ln5_3_reg_429_pp0_iter4_reg}};
assign tmp_9_fu_331_p3 = {{trunc_ln5_fu_307_p1}, {lshr_ln5_4_fu_321_p4}};
assign tmp_fu_283_p3 = j_fu_68[32'd6];
assign tmp_s_fu_345_p4 = {{{trunc_ln5_fu_307_p1}, {lshr_ln5_3_fu_311_p4}}, {1'd1}};
assign trunc_ln5_fu_307_p1 = select_ln29_fu_299_p3[5:0];
assign zext_ln32_1_fu_339_p1 = tmp_9_fu_331_p3;
assign zext_ln32_2_fu_355_p1 = tmp_s_fu_345_p4;
assign zext_ln32_fu_383_p1 = tmp_8_fu_377_p3;
endmodule 