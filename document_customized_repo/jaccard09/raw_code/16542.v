...
wire   [63:0] grp_bfs_Pipeline_loop_neighbors_fu_250_cnt_62_out;
wire    grp_bfs_Pipeline_loop_neighbors_fu_250_cnt_62_out_ap_vld;
reg   [63:0] cnt_reg_214;
reg   [63:0] ap_phi_mux_cnt_4_phi_fu_242_p4;
wire    ap_CS_fsm_state7;
reg   [8:0] n_reg_227;
reg   [63:0] cnt_4_reg_238;
...
sparsemux_9_2_64_1_1_U79(.din0(e_fu_372_p2),.din1(e_fu_372_p4),.din2(e_fu_372_p6),.din3(e_fu_372_p8),.def(e_fu_372_p9),.sel(trunc_ln24_reg_502),.dout(e_fu_372_p11));
(* dissolve_hierarchy = "yes" *) bfs_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U80(.din0(tmp_end_fu_436_p2),.din1(tmp_end_fu_436_p4),.din2(tmp_end_fu_436_p6),.din3(tmp_end_fu_436_p8),.def(tmp_end_fu_436_p9),.sel(trunc_ln24_reg_502),.dout(tmp_end_fu_436_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln25_fu_351_p2 == 1'd0))) begin
        cnt_4_reg_238 <= cnt_reg_214;
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln25_reg_521 == 1'd1))) begin
        cnt_4_reg_238 <= grp_bfs_Pipeline_loop_neighbors_fu_250_cnt_62_out;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        cnt_reg_214 <= ap_phi_mux_cnt_4_phi_fu_242_p4;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln25_reg_521 == 1'd1))) begin
        ap_phi_mux_cnt_4_phi_fu_242_p4 = grp_bfs_Pipeline_loop_neighbors_fu_250_cnt_62_out;
    end else begin
        ap_phi_mux_cnt_4_phi_fu_242_p4 = cnt_4_reg_238;
    end
end
always @ (*) begin
    if (((icmp_ln24_fu_292_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3) & (1'd0 == and_ln43_fu_334_p2))) begin
