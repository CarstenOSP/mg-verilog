...
reg   [5:0] s_reg_584;
wire   [1:0] trunc_ln11_fu_219_p1;
reg   [1:0] trunc_ln11_reg_590;
...
wire   [11:0] tmp_255_cast_fu_233_p3;
wire   [6:0] zext_ln11_fu_215_p1;
...
sparsemux_9_2_64_1_1_U24(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(p_fu_263_p9),.sel(trunc_ln11_reg_590),.dout(p_fu_263_p11));
...
sparsemux_9_2_64_1_1_U25(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(p_64_fu_317_p9),.sel(trunc_ln11_reg_590),.dout(p_64_fu_317_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln11_reg_590 <= trunc_ln11_fu_219_p1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_7_reg_685 <= grp_fu_390_p_dout0;
    end
end
always @ (*) begin
...
assign add_ln40_fu_249_p2 = (zext_ln11_fu_215_p1 + 7'd1);
...
assign and_ln42_fu_410_p2 = (or_ln42_fu_386_p2 & grp_fu_390_p_dout0);
...
assign grp_fu_390_p_din0 = grp_fu_193_p0;
assign grp_fu_390_p_din1 = grp_fu_193_p1;
...
assign icmp_ln42_fu_374_p2 = ((tmp_2_fu_343_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign tmp_255_cast_fu_233_p3 = {{8'd139}, {tmp_s_fu_223_p4}};
assign tmp_2_fu_343_p4 = {{bitcast_ln42_fu_340_p1[62:52]}};
...
assign trunc_ln11_fu_219_p1 = ap_sig_allocacmp_s[1:0];
