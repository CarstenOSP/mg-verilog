module atax_atax_node0_Pipeline_label_1 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v3,v4,v113_0_address0,v113_0_ce0,v113_0_q0,v113_0_address1,v113_0_ce1,v113_0_q1,v113_1_address0,v113_1_ce0,v113_1_q0,v113_1_address1,v113_1_ce1,v113_1_q1,v113_2_address0,v113_2_ce0,v113_2_q0,v113_2_address1,v113_2_ce1,v113_2_q1,v113_3_address0,v113_3_ce0,v113_3_q0,v113_3_address1,v113_3_ce1,v113_3_q1,v116_address0,v116_ce0,v116_we0,v116_d0,v116_q0,v116_address1,v116_ce1,v116_we1,v116_d1,v116_q1,v6,v7_out,v7_out_ap_vld,grp_fu_667_p_din0,grp_fu_667_p_din1,grp_fu_667_p_opcode,grp_fu_667_p_dout0,grp_fu_667_p_ce,grp_fu_671_p_din0,grp_fu_671_p_din1,grp_fu_671_p_dout0,grp_fu_671_p_ce); 
...
wire   [3:0] lshr_ln2_fu_340_p4;
reg   [3:0] lshr_ln2_reg_672;
wire   [0:0] icmp_ln31_fu_378_p2;
reg   [0:0] icmp_ln31_reg_698;
reg   [5:0] v116_addr_reg_703;
reg   [5:0] v116_addr_reg_703_pp0_iter1_reg;
wire   [2:0] tmp_38_fu_407_p4;
reg   [2:0] tmp_38_reg_708;
reg   [2:0] tmp_38_reg_708_pp0_iter1_reg;
reg   [0:0] tmp_21_reg_736;
...
wire   [4:0] tmp_37_fu_384_p4;
wire   [5:0] or_ln_fu_394_p3;
wire   [9:0] tmp_39_fu_417_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln2_reg_672 <= {{ap_sig_allocacmp_v5[5:2]}};
        tmp_21_reg_736 <= ap_sig_allocacmp_v5[32'd1];
        tmp_38_reg_708 <= {{ap_sig_allocacmp_v5[5:3]}};
        tmp_38_reg_708_pp0_iter1_reg <= tmp_38_reg_708;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        v53_reg_965 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v11_reg_870 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        v17_reg_885 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        v23_reg_895 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v29_reg_910 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v35_reg_925 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v36_reg_985 <= grp_fu_667_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v41_reg_940 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v42_reg_990 <= grp_fu_667_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v47_reg_950 <= grp_fu_671_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v48_reg_995 <= grp_fu_667_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v54_reg_1000 <= grp_fu_667_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_667_p_din0 = grp_fu_302_p0;
assign grp_fu_667_p_din1 = grp_fu_302_p1;
assign grp_fu_667_p_opcode = 2'd0;
assign grp_fu_671_p_ce = 1'b1;
assign grp_fu_671_p_din0 = grp_fu_306_p0;
assign grp_fu_671_p_din1 = grp_fu_306_p1;
assign icmp_ln31_fu_378_p2 = ((ap_sig_allocacmp_v5 == 7'd0) ? 1'b1 : 1'b0);
assign lshr_ln2_fu_340_p4 = {{ap_sig_allocacmp_v5[5:2]}};
assign or_ln1_fu_454_p3 = {{lshr_ln2_reg_672}, {2'd2}};
assign or_ln2_fu_466_p3 = {{lshr_ln2_reg_672}, {2'd3}};
assign or_ln3_fu_492_p3 = {{tmp_38_reg_708}, {3'd4}};
assign or_ln4_fu_504_p5 = {{{{tmp_38_reg_708}, {1'd1}}, {tmp_21_reg_736}}, {1'd1}};
assign or_ln5_fu_528_p3 = {{tmp_38_reg_708}, {3'd6}};
assign or_ln6_fu_584_p3 = {{tmp_38_reg_708_pp0_iter1_reg}, {3'd7}};
assign or_ln_fu_394_p3 = {{tmp_37_fu_384_p4}, {1'd1}};
assign tmp_37_fu_384_p4 = {{ap_sig_allocacmp_v5[5:1]}};
assign tmp_38_fu_407_p4 = {{ap_sig_allocacmp_v5[5:3]}};
assign tmp_39_fu_417_p4 = {{{v4}, {tmp_38_fu_407_p4}}, {1'd1}};
assign tmp_cast_fu_350_p4 = {{v4[5:2]}};
assign tmp_fu_327_p3 = ap_sig_allocacmp_v5[32'd6];
assign tmp_s_fu_360_p4 = {{{tmp_cast_fu_350_p4}, {2'd0}}, {lshr_ln2_fu_340_p4}};
...
assign v45_1_fu_600_p1 = v116_load_6_reg_865;
...
assign v8_fu_481_p3 = ((icmp_ln31_reg_698[0:0] == 1'b1) ? v6 : v3_7_fu_96);
...
assign zext_ln61_fu_427_p1 = tmp_39_fu_417_p4;
