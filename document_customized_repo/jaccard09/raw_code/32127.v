module backprop_backprop_Pipeline_VITIS_LOOP_66_1 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,output_difference_2_promoted,output_difference_0_promoted,output_difference_1_promoted,mux_case_24485,mux_case_14380,mux_case_04275,mux_case_03548_reload,mux_case_13652_reload,mux_case_23756_reload,mul_ln66,training_targets_0_address0,training_targets_0_ce0,training_targets_0_q0,training_targets_1_address0,training_targets_1_ce0,training_targets_1_q0,training_targets_2_address0,training_targets_2_ce0,training_targets_2_q0,training_targets_3_address0,training_targets_3_ce0,training_targets_3_q0,training_targets_4_address0,training_targets_4_ce0,training_targets_4_q0,training_targets_5_address0,training_targets_5_ce0,training_targets_5_q0,training_targets_6_address0,training_targets_6_ce0,training_targets_6_q0,training_targets_7_address0,training_targets_7_ce0,training_targets_7_q0,mux_case_03860_reload,mux_case_13964_reload,mux_case_24068_reload,output_difference_out,output_difference_out_ap_vld,output_difference_1_out,output_difference_1_out_ap_vld,output_difference_2_out,output_difference_2_out_ap_vld,mux_case_24483_out,mux_case_24483_out_ap_vld,mux_case_14378_out,mux_case_14378_out_ap_vld,mux_case_04273_out,mux_case_04273_out_ap_vld,grp_fu_8514_p_din0,grp_fu_8514_p_din1,grp_fu_8514_p_opcode,grp_fu_8514_p_dout0,grp_fu_8514_p_ce,grp_fu_8566_p_din0,grp_fu_8566_p_din1,grp_fu_8566_p_dout0,grp_fu_8566_p_ce); 
...
input  [63:0] mux_case_24485;
input  [63:0] mux_case_14380;
input  [63:0] mux_case_04275;
input  [63:0] mux_case_03548_reload;
input  [63:0] mux_case_13652_reload;
input  [63:0] mux_case_23756_reload;
input  [8:0] mul_ln66;
...
input  [63:0] mux_case_03860_reload;
input  [63:0] mux_case_13964_reload;
input  [63:0] mux_case_24068_reload;
...
output  [63:0] mux_case_24483_out;
output   mux_case_24483_out_ap_vld;
output  [63:0] mux_case_14378_out;
output   mux_case_14378_out_ap_vld;
output  [63:0] mux_case_04273_out;
output   mux_case_04273_out_ap_vld;
...
reg mux_case_24483_out_ap_vld;
reg mux_case_14378_out_ap_vld;
reg mux_case_04273_out_ap_vld;
...
reg   [1:0] i_7_reg_743;
reg   [1:0] i_7_reg_743_pp0_iter1_reg;
reg   [1:0] i_7_reg_743_pp0_iter2_reg;
reg   [1:0] i_7_reg_743_pp0_iter3_reg;
reg   [1:0] i_7_reg_743_pp0_iter4_reg;
reg   [1:0] i_7_reg_743_pp0_iter5_reg;
reg   [1:0] i_7_reg_743_pp0_iter6_reg;
reg   [1:0] i_7_reg_743_pp0_iter7_reg;
reg   [1:0] i_7_reg_743_pp0_iter8_reg;
reg   [1:0] i_7_reg_743_pp0_iter9_reg;
reg   [1:0] i_7_reg_743_pp0_iter10_reg;
reg   [1:0] i_7_reg_743_pp0_iter11_reg;
reg   [1:0] i_7_reg_743_pp0_iter12_reg;
reg   [1:0] i_7_reg_743_pp0_iter13_reg;
reg   [1:0] i_7_reg_743_pp0_iter14_reg;
reg   [1:0] i_7_reg_743_pp0_iter15_reg;
reg   [1:0] i_7_reg_743_pp0_iter16_reg;
...
wire   [63:0] tmp_31_fu_511_p19;
reg   [63:0] tmp_31_reg_798;
...
wire   [63:0] tmp_32_fu_589_p9;
reg   [63:0] tmp_32_reg_818;
...
reg   [63:0] mux_case_04273_fu_132;
...
reg   [63:0] mux_case_14378_fu_136;
reg   [63:0] mux_case_24483_fu_140;
...
wire   [5:0] lshr_ln5_fu_452_p4;
wire   [63:0] tmp_31_fu_511_p2;
wire   [63:0] tmp_31_fu_511_p4;
wire   [63:0] tmp_31_fu_511_p6;
wire   [63:0] tmp_31_fu_511_p8;
wire   [63:0] tmp_31_fu_511_p10;
wire   [63:0] tmp_31_fu_511_p12;
wire   [63:0] tmp_31_fu_511_p14;
wire   [63:0] tmp_31_fu_511_p16;
wire   [63:0] tmp_31_fu_511_p17;
wire   [63:0] tmp_s_fu_550_p7;
wire   [63:0] bitcast_ln67_8_fu_567_p1;
wire   [0:0] bit_sel5_fu_571_p3;
wire   [63:0] tmp_32_fu_589_p7;
...
wire   [2:0] tmp_31_fu_511_p1;
wire   [2:0] tmp_31_fu_511_p3;
wire   [2:0] tmp_31_fu_511_p5;
wire   [2:0] tmp_31_fu_511_p7;
wire  signed [2:0] tmp_31_fu_511_p9;
wire  signed [2:0] tmp_31_fu_511_p11;
wire  signed [2:0] tmp_31_fu_511_p13;
wire  signed [2:0] tmp_31_fu_511_p15;
wire   [1:0] tmp_s_fu_550_p1;
wire   [1:0] tmp_s_fu_550_p3;
wire  signed [1:0] tmp_s_fu_550_p5;
wire   [1:0] tmp_32_fu_589_p1;
wire   [1:0] tmp_32_fu_589_p3;
wire  signed [1:0] tmp_32_fu_589_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 i_fu_128 = 2'd0;
#0 mux_case_04273_fu_132 = 64'd0;
#0 mux_case_14378_fu_136 = 64'd0;
#0 mux_case_24483_fu_140 = 64'd0;
...
sparsemux_17_3_64_1_1_x_U426(.din0(tmp_31_fu_511_p2),.din1(tmp_31_fu_511_p4),.din2(tmp_31_fu_511_p6),.din3(tmp_31_fu_511_p8),.din4(tmp_31_fu_511_p10),.din5(tmp_31_fu_511_p12),.din6(tmp_31_fu_511_p14),.din7(tmp_31_fu_511_p16),.def(tmp_31_fu_511_p17),.sel(trunc_ln67_reg_753),.dout(tmp_31_fu_511_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U427(.din0(mux_case_03548_reload),.din1(mux_case_13652_reload),.din2(mux_case_23756_reload),.def(tmp_s_fu_550_p7),.sel(i_7_reg_743_pp0_iter1_reg),.dout(tmp_s_fu_550_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U428(.din0(mux_case_03860_reload),.din1(mux_case_13964_reload),.din2(mux_case_24068_reload),.def(tmp_32_fu_589_p7),.sel(i_7_reg_743_pp0_iter8_reg),.dout(tmp_32_fu_589_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_04273_fu_132 <= mux_case_04275;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_7_reg_743_pp0_iter16_reg == 2'd0))) begin
            mux_case_04273_fu_132 <= mul5_i_reg_828;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_14378_fu_136 <= mux_case_14380;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_7_reg_743_pp0_iter16_reg == 2'd1))) begin
            mux_case_14378_fu_136 <= mul5_i_reg_828;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_24483_fu_140 <= mux_case_24485;
        end else if ((1'b1 == ap_condition_739)) begin
            mux_case_24483_fu_140 <= mul5_i_reg_828;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_7_reg_743_pp0_iter10_reg <= i_7_reg_743_pp0_iter9_reg;
        i_7_reg_743_pp0_iter11_reg <= i_7_reg_743_pp0_iter10_reg;
        i_7_reg_743_pp0_iter12_reg <= i_7_reg_743_pp0_iter11_reg;
        i_7_reg_743_pp0_iter13_reg <= i_7_reg_743_pp0_iter12_reg;
        i_7_reg_743_pp0_iter14_reg <= i_7_reg_743_pp0_iter13_reg;
        i_7_reg_743_pp0_iter15_reg <= i_7_reg_743_pp0_iter14_reg;
        i_7_reg_743_pp0_iter16_reg <= i_7_reg_743_pp0_iter15_reg;
        i_7_reg_743_pp0_iter2_reg <= i_7_reg_743_pp0_iter1_reg;
        i_7_reg_743_pp0_iter3_reg <= i_7_reg_743_pp0_iter2_reg;
        i_7_reg_743_pp0_iter4_reg <= i_7_reg_743_pp0_iter3_reg;
        i_7_reg_743_pp0_iter5_reg <= i_7_reg_743_pp0_iter4_reg;
        i_7_reg_743_pp0_iter6_reg <= i_7_reg_743_pp0_iter5_reg;
        i_7_reg_743_pp0_iter7_reg <= i_7_reg_743_pp0_iter6_reg;
        i_7_reg_743_pp0_iter8_reg <= i_7_reg_743_pp0_iter7_reg;
        i_7_reg_743_pp0_iter9_reg <= i_7_reg_743_pp0_iter8_reg;
        ...
        mul5_i_reg_828 <= grp_fu_8566_p_dout0;
        tmp_32_reg_818 <= tmp_32_fu_589_p9;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_7_reg_743 <= ap_sig_allocacmp_i_7;
        i_7_reg_743_pp0_iter1_reg <= i_7_reg_743;
        icmp_ln66_reg_749 <= icmp_ln66_fu_426_p2;
        icmp_ln66_reg_749_pp0_iter1_reg <= icmp_ln66_reg_749;
        tmp_31_reg_798 <= tmp_31_fu_511_p19;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_i_7 = i_fu_128;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_749_pp0_iter15_reg == 1'd1))) begin
        mux_case_04273_out_ap_vld = 1'b1;
    end else begin
        mux_case_04273_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_749_pp0_iter15_reg == 1'd1))) begin
        mux_case_14378_out_ap_vld = 1'b1;
    end else begin
        mux_case_14378_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_749_pp0_iter15_reg == 1'd1))) begin
        mux_case_24483_out_ap_vld = 1'b1;
    end else begin
        mux_case_24483_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_749_pp0_iter15_reg == 1'd1))) begin
...
assign add_ln66_fu_432_p2 = (ap_sig_allocacmp_i_7 + 2'd1);
...
always @ (*) begin
    ap_condition_739 = (~(i_7_reg_743_pp0_iter16_reg == 2'd1) & ~(i_7_reg_743_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
...
assign bitcast_ln67_8_fu_567_p1 = grp_fu_8514_p_dout0;
assign bitcast_ln67_9_fu_611_p1 = xor_ln2_fu_605_p3;
assign grp_fu_8514_p_ce = 1'b1;
assign grp_fu_8514_p_din0 = tmp_s_fu_550_p9;
assign grp_fu_8514_p_din1 = tmp_31_reg_798;
assign grp_fu_8514_p_opcode = 2'd1;
assign grp_fu_8566_p_ce = 1'b1;
assign grp_fu_8566_p_din0 = bitcast_ln67_9_fu_611_p1;
assign grp_fu_8566_p_din1 = tmp_32_reg_818;
assign icmp_ln66_fu_426_p2 = ((ap_sig_allocacmp_i_7 == 2'd3) ? 1'b1 : 1'b0);
assign lshr_ln5_fu_452_p4 = {{add_ln67_fu_442_p2[8:3]}};
assign mux_case_04273_out = mux_case_04273_fu_132;
assign mux_case_14378_out = mux_case_14378_fu_136;
assign mux_case_24483_out = mux_case_24483_fu_140;
...
assign tmp_31_fu_511_p10 = training_targets_4_q0;
assign tmp_31_fu_511_p12 = training_targets_5_q0;
assign tmp_31_fu_511_p14 = training_targets_6_q0;
assign tmp_31_fu_511_p16 = training_targets_7_q0;
assign tmp_31_fu_511_p17 = 'bx;
assign tmp_31_fu_511_p2 = training_targets_0_q0;
assign tmp_31_fu_511_p4 = training_targets_1_q0;
assign tmp_31_fu_511_p6 = training_targets_2_q0;
assign tmp_31_fu_511_p8 = training_targets_3_q0;
assign tmp_32_fu_589_p7 = 'bx;
...
assign zext_ln67_1_fu_462_p1 = lshr_ln5_fu_452_p4;
assign zext_ln67_fu_438_p1 = ap_sig_allocacmp_i_7;
endmodule 