...
wire   [31:0] tmp_fu_485_p19;
reg   [31:0] tmp_reg_651;
...
wire   [2:0] lshr_ln5_4_fu_439_p4;
wire   [8:0] tmp_s_fu_449_p3;
wire   [31:0] tmp_fu_485_p17;
wire   [31:0] tmp_1_fu_524_p17;
reg    ap_done_reg;
...
wire   [2:0] tmp_fu_485_p3;
wire   [2:0] tmp_fu_485_p5;
wire   [2:0] tmp_fu_485_p7;
wire  signed [2:0] tmp_fu_485_p9;
wire  signed [2:0] tmp_fu_485_p11;
wire  signed [2:0] tmp_fu_485_p13;
wire  signed [2:0] tmp_fu_485_p15;
wire   [2:0] tmp_1_fu_524_p1;
wire   [2:0] tmp_1_fu_524_p3;
wire   [2:0] tmp_1_fu_524_p5;
wire   [2:0] tmp_1_fu_524_p7;
wire  signed [2:0] tmp_1_fu_524_p9;
wire  signed [2:0] tmp_1_fu_524_p11;
wire  signed [2:0] tmp_1_fu_524_p13;
wire  signed [2:0] tmp_1_fu_524_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U1214(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.din4(buff_B_4_q0),.din5(buff_B_5_q0),.din6(buff_B_6_q0),.din7(buff_B_7_q0),.def(tmp_fu_485_p17),.sel(trunc_ln30_1_reg_593),.dout(tmp_fu_485_p19));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U1215(.din0(buff_C_out_q1),.din1(buff_C_out_1_q1),.din2(buff_C_out_2_q1),.din3(buff_C_out_3_q1),.din4(buff_C_out_4_q1),.din5(buff_C_out_5_q1),.din6(buff_C_out_6_q1),.din7(buff_C_out_7_q1),.def(tmp_1_fu_524_p17),.sel(trunc_ln30_1_reg_593_pp0_iter5_reg),.dout(tmp_1_fu_524_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_714 <= grp_fu_588_p_dout0;
        ...
        mul2_reg_704 <= grp_fu_584_p_dout0;
        tmp_1_reg_709 <= tmp_1_fu_524_p19;
        tmp_reg_651 <= tmp_fu_485_p19;
...
assign grp_fu_584_p_din0 = tmp_reg_651;
assign grp_fu_584_p_din1 = beta;
assign grp_fu_588_p_ce = 1'b1;
assign grp_fu_588_p_din0 = tmp_1_reg_709;
assign grp_fu_588_p_din1 = mul2_reg_704;
...
assign lshr_ln5_4_fu_439_p4 = {{select_ln5_fu_415_p3[5:3]}};
...
assign tmp_1_fu_524_p17 = 'bx;
assign tmp_fu_485_p17 = 'bx;
assign tmp_s_fu_449_p3 = {{trunc_ln30_fu_431_p1}, {lshr_ln5_4_fu_439_p4}};
