...
reg   [31:0] D_19_reg_1390;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] C_21_reg_1395;
reg   [31:0] A_20_reg_1401;
wire   [31:0] temp_fu_656_p2;
reg   [31:0] temp_reg_1407;
wire   [31:0] C_22_fu_676_p3;
reg   [31:0] C_22_reg_1413;
wire   [26:0] trunc_ln118_2_fu_684_p1;
reg   [26:0] trunc_ln118_2_reg_1420;
reg   [4:0] lshr_ln118_2_reg_1425;
wire   [31:0] E_33_fu_712_p3;
reg   [31:0] E_33_reg_1430;
wire   [31:0] D_20_fu_734_p3;
reg   [31:0] D_20_reg_1438;
...
wire   [31:0] B_31_fu_879_p2;
reg   [31:0] B_31_reg_1487;
...
wire   [31:0] C_23_fu_925_p3;
reg   [31:0] C_23_reg_1521;
wire   [31:0] temp_14_fu_988_p2;
reg   [31:0] temp_14_reg_1528;
...
wire   [31:0] C_24_fu_1051_p3;
reg   [31:0] C_24_reg_1559;
...
reg   [31:0] E_1_fu_128;
wire   [31:0] C_25_fu_1102_p3;
wire    ap_loop_init;
wire    ap_block_pp0_stage1;
reg   [31:0] E_22_fu_132;
wire   [31:0] C_26_fu_1146_p3;
reg   [31:0] E_23_fu_136;
wire   [31:0] C_9_fu_1190_p3;
reg   [31:0] B_1_fu_140;
wire   [31:0] temp_16_fu_1234_p2;
reg   [31:0] B_21_fu_144;
wire   [31:0] temp_17_fu_1289_p2;
reg   [4:0] i_1_fu_148;
...
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U104(.din0(W_1),.din1(W_9),.din2(W_33_reload),.def(tmp_14_fu_414_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_14_fu_414_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U105(.din0(W_2),.din1(W_10),.din2(W_34_reload),.def(tmp_15_fu_434_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_15_fu_434_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U106(.din0(W_3),.din1(W_11),.din2(W_35_reload),.def(tmp_16_fu_454_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_16_fu_454_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U107(.din0(W_4),.din1(W_12),.din2(W_36_reload),.def(tmp_18_fu_498_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_18_fu_498_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U108(.din0(W_5),.din1(W_13),.din2(W_37_reload),.def(tmp_19_fu_518_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_19_fu_518_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U109(.din0(W_6),.din1(W_14),.din2(W_38_reload),.def(tmp_20_fu_538_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_20_fu_538_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h8 ),.din1_WIDTH( 32 ),.CASE2( 5'h10 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U110(.din0(W_7),.din1(W_15),.din2(W_39_reload),.def(tmp_21_fu_558_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_21_fu_558_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            B_21_fu_144 <= temp_17_fu_1289_p2;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        A_20_reg_1401 <= B_21_fu_144;
        C_21_reg_1395 <= E_23_fu_136;
        C_22_reg_1413 <= C_22_fu_676_p3;
        D_19_reg_1390 <= E_22_fu_132;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        ...
        C_23_reg_1521 <= C_23_fu_925_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        B_31_reg_1487 <= B_31_fu_879_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        C_24_reg_1559 <= C_24_fu_1051_p3;
        lshr_ln118_11_reg_1569 <= {{temp_15_fu_1085_p2[31:27]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        D_20_reg_1438 <= D_20_fu_734_p3;
        E_33_reg_1430 <= E_33_fu_712_p3;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        lshr_ln118_12_reg_1549 <= {{temp_14_fu_988_p2[31:2]}};
        lshr_ln118_s_reg_1539 <= {{temp_14_fu_988_p2[31:27]}};
        temp_14_reg_1528 <= temp_14_fu_988_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage12_11001) & (1'b1 == ap_CS_fsm_pp0_stage12))) begin
        lshr_ln118_13_reg_1594 <= {{temp_16_fu_1234_p2[31:27]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        lshr_ln118_6_reg_1501 <= {{B_31_fu_879_p2[31:27]}};
...
assign B_31_fu_879_p2 = (add_ln118_10_reg_1477 + add_ln118_8_fu_874_p2);
assign B_31_out = B_31_reg_1487;
assign C_22_fu_676_p3 = {{trunc_ln118_1_fu_662_p1}, {lshr_ln118_1_fu_666_p4}};
assign C_23_fu_925_p3 = {{trunc_ln118_7_reg_1467}, {lshr_ln118_7_reg_1472}};
assign C_24_fu_1051_p3 = {{trunc_ln118_9_fu_1039_p1}, {lshr_ln118_9_fu_1042_p4}};
assign C_25_fu_1102_p3 = {{trunc_ln118_11_fu_1090_p1}, {lshr_ln118_10_fu_1093_p4}};
assign C_26_fu_1146_p3 = {{trunc_ln118_13_reg_1544}, {lshr_ln118_12_reg_1549}};
assign C_42_out = {{trunc_ln118_7_reg_1467}, {lshr_ln118_7_reg_1472}};
assign C_9_fu_1190_p3 = {{trunc_ln118_15_fu_1176_p1}, {lshr_ln118_14_fu_1180_p4}};
assign D_20_fu_734_p3 = {{trunc_ln118_5_fu_720_p1}, {lshr_ln118_5_fu_724_p4}};
assign D_35_out = D_20_reg_1438;
assign E_31_out = E_33_reg_1430;
assign E_33_fu_712_p3 = {{trunc_ln118_3_fu_698_p1}, {lshr_ln118_3_fu_702_p4}};
assign add_ln116_fu_1275_p2 = (i_reg_1341 + 5'd8);
assign add_ln118_10_fu_829_p2 = (add_ln118_9_fu_823_p2 + C_21_reg_1395);
...
assign add_ln118_14_fu_910_p2 = (add_ln118_13_fu_904_p2 + C_22_reg_1413);
...
assign add_ln118_18_fu_977_p2 = (add_ln118_17_fu_972_p2 + E_33_reg_1430);
...
assign add_ln118_22_fu_1034_p2 = (add_ln118_21_fu_1028_p2 + D_20_reg_1438);
...
assign add_ln118_26_fu_1225_p2 = (add_ln118_25_fu_1219_p2 + C_23_reg_1521);
assign add_ln118_28_fu_1285_p2 = (C_24_reg_1559 + tmp_21_reg_1385);
...
assign add_ln118_6_fu_754_p2 = (add_ln118_5_fu_748_p2 + D_19_reg_1390);
...
assign and_ln118_10_fu_1064_p2 = (C_24_fu_1051_p3 & A_21_reg_1511);
assign and_ln118_11_fu_1069_p2 = (xor_ln118_5_fu_1059_p2 & C_23_reg_1521);
assign and_ln118_12_fu_1129_p2 = (temp_14_reg_1528 & C_25_fu_1102_p3);
assign and_ln118_13_fu_1134_p2 = (xor_ln118_6_fu_1124_p2 & C_24_fu_1051_p3);
assign and_ln118_14_fu_1158_p2 = (temp_15_fu_1085_p2 & C_26_fu_1146_p3);
assign and_ln118_15_fu_1164_p2 = (xor_ln118_7_fu_1152_p2 & C_25_fu_1102_p3);
assign and_ln118_1_fu_619_p2 = (xor_ln118_fu_607_p2 & E_22_fu_132);
assign and_ln118_2_fu_764_p2 = (C_22_reg_1413 & A_20_reg_1401);
assign and_ln118_3_fu_768_p2 = (xor_ln118_1_fu_759_p2 & C_21_reg_1395);
assign and_ln118_4_fu_859_p2 = (temp_reg_1407 & E_33_reg_1430);
assign and_ln118_5_fu_863_p2 = (xor_ln118_2_fu_854_p2 & C_22_reg_1413);
assign and_ln118_6_fu_839_p2 = (temp_13_reg_1451 & D_20_reg_1438);
assign and_ln118_7_fu_843_p2 = (xor_ln118_3_fu_834_p2 & E_33_reg_1430);
assign and_ln118_8_fu_949_p2 = (C_23_reg_1521 & B_31_reg_1487);
assign and_ln118_9_fu_953_p2 = (xor_ln118_4_fu_944_p2 & D_20_reg_1438);
assign and_ln118_fu_613_p2 = (E_23_fu_136 & B_1_fu_140);
...
assign lshr_ln118_14_fu_1180_p4 = {{temp_15_fu_1085_p2[31:2]}};
assign lshr_ln118_1_fu_666_p4 = {{B_1_fu_140[31:2]}};
assign lshr_ln118_3_fu_702_p4 = {{B_21_fu_144[31:2]}};
assign lshr_ln118_5_fu_724_p4 = {{temp_fu_656_p2[31:2]}};
assign lshr_ln118_8_fu_935_p4 = {{A_21_reg_1511[31:27]}};
assign lshr_ln118_9_fu_1042_p4 = {{B_31_reg_1487[31:2]}};
assign lshr_ln_fu_597_p4 = {{B_21_fu_144[31:27]}};
...
assign temp_14_fu_988_p2 = (add_ln118_16_fu_982_p2 + add_ln118_18_fu_977_p2);
assign temp_15_fu_1085_p2 = (add_ln118_22_reg_1554 + add_ln118_20_fu_1080_p2);
assign temp_16_fu_1234_p2 = (add_ln118_26_reg_1584 + add_ln118_24_fu_1230_p2);
assign temp_17_fu_1289_p2 = (add_ln118_30_reg_1599 + add_ln118_28_fu_1285_p2);
...
assign trunc_ln118_10_fu_994_p1 = temp_14_fu_988_p2[26:0];
assign trunc_ln118_11_fu_1090_p1 = A_21_reg_1511[1:0];
assign trunc_ln118_12_fu_1110_p1 = temp_15_fu_1085_p2[26:0];
assign trunc_ln118_13_fu_1008_p1 = temp_14_fu_988_p2[1:0];
assign trunc_ln118_14_fu_1239_p1 = temp_16_fu_1234_p2[26:0];
assign trunc_ln118_15_fu_1176_p1 = temp_15_fu_1085_p2[1:0];
assign trunc_ln118_1_fu_662_p1 = B_1_fu_140[1:0];
assign trunc_ln118_2_fu_684_p1 = temp_fu_656_p2[26:0];
assign trunc_ln118_3_fu_698_p1 = B_21_fu_144[1:0];
assign trunc_ln118_4_fu_789_p1 = temp_13_fu_784_p2[26:0];
assign trunc_ln118_5_fu_720_p1 = temp_fu_656_p2[1:0];
assign trunc_ln118_6_fu_884_p1 = B_31_fu_879_p2[26:0];
assign trunc_ln118_7_fu_803_p1 = temp_13_fu_784_p2[1:0];
assign trunc_ln118_8_fu_932_p1 = A_21_reg_1511[26:0];
assign trunc_ln118_9_fu_1039_p1 = B_31_reg_1487[1:0];
assign trunc_ln118_fu_593_p1 = B_21_fu_144[26:0];
...
assign xor_ln118_4_fu_944_p2 = (32'd4294967295 ^ B_31_reg_1487);
assign xor_ln118_5_fu_1059_p2 = (32'd4294967295 ^ A_21_reg_1511);
assign xor_ln118_6_fu_1124_p2 = (temp_14_reg_1528 ^ 32'd4294967295);
assign xor_ln118_7_fu_1152_p2 = (temp_15_fu_1085_p2 ^ 32'd4294967295);
