module backprop_backprop_Pipeline_label_27_label_28 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v12_address0,v12_ce0,v12_q0,v0_address0,v0_ce0,v0_we0,v0_d0,v0_q0,v150_out,v150_out_ap_vld,grp_fu_3531_p_din0,grp_fu_3531_p_din1,grp_fu_3531_p_opcode,grp_fu_3531_p_dout0,grp_fu_3531_p_ce,grp_fu_3539_p_din0,grp_fu_3539_p_din1,grp_fu_3539_p_dout0,grp_fu_3539_p_ce); 
...
output  [1:0] grp_fu_3531_p_opcode;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        v148_fu_56 <= grp_fu_3531_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        v152_reg_304 <= grp_fu_3539_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v154_reg_319 <= grp_fu_3531_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v155_reg_326 <= grp_fu_3539_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v148_load_1 = grp_fu_3531_p_dout0;
    end else begin
...
assign grp_fu_3531_p_din0 = grp_fu_104_p0;
assign grp_fu_3531_p_din1 = grp_fu_104_p1;
assign grp_fu_3531_p_opcode = grp_fu_104_opcode;
assign grp_fu_3539_p_ce = 1'b1;
assign grp_fu_3539_p_din0 = grp_fu_108_p0;
assign grp_fu_3539_p_din1 = grp_fu_108_p1;
