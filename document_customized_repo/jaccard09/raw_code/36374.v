...
reg    ap_predicate_op35_call_state4;
reg    ap_predicate_op37_call_state4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state5) & (icmp_ln43_1_fu_199_p2 == 1'd1)) | ((1'b1 == ap_CS_fsm_state5) & (icmp_ln43_1_fu_199_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state3) & (icmp_ln43_fu_147_p2 == 1'd1)) | ((1'b1 == ap_CS_fsm_state3) & (icmp_ln43_fu_147_p2 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        from_fu_52 <= i_fu_205_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        add_ln41_2_reg_276 <= add_ln41_2_fu_173_p2;
        from_2_reg_267 <= from_2_fu_153_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        add_ln41_reg_241 <= add_ln41_fu_116_p2;
        add_ln42_reg_247 <= add_ln42_fu_121_p2;
        icmp_ln39_reg_237 <= icmp_ln39_fu_110_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        icmp_ln43_1_reg_292 <= icmp_ln43_1_fu_199_p2;
        mid_1_reg_282 <= mid_1_fu_178_p2;
        to_1_reg_287 <= to_1_fu_184_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        icmp_ln43_reg_263 <= icmp_ln43_fu_147_p2;
        mid_reg_253 <= mid_fu_126_p2;
        to_reg_258 <= to_fu_132_p2;
    end
end
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd1)) | ((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd0)) | ((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd1)) | ((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd0)))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4) & ((icmp_ln39_reg_237 == 1'd0) | (icmp_ln39_1_fu_167_p2 == 1'd0))) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4) & ((icmp_ln39_reg_237 == 1'd0) | (icmp_ln39_1_fu_167_p2 == 1'd0)))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd1)) | ((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd0)))) begin
        grp_merge_fu_68_m = mid_1_reg_282;
    end else if ((((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd1)) | ((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd0)))) begin
        grp_merge_fu_68_m = mid_reg_253;
    end else begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd1)) | ((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd0)))) begin
        grp_merge_fu_68_start_r = from_2_reg_267;
    end else if ((((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd1)) | ((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd0)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd1))) begin
        grp_merge_fu_68_stop = to_1_reg_287;
    end else if (((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd1))) begin
        grp_merge_fu_68_stop = to_reg_258;
    end else if ((((1'b1 == ap_CS_fsm_state6) & (icmp_ln43_1_reg_292 == 1'd0)) | ((icmp_ln39_reg_237 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln43_reg_263 == 1'd0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4) & ((icmp_ln39_reg_237 == 1'd0) | (icmp_ln39_1_fu_167_p2 == 1'd0)))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((icmp_ln39_reg_237 == 1'd1) & (icmp_ln39_1_fu_167_p2 == 1'd1) & (1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    ap_block_state4_on_subcall_done = (((ap_predicate_op37_call_state4 == 1'b1) & (grp_merge_fu_68_ap_done == 1'b0)) | ((ap_predicate_op35_call_state4 == 1'b1) & (grp_merge_fu_68_ap_done == 1'b0)));
end
always @ (*) begin
    ap_block_state6_on_subcall_done = (((grp_merge_fu_68_ap_done == 1'b0) & (icmp_ln43_1_reg_292 == 1'd1)) | ((grp_merge_fu_68_ap_done == 1'b0) & (icmp_ln43_1_reg_292 == 1'd0)));
end
always @ (*) begin
    ap_predicate_op35_call_state4 = ((icmp_ln39_reg_237 == 1'd1) & (icmp_ln43_reg_263 == 1'd0));
end
always @ (*) begin
    ap_predicate_op37_call_state4 = ((icmp_ln39_reg_237 == 1'd1) & (icmp_ln43_reg_263 == 1'd1));
end
assign from_2_fu_153_p2 = (from_fu_52 + empty);
assign grp_merge_fu_68_ap_start = grp_merge_fu_68_ap_start_reg;
assign i_fu_205_p2 = (from_2_reg_267 + empty);
...
assign mid_1_fu_178_p2 = ($signed(add_ln41_2_reg_276) + $signed(32'd4294967295));
assign mid_fu_126_p2 = ($signed(add_ln41_reg_241) + $signed(32'd4294967295));
...
assign to_1_fu_184_p2 = (add_ln41_2_reg_276 + add_ln42_reg_247);
assign to_fu_132_p2 = (add_ln41_reg_241 + add_ln42_reg_247);
endmodule 