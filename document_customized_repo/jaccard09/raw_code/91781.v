...
reg   [11:0] indvar_flatten35_fu_92;
...
wire   [4:0] lshr_ln6_9_fu_289_p4;
wire   [8:0] tmp_2_fu_309_p3;
wire   [31:0] tmp_s_fu_345_p9;
wire   [31:0] tmp_3_fu_368_p9;
reg    ap_done_reg;
...
wire   [1:0] tmp_3_fu_368_p1;
wire   [1:0] tmp_3_fu_368_p3;
wire  signed [1:0] tmp_3_fu_368_p5;
wire  signed [1:0] tmp_3_fu_368_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_84 = 7'd0;
#0 i_fu_88 = 7'd0;
#0 indvar_flatten35_fu_92 = 12'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_9_2_32_1_1_U442(.din0(buff_E_out_q0),.din1(buff_E_out_1_q0),.din2(buff_E_out_2_q0),.din3(buff_E_out_3_q0),.def(tmp_s_fu_345_p9),.sel(trunc_ln50_reg_424),.dout(tmp_s_fu_345_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U443(.din0(buff_E_out_4_q0),.din1(buff_E_out_5_q0),.din2(buff_E_out_6_q0),.din3(buff_E_out_7_q0),.def(tmp_3_fu_368_p9),.sel(trunc_ln50_reg_424),.dout(tmp_3_fu_368_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln50_fu_232_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten35_fu_92 <= add_ln50_1_fu_238_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten35_fu_92 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        tmp_3_reg_475 <= tmp_3_fu_368_p11;
...
assign add_ln50_1_fu_238_p2 = (ap_sig_allocacmp_indvar_flatten35_load + 12'd1);
...
assign bitcast_ln52_1_fu_395_p1 = tmp_3_reg_475;
...
assign icmp_ln50_fu_232_p2 = ((ap_sig_allocacmp_indvar_flatten35_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_9_fu_289_p4 = {{select_ln6_fu_269_p3[5:1]}};
...
assign tmp_2_fu_309_p3 = {{tmp_1_fu_299_p4}, {lshr_ln6_9_fu_289_p4}};
assign tmp_3_fu_368_p9 = 'bx;
assign tmp_fu_261_p3 = j_fu_84[32'd6];
assign tmp_s_fu_345_p9 = 'bx;
assign trunc_ln50_fu_285_p1 = select_ln50_fu_277_p3[1:0];
assign zext_ln52_fu_317_p1 = tmp_2_fu_309_p3;
endmodule 