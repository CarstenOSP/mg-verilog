module ss_sort_ss_sort_Pipeline_hist_1_hist_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,a_0_address0,a_0_ce0,a_0_q0,a_1_address0,a_1_ce0,a_1_q0,zext_ln50,bucket_0_address0,bucket_0_ce0,bucket_0_we0,bucket_0_d0,bucket_0_q0,bucket_1_address0,bucket_1_ce0,bucket_1_we0,bucket_1_d0,bucket_1_q0); 
...
reg    ap_ready_int;
wire   [31:0] zext_ln50_cast_fu_134_p1;
reg   [31:0] zext_ln50_cast_reg_338;
...
wire   [9:0] add_ln54_2_fu_193_p2;
wire   [2:0] select_ln52_fu_185_p3;
wire   [0:0] tmp_fu_219_p3;
wire   [9:0] add_ln_fu_227_p3;
wire    ap_block_pp0_stage2;
wire   [31:0] ashr_ln57_fu_267_p2;
wire   [1:0] trunc_ln57_fu_271_p1;
wire   [10:0] or_ln57_3_fu_275_p3;
wire   [10:0] blockID_cast_cast9_fu_264_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        empty_24_reg_352 <= empty_24_fu_211_p1;
        empty_24_reg_352_pp0_iter1_reg <= empty_24_reg_352;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln2_reg_377 <= {{bucket_indx_fu_283_p2[10:1]}};
        zext_ln50_cast_reg_338[4 : 0] <= zext_ln50_cast_fu_134_p1[4 : 0];
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (empty_24_reg_352_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (empty_24_reg_352_pp0_iter1_reg == 1'd0))) begin
...
assign a_0_address0 = zext_ln57_fu_235_p1;
assign a_0_ce0 = a_0_ce0_local;
assign a_1_address0 = zext_ln57_fu_235_p1;
assign a_1_ce0 = a_1_ce0_local;
assign add_ln54_2_fu_193_p2 = (blockID_fu_68 + 10'd1);
assign add_ln54_fu_162_p2 = (ap_sig_allocacmp_indvar_flatten_load + 12'd1);
assign add_ln55_fu_241_p2 = (select_ln52_fu_185_p3 + 3'd1);
assign add_ln58_fu_311_p2 = (select_ln58_fu_304_p3 + 32'd1);
assign add_ln_fu_227_p3 = {{empty_fu_207_p1}, {tmp_fu_219_p3}};
...
assign ashr_ln57_fu_267_p2 = $signed(select_ln57_reg_372) >>> zext_ln50_cast_reg_338;
assign blockID_cast_cast9_fu_264_p1 = empty_reg_347;
...
assign bucket_indx_fu_283_p2 = (or_ln57_3_fu_275_p3 + blockID_cast_cast9_fu_264_p1);
assign empty_24_fu_211_p1 = select_ln54_fu_199_p3[0:0];
assign empty_fu_207_p1 = select_ln54_fu_199_p3[8:0];
assign icmp_ln54_fu_156_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 12'd2048) ? 1'b1 : 1'b0);
assign icmp_ln55_fu_179_p2 = ((i_1_fu_64 == 3'd4) ? 1'b1 : 1'b0);
assign or_ln57_3_fu_275_p3 = {{trunc_ln57_fu_271_p1}, {9'd1}};
assign select_ln52_fu_185_p3 = ((icmp_ln55_fu_179_p2[0:0] == 1'b1) ? 3'd0 : i_1_fu_64);
assign select_ln54_fu_199_p3 = ((icmp_ln55_fu_179_p2[0:0] == 1'b1) ? add_ln54_2_fu_193_p2 : blockID_fu_68);
assign select_ln57_fu_257_p3 = ((trunc_ln55_reg_357[0:0] == 1'b1) ? a_1_q0 : a_0_q0);
assign select_ln58_fu_304_p3 = ((empty_24_reg_352_pp0_iter1_reg[0:0] == 1'b1) ? bucket_0_q0 : bucket_1_q0);
...
assign zext_ln50_cast_fu_134_p1 = zext_ln50;
assign zext_ln52_fu_299_p1 = lshr_ln2_reg_377;
assign zext_ln57_fu_235_p1 = add_ln_fu_227_p3;
always @ (posedge ap_clk) begin
    zext_ln50_cast_reg_338[31:5] <= 27'b000000000000000000000000000;
end
endmodule 