...
wire   [2:0] lshr_ln_fu_508_p4;
wire   [4:0] tmp_s_fu_545_p4;
wire   [5:0] or_ln_fu_555_p3;
wire   [31:0] v6_fu_604_p17;
wire   [9:0] tmp_fu_643_p3;
wire   [5:0] or_ln7_fu_657_p4;
wire   [5:0] or_ln8_fu_670_p3;
wire   [9:0] tmp_12_fu_682_p4;
wire   [0:0] icmp_ln31_fu_701_p2;
wire   [5:0] or_ln9_fu_713_p4;
wire   [5:0] or_ln1_fu_785_p5;
wire   [5:0] or_ln2_fu_808_p4;
wire   [5:0] or_ln3_fu_821_p3;
reg    ap_done_reg;
...
sparsemux_17_3_32_1_1_U23(.din0(v124_q0),.din1(v124_1_q0),.din2(v124_2_q0),.din3(v124_3_q0),.din4(v124_4_q0),.din5(v124_5_q0),.din6(v124_6_q0),.din7(v124_7_q0),.def(v6_fu_604_p17),.sel(trunc_ln27_1_reg_927),.dout(v6_fu_604_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        v47_reg_1261 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        v11_reg_1160 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        v17_reg_1175 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v23_reg_1190 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v29_reg_1205 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v35_reg_1220 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v36_reg_1286 <= grp_fu_127_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v41_reg_1240 <= grp_fu_131_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v42_reg_1291 <= grp_fu_127_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v48_reg_1296 <= grp_fu_127_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v53_reg_1276 <= grp_fu_131_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_127_p_din0 = grp_fu_413_p0;
assign grp_fu_127_p_din1 = grp_fu_413_p1;
assign grp_fu_127_p_opcode = 2'd0;
assign grp_fu_131_p_ce = 1'b1;
assign grp_fu_131_p_din0 = grp_fu_417_p0;
assign grp_fu_131_p_din1 = v3_reg_1080;
...
assign lshr_ln_fu_508_p4 = {{select_ln27_fu_492_p3[5:3]}};
assign or_ln1_fu_785_p5 = {{{{tmp_11_reg_996_pp0_iter1_reg}, {1'd1}}, {tmp_8_reg_1010_pp0_iter1_reg}}, {1'd1}};
assign or_ln2_fu_808_p4 = {{{tmp_11_reg_996_pp0_iter1_reg}, {2'd3}}, {trunc_ln46_reg_990_pp0_iter1_reg}};
assign or_ln3_fu_821_p3 = {{tmp_11_reg_996_pp0_iter1_reg}, {3'd7}};
assign or_ln7_fu_657_p4 = {{{lshr_ln2_reg_972}, {1'd1}}, {trunc_ln46_reg_990}};
assign or_ln8_fu_670_p3 = {{lshr_ln2_reg_972}, {2'd3}};
assign or_ln9_fu_713_p4 = {{{tmp_11_reg_996}, {1'd1}}, {trunc_ln60_reg_1005}};
...
assign zext_ln26_fu_518_p1 = lshr_ln_fu_508_p4;
...
assign zext_ln46_fu_665_p1 = or_ln7_fu_657_p4;
assign zext_ln53_fu_677_p1 = or_ln8_fu_670_p3;
assign zext_ln60_fu_721_p1 = or_ln9_fu_713_p4;
assign zext_ln61_fu_690_p1 = tmp_12_fu_682_p4;
assign zext_ln67_fu_795_p1 = or_ln1_fu_785_p5;
assign zext_ln74_fu_816_p1 = or_ln2_fu_808_p4;
assign zext_ln82_fu_828_p1 = or_ln3_fu_821_p3;
always @ (posedge ap_clk) begin
