...
output  [63:0] grp_fu_920_p_din0;
output  [63:0] grp_fu_920_p_din1;
output  [1:0] grp_fu_920_p_opcode;
input  [63:0] grp_fu_920_p_dout0;
output   grp_fu_920_p_ce;
output  [63:0] grp_fu_1924_p_din0;
output  [63:0] grp_fu_1924_p_din1;
output  [4:0] grp_fu_1924_p_opcode;
input  [0:0] grp_fu_1924_p_dout0;
...
wire   [0:0] tmp_14_fu_446_p3;
reg   [0:0] tmp_14_reg_909_pp0_iter1_reg;
reg   [0:0] tmp_14_reg_909_pp0_iter2_reg;
reg   [0:0] tmp_14_reg_909_pp0_iter3_reg;
reg   [0:0] tmp_14_reg_909_pp0_iter4_reg;
reg   [63:0] llike_load_1_reg_953;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
wire   [63:0] tmp_7_fu_521_p19;
reg   [63:0] tmp_7_reg_958;
wire   [63:0] tmp_s_fu_605_p19;
reg   [63:0] tmp_s_reg_968;
reg   [63:0] llike_load_reg_973;
...
reg   [63:0] p_reg_988;
reg   [63:0] min_p_7_reg_995;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3_11001;
reg   [63:0] p_2_reg_1002;
wire   [0:0] and_ln29_1_fu_724_p2;
reg   [0:0] and_ln29_1_reg_1009;
wire   [63:0] min_p_9_fu_730_p3;
reg   [63:0] min_p_9_reg_1014;
...
wire   [2:0] tmp_s_fu_605_p1;
wire   [2:0] tmp_s_fu_605_p3;
wire   [2:0] tmp_s_fu_605_p5;
wire   [2:0] tmp_s_fu_605_p7;
wire  signed [2:0] tmp_s_fu_605_p9;
wire  signed [2:0] tmp_s_fu_605_p11;
wire  signed [2:0] tmp_s_fu_605_p13;
wire  signed [2:0] tmp_s_fu_605_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 5'd1;
...
sparsemux_17_3_64_1_1_U31(.din0(tmp_7_fu_521_p2),.din1(tmp_7_fu_521_p4),.din2(tmp_7_fu_521_p6),.din3(tmp_7_fu_521_p8),.din4(tmp_7_fu_521_p10),.din5(tmp_7_fu_521_p12),.din6(tmp_7_fu_521_p14),.din7(tmp_7_fu_521_p16),.def(tmp_7_fu_521_p17),.sel(empty_10),.dout(tmp_7_fu_521_p19));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U32(.din0(tmp_s_fu_605_p2),.din1(tmp_s_fu_605_p4),.din2(tmp_s_fu_605_p6),.din3(tmp_s_fu_605_p8),.din4(tmp_s_fu_605_p10),.din5(tmp_s_fu_605_p12),.din6(tmp_s_fu_605_p14),.din7(tmp_s_fu_605_p16),.def(tmp_s_fu_605_p17),.sel(empty_10),.dout(tmp_s_fu_605_p19));
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (tmp_14_reg_909_pp0_iter4_reg == 1'd0))) begin
        min_p_fu_110 <= min_p_11_fu_818_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_14_fu_446_p3 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        add1_reg_978 <= grp_fu_920_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add52_1_reg_983 <= grp_fu_920_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_ln25_reg_904 <= add_ln25_fu_440_p2;
        tmp_14_reg_909 <= add_ln25_fu_440_p2[32'd6];
        tmp_14_reg_909_pp0_iter1_reg <= tmp_14_reg_909;
        tmp_14_reg_909_pp0_iter2_reg <= tmp_14_reg_909_pp0_iter1_reg;
        tmp_14_reg_909_pp0_iter3_reg <= tmp_14_reg_909_pp0_iter2_reg;
        tmp_14_reg_909_pp0_iter4_reg <= tmp_14_reg_909_pp0_iter3_reg;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        llike_load_1_reg_953 <= llike_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        llike_load_reg_973 <= llike_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        min_p_7_reg_995 <= min_p_fu_110;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_9_reg_1014 <= min_p_9_fu_730_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        p_2_reg_1002 <= grp_fu_920_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_reg_988 <= grp_fu_920_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_17_reg_1021 <= grp_fu_1924_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_7_reg_958 <= tmp_7_fu_521_p19;
        tmp_s_reg_968 <= tmp_s_fu_605_p19;
    end
end
always @ (*) begin
    if (((tmp_14_reg_909 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_14_reg_909_pp0_iter3_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        grp_fu_382_p0 = llike_load_reg_973;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_382_p0 = llike_load_1_reg_953;
    end else begin
        grp_fu_382_p0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_386_p1 = min_p_9_fu_730_p3;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter4_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_14_reg_909_pp0_iter3_reg == 1'd1))) begin
...
assign and_ln29_3_fu_813_p2 = (tmp_17_reg_1021 & and_ln29_2_fu_807_p2);
assign and_ln29_fu_718_p2 = (or_ln29_fu_694_p2 & grp_fu_1924_p_dout0);
...
assign bitcast_ln29_1_fu_665_p1 = min_p_7_reg_995;
assign bitcast_ln29_2_fu_737_p1 = p_2_reg_1002;
assign bitcast_ln29_3_fu_754_p1 = min_p_9_reg_1014;
assign bitcast_ln29_fu_648_p1 = p_reg_988;
assign grp_fu_1924_p_ce = 1'b1;
assign grp_fu_1924_p_din0 = grp_fu_386_p0;
assign grp_fu_1924_p_din1 = grp_fu_386_p1;
assign grp_fu_1924_p_opcode = 5'd4;
assign grp_fu_920_p_ce = 1'b1;
assign grp_fu_920_p_din0 = grp_fu_382_p0;
assign grp_fu_920_p_din1 = grp_fu_382_p1;
assign grp_fu_920_p_opcode = 2'd0;
assign icmp_ln29_1_fu_688_p2 = ((trunc_ln29_fu_661_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_2_fu_700_p2 = ((tmp_12_fu_668_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_3_fu_706_p2 = ((trunc_ln29_1_fu_678_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_4_fu_771_p2 = ((tmp_15_fu_740_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_5_fu_777_p2 = ((trunc_ln29_2_fu_750_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_6_fu_789_p2 = ((tmp_16_fu_757_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_7_fu_795_p2 = ((trunc_ln29_3_fu_767_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_fu_682_p2 = ((tmp_11_fu_651_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign llike_address0 = llike_address0_local;
assign llike_ce0 = llike_ce0_local;
assign min_p_10_out = ((and_ln29_1_reg_1009[0:0] == 1'b1) ? p_reg_988 : min_p_7_reg_995);
assign min_p_11_fu_818_p3 = ((and_ln29_3_fu_813_p2[0:0] == 1'b1) ? p_2_reg_1002 : min_p_9_reg_1014);
assign min_p_9_fu_730_p3 = ((and_ln29_1_reg_1009[0:0] == 1'b1) ? p_reg_988 : min_p_7_reg_995);
...
assign tmp_10_fu_403_p3 = {{empty_9}, {ap_sig_allocacmp_prev_1}};
assign tmp_11_fu_651_p4 = {{bitcast_ln29_fu_648_p1[62:52]}};
assign tmp_12_fu_668_p4 = {{bitcast_ln29_1_fu_665_p1[62:52]}};
assign tmp_14_fu_446_p3 = add_ln25_fu_440_p2[32'd6];
assign tmp_15_fu_740_p4 = {{bitcast_ln29_2_fu_737_p1[62:52]}};
assign tmp_16_fu_757_p4 = {{bitcast_ln29_3_fu_754_p1[62:52]}};
...
assign tmp_s_fu_605_p10 = transition_4_q0;
assign tmp_s_fu_605_p12 = transition_5_q0;
assign tmp_s_fu_605_p14 = transition_6_q0;
assign tmp_s_fu_605_p16 = transition_7_q0;
assign tmp_s_fu_605_p17 = 'bx;
assign tmp_s_fu_605_p2 = transition_0_q0;
assign tmp_s_fu_605_p4 = transition_1_q0;
assign tmp_s_fu_605_p6 = transition_2_q0;
assign tmp_s_fu_605_p8 = transition_3_q0;
...
assign zext_ln26_fu_411_p1 = tmp_10_fu_403_p3;
