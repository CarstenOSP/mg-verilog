...
wire   [1:0] trunc_ln51_1_fu_212_p1;
reg   [1:0] trunc_ln51_1_reg_310;
wire   [31:0] tmp_2_fu_258_p11;
reg   [31:0] tmp_2_reg_335;
wire   [63:0] zext_ln52_fu_234_p1;
reg   [6:0] j_fu_68;
wire   [6:0] add_ln51_fu_242_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_72;
wire   [6:0] select_ln50_fu_200_p3;
reg   [12:0] indvar_flatten91_fu_76;
wire   [12:0] add_ln50_1_fu_163_p2;
reg   [12:0] ap_sig_allocacmp_indvar_flatten91_load;
wire   [31:0] bitcast_ln52_fu_281_p1;
...
wire   [6:0] add_ln50_fu_180_p2;
wire   [6:0] select_ln6_fu_192_p3;
wire   [5:0] trunc_ln51_fu_208_p1;
wire   [3:0] lshr_ln6_3_fu_216_p4;
wire   [9:0] tmp_9_fu_226_p3;
wire   [31:0] tmp_2_fu_258_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_2_fu_258_p1;
wire   [1:0] tmp_2_fu_258_p3;
wire  signed [1:0] tmp_2_fu_258_p5;
wire  signed [1:0] tmp_2_fu_258_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U765(.din0(buff_E_out_q0),.din1(buff_E_out_1_q0),.din2(buff_E_out_2_q0),.din3(buff_E_out_3_q0),.def(tmp_2_fu_258_p9),.sel(trunc_ln51_1_reg_310),.dout(tmp_2_fu_258_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_fu_72 <= select_ln50_fu_200_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln50_fu_157_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten91_fu_76 <= add_ln50_1_fu_163_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln51_1_reg_310 <= trunc_ln51_1_fu_212_p1;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        tmp_2_reg_335 <= tmp_2_fu_258_p11;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln50_fu_157_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign E_out_din = bitcast_ln52_fu_281_p1;
assign E_out_write = E_out_write_local;
assign add_ln50_1_fu_163_p2 = (ap_sig_allocacmp_indvar_flatten91_load + 13'd1);
assign add_ln50_fu_180_p2 = (i_fu_72 + 7'd1);
assign add_ln51_fu_242_p2 = (select_ln6_fu_192_p3 + 7'd1);
...
assign bitcast_ln52_fu_281_p1 = tmp_2_reg_335;
assign buff_E_out_1_address0 = zext_ln52_fu_234_p1;
assign buff_E_out_1_ce0 = buff_E_out_1_ce0_local;
assign buff_E_out_2_address0 = zext_ln52_fu_234_p1;
assign buff_E_out_2_ce0 = buff_E_out_2_ce0_local;
assign buff_E_out_3_address0 = zext_ln52_fu_234_p1;
assign buff_E_out_3_ce0 = buff_E_out_3_ce0_local;
assign buff_E_out_address0 = zext_ln52_fu_234_p1;
assign buff_E_out_ce0 = buff_E_out_ce0_local;
assign icmp_ln50_fu_157_p2 = ((ap_sig_allocacmp_indvar_flatten91_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln51_fu_186_p2 = ((j_fu_68 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_3_fu_216_p4 = {{select_ln6_fu_192_p3[5:2]}};
assign select_ln50_fu_200_p3 = ((icmp_ln51_fu_186_p2[0:0] == 1'b1) ? add_ln50_fu_180_p2 : i_fu_72);
assign select_ln6_fu_192_p3 = ((icmp_ln51_fu_186_p2[0:0] == 1'b1) ? 7'd0 : j_fu_68);
assign tmp_2_fu_258_p9 = 'bx;
assign tmp_9_fu_226_p3 = {{trunc_ln51_fu_208_p1}, {lshr_ln6_3_fu_216_p4}};
assign trunc_ln51_1_fu_212_p1 = select_ln6_fu_192_p3[1:0];
assign trunc_ln51_fu_208_p1 = select_ln50_fu_200_p3[5:0];
assign zext_ln52_fu_234_p1 = tmp_9_fu_226_p3;
endmodule 