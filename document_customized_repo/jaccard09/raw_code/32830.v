...
reg   [6:0] tmp_35_reg_1667;
reg   [6:0] tmp_36_reg_1672;
reg   [6:0] tmp_37_reg_1677;
reg   [6:0] tmp_38_reg_1682;
wire   [8:0] add_ln108_fu_1004_p2;
reg   [8:0] add_ln108_reg_1687;
wire   [2:0] trunc_ln102_fu_1009_p1;
reg   [2:0] trunc_ln102_reg_1692;
reg   [6:0] tmp_39_reg_1704;
reg   [7:0] tmp_40_reg_1709;
...
wire   [63:0] tmp_s_fu_1376_p17;
reg   [63:0] tmp_s_reg_2029;
...
wire   [20:0] tmp_40_fu_1032_p1;
wire  signed [20:0] grp_fu_1535_p3;
wire   [20:0] tmp_41_fu_1111_p1;
wire  signed [20:0] grp_fu_1544_p3;
wire   [7:0] tmp_41_fu_1111_p4;
...
wire   [63:0] tmp_s_fu_1376_p15;
wire   [7:0] shl_ln4_fu_1451_p3;
wire   [7:0] or_ln_fu_1464_p3;
wire   [7:0] or_ln7_fu_1477_p3;
wire   [7:0] or_ln8_fu_1490_p3;
...
wire   [2:0] tmp_s_fu_1376_p1;
wire   [2:0] tmp_s_fu_1376_p3;
wire   [2:0] tmp_s_fu_1376_p5;
wire   [2:0] tmp_s_fu_1376_p7;
wire  signed [2:0] tmp_s_fu_1376_p9;
wire  signed [2:0] tmp_s_fu_1376_p11;
wire  signed [2:0] tmp_s_fu_1376_p13;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 2'd1;
...
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_15_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_15_3_64_1_1_U150(.din0(smem_q0),.din1(smem_7_q0),.din2(smem_8_q0),.din3(smem_9_q0),.din4(smem_10_q0),.din5(smem_11_q0),.din6(smem_12_q0),.def(tmp_s_fu_1376_p15),.sel(trunc_ln102_reg_1692),.dout(tmp_s_fu_1376_p17));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_39_reg_1704 <= {{mul_ln108_fu_1016_p2[18:12]}};
        tmp_40_reg_1709 <= {{tmp_40_fu_1032_p1[20:13]}};
        tmp_s_reg_2029 <= tmp_s_fu_1376_p17;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_35_reg_1667 <= {{mul_ln104_fu_931_p2[18:12]}};
        tmp_36_reg_1672 <= {{mul_ln105_fu_950_p2[18:12]}};
        tmp_37_reg_1677 <= {{mul_ln106_fu_969_p2[18:12]}};
        tmp_38_reg_1682 <= {{mul_ln107_fu_988_p2[18:12]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_phi38_fu_132 <= tmp_s_fu_1376_p17;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter8 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        DATA_y_1_d0_local = tmp_s_reg_2029;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign or_ln7_fu_1477_p3 = {{trunc_ln220_reg_1629_pp0_iter7_reg}, {2'd2}};
assign or_ln8_fu_1490_p3 = {{trunc_ln220_reg_1629_pp0_iter7_reg}, {2'd3}};
...
assign tmp_40_fu_1032_p1 = grp_fu_1535_p3;
assign tmp_41_fu_1111_p1 = grp_fu_1544_p3;
assign tmp_41_fu_1111_p4 = {{tmp_41_fu_1111_p1[20:13]}};
assign tmp_s_fu_1376_p15 = 'bx;
...
assign zext_ln104_fu_1051_p1 = tmp_35_reg_1667;
assign zext_ln105_fu_1061_p1 = tmp_36_reg_1672;
assign zext_ln106_fu_1071_p1 = tmp_37_reg_1677;
assign zext_ln107_fu_1081_p1 = tmp_38_reg_1682;
assign zext_ln108_fu_1091_p1 = tmp_39_reg_1704;
assign zext_ln109_fu_1101_p1 = tmp_40_reg_1709;
assign zext_ln110_fu_1120_p1 = tmp_41_fu_1111_p4;
...
assign zext_ln224_fu_1484_p1 = or_ln7_fu_1477_p3;
assign zext_ln226_fu_1497_p1 = or_ln8_fu_1490_p3;
always @ (posedge ap_clk) begin
