...
input  [63:0] output_difference_idx183_val243;
input  [63:0] output_difference_idx182_val240;
...
output  [63:0] output_difference_idx183_val241_out;
output   output_difference_idx183_val241_out_ap_vld;
output  [63:0] output_difference_idx182_val238_out;
output   output_difference_idx182_val238_out_ap_vld;
...
reg output_difference_idx183_val241_out_ap_vld;
reg output_difference_idx182_val238_out_ap_vld;
...
reg   [63:0] output_difference_idx_val235_fu_100;
...
reg   [63:0] output_difference_idx182_val238_fu_104;
reg   [63:0] output_difference_idx183_val241_fu_108;
...
#0 i_fu_96 = 2'd0;
#0 output_difference_idx_val235_fu_100 = 64'd0;
#0 output_difference_idx182_val238_fu_104 = 64'd0;
#0 output_difference_idx183_val241_fu_108 = 64'd0;
...
sparsemux_7_2_64_1_1_U139(.din0(mux_case_0202211_reload),.din1(mux_case_1203215_reload),.din2(mux_case_2204219_reload),.def(tmp_9_fu_370_p7),.sel(i_9_reg_567_pp0_iter1_reg),.dout(tmp_9_fu_370_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U140(.din0(mux_case_0205223_reload),.din1(mux_case_1206227_reload),.din2(mux_case_2207231_reload),.def(tmp_10_fu_413_p7),.sel(i_9_reg_567_pp0_iter8_reg),.dout(tmp_10_fu_413_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            output_difference_idx182_val238_fu_104 <= output_difference_idx182_val240;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_9_reg_567_pp0_iter16_reg == 2'd1))) begin
            output_difference_idx182_val238_fu_104 <= mul5_i_reg_627;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            output_difference_idx183_val241_fu_108 <= output_difference_idx183_val243;
        end else if ((1'b1 == ap_condition_626)) begin
            output_difference_idx183_val241_fu_108 <= mul5_i_reg_627;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            output_difference_idx_val235_fu_100 <= output_difference_idx_val237;
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_9_reg_567_pp0_iter16_reg == 2'd0))) begin
            output_difference_idx_val235_fu_100 <= mul5_i_reg_627;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul5_i_reg_627 <= grp_fu_1770_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_573_pp0_iter15_reg == 1'd1))) begin
        output_difference_idx182_val238_out_ap_vld = 1'b1;
    end else begin
        output_difference_idx182_val238_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_573_pp0_iter15_reg == 1'd1))) begin
        output_difference_idx183_val241_out_ap_vld = 1'b1;
    end else begin
        output_difference_idx183_val241_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln66_reg_573_pp0_iter15_reg == 1'd1))) begin
...
assign bitcast_ln67_1_fu_391_p1 = grp_fu_3145_p_dout0;
...
assign grp_fu_1770_p_din0 = bitcast_ln67_2_fu_435_p1;
assign grp_fu_1770_p_din1 = tmp_10_reg_617;
assign grp_fu_3145_p_ce = 1'b1;
assign grp_fu_3145_p_din0 = tmp_9_fu_370_p9;
assign grp_fu_3145_p_din1 = bitcast_ln67_fu_387_p1;
assign grp_fu_3145_p_opcode = 2'd1;
assign icmp_ln66_fu_316_p2 = ((ap_sig_allocacmp_i_9 == 2'd3) ? 1'b1 : 1'b0);
assign lshr_ln9_fu_342_p4 = {{add_ln67_fu_332_p2[8:1]}};
assign output_difference_1_out = output_difference_1_fu_116;
assign output_difference_2_out = output_difference_2_fu_120;
assign output_difference_idx182_val238_out = output_difference_idx182_val238_fu_104;
assign output_difference_idx183_val241_out = output_difference_idx183_val241_fu_108;
assign output_difference_idx_val235_out = output_difference_idx_val235_fu_100;
...
assign zext_ln66_fu_328_p1 = ap_sig_allocacmp_i_9;
assign zext_ln67_fu_352_p1 = lshr_ln9_fu_342_p4;
endmodule 