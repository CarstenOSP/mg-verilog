module backprop_backprop_Pipeline_label_39_label_40 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v10_address0,v10_ce0,v10_q0,v10_1_address0,v10_1_ce0,v10_1_q0,v10_2_address0,v10_2_ce0,v10_2_q0,v2_1_address0,v2_1_ce0,v2_1_we0,v2_1_d0,v2_1_q0,v2_0_address0,v2_0_ce0,v2_0_we0,v2_0_d0,v2_0_q0,v216_out,v216_out_ap_vld,grp_fu_9308_p_din0,grp_fu_9308_p_din1,grp_fu_9308_p_opcode,grp_fu_9308_p_dout0,grp_fu_9308_p_ce,grp_fu_9324_p_din0,grp_fu_9324_p_din1,grp_fu_9324_p_dout0,grp_fu_9324_p_ce); 
...
output  [63:0] grp_fu_9308_p_din0;
output  [63:0] grp_fu_9308_p_din1;
output  [1:0] grp_fu_9308_p_opcode;
input  [63:0] grp_fu_9308_p_dout0;
output   grp_fu_9308_p_ce;
...
reg   [7:0] indvar_flatten47_fu_82;
...
#0 v215_fu_74 = 2'd0;
#0 v212_fu_78 = 7'd0;
#0 indvar_flatten47_fu_82 = 8'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U706(.din0(v10_q0),.din1(v10_1_q0),.din2(v10_2_q0),.def(v217_fu_310_p7),.sel(select_ln342_reg_396),.dout(v217_fu_310_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        indvar_flatten47_fu_82 <= add_ln341_fu_196_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v214_fu_70 <= grp_fu_9308_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v218_reg_441 <= grp_fu_9324_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v220_reg_456 <= grp_fu_9308_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v221_reg_463 <= grp_fu_9324_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v214_load_1 = grp_fu_9308_p_dout0;
    end else begin
...
assign add_ln341_fu_196_p2 = (indvar_flatten47_fu_82 + 8'd1);
assign add_ln345_fu_289_p2 = (select_ln342_fu_214_p3 + 2'd1);
assign add_ln347_fu_269_p2 = (zext_ln345_fu_265_p1 + empty_104_fu_259_p2);
...
assign empty_104_fu_259_p2 = (p_shl_fu_251_p3 - v212_cast_fu_243_p1);
assign empty_fu_247_p1 = select_ln341_fu_228_p3[5:0];
assign grp_fu_9308_p_ce = 1'b1;
assign grp_fu_9308_p_din0 = grp_fu_158_p0;
assign grp_fu_9308_p_din1 = grp_fu_158_p1;
assign grp_fu_9308_p_opcode = grp_fu_158_opcode;
assign grp_fu_9324_p_ce = 1'b1;
assign grp_fu_9324_p_din0 = grp_fu_162_p0;
assign grp_fu_9324_p_din1 = grp_fu_162_p1;
assign icmp_ln341_fu_190_p2 = ((indvar_flatten47_fu_82 == 8'd192) ? 1'b1 : 1'b0);
