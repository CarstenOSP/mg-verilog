...
wire   [0:0] icmp_ln137_fu_103_p2;
wire    ap_block_pp0_stage1_11001;
reg   [767:0] ctx_ret_reg_179;
reg   [7:0] rcon_reg_184;
reg    ap_enable_reg_pp0_iter0_reg;
wire    grp_aes_expandEncKey_fu_69_ap_ready;
reg    grp_aes_expandEncKey_fu_69_ap_start_reg;
wire    ap_block_pp0_stage1_ignoreCallOp100;
reg   [2:0] i_1_fu_44;
wire   [2:0] add_ln137_fu_109_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_i;
wire    ap_block_pp0_stage0;
reg   [7:0] rcon_0_fu_48;
reg   [7:0] ap_sig_allocacmp_rcon_0_load;
wire    ap_block_pp0_stage1;
reg   [767:0] ctx5_fu_52;
...
#0 grp_aes_expandEncKey_fu_69_ap_start_reg = 1'b0;
#0 i_1_fu_44 = 3'd0;
#0 rcon_0_fu_48 = 8'd0;
#0 ctx5_fu_52 = 768'd0;
#0 ap_done_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_aes_expandEncKey_fu_69_ap_start_reg <= 1'b0;
    end else begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln137_fu_103_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
            grp_aes_expandEncKey_fu_69_ap_start_reg <= 1'b1;
        end else if ((grp_aes_expandEncKey_fu_69_ap_ready == 1'b1)) begin
            grp_aes_expandEncKey_fu_69_ap_start_reg <= 1'b0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ctx5_fu_52 <= p_partset113_reload;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ctx5_fu_52 <= ctx_ret_reg_179;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln137_fu_103_p2 == 1'd0))) begin
            i_1_fu_44 <= add_ln137_fu_109_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        rcon_0_fu_48 <= rcon_reg_184;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ctx_ret_reg_179 <= grp_aes_expandEncKey_fu_477_p_dout0_0;
        icmp_ln137_reg_170 <= icmp_ln137_fu_103_p2;
        rcon_reg_184 <= grp_aes_expandEncKey_fu_477_p_dout0_1;
    end
end
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln137_reg_170 == 1'd1) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ap_sig_allocacmp_ctx5_load_1 = ctx_ret_reg_179;
    end else begin
        ap_sig_allocacmp_ctx5_load_1 = ctx5_fu_52;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ap_sig_allocacmp_rcon_0_load = rcon_reg_184;
    end else begin
        ap_sig_allocacmp_rcon_0_load = rcon_0_fu_48;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (ap_loop_exit_ready == 1'b1) & (icmp_ln137_reg_170 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
...
assign add_ln137_fu_109_p2 = ($signed(ap_sig_allocacmp_i) + $signed(3'd7));
...
assign ctx5_out = ctx5_fu_52;
assign grp_aes_expandEncKey_fu_477_p_ce = 1'b1;
assign grp_aes_expandEncKey_fu_477_p_din1 = ap_sig_allocacmp_ctx5_load_1;
assign grp_aes_expandEncKey_fu_477_p_din2 = 10'd512;
assign grp_aes_expandEncKey_fu_477_p_din3 = ap_sig_allocacmp_rcon_0_load;
assign grp_aes_expandEncKey_fu_477_p_start = grp_aes_expandEncKey_fu_69_ap_start_reg;
assign grp_aes_expandEncKey_fu_69_ap_ready = grp_aes_expandEncKey_fu_477_p_ready;
assign icmp_ln137_fu_103_p2 = ((ap_sig_allocacmp_i == 3'd0) ? 1'b1 : 1'b0);
endmodule 