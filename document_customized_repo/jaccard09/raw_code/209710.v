...
urem_24ns_23ns_24_28_1_U68(.clk(ap_clk),.reset(ap_rst),.din0(add_ln35_fu_164_p2),.din1(grp_fu_169_p1),.ce(1'b1),.dout(grp_fu_169_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        lshr_ln29_6_reg_300 <= {{v8_1_reg_274[9:1]}};
