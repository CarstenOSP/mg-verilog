...
wire   [31:0] tmp_6_fu_377_p19;
reg   [31:0] tmp_6_reg_635;
reg   [31:0] E_reg_640;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_6_fu_377_p1;
wire   [2:0] tmp_6_fu_377_p3;
wire   [2:0] tmp_6_fu_377_p5;
wire   [2:0] tmp_6_fu_377_p7;
wire  signed [2:0] tmp_6_fu_377_p9;
wire  signed [2:0] tmp_6_fu_377_p11;
wire  signed [2:0] tmp_6_fu_377_p13;
wire  signed [2:0] tmp_6_fu_377_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U40(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.din4(W_4_q0),.din5(W_5_q0),.din6(W_6_q0),.din7(W_7_q0),.def(tmp_6_fu_377_p17),.sel(trunc_ln100_reg_590),.dout(tmp_6_fu_377_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_6_reg_635 <= tmp_6_fu_377_p19;
...
assign add_ln122_1_fu_437_p2 = (tmp_6_reg_635 + 32'd1859775393);
