...
reg   [0:0] tmp_448_reg_1244;
reg   [0:0] tmp_448_reg_1244_pp0_iter1_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter2_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter3_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter4_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter5_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter6_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter7_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter8_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter9_reg;
reg   [0:0] tmp_448_reg_1244_pp0_iter10_reg;
reg   [2:0] lshr_ln113_1_reg_1248;
reg   [2:0] lshr_ln113_1_reg_1248_pp0_iter1_reg;
reg   [2:0] lshr_ln113_1_reg_1248_pp0_iter2_reg;
...
sparsemux_17_3_32_1_1_U118(.din0(empty_392),.din1(empty_393),.din2(empty_394),.din3(empty_395),.din4(empty_396),.din5(empty_397),.din6(empty_398),.din7(empty_399),.def(v75_fu_856_p17),.sel(v75_fu_856_p18),.dout(v75_fu_856_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U119(.din0(empty_400),.din1(empty_401),.din2(empty_402),.din3(empty_403),.din4(empty_404),.din5(empty_405),.din6(empty_406),.din7(empty_407),.def(v83_fu_896_p17),.sel(v83_fu_896_p18),.dout(v83_fu_896_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U120(.din0(empty_408),.din1(empty_409),.din2(empty_410),.din3(empty_411),.din4(empty_412),.din5(empty_413),.din6(empty_414),.din7(empty_415),.def(v91_fu_936_p17),.sel(v91_fu_936_p18),.dout(v91_fu_936_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U121(.din0(empty_416),.din1(empty_417),.din2(empty_418),.din3(empty_419),.din4(empty_420),.din5(empty_421),.din6(empty_422),.din7(empty_423),.def(v99_fu_976_p17),.sel(v99_fu_976_p18),.dout(v99_fu_976_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U122(.din0(empty_424),.din1(empty_425),.din2(empty_426),.din3(empty_427),.din4(empty_428),.din5(empty_429),.din6(empty_430),.din7(empty_431),.def(v107_fu_1016_p17),.sel(v107_fu_1016_p18),.dout(v107_fu_1016_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U123(.din0(empty_432),.din1(empty_433),.din2(empty_434),.din3(empty_435),.din4(empty_436),.din5(empty_437),.din6(empty_438),.din7(empty_439),.def(v115_fu_1056_p17),.sel(v115_fu_1056_p18),.dout(v115_fu_1056_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U124(.din0(empty_440),.din1(empty_441),.din2(empty_442),.din3(empty_443),.din4(empty_444),.din5(empty_445),.din6(empty_446),.din7(empty_447),.def(v123_fu_1096_p17),.sel(v123_fu_1096_p18),.dout(v123_fu_1096_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U125(.din0(empty_448),.din1(empty_449),.din2(empty_450),.din3(empty_451),.din4(empty_452),.din5(empty_453),.din6(empty_454),.din7(empty),.def(v131_fu_1136_p17),.sel(v131_fu_1136_p18),.dout(v131_fu_1136_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln113_1_reg_1248_pp0_iter2_reg <= lshr_ln113_1_reg_1248_pp0_iter1_reg;
        tmp_448_reg_1244_pp0_iter10_reg <= tmp_448_reg_1244_pp0_iter9_reg;
        tmp_448_reg_1244_pp0_iter2_reg <= tmp_448_reg_1244_pp0_iter1_reg;
        tmp_448_reg_1244_pp0_iter3_reg <= tmp_448_reg_1244_pp0_iter2_reg;
        tmp_448_reg_1244_pp0_iter4_reg <= tmp_448_reg_1244_pp0_iter3_reg;
        tmp_448_reg_1244_pp0_iter5_reg <= tmp_448_reg_1244_pp0_iter4_reg;
        tmp_448_reg_1244_pp0_iter6_reg <= tmp_448_reg_1244_pp0_iter5_reg;
        tmp_448_reg_1244_pp0_iter7_reg <= tmp_448_reg_1244_pp0_iter6_reg;
        tmp_448_reg_1244_pp0_iter8_reg <= tmp_448_reg_1244_pp0_iter7_reg;
        tmp_448_reg_1244_pp0_iter9_reg <= tmp_448_reg_1244_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln113_1_reg_1248 <= {{ap_sig_allocacmp_v68[5:3]}};
        lshr_ln113_1_reg_1248_pp0_iter1_reg <= lshr_ln113_1_reg_1248;
        tmp_448_reg_1244 <= ap_sig_allocacmp_v68[32'd6];
        tmp_448_reg_1244_pp0_iter1_reg <= tmp_448_reg_1244;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter11_reg == 1'b1) & (tmp_448_reg_1244_pp0_iter10_reg == 1'd1))) begin
...
assign v71_fu_1190_p3 = ((icmp_ln115_reg_1253[0:0] == 1'b1) ? v69_1 : v66_fu_208);
...
assign zext_ln113_fu_1209_p1 = lshr_ln113_1_reg_1248_pp0_iter2_reg;
endmodule 