...
wire   [13:0] tmp_281_fu_360_p3;
reg   [13:0] tmp_281_reg_578;
wire    ap_CS_fsm_state6;
wire   [7:0] empty_22_fu_370_p2;
reg   [7:0] empty_22_reg_583;
wire   [13:0] tmp_282_fu_375_p3;
reg   [13:0] tmp_282_reg_588;
reg   [13:0] llike_addr_17_reg_593;
...
wire   [63:0] grp_viterbi_Pipeline_L_init_fu_247_grp_fu_678_p_din0;
wire   [63:0] grp_viterbi_Pipeline_L_init_fu_247_grp_fu_678_p_din1;
wire   [1:0] grp_viterbi_Pipeline_L_init_fu_247_grp_fu_678_p_opcode;
wire    grp_viterbi_Pipeline_L_init_fu_247_grp_fu_678_p_ce;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_161_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_161_out_ap_vld;
...
wire   [1:0] grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_678_p_opcode;
wire    grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_678_p_ce;
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_din0;
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_din1;
wire   [4:0] grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_opcode;
wire    grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_ce;
...
wire   [63:0] grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_din0;
wire   [63:0] grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_din1;
wire   [4:0] grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_opcode;
wire    grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_ce;
...
wire   [63:0] grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_din0;
wire   [63:0] grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_din1;
wire   [4:0] grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_opcode;
wire    grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_ce;
...
wire   [63:0] tmp_282_cast_fu_383_p1;
...
viterbi_dadd_64ns_64ns_64_8_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 8 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dadd_64ns_64ns_64_8_full_dsp_1_U37(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_678_p0),.din1(grp_fu_678_p1),.ce(grp_fu_678_ce),.dout(grp_fu_678_p2));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U38(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_682_p0),.din1(grp_fu_682_p1),.ce(grp_fu_682_ce),.opcode(grp_fu_682_opcode),.dout(grp_fu_682_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_17_reg_593[13 : 6] <= tmp_282_cast_fu_383_p1[13 : 6];
        tmp_281_reg_578[13 : 6] <= tmp_281_fu_360_p3[13 : 6];
        tmp_282_reg_588[13 : 6] <= tmp_282_fu_375_p3[13 : 6];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_161_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_161_loc_fu_102 <= grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_161_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state26)) begin
        ...
        grp_fu_678_ce = grp_viterbi_Pipeline_L_init_fu_247_grp_fu_678_p_ce;
    end else begin
        grp_fu_678_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state26)) begin
        ...
        grp_fu_678_p0 = grp_viterbi_Pipeline_L_init_fu_247_grp_fu_678_p_din0;
    end else begin
        grp_fu_678_p0 = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state26)) begin
        ...
        grp_fu_678_p1 = grp_viterbi_Pipeline_L_init_fu_247_grp_fu_678_p_din1;
    end else begin
        grp_fu_678_p1 = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        grp_fu_682_ce = grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_ce;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        grp_fu_682_ce = grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_ce;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        grp_fu_682_ce = grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_ce;
    end else begin
        grp_fu_682_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        grp_fu_682_opcode = grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_opcode;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        grp_fu_682_opcode = grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_opcode;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        grp_fu_682_opcode = grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_opcode;
    end else begin
        grp_fu_682_opcode = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        grp_fu_682_p0 = grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_din0;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        grp_fu_682_p0 = grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_din0;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        grp_fu_682_p0 = grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_din0;
    end else begin
        grp_fu_682_p0 = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        grp_fu_682_p1 = grp_viterbi_Pipeline_L_backtrack_fu_287_grp_fu_682_p_din1;
    end else if ((1'b1 == ap_CS_fsm_state30)) begin
        grp_fu_682_p1 = grp_viterbi_Pipeline_L_end_fu_280_grp_fu_682_p_din1;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        grp_fu_682_p1 = grp_viterbi_Pipeline_L_prev_state_fu_264_grp_fu_682_p_din1;
    end else begin
        grp_fu_682_p1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state27)) begin
        ...
        llike_address0_local = llike_addr_17_reg_593;
...
assign add_ln33_fu_430_p2 = (tmp_281_reg_578 + zext_ln33_fu_426_p1);
...
assign conv32_udiv_fu_400_p4 = {{tmp_15_fu_388_p3[7:1]}};
...
assign empty_23_fu_396_p1 = tmp_15_fu_388_p3[0:0];
...
assign tmp_15_fu_388_p3 = ((trunc_ln18_fu_367_p1[0:0] == 1'b1) ? obs_1_q0 : obs_0_q0);
assign tmp_281_fu_360_p3 = {{t_fu_94}, {6'd0}};
assign tmp_282_cast_fu_383_p1 = tmp_282_fu_375_p3;
assign tmp_282_fu_375_p3 = {{empty_22_fu_370_p2}, {6'd0}};
...
always @ (posedge ap_clk) begin
    tmp_281_reg_578[5:0] <= 6'b000000;
    tmp_282_reg_588[5:0] <= 6'b000000;
    llike_addr_17_reg_593[5:0] <= 6'b000000;
