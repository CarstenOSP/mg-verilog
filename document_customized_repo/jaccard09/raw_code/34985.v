...
sparsemux_7_2_64_1_1_U1087(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_s_fu_222_p7),.sel(ap_sig_allocacmp_i_16),.dout(tmp_s_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_74_reg_373 <= grp_fu_7028_p_dout0;
