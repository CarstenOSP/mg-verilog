...
wire   [31:0] tmp_s_fu_238_p11;
reg   [31:0] tmp_s_reg_325;
wire   [63:0] zext_ln6_1_fu_220_p1;
...
wire   [3:0] lshr_ln6_4_fu_192_p4;
wire   [4:0] lshr_ln6_5_fu_210_p4;
wire   [31:0] tmp_s_fu_238_p9;
reg    ap_done_reg;
...
wire  signed [1:0] tmp_s_fu_238_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U13583(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.def(tmp_s_fu_238_p9),.sel(trunc_ln35_1_reg_285),.dout(tmp_s_fu_238_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_s_reg_325 <= tmp_s_fu_238_p11;
...
assign bitcast_ln37_fu_265_p1 = tmp_s_reg_325;
assign buff_x1_1_address0 = zext_ln6_1_fu_220_p1;
assign buff_x1_1_ce0 = buff_x1_1_ce0_local;
assign buff_x1_address0 = zext_ln6_1_fu_220_p1;
assign buff_x1_ce0 = buff_x1_ce0_local;
assign buff_x2_1_address0 = zext_ln6_fu_202_p1;
assign buff_x2_1_ce0 = buff_x2_1_ce0_local;
assign buff_x2_2_address0 = zext_ln6_fu_202_p1;
assign buff_x2_2_ce0 = buff_x2_2_ce0_local;
assign buff_x2_3_address0 = zext_ln6_fu_202_p1;
...
assign lshr_ln6_4_fu_192_p4 = {{ap_sig_allocacmp_i_1[5:2]}};
assign lshr_ln6_5_fu_210_p4 = {{ap_sig_allocacmp_i_1[5:1]}};
assign select_ln36_fu_231_p3 = ((trunc_ln35_reg_280[0:0] == 1'b1) ? buff_x1_1_q0 : buff_x1_q0);
assign tmp_s_fu_238_p9 = 'bx;
...
assign zext_ln6_1_fu_220_p1 = lshr_ln6_5_fu_210_p4;
