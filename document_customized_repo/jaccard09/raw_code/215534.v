...
reg   [6:0] lshr_ln48_s_reg_482;
reg   [6:0] lshr_ln48_s_reg_482_pp0_iter1_reg;
reg   [6:0] lshr_ln48_s_reg_482_pp0_iter2_reg;
wire   [31:0] v23_fu_407_p1;
wire   [31:0] v23_52_fu_412_p1;
wire   [31:0] v23_53_fu_417_p1;
wire   [31:0] v23_54_fu_422_p1;
...
wire   [63:0] zext_ln51_46_fu_340_p1;
wire   [63:0] zext_ln51_47_fu_378_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln51_48_fu_392_p1;
...
wire   [11:0] tmp_s_fu_297_p4;
wire   [22:0] add_ln51_s_fu_307_p3;
wire   [8:0] tmp_26_fu_320_p4;
wire   [22:0] add_ln51_34_fu_330_p4;
wire   [2:0] trunc_ln47_fu_293_p1;
wire   [7:0] tmp_27_fu_360_p4;
wire   [22:0] add_ln51_35_fu_369_p4;
wire   [22:0] add_ln51_36_fu_383_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v19_13_fu_88 <= add_ln47_fu_397_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln48_s_reg_482 <= {{v19_reg_457[9:3]}};
        lshr_ln48_s_reg_482_pp0_iter1_reg <= lshr_ln48_s_reg_482;
        lshr_ln48_s_reg_482_pp0_iter2_reg <= lshr_ln48_s_reg_482_pp0_iter1_reg;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
        reg_261 <= grp_fu_8063_p_dout0;
        reg_269 <= grp_fu_8067_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            grp_fu_245_p1 = v23_53_fu_417_p1;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            grp_fu_249_p1 = v23_54_fu_422_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            grp_fu_249_p1 = v23_52_fu_412_p1;
        end else begin
            grp_fu_249_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address0_local = zext_ln51_48_fu_392_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v0_address0_local = zext_ln51_46_fu_340_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address1_local = zext_ln51_47_fu_378_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln51_34_fu_330_p4 = {{{v5_2}, {tmp_26_fu_320_p4}}, {1'd1}};
assign add_ln51_35_fu_369_p4 = {{{v5_2}, {tmp_27_fu_360_p4}}, {2'd2}};
assign add_ln51_36_fu_383_p4 = {{{v5_2}, {tmp_27_fu_360_p4}}, {2'd3}};
assign add_ln51_s_fu_307_p3 = {{tmp_s_fu_297_p4}, {ap_sig_allocacmp_v19}};
...
assign grp_fu_8063_p_din0 = v22_12;
assign grp_fu_8063_p_din1 = grp_fu_245_p1;
assign grp_fu_8067_p_ce = 1'b1;
assign grp_fu_8067_p_din0 = v22_12;
assign grp_fu_8067_p_din1 = grp_fu_249_p1;
assign icmp_ln53_fu_345_p2 = ((trunc_ln47_fu_293_p1 == 3'd0) ? 1'b1 : 1'b0);
assign tmp_26_fu_320_p4 = {{ap_sig_allocacmp_v19[9:1]}};
assign tmp_27_fu_360_p4 = {{v19_reg_457[9:2]}};
assign tmp_fu_285_p3 = ap_sig_allocacmp_v19[32'd10];
assign tmp_s_fu_297_p4 = {{v5_2[12:1]}};
assign trunc_ln47_fu_293_p1 = ap_sig_allocacmp_v19[2:0];
assign v0_address0 = v0_address0_local;
assign v0_address1 = v0_address1_local;
assign v0_ce0 = v0_ce0_local;
assign v0_ce1 = v0_ce1_local;
assign v23_52_fu_412_p1 = reg_257;
assign v23_53_fu_417_p1 = reg_253;
assign v23_54_fu_422_p1 = reg_257;
...
assign zext_ln48_fu_427_p1 = lshr_ln48_s_reg_482_pp0_iter2_reg;
assign zext_ln51_46_fu_340_p1 = add_ln51_34_fu_330_p4;
assign zext_ln51_47_fu_378_p1 = add_ln51_35_fu_369_p4;
assign zext_ln51_48_fu_392_p1 = add_ln51_36_fu_383_p4;
