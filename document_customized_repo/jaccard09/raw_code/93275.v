...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_s_fu_265_p1;
wire   [1:0] tmp_s_fu_265_p3;
wire  signed [1:0] tmp_s_fu_265_p5;
wire  signed [1:0] tmp_s_fu_265_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U605(.din0(buff_D_out_q0),.din1(buff_D_out_1_q0),.din2(buff_D_out_2_q0),.din3(buff_D_out_3_q0),.def(tmp_s_fu_265_p9),.sel(trunc_ln53_1_reg_317),.dout(tmp_s_fu_265_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_s_reg_346 <= tmp_s_fu_265_p11;
    end
end
always @ (*) begin
...
assign bitcast_ln55_fu_288_p1 = tmp_s_reg_346;
...
assign tmp_1_fu_227_p3 = {{trunc_ln53_fu_209_p1}, {lshr_ln5_5_fu_217_p4}};
assign tmp_s_fu_265_p9 = 'bx;
assign trunc_ln53_1_fu_213_p1 = select_ln5_fu_193_p3[1:0];
assign trunc_ln53_fu_209_p1 = select_ln52_fu_201_p3[5:0];
assign zext_ln55_fu_235_p1 = tmp_1_fu_227_p3;
endmodule 