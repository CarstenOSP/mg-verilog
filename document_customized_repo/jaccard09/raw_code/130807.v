...
wire   [31:0] tmp_6_fu_394_p11;
reg   [31:0] tmp_6_reg_616;
...
wire   [31:0] tmp_2_fu_469_p11;
reg   [31:0] tmp_2_reg_655;
...
wire   [31:0] tmp_6_fu_394_p9;
wire   [1:0] tmp_6_fu_394_p10;
wire   [31:0] tmp_5_fu_439_p9;
wire   [31:0] tmp_2_fu_469_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_6_fu_394_p1;
wire   [1:0] tmp_6_fu_394_p3;
wire  signed [1:0] tmp_6_fu_394_p5;
wire  signed [1:0] tmp_6_fu_394_p7;
wire   [1:0] tmp_5_fu_439_p1;
wire   [1:0] tmp_5_fu_439_p3;
wire  signed [1:0] tmp_5_fu_439_p5;
wire  signed [1:0] tmp_5_fu_439_p7;
wire   [1:0] tmp_2_fu_469_p1;
wire   [1:0] tmp_2_fu_469_p3;
wire  signed [1:0] tmp_2_fu_469_p5;
wire  signed [1:0] tmp_2_fu_469_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 8'd1;
...
fadd_32ns_32ns_32_7_full_dsp_1_U285(.clk(ap_clk),.reset(ap_rst),.din0(add6815_fu_92),.din1(mul3_reg_660),.ce(1'b1),.dout(grp_fu_258_p2));
gesummv_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U286(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_262_p0),.din1(grp_fu_262_p1),.ce(1'b1),.dout(grp_fu_262_p2));
...
sparsemux_9_2_32_1_1_U287(.din0(buff_x_q0),.din1(buff_x_1_q0),.din2(buff_x_2_q0),.din3(buff_x_3_q0),.def(tmp_6_fu_394_p9),.sel(tmp_6_fu_394_p10),.dout(tmp_6_fu_394_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U288(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.def(tmp_5_fu_439_p9),.sel(trunc_ln32_reg_591),.dout(tmp_5_fu_439_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U289(.din0(tmp2_q0),.din1(tmp2_1_q0),.din2(tmp2_2_q0),.din3(tmp2_3_q0),.def(tmp_2_fu_469_p9),.sel(trunc_ln31_reg_581),.dout(tmp_2_fu_469_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_2_reg_655 <= tmp_2_fu_469_p11;
        tmp_6_reg_616 <= tmp_6_fu_394_p11;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_5_reg_625 <= tmp_5_fu_439_p11;
    end
end
always @ (*) begin
...
assign tmp_2_fu_469_p9 = 'bx;
assign tmp_5_fu_439_p9 = 'bx;
assign tmp_6_fu_394_p10 = select_ln6_reg_546[1:0];
assign tmp_6_fu_394_p9 = 'bx;
assign tmp_s_fu_379_p3 = {{empty_fu_358_p1}, {lshr_ln6_5_reg_556}};
