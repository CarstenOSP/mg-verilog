module sha_stream_sha_transform_Pipeline_trans_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_11_reload,B_1_reload,E_11_reload,D_11_reload,E_2_reload,W_36_reload,W_38_reload,W_40_reload,W_42_reload,W_44_reload,W_46_reload,W_48_reload,W_50_reload,W_52_reload,W_54_reload,W_37_reload,W_39_reload,W_41_reload,W_43_reload,W_45_reload,W_47_reload,W_49_reload,W_51_reload,W_53_reload,W_55_reload,A_13_out,A_13_out_ap_vld,B_4_out,B_4_out_ap_vld,E_12_out,E_12_out_ap_vld,D_13_out,D_13_out_ap_vld,E_5_out,E_5_out_ap_vld); 
...
reg   [31:0] E_5_load_reg_838;
wire    ap_block_pp0_stage2_11001;
wire   [31:0] B_6_fu_516_p2;
reg   [31:0] B_6_reg_843;
...
sparsemux_21_6_32_1_1_U128(.din0(W_36_reload),.din1(W_38_reload),.din2(W_40_reload),.din3(W_42_reload),.din4(W_44_reload),.din5(W_46_reload),.din6(W_48_reload),.din7(W_50_reload),.din8(W_52_reload),.din9(W_54_reload),.def(tmp_s_fu_378_p21),.sel(i_2_fu_142),.dout(tmp_s_fu_378_p23));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_21_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h16 ),.din1_WIDTH( 32 ),.CASE2( 6'h18 ),.din2_WIDTH( 32 ),.CASE3( 6'h1A ),.din3_WIDTH( 32 ),.CASE4( 6'h1C ),.din4_WIDTH( 32 ),.CASE5( 6'h1E ),.din5_WIDTH( 32 ),.CASE6( 6'h20 ),.din6_WIDTH( 32 ),.CASE7( 6'h22 ),.din7_WIDTH( 32 ),.CASE8( 6'h24 ),.din8_WIDTH( 32 ),.CASE9( 6'h26 ),.din9_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_21_6_32_1_1_U129(.din0(W_37_reload),.din1(W_39_reload),.din2(W_41_reload),.din3(W_43_reload),.din4(W_45_reload),.din5(W_47_reload),.din6(W_49_reload),.din7(W_51_reload),.din8(W_53_reload),.din9(W_55_reload),.def(tmp_1_fu_416_p21),.sel(i_2_fu_142),.dout(tmp_1_fu_416_p23));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        D_fu_146 <= C_fu_583_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        E_5_fu_130 <= D_11_reload;
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln120_reg_824 == 1'd1))) begin
        E_5_fu_130 <= D_9_fu_536_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        B_6_reg_843 <= B_6_fu_516_p2;
        E_5_load_reg_838 <= E_5_fu_130;
        lshr_ln122_2_reg_853 <= {{B_6_fu_516_p2[31:27]}};
...
assign A_13_out = B_fu_138;
assign A_fu_640_p2 = (add_ln122_6_reg_863 + add_ln122_4_fu_636_p2);
assign B_4_out = B_4_fu_134;
assign B_6_fu_516_p2 = (add_ln122_fu_510_p2 + add_ln122_2_fu_504_p2);
assign C_fu_583_p3 = {{trunc_ln122_3_fu_569_p1}, {lshr_ln122_3_fu_573_p4}};
assign D_13_out = E_5_fu_130;
assign D_9_fu_536_p3 = {{trunc_ln122_1_fu_522_p1}, {lshr_ln122_1_fu_526_p4}};
assign E_12_out = D_fu_146;
assign E_5_out = E_fu_126;
...
assign add_ln122_4_fu_636_p2 = (E_5_load_reg_838 + xor_ln122_3_reg_858);
...
assign trunc_ln122_2_fu_544_p1 = B_6_fu_516_p2[26:0];
...
assign xor_ln122_2_fu_558_p2 = (D_9_fu_536_p3 ^ B_fu_138);
assign xor_ln122_3_fu_564_p2 = (xor_ln122_2_fu_558_p2 ^ E_7_reg_817);
assign xor_ln122_fu_480_p2 = (E_7_reg_817 ^ E_5_fu_130);
endmodule 