...
wire   [3:0] lshr_ln6_5_fu_167_p4;
wire   [31:0] tmp_1_fu_197_p9;
wire   [1:0] tmp_1_fu_197_p10;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_1_fu_197_p1;
wire   [1:0] tmp_1_fu_197_p3;
wire  signed [1:0] tmp_1_fu_197_p5;
wire  signed [1:0] tmp_1_fu_197_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U983(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.def(tmp_1_fu_197_p9),.sel(tmp_1_fu_197_p10),.dout(tmp_1_fu_197_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_272 <= tmp_1_fu_197_p11;
    end
end
always @ (*) begin
...
assign bitcast_ln37_fu_226_p1 = tmp_1_reg_272;
...
assign lshr_ln6_5_fu_167_p4 = {{ap_sig_allocacmp_i_1[5:2]}};
assign tmp_1_fu_197_p10 = i_1_reg_237[1:0];
assign tmp_1_fu_197_p9 = 'bx;
...
assign zext_ln6_fu_177_p1 = lshr_ln6_5_fu_167_p4;
endmodule 