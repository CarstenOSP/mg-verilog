...
faddfsub_32ns_32ns_32_7_full_dsp_1_U24(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_153_p0),.din1(grp_fu_153_p1),.opcode(grp_fu_153_opcode),.ce(grp_fu_153_ce),.dout(grp_fu_153_p2));
SgdLR_sw_fdiv_32ns_32ns_32_16_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 16 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fdiv_32ns_32ns_32_16_no_dsp_1_U25(.clk(ap_clk),.reset(ap_rst),.din0(32'd1065353216),.din1(reg_171),.ce(1'b1),.dout(grp_fu_158_p2));
SgdLR_sw_sitofp_32ns_32_6_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 6 ),.din0_WIDTH( 32 ),.dout_WIDTH( 32 ))
sitofp_32ns_32_6_no_dsp_1_U26(.clk(ap_clk),.reset(ap_rst),.din0(v1_load_reg_308),.ce(1'b1),.dout(grp_fu_163_p1));
SgdLR_sw_fexp_32ns_32ns_32_10_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 10 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fexp_32ns_32ns_32_10_full_dsp_1_U27(.clk(ap_clk),.reset(ap_rst),.din0(32'd0),.din1(grp_fu_166_p1),.ce(1'b1),.dout(grp_fu_166_p2));
SgdLR_sw_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U28(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_323_p0),.din1(grp_fu_323_p1),.ce(grp_fu_323_ce),.dout(grp_fu_323_p2));
...
assign bitcast_ln43_fu_216_p1 = grp_SgdLR_sw_Pipeline_label_2_fu_113_v6_1_out;
...
assign v0_0_address1 = grp_SgdLR_sw_Pipeline_label_2_fu_113_v0_0_address1;
assign v0_1_address1 = grp_SgdLR_sw_Pipeline_label_2_fu_113_v0_1_address1;
assign v0_2_address1 = grp_SgdLR_sw_Pipeline_label_2_fu_113_v0_2_address1;
assign v0_3_address1 = grp_SgdLR_sw_Pipeline_label_2_fu_113_v0_3_address1;
