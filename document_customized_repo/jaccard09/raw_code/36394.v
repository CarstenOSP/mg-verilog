...
wire   [10:0] tmp_48_fu_823_p3;
reg   [10:0] tmp_48_reg_1099;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_26_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_26_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_503_min_s_4_out;
wire    grp_viterbi_Pipeline_L_end_fu_503_min_s_4_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_517_min_s_10_out;
wire    grp_viterbi_Pipeline_L_state_fu_517_min_s_10_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_2_reg_989[10 : 3] <= tmp_67_cast_fu_621_p1[10 : 3];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_48_reg_1099[10 : 3] <= tmp_48_fu_823_p3[10 : 3];
        trunc_ln50_1_reg_1109 <= trunc_ln50_1_fu_835_p1;
        trunc_ln52_reg_1113 <= trunc_ln52_fu_846_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_26_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_26_loc_fu_134 <= grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_26_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_517_min_s_10_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state44))) begin
        min_s_10_loc_fu_126 <= grp_viterbi_Pipeline_L_state_fu_517_min_s_10_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_503_min_s_4_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_4_loc_fu_130 <= grp_viterbi_Pipeline_L_end_fu_503_min_s_4_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state45)) begin
        path_1_d0_local = min_s_10_loc_fu_126;
    end else if ((1'b1 == ap_CS_fsm_state31)) begin
        path_1_d0_local = min_s_4_loc_fu_130;
    end else begin
        path_1_d0_local = 'bx;
    end
end
...
assign path_0_d0 = min_s_10_loc_fu_126;
...
assign tmp_48_fu_823_p3 = {{trunc_ln50_reg_1083}, {3'd0}};
assign tmp_49_fu_753_p3 = {{t_2_reg_954}, {lshr_ln7_reg_1031}};
assign tmp_67_cast_fu_621_p1 = tmp_s_fu_613_p3;
...
assign zext_ln33_fu_759_p1 = tmp_49_fu_753_p3;
assign zext_ln52_1_fu_860_p1 = lshr_ln52_1_fu_850_p4;
assign zext_ln52_2_fu_830_p1 = tmp_48_fu_823_p3;
