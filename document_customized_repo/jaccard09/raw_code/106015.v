...
wire   [1:0] trunc_ln35_fu_294_p1;
reg   [1:0] trunc_ln35_reg_428;
wire   [2:0] trunc_ln35_1_fu_298_p1;
reg   [2:0] trunc_ln35_1_reg_433;
wire   [31:0] tmp_s_fu_347_p11;
reg   [31:0] tmp_s_reg_498;
wire   [31:0] tmp_1_fu_370_p19;
reg   [31:0] tmp_1_reg_503;
wire   [63:0] zext_ln6_1_fu_334_p1;
wire   [63:0] zext_ln6_fu_312_p1;
reg   [6:0] i_fu_100;
...
wire   [2:0] lshr_ln6_4_fu_302_p4;
wire   [3:0] lshr_ln6_5_fu_324_p4;
wire   [31:0] tmp_s_fu_347_p9;
wire   [31:0] tmp_1_fu_370_p17;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_s_fu_347_p1;
wire   [1:0] tmp_s_fu_347_p3;
wire  signed [1:0] tmp_s_fu_347_p5;
wire  signed [1:0] tmp_s_fu_347_p7;
wire   [2:0] tmp_1_fu_370_p1;
wire   [2:0] tmp_1_fu_370_p3;
wire   [2:0] tmp_1_fu_370_p5;
wire   [2:0] tmp_1_fu_370_p7;
wire  signed [2:0] tmp_1_fu_370_p9;
wire  signed [2:0] tmp_1_fu_370_p11;
wire  signed [2:0] tmp_1_fu_370_p13;
wire  signed [2:0] tmp_1_fu_370_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U14741(.din0(buff_x1_q0),.din1(buff_x1_1_q0),.din2(buff_x1_2_q0),.din3(buff_x1_3_q0),.def(tmp_s_fu_347_p9),.sel(trunc_ln35_reg_428),.dout(tmp_s_fu_347_p11));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U14742(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.din4(buff_x2_4_q0),.din5(buff_x2_5_q0),.din6(buff_x2_6_q0),.din7(buff_x2_7_q0),.def(tmp_1_fu_370_p17),.sel(trunc_ln35_1_reg_433),.dout(tmp_1_fu_370_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_503 <= tmp_1_fu_370_p19;
        tmp_s_reg_498 <= tmp_s_fu_347_p11;
...
assign buff_x1_1_address0 = zext_ln6_1_fu_334_p1;
assign buff_x1_1_ce0 = buff_x1_1_ce0_local;
assign buff_x1_2_address0 = zext_ln6_1_fu_334_p1;
assign buff_x1_2_ce0 = buff_x1_2_ce0_local;
assign buff_x1_3_address0 = zext_ln6_1_fu_334_p1;
assign buff_x1_3_ce0 = buff_x1_3_ce0_local;
assign buff_x1_address0 = zext_ln6_1_fu_334_p1;
assign buff_x1_ce0 = buff_x1_ce0_local;
assign buff_x2_1_address0 = zext_ln6_fu_312_p1;
assign buff_x2_1_ce0 = buff_x2_1_ce0_local;
assign buff_x2_2_address0 = zext_ln6_fu_312_p1;
assign buff_x2_2_ce0 = buff_x2_2_ce0_local;
assign buff_x2_3_address0 = zext_ln6_fu_312_p1;
assign buff_x2_3_ce0 = buff_x2_3_ce0_local;
assign buff_x2_4_address0 = zext_ln6_fu_312_p1;
assign buff_x2_4_ce0 = buff_x2_4_ce0_local;
assign buff_x2_5_address0 = zext_ln6_fu_312_p1;
assign buff_x2_5_ce0 = buff_x2_5_ce0_local;
assign buff_x2_6_address0 = zext_ln6_fu_312_p1;
assign buff_x2_6_ce0 = buff_x2_6_ce0_local;
assign buff_x2_7_address0 = zext_ln6_fu_312_p1;
assign buff_x2_7_ce0 = buff_x2_7_ce0_local;
assign buff_x2_address0 = zext_ln6_fu_312_p1;
assign buff_x2_ce0 = buff_x2_ce0_local;
assign icmp_ln35_fu_282_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_4_fu_302_p4 = {{ap_sig_allocacmp_i_1[5:3]}};
assign lshr_ln6_5_fu_324_p4 = {{ap_sig_allocacmp_i_1[5:2]}};
assign tmp_1_fu_370_p17 = 'bx;
assign tmp_s_fu_347_p9 = 'bx;
assign trunc_ln35_1_fu_298_p1 = ap_sig_allocacmp_i_1[2:0];
assign trunc_ln35_fu_294_p1 = ap_sig_allocacmp_i_1[1:0];
assign x1_out_din = bitcast_ln36_fu_409_p1;
assign x1_out_write = x1_out_write_local;
assign x2_out_din = bitcast_ln37_fu_413_p1;
assign x2_out_write = x2_out_write_local;
assign zext_ln6_1_fu_334_p1 = lshr_ln6_5_fu_324_p4;
assign zext_ln6_fu_312_p1 = lshr_ln6_4_fu_302_p4;
endmodule 