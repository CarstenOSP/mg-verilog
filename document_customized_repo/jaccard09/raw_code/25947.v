...
wire   [8:0] offset_1_fu_583_p3;
reg   [8:0] offset_1_reg_1111;
reg   [8:0] offset_1_reg_1111_pp0_iter1_reg;
reg   [8:0] offset_1_reg_1111_pp0_iter2_reg;
reg   [8:0] offset_1_reg_1111_pp0_iter3_reg;
reg   [8:0] offset_1_reg_1111_pp0_iter4_reg;
...
wire   [9:0] zext_ln172_10_fu_610_p1;
reg   [9:0] zext_ln172_10_reg_1126;
reg   [6:0] tmp_61_reg_1134;
reg   [6:0] tmp_61_reg_1134_pp0_iter5_reg;
wire   [2:0] trunc_ln172_fu_632_p1;
reg   [2:0] trunc_ln172_reg_1139;
reg   [7:0] tmp_66_reg_1151;
reg   [7:0] tmp_67_reg_1156;
reg   [7:0] tmp_68_reg_1161;
...
wire   [63:0] zext_ln172_1_fu_663_p1;
...
wire   [8:0] mul_ln172_1_fu_616_p0;
wire   [10:0] mul_ln172_1_fu_616_p1;
wire   [18:0] mul_ln172_1_fu_616_p2;
wire   [2:0] grp_fu_591_p2;
wire   [20:0] tmp_66_fu_636_p1;
wire  signed [20:0] grp_fu_1035_p3;
wire   [20:0] tmp_67_fu_645_p1;
wire  signed [20:0] grp_fu_1044_p3;
wire   [20:0] tmp_68_fu_654_p1;
wire  signed [20:0] grp_fu_1053_p3;
wire   [20:0] tmp_62_fu_671_p1;
wire  signed [20:0] grp_fu_1062_p3;
wire   [7:0] tmp_62_fu_671_p4;
wire   [20:0] tmp_63_fu_689_p1;
wire  signed [20:0] grp_fu_1070_p3;
wire   [7:0] tmp_63_fu_689_p4;
wire   [20:0] tmp_64_fu_707_p1;
wire  signed [20:0] grp_fu_1078_p3;
wire   [7:0] tmp_64_fu_707_p4;
wire   [20:0] tmp_65_fu_725_p1;
wire  signed [20:0] grp_fu_1086_p3;
wire   [7:0] tmp_65_fu_725_p4;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [18:0] mul_ln172_1_fu_616_p00;
...
urem_9ns_4ns_3_13_1_U438(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_591_p0),.din1(grp_fu_591_p1),.ce(1'b1),.dout(grp_fu_591_p2));
fft1D_512_mul_9ns_11ns_19_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 9 ),.din1_WIDTH( 11 ),.dout_WIDTH( 19 ))
mul_9ns_11ns_19_1_1_U439(.din0(mul_ln172_1_fu_616_p0),.din1(mul_ln172_1_fu_616_p1),.dout(mul_ln172_1_fu_616_p2));
...
sparsemux_11_3_64_1_1_U440(.din0(smem_q1),.din1(smem_1_q1),.din2(smem_2_q1),.din3(smem_3_q1),.din4(smem_4_q1),.def(tmp_s_fu_767_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_s_fu_767_p13));
...
sparsemux_11_3_64_1_1_U441(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.def(tmp_21_fu_794_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_21_fu_794_p13));
...
sparsemux_11_3_64_1_1_U442(.din0(smem_q1),.din1(smem_1_q1),.din2(smem_2_q1),.din3(smem_3_q1),.din4(smem_4_q1),.def(tmp_22_fu_821_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_22_fu_821_p13));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_11_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_11_3_64_1_1_U443(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.def(tmp_23_fu_848_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_23_fu_848_p13));
...
sparsemux_11_3_64_1_1_U444(.din0(smem_q1),.din1(smem_1_q1),.din2(smem_2_q1),.din3(smem_3_q1),.din4(smem_4_q1),.def(tmp_24_fu_875_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_24_fu_875_p13));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_11_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h2 ),.din0_WIDTH( 64 ),.CASE1( 3'h3 ),.din1_WIDTH( 64 ),.CASE2( 3'h4 ),.din2_WIDTH( 64 ),.CASE3( 3'h0 ),.din3_WIDTH( 64 ),.CASE4( 3'h1 ),.din4_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_11_3_64_1_1_U445(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.def(tmp_25_fu_902_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_25_fu_902_p13));
...
sparsemux_11_3_64_1_1_U446(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.def(tmp_26_fu_929_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_26_fu_929_p13));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_11_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h4 ),.din0_WIDTH( 64 ),.CASE1( 3'h0 ),.din1_WIDTH( 64 ),.CASE2( 3'h1 ),.din2_WIDTH( 64 ),.CASE3( 3'h2 ),.din3_WIDTH( 64 ),.CASE4( 3'h3 ),.din4_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_11_3_64_1_1_U447(.din0(smem_q0),.din1(smem_1_q0),.din2(smem_2_q0),.din3(smem_3_q0),.din4(smem_4_q0),.def(tmp_27_fu_956_p11),.sel(trunc_ln172_reg_1139),.dout(tmp_27_fu_956_p13));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U448(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1035_p0),.din1(grp_fu_1035_p1),.din2(grp_fu_1035_p2),.ce(1'b1),.dout(grp_fu_1035_p3));
fft1D_512_am_addmul_9ns_5ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 5 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_5ns_11ns_21_4_1_U449(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1044_p0),.din1(grp_fu_1044_p1),.din2(grp_fu_1044_p2),.ce(1'b1),.dout(grp_fu_1044_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U450(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1053_p0),.din1(grp_fu_1053_p1),.din2(grp_fu_1053_p2),.ce(1'b1),.dout(grp_fu_1053_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U451(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1062_p0),.din1(grp_fu_1062_p1),.din2(grp_fu_1062_p2),.ce(1'b1),.dout(grp_fu_1062_p3));
fft1D_512_am_addmul_9ns_4ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 4 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_4ns_11ns_21_4_1_U452(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1070_p0),.din1(grp_fu_1070_p1),.din2(grp_fu_1070_p2),.ce(1'b1),.dout(grp_fu_1070_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U453(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1078_p0),.din1(grp_fu_1078_p1),.din2(grp_fu_1078_p2),.ce(1'b1),.dout(grp_fu_1078_p3));
fft1D_512_am_addmul_9ns_5ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 5 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_5ns_11ns_21_4_1_U454(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1086_p0),.din1(grp_fu_1086_p1),.din2(grp_fu_1086_p2),.ce(1'b1),.dout(grp_fu_1086_p3));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        offset_1_reg_1111 <= offset_1_fu_583_p3;
        offset_1_reg_1111_pp0_iter1_reg <= offset_1_reg_1111;
        offset_1_reg_1111_pp0_iter2_reg <= offset_1_reg_1111_pp0_iter1_reg;
        offset_1_reg_1111_pp0_iter3_reg <= offset_1_reg_1111_pp0_iter2_reg;
        offset_1_reg_1111_pp0_iter4_reg <= offset_1_reg_1111_pp0_iter3_reg;
        ...
        tmp_66_reg_1151 <= {{tmp_66_fu_636_p1[20:13]}};
        tmp_67_reg_1156 <= {{tmp_67_fu_645_p1[20:13]}};
        tmp_68_reg_1161 <= {{tmp_68_fu_654_p1[20:13]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_61_reg_1134 <= {{mul_ln172_1_fu_616_p2[18:12]}};
        tmp_61_reg_1134_pp0_iter5_reg <= tmp_61_reg_1134;
        ...
        zext_ln172_10_reg_1126[8 : 0] <= zext_ln172_10_fu_610_p1[8 : 0];
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_297)) begin
        if ((trunc_ln172_reg_1139 == 3'd0)) begin
            ...
            smem_1_address1_local = zext_ln172_1_fu_663_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_297)) begin
        if ((trunc_ln172_reg_1139 == 3'd1)) begin
            ...
            smem_2_address1_local = zext_ln172_1_fu_663_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_297)) begin
        if ((trunc_ln172_reg_1139 == 3'd2)) begin
            ...
            smem_3_address1_local = zext_ln172_1_fu_663_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_297)) begin
        if ((trunc_ln172_reg_1139 == 3'd3)) begin
            ...
            smem_4_address1_local = zext_ln172_1_fu_663_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_297)) begin
        if ((trunc_ln172_reg_1139 == 3'd4)) begin
            ...
            smem_address1_local = zext_ln172_1_fu_663_p1;
        end else begin
...
assign mul_ln172_1_fu_616_p0 = mul_ln172_1_fu_616_p00;
assign mul_ln172_1_fu_616_p00 = offset_1_reg_1111_pp0_iter4_reg;
assign mul_ln172_1_fu_616_p1 = 19'd820;
assign offset_1_fu_583_p3 = {{tmp_fu_569_p4}, {trunc_ln312_fu_579_p1}};
...
assign tmp_62_fu_671_p1 = grp_fu_1062_p3;
assign tmp_62_fu_671_p4 = {{tmp_62_fu_671_p1[20:13]}};
assign tmp_63_fu_689_p1 = grp_fu_1070_p3;
assign tmp_63_fu_689_p4 = {{tmp_63_fu_689_p1[20:13]}};
assign tmp_64_fu_707_p1 = grp_fu_1078_p3;
assign tmp_64_fu_707_p4 = {{tmp_64_fu_707_p1[20:13]}};
assign tmp_65_fu_725_p1 = grp_fu_1086_p3;
assign tmp_65_fu_725_p4 = {{tmp_65_fu_725_p1[20:13]}};
assign tmp_66_fu_636_p1 = grp_fu_1035_p3;
assign tmp_67_fu_645_p1 = grp_fu_1044_p3;
assign tmp_68_fu_654_p1 = grp_fu_1053_p3;
...
assign zext_ln172_10_fu_610_p1 = offset_1_reg_1111_pp0_iter4_reg;
assign zext_ln172_1_fu_663_p1 = tmp_61_reg_1134_pp0_iter5_reg;
assign zext_ln314_fu_990_p1 = shl_ln7_fu_983_p3;
assign zext_ln315_1_fu_1003_p1 = or_ln_fu_996_p3;
assign zext_ln315_fu_680_p1 = tmp_62_fu_671_p4;
assign zext_ln316_fu_698_p1 = tmp_63_fu_689_p4;
assign zext_ln317_fu_716_p1 = tmp_64_fu_707_p4;
assign zext_ln318_1_fu_1016_p1 = or_ln5_fu_1009_p3;
assign zext_ln318_fu_734_p1 = tmp_65_fu_725_p4;
assign zext_ln319_1_fu_1029_p1 = or_ln6_fu_1022_p3;
assign zext_ln319_fu_743_p1 = tmp_66_reg_1151;
assign zext_ln320_fu_751_p1 = tmp_67_reg_1156;
assign zext_ln321_fu_759_p1 = tmp_68_reg_1161;
always @ (posedge ap_clk) begin
    zext_ln172_10_reg_1126[9] <= 1'b0;
end
endmodule 