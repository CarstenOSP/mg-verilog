module backprop_backprop_Pipeline_VITIS_LOOP_11_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_22946,mux_case_12842,mux_case_02738,activations3_load,activations3_1_load,activations3_2_load,sum_reload,mux_case_22944_out,mux_case_22944_out_ap_vld,mux_case_12840_out,mux_case_12840_out_ap_vld,mux_case_02736_out,mux_case_02736_out_ap_vld,grp_fu_3255_p_din0,grp_fu_3255_p_din1,grp_fu_3255_p_dout0,grp_fu_3255_p_ce,grp_fu_3259_p_din0,grp_fu_3259_p_din1,grp_fu_3259_p_dout0,grp_fu_3259_p_ce); 
...
sparsemux_7_2_64_1_1_U153(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_7_fu_187_p7),.sel(ap_sig_allocacmp_i_16),.dout(tmp_7_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_02736_fu_68 <= grp_fu_3255_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_12840_fu_72 <= grp_fu_3255_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_22944_fu_76 <= grp_fu_3255_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_8_reg_328 <= grp_fu_3259_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_3255_p_din0 = tmp_8_reg_328;
assign grp_fu_3255_p_din1 = sum_reload;
assign grp_fu_3259_p_ce = 1'b1;
assign grp_fu_3259_p_din0 = 64'd0;
assign grp_fu_3259_p_din1 = bitcast_ln12_1_fu_240_p1;
