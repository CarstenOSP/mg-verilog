...
sparsemux_17_3_32_1_1_U930(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.din4(tmp1_4_q0),.din5(tmp1_5_q0),.din6(tmp1_6_q0),.din7(tmp1_7_q0),.def(tmp_1_fu_705_p17),.sel(trunc_ln46_1_reg_852),.dout(tmp_1_fu_705_p19));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U931(.din0(tmp2_q0),.din1(tmp2_1_q0),.din2(tmp2_2_q0),.din3(tmp2_3_q0),.din4(tmp2_4_q0),.din5(tmp2_5_q0),.din6(tmp2_6_q0),.din7(tmp2_7_q0),.def(tmp_2_fu_744_p17),.sel(trunc_ln46_1_reg_852),.dout(tmp_2_fu_744_p19));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U932(.din0(buff_C_q0),.din1(buff_C_1_q0),.din2(buff_C_2_q0),.din3(buff_C_3_q0),.din4(buff_C_4_q0),.din5(buff_C_5_q0),.din6(buff_C_6_q0),.din7(buff_C_7_q0),.def(tmp_3_fu_783_p17),.sel(trunc_ln46_1_reg_852_pp0_iter4_reg),.dout(tmp_3_fu_783_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add2_reg_1014 <= grp_fu_704_p_dout0;
        add3_reg_1024 <= grp_fu_708_p_dout0;
        ...
        mul4_reg_1019 <= grp_fu_960_p_dout0;
        tmp_1_reg_959 <= tmp_1_fu_705_p19;
...
assign grp_fu_704_p_din0 = tmp_1_reg_959;
assign grp_fu_704_p_din1 = tmp_2_reg_964;
assign grp_fu_704_p_opcode = 2'd0;
assign grp_fu_708_p_ce = 1'b1;
assign grp_fu_708_p_din0 = add2_reg_1014;
assign grp_fu_708_p_din1 = mul4_reg_1019;
assign grp_fu_708_p_opcode = 2'd0;
assign grp_fu_960_p_ce = 1'b1;
assign grp_fu_960_p_din0 = tmp_3_reg_1009;
