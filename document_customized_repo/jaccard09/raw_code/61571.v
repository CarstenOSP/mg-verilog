...
wire   [13:0] tmp_227_fu_262_p3;
reg   [13:0] tmp_227_reg_414;
wire    ap_CS_fsm_state6;
wire   [7:0] empty_fu_269_p2;
reg   [7:0] empty_reg_419;
wire   [13:0] tmp_228_fu_274_p3;
reg   [13:0] tmp_228_reg_424;
reg   [13:0] llike_addr_9_reg_429;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_197_min_p_145_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_197_min_p_145_out_ap_vld;
...
wire   [63:0] tmp_228_cast_fu_282_p1;
...
dadd_64ns_64ns_64_8_full_dsp_1_U29(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_227_p0),.din1(grp_fu_227_p1),.ce(grp_fu_227_ce),.dout(grp_fu_227_p2));
viterbi_dadd_64ns_64ns_64_8_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 8 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dadd_64ns_64ns_64_8_full_dsp_1_U30(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_492_p0),.din1(grp_fu_492_p1),.ce(grp_fu_492_ce),.dout(grp_fu_492_p2));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U31(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_496_p0),.din1(grp_fu_496_p1),.ce(grp_fu_496_ce),.opcode(grp_fu_496_opcode),.dout(grp_fu_496_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_9_reg_429[13 : 6] <= tmp_228_cast_fu_282_p1[13 : 6];
        tmp_227_reg_414[13 : 6] <= tmp_227_fu_262_p3[13 : 6];
        tmp_228_reg_424[13 : 6] <= tmp_228_fu_274_p3[13 : 6];
        zext_ln19_reg_434[7 : 0] <= zext_ln19_fu_287_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_197_min_p_145_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_145_loc_fu_80 <= grp_viterbi_Pipeline_L_prev_state_fu_197_min_p_145_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state27)) begin
        ...
        llike_address0_local = llike_addr_9_reg_429;
...
assign add_ln33_fu_307_p2 = (tmp_227_reg_414 + zext_ln33_fu_303_p1);
...
assign tmp_227_fu_262_p3 = {{t_fu_72}, {6'd0}};
assign tmp_228_cast_fu_282_p1 = tmp_228_fu_274_p3;
assign tmp_228_fu_274_p3 = {{empty_fu_269_p2}, {6'd0}};
...
always @ (posedge ap_clk) begin
    tmp_227_reg_414[5:0] <= 6'b000000;
    tmp_228_reg_424[5:0] <= 6'b000000;
    llike_addr_9_reg_429[5:0] <= 6'b000000;
