module sha_stream_sha_transform_Pipeline_trans_lp6 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,B_23_reload,B_20_reload,D_23_reload,E_23_reload,E_20_reload,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,W_2_address0,W_2_ce0,W_2_q0,W_3_address0,W_3_ce0,W_3_q0,A_24_out,A_24_out_ap_vld,B_21_out,B_21_out_ap_vld,C_22_out,C_22_out_ap_vld,D_24_out,D_24_out_ap_vld,E_21_out,E_21_out_ap_vld); 
...
wire   [31:0] tmp_2_fu_303_p11;
reg   [31:0] tmp_2_reg_525;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_2_fu_303_p1;
wire   [1:0] tmp_2_fu_303_p3;
wire  signed [1:0] tmp_2_fu_303_p5;
wire  signed [1:0] tmp_2_fu_303_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U62(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.def(tmp_2_fu_303_p9),.sel(trunc_ln128_reg_500),.dout(tmp_2_fu_303_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_525 <= tmp_2_fu_303_p11;
...
assign A_24_out = B_1_fu_110;
assign B_21_out = B_fu_94;
assign C_1_fu_372_p3 = {{trunc_ln130_1_fu_358_p1}, {lshr_ln130_1_fu_362_p4}};
assign C_22_out = C_reg_536;
assign D_24_out = D_3_reg_530;
assign E_21_out = E_fu_90;
...
assign add_ln130_1_fu_347_p2 = ($signed(tmp_2_reg_525) + $signed(32'd3395469782));
assign add_ln130_2_fu_352_p2 = (add_ln130_1_fu_347_p2 + xor_ln130_1_fu_341_p2);
assign add_ln130_fu_419_p2 = (or_ln4_fu_411_p3 + E_fu_90);
...
assign or_ln4_fu_411_p3 = {{trunc_ln130_fu_397_p1}, {lshr_ln6_fu_401_p4}};
assign temp_fu_425_p2 = (add_ln130_2_reg_541 + add_ln130_fu_419_p2);
assign tmp_2_fu_303_p9 = 'bx;
