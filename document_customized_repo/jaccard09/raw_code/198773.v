module SgdLR_sw_SgdLR_sw_Pipeline_label_38 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v3_1_address0,v3_1_ce0,v3_1_we0,v3_1_d0,v3_1_address1,v3_1_ce1,v3_1_we1,v3_1_d1,v3_address0,v3_ce0,v3_we0,v3_d0,v3_address1,v3_ce1,v3_we1,v3_d1,tmp_15,v0_address0,v0_ce0,v0_q0,v0_address1,v0_ce1,v0_q1,v22_3,v5_3,grp_fu_2246_p_din0,grp_fu_2246_p_din1,grp_fu_2246_p_dout0,grp_fu_2246_p_ce,grp_fu_2250_p_din0,grp_fu_2250_p_din1,grp_fu_2250_p_dout0,grp_fu_2250_p_ce); 
...
reg   [31:0] reg_241;
reg   [31:0] reg_247;
reg   [10:0] v19_1_reg_478;
reg   [10:0] v19_1_reg_478_pp0_iter1_reg;
reg   [10:0] v19_1_reg_478_pp0_iter2_reg;
...
wire   [31:0] v23_1_fu_377_p1;
wire   [31:0] v23_2_fu_382_p1;
wire   [31:0] v23_3_fu_387_p1;
reg   [6:0] tmp_2_reg_535;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln51_fu_279_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln51_2_fu_304_p1;
wire   [63:0] zext_ln51_4_fu_343_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln51_6_fu_357_p1;
wire   [63:0] zext_ln48_fu_395_p1;
wire   [63:0] zext_ln51_1_fu_418_p1;
wire   [63:0] zext_ln51_3_fu_440_p1;
wire   [63:0] zext_ln51_5_fu_453_p1;
reg   [10:0] v19_fu_80;
...
wire   [7:0] tmp_3_fu_325_p4;
wire   [22:0] add_ln51_1_fu_334_p4;
wire   [22:0] add_ln51_2_fu_348_p4;
wire   [8:0] trunc_ln47_fu_392_p1;
wire   [7:0] tmp_s_fu_401_p4;
wire   [8:0] or_ln48_9_fu_410_p3;
wire   [8:0] or_ln48_s_fu_433_p3;
wire   [8:0] or_ln48_1_fu_446_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_535 <= {{v19_1_reg_478_pp0_iter2_reg[8:2]}};
        tmp_reg_487 <= ap_sig_allocacmp_v19_1[32'd10];
        v19_1_reg_478 <= ap_sig_allocacmp_v19_1;
        v19_1_reg_478_pp0_iter1_reg <= v19_1_reg_478;
        v19_1_reg_478_pp0_iter2_reg <= v19_1_reg_478_pp0_iter1_reg;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            grp_fu_229_p1 = v23_3_fu_387_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            grp_fu_229_p1 = v23_1_fu_377_p1;
        end else begin
            grp_fu_229_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address0_local = zext_ln51_6_fu_357_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v0_address0_local = zext_ln51_2_fu_304_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address1_local = zext_ln51_4_fu_343_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter3 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v3_1_address0_local = zext_ln51_5_fu_453_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v3_1_address0_local = zext_ln51_1_fu_418_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter3 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v3_1_address1_local = zext_ln51_3_fu_440_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter3 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v3_address0_local = zext_ln51_5_fu_453_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v3_address0_local = zext_ln51_1_fu_418_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter3 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v3_address1_local = zext_ln51_3_fu_440_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln47_fu_362_p2 = (v19_1_reg_478 + 11'd4);
assign add_ln51_1_fu_334_p4 = {{{v5_3}, {tmp_3_fu_325_p4}}, {2'd2}};
assign add_ln51_2_fu_348_p4 = {{{v5_3}, {tmp_3_fu_325_p4}}, {2'd3}};
assign add_ln51_fu_273_p2 = (zext_ln47_fu_269_p1 + tmp_15);
assign add_ln51_s_fu_294_p4 = {{{v5_3}, {tmp_1_fu_284_p4}}, {1'd1}};
...
assign grp_fu_2246_p_din0 = v22_3;
assign grp_fu_2246_p_din1 = grp_fu_225_p1;
assign grp_fu_2250_p_ce = 1'b1;
assign grp_fu_2250_p_din0 = v22_3;
assign grp_fu_2250_p_din1 = grp_fu_229_p1;
assign icmp_ln53_fu_319_p2 = ((tmp_6_fu_309_p4 == 2'd0) ? 1'b1 : 1'b0);
assign or_ln48_1_fu_446_p3 = {{tmp_2_reg_535}, {2'd3}};
assign or_ln48_9_fu_410_p3 = {{tmp_s_fu_401_p4}, {1'd1}};
assign or_ln48_s_fu_433_p3 = {{tmp_2_reg_535}, {2'd2}};
assign tmp_1_fu_284_p4 = {{ap_sig_allocacmp_v19_1[9:1]}};
assign tmp_3_fu_325_p4 = {{v19_1_reg_478[9:2]}};
assign tmp_6_fu_309_p4 = {{ap_sig_allocacmp_v19_1[10:9]}};
assign tmp_fu_261_p3 = ap_sig_allocacmp_v19_1[32'd10];
assign tmp_s_fu_401_p4 = {{v19_1_reg_478_pp0_iter2_reg[8:1]}};
assign trunc_ln47_fu_392_p1 = v19_1_reg_478_pp0_iter2_reg[8:0];
assign v0_address0 = v0_address0_local;
assign v0_address1 = v0_address1_local;
assign v0_ce0 = v0_ce0_local;
assign v0_ce1 = v0_ce1_local;
assign v23_1_fu_377_p1 = reg_237;
assign v23_2_fu_382_p1 = reg_233;
assign v23_3_fu_387_p1 = reg_237;
...
assign zext_ln51_1_fu_418_p1 = or_ln48_9_fu_410_p3;
assign zext_ln51_2_fu_304_p1 = add_ln51_s_fu_294_p4;
assign zext_ln51_3_fu_440_p1 = or_ln48_s_fu_433_p3;
assign zext_ln51_4_fu_343_p1 = add_ln51_1_fu_334_p4;
assign zext_ln51_5_fu_453_p1 = or_ln48_1_fu_446_p3;
assign zext_ln51_6_fu_357_p1 = add_ln51_2_fu_348_p4;
