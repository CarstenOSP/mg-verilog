...
sparsemux_7_2_64_1_1_U166(.din0(mux_case_02736_reload),.din1(mux_case_12840_reload),.din2(mux_case_22944_reload),.def(tmp_9_fu_329_p7),.sel(i_11_reg_526_pp0_iter1_reg),.dout(tmp_9_fu_329_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U167(.din0(mux_case_03048_reload),.din1(mux_case_13152_reload),.din2(mux_case_23256_reload),.def(tmp_s_fu_372_p7),.sel(i_11_reg_526_pp0_iter8_reg),.dout(tmp_s_fu_372_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul5_i_reg_576 <= grp_fu_3247_p_dout0;
...
assign bitcast_ln67_1_fu_350_p1 = grp_fu_3239_p_dout0;
...
assign grp_fu_3239_p_din0 = tmp_9_fu_329_p9;
assign grp_fu_3239_p_din1 = bitcast_ln67_fu_346_p1;
assign grp_fu_3239_p_opcode = 2'd1;
assign grp_fu_3247_p_ce = 1'b1;
assign grp_fu_3247_p_din0 = bitcast_ln67_2_fu_394_p1;
assign grp_fu_3247_p_din1 = tmp_s_reg_566;
