...
wire   [7:0] lshr_ln4_fu_303_p4;
wire   [6:0] add_ln27_fu_318_p2;
wire   [3:0] lshr_ln27_1_fu_324_p4;
wire   [31:0] tmp_fu_349_p17;
wire   [2:0] tmp_fu_349_p18;
wire   [31:0] tmp_fu_349_p19;
wire   [3:0] lshr_ln3_fu_395_p4;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_fu_349_p1;
wire   [2:0] tmp_fu_349_p3;
wire   [2:0] tmp_fu_349_p5;
wire  signed [2:0] tmp_fu_349_p7;
wire  signed [2:0] tmp_fu_349_p9;
wire  signed [2:0] tmp_fu_349_p11;
wire  signed [2:0] tmp_fu_349_p13;
wire   [2:0] tmp_fu_349_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_17_3_32_1_1_x_U40(.din0(sum_0_q0),.din1(sum_1_q0),.din2(sum_2_q0),.din3(sum_3_q0),.din4(sum_4_q0),.din5(sum_5_q0),.din6(sum_6_q0),.din7(sum_7_q0),.def(tmp_fu_349_p17),.sel(tmp_fu_349_p18),.dout(tmp_fu_349_p19));
...
assign add_ln27_1_fu_389_p2 = (bucket_7_q0 + tmp_fu_349_p19);
...
assign lshr_ln3_fu_395_p4 = {{radixID_1_reg_433[6:3]}};
assign lshr_ln4_fu_303_p4 = {{add_ln26_fu_297_p2[10:3]}};
