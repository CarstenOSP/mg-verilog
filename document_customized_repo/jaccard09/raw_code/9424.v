module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_42_reload,B_40_reload,C_41_reload,D_42_reload,E_40_reload,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,W_2_address0,W_2_ce0,W_2_q0,W_3_address0,W_3_ce0,W_3_q0,B_39_out,B_39_out_ap_vld,B_37_out,B_37_out_ap_vld,D_39_out,D_39_out_ap_vld,E_39_out,E_39_out_ap_vld,E_28_out,E_28_out_ap_vld); 
...
sparsemux_9_2_32_1_1_U38(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.def(tmp_fu_303_p9),.sel(trunc_ln100_reg_513),.dout(tmp_fu_303_p11));
...
assign B_37_out = B_fu_94;
assign B_39_out = A_fu_110;
assign C_3_fu_387_p3 = {{trunc_ln126_1_fu_373_p1}, {lshr_ln126_1_fu_377_p4}};
assign D_39_out = D_6_reg_548;
assign E_28_out = E_fu_90;
assign E_39_out = E_4_reg_543;
