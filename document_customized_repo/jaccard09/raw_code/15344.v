...
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U1016(.din0(mux_case_0188206_reload),.din1(mux_case_1189210_reload),.din2(mux_case_2190214_reload),.def(tmp_196_fu_1213_p7),.sel(i_11_reg_1367_pp0_iter8_reg),.dout(tmp_196_fu_1213_p9));
...
assign grp_fu_6440_p_din1 = tmp_196_reg_1562;
assign grp_fu_8393_p_ce = 1'b1;
assign grp_fu_8393_p_din0 = tmp_s_fu_1174_p9;
assign grp_fu_8393_p_din1 = tmp_195_reg_1542;
