...
reg   [11:0] indvar_flatten28_fu_100;
...
#0 j_fu_92 = 7'd0;
#0 i_fu_96 = 7'd0;
#0 indvar_flatten28_fu_100 = 12'd0;
#0 ap_done_reg = 1'b0;
end
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U81(.clk(ap_clk),.reset(ap_rst),.din0(tmp_4_reg_747),.din1(mul74_1_reg_742),.ce(1'b1),.dout(grp_fu_354_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U83(.clk(ap_clk),.reset(ap_rst),.din0(tmp_3_reg_679),.din1(beta),.ce(1'b1),.dout(grp_fu_362_p2));
...
sparsemux_9_3_32_1_1_U84(.din0(buff_B_q0),.din1(buff_B_2_q0),.din2(buff_B_4_q0),.din3(buff_B_6_q0),.def(tmp_1_fu_491_p9),.sel(trunc_ln30_1_reg_614),.dout(tmp_1_fu_491_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U85(.din0(buff_B_1_q0),.din1(buff_B_3_q0),.din2(buff_B_5_q0),.din3(buff_B_7_q0),.def(tmp_3_fu_514_p9),.sel(trunc_ln30_1_reg_614),.dout(tmp_3_fu_514_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U86(.din0(buff_C_out_q1),.din1(buff_C_out_2_q1),.din2(buff_C_out_4_q1),.din3(buff_C_out_6_q1),.def(tmp_2_fu_537_p9),.sel(trunc_ln30_1_reg_614_pp0_iter5_reg),.dout(tmp_2_fu_537_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U87(.din0(buff_C_out_1_q1),.din1(buff_C_out_3_q1),.din2(buff_C_out_5_q1),.din3(buff_C_out_7_q1),.def(tmp_4_fu_560_p9),.sel(trunc_ln30_1_reg_614_pp0_iter5_reg),.dout(tmp_4_fu_560_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln29_fu_384_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten28_fu_100 <= add_ln29_1_fu_390_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten28_fu_100 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul1_reg_732 <= grp_fu_420_p_dout0;
        mul74_1_reg_742 <= grp_fu_362_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten28_load = indvar_flatten28_fu_100;
    end
end
always @ (*) begin
...
assign add_ln29_1_fu_390_p2 = (ap_sig_allocacmp_indvar_flatten28_load + 12'd1);
...
assign grp_fu_416_p_din1 = mul1_reg_732;
assign grp_fu_416_p_opcode = 2'd0;
assign grp_fu_420_p_ce = 1'b1;
assign grp_fu_420_p_din0 = tmp_1_reg_674;
assign grp_fu_420_p_din1 = beta;
assign icmp_ln29_fu_384_p2 = ((ap_sig_allocacmp_indvar_flatten28_load == 12'd2048) ? 1'b1 : 1'b0);
