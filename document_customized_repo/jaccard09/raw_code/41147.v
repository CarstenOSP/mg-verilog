...
wire   [63:0] tmp_166_fu_1566_p67;
reg   [63:0] tmp_166_reg_2075;
...
wire   [63:0] tmp_166_fu_1566_p2;
wire   [63:0] tmp_166_fu_1566_p4;
wire   [63:0] tmp_166_fu_1566_p6;
wire   [63:0] tmp_166_fu_1566_p8;
wire   [63:0] tmp_166_fu_1566_p10;
wire   [63:0] tmp_166_fu_1566_p12;
wire   [63:0] tmp_166_fu_1566_p14;
wire   [63:0] tmp_166_fu_1566_p16;
wire   [63:0] tmp_166_fu_1566_p18;
wire   [63:0] tmp_166_fu_1566_p20;
wire   [63:0] tmp_166_fu_1566_p22;
wire   [63:0] tmp_166_fu_1566_p24;
wire   [63:0] tmp_166_fu_1566_p26;
wire   [63:0] tmp_166_fu_1566_p28;
wire   [63:0] tmp_166_fu_1566_p30;
wire   [63:0] tmp_166_fu_1566_p32;
wire   [63:0] tmp_166_fu_1566_p34;
wire   [63:0] tmp_166_fu_1566_p36;
wire   [63:0] tmp_166_fu_1566_p38;
wire   [63:0] tmp_166_fu_1566_p40;
wire   [63:0] tmp_166_fu_1566_p42;
wire   [63:0] tmp_166_fu_1566_p44;
wire   [63:0] tmp_166_fu_1566_p46;
wire   [63:0] tmp_166_fu_1566_p48;
wire   [63:0] tmp_166_fu_1566_p50;
wire   [63:0] tmp_166_fu_1566_p52;
wire   [63:0] tmp_166_fu_1566_p54;
wire   [63:0] tmp_166_fu_1566_p56;
wire   [63:0] tmp_166_fu_1566_p58;
wire   [63:0] tmp_166_fu_1566_p60;
wire   [63:0] tmp_166_fu_1566_p62;
wire   [63:0] tmp_166_fu_1566_p64;
wire   [63:0] tmp_166_fu_1566_p65;
...
wire   [4:0] tmp_166_fu_1566_p1;
wire   [4:0] tmp_166_fu_1566_p3;
wire   [4:0] tmp_166_fu_1566_p5;
wire   [4:0] tmp_166_fu_1566_p7;
wire   [4:0] tmp_166_fu_1566_p9;
wire   [4:0] tmp_166_fu_1566_p11;
wire   [4:0] tmp_166_fu_1566_p13;
wire   [4:0] tmp_166_fu_1566_p15;
wire   [4:0] tmp_166_fu_1566_p17;
wire   [4:0] tmp_166_fu_1566_p19;
wire   [4:0] tmp_166_fu_1566_p21;
wire   [4:0] tmp_166_fu_1566_p23;
wire   [4:0] tmp_166_fu_1566_p25;
wire   [4:0] tmp_166_fu_1566_p27;
wire   [4:0] tmp_166_fu_1566_p29;
wire   [4:0] tmp_166_fu_1566_p31;
wire  signed [4:0] tmp_166_fu_1566_p33;
wire  signed [4:0] tmp_166_fu_1566_p35;
wire  signed [4:0] tmp_166_fu_1566_p37;
wire  signed [4:0] tmp_166_fu_1566_p39;
wire  signed [4:0] tmp_166_fu_1566_p41;
wire  signed [4:0] tmp_166_fu_1566_p43;
wire  signed [4:0] tmp_166_fu_1566_p45;
wire  signed [4:0] tmp_166_fu_1566_p47;
wire  signed [4:0] tmp_166_fu_1566_p49;
wire  signed [4:0] tmp_166_fu_1566_p51;
wire  signed [4:0] tmp_166_fu_1566_p53;
wire  signed [4:0] tmp_166_fu_1566_p55;
wire  signed [4:0] tmp_166_fu_1566_p57;
wire  signed [4:0] tmp_166_fu_1566_p59;
wire  signed [4:0] tmp_166_fu_1566_p61;
wire  signed [4:0] tmp_166_fu_1566_p63;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_65_5_64_1_1_U564(.din0(activations2_q1),.din1(activations2_1_q1),.din2(activations2_2_q1),.din3(activations2_3_q1),.din4(activations2_4_q1),.din5(activations2_5_q1),.din6(activations2_6_q1),.din7(activations2_7_q1),.din8(activations2_8_q1),.din9(activations2_9_q1),.din10(activations2_10_q1),.din11(activations2_11_q1),.din12(activations2_12_q1),.din13(activations2_13_q1),.din14(activations2_14_q1),.din15(activations2_15_q1),.din16(activations2_16_q1),.din17(activations2_17_q1),.din18(activations2_18_q1),.din19(activations2_19_q1),.din20(activations2_20_q1),.din21(activations2_21_q1),.din22(activations2_22_q1),.din23(activations2_23_q1),.din24(activations2_24_q1),.din25(activations2_25_q1),.din26(activations2_26_q1),.din27(activations2_27_q1),.din28(activations2_28_q1),.din29(activations2_29_q1),.din30(activations2_30_q1),.din31(activations2_31_q1),.def(tmp_s_fu_1303_p65),.sel(trunc_ln26_reg_1712),.dout(tmp_s_fu_1303_p67));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_65_5_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 64 ),.CASE1( 5'h1 ),.din1_WIDTH( 64 ),.CASE2( 5'h2 ),.din2_WIDTH( 64 ),.CASE3( 5'h3 ),.din3_WIDTH( 64 ),.CASE4( 5'h4 ),.din4_WIDTH( 64 ),.CASE5( 5'h5 ),.din5_WIDTH( 64 ),.CASE6( 5'h6 ),.din6_WIDTH( 64 ),.CASE7( 5'h7 ),.din7_WIDTH( 64 ),.CASE8( 5'h8 ),.din8_WIDTH( 64 ),.CASE9( 5'h9 ),.din9_WIDTH( 64 ),.CASE10( 5'hA ),.din10_WIDTH( 64 ),.CASE11( 5'hB ),.din11_WIDTH( 64 ),.CASE12( 5'hC ),.din12_WIDTH( 64 ),.CASE13( 5'hD ),.din13_WIDTH( 64 ),.CASE14( 5'hE ),.din14_WIDTH( 64 ),.CASE15( 5'hF ),.din15_WIDTH( 64 ),.CASE16( 5'h10 ),.din16_WIDTH( 64 ),.CASE17( 5'h11 ),.din17_WIDTH( 64 ),.CASE18( 5'h12 ),.din18_WIDTH( 64 ),.CASE19( 5'h13 ),.din19_WIDTH( 64 ),.CASE20( 5'h14 ),.din20_WIDTH( 64 ),.CASE21( 5'h15 ),.din21_WIDTH( 64 ),.CASE22( 5'h16 ),.din22_WIDTH( 64 ),.CASE23( 5'h17 ),.din23_WIDTH( 64 ),.CASE24( 5'h18 ),.din24_WIDTH( 64 ),.CASE25( 5'h19 ),.din25_WIDTH( 64 ),.CASE26( 5'h1A ),.din26_WIDTH( 64 ),.CASE27( 5'h1B ),.din27_WIDTH( 64 ),.CASE28( 5'h1C ),.din28_WIDTH( 64 ),.CASE29( 5'h1D ),.din29_WIDTH( 64 ),.CASE30( 5'h1E ),.din30_WIDTH( 64 ),.CASE31( 5'h1F ),.din31_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 5 ),.dout_WIDTH( 64 ))
sparsemux_65_5_64_1_1_U565(.din0(tmp_166_fu_1566_p2),.din1(tmp_166_fu_1566_p4),.din2(tmp_166_fu_1566_p6),.din3(tmp_166_fu_1566_p8),.din4(tmp_166_fu_1566_p10),.din5(tmp_166_fu_1566_p12),.din6(tmp_166_fu_1566_p14),.din7(tmp_166_fu_1566_p16),.din8(tmp_166_fu_1566_p18),.din9(tmp_166_fu_1566_p20),.din10(tmp_166_fu_1566_p22),.din11(tmp_166_fu_1566_p24),.din12(tmp_166_fu_1566_p26),.din13(tmp_166_fu_1566_p28),.din14(tmp_166_fu_1566_p30),.din15(tmp_166_fu_1566_p32),.din16(tmp_166_fu_1566_p34),.din17(tmp_166_fu_1566_p36),.din18(tmp_166_fu_1566_p38),.din19(tmp_166_fu_1566_p40),.din20(tmp_166_fu_1566_p42),.din21(tmp_166_fu_1566_p44),.din22(tmp_166_fu_1566_p46),.din23(tmp_166_fu_1566_p48),.din24(tmp_166_fu_1566_p50),.din25(tmp_166_fu_1566_p52),.din26(tmp_166_fu_1566_p54),.din27(tmp_166_fu_1566_p56),.din28(tmp_166_fu_1566_p58),.din29(tmp_166_fu_1566_p60),.din30(tmp_166_fu_1566_p62),.din31(tmp_166_fu_1566_p64),.def(tmp_166_fu_1566_p65),.sel(trunc_ln26_reg_1712),.dout(tmp_166_fu_1566_p67));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_166_reg_2075 <= tmp_166_fu_1566_p67;
...
assign grp_fu_8393_p_din1 = tmp_166_reg_2075;
assign grp_fu_8393_p_opcode = 2'd0;
assign icmp_ln26_fu_1206_p2 = ((ap_sig_allocacmp_i_13 == 7'd64) ? 1'b1 : 1'b0);
assign tmp_166_fu_1566_p10 = biases2_4_q0;
assign tmp_166_fu_1566_p12 = biases2_5_q0;
assign tmp_166_fu_1566_p14 = biases2_6_q0;
assign tmp_166_fu_1566_p16 = biases2_7_q0;
assign tmp_166_fu_1566_p18 = biases2_8_q0;
assign tmp_166_fu_1566_p2 = biases2_0_q0;
assign tmp_166_fu_1566_p20 = biases2_9_q0;
assign tmp_166_fu_1566_p22 = biases2_10_q0;
assign tmp_166_fu_1566_p24 = biases2_11_q0;
assign tmp_166_fu_1566_p26 = biases2_12_q0;
assign tmp_166_fu_1566_p28 = biases2_13_q0;
assign tmp_166_fu_1566_p30 = biases2_14_q0;
assign tmp_166_fu_1566_p32 = biases2_15_q0;
assign tmp_166_fu_1566_p34 = biases2_16_q0;
assign tmp_166_fu_1566_p36 = biases2_17_q0;
assign tmp_166_fu_1566_p38 = biases2_18_q0;
assign tmp_166_fu_1566_p4 = biases2_1_q0;
assign tmp_166_fu_1566_p40 = biases2_19_q0;
assign tmp_166_fu_1566_p42 = biases2_20_q0;
assign tmp_166_fu_1566_p44 = biases2_21_q0;
assign tmp_166_fu_1566_p46 = biases2_22_q0;
assign tmp_166_fu_1566_p48 = biases2_23_q0;
assign tmp_166_fu_1566_p50 = biases2_24_q0;
assign tmp_166_fu_1566_p52 = biases2_25_q0;
assign tmp_166_fu_1566_p54 = biases2_26_q0;
assign tmp_166_fu_1566_p56 = biases2_27_q0;
assign tmp_166_fu_1566_p58 = biases2_28_q0;
assign tmp_166_fu_1566_p6 = biases2_2_q0;
assign tmp_166_fu_1566_p60 = biases2_29_q0;
assign tmp_166_fu_1566_p62 = biases2_30_q0;
assign tmp_166_fu_1566_p64 = biases2_31_q0;
assign tmp_166_fu_1566_p65 = 'bx;
assign tmp_166_fu_1566_p8 = biases2_3_q0;
