module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_31_reload,B_6_reload,C_27_reload,D_31_reload,E_6_reload,W_address0,W_ce0,W_q0,W_address1,W_ce1,W_q1,W_1_address0,W_1_ce0,W_1_q0,W_1_address1,W_1_ce1,W_1_q1,E_31_out,E_31_out_ap_vld,B_31_out,B_31_out_ap_vld,D_35_out,D_35_out_ap_vld,A_35_out,A_35_out_ap_vld,C_39_out,C_39_out_ap_vld); 
...
wire   [4:0] or_ln100_2_fu_344_p3;
wire   [5:0] or_ln3_fu_368_p3;
...
wire   [4:0] or_ln100_3_fu_507_p4;
wire   [4:0] or_ln100_4_fu_521_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        E_11_fu_96 <= C_14_fu_987_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_12_fu_108 <= C_27_reload;
...
assign A_35_out = (add_ln126_13_reg_1362 + add_ln126_14_fu_763_p2);
...
assign C_39_out = {{trunc_ln126_7_reg_1344}, {lshr_ln126_7_reg_1349}};
assign D_35_out = D_reg_1331;
...
assign add_ln126_fu_537_p2 = (reg_267 + E_11_fu_96);
...
assign icmp_ln124_fu_376_p2 = ((or_ln3_fu_368_p3 == 6'd60) ? 1'b1 : 1'b0);
...
assign or_ln100_2_fu_344_p3 = {{tmp_s_fu_334_p4}, {1'd1}};
assign or_ln100_3_fu_507_p4 = {{{tmp_1_reg_1194}, {1'd1}}, {tmp_reg_1204}};
assign or_ln100_4_fu_521_p3 = {{tmp_1_reg_1194}, {2'd3}};
...
assign or_ln3_fu_368_p3 = {{tmp_1_fu_358_p4}, {3'd4}};
...
assign zext_ln100_4_fu_352_p1 = or_ln100_2_fu_344_p3;
assign zext_ln100_5_fu_528_p1 = or_ln100_4_fu_521_p3;
assign zext_ln100_fu_328_p1 = lshr_ln100_2_fu_318_p4;
assign zext_ln124_fu_515_p1 = or_ln100_3_fu_507_p4;
endmodule 