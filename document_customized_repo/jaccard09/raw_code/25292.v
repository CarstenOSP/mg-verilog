...
wire   [10:0] tmp_57_fu_823_p3;
reg   [10:0] tmp_57_reg_1099;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_34_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_34_out_ap_vld;
...
wire   [63:0] tmp_88_cast_fu_621_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_1_reg_989[10 : 3] <= tmp_88_cast_fu_621_p1[10 : 3];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_57_reg_1099[10 : 3] <= tmp_57_fu_823_p3[10 : 3];
        trunc_ln50_1_reg_1109 <= trunc_ln50_1_fu_835_p1;
        trunc_ln52_reg_1113 <= trunc_ln52_fu_846_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_34_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_34_loc_fu_134 <= grp_viterbi_Pipeline_L_prev_state_fu_480_min_p_34_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_34_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_34_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_34_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_4_d0 = min_p_34_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_5_d0 = min_p_34_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_6_d0 = min_p_34_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_7_d0 = min_p_34_loc_fu_134;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        llike_address0_local = llike_addr_1_reg_989;
...
assign tmp_57_fu_823_p3 = {{trunc_ln50_reg_1083}, {3'd0}};
assign tmp_58_fu_753_p3 = {{t_2_reg_954}, {lshr_ln7_reg_1031}};
assign tmp_88_cast_fu_621_p1 = tmp_s_fu_613_p3;
...
assign zext_ln33_fu_759_p1 = tmp_58_fu_753_p3;
assign zext_ln52_1_fu_860_p1 = lshr_ln52_1_fu_850_p4;
assign zext_ln52_2_fu_830_p1 = tmp_57_fu_823_p3;
...
always @ (posedge ap_clk) begin
    ...
    llike_addr_1_reg_989[2:0] <= 3'b000;
    conv32_udiv_cast_reg_999[10:7] <= 4'b0000;
    tmp_57_reg_1099[2:0] <= 3'b000;
end
endmodule 