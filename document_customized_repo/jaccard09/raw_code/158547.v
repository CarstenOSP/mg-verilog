module mvt_mvt_Pipeline_lpwr (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,x1_out_din,x1_out_full_n,x1_out_write,x2_out_din,x2_out_full_n,x2_out_write,buff_x1_address0,buff_x1_ce0,buff_x1_q0,buff_x1_1_address0,buff_x1_1_ce0,buff_x1_1_q0,buff_x1_2_address0,buff_x1_2_ce0,buff_x1_2_q0,buff_x1_3_address0,buff_x1_3_ce0,buff_x1_3_q0,buff_x2_address0,buff_x2_ce0,buff_x2_q0,buff_x2_1_address0,buff_x2_1_ce0,buff_x2_1_q0,buff_x2_2_address0,buff_x2_2_ce0,buff_x2_2_q0,buff_x2_3_address0,buff_x2_3_ce0,buff_x2_3_q0); 
...
wire   [31:0] tmp_s_fu_243_p11;
reg   [31:0] tmp_s_reg_354;
wire   [31:0] tmp_1_fu_266_p11;
reg   [31:0] tmp_1_reg_359;
wire   [63:0] zext_ln6_fu_226_p1;
reg   [6:0] i_fu_70;
...
wire   [31:0] tmp_s_fu_243_p9;
wire   [31:0] tmp_1_fu_266_p9;
reg    ap_done_reg;
...
wire   [1:0] tmp_1_fu_266_p1;
wire   [1:0] tmp_1_fu_266_p3;
wire  signed [1:0] tmp_1_fu_266_p5;
wire  signed [1:0] tmp_1_fu_266_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U13968(.din0(buff_x1_q0),.din1(buff_x1_1_q0),.din2(buff_x1_2_q0),.din3(buff_x1_3_q0),.def(tmp_s_fu_243_p9),.sel(trunc_ln35_reg_308),.dout(tmp_s_fu_243_p11));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U13969(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.def(tmp_1_fu_266_p9),.sel(trunc_ln35_reg_308),.dout(tmp_1_fu_266_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_359 <= tmp_1_fu_266_p11;
        tmp_s_reg_354 <= tmp_s_fu_243_p11;
...
assign bitcast_ln36_fu_289_p1 = tmp_s_reg_354;
assign bitcast_ln37_fu_293_p1 = tmp_1_reg_359;
assign buff_x1_1_address0 = zext_ln6_fu_226_p1;
assign buff_x1_1_ce0 = buff_x1_1_ce0_local;
assign buff_x1_2_address0 = zext_ln6_fu_226_p1;
assign buff_x1_2_ce0 = buff_x1_2_ce0_local;
assign buff_x1_3_address0 = zext_ln6_fu_226_p1;
assign buff_x1_3_ce0 = buff_x1_3_ce0_local;
assign buff_x1_address0 = zext_ln6_fu_226_p1;
assign buff_x1_ce0 = buff_x1_ce0_local;
assign buff_x2_1_address0 = zext_ln6_fu_226_p1;
assign buff_x2_1_ce0 = buff_x2_1_ce0_local;
assign buff_x2_2_address0 = zext_ln6_fu_226_p1;
assign buff_x2_2_ce0 = buff_x2_2_ce0_local;
assign buff_x2_3_address0 = zext_ln6_fu_226_p1;
assign buff_x2_3_ce0 = buff_x2_3_ce0_local;
assign buff_x2_address0 = zext_ln6_fu_226_p1;
assign buff_x2_ce0 = buff_x2_ce0_local;
assign icmp_ln35_fu_200_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_3_fu_216_p4 = {{ap_sig_allocacmp_i_1[5:2]}};
assign tmp_1_fu_266_p9 = 'bx;
assign tmp_s_fu_243_p9 = 'bx;
assign trunc_ln35_fu_212_p1 = ap_sig_allocacmp_i_1[1:0];
assign x1_out_din = bitcast_ln36_fu_289_p1;
assign x1_out_write = x1_out_write_local;
assign x2_out_din = bitcast_ln37_fu_293_p1;
assign x2_out_write = x2_out_write_local;
assign zext_ln6_fu_226_p1 = lshr_ln6_3_fu_216_p4;
endmodule 