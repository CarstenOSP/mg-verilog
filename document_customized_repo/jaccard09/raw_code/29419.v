...
always @ (*) begin
    ap_block_state6_on_subcall_done = (((icmp_ln43_reg_202 == 1'd1) & (grp_merge_fu_64_ap_done == 1'b0)) | ((icmp_ln43_reg_202 == 1'd0) & (grp_merge_fu_64_ap_done == 1'b0)));
end
