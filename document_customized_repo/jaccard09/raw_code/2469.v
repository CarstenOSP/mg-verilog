module sha_stream_sha_transform_Pipeline_trans_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_13_reload,B_1_reload,C_13_reload,D_13_reload,E_1_reload,W_20_load_4,W_22_load_4,W_24_load_4,W_26_load_4,W_28_load_4,W_30_load_4,W_32_load_4,W_34_load_4,W_36_load_4,W_38_load_4,W_21_load_4,W_23_load_4,W_25_load_4,W_27_load_4,W_29_load_4,W_31_load_4,W_33_load_4,W_35_load_4,W_37_load_4,W_39_load_4,A_14_out,A_14_out_ap_vld,B_4_out,B_4_out_ap_vld,C_15_out,C_15_out_ap_vld,D_14_out,D_14_out_ap_vld,E_4_out,E_4_out_ap_vld); 
...
reg   [31:0] E_fu_130;
wire   [31:0] C_7_fu_536_p3;
reg   [31:0] B_4_fu_134;
reg   [31:0] B_fu_138;
wire   [31:0] temp_2_fu_640_p2;
reg   [5:0] i_2_fu_142;
...
wire   [5:0] tmp_3_fu_416_p1;
wire   [5:0] tmp_3_fu_416_p3;
wire   [5:0] tmp_3_fu_416_p5;
wire   [5:0] tmp_3_fu_416_p7;
wire   [5:0] tmp_3_fu_416_p9;
wire   [5:0] tmp_3_fu_416_p11;
wire  signed [5:0] tmp_3_fu_416_p13;
wire  signed [5:0] tmp_3_fu_416_p15;
wire  signed [5:0] tmp_3_fu_416_p17;
wire  signed [5:0] tmp_3_fu_416_p19;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_21_6_32_1_1_U116(.din0(W_20_load_4),.din1(W_22_load_4),.din2(W_24_load_4),.din3(W_26_load_4),.din4(W_28_load_4),.din5(W_30_load_4),.din6(W_32_load_4),.din7(W_34_load_4),.din8(W_36_load_4),.din9(W_38_load_4),.def(tmp_s_fu_378_p21),.sel(i_2_fu_142),.dout(tmp_s_fu_378_p23));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_21_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h16 ),.din1_WIDTH( 32 ),.CASE2( 6'h18 ),.din2_WIDTH( 32 ),.CASE3( 6'h1A ),.din3_WIDTH( 32 ),.CASE4( 6'h1C ),.din4_WIDTH( 32 ),.CASE5( 6'h1E ),.din5_WIDTH( 32 ),.CASE6( 6'h20 ),.din6_WIDTH( 32 ),.CASE7( 6'h22 ),.din7_WIDTH( 32 ),.CASE8( 6'h24 ),.din8_WIDTH( 32 ),.CASE9( 6'h26 ),.din9_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_21_6_32_1_1_U117(.din0(W_21_load_4),.din1(W_23_load_4),.din2(W_25_load_4),.din3(W_27_load_4),.din4(W_29_load_4),.din5(W_31_load_4),.din6(W_33_load_4),.din7(W_35_load_4),.din8(W_37_load_4),.din9(W_39_load_4),.def(tmp_3_fu_416_p21),.sel(i_2_fu_142),.dout(tmp_3_fu_416_p23));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            B_4_fu_134 <= temp_reg_843;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        B_fu_138 <= A_13_reload;
    end else if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        B_fu_138 <= temp_2_fu_640_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        E_4_fu_126 <= E_1_reload;
        ...
        E_4_fu_126 <= C_6_reg_817;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        E_7_fu_146 <= C_13_reload;
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln120_reg_824 == 1'd1))) begin
        E_7_fu_146 <= C_fu_583_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        E_fu_130 <= D_13_reload;
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln120_reg_824 == 1'd1))) begin
        E_fu_130 <= C_7_fu_536_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_3_reg_833 <= tmp_3_fu_416_p23;
...
assign A_14_out = B_fu_138;
assign B_4_out = B_4_fu_134;
assign C_15_out = E_7_fu_146;
assign C_7_fu_536_p3 = {{trunc_ln122_1_fu_522_p1}, {lshr_ln122_1_fu_526_p4}};
assign C_fu_583_p3 = {{trunc_ln122_3_fu_569_p1}, {lshr_ln122_3_fu_573_p4}};
assign D_14_out = E_fu_130;
assign E_4_out = E_4_fu_126;
...
assign add_ln122_5_fu_611_p2 = (tmp_3_reg_833 + 32'd1859775393);
assign add_ln122_6_fu_616_p2 = (or_ln122_2_fu_605_p3 + add_ln122_5_fu_611_p2);
assign add_ln122_fu_510_p2 = (xor_ln122_1_fu_485_p2 + E_4_fu_126);
...
assign lshr_ln3_fu_470_p4 = {{B_fu_138[31:27]}};
...
assign temp_2_fu_640_p2 = (add_ln122_6_reg_863 + add_ln122_4_fu_636_p2);
assign temp_fu_516_p2 = (add_ln122_fu_510_p2 + add_ln122_2_fu_504_p2);
assign tmp_3_fu_416_p21 = 'bx;
...
assign xor_ln122_2_fu_558_p2 = (C_7_fu_536_p3 ^ B_fu_138);
assign xor_ln122_3_fu_564_p2 = (xor_ln122_2_fu_558_p2 ^ C_6_reg_817);
assign xor_ln122_fu_480_p2 = (E_fu_130 ^ C_6_reg_817);
endmodule 