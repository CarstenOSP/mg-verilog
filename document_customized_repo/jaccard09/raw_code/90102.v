...
wire   [3:0] lshr_ln5_6_fu_393_p4;
reg   [3:0] lshr_ln5_6_reg_515;
reg   [3:0] lshr_ln5_6_reg_515_pp0_iter2_reg;
reg   [3:0] lshr_ln5_6_reg_515_pp0_iter3_reg;
reg   [3:0] lshr_ln5_6_reg_515_pp0_iter4_reg;
wire   [31:0] tmp_1_fu_435_p11;
reg   [31:0] tmp_1_reg_540;
...
reg   [10:0] indvar_flatten8_fu_88;
...
wire   [1:0] tmp_1_fu_435_p1;
wire   [1:0] tmp_1_fu_435_p3;
wire  signed [1:0] tmp_1_fu_435_p5;
wire  signed [1:0] tmp_1_fu_435_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_80 = 7'd0;
#0 i_fu_84 = 7'd0;
#0 indvar_flatten8_fu_88 = 11'd0;
#0 ap_done_reg = 1'b0;
end
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U27(.clk(ap_clk),.reset(ap_rst),.din0(buff_y_out_1_load_reg_617),.din1(mul57_1_reg_602),.ce(1'b1),.dout(grp_fu_268_p2));
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U28(.clk(ap_clk),.reset(ap_rst),.din0(buff_y_out_2_load_reg_622),.din1(mul57_2_reg_607),.ce(1'b1),.dout(grp_fu_272_p2));
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U29(.clk(ap_clk),.reset(ap_rst),.din0(buff_y_out_3_load_reg_627),.din1(mul57_3_reg_612),.ce(1'b1),.dout(grp_fu_276_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U31(.clk(ap_clk),.reset(ap_rst),.din0(buff_A_1_load_reg_553),.din1(tmp_1_reg_540),.ce(1'b1),.dout(grp_fu_284_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U32(.clk(ap_clk),.reset(ap_rst),.din0(buff_A_2_load_reg_558),.din1(tmp_1_reg_540),.ce(1'b1),.dout(grp_fu_288_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U33(.clk(ap_clk),.reset(ap_rst),.din0(buff_A_3_load_reg_563),.din1(tmp_1_reg_540),.ce(1'b1),.dout(grp_fu_292_p2));
(* dissolve_hierarchy = "yes" *) atax_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U34(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_1_fu_435_p9),.sel(trunc_ln26_1_reg_490),.dout(tmp_1_fu_435_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln26_fu_314_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten8_fu_88 <= add_ln26_1_fu_320_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten8_fu_88 <= 11'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            j_fu_80 <= add_ln27_fu_419_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_632 <= grp_fu_466_p_dout0;
        add58_1_reg_637 <= grp_fu_268_p2;
        add58_2_reg_642 <= grp_fu_272_p2;
        add58_3_reg_647 <= grp_fu_276_p2;
        ...
        lshr_ln5_6_reg_515_pp0_iter2_reg <= lshr_ln5_6_reg_515;
        lshr_ln5_6_reg_515_pp0_iter3_reg <= lshr_ln5_6_reg_515_pp0_iter2_reg;
        lshr_ln5_6_reg_515_pp0_iter4_reg <= lshr_ln5_6_reg_515_pp0_iter3_reg;
        mul1_reg_597 <= grp_fu_470_p_dout0;
        mul57_1_reg_602 <= grp_fu_284_p2;
        mul57_2_reg_607 <= grp_fu_288_p2;
        mul57_3_reg_612 <= grp_fu_292_p2;
        tmp_1_reg_540 <= tmp_1_fu_435_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln5_6_reg_515 <= {{select_ln5_fu_351_p3[5:2]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten8_load = indvar_flatten8_fu_88;
    end
end
always @ (*) begin
...
assign add_ln26_1_fu_320_p2 = (ap_sig_allocacmp_indvar_flatten8_load + 11'd1);
...
assign grp_fu_466_p_din0 = buff_y_out_load_reg_592;
assign grp_fu_466_p_din1 = mul1_reg_597;
assign grp_fu_466_p_opcode = 2'd0;
assign grp_fu_470_p_ce = 1'b1;
assign grp_fu_470_p_din0 = buff_A_load_reg_548;
assign grp_fu_470_p_din1 = tmp_1_reg_540;
assign icmp_ln26_fu_314_p2 = ((ap_sig_allocacmp_indvar_flatten8_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_375_p4 = {{select_ln26_fu_359_p3[5:2]}};
assign lshr_ln5_6_fu_393_p4 = {{select_ln5_fu_351_p3[5:2]}};
assign select_ln26_fu_359_p3 = ((tmp_fu_343_p3[0:0] == 1'b1) ? add_ln26_fu_337_p2 : i_fu_84);
assign select_ln5_fu_351_p3 = ((tmp_fu_343_p3[0:0] == 1'b1) ? 7'd0 : j_fu_80);
...
assign tmp_1_fu_435_p9 = 'bx;
assign tmp_3_fu_403_p3 = {{trunc_ln26_fu_367_p1}, {lshr_ln5_6_fu_393_p4}};
assign tmp_fu_343_p3 = j_fu_80[32'd6];
assign trunc_ln26_1_fu_371_p1 = select_ln26_fu_359_p3[1:0];
assign trunc_ln26_fu_367_p1 = select_ln26_fu_359_p3[5:0];
assign zext_ln28_fu_411_p1 = tmp_3_fu_403_p3;
assign zext_ln5_1_fu_458_p1 = lshr_ln5_6_reg_515_pp0_iter4_reg;
