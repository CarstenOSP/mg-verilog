...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        reg_418 <= grp_fu_345_p_dout0;
        reg_423 <= grp_fu_349_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v102_reg_1248 <= grp_fu_353_p_dout0;
        v108_reg_1253 <= grp_fu_357_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v103_reg_1278 <= grp_fu_345_p_dout0;
        v109_reg_1283 <= grp_fu_349_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v105_reg_1213 <= v58_1_q0;
        v66_reg_1178 <= grp_fu_353_p_dout0;
        v72_reg_1183 <= grp_fu_357_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v78_reg_1218 <= grp_fu_353_p_dout0;
        v84_reg_1223 <= grp_fu_357_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v90_reg_1228 <= grp_fu_353_p_dout0;
        v96_reg_1233 <= grp_fu_357_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v91_reg_1268 <= grp_fu_345_p_dout0;
        v97_reg_1273 <= grp_fu_349_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_345_p_din0 = grp_fu_394_p0;
assign grp_fu_345_p_din1 = grp_fu_394_p1;
assign grp_fu_345_p_opcode = 2'd0;
assign grp_fu_349_p_ce = 1'b1;
assign grp_fu_349_p_din0 = grp_fu_398_p0;
assign grp_fu_349_p_din1 = grp_fu_398_p1;
assign grp_fu_349_p_opcode = 2'd0;
assign grp_fu_353_p_ce = 1'b1;
assign grp_fu_353_p_din0 = grp_fu_402_p0;
assign grp_fu_353_p_din1 = grp_fu_402_p1;
assign grp_fu_357_p_ce = 1'b1;
assign grp_fu_357_p_din0 = grp_fu_406_p0;
assign grp_fu_357_p_din1 = grp_fu_406_p1;
