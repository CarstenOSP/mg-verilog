module viterbi_viterbi_Pipeline_L_end (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p,llike_1_address0,llike_1_ce0,llike_1_q0,llike_2_address0,llike_2_ce0,llike_2_q0,llike_3_address0,llike_3_ce0,llike_3_q0,llike_address0,llike_ce0,llike_q0,min_s_4_out,min_s_4_out_ap_vld,grp_fu_552_p_din0,grp_fu_552_p_din1,grp_fu_552_p_opcode,grp_fu_552_p_dout0,grp_fu_552_p_ce); 
...
reg   [63:0] p_66_reg_736;
reg   [63:0] p_67_reg_743;
reg   [63:0] min_p_136_reg_755;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
reg   [63:0] p_68_reg_762;
wire   [0:0] and_ln42_1_fu_320_p2;
reg   [0:0] and_ln42_1_reg_769;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3_11001;
wire   [63:0] min_p_138_fu_326_p3;
reg   [63:0] min_p_138_reg_775;
...
wire   [63:0] min_p_140_fu_414_p3;
reg   [63:0] min_p_140_reg_788;
...
wire   [63:0] min_p_143_fu_548_p3;
reg   [63:0] min_p_143_reg_806;
...
wire   [11:0] tmp_250_cast_fu_187_p3;
wire   [6:0] zext_ln16_fu_173_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        min_p_1_fu_74 <= min_p_145_fu_645_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_s_8_fu_82 <= 6'd1;
    end else if (((tmp_2_reg_725 == 1'd0) & (1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_725 <= add_ln40_fu_202_p2[32'd6];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        min_p_136_reg_755 <= min_p_1_fu_74;
        p_68_reg_762 <= llike_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        min_p_138_reg_775 <= min_p_138_fu_326_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        min_p_140_reg_788 <= min_p_140_fu_414_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        min_p_143_reg_806 <= min_p_143_fu_548_p3;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        p_66_reg_736 <= llike_2_q0;
        p_67_reg_743 <= llike_3_q0;
        p_reg_729 <= llike_1_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_12_reg_813 <= grp_fu_552_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_2_reg_725 == 1'd1) & (1'b0 == ap_block_pp0_stage8_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage8) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
            grp_fu_151_p0 = p_68_reg_762;
        end else if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
            grp_fu_151_p0 = p_67_reg_743;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_151_p0 = p_66_reg_736;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage8) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
            grp_fu_151_p1 = min_p_143_fu_548_p3;
        end else if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
            grp_fu_151_p1 = min_p_140_fu_414_p3;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_151_p1 = min_p_138_fu_326_p3;
        end else if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (tmp_2_reg_725 == 1'd1) & (1'b0 == ap_block_pp0_stage8_11001) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
...
assign add_ln40_fu_202_p2 = (zext_ln16_fu_173_p1 + 7'd3);
...
assign and_ln42_3_fu_408_p2 = (grp_fu_552_p_dout0 & and_ln42_2_fu_402_p2);
assign and_ln42_4_fu_490_p2 = (or_ln42_5_fu_484_p2 & or_ln42_4_fu_466_p2);
assign and_ln42_5_fu_496_p2 = (grp_fu_552_p_dout0 & and_ln42_4_fu_490_p2);
...
assign and_ln42_fu_314_p2 = (or_ln42_fu_290_p2 & grp_fu_552_p_dout0);
...
assign bitcast_ln42_1_fu_261_p1 = min_p_136_reg_755;
assign bitcast_ln42_2_fu_332_p1 = p_66_reg_736;
assign bitcast_ln42_3_fu_349_p1 = min_p_138_reg_775;
assign bitcast_ln42_4_fu_420_p1 = p_67_reg_743;
assign bitcast_ln42_5_fu_437_p1 = min_p_140_reg_788;
assign bitcast_ln42_6_fu_564_p1 = p_68_reg_762;
assign bitcast_ln42_7_fu_581_p1 = min_p_143_reg_806;
assign bitcast_ln42_fu_244_p1 = p_reg_729;
assign grp_fu_552_p_ce = 1'b1;
assign grp_fu_552_p_din0 = grp_fu_151_p0;
assign grp_fu_552_p_din1 = grp_fu_151_p1;
assign grp_fu_552_p_opcode = 5'd4;
assign icmp_ln42_10_fu_472_p2 = ((tmp_8_fu_440_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign icmp_ln42_2_fu_296_p2 = ((tmp_1_fu_264_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_3_fu_302_p2 = ((trunc_ln42_1_fu_274_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_4_fu_366_p2 = ((tmp_4_fu_335_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_5_fu_372_p2 = ((trunc_ln42_2_fu_345_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_6_fu_384_p2 = ((tmp_5_fu_352_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_7_fu_390_p2 = ((trunc_ln42_3_fu_362_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_8_fu_454_p2 = ((tmp_7_fu_423_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign min_p_138_fu_326_p3 = ((and_ln42_1_reg_769[0:0] == 1'b1) ? p_reg_729 : min_p_136_reg_755);
assign min_p_140_fu_414_p3 = ((and_ln42_3_reg_782[0:0] == 1'b1) ? p_66_reg_736 : min_p_138_reg_775);
assign min_p_143_fu_548_p3 = ((and_ln42_5_reg_795[0:0] == 1'b1) ? p_67_reg_743 : min_p_140_reg_788);
assign min_p_145_fu_645_p3 = ((and_ln42_7_fu_640_p2[0:0] == 1'b1) ? p_68_reg_762 : min_p_143_reg_806);
...
assign tmp_1_fu_264_p4 = {{bitcast_ln42_1_fu_261_p1[62:52]}};
assign tmp_250_cast_fu_187_p3 = {{8'd139}, {tmp_s_fu_177_p4}};
assign tmp_4_fu_335_p4 = {{bitcast_ln42_2_fu_332_p1[62:52]}};
assign tmp_5_fu_352_p4 = {{bitcast_ln42_3_fu_349_p1[62:52]}};
assign tmp_7_fu_423_p4 = {{bitcast_ln42_4_fu_420_p1[62:52]}};
assign tmp_8_fu_440_p4 = {{bitcast_ln42_5_fu_437_p1[62:52]}};
