module backprop_backprop_Pipeline_label_16 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_23686,mux_case_13582,mux_case_03478,mux_case_02240_reload,mux_case_12344_reload,mux_case_22448_reload,empty,v7_address0,v7_ce0,v7_q0,v116_reload,mux_case_12656_reload,v116_2_reload,mux_case_23684_out,mux_case_23684_out_ap_vld,mux_case_13580_out,mux_case_13580_out_ap_vld,mux_case_03476_out,mux_case_03476_out_ap_vld,grp_fu_3043_p_din0,grp_fu_3043_p_din1,grp_fu_3043_p_opcode,grp_fu_3043_p_dout0,grp_fu_3043_p_ce,grp_fu_3051_p_din0,grp_fu_3051_p_din1,grp_fu_3051_p_dout0,grp_fu_3051_p_ce); 
...
sparsemux_7_2_64_1_1_U258(.din0(mux_case_02240_reload),.din1(mux_case_12344_reload),.din2(mux_case_22448_reload),.def(v94_fu_251_p7),.sel(v93_1_reg_403_pp0_iter1_reg),.dout(v94_fu_251_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U259(.din0(v116_reload),.din1(mux_case_12656_reload),.din2(v116_2_reload),.def(v98_fu_294_p7),.sel(v93_1_reg_403_pp0_iter8_reg),.dout(v98_fu_294_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v13_reg_453 <= grp_fu_3051_p_dout0;
...
assign bitcast_ln172_fu_272_p1 = grp_fu_3043_p_dout0;
assign grp_fu_3043_p_ce = 1'b1;
assign grp_fu_3043_p_din0 = v94_fu_251_p9;
assign grp_fu_3043_p_din1 = v95_fu_268_p1;
assign grp_fu_3043_p_opcode = 2'd1;
assign grp_fu_3051_p_ce = 1'b1;
assign grp_fu_3051_p_din0 = v97_fu_316_p1;
assign grp_fu_3051_p_din1 = v98_reg_443;
