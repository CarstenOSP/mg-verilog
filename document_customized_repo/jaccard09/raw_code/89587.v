...
wire   [31:0] tmp_6_fu_375_p11;
reg   [31:0] tmp_6_reg_508;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_6_fu_375_p1;
wire   [1:0] tmp_6_fu_375_p3;
wire  signed [1:0] tmp_6_fu_375_p5;
wire  signed [1:0] tmp_6_fu_375_p7;
wire   [1:0] tmp_7_fu_398_p1;
wire   [1:0] tmp_7_fu_398_p3;
wire  signed [1:0] tmp_7_fu_398_p5;
wire  signed [1:0] tmp_7_fu_398_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U349(.din0(buff_D_out_q0),.din1(buff_D_out_1_q0),.din2(buff_D_out_2_q0),.din3(buff_D_out_3_q0),.def(tmp_6_fu_375_p9),.sel(trunc_ln52_reg_454),.dout(tmp_6_fu_375_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U350(.din0(buff_D_out_4_q0),.din1(buff_D_out_5_q0),.din2(buff_D_out_6_q0),.din3(buff_D_out_7_q0),.def(tmp_7_fu_398_p9),.sel(trunc_ln52_reg_454),.dout(tmp_7_fu_398_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln52_fu_238_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten20_fu_96 <= add_ln52_1_fu_244_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_6_reg_508 <= tmp_6_fu_375_p11;
        tmp_7_reg_513 <= tmp_7_fu_398_p11;
    end
end
always @ (*) begin
...
assign add_ln52_1_fu_244_p2 = (ap_sig_allocacmp_indvar_flatten20_load + 12'd1);
...
assign bitcast_ln55_1_fu_425_p1 = tmp_7_reg_513;
assign bitcast_ln55_fu_421_p1 = tmp_6_reg_508;
...
assign icmp_ln52_fu_238_p2 = ((ap_sig_allocacmp_indvar_flatten20_load == 12'd2048) ? 1'b1 : 1'b0);
...
assign lshr_ln5_8_fu_295_p4 = {{select_ln5_fu_275_p3[5:1]}};
assign or_ln_fu_341_p3 = {{lshr_ln5_8_fu_295_p4}, {1'd1}};
...
assign tmp_1_fu_315_p3 = {{tmp_s_fu_305_p4}, {lshr_ln5_8_fu_295_p4}};
assign tmp_6_fu_375_p9 = 'bx;
assign tmp_7_fu_398_p9 = 'bx;
