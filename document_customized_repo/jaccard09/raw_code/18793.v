...
reg   [7:0] bucket_0_addr_4_reg_975;
reg   [7:0] bucket_1_addr_4_reg_980;
reg   [7:0] bucket_2_addr_4_reg_985;
reg   [7:0] bucket_3_addr_4_reg_990;
reg   [7:0] bucket_4_addr_4_reg_995;
reg   [7:0] bucket_5_addr_4_reg_1000;
reg   [7:0] bucket_6_addr_4_reg_1005;
reg   [7:0] bucket_7_addr_5_reg_1010;
...
wire   [31:0] tmp_5_fu_764_p11;
reg   [31:0] tmp_5_reg_1115;
reg   [7:0] bucket_0_addr_5_reg_1135;
reg   [7:0] bucket_1_addr_5_reg_1140;
reg   [7:0] bucket_2_addr_5_reg_1145;
reg   [7:0] bucket_3_addr_5_reg_1150;
reg   [7:0] bucket_4_addr_5_reg_1155;
reg   [7:0] bucket_5_addr_5_reg_1160;
reg   [7:0] bucket_6_addr_5_reg_1165;
reg   [7:0] bucket_7_addr_6_reg_1170;
reg   [7:0] bucket_0_addr_6_reg_1175;
reg   [7:0] bucket_1_addr_6_reg_1180;
reg   [7:0] bucket_2_addr_6_reg_1185;
reg   [7:0] bucket_3_addr_6_reg_1190;
reg   [7:0] bucket_4_addr_6_reg_1195;
reg   [7:0] bucket_5_addr_6_reg_1200;
reg   [7:0] bucket_6_addr_6_reg_1205;
reg   [7:0] bucket_7_addr_7_reg_1210;
...
wire   [2:0] tmp_5_fu_764_p1;
wire   [2:0] tmp_5_fu_764_p3;
wire  signed [2:0] tmp_5_fu_764_p5;
wire  signed [2:0] tmp_5_fu_764_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 4'd1;
...
sparsemux_9_3_32_1_1_U45(.din0(sum_0_q0),.din1(sum_2_q0),.din2(sum_4_q0),.din3(sum_6_q0),.def(tmp_fu_615_p9),.sel(trunc_ln34_fu_612_p1),.dout(tmp_fu_615_p11));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U46(.din0(sum_1_q0),.din1(sum_3_q0),.din2(sum_5_q0),.din3(sum_7_q0),.def(tmp_5_fu_764_p9),.sel(trunc_ln34_fu_612_p1),.dout(tmp_5_fu_764_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        bucket_0_addr_5_reg_1135[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_0_addr_6_reg_1175[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        bucket_1_addr_5_reg_1140[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_1_addr_6_reg_1180[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        bucket_2_addr_5_reg_1145[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_2_addr_6_reg_1185[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        bucket_3_addr_5_reg_1150[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_3_addr_6_reg_1190[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        bucket_4_addr_5_reg_1155[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_4_addr_6_reg_1195[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        bucket_5_addr_5_reg_1160[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_5_addr_6_reg_1200[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        bucket_6_addr_5_reg_1165[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_6_addr_6_reg_1205[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        bucket_7_addr_6_reg_1170[7 : 2] <= p_cast3_fu_752_p1[7 : 2];
        bucket_7_addr_7_reg_1210[7 : 2] <= zext_ln37_1_fu_796_p1[7 : 2];
        tmp_5_reg_1115 <= tmp_5_fu_764_p11;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        bucket_0_addr_4_reg_975[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
        bucket_0_addr_reg_935[7 : 1] <= p_cast_fu_580_p1[7 : 1];
        bucket_1_addr_4_reg_980[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
        bucket_1_addr_reg_940[7 : 1] <= p_cast_fu_580_p1[7 : 1];
        bucket_2_addr_4_reg_985[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
        bucket_2_addr_reg_945[7 : 1] <= p_cast_fu_580_p1[7 : 1];
        bucket_3_addr_4_reg_990[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
        bucket_3_addr_reg_950[7 : 1] <= p_cast_fu_580_p1[7 : 1];
        bucket_4_addr_4_reg_995[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
        bucket_4_addr_reg_955[7 : 1] <= p_cast_fu_580_p1[7 : 1];
        bucket_5_addr_4_reg_1000[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
        bucket_5_addr_reg_960[7 : 1] <= p_cast_fu_580_p1[7 : 1];
        bucket_6_addr_4_reg_1005[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
        bucket_6_addr_reg_965[7 : 1] <= p_cast_fu_580_p1[7 : 1];
        bucket_7_addr_5_reg_1010[7 : 1] <= zext_ln37_fu_600_p1[7 : 1];
...
always @ (*) begin
    if (((tmp_2_fu_540_p3 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_0_address0_local = bucket_0_addr_6_reg_1175;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_0_address0_local = bucket_0_addr_4_reg_975;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        bucket_0_address0_local = zext_ln37_1_fu_796_p1;
    end else if (((tmp_2_fu_540_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_0_address1_local = bucket_0_addr_5_reg_1135;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | ((tmp_2_fu_540_p3 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_1_address0_local = bucket_1_addr_6_reg_1180;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_1_address0_local = bucket_1_addr_4_reg_980;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_1_address1_local = bucket_1_addr_5_reg_1140;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_2_address0_local = bucket_2_addr_6_reg_1185;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_2_address0_local = bucket_2_addr_4_reg_985;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_2_address1_local = bucket_2_addr_5_reg_1145;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_3_address0_local = bucket_3_addr_6_reg_1190;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_3_address0_local = bucket_3_addr_4_reg_990;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_3_address1_local = bucket_3_addr_5_reg_1150;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_4_address0_local = bucket_4_addr_6_reg_1195;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_4_address0_local = bucket_4_addr_4_reg_995;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_4_address1_local = bucket_4_addr_5_reg_1155;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_5_address0_local = bucket_5_addr_6_reg_1200;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_5_address0_local = bucket_5_addr_4_reg_1000;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_5_address1_local = bucket_5_addr_5_reg_1160;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_6_address0_local = bucket_6_addr_6_reg_1205;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_6_address0_local = bucket_6_addr_4_reg_1005;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_6_address1_local = bucket_6_addr_5_reg_1165;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_7_address0_local = bucket_7_addr_7_reg_1210;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_7_address0_local = bucket_7_addr_5_reg_1010;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_7_address1_local = bucket_7_addr_6_reg_1170;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
assign add_ln37_16_fu_808_p2 = (bucket_0_q1 + tmp_5_reg_1115);
assign add_ln37_17_fu_813_p2 = (bucket_1_q1 + tmp_5_reg_1115);
assign add_ln37_18_fu_818_p2 = (bucket_2_q1 + tmp_5_reg_1115);
assign add_ln37_19_fu_823_p2 = (bucket_3_q1 + tmp_5_reg_1115);
assign add_ln37_1_fu_645_p2 = (bucket_1_q1 + tmp_fu_615_p11);
assign add_ln37_20_fu_828_p2 = (bucket_4_q1 + tmp_5_reg_1115);
assign add_ln37_21_fu_833_p2 = (bucket_5_q1 + tmp_5_reg_1115);
assign add_ln37_22_fu_838_p2 = (bucket_6_q1 + tmp_5_reg_1115);
assign add_ln37_23_fu_843_p2 = (bucket_7_q1 + tmp_5_reg_1115);
assign add_ln37_24_fu_848_p2 = (bucket_0_q0 + tmp_5_reg_1115);
assign add_ln37_25_fu_853_p2 = (bucket_1_q0 + tmp_5_reg_1115);
assign add_ln37_26_fu_858_p2 = (bucket_2_q0 + tmp_5_reg_1115);
assign add_ln37_27_fu_863_p2 = (bucket_3_q0 + tmp_5_reg_1115);
assign add_ln37_28_fu_868_p2 = (bucket_4_q0 + tmp_5_reg_1115);
assign add_ln37_29_fu_873_p2 = (bucket_5_q0 + tmp_5_reg_1115);
assign add_ln37_2_fu_651_p2 = (bucket_2_q1 + tmp_fu_615_p11);
assign add_ln37_30_fu_878_p2 = (bucket_6_q0 + tmp_5_reg_1115);
assign add_ln37_31_fu_883_p2 = (bucket_7_q0 + tmp_5_reg_1115);
...
assign empty_23_fu_574_p2 = ap_sig_allocacmp_radixID_3 << 8'd1;
...
assign p_cast3_fu_752_p1 = tmp_1_fu_744_p3;
assign p_cast_fu_580_p1 = empty_23_fu_574_p2;
...
assign tmp_1_fu_744_p3 = {{tmp_s_fu_735_p4}, {2'd2}};
assign tmp_2_fu_540_p3 = ap_sig_allocacmp_radixID_3[32'd7];
assign tmp_5_fu_764_p9 = 'bx;
...
always @ (posedge ap_clk) begin
    ...
    bucket_0_addr_4_reg_975[0] <= 1'b1;
    bucket_1_addr_4_reg_980[0] <= 1'b1;
    bucket_2_addr_4_reg_985[0] <= 1'b1;
    bucket_3_addr_4_reg_990[0] <= 1'b1;
    bucket_4_addr_4_reg_995[0] <= 1'b1;
    bucket_5_addr_4_reg_1000[0] <= 1'b1;
    bucket_6_addr_4_reg_1005[0] <= 1'b1;
    bucket_7_addr_5_reg_1010[0] <= 1'b1;
    bucket_0_addr_5_reg_1135[1:0] <= 2'b10;
    bucket_1_addr_5_reg_1140[1:0] <= 2'b10;
    bucket_2_addr_5_reg_1145[1:0] <= 2'b10;
    bucket_3_addr_5_reg_1150[1:0] <= 2'b10;
    bucket_4_addr_5_reg_1155[1:0] <= 2'b10;
    bucket_5_addr_5_reg_1160[1:0] <= 2'b10;
    bucket_6_addr_5_reg_1165[1:0] <= 2'b10;
    bucket_7_addr_6_reg_1170[1:0] <= 2'b10;
    bucket_0_addr_6_reg_1175[1:0] <= 2'b11;
    bucket_1_addr_6_reg_1180[1:0] <= 2'b11;
    bucket_2_addr_6_reg_1185[1:0] <= 2'b11;
    bucket_3_addr_6_reg_1190[1:0] <= 2'b11;
    bucket_4_addr_6_reg_1195[1:0] <= 2'b11;
    bucket_5_addr_6_reg_1200[1:0] <= 2'b11;
    bucket_6_addr_6_reg_1205[1:0] <= 2'b11;
    bucket_7_addr_7_reg_1210[1:0] <= 2'b11;
end
endmodule 