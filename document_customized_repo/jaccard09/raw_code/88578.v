module syrk_syrk_Pipeline_lp4_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_B_address0,buff_B_ce0,buff_B_q0,buff_B_address1,buff_B_ce1,buff_B_q1,buff_C_out_address0,buff_C_out_ce0,buff_C_out_we0,buff_C_out_d0,buff_C_out_address1,buff_C_out_ce1,buff_C_out_q1,buff_C_out_1_address0,buff_C_out_1_ce0,buff_C_out_1_we0,buff_C_out_1_d0,buff_C_out_1_address1,buff_C_out_1_ce1,buff_C_out_1_q1,beta,grp_fu_131_p_din0,grp_fu_131_p_din1,grp_fu_131_p_opcode,grp_fu_131_p_dout0,grp_fu_131_p_ce,grp_fu_135_p_din0,grp_fu_135_p_din1,grp_fu_135_p_dout0,grp_fu_135_p_ce); 
...
wire   [11:0] tmp_8_fu_254_p3;
wire   [11:0] zext_ln32_fu_261_p1;
wire   [11:0] add_ln32_fu_264_p2;
wire   [11:0] tmp_s_fu_275_p4;
wire   [10:0] tmp_9_fu_288_p3;
reg    ap_done_reg;
...
fadd_32ns_32ns_32_7_full_dsp_1_U16(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_1_load_reg_396),.din1(mul74_1_reg_391),.ce(1'b1),.dout(grp_fu_141_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U18(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_load_1_reg_364),.din1(beta),.ce(1'b1),.dout(grp_fu_149_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_401 <= grp_fu_131_p_dout0;
        ...
        mul1_reg_381 <= grp_fu_135_p_dout0;
...
assign add_ln32_fu_264_p2 = (tmp_8_fu_254_p3 + zext_ln32_fu_261_p1);
...
assign grp_fu_131_p_din0 = buff_C_out_load_reg_386;
assign grp_fu_131_p_din1 = mul1_reg_381;
assign grp_fu_131_p_opcode = 2'd0;
assign grp_fu_135_p_ce = 1'b1;
assign grp_fu_135_p_din0 = buff_B_load_reg_359;
assign grp_fu_135_p_din1 = beta;
...
assign tmp_8_fu_254_p3 = {{trunc_ln32_reg_336}, {6'd0}};
assign tmp_9_fu_288_p3 = {{trunc_ln32_reg_336_pp0_iter4_reg}, {lshr_ln5_2_reg_343_pp0_iter4_reg}};
assign tmp_fu_195_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_s_fu_275_p4 = {{{trunc_ln32_reg_336}, {lshr_ln5_2_reg_343}}, {1'd1}};
assign trunc_ln32_fu_219_p1 = select_ln29_fu_211_p3[5:0];
assign zext_ln32_1_fu_294_p1 = tmp_9_fu_288_p3;
assign zext_ln32_2_fu_283_p1 = tmp_s_fu_275_p4;
