...
wire   [0:0] trunc_ln29_fu_231_p1;
reg   [0:0] trunc_ln29_reg_376;
reg   [0:0] trunc_ln29_reg_376_pp0_iter1_reg;
reg   [4:0] buff_q_out_addr_reg_381;
reg   [4:0] buff_q_out_addr_reg_381_pp0_iter1_reg;
reg   [4:0] buff_q_out_1_addr_reg_386;
reg   [4:0] buff_q_out_1_addr_reg_386_pp0_iter1_reg;
wire   [0:0] trunc_ln30_fu_251_p1;
reg   [0:0] trunc_ln30_reg_391;
...
wire   [4:0] lshr_ln5_2_fu_235_p4;
wire   [4:0] lshr_ln5_5_fu_255_p4;
wire   [5:0] empty_13_fu_221_p1;
wire   [10:0] tmp_s_fu_271_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        j_1_fu_50 <= add_ln30_fu_285_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        add1_reg_446 <= grp_fu_2635_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_q_out_1_addr_reg_386 <= zext_ln5_fu_245_p1;
        buff_q_out_1_addr_reg_386_pp0_iter1_reg <= buff_q_out_1_addr_reg_386;
        buff_q_out_addr_reg_381 <= zext_ln5_fu_245_p1;
        buff_q_out_addr_reg_381_pp0_iter1_reg <= buff_q_out_addr_reg_381;
        ...
        trunc_ln29_reg_376 <= trunc_ln29_fu_231_p1;
        trunc_ln29_reg_376_pp0_iter1_reg <= trunc_ln29_reg_376;
        trunc_ln30_reg_391 <= trunc_ln30_fu_251_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul1_reg_436 <= grp_fu_2639_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_q_out_1_address0_local = buff_q_out_1_addr_reg_386_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_q_out_1_address0_local = zext_ln5_fu_245_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6) & (icmp_ln30_1_reg_417_pp0_iter1_reg == 1'd1) & (trunc_ln29_reg_376_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_q_out_address0_local = buff_q_out_addr_reg_381_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_q_out_address0_local = zext_ln5_fu_245_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6) & (icmp_ln30_1_reg_417_pp0_iter1_reg == 1'd1) & (trunc_ln29_reg_376_pp0_iter1_reg == 1'd0))) begin
...
assign add_ln29_1_fu_176_p2 = (ap_sig_allocacmp_indvar_flatten_load + 13'd1);
assign add_ln29_fu_193_p2 = (i_fu_54 + 7'd1);
assign add_ln30_fu_285_p2 = (select_ln5_fu_205_p3 + 7'd1);
...
always @ (*) begin
    ap_condition_492 = ((icmp_ln29_reg_368 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_0_reg_372 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage6;
assign ap_ready = ap_ready_sig;
assign buff_A_1_address0 = zext_ln31_fu_279_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_address0 = zext_ln31_fu_279_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_p_1_address0 = zext_ln5_1_fu_265_p1;
assign buff_p_1_ce0 = buff_p_1_ce0_local;
assign buff_p_address0 = zext_ln5_1_fu_265_p1;
...
assign buff_q_out_1_d0 = add1_reg_446;
...
assign buff_q_out_d0 = add1_reg_446;
assign buff_q_out_we0 = buff_q_out_we0_local;
assign empty_13_fu_221_p1 = select_ln29_fu_213_p3[5:0];
assign first_iter_0_fu_225_p2 = ((select_ln5_fu_205_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_2635_p_ce = 1'b1;
assign grp_fu_2635_p_din0 = empty_fu_62;
assign grp_fu_2635_p_din1 = mul1_reg_436;
assign grp_fu_2635_p_opcode = 2'd0;
assign grp_fu_2639_p_ce = 1'b1;
assign grp_fu_2639_p_din0 = select_ln31_1_reg_426;
assign grp_fu_2639_p_din1 = select_ln31_2_reg_431;
assign icmp_ln29_fu_170_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln30_1_fu_291_p2 = ((add_ln30_fu_285_p2 == 7'd64) ? 1'b1 : 1'b0);
assign icmp_ln30_fu_199_p2 = ((j_1_fu_50 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_235_p4 = {{select_ln29_fu_213_p3[5:1]}};
assign lshr_ln5_5_fu_255_p4 = {{select_ln5_fu_205_p3[5:1]}};
assign select_ln29_fu_213_p3 = ((icmp_ln30_fu_199_p2[0:0] == 1'b1) ? add_ln29_fu_193_p2 : i_fu_54);
assign select_ln31_1_fu_314_p3 = ((trunc_ln30_reg_391[0:0] == 1'b1) ? buff_A_1_q0 : buff_A_q0);
assign select_ln31_2_fu_321_p3 = ((trunc_ln30_reg_391[0:0] == 1'b1) ? buff_p_1_q0 : buff_p_q0);
assign select_ln31_fu_307_p3 = ((trunc_ln29_reg_376[0:0] == 1'b1) ? buff_q_out_1_q0 : buff_q_out_q0);
assign select_ln5_fu_205_p3 = ((icmp_ln30_fu_199_p2[0:0] == 1'b1) ? 7'd0 : j_1_fu_50);
assign tmp_s_fu_271_p3 = {{empty_13_fu_221_p1}, {lshr_ln5_5_fu_255_p4}};
assign trunc_ln29_fu_231_p1 = select_ln29_fu_213_p3[0:0];
assign trunc_ln30_fu_251_p1 = select_ln5_fu_205_p3[0:0];
assign zext_ln31_fu_279_p1 = tmp_s_fu_271_p3;
assign zext_ln5_1_fu_265_p1 = lshr_ln5_5_fu_255_p4;
assign zext_ln5_fu_245_p1 = lshr_ln5_2_fu_235_p4;
endmodule 