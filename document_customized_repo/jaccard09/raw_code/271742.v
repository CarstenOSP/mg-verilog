module backprop_backprop_Pipeline_label_3 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,phi_mul,v0_address0,v0_ce0,v0_q0,v0_address1,v0_ce1,v0_q1,phi_mul168,v6_address0,v6_ce0,v6_q0,v6_address1,v6_ce1,v6_q1,v29_12_out,v29_12_out_ap_vld,grp_fu_6200_p_din0,grp_fu_6200_p_din1,grp_fu_6200_p_opcode,grp_fu_6200_p_dout0,grp_fu_6200_p_ce,grp_fu_6208_p_din0,grp_fu_6208_p_din1,grp_fu_6208_p_dout0,grp_fu_6208_p_ce); 
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        v27_1_reg_978 <= grp_fu_6208_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        v27_2_reg_993 <= grp_fu_6208_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage11_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        v27_3_reg_998 <= grp_fu_6208_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage12_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage12))) begin
        v27_4_reg_1003 <= grp_fu_6208_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage13_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage13))) begin
        v27_5_reg_1008 <= grp_fu_6208_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage14_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        v27_6_reg_1013 <= grp_fu_6208_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage15_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
        v27_7_reg_1018 <= grp_fu_6208_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        v27_reg_958 <= grp_fu_6208_p_dout0;
    end
end
always @ (*) begin
...
assign add_ln70_1_fu_369_p2 = (zext_ln69_1_fu_350_p1 + phi_mul168);
assign add_ln70_2_fu_440_p2 = (zext_ln69_4_fu_422_p1 + phi_mul168);
assign add_ln70_3_fu_475_p2 = (zext_ln69_7_fu_457_p1 + phi_mul168);
assign add_ln70_4_fu_521_p2 = (zext_ln69_10_fu_503_p1 + phi_mul168);
assign add_ln70_5_fu_565_p2 = (zext_ln68_2_fu_547_p1 + phi_mul168);
assign add_ln70_6_fu_624_p2 = (phi_mul168 + 12'd6);
assign add_ln70_7_fu_644_p2 = (phi_mul168 + 12'd7);
assign add_ln70_fu_321_p2 = (zext_ln68_fu_302_p1 + phi_mul168);
...
assign grp_fu_6200_p_din0 = grp_fu_257_p0;
assign grp_fu_6200_p_din1 = grp_fu_257_p1;
assign grp_fu_6200_p_opcode = 2'd0;
assign grp_fu_6208_p_ce = 1'b1;
assign grp_fu_6208_p_din0 = grp_fu_262_p0;
assign grp_fu_6208_p_din1 = grp_fu_262_p1;
...
assign v29_12_out = grp_fu_6200_p_dout0;
