...
reg   [6:0] lshr_ln48_6_reg_482;
reg   [6:0] lshr_ln48_6_reg_482_pp0_iter1_reg;
reg   [6:0] lshr_ln48_6_reg_482_pp0_iter2_reg;
wire   [31:0] v23_fu_407_p1;
wire   [31:0] v23_16_fu_412_p1;
wire   [31:0] v23_17_fu_417_p1;
wire   [31:0] v23_18_fu_422_p1;
reg   [6:0] v3_2_addr_reg_517;
reg   [6:0] v3_6_addr_reg_522;
reg   [6:0] v3_3_addr_reg_527;
reg   [6:0] v3_7_addr_reg_532;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln51_fu_315_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln51_16_fu_340_p1;
wire   [63:0] zext_ln51_17_fu_378_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln51_18_fu_392_p1;
...
wire   [22:0] add_ln51_s_fu_307_p3;
wire   [8:0] tmp_s_fu_320_p4;
wire   [22:0] add_ln51_13_fu_330_p4;
wire   [2:0] trunc_ln47_fu_293_p1;
wire   [7:0] tmp_26_fu_360_p4;
wire   [22:0] add_ln51_14_fu_369_p4;
wire   [22:0] add_ln51_15_fu_383_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v19_fu_88 <= 11'd0;
    end else if (((tmp_reg_464 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v19_fu_88 <= add_ln47_fu_397_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln48_6_reg_482 <= {{v19_6_reg_457[9:3]}};
        lshr_ln48_6_reg_482_pp0_iter1_reg <= lshr_ln48_6_reg_482;
        lshr_ln48_6_reg_482_pp0_iter2_reg <= lshr_ln48_6_reg_482_pp0_iter1_reg;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_reg_464 <= ap_sig_allocacmp_v19_6[32'd10];
        v19_6_reg_457 <= ap_sig_allocacmp_v19_6;
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
        reg_261 <= grp_fu_4578_p_dout0;
        reg_269 <= grp_fu_4582_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_reg_464 == 1'd1) & (1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            grp_fu_245_p1 = v23_17_fu_417_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            grp_fu_245_p1 = v23_fu_407_p1;
        end else begin
            grp_fu_245_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            grp_fu_249_p1 = v23_18_fu_422_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            grp_fu_249_p1 = v23_16_fu_412_p1;
        end else begin
            grp_fu_249_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address0_local = zext_ln51_18_fu_392_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v0_address0_local = zext_ln51_16_fu_340_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address1_local = zext_ln51_17_fu_378_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v0_address1_local = zext_ln51_fu_315_p1;
        end else begin
...
assign add_ln47_fu_397_p2 = (v19_6_reg_457 + 11'd4);
assign add_ln51_13_fu_330_p4 = {{{v5_4}, {tmp_s_fu_320_p4}}, {1'd1}};
assign add_ln51_14_fu_369_p4 = {{{v5_4}, {tmp_26_fu_360_p4}}, {2'd2}};
assign add_ln51_15_fu_383_p4 = {{{v5_4}, {tmp_26_fu_360_p4}}, {2'd3}};
assign add_ln51_s_fu_307_p3 = {{tmp_9_fu_297_p4}, {ap_sig_allocacmp_v19_6}};
...
assign grp_fu_4578_p_din0 = v22_6;
assign grp_fu_4578_p_din1 = grp_fu_245_p1;
assign grp_fu_4582_p_ce = 1'b1;
assign grp_fu_4582_p_din0 = v22_6;
assign grp_fu_4582_p_din1 = grp_fu_249_p1;
assign icmp_ln53_fu_345_p2 = ((trunc_ln47_fu_293_p1 == 3'd0) ? 1'b1 : 1'b0);
assign tmp_26_fu_360_p4 = {{v19_6_reg_457[9:2]}};
assign tmp_9_fu_297_p4 = {{v5_4[12:1]}};
assign tmp_fu_285_p3 = ap_sig_allocacmp_v19_6[32'd10];
assign tmp_s_fu_320_p4 = {{ap_sig_allocacmp_v19_6[9:1]}};
assign trunc_ln47_fu_293_p1 = ap_sig_allocacmp_v19_6[2:0];
assign v0_address0 = v0_address0_local;
assign v0_address1 = v0_address1_local;
assign v0_ce0 = v0_ce0_local;
assign v0_ce1 = v0_ce1_local;
assign v23_16_fu_412_p1 = reg_257;
assign v23_17_fu_417_p1 = reg_253;
assign v23_18_fu_422_p1 = reg_257;
assign v23_fu_407_p1 = reg_253;
assign v3_1_address0 = zext_ln48_fu_427_p1;
assign v3_1_ce0 = v3_1_ce0_local;
assign v3_1_d0 = reg_269;
assign v3_1_we0 = v3_1_we0_local;
assign v3_2_address0 = v3_2_addr_reg_517;
assign v3_2_ce0 = v3_2_ce0_local;
assign v3_2_d0 = reg_261;
assign v3_2_we0 = v3_2_we0_local;
assign v3_3_address0 = v3_3_addr_reg_527;
assign v3_3_ce0 = v3_3_ce0_local;
assign v3_3_d0 = reg_269;
assign v3_3_we0 = v3_3_we0_local;
assign v3_4_address0 = zext_ln48_fu_427_p1;
assign v3_4_ce0 = v3_4_ce0_local;
assign v3_4_d0 = reg_261;
assign v3_4_we0 = v3_4_we0_local;
assign v3_5_address0 = zext_ln48_fu_427_p1;
assign v3_5_ce0 = v3_5_ce0_local;
assign v3_5_d0 = reg_269;
assign v3_5_we0 = v3_5_we0_local;
assign v3_6_address0 = v3_6_addr_reg_522;
assign v3_6_ce0 = v3_6_ce0_local;
assign v3_6_d0 = reg_261;
assign v3_6_we0 = v3_6_we0_local;
assign v3_7_address0 = v3_7_addr_reg_532;
assign v3_7_ce0 = v3_7_ce0_local;
assign v3_7_d0 = reg_269;
assign v3_7_we0 = v3_7_we0_local;
assign v3_address0 = zext_ln48_fu_427_p1;
assign v3_ce0 = v3_ce0_local;
assign v3_d0 = reg_261;
assign v3_we0 = v3_we0_local;
assign zext_ln48_fu_427_p1 = lshr_ln48_6_reg_482_pp0_iter2_reg;
assign zext_ln51_16_fu_340_p1 = add_ln51_13_fu_330_p4;
assign zext_ln51_17_fu_378_p1 = add_ln51_14_fu_369_p4;
assign zext_ln51_18_fu_392_p1 = add_ln51_15_fu_383_p4;
assign zext_ln51_fu_315_p1 = add_ln51_s_fu_307_p3;
endmodule 