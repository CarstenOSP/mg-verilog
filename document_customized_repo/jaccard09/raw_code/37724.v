module aes256_encrypt_ecb_aes256_encrypt_ecb_Pipeline_addkey1 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buf_1_address0,buf_1_ce0,buf_1_we0,buf_1_d0,buf_1_address1,buf_1_ce1,buf_1_q1,buf_0_address0,buf_0_ce0,buf_0_we0,buf_0_d0,buf_0_address1,buf_0_ce1,buf_0_q1,ctx_ret1); 
...
reg   [2:0] lshr_ln66_2_reg_193;
wire   [3:0] trunc_ln66_3_fu_124_p1;
reg   [3:0] trunc_ln66_3_reg_198;
wire   [7:0] trunc_ln66_4_fu_154_p1;
reg   [7:0] trunc_ln66_4_reg_203;
reg   [2:0] buf_0_addr_reg_208;
reg   [2:0] buf_1_addr_reg_214;
wire   [63:0] zext_ln66_fu_133_p1;
...
reg    buf_1_we0_local;
reg    buf_1_ce0_local;
wire   [6:0] shl_ln66_1_fu_138_p3;
wire   [767:0] zext_ln66_1_fu_145_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        buf_0_addr_reg_208 <= zext_ln66_fu_133_p1;
        buf_1_addr_reg_214 <= zext_ln66_fu_133_p1;
        lshr_ln66_2_reg_193 <= {{add_ln66_fu_108_p2[3:1]}};
        trunc_ln66_3_reg_198 <= trunc_ln66_3_fu_124_p1;
        trunc_ln66_4_reg_203 <= trunc_ln66_4_fu_154_p1;
...
assign add_ln66_fu_108_p2 = ($signed(ap_sig_allocacmp_i_7) + $signed(5'd31));
...
assign buf_0_address1 = zext_ln66_fu_133_p1;
...
assign buf_1_address1 = zext_ln66_fu_133_p1;
...
assign icmp_ln66_fu_98_p2 = ((ap_sig_allocacmp_i_7 == 5'd0) ? 1'b1 : 1'b0);
assign lshr_ln66_fu_149_p2 = ctx_ret1 >> zext_ln66_1_fu_145_p1;
assign select_ln66_fu_158_p3 = ((trunc_ln66_reg_188_pp0_iter1_reg[0:0] == 1'b1) ? buf_0_q1 : buf_1_q1);
assign shl_ln66_1_fu_138_p3 = {{trunc_ln66_3_reg_198}, {3'd0}};
assign trunc_ln66_3_fu_124_p1 = add_ln66_fu_108_p2[3:0];
assign trunc_ln66_4_fu_154_p1 = lshr_ln66_fu_149_p2[7:0];
assign trunc_ln66_fu_104_p1 = ap_sig_allocacmp_i_7[0:0];
assign xor_ln66_fu_165_p2 = (trunc_ln66_4_reg_203 ^ select_ln66_fu_158_p3);
assign zext_ln66_1_fu_145_p1 = shl_ln66_1_fu_138_p3;
assign zext_ln66_fu_133_p1 = lshr_ln66_2_reg_193;
endmodule 