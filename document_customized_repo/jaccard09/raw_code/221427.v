module SgdLR_sw_SgdLR_sw_Pipeline_label_3 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v5,v0_address0,v0_ce0,v0_q0,v0_address1,v0_ce1,v0_q1,v22,v3_address0,v3_ce0,v3_we0,v3_d0,v3_address1,v3_ce1,v3_we1,v3_d1,grp_fu_666_p_din0,grp_fu_666_p_din1,grp_fu_666_p_dout0,grp_fu_666_p_ce,grp_fu_670_p_din0,grp_fu_670_p_din1,grp_fu_670_p_dout0,grp_fu_670_p_ce); 
...
reg   [31:0] reg_268;
reg   [31:0] reg_273;
reg   [10:0] v19_2_reg_618;
reg   [10:0] v19_2_reg_618_pp0_iter1_reg;
wire   [0:0] tmp_fu_286_p3;
reg   [0:0] tmp_reg_626_pp0_iter1_reg;
wire   [8:0] tmp_2_fu_317_p4;
reg   [8:0] tmp_2_reg_635;
reg   [8:0] tmp_2_reg_635_pp0_iter1_reg;
wire   [7:0] tmp_3_fu_353_p4;
reg   [7:0] tmp_3_reg_645;
reg   [7:0] tmp_3_reg_645_pp0_iter1_reg;
wire   [31:0] v23_fu_390_p1;
wire   [31:0] v23_8_fu_395_p1;
wire   [6:0] tmp_6_fu_400_p4;
reg   [6:0] tmp_6_reg_671;
reg   [6:0] tmp_6_reg_671_pp0_iter1_reg;
wire   [0:0] tmp_4_fu_423_p3;
reg   [0:0] tmp_4_reg_686;
reg   [0:0] tmp_4_reg_686_pp0_iter1_reg;
wire   [31:0] v23_9_fu_448_p1;
wire   [31:0] v23_10_fu_453_p1;
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3)))) begin
        reg_268 <= grp_fu_666_p_dout0;
        reg_273 <= grp_fu_670_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_2_reg_635 <= {{ap_sig_allocacmp_v19_2[9:1]}};
        tmp_2_reg_635_pp0_iter1_reg <= tmp_2_reg_635;
        tmp_reg_626 <= ap_sig_allocacmp_v19_2[32'd10];
        tmp_reg_626_pp0_iter1_reg <= tmp_reg_626;
        v19_2_reg_618 <= ap_sig_allocacmp_v19_2;
        v19_2_reg_618_pp0_iter1_reg <= v19_2_reg_618;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_3_reg_645 <= {{v19_2_reg_618[9:2]}};
        tmp_3_reg_645_pp0_iter1_reg <= tmp_3_reg_645;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_4_reg_686 <= v19_2_reg_618[32'd1];
        tmp_4_reg_686_pp0_iter1_reg <= tmp_4_reg_686;
        tmp_6_reg_671 <= {{v19_2_reg_618[9:3]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_v19_2 = v19_fu_90;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_252_p1 = v23_13_fu_494_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_252_p1 = v23_11_fu_484_p1;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_252_p1 = v23_9_fu_448_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_256_p1 = v23_14_fu_499_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_256_p1 = v23_12_fu_489_p1;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_256_p1 = v23_10_fu_453_p1;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_256_p1 = v23_8_fu_395_p1;
    end else begin
        grp_fu_256_p1 = 'bx;
    end
end
...
assign add_ln1_fu_304_p3 = {{tmp_1_fu_294_p4}, {ap_sig_allocacmp_v19_2}};
assign add_ln47_fu_342_p2 = (ap_sig_allocacmp_v19_2 + 11'd8);
assign add_ln51_1_fu_327_p4 = {{{v5}, {tmp_2_fu_317_p4}}, {1'd1}};
assign add_ln51_2_fu_362_p4 = {{{v5}, {tmp_3_fu_353_p4}}, {2'd2}};
assign add_ln51_3_fu_376_p4 = {{{v5}, {tmp_3_fu_353_p4}}, {2'd3}};
assign add_ln51_4_fu_409_p4 = {{{v5}, {tmp_6_fu_400_p4}}, {3'd4}};
assign add_ln51_5_fu_430_p6 = {{{{{v5}, {tmp_6_fu_400_p4}}, {1'd1}}, {tmp_4_fu_423_p3}}, {1'd1}};
assign add_ln51_6_fu_458_p4 = {{{v5}, {tmp_6_reg_671}}, {3'd6}};
assign add_ln51_7_fu_471_p4 = {{{v5}, {tmp_6_reg_671}}, {3'd7}};
...
assign grp_fu_666_p_din0 = v22;
assign grp_fu_666_p_din1 = grp_fu_252_p1;
assign grp_fu_670_p_ce = 1'b1;
assign grp_fu_670_p_din0 = v22;
assign grp_fu_670_p_din1 = grp_fu_256_p1;
assign or_ln47_1_fu_520_p3 = {{tmp_3_reg_645_pp0_iter1_reg}, {2'd2}};
assign or_ln47_2_fu_532_p3 = {{tmp_3_reg_645_pp0_iter1_reg}, {2'd3}};
assign or_ln47_3_fu_544_p3 = {{tmp_6_reg_671_pp0_iter1_reg}, {3'd4}};
assign or_ln47_4_fu_556_p5 = {{{{tmp_6_reg_671_pp0_iter1_reg}, {1'd1}}, {tmp_4_reg_686_pp0_iter1_reg}}, {1'd1}};
assign or_ln47_5_fu_571_p3 = {{tmp_6_reg_671_pp0_iter1_reg}, {3'd6}};
assign or_ln47_6_fu_583_p3 = {{tmp_6_reg_671_pp0_iter1_reg}, {3'd7}};
assign or_ln_fu_508_p3 = {{tmp_2_reg_635_pp0_iter1_reg}, {1'd1}};
assign tmp_1_fu_294_p4 = {{v5[12:1]}};
assign tmp_2_fu_317_p4 = {{ap_sig_allocacmp_v19_2[9:1]}};
assign tmp_3_fu_353_p4 = {{v19_2_reg_618[9:2]}};
assign tmp_4_fu_423_p3 = v19_2_reg_618[32'd1];
assign tmp_6_fu_400_p4 = {{v19_2_reg_618[9:3]}};
assign tmp_fu_286_p3 = ap_sig_allocacmp_v19_2[32'd10];
assign v0_address0 = v0_address0_local;
assign v0_address1 = v0_address1_local;
assign v0_ce0 = v0_ce0_local;
assign v0_ce1 = v0_ce1_local;
assign v23_10_fu_453_p1 = reg_264;
assign v23_11_fu_484_p1 = reg_260;
assign v23_12_fu_489_p1 = reg_264;
assign v23_13_fu_494_p1 = reg_260;
assign v23_14_fu_499_p1 = reg_264;
assign v23_8_fu_395_p1 = reg_264;
assign v23_9_fu_448_p1 = reg_260;
...
assign zext_ln47_fu_504_p1 = v19_2_reg_618_pp0_iter1_reg;
