...
sparsemux_9_2_32_1_1_U222(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_1_fu_435_p9),.sel(trunc_ln26_1_reg_490),.dout(tmp_1_fu_435_p11));
