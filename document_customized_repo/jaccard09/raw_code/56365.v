...
wire   [63:0] tmp_130_fu_121_p7;
wire   [63:0] tmp_130_fu_121_p9;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_130_fu_121_p1;
wire   [1:0] tmp_130_fu_121_p3;
wire  signed [1:0] tmp_130_fu_121_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 7'd1;
...
sparsemux_7_2_64_1_1_U896(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_130_fu_121_p7),.sel(ap_sig_allocacmp_i_10),.dout(tmp_130_fu_121_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_131_reg_226 <= grp_fu_8553_p_dout0;
