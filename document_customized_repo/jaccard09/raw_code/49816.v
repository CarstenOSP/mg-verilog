module ss_sort_ss_sort_Pipeline_hist_1_hist_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,a_address0,a_ce0,a_q0,a_address1,a_ce1,a_q1,zext_ln63,bucket_address0,bucket_ce0,bucket_we0,bucket_d0,bucket_q0); 
...
wire   [31:0] zext_ln63_cast_fu_137_p1;
reg   [31:0] zext_ln63_cast_reg_358;
wire    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln54_fu_159_p2;
reg   [2:0] i_1_load_reg_368;
...
reg   [31:0] a_load_reg_400;
reg   [31:0] a_load_1_reg_405;
wire   [9:0] thr_add36_fu_266_p2;
reg   [9:0] thr_add36_reg_410;
wire    ap_block_pp0_stage3_11001;
wire   [1:0] trunc_ln57_fu_276_p1;
reg   [1:0] trunc_ln57_reg_415;
reg   [10:0] bucket_addr_2_reg_420;
wire    ap_CS_fsm_pp0_stage4;
wire    ap_block_pp0_stage4_11001;
wire   [10:0] bucket_indx_2_fu_317_p2;
reg   [10:0] bucket_indx_2_reg_425;
reg   [10:0] bucket_addr_reg_430;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln57_fu_236_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln57_2_fu_258_p1;
...
wire   [9:0] add_ln54_2_fu_185_p2;
wire   [10:0] zext_ln55_fu_226_p1;
wire   [10:0] tmp_8_fu_219_p3;
wire   [10:0] add_ln56_fu_230_p2;
wire   [0:0] tmp_2_fu_241_p3;
wire   [10:0] add_ln56_1_fu_249_p4;
wire   [9:0] blockID_cast1_cast_fu_263_p1;
wire   [31:0] ashr_ln57_fu_272_p2;
wire   [10:0] shl_ln_fu_283_p3;
wire   [10:0] zext_ln55_1_fu_280_p1;
wire   [10:0] bucket_indx_fu_290_p2;
wire   [31:0] ashr_ln57_1_fu_301_p2;
wire   [1:0] trunc_ln57_2_fu_305_p1;
wire   [10:0] shl_ln57_1_fu_309_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln54_fu_159_p2 == 1'd0))) begin
            blockID_fu_66 <= select_ln54_fu_191_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        i_1_fu_62 <= add_ln55_fu_323_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln54_fu_159_p2 == 1'd0))) begin
            indvar_flatten_fu_70 <= add_ln54_fu_165_p2;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        a_load_1_reg_405 <= a_q0;
        a_load_reg_400 <= a_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        bucket_addr_2_reg_420 <= zext_ln58_fu_296_p1;
        bucket_indx_2_reg_425 <= bucket_indx_2_fu_317_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        bucket_addr_reg_430 <= zext_ln58_1_fu_333_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_1_load_reg_368 <= ap_sig_allocacmp_i_1_load;
        icmp_ln54_reg_364 <= icmp_ln54_fu_159_p2;
        tmp_reg_373 <= ap_sig_allocacmp_i_1_load[32'd2];
        zext_ln63_cast_reg_358[4 : 0] <= zext_ln63_cast_fu_137_p1[4 : 0];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        thr_add36_reg_410 <= thr_add36_fu_266_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_blockID_load = blockID_fu_66;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        bucket_address0_local = bucket_addr_reg_430;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        bucket_address0_local = zext_ln58_1_fu_333_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        bucket_address0_local = bucket_addr_2_reg_420;
...
assign a_address0 = zext_ln57_2_fu_258_p1;
assign a_address1 = zext_ln57_fu_236_p1;
assign a_ce0 = a_ce0_local;
assign a_ce1 = a_ce1_local;
assign add_ln54_2_fu_185_p2 = (ap_sig_allocacmp_blockID_load + 10'd1);
assign add_ln54_fu_165_p2 = (ap_sig_allocacmp_indvar_flatten_load + 11'd1);
assign add_ln55_fu_323_p2 = (select_ln52_reg_385 + 3'd2);
assign add_ln56_1_fu_249_p4 = {{{empty_reg_378}, {tmp_2_fu_241_p3}}, {1'd1}};
assign add_ln56_fu_230_p2 = (zext_ln55_fu_226_p1 + tmp_8_fu_219_p3);
...
assign ashr_ln57_1_fu_301_p2 = $signed(a_load_1_reg_405) >>> zext_ln63_cast_reg_358;
assign ashr_ln57_fu_272_p2 = $signed(a_load_reg_400) >>> zext_ln63_cast_reg_358;
assign blockID_cast1_cast_fu_263_p1 = empty_reg_378;
assign bucket_address0 = bucket_address0_local;
assign bucket_ce0 = bucket_ce0_local;
assign bucket_d0 = grp_fu_130_p2;
assign bucket_indx_2_fu_317_p2 = (shl_ln57_1_fu_309_p3 + zext_ln55_1_fu_280_p1);
assign bucket_indx_fu_290_p2 = (shl_ln_fu_283_p3 + zext_ln55_1_fu_280_p1);
assign bucket_we0 = bucket_we0_local;
assign empty_fu_199_p1 = select_ln54_fu_191_p3[8:0];
assign grp_fu_130_p2 = (reg_126 + 32'd1);
assign icmp_ln54_fu_159_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 11'd1024) ? 1'b1 : 1'b0);
assign select_ln52_fu_213_p3 = ((tmp_reg_373[0:0] == 1'b1) ? 3'd0 : i_1_load_reg_368);
assign select_ln54_fu_191_p3 = ((tmp_fu_177_p3[0:0] == 1'b1) ? add_ln54_2_fu_185_p2 : ap_sig_allocacmp_blockID_load);
assign shl_ln57_1_fu_309_p3 = {{trunc_ln57_2_fu_305_p1}, {9'd0}};
assign shl_ln_fu_283_p3 = {{trunc_ln57_reg_415}, {9'd0}};
assign thr_add36_fu_266_p2 = (blockID_cast1_cast_fu_263_p1 + 10'd1);
assign tmp_2_fu_241_p3 = select_ln52_fu_213_p3[32'd1];
assign tmp_8_fu_219_p3 = {{empty_reg_378}, {2'd0}};
assign tmp_fu_177_p3 = ap_sig_allocacmp_i_1_load[32'd2];
assign trunc_ln57_2_fu_305_p1 = ashr_ln57_1_fu_301_p2[1:0];
assign trunc_ln57_fu_276_p1 = ashr_ln57_fu_272_p2[1:0];
assign zext_ln55_1_fu_280_p1 = thr_add36_reg_410;
assign zext_ln55_fu_226_p1 = select_ln52_fu_213_p3;
assign zext_ln57_2_fu_258_p1 = add_ln56_1_fu_249_p4;
assign zext_ln57_fu_236_p1 = add_ln56_fu_230_p2;
assign zext_ln58_1_fu_333_p1 = bucket_indx_2_reg_425;
assign zext_ln58_fu_296_p1 = bucket_indx_fu_290_p2;
assign zext_ln63_cast_fu_137_p1 = zext_ln63;
always @ (posedge ap_clk) begin
    zext_ln63_cast_reg_358[31:5] <= 27'b000000000000000000000000000;
end
endmodule 