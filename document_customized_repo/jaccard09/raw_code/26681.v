...
sparsemux_7_2_64_1_1_U309(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_53_fu_222_p7),.sel(ap_sig_allocacmp_i_14),.dout(tmp_53_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_54_reg_373 <= grp_fu_4261_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((i_14_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_1_o = grp_fu_4257_p_dout0;
    end else begin
...
always @ (*) begin
    if ((~(i_14_reg_332_pp0_iter87_reg == 2'd0) & ~(i_14_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_2_o = grp_fu_4257_p_dout0;
    end else begin
...
always @ (*) begin
    if (((i_14_reg_332_pp0_iter87_reg == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_o = grp_fu_4257_p_dout0;
    end else begin
...
assign grp_fu_4257_p_din0 = 64'd4607182418800017408;
assign grp_fu_4257_p_din1 = add_i2_reg_378;
assign grp_fu_4261_p_ce = 1'b1;
assign grp_fu_4261_p_din0 = 64'd0;
assign grp_fu_4261_p_din1 = bitcast_ln20_1_fu_275_p1;
