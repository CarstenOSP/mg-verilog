module viterbi_viterbi_Pipeline_L_prev_state (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p_34,empty_9,llike_1_address0,llike_1_ce0,llike_1_q0,llike_2_address0,llike_2_ce0,llike_2_q0,llike_3_address0,llike_3_ce0,llike_3_q0,empty_10,transition_address0,transition_ce0,transition_q0,transition_address1,transition_ce1,transition_q1,bitcast_ln24,empty,llike_address0,llike_ce0,llike_q0,min_p_42_out,min_p_42_out_ap_vld,grp_fu_348_p_din0,grp_fu_348_p_din1,grp_fu_348_p_opcode,grp_fu_348_p_dout0,grp_fu_348_p_ce,grp_fu_754_p_din0,grp_fu_754_p_din1,grp_fu_754_p_opcode,grp_fu_754_p_dout0,grp_fu_754_p_ce); 
...
reg   [63:0] min_p_35_reg_975;
wire   [0:0] and_ln29_1_fu_527_p2;
reg   [0:0] and_ln29_1_reg_982;
reg   [63:0] p_16_reg_987;
wire   [63:0] min_p_37_fu_533_p3;
reg   [63:0] min_p_37_reg_994;
reg   [63:0] p_17_reg_1001;
wire   [0:0] and_ln29_3_fu_615_p2;
reg   [0:0] and_ln29_3_reg_1008;
wire    ap_CS_fsm_pp0_stage6;
wire    ap_block_pp0_stage6_11001;
reg   [63:0] p_18_reg_1013;
wire   [63:0] min_p_39_fu_621_p3;
reg   [63:0] min_p_39_reg_1020;
wire    ap_CS_fsm_pp0_stage7;
wire    ap_block_pp0_stage7_11001;
wire   [0:0] and_ln29_5_fu_703_p2;
reg   [0:0] and_ln29_5_reg_1027;
wire   [63:0] min_p_41_fu_709_p3;
reg   [63:0] min_p_41_reg_1032;
reg   [0:0] tmp_60_reg_1039;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        min_p_fu_98 <= min_p_43_fu_797_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_54_reg_868 <= {{add_ln27_1_fu_340_p2[11:6]}};
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        min_p_35_reg_975 <= min_p_fu_98;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        min_p_37_reg_994 <= min_p_37_fu_533_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        min_p_39_reg_1020 <= min_p_39_fu_621_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_41_reg_1032 <= min_p_41_fu_709_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        p_16_reg_987 <= grp_fu_348_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        p_17_reg_1001 <= grp_fu_348_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        p_18_reg_1013 <= grp_fu_348_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_60_reg_1039 <= grp_fu_754_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_240_p0 = p_18_reg_1013;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        grp_fu_240_p0 = p_17_reg_1001;
    end else if (((1'b0 == ap_block_pp0_stage5) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        grp_fu_240_p0 = p_16_reg_987;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_240_p1 = min_p_41_fu_709_p3;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        grp_fu_240_p1 = min_p_39_fu_621_p3;
    end else if (((1'b0 == ap_block_pp0_stage5) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        grp_fu_240_p1 = min_p_37_fu_533_p3;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
assign add_ln27_2_fu_327_p3 = {{tmp_50_fu_317_p4}, {empty_10}};
assign add_ln27_4_fu_370_p3 = {{tmp_54_reg_868}, {empty_10}};
...
assign and_ln29_7_fu_792_p2 = (tmp_60_reg_1039 & and_ln29_6_fu_786_p2);
...
assign bitcast_ln29_1_fu_468_p1 = min_p_35_reg_975;
assign bitcast_ln29_2_fu_539_p1 = p_16_reg_987;
assign bitcast_ln29_3_fu_556_p1 = min_p_37_reg_994;
assign bitcast_ln29_4_fu_627_p1 = p_17_reg_1001;
assign bitcast_ln29_5_fu_644_p1 = min_p_39_reg_1020;
assign bitcast_ln29_6_fu_716_p1 = p_18_reg_1013;
assign bitcast_ln29_7_fu_733_p1 = min_p_41_reg_1032;
...
assign icmp_ln29_10_fu_679_p2 = ((tmp_56_fu_647_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_11_fu_685_p2 = ((trunc_ln29_5_fu_657_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_12_fu_750_p2 = ((tmp_58_fu_719_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_13_fu_756_p2 = ((trunc_ln29_6_fu_729_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_14_fu_768_p2 = ((tmp_59_fu_736_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign icmp_ln29_2_fu_503_p2 = ((tmp_48_fu_471_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_3_fu_509_p2 = ((trunc_ln29_1_fu_481_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_4_fu_573_p2 = ((tmp_51_fu_542_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_5_fu_579_p2 = ((trunc_ln29_2_fu_552_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_6_fu_591_p2 = ((tmp_52_fu_559_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_7_fu_597_p2 = ((trunc_ln29_3_fu_569_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_8_fu_661_p2 = ((tmp_55_fu_630_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_9_fu_667_p2 = ((trunc_ln29_4_fu_640_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_fu_485_p2 = ((tmp_47_fu_454_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign min_p_37_fu_533_p3 = ((and_ln29_1_reg_982[0:0] == 1'b1) ? p_reg_968 : min_p_35_reg_975);
assign min_p_39_fu_621_p3 = ((and_ln29_3_reg_1008[0:0] == 1'b1) ? p_16_reg_987 : min_p_37_reg_994);
assign min_p_41_fu_709_p3 = ((and_ln29_5_reg_1027[0:0] == 1'b1) ? p_17_reg_1001 : min_p_39_reg_1020);
assign min_p_42_out = ((and_ln29_5_reg_1027[0:0] == 1'b1) ? p_17_reg_1001 : min_p_39_reg_1020);
assign min_p_43_fu_797_p3 = ((and_ln29_7_fu_792_p2[0:0] == 1'b1) ? p_18_reg_1013 : min_p_41_reg_1032);
...
assign tmp_47_fu_454_p4 = {{bitcast_ln29_fu_451_p1[62:52]}};
assign tmp_48_fu_471_p4 = {{bitcast_ln29_1_fu_468_p1[62:52]}};
assign tmp_50_fu_317_p4 = {{add_ln27_fu_311_p2[11:6]}};
assign tmp_51_fu_542_p4 = {{bitcast_ln29_2_fu_539_p1[62:52]}};
assign tmp_52_fu_559_p4 = {{bitcast_ln29_3_fu_556_p1[62:52]}};
assign tmp_55_fu_630_p4 = {{bitcast_ln29_4_fu_627_p1[62:52]}};
assign tmp_56_fu_647_p4 = {{bitcast_ln29_5_fu_644_p1[62:52]}};
assign tmp_58_fu_719_p4 = {{bitcast_ln29_6_fu_716_p1[62:52]}};
assign tmp_59_fu_736_p4 = {{bitcast_ln29_7_fu_733_p1[62:52]}};
