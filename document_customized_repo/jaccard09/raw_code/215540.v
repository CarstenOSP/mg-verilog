...
reg   [31:0] reg_259;
reg   [31:0] reg_267;
reg   [10:0] v19_14_reg_451;
wire   [0:0] tmp_8_fu_283_p3;
wire   [12:0] tmp_23_fu_320_p4;
reg   [12:0] tmp_23_reg_467;
...
wire   [31:0] v23_43_fu_412_p1;
wire   [31:0] v23_44_fu_417_p1;
wire   [31:0] v23_45_fu_422_p1;
reg   [6:0] v3_2_addr_reg_517;
reg   [6:0] v3_6_addr_reg_522;
reg   [6:0] v3_3_addr_reg_527;
reg   [6:0] v3_7_addr_reg_532;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln51_fu_305_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln51_40_fu_340_p1;
wire   [63:0] zext_ln51_41_fu_378_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln51_42_fu_392_p1;
...
wire   [22:0] add_ln51_s_fu_330_p4;
wire   [2:0] trunc_ln47_fu_295_p1;
wire   [7:0] tmp_24_fu_360_p4;
wire   [22:0] add_ln51_30_fu_369_p4;
wire   [22:0] add_ln51_31_fu_383_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v19_fu_86 <= 11'd0;
    end else if (((tmp_8_reg_458 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v19_fu_86 <= add_ln47_fu_397_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln48_s_reg_482 <= {{v19_14_reg_451[9:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_23_reg_467 <= {{empty[22:10]}};
        tmp_8_reg_458 <= ap_sig_allocacmp_v19_14[32'd10];
        v19_14_reg_451 <= ap_sig_allocacmp_v19_14;
...
always @ (*) begin
    if (((tmp_8_reg_458 == 1'd1) & (1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            grp_fu_243_p1 = v23_44_fu_417_p1;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            grp_fu_247_p1 = v23_45_fu_422_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            grp_fu_247_p1 = v23_43_fu_412_p1;
        end else begin
            grp_fu_247_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address0_local = zext_ln51_42_fu_392_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v0_address0_local = zext_ln51_40_fu_340_p1;
        end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            v0_address1_local = zext_ln51_41_fu_378_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v0_address1_local = zext_ln51_fu_305_p1;
        end else begin
...
assign add_ln47_fu_397_p2 = (v19_14_reg_451 + 11'd4);
assign add_ln51_30_fu_369_p4 = {{{tmp_23_reg_467}, {tmp_24_fu_360_p4}}, {2'd2}};
assign add_ln51_31_fu_383_p4 = {{{tmp_23_reg_467}, {tmp_24_fu_360_p4}}, {2'd3}};
assign add_ln51_fu_299_p2 = (zext_ln47_fu_291_p1 + empty);
assign add_ln51_s_fu_330_p4 = {{{tmp_23_fu_320_p4}, {tmp_s_fu_310_p4}}, {1'd1}};
...
assign grp_fu_8063_p_din0 = v22_16;
assign grp_fu_8063_p_din1 = grp_fu_243_p1;
assign grp_fu_8067_p_ce = 1'b1;
assign grp_fu_8067_p_din0 = v22_16;
assign grp_fu_8067_p_din1 = grp_fu_247_p1;
assign icmp_ln53_fu_345_p2 = ((trunc_ln47_fu_295_p1 == 3'd0) ? 1'b1 : 1'b0);
assign tmp_23_fu_320_p4 = {{empty[22:10]}};
assign tmp_24_fu_360_p4 = {{v19_14_reg_451[9:2]}};
assign tmp_8_fu_283_p3 = ap_sig_allocacmp_v19_14[32'd10];
assign tmp_s_fu_310_p4 = {{ap_sig_allocacmp_v19_14[9:1]}};
assign trunc_ln47_fu_295_p1 = ap_sig_allocacmp_v19_14[2:0];
assign v0_address0 = v0_address0_local;
assign v0_address1 = v0_address1_local;
assign v0_ce0 = v0_ce0_local;
assign v0_ce1 = v0_ce1_local;
assign v23_43_fu_412_p1 = reg_255;
assign v23_44_fu_417_p1 = reg_251;
assign v23_45_fu_422_p1 = reg_255;
...
assign zext_ln47_fu_291_p1 = ap_sig_allocacmp_v19_14;
assign zext_ln48_fu_427_p1 = lshr_ln48_s_reg_482_pp0_iter2_reg;
assign zext_ln51_40_fu_340_p1 = add_ln51_s_fu_330_p4;
assign zext_ln51_41_fu_378_p1 = add_ln51_30_fu_369_p4;
assign zext_ln51_42_fu_392_p1 = add_ln51_31_fu_383_p4;
assign zext_ln51_fu_305_p1 = add_ln51_fu_299_p2;
endmodule 