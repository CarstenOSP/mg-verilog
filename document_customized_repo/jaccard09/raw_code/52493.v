...
sparsemux_7_2_64_1_1_U502(.din0(mux_case_02736_reload),.din1(mux_case_12840_reload),.din2(mux_case_22944_reload),.def(tmp_8_fu_329_p7),.sel(i_12_reg_526_pp0_iter1_reg),.dout(tmp_8_fu_329_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U503(.din0(mux_case_03048_reload),.din1(mux_case_13152_reload),.din2(mux_case_23256_reload),.def(tmp_9_fu_372_p7),.sel(i_12_reg_526_pp0_iter8_reg),.dout(tmp_9_fu_372_p9));
