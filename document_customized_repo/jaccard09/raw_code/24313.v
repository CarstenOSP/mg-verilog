...
sparsemux_7_2_64_1_1_U290(.din0(x_0_q0),.din1(x_1_q0),.din2(x_2_q0),.def(grp_fu_281_p7),.sel(grp_fu_281_p8),.dout(grp_fu_281_p9));
...
sparsemux_7_2_64_1_1_U291(.din0(x_0_q0),.din1(x_1_q0),.din2(x_2_q0),.def(grp_fu_300_p7),.sel(grp_fu_300_p8),.dout(grp_fu_300_p9));
fft1D_512_urem_9ns_3ns_2_13_1 #(.ID( 1 ),.NUM_STAGE( 13 ),.din0_WIDTH( 9 ),.din1_WIDTH( 3 ),.dout_WIDTH( 2 ))
urem_9ns_3ns_2_13_1_U292(.clk(ap_clk),.reset(ap_rst),.din0(offset),.din1(grp_fu_319_p1),.ce(grp_fu_319_ce),.dout(grp_fu_319_p2));
fft1D_512_mul_9ns_11ns_19_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 9 ),.din1_WIDTH( 11 ),.dout_WIDTH( 19 ))
mul_9ns_11ns_19_1_1_U293(.din0(mul_ln102_fu_331_p0),.din1(mul_ln102_fu_331_p1),.dout(mul_ln102_fu_331_p2));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U294(.din0(x_0_q1),.din1(x_1_q1),.din2(x_2_q1),.def(a_y_fu_436_p7),.sel(trunc_ln103_reg_665),.dout(a_y_fu_436_p9));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h1 ),.din0_WIDTH( 64 ),.CASE1( 2'h2 ),.din1_WIDTH( 64 ),.CASE2( 2'h0 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U295(.din0(x_0_q1),.din1(x_1_q1),.din2(x_2_q1),.def(a_y_1_fu_455_p7),.sel(trunc_ln103_reg_665),.dout(a_y_1_fu_455_p9));
...
sparsemux_7_2_64_1_1_U296(.din0(x_0_q1),.din1(x_1_q1),.din2(x_2_q1),.def(a_y_2_fu_474_p7),.sel(trunc_ln103_reg_665),.dout(a_y_2_fu_474_p9));
(* dissolve_hierarchy = "yes" *) fft1D_512_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h2 ),.din0_WIDTH( 64 ),.CASE1( 2'h0 ),.din1_WIDTH( 64 ),.CASE2( 2'h1 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U297(.din0(x_0_q0),.din1(x_1_q0),.din2(x_2_q0),.def(a_y_5_fu_493_p7),.sel(trunc_ln103_reg_665),.dout(a_y_5_fu_493_p9));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U298(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_586_p0),.din1(grp_fu_586_p1),.din2(grp_fu_586_p2),.ce(grp_fu_586_ce),.dout(grp_fu_586_p3));
fft1D_512_am_addmul_9ns_4ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 4 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_4ns_11ns_21_4_1_U299(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_595_p0),.din1(grp_fu_595_p1),.din2(grp_fu_595_p2),.ce(grp_fu_595_ce),.dout(grp_fu_595_p3));
fft1D_512_am_addmul_9ns_5ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 5 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_5ns_11ns_21_4_1_U300(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_603_p0),.din1(grp_fu_603_p1),.din2(grp_fu_603_p2),.ce(grp_fu_603_ce),.dout(grp_fu_603_p3));
fft1D_512_am_addmul_9ns_5ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 5 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_5ns_11ns_21_4_1_U301(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_611_p0),.din1(grp_fu_611_p1),.din2(grp_fu_611_p2),.ce(grp_fu_611_ce),.dout(grp_fu_611_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U302(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_619_p0),.din1(grp_fu_619_p1),.din2(grp_fu_619_p2),.ce(grp_fu_619_ce),.dout(grp_fu_619_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U303(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_627_p0),.din1(grp_fu_627_p1),.din2(grp_fu_627_p2),.ce(grp_fu_627_ce),.dout(grp_fu_627_p3));
fft1D_512_am_addmul_9ns_6ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 9 ),.din1_WIDTH( 6 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_9ns_6ns_11ns_21_4_1_U304(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_635_p0),.din1(grp_fu_635_p1),.din2(grp_fu_635_p2),.ce(grp_fu_635_ce),.dout(grp_fu_635_p3));
