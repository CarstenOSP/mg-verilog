...
wire   [63:0] tmp_83_fu_121_p7;
wire   [63:0] tmp_83_fu_121_p9;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_83_fu_121_p1;
wire   [1:0] tmp_83_fu_121_p3;
wire  signed [1:0] tmp_83_fu_121_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 7'd1;
...
sparsemux_7_2_64_1_1_U482(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_83_fu_121_p7),.sel(ap_sig_allocacmp_i_12),.dout(tmp_83_fu_121_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_84_reg_226 <= grp_fu_10495_p_dout0;
...
assign bitcast_ln9_fu_141_p1 = tmp_83_fu_121_p9;
assign grp_fu_10475_p_ce = 1'b1;
assign grp_fu_10475_p_din0 = ap_sig_allocacmp_sum_load;
assign grp_fu_10475_p_din1 = tmp_84_reg_226;
