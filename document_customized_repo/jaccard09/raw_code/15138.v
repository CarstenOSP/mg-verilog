...
wire   [63:0] grp_bfs_Pipeline_loop_neighbors_fu_472_cnt_6_out;
wire    grp_bfs_Pipeline_loop_neighbors_fu_472_cnt_6_out_ap_vld;
...
sparsemux_33_4_64_1_1_U31(.din0(e_fu_678_p2),.din1(e_fu_678_p4),.din2(e_fu_678_p6),.din3(e_fu_678_p8),.din4(e_fu_678_p10),.din5(e_fu_678_p12),.din6(e_fu_678_p14),.din7(e_fu_678_p16),.din8(e_fu_678_p18),.din9(e_fu_678_p20),.din10(e_fu_678_p22),.din11(e_fu_678_p24),.din12(e_fu_678_p26),.din13(e_fu_678_p28),.din14(e_fu_678_p30),.din15(e_fu_678_p32),.def(e_fu_678_p33),.sel(trunc_ln24_reg_1024),.dout(e_fu_678_p35));
(* dissolve_hierarchy = "yes" *) bfs_sparsemux_33_4_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h1 ),.din1_WIDTH( 64 ),.CASE2( 4'h2 ),.din2_WIDTH( 64 ),.CASE3( 4'h3 ),.din3_WIDTH( 64 ),.CASE4( 4'h4 ),.din4_WIDTH( 64 ),.CASE5( 4'h5 ),.din5_WIDTH( 64 ),.CASE6( 4'h6 ),.din6_WIDTH( 64 ),.CASE7( 4'h7 ),.din7_WIDTH( 64 ),.CASE8( 4'h8 ),.din8_WIDTH( 64 ),.CASE9( 4'h9 ),.din9_WIDTH( 64 ),.CASE10( 4'hA ),.din10_WIDTH( 64 ),.CASE11( 4'hB ),.din11_WIDTH( 64 ),.CASE12( 4'hC ),.din12_WIDTH( 64 ),.CASE13( 4'hD ),.din13_WIDTH( 64 ),.CASE14( 4'hE ),.din14_WIDTH( 64 ),.CASE15( 4'hF ),.din15_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_33_4_64_1_1_U32(.din0(tmp_end_fu_910_p2),.din1(tmp_end_fu_910_p4),.din2(tmp_end_fu_910_p6),.din3(tmp_end_fu_910_p8),.din4(tmp_end_fu_910_p10),.din5(tmp_end_fu_910_p12),.din6(tmp_end_fu_910_p14),.din7(tmp_end_fu_910_p16),.din8(tmp_end_fu_910_p18),.din9(tmp_end_fu_910_p20),.din10(tmp_end_fu_910_p22),.din11(tmp_end_fu_910_p24),.din12(tmp_end_fu_910_p26),.din13(tmp_end_fu_910_p28),.din14(tmp_end_fu_910_p30),.din15(tmp_end_fu_910_p32),.def(tmp_end_fu_910_p33),.sel(trunc_ln24_reg_1024),.dout(tmp_end_fu_910_p35));
...
always @ (posedge ap_clk) begin
    if (((icmp_ln25_fu_609_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        cnt_4_reg_460 <= grp_bfs_Pipeline_loop_neighbors_fu_472_cnt_6_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((icmp_ln25_reg_1043 == 1'd1) & (1'b1 == ap_CS_fsm_state7))) begin
        ap_phi_mux_cnt_4_phi_fu_464_p4 = grp_bfs_Pipeline_loop_neighbors_fu_472_cnt_6_out;
    end else begin
