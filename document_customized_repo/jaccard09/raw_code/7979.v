module sha_stream_sha_transform_Pipeline_trans_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_41_reload,B_1_reload,E_41_reload,D_41_reload,E_2_reload,W_36_reload,W_38_reload,W_40_reload,W_42_reload,W_44_reload,W_46_reload,W_48_reload,W_50_reload,W_52_reload,W_54_reload,W_37_reload,W_39_reload,W_41_reload,W_43_reload,W_45_reload,W_47_reload,W_49_reload,W_51_reload,W_53_reload,W_55_reload,A_43_out,A_43_out_ap_vld,B_4_out,B_4_out_ap_vld,E_42_out,E_42_out_ap_vld,D_43_out,D_43_out_ap_vld,E_5_out,E_5_out_ap_vld); 
...
wire   [31:0] B_38_fu_516_p2;
reg   [31:0] B_38_reg_843;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            B_4_fu_134 <= B_38_reg_843;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        B_fu_138 <= A_41_reload;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        E_5_fu_126 <= E_40_reg_817;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        E_fu_130 <= D_41_reload;
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln120_reg_824 == 1'd1))) begin
        E_fu_130 <= D_19_fu_536_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        B_38_reg_843 <= B_38_fu_516_p2;
        E_load_reg_838 <= E_fu_130;
        lshr_ln122_2_reg_853 <= {{B_38_fu_516_p2[31:27]}};
...
assign B_38_fu_516_p2 = (add_ln122_fu_510_p2 + add_ln122_2_fu_504_p2);
assign B_4_out = B_4_fu_134;
assign C_6_fu_583_p3 = {{trunc_ln122_3_fu_569_p1}, {lshr_ln122_3_fu_573_p4}};
assign D_19_fu_536_p3 = {{trunc_ln122_1_fu_522_p1}, {lshr_ln122_1_fu_526_p4}};
...
assign trunc_ln122_2_fu_544_p1 = B_38_fu_516_p2[26:0];
...
assign xor_ln122_2_fu_558_p2 = (D_19_fu_536_p3 ^ B_fu_138);
assign xor_ln122_3_fu_564_p2 = (xor_ln122_2_fu_558_p2 ^ E_40_reg_817);
assign xor_ln122_fu_480_p2 = (E_fu_130 ^ E_40_reg_817);
endmodule 