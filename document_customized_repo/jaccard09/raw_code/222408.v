...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
        reg_186 <= grp_fu_779_p_dout0;
        reg_191 <= grp_fu_783_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_779_p_din0 = v22_1;
assign grp_fu_779_p_din1 = grp_fu_170_p1;
assign grp_fu_783_p_ce = 1'b1;
assign grp_fu_783_p_din0 = v22_1;
assign grp_fu_783_p_din1 = grp_fu_174_p1;
