...
wire   [3:0] lshr_ln5_6_fu_352_p4;
reg   [3:0] lshr_ln5_6_reg_567;
...
reg   [12:0] indvar_flatten7_fu_84;
...
wire   [31:0] tmp_7_fu_420_p9;
wire   [1:0] tmp_7_fu_420_p10;
...
wire   [1:0] tmp_7_fu_420_p1;
wire   [1:0] tmp_7_fu_420_p3;
wire  signed [1:0] tmp_7_fu_420_p5;
wire  signed [1:0] tmp_7_fu_420_p7;
...
sparsemux_9_2_32_1_1_U28(.din0(buff_q_out_q0),.din1(buff_q_out_1_q0),.din2(buff_q_out_2_q0),.din3(buff_q_out_3_q0),.def(tmp_1_fu_380_p9),.sel(trunc_ln29_reg_542),.dout(tmp_1_fu_380_p11));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U29(.din0(buff_p_q0),.din1(buff_p_1_q0),.din2(buff_p_2_q0),.din3(buff_p_3_q0),.def(tmp_7_fu_420_p9),.sel(tmp_7_fu_420_p10),.dout(tmp_7_fu_420_p11));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U30(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.def(tmp_6_fu_460_p9),.sel(trunc_ln30_reg_597),.dout(tmp_6_fu_460_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln29_fu_274_p2 == 1'd0))) begin
            indvar_flatten7_fu_84 <= add_ln29_1_fu_280_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten7_fu_84 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        add1_reg_646 <= grp_fu_571_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln5_6_reg_567 <= {{select_ln5_fu_304_p3[5:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_1_reg_592 <= tmp_1_fu_380_p11;
        tmp_7_reg_622 <= tmp_7_fu_420_p11;
        trunc_ln30_reg_597 <= trunc_ln30_fu_403_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul1_reg_636 <= grp_fu_575_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_6_reg_631 <= tmp_6_fu_460_p11;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln30_1_reg_627_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage6) & (trunc_ln29_reg_542_pp0_iter1_reg == 2'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln30_1_reg_627_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage6) & (trunc_ln29_reg_542_pp0_iter1_reg == 2'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln30_1_reg_627_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage6) & (trunc_ln29_reg_542_pp0_iter1_reg == 2'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln30_1_reg_627_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage6) & (trunc_ln29_reg_542_pp0_iter1_reg == 2'd0))) begin
...
assign add_ln29_1_fu_280_p2 = (ap_sig_allocacmp_indvar_flatten7_load + 13'd1);
...
always @ (*) begin
    ap_condition_575 = ((icmp_ln29_reg_523 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_538 == 1'd1));
end
...
assign empty_12_fu_320_p1 = select_ln29_fu_312_p3[5:0];
assign first_iter_1_fu_324_p2 = ((select_ln5_fu_304_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_571_p_ce = 1'b1;
assign grp_fu_571_p_din0 = empty_fu_88;
assign grp_fu_571_p_din1 = mul1_reg_636;
assign grp_fu_571_p_opcode = 2'd0;
assign grp_fu_575_p_ce = 1'b1;
assign grp_fu_575_p_din0 = tmp_6_reg_631;
assign grp_fu_575_p_din1 = tmp_7_reg_622;
assign icmp_ln29_fu_274_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 13'd4096) ? 1'b1 : 1'b0);
...
assign lshr_ln5_6_fu_352_p4 = {{select_ln5_fu_304_p3[5:2]}};
assign select_ln29_fu_312_p3 = ((icmp_ln30_fu_298_p2[0:0] == 1'b1) ? add_ln29_fu_292_p2 : ap_sig_allocacmp_i_load);
assign select_ln5_fu_304_p3 = ((icmp_ln30_fu_298_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp_1_fu_380_p9 = 'bx;
assign tmp_5_fu_406_p3 = {{empty_12_reg_533}, {lshr_ln5_6_reg_567}};
assign tmp_6_fu_460_p9 = 'bx;
assign tmp_7_fu_420_p10 = select_ln5_reg_527[1:0];
assign tmp_7_fu_420_p9 = 'bx;
assign trunc_ln29_fu_330_p1 = select_ln29_fu_312_p3[1:0];
assign trunc_ln30_fu_403_p1 = select_ln5_reg_527[1:0];
assign zext_ln31_fu_412_p1 = tmp_5_fu_406_p3;
assign zext_ln5_1_fu_362_p1 = lshr_ln5_6_fu_352_p4;
