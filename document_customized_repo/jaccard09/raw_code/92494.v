module syr2k_syr2k_Pipeline_lp7_lp8 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_C_address0,buff_C_ce0,buff_C_q0,buff_D_out_address0,buff_D_out_ce0,buff_D_out_we0,buff_D_out_d0,tmp1_address0,tmp1_ce0,tmp1_q0,tmp2_address0,tmp2_ce0,tmp2_q0,beta,grp_fu_1123_p_din0,grp_fu_1123_p_din1,grp_fu_1123_p_opcode,grp_fu_1123_p_dout0,grp_fu_1123_p_ce,grp_fu_1131_p_din0,grp_fu_1131_p_din1,grp_fu_1131_p_opcode,grp_fu_1131_p_dout0,grp_fu_1131_p_ce,grp_fu_1127_p_din0,grp_fu_1127_p_din1,grp_fu_1127_p_dout0,grp_fu_1127_p_ce); 
...
reg   [12:0] indvar_flatten35_fu_56;
...
#0 j_fu_48 = 7'd0;
#0 i_fu_52 = 7'd0;
#0 indvar_flatten35_fu_56 = 13'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln45_fu_148_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten35_fu_56 <= add_ln45_1_fu_154_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten35_fu_56 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add2_reg_313 <= grp_fu_1123_p_dout0;
        add3_reg_323 <= grp_fu_1131_p_dout0;
        ...
        empty_10_reg_298 <= tmp2_q0;
        empty_reg_293 <= tmp1_q0;
        mul4_reg_318 <= grp_fu_1127_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten35_load = indvar_flatten35_fu_56;
    end
end
always @ (*) begin
...
assign add_ln45_1_fu_154_p2 = (ap_sig_allocacmp_indvar_flatten35_load + 13'd1);
assign add_ln45_fu_171_p2 = (i_fu_52 + 7'd1);
assign add_ln46_fu_221_p2 = (select_ln5_fu_183_p3 + 7'd1);
assign add_ln48_fu_215_p2 = (tmp_s_fu_203_p3 + zext_ln48_fu_211_p1);
...
assign grp_fu_1123_p_din0 = empty_reg_293;
assign grp_fu_1123_p_din1 = empty_10_reg_298;
assign grp_fu_1123_p_opcode = 2'd0;
assign grp_fu_1127_p_ce = 1'b1;
assign grp_fu_1127_p_din0 = buff_C_load_reg_308;
assign grp_fu_1127_p_din1 = beta;
assign grp_fu_1131_p_ce = 1'b1;
assign grp_fu_1131_p_din0 = add2_reg_313;
assign grp_fu_1131_p_din1 = mul4_reg_318;
assign grp_fu_1131_p_opcode = 2'd0;
assign icmp_ln45_fu_148_p2 = ((ap_sig_allocacmp_indvar_flatten35_load == 13'd4096) ? 1'b1 : 1'b0);
...
assign tmp_s_fu_203_p3 = {{trunc_ln48_fu_199_p1}, {6'd0}};
