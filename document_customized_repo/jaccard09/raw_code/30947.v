...
wire   [11:0] tmp_95_fu_729_p3;
reg   [11:0] tmp_95_reg_1005;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_50_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_50_out_ap_vld;
...
wire   [63:0] tmp_137_cast_fu_535_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_3_reg_895[11 : 4] <= tmp_137_cast_fu_535_p1[11 : 4];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_95_reg_1005[11 : 4] <= tmp_95_fu_729_p3[11 : 4];
        trunc_ln50_1_reg_1015 <= trunc_ln50_1_fu_741_p1;
        trunc_ln52_reg_1019 <= trunc_ln52_fu_752_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_50_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_50_loc_fu_128 <= grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_50_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_50_loc_fu_128;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_50_loc_fu_128;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_50_loc_fu_128;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
assign tmp_137_cast_fu_535_p1 = tmp_s_fu_527_p3;
assign tmp_8_fu_540_p3 = ((trunc_ln18_fu_519_p1[0:0] == 1'b1) ? obs_1_q0 : obs_0_q0);
assign tmp_95_fu_729_p3 = {{trunc_ln50_reg_989}, {4'd0}};
assign tmp_96_fu_667_p3 = {{t_2_reg_860}, {lshr_ln7_reg_937}};
...
assign zext_ln33_fu_673_p1 = tmp_96_fu_667_p3;
assign zext_ln52_1_fu_766_p1 = lshr_ln52_1_fu_756_p4;
assign zext_ln52_2_fu_736_p1 = tmp_95_fu_729_p3;
