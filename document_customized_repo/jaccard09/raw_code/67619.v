...
reg   [8:0] indvar_flatten20_load_reg_1426;
...
wire   [4:0] indvars_iv_next19_dup_fu_965_p2;
reg   [4:0] indvars_iv_next19_dup_reg_1474;
wire   [3:0] k_2_mid2_fu_977_p3;
reg   [3:0] k_2_mid2_reg_1479;
...
reg   [0:0] tmp_reg_1493;
wire   [4:0] select_ln37_fu_1002_p3;
reg   [4:0] select_ln37_reg_1502;
wire   [9:0] empty_6_fu_1036_p2;
reg   [9:0] empty_6_reg_1507;
wire   [4:0] empty_7_fu_1079_p3;
reg   [4:0] empty_7_reg_1552;
reg   [31:0] tmp_5_reg_1677;
wire   [31:0] tmp_9_fu_1246_p19;
reg   [31:0] tmp_9_reg_1762;
wire   [31:0] tmp_s_fu_1285_p19;
reg   [31:0] tmp_s_reg_1767;
...
wire    ap_loop_init;
reg   [4:0] j_fu_124;
reg   [8:0] indvar_flatten20_fu_128;
wire   [8:0] select_ln37_1_fu_1179_p3;
reg   [4:0] i_fu_132;
reg   [13:0] indvar_flatten35_fu_136;
...
wire   [4:0] indvars_iv_next3347_fu_951_p2;
wire   [0:0] empty_fu_971_p2;
wire  signed [5:0] tmp2_cast_cast_fu_1014_p3;
wire   [9:0] tmp2_cast_cast_cast_fu_1022_p1;
wire   [9:0] tmp_1_fu_1007_p3;
wire  signed [9:0] tmp3_cast_fu_1032_p1;
wire   [9:0] empty_5_fu_1026_p2;
wire   [10:0] add_ln5_fu_1048_p3;
wire   [4:0] indvars_iv_next1954_fu_1067_p2;
wire   [4:0] indvars_iv_next19_mid1_fu_997_p2;
wire   [4:0] select_ln11_1_fu_1072_p3;
wire   [4:0] tmp4_fu_1042_p2;
wire   [10:0] add_ln8_fu_1086_p4;
wire   [0:0] tmp_2_fu_1111_p3;
wire   [10:0] add_ln44_1_fu_1119_p4;
wire   [3:0] add_ln45_fu_1140_p2;
wire   [0:0] tmp_3_fu_1145_p3;
wire   [10:0] add_ln45_1_fu_1153_p4;
wire   [8:0] add_ln37_fu_1174_p2;
wire   [10:0] add_ln6_fu_1209_p3;
wire   [10:0] add_ln7_fu_1227_p4;
wire   [31:0] tmp_9_fu_1246_p17;
wire   [31:0] tmp_s_fu_1285_p17;
wire   [10:0] add_ln4_fu_1324_p4;
...
wire  signed [2:0] tmp_9_fu_1246_p1;
wire   [2:0] tmp_9_fu_1246_p3;
wire   [2:0] tmp_9_fu_1246_p5;
wire   [2:0] tmp_9_fu_1246_p7;
wire   [2:0] tmp_9_fu_1246_p9;
wire  signed [2:0] tmp_9_fu_1246_p11;
wire  signed [2:0] tmp_9_fu_1246_p13;
wire  signed [2:0] tmp_9_fu_1246_p15;
wire   [2:0] tmp_s_fu_1285_p1;
wire   [2:0] tmp_s_fu_1285_p3;
wire   [2:0] tmp_s_fu_1285_p5;
wire  signed [2:0] tmp_s_fu_1285_p7;
wire  signed [2:0] tmp_s_fu_1285_p9;
wire  signed [2:0] tmp_s_fu_1285_p11;
wire  signed [2:0] tmp_s_fu_1285_p13;
wire   [2:0] tmp_s_fu_1285_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
#0 k_fu_120 = 4'd0;
#0 j_fu_124 = 5'd0;
#0 indvar_flatten20_fu_128 = 9'd0;
#0 i_fu_132 = 5'd0;
#0 indvar_flatten35_fu_136 = 14'd0;
#0 ap_done_reg = 1'b0;
end
stencil3d_mul_32s_32s_32_2_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
mul_32s_32s_32_2_1_U42(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_776_p0),.din1(grp_fu_776_p1),.ce(1'b1),.dout(grp_fu_776_p2));
(* dissolve_hierarchy = "yes" *) stencil3d_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U43(.din0(orig_0_q0),.din1(orig_1_q0),.din2(orig_2_q0),.din3(orig_3_q0),.din4(orig_4_q0),.din5(orig_5_q0),.din6(orig_6_q0),.din7(orig_7_q0),.def(grp_fu_780_p17),.sel(grp_fu_780_p18),.dout(grp_fu_780_p19));
(* dissolve_hierarchy = "yes" *) stencil3d_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U44(.din0(orig_0_q1),.din1(orig_1_q1),.din2(orig_2_q1),.din3(orig_3_q1),.din4(orig_4_q1),.din5(orig_5_q1),.din6(orig_6_q1),.din7(orig_7_q1),.def(grp_fu_819_p17),.sel(trunc_ln38_reg_1485),.dout(grp_fu_819_p19));
...
sparsemux_17_3_32_1_1_x_U45(.din0(orig_0_q1),.din1(orig_1_q1),.din2(orig_2_q1),.din3(orig_3_q1),.din4(orig_4_q1),.din5(orig_5_q1),.din6(orig_6_q1),.din7(orig_7_q1),.def(tmp_9_fu_1246_p17),.sel(trunc_ln38_reg_1485),.dout(tmp_9_fu_1246_p19));
...
sparsemux_17_3_32_1_1_x_U46(.din0(orig_0_q1),.din1(orig_1_q1),.din2(orig_2_q1),.din3(orig_3_q1),.din4(orig_4_q1),.din5(orig_5_q1),.din6(orig_6_q1),.din7(orig_7_q1),.def(tmp_s_fu_1285_p17),.sel(trunc_ln38_reg_1485),.dout(tmp_s_fu_1285_p19));
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten20_fu_128 <= 9'd0;
    end else if (((icmp_ln36_reg_1431 == 1'd0) & (1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        indvar_flatten20_fu_128 <= select_ln37_1_fu_1179_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten35_fu_136 <= 14'd0;
    end else if (((icmp_ln36_reg_1431 == 1'd0) & (1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        indvar_flatten35_fu_136 <= add_ln36_reg_1435;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        indvar_flatten20_load_reg_1426 <= indvar_flatten20_fu_128;
        indvars_iv_next19_dup_reg_1474 <= indvars_iv_next19_dup_fu_965_p2;
        j_load_reg_1440 <= j_fu_124;
        k_2_mid2_reg_1479 <= k_2_mid2_fu_977_p3;
        select_ln11_reg_1451 <= select_ln11_fu_925_p3;
        select_ln36_reg_1463 <= select_ln36_fu_957_p3;
        tmp_reg_1493 <= k_2_mid2_fu_977_p3[32'd3];
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        empty_6_reg_1507 <= empty_6_fu_1036_p2;
        empty_7_reg_1552 <= empty_7_fu_1079_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_5_reg_1677 <= grp_fu_780_p19;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_9_reg_1762 <= tmp_9_fu_1246_p19;
        tmp_s_reg_1767 <= tmp_s_fu_1285_p19;
    end
end
always @ (*) begin
...
assign add_ln36_fu_904_p2 = (indvar_flatten35_fu_136 + 14'd1);
assign add_ln37_fu_1174_p2 = (indvar_flatten20_load_reg_1426 + 9'd1);
assign add_ln44_1_fu_1119_p4 = {{{select_ln36_reg_1463}, {select_ln37_fu_1002_p3}}, {tmp_2_fu_1111_p3}};
assign add_ln44_fu_1106_p2 = (k_2_mid2_reg_1479 + 4'd1);
assign add_ln45_1_fu_1153_p4 = {{{select_ln36_reg_1463}, {select_ln37_fu_1002_p3}}, {tmp_3_fu_1145_p3}};
assign add_ln45_fu_1140_p2 = ($signed(k_2_mid2_reg_1479) + $signed(4'd15));
assign add_ln48_1_fu_1358_p2 = (add_ln48_fu_1353_p2 + reg_858);
assign add_ln48_2_fu_1343_p2 = (tmp_9_reg_1762 + tmp_s_reg_1767);
...
assign add_ln48_fu_1353_p2 = (tmp_5_reg_1677 + reg_862);
assign add_ln4_fu_1324_p4 = {{{select_ln36_reg_1463}, {select_ln37_reg_1502}}, {tmp_reg_1493}};
assign add_ln5_fu_1048_p3 = {{empty_5_fu_1026_p2}, {tmp_reg_1493}};
assign add_ln6_fu_1209_p3 = {{empty_6_reg_1507}, {tmp_reg_1493}};
assign add_ln7_fu_1227_p4 = {{{select_ln36_reg_1463}, {empty_7_reg_1552}}, {tmp_reg_1493}};
assign add_ln8_fu_1086_p4 = {{{select_ln36_reg_1463}, {tmp4_fu_1042_p2}}, {tmp_reg_1493}};
...
assign empty_5_fu_1026_p2 = (tmp2_cast_cast_cast_fu_1022_p1 + tmp_1_fu_1007_p3);
assign empty_6_fu_1036_p2 = ($signed(tmp3_cast_fu_1032_p1) + $signed(tmp_1_fu_1007_p3));
assign empty_7_fu_1079_p3 = ((and_ln11_reg_1457[0:0] == 1'b1) ? indvars_iv_next19_mid1_fu_997_p2 : select_ln11_1_fu_1072_p3);
assign empty_fu_971_p2 = (icmp_ln37_fu_919_p2 | and_ln11_fu_945_p2);
assign grp_fu_780_p17 = 'bx;
assign grp_fu_819_p17 = 'bx;
assign icmp_ln36_fu_898_p2 = ((indvar_flatten35_fu_136 == 14'd12600) ? 1'b1 : 1'b0);
assign icmp_ln37_fu_919_p2 = ((indvar_flatten20_fu_128 == 9'd420) ? 1'b1 : 1'b0);
assign icmp_ln38_fu_939_p2 = ((k_fu_120 == 4'd15) ? 1'b1 : 1'b0);
assign indvars_iv_next1954_fu_1067_p2 = (j_load_reg_1440 + 5'd1);
assign indvars_iv_next19_dup_fu_965_p2 = (select_ln11_fu_925_p3 + 5'd1);
assign indvars_iv_next19_mid1_fu_997_p2 = (select_ln11_reg_1451 + 5'd2);
assign indvars_iv_next3347_fu_951_p2 = (i_fu_132 + 5'd1);
assign k_2_mid2_fu_977_p3 = ((empty_fu_971_p2[0:0] == 1'b1) ? 4'd1 : k_fu_120);
...
assign select_ln11_1_fu_1072_p3 = ((icmp_ln37_reg_1445[0:0] == 1'b1) ? 5'd2 : indvars_iv_next1954_fu_1067_p2);
assign select_ln11_fu_925_p3 = ((icmp_ln37_fu_919_p2[0:0] == 1'b1) ? 5'd1 : j_fu_124);
assign select_ln36_fu_957_p3 = ((icmp_ln37_fu_919_p2[0:0] == 1'b1) ? indvars_iv_next3347_fu_951_p2 : i_fu_132);
assign select_ln37_1_fu_1179_p3 = ((icmp_ln37_reg_1445[0:0] == 1'b1) ? 9'd1 : add_ln37_fu_1174_p2);
assign select_ln37_fu_1002_p3 = ((and_ln11_reg_1457[0:0] == 1'b1) ? indvars_iv_next19_dup_reg_1474 : select_ln11_reg_1451);
...
assign tmp2_cast_cast_cast_fu_1022_p1 = $unsigned(tmp2_cast_cast_fu_1014_p3);
assign tmp2_cast_cast_fu_1014_p3 = {{1'd1}, {select_ln37_fu_1002_p3}};
assign tmp3_cast_fu_1032_p1 = tmp2_cast_cast_fu_1014_p3;
assign tmp4_fu_1042_p2 = ($signed(select_ln37_fu_1002_p3) + $signed(5'd31));
assign tmp_1_fu_1007_p3 = {{select_ln36_reg_1463}, {5'd0}};
assign tmp_2_fu_1111_p3 = add_ln44_fu_1106_p2[32'd3];
assign tmp_3_fu_1145_p3 = add_ln45_fu_1140_p2[32'd3];
assign tmp_9_fu_1246_p17 = 'bx;
assign tmp_s_fu_1285_p17 = 'bx;
assign trunc_ln38_fu_985_p1 = k_2_mid2_fu_977_p3[2:0];
assign xor_ln11_fu_933_p2 = (icmp_ln37_fu_919_p2 ^ 1'd1);
assign zext_ln39_fu_1331_p1 = add_ln4_fu_1324_p4;
assign zext_ln40_fu_1055_p1 = add_ln5_fu_1048_p3;
assign zext_ln41_fu_1215_p1 = add_ln6_fu_1209_p3;
assign zext_ln42_fu_1234_p1 = add_ln7_fu_1227_p4;
assign zext_ln43_fu_1094_p1 = add_ln8_fu_1086_p4;
