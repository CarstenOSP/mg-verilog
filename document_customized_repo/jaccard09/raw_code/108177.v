module bicg_bicg_Pipeline_lpwr (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,s_out_din,s_out_full_n,s_out_write,q_out_din,q_out_full_n,q_out_write,buff_s_out_address0,buff_s_out_ce0,buff_s_out_q0,buff_s_out_1_address0,buff_s_out_1_ce0,buff_s_out_1_q0,buff_s_out_2_address0,buff_s_out_2_ce0,buff_s_out_2_q0,buff_s_out_3_address0,buff_s_out_3_ce0,buff_s_out_3_q0,buff_s_out_4_address0,buff_s_out_4_ce0,buff_s_out_4_q0,buff_s_out_5_address0,buff_s_out_5_ce0,buff_s_out_5_q0,buff_s_out_6_address0,buff_s_out_6_ce0,buff_s_out_6_q0,buff_s_out_7_address0,buff_s_out_7_ce0,buff_s_out_7_q0,buff_q_out_address0,buff_q_out_ce0,buff_q_out_q0,buff_q_out_1_address0,buff_q_out_1_ce0,buff_q_out_1_q0,buff_q_out_2_address0,buff_q_out_2_ce0,buff_q_out_2_q0,buff_q_out_3_address0,buff_q_out_3_ce0,buff_q_out_3_q0); 
...
wire   [2:0] trunc_ln35_fu_294_p1;
reg   [2:0] trunc_ln35_reg_428;
wire   [1:0] trunc_ln35_1_fu_298_p1;
reg   [1:0] trunc_ln35_1_reg_433;
wire   [31:0] tmp_s_fu_347_p19;
reg   [31:0] tmp_s_reg_498;
wire   [31:0] tmp_1_fu_386_p11;
reg   [31:0] tmp_1_reg_503;
wire   [63:0] zext_ln5_1_fu_330_p1;
wire   [63:0] zext_ln5_fu_312_p1;
reg   [6:0] i_fu_100;
wire   [6:0] add_ln35_fu_288_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i_1;
wire   [31:0] bitcast_ln36_fu_409_p1;
reg    ap_block_pp0_stage0_01001;
reg    s_out_write_local;
wire   [31:0] bitcast_ln37_fu_413_p1;
...
wire   [3:0] lshr_ln5_7_fu_302_p4;
wire   [2:0] lshr_ln5_8_fu_320_p4;
wire   [31:0] tmp_s_fu_347_p17;
wire   [31:0] tmp_1_fu_386_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_s_fu_347_p1;
wire   [2:0] tmp_s_fu_347_p3;
wire   [2:0] tmp_s_fu_347_p5;
wire   [2:0] tmp_s_fu_347_p7;
wire  signed [2:0] tmp_s_fu_347_p9;
wire  signed [2:0] tmp_s_fu_347_p11;
wire  signed [2:0] tmp_s_fu_347_p13;
wire  signed [2:0] tmp_s_fu_347_p15;
wire   [1:0] tmp_1_fu_386_p1;
wire   [1:0] tmp_1_fu_386_p3;
wire  signed [1:0] tmp_1_fu_386_p5;
wire  signed [1:0] tmp_1_fu_386_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U1016(.din0(buff_s_out_q0),.din1(buff_s_out_1_q0),.din2(buff_s_out_2_q0),.din3(buff_s_out_3_q0),.din4(buff_s_out_4_q0),.din5(buff_s_out_5_q0),.din6(buff_s_out_6_q0),.din7(buff_s_out_7_q0),.def(tmp_s_fu_347_p17),.sel(trunc_ln35_reg_428),.dout(tmp_s_fu_347_p19));
...
sparsemux_9_2_32_1_1_U1017(.din0(buff_q_out_q0),.din1(buff_q_out_1_q0),.din2(buff_q_out_2_q0),.din3(buff_q_out_3_q0),.def(tmp_1_fu_386_p9),.sel(trunc_ln35_1_reg_433),.dout(tmp_1_fu_386_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln35_fu_282_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_100 <= add_ln35_fu_288_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_503 <= tmp_1_fu_386_p11;
        tmp_s_reg_498 <= tmp_s_fu_347_p19;
        trunc_ln35_1_reg_433 <= trunc_ln35_1_fu_298_p1;
        trunc_ln35_reg_428 <= trunc_ln35_fu_294_p1;
    end
end
always @ (*) begin
    if (((icmp_ln35_fu_282_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln35_fu_288_p2 = (ap_sig_allocacmp_i_1 + 7'd1);
...
assign bitcast_ln36_fu_409_p1 = tmp_s_reg_498;
assign bitcast_ln37_fu_413_p1 = tmp_1_reg_503;
assign buff_q_out_1_address0 = zext_ln5_fu_312_p1;
assign buff_q_out_1_ce0 = buff_q_out_1_ce0_local;
assign buff_q_out_2_address0 = zext_ln5_fu_312_p1;
assign buff_q_out_2_ce0 = buff_q_out_2_ce0_local;
assign buff_q_out_3_address0 = zext_ln5_fu_312_p1;
assign buff_q_out_3_ce0 = buff_q_out_3_ce0_local;
assign buff_q_out_address0 = zext_ln5_fu_312_p1;
assign buff_q_out_ce0 = buff_q_out_ce0_local;
assign buff_s_out_1_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_1_ce0 = buff_s_out_1_ce0_local;
assign buff_s_out_2_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_2_ce0 = buff_s_out_2_ce0_local;
assign buff_s_out_3_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_3_ce0 = buff_s_out_3_ce0_local;
assign buff_s_out_4_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_4_ce0 = buff_s_out_4_ce0_local;
assign buff_s_out_5_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_5_ce0 = buff_s_out_5_ce0_local;
assign buff_s_out_6_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_6_ce0 = buff_s_out_6_ce0_local;
assign buff_s_out_7_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_7_ce0 = buff_s_out_7_ce0_local;
assign buff_s_out_address0 = zext_ln5_1_fu_330_p1;
assign buff_s_out_ce0 = buff_s_out_ce0_local;
assign icmp_ln35_fu_282_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_7_fu_302_p4 = {{ap_sig_allocacmp_i_1[5:2]}};
assign lshr_ln5_8_fu_320_p4 = {{ap_sig_allocacmp_i_1[5:3]}};
assign q_out_din = bitcast_ln37_fu_413_p1;
assign q_out_write = q_out_write_local;
assign s_out_din = bitcast_ln36_fu_409_p1;
assign s_out_write = s_out_write_local;
assign tmp_1_fu_386_p9 = 'bx;
assign tmp_s_fu_347_p17 = 'bx;
assign trunc_ln35_1_fu_298_p1 = ap_sig_allocacmp_i_1[1:0];
assign trunc_ln35_fu_294_p1 = ap_sig_allocacmp_i_1[2:0];
assign zext_ln5_1_fu_330_p1 = lshr_ln5_8_fu_320_p4;
assign zext_ln5_fu_312_p1 = lshr_ln5_7_fu_302_p4;
endmodule 