...
reg   [8:0] bucket_0_addr_9_reg_563;
reg   [8:0] bucket_1_addr_9_reg_568;
reg   [8:0] bucket_2_addr_9_reg_573;
reg   [8:0] bucket_3_addr_9_reg_578;
wire   [31:0] tmp_5_fu_369_p11;
reg   [31:0] tmp_5_reg_583;
...
reg   [31:0] bucket_0_load_9_reg_623;
reg   [31:0] bucket_1_load_9_reg_628;
reg   [31:0] bucket_2_load_9_reg_633;
reg   [31:0] bucket_3_load_9_reg_638;
reg   [8:0] bucket_0_addr_10_reg_643;
reg   [8:0] bucket_1_addr_10_reg_648;
reg   [8:0] bucket_2_addr_10_reg_653;
reg   [8:0] bucket_3_addr_10_reg_658;
reg   [8:0] bucket_0_addr_11_reg_663;
reg   [8:0] bucket_1_addr_11_reg_668;
reg   [8:0] bucket_2_addr_11_reg_673;
reg   [8:0] bucket_3_addr_11_reg_678;
...
wire   [8:0] p_udiv3_fu_332_p3;
wire   [8:0] or_ln_fu_348_p3;
wire   [31:0] tmp_5_fu_369_p9;
...
wire   [1:0] tmp_5_fu_369_p3;
wire  signed [1:0] tmp_5_fu_369_p5;
wire  signed [1:0] tmp_5_fu_369_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 4'd1;
...
sparsemux_9_2_32_1_1_x_U40(.din0(sum_0_q0),.din1(sum_1_q0),.din2(sum_2_q0),.din3(sum_3_q0),.def(tmp_5_fu_369_p9),.sel(trunc_ln34_reg_512),.dout(tmp_5_fu_369_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        bucket_0_addr_10_reg_643[8 : 2] <= zext_ln37_2_fu_399_p1[8 : 2];
        bucket_0_addr_11_reg_663[8 : 2] <= zext_ln37_3_fu_414_p1[8 : 2];
        bucket_0_load_9_reg_623 <= bucket_0_q0;
        bucket_0_load_reg_603 <= bucket_0_q1;
        bucket_1_addr_10_reg_648[8 : 2] <= zext_ln37_2_fu_399_p1[8 : 2];
        bucket_1_addr_11_reg_668[8 : 2] <= zext_ln37_3_fu_414_p1[8 : 2];
        bucket_1_load_9_reg_628 <= bucket_1_q0;
        bucket_1_load_reg_608 <= bucket_1_q1;
        bucket_2_addr_10_reg_653[8 : 2] <= zext_ln37_2_fu_399_p1[8 : 2];
        bucket_2_addr_11_reg_673[8 : 2] <= zext_ln37_3_fu_414_p1[8 : 2];
        bucket_2_load_9_reg_633 <= bucket_2_q0;
        bucket_2_load_reg_613 <= bucket_2_q1;
        bucket_3_addr_10_reg_658[8 : 2] <= zext_ln37_2_fu_399_p1[8 : 2];
        bucket_3_addr_11_reg_678[8 : 2] <= zext_ln37_3_fu_414_p1[8 : 2];
        bucket_3_load_9_reg_638 <= bucket_3_q0;
        bucket_3_load_reg_618 <= bucket_3_q1;
        tmp_5_reg_583 <= tmp_5_fu_369_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        bucket_0_addr_9_reg_563[8 : 2] <= zext_ln37_1_fu_356_p1[8 : 2];
        bucket_0_addr_reg_543[8 : 2] <= zext_ln37_fu_340_p1[8 : 2];
        bucket_1_addr_9_reg_568[8 : 2] <= zext_ln37_1_fu_356_p1[8 : 2];
        bucket_1_addr_reg_548[8 : 2] <= zext_ln37_fu_340_p1[8 : 2];
        bucket_2_addr_9_reg_573[8 : 2] <= zext_ln37_1_fu_356_p1[8 : 2];
        bucket_2_addr_reg_553[8 : 2] <= zext_ln37_fu_340_p1[8 : 2];
        bucket_3_addr_9_reg_578[8 : 2] <= zext_ln37_1_fu_356_p1[8 : 2];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_0_address0_local = bucket_0_addr_11_reg_663;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_0_address0_local = bucket_0_addr_9_reg_563;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_0_address1_local = bucket_0_addr_10_reg_643;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_1_address0_local = bucket_1_addr_11_reg_668;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_1_address0_local = bucket_1_addr_9_reg_568;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_1_address1_local = bucket_1_addr_10_reg_648;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_2_address0_local = bucket_2_addr_11_reg_673;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_2_address0_local = bucket_2_addr_9_reg_573;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_2_address1_local = bucket_2_addr_10_reg_653;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_3_address0_local = bucket_3_addr_11_reg_678;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        bucket_3_address0_local = bucket_3_addr_9_reg_578;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        bucket_3_address1_local = bucket_3_addr_10_reg_658;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
...
assign add_ln37_10_fu_472_p2 = (bucket_2_q1 + tmp_5_reg_583);
assign add_ln37_11_fu_477_p2 = (bucket_3_q1 + tmp_5_reg_583);
assign add_ln37_12_fu_482_p2 = (bucket_0_q0 + tmp_5_reg_583);
assign add_ln37_13_fu_487_p2 = (bucket_1_q0 + tmp_5_reg_583);
assign add_ln37_14_fu_492_p2 = (bucket_2_q0 + tmp_5_reg_583);
assign add_ln37_15_fu_497_p2 = (bucket_3_q0 + tmp_5_reg_583);
assign add_ln37_1_fu_427_p2 = (bucket_1_load_reg_608 + tmp_5_reg_583);
assign add_ln37_2_fu_432_p2 = (bucket_2_load_reg_613 + tmp_5_reg_583);
assign add_ln37_3_fu_437_p2 = (bucket_3_load_reg_618 + tmp_5_reg_583);
assign add_ln37_4_fu_442_p2 = (bucket_0_load_9_reg_623 + tmp_5_reg_583);
assign add_ln37_5_fu_447_p2 = (bucket_1_load_9_reg_628 + tmp_5_reg_583);
assign add_ln37_6_fu_452_p2 = (bucket_2_load_9_reg_633 + tmp_5_reg_583);
assign add_ln37_7_fu_457_p2 = (bucket_3_load_9_reg_638 + tmp_5_reg_583);
assign add_ln37_8_fu_462_p2 = (bucket_0_q1 + tmp_5_reg_583);
assign add_ln37_9_fu_467_p2 = (bucket_1_q1 + tmp_5_reg_583);
assign add_ln37_fu_422_p2 = (bucket_0_load_reg_603 + tmp_5_reg_583);
...
assign p_udiv3_fu_332_p3 = {{empty_fu_328_p1}, {2'd0}};
...
assign zext_ln37_fu_340_p1 = p_udiv3_fu_332_p3;
always @ (posedge ap_clk) begin
    ...
    bucket_0_addr_9_reg_563[1:0] <= 2'b01;
    bucket_1_addr_9_reg_568[1:0] <= 2'b01;
    bucket_2_addr_9_reg_573[1:0] <= 2'b01;
    bucket_3_addr_9_reg_578[1:0] <= 2'b01;
    bucket_0_addr_10_reg_643[1:0] <= 2'b10;
    bucket_1_addr_10_reg_648[1:0] <= 2'b10;
    bucket_2_addr_10_reg_653[1:0] <= 2'b10;
    bucket_3_addr_10_reg_658[1:0] <= 2'b10;
    bucket_0_addr_11_reg_663[1:0] <= 2'b11;
    bucket_1_addr_11_reg_668[1:0] <= 2'b11;
    bucket_2_addr_11_reg_673[1:0] <= 2'b11;
    bucket_3_addr_11_reg_678[1:0] <= 2'b11;
end
endmodule 