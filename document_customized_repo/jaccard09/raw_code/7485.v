module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,temp_81,temp_80,C,C_86,C_85,W_address0,W_ce0,W_q0,W_2_address0,W_2_ce0,W_2_q0,W_4_address0,W_4_ce0,W_4_q0,W_6_address0,W_6_ce0,W_6_q0,W_8_address0,W_8_ce0,W_8_q0,W_10_address0,W_10_ce0,W_10_q0,W_12_address0,W_12_ce0,W_12_q0,W_14_address0,W_14_ce0,W_14_q0,W_1_address0,W_1_ce0,W_1_q0,W_3_address0,W_3_ce0,W_3_q0,W_5_address0,W_5_ce0,W_5_q0,W_7_address0,W_7_ce0,W_7_q0,W_9_address0,W_9_ce0,W_9_q0,W_11_address0,W_11_ce0,W_11_q0,W_13_address0,W_13_ce0,W_13_q0,W_15_address0,W_15_ce0,W_15_q0,A_out,A_out_ap_vld,B_42_out,B_42_out_ap_vld,E_47_out,E_47_out_ap_vld,D_out,D_out_ap_vld,E_28_out,E_28_out_ap_vld); 
...
sparsemux_17_4_32_1_1_U42(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.din4(W_8_q0),.din5(W_10_q0),.din6(W_12_q0),.din7(W_14_q0),.def(tmp_s_fu_497_p17),.sel(trunc_ln100_fu_494_p1),.dout(tmp_s_fu_497_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h2 ),.din1_WIDTH( 32 ),.CASE2( 4'h4 ),.din2_WIDTH( 32 ),.CASE3( 4'h6 ),.din3_WIDTH( 32 ),.CASE4( 4'h8 ),.din4_WIDTH( 32 ),.CASE5( 4'hA ),.din5_WIDTH( 32 ),.CASE6( 4'hC ),.din6_WIDTH( 32 ),.CASE7( 4'hE ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_17_4_32_1_1_U43(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.din4(W_9_q0),.din5(W_11_q0),.din6(W_13_q0),.din7(W_15_q0),.def(tmp_2_fu_537_p17),.sel(trunc_ln100_fu_494_p1),.dout(tmp_2_fu_537_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_1_fu_140 <= add_ln124_fu_736_p2;
    end
end
always @ (posedge ap_clk) begin
...
assign A_out = B_3_fu_136;
assign B_42_out = B_fu_132;
assign B_5_fu_650_p2 = (add_ln126_fu_644_p2 + add_ln126_2_fu_638_p2);
assign C_6_fu_728_p3 = {{trunc_ln126_3_fu_714_p1}, {lshr_ln126_3_fu_718_p4}};
assign D_4_fu_670_p3 = {{trunc_ln126_1_fu_656_p1}, {lshr_ln126_1_fu_660_p4}};
assign D_out = E_4_fu_128;
assign E_28_out = E_fu_124;
assign E_47_out = D_fu_144;
...
assign add_ln124_fu_736_p2 = (i_reg_857 + 6'd2);
...
assign icmp_ln124_fu_454_p2 = ((ap_sig_allocacmp_i < 6'd60) ? 1'b1 : 1'b0);
assign lshr_ln126_1_fu_660_p4 = {{B_fu_132[31:2]}};
assign lshr_ln126_3_fu_718_p4 = {{B_3_fu_136[31:2]}};
assign lshr_ln5_fu_460_p4 = {{ap_sig_allocacmp_i[5:4]}};
assign lshr_ln6_fu_593_p4 = {{B_3_fu_136[31:27]}};
assign or_ln126_1_fu_619_p2 = (and_ln126_fu_608_p2 | and_ln126_1_fu_614_p2);
assign or_ln126_2_fu_625_p3 = {{trunc_ln126_fu_589_p1}, {lshr_ln6_fu_593_p4}};
...
assign trunc_ln100_fu_494_p1 = i_reg_857[3:0];
...
assign zext_ln100_fu_470_p1 = lshr_ln5_fu_460_p4;
endmodule 