...
wire   [31:0] tmp_1_fu_699_p19;
reg   [31:0] tmp_1_reg_1087;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
wire   [31:0] tmp_2_fu_759_p11;
reg   [31:0] tmp_2_reg_1132;
wire   [31:0] tmp_4_fu_813_p11;
reg   [31:0] tmp_4_reg_1177;
wire   [31:0] tmp_s_fu_837_p19;
reg   [31:0] tmp_s_reg_1182;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [31:0] tmp_3_fu_876_p19;
reg   [31:0] tmp_3_reg_1187;
reg   [31:0] mul1_reg_1192;
wire    ap_block_pp0_stage6_11001;
wire    ap_CS_fsm_pp0_stage7;
wire    ap_block_pp0_stage7_11001;
reg   [31:0] mul65_1_reg_1202;
reg   [0:0] tmp_6_reg_1207;
...
reg   [11:0] indvar_flatten9_fu_128;
...
wire   [2:0] lshr_ln6_6_fu_667_p4;
wire   [31:0] tmp_1_fu_699_p17;
wire   [8:0] tmp_8_fu_738_p3;
wire   [31:0] tmp_2_fu_759_p9;
wire   [2:0] trunc_ln30_fu_756_p1;
wire   [4:0] tmp_9_fu_783_p4;
wire   [8:0] tmp_5_fu_792_p4;
wire   [31:0] tmp_4_fu_813_p9;
wire   [31:0] tmp_s_fu_837_p17;
wire    ap_block_pp0_stage2;
wire   [31:0] tmp_3_fu_876_p17;
reg    ap_done_reg;
...
wire   [2:0] tmp_1_fu_699_p1;
wire   [2:0] tmp_1_fu_699_p3;
wire   [2:0] tmp_1_fu_699_p5;
wire   [2:0] tmp_1_fu_699_p7;
wire  signed [2:0] tmp_1_fu_699_p9;
wire  signed [2:0] tmp_1_fu_699_p11;
wire  signed [2:0] tmp_1_fu_699_p13;
wire  signed [2:0] tmp_1_fu_699_p15;
wire   [2:0] tmp_2_fu_759_p1;
wire   [2:0] tmp_2_fu_759_p3;
wire  signed [2:0] tmp_2_fu_759_p5;
wire  signed [2:0] tmp_2_fu_759_p7;
wire   [2:0] tmp_4_fu_813_p1;
wire   [2:0] tmp_4_fu_813_p3;
wire  signed [2:0] tmp_4_fu_813_p5;
wire  signed [2:0] tmp_4_fu_813_p7;
wire   [2:0] tmp_s_fu_837_p1;
wire   [2:0] tmp_s_fu_837_p3;
wire   [2:0] tmp_s_fu_837_p5;
wire   [2:0] tmp_s_fu_837_p7;
wire  signed [2:0] tmp_s_fu_837_p9;
wire  signed [2:0] tmp_s_fu_837_p11;
wire  signed [2:0] tmp_s_fu_837_p13;
wire  signed [2:0] tmp_s_fu_837_p15;
wire   [2:0] tmp_3_fu_876_p1;
wire   [2:0] tmp_3_fu_876_p3;
wire   [2:0] tmp_3_fu_876_p5;
wire   [2:0] tmp_3_fu_876_p7;
wire  signed [2:0] tmp_3_fu_876_p9;
wire  signed [2:0] tmp_3_fu_876_p11;
wire  signed [2:0] tmp_3_fu_876_p13;
wire  signed [2:0] tmp_3_fu_876_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 15'd1;
...
#0 j_fu_120 = 7'd0;
#0 i_fu_124 = 7'd0;
#0 indvar_flatten9_fu_128 = 12'd0;
#0 empty_fu_132 = 32'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U48(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.din4(buff_x2_4_q0),.din5(buff_x2_5_q0),.din6(buff_x2_6_q0),.din7(buff_x2_7_q0),.def(tmp_1_fu_699_p17),.sel(trunc_ln29_1_reg_994),.dout(tmp_1_fu_699_p19));
...
sparsemux_9_3_32_1_1_U49(.din0(buff_y2_q0),.din1(buff_y2_2_q0),.din2(buff_y2_4_q0),.din3(buff_y2_6_q0),.def(tmp_2_fu_759_p9),.sel(trunc_ln30_fu_756_p1),.dout(tmp_2_fu_759_p11));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U50(.din0(buff_y2_1_q0),.din1(buff_y2_3_q0),.din2(buff_y2_5_q0),.din3(buff_y2_7_q0),.def(tmp_4_fu_813_p9),.sel(trunc_ln30_fu_756_p1),.dout(tmp_4_fu_813_p11));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U51(.din0(buff_A_q1),.din1(buff_A_1_q1),.din2(buff_A_2_q1),.din3(buff_A_3_q1),.din4(buff_A_4_q1),.din5(buff_A_5_q1),.din6(buff_A_6_q1),.din7(buff_A_7_q1),.def(tmp_s_fu_837_p17),.sel(trunc_ln29_1_reg_994),.dout(tmp_s_fu_837_p19));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U52(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.din4(buff_A_4_q0),.din5(buff_A_5_q0),.din6(buff_A_6_q0),.din7(buff_A_7_q0),.def(tmp_3_fu_876_p17),.sel(trunc_ln29_1_reg_994),.dout(tmp_3_fu_876_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln29_fu_583_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln29_fu_583_p2 == 1'd0))) begin
            indvar_flatten9_fu_128 <= add_ln29_1_fu_589_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten9_fu_128 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        first_iter_1_reg_990 <= first_iter_1_fu_635_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul1_reg_1192 <= grp_fu_975_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul65_1_reg_1202 <= grp_fu_975_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5)) | ((1'b0 == ap_block_pp0_stage13_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage13)))) begin
        reg_552 <= grp_fu_971_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_1_reg_1087 <= tmp_1_fu_699_p19;
        tmp_2_reg_1132 <= tmp_2_fu_759_p11;
        tmp_4_reg_1177 <= tmp_4_fu_813_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_3_reg_1187 <= tmp_3_fu_876_p19;
        tmp_s_reg_1182 <= tmp_s_fu_837_p19;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage14_11001) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        tmp_6_reg_1207 <= add_ln30_fu_923_p2[32'd6];
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten9_load = indvar_flatten9_fu_128;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd2) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd3) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd4) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd5) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd7) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (tmp_6_reg_1207 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_994_pp0_iter1_reg == 3'd0) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_548_p0 = tmp_3_reg_1187;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_548_p0 = tmp_s_reg_1182;
        end else begin
            grp_fu_548_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_548_p1 = tmp_4_reg_1177;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_548_p1 = tmp_2_reg_1132;
        end else begin
            grp_fu_548_p1 = 'bx;
        end
    end else begin
...
assign add_ln29_1_fu_589_p2 = (ap_sig_allocacmp_indvar_flatten9_load + 12'd1);
...
always @ (*) begin
    ap_condition_977 = ((icmp_ln29_reg_974 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_990 == 1'd1));
end
...
assign first_iter_1_fu_635_p2 = ((select_ln6_fu_615_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_971_p_ce = 1'b1;
assign grp_fu_971_p_din0 = grp_fu_544_p0;
assign grp_fu_971_p_din1 = grp_fu_544_p1;
assign grp_fu_971_p_opcode = 2'd0;
assign grp_fu_975_p_ce = 1'b1;
assign grp_fu_975_p_din0 = grp_fu_548_p0;
assign grp_fu_975_p_din1 = grp_fu_548_p1;
assign icmp_ln29_fu_583_p2 = ((ap_sig_allocacmp_indvar_flatten9_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_2_fu_645_p4 = {{select_ln29_fu_627_p3[5:3]}};
assign lshr_ln6_6_fu_667_p4 = {{select_ln6_fu_615_p3[5:3]}};
assign select_ln29_fu_627_p3 = ((tmp_fu_607_p3[0:0] == 1'b1) ? add_ln29_fu_601_p2 : ap_sig_allocacmp_i_load);
assign select_ln6_fu_615_p3 = ((tmp_fu_607_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp_1_fu_699_p17 = 'bx;
assign tmp_2_fu_759_p9 = 'bx;
assign tmp_3_fu_876_p17 = 'bx;
assign tmp_4_fu_813_p9 = 'bx;
assign tmp_5_fu_792_p4 = {{{tmp_9_fu_783_p4}, {1'd1}}, {lshr_ln6_2_reg_1001}};
assign tmp_8_fu_738_p3 = {{trunc_ln29_reg_985}, {lshr_ln6_2_reg_1001}};
assign tmp_9_fu_783_p4 = {{select_ln6_reg_978[5:1]}};
assign tmp_fu_607_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_s_fu_837_p17 = 'bx;
...
assign zext_ln31_1_fu_801_p1 = tmp_5_fu_792_p4;
assign zext_ln31_fu_744_p1 = tmp_8_fu_738_p3;
assign zext_ln6_1_fu_677_p1 = lshr_ln6_6_fu_667_p4;
