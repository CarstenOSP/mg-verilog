...
wire   [63:0] zext_ln58_fu_251_p1;
reg   [6:0] j_fu_66;
wire   [6:0] add_ln57_fu_259_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_70;
wire   [6:0] select_ln56_fu_221_p3;
reg   [10:0] indvar_flatten44_fu_74;
wire   [10:0] add_ln56_1_fu_182_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten44_load;
wire   [31:0] bitcast_ln58_fu_275_p1;
reg    ap_block_pp0_stage0_01001;
reg    E_out_0_write_local;
wire   [31:0] bitcast_ln58_1_fu_280_p1;
reg    E_out_1_write_local;
wire   [31:0] bitcast_ln58_2_fu_285_p1;
reg    E_out_2_write_local;
wire   [31:0] bitcast_ln58_3_fu_290_p1;
...
wire   [6:0] add_ln56_fu_199_p2;
wire   [6:0] select_ln10_fu_213_p3;
wire   [5:0] trunc_ln7_fu_229_p1;
wire   [3:0] lshr_ln10_5_fu_233_p4;
...
#0 j_fu_66 = 7'd0;
#0 i_fu_70 = 7'd0;
#0 indvar_flatten44_fu_74 = 11'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_fu_70 <= select_ln56_fu_221_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln56_fu_176_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten44_fu_74 <= add_ln56_1_fu_182_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten44_fu_74 <= 11'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((icmp_ln56_fu_176_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign E_out_0_din = bitcast_ln58_fu_275_p1;
assign E_out_0_write = E_out_0_write_local;
assign E_out_1_din = bitcast_ln58_1_fu_280_p1;
assign E_out_1_write = E_out_1_write_local;
assign E_out_2_din = bitcast_ln58_2_fu_285_p1;
assign E_out_2_write = E_out_2_write_local;
assign E_out_3_din = bitcast_ln58_3_fu_290_p1;
assign E_out_3_write = E_out_3_write_local;
assign add_ln56_1_fu_182_p2 = (ap_sig_allocacmp_indvar_flatten44_load + 11'd1);
assign add_ln56_fu_199_p2 = (i_fu_70 + 7'd1);
assign add_ln57_fu_259_p2 = (select_ln10_fu_213_p3 + 7'd4);
...
assign bitcast_ln58_1_fu_280_p1 = buff_E_out_1_q0;
assign bitcast_ln58_2_fu_285_p1 = buff_E_out_2_q0;
assign bitcast_ln58_3_fu_290_p1 = buff_E_out_3_q0;
assign bitcast_ln58_fu_275_p1 = buff_E_out_q0;
assign buff_E_out_1_address0 = zext_ln58_fu_251_p1;
assign buff_E_out_1_ce0 = buff_E_out_1_ce0_local;
assign buff_E_out_2_address0 = zext_ln58_fu_251_p1;
assign buff_E_out_2_ce0 = buff_E_out_2_ce0_local;
assign buff_E_out_3_address0 = zext_ln58_fu_251_p1;
assign buff_E_out_3_ce0 = buff_E_out_3_ce0_local;
assign buff_E_out_address0 = zext_ln58_fu_251_p1;
assign buff_E_out_ce0 = buff_E_out_ce0_local;
assign icmp_ln56_fu_176_p2 = ((ap_sig_allocacmp_indvar_flatten44_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln10_5_fu_233_p4 = {{select_ln10_fu_213_p3[5:2]}};
assign select_ln10_fu_213_p3 = ((tmp_fu_205_p3[0:0] == 1'b1) ? 7'd0 : j_fu_66);
assign select_ln56_fu_221_p3 = ((tmp_fu_205_p3[0:0] == 1'b1) ? add_ln56_fu_199_p2 : i_fu_70);
assign tmp_fu_205_p3 = j_fu_66[32'd6];
assign tmp_s_fu_243_p3 = {{trunc_ln7_fu_229_p1}, {lshr_ln10_5_fu_233_p4}};
assign trunc_ln7_fu_229_p1 = select_ln56_fu_221_p3[5:0];
assign zext_ln58_fu_251_p1 = tmp_s_fu_243_p3;
endmodule 