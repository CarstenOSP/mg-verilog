...
fadd_32ns_32ns_32_7_full_dsp_1_U45(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_1_load_reg_783),.din1(mul74_1_reg_748),.ce(1'b1),.dout(grp_fu_340_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U46(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_2_load_reg_788),.din1(mul74_2_reg_753),.ce(1'b1),.dout(grp_fu_344_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U47(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_3_load_reg_793),.din1(mul74_3_reg_758),.ce(1'b1),.dout(grp_fu_348_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U48(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_4_load_reg_798),.din1(mul74_4_reg_763),.ce(1'b1),.dout(grp_fu_352_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U49(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_5_load_reg_803),.din1(mul74_5_reg_768),.ce(1'b1),.dout(grp_fu_356_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U50(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_6_load_reg_808),.din1(mul74_6_reg_773),.ce(1'b1),.dout(grp_fu_360_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U51(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_7_load_reg_813),.din1(mul74_7_reg_778),.ce(1'b1),.dout(grp_fu_364_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U53(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_1_load_reg_655),.din1(beta),.ce(1'b1),.dout(grp_fu_372_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U54(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_2_load_reg_660),.din1(beta),.ce(1'b1),.dout(grp_fu_376_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U55(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_3_load_reg_665),.din1(beta),.ce(1'b1),.dout(grp_fu_380_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U56(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_load_1_reg_670),.din1(beta),.ce(1'b1),.dout(grp_fu_384_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U57(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_1_load_1_reg_675),.din1(beta),.ce(1'b1),.dout(grp_fu_388_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U58(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_2_load_1_reg_680),.din1(beta),.ce(1'b1),.dout(grp_fu_392_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U59(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_3_load_1_reg_685),.din1(beta),.ce(1'b1),.dout(grp_fu_396_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_818 <= grp_fu_248_p_dout0;
        ...
        mul1_reg_738 <= grp_fu_252_p_dout0;
...
assign grp_fu_248_p_din0 = buff_C_out_load_reg_743;
assign grp_fu_248_p_din1 = mul1_reg_738;
assign grp_fu_248_p_opcode = 2'd0;
assign grp_fu_252_p_ce = 1'b1;
assign grp_fu_252_p_din0 = buff_B_load_reg_650;
...
assign tmp_1_fu_495_p3 = {{trunc_ln5_fu_471_p1}, {lshr_ln5_4_fu_485_p4}};
assign tmp_2_fu_511_p4 = {{{trunc_ln5_fu_471_p1}, {lshr_ln5_3_fu_475_p4}}, {1'd1}};
assign tmp_fu_447_p3 = j_fu_82[32'd6];
assign tmp_s_fu_545_p3 = {{trunc_ln5_reg_600_pp0_iter4_reg}, {lshr_ln5_3_reg_605_pp0_iter4_reg}};
