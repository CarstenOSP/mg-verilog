module backprop_backprop_Pipeline_label_35 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v8_address0,v8_ce0,v8_q0,v4_address0,v4_ce0,v4_we0,v4_d0,v4_q0,v194_out,v194_out_ap_vld); 
...
dadddsub_64ns_64ns_64_8_full_dsp_1_U397(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_82_p0),.din1(grp_fu_82_p1),.opcode(grp_fu_82_opcode),.ce(1'b1),.dout(grp_fu_82_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U398(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_86_p0),.din1(grp_fu_86_p1),.ce(1'b1),.dout(grp_fu_86_p2));
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ap_sig_allocacmp_v192_load_1 = grp_fu_82_p2;
    end else begin
