module k2mm_k2mm_Pipeline_lp7_lp8 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_D_address0,buff_D_ce0,buff_D_q0,buff_D_address1,buff_D_ce1,buff_D_q1,buff_D_1_address0,buff_D_1_ce0,buff_D_1_q0,buff_D_1_address1,buff_D_1_ce1,buff_D_1_q1,buff_E_out_address0,buff_E_out_ce0,buff_E_out_we0,buff_E_out_d0,buff_E_out_address1,buff_E_out_ce1,buff_E_out_we1,buff_E_out_d1,buff_E_out_1_address0,buff_E_out_1_ce0,buff_E_out_1_we0,buff_E_out_1_d0,buff_E_out_1_address1,buff_E_out_1_ce1,buff_E_out_1_we1,buff_E_out_1_d1,tmp2_address0,tmp2_ce0,tmp2_q0,tmp2_address1,tmp2_ce1,tmp2_q1,tmp2_1_address0,tmp2_1_ce0,tmp2_1_q0,tmp2_1_address1,tmp2_1_ce1,tmp2_1_q1,beta,grp_fu_1168_p_din0,grp_fu_1168_p_din1,grp_fu_1168_p_opcode,grp_fu_1168_p_dout0,grp_fu_1168_p_ce,grp_fu_1176_p_din0,grp_fu_1176_p_din1,grp_fu_1176_p_opcode,grp_fu_1176_p_dout0,grp_fu_1176_p_ce,grp_fu_1180_p_din0,grp_fu_1180_p_din1,grp_fu_1180_p_opcode,grp_fu_1180_p_dout0,grp_fu_1180_p_ce,grp_fu_1184_p_din0,grp_fu_1184_p_din1,grp_fu_1184_p_opcode,grp_fu_1184_p_dout0,grp_fu_1184_p_ce,grp_fu_1172_p_din0,grp_fu_1172_p_din1,grp_fu_1172_p_dout0,grp_fu_1172_p_ce,grp_fu_1188_p_din0,grp_fu_1188_p_din1,grp_fu_1188_p_dout0,grp_fu_1188_p_ce,grp_fu_1192_p_din0,grp_fu_1192_p_din1,grp_fu_1192_p_dout0,grp_fu_1192_p_ce,grp_fu_1196_p_din0,grp_fu_1196_p_din1,grp_fu_1196_p_dout0,grp_fu_1196_p_ce); 
...
reg   [31:0] mux_case_031_reg_516;
reg   [31:0] mul3_reg_521;
reg   [31:0] tmp2_1_load_reg_526;
reg   [31:0] mux_case_034_reg_531;
...
reg   [10:0] indvar_flatten547_fu_74;
wire   [10:0] add_ln43_1_fu_290_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten547_load;
...
wire   [4:0] lshr_ln6_5_fu_341_p4;
wire   [10:0] tmp_s_fu_351_p3;
wire   [3:0] tmp_1_fu_365_p4;
wire   [10:0] tmp_2_fu_375_p4;
reg    ap_done_reg;
...
#0 j_fu_66 = 7'd0;
#0 i_fu_70 = 7'd0;
#0 indvar_flatten547_fu_74 = 11'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln43_fu_284_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten547_fu_74 <= add_ln43_1_fu_290_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten547_fu_74 <= 11'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add127_1_reg_561 <= grp_fu_1176_p_dout0;
        add127_2_reg_566 <= grp_fu_1180_p_dout0;
        add127_3_reg_571 <= grp_fu_1184_p_dout0;
        add2_reg_556 <= grp_fu_1168_p_dout0;
        ...
        mul126_1_reg_541 <= grp_fu_1188_p_dout0;
        mul126_2_reg_546 <= grp_fu_1192_p_dout0;
        mul126_3_reg_551 <= grp_fu_1196_p_dout0;
        mul3_reg_521 <= grp_fu_1172_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1))) begin
        mux_case_031_reg_516 <= tmp2_q1;
        mux_case_034_reg_531 <= tmp2_q0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten547_load = 11'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten547_load = indvar_flatten547_fu_74;
    end
end
always @ (*) begin
...
assign add_ln43_1_fu_290_p2 = (ap_sig_allocacmp_indvar_flatten547_load + 11'd1);
...
assign grp_fu_1168_p_din0 = mux_case_031_reg_516;
assign grp_fu_1168_p_din1 = mul3_reg_521;
assign grp_fu_1168_p_opcode = 2'd0;
assign grp_fu_1172_p_ce = 1'b1;
assign grp_fu_1172_p_din0 = buff_D_load_reg_476;
assign grp_fu_1172_p_din1 = beta;
assign grp_fu_1176_p_ce = 1'b1;
assign grp_fu_1176_p_din0 = tmp2_1_load_reg_526;
assign grp_fu_1176_p_din1 = mul126_1_reg_541;
assign grp_fu_1176_p_opcode = 2'd0;
assign grp_fu_1180_p_ce = 1'b1;
assign grp_fu_1180_p_din0 = mux_case_034_reg_531;
assign grp_fu_1180_p_din1 = mul126_2_reg_546;
assign grp_fu_1180_p_opcode = 2'd0;
assign grp_fu_1184_p_ce = 1'b1;
assign grp_fu_1184_p_din0 = tmp2_1_load_1_reg_536;
assign grp_fu_1184_p_din1 = mul126_3_reg_551;
assign grp_fu_1184_p_opcode = 2'd0;
assign grp_fu_1188_p_ce = 1'b1;
assign grp_fu_1188_p_din0 = buff_D_1_load_reg_481;
assign grp_fu_1188_p_din1 = beta;
assign grp_fu_1192_p_ce = 1'b1;
assign grp_fu_1192_p_din0 = buff_D_load_1_reg_486;
assign grp_fu_1192_p_din1 = beta;
assign grp_fu_1196_p_ce = 1'b1;
assign grp_fu_1196_p_din0 = buff_D_1_load_1_reg_491;
assign grp_fu_1196_p_din1 = beta;
assign icmp_ln43_fu_284_p2 = ((ap_sig_allocacmp_indvar_flatten547_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln6_5_fu_341_p4 = {{select_ln6_fu_321_p3[5:1]}};
...
assign tmp_1_fu_365_p4 = {{select_ln6_fu_321_p3[5:2]}};
assign tmp_2_fu_375_p4 = {{{trunc_ln6_fu_337_p1}, {tmp_1_fu_365_p4}}, {1'd1}};
assign tmp_fu_313_p3 = j_fu_66[32'd6];
assign tmp_s_fu_351_p3 = {{trunc_ln6_fu_337_p1}, {lshr_ln6_5_fu_341_p4}};
assign trunc_ln6_fu_337_p1 = select_ln43_fu_329_p3[5:0];
assign zext_ln45_1_fu_385_p1 = tmp_2_fu_375_p4;
assign zext_ln45_fu_359_p1 = tmp_s_fu_351_p3;
always @ (posedge ap_clk) begin
