...
wire   [63:0] p_cast10_fu_321_p1;
wire   [63:0] p_cast9_fu_310_p1;
...
wire   [30:0] tmp_s_fu_453_p4;
wire   [23:0] tmp_19_fu_472_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_needwun_Pipeline_pad_a_fu_224_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln83_reg_563 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        empty_24_reg_544 <= empty_24_fu_355_p2;
        empty_25_reg_549 <= empty_25_fu_368_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        empty_23_reg_523 <= empty_23_fu_315_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        SEQB_address0 = p_cast10_fu_321_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state11 : begin
            if (((grp_needwun_Pipeline_pad_a_fu_224_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state11))) begin
...
always @ (*) begin
    ap_block_state12_on_subcall_done = ((grp_needwun_Pipeline_pad_b_fu_232_ap_done == 1'b0) & (icmp_ln83_reg_563 == 1'd1));
end
...
assign empty_24_fu_355_p2 = (p_shl9_fu_348_p3 + p_cast3_fu_345_p1);
...
assign icmp_ln83_fu_482_p2 = (($signed(tmp_19_fu_472_p4) < $signed(24'd1)) ? 1'b1 : 1'b0);
assign indvar_cast_fu_286_p1 = indvar_fu_122;
assign or_ln65_1_fu_439_p3 = {{grp_fu_249_p4}, {3'd7}};
assign or_ln65_2_fu_463_p3 = {{tmp_s_fu_453_p4}, {1'd1}};
...
assign p_cast10_fu_321_p1 = empty_23_fu_315_p2;
assign p_cast3_fu_345_p1 = empty_23_reg_523;
assign p_cast9_fu_310_p1 = empty_22_fu_304_p2;
assign p_shl8_fu_290_p3 = {{indvar_fu_122}, {7'd0}};
assign p_shl9_fu_348_p3 = {{empty_23_reg_523}, {7'd0}};
assign p_shl_fu_361_p3 = {{b_idx_reg_514}, {7'd0}};
assign ptr_d0 = grp_needwun_Pipeline_fill_in_fu_210_ptr_d0;
assign tmp_19_fu_472_p4 = {{ap_phi_mux_b_str_idx_phi_fu_163_p16[31:8]}};
assign tmp_fu_409_p3 = a_str_idx_0_0_loc_fu_126[32'd1];
assign tmp_s_fu_453_p4 = {{a_str_idx_0_0_loc_fu_126[31:1]}};
