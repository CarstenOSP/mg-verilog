...
sparsemux_7_2_64_1_1_U795(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_55_fu_121_p7),.sel(ap_sig_allocacmp_i_8),.dout(tmp_55_fu_121_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_56_reg_226 <= grp_fu_11257_p_dout0;
