module sha_stream_sha_transform_Pipeline_trans_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_25_reload,B_1_reload,E_25_reload,D_25_reload,E_2_reload,W_address0,W_ce0,W_q0,W_2_address0,W_2_ce0,W_2_q0,W_4_address0,W_4_ce0,W_4_q0,W_6_address0,W_6_ce0,W_6_q0,W_1_address0,W_1_ce0,W_1_q0,W_3_address0,W_3_ce0,W_3_q0,W_5_address0,W_5_ce0,W_5_q0,W_7_address0,W_7_ce0,W_7_q0,A_27_out,A_27_out_ap_vld,B_4_out,B_4_out_ap_vld,E_26_out,E_26_out_ap_vld,D_27_out,D_27_out_ap_vld,E_5_out,E_5_out_ap_vld); 
...
reg   [31:0] E_24_reg_717;
wire    ap_block_pp0_stage1_11001;
wire   [31:0] tmp_1_fu_361_p11;
reg   [31:0] tmp_1_reg_724;
wire   [31:0] tmp_s_fu_385_p11;
reg   [31:0] tmp_s_reg_729;
reg   [31:0] E_load_reg_734;
wire    ap_block_pp0_stage2_11001;
wire   [31:0] B_22_fu_471_p2;
reg   [31:0] B_22_reg_739;
...
wire   [63:0] zext_ln100_1_fu_342_p1;
...
wire   [31:0] tmp_1_fu_361_p9;
wire   [2:0] trunc_ln100_fu_358_p1;
wire   [31:0] tmp_s_fu_385_p9;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_1_fu_361_p1;
wire   [2:0] tmp_1_fu_361_p3;
wire  signed [2:0] tmp_1_fu_361_p5;
wire  signed [2:0] tmp_1_fu_361_p7;
wire   [2:0] tmp_s_fu_385_p1;
wire   [2:0] tmp_s_fu_385_p3;
wire  signed [2:0] tmp_s_fu_385_p5;
wire  signed [2:0] tmp_s_fu_385_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_9_3_32_1_1_U46(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_1_fu_361_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_1_fu_361_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U47(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_s_fu_385_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_s_fu_385_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            B_4_fu_108 <= B_22_reg_739;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        B_fu_112 <= A_25_reload;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        D_fu_120 <= C_6_fu_538_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_5_fu_100 <= E_2_reload;
    end else if (((icmp_ln120_reg_673 == 1'd1) & (1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        E_5_fu_100 <= E_24_reg_717;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_fu_104 <= D_25_reload;
    end else if (((icmp_ln120_reg_673 == 1'd1) & (1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        E_fu_104 <= D_11_fu_491_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        B_22_reg_739 <= B_22_fu_471_p2;
        E_load_reg_734 <= E_fu_104;
        lshr_ln122_2_reg_749 <= {{B_22_fu_471_p2[31:27]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_1_reg_724 <= tmp_1_fu_361_p11;
        tmp_s_reg_729 <= tmp_s_fu_385_p11;
    end
end
always @ (*) begin
...
assign A_27_out = B_fu_112;
assign A_fu_595_p2 = (add_ln122_6_reg_759 + add_ln122_4_fu_591_p2);
assign B_22_fu_471_p2 = (add_ln122_fu_465_p2 + add_ln122_2_fu_459_p2);
assign B_4_out = B_4_fu_108;
assign C_6_fu_538_p3 = {{trunc_ln122_3_fu_524_p1}, {lshr_ln122_3_fu_528_p4}};
assign D_11_fu_491_p3 = {{trunc_ln122_1_fu_477_p1}, {lshr_ln122_1_fu_481_p4}};
assign D_27_out = E_fu_104;
assign E_26_out = D_fu_120;
assign E_5_out = E_5_fu_100;
assign W_1_address0 = zext_ln100_1_fu_342_p1;
assign W_1_ce0 = W_1_ce0_local;
assign W_2_address0 = zext_ln100_1_fu_342_p1;
assign W_2_ce0 = W_2_ce0_local;
assign W_3_address0 = zext_ln100_1_fu_342_p1;
assign W_3_ce0 = W_3_ce0_local;
assign W_4_address0 = zext_ln100_1_fu_342_p1;
assign W_4_ce0 = W_4_ce0_local;
assign W_5_address0 = zext_ln100_1_fu_342_p1;
assign W_5_ce0 = W_5_ce0_local;
assign W_6_address0 = zext_ln100_1_fu_342_p1;
assign W_6_ce0 = W_6_ce0_local;
assign W_7_address0 = zext_ln100_1_fu_342_p1;
assign W_7_ce0 = W_7_ce0_local;
assign W_address0 = zext_ln100_1_fu_342_p1;
assign W_ce0 = W_ce0_local;
assign add_ln120_fu_546_p2 = (i_reg_667 + 6'd2);
assign add_ln122_1_fu_454_p2 = (tmp_1_reg_724 + 32'd1859775393);
assign add_ln122_2_fu_459_p2 = (add_ln122_1_fu_454_p2 + or_ln_fu_446_p3);
assign add_ln122_4_fu_591_p2 = (E_load_reg_734 + xor_ln122_3_reg_754);
assign add_ln122_5_fu_576_p2 = (tmp_s_reg_729 + 32'd1859775393);
assign add_ln122_6_fu_581_p2 = (or_ln122_2_fu_570_p3 + add_ln122_5_fu_576_p2);
assign add_ln122_fu_465_p2 = (xor_ln122_1_fu_440_p2 + E_5_fu_100);
...
assign tmp_1_fu_361_p9 = 'bx;
assign tmp_s_fu_385_p9 = 'bx;
assign trunc_ln100_fu_358_p1 = i_reg_667[2:0];
assign trunc_ln122_1_fu_477_p1 = B_4_fu_108[1:0];
assign trunc_ln122_2_fu_499_p1 = B_22_fu_471_p2[26:0];
...
assign xor_ln122_2_fu_513_p2 = (D_11_fu_491_p3 ^ B_fu_112);
assign xor_ln122_3_fu_519_p2 = (xor_ln122_2_fu_513_p2 ^ E_24_reg_717);
assign xor_ln122_fu_435_p2 = (E_fu_104 ^ E_24_reg_717);
assign zext_ln100_1_fu_342_p1 = lshr_ln100_1_fu_332_p4;
endmodule 