...
needwun_needwun_Pipeline_pad_a grp_needwun_Pipeline_pad_a_fu_213(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_needwun_Pipeline_pad_a_fu_213_ap_start),.ap_done(grp_needwun_Pipeline_pad_a_fu_213_ap_done),.ap_idle(grp_needwun_Pipeline_pad_a_fu_213_ap_idle),.ap_ready(grp_needwun_Pipeline_pad_a_fu_213_ap_ready),.sext_ln83(b_str_idx_reg_98),.alignedA_0_address0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_0_address0),.alignedA_0_ce0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_0_ce0),.alignedA_0_we0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_0_we0),.alignedA_0_d0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_0_d0),.alignedA_3_address0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_3_address0),.alignedA_3_ce0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_3_ce0),.alignedA_3_we0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_3_we0),.alignedA_3_d0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_3_d0),.alignedA_2_address0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_2_address0),.alignedA_2_ce0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_2_ce0),.alignedA_2_we0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_2_we0),.alignedA_2_d0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_2_d0),.alignedA_1_address0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_1_address0),.alignedA_1_ce0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_1_ce0),.alignedA_1_we0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_1_we0),.alignedA_1_d0(grp_needwun_Pipeline_pad_a_fu_213_alignedA_1_d0));
needwun_needwun_Pipeline_pad_b grp_needwun_Pipeline_pad_b_fu_227(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_needwun_Pipeline_pad_b_fu_227_ap_start),.ap_done(grp_needwun_Pipeline_pad_b_fu_227_ap_done),.ap_idle(grp_needwun_Pipeline_pad_b_fu_227_ap_idle),.ap_ready(grp_needwun_Pipeline_pad_b_fu_227_ap_ready),.sext_ln83(b_str_idx_reg_98),.alignedB_0_address0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_0_address0),.alignedB_0_ce0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_0_ce0),.alignedB_0_we0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_0_we0),.alignedB_0_d0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_0_d0),.alignedB_3_address0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_3_address0),.alignedB_3_ce0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_3_ce0),.alignedB_3_we0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_3_we0),.alignedB_3_d0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_3_d0),.alignedB_2_address0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_2_address0),.alignedB_2_ce0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_2_ce0),.alignedB_2_we0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_2_we0),.alignedB_2_d0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_2_d0),.alignedB_1_address0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_1_address0),.alignedB_1_ce0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_1_ce0),.alignedB_1_we0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_1_we0),.alignedB_1_d0(grp_needwun_Pipeline_pad_b_fu_227_alignedB_1_d0));
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln83_fu_274_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        if ((targetBlock_reg_286 == 1'd1)) begin
            ...
            b_str_idx_reg_98 <= or_ln_fu_255_p3;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((icmp_ln83_reg_290 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
        alignedA_0_address0 = grp_needwun_Pipeline_pad_a_fu_213_alignedA_0_address0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        if ((targetBlock_reg_286 == 1'd1)) begin
            ...
            ap_phi_mux_b_str_idx_phi_fu_101_p4 = or_ln_fu_255_p3;
        end else begin
...
assign M_0_d1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_0_d1;
assign M_1_address1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_1_address1;
assign M_1_d1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_1_d1;
assign M_2_address1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_2_address1;
assign M_2_d1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_2_d1;
assign M_3_address1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_3_address1;
assign M_3_d1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_3_d1;
...
always @ (*) begin
    ap_block_state10_on_subcall_done = (((grp_needwun_Pipeline_pad_b_fu_227_ap_done == 1'b0) & (icmp_ln83_reg_290 == 1'd1)) | ((grp_needwun_Pipeline_pad_a_fu_213_ap_done == 1'b0) & (icmp_ln83_reg_290 == 1'd1)));
end
...
assign or_ln_fu_255_p3 = {{tmp_s_fu_245_p4}, {1'd1}};
