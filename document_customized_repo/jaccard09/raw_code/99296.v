...
output  [1:0] grp_fu_3302_p_opcode;
...
wire   [0:0] icmp_ln25_fu_257_p2;
wire   [0:0] tmp_fu_272_p3;
reg   [0:0] tmp_reg_465;
wire   [6:0] select_ln6_fu_280_p3;
reg   [6:0] select_ln6_reg_470;
wire   [0:0] first_iter_1_fu_288_p2;
reg   [0:0] first_iter_1_reg_475;
wire   [4:0] lshr_ln6_5_fu_294_p4;
reg   [4:0] lshr_ln6_5_reg_479;
wire   [3:0] tmp_4_fu_310_p4;
reg   [3:0] tmp_4_reg_494;
reg   [5:0] tmp1_addr_reg_509;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] tmp1_addr_reg_509_pp0_iter1_reg;
reg   [31:0] buff_x_load_reg_524;
reg   [31:0] buff_x_1_load_reg_529;
reg   [31:0] buff_x_load_1_reg_544;
reg   [31:0] buff_x_1_load_1_reg_549;
reg   [31:0] arrayidx45_promoted_reg_554;
reg   [31:0] buff_A_load_reg_559;
reg   [31:0] buff_A_1_load_reg_564;
reg   [31:0] buff_A_load_1_reg_569;
reg   [31:0] buff_A_1_load_1_reg_574;
reg   [0:0] tmp_1_reg_584;
wire    ap_block_pp0_stage28_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln6_fu_304_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln27_fu_328_p1;
wire   [63:0] zext_ln25_fu_359_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln27_1_fu_371_p1;
wire   [63:0] zext_ln27_2_fu_386_p1;
reg   [6:0] j_fu_66;
wire   [6:0] add_ln26_fu_405_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_1_fu_70;
wire   [6:0] select_ln25_fu_348_p3;
reg   [10:0] indvar_flatten7_fu_74;
wire   [10:0] add_ln25_1_fu_263_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten7_load;
reg   [31:0] add16_fu_78;
...
wire   [4:0] or_ln_fu_320_p3;
wire   [6:0] add_ln25_fu_342_p2;
wire   [5:0] empty_fu_355_p1;
wire   [10:0] tmp_3_fu_364_p3;
wire   [10:0] tmp_5_fu_377_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_761)) begin
            add16_fu_78 <= arrayidx45_promoted_reg_554;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_1_fu_70 <= 7'd0;
    end else if (((icmp_ln25_reg_461 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_1_fu_70 <= select_ln25_fu_348_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln25_fu_257_p2 == 1'd0))) begin
            indvar_flatten7_fu_74 <= add_ln25_1_fu_263_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten7_fu_74 <= 11'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_66 <= 7'd0;
    end else if (((icmp_ln25_reg_461 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_fu_66 <= add_ln26_fu_405_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx45_promoted_reg_554 <= tmp1_q0;
        buff_A_1_load_1_reg_574 <= buff_A_1_q0;
        buff_A_1_load_reg_564 <= buff_A_1_q1;
        buff_A_load_1_reg_569 <= buff_A_q0;
        buff_A_load_reg_559 <= buff_A_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_x_1_load_1_reg_549 <= buff_x_1_q0;
        buff_x_1_load_reg_529 <= buff_x_1_q1;
        buff_x_load_1_reg_544 <= buff_x_q0;
        buff_x_load_reg_524 <= buff_x_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_1_reg_475 <= first_iter_1_fu_288_p2;
        icmp_ln25_reg_461 <= icmp_ln25_fu_257_p2;
        lshr_ln6_5_reg_479 <= {{select_ln6_fu_280_p3[5:1]}};
        select_ln6_reg_470 <= select_ln6_fu_280_p3;
        tmp_4_reg_494 <= {{select_ln6_fu_280_p3[5:2]}};
        tmp_reg_465 <= ap_sig_allocacmp_j_load[32'd6];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage24_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage24)) | ((1'b0 == ap_block_pp0_stage17_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17)) | ((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9)))) begin
        reg_233 <= grp_fu_3302_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp1_addr_reg_509 <= zext_ln25_fu_359_p1;
        tmp1_addr_reg_509_pp0_iter1_reg <= tmp1_addr_reg_509;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_1_reg_584 <= add_ln26_fu_405_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln25_reg_461 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3)) | ((1'b0 == ap_block_pp0_stage25) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage25)) | ((1'b0 == ap_block_pp0_stage18) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage18)))) begin
        grp_fu_201_p0 = reg_233;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        grp_fu_201_p0 = add16_fu_78;
    end else begin
        grp_fu_201_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_201_p1 = reg_227;
    end else if (((1'b0 == ap_block_pp0_stage25) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage25))) begin
        grp_fu_201_p1 = reg_221;
    end else if (((1'b0 == ap_block_pp0_stage18) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage18))) begin
        grp_fu_201_p1 = reg_215;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        grp_fu_201_p1 = reg_209;
    end else begin
        grp_fu_201_p1 = 'bx;
    end
end
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage10) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
            grp_fu_205_p0 = reg_227;
        end else if (((1'b0 == ap_block_pp0_stage9) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
            grp_fu_205_p0 = reg_221;
        end else if (((1'b0 == ap_block_pp0_stage8) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
            grp_fu_205_p0 = reg_215;
        end else if (((1'b0 == ap_block_pp0_stage7) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
            grp_fu_205_p0 = reg_209;
        end else if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
            grp_fu_205_p0 = buff_A_1_load_1_reg_574;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_205_p0 = buff_A_load_1_reg_569;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_205_p0 = buff_A_1_load_reg_564;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_205_p0 = buff_A_load_reg_559;
        end else begin
            grp_fu_205_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        grp_fu_205_p1 = buff_x_1_load_1_reg_549;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_205_p1 = buff_x_load_1_reg_544;
    end else if (((1'b0 == ap_block_pp0_stage8) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        grp_fu_205_p1 = buff_x_1_load_reg_529;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        grp_fu_205_p1 = buff_x_load_reg_524;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_address0_local = tmp1_addr_reg_509_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp1_address0_local = zext_ln25_fu_359_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1_reg_584 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_we0_local = 1'b1;
    end else begin
        tmp1_we0_local = 1'b0;
    end
...
assign add_ln25_1_fu_263_p2 = (ap_sig_allocacmp_indvar_flatten7_load + 11'd1);
assign add_ln25_fu_342_p2 = (i_1_fu_70 + 7'd1);
assign add_ln26_fu_405_p2 = (select_ln6_reg_470 + 7'd4);
...
always @ (*) begin
    ap_condition_761 = ((icmp_ln25_reg_461 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_475 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_A_1_address0 = zext_ln27_2_fu_386_p1;
assign buff_A_1_address1 = zext_ln27_1_fu_371_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_1_ce1 = buff_A_1_ce1_local;
assign buff_A_address0 = zext_ln27_2_fu_386_p1;
assign buff_A_address1 = zext_ln27_1_fu_371_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_A_ce1 = buff_A_ce1_local;
assign buff_x_1_address0 = zext_ln27_fu_328_p1;
assign buff_x_1_address1 = zext_ln6_fu_304_p1;
assign buff_x_1_ce0 = buff_x_1_ce0_local;
assign buff_x_1_ce1 = buff_x_1_ce1_local;
assign buff_x_address0 = zext_ln27_fu_328_p1;
assign buff_x_address1 = zext_ln6_fu_304_p1;
assign buff_x_ce0 = buff_x_ce0_local;
assign buff_x_ce1 = buff_x_ce1_local;
assign empty_fu_355_p1 = select_ln25_fu_348_p3[5:0];
assign first_iter_1_fu_288_p2 = ((select_ln6_fu_280_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_3302_p_ce = 1'b1;
assign grp_fu_3302_p_din0 = grp_fu_201_p0;
assign grp_fu_3302_p_din1 = grp_fu_201_p1;
assign grp_fu_3302_p_opcode = 2'd0;
assign grp_fu_3306_p_ce = 1'b1;
assign grp_fu_3306_p_din0 = grp_fu_205_p0;
assign grp_fu_3306_p_din1 = grp_fu_205_p1;
assign icmp_ln25_fu_257_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln6_5_fu_294_p4 = {{select_ln6_fu_280_p3[5:1]}};
assign or_ln_fu_320_p3 = {{tmp_4_fu_310_p4}, {1'd1}};
assign select_ln25_fu_348_p3 = ((tmp_reg_465[0:0] == 1'b1) ? add_ln25_fu_342_p2 : i_1_fu_70);
assign select_ln6_fu_280_p3 = ((tmp_fu_272_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp1_address0 = tmp1_address0_local;
assign tmp1_ce0 = tmp1_ce0_local;
assign tmp1_d0 = reg_233;
assign tmp1_we0 = tmp1_we0_local;
assign tmp_3_fu_364_p3 = {{empty_fu_355_p1}, {lshr_ln6_5_reg_479}};
assign tmp_4_fu_310_p4 = {{select_ln6_fu_280_p3[5:2]}};
assign tmp_5_fu_377_p4 = {{{empty_fu_355_p1}, {tmp_4_reg_494}}, {1'd1}};
assign tmp_fu_272_p3 = ap_sig_allocacmp_j_load[32'd6];
assign zext_ln25_fu_359_p1 = select_ln25_fu_348_p3;
assign zext_ln27_1_fu_371_p1 = tmp_3_fu_364_p3;
assign zext_ln27_2_fu_386_p1 = tmp_5_fu_377_p4;
assign zext_ln27_fu_328_p1 = or_ln_fu_320_p3;
assign zext_ln6_fu_304_p1 = lshr_ln6_5_fu_294_p4;
endmodule 