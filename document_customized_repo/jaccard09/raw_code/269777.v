module backprop_backprop_Pipeline_label_39_label_40 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v10_address0,v10_ce0,v10_q0,v2_address0,v2_ce0,v2_we0,v2_d0,v2_q0,v216_out,v216_out_ap_vld,grp_fu_18914_p_din0,grp_fu_18914_p_din1,grp_fu_18914_p_opcode,grp_fu_18914_p_dout0,grp_fu_18914_p_ce,grp_fu_18926_p_din0,grp_fu_18926_p_din1,grp_fu_18926_p_dout0,grp_fu_18926_p_ce); 
...
output  [1:0] grp_fu_18914_p_opcode;
input  [63:0] grp_fu_18914_p_dout0;
output   grp_fu_18914_p_ce;
output  [63:0] grp_fu_18926_p_din0;
output  [63:0] grp_fu_18926_p_din1;
input  [63:0] grp_fu_18926_p_dout0;
output   grp_fu_18926_p_ce;
reg ap_idle;
reg v216_out_ap_vld;
...
reg   [7:0] indvar_flatten55_fu_66;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln341_fu_134_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten55_fu_66 <= add_ln341_fu_140_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten55_fu_66 <= 8'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        v214_fu_54 <= grp_fu_18914_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v218_reg_320 <= grp_fu_18926_p_dout0;
        v2_load_reg_325 <= v2_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v220_reg_335 <= grp_fu_18914_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v221_reg_342 <= grp_fu_18926_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_indvar_flatten55_load = indvar_flatten55_fu_66;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v214_load_1 = grp_fu_18914_p_dout0;
    end else begin
...
assign add_ln341_fu_140_p2 = (ap_sig_allocacmp_indvar_flatten55_load + 8'd1);
...
assign grp_fu_18914_p_din0 = grp_fu_102_p0;
assign grp_fu_18914_p_din1 = grp_fu_102_p1;
assign grp_fu_18914_p_opcode = grp_fu_102_opcode;
assign grp_fu_18926_p_ce = 1'b1;
assign grp_fu_18926_p_din0 = grp_fu_106_p0;
assign grp_fu_18926_p_din1 = grp_fu_106_p1;
assign icmp_ln341_fu_134_p2 = ((ap_sig_allocacmp_indvar_flatten55_load == 8'd192) ? 1'b1 : 1'b0);
