...
wire   [7:0] zext_ln172_7_fu_749_p1;
reg   [7:0] zext_ln172_7_reg_1092;
reg   [7:0] zext_ln172_7_reg_1092_pp0_iter4_reg;
wire   [8:0] zext_ln172_8_fu_752_p1;
reg   [8:0] zext_ln172_8_reg_1098;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln172_7_reg_1092[5 : 0] <= zext_ln172_7_fu_749_p1[5 : 0];
        zext_ln172_7_reg_1092_pp0_iter4_reg[5 : 0] <= zext_ln172_7_reg_1092[5 : 0];
        zext_ln172_8_reg_1098[5 : 0] <= zext_ln172_8_fu_752_p1[5 : 0];
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln210_fu_795_p2 = ($signed(zext_ln172_8_reg_1098) + $signed(9'd264));
assign add_ln212_fu_813_p2 = ($signed(zext_ln172_8_reg_1098) + $signed(9'd330));
assign add_ln213_fu_905_p2 = ($signed(zext_ln172_7_reg_1092_pp0_iter4_reg) + $signed(8'd132));
assign add_ln214_fu_758_p2 = ($signed(zext_ln172_7_reg_1092) + $signed(8'd140));
...
assign or_ln_fu_930_p3 = {{offset_reg_1079_pp0_iter4_reg}, {2'd3}};
...
assign zext_ln172_7_fu_749_p1 = offset_reg_1079_pp0_iter2_reg;
assign zext_ln172_8_fu_752_p1 = offset_reg_1079_pp0_iter2_reg;
...
assign zext_ln215_1_fu_937_p1 = or_ln_fu_930_p3;
assign zext_ln215_fu_1012_p1 = tmp_203_reg_1210;
assign zext_ln216_fu_1031_p1 = tmp_204_reg_1231;
always @ (posedge ap_clk) begin
    zext_ln172_7_reg_1092[7:6] <= 2'b00;
    zext_ln172_7_reg_1092_pp0_iter4_reg[7:6] <= 2'b00;
    zext_ln172_8_reg_1098[8:6] <= 3'b000;
end
endmodule 