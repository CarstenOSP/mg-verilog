...
wire   [63:0] zext_ln249_1_fu_134_p1;
...
wire   [8:0] mul_ln249_fu_118_p0;
wire   [10:0] mul_ln249_fu_118_p1;
wire   [18:0] mul_ln249_fu_118_p2;
...
wire   [18:0] mul_ln249_fu_118_p00;
...
urem_9ns_8ns_9_13_seq_1_U100(.clk(ap_clk),.reset(ap_rst),.start(grp_fu_100_ap_start),.done(grp_fu_100_ap_done),.din0(v175),.din1(grp_fu_100_p1),.ce(grp_fu_100_ce),.dout(grp_fu_100_p2));
kernel_atax_mul_8ns_10ns_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 8 ),.din1_WIDTH( 10 ),.dout_WIDTH( 16 ))
mul_8ns_10ns_16_1_1_U101(.din0(mul_ln251_fu_109_p0),.din1(mul_ln251_fu_109_p1),.dout(mul_ln251_fu_109_p2));
kernel_atax_mul_9ns_11ns_19_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 9 ),.din1_WIDTH( 11 ),.dout_WIDTH( 19 ))
mul_9ns_11ns_19_1_1_U102(.din0(mul_ln249_fu_118_p0),.din1(mul_ln249_fu_118_p1),.dout(mul_ln249_fu_118_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        ...
        trunc_ln_reg_169 <= {{mul_ln249_fu_118_p2[17:16]}};
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state13)) begin
        urem_ln249_reg_159 <= grp_fu_100_p2;
    end
end
...
assign mul_ln249_fu_118_p0 = mul_ln249_fu_118_p00;
assign mul_ln249_fu_118_p00 = v175;
assign mul_ln249_fu_118_p1 = 19'd669;
assign mul_ln251_fu_109_p0 = mul_ln251_fu_109_p00;
assign mul_ln251_fu_109_p00 = urem_ln249_reg_159;
