...
wire   [3:0] lshr_ln6_5_fu_319_p4;
reg   [3:0] lshr_ln6_5_reg_556;
...
wire   [31:0] tmp_2_fu_394_p11;
reg   [31:0] tmp_2_reg_616;
...
wire   [31:0] tmp_1_fu_439_p11;
reg   [31:0] tmp_1_reg_625;
...
wire   [31:0] tmp_2_fu_394_p9;
wire   [1:0] tmp_2_fu_394_p10;
wire   [31:0] tmp_1_fu_439_p9;
...
wire   [1:0] tmp_2_fu_394_p1;
wire   [1:0] tmp_2_fu_394_p3;
wire  signed [1:0] tmp_2_fu_394_p5;
wire  signed [1:0] tmp_2_fu_394_p7;
wire   [1:0] tmp_1_fu_439_p1;
wire   [1:0] tmp_1_fu_439_p3;
wire  signed [1:0] tmp_1_fu_439_p5;
wire  signed [1:0] tmp_1_fu_439_p7;
...
sparsemux_9_2_32_1_1_U25(.din0(buff_x_q0),.din1(buff_x_1_q0),.din2(buff_x_2_q0),.din3(buff_x_3_q0),.def(tmp_2_fu_394_p9),.sel(tmp_2_fu_394_p10),.dout(tmp_2_fu_394_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U26(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.def(tmp_1_fu_439_p9),.sel(trunc_ln26_reg_591),.dout(tmp_1_fu_439_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U27(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_fu_469_p9),.sel(trunc_ln25_reg_581),.dout(tmp_fu_469_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add_reg_670 <= grp_fu_1922_p_dout0;
        ...
        lshr_ln6_2_reg_586 <= {{select_ln25_fu_351_p3[5:2]}};
        tmp_2_reg_616 <= tmp_2_fu_394_p11;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln6_5_reg_556 <= {{select_ln6_fu_305_p3[5:2]}};
        select_ln6_reg_546 <= select_ln6_fu_305_p3;
        tmp1_1_addr_reg_640 <= zext_ln6_fu_462_p1;
        tmp1_1_addr_reg_640_pp0_iter2_reg <= tmp1_1_addr_reg_640;
        tmp1_2_addr_reg_645 <= zext_ln6_fu_462_p1;
        tmp1_2_addr_reg_645_pp0_iter2_reg <= tmp1_2_addr_reg_645;
        tmp1_3_addr_reg_650 <= zext_ln6_fu_462_p1;
        tmp1_3_addr_reg_650_pp0_iter2_reg <= tmp1_3_addr_reg_650;
        tmp1_addr_reg_635 <= zext_ln6_fu_462_p1;
        tmp1_addr_reg_635_pp0_iter2_reg <= tmp1_addr_reg_635;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        mul3_reg_660 <= grp_fu_1926_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul_reg_630 <= grp_fu_1926_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_1_reg_625 <= tmp_1_fu_439_p11;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp1_1_address0_local = zext_ln6_fu_462_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp1_2_address0_local = zext_ln6_fu_462_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp1_3_address0_local = zext_ln6_fu_462_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp1_address0_local = zext_ln6_fu_462_p1;
    end else begin
...
assign grp_fu_1922_p_din0 = add16_fu_92;
assign grp_fu_1922_p_din1 = mul3_reg_660;
assign grp_fu_1922_p_opcode = 2'd0;
assign grp_fu_1926_p_ce = 1'b1;
assign grp_fu_1926_p_din0 = grp_fu_262_p0;
assign grp_fu_1926_p_din1 = grp_fu_262_p1;
...
assign lshr_ln6_5_fu_319_p4 = {{select_ln6_fu_305_p3[5:2]}};
...
assign tmp_2_fu_394_p10 = select_ln6_reg_546[1:0];
assign tmp_2_fu_394_p9 = 'bx;
assign tmp_5_fu_379_p3 = {{empty_fu_358_p1}, {lshr_ln6_5_reg_556}};
...
assign zext_ln27_fu_386_p1 = tmp_5_fu_379_p3;
assign zext_ln6_1_fu_329_p1 = lshr_ln6_5_fu_319_p4;
