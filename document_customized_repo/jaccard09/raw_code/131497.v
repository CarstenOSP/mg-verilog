...
reg   [31:0] tmp_1_reg_881;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
wire   [31:0] tmp_5_fu_636_p19;
reg   [31:0] tmp_5_reg_926;
...
reg   [12:0] indvar_flatten9_fu_116;
...
wire   [2:0] lshr_ln6_6_fu_544_p4;
wire   [31:0] tmp_1_fu_576_p17;
wire   [8:0] tmp_9_fu_615_p3;
...
#0 j_fu_108 = 7'd0;
#0 i_fu_112 = 7'd0;
#0 indvar_flatten9_fu_116 = 13'd0;
#0 empty_fu_120 = 32'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U50(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.din4(buff_x2_4_q0),.din5(buff_x2_5_q0),.din6(buff_x2_6_q0),.din7(buff_x2_7_q0),.def(tmp_1_fu_576_p17),.sel(trunc_ln29_1_reg_790),.dout(tmp_1_fu_576_p19));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U51(.din0(buff_y2_q0),.din1(buff_y2_1_q0),.din2(buff_y2_2_q0),.din3(buff_y2_3_q0),.din4(buff_y2_4_q0),.din5(buff_y2_5_q0),.din6(buff_y2_6_q0),.din7(buff_y2_7_q0),.def(tmp_5_fu_636_p17),.sel(tmp_5_fu_636_p18),.dout(tmp_5_fu_636_p19));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U52(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.din4(buff_A_4_q0),.din5(buff_A_5_q0),.din6(buff_A_6_q0),.din7(buff_A_7_q0),.def(tmp_4_fu_692_p17),.sel(trunc_ln29_1_reg_790),.dout(tmp_4_fu_692_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln29_fu_462_p2 == 1'd0))) begin
            indvar_flatten9_fu_116 <= add_ln29_1_fu_468_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten9_fu_116 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        add1_reg_950 <= grp_fu_971_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_1_reg_881 <= tmp_1_fu_576_p19;
        tmp_5_reg_926 <= tmp_5_fu_636_p19;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul1_reg_940 <= grp_fu_975_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_4_reg_935 <= tmp_4_fu_692_p19;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten9_load = indvar_flatten9_fu_116;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd2) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd3) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd4) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd5) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd7) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (icmp_ln30_1_reg_931_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln29_1_reg_790_pp0_iter1_reg == 3'd0) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
assign add_ln29_1_fu_468_p2 = (ap_sig_allocacmp_indvar_flatten9_load + 13'd1);
...
always @ (*) begin
    ap_condition_794 = ((icmp_ln29_reg_771 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_786 == 1'd1));
end
...
assign first_iter_1_fu_512_p2 = ((select_ln6_fu_492_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_971_p_ce = 1'b1;
assign grp_fu_971_p_din0 = empty_fu_120;
assign grp_fu_971_p_din1 = mul1_reg_940;
assign grp_fu_971_p_opcode = 2'd0;
assign grp_fu_975_p_ce = 1'b1;
assign grp_fu_975_p_din0 = tmp_4_reg_935;
assign grp_fu_975_p_din1 = tmp_5_reg_926;
assign icmp_ln29_fu_462_p2 = ((ap_sig_allocacmp_indvar_flatten9_load == 13'd4096) ? 1'b1 : 1'b0);
...
assign lshr_ln6_6_fu_544_p4 = {{select_ln6_fu_492_p3[5:3]}};
assign select_ln29_fu_504_p3 = ((icmp_ln30_fu_486_p2[0:0] == 1'b1) ? add_ln29_fu_480_p2 : ap_sig_allocacmp_i_load);
assign select_ln6_fu_492_p3 = ((icmp_ln30_fu_486_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp_1_fu_576_p17 = 'bx;
assign tmp_4_fu_692_p17 = 'bx;
assign tmp_5_fu_636_p17 = 'bx;
assign tmp_5_fu_636_p18 = select_ln6_reg_775[2:0];
assign tmp_9_fu_615_p3 = {{trunc_ln29_reg_781}, {lshr_ln6_2_reg_796}};
assign trunc_ln29_1_fu_518_p1 = select_ln29_fu_504_p3[2:0];
assign trunc_ln29_fu_500_p1 = select_ln6_fu_492_p3[5:0];
assign zext_ln31_fu_621_p1 = tmp_9_fu_615_p3;
assign zext_ln6_1_fu_554_p1 = lshr_ln6_6_fu_544_p4;
