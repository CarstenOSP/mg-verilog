...
wire   [12:0] tmp_143_fu_481_p3;
reg   [12:0] tmp_143_reg_680;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_70_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_70_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_278_min_s_32_out;
wire    grp_viterbi_Pipeline_L_end_fu_278_min_s_32_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_286_min_s_66_out;
wire    grp_viterbi_Pipeline_L_state_fu_286_min_s_66_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state31)) begin
        store_forwarded_fu_116 <= min_s_32_loc_fu_96;
    end else if ((1'b1 == ap_CS_fsm_state44)) begin
        store_forwarded_fu_116 <= min_s_66_loc_fu_92;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_2_reg_605[12 : 5] <= tmp_200_cast_fu_357_p1[12 : 5];
        tmp_s_reg_600[12 : 5] <= tmp_s_fu_349_p3[12 : 5];
        zext_ln19_reg_610[7 : 0] <= zext_ln19_fu_362_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_70_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_70_loc_fu_100 <= grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_70_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_278_min_s_32_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_32_loc_fu_96 <= grp_viterbi_Pipeline_L_end_fu_278_min_s_32_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_286_min_s_66_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state43))) begin
        min_s_66_loc_fu_92 <= grp_viterbi_Pipeline_L_state_fu_286_min_s_66_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        tmp_143_reg_680[12 : 5] <= tmp_143_fu_481_p3[12 : 5];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_70_loc_fu_100;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        path_d0_local = min_s_66_loc_fu_92;
    end else if ((1'b1 == ap_CS_fsm_state31)) begin
        path_d0_local = min_s_32_loc_fu_96;
    end else begin
        path_d0_local = 'bx;
    end
end
...
assign tmp_143_fu_481_p3 = {{trunc_ln50_fu_477_p1}, {5'd0}};
assign tmp_144_fu_437_p3 = {{t_2_reg_568}, {lshr_ln7_reg_633}};
assign tmp_200_cast_fu_357_p1 = tmp_s_fu_349_p3;
