...
reg   [11:0] indvar_flatten28_fu_62;
...
#0 j_fu_54 = 7'd0;
#0 i_fu_58 = 7'd0;
#0 indvar_flatten28_fu_62 = 12'd0;
#0 ap_done_reg = 1'b0;
end
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U23(.clk(ap_clk),.reset(ap_rst),.din0(buff_C_out_1_load_reg_341),.din1(mul74_1_reg_336),.ce(1'b1),.dout(grp_fu_134_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U25(.clk(ap_clk),.reset(ap_rst),.din0(buff_B_1_load_reg_321),.din1(beta),.ce(1'b1),.dout(grp_fu_142_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln29_fu_164_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten28_fu_62 <= add_ln29_1_fu_170_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten28_fu_62 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_346 <= grp_fu_164_p_dout0;
        add79_1_reg_351 <= grp_fu_134_p2;
        ...
        mul1_reg_326 <= grp_fu_168_p_dout0;
        mul74_1_reg_336 <= grp_fu_142_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten28_load = indvar_flatten28_fu_62;
    end
end
always @ (*) begin
...
assign add_ln29_1_fu_170_p2 = (ap_sig_allocacmp_indvar_flatten28_load + 12'd1);
...
assign grp_fu_164_p_din0 = buff_C_out_load_reg_331;
assign grp_fu_164_p_din1 = mul1_reg_326;
assign grp_fu_164_p_opcode = 2'd0;
assign grp_fu_168_p_ce = 1'b1;
assign grp_fu_168_p_din0 = buff_B_load_reg_316;
assign grp_fu_168_p_din1 = beta;
assign icmp_ln29_fu_164_p2 = ((ap_sig_allocacmp_indvar_flatten28_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_221_p4 = {{select_ln5_fu_201_p3[5:1]}};
...
assign tmp_5_fu_231_p3 = {{trunc_ln20_fu_217_p1}, {lshr_ln5_2_fu_221_p4}};
assign tmp_fu_193_p3 = j_fu_54[32'd6];
assign trunc_ln20_fu_217_p1 = select_ln29_fu_209_p3[5:0];
assign zext_ln32_fu_239_p1 = tmp_5_fu_231_p3;
endmodule 