module aes256_encrypt_ecb_rj_sbox_Pipeline_glog (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,x,i_out,i_out_ap_vld,ap_return); 
...
reg   [7:0] z_fu_42;
wire   [7:0] atb_2_fu_130_p2;
reg   [7:0] ap_sig_allocacmp_atb_3;
wire   [7:0] atb_fu_102_p2;
wire   [0:0] tmp_fu_108_p3;
wire   [7:0] xor_ln27_fu_116_p2;
wire   [7:0] atb_1_fu_122_p3;
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_sig_allocacmp_atb_3 = 8'd1;
    end else begin
        ap_sig_allocacmp_atb_3 = z_fu_42;
    end
end
always @ (*) begin
    if ((1'b1 == ap_condition_109)) begin
        if ((icmp_ln26_fu_90_p2 == 1'd1)) begin
            i_out = ap_phi_mux_i_phi_fu_63_p4;
...
assign atb_1_fu_122_p3 = ((tmp_fu_108_p3[0:0] == 1'b1) ? xor_ln27_fu_116_p2 : atb_fu_102_p2);
assign atb_2_fu_130_p2 = (atb_1_fu_122_p3 ^ ap_sig_allocacmp_atb_3);
assign atb_fu_102_p2 = ap_sig_allocacmp_atb_3 << 8'd1;
assign i_1_fu_96_p2 = (ap_phi_mux_i_phi_fu_63_p4 + 8'd1);
assign icmp_ln26_fu_90_p2 = ((ap_sig_allocacmp_atb_3 == x) ? 1'b1 : 1'b0);
assign icmp_ln28_fu_136_p2 = ((ap_phi_mux_i_phi_fu_63_p4 == 8'd255) ? 1'b1 : 1'b0);
assign tmp_fu_108_p3 = ap_sig_allocacmp_atb_3[32'd7];
