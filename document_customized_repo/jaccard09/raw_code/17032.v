module viterbi_viterbi_Pipeline_L_end (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p,llike_1_address0,llike_1_ce0,llike_1_q0,llike_address0,llike_ce0,llike_q0,min_s_2_out,min_s_2_out_ap_vld,grp_fu_1963_p_din0,grp_fu_1963_p_din1,grp_fu_1963_p_opcode,grp_fu_1963_p_dout0,grp_fu_1963_p_ce); 
...
reg   [63:0] min_p_72_reg_485;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
reg   [63:0] p_33_reg_492;
...
wire   [63:0] min_p_74_fu_314_p3;
reg   [63:0] min_p_74_reg_510;
reg   [0:0] tmp_76_reg_517;
...
wire   [12:0] tmp_267_cast_fu_153_p3;
wire   [6:0] zext_ln20_fu_139_p1;
wire   [5:0] lshr_ln9_2_fu_180_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        min_p_1_fu_66 <= min_p_76_fu_401_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        min_s_6_fu_74 <= 6'd1;
    end else if (((tmp_reg_469 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_reg_469 <= add_ln40_fu_166_p2[32'd6];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        min_p_72_reg_485 <= min_p_1_fu_66;
        p_33_reg_492 <= llike_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        min_p_74_reg_510 <= min_p_74_fu_314_p3;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_76_reg_517 <= grp_fu_1963_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_reg_469 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_117_p1 = min_p_74_fu_314_p3;
        end else if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (tmp_reg_469 == 1'd1) & (1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
assign add_ln40_fu_166_p2 = (zext_ln20_fu_139_p1 + 7'd1);
...
assign and_ln42_3_fu_396_p2 = (tmp_76_reg_517 & and_ln42_2_fu_390_p2);
assign and_ln42_fu_288_p2 = (or_ln42_fu_264_p2 & grp_fu_1963_p_dout0);
...
assign bitcast_ln42_1_fu_235_p1 = min_p_72_reg_485;
assign bitcast_ln42_2_fu_320_p1 = p_33_reg_492;
assign bitcast_ln42_3_fu_337_p1 = min_p_74_reg_510;
assign bitcast_ln42_fu_218_p1 = p_reg_473;
assign grp_fu_1963_p_ce = 1'b1;
assign grp_fu_1963_p_din0 = grp_fu_117_p0;
assign grp_fu_1963_p_din1 = grp_fu_117_p1;
assign grp_fu_1963_p_opcode = 5'd4;
assign icmp_ln42_1_fu_258_p2 = ((trunc_ln42_fu_231_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_2_fu_270_p2 = ((tmp_72_fu_238_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_3_fu_276_p2 = ((trunc_ln42_1_fu_248_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_4_fu_354_p2 = ((tmp_74_fu_323_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_5_fu_360_p2 = ((trunc_ln42_2_fu_333_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_6_fu_372_p2 = ((tmp_75_fu_340_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_7_fu_378_p2 = ((trunc_ln42_3_fu_350_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_fu_252_p2 = ((tmp_71_fu_221_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign llike_1_address0 = zext_ln41_fu_161_p1;
assign llike_1_ce0 = llike_1_ce0_local;
assign llike_address0 = zext_ln41_2_fu_199_p1;
assign llike_ce0 = llike_ce0_local;
assign lshr_ln9_2_fu_180_p4 = {{add_ln40_reg_463[6:1]}};
assign min_p_74_fu_314_p3 = ((and_ln42_1_reg_499[0:0] == 1'b1) ? p_reg_473 : min_p_72_reg_485);
assign min_p_76_fu_401_p3 = ((and_ln42_3_fu_396_p2[0:0] == 1'b1) ? p_33_reg_492 : min_p_74_reg_510);
...
assign tmp_267_cast_fu_153_p3 = {{8'd139}, {tmp_s_fu_143_p4}};
assign tmp_71_fu_221_p4 = {{bitcast_ln42_fu_218_p1[62:52]}};
assign tmp_72_fu_238_p4 = {{bitcast_ln42_1_fu_235_p1[62:52]}};
assign tmp_74_fu_323_p4 = {{bitcast_ln42_2_fu_320_p1[62:52]}};
assign tmp_75_fu_340_p4 = {{bitcast_ln42_3_fu_337_p1[62:52]}};
...
assign zext_ln20_fu_139_p1 = ap_sig_allocacmp_s;
assign zext_ln41_1_fu_189_p1 = lshr_ln9_2_fu_180_p4;
assign zext_ln41_2_fu_199_p1 = add_ln41_fu_193_p2;
assign zext_ln41_fu_161_p1 = tmp_267_cast_fu_153_p3;
