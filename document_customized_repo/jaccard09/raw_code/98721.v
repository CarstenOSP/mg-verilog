...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_4_fu_337_p1;
wire   [2:0] tmp_4_fu_337_p3;
wire   [2:0] tmp_4_fu_337_p5;
wire   [2:0] tmp_4_fu_337_p7;
wire  signed [2:0] tmp_4_fu_337_p9;
wire  signed [2:0] tmp_4_fu_337_p11;
wire  signed [2:0] tmp_4_fu_337_p13;
wire  signed [2:0] tmp_4_fu_337_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U1771(.din0(buff_C_out_q0),.din1(buff_C_out_1_q0),.din2(buff_C_out_2_q0),.din3(buff_C_out_3_q0),.din4(buff_C_out_4_q0),.din5(buff_C_out_5_q0),.din6(buff_C_out_6_q0),.din7(buff_C_out_7_q0),.def(tmp_4_fu_337_p17),.sel(trunc_ln39_1_reg_405),.dout(tmp_4_fu_337_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_4_reg_454 <= tmp_4_fu_337_p19;
    end
end
always @ (*) begin
...
assign bitcast_ln41_fu_376_p1 = tmp_4_reg_454;
