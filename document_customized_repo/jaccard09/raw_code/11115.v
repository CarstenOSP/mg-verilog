...
sparsemux_17_3_32_1_1_U78(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.din4(W_4_q0),.din5(W_5_q0),.din6(W_6_q0),.din7(W_7_q0),.def(tmp_9_fu_377_p17),.sel(trunc_ln128_reg_590),.dout(tmp_9_fu_377_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_9_reg_635 <= tmp_9_fu_377_p19;
...
assign add_ln130_1_fu_437_p2 = ($signed(tmp_9_reg_635) + $signed(32'd3395469782));
