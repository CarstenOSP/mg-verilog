...
wire   [11:0] tmp_79_fu_729_p3;
reg   [11:0] tmp_79_reg_1005;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_42_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_42_out_ap_vld;
...
wire   [63:0] tmp_114_cast_fu_535_p1;
...
llike_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_address0),.ce0(llike_ce0),.we0(llike_we0),.d0(llike_d0),.q0(llike_q0),.address1(grp_viterbi_Pipeline_L_prev_state_fu_406_llike_address1),.ce1(llike_ce1),.q1(llike_q1));
viterbi_llike_RAM_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 2240 ),.AddressWidth( 12 ))
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_4_reg_895[11 : 4] <= tmp_114_cast_fu_535_p1[11 : 4];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_79_reg_1005[11 : 4] <= tmp_79_fu_729_p3[11 : 4];
        trunc_ln50_1_reg_1015 <= trunc_ln50_1_fu_741_p1;
        trunc_ln52_reg_1019 <= trunc_ln52_fu_752_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_42_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_42_loc_fu_128 <= grp_viterbi_Pipeline_L_prev_state_fu_406_min_p_42_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_42_loc_fu_128;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_42_loc_fu_128;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_42_loc_fu_128;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        llike_address0_local = llike_addr_4_reg_895;
...
assign conv32_udiv_fu_552_p4 = {{tmp_15_fu_540_p3[7:1]}};
...
assign empty_28_fu_548_p1 = tmp_15_fu_540_p3[0:0];
...
assign tmp_114_cast_fu_535_p1 = tmp_s_fu_527_p3;
assign tmp_15_fu_540_p3 = ((trunc_ln18_fu_519_p1[0:0] == 1'b1) ? obs_1_q0 : obs_0_q0);
assign tmp_79_fu_729_p3 = {{trunc_ln50_reg_989}, {4'd0}};
assign tmp_80_fu_667_p3 = {{t_2_reg_860}, {lshr_ln7_reg_937}};
...
assign zext_ln33_fu_673_p1 = tmp_80_fu_667_p3;
assign zext_ln52_1_fu_766_p1 = lshr_ln52_1_fu_756_p4;
assign zext_ln52_2_fu_736_p1 = tmp_79_fu_729_p3;
...
always @ (posedge ap_clk) begin
    ...
    llike_addr_4_reg_895[3:0] <= 4'b0000;
    conv32_udiv_cast_reg_905[10:7] <= 4'b0000;
    tmp_79_reg_1005[3:0] <= 4'b0000;
end
endmodule 