module viterbi_viterbi_Pipeline_L_end (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p,llike_address0,llike_ce0,llike_q0,min_s_out,min_s_out_ap_vld,grp_fu_1304_p_din0,grp_fu_1304_p_din1,grp_fu_1304_p_opcode,grp_fu_1304_p_dout0,grp_fu_1304_p_ce); 
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        min_p_1_fu_48 <= min_p_20_fu_229_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_45_reg_325 <= grp_fu_1304_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
assign and_ln42_fu_218_p2 = (tmp_45_reg_325 & or_ln42_fu_208_p2);
...
assign grp_fu_1304_p_din0 = p_reg_297;
assign grp_fu_1304_p_din1 = min_p_1_fu_48;
...
assign icmp_ln42_2_fu_151_p2 = ((tmp_44_fu_137_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln42_3_fu_157_p2 = ((trunc_ln42_1_fu_147_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln42_fu_196_p2 = ((tmp_s_fu_182_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign llike_address0 = zext_ln41_1_fu_124_p1;
assign llike_ce0 = llike_ce0_local;
assign min_p_20_fu_229_p3 = ((and_ln42_1_fu_223_p2[0:0] == 1'b1) ? p_reg_297 : min_p_1_load_reg_304);
...
assign tmp_44_fu_137_p4 = {{bitcast_ln42_1_fu_133_p1[62:52]}};
assign tmp_s_fu_182_p4 = {{bitcast_ln42_fu_179_p1[62:52]}};
