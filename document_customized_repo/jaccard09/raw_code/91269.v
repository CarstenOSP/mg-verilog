...
wire   [5:0] trunc_ln20_fu_380_p1;
wire   [3:0] lshr_ln5_2_fu_384_p4;
wire   [9:0] tmp_8_fu_394_p3;
wire   [2:0] tmp_9_fu_414_p4;
wire   [9:0] tmp_s_fu_424_p4;
reg    ap_done_reg;
...
fadd_32ns_32ns_32_7_full_dsp_1_U45(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_286_p0),.din1(grp_fu_286_p1),.ce(1'b1),.dout(grp_fu_286_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U46(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_290_p0),.din1(grp_fu_290_p1),.ce(1'b1),.dout(grp_fu_290_p2));
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U47(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_294_p0),.din1(grp_fu_294_p1),.ce(1'b1),.dout(grp_fu_294_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U49(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_302_p0),.din1(beta),.ce(1'b1),.dout(grp_fu_302_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U50(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_306_p0),.din1(beta),.ce(1'b1),.dout(grp_fu_306_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U51(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_310_p0),.din1(beta),.ce(1'b1),.dout(grp_fu_310_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        indvar_flatten28_fu_80 <= add_ln29_1_fu_338_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add1_reg_704 <= grp_fu_248_p_dout0;
        add79_1_reg_709 <= grp_fu_286_p2;
        add79_2_reg_714 <= grp_fu_290_p2;
        add79_3_reg_719 <= grp_fu_294_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add79_4_reg_724 <= grp_fu_248_p_dout0;
        add79_5_reg_729 <= grp_fu_286_p2;
        add79_6_reg_734 <= grp_fu_290_p2;
        add79_7_reg_739 <= grp_fu_294_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        mul1_reg_624 <= grp_fu_252_p_dout0;
        mul74_1_reg_634 <= grp_fu_302_p2;
        mul74_2_reg_639 <= grp_fu_306_p2;
        mul74_3_reg_644 <= grp_fu_310_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        mul74_4_reg_684 <= grp_fu_252_p_dout0;
        mul74_5_reg_689 <= grp_fu_302_p2;
        mul74_6_reg_694 <= grp_fu_306_p2;
        mul74_7_reg_699 <= grp_fu_310_p2;
    end
end
always @ (*) begin
...
assign add_ln29_1_fu_338_p2 = (indvar_flatten28_fu_80 + 10'd1);
...
assign grp_fu_248_p_din0 = grp_fu_282_p0;
assign grp_fu_248_p_din1 = grp_fu_282_p1;
assign grp_fu_248_p_opcode = 2'd0;
assign grp_fu_252_p_ce = 1'b1;
assign grp_fu_252_p_din0 = grp_fu_298_p0;
assign grp_fu_252_p_din1 = beta;
assign icmp_ln29_fu_332_p2 = ((indvar_flatten28_fu_80 == 10'd512) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_384_p4 = {{select_ln5_fu_364_p3[5:2]}};
...
assign tmp_8_fu_394_p3 = {{trunc_ln20_fu_380_p1}, {lshr_ln5_2_fu_384_p4}};
assign tmp_9_fu_414_p4 = {{select_ln5_fu_364_p3[5:3]}};
assign tmp_fu_356_p3 = j_fu_72[32'd6];
assign tmp_s_fu_424_p4 = {{{trunc_ln20_fu_380_p1}, {tmp_9_fu_414_p4}}, {1'd1}};
assign trunc_ln20_fu_380_p1 = select_ln29_fu_372_p3[5:0];
assign zext_ln32_1_fu_434_p1 = tmp_s_fu_424_p4;
assign zext_ln32_fu_402_p1 = tmp_8_fu_394_p3;
always @ (posedge ap_clk) begin
