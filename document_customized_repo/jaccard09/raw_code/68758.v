...
wire   [10:0] tmp_95_fu_1139_p3;
reg   [10:0] tmp_95_reg_1804;
...
wire   [10:0] tmp_96_fu_1504_p3;
reg   [10:0] tmp_96_reg_1992;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_976_min_p_42_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_976_min_p_42_out_ap_vld;
...
wire   [63:0] tmp_147_cast_fu_1147_p1;
...
sparsemux_17_3_8_1_1_U124(.din0(obs_0_q0),.din1(obs_1_q0),.din2(obs_2_q0),.din3(obs_3_q0),.din4(obs_4_q0),.din5(obs_5_q0),.din6(obs_6_q0),.din7(obs_7_q0),.def(tmp_8_fu_1152_p17),.sel(tmp_8_fu_1152_p18),.dout(tmp_8_fu_1152_p19));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U125(.din0(tmp_s_fu_1307_p2),.din1(tmp_s_fu_1307_p4),.din2(tmp_s_fu_1307_p6),.din3(tmp_s_fu_1307_p8),.din4(tmp_s_fu_1307_p10),.din5(tmp_s_fu_1307_p12),.din6(tmp_s_fu_1307_p14),.din7(tmp_s_fu_1307_p16),.def(tmp_s_fu_1307_p17),.sel(trunc_ln19_reg_1832),.dout(tmp_s_fu_1307_p19));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U126(.din0(tmp_9_fu_1389_p2),.din1(tmp_9_fu_1389_p4),.din2(tmp_9_fu_1389_p6),.din3(tmp_9_fu_1389_p8),.din4(tmp_9_fu_1389_p10),.din5(tmp_9_fu_1389_p12),.din6(tmp_9_fu_1389_p14),.din7(tmp_9_fu_1389_p16),.def(tmp_9_fu_1389_p17),.sel(empty_25_reg_1814),.dout(tmp_9_fu_1389_p19));
...
sparsemux_17_3_8_1_1_U127(.din0(path_0_q0),.din1(path_1_q0),.din2(path_2_q0),.din3(path_3_q0),.din4(path_4_q0),.din5(path_5_q0),.din6(path_6_q0),.din7(path_7_q0),.def(tmp_13_fu_1519_p17),.sel(tmp_13_fu_1519_p18),.dout(tmp_13_fu_1519_p19));
(* dissolve_hierarchy = "yes" *) viterbi_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U128(.din0(tmp_14_fu_1617_p2),.din1(tmp_14_fu_1617_p4),.din2(tmp_14_fu_1617_p6),.din3(tmp_14_fu_1617_p8),.din4(tmp_14_fu_1617_p10),.din5(tmp_14_fu_1617_p12),.din6(tmp_14_fu_1617_p14),.din7(tmp_14_fu_1617_p16),.def(tmp_14_fu_1617_p17),.sel(trunc_ln52_reg_2006),.dout(tmp_14_fu_1617_p19));
viterbi_dcmp_64ns_64ns_1_2_no_dsp_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 1 ))
dcmp_64ns_64ns_1_2_no_dsp_1_U129(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_2062_p0),.din1(grp_fu_2062_p1),.ce(grp_fu_2062_ce),.opcode(grp_fu_2062_opcode),.dout(grp_fu_2062_p2));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_2_reg_1809[10 : 3] <= tmp_147_cast_fu_1147_p1[10 : 3];
        tmp_95_reg_1804[10 : 3] <= tmp_95_fu_1139_p3[10 : 3];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state33)) begin
        ...
        tmp_96_reg_1992[10 : 3] <= tmp_96_fu_1504_p3[10 : 3];
        trunc_ln50_1_reg_2002 <= trunc_ln50_1_fu_1516_p1;
        trunc_ln52_reg_2006 <= trunc_ln52_fu_1559_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_976_min_p_42_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_42_loc_fu_200 <= grp_viterbi_Pipeline_L_prev_state_fu_976_min_p_42_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_42_loc_fu_200;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_42_loc_fu_200;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_42_loc_fu_200;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_4_d0 = min_p_42_loc_fu_200;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_5_d0 = min_p_42_loc_fu_200;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_6_d0 = min_p_42_loc_fu_200;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_7_d0 = min_p_42_loc_fu_200;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
assign tmp_147_cast_fu_1147_p1 = tmp_95_fu_1139_p3;
...
assign tmp_95_fu_1139_p3 = {{empty_24_fu_1134_p2}, {3'd0}};
assign tmp_96_fu_1504_p3 = {{trunc_ln50_reg_1946}, {3'd0}};
assign tmp_97_fu_1428_p3 = {{t_2_reg_1744}, {lshr_ln7_reg_1838}};
...
assign zext_ln33_fu_1434_p1 = tmp_97_fu_1428_p3;
assign zext_ln52_1_fu_1573_p1 = lshr_ln52_1_fu_1563_p4;
assign zext_ln52_2_fu_1511_p1 = tmp_96_fu_1504_p3;
