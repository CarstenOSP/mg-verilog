...
dadddsub_64ns_64ns_64_8_full_dsp_1_U1727(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_714_p0),.din1(grp_fu_714_p1),.opcode(grp_fu_714_opcode),.ce(1'b1),.dout(grp_fu_714_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U1728(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_718_p0),.din1(grp_fu_718_p1),.ce(1'b1),.dout(grp_fu_718_p2));
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_v192_load_1 = grp_fu_714_p2;
    end else begin
