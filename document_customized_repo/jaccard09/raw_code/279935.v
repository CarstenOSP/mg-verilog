module backprop_backprop_Pipeline_label_13 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_219782013,mux_case_119772009,mux_case_019762005,v18_i,v18_o,v18_o_ap_vld,v18_2_i,v18_2_o,v18_2_o_ap_vld,v18_1_i,v18_1_o,v18_1_o_ap_vld,v116_2_out,v116_2_out_ap_vld,mux_case_119772007_out,mux_case_119772007_out_ap_vld,v116_out,v116_out_ap_vld,grp_fu_7115_p_din0,grp_fu_7115_p_din1,grp_fu_7115_p_opcode,grp_fu_7115_p_dout0,grp_fu_7115_p_ce,grp_fu_7119_p_din0,grp_fu_7119_p_din1,grp_fu_7119_p_opcode,grp_fu_7119_p_dout0,grp_fu_7119_p_ce,grp_fu_7127_p_din0,grp_fu_7127_p_din1,grp_fu_7127_p_dout0,grp_fu_7127_p_ce,grp_fu_16115_p_din0,grp_fu_16115_p_din1,grp_fu_16115_p_dout0,grp_fu_16115_p_ce,grp_fu_16119_p_din0,grp_fu_16119_p_din1,grp_fu_16119_p_dout0,grp_fu_16119_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_219782013;
input  [63:0] mux_case_119772009;
input  [63:0] mux_case_019762005;
input  [63:0] v18_i;
output  [63:0] v18_o;
output   v18_o_ap_vld;
input  [63:0] v18_2_i;
...
output  [63:0] v116_2_out;
output   v116_2_out_ap_vld;
output  [63:0] mux_case_119772007_out;
output   mux_case_119772007_out_ap_vld;
output  [63:0] v116_out;
output   v116_out_ap_vld;
output  [63:0] grp_fu_7115_p_din0;
output  [63:0] grp_fu_7115_p_din1;
output  [0:0] grp_fu_7115_p_opcode;
input  [63:0] grp_fu_7115_p_dout0;
output   grp_fu_7115_p_ce;
output  [63:0] grp_fu_7119_p_din0;
output  [63:0] grp_fu_7119_p_din1;
output  [0:0] grp_fu_7119_p_opcode;
input  [63:0] grp_fu_7119_p_dout0;
output   grp_fu_7119_p_ce;
output  [63:0] grp_fu_7127_p_din0;
output  [63:0] grp_fu_7127_p_din1;
input  [63:0] grp_fu_7127_p_dout0;
output   grp_fu_7127_p_ce;
output  [63:0] grp_fu_16115_p_din0;
output  [63:0] grp_fu_16115_p_din1;
input  [63:0] grp_fu_16115_p_dout0;
output   grp_fu_16115_p_ce;
output  [63:0] grp_fu_16119_p_din0;
output  [63:0] grp_fu_16119_p_din1;
input  [63:0] grp_fu_16119_p_dout0;
output   grp_fu_16119_p_ce;
reg ap_idle;
reg[63:0] v18_o;
reg v18_o_ap_vld;
reg[63:0] v18_2_o;
...
reg[63:0] v18_1_o;
reg v18_1_o_ap_vld;
reg v116_2_out_ap_vld;
reg mux_case_119772007_out_ap_vld;
reg v116_out_ap_vld;
...
reg   [63:0] mux_case_119772007_fu_74;
reg   [63:0] v116_2_fu_78;
wire    ap_block_pp0_stage0_01001;
wire   [63:0] v73_fu_222_p7;
wire   [63:0] bitcast_ln144_fu_242_p1;
wire   [0:0] bit_sel3_fu_246_p3;
wire   [63:0] xor_ln3_fu_269_p3;
...
#0 v72_fu_66 = 2'd0;
#0 v116_fu_70 = 64'd0;
#0 mux_case_119772007_fu_74 = 64'd0;
#0 v116_2_fu_78 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U125(.din0(v18_i),.din1(v18_1_i),.din2(v18_2_i),.def(v73_fu_222_p7),.sel(ap_sig_allocacmp_v72_1),.dout(v73_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            v116_2_fu_78 <= mux_case_219782013;
        end else if ((1'b1 == ap_condition_1277)) begin
            v116_2_fu_78 <= v75_reg_366;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v74_reg_361 <= grp_fu_7115_p_dout0;
        v75_reg_366 <= grp_fu_7127_p_dout0;
        v77_reg_373 <= grp_fu_16119_p_dout0;
        v78_reg_378 <= grp_fu_7119_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        mux_case_119772007_out_ap_vld = 1'b1;
    end else begin
        mux_case_119772007_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        v116_2_out_ap_vld = 1'b1;
    end else begin
        v116_2_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
...
assign bit_sel3_fu_246_p3 = bitcast_ln144_fu_242_p1[64'd63];
assign bitcast_ln144_fu_242_p1 = v73_fu_222_p9;
assign grp_fu_16115_p_ce = 1'b1;
assign grp_fu_16115_p_din0 = 64'd4607182418800017408;
assign grp_fu_16115_p_din1 = v78_reg_378;
assign grp_fu_16119_p_ce = 1'b1;
assign grp_fu_16119_p_din0 = 64'd0;
assign grp_fu_16119_p_din1 = v76_fu_275_p1;
assign grp_fu_7115_p_ce = 1'b1;
assign grp_fu_7115_p_din0 = 64'd4607182418800017408;
assign grp_fu_7115_p_din1 = v73_reg_340;
assign grp_fu_7115_p_opcode = 2'd1;
assign grp_fu_7119_p_ce = 1'b1;
assign grp_fu_7119_p_din0 = v77_reg_373;
assign grp_fu_7119_p_din1 = 64'd4607182418800017408;
assign grp_fu_7119_p_opcode = 2'd0;
assign grp_fu_7127_p_ce = 1'b1;
assign grp_fu_7127_p_din0 = v73_reg_340_pp0_iter8_reg;
assign grp_fu_7127_p_din1 = v74_reg_361;
assign icmp_ln139_fu_210_p2 = ((ap_sig_allocacmp_v72_1 == 2'd3) ? 1'b1 : 1'b0);
assign mux_case_119772007_out = mux_case_119772007_fu_74;
assign trunc_ln144_fu_260_p1 = bitcast_ln144_fu_242_p1[62:0];
assign v116_2_out = v116_2_fu_78;
assign v116_out = v116_fu_70;
assign v73_fu_222_p7 = 'bx;
assign v76_fu_275_p1 = xor_ln3_fu_269_p3;
assign xor_ln144_fu_254_p2 = (bit_sel3_fu_246_p3 ^ 1'd1);
assign xor_ln3_fu_269_p3 = {{xor_ln144_reg_346}, {trunc_ln144_reg_351}};
endmodule 