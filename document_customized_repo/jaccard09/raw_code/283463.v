module backprop_backprop_Pipeline_label_33_label_34 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v11_address0,v11_ce0,v11_q0,v11_1_address0,v11_1_ce0,v11_1_q0,v11_2_address0,v11_2_ce0,v11_2_q0,v11_3_address0,v11_3_ce0,v11_3_q0,v1_address0,v1_ce0,v1_we0,v1_d0,v1_q0,v183_out,v183_out_ap_vld,grp_fu_24242_p_din0,grp_fu_24242_p_din1,grp_fu_24242_p_dout0,grp_fu_24242_p_ce); 
...
dadddsub_64ns_64ns_64_8_full_dsp_1_U471(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_166_p0),.din1(grp_fu_166_p1),.opcode(grp_fu_166_opcode),.ce(1'b1),.dout(grp_fu_166_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U473(.din0(v11_q0),.din1(v11_1_q0),.din2(v11_2_q0),.din3(v11_3_q0),.def(v184_fu_317_p9),.sel(trunc_ln296_reg_398),.dout(v184_fu_317_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v185_reg_438 <= grp_fu_24242_p_dout0;
        v1_load_reg_443 <= v1_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v187_reg_453 <= grp_fu_166_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v188_reg_460 <= grp_fu_24242_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v181_load_1 = grp_fu_166_p2;
    end else begin
...
assign add_ln298_1_fu_280_p3 = {{empty_fu_244_p1}, {lshr_ln6_fu_270_p4}};
...
assign grp_fu_24242_p_din0 = grp_fu_170_p0;
assign grp_fu_24242_p_din1 = grp_fu_170_p1;
...
assign lshr_ln6_fu_270_p4 = {{select_ln293_fu_222_p3[5:2]}};
