...
fmul_32ns_32ns_32_4_max_dsp_1_U8(.clk(ap_clk),.reset(ap_rst),.din0(v22),.din1(grp_fu_169_p1),.ce(1'b1),.dout(grp_fu_169_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((tmp_3_fu_181_p3 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v24_1_reg_359 <= grp_fu_169_p2;
        v24_reg_353 <= grp_fu_330_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((tmp_3_fu_181_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln51_1_fu_214_p4 = {{{v5}, {tmp_2_fu_204_p4}}, {1'd1}};
...
assign grp_fu_169_p1 = v0_load_1_reg_338;
assign grp_fu_330_p_ce = 1'b1;
assign grp_fu_330_p_din0 = v22;
assign grp_fu_330_p_din1 = v23_fu_256_p1;
assign icmp_ln53_fu_239_p2 = ((tmp_4_fu_229_p4 == 2'd0) ? 1'b1 : 1'b0);
assign or_ln_fu_282_p3 = {{tmp_1_fu_273_p4}, {1'd1}};
assign tmp_1_fu_273_p4 = {{v19_1_reg_309_pp0_iter5_reg[8:1]}};
assign tmp_2_fu_204_p4 = {{ap_sig_allocacmp_v19_1[9:1]}};
assign tmp_3_fu_181_p3 = ap_sig_allocacmp_v19_1[32'd10];
assign tmp_4_fu_229_p4 = {{ap_sig_allocacmp_v19_1[10:9]}};
...
assign zext_ln51_1_fu_290_p1 = or_ln_fu_282_p3;
