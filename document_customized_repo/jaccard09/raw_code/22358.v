...
wire   [11:0] tmp_255_fu_534_p3;
reg   [11:0] tmp_255_reg_734;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_130_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_130_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_323_min_s_32_out;
wire    grp_viterbi_Pipeline_L_end_fu_323_min_s_32_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_333_min_s_66_out;
wire    grp_viterbi_Pipeline_L_state_fu_333_min_s_66_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state31)) begin
        store_forwarded_fu_132 <= min_s_32_loc_fu_104;
    end else if ((1'b1 == ap_CS_fsm_state44)) begin
        store_forwarded_fu_132 <= min_s_66_loc_fu_100;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_9_reg_659[11 : 4] <= tmp_374_cast_fu_406_p1[11 : 4];
        tmp_s_reg_654[11 : 4] <= tmp_s_fu_398_p3[11 : 4];
        zext_ln19_reg_664[7 : 0] <= zext_ln19_fu_411_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_130_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_130_loc_fu_108 <= grp_viterbi_Pipeline_L_prev_state_fu_307_min_p_130_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_323_min_s_32_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_32_loc_fu_104 <= grp_viterbi_Pipeline_L_end_fu_323_min_s_32_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_333_min_s_66_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state43))) begin
        min_s_66_loc_fu_100 <= grp_viterbi_Pipeline_L_state_fu_333_min_s_66_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        tmp_255_reg_734[11 : 4] <= tmp_255_fu_534_p3[11 : 4];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_130_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_2_d0 = min_p_130_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_3_d0 = min_p_130_loc_fu_108;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        path_d0_local = min_s_66_loc_fu_100;
    end else if ((1'b1 == ap_CS_fsm_state31)) begin
        path_d0_local = min_s_32_loc_fu_104;
    end else begin
        path_d0_local = 'bx;
    end
end
...
assign tmp_255_fu_534_p3 = {{trunc_ln50_fu_530_p1}, {4'd0}};
assign tmp_256_fu_486_p3 = {{t_2_reg_622}, {lshr_ln7_reg_687}};
assign tmp_374_cast_fu_406_p1 = tmp_s_fu_398_p3;
