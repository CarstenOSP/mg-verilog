...
sparsemux_9_2_32_1_1_U20(.din0(v28_fu_221_p2),.din1(v28_fu_221_p4),.din2(v28_fu_221_p6),.din3(v28_fu_221_p8),.def(v28_fu_221_p9),.sel(trunc_ln55_reg_259_pp0_iter4_reg),.dout(v28_fu_221_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln1_reg_264 <= {{ap_sig_allocacmp_v25_4[9:2]}};
...
assign add_ln55_fu_168_p2 = (ap_sig_allocacmp_v25_4 + 11'd1);
...
assign icmp_ln55_fu_162_p2 = ((ap_sig_allocacmp_v25_4 == 11'd1024) ? 1'b1 : 1'b0);
assign trunc_ln55_fu_179_p1 = ap_sig_allocacmp_v25_4[1:0];
...
assign zext_ln55_fu_174_p1 = ap_sig_allocacmp_v25_4;
endmodule 