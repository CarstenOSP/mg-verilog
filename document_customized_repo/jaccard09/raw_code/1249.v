...
reg   [31:0] tmp_8_reg_724;
wire   [31:0] tmp_9_fu_385_p11;
reg   [31:0] tmp_9_reg_729;
...
sparsemux_9_3_32_1_1_U80(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_8_fu_361_p9),.sel(trunc_ln128_fu_358_p1),.dout(tmp_8_fu_361_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U81(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_9_fu_385_p9),.sel(trunc_ln128_fu_358_p1),.dout(tmp_9_fu_385_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_8_reg_724 <= tmp_8_fu_361_p11;
        tmp_9_reg_729 <= tmp_9_fu_385_p11;
    end
end
always @ (*) begin
...
assign add_ln130_1_fu_454_p2 = ($signed(tmp_8_reg_724) + $signed(32'd3395469782));
...
assign add_ln130_5_fu_576_p2 = ($signed(tmp_9_reg_729) + $signed(32'd3395469782));
