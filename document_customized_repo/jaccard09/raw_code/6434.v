module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_19_reload,B_6_reload,C_19_reload,D_19_reload,E_6_reload,W_address0,W_ce0,W_q0,W_2_address0,W_2_ce0,W_2_q0,W_4_address0,W_4_ce0,W_4_q0,W_6_address0,W_6_ce0,W_6_q0,W_8_address0,W_8_ce0,W_8_q0,W_10_address0,W_10_ce0,W_10_q0,W_12_address0,W_12_ce0,W_12_q0,W_14_address0,W_14_ce0,W_14_q0,W_1_address0,W_1_ce0,W_1_q0,W_3_address0,W_3_ce0,W_3_q0,W_5_address0,W_5_ce0,W_5_q0,W_7_address0,W_7_ce0,W_7_q0,W_9_address0,W_9_ce0,W_9_q0,W_11_address0,W_11_ce0,W_11_q0,W_13_address0,W_13_ce0,W_13_q0,W_15_address0,W_15_ce0,W_15_q0,A_21_out,A_21_out_ap_vld,B_11_out,B_11_out_ap_vld,E_19_out,E_19_out_ap_vld,D_21_out,D_21_out_ap_vld,E_12_out,E_12_out_ap_vld); 
...
reg   [31:0] tmp_s_reg_956;
wire   [31:0] tmp_2_fu_537_p19;
reg   [31:0] tmp_2_reg_961;
...
wire   [3:0] tmp_2_fu_537_p1;
wire   [3:0] tmp_2_fu_537_p3;
wire   [3:0] tmp_2_fu_537_p5;
wire   [3:0] tmp_2_fu_537_p7;
wire  signed [3:0] tmp_2_fu_537_p9;
wire  signed [3:0] tmp_2_fu_537_p11;
wire  signed [3:0] tmp_2_fu_537_p13;
wire  signed [3:0] tmp_2_fu_537_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_17_4_32_1_1_U99(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.din4(W_8_q0),.din5(W_10_q0),.din6(W_12_q0),.din7(W_14_q0),.def(tmp_s_fu_497_p17),.sel(trunc_ln100_fu_494_p1),.dout(tmp_s_fu_497_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h2 ),.din1_WIDTH( 32 ),.CASE2( 4'h4 ),.din2_WIDTH( 32 ),.CASE3( 4'h6 ),.din3_WIDTH( 32 ),.CASE4( 4'h8 ),.din4_WIDTH( 32 ),.CASE5( 4'hA ),.din5_WIDTH( 32 ),.CASE6( 4'hC ),.din6_WIDTH( 32 ),.CASE7( 4'hE ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_17_4_32_1_1_U100(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.din4(W_9_q0),.din5(W_11_q0),.din6(W_13_q0),.din7(W_15_q0),.def(tmp_2_fu_537_p17),.sel(trunc_ln100_fu_494_p1),.dout(tmp_2_fu_537_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_2_reg_961 <= tmp_2_fu_537_p19;
        tmp_s_reg_956 <= tmp_s_fu_497_p19;
    end
end
always @ (*) begin
...
assign D_21_out = E_4_fu_128;
assign D_4_fu_670_p3 = {{trunc_ln126_1_fu_656_p1}, {lshr_ln126_1_fu_660_p4}};
assign E_12_out = E_fu_124;
assign E_19_out = D_fu_144;
...
assign add_ln126_1_fu_633_p2 = ($signed(32'd2400959708) + $signed(tmp_s_reg_956));
...
assign add_ln126_5_fu_766_p2 = (or_ln126_6_fu_760_p3 + tmp_2_reg_961);
