...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v25_2_reg_318 <= ap_sig_allocacmp_v25_2;
...
assign add_ln55_fu_223_p2 = (ap_sig_allocacmp_v25_2 + 11'd1);
...
assign icmp_ln55_fu_217_p2 = ((ap_sig_allocacmp_v25_2 == 11'd1024) ? 1'b1 : 1'b0);
assign trunc_ln55_fu_229_p1 = ap_sig_allocacmp_v25_2[6:0];
assign v26_fu_263_p17 = 'bx;
assign v26_fu_263_p18 = {{v25_2_reg_318[9:7]}};
...
assign zext_ln55_fu_250_p1 = v25_2_reg_318;
endmodule 