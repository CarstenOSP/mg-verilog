...
output  [1:0] grp_fu_1968_p_opcode;
...
wire   [0:0] icmp_ln23_fu_1196_p2;
wire   [0:0] first_iter_1_fu_1247_p2;
reg   [0:0] first_iter_1_reg_1660;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] buff_x1_addr_reg_1664;
reg   [5:0] buff_x1_addr_reg_1664_pp0_iter1_reg;
wire   [5:0] trunc_ln23_fu_1258_p1;
reg   [5:0] trunc_ln23_reg_1669;
wire   [0:0] icmp_ln24_1_fu_1337_p2;
reg   [0:0] icmp_ln24_1_reg_1999;
reg   [0:0] icmp_ln24_1_reg_1999_pp0_iter1_reg;
reg   [31:0] buff_x1_load_reg_2003;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [31:0] tmp_fu_1353_p131;
reg   [31:0] tmp_reg_2008;
reg   [31:0] buff_y1_load_reg_2013;
reg   [31:0] mul_reg_2018;
wire    ap_block_pp0_stage6_11001;
wire    ap_block_pp0_stage7_11001;
reg   [31:0] add_reg_2028;
wire    ap_CS_fsm_pp0_stage5;
wire    ap_block_pp0_stage5_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln23_fu_1253_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln24_fu_1262_p1;
reg   [6:0] j_fu_296;
wire   [6:0] add_ln24_fu_1331_p2;
wire    ap_loop_init;
reg   [6:0] i_1_fu_300;
wire   [6:0] select_ln23_fu_1239_p3;
reg   [12:0] indvar_flatten7_fu_304;
wire   [12:0] add_ln23_1_fu_1202_p2;
...
wire   [0:0] icmp_ln24_fu_1225_p2;
wire   [6:0] add_ln23_fu_1219_p2;
...
#0 j_fu_296 = 7'd0;
#0 i_1_fu_300 = 7'd0;
#0 indvar_flatten7_fu_304 = 13'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        if ((1'b1 == ap_condition_1269)) begin
            empty_fu_308 <= buff_x1_load_reg_2003;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            empty_fu_308 <= add_reg_2028;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_1_fu_300 <= 7'd0;
    end else if (((icmp_ln23_reg_1656 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_1_fu_300 <= select_ln23_fu_1239_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln23_fu_1196_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten7_fu_304 <= add_ln23_1_fu_1202_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten7_fu_304 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        j_fu_296 <= add_ln24_fu_1331_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        add_reg_2028 <= grp_fu_1968_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_x1_addr_reg_1664 <= zext_ln23_fu_1253_p1;
        buff_x1_addr_reg_1664_pp0_iter1_reg <= buff_x1_addr_reg_1664;
        first_iter_1_reg_1660 <= first_iter_1_fu_1247_p2;
        icmp_ln24_1_reg_1999 <= icmp_ln24_1_fu_1337_p2;
        icmp_ln24_1_reg_1999_pp0_iter1_reg <= icmp_ln24_1_reg_1999;
        trunc_ln23_reg_1669 <= trunc_ln23_fu_1258_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        buff_x1_load_reg_2003 <= buff_x1_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        buff_y1_load_reg_2013 <= buff_y1_q0;
        tmp_reg_2008 <= tmp_fu_1353_p131;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln23_reg_1656 <= icmp_ln23_fu_1196_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul_reg_2018 <= grp_fu_1972_p_dout0;
    end
end
always @ (*) begin
    if (((icmp_ln23_reg_1656 == 1'd1) & (1'b0 == ap_block_pp0_stage6_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten7_load = indvar_flatten7_fu_304;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_x1_address0_local = buff_x1_addr_reg_1664_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_x1_address0_local = zext_ln23_fu_1253_p1;
    end else begin
...
always @ (*) begin
    if (((icmp_ln24_1_reg_1999_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
assign add_ln23_1_fu_1202_p2 = (ap_sig_allocacmp_indvar_flatten7_load + 13'd1);
assign add_ln23_fu_1219_p2 = (i_1_fu_300 + 7'd1);
assign add_ln24_fu_1331_p2 = (select_ln6_fu_1231_p3 + 7'd1);
...
always @ (*) begin
    ap_condition_1269 = ((icmp_ln23_reg_1656 == 1'd0) & (first_iter_1_reg_1660 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage6;
assign ap_ready = ap_ready_sig;
assign buff_A_10_address0 = zext_ln24_fu_1262_p1;
assign buff_A_10_ce0 = buff_A_10_ce0_local;
assign buff_A_11_address0 = zext_ln24_fu_1262_p1;
assign buff_A_11_ce0 = buff_A_11_ce0_local;
assign buff_A_12_address0 = zext_ln24_fu_1262_p1;
assign buff_A_12_ce0 = buff_A_12_ce0_local;
assign buff_A_13_address0 = zext_ln24_fu_1262_p1;
assign buff_A_13_ce0 = buff_A_13_ce0_local;
assign buff_A_14_address0 = zext_ln24_fu_1262_p1;
assign buff_A_14_ce0 = buff_A_14_ce0_local;
assign buff_A_15_address0 = zext_ln24_fu_1262_p1;
assign buff_A_15_ce0 = buff_A_15_ce0_local;
assign buff_A_16_address0 = zext_ln24_fu_1262_p1;
assign buff_A_16_ce0 = buff_A_16_ce0_local;
assign buff_A_17_address0 = zext_ln24_fu_1262_p1;
assign buff_A_17_ce0 = buff_A_17_ce0_local;
assign buff_A_18_address0 = zext_ln24_fu_1262_p1;
assign buff_A_18_ce0 = buff_A_18_ce0_local;
assign buff_A_19_address0 = zext_ln24_fu_1262_p1;
assign buff_A_19_ce0 = buff_A_19_ce0_local;
assign buff_A_1_address0 = zext_ln24_fu_1262_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_20_address0 = zext_ln24_fu_1262_p1;
assign buff_A_20_ce0 = buff_A_20_ce0_local;
assign buff_A_21_address0 = zext_ln24_fu_1262_p1;
assign buff_A_21_ce0 = buff_A_21_ce0_local;
assign buff_A_22_address0 = zext_ln24_fu_1262_p1;
assign buff_A_22_ce0 = buff_A_22_ce0_local;
assign buff_A_23_address0 = zext_ln24_fu_1262_p1;
assign buff_A_23_ce0 = buff_A_23_ce0_local;
assign buff_A_24_address0 = zext_ln24_fu_1262_p1;
assign buff_A_24_ce0 = buff_A_24_ce0_local;
assign buff_A_25_address0 = zext_ln24_fu_1262_p1;
assign buff_A_25_ce0 = buff_A_25_ce0_local;
assign buff_A_26_address0 = zext_ln24_fu_1262_p1;
assign buff_A_26_ce0 = buff_A_26_ce0_local;
assign buff_A_27_address0 = zext_ln24_fu_1262_p1;
assign buff_A_27_ce0 = buff_A_27_ce0_local;
assign buff_A_28_address0 = zext_ln24_fu_1262_p1;
assign buff_A_28_ce0 = buff_A_28_ce0_local;
assign buff_A_29_address0 = zext_ln24_fu_1262_p1;
assign buff_A_29_ce0 = buff_A_29_ce0_local;
assign buff_A_2_address0 = zext_ln24_fu_1262_p1;
assign buff_A_2_ce0 = buff_A_2_ce0_local;
assign buff_A_30_address0 = zext_ln24_fu_1262_p1;
assign buff_A_30_ce0 = buff_A_30_ce0_local;
assign buff_A_31_address0 = zext_ln24_fu_1262_p1;
assign buff_A_31_ce0 = buff_A_31_ce0_local;
assign buff_A_32_address0 = zext_ln24_fu_1262_p1;
assign buff_A_32_ce0 = buff_A_32_ce0_local;
assign buff_A_33_address0 = zext_ln24_fu_1262_p1;
assign buff_A_33_ce0 = buff_A_33_ce0_local;
assign buff_A_34_address0 = zext_ln24_fu_1262_p1;
assign buff_A_34_ce0 = buff_A_34_ce0_local;
assign buff_A_35_address0 = zext_ln24_fu_1262_p1;
assign buff_A_35_ce0 = buff_A_35_ce0_local;
assign buff_A_36_address0 = zext_ln24_fu_1262_p1;
assign buff_A_36_ce0 = buff_A_36_ce0_local;
assign buff_A_37_address0 = zext_ln24_fu_1262_p1;
assign buff_A_37_ce0 = buff_A_37_ce0_local;
assign buff_A_38_address0 = zext_ln24_fu_1262_p1;
assign buff_A_38_ce0 = buff_A_38_ce0_local;
assign buff_A_39_address0 = zext_ln24_fu_1262_p1;
assign buff_A_39_ce0 = buff_A_39_ce0_local;
assign buff_A_3_address0 = zext_ln24_fu_1262_p1;
assign buff_A_3_ce0 = buff_A_3_ce0_local;
assign buff_A_40_address0 = zext_ln24_fu_1262_p1;
assign buff_A_40_ce0 = buff_A_40_ce0_local;
assign buff_A_41_address0 = zext_ln24_fu_1262_p1;
assign buff_A_41_ce0 = buff_A_41_ce0_local;
assign buff_A_42_address0 = zext_ln24_fu_1262_p1;
assign buff_A_42_ce0 = buff_A_42_ce0_local;
assign buff_A_43_address0 = zext_ln24_fu_1262_p1;
assign buff_A_43_ce0 = buff_A_43_ce0_local;
assign buff_A_44_address0 = zext_ln24_fu_1262_p1;
assign buff_A_44_ce0 = buff_A_44_ce0_local;
assign buff_A_45_address0 = zext_ln24_fu_1262_p1;
assign buff_A_45_ce0 = buff_A_45_ce0_local;
assign buff_A_46_address0 = zext_ln24_fu_1262_p1;
assign buff_A_46_ce0 = buff_A_46_ce0_local;
assign buff_A_47_address0 = zext_ln24_fu_1262_p1;
assign buff_A_47_ce0 = buff_A_47_ce0_local;
assign buff_A_48_address0 = zext_ln24_fu_1262_p1;
assign buff_A_48_ce0 = buff_A_48_ce0_local;
assign buff_A_49_address0 = zext_ln24_fu_1262_p1;
assign buff_A_49_ce0 = buff_A_49_ce0_local;
assign buff_A_4_address0 = zext_ln24_fu_1262_p1;
assign buff_A_4_ce0 = buff_A_4_ce0_local;
assign buff_A_50_address0 = zext_ln24_fu_1262_p1;
assign buff_A_50_ce0 = buff_A_50_ce0_local;
assign buff_A_51_address0 = zext_ln24_fu_1262_p1;
assign buff_A_51_ce0 = buff_A_51_ce0_local;
assign buff_A_52_address0 = zext_ln24_fu_1262_p1;
assign buff_A_52_ce0 = buff_A_52_ce0_local;
assign buff_A_53_address0 = zext_ln24_fu_1262_p1;
assign buff_A_53_ce0 = buff_A_53_ce0_local;
assign buff_A_54_address0 = zext_ln24_fu_1262_p1;
assign buff_A_54_ce0 = buff_A_54_ce0_local;
assign buff_A_55_address0 = zext_ln24_fu_1262_p1;
assign buff_A_55_ce0 = buff_A_55_ce0_local;
assign buff_A_56_address0 = zext_ln24_fu_1262_p1;
assign buff_A_56_ce0 = buff_A_56_ce0_local;
assign buff_A_57_address0 = zext_ln24_fu_1262_p1;
assign buff_A_57_ce0 = buff_A_57_ce0_local;
assign buff_A_58_address0 = zext_ln24_fu_1262_p1;
assign buff_A_58_ce0 = buff_A_58_ce0_local;
assign buff_A_59_address0 = zext_ln24_fu_1262_p1;
assign buff_A_59_ce0 = buff_A_59_ce0_local;
assign buff_A_5_address0 = zext_ln24_fu_1262_p1;
assign buff_A_5_ce0 = buff_A_5_ce0_local;
assign buff_A_60_address0 = zext_ln24_fu_1262_p1;
assign buff_A_60_ce0 = buff_A_60_ce0_local;
assign buff_A_61_address0 = zext_ln24_fu_1262_p1;
assign buff_A_61_ce0 = buff_A_61_ce0_local;
assign buff_A_62_address0 = zext_ln24_fu_1262_p1;
assign buff_A_62_ce0 = buff_A_62_ce0_local;
assign buff_A_63_address0 = zext_ln24_fu_1262_p1;
assign buff_A_63_ce0 = buff_A_63_ce0_local;
assign buff_A_6_address0 = zext_ln24_fu_1262_p1;
assign buff_A_6_ce0 = buff_A_6_ce0_local;
assign buff_A_7_address0 = zext_ln24_fu_1262_p1;
assign buff_A_7_ce0 = buff_A_7_ce0_local;
assign buff_A_8_address0 = zext_ln24_fu_1262_p1;
assign buff_A_8_ce0 = buff_A_8_ce0_local;
assign buff_A_9_address0 = zext_ln24_fu_1262_p1;
assign buff_A_9_ce0 = buff_A_9_ce0_local;
assign buff_A_address0 = zext_ln24_fu_1262_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_x1_address0 = buff_x1_address0_local;
assign buff_x1_ce0 = buff_x1_ce0_local;
assign buff_x1_d0 = add_reg_2028;
assign buff_x1_we0 = buff_x1_we0_local;
assign buff_y1_address0 = zext_ln24_fu_1262_p1;
...
assign grp_fu_1968_p_din0 = empty_fu_308;
assign grp_fu_1968_p_din1 = mul_reg_2018;
assign grp_fu_1968_p_opcode = 2'd0;
assign grp_fu_1972_p_ce = 1'b1;
assign grp_fu_1972_p_din0 = tmp_reg_2008;
assign grp_fu_1972_p_din1 = buff_y1_load_reg_2013;
assign icmp_ln23_fu_1196_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln24_1_fu_1337_p2 = ((add_ln24_fu_1331_p2 == 7'd64) ? 1'b1 : 1'b0);
assign icmp_ln24_fu_1225_p2 = ((j_fu_296 == 7'd64) ? 1'b1 : 1'b0);
assign select_ln23_fu_1239_p3 = ((icmp_ln24_fu_1225_p2[0:0] == 1'b1) ? add_ln23_fu_1219_p2 : i_1_fu_300);
assign select_ln6_fu_1231_p3 = ((icmp_ln24_fu_1225_p2[0:0] == 1'b1) ? 7'd0 : j_fu_296);
assign tmp_fu_1353_p129 = 'bx;
assign trunc_ln23_fu_1258_p1 = select_ln23_fu_1239_p3[5:0];
assign zext_ln23_fu_1253_p1 = select_ln23_fu_1239_p3;
assign zext_ln24_fu_1262_p1 = select_ln6_fu_1231_p3;
endmodule 