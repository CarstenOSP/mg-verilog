...
wire   [63:0] tmp_48_fu_372_p9;
reg   [63:0] tmp_48_reg_566;
...
wire   [1:0] tmp_47_fu_329_p1;
wire   [1:0] tmp_47_fu_329_p3;
wire  signed [1:0] tmp_47_fu_329_p5;
wire   [1:0] tmp_48_fu_372_p1;
wire   [1:0] tmp_48_fu_372_p3;
wire  signed [1:0] tmp_48_fu_372_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_7_2_64_1_1_U502(.din0(mux_case_02736_reload),.din1(mux_case_12840_reload),.din2(mux_case_22944_reload),.def(tmp_47_fu_329_p7),.sel(i_13_reg_526_pp0_iter1_reg),.dout(tmp_47_fu_329_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U503(.din0(mux_case_03048_reload),.din1(mux_case_13152_reload),.din2(mux_case_23256_reload),.def(tmp_48_fu_372_p7),.sel(i_13_reg_526_pp0_iter8_reg),.dout(tmp_48_fu_372_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_48_reg_566 <= tmp_48_fu_372_p9;
...
assign grp_fu_10475_p_din0 = tmp_47_fu_329_p9;
...
assign grp_fu_10483_p_din1 = tmp_48_reg_566;
...
assign tmp_47_fu_329_p7 = 'bx;
assign tmp_48_fu_372_p7 = 'bx;
