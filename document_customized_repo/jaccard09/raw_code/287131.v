module backprop_backprop_Pipeline_label_16 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_291120,mux_case_190116,mux_case_089112,mux_case_03695_reload,mux_case_13799_reload,mux_case_238103_reload,empty,v7_0_address0,v7_0_ce0,v7_0_q0,v7_1_address0,v7_1_ce0,v7_1_q0,v75,v75_3,v75_4,mux_case_291118_out,mux_case_291118_out_ap_vld,mux_case_190114_out,mux_case_190114_out_ap_vld,mux_case_089110_out,mux_case_089110_out_ap_vld,grp_fu_2831_p_din0,grp_fu_2831_p_din1,grp_fu_2831_p_opcode,grp_fu_2831_p_dout0,grp_fu_2831_p_ce,grp_fu_2849_p_din0,grp_fu_2849_p_din1,grp_fu_2849_p_dout0,grp_fu_2849_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_291120;
input  [63:0] mux_case_190116;
input  [63:0] mux_case_089112;
input  [63:0] mux_case_03695_reload;
input  [63:0] mux_case_13799_reload;
input  [63:0] mux_case_238103_reload;
input  [8:0] empty;
...
input  [63:0] v75_3;
input  [63:0] v75_4;
output  [63:0] mux_case_291118_out;
output   mux_case_291118_out_ap_vld;
output  [63:0] mux_case_190114_out;
output   mux_case_190114_out_ap_vld;
output  [63:0] mux_case_089110_out;
output   mux_case_089110_out_ap_vld;
...
reg ap_idle;
reg mux_case_291118_out_ap_vld;
reg mux_case_190114_out_ap_vld;
reg mux_case_089110_out_ap_vld;
...
reg   [63:0] mux_case_089110_fu_88;
...
reg   [63:0] mux_case_190114_fu_92;
reg   [63:0] mux_case_291118_fu_96;
...
#0 v93_fu_84 = 2'd0;
#0 mux_case_089110_fu_88 = 64'd0;
#0 mux_case_190114_fu_92 = 64'd0;
#0 mux_case_291118_fu_96 = 64'd0;
#0 ap_done_reg = 1'b0;
end
backprop_urem_9ns_9ns_9_13_1 #(.ID( 1 ),.NUM_STAGE( 13 ),.din0_WIDTH( 9 ),.din1_WIDTH( 9 ),.dout_WIDTH( 9 ))
urem_9ns_9ns_9_13_1_U231(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_260_p0),.din1(9'd245),.ce(1'b1),.dout(grp_fu_260_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U232(.din0(mux_case_03695_reload),.din1(mux_case_13799_reload),.din2(mux_case_238103_reload),.def(v94_fu_295_p7),.sel(v93_1_reg_447_pp0_iter13_reg),.dout(v94_fu_295_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U233(.din0(v75),.din1(v75_3),.din2(v75_4),.def(v98_fu_338_p7),.sel(v93_1_reg_447_pp0_iter20_reg),.dout(v98_fu_338_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_291118_fu_96 <= mux_case_291120;
        end else if ((1'b1 == ap_condition_781)) begin
            mux_case_291118_fu_96 <= v13_reg_513;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v13_reg_513 <= grp_fu_2849_p_dout0;
...
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter28_reg == 1'b1) & (icmp_ln168_reg_453_pp0_iter27_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_089110_out_ap_vld = 1'b1;
    end else begin
        mux_case_089110_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter28_reg == 1'b1) & (icmp_ln168_reg_453_pp0_iter27_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_190114_out_ap_vld = 1'b1;
    end else begin
        mux_case_190114_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter28_reg == 1'b1) & (icmp_ln168_reg_453_pp0_iter27_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_291118_out_ap_vld = 1'b1;
    end else begin
        mux_case_291118_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
...
assign bit_sel_fu_320_p3 = bitcast_ln172_fu_316_p1[64'd63];
assign bitcast_ln172_fu_316_p1 = grp_fu_2831_p_dout0;
assign grp_fu_260_p0 = (zext_ln168_fu_250_p1 + empty);
assign grp_fu_2831_p_ce = 1'b1;
assign grp_fu_2831_p_din0 = v94_fu_295_p9;
assign grp_fu_2831_p_din1 = v95_fu_312_p1;
assign grp_fu_2831_p_opcode = 2'd1;
assign grp_fu_2849_p_ce = 1'b1;
assign grp_fu_2849_p_din0 = v97_fu_360_p1;
assign grp_fu_2849_p_din1 = v98_reg_503;
...
assign mux_case_089110_out = mux_case_089110_fu_88;
assign mux_case_190114_out = mux_case_190114_fu_92;
assign mux_case_291118_out = mux_case_291118_fu_96;
...
assign xor_ln172_fu_328_p2 = (bit_sel_fu_320_p3 ^ 1'd1);
