...
urem_8ns_8ns_8_12_1_U263(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_286_p0),.din1(8'd96),.ce(1'b1),.dout(grp_fu_286_p2));
backprop_urem_8ns_8ns_8_12_1 #(.ID( 1 ),.NUM_STAGE( 12 ),.din0_WIDTH( 8 ),.din1_WIDTH( 8 ),.dout_WIDTH( 8 ))
urem_8ns_8ns_8_12_1_U264(.clk(ap_clk),.reset(ap_rst),.din0(add_ln199_1_reg_437),.din1(8'd96),.ce(1'b1),.dout(grp_fu_328_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        v121_4_reg_512 <= grp_fu_1928_p_dout0;
...
assign grp_fu_1924_p_din0 = grp_fu_182_p0;
assign grp_fu_1924_p_din1 = grp_fu_182_p1;
assign grp_fu_1924_p_opcode = 2'd0;
assign grp_fu_1928_p_ce = 1'b1;
assign grp_fu_1928_p_din0 = v121_3_reg_497_pp0_iter10_reg;
assign grp_fu_1928_p_din1 = v119_1_reg_502;
assign grp_fu_1928_p_opcode = 2'd0;
assign grp_fu_1932_p_ce = 1'b1;
assign grp_fu_1932_p_din0 = grp_fu_191_p0;
assign grp_fu_1932_p_din1 = grp_fu_191_p1;
assign grp_fu_1936_p_ce = 1'b1;
assign grp_fu_1936_p_din0 = grp_fu_195_p0;
assign grp_fu_1936_p_din1 = grp_fu_195_p1;
