...
reg   [1:0] i_10_reg_567;
reg   [1:0] i_10_reg_567_pp0_iter1_reg;
reg   [1:0] i_10_reg_567_pp0_iter2_reg;
reg   [1:0] i_10_reg_567_pp0_iter3_reg;
reg   [1:0] i_10_reg_567_pp0_iter4_reg;
reg   [1:0] i_10_reg_567_pp0_iter5_reg;
reg   [1:0] i_10_reg_567_pp0_iter6_reg;
reg   [1:0] i_10_reg_567_pp0_iter7_reg;
reg   [1:0] i_10_reg_567_pp0_iter8_reg;
reg   [1:0] i_10_reg_567_pp0_iter9_reg;
reg   [1:0] i_10_reg_567_pp0_iter10_reg;
reg   [1:0] i_10_reg_567_pp0_iter11_reg;
reg   [1:0] i_10_reg_567_pp0_iter12_reg;
reg   [1:0] i_10_reg_567_pp0_iter13_reg;
reg   [1:0] i_10_reg_567_pp0_iter14_reg;
reg   [1:0] i_10_reg_567_pp0_iter15_reg;
reg   [1:0] i_10_reg_567_pp0_iter16_reg;
...
sparsemux_7_2_64_1_1_U139(.din0(mux_case_0152161_reload),.din1(mux_case_1153165_reload),.din2(mux_case_2154169_reload),.def(tmp_9_fu_370_p7),.sel(i_10_reg_567_pp0_iter1_reg),.dout(tmp_9_fu_370_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U140(.din0(mux_case_0155173_reload),.din1(mux_case_1156177_reload),.din2(mux_case_2157181_reload),.def(tmp_10_fu_413_p7),.sel(i_10_reg_567_pp0_iter8_reg),.dout(tmp_10_fu_413_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_10_reg_567_pp0_iter16_reg == 2'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((ap_enable_reg_pp0_iter17 == 1'b1) & (i_10_reg_567_pp0_iter16_reg == 2'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_10_reg_567_pp0_iter10_reg <= i_10_reg_567_pp0_iter9_reg;
        i_10_reg_567_pp0_iter11_reg <= i_10_reg_567_pp0_iter10_reg;
        i_10_reg_567_pp0_iter12_reg <= i_10_reg_567_pp0_iter11_reg;
        i_10_reg_567_pp0_iter13_reg <= i_10_reg_567_pp0_iter12_reg;
        i_10_reg_567_pp0_iter14_reg <= i_10_reg_567_pp0_iter13_reg;
        i_10_reg_567_pp0_iter15_reg <= i_10_reg_567_pp0_iter14_reg;
        i_10_reg_567_pp0_iter16_reg <= i_10_reg_567_pp0_iter15_reg;
        i_10_reg_567_pp0_iter2_reg <= i_10_reg_567_pp0_iter1_reg;
        i_10_reg_567_pp0_iter3_reg <= i_10_reg_567_pp0_iter2_reg;
        i_10_reg_567_pp0_iter4_reg <= i_10_reg_567_pp0_iter3_reg;
        i_10_reg_567_pp0_iter5_reg <= i_10_reg_567_pp0_iter4_reg;
        i_10_reg_567_pp0_iter6_reg <= i_10_reg_567_pp0_iter5_reg;
        i_10_reg_567_pp0_iter7_reg <= i_10_reg_567_pp0_iter6_reg;
        i_10_reg_567_pp0_iter8_reg <= i_10_reg_567_pp0_iter7_reg;
        i_10_reg_567_pp0_iter9_reg <= i_10_reg_567_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_10_reg_567 <= ap_sig_allocacmp_i_10;
        i_10_reg_567_pp0_iter1_reg <= i_10_reg_567;
...
assign add_ln66_fu_322_p2 = (ap_sig_allocacmp_i_10 + 2'd1);
...
always @ (*) begin
    ap_condition_626 = (~(i_10_reg_567_pp0_iter16_reg == 2'd1) & ~(i_10_reg_567_pp0_iter16_reg == 2'd0) & (ap_enable_reg_pp0_iter17 == 1'b1));
end
...
assign icmp_ln66_fu_316_p2 = ((ap_sig_allocacmp_i_10 == 2'd3) ? 1'b1 : 1'b0);
...
assign zext_ln67_fu_328_p1 = ap_sig_allocacmp_i_10;
endmodule 