...
reg   [11:0] indvar_flatten20_fu_116;
...
#0 j_fu_108 = 7'd0;
#0 i_fu_112 = 7'd0;
#0 indvar_flatten20_fu_116 = 12'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_9_3_32_1_1_U3442(.din0(buff_D_q0),.din1(buff_D_2_q0),.din2(buff_D_4_q0),.din3(buff_D_6_q0),.def(tmp_2_fu_579_p9),.sel(trunc_ln44_1_reg_702),.dout(tmp_2_fu_579_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U3443(.din0(buff_D_1_q0),.din1(buff_D_3_q0),.din2(buff_D_5_q0),.din3(buff_D_7_q0),.def(tmp_4_fu_602_p9),.sel(trunc_ln44_1_reg_702),.dout(tmp_4_fu_602_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U3444(.din0(tmp2_q0),.din1(tmp2_2_q0),.din2(tmp2_4_q0),.din3(tmp2_6_q0),.def(tmp_1_fu_625_p9),.sel(trunc_ln44_1_reg_702_pp0_iter5_reg),.dout(tmp_1_fu_625_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U3445(.din0(tmp2_1_q0),.din1(tmp2_3_q0),.din2(tmp2_5_q0),.din3(tmp2_7_q0),.def(tmp_3_fu_648_p9),.sel(trunc_ln44_1_reg_702_pp0_iter5_reg),.dout(tmp_3_fu_648_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln43_fu_472_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten20_fu_116 <= add_ln43_1_fu_478_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten20_fu_116 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add127_1_reg_848 <= grp_fu_7722_p_dout0;
        add2_reg_840 <= grp_fu_7718_p_dout0;
        ...
        mul126_1_reg_835 <= grp_fu_7978_p_dout0;
        mul3_reg_825 <= grp_fu_7974_p_dout0;
...
assign add_ln43_1_fu_478_p2 = (ap_sig_allocacmp_indvar_flatten20_load + 12'd1);
...
assign grp_fu_7718_p_din0 = tmp_1_reg_820;
assign grp_fu_7718_p_din1 = mul3_reg_825;
assign grp_fu_7718_p_opcode = 2'd0;
assign grp_fu_7722_p_ce = 1'b1;
assign grp_fu_7722_p_din0 = tmp_3_reg_830;
assign grp_fu_7722_p_din1 = mul126_1_reg_835;
assign grp_fu_7722_p_opcode = 2'd0;
assign grp_fu_7974_p_ce = 1'b1;
assign grp_fu_7974_p_din0 = tmp_2_reg_770;
assign grp_fu_7974_p_din1 = beta;
assign grp_fu_7978_p_ce = 1'b1;
assign grp_fu_7978_p_din0 = tmp_4_reg_775;
assign grp_fu_7978_p_din1 = beta;
assign icmp_ln43_fu_472_p2 = ((ap_sig_allocacmp_indvar_flatten20_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_3_fu_533_p4 = {{select_ln6_fu_509_p3[5:3]}};
...
assign tmp_s_fu_543_p3 = {{trunc_ln44_fu_525_p1}, {lshr_ln6_3_fu_533_p4}};
