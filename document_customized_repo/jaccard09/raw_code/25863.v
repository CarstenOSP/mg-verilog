...
wire   [63:0] grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_30_out;
wire    grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_30_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln25_fu_255_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        cnt_4_reg_169 <= grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_30_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((icmp_ln25_reg_331 == 1'd1) & (1'b1 == ap_CS_fsm_state7))) begin
        ap_phi_mux_cnt_4_phi_fu_173_p4 = grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_30_out;
    end else begin
