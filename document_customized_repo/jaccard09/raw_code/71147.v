...
dmul_64ns_64ns_64_7_max_dsp_1_U239(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_292_p0),.din1(p_reload86),.ce(1'b1),.dout(grp_fu_292_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U240(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_296_p0),.din1(p_reload85),.ce(1'b1),.dout(grp_fu_296_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U241(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_300_p0),.din1(p_reload),.ce(1'b1),.dout(grp_fu_300_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U242(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_304_p0),.din1(p_reload86),.ce(1'b1),.dout(grp_fu_304_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U243(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_308_p0),.din1(p_reload85),.ce(1'b1),.dout(grp_fu_308_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U244(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_312_p0),.din1(p_reload),.ce(1'b1),.dout(grp_fu_312_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_7_reg_594 <= ap_sig_allocacmp_i_7;
        lshr_ln1_reg_673 <= {{empty_fu_423_p2[7:2]}};
        lshr_ln_reg_604 <= {{ap_sig_allocacmp_i_7[5:2]}};
        ...
        tmp_reg_600 <= ap_sig_allocacmp_i_7[32'd6];
...
assign add_ln73_fu_395_p2 = (i_7_reg_594 + 7'd4);
...
assign empty_91_fu_506_p2 = (empty_reg_664 + 8'd3);
assign empty_92_fu_547_p2 = (empty_reg_664 + 8'd6);
...
assign lshr_ln75_3_fu_511_p4 = {{empty_91_fu_506_p2[7:2]}};
assign lshr_ln75_4_fu_532_p4 = {{add_ln75_2_fu_527_p2[7:2]}};
assign lshr_ln75_5_fu_552_p4 = {{empty_92_fu_547_p2[7:2]}};
assign lshr_ln_fu_368_p4 = {{ap_sig_allocacmp_i_7[5:2]}};
assign or_ln1_fu_405_p3 = {{tmp_s_reg_637_pp0_iter3_reg}, {1'd1}};
assign or_ln73_cast_fu_412_p1 = or_ln1_fu_405_p3;
