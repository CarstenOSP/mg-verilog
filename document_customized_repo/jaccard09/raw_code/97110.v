...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln29_fu_117_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten13_fu_52 <= add_ln29_1_fu_123_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_272 <= grp_fu_1004_p_dout0;
        ...
        mul2_reg_262 <= grp_fu_1008_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln29_1_fu_123_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 13'd1);
assign add_ln29_fu_140_p2 = (i_fu_48 + 7'd1);
assign add_ln30_fu_190_p2 = (select_ln5_fu_152_p3 + 7'd1);
assign add_ln32_fu_184_p2 = (tmp_2_fu_172_p3 + zext_ln32_fu_180_p1);
...
assign grp_fu_1004_p_din0 = buff_C_out_load_reg_267;
assign grp_fu_1004_p_din1 = mul2_reg_262;
assign grp_fu_1004_p_opcode = 2'd0;
assign grp_fu_1008_p_ce = 1'b1;
assign grp_fu_1008_p_din0 = buff_B_load_reg_257;
assign grp_fu_1008_p_din1 = beta;
assign icmp_ln29_fu_117_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 13'd4096) ? 1'b1 : 1'b0);
...
assign tmp_2_fu_172_p3 = {{trunc_ln32_fu_168_p1}, {6'd0}};
