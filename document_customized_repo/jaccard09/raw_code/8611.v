module sha_stream_sha_transform_Pipeline_trans_lp6 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,B_23_reload,B_20_reload,D_23_reload,E_23_reload,E_20_reload,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,W_2_address0,W_2_ce0,W_2_q0,W_3_address0,W_3_ce0,W_3_q0,W_4_address0,W_4_ce0,W_4_q0,W_5_address0,W_5_ce0,W_5_q0,W_6_address0,W_6_ce0,W_6_q0,W_7_address0,W_7_ce0,W_7_q0,A_24_out,A_24_out_ap_vld,B_21_out,B_21_out_ap_vld,C_22_out,C_22_out_ap_vld,D_24_out,D_24_out_ap_vld,E_21_out,E_21_out_ap_vld); 
...
reg    W_6_ce0_local;
reg    W_7_ce0_local;
wire   [3:0] lshr_ln100_7_fu_344_p4;
...
sparsemux_17_3_32_1_1_U78(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.din4(W_4_q0),.din5(W_5_q0),.din6(W_6_q0),.din7(W_7_q0),.def(tmp_s_fu_377_p17),.sel(trunc_ln128_reg_590),.dout(tmp_s_fu_377_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_s_reg_635 <= tmp_s_fu_377_p19;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter3_reg == 1'b1) & (icmp_ln128_reg_586_pp0_iter2_reg == 1'd1))) begin
        E_21_out_ap_vld = 1'b1;
    end else begin
        E_21_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
...
assign A_24_out = B_1_fu_128;
assign B_21_out = B_fu_112;
assign C_1_fu_462_p3 = {{trunc_ln130_1_fu_448_p1}, {lshr_ln130_1_fu_452_p4}};
assign C_22_out = C_reg_646;
assign D_24_out = D_3_reg_640;
assign E_21_out = E_fu_108;
...
assign add_ln130_1_fu_437_p2 = ($signed(tmp_s_reg_635) + $signed(32'd3395469782));
...
assign lshr_ln100_7_fu_344_p4 = {{ap_sig_allocacmp_i_1[6:3]}};
assign lshr_ln130_1_fu_452_p4 = {{ap_sig_allocacmp_B_load_1[31:2]}};
assign lshr_ln6_fu_491_p4 = {{B_1_fu_128[31:27]}};
assign or_ln2_fu_501_p3 = {{trunc_ln130_fu_487_p1}, {lshr_ln6_fu_491_p4}};
...
assign zext_ln100_fu_354_p1 = lshr_ln100_7_fu_344_p4;
endmodule 