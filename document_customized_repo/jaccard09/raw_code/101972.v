module gesummv_gesummv_Pipeline_lp1_lp2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_A_address0,buff_A_ce0,buff_A_q0,buff_A_address1,buff_A_ce1,buff_A_q1,buff_A_1_address0,buff_A_1_ce0,buff_A_1_q0,buff_A_1_address1,buff_A_1_ce1,buff_A_1_q1,alpha,buff_x_address0,buff_x_ce0,buff_x_q0,buff_x_1_address0,buff_x_1_ce0,buff_x_1_q0,buff_x_2_address0,buff_x_2_ce0,buff_x_2_q0,buff_x_3_address0,buff_x_3_ce0,buff_x_3_q0,tmp1_address0,tmp1_ce0,tmp1_we0,tmp1_d0,tmp1_q0,grp_fu_200_p_din0,grp_fu_200_p_din1,grp_fu_200_p_opcode,grp_fu_200_p_dout0,grp_fu_200_p_ce,grp_fu_204_p_din0,grp_fu_204_p_din1,grp_fu_204_p_dout0,grp_fu_204_p_ce); 
...
reg   [6:0] select_ln6_reg_462;
wire   [0:0] first_iter_1_fu_292_p2;
reg   [0:0] first_iter_1_reg_468;
wire   [3:0] lshr_ln6_1_fu_298_p4;
reg   [3:0] lshr_ln6_1_reg_472;
reg   [5:0] tmp1_addr_reg_497;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] tmp1_addr_reg_497_pp0_iter1_reg;
reg   [31:0] buff_x_load_reg_512;
reg   [31:0] buff_x_1_load_reg_517;
reg   [31:0] buff_x_2_load_reg_532;
reg   [31:0] buff_x_3_load_reg_537;
reg   [31:0] arrayidx45_promoted_reg_542;
reg   [31:0] buff_A_load_reg_547;
reg   [31:0] buff_A_1_load_reg_552;
reg   [31:0] buff_A_load_1_reg_557;
reg   [31:0] buff_A_1_load_1_reg_562;
reg   [0:0] tmp_5_reg_572;
wire    ap_block_pp0_stage28_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln6_fu_308_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln25_fu_341_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln27_fu_363_p1;
wire   [63:0] zext_ln27_1_fu_378_p1;
reg   [6:0] j_fu_68;
wire   [6:0] add_ln26_fu_397_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_1_fu_72;
wire   [6:0] select_ln25_fu_330_p3;
reg   [10:0] indvar_flatten8_fu_76;
wire   [10:0] add_ln25_1_fu_267_p2;
...
wire   [5:0] empty_fu_337_p1;
wire   [4:0] lshr_ln6_2_fu_346_p4;
wire   [10:0] tmp_2_fu_355_p3;
wire   [10:0] tmp_4_fu_369_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_759)) begin
            add16_fu_80 <= arrayidx45_promoted_reg_542;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_1_fu_72 <= 7'd0;
    end else if (((icmp_ln25_reg_453 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_1_fu_72 <= select_ln25_fu_330_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln25_fu_261_p2 == 1'd0))) begin
            indvar_flatten8_fu_76 <= add_ln25_1_fu_267_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten8_fu_76 <= 11'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_68 <= 7'd0;
    end else if (((icmp_ln25_reg_453 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_fu_68 <= add_ln26_fu_397_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx45_promoted_reg_542 <= tmp1_q0;
        buff_A_1_load_1_reg_562 <= buff_A_1_q0;
        buff_A_1_load_reg_552 <= buff_A_1_q1;
        buff_A_load_1_reg_557 <= buff_A_q0;
        buff_A_load_reg_547 <= buff_A_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_x_1_load_reg_517 <= buff_x_1_q0;
        buff_x_2_load_reg_532 <= buff_x_2_q0;
        buff_x_3_load_reg_537 <= buff_x_3_q0;
        buff_x_load_reg_512 <= buff_x_q0;
        tmp1_addr_reg_497 <= zext_ln25_fu_341_p1;
        tmp1_addr_reg_497_pp0_iter1_reg <= tmp1_addr_reg_497;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_1_reg_468 <= first_iter_1_fu_292_p2;
        icmp_ln25_reg_453 <= icmp_ln25_fu_261_p2;
        lshr_ln6_1_reg_472 <= {{select_ln6_fu_284_p3[5:2]}};
        select_ln6_reg_462 <= select_ln6_fu_284_p3;
        tmp_reg_457 <= ap_sig_allocacmp_j_load[32'd6];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage24_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage24)) | ((1'b0 == ap_block_pp0_stage17_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage17)) | ((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9)))) begin
        reg_237 <= grp_fu_200_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_5_reg_572 <= add_ln26_fu_397_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln25_reg_453 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten8_load = indvar_flatten8_fu_76;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3)) | ((1'b0 == ap_block_pp0_stage25) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage25)) | ((1'b0 == ap_block_pp0_stage18) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage18)))) begin
        grp_fu_205_p0 = reg_237;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        grp_fu_205_p0 = add16_fu_80;
    end else begin
        grp_fu_205_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_205_p1 = reg_231;
    end else if (((1'b0 == ap_block_pp0_stage25) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage25))) begin
        grp_fu_205_p1 = reg_225;
    end else if (((1'b0 == ap_block_pp0_stage18) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage18))) begin
        grp_fu_205_p1 = reg_219;
    end else if (((1'b0 == ap_block_pp0_stage11) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        grp_fu_205_p1 = reg_213;
    end else begin
        grp_fu_205_p1 = 'bx;
    end
end
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage10) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
            grp_fu_209_p0 = reg_231;
        end else if (((1'b0 == ap_block_pp0_stage9) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
            grp_fu_209_p0 = reg_225;
        end else if (((1'b0 == ap_block_pp0_stage8) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
            grp_fu_209_p0 = reg_219;
        end else if (((1'b0 == ap_block_pp0_stage7) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
            grp_fu_209_p0 = reg_213;
        end else if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
            grp_fu_209_p0 = buff_A_1_load_1_reg_562;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_209_p0 = buff_A_load_1_reg_557;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_209_p0 = buff_A_1_load_reg_552;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_209_p0 = buff_A_load_reg_547;
        end else begin
            grp_fu_209_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        grp_fu_209_p1 = buff_x_3_load_reg_537;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_209_p1 = buff_x_2_load_reg_532;
    end else if (((1'b0 == ap_block_pp0_stage8) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        grp_fu_209_p1 = buff_x_1_load_reg_517;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        grp_fu_209_p1 = buff_x_load_reg_512;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_address0_local = tmp1_addr_reg_497_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp1_address0_local = zext_ln25_fu_341_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_5_reg_572 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_we0_local = 1'b1;
    end else begin
        tmp1_we0_local = 1'b0;
    end
...
assign add_ln25_1_fu_267_p2 = (ap_sig_allocacmp_indvar_flatten8_load + 11'd1);
assign add_ln25_fu_324_p2 = (i_1_fu_72 + 7'd1);
assign add_ln26_fu_397_p2 = (select_ln6_reg_462 + 7'd4);
...
always @ (*) begin
    ap_condition_759 = ((icmp_ln25_reg_453 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_468 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_A_1_address0 = zext_ln27_1_fu_378_p1;
assign buff_A_1_address1 = zext_ln27_fu_363_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_1_ce1 = buff_A_1_ce1_local;
assign buff_A_address0 = zext_ln27_1_fu_378_p1;
assign buff_A_address1 = zext_ln27_fu_363_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_A_ce1 = buff_A_ce1_local;
assign buff_x_1_address0 = zext_ln6_fu_308_p1;
assign buff_x_1_ce0 = buff_x_1_ce0_local;
assign buff_x_2_address0 = zext_ln6_fu_308_p1;
assign buff_x_2_ce0 = buff_x_2_ce0_local;
assign buff_x_3_address0 = zext_ln6_fu_308_p1;
assign buff_x_3_ce0 = buff_x_3_ce0_local;
assign buff_x_address0 = zext_ln6_fu_308_p1;
assign buff_x_ce0 = buff_x_ce0_local;
assign empty_fu_337_p1 = select_ln25_fu_330_p3[5:0];
assign first_iter_1_fu_292_p2 = ((select_ln6_fu_284_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_200_p_ce = 1'b1;
assign grp_fu_200_p_din0 = grp_fu_205_p0;
assign grp_fu_200_p_din1 = grp_fu_205_p1;
assign grp_fu_200_p_opcode = 2'd0;
assign grp_fu_204_p_ce = 1'b1;
assign grp_fu_204_p_din0 = grp_fu_209_p0;
assign grp_fu_204_p_din1 = grp_fu_209_p1;
assign icmp_ln25_fu_261_p2 = ((ap_sig_allocacmp_indvar_flatten8_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln6_1_fu_298_p4 = {{select_ln6_fu_284_p3[5:2]}};
assign lshr_ln6_2_fu_346_p4 = {{select_ln6_reg_462[5:1]}};
assign select_ln25_fu_330_p3 = ((tmp_reg_457[0:0] == 1'b1) ? add_ln25_fu_324_p2 : i_1_fu_72);
assign select_ln6_fu_284_p3 = ((tmp_fu_276_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp1_address0 = tmp1_address0_local;
assign tmp1_ce0 = tmp1_ce0_local;
assign tmp1_d0 = reg_237;
assign tmp1_we0 = tmp1_we0_local;
assign tmp_2_fu_355_p3 = {{empty_fu_337_p1}, {lshr_ln6_2_fu_346_p4}};
assign tmp_4_fu_369_p4 = {{{empty_fu_337_p1}, {lshr_ln6_1_reg_472}}, {1'd1}};
assign tmp_fu_276_p3 = ap_sig_allocacmp_j_load[32'd6];
assign zext_ln25_fu_341_p1 = select_ln25_fu_330_p3;
assign zext_ln27_1_fu_378_p1 = tmp_4_fu_369_p4;
assign zext_ln27_fu_363_p1 = tmp_2_fu_355_p3;
assign zext_ln6_fu_308_p1 = lshr_ln6_1_fu_298_p4;
endmodule 