...
wire   [31:0] tmp_2_fu_361_p11;
reg   [31:0] tmp_2_reg_724;
...
reg    W_5_ce0_local;
reg    W_7_ce0_local;
wire   [3:0] lshr_ln100_s_fu_332_p4;
wire   [31:0] tmp_2_fu_361_p9;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_2_fu_361_p1;
wire   [2:0] tmp_2_fu_361_p3;
wire  signed [2:0] tmp_2_fu_361_p5;
wire  signed [2:0] tmp_2_fu_361_p7;
...
sparsemux_9_3_32_1_1_U71(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_2_fu_361_p9),.sel(trunc_ln128_fu_358_p1),.dout(tmp_2_fu_361_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U72(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_3_fu_385_p9),.sel(trunc_ln128_fu_358_p1),.dout(tmp_3_fu_385_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_2_reg_724 <= tmp_2_fu_361_p11;
...
assign add_ln130_1_fu_454_p2 = ($signed(tmp_2_reg_724) + $signed(32'd3395469782));
assign add_ln130_2_fu_459_p2 = (add_ln130_1_fu_454_p2 + or_ln4_fu_446_p3);
assign add_ln130_4_fu_591_p2 = (E_1_load_reg_734 + xor_ln130_3_reg_754);
assign add_ln130_5_fu_576_p2 = ($signed(tmp_3_reg_729) + $signed(32'd3395469782));
...
assign lshr_ln100_s_fu_332_p4 = {{ap_sig_allocacmp_i_1[6:3]}};
...
assign or_ln4_fu_446_p3 = {{trunc_ln130_fu_421_p1}, {lshr_ln6_fu_425_p4}};
...
assign zext_ln100_fu_342_p1 = lshr_ln100_s_fu_332_p4;
endmodule 