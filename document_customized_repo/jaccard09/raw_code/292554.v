module backprop_backprop_Pipeline_label_39_label_40 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v2_3_address0,v2_3_ce0,v2_3_we0,v2_3_d0,v2_3_q0,v2_2_address0,v2_2_ce0,v2_2_we0,v2_2_d0,v2_2_q0,v2_1_address0,v2_1_ce0,v2_1_we0,v2_1_d0,v2_1_q0,v2_0_address0,v2_0_ce0,v2_0_we0,v2_0_d0,v2_0_q0,v10_address0,v10_ce0,v10_q0,v216_out,v216_out_ap_vld,grp_fu_3408_p_din0,grp_fu_3408_p_din1,grp_fu_3408_p_opcode,grp_fu_3408_p_dout0,grp_fu_3408_p_ce,grp_fu_3444_p_din0,grp_fu_3444_p_din1,grp_fu_3444_p_dout0,grp_fu_3444_p_ce); 
...
reg   [7:0] indvar_flatten68_fu_88;
...
#0 v215_fu_80 = 2'd0;
#0 v212_fu_84 = 7'd0;
#0 indvar_flatten68_fu_88 = 8'd0;
#0 ap_done_reg = 1'b0;
end
backprop_urem_8ns_7ns_8_12_1 #(.ID( 1 ),.NUM_STAGE( 12 ),.din0_WIDTH( 8 ),.din1_WIDTH( 7 ),.dout_WIDTH( 8 ))
urem_8ns_7ns_8_12_1_U488(.clk(ap_clk),.reset(ap_rst),.din0(add_ln347_reg_436),.din1(grp_fu_295_p1),.ce(1'b1),.dout(grp_fu_295_p2));
backprop_mul_8ns_10ns_17_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 8 ),.din1_WIDTH( 10 ),.dout_WIDTH( 17 ))
mul_8ns_10ns_17_1_1_U489(.din0(mul_ln347_fu_303_p0),.din1(mul_ln347_fu_303_p1),.dout(mul_ln347_fu_303_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U490(.din0(v219_fu_343_p2),.din1(v219_fu_343_p4),.din2(v219_fu_343_p6),.din3(v219_fu_343_p8),.def(v219_fu_343_p9),.sel(trunc_ln347_1_reg_447_pp0_iter1_reg),.dout(v219_fu_343_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln341_fu_196_p2 == 1'd0))) begin
            indvar_flatten68_fu_88 <= add_ln341_fu_202_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten68_fu_88 <= 8'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v214_fu_76 <= grp_fu_3408_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v218_reg_457 <= grp_fu_3444_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v220_reg_487 <= grp_fu_3408_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v221_reg_494 <= grp_fu_3444_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten68_load = indvar_flatten68_fu_88;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_v214_load_1 = grp_fu_3408_p_dout0;
    end else begin
...
assign add_ln341_fu_202_p2 = (ap_sig_allocacmp_indvar_flatten68_load + 8'd1);
...
assign grp_fu_3408_p_din0 = grp_fu_164_p0;
assign grp_fu_3408_p_din1 = grp_fu_164_p1;
assign grp_fu_3408_p_opcode = grp_fu_164_opcode;
assign grp_fu_3444_p_ce = 1'b1;
assign grp_fu_3444_p_din0 = grp_fu_168_p0;
assign grp_fu_3444_p_din1 = grp_fu_168_p1;
assign icmp_ln341_fu_196_p2 = ((ap_sig_allocacmp_indvar_flatten68_load == 8'd192) ? 1'b1 : 1'b0);
