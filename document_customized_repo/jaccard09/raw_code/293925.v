module backprop_backprop_Pipeline_label_16 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_2201254,mux_case_1200250,mux_case_0199246,mux_case_090206_reload,v103_1_reload,mux_case_292214_reload,mul_ln168,v7_0_address0,v7_0_ce0,v7_0_q0,v7_1_address0,v7_1_ce0,v7_1_q0,v7_2_address0,v7_2_ce0,v7_2_q0,v7_3_address0,v7_3_ce0,v7_3_q0,v7_4_address0,v7_4_ce0,v7_4_q0,v7_5_address0,v7_5_ce0,v7_5_q0,v7_6_address0,v7_6_ce0,v7_6_q0,v7_7_address0,v7_7_ce0,v7_7_q0,v116_reload,v116_3_reload,v75_reload,mux_case_2201252_out,mux_case_2201252_out_ap_vld,mux_case_1200248_out,mux_case_1200248_out_ap_vld,mux_case_0199244_out,mux_case_0199244_out_ap_vld,grp_fu_3324_p_din0,grp_fu_3324_p_din1,grp_fu_3324_p_opcode,grp_fu_3324_p_dout0,grp_fu_3324_p_ce,grp_fu_3336_p_din0,grp_fu_3336_p_din1,grp_fu_3336_p_dout0,grp_fu_3336_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_2201254;
input  [63:0] mux_case_1200250;
input  [63:0] mux_case_0199246;
...
output  [63:0] mux_case_2201252_out;
output   mux_case_2201252_out_ap_vld;
output  [63:0] mux_case_1200248_out;
output   mux_case_1200248_out_ap_vld;
output  [63:0] mux_case_0199244_out;
output   mux_case_0199244_out_ap_vld;
...
reg ap_idle;
reg mux_case_2201252_out_ap_vld;
reg mux_case_1200248_out_ap_vld;
reg mux_case_0199244_out_ap_vld;
...
reg   [63:0] mux_case_0199244_fu_120;
...
reg   [63:0] mux_case_1200248_fu_124;
reg   [63:0] mux_case_2201252_fu_128;
...
#0 v93_fu_116 = 2'd0;
#0 mux_case_0199244_fu_120 = 64'd0;
#0 mux_case_1200248_fu_124 = 64'd0;
#0 mux_case_2201252_fu_128 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U283(.din0(v95_fu_433_p2),.din1(v95_fu_433_p4),.din2(v95_fu_433_p6),.din3(v95_fu_433_p8),.din4(v95_fu_433_p10),.din5(v95_fu_433_p12),.din6(v95_fu_433_p14),.din7(v95_fu_433_p16),.def(v95_fu_433_p17),.sel(trunc_ln170_reg_630),.dout(v95_fu_433_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U284(.din0(mux_case_090206_reload),.din1(v103_1_reload),.din2(mux_case_292214_reload),.def(v94_fu_472_p7),.sel(v93_1_reg_620_pp0_iter1_reg),.dout(v94_fu_472_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U285(.din0(v116_reload),.din1(v116_3_reload),.din2(v75_reload),.def(v98_fu_511_p7),.sel(v93_1_reg_620_pp0_iter8_reg),.dout(v98_fu_511_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_2201252_fu_128 <= mux_case_2201254;
        end else if ((1'b1 == ap_condition_660)) begin
            mux_case_2201252_fu_128 <= v13_reg_705;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v13_reg_705 <= grp_fu_3336_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln168_reg_626_pp0_iter15_reg == 1'd1))) begin
        mux_case_0199244_out_ap_vld = 1'b1;
    end else begin
        mux_case_0199244_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln168_reg_626_pp0_iter15_reg == 1'd1))) begin
        mux_case_1200248_out_ap_vld = 1'b1;
    end else begin
        mux_case_1200248_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln168_reg_626_pp0_iter15_reg == 1'd1))) begin
        mux_case_2201252_out_ap_vld = 1'b1;
    end else begin
        mux_case_2201252_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
...
assign bit_sel9_fu_493_p3 = bitcast_ln172_fu_489_p1[64'd63];
assign bitcast_ln172_fu_489_p1 = grp_fu_3324_p_dout0;
assign grp_fu_3324_p_ce = 1'b1;
assign grp_fu_3324_p_din0 = v94_fu_472_p9;
assign grp_fu_3324_p_din1 = v95_reg_675;
assign grp_fu_3324_p_opcode = 2'd1;
assign grp_fu_3336_p_ce = 1'b1;
assign grp_fu_3336_p_din0 = v97_fu_533_p1;
assign grp_fu_3336_p_din1 = v98_reg_695;
assign icmp_ln168_fu_348_p2 = ((ap_sig_allocacmp_v93_1 == 2'd3) ? 1'b1 : 1'b0);
assign lshr_ln_fu_374_p4 = {{add_ln170_fu_364_p2[8:3]}};
assign mux_case_0199244_out = mux_case_0199244_fu_120;
assign mux_case_1200248_out = mux_case_1200248_fu_124;
assign mux_case_2201252_out = mux_case_2201252_fu_128;
...
assign v97_fu_533_p1 = xor_ln5_fu_527_p3;
assign v98_fu_511_p7 = 'bx;
assign xor_ln172_fu_501_p2 = (bit_sel9_fu_493_p3 ^ 1'd1);
assign xor_ln5_fu_527_p3 = {{xor_ln172_reg_685}, {trunc_ln172_reg_690}};
assign zext_ln168_fu_360_p1 = ap_sig_allocacmp_v93_1;
assign zext_ln170_fu_384_p1 = lshr_ln_fu_374_p4;
endmodule 