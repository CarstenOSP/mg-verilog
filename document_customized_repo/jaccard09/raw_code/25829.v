...
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U255(.din0(mux_case_04970_reload),.din1(mux_case_15074_reload),.din2(mux_case_25178_reload),.def(tmp_10_fu_413_p7),.sel(i_9_reg_567_pp0_iter8_reg),.dout(tmp_10_fu_413_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul5_i_reg_627 <= grp_fu_5887_p_dout0;
...
assign bitcast_ln67_1_fu_391_p1 = grp_fu_5871_p_dout0;
...
assign grp_fu_5871_p_din0 = tmp_9_fu_370_p9;
assign grp_fu_5871_p_din1 = bitcast_ln67_fu_387_p1;
assign grp_fu_5871_p_opcode = 2'd1;
assign grp_fu_5887_p_ce = 1'b1;
assign grp_fu_5887_p_din0 = bitcast_ln67_2_fu_435_p1;
assign grp_fu_5887_p_din1 = tmp_10_reg_617;
