...
output  [1:0] grp_fu_13972_p_opcode;
...
dmul_64ns_64ns_64_7_max_dsp_1_U1964(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_718_p0),.din1(grp_fu_718_p1),.ce(1'b1),.dout(grp_fu_718_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v192_fu_302 <= grp_fu_13972_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v198_reg_1091 <= grp_fu_13972_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_v192_load_1 = grp_fu_13972_p_dout0;
    end else begin
...
assign grp_fu_13972_p_din0 = grp_fu_714_p0;
assign grp_fu_13972_p_din1 = grp_fu_714_p1;
assign grp_fu_13972_p_opcode = grp_fu_714_opcode;
