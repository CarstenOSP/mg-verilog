module viterbi_viterbi_Pipeline_L_prev_state (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p_6,empty_9,llike_address0,llike_ce0,llike_q0,lshr_ln,transition_0_address0,transition_0_ce0,transition_0_q0,transition_0_address1,transition_0_ce1,transition_0_q1,transition_1_address0,transition_1_ce0,transition_1_q0,transition_1_address1,transition_1_ce1,transition_1_q1,empty_10,bitcast_ln24,empty,min_p_10_out,min_p_10_out_ap_vld,grp_fu_380_p_din0,grp_fu_380_p_din1,grp_fu_380_p_opcode,grp_fu_380_p_dout0,grp_fu_380_p_ce,grp_fu_963_p_din0,grp_fu_963_p_din1,grp_fu_963_p_opcode,grp_fu_963_p_dout0,grp_fu_963_p_ce); 
...
wire   [0:0] tmp_7_fu_260_p3;
reg   [0:0] tmp_7_reg_567_pp0_iter1_reg;
reg   [0:0] tmp_7_reg_567_pp0_iter2_reg;
reg   [0:0] tmp_7_reg_567_pp0_iter3_reg;
reg   [0:0] tmp_7_reg_567_pp0_iter4_reg;
reg   [63:0] llike_load_1_reg_581;
...
reg   [63:0] p_reg_626;
reg   [63:0] min_p_7_reg_633;
reg   [63:0] p_2_reg_640;
wire   [0:0] and_ln29_1_fu_412_p2;
reg   [0:0] and_ln29_1_reg_647;
wire   [63:0] min_p_9_fu_418_p3;
reg   [63:0] min_p_9_reg_652;
reg   [0:0] tmp_13_reg_659;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_fu_80 <= min_p_6;
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (tmp_7_reg_567_pp0_iter4_reg == 1'd0))) begin
        min_p_fu_80 <= min_p_11_fu_506_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_7_fu_260_p3 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        add1_reg_616 <= grp_fu_380_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add52_1_reg_621 <= grp_fu_380_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_ln25_reg_562 <= add_ln25_fu_254_p2;
        tmp_7_reg_567 <= add_ln25_fu_254_p2[32'd6];
        tmp_7_reg_567_pp0_iter1_reg <= tmp_7_reg_567;
        tmp_7_reg_567_pp0_iter2_reg <= tmp_7_reg_567_pp0_iter1_reg;
        tmp_7_reg_567_pp0_iter3_reg <= tmp_7_reg_567_pp0_iter2_reg;
        tmp_7_reg_567_pp0_iter4_reg <= tmp_7_reg_567_pp0_iter3_reg;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        llike_load_1_reg_581 <= llike_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        llike_load_reg_606 <= llike_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        min_p_7_reg_633 <= min_p_fu_80;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_9_reg_652 <= min_p_9_fu_418_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        p_2_reg_640 <= grp_fu_380_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_reg_626 <= grp_fu_380_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_13_reg_659 <= grp_fu_963_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_7_reg_567 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_7_reg_567_pp0_iter3_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        grp_fu_202_p0 = llike_load_reg_606;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_202_p0 = llike_load_1_reg_581;
    end else begin
        grp_fu_202_p0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_206_p1 = min_p_9_fu_418_p3;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter4_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_7_reg_567_pp0_iter3_reg == 1'd1))) begin
...
assign and_ln29_3_fu_501_p2 = (tmp_13_reg_659 & and_ln29_2_fu_495_p2);
assign and_ln29_fu_406_p2 = (or_ln29_fu_382_p2 & grp_fu_963_p_dout0);
...
assign bitcast_ln29_1_fu_353_p1 = min_p_7_reg_633;
assign bitcast_ln29_2_fu_425_p1 = p_2_reg_640;
assign bitcast_ln29_3_fu_442_p1 = min_p_9_reg_652;
assign bitcast_ln29_fu_336_p1 = p_reg_626;
assign grp_fu_380_p_ce = 1'b1;
assign grp_fu_380_p_din0 = grp_fu_202_p0;
assign grp_fu_380_p_din1 = grp_fu_202_p1;
assign grp_fu_380_p_opcode = 2'd0;
assign grp_fu_963_p_ce = 1'b1;
assign grp_fu_963_p_din0 = grp_fu_206_p0;
assign grp_fu_963_p_din1 = grp_fu_206_p1;
assign grp_fu_963_p_opcode = 5'd4;
assign icmp_ln29_1_fu_376_p2 = ((trunc_ln29_fu_349_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_2_fu_388_p2 = ((tmp_9_fu_356_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_3_fu_394_p2 = ((trunc_ln29_1_fu_366_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_4_fu_459_p2 = ((tmp_10_fu_428_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_5_fu_465_p2 = ((trunc_ln29_2_fu_438_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_6_fu_477_p2 = ((tmp_12_fu_445_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_7_fu_483_p2 = ((trunc_ln29_3_fu_455_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_fu_370_p2 = ((tmp_8_fu_339_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign llike_address0 = llike_address0_local;
assign llike_ce0 = llike_ce0_local;
assign min_p_10_out = ((and_ln29_1_reg_647[0:0] == 1'b1) ? p_reg_626 : min_p_7_reg_633);
assign min_p_11_fu_506_p3 = ((and_ln29_3_fu_501_p2[0:0] == 1'b1) ? p_2_reg_640 : min_p_9_reg_652);
assign min_p_9_fu_418_p3 = ((and_ln29_1_reg_647[0:0] == 1'b1) ? p_reg_626 : min_p_7_reg_633);
...
assign select_ln27_1_fu_317_p3 = ((empty_10[0:0] == 1'b1) ? transition_1_q0 : transition_0_q0);
assign select_ln27_fu_297_p3 = ((empty_10[0:0] == 1'b1) ? transition_1_q1 : transition_0_q1);
assign tmp_10_fu_428_p4 = {{bitcast_ln29_2_fu_425_p1[62:52]}};
assign tmp_11_fu_223_p3 = {{empty_9}, {ap_sig_allocacmp_prev_1}};
assign tmp_12_fu_445_p4 = {{bitcast_ln29_3_fu_442_p1[62:52]}};
assign tmp_7_fu_260_p3 = add_ln25_fu_254_p2[32'd6];
assign tmp_8_fu_339_p4 = {{bitcast_ln29_fu_336_p1[62:52]}};
assign tmp_9_fu_356_p4 = {{bitcast_ln29_1_fu_353_p1[62:52]}};
...
assign zext_ln26_fu_231_p1 = tmp_11_fu_223_p3;
