...
reg   [4:0] tmp_reg_794;
reg   [4:0] tmp_1_reg_804;
wire    ap_CS_fsm_state5;
reg   [4:0] tmp_2_reg_814;
reg   [4:0] tmp_3_reg_824;
wire    ap_CS_fsm_state6;
reg   [4:0] tmp_4_reg_839;
reg   [4:0] tmp_5_reg_849;
reg   [31:0] v224_load_reg_854;
wire    ap_CS_fsm_state7;
reg   [4:0] tmp_6_reg_874;
...
wire   [0:0] empty_67_fu_641_p2;
reg   [0:0] empty_67_reg_1045;
...
wire   [7:0] empty_42_fu_326_p2;
wire   [7:0] empty_45_fu_346_p2;
wire   [7:0] empty_48_fu_366_p2;
wire   [7:0] empty_51_fu_386_p2;
wire   [15:0] grp_fu_647_p3;
wire   [7:0] empty_54_fu_410_p2;
wire   [7:0] empty_57_fu_430_p2;
wire   [15:0] grp_fu_655_p3;
wire   [15:0] grp_fu_663_p3;
wire   [7:0] empty_60_fu_458_p2;
...
ama_addmuladd_8ns_4ns_8ns_8ns_16_4_1_U130(.clk(ap_clk),.reset(ap_rst),.din0(v6_reg_201),.din1(grp_fu_711_p1),.din2(grp_fu_711_p2),.din3(grp_fu_711_p3),.ce(1'b1),.dout(grp_fu_711_p4));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        empty_67_reg_1045 <= empty_67_fu_641_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        tmp_1_reg_804 <= {{empty_45_fu_346_p2[7:3]}};
        tmp_reg_794 <= {{empty_42_fu_326_p2[7:3]}};
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        tmp_2_reg_814 <= {{empty_48_fu_366_p2[7:3]}};
        tmp_3_reg_824 <= {{empty_51_fu_386_p2[7:3]}};
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        tmp_4_reg_839 <= {{empty_54_fu_410_p2[7:3]}};
        tmp_5_reg_849 <= {{empty_57_fu_430_p2[7:3]}};
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        tmp_6_reg_874 <= {{empty_60_fu_458_p2[7:3]}};
...
assign empty_42_fu_326_p2 = (v6_reg_201 + 8'd1);
assign empty_45_fu_346_p2 = (v6_reg_201 + 8'd2);
assign empty_48_fu_366_p2 = (v6_reg_201 + 8'd3);
assign empty_51_fu_386_p2 = (v6_reg_201 + 8'd4);
assign empty_54_fu_410_p2 = (v6_reg_201 + 8'd5);
assign empty_57_fu_430_p2 = (v6_reg_201 + 8'd6);
assign empty_60_fu_458_p2 = (v6_reg_201 + 8'd7);
assign empty_66_fu_589_p2 = (lshr_ln_fu_506_p4 + 5'd1);
assign empty_67_fu_641_p2 = ((trunc_ln32_reg_939 == 3'd7) ? 1'b1 : 1'b0);
