...
wire   [31:0] tmp_8_fu_991_p11;
reg   [31:0] tmp_8_reg_1436;
wire   [31:0] tmp_9_fu_1014_p11;
reg   [31:0] tmp_9_reg_1441;
wire   [31:0] tmp_s_fu_1037_p11;
reg   [31:0] tmp_s_reg_1446;
wire   [31:0] tmp_5_fu_1060_p11;
reg   [31:0] tmp_5_reg_1451;
wire   [31:0] tmp_6_fu_1083_p11;
reg   [31:0] tmp_6_reg_1456;
...
wire   [31:0] tmp_8_fu_991_p9;
wire   [31:0] tmp_9_fu_1014_p9;
wire   [31:0] tmp_s_fu_1037_p9;
wire   [31:0] tmp_5_fu_1060_p9;
wire   [31:0] tmp_6_fu_1083_p9;
...
wire   [1:0] tmp_s_fu_1037_p1;
wire   [1:0] tmp_s_fu_1037_p3;
wire  signed [1:0] tmp_s_fu_1037_p5;
wire  signed [1:0] tmp_s_fu_1037_p7;
wire   [1:0] tmp_5_fu_1060_p1;
wire   [1:0] tmp_5_fu_1060_p3;
wire  signed [1:0] tmp_5_fu_1060_p5;
wire  signed [1:0] tmp_5_fu_1060_p7;
wire   [1:0] tmp_6_fu_1083_p1;
wire   [1:0] tmp_6_fu_1083_p3;
wire  signed [1:0] tmp_6_fu_1083_p5;
wire  signed [1:0] tmp_6_fu_1083_p7;
...
sparsemux_9_2_32_1_1_U1422(.din0(buff_C_out_q0),.din1(buff_C_out_1_q0),.din2(buff_C_out_2_q0),.din3(buff_C_out_3_q0),.def(tmp_8_fu_991_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_8_fu_991_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1423(.din0(buff_C_out_4_q0),.din1(buff_C_out_5_q0),.din2(buff_C_out_6_q0),.din3(buff_C_out_7_q0),.def(tmp_9_fu_1014_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_9_fu_1014_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1424(.din0(buff_C_out_8_q0),.din1(buff_C_out_9_q0),.din2(buff_C_out_10_q0),.din3(buff_C_out_11_q0),.def(tmp_s_fu_1037_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_s_fu_1037_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1425(.din0(buff_C_out_12_q0),.din1(buff_C_out_13_q0),.din2(buff_C_out_14_q0),.din3(buff_C_out_15_q0),.def(tmp_5_fu_1060_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_5_fu_1060_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1426(.din0(buff_C_out_16_q0),.din1(buff_C_out_17_q0),.din2(buff_C_out_18_q0),.din3(buff_C_out_19_q0),.def(tmp_6_fu_1083_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_6_fu_1083_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1427(.din0(buff_C_out_20_q0),.din1(buff_C_out_21_q0),.din2(buff_C_out_22_q0),.din3(buff_C_out_23_q0),.def(tmp_10_fu_1106_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_10_fu_1106_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1428(.din0(buff_C_out_24_q0),.din1(buff_C_out_25_q0),.din2(buff_C_out_26_q0),.din3(buff_C_out_27_q0),.def(tmp_11_fu_1129_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_11_fu_1129_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1429(.din0(buff_C_out_28_q0),.din1(buff_C_out_29_q0),.din2(buff_C_out_30_q0),.din3(buff_C_out_31_q0),.def(tmp_12_fu_1152_p9),.sel(trunc_ln38_reg_1232),.dout(tmp_12_fu_1152_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_5_reg_1451 <= tmp_5_fu_1060_p11;
        tmp_6_reg_1456 <= tmp_6_fu_1083_p11;
        tmp_8_reg_1436 <= tmp_8_fu_991_p11;
        tmp_9_reg_1441 <= tmp_9_fu_1014_p11;
        tmp_s_reg_1446 <= tmp_s_fu_1037_p11;
    end
end
always @ (*) begin
...
assign bitcast_ln41_2_fu_1183_p1 = tmp_s_reg_1446;
assign bitcast_ln41_3_fu_1187_p1 = tmp_5_reg_1451;
assign bitcast_ln41_4_fu_1191_p1 = tmp_6_reg_1456;
...
assign bitcast_ln41_fu_1175_p1 = tmp_8_reg_1436;
...
assign or_ln39_4_fu_915_p5 = {{{{lshr_ln5_7_fu_733_p4}, {1'd1}}, {tmp_7_fu_907_p3}}, {1'd1}};
...
assign tmp_5_fu_1060_p9 = 'bx;
assign tmp_6_fu_1083_p9 = 'bx;
assign tmp_7_fu_907_p3 = select_ln5_fu_713_p3[32'd1];
assign tmp_8_fu_991_p9 = 'bx;
assign tmp_9_fu_1014_p9 = 'bx;
assign tmp_fu_705_p3 = j_fu_166[32'd6];
assign tmp_s_fu_1037_p9 = 'bx;
