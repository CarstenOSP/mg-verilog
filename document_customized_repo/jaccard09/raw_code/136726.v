...
fmul_32ns_32ns_32_4_max_dsp_1_U411(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_2210_p0),.din1(grp_fu_2210_p1),.ce(grp_fu_2210_ce),.dout(grp_fu_2210_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U412(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_2214_p0),.din1(grp_fu_2214_p1),.ce(grp_fu_2214_ce),.dout(grp_fu_2214_p2));
