module mvt_mvt_Pipeline_lpwr (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,x1_out_din,x1_out_full_n,x1_out_write,x2_out_din,x2_out_full_n,x2_out_write,buff_x1_address0,buff_x1_ce0,buff_x1_q0,buff_x1_1_address0,buff_x1_1_ce0,buff_x1_1_q0,buff_x1_2_address0,buff_x1_2_ce0,buff_x1_2_q0,buff_x1_3_address0,buff_x1_3_ce0,buff_x1_3_q0,buff_x1_4_address0,buff_x1_4_ce0,buff_x1_4_q0,buff_x1_5_address0,buff_x1_5_ce0,buff_x1_5_q0,buff_x1_6_address0,buff_x1_6_ce0,buff_x1_6_q0,buff_x1_7_address0,buff_x1_7_ce0,buff_x1_7_q0,buff_x2_address0,buff_x2_ce0,buff_x2_q0,buff_x2_1_address0,buff_x2_1_ce0,buff_x2_1_q0,buff_x2_2_address0,buff_x2_2_ce0,buff_x2_2_q0,buff_x2_3_address0,buff_x2_3_ce0,buff_x2_3_q0,buff_x2_4_address0,buff_x2_4_ce0,buff_x2_4_q0,buff_x2_5_address0,buff_x2_5_ce0,buff_x2_5_q0,buff_x2_6_address0,buff_x2_6_ce0,buff_x2_6_q0,buff_x2_7_address0,buff_x2_7_ce0,buff_x2_7_q0); 
...
wire   [2:0] trunc_ln35_fu_340_p1;
reg   [2:0] trunc_ln35_reg_476;
wire   [31:0] tmp_s_fu_379_p19;
reg   [31:0] tmp_s_reg_562;
wire   [31:0] tmp_1_fu_418_p19;
reg   [31:0] tmp_1_reg_567;
wire   [63:0] zext_ln6_fu_354_p1;
reg   [6:0] i_fu_94;
wire   [6:0] add_ln35_fu_334_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i_1;
wire   [31:0] bitcast_ln36_fu_457_p1;
reg    ap_block_pp0_stage0_01001;
reg    x1_out_write_local;
wire   [31:0] bitcast_ln37_fu_461_p1;
...
wire   [2:0] lshr_ln6_3_fu_344_p4;
wire   [31:0] tmp_s_fu_379_p17;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_s_fu_379_p1;
wire   [2:0] tmp_s_fu_379_p3;
wire   [2:0] tmp_s_fu_379_p5;
wire   [2:0] tmp_s_fu_379_p7;
wire  signed [2:0] tmp_s_fu_379_p9;
wire  signed [2:0] tmp_s_fu_379_p11;
wire  signed [2:0] tmp_s_fu_379_p13;
wire  signed [2:0] tmp_s_fu_379_p15;
wire   [2:0] tmp_1_fu_418_p1;
wire   [2:0] tmp_1_fu_418_p3;
wire   [2:0] tmp_1_fu_418_p5;
wire   [2:0] tmp_1_fu_418_p7;
wire  signed [2:0] tmp_1_fu_418_p9;
wire  signed [2:0] tmp_1_fu_418_p11;
wire  signed [2:0] tmp_1_fu_418_p13;
wire  signed [2:0] tmp_1_fu_418_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U15512(.din0(buff_x1_q0),.din1(buff_x1_1_q0),.din2(buff_x1_2_q0),.din3(buff_x1_3_q0),.din4(buff_x1_4_q0),.din5(buff_x1_5_q0),.din6(buff_x1_6_q0),.din7(buff_x1_7_q0),.def(tmp_s_fu_379_p17),.sel(trunc_ln35_reg_476),.dout(tmp_s_fu_379_p19));
(* dissolve_hierarchy = "yes" *) mvt_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U15513(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.din4(buff_x2_4_q0),.din5(buff_x2_5_q0),.din6(buff_x2_6_q0),.din7(buff_x2_7_q0),.def(tmp_1_fu_418_p17),.sel(trunc_ln35_reg_476),.dout(tmp_1_fu_418_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln35_fu_328_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_94 <= add_ln35_fu_334_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_567 <= tmp_1_fu_418_p19;
        tmp_s_reg_562 <= tmp_s_fu_379_p19;
        trunc_ln35_reg_476 <= trunc_ln35_fu_340_p1;
    end
end
always @ (*) begin
    if (((icmp_ln35_fu_328_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln35_fu_334_p2 = (ap_sig_allocacmp_i_1 + 7'd1);
...
assign bitcast_ln36_fu_457_p1 = tmp_s_reg_562;
assign bitcast_ln37_fu_461_p1 = tmp_1_reg_567;
assign buff_x1_1_address0 = zext_ln6_fu_354_p1;
assign buff_x1_1_ce0 = buff_x1_1_ce0_local;
assign buff_x1_2_address0 = zext_ln6_fu_354_p1;
assign buff_x1_2_ce0 = buff_x1_2_ce0_local;
assign buff_x1_3_address0 = zext_ln6_fu_354_p1;
assign buff_x1_3_ce0 = buff_x1_3_ce0_local;
assign buff_x1_4_address0 = zext_ln6_fu_354_p1;
assign buff_x1_4_ce0 = buff_x1_4_ce0_local;
assign buff_x1_5_address0 = zext_ln6_fu_354_p1;
assign buff_x1_5_ce0 = buff_x1_5_ce0_local;
assign buff_x1_6_address0 = zext_ln6_fu_354_p1;
assign buff_x1_6_ce0 = buff_x1_6_ce0_local;
assign buff_x1_7_address0 = zext_ln6_fu_354_p1;
assign buff_x1_7_ce0 = buff_x1_7_ce0_local;
assign buff_x1_address0 = zext_ln6_fu_354_p1;
assign buff_x1_ce0 = buff_x1_ce0_local;
assign buff_x2_1_address0 = zext_ln6_fu_354_p1;
assign buff_x2_1_ce0 = buff_x2_1_ce0_local;
assign buff_x2_2_address0 = zext_ln6_fu_354_p1;
assign buff_x2_2_ce0 = buff_x2_2_ce0_local;
assign buff_x2_3_address0 = zext_ln6_fu_354_p1;
assign buff_x2_3_ce0 = buff_x2_3_ce0_local;
assign buff_x2_4_address0 = zext_ln6_fu_354_p1;
assign buff_x2_4_ce0 = buff_x2_4_ce0_local;
assign buff_x2_5_address0 = zext_ln6_fu_354_p1;
assign buff_x2_5_ce0 = buff_x2_5_ce0_local;
assign buff_x2_6_address0 = zext_ln6_fu_354_p1;
assign buff_x2_6_ce0 = buff_x2_6_ce0_local;
assign buff_x2_7_address0 = zext_ln6_fu_354_p1;
assign buff_x2_7_ce0 = buff_x2_7_ce0_local;
assign buff_x2_address0 = zext_ln6_fu_354_p1;
assign buff_x2_ce0 = buff_x2_ce0_local;
assign icmp_ln35_fu_328_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_3_fu_344_p4 = {{ap_sig_allocacmp_i_1[5:3]}};
assign tmp_1_fu_418_p17 = 'bx;
assign tmp_s_fu_379_p17 = 'bx;
assign trunc_ln35_fu_340_p1 = ap_sig_allocacmp_i_1[2:0];
assign x1_out_din = bitcast_ln36_fu_457_p1;
assign x1_out_write = x1_out_write_local;
assign x2_out_din = bitcast_ln37_fu_461_p1;
assign x2_out_write = x2_out_write_local;
assign zext_ln6_fu_354_p1 = lshr_ln6_3_fu_344_p4;
endmodule 