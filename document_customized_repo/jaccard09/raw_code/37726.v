module aes256_encrypt_ecb_aes256_encrypt_ecb_Pipeline_sub2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buf_1_address0,buf_1_ce0,buf_1_we0,buf_1_d0,buf_1_address1,buf_1_ce1,buf_1_q1,buf_0_address0,buf_0_ce0,buf_0_we0,buf_0_d0,buf_0_address1,buf_0_ce1,buf_0_q1); 
...
assign add_ln58_fu_136_p2 = ($signed(ap_sig_allocacmp_i_3) + $signed(5'd31));
...
assign icmp_ln58_fu_126_p2 = ((ap_sig_allocacmp_i_3 == 5'd0) ? 1'b1 : 1'b0);
assign lshr_ln2_fu_142_p4 = {{add_ln58_fu_136_p2[3:1]}};
...
assign trunc_ln58_fu_132_p1 = ap_sig_allocacmp_i_3[0:0];
assign zext_ln58_1_fu_184_p1 = lshr_ln58_1_fu_174_p4;
assign zext_ln58_fu_152_p1 = lshr_ln2_fu_142_p4;
endmodule 