module sha_stream_sha_transform_Pipeline_trans_lp4 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_35_reload,B_31_reload,C_42_reload,D_35_reload,E_31_reload,W_36_reload,W_40_reload,W_44_reload,W_48_reload,W_52_reload,W_37_reload,W_41_reload,W_45_reload,W_49_reload,W_53_reload,W_38_reload,W_42_reload,W_46_reload,W_50_reload,W_54_reload,W_39_reload,W_43_reload,W_47_reload,W_51_reload,W_55_reload,W_56_reload,W_57_reload,W_58_reload,W_59_reload,E_30_out,E_30_out_ap_vld,B_30_out,B_30_out_ap_vld,D_33_out,D_33_out_ap_vld,A_33_out,A_33_out_ap_vld,C_36_out,C_36_out_ap_vld); 
...
wire   [31:0] E_21_fu_753_p3;
reg   [31:0] E_21_reg_1393;
...
wire   [31:0] B_20_fu_895_p2;
reg   [31:0] B_20_reg_1457;
...
wire   [31:0] C_10_fu_942_p3;
reg   [31:0] C_10_reg_1489;
wire   [31:0] temp_8_fu_983_p2;
reg   [31:0] temp_8_reg_1496;
...
reg   [31:0] E_fu_126;
wire   [31:0] C_12_fu_1086_p3;
wire    ap_loop_init;
wire    ap_block_pp0_stage1;
reg   [31:0] B_fu_130;
wire   [31:0] temp_10_fu_1195_p2;
reg   [31:0] E_10_fu_134;
wire   [31:0] C_13_fu_1129_p3;
reg   [31:0] B_10_fu_138;
wire   [31:0] temp_11_fu_1250_p2;
...
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h18 ),.din1_WIDTH( 32 ),.CASE2( 6'h1C ),.din2_WIDTH( 32 ),.CASE3( 6'h20 ),.din3_WIDTH( 32 ),.CASE4( 6'h24 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U147(.din0(W_37_reload),.din1(W_41_reload),.din2(W_45_reload),.din3(W_49_reload),.din4(W_53_reload),.def(tmp_7_fu_426_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_7_fu_426_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h18 ),.din1_WIDTH( 32 ),.CASE2( 6'h1C ),.din2_WIDTH( 32 ),.CASE3( 6'h20 ),.din3_WIDTH( 32 ),.CASE4( 6'h24 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U148(.din0(W_38_reload),.din1(W_42_reload),.din2(W_46_reload),.din3(W_50_reload),.din4(W_54_reload),.def(tmp_8_fu_454_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_8_fu_454_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h18 ),.din1_WIDTH( 32 ),.CASE2( 6'h1C ),.din2_WIDTH( 32 ),.CASE3( 6'h20 ),.din3_WIDTH( 32 ),.CASE4( 6'h24 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U149(.din0(W_39_reload),.din1(W_43_reload),.din2(W_47_reload),.din3(W_51_reload),.din4(W_55_reload),.def(tmp_9_fu_482_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_9_fu_482_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h18 ),.din1_WIDTH( 32 ),.CASE2( 6'h1C ),.din2_WIDTH( 32 ),.CASE3( 6'h20 ),.din3_WIDTH( 32 ),.CASE4( 6'h24 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U150(.din0(W_40_reload),.din1(W_44_reload),.din2(W_48_reload),.din3(W_52_reload),.din4(W_56_reload),.def(tmp_10_fu_522_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_10_fu_522_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h18 ),.din1_WIDTH( 32 ),.CASE2( 6'h1C ),.din2_WIDTH( 32 ),.CASE3( 6'h20 ),.din3_WIDTH( 32 ),.CASE4( 6'h24 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U151(.din0(W_41_reload),.din1(W_45_reload),.din2(W_49_reload),.din3(W_53_reload),.din4(W_57_reload),.def(tmp_11_fu_550_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_11_fu_550_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h18 ),.din1_WIDTH( 32 ),.CASE2( 6'h1C ),.din2_WIDTH( 32 ),.CASE3( 6'h20 ),.din3_WIDTH( 32 ),.CASE4( 6'h24 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U152(.din0(W_42_reload),.din1(W_46_reload),.din2(W_50_reload),.din3(W_54_reload),.din4(W_58_reload),.def(tmp_12_fu_578_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_12_fu_578_p13));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_11_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h14 ),.din0_WIDTH( 32 ),.CASE1( 6'h18 ),.din1_WIDTH( 32 ),.CASE2( 6'h1C ),.din2_WIDTH( 32 ),.CASE3( 6'h20 ),.din3_WIDTH( 32 ),.CASE4( 6'h24 ),.din4_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_11_6_32_1_1_U153(.din0(W_43_reload),.din1(W_47_reload),.din2(W_51_reload),.din3(W_55_reload),.din4(W_59_reload),.def(tmp_13_fu_606_p11),.sel(ap_sig_allocacmp_i),.dout(tmp_13_fu_606_p13));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            B_10_fu_138 <= A_35_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            B_10_fu_138 <= temp_11_fu_1250_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        B_fu_130 <= B_31_reload;
        ...
        B_fu_130 <= temp_10_fu_1195_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_10_fu_134 <= D_35_reload;
        ...
        E_10_fu_134 <= C_13_fu_1129_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_11_fu_142 <= C_42_reload;
    end else if (((icmp_ln120_reg_1328 == 1'd1) & (1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_fu_126 <= E_31_reload;
    end else if (((icmp_ln120_reg_1328 == 1'd1) & (1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        E_fu_126 <= C_12_fu_1086_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        ...
        C_10_reg_1489 <= C_10_fu_942_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        B_20_reg_1457 <= B_20_fu_895_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        C_11_reg_1526 <= C_11_fu_1046_p3;
        add_ln122_26_reg_1541 <= add_ln122_26_fu_1124_p2;
        lshr_ln122_11_reg_1536 <= {{temp_9_fu_1069_p2[31:27]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        lshr_ln122_4_reg_1425 <= {{temp_7_fu_813_p2[31:27]}};
        lshr_ln122_7_reg_1452 <= {{temp_7_fu_813_p2[31:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        ...
        lshr_ln122_13_reg_1556 <= {{temp_10_fu_1195_p2[31:27]}};
        trunc_ln122_14_reg_1551 <= trunc_ln122_14_fu_1201_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        lshr_ln122_12_reg_1516 <= {{temp_8_fu_983_p2[31:2]}};
        lshr_ln122_s_reg_1506 <= {{temp_8_fu_983_p2[31:27]}};
        temp_8_reg_1496 <= temp_8_fu_983_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        lshr_ln122_6_reg_1470 <= {{B_20_fu_895_p2[31:27]}};
...
assign A_33_out = (add_ln122_14_reg_1475 + add_ln122_12_fu_932_p2);
assign A_fu_936_p2 = (add_ln122_14_reg_1475 + add_ln122_12_fu_932_p2);
assign B_20_fu_895_p2 = (add_ln122_9_fu_889_p2 + add_ln122_10_fu_885_p2);
assign B_30_out = B_20_reg_1457;
assign C_10_fu_942_p3 = {{trunc_ln122_7_reg_1447}, {lshr_ln122_7_reg_1452}};
assign C_11_fu_1046_p3 = {{trunc_ln122_9_fu_1034_p1}, {lshr_ln122_9_fu_1037_p4}};
assign C_12_fu_1086_p3 = {{trunc_ln122_11_fu_1074_p1}, {lshr_ln122_10_fu_1077_p4}};
assign C_13_fu_1129_p3 = {{trunc_ln122_13_reg_1511}, {lshr_ln122_12_reg_1516}};
assign C_36_out = {{trunc_ln122_7_reg_1447}, {lshr_ln122_7_reg_1452}};
...
assign D_33_out = D_reg_1435;
assign D_fu_848_p3 = {{trunc_ln122_5_reg_1400}, {lshr_ln122_5_reg_1405}};
assign E_21_fu_753_p3 = {{trunc_ln122_3_fu_739_p1}, {lshr_ln122_3_fu_743_p4}};
assign E_30_out = E_21_reg_1393;
...
assign add_ln122_18_fu_780_p2 = (add_ln122_17_fu_775_p2 + E_21_fu_753_p3);
...
assign add_ln122_26_fu_1124_p2 = (add_ln122_24_fu_1119_p2 + C_10_reg_1489);
assign add_ln122_28_fu_1215_p2 = (C_11_reg_1526 + tmp_13_reg_1347);
...
assign lshr_ln122_14_fu_1151_p4 = {{temp_9_fu_1069_p2[31:2]}};
assign lshr_ln122_3_fu_743_p4 = {{B_10_fu_138[31:2]}};
assign lshr_ln122_8_fu_952_p4 = {{A_reg_1480[31:27]}};
assign lshr_ln122_9_fu_1037_p4 = {{B_20_reg_1457[31:2]}};
assign lshr_ln1_fu_653_p4 = {{B_10_fu_138[31:27]}};
...
assign temp_10_fu_1195_p2 = (add_ln122_25_fu_1190_p2 + or_ln122_1_fu_1184_p3);
assign temp_11_fu_1250_p2 = (add_ln122_29_fu_1245_p2 + or_ln122_3_fu_1239_p3);
assign temp_7_fu_813_p2 = (add_ln122_5_fu_808_p2 + or_ln122_2_fu_802_p3);
assign temp_8_fu_983_p2 = (add_ln122_16_fu_978_p2 + or_ln122_8_fu_970_p3);
assign temp_9_fu_1069_p2 = (add_ln122_22_reg_1521 + add_ln122_20_fu_1064_p2);
...
assign trunc_ln122_10_fu_989_p1 = temp_8_fu_983_p2[26:0];
assign trunc_ln122_11_fu_1074_p1 = A_reg_1480[1:0];
assign trunc_ln122_12_fu_1094_p1 = temp_9_fu_1069_p2[26:0];
assign trunc_ln122_13_fu_1003_p1 = temp_8_fu_983_p2[1:0];
assign trunc_ln122_14_fu_1201_p1 = temp_10_fu_1195_p2[26:0];
assign trunc_ln122_15_fu_1147_p1 = temp_9_fu_1069_p2[1:0];
...
assign trunc_ln122_4_fu_819_p1 = temp_7_fu_813_p2[26:0];
assign trunc_ln122_5_fu_761_p1 = temp_fu_694_p2[1:0];
assign trunc_ln122_6_fu_901_p1 = B_20_fu_895_p2[26:0];
assign trunc_ln122_7_fu_865_p1 = temp_7_fu_813_p2[1:0];
assign trunc_ln122_8_fu_949_p1 = A_reg_1480[26:0];
assign trunc_ln122_9_fu_1034_p1 = B_20_reg_1457[1:0];
assign trunc_ln122_fu_649_p1 = B_10_fu_138[26:0];
assign xor_ln122_10_fu_1054_p2 = (C_10_reg_1489 ^ A_reg_1480);
assign xor_ln122_11_fu_1058_p2 = (xor_ln122_10_fu_1054_p2 ^ C_11_fu_1046_p3);
assign xor_ln122_12_fu_1108_p2 = (temp_8_reg_1496 ^ C_11_fu_1046_p3);
assign xor_ln122_13_fu_1113_p2 = (xor_ln122_12_fu_1108_p2 ^ C_12_fu_1086_p3);
assign xor_ln122_14_fu_1135_p2 = (temp_9_fu_1069_p2 ^ C_12_fu_1086_p3);
assign xor_ln122_15_fu_1141_p2 = (xor_ln122_14_fu_1135_p2 ^ C_13_fu_1129_p3);
assign xor_ln122_1_fu_669_p2 = (xor_ln122_fu_663_p2 ^ E_11_fu_142);
assign xor_ln122_2_fu_792_p2 = (C_9_fu_786_p3 ^ A_10_reg_1352);
assign xor_ln122_3_fu_797_p2 = (xor_ln122_2_fu_792_p2 ^ C_reg_1357);
assign xor_ln122_4_fu_833_p2 = (temp_reg_1363 ^ E_21_reg_1393);
assign xor_ln122_5_fu_837_p2 = (xor_ln122_4_fu_833_p2 ^ C_9_fu_786_p3);
assign xor_ln122_6_fu_854_p2 = (temp_7_fu_813_p2 ^ E_21_reg_1393);
assign xor_ln122_7_fu_859_p2 = (xor_ln122_6_fu_854_p2 ^ D_fu_848_p3);
assign xor_ln122_8_fu_961_p2 = (D_reg_1435 ^ B_20_reg_1457);
assign xor_ln122_9_fu_965_p2 = (xor_ln122_8_fu_961_p2 ^ C_10_reg_1489);
