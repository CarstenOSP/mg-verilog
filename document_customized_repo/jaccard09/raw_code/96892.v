...
wire   [0:0] first_iter_1_fu_313_p2;
reg   [0:0] first_iter_1_reg_552;
reg   [0:0] first_iter_1_reg_552_pp0_iter1_reg;
wire   [3:0] lshr_ln6_6_fu_319_p4;
reg   [3:0] lshr_ln6_6_reg_556;
...
wire   [31:0] tmp_1_fu_469_p11;
reg   [31:0] tmp_1_reg_655;
...
reg   [12:0] indvar_flatten10_fu_88;
...
wire   [9:0] tmp_5_fu_379_p3;
wire   [31:0] tmp_9_fu_394_p9;
wire   [1:0] tmp_9_fu_394_p10;
wire   [31:0] tmp_8_fu_439_p9;
wire   [31:0] tmp_1_fu_469_p9;
reg    ap_done_reg;
...
wire   [1:0] tmp_9_fu_394_p1;
wire   [1:0] tmp_9_fu_394_p3;
wire  signed [1:0] tmp_9_fu_394_p5;
wire  signed [1:0] tmp_9_fu_394_p7;
wire   [1:0] tmp_8_fu_439_p1;
wire   [1:0] tmp_8_fu_439_p3;
wire  signed [1:0] tmp_8_fu_439_p5;
wire  signed [1:0] tmp_8_fu_439_p7;
wire   [1:0] tmp_1_fu_469_p1;
wire   [1:0] tmp_1_fu_469_p3;
wire  signed [1:0] tmp_1_fu_469_p5;
wire  signed [1:0] tmp_1_fu_469_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 8'd1;
...
#0 j_fu_80 = 7'd0;
#0 i_2_fu_84 = 7'd0;
#0 indvar_flatten10_fu_88 = 13'd0;
...
sparsemux_9_2_32_1_1_U37(.din0(buff_x_q0),.din1(buff_x_1_q0),.din2(buff_x_2_q0),.din3(buff_x_3_q0),.def(tmp_9_fu_394_p9),.sel(tmp_9_fu_394_p10),.dout(tmp_9_fu_394_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U38(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.def(tmp_8_fu_439_p9),.sel(trunc_ln32_reg_591),.dout(tmp_8_fu_439_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U39(.din0(tmp2_q0),.din1(tmp2_1_q0),.din2(tmp2_2_q0),.din3(tmp2_3_q0),.def(tmp_1_fu_469_p9),.sel(trunc_ln31_reg_581),.dout(tmp_1_fu_469_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        if (((ap_enable_reg_pp0_iter1 == 1'b1) & (first_iter_1_reg_552_pp0_iter1_reg == 1'd1))) begin
            add6815_fu_92 <= tmp_1_reg_655;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_284_p2 == 1'd0))) begin
            indvar_flatten10_fu_88 <= add_ln31_1_fu_290_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten10_fu_88 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        j_fu_80 <= add_ln32_fu_418_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add2_reg_670 <= grp_fu_624_p_dout0;
        ...
        lshr_ln6_2_reg_586 <= {{select_ln31_fu_351_p3[5:2]}};
        tmp_1_reg_655 <= tmp_1_fu_469_p11;
        tmp_9_reg_616 <= tmp_9_fu_394_p11;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_1_reg_552 <= first_iter_1_fu_313_p2;
        first_iter_1_reg_552_pp0_iter1_reg <= first_iter_1_reg_552;
        ...
        lshr_ln6_6_reg_556 <= {{select_ln6_fu_305_p3[5:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul2_reg_630 <= grp_fu_628_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        mul3_reg_660 <= grp_fu_628_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_8_reg_625 <= tmp_8_fu_439_p11;
    end
end
always @ (*) begin
...
assign add_ln31_1_fu_290_p2 = (ap_sig_allocacmp_indvar_flatten10_load + 13'd1);
...
assign first_iter_1_fu_313_p2 = ((select_ln6_fu_305_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_624_p_ce = 1'b1;
assign grp_fu_624_p_din0 = add6815_fu_92;
assign grp_fu_624_p_din1 = mul3_reg_660;
...
assign icmp_ln31_fu_284_p2 = ((ap_sig_allocacmp_indvar_flatten10_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln32_1_fu_423_p2 = ((add_ln32_fu_418_p2 == 7'd64) ? 1'b1 : 1'b0);
assign icmp_ln32_fu_299_p2 = ((ap_sig_allocacmp_j_load == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_6_fu_319_p4 = {{select_ln6_fu_305_p3[5:2]}};
assign select_ln31_fu_351_p3 = ((icmp_ln32_reg_541[0:0] == 1'b1) ? add_ln31_fu_345_p2 : i_2_fu_84);
assign select_ln6_fu_305_p3 = ((icmp_ln32_fu_299_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
...
assign tmp_1_fu_469_p9 = 'bx;
assign tmp_5_fu_379_p3 = {{empty_fu_358_p1}, {lshr_ln6_6_reg_556}};
assign tmp_8_fu_439_p9 = 'bx;
assign tmp_9_fu_394_p10 = select_ln6_reg_546[1:0];
assign tmp_9_fu_394_p9 = 'bx;
assign trunc_ln31_fu_362_p1 = select_ln31_fu_351_p3[1:0];
assign trunc_ln32_fu_376_p1 = select_ln6_reg_546[1:0];
assign zext_ln33_fu_386_p1 = tmp_5_fu_379_p3;
assign zext_ln6_1_fu_329_p1 = lshr_ln6_6_fu_319_p4;
assign zext_ln6_fu_462_p1 = lshr_ln6_2_reg_586;
endmodule 