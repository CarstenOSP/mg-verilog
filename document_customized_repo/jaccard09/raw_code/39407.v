module backprop_backprop_Pipeline_VITIS_LOOP_11_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_23657,mux_case_13553,mux_case_03449,activations3_load_2,activations3_1_load_2,activations3_2_load_2,sum_reload,mux_case_23655_out,mux_case_23655_out_ap_vld,mux_case_13551_out,mux_case_13551_out_ap_vld,mux_case_03447_out,mux_case_03447_out_ap_vld,grp_fu_6820_p_din0,grp_fu_6820_p_din1,grp_fu_6820_p_dout0,grp_fu_6820_p_ce,grp_fu_6824_p_din0,grp_fu_6824_p_din1,grp_fu_6824_p_dout0,grp_fu_6824_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_23657;
input  [63:0] mux_case_13553;
input  [63:0] mux_case_03449;
input  [63:0] activations3_load_2;
input  [63:0] activations3_1_load_2;
input  [63:0] activations3_2_load_2;
input  [63:0] sum_reload;
output  [63:0] mux_case_23655_out;
output   mux_case_23655_out_ap_vld;
output  [63:0] mux_case_13551_out;
output   mux_case_13551_out_ap_vld;
output  [63:0] mux_case_03447_out;
output   mux_case_03447_out_ap_vld;
...
reg ap_idle;
reg mux_case_23655_out_ap_vld;
reg mux_case_13551_out_ap_vld;
reg mux_case_03447_out_ap_vld;
...
reg   [63:0] mux_case_13551_fu_72;
reg   [63:0] mux_case_23655_fu_76;
...
#0 i_fu_64 = 2'd0;
#0 mux_case_03447_fu_68 = 64'd0;
#0 mux_case_13551_fu_72 = 64'd0;
#0 mux_case_23655_fu_76 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U312(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_s_fu_187_p7),.sel(ap_sig_allocacmp_i_11),.dout(tmp_s_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_23655_fu_76 <= mux_case_23657;
        end else if ((1'b1 == ap_condition_1192)) begin
            mux_case_23655_fu_76 <= grp_fu_6820_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_34_reg_328 <= grp_fu_6824_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter79_reg == 1'b1) & (icmp_ln11_reg_309_pp0_iter78_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_03447_out_ap_vld = 1'b1;
    end else begin
        mux_case_03447_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter79_reg == 1'b1) & (icmp_ln11_reg_309_pp0_iter78_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_13551_out_ap_vld = 1'b1;
    end else begin
        mux_case_13551_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter79_reg == 1'b1) & (icmp_ln11_reg_309_pp0_iter78_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_23655_out_ap_vld = 1'b1;
    end else begin
        mux_case_23655_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    case (ap_CS_fsm)
...
assign grp_fu_6820_p_din0 = tmp_34_reg_328;
assign grp_fu_6820_p_din1 = sum_reload;
assign grp_fu_6824_p_ce = 1'b1;
assign grp_fu_6824_p_din0 = 64'd0;
assign grp_fu_6824_p_din1 = bitcast_ln12_1_fu_240_p1;
assign icmp_ln11_fu_175_p2 = ((ap_sig_allocacmp_i_11 == 2'd3) ? 1'b1 : 1'b0);
assign mux_case_03447_out = mux_case_03447_fu_68;
assign mux_case_13551_out = mux_case_13551_fu_72;
assign mux_case_23655_out = mux_case_23655_fu_76;
