module backprop_update_weights_1_Pipeline_up_weight_loop2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,d_biases1_0_address0,d_biases1_0_ce0,d_biases1_0_q0,d_biases1_2_address0,d_biases1_2_ce0,d_biases1_2_q0,biases1_address0,biases1_ce0,biases1_we0,biases1_d0,biases1_q0,biases1_address1,biases1_ce1,biases1_we1,biases1_d1,biases1_q1,d_biases1_1_address0,d_biases1_1_ce0,d_biases1_1_q0,d_biases1_3_address0,d_biases1_3_ce0,d_biases1_3_q0,bias_norm_out,bias_norm_out_ap_vld,grp_fu_469_p_din0,grp_fu_469_p_din1,grp_fu_469_p_dout0,grp_fu_469_p_ce); 
...
wire   [0:0] icmp_ln133_fu_213_p2;
reg   [0:0] icmp_ln133_reg_325;
reg   [5:0] biases1_addr_reg_331;
reg   [5:0] biases1_addr_reg_331_pp0_iter1_reg;
reg   [5:0] biases1_addr_1_reg_347;
reg   [5:0] biases1_addr_1_reg_347_pp0_iter1_reg;
wire   [63:0] select_ln133_fu_253_p3;
reg   [63:0] select_ln133_reg_353;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [63:0] biases1_load_reg_358;
wire   [63:0] select_ln133_1_fu_260_p3;
reg   [63:0] select_ln133_1_reg_363;
reg   [63:0] biases1_load_1_reg_368;
reg   [63:0] mul_reg_373;
wire    ap_CS_fsm_pp0_stage8;
wire    ap_block_pp0_stage8_11001;
wire   [63:0] bitcast_ln133_fu_267_p1;
wire    ap_CS_fsm_pp0_stage9;
wire    ap_block_pp0_stage9_11001;
reg   [63:0] mul27_1_reg_383;
wire   [63:0] bitcast_ln133_2_fu_271_p1;
wire    ap_CS_fsm_pp0_stage10;
wire    ap_block_pp0_stage10_11001;
wire   [63:0] grp_fu_156_p2;
reg   [63:0] sub1_reg_393;
reg   [63:0] sub30_1_reg_400;
reg   [63:0] mul1_reg_407;
wire    ap_CS_fsm_pp0_stage7;
wire    ap_block_pp0_stage7_11001;
reg   [63:0] mul35_1_reg_417;
...
wire   [63:0] zext_ln122_fu_237_p1;
...
wire   [63:0] bitcast_ln133_1_fu_275_p1;
wire    ap_block_pp0_stage1;
reg    biases1_we1_local;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [63:0] bitcast_ln133_3_fu_279_p1;
...
wire   [3:0] lshr_ln1_fu_195_p4;
wire   [1:0] trunc_ln132_fu_191_p1;
wire   [4:0] tmp_4_fu_219_p4;
...
dadddsub_64ns_64ns_64_8_full_dsp_1_U259(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_156_p0),.din1(grp_fu_156_p1),.opcode(grp_fu_156_opcode),.ce(1'b1),.dout(grp_fu_156_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        biases1_addr_1_reg_347[5 : 1] <= zext_ln122_fu_237_p1[5 : 1];
        biases1_addr_1_reg_347_pp0_iter1_reg[5 : 1] <= biases1_addr_1_reg_347[5 : 1];
        biases1_addr_reg_331 <= zext_ln132_fu_186_p1;
        biases1_addr_reg_331_pp0_iter1_reg <= biases1_addr_reg_331;
        icmp_ln133_reg_325 <= icmp_ln133_fu_213_p2;
        tmp_reg_311 <= ap_sig_allocacmp_i[32'd6];
        tmp_reg_311_pp0_iter1_reg <= tmp_reg_311;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        biases1_load_1_reg_368 <= biases1_q0;
        biases1_load_reg_358 <= biases1_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul1_reg_407 <= grp_fu_469_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        mul27_1_reg_383 <= grp_fu_469_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        mul35_1_reg_417 <= grp_fu_469_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        mul_reg_373 <= grp_fu_469_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        select_ln133_1_reg_363 <= select_ln133_1_fu_260_p3;
        select_ln133_reg_353 <= select_ln133_fu_253_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        sub1_reg_393 <= grp_fu_156_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        sub30_1_reg_400 <= grp_fu_156_p2;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        biases1_address0_local = biases1_addr_reg_331_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        biases1_address0_local = zext_ln122_fu_237_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        biases1_address1_local = biases1_addr_1_reg_347_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        biases1_address1_local = zext_ln132_fu_186_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        grp_fu_156_p0 = bitcast_ln133_2_fu_271_p1;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_156_p0 = bitcast_ln133_fu_267_p1;
    end else begin
        grp_fu_156_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_156_p1 = mul35_1_reg_417;
    end else if (((1'b0 == ap_block_pp0_stage8) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        grp_fu_156_p1 = mul1_reg_407;
    end else if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        grp_fu_156_p1 = mul27_1_reg_383;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_156_p1 = mul_reg_373;
    end else begin
        grp_fu_156_p1 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        grp_fu_160_p0 = sub30_1_reg_400;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_160_p0 = sub1_reg_393;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_160_p0 = select_ln133_1_reg_363;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_160_p0 = select_ln133_reg_353;
    end else begin
        grp_fu_160_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        grp_fu_160_p1 = sub30_1_reg_400;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_160_p1 = sub1_reg_393;
...
assign add_ln132_fu_242_p2 = (ap_sig_allocacmp_i + 7'd2);
...
assign biases1_d0 = bitcast_ln133_1_fu_275_p1;
assign biases1_d1 = bitcast_ln133_3_fu_279_p1;
assign biases1_we0 = biases1_we0_local;
assign biases1_we1 = biases1_we1_local;
assign bitcast_ln133_1_fu_275_p1 = sub1_reg_393;
assign bitcast_ln133_2_fu_271_p1 = biases1_load_1_reg_368;
assign bitcast_ln133_3_fu_279_p1 = sub30_1_reg_400;
assign bitcast_ln133_fu_267_p1 = biases1_load_reg_358;
assign d_biases1_0_address0 = zext_ln121_fu_205_p1;
assign d_biases1_0_ce0 = d_biases1_0_ce0_local;
assign d_biases1_1_address0 = zext_ln121_fu_205_p1;
assign d_biases1_1_ce0 = d_biases1_1_ce0_local;
assign d_biases1_2_address0 = zext_ln121_fu_205_p1;
assign d_biases1_2_ce0 = d_biases1_2_ce0_local;
assign d_biases1_3_address0 = zext_ln121_fu_205_p1;
assign d_biases1_3_ce0 = d_biases1_3_ce0_local;
assign grp_fu_469_p_ce = 1'b1;
assign grp_fu_469_p_din0 = grp_fu_160_p0;
assign grp_fu_469_p_din1 = grp_fu_160_p1;
assign icmp_ln133_fu_213_p2 = ((trunc_ln132_fu_191_p1 != 2'd0) ? 1'b1 : 1'b0);
assign lshr_ln1_fu_195_p4 = {{ap_sig_allocacmp_i[5:2]}};
assign or_ln_fu_229_p3 = {{tmp_4_fu_219_p4}, {1'd1}};
assign select_ln133_1_fu_260_p3 = ((icmp_ln133_reg_325[0:0] == 1'b1) ? d_biases1_3_q0 : d_biases1_1_q0);
assign select_ln133_fu_253_p3 = ((icmp_ln133_reg_325[0:0] == 1'b1) ? d_biases1_2_q0 : d_biases1_0_q0);
assign tmp_4_fu_219_p4 = {{ap_sig_allocacmp_i[5:1]}};
assign tmp_fu_178_p3 = ap_sig_allocacmp_i[32'd6];
assign trunc_ln132_fu_191_p1 = ap_sig_allocacmp_i[1:0];
assign zext_ln121_fu_205_p1 = lshr_ln1_fu_195_p4;
assign zext_ln122_fu_237_p1 = or_ln_fu_229_p3;
assign zext_ln132_fu_186_p1 = ap_sig_allocacmp_i;
always @ (posedge ap_clk) begin
    biases1_addr_1_reg_347[0] <= 1'b1;
    biases1_addr_1_reg_347_pp0_iter1_reg[0] <= 1'b1;
end
endmodule 