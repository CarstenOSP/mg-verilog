...
wire   [14:0] empty_24_fu_219_p2;
reg   [14:0] empty_24_reg_328;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        empty_24_reg_328 <= empty_24_fu_219_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        SEQB_address0 = p_cast4_fu_190_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state10 : begin
            if (((1'b1 == ap_CS_fsm_state10) & (icmp_ln83_fu_278_p2 == 1'd0))) begin
...
assign M_d1 = grp_needwun_Pipeline_fill_in_fu_141_M_d1;
...
always @ (*) begin
    ap_block_state12_on_subcall_done = (((grp_needwun_Pipeline_pad_b_fu_162_ap_done == 1'b0) & (icmp_ln83_reg_342 == 1'd1)) | ((grp_needwun_Pipeline_pad_a_fu_154_ap_done == 1'b0) & (icmp_ln83_reg_342 == 1'd1)));
end
assign empty_24_fu_219_p2 = (p_shl1_fu_212_p3 + p_cast_fu_209_p1);
...
assign or_ln65_1_fu_254_p3 = {{tmp_1_fu_244_p4}, {1'd1}};
assign p_cast4_fu_190_p1 = empty_fu_184_p2;
...
assign tmp_1_fu_244_p4 = {{a_str_idx_0_0_loc_fu_82[31:1]}};
