...
wire   [63:0] tmp_132_fu_187_p7;
wire   [63:0] tmp_132_fu_187_p9;
...
wire   [1:0] tmp_132_fu_187_p1;
wire   [1:0] tmp_132_fu_187_p3;
wire  signed [1:0] tmp_132_fu_187_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_7_2_64_1_1_U903(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_132_fu_187_p7),.sel(ap_sig_allocacmp_i_16),.dout(tmp_132_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_133_reg_328 <= grp_fu_8553_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign bitcast_ln12_fu_207_p1 = tmp_132_fu_187_p9;
assign grp_fu_8549_p_ce = 1'b1;
assign grp_fu_8549_p_din0 = tmp_133_reg_328;
