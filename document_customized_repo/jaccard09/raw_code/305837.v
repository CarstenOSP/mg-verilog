module backprop_backprop_Pipeline_label_35 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v8_address0,v8_ce0,v8_q0,v4_address0,v4_ce0,v4_we0,v4_d0,v4_q0,v194_out,v194_out_ap_vld,grp_fu_3157_p_din0,grp_fu_3157_p_din1,grp_fu_3157_p_opcode,grp_fu_3157_p_dout0,grp_fu_3157_p_ce,grp_fu_6634_p_din0,grp_fu_6634_p_din1,grp_fu_6634_p_dout0,grp_fu_6634_p_ce); 
...
output  [63:0] grp_fu_6634_p_din0;
output  [63:0] grp_fu_6634_p_din1;
input  [63:0] grp_fu_6634_p_dout0;
output   grp_fu_6634_p_ce;
reg ap_idle;
reg v194_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        v192_fu_42 <= grp_fu_3157_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v196_reg_182 <= grp_fu_6634_p_dout0;
        v4_load_reg_187 <= v4_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v198_reg_197 <= grp_fu_3157_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v199_reg_204 <= grp_fu_6634_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ap_sig_allocacmp_v192_load_1 = grp_fu_3157_p_dout0;
    end else begin
...
assign grp_fu_3157_p_din0 = grp_fu_82_p0;
assign grp_fu_3157_p_din1 = grp_fu_82_p1;
assign grp_fu_3157_p_opcode = grp_fu_82_opcode;
assign grp_fu_6634_p_ce = 1'b1;
assign grp_fu_6634_p_din0 = grp_fu_86_p0;
assign grp_fu_6634_p_din1 = grp_fu_86_p1;
