...
buff_B_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_B_address0),.ce0(buff_B_ce0),.we0(buff_B_we0),.d0(grp_syrk_Pipeline_lprd_1_lprd_2_fu_94_buff_B_d0),.q0(buff_B_q0));
syrk_buff_B_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 2048 ),.AddressWidth( 11 ))
buff_B_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_B_1_address0),.ce0(buff_B_1_ce0),.we0(buff_B_1_we0),.d0(grp_syrk_Pipeline_lprd_1_lprd_2_fu_94_buff_B_1_d0),.q0(buff_B_1_q0));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 2048 ),.AddressWidth( 11 ))
buff_C_out_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_address0),.ce0(buff_C_out_ce0),.we0(buff_C_out_we0),.d0(buff_C_out_d0),.q0(buff_C_out_q0),.address1(grp_syrk_Pipeline_lp4_lp5_fu_134_buff_C_out_address1),.ce1(buff_C_out_ce1),.q1(buff_C_out_q1));
syrk_buff_C_out_RAM_AUTO_1R1W #(.DataWidth( 32 ),.AddressRange( 2048 ),.AddressWidth( 11 ))
buff_C_out_1_U(.clk(ap_clk),.reset(ap_rst),.address0(buff_C_out_1_address0),.ce0(buff_C_out_1_ce0),.we0(buff_C_out_1_we0),.d0(buff_C_out_1_d0),.q0(buff_C_out_1_q0),.address1(grp_syrk_Pipeline_lp4_lp5_fu_134_buff_C_out_1_address1),.ce1(buff_C_out_1_ce1),.q1(buff_C_out_1_q1));
...
fadd_32ns_32ns_32_7_full_dsp_1_U113(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_164_p0),.din1(grp_fu_164_p1),.ce(grp_fu_164_ce),.dout(grp_fu_164_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U114(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_168_p0),.din1(grp_fu_168_p1),.ce(grp_fu_168_ce),.dout(grp_fu_168_p2));
