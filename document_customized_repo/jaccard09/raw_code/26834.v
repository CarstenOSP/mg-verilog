module backprop_update_weights_45_46_1_Pipeline_up_weight_loop9_VITIS_LOOP_179_5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,weights3_1_address0,weights3_1_ce0,weights3_1_we0,weights3_1_d0,weights3_1_q0,weights3_0_address0,weights3_0_ce0,weights3_0_we0,weights3_0_d0,weights3_0_q0,d_weights3_0_address0,d_weights3_0_ce0,d_weights3_0_q0,d_weights3_1_address0,d_weights3_1_ce0,d_weights3_1_q0,norm_7_out,norm_7_out_ap_vld,grp_fu_451_p_din0,grp_fu_451_p_din1,grp_fu_451_p_dout0,grp_fu_451_p_ce); 
...
dadddsub_64ns_64ns_64_8_full_dsp_1_U265(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_135_p0),.din1(grp_fu_135_p1),.opcode(grp_fu_135_opcode),.ce(1'b1),.dout(grp_fu_135_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        mul1_reg_422 <= grp_fu_451_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        mul_reg_400 <= grp_fu_451_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_norm_load_1 = grp_fu_135_p2;
    end else begin
...
assign grp_fu_451_p_din0 = grp_fu_139_p0;
assign grp_fu_451_p_din1 = grp_fu_139_p1;
