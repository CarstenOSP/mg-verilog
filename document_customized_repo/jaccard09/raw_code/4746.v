...
sparsemux_7_5_32_1_1_U156(.din0(W_8_load_3),.din1(W_16_load_2),.din2(W_24_load_2),.def(tmp_s_fu_402_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_s_fu_402_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U157(.din0(W_9_load_3),.din1(W_17_load_2),.din2(W_25_load_2),.def(tmp_8_fu_422_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_8_fu_422_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U158(.din0(W_10_load_3),.din1(W_18_load_2),.din2(W_26_load_2),.def(tmp_9_fu_442_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_9_fu_442_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U159(.din0(W_11_load_3),.din1(W_19_load_2),.din2(W_27_load_2),.def(tmp_10_fu_462_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_10_fu_462_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U160(.din0(W_12_load_3),.din1(W_20_load_2),.din2(W_28_load_2),.def(tmp_12_fu_506_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_12_fu_506_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U161(.din0(W_13_load_3),.din1(W_21_load_2),.din2(W_29_load_2),.def(tmp_13_fu_526_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_13_fu_526_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U162(.din0(W_14_load_3),.din1(W_22_load_2),.din2(W_30_load_2),.def(tmp_14_fu_546_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_14_fu_546_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h8 ),.din0_WIDTH( 32 ),.CASE1( 5'h10 ),.din1_WIDTH( 32 ),.CASE2( 5'h18 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_7_5_32_1_1_U163(.din0(W_15_load_3),.din1(W_23_load_2),.din2(W_31_load_2),.def(tmp_15_fu_566_p7),.sel(trunc_ln14_fu_398_p1),.dout(tmp_15_fu_566_p9));
...
assign A_57_out = (add_ln126_14_reg_1516 + add_ln126_12_fu_925_p2);
assign B_41_out = temp_9_reg_1498;
...
assign C_51_out = {{trunc_ln126_7_reg_1483}, {lshr_ln126_7_reg_1488}};
assign D_57_out = C_13_reg_1470;
assign E_41_out = C_12_reg_1435;
