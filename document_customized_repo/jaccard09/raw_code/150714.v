...
sparsemux_9_2_32_1_1_U581(.din0(buff_D_out_q0),.din1(buff_D_out_1_q0),.din2(buff_D_out_2_q0),.din3(buff_D_out_3_q0),.def(tmp_2_fu_375_p9),.sel(trunc_ln52_reg_454),.dout(tmp_2_fu_375_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U582(.din0(buff_D_out_4_q0),.din1(buff_D_out_5_q0),.din2(buff_D_out_6_q0),.din3(buff_D_out_7_q0),.def(tmp_3_fu_398_p9),.sel(trunc_ln52_reg_454),.dout(tmp_3_fu_398_p11));
...
assign bitcast_ln55_1_fu_425_p1 = tmp_3_reg_513;
assign bitcast_ln55_fu_421_p1 = tmp_2_reg_508;
