...
wire   [31:0] tmp_s_fu_602_p11;
reg   [31:0] tmp_s_reg_821;
...
wire   [1:0] tmp_s_fu_602_p1;
wire   [1:0] tmp_s_fu_602_p3;
wire  signed [1:0] tmp_s_fu_602_p5;
wire  signed [1:0] tmp_s_fu_602_p7;
...
sparsemux_9_2_32_1_1_U147(.din0(buff_C_out_q0),.din1(buff_C_out_1_q0),.din2(buff_C_out_2_q0),.din3(buff_C_out_3_q0),.def(tmp_9_fu_579_p9),.sel(trunc_ln38_reg_712),.dout(tmp_9_fu_579_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U148(.din0(buff_C_out_4_q0),.din1(buff_C_out_5_q0),.din2(buff_C_out_6_q0),.din3(buff_C_out_7_q0),.def(tmp_s_fu_602_p9),.sel(trunc_ln38_reg_712),.dout(tmp_s_fu_602_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U149(.din0(buff_C_out_8_q0),.din1(buff_C_out_9_q0),.din2(buff_C_out_10_q0),.din3(buff_C_out_11_q0),.def(tmp_5_fu_625_p9),.sel(trunc_ln38_reg_712),.dout(tmp_5_fu_625_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U150(.din0(buff_C_out_12_q0),.din1(buff_C_out_13_q0),.din2(buff_C_out_14_q0),.din3(buff_C_out_15_q0),.def(tmp_6_fu_648_p9),.sel(trunc_ln38_reg_712),.dout(tmp_6_fu_648_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_s_reg_821 <= tmp_s_fu_602_p11;
    end
end
always @ (*) begin
...
assign bitcast_ln41_1_fu_675_p1 = tmp_s_reg_821;
assign bitcast_ln41_2_fu_679_p1 = tmp_5_reg_826;
assign bitcast_ln41_3_fu_683_p1 = tmp_6_reg_831;
assign bitcast_ln41_fu_671_p1 = tmp_9_reg_816;
