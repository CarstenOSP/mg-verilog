...
fadd_32ns_32ns_32_7_full_dsp_1_U11(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_276_p0),.din1(grp_fu_276_p1),.ce(1'b1),.dout(grp_fu_276_p2));
bicg_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U12(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_280_p0),.din1(grp_fu_280_p1),.ce(1'b1),.dout(grp_fu_280_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U13(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_284_p0),.din1(grp_fu_284_p1),.ce(1'b1),.dout(grp_fu_284_p2));
bicg_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U14(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_288_p0),.din1(grp_fu_288_p1),.ce(1'b1),.dout(grp_fu_288_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_11_reg_835 <= {{select_ln41_fu_365_p3[5:2]}};
        tmp_14_reg_848 <= {{select_ln41_fu_365_p3[5:3]}};
        tmp_6_reg_863 <= select_ln41_fu_365_p3[32'd1];
...
assign add_ln61_fu_497_p2 = (tmp_12_fu_487_p5 + select_ln41_1_cast_reg_793);
assign add_ln68_fu_514_p2 = (tmp_13_fu_507_p3 + select_ln41_1_cast_reg_793);
assign add_ln75_fu_549_p2 = (tmp_15_fu_539_p5 + select_ln41_1_cast_reg_793);
assign add_ln82_fu_569_p2 = (tmp_16_fu_559_p5 + select_ln41_1_cast_reg_793);
assign add_ln89_fu_617_p2 = (tmp_17_fu_607_p5 + select_ln41_1_cast_reg_793);
assign add_ln96_fu_634_p2 = (tmp_18_fu_627_p3 + select_ln41_1_cast_reg_793);
...
assign or_ln58_1_fu_584_p3 = {{tmp_11_reg_835}, {1'd1}};
assign or_ln72_1_fu_654_p4 = {{{tmp_14_reg_848}, {1'd1}}, {tmp_6_reg_863}};
assign or_ln86_1_fu_678_p3 = {{tmp_14_reg_848}, {2'd3}};
...
assign tmp_12_fu_487_p5 = {{{{tmp_11_reg_835}, {1'd1}}, {trunc_ln58_reg_842}}, {6'd0}};
assign tmp_13_fu_507_p3 = {{tmp_11_reg_835}, {8'd192}};
assign tmp_15_fu_539_p5 = {{{{tmp_14_reg_848}, {1'd1}}, {trunc_ln72_reg_858}}, {6'd0}};
assign tmp_16_fu_559_p5 = {{{{tmp_14_reg_848}, {1'd1}}, {tmp_6_reg_863}}, {7'd64}};
assign tmp_17_fu_607_p5 = {{{{tmp_14_reg_848}, {2'd3}}, {trunc_ln58_reg_842}}, {6'd0}};
assign tmp_18_fu_627_p3 = {{tmp_14_reg_848}, {9'd448}};
