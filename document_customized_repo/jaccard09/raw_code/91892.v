...
wire   [0:0] icmp_ln13_fu_380_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [6:0] select_ln5_fu_415_p3;
reg   [6:0] select_ln5_reg_582;
wire   [5:0] empty_fu_431_p1;
reg   [5:0] empty_reg_589;
reg   [5:0] empty_reg_589_pp0_iter2_reg;
wire   [0:0] first_iter_0_fu_435_p2;
reg   [0:0] first_iter_0_reg_595;
reg   [5:0] buff_p_addr_reg_607;
reg   [5:0] buff_r_addr_reg_617;
reg   [5:0] buff_q_out_addr_reg_622;
wire   [1:0] trunc_ln18_fu_523_p1;
reg   [1:0] trunc_ln18_reg_632;
reg   [3:0] lshr_ln5_3_reg_636;
wire   [63:0] zext_ln13_fu_441_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln5_fu_464_p1;
wire   [63:0] zext_ln19_2_fu_518_p1;
wire   [63:0] zext_ln19_1_fu_541_p1;
reg   [6:0] j_fu_110;
wire   [6:0] add_ln18_fu_476_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_114;
wire   [6:0] select_ln13_fu_423_p3;
reg   [12:0] indvar_flatten_fu_118;
wire   [12:0] add_ln13_1_fu_386_p2;
reg   [12:0] ap_sig_allocacmp_indvar_flatten_load;
reg    p_ce0_local;
reg    r_ce0_local;
reg    buff_s_out_6_we0_local;
wire   [2:0] trunc_ln13_fu_450_p1;
...
wire   [31:0] bitcast_ln19_fu_549_p1;
...
wire   [6:0] add_ln13_fu_403_p2;
wire   [2:0] lshr_ln5_fu_454_p4;
wire   [11:0] tmp_2_fu_492_p3;
wire   [11:0] zext_ln19_fu_509_p1;
wire   [11:0] add_ln19_fu_512_p2;
wire   [9:0] tmp_7_fu_535_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_fu_114 <= select_ln13_fu_423_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln13_fu_380_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten_fu_118 <= add_ln13_1_fu_386_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        buff_p_addr_reg_607 <= zext_ln13_fu_441_p1;
        buff_q_out_addr_reg_622 <= zext_ln13_fu_441_p1;
        buff_r_addr_reg_617 <= zext_ln13_fu_441_p1;
        empty_reg_589 <= empty_fu_431_p1;
        first_iter_0_reg_595 <= first_iter_0_fu_435_p2;
        select_ln5_reg_582 <= select_ln5_fu_415_p3;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        empty_reg_589_pp0_iter2_reg <= empty_reg_589;
        lshr_ln5_3_reg_636 <= {{select_ln5_reg_582[5:2]}};
        trunc_ln18_reg_632 <= trunc_ln18_fu_523_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (trunc_ln18_reg_632 == 2'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (trunc_ln18_reg_632 == 2'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (trunc_ln18_reg_632 == 2'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (trunc_ln18_reg_632 == 2'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (first_iter_0_reg_595 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd4) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd5) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd7) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln13_fu_450_p1 == 3'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (first_iter_0_fu_435_p2 == 1'd1))) begin
...
assign A_address0 = zext_ln19_2_fu_518_p1;
assign A_ce0 = A_ce0_local;
assign add_ln13_1_fu_386_p2 = (ap_sig_allocacmp_indvar_flatten_load + 13'd1);
assign add_ln13_fu_403_p2 = (i_fu_114 + 7'd1);
assign add_ln18_fu_476_p2 = (select_ln5_fu_415_p3 + 7'd1);
assign add_ln19_fu_512_p2 = (tmp_2_fu_492_p3 + zext_ln19_fu_509_p1);
...
assign bitcast_ln14_fu_499_p1 = p_q0;
assign bitcast_ln15_fu_504_p1 = r_q0;
assign bitcast_ln19_fu_549_p1 = A_q0;
assign buff_A_1_address0 = zext_ln19_1_fu_541_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_1_d0 = bitcast_ln19_fu_549_p1;
assign buff_A_1_we0 = buff_A_1_we0_local;
assign buff_A_2_address0 = zext_ln19_1_fu_541_p1;
assign buff_A_2_ce0 = buff_A_2_ce0_local;
assign buff_A_2_d0 = bitcast_ln19_fu_549_p1;
assign buff_A_2_we0 = buff_A_2_we0_local;
assign buff_A_3_address0 = zext_ln19_1_fu_541_p1;
assign buff_A_3_ce0 = buff_A_3_ce0_local;
assign buff_A_3_d0 = bitcast_ln19_fu_549_p1;
assign buff_A_3_we0 = buff_A_3_we0_local;
assign buff_A_address0 = zext_ln19_1_fu_541_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_A_d0 = bitcast_ln19_fu_549_p1;
assign buff_A_we0 = buff_A_we0_local;
assign buff_p_address0 = buff_p_addr_reg_607;
assign buff_p_ce0 = buff_p_ce0_local;
assign buff_p_d0 = bitcast_ln14_fu_499_p1;
assign buff_p_we0 = buff_p_we0_local;
assign buff_q_out_address0 = buff_q_out_addr_reg_622;
assign buff_q_out_ce0 = buff_q_out_ce0_local;
assign buff_q_out_d0 = 32'd0;
assign buff_q_out_we0 = buff_q_out_we0_local;
assign buff_r_address0 = buff_r_addr_reg_617;
assign buff_r_ce0 = buff_r_ce0_local;
assign buff_r_d0 = bitcast_ln15_fu_504_p1;
assign buff_r_we0 = buff_r_we0_local;
assign buff_s_out_1_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_1_ce0 = buff_s_out_1_ce0_local;
assign buff_s_out_1_d0 = 32'd0;
assign buff_s_out_1_we0 = buff_s_out_1_we0_local;
assign buff_s_out_2_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_2_ce0 = buff_s_out_2_ce0_local;
assign buff_s_out_2_d0 = 32'd0;
assign buff_s_out_2_we0 = buff_s_out_2_we0_local;
assign buff_s_out_3_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_3_ce0 = buff_s_out_3_ce0_local;
assign buff_s_out_3_d0 = 32'd0;
assign buff_s_out_3_we0 = buff_s_out_3_we0_local;
assign buff_s_out_4_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_4_ce0 = buff_s_out_4_ce0_local;
assign buff_s_out_4_d0 = 32'd0;
assign buff_s_out_4_we0 = buff_s_out_4_we0_local;
assign buff_s_out_5_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_5_ce0 = buff_s_out_5_ce0_local;
assign buff_s_out_5_d0 = 32'd0;
assign buff_s_out_5_we0 = buff_s_out_5_we0_local;
assign buff_s_out_6_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_6_ce0 = buff_s_out_6_ce0_local;
assign buff_s_out_6_d0 = 32'd0;
assign buff_s_out_6_we0 = buff_s_out_6_we0_local;
assign buff_s_out_7_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_7_ce0 = buff_s_out_7_ce0_local;
assign buff_s_out_7_d0 = 32'd0;
assign buff_s_out_7_we0 = buff_s_out_7_we0_local;
assign buff_s_out_address0 = zext_ln5_fu_464_p1;
assign buff_s_out_ce0 = buff_s_out_ce0_local;
assign buff_s_out_d0 = 32'd0;
assign buff_s_out_we0 = buff_s_out_we0_local;
assign empty_fu_431_p1 = select_ln13_fu_423_p3[5:0];
assign first_iter_0_fu_435_p2 = ((select_ln5_fu_415_p3 == 7'd0) ? 1'b1 : 1'b0);
assign icmp_ln13_fu_380_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln18_fu_409_p2 = ((j_fu_110 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_fu_454_p4 = {{select_ln13_fu_423_p3[5:3]}};
assign p_address0 = zext_ln13_fu_441_p1;
assign p_ce0 = p_ce0_local;
assign r_address0 = zext_ln13_fu_441_p1;
assign r_ce0 = r_ce0_local;
assign select_ln13_fu_423_p3 = ((icmp_ln18_fu_409_p2[0:0] == 1'b1) ? add_ln13_fu_403_p2 : i_fu_114);
assign select_ln5_fu_415_p3 = ((icmp_ln18_fu_409_p2[0:0] == 1'b1) ? 7'd0 : j_fu_110);
assign tmp_2_fu_492_p3 = {{empty_reg_589}, {6'd0}};
assign tmp_7_fu_535_p3 = {{empty_reg_589_pp0_iter2_reg}, {lshr_ln5_3_reg_636}};
assign trunc_ln13_fu_450_p1 = select_ln13_fu_423_p3[2:0];
assign trunc_ln18_fu_523_p1 = select_ln5_reg_582[1:0];
assign zext_ln13_fu_441_p1 = select_ln13_fu_423_p3;
assign zext_ln19_1_fu_541_p1 = tmp_7_fu_535_p3;
assign zext_ln19_2_fu_518_p1 = add_ln19_fu_512_p2;
assign zext_ln19_fu_509_p1 = select_ln5_reg_582;
assign zext_ln5_fu_464_p1 = lshr_ln5_fu_454_p4;
endmodule 