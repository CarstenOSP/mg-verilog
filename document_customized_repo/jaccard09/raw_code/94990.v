...
sparsemux_9_3_32_1_1_U1367(.din0(buff_D_q0),.din1(buff_D_2_q0),.din2(buff_D_4_q0),.din3(buff_D_6_q0),.def(tmp_4_fu_579_p9),.sel(trunc_ln44_1_reg_702),.dout(tmp_4_fu_579_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U1368(.din0(buff_D_1_q0),.din1(buff_D_3_q0),.din2(buff_D_5_q0),.din3(buff_D_7_q0),.def(tmp_6_fu_602_p9),.sel(trunc_ln44_1_reg_702),.dout(tmp_6_fu_602_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U1369(.din0(tmp2_q0),.din1(tmp2_2_q0),.din2(tmp2_4_q0),.din3(tmp2_6_q0),.def(tmp_3_fu_625_p9),.sel(trunc_ln44_1_reg_702_pp0_iter5_reg),.dout(tmp_3_fu_625_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U1370(.din0(tmp2_1_q0),.din1(tmp2_3_q0),.din2(tmp2_5_q0),.din3(tmp2_7_q0),.def(tmp_5_fu_648_p9),.sel(trunc_ln44_1_reg_702_pp0_iter5_reg),.dout(tmp_5_fu_648_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add127_1_reg_848 <= grp_fu_4254_p_dout0;
        add2_reg_840 <= grp_fu_4246_p_dout0;
        ...
        mul126_1_reg_835 <= grp_fu_4258_p_dout0;
        mul3_reg_825 <= grp_fu_4250_p_dout0;
...
assign grp_fu_4246_p_din0 = tmp_3_reg_820;
assign grp_fu_4246_p_din1 = mul3_reg_825;
assign grp_fu_4246_p_opcode = 2'd0;
assign grp_fu_4250_p_ce = 1'b1;
assign grp_fu_4250_p_din0 = tmp_4_reg_770;
assign grp_fu_4250_p_din1 = beta;
assign grp_fu_4254_p_ce = 1'b1;
assign grp_fu_4254_p_din0 = tmp_5_reg_830;
assign grp_fu_4254_p_din1 = mul126_1_reg_835;
assign grp_fu_4254_p_opcode = 2'd0;
assign grp_fu_4258_p_ce = 1'b1;
assign grp_fu_4258_p_din0 = tmp_6_reg_775;
