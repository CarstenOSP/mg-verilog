...
reg   [31:0] store_forwarded71_fu_94;
wire   [31:0] xor_ln108_2_fu_613_p2;
reg   [31:0] store_forwarded74_fu_98;
wire   [31:0] xor_ln108_17_fu_733_p2;
reg   [31:0] store_forwarded77_fu_102;
wire   [31:0] xor_ln108_5_fu_657_p2;
reg   [31:0] store_forwarded80_fu_106;
wire   [31:0] xor_ln108_23_fu_771_p2;
reg   [31:0] store_forwarded83_fu_110;
wire   [31:0] xor_ln108_8_fu_676_p2;
reg   [31:0] store_forwarded86_fu_114;
wire   [31:0] xor_ln108_11_fu_695_p2;
reg   [31:0] store_forwarded89_fu_118;
...
#0 store_forwarded71_fu_94 = 32'd0;
#0 store_forwarded74_fu_98 = 32'd0;
#0 store_forwarded77_fu_102 = 32'd0;
#0 store_forwarded80_fu_106 = 32'd0;
#0 store_forwarded83_fu_110 = 32'd0;
#0 store_forwarded86_fu_114 = 32'd0;
#0 store_forwarded89_fu_118 = 32'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        store_forwarded71_fu_94 <= sha_info_data_load_8;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        store_forwarded71_fu_94 <= xor_ln108_2_fu_613_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        store_forwarded74_fu_98 <= sha_info_data_load_14;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        store_forwarded74_fu_98 <= xor_ln108_17_fu_733_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        store_forwarded77_fu_102 <= sha_info_data_load_9;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        store_forwarded77_fu_102 <= xor_ln108_5_fu_657_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        store_forwarded80_fu_106 <= sha_info_data_load_15;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        store_forwarded80_fu_106 <= xor_ln108_23_fu_771_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        store_forwarded83_fu_110 <= sha_info_data_load_10;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        store_forwarded83_fu_110 <= xor_ln108_8_fu_676_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        store_forwarded86_fu_114 <= sha_info_data_load_11;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        store_forwarded86_fu_114 <= xor_ln108_11_fu_695_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        store_forwarded89_fu_118 <= sha_info_data_load_12;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        store_forwarded89_fu_118 <= xor_ln108_14_fu_714_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        i_2_reg_891 <= ap_sig_allocacmp_i_2;
    end
end
always @ (*) begin
...
assign add_ln106_fu_778_p2 = (i_2_reg_891 + 7'd8);
assign add_ln108_1_fu_413_p2 = ($signed(trunc_ln106_fu_388_p1) + $signed(6'd48));
assign add_ln108_2_fu_434_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(7'd115));
assign add_ln108_3_fu_455_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(7'd113));
assign add_ln108_4_fu_476_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(7'd116));
assign add_ln108_5_fu_497_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(7'd117));
assign add_ln108_6_fu_518_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(7'd118));
assign add_ln108_7_fu_539_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(7'd119));
assign add_ln108_fu_392_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(7'd114));
...
assign icmp_ln106_fu_382_p2 = ((ap_sig_allocacmp_i_2 < 7'd80) ? 1'b1 : 1'b0);
...
assign lshr_ln_fu_584_p4 = {{i_2_reg_891[6:2]}};
assign or_ln_fu_629_p3 = {{tmp_fu_620_p4}, {1'd1}};
assign tmp_fu_620_p4 = {{i_2_reg_891[6:3]}};
assign trunc_ln106_fu_388_p1 = ap_sig_allocacmp_i_2[5:0];
assign xor_ln108_10_fu_689_p2 = (xor_ln108_9_fu_683_p2 ^ xor_ln108_2_fu_613_p2);
assign xor_ln108_11_fu_695_p2 = (xor_ln108_10_fu_689_p2 ^ store_forwarded86_fu_114);
assign xor_ln108_12_fu_702_p2 = (xor_ln108_5_fu_657_p2 ^ W_2_q0);
assign xor_ln108_13_fu_708_p2 = (xor_ln108_12_fu_702_p2 ^ W_q0);
assign xor_ln108_14_fu_714_p2 = (xor_ln108_13_fu_708_p2 ^ store_forwarded89_fu_118);
assign xor_ln108_15_fu_721_p2 = (store_forwarded71_fu_94 ^ W_2_q0);
assign xor_ln108_16_fu_727_p2 = (xor_ln108_15_fu_721_p2 ^ xor_ln108_11_fu_695_p2);
assign xor_ln108_17_fu_733_p2 = (xor_ln108_16_fu_727_p2 ^ store_forwarded74_fu_98);
...
assign xor_ln108_21_fu_759_p2 = (store_forwarded77_fu_102 ^ W_3_q0);
assign xor_ln108_22_fu_765_p2 = (xor_ln108_21_fu_759_p2 ^ xor_ln108_14_fu_714_p2);
assign xor_ln108_23_fu_771_p2 = (xor_ln108_22_fu_765_p2 ^ store_forwarded80_fu_106);
assign xor_ln108_2_fu_613_p2 = (xor_ln108_1_fu_607_p2 ^ store_forwarded71_fu_94);
assign xor_ln108_3_fu_645_p2 = (W_3_q1 ^ W_1_q1);
assign xor_ln108_4_fu_651_p2 = (xor_ln108_3_fu_645_p2 ^ store_forwarded74_fu_98);
assign xor_ln108_5_fu_657_p2 = (xor_ln108_4_fu_651_p2 ^ store_forwarded77_fu_102);
assign xor_ln108_6_fu_664_p2 = (store_forwarded80_fu_106 ^ W_q0);
assign xor_ln108_7_fu_670_p2 = (xor_ln108_6_fu_664_p2 ^ W_2_q1);
assign xor_ln108_8_fu_676_p2 = (xor_ln108_7_fu_670_p2 ^ store_forwarded83_fu_110);
