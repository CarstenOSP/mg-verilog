...
output  [63:0] grp_fu_8465_p_din0;
output  [63:0] grp_fu_8465_p_din1;
input  [63:0] grp_fu_8465_p_dout0;
output   grp_fu_8465_p_ce;
...
output  [63:0] grp_fu_8477_p_din0;
output  [63:0] grp_fu_8477_p_din1;
input  [63:0] grp_fu_8477_p_dout0;
output   grp_fu_8477_p_ce;
output  [63:0] grp_fu_8481_p_din0;
output  [63:0] grp_fu_8481_p_din1;
input  [63:0] grp_fu_8481_p_dout0;
output   grp_fu_8481_p_ce;
...
reg   [6:0] i_8_reg_2061;
reg   [6:0] i_8_reg_2061_pp0_iter1_reg;
reg   [6:0] i_8_reg_2061_pp0_iter2_reg;
reg   [6:0] i_8_reg_2061_pp0_iter3_reg;
reg   [6:0] i_8_reg_2061_pp0_iter4_reg;
reg   [6:0] i_8_reg_2061_pp0_iter5_reg;
reg   [6:0] i_8_reg_2061_pp0_iter6_reg;
reg   [6:0] i_8_reg_2061_pp0_iter7_reg;
reg   [6:0] i_8_reg_2061_pp0_iter8_reg;
...
wire   [63:0] tmp_147_fu_1754_p35;
reg   [63:0] tmp_147_reg_2243;
...
wire   [4:0] tmp_147_fu_1754_p1;
wire   [4:0] tmp_147_fu_1754_p3;
wire   [4:0] tmp_147_fu_1754_p5;
wire   [4:0] tmp_147_fu_1754_p7;
wire   [4:0] tmp_147_fu_1754_p9;
wire   [4:0] tmp_147_fu_1754_p11;
wire   [4:0] tmp_147_fu_1754_p13;
wire   [4:0] tmp_147_fu_1754_p15;
wire  signed [4:0] tmp_147_fu_1754_p17;
wire  signed [4:0] tmp_147_fu_1754_p19;
wire  signed [4:0] tmp_147_fu_1754_p21;
wire  signed [4:0] tmp_147_fu_1754_p23;
wire  signed [4:0] tmp_147_fu_1754_p25;
wire  signed [4:0] tmp_147_fu_1754_p27;
wire  signed [4:0] tmp_147_fu_1754_p29;
wire  signed [4:0] tmp_147_fu_1754_p31;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_33_5_64_1_1_x_U880(.din0(activations2_q0),.din1(activations2_2_q0),.din2(activations2_4_q0),.din3(activations2_6_q0),.din4(activations2_8_q0),.din5(activations2_10_q0),.din6(activations2_12_q0),.din7(activations2_14_q0),.din8(activations2_16_q0),.din9(activations2_18_q0),.din10(activations2_20_q0),.din11(activations2_22_q0),.din12(activations2_24_q0),.din13(activations2_26_q0),.din14(activations2_28_q0),.din15(activations2_30_q0),.def(tmp_s_fu_1682_p33),.sel(trunc_ln73_fu_1679_p1),.dout(tmp_s_fu_1682_p35));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_33_5_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 64 ),.CASE1( 5'h2 ),.din1_WIDTH( 64 ),.CASE2( 5'h4 ),.din2_WIDTH( 64 ),.CASE3( 5'h6 ),.din3_WIDTH( 64 ),.CASE4( 5'h8 ),.din4_WIDTH( 64 ),.CASE5( 5'hA ),.din5_WIDTH( 64 ),.CASE6( 5'hC ),.din6_WIDTH( 64 ),.CASE7( 5'hE ),.din7_WIDTH( 64 ),.CASE8( 5'h10 ),.din8_WIDTH( 64 ),.CASE9( 5'h12 ),.din9_WIDTH( 64 ),.CASE10( 5'h14 ),.din10_WIDTH( 64 ),.CASE11( 5'h16 ),.din11_WIDTH( 64 ),.CASE12( 5'h18 ),.din12_WIDTH( 64 ),.CASE13( 5'h1A ),.din13_WIDTH( 64 ),.CASE14( 5'h1C ),.din14_WIDTH( 64 ),.CASE15( 5'h1E ),.din15_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 5 ),.dout_WIDTH( 64 ))
sparsemux_33_5_64_1_1_x_U881(.din0(activations2_1_q0),.din1(activations2_3_q0),.din2(activations2_5_q0),.din3(activations2_7_q0),.din4(activations2_9_q0),.din5(activations2_11_q0),.din6(activations2_13_q0),.din7(activations2_15_q0),.din8(activations2_17_q0),.din9(activations2_19_q0),.din10(activations2_21_q0),.din11(activations2_23_q0),.din12(activations2_25_q0),.din13(activations2_27_q0),.din14(activations2_29_q0),.din15(activations2_31_q0),.def(tmp_147_fu_1754_p33),.sel(trunc_ln73_fu_1679_p1),.dout(tmp_147_fu_1754_p35));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_8_reg_2061 <= ap_sig_allocacmp_i_8;
        i_8_reg_2061_pp0_iter1_reg <= i_8_reg_2061;
        tmp_147_reg_2243 <= tmp_147_fu_1754_p35;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_8_reg_2061_pp0_iter2_reg <= i_8_reg_2061_pp0_iter1_reg;
        i_8_reg_2061_pp0_iter3_reg <= i_8_reg_2061_pp0_iter2_reg;
        i_8_reg_2061_pp0_iter4_reg <= i_8_reg_2061_pp0_iter3_reg;
        i_8_reg_2061_pp0_iter5_reg <= i_8_reg_2061_pp0_iter4_reg;
        i_8_reg_2061_pp0_iter6_reg <= i_8_reg_2061_pp0_iter5_reg;
        i_8_reg_2061_pp0_iter7_reg <= i_8_reg_2061_pp0_iter6_reg;
        i_8_reg_2061_pp0_iter8_reg <= i_8_reg_2061_pp0_iter7_reg;
        mul_16_i_reg_2270 <= grp_fu_8469_p_dout0;
        mul_1_1_i_reg_2330 <= grp_fu_8481_p_dout0;
        mul_1_2_i_reg_2350 <= grp_fu_8485_p_dout0;
        mul_1_i_reg_2310 <= grp_fu_8477_p_dout0;
        mul_2_i_reg_2290 <= grp_fu_8473_p_dout0;
        mul_i3_reg_2250 <= grp_fu_8465_p_dout0;
...
assign add_ln73_fu_1668_p2 = (ap_sig_allocacmp_i_8 + 7'd2);
...
assign grp_fu_8465_p_ce = 1'b1;
assign grp_fu_8465_p_din0 = tmp_s_reg_2236;
assign grp_fu_8465_p_din1 = p_reload86;
assign grp_fu_8469_p_ce = 1'b1;
assign grp_fu_8469_p_din0 = tmp_s_reg_2236;
assign grp_fu_8469_p_din1 = p_reload85;
assign grp_fu_8473_p_ce = 1'b1;
assign grp_fu_8473_p_din0 = tmp_s_reg_2236;
assign grp_fu_8473_p_din1 = p_reload;
assign grp_fu_8477_p_ce = 1'b1;
assign grp_fu_8477_p_din0 = tmp_147_reg_2243;
assign grp_fu_8477_p_din1 = p_reload86;
assign grp_fu_8481_p_ce = 1'b1;
assign grp_fu_8481_p_din0 = tmp_147_reg_2243;
assign grp_fu_8481_p_din1 = p_reload85;
assign grp_fu_8485_p_ce = 1'b1;
assign grp_fu_8485_p_din0 = tmp_147_reg_2243;
assign grp_fu_8485_p_din1 = p_reload;
...
assign lshr_ln_fu_1846_p4 = {{sub_ln75_fu_1840_p2[7:5]}};
assign p_shl_fu_1832_p3 = {{trunc_ln75_fu_1829_p1}, {2'd0}};
assign sub_ln75_fu_1840_p2 = (p_shl_fu_1832_p3 - zext_ln75_fu_1826_p1);
assign tmp_147_fu_1754_p33 = 'bx;
assign tmp_35_fu_1624_p3 = ap_sig_allocacmp_i_8[32'd5];
assign tmp_fu_1616_p3 = ap_sig_allocacmp_i_8[32'd6];
assign tmp_s_fu_1682_p33 = 'bx;
assign trunc_ln73_fu_1679_p1 = i_8_reg_2061[4:0];
assign trunc_ln75_fu_1829_p1 = i_8_reg_2061_pp0_iter8_reg[5:0];
assign zext_ln72_fu_1632_p1 = tmp_35_fu_1624_p3;
assign zext_ln75_1_fu_1856_p1 = lshr_ln_fu_1846_p4;
...
assign zext_ln75_fu_1826_p1 = i_8_reg_2061_pp0_iter8_reg;
endmodule 