module forward_ama_addmuladd_9ns_5ns_5ns_5ns_14_4_1_DSP48_0 (input clk,input rst,input ce,input  [9 - 1:0] in0,input  [5 - 1:0] in1,input  [5 - 1:0] in2,input  [5 - 1:0] in3,output [14 - 1:0]  dout); 
