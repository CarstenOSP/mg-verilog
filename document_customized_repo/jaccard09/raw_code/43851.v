...
wire   [12:0] tmp_12_fu_481_p3;
reg   [12:0] tmp_12_reg_680;
...
wire   [63:0] grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_10_out;
wire    grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_10_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_278_min_s_2_out;
wire    grp_viterbi_Pipeline_L_end_fu_278_min_s_2_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_286_min_s_6_out;
wire    grp_viterbi_Pipeline_L_state_fu_286_min_s_6_out_ap_vld;
...
wire   [63:0] tmp_20_cast_fu_357_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        llike_addr_1_reg_605[12 : 5] <= tmp_20_cast_fu_357_p1[12 : 5];
        tmp_s_reg_600[12 : 5] <= tmp_s_fu_349_p3[12 : 5];
        zext_ln19_reg_610[7 : 0] <= zext_ln19_fu_362_p1[7 : 0];
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_10_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state26))) begin
        min_p_10_loc_fu_100 <= grp_viterbi_Pipeline_L_prev_state_fu_264_min_p_10_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_278_min_s_2_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state30))) begin
        min_s_2_loc_fu_96 <= grp_viterbi_Pipeline_L_end_fu_278_min_s_2_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_286_min_s_6_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state43))) begin
        min_s_6_loc_fu_92 <= grp_viterbi_Pipeline_L_state_fu_286_min_s_6_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        tmp_12_reg_680[12 : 5] <= tmp_12_fu_481_p3[12 : 5];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        llike_1_d0 = min_p_10_loc_fu_100;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        ...
        llike_address0_local = llike_addr_1_reg_605;
...
assign tmp_12_fu_481_p3 = {{trunc_ln50_fu_477_p1}, {5'd0}};
assign tmp_13_fu_437_p3 = {{t_2_reg_568}, {lshr_ln7_reg_633}};
assign tmp_20_cast_fu_357_p1 = tmp_s_fu_349_p3;
assign tmp_fu_466_p3 = t_1_fu_112[32'd8];
assign tmp_s_fu_349_p3 = {{empty_fu_344_p2}, {5'd0}};
assign transition_address1 = grp_viterbi_Pipeline_L_prev_state_fu_264_transition_address1;
...
assign zext_ln33_fu_443_p1 = tmp_13_fu_437_p3;
assign zext_ln50_fu_515_p1 = t_3_reg_664;
assign zext_ln52_1_fu_494_p1 = store_forwarded_fu_116;
assign zext_ln52_fu_489_p1 = tmp_12_fu_481_p3;
always @ (posedge ap_clk) begin
    tmp_s_reg_600[4:0] <= 5'b00000;
    llike_addr_1_reg_605[4:0] <= 5'b00000;
    zext_ln19_reg_610[11:8] <= 4'b0000;
    tmp_12_reg_680[4:0] <= 5'b00000;
end
endmodule 