module bfs (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,nodes_address0,nodes_ce0,nodes_q0,edges_address0,edges_ce0,edges_q0,edges_address1,edges_ce1,edges_q1,starting_node,level_address0,level_ce0,level_we0,level_d0,level_q0,level_counts_address0,level_counts_ce0,level_counts_we0,level_counts_d0); 
...
wire   [11:0] grp_bfs_Pipeline_loop_neighbors_fu_181_edges_address1;
wire    grp_bfs_Pipeline_loop_neighbors_fu_181_edges_ce1;
...
wire   [63:0] grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_6_out;
wire    grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_6_out_ap_vld;
reg   [63:0] cnt_reg_145;
reg   [63:0] ap_phi_mux_cnt_4_phi_fu_173_p4;
wire    ap_CS_fsm_state7;
reg   [8:0] n_reg_158;
reg   [63:0] cnt_4_reg_169;
...
bfs_bfs_Pipeline_loop_neighbors grp_bfs_Pipeline_loop_neighbors_fu_181(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_bfs_Pipeline_loop_neighbors_fu_181_ap_start),.ap_done(grp_bfs_Pipeline_loop_neighbors_fu_181_ap_done),.ap_idle(grp_bfs_Pipeline_loop_neighbors_fu_181_ap_idle),.ap_ready(grp_bfs_Pipeline_loop_neighbors_fu_181_ap_ready),.empty(e_reg_340),.cnt(cnt_reg_145),.tmp_end(tmp_end_reg_345),.edges_address0(grp_bfs_Pipeline_loop_neighbors_fu_181_edges_address0),.edges_ce0(grp_bfs_Pipeline_loop_neighbors_fu_181_edges_ce0),.edges_q0(edges_q0),.edges_address1(grp_bfs_Pipeline_loop_neighbors_fu_181_edges_address1),.edges_ce1(grp_bfs_Pipeline_loop_neighbors_fu_181_edges_ce1),.edges_q1(edges_q1),.level_address0(grp_bfs_Pipeline_loop_neighbors_fu_181_level_address0),.level_ce0(grp_bfs_Pipeline_loop_neighbors_fu_181_level_ce0),.level_we0(grp_bfs_Pipeline_loop_neighbors_fu_181_level_we0),.level_d0(grp_bfs_Pipeline_loop_neighbors_fu_181_level_d0),.level_q0(level_q0),.indvars_iv_next11_cast2(indvars_iv_next11_reg_298),.cnt_6_out(grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_6_out),.cnt_6_out_ap_vld(grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_6_out_ap_vld));
...
always @ (posedge ap_clk) begin
    if (((icmp_ln25_fu_255_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        cnt_4_reg_169 <= cnt_reg_145;
    end else if (((icmp_ln25_reg_331 == 1'd1) & (1'b1 == ap_CS_fsm_state7))) begin
        cnt_4_reg_169 <= grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_6_out;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        cnt_reg_145 <= ap_phi_mux_cnt_4_phi_fu_173_p4;
...
always @ (*) begin
    if (((icmp_ln25_reg_331 == 1'd1) & (1'b1 == ap_CS_fsm_state7))) begin
        ap_phi_mux_cnt_4_phi_fu_173_p4 = grp_bfs_Pipeline_loop_neighbors_fu_181_cnt_6_out;
    end else begin
        ap_phi_mux_cnt_4_phi_fu_173_p4 = cnt_4_reg_169;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln24_fu_217_p2 == 1'd1) & (1'd0 == and_ln43_fu_245_p2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (grp_bfs_Pipeline_loop_neighbors_fu_181_ap_done == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end
...
assign edges_address1 = grp_bfs_Pipeline_loop_neighbors_fu_181_edges_address1;
assign edges_ce0 = grp_bfs_Pipeline_loop_neighbors_fu_181_edges_ce0;
assign edges_ce1 = grp_bfs_Pipeline_loop_neighbors_fu_181_edges_ce1;
