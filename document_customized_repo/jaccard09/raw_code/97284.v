...
sparsemux_9_2_32_1_1_U1729(.din0(buff_E_out_q0),.din1(buff_E_out_1_q0),.din2(buff_E_out_2_q0),.din3(buff_E_out_3_q0),.def(tmp_2_fu_785_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_2_fu_785_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1730(.din0(buff_E_out_4_q0),.din1(buff_E_out_5_q0),.din2(buff_E_out_6_q0),.din3(buff_E_out_7_q0),.def(tmp_3_fu_808_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_3_fu_808_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1731(.din0(buff_E_out_8_q0),.din1(buff_E_out_9_q0),.din2(buff_E_out_10_q0),.din3(buff_E_out_11_q0),.def(tmp_4_fu_831_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_4_fu_831_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1732(.din0(buff_E_out_12_q0),.din1(buff_E_out_13_q0),.din2(buff_E_out_14_q0),.din3(buff_E_out_15_q0),.def(tmp_5_fu_854_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_5_fu_854_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1733(.din0(buff_E_out_16_q0),.din1(buff_E_out_17_q0),.din2(buff_E_out_18_q0),.din3(buff_E_out_19_q0),.def(tmp_6_fu_877_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_6_fu_877_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1734(.din0(buff_E_out_20_q0),.din1(buff_E_out_21_q0),.din2(buff_E_out_22_q0),.din3(buff_E_out_23_q0),.def(tmp_7_fu_900_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_7_fu_900_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1735(.din0(buff_E_out_24_q0),.din1(buff_E_out_25_q0),.din2(buff_E_out_26_q0),.din3(buff_E_out_27_q0),.def(tmp_8_fu_923_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_8_fu_923_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U1736(.din0(buff_E_out_28_q0),.din1(buff_E_out_29_q0),.din2(buff_E_out_30_q0),.din3(buff_E_out_31_q0),.def(tmp_9_fu_946_p9),.sel(trunc_ln50_reg_1026),.dout(tmp_9_fu_946_p11));
...
assign lshr_ln6_9_fu_705_p4 = {{select_ln6_fu_685_p3[5:3]}};
...
assign tmp_1_fu_725_p3 = {{tmp_s_fu_715_p4}, {lshr_ln6_9_fu_705_p4}};
