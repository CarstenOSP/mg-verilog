...
sparsemux_9_2_32_1_1_U20(.din0(buff_x_q0),.din1(buff_x_1_q0),.din2(buff_x_2_q0),.din3(buff_x_3_q0),.def(tmp_4_fu_394_p9),.sel(tmp_4_fu_394_p10),.dout(tmp_4_fu_394_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U21(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.def(tmp_3_fu_439_p9),.sel(trunc_ln26_reg_591),.dout(tmp_3_fu_439_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add_reg_670 <= grp_fu_1888_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        mul3_reg_660 <= grp_fu_1892_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul_reg_630 <= grp_fu_1892_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
assign grp_fu_1888_p_din0 = add16_fu_92;
assign grp_fu_1888_p_din1 = mul3_reg_660;
assign grp_fu_1888_p_opcode = 2'd0;
assign grp_fu_1892_p_ce = 1'b1;
assign grp_fu_1892_p_din0 = grp_fu_262_p0;
assign grp_fu_1892_p_din1 = grp_fu_262_p1;
...
assign tmp_1_fu_379_p3 = {{empty_fu_358_p1}, {lshr_ln6_3_reg_556}};
...
assign zext_ln27_fu_386_p1 = tmp_1_fu_379_p3;
assign zext_ln6_1_fu_329_p1 = lshr_ln6_3_fu_319_p4;
assign zext_ln6_fu_462_p1 = lshr_ln6_1_reg_586;
endmodule 