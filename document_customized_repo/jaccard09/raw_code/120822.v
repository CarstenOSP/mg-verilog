...
output  [1:0] grp_fu_4742_p_opcode;
...
wire   [31:0] tmp_73_fu_947_p11;
reg   [31:0] tmp_73_reg_1329;
wire   [31:0] tmp_74_fu_970_p19;
reg   [31:0] tmp_74_reg_1334;
wire   [31:0] tmp_75_fu_1009_p11;
reg   [31:0] tmp_75_reg_1339;
wire   [31:0] tmp_76_fu_1032_p19;
reg   [31:0] tmp_76_reg_1344;
...
wire   [63:0] tmp_88_cast_fu_781_p1;
...
wire   [2:0] lshr_ln6_3_fu_763_p4;
wire   [8:0] tmp_s_fu_773_p3;
wire   [5:0] trunc_ln28_1_fu_741_p1;
wire   [8:0] tmp_83_fu_793_p3;
wire   [2:0] lshr_ln6_6_fu_817_p4;
wire   [8:0] tmp_84_fu_827_p3;
wire   [4:0] tmp_85_fu_847_p4;
wire   [8:0] tmp_86_fu_857_p4;
wire   [31:0] tmp_fu_908_p17;
wire    ap_block_pp0_stage2;
wire   [31:0] tmp_73_fu_947_p9;
wire   [31:0] tmp_74_fu_970_p17;
wire   [31:0] tmp_75_fu_1009_p9;
wire   [31:0] tmp_76_fu_1032_p17;
reg    ap_done_reg;
...
wire   [2:0] tmp_73_fu_947_p1;
wire   [2:0] tmp_73_fu_947_p3;
wire  signed [2:0] tmp_73_fu_947_p5;
wire  signed [2:0] tmp_73_fu_947_p7;
wire   [2:0] tmp_74_fu_970_p1;
wire   [2:0] tmp_74_fu_970_p3;
wire   [2:0] tmp_74_fu_970_p5;
wire   [2:0] tmp_74_fu_970_p7;
wire  signed [2:0] tmp_74_fu_970_p9;
wire  signed [2:0] tmp_74_fu_970_p11;
wire  signed [2:0] tmp_74_fu_970_p13;
wire  signed [2:0] tmp_74_fu_970_p15;
wire   [2:0] tmp_75_fu_1009_p1;
wire   [2:0] tmp_75_fu_1009_p3;
wire  signed [2:0] tmp_75_fu_1009_p5;
wire  signed [2:0] tmp_75_fu_1009_p7;
wire   [2:0] tmp_76_fu_1032_p1;
wire   [2:0] tmp_76_fu_1032_p3;
wire   [2:0] tmp_76_fu_1032_p5;
wire   [2:0] tmp_76_fu_1032_p7;
wire  signed [2:0] tmp_76_fu_1032_p9;
wire  signed [2:0] tmp_76_fu_1032_p11;
wire  signed [2:0] tmp_76_fu_1032_p13;
wire  signed [2:0] tmp_76_fu_1032_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 15'd1;
...
sparsemux_17_3_32_1_1_U667(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.din4(tmp1_4_q0),.din5(tmp1_5_q0),.din6(tmp1_6_q0),.din7(tmp1_7_q0),.def(tmp_fu_908_p17),.sel(trunc_ln28_2_reg_1147),.dout(tmp_fu_908_p19));
...
sparsemux_9_3_32_1_1_U668(.din0(buff_A_q0),.din1(buff_A_2_q0),.din2(buff_A_4_q0),.din3(buff_A_6_q0),.def(tmp_73_fu_947_p9),.sel(trunc_ln29_reg_1234),.dout(tmp_73_fu_947_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U669(.din0(buff_B_q1),.din1(buff_B_1_q1),.din2(buff_B_2_q1),.din3(buff_B_3_q1),.din4(buff_B_4_q1),.din5(buff_B_5_q1),.din6(buff_B_6_q1),.din7(buff_B_7_q1),.def(tmp_74_fu_970_p17),.sel(trunc_ln28_2_reg_1147),.dout(tmp_74_fu_970_p19));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U670(.din0(buff_A_1_q0),.din1(buff_A_3_q0),.din2(buff_A_5_q0),.din3(buff_A_7_q0),.def(tmp_75_fu_1009_p9),.sel(trunc_ln29_reg_1234),.dout(tmp_75_fu_1009_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U671(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.din4(buff_B_4_q0),.din5(buff_B_5_q0),.din6(buff_B_6_q0),.din7(buff_B_7_q0),.def(tmp_76_fu_1032_p17),.sel(trunc_ln28_2_reg_1147),.dout(tmp_76_fu_1032_p19));
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_1_fu_142 <= select_ln27_fu_716_p3;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage11_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        mul66_1_reg_1359 <= grp_fu_4746_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul_1_reg_1349 <= grp_fu_4746_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10)) | ((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6)))) begin
        reg_576 <= grp_fu_4746_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        reg_582 <= grp_fu_4742_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_73_reg_1329 <= tmp_73_fu_947_p11;
        tmp_74_reg_1334 <= tmp_74_fu_970_p19;
        tmp_75_reg_1339 <= tmp_75_fu_1009_p11;
        tmp_76_reg_1344 <= tmp_76_fu_1032_p19;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage8) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
            ...
            grp_fu_572_p0 = tmp_75_reg_1339;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_572_p0 = tmp_73_reg_1329;
        end else begin
            grp_fu_572_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage8) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        grp_fu_572_p1 = tmp_76_reg_1344;
    end else if (((1'b0 == ap_block_pp0_stage7) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        grp_fu_572_p1 = tmp_74_reg_1334;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_1_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_2_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_3_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_4_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_5_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_6_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_7_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        ...
        tmp1_address0_local = tmp_88_cast_fu_781_p1;
    end else begin
...
assign add_ln27_fu_677_p2 = (i_1_fu_142 + 7'd1);
...
assign grp_fu_4742_p_din0 = grp_fu_568_p0;
assign grp_fu_4742_p_din1 = grp_fu_568_p1;
assign grp_fu_4742_p_opcode = 2'd0;
assign grp_fu_4746_p_ce = 1'b1;
assign grp_fu_4746_p_din0 = grp_fu_572_p0;
assign grp_fu_4746_p_din1 = grp_fu_572_p1;
...
assign lshr_ln6_3_fu_763_p4 = {{select_ln28_fu_745_p3[5:3]}};
assign lshr_ln6_6_fu_817_p4 = {{k_mid2_fu_733_p3[5:3]}};
assign or_ln6_fu_711_p2 = (xor_ln29_fu_705_p2 | icmp_ln28_reg_1135);
assign select_ln27_fu_716_p3 = ((icmp_ln28_reg_1135[0:0] == 1'b1) ? add_ln27_fu_677_p2 : i_1_fu_142);
...
assign tmp_73_fu_947_p9 = 'bx;
assign tmp_74_fu_970_p17 = 'bx;
assign tmp_75_fu_1009_p9 = 'bx;
assign tmp_76_fu_1032_p17 = 'bx;
assign tmp_83_fu_793_p3 = {{trunc_ln28_1_fu_741_p1}, {lshr_ln6_3_fu_763_p4}};
assign tmp_84_fu_827_p3 = {{trunc_ln28_fu_723_p1}, {lshr_ln6_6_fu_817_p4}};
assign tmp_85_fu_847_p4 = {{k_mid2_fu_733_p3[5:1]}};
assign tmp_86_fu_857_p4 = {{{tmp_85_fu_847_p4}, {1'd1}}, {lshr_ln6_3_fu_763_p4}};
assign tmp_88_cast_fu_781_p1 = tmp_s_fu_773_p3;
assign tmp_fu_908_p17 = 'bx;
assign tmp_s_fu_773_p3 = {{trunc_ln28_fu_723_p1}, {lshr_ln6_3_fu_763_p4}};
...
assign zext_ln30_1_fu_835_p1 = tmp_84_fu_827_p3;
assign zext_ln30_2_fu_867_p1 = tmp_86_fu_857_p4;
assign zext_ln30_fu_801_p1 = tmp_83_fu_793_p3;
endmodule 