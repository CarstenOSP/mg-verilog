...
wire   [63:0] p_cast10_fu_255_p1;
wire   [63:0] p_cast9_fu_244_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_needwun_Pipeline_pad_a_fu_176_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln83_reg_429 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        empty_24_reg_410 <= empty_24_fu_289_p2;
        empty_25_reg_415 <= empty_25_fu_302_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        empty_23_reg_389 <= empty_23_fu_249_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        SEQB_address0 = p_cast10_fu_255_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state11 : begin
            if (((grp_needwun_Pipeline_pad_a_fu_176_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state11))) begin
...
always @ (*) begin
    ap_block_state12_on_subcall_done = ((grp_needwun_Pipeline_pad_b_fu_184_ap_done == 1'b0) & (icmp_ln83_reg_429 == 1'd1));
end
...
assign empty_24_fu_289_p2 = (p_shl2_fu_282_p3 + p_cast3_fu_279_p1);
...
assign or_ln65_1_fu_324_p3 = {{tmp_s_fu_314_p4}, {1'd1}};
assign p_cast10_fu_255_p1 = empty_23_fu_249_p2;
assign p_cast3_fu_279_p1 = empty_23_reg_389;
assign p_cast9_fu_244_p1 = empty_22_fu_238_p2;
assign p_shl1_fu_224_p3 = {{indvar_fu_86}, {7'd0}};
assign p_shl2_fu_282_p3 = {{empty_23_reg_389}, {7'd0}};
...
assign tmp_s_fu_314_p4 = {{a_str_idx_0_0_loc_fu_90[31:1]}};
