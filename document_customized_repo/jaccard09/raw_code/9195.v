...
sparsemux_9_3_32_1_1_U59(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_7_fu_361_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_7_fu_361_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U60(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_8_fu_385_p9),.sel(trunc_ln100_fu_358_p1),.dout(tmp_8_fu_385_p11));
...
assign add_ln126_1_fu_465_p2 = ($signed(32'd2400959708) + $signed(tmp_7_reg_748));
...
assign add_ln126_5_fu_598_p2 = (or_ln126_6_fu_592_p3 + tmp_8_reg_753);
