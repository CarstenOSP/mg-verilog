module backprop_backprop_Pipeline_label_39_label_40 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v2_1_address0,v2_1_ce0,v2_1_we0,v2_1_d0,v2_1_q0,v2_0_address0,v2_0_ce0,v2_0_we0,v2_0_d0,v2_0_q0,v10_address0,v10_ce0,v10_q0,v216_out,v216_out_ap_vld,grp_fu_48480_p_din0,grp_fu_48480_p_din1,grp_fu_48480_p_opcode,grp_fu_48480_p_dout0,grp_fu_48480_p_ce); 
...
output  [63:0] grp_fu_48480_p_din0;
output  [63:0] grp_fu_48480_p_din1;
output  [1:0] grp_fu_48480_p_opcode;
input  [63:0] grp_fu_48480_p_dout0;
output   grp_fu_48480_p_ce;
reg ap_idle;
reg v216_out_ap_vld;
...
dmul_64ns_64ns_64_7_max_dsp_1_U4783(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_126_p0),.din1(grp_fu_126_p1),.ce(1'b1),.dout(grp_fu_126_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v214_fu_60 <= grp_fu_48480_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v218_reg_381 <= grp_fu_126_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v220_reg_396 <= grp_fu_48480_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v221_reg_403 <= grp_fu_126_p2;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v214_load_1 = grp_fu_48480_p_dout0;
    end else begin
...
assign grp_fu_48480_p_ce = 1'b1;
assign grp_fu_48480_p_din0 = grp_fu_122_p0;
assign grp_fu_48480_p_din1 = grp_fu_122_p1;
assign grp_fu_48480_p_opcode = grp_fu_122_opcode;
