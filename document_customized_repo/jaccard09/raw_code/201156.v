...
wire   [11:0] tmp_6_fu_287_p4;
wire   [22:0] add_ln35_4_fu_297_p3;
...
sparsemux_17_3_32_1_1_U376(.din0(v9_fu_347_p2),.din1(v9_fu_347_p4),.din2(v9_fu_347_p6),.din3(v9_fu_347_p8),.din4(v9_fu_347_p10),.din5(v9_fu_347_p12),.din6(v9_fu_347_p14),.din7(v9_fu_347_p16),.def(v9_fu_347_p17),.sel(trunc_ln29_4_reg_421),.dout(v9_fu_347_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln29_4_reg_421 <= {{ap_sig_allocacmp_v8[9:7]}};
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln35_4_fu_297_p3 = {{tmp_6_fu_287_p4}, {ap_sig_allocacmp_v8}};
...
assign tmp_6_fu_287_p4 = {{v5_3[12:1]}};
...
assign zext_ln35_fu_305_p1 = add_ln35_4_fu_297_p3;
endmodule 