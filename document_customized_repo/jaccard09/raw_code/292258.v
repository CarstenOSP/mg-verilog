module backprop_backprop_Pipeline_label_19_label_20 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_02548_reload,mux_case_12652_reload,mux_case_22756_reload,empty,v7_address0,v7_ce0,v7_q0,v107_reload,mux_case_12964_reload,v107_2_reload,v2_address0,v2_ce0,v2_q0,v8_address0,v8_ce0,v8_we0,v8_d0,v16_address0,v16_ce0,v16_q0,grp_fu_3053_p_din0,grp_fu_3053_p_din1,grp_fu_3053_p_opcode,grp_fu_3053_p_dout0,grp_fu_3053_p_ce,grp_fu_3065_p_din0,grp_fu_3065_p_din1,grp_fu_3065_p_dout0,grp_fu_3065_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_02548_reload;
input  [63:0] mux_case_12652_reload;
input  [63:0] mux_case_22756_reload;
input  [8:0] empty;
output  [8:0] v7_address0;
output   v7_ce0;
input  [63:0] v7_q0;
input  [63:0] v107_reload;
input  [63:0] mux_case_12964_reload;
...
output  [1:0] grp_fu_3053_p_opcode;
...
wire   [0:0] bit_sel9_fu_367_p3;
wire   [63:0] v116_fu_385_p7;
wire   [63:0] xor_ln6_fu_401_p3;
...
sparsemux_7_2_64_1_1_U287(.din0(mux_case_02548_reload),.din1(mux_case_12652_reload),.din2(mux_case_22756_reload),.def(v112_fu_287_p7),.sel(select_ln190_reg_516),.dout(v112_fu_287_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U288(.din0(v107_reload),.din1(mux_case_12964_reload),.din2(v107_2_reload),.def(v116_fu_385_p7),.sel(select_ln190_reg_516_pp0_iter1_reg),.dout(v116_fu_385_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln190_fu_224_p2 == 1'd0))) begin
            indvar_flatten_fu_96 <= add_ln190_fu_230_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            v120_fu_84 <= grp_fu_3053_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln190_fu_230_p2 = (ap_sig_allocacmp_indvar_flatten_load + 8'd1);
assign add_ln192_fu_270_p2 = (select_ln190_fu_250_p3 + 2'd1);
assign add_ln194_fu_260_p2 = (zext_ln192_2_fu_256_p1 + empty);
...
assign bit_sel9_fu_367_p3 = bitcast_ln196_fu_363_p1[64'd63];
assign bitcast_ln196_fu_363_p1 = grp_fu_3053_p_dout0;
assign grp_fu_3053_p_ce = 1'b1;
assign grp_fu_3053_p_din0 = grp_fu_193_p0;
assign grp_fu_3053_p_din1 = grp_fu_193_p1;
assign grp_fu_3053_p_opcode = grp_fu_193_opcode;
assign grp_fu_3065_p_ce = 1'b1;
assign grp_fu_3065_p_din0 = grp_fu_197_p0;
assign grp_fu_3065_p_din1 = grp_fu_197_p1;
assign icmp_ln190_fu_224_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 8'd192) ? 1'b1 : 1'b0);
...
assign v115_fu_407_p1 = xor_ln6_fu_401_p3;
...
assign xor_ln196_fu_375_p2 = (bit_sel9_fu_367_p3 ^ 1'd1);
assign xor_ln6_fu_401_p3 = {{xor_ln196_reg_563}, {trunc_ln196_reg_568}};
