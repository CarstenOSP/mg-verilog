...
sparsemux_7_2_64_1_1_U258(.din0(v14_3_reload),.din1(v14_4_reload),.din2(v14_5_reload),.def(v94_fu_251_p7),.sel(v93_1_reg_403_pp0_iter1_reg),.dout(v94_fu_251_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U259(.din0(v75),.din1(v75_3),.din2(v75_4),.def(v98_fu_294_p7),.sel(v93_1_reg_403_pp0_iter8_reg),.dout(v98_fu_294_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v13_7_reg_453 <= grp_fu_3781_p_dout0;
...
assign bitcast_ln172_fu_272_p1 = grp_fu_3763_p_dout0;
assign grp_fu_3763_p_ce = 1'b1;
assign grp_fu_3763_p_din0 = v94_fu_251_p9;
assign grp_fu_3763_p_din1 = v95_fu_268_p1;
assign grp_fu_3763_p_opcode = 2'd1;
assign grp_fu_3781_p_ce = 1'b1;
assign grp_fu_3781_p_din0 = v97_fu_316_p1;
assign grp_fu_3781_p_din1 = v98_reg_443;
