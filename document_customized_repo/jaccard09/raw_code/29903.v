...
wire   [63:0] tmp_161_fu_136_p9;
reg   [63:0] tmp_161_reg_180;
reg   [63:0] tmp_161_reg_180_pp0_iter1_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_161_fu_136_p1;
wire   [1:0] tmp_161_fu_136_p3;
wire  signed [1:0] tmp_161_fu_136_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_7_2_64_1_1_U525(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_161_fu_136_p7),.sel(ap_sig_allocacmp_i_12),.dout(tmp_161_fu_136_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_161_reg_180 <= tmp_161_fu_136_p9;
        tmp_161_reg_180_pp0_iter1_reg <= tmp_161_reg_180;
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_5581_p_din0 = tmp_161_reg_180_pp0_iter1_reg;
