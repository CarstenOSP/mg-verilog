...
reg   [31:0] bucket_load_64_reg_251;
...
wire   [7:0] zext_ln11_1_fu_118_p1;
wire   [10:0] or_ln_fu_166_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        bucket_load_64_reg_251 <= bucket_q0;
    end
end
always @ (*) begin
...
assign add_ln25_fu_152_p2 = (zext_ln11_1_fu_118_p1 + 8'd1);
assign add_ln26_fu_130_p2 = ($signed(shl_ln_fu_122_p3) + $signed(11'd2047));
assign add_ln27_1_fu_179_p2 = (bucket_q1 + sum_q0);
assign add_ln27_2_fu_193_p2 = (bucket_load_64_reg_251 + add_ln27_1_reg_245);
...
assign or_ln_fu_166_p3 = {{ap_sig_allocacmp_radixID_1}, {4'd15}};
assign shl_ln_fu_122_p3 = {{ap_sig_allocacmp_radixID_1}, {4'd0}};
assign sum_address0 = sum_address0_local;
assign sum_address1 = zext_ln11_fu_185_p1;
...
assign zext_ln11_1_fu_118_p1 = ap_sig_allocacmp_radixID_1;
assign zext_ln11_fu_185_p1 = radixID_1_reg_215;
assign zext_ln25_fu_189_p1 = add_ln25_reg_231;
assign zext_ln27_1_fu_147_p1 = add_ln27_fu_141_p2;
assign zext_ln27_2_fu_174_p1 = or_ln_fu_166_p3;
