...
wire   [1:0] trunc_ln12_fu_286_p1;
reg   [1:0] trunc_ln12_reg_712;
wire   [6:0] add_ln53_fu_335_p2;
reg   [6:0] add_ln53_reg_743;
reg   [0:0] tmp_2_reg_749_pp0_iter1_reg;
reg   [0:0] tmp_2_reg_749_pp0_iter2_reg;
wire   [63:0] tmp_fu_349_p11;
reg   [63:0] tmp_reg_753;
...
wire   [3:0] lshr_ln8_1_fu_290_p4;
wire   [11:0] tmp_s_fu_300_p3;
wire   [11:0] shl_ln2_fu_316_p3;
wire   [11:0] add_ln54_fu_324_p2;
wire   [6:0] zext_ln12_fu_282_p1;
wire   [63:0] tmp_fu_349_p9;
...
wire   [1:0] tmp_fu_349_p1;
wire   [1:0] tmp_fu_349_p3;
wire  signed [1:0] tmp_fu_349_p5;
wire  signed [1:0] tmp_fu_349_p7;
wire  signed [1:0] tmp_1_fu_424_p1;
wire   [1:0] tmp_1_fu_424_p3;
wire   [1:0] tmp_1_fu_424_p5;
...
sparsemux_9_2_64_1_1_U36(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(tmp_fu_349_p9),.sel(trunc_ln12_reg_712),.dout(tmp_fu_349_p11));
...
sparsemux_9_2_64_1_1_U37(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(tmp_1_fu_424_p9),.sel(trunc_ln12_reg_712),.dout(tmp_1_fu_424_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_fu_100 <= min_p_139;
    end else if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (tmp_2_reg_749_pp0_iter2_reg == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        min_p_fu_100 <= min_p_131_fu_649_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_s_1_fu_108 <= 6'd1;
    end else if (((tmp_2_reg_749 == 1'd0) & (1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        min_p_127_reg_810 <= min_p_fu_100;
        s_reg_706 <= ap_sig_allocacmp_s;
        s_reg_706_pp0_iter1_reg <= s_reg_706;
        s_reg_706_pp0_iter2_reg <= s_reg_706_pp0_iter1_reg;
        tmp_2_reg_749 <= add_ln53_fu_335_p2[32'd6];
        tmp_2_reg_749_pp0_iter1_reg <= tmp_2_reg_749;
        tmp_2_reg_749_pp0_iter2_reg <= tmp_2_reg_749_pp0_iter1_reg;
        trunc_ln12_reg_712 <= trunc_ln12_fu_286_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        min_p_129_reg_835 <= min_p_129_fu_562_p3;
        tmp_1_reg_793 <= tmp_1_fu_424_p11;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_63_reg_817 <= grp_fu_215_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        p_reg_803 <= grp_fu_215_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp_201_reg_842 <= grp_fu_390_p_dout0;
    end
end
always @ (*) begin
    if (((tmp_2_reg_749 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (tmp_2_reg_749_pp0_iter2_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_248_p0 = tmp_1_reg_793;
        end else if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
            grp_fu_248_p0 = tmp_reg_753;
        end else begin
            grp_fu_248_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
            grp_fu_252_p1 = min_p_129_fu_562_p3;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_loop_exit_ready_pp0_iter2_reg == 1'b1) & (tmp_2_reg_749_pp0_iter2_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
assign add_ln53_fu_335_p2 = (zext_ln12_fu_282_p1 + 7'd1);
...
assign add_ln54_fu_324_p2 = (shl_ln2_fu_316_p3 + zext_ln52_cast_fu_260_p1);
...
assign and_ln55_3_fu_644_p2 = (tmp_201_reg_842 & and_ln55_2_fu_638_p2);
assign and_ln55_fu_536_p2 = (or_ln55_fu_512_p2 & grp_fu_390_p_dout0);
...
assign bitcast_ln55_1_fu_483_p1 = min_p_127_reg_810;
assign bitcast_ln55_2_fu_568_p1 = p_63_reg_817;
assign bitcast_ln55_3_fu_585_p1 = min_p_129_reg_835;
assign bitcast_ln55_fu_466_p1 = p_reg_803;
assign grp_fu_215_p_ce = 1'b1;
assign grp_fu_215_p_din0 = grp_fu_248_p0;
assign grp_fu_215_p_din1 = grp_fu_248_p1;
assign grp_fu_215_p_opcode = 2'd0;
assign grp_fu_390_p_ce = 1'b1;
assign grp_fu_390_p_din0 = grp_fu_252_p0;
assign grp_fu_390_p_din1 = grp_fu_252_p1;
assign grp_fu_390_p_opcode = 5'd4;
assign icmp_ln55_1_fu_506_p2 = ((trunc_ln55_fu_479_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln55_2_fu_518_p2 = ((tmp_197_fu_486_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln55_3_fu_524_p2 = ((trunc_ln55_1_fu_496_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln55_4_fu_602_p2 = ((tmp_199_fu_571_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln55_5_fu_608_p2 = ((trunc_ln55_2_fu_581_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln55_6_fu_620_p2 = ((tmp_200_fu_588_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln55_7_fu_626_p2 = ((trunc_ln55_3_fu_598_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln55_fu_500_p2 = ((tmp_196_fu_469_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign lshr_ln8_1_fu_290_p4 = {{ap_sig_allocacmp_s[5:2]}};
assign lshr_ln9_2_fu_372_p4 = {{add_ln53_reg_743[6:2]}};
assign min_p_129_fu_562_p3 = ((and_ln55_1_reg_824[0:0] == 1'b1) ? p_reg_803 : min_p_127_reg_810);
assign min_p_131_fu_649_p3 = ((and_ln55_3_fu_644_p2[0:0] == 1'b1) ? p_63_reg_817 : min_p_129_reg_835);
...
assign shl_ln2_fu_316_p3 = {{ap_sig_allocacmp_s}, {6'd0}};
assign shl_ln54_1_fu_401_p3 = {{trunc_ln54_fu_398_p1}, {6'd0}};
assign tmp_196_fu_469_p4 = {{bitcast_ln55_fu_466_p1[62:52]}};
assign tmp_197_fu_486_p4 = {{bitcast_ln55_1_fu_483_p1[62:52]}};
assign tmp_199_fu_571_p4 = {{bitcast_ln55_2_fu_568_p1[62:52]}};
assign tmp_1_fu_424_p9 = 'bx;
assign tmp_200_fu_588_p4 = {{bitcast_ln55_3_fu_585_p1[62:52]}};
assign tmp_fu_349_p9 = 'bx;
assign tmp_s_fu_300_p3 = {{t_1}, {lshr_ln8_1_fu_290_p4}};
assign transition_address0 = transition_address0_local;
assign transition_ce0 = transition_ce0_local;
assign trunc_ln12_fu_286_p1 = ap_sig_allocacmp_s[1:0];
