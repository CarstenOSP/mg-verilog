module aes256_encrypt_ecb_aes256_encrypt_ecb_Pipeline_sub (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buf_1_address0,buf_1_ce0,buf_1_we0,buf_1_d0,buf_1_address1,buf_1_ce1,buf_1_q1,buf_0_address0,buf_0_ce0,buf_0_we0,buf_0_d0,buf_0_address1,buf_0_ce1,buf_0_q1,sbox_0_address0,sbox_0_ce0,sbox_0_q0,sbox_1_address0,sbox_1_ce0,sbox_1_q0); 
...
reg   [0:0] trunc_ln58_1_reg_227;
wire   [63:0] zext_ln58_fu_152_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln58_1_fu_184_p1;
reg   [4:0] i_fu_54;
...
reg    buf_0_ce1_local;
reg    buf_0_we0_local;
wire   [7:0] select_ln58_1_fu_190_p3;
reg    buf_0_ce0_local;
reg    buf_1_ce1_local;
reg    buf_1_we0_local;
reg    buf_1_ce0_local;
...
wire   [2:0] lshr_ln58_s_fu_142_p4;
wire   [7:0] select_ln58_fu_163_p3;
wire   [6:0] lshr_ln58_1_fu_174_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln58_1_reg_227 <= trunc_ln58_1_fu_170_p1;
...
assign add_ln58_fu_136_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(5'd31));
...
assign buf_0_d0 = select_ln58_1_fu_190_p3;
...
assign buf_1_d0 = select_ln58_1_fu_190_p3;
assign buf_1_we0 = buf_1_we0_local;
assign icmp_ln58_fu_126_p2 = ((ap_sig_allocacmp_i_1 == 5'd0) ? 1'b1 : 1'b0);
assign lshr_ln58_1_fu_174_p4 = {{select_ln58_fu_163_p3[7:1]}};
assign lshr_ln58_s_fu_142_p4 = {{add_ln58_fu_136_p2[3:1]}};
assign sbox_0_address0 = zext_ln58_1_fu_184_p1;
assign sbox_0_ce0 = sbox_0_ce0_local;
assign sbox_1_address0 = zext_ln58_1_fu_184_p1;
assign sbox_1_ce0 = sbox_1_ce0_local;
assign select_ln58_1_fu_190_p3 = ((trunc_ln58_1_reg_227[0:0] == 1'b1) ? sbox_1_q0 : sbox_0_q0);
assign select_ln58_fu_163_p3 = ((trunc_ln58_reg_210[0:0] == 1'b1) ? buf_0_q1 : buf_1_q1);
assign trunc_ln58_1_fu_170_p1 = select_ln58_fu_163_p3[0:0];
assign trunc_ln58_fu_132_p1 = ap_sig_allocacmp_i_1[0:0];
assign zext_ln58_1_fu_184_p1 = lshr_ln58_1_fu_174_p4;
assign zext_ln58_fu_152_p1 = lshr_ln58_s_fu_142_p4;
endmodule 