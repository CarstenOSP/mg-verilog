module sha_stream_sha_transform_Pipeline_trans_lp3 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A,B,C,D,E,W_address0,W_ce0,W_q0,W_1_address0,W_1_ce0,W_1_q0,W_2_address0,W_2_ce0,W_2_q0,W_3_address0,W_3_ce0,W_3_q0,B_23_out,B_23_out_ap_vld,B_2_out,B_2_out_ap_vld,D_23_out,D_23_out_ap_vld,E_23_out,E_23_out_ap_vld,E_2_out,E_2_out_ap_vld); 
...
reg   [31:0] E_24_reg_542;
reg   [31:0] D_15_reg_548;
...
reg   [31:0] D_12_fu_102;
reg   [31:0] C_17_fu_106;
wire   [31:0] C_2_fu_384_p3;
reg   [31:0] A_12_fu_110;
wire   [31:0] A_15_fu_437_p2;
...
sparsemux_9_2_32_1_1_U17(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.def(tmp_5_fu_303_p9),.sel(trunc_ln100_reg_512),.dout(tmp_5_fu_303_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        D_15_reg_548 <= C_17_fu_106;
        E_24_reg_542 <= D_12_fu_102;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_5_reg_537 <= tmp_5_fu_303_p11;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln116_reg_508_pp0_iter2_reg == 1'd0))) begin
        ap_sig_allocacmp_B_2_load = A_12_fu_110;
    end else begin
...
assign A_15_fu_437_p2 = (add_ln118_2_reg_553 + add_ln118_fu_431_p2);
assign B_23_out = A_12_fu_110;
assign B_2_out = B_2_fu_94;
assign C_2_fu_384_p3 = {{trunc_ln118_1_fu_370_p1}, {lshr_ln118_1_fu_374_p4}};
assign D_23_out = D_15_reg_548;
assign E_23_out = E_24_reg_542;
...
assign add_ln118_1_fu_359_p2 = (tmp_5_reg_537 + 32'd1518500249);
...
assign and_ln118_1_fu_347_p2 = (xor_ln118_fu_335_p2 & D_12_fu_102);
assign and_ln118_fu_341_p2 = (ap_sig_allocacmp_B_2_load & C_17_fu_106);
...
assign lshr_ln3_fu_413_p4 = {{A_12_fu_110[31:27]}};
...
assign trunc_ln118_fu_409_p1 = A_12_fu_110[26:0];
