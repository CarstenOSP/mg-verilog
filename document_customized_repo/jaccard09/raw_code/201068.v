...
sparsemux_17_3_32_1_1_U128(.din0(v9_fu_347_p2),.din1(v9_fu_347_p4),.din2(v9_fu_347_p6),.din3(v9_fu_347_p8),.din4(v9_fu_347_p10),.din5(v9_fu_347_p12),.din6(v9_fu_347_p14),.din7(v9_fu_347_p16),.def(v9_fu_347_p17),.sel(trunc_ln29_1_reg_421),.dout(v9_fu_347_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln29_1_reg_421 <= {{ap_sig_allocacmp_v8[9:7]}};
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v11_reg_486 <= grp_fu_3462_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        v13_reg_496 <= grp_fu_1574_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_1574_p_din0 = v12_fu_90;
assign grp_fu_1574_p_din1 = v11_reg_486;
assign grp_fu_1574_p_opcode = 2'd0;
assign grp_fu_3462_p_ce = 1'b1;
assign grp_fu_3462_p_din0 = v9_reg_471;
assign grp_fu_3462_p_din1 = v10_fu_386_p1;
assign icmp_ln33_fu_249_p2 = ((ap_sig_allocacmp_v8 == 11'd1024) ? 1'b1 : 1'b0);
assign tmp_2_fu_287_p4 = {{v5_1[12:1]}};
assign trunc_ln33_fu_261_p1 = ap_sig_allocacmp_v8[6:0];
