...
wire   [2:0] trunc_ln93_fu_505_p1;
reg   [2:0] trunc_ln93_reg_698;
wire   [2:0] trunc_ln94_fu_531_p1;
reg   [2:0] trunc_ln94_reg_743;
reg   [2:0] trunc_ln94_reg_743_pp0_iter2_reg;
reg   [2:0] trunc_ln94_reg_743_pp0_iter3_reg;
reg   [2:0] trunc_ln94_reg_743_pp0_iter4_reg;
reg   [2:0] trunc_ln94_reg_743_pp0_iter5_reg;
reg   [2:0] trunc_ln94_reg_743_pp0_iter6_reg;
reg   [2:0] trunc_ln94_reg_743_pp0_iter7_reg;
reg   [2:0] trunc_ln94_reg_743_pp0_iter8_reg;
reg   [2:0] trunc_ln94_reg_743_pp0_iter9_reg;
wire   [2:0] lshr_ln92_1_fu_535_p4;
reg   [2:0] lshr_ln92_1_reg_748;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter2_reg;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter3_reg;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter4_reg;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter5_reg;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter6_reg;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter7_reg;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter8_reg;
reg   [2:0] lshr_ln92_1_reg_748_pp0_iter9_reg;
wire   [5:0] trunc_ln95_fu_557_p1;
...
reg   [5:0] trunc_ln95_reg_793_pp0_iter9_reg;
wire   [63:0] tmp_s_fu_577_p19;
reg   [63:0] tmp_s_reg_798;
wire   [63:0] tmp_29_fu_616_p19;
reg   [63:0] tmp_29_reg_803;
reg   [63:0] mul_i4_reg_808;
wire   [63:0] zext_ln92_fu_519_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln92_1_fu_545_p1;
wire   [63:0] zext_ln95_fu_661_p1;
reg   [6:0] j_fu_108;
wire   [6:0] add_ln94_fu_561_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_112;
wire   [6:0] select_ln93_fu_497_p3;
reg   [12:0] indvar_flatten6_fu_116;
wire   [12:0] add_ln93_fu_460_p2;
...
wire   [0:0] icmp_ln94_fu_477_p2;
wire   [6:0] add_ln93_1_fu_491_p2;
wire   [2:0] lshr_ln_fu_509_p4;
wire   [6:0] select_ln92_fu_483_p3;
wire   [63:0] tmp_s_fu_577_p17;
wire   [63:0] tmp_29_fu_616_p17;
wire   [8:0] add_ln_fu_655_p3;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_s_fu_577_p1;
wire   [2:0] tmp_s_fu_577_p3;
wire   [2:0] tmp_s_fu_577_p5;
wire   [2:0] tmp_s_fu_577_p7;
wire  signed [2:0] tmp_s_fu_577_p9;
wire  signed [2:0] tmp_s_fu_577_p11;
wire  signed [2:0] tmp_s_fu_577_p13;
wire  signed [2:0] tmp_s_fu_577_p15;
wire   [2:0] tmp_29_fu_616_p1;
wire   [2:0] tmp_29_fu_616_p3;
wire   [2:0] tmp_29_fu_616_p5;
wire   [2:0] tmp_29_fu_616_p7;
wire  signed [2:0] tmp_29_fu_616_p9;
wire  signed [2:0] tmp_29_fu_616_p11;
wire  signed [2:0] tmp_29_fu_616_p13;
wire  signed [2:0] tmp_29_fu_616_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_108 = 7'd0;
#0 i_fu_112 = 7'd0;
#0 indvar_flatten6_fu_116 = 13'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_x_U517(.din0(activations1_q0),.din1(activations1_1_q0),.din2(activations1_2_q0),.din3(activations1_3_q0),.din4(activations1_4_q0),.din5(activations1_5_q0),.din6(activations1_6_q0),.din7(activations1_7_q0),.def(tmp_s_fu_577_p17),.sel(trunc_ln93_reg_698),.dout(tmp_s_fu_577_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_x_U518(.din0(oracle_activations2_q0),.din1(oracle_activations2_1_q0),.din2(oracle_activations2_2_q0),.din3(oracle_activations2_3_q0),.din4(oracle_activations2_4_q0),.din5(oracle_activations2_5_q0),.din6(oracle_activations2_6_q0),.din7(oracle_activations2_7_q0),.def(tmp_29_fu_616_p17),.sel(trunc_ln94_reg_743),.dout(tmp_29_fu_616_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_fu_112 <= select_ln93_fu_497_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln93_fu_454_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten6_fu_116 <= add_ln93_fu_460_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten6_fu_116 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln92_1_reg_748 <= {{select_ln92_fu_483_p3[5:3]}};
        trunc_ln93_reg_698 <= trunc_ln93_fu_505_p1;
        trunc_ln94_reg_743 <= trunc_ln94_fu_531_p1;
        trunc_ln95_reg_793 <= trunc_ln95_fu_557_p1;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln92_1_reg_748_pp0_iter2_reg <= lshr_ln92_1_reg_748;
        lshr_ln92_1_reg_748_pp0_iter3_reg <= lshr_ln92_1_reg_748_pp0_iter2_reg;
        lshr_ln92_1_reg_748_pp0_iter4_reg <= lshr_ln92_1_reg_748_pp0_iter3_reg;
        lshr_ln92_1_reg_748_pp0_iter5_reg <= lshr_ln92_1_reg_748_pp0_iter4_reg;
        lshr_ln92_1_reg_748_pp0_iter6_reg <= lshr_ln92_1_reg_748_pp0_iter5_reg;
        lshr_ln92_1_reg_748_pp0_iter7_reg <= lshr_ln92_1_reg_748_pp0_iter6_reg;
        lshr_ln92_1_reg_748_pp0_iter8_reg <= lshr_ln92_1_reg_748_pp0_iter7_reg;
        lshr_ln92_1_reg_748_pp0_iter9_reg <= lshr_ln92_1_reg_748_pp0_iter8_reg;
        mul_i4_reg_808 <= grp_fu_8566_p_dout0;
        tmp_29_reg_803 <= tmp_29_fu_616_p19;
        tmp_s_reg_798 <= tmp_s_fu_577_p19;
        trunc_ln94_reg_743_pp0_iter2_reg <= trunc_ln94_reg_743;
        trunc_ln94_reg_743_pp0_iter3_reg <= trunc_ln94_reg_743_pp0_iter2_reg;
        trunc_ln94_reg_743_pp0_iter4_reg <= trunc_ln94_reg_743_pp0_iter3_reg;
        trunc_ln94_reg_743_pp0_iter5_reg <= trunc_ln94_reg_743_pp0_iter4_reg;
        trunc_ln94_reg_743_pp0_iter6_reg <= trunc_ln94_reg_743_pp0_iter5_reg;
        trunc_ln94_reg_743_pp0_iter7_reg <= trunc_ln94_reg_743_pp0_iter6_reg;
        trunc_ln94_reg_743_pp0_iter8_reg <= trunc_ln94_reg_743_pp0_iter7_reg;
        trunc_ln94_reg_743_pp0_iter9_reg <= trunc_ln94_reg_743_pp0_iter8_reg;
        trunc_ln95_reg_793_pp0_iter2_reg <= trunc_ln95_reg_793;
        ...
        trunc_ln95_reg_793_pp0_iter9_reg <= trunc_ln95_reg_793_pp0_iter8_reg;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln93_fu_454_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd7))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1) & (trunc_ln94_reg_743_pp0_iter9_reg == 3'd0))) begin
...
assign activations1_1_address0 = zext_ln92_fu_519_p1;
assign activations1_1_ce0 = activations1_1_ce0_local;
assign activations1_2_address0 = zext_ln92_fu_519_p1;
assign activations1_2_ce0 = activations1_2_ce0_local;
assign activations1_3_address0 = zext_ln92_fu_519_p1;
assign activations1_3_ce0 = activations1_3_ce0_local;
assign activations1_4_address0 = zext_ln92_fu_519_p1;
assign activations1_4_ce0 = activations1_4_ce0_local;
assign activations1_5_address0 = zext_ln92_fu_519_p1;
assign activations1_5_ce0 = activations1_5_ce0_local;
assign activations1_6_address0 = zext_ln92_fu_519_p1;
assign activations1_6_ce0 = activations1_6_ce0_local;
assign activations1_7_address0 = zext_ln92_fu_519_p1;
assign activations1_7_ce0 = activations1_7_ce0_local;
assign activations1_address0 = zext_ln92_fu_519_p1;
assign activations1_ce0 = activations1_ce0_local;
assign add_ln93_1_fu_491_p2 = (i_fu_112 + 7'd1);
assign add_ln93_fu_460_p2 = (ap_sig_allocacmp_indvar_flatten6_load + 13'd1);
assign add_ln94_fu_561_p2 = (select_ln92_fu_483_p3 + 7'd1);
assign add_ln_fu_655_p3 = {{trunc_ln95_reg_793_pp0_iter9_reg}, {lshr_ln92_1_reg_748_pp0_iter9_reg}};
...
assign delta_weights2_1_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_1_ce0 = delta_weights2_1_ce0_local;
assign delta_weights2_1_d0 = mul_i4_reg_808;
assign delta_weights2_1_we0 = delta_weights2_1_we0_local;
assign delta_weights2_2_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_2_ce0 = delta_weights2_2_ce0_local;
assign delta_weights2_2_d0 = mul_i4_reg_808;
assign delta_weights2_2_we0 = delta_weights2_2_we0_local;
assign delta_weights2_3_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_3_ce0 = delta_weights2_3_ce0_local;
assign delta_weights2_3_d0 = mul_i4_reg_808;
assign delta_weights2_3_we0 = delta_weights2_3_we0_local;
assign delta_weights2_4_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_4_ce0 = delta_weights2_4_ce0_local;
assign delta_weights2_4_d0 = mul_i4_reg_808;
assign delta_weights2_4_we0 = delta_weights2_4_we0_local;
assign delta_weights2_5_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_5_ce0 = delta_weights2_5_ce0_local;
assign delta_weights2_5_d0 = mul_i4_reg_808;
assign delta_weights2_5_we0 = delta_weights2_5_we0_local;
assign delta_weights2_6_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_6_ce0 = delta_weights2_6_ce0_local;
assign delta_weights2_6_d0 = mul_i4_reg_808;
assign delta_weights2_6_we0 = delta_weights2_6_we0_local;
assign delta_weights2_7_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_7_ce0 = delta_weights2_7_ce0_local;
assign delta_weights2_7_d0 = mul_i4_reg_808;
assign delta_weights2_7_we0 = delta_weights2_7_we0_local;
assign delta_weights2_address0 = zext_ln95_fu_661_p1;
assign delta_weights2_ce0 = delta_weights2_ce0_local;
assign delta_weights2_d0 = mul_i4_reg_808;
assign delta_weights2_we0 = delta_weights2_we0_local;
assign grp_fu_8566_p_ce = 1'b1;
assign grp_fu_8566_p_din0 = tmp_s_reg_798;
assign grp_fu_8566_p_din1 = tmp_29_reg_803;
assign icmp_ln93_fu_454_p2 = ((ap_sig_allocacmp_indvar_flatten6_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln94_fu_477_p2 = ((j_fu_108 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln92_1_fu_535_p4 = {{select_ln92_fu_483_p3[5:3]}};
assign lshr_ln_fu_509_p4 = {{select_ln93_fu_497_p3[5:3]}};
assign oracle_activations2_1_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_1_ce0 = oracle_activations2_1_ce0_local;
assign oracle_activations2_2_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_2_ce0 = oracle_activations2_2_ce0_local;
assign oracle_activations2_3_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_3_ce0 = oracle_activations2_3_ce0_local;
assign oracle_activations2_4_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_4_ce0 = oracle_activations2_4_ce0_local;
assign oracle_activations2_5_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_5_ce0 = oracle_activations2_5_ce0_local;
assign oracle_activations2_6_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_6_ce0 = oracle_activations2_6_ce0_local;
assign oracle_activations2_7_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_7_ce0 = oracle_activations2_7_ce0_local;
assign oracle_activations2_address0 = zext_ln92_1_fu_545_p1;
assign oracle_activations2_ce0 = oracle_activations2_ce0_local;
assign select_ln92_fu_483_p3 = ((icmp_ln94_fu_477_p2[0:0] == 1'b1) ? 7'd0 : j_fu_108);
assign select_ln93_fu_497_p3 = ((icmp_ln94_fu_477_p2[0:0] == 1'b1) ? add_ln93_1_fu_491_p2 : i_fu_112);
assign tmp_29_fu_616_p17 = 'bx;
assign tmp_s_fu_577_p17 = 'bx;
assign trunc_ln93_fu_505_p1 = select_ln93_fu_497_p3[2:0];
assign trunc_ln94_fu_531_p1 = select_ln92_fu_483_p3[2:0];
assign trunc_ln95_fu_557_p1 = select_ln93_fu_497_p3[5:0];
assign zext_ln92_1_fu_545_p1 = lshr_ln92_1_fu_535_p4;
assign zext_ln92_fu_519_p1 = lshr_ln_fu_509_p4;
assign zext_ln95_fu_661_p1 = add_ln_fu_655_p3;
endmodule 