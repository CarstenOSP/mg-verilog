...
wire   [31:0] tmp_7_fu_1155_p11;
reg   [31:0] tmp_7_reg_1578;
...
wire   [12:0] ptr_2_addr_1_gep_fu_478_p3;
wire   [12:0] ptr_1_addr_1_gep_fu_487_p3;
wire   [12:0] ptr_0_addr_1_gep_fu_496_p3;
wire   [12:0] ptr_3_addr_1_gep_fu_505_p3;
wire   [12:0] ptr_2_addr_gep_fu_514_p3;
wire   [12:0] ptr_1_addr_gep_fu_523_p3;
wire   [12:0] ptr_0_addr_gep_fu_532_p3;
wire   [12:0] ptr_3_addr_gep_fu_541_p3;
...
wire   [14:0] b_idx_1_cast7_fu_802_p1;
wire   [7:0] tmp_2_fu_836_p9;
wire   [7:0] tmp_s_fu_859_p9;
...
wire   [1:0] tmp_s_fu_859_p1;
wire   [1:0] tmp_s_fu_859_p3;
wire  signed [1:0] tmp_s_fu_859_p5;
wire  signed [1:0] tmp_s_fu_859_p7;
...
wire   [1:0] tmp_7_fu_1155_p1;
wire   [1:0] tmp_7_fu_1155_p3;
wire  signed [1:0] tmp_7_fu_1155_p5;
wire  signed [1:0] tmp_7_fu_1155_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 6'd1;
...
sparsemux_9_2_8_1_1_U10(.din0(SEQA_0_q0),.din1(SEQA_1_q0),.din2(SEQA_2_q0),.din3(SEQA_3_q0),.def(tmp_s_fu_859_p9),.sel(trunc_ln29_1_reg_1349),.dout(tmp_s_fu_859_p11));
(* dissolve_hierarchy = "yes" *) needwun_sparsemux_9_2_8_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h1 ),.din0_WIDTH( 8 ),.CASE1( 2'h2 ),.din1_WIDTH( 8 ),.CASE2( 2'h3 ),.din2_WIDTH( 8 ),.CASE3( 2'h0 ),.din3_WIDTH( 8 ),.def_WIDTH( 8 ),.sel_WIDTH( 2 ),.dout_WIDTH( 8 ))
...
sparsemux_9_2_32_1_1_U15(.din0(M_0_q1),.din1(M_1_q1),.din2(M_2_q1),.din3(M_3_q1),.def(tmp_7_fu_1155_p9),.sel(trunc_ln39_reg_1429),.dout(tmp_7_fu_1155_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_s_reg_1419 <= tmp_s_fu_859_p11;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_6_reg_1339 <= {{empty_fu_750_p2[6:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        tmp_7_reg_1578 <= tmp_7_fu_1155_p11;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1132)) begin
            ...
            ptr_0_address0_local = ptr_0_addr_gep_fu_532_p3;
        end else if ((1'b1 == ap_condition_1110)) begin
            ptr_0_address0_local = ptr_0_addr_1_gep_fu_496_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1156)) begin
            ...
            ptr_1_address0_local = ptr_1_addr_gep_fu_523_p3;
        end else if ((1'b1 == ap_condition_1140)) begin
            ptr_1_address0_local = ptr_1_addr_1_gep_fu_487_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1180)) begin
            ...
            ptr_2_address0_local = ptr_2_addr_gep_fu_514_p3;
        end else if ((1'b1 == ap_condition_1164)) begin
            ptr_2_address0_local = ptr_2_addr_1_gep_fu_478_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1204)) begin
            ...
            ptr_3_address0_local = ptr_3_addr_gep_fu_541_p3;
        end else if ((1'b1 == ap_condition_1188)) begin
            ptr_3_address0_local = ptr_3_addr_1_gep_fu_505_p3;
...
assign SEQB_0_address0 = p_cast16_fu_805_p1;
assign SEQB_0_ce0 = SEQB_0_ce0_local;
assign SEQB_1_address0 = p_cast16_fu_805_p1;
assign SEQB_1_ce0 = SEQB_1_ce0_local;
assign SEQB_2_address0 = p_cast16_fu_805_p1;
assign SEQB_2_ce0 = SEQB_2_ce0_local;
assign SEQB_3_address0 = p_cast16_fu_805_p1;
...
assign b_idx_1_cast7_fu_802_p1 = select_ln28_reg_1328;
assign empty_20_fu_819_p2 = (p_shl_fu_812_p3 + b_idx_1_cast7_fu_802_p1);
...
assign icmp_ln30_1_fu_1015_p2 = ((tmp_s_reg_1419 == tmp_fu_892_p11) ? 1'b1 : 1'b0);
...
assign tmp_7_fu_1155_p9 = 'bx;
assign tmp_fu_892_p9 = 'bx;
assign tmp_s_fu_859_p9 = 'bx;
...
assign up_1_fu_1241_p2 = ($signed(tmp_7_reg_1578) + $signed(32'd4294967295));
