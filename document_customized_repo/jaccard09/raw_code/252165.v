...
wire   [1:0] grp_kernel_atax_node2_fu_88_grp_fu_176_p_opcode;
wire    grp_kernel_atax_node2_fu_88_grp_fu_176_p_ce;
wire   [31:0] grp_kernel_atax_node2_fu_88_grp_fu_180_p_din0;
wire   [31:0] grp_kernel_atax_node2_fu_88_grp_fu_180_p_din1;
wire    grp_kernel_atax_node2_fu_88_grp_fu_180_p_ce;
wire   [31:0] grp_kernel_atax_node2_fu_88_grp_fu_184_p_din0;
wire   [31:0] grp_kernel_atax_node2_fu_88_grp_fu_184_p_din1;
wire    grp_kernel_atax_node2_fu_88_grp_fu_184_p_ce;
...
wire   [1:0] grp_kernel_atax_node1_fu_106_grp_fu_176_p_opcode;
wire    grp_kernel_atax_node1_fu_106_grp_fu_176_p_ce;
wire   [31:0] grp_kernel_atax_node1_fu_106_grp_fu_180_p_din0;
wire   [31:0] grp_kernel_atax_node1_fu_106_grp_fu_180_p_din1;
wire    grp_kernel_atax_node1_fu_106_grp_fu_180_p_ce;
wire   [31:0] grp_kernel_atax_node1_fu_106_grp_fu_184_p_din0;
wire   [31:0] grp_kernel_atax_node1_fu_106_grp_fu_184_p_din1;
wire    grp_kernel_atax_node1_fu_106_grp_fu_184_p_ce;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        grp_fu_180_ce = grp_kernel_atax_node1_fu_106_grp_fu_180_p_ce;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_180_ce = grp_kernel_atax_node2_fu_88_grp_fu_180_p_ce;
    end else begin
        grp_fu_180_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        grp_fu_180_p0 = grp_kernel_atax_node1_fu_106_grp_fu_180_p_din0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_180_p0 = grp_kernel_atax_node2_fu_88_grp_fu_180_p_din0;
    end else begin
        grp_fu_180_p0 = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        grp_fu_180_p1 = grp_kernel_atax_node1_fu_106_grp_fu_180_p_din1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_180_p1 = grp_kernel_atax_node2_fu_88_grp_fu_180_p_din1;
    end else begin
        grp_fu_180_p1 = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        grp_fu_184_ce = grp_kernel_atax_node1_fu_106_grp_fu_184_p_ce;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_184_ce = grp_kernel_atax_node2_fu_88_grp_fu_184_p_ce;
    end else begin
        grp_fu_184_ce = 1'b1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        grp_fu_184_p0 = grp_kernel_atax_node1_fu_106_grp_fu_184_p_din0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_184_p0 = grp_kernel_atax_node2_fu_88_grp_fu_184_p_din0;
    end else begin
        grp_fu_184_p0 = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        grp_fu_184_p1 = grp_kernel_atax_node1_fu_106_grp_fu_184_p_din1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fu_184_p1 = grp_kernel_atax_node2_fu_88_grp_fu_184_p_din1;
    end else begin
        grp_fu_184_p1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        v356_0_d1 = grp_kernel_atax_node0_Pipeline_label_2_fu_76_v356_0_d1;
    end else begin
        v356_0_d1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        v356_1_d1 = grp_kernel_atax_node0_Pipeline_label_2_fu_76_v356_1_d1;
    end else begin
        v356_1_d1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        v356_2_d1 = grp_kernel_atax_node0_Pipeline_label_2_fu_76_v356_2_d1;
    end else begin
        v356_2_d1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        v356_3_d1 = grp_kernel_atax_node0_Pipeline_label_2_fu_76_v356_3_d1;
    end else begin
        v356_3_d1 = 'bx;
    end
end
