module viterbi_viterbi_Pipeline_L_prev_state (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p_4,empty_8,llike_address0,llike_ce0,llike_q0,llike_1_address0,llike_1_ce0,llike_1_q0,llike_2_address0,llike_2_ce0,llike_2_q0,llike_3_address0,llike_3_ce0,llike_3_q0,lshr_ln,transition_0_address0,transition_0_ce0,transition_0_q0,transition_0_address1,transition_0_ce1,transition_0_q1,transition_1_address0,transition_1_ce0,transition_1_q0,transition_1_address1,transition_1_ce1,transition_1_q1,empty_9,bitcast_ln24,empty,min_p_133_out,min_p_133_out_ap_vld,grp_fu_369_p_din0,grp_fu_369_p_din1,grp_fu_369_p_opcode,grp_fu_369_p_dout0,grp_fu_369_p_ce,grp_fu_757_p_din0,grp_fu_757_p_din1,grp_fu_757_p_opcode,grp_fu_757_p_dout0,grp_fu_757_p_ce); 
...
wire   [0:0] tmp_4_fu_366_p3;
reg   [0:0] tmp_4_reg_753_pp0_iter1_reg;
reg   [0:0] tmp_4_reg_753_pp0_iter2_reg;
reg   [0:0] tmp_4_reg_753_pp0_iter3_reg;
reg   [0:0] tmp_4_reg_753_pp0_iter4_reg;
wire   [63:0] tmp_6_fu_403_p11;
reg   [63:0] tmp_6_reg_767;
...
reg   [63:0] p_reg_827;
reg   [63:0] min_p_1_reg_834;
reg   [63:0] p_1_reg_841;
wire   [0:0] and_ln29_1_fu_577_p2;
reg   [0:0] and_ln29_1_reg_848;
wire   [63:0] min_p_3_fu_583_p3;
reg   [63:0] min_p_3_reg_853;
reg   [0:0] tmp_11_reg_860;
...
wire  signed [1:0] tmp_s_fu_470_p1;
wire   [1:0] tmp_s_fu_470_p3;
wire   [1:0] tmp_s_fu_470_p5;
wire  signed [1:0] tmp_s_fu_470_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 5'd1;
...
sparsemux_9_2_64_1_1_U16(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(tmp_6_fu_403_p9),.sel(trunc_ln16_reg_712),.dout(tmp_6_fu_403_p11));
...
sparsemux_9_2_64_1_1_U17(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(tmp_s_fu_470_p9),.sel(trunc_ln16_reg_712),.dout(tmp_s_fu_470_p11));
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (tmp_4_reg_753_pp0_iter4_reg == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        min_p_fu_106 <= min_p_6_fu_671_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_4_fu_366_p3 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        add1_reg_817 <= grp_fu_369_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add52_1_reg_822 <= grp_fu_369_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_ln25_reg_748 <= add_ln25_fu_360_p2;
        tmp_4_reg_753 <= add_ln25_fu_360_p2[32'd6];
        tmp_4_reg_753_pp0_iter1_reg <= tmp_4_reg_753;
        tmp_4_reg_753_pp0_iter2_reg <= tmp_4_reg_753_pp0_iter1_reg;
        tmp_4_reg_753_pp0_iter3_reg <= tmp_4_reg_753_pp0_iter2_reg;
        tmp_4_reg_753_pp0_iter4_reg <= tmp_4_reg_753_pp0_iter3_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        min_p_1_reg_834 <= min_p_fu_106;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        min_p_3_reg_853 <= min_p_3_fu_583_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        p_1_reg_841 <= grp_fu_369_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_reg_827 <= grp_fu_369_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_6_reg_767 <= tmp_6_fu_403_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_11_reg_860 <= grp_fu_757_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_s_reg_807 <= tmp_s_fu_470_p11;
    end
end
always @ (*) begin
    if (((tmp_4_reg_753 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1) & (tmp_4_reg_753_pp0_iter3_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        grp_fu_291_p0 = tmp_s_reg_807;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_291_p0 = tmp_6_reg_767;
    end else begin
        grp_fu_291_p0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_295_p1 = min_p_3_fu_583_p3;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter4_reg == 1'b1) & (tmp_4_reg_753_pp0_iter3_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign and_ln29_3_fu_666_p2 = (tmp_11_reg_860 & and_ln29_2_fu_660_p2);
assign and_ln29_fu_571_p2 = (or_ln29_fu_547_p2 & grp_fu_757_p_dout0);
...
assign bitcast_ln29_1_fu_518_p1 = min_p_1_reg_834;
assign bitcast_ln29_2_fu_590_p1 = p_1_reg_841;
assign bitcast_ln29_3_fu_607_p1 = min_p_3_reg_853;
assign bitcast_ln29_fu_501_p1 = p_reg_827;
assign grp_fu_369_p_ce = 1'b1;
assign grp_fu_369_p_din0 = grp_fu_291_p0;
assign grp_fu_369_p_din1 = grp_fu_291_p1;
assign grp_fu_369_p_opcode = 2'd0;
assign grp_fu_757_p_ce = 1'b1;
assign grp_fu_757_p_din0 = grp_fu_295_p0;
assign grp_fu_757_p_din1 = grp_fu_295_p1;
assign grp_fu_757_p_opcode = 5'd4;
assign icmp_ln29_1_fu_541_p2 = ((trunc_ln29_fu_514_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_2_fu_553_p2 = ((tmp_7_fu_521_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_3_fu_559_p2 = ((trunc_ln29_1_fu_531_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_4_fu_624_p2 = ((tmp_9_fu_593_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_5_fu_630_p2 = ((trunc_ln29_2_fu_603_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_6_fu_642_p2 = ((tmp_10_fu_610_p4 != 11'd2047) ? 1'b1 : 1'b0);
assign icmp_ln29_7_fu_648_p2 = ((trunc_ln29_3_fu_620_p1 == 52'd0) ? 1'b1 : 1'b0);
assign icmp_ln29_fu_535_p2 = ((tmp_5_fu_504_p4 != 11'd2047) ? 1'b1 : 1'b0);
...
assign min_p_133_out = ((and_ln29_1_reg_848[0:0] == 1'b1) ? p_reg_827 : min_p_1_reg_834);
assign min_p_3_fu_583_p3 = ((and_ln29_1_reg_848[0:0] == 1'b1) ? p_reg_827 : min_p_1_reg_834);
assign min_p_6_fu_671_p3 = ((and_ln29_3_fu_666_p2[0:0] == 1'b1) ? p_1_reg_841 : min_p_3_reg_853);
...
assign select_ln27_1_fu_459_p3 = ((empty_9[0:0] == 1'b1) ? transition_1_q0 : transition_0_q0);
assign select_ln27_fu_426_p3 = ((empty_9[0:0] == 1'b1) ? transition_1_q1 : transition_0_q1);
assign tmp_10_fu_610_p4 = {{bitcast_ln29_3_fu_607_p1[62:52]}};
assign tmp_3_fu_330_p3 = {{empty_8}, {lshr_ln7_1_fu_320_p4}};
assign tmp_4_fu_366_p3 = add_ln25_fu_360_p2[32'd6];
assign tmp_5_fu_504_p4 = {{bitcast_ln29_fu_501_p1[62:52]}};
assign tmp_6_fu_403_p9 = 'bx;
assign tmp_7_fu_521_p4 = {{bitcast_ln29_1_fu_518_p1[62:52]}};
assign tmp_9_fu_593_p4 = {{bitcast_ln29_2_fu_590_p1[62:52]}};
assign tmp_s_fu_470_p9 = 'bx;
