module ss_sort_ss_sort_Pipeline_hist_1_hist_21 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,b_address0,b_ce0,b_q0,zext_ln50,bucket_address0,bucket_ce0,bucket_we0,bucket_d0,bucket_address1,bucket_ce1,bucket_q1); 
...
reg   [9:0] blockID_1_load_reg_347;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        blockID_1_fu_70 <= select_ln54_fu_187_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        b_load_reg_373 <= b_q0;
        blockID_1_load_reg_347 <= ap_sig_allocacmp_blockID_1_load;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_blockID_1_load = blockID_1_fu_70;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
assign add_ln54_1_fu_170_p2 = (ap_sig_allocacmp_blockID_1_load + 10'd1);
...
assign add_ln56_fu_208_p2 = (zext_ln55_1_fu_204_p1 + tmp_s_fu_196_p3);
...
assign ashr_ln57_fu_235_p2 = $signed(b_load_reg_373) >>> zext_ln50_cast_reg_333;
...
assign select_ln54_fu_187_p3 = ((icmp_ln55_reg_352[0:0] == 1'b1) ? add_ln54_1_reg_358 : blockID_1_load_reg_347);
