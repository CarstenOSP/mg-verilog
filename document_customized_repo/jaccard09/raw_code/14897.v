...
wire   [7:0] zext_ln172_2_fu_594_p1;
reg   [7:0] zext_ln172_2_reg_920;
reg   [7:0] zext_ln172_2_reg_920_pp0_iter4_reg;
wire   [8:0] zext_ln172_3_fu_597_p1;
reg   [8:0] zext_ln172_3_reg_926;
reg   [3:0] tmp_reg_932;
...
urem_6ns_4ns_3_10_1_U547(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_583_p0),.din1(grp_fu_583_p1),.ce(1'b1),.dout(grp_fu_583_p2));
fft1D_512_mul_6ns_8ns_13_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 6 ),.din1_WIDTH( 8 ),.dout_WIDTH( 13 ))
mul_6ns_8ns_13_1_1_U548(.din0(mul_ln172_fu_606_p0),.din1(mul_ln172_fu_606_p1),.dout(mul_ln172_fu_606_p2));
fft1D_512_mul_9ns_11ns_19_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 9 ),.din1_WIDTH( 11 ),.dout_WIDTH( 19 ))
mul_9ns_11ns_19_1_1_U549(.din0(mul_ln331_fu_664_p0),.din1(mul_ln331_fu_664_p1),.dout(mul_ln331_fu_664_p2));
fft1D_512_mul_9ns_11ns_19_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 9 ),.din1_WIDTH( 11 ),.dout_WIDTH( 19 ))
mul_9ns_11ns_19_1_1_U550(.din0(mul_ln333_fu_692_p0),.din1(mul_ln333_fu_692_p1),.dout(mul_ln333_fu_692_p2));
fft1D_512_mul_8ns_10ns_17_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 8 ),.din1_WIDTH( 10 ),.dout_WIDTH( 17 ))
mul_8ns_10ns_17_1_1_U551(.din0(mul_ln334_fu_730_p0),.din1(mul_ln334_fu_730_p1),.dout(mul_ln334_fu_730_p2));
fft1D_512_mul_9ns_11ns_19_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 9 ),.din1_WIDTH( 11 ),.dout_WIDTH( 19 ))
mul_9ns_11ns_19_1_1_U552(.din0(mul_ln335_fu_812_p0),.din1(mul_ln335_fu_812_p1),.dout(mul_ln335_fu_812_p2));
fft1D_512_am_addmul_6ns_7ns_9ns_17_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 6 ),.din1_WIDTH( 7 ),.din2_WIDTH( 9 ),.dout_WIDTH( 17 ))
am_addmul_6ns_7ns_9ns_17_4_1_U553(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_869_p0),.din1(grp_fu_869_p1),.din2(grp_fu_869_p2),.ce(1'b1),.dout(grp_fu_869_p3));
fft1D_512_am_addmul_6ns_8ns_10ns_19_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 6 ),.din1_WIDTH( 8 ),.din2_WIDTH( 10 ),.dout_WIDTH( 19 ))
am_addmul_6ns_8ns_10ns_19_4_1_U554(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_878_p0),.din1(grp_fu_878_p1),.din2(grp_fu_878_p2),.ce(1'b1),.dout(grp_fu_878_p3));
fft1D_512_am_addmul_6ns_9ns_11ns_21_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 6 ),.din1_WIDTH( 9 ),.din2_WIDTH( 11 ),.dout_WIDTH( 21 ))
am_addmul_6ns_9ns_11ns_21_4_1_U555(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_887_p0),.din1(grp_fu_887_p1),.din2(grp_fu_887_p2),.ce(1'b1),.dout(grp_fu_887_p3));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln172_2_reg_920[5 : 0] <= zext_ln172_2_fu_594_p1[5 : 0];
        zext_ln172_2_reg_920_pp0_iter4_reg[5 : 0] <= zext_ln172_2_reg_920[5 : 0];
        zext_ln172_3_reg_926[5 : 0] <= zext_ln172_3_fu_597_p1[5 : 0];
...
assign add_ln331_fu_635_p2 = ($signed(zext_ln172_3_reg_926) + $signed(9'd288));
assign add_ln333_fu_652_p2 = ($signed(zext_ln172_3_reg_926) + $signed(9'd360));
assign add_ln334_fu_721_p2 = ($signed(zext_ln172_2_reg_920_pp0_iter4_reg) + $signed(8'd144));
assign add_ln335_fu_746_p2 = ($signed(zext_ln172_2_reg_920_pp0_iter4_reg) + $signed(8'd176));
...
assign zext_ln172_2_fu_594_p1 = offset_reg_907_pp0_iter2_reg;
assign zext_ln172_3_fu_597_p1 = offset_reg_907_pp0_iter2_reg;
...
always @ (posedge ap_clk) begin
    zext_ln172_2_reg_920[7:6] <= 2'b00;
    zext_ln172_2_reg_920_pp0_iter4_reg[7:6] <= 2'b00;
    zext_ln172_3_reg_926[8:6] <= 3'b000;
