module backprop_backprop_Pipeline_VITIS_LOOP_26_12 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,activations3_i,activations3_o,activations3_o_ap_vld,activations3_2_i,activations3_2_o,activations3_2_o_ap_vld,activations3_1_i,activations3_1_o,activations3_1_o_ap_vld,biases3_address0,biases3_ce0,biases3_q0,grp_fu_22783_p_din0,grp_fu_22783_p_din1,grp_fu_22783_p_opcode,grp_fu_22783_p_dout0,grp_fu_22783_p_ce); 
...
sparsemux_7_2_64_1_1_U1915(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_s_fu_136_p7),.sel(ap_sig_allocacmp_i_12),.dout(tmp_s_fu_136_p9));
...
always @ (*) begin
    if (((i_12_reg_172_pp0_iter8_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter9 == 1'b1))) begin
        activations3_1_o = grp_fu_22783_p_dout0;
    end else begin
...
always @ (*) begin
    if ((~(i_12_reg_172_pp0_iter8_reg == 2'd0) & ~(i_12_reg_172_pp0_iter8_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter9 == 1'b1))) begin
        activations3_2_o = grp_fu_22783_p_dout0;
    end else begin
...
always @ (*) begin
    if (((i_12_reg_172_pp0_iter8_reg == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter9 == 1'b1))) begin
        activations3_o = grp_fu_22783_p_dout0;
    end else begin
...
assign grp_fu_22783_p_din0 = tmp_s_reg_180_pp0_iter1_reg;
assign grp_fu_22783_p_din1 = bitcast_ln27_fu_161_p1;
