...
input  [31:0] W_40_load_3;
input  [31:0] W_44_load_3;
input  [31:0] W_48_load_3;
input  [31:0] W_52_load_3;
input  [31:0] W_56_load_3;
input  [31:0] W_60_load_3;
input  [31:0] W_1_load_3;
input  [31:0] W_5_load_3;
input  [31:0] W_9_load_3;
input  [31:0] W_13_load_3;
input  [31:0] W_17_load_3;
input  [31:0] W_21_load_3;
input  [31:0] W_25_load_3;
input  [31:0] W_29_load_3;
input  [31:0] W_33_load_3;
input  [31:0] W_37_load_3;
input  [31:0] W_41_load_3;
input  [31:0] W_45_load_3;
input  [31:0] W_49_load_3;
input  [31:0] W_53_load_3;
input  [31:0] W_57_load_3;
input  [31:0] W_61_load_3;
...
input  [31:0] W_42_load_3;
input  [31:0] W_46_load_3;
input  [31:0] W_50_load_3;
input  [31:0] W_54_load_3;
input  [31:0] W_58_load_3;
input  [31:0] W_62_load_3;
...
input  [31:0] W_43_load_3;
input  [31:0] W_47_load_3;
input  [31:0] W_51_load_3;
input  [31:0] W_55_load_3;
input  [31:0] W_59_load_3;
input  [31:0] W_63_load_3;
...
output  [31:0] C_37_out;
output   C_37_out_ap_vld;
reg ap_idle;
reg C_35_out_ap_vld;
...
sparsemux_33_6_32_1_1_U217(.din0(W_load_3),.din1(W_4_load_3),.din2(W_8_load_3),.din3(W_12_load_3),.din4(W_16_load_3),.din5(W_20_load_3),.din6(W_24_load_3),.din7(W_28_load_3),.din8(W_32_load_3),.din9(W_36_load_3),.din10(W_40_load_3),.din11(W_44_load_3),.din12(W_48_load_3),.din13(W_52_load_3),.din14(W_56_load_3),.din15(W_60_load_3),.def(tmp_4_fu_1794_p33),.sel(trunc_ln15_fu_1702_p1),.dout(tmp_4_fu_1794_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h3C ),.din0_WIDTH( 32 ),.CASE1( 6'h0 ),.din1_WIDTH( 32 ),.CASE2( 6'h4 ),.din2_WIDTH( 32 ),.CASE3( 6'h8 ),.din3_WIDTH( 32 ),.CASE4( 6'hC ),.din4_WIDTH( 32 ),.CASE5( 6'h10 ),.din5_WIDTH( 32 ),.CASE6( 6'h14 ),.din6_WIDTH( 32 ),.CASE7( 6'h18 ),.din7_WIDTH( 32 ),.CASE8( 6'h1C ),.din8_WIDTH( 32 ),.CASE9( 6'h20 ),.din9_WIDTH( 32 ),.CASE10( 6'h24 ),.din10_WIDTH( 32 ),.CASE11( 6'h28 ),.din11_WIDTH( 32 ),.CASE12( 6'h2C ),.din12_WIDTH( 32 ),.CASE13( 6'h30 ),.din13_WIDTH( 32 ),.CASE14( 6'h34 ),.din14_WIDTH( 32 ),.CASE15( 6'h38 ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U218(.din0(W_1_load_3),.din1(W_5_load_3),.din2(W_9_load_3),.din3(W_13_load_3),.din4(W_17_load_3),.din5(W_21_load_3),.din6(W_25_load_3),.din7(W_29_load_3),.din8(W_33_load_3),.din9(W_37_load_3),.din10(W_41_load_3),.din11(W_45_load_3),.din12(W_49_load_3),.din13(W_53_load_3),.din14(W_57_load_3),.din15(W_61_load_3),.def(tmp_5_fu_1866_p33),.sel(trunc_ln15_fu_1702_p1),.dout(tmp_5_fu_1866_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h3C ),.din0_WIDTH( 32 ),.CASE1( 6'h0 ),.din1_WIDTH( 32 ),.CASE2( 6'h4 ),.din2_WIDTH( 32 ),.CASE3( 6'h8 ),.din3_WIDTH( 32 ),.CASE4( 6'hC ),.din4_WIDTH( 32 ),.CASE5( 6'h10 ),.din5_WIDTH( 32 ),.CASE6( 6'h14 ),.din6_WIDTH( 32 ),.CASE7( 6'h18 ),.din7_WIDTH( 32 ),.CASE8( 6'h1C ),.din8_WIDTH( 32 ),.CASE9( 6'h20 ),.din9_WIDTH( 32 ),.CASE10( 6'h24 ),.din10_WIDTH( 32 ),.CASE11( 6'h28 ),.din11_WIDTH( 32 ),.CASE12( 6'h2C ),.din12_WIDTH( 32 ),.CASE13( 6'h30 ),.din13_WIDTH( 32 ),.CASE14( 6'h34 ),.din14_WIDTH( 32 ),.CASE15( 6'h38 ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U219(.din0(W_2_load_3),.din1(W_6_load_3),.din2(W_10_load_3),.din3(W_14_load_3),.din4(W_18_load_3),.din5(W_22_load_3),.din6(W_26_load_3),.din7(W_30_load_3),.din8(W_34_load_3),.din9(W_38_load_3),.din10(W_42_load_3),.din11(W_46_load_3),.din12(W_50_load_3),.din13(W_54_load_3),.din14(W_58_load_3),.din15(W_62_load_3),.def(tmp_6_fu_1938_p33),.sel(trunc_ln15_fu_1702_p1),.dout(tmp_6_fu_1938_p35));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_33_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h3C ),.din0_WIDTH( 32 ),.CASE1( 6'h0 ),.din1_WIDTH( 32 ),.CASE2( 6'h4 ),.din2_WIDTH( 32 ),.CASE3( 6'h8 ),.din3_WIDTH( 32 ),.CASE4( 6'hC ),.din4_WIDTH( 32 ),.CASE5( 6'h10 ),.din5_WIDTH( 32 ),.CASE6( 6'h14 ),.din6_WIDTH( 32 ),.CASE7( 6'h18 ),.din7_WIDTH( 32 ),.CASE8( 6'h1C ),.din8_WIDTH( 32 ),.CASE9( 6'h20 ),.din9_WIDTH( 32 ),.CASE10( 6'h24 ),.din10_WIDTH( 32 ),.CASE11( 6'h28 ),.din11_WIDTH( 32 ),.CASE12( 6'h2C ),.din12_WIDTH( 32 ),.CASE13( 6'h30 ),.din13_WIDTH( 32 ),.CASE14( 6'h34 ),.din14_WIDTH( 32 ),.CASE15( 6'h38 ),.din15_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_33_6_32_1_1_U220(.din0(W_3_load_3),.din1(W_7_load_3),.din2(W_11_load_3),.din3(W_15_load_3),.din4(W_19_load_3),.din5(W_23_load_3),.din6(W_27_load_3),.din7(W_31_load_3),.din8(W_35_load_3),.din9(W_39_load_3),.din10(W_43_load_3),.din11(W_47_load_3),.din12(W_51_load_3),.din13(W_55_load_3),.din14(W_59_load_3),.din15(W_63_load_3),.def(tmp_7_fu_2010_p33),.sel(trunc_ln15_fu_1702_p1),.dout(tmp_7_fu_2010_p35));
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln128_reg_3373 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        C_37_out_ap_vld = 1'b1;
    end else begin
        C_37_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
...
assign C_35_out = C_4_reg_3478;
assign C_36_out = C_5_reg_3516;
assign C_37_out = {{trunc_ln130_7_reg_3500}, {lshr_ln130_7_reg_3505}};
...
assign or_ln3_fu_2407_p3 = {{trunc_ln130_fu_2381_p1}, {lshr_ln6_fu_2385_p4}};
