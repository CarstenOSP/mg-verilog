module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_27_reload,B_5_reload,C_21_reload,D_27_reload,E_5_reload,W_40_load_4,W_48_load_4,W_56_load_4,W_41_load_4,W_49_load_4,W_57_load_4,W_42_load_4,W_50_load_4,W_58_load_4,W_43_load_4,W_51_load_4,W_59_load_4,W_44_load_4,W_52_load_4,W_60_load_4,W_45_load_4,W_53_load_4,W_61_load_4,W_46_load_4,W_54_load_4,W_62_load_4,W_47_load_4,W_55_load_4,W_63_load_4,E_12_out,E_12_out_ap_vld,B_12_out,B_12_out_ap_vld,D_28_out,D_28_out_ap_vld,A_28_out,A_28_out_ap_vld,C_22_out,C_22_out_ap_vld); 
...
wire   [31:0] tmp_7_fu_396_p9;
reg   [31:0] tmp_7_reg_1348;
wire   [31:0] tmp_8_fu_416_p9;
reg   [31:0] tmp_8_reg_1353;
wire   [31:0] tmp_9_fu_436_p9;
reg   [31:0] tmp_9_reg_1358;
wire   [31:0] tmp_s_fu_456_p9;
reg   [31:0] tmp_s_reg_1363;
wire   [0:0] icmp_ln124_fu_494_p2;
wire   [31:0] tmp_1_fu_500_p9;
reg   [31:0] tmp_1_reg_1372;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire  signed [5:0] tmp_7_fu_396_p1;
wire  signed [5:0] tmp_7_fu_396_p3;
wire  signed [5:0] tmp_7_fu_396_p5;
...
wire  signed [5:0] tmp_s_fu_456_p1;
wire  signed [5:0] tmp_s_fu_456_p3;
wire  signed [5:0] tmp_s_fu_456_p5;
wire  signed [5:0] tmp_1_fu_500_p1;
wire  signed [5:0] tmp_1_fu_500_p3;
wire  signed [5:0] tmp_1_fu_500_p5;
...
sparsemux_7_6_32_1_1_U142(.din0(W_40_load_4),.din1(W_48_load_4),.din2(W_56_load_4),.def(tmp_7_fu_396_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_7_fu_396_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h30 ),.din1_WIDTH( 32 ),.CASE2( 6'h38 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_7_6_32_1_1_U143(.din0(W_41_load_4),.din1(W_49_load_4),.din2(W_57_load_4),.def(tmp_8_fu_416_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_8_fu_416_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h30 ),.din1_WIDTH( 32 ),.CASE2( 6'h38 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_7_6_32_1_1_U144(.din0(W_42_load_4),.din1(W_50_load_4),.din2(W_58_load_4),.def(tmp_9_fu_436_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_9_fu_436_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h30 ),.din1_WIDTH( 32 ),.CASE2( 6'h38 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_7_6_32_1_1_U145(.din0(W_43_load_4),.din1(W_51_load_4),.din2(W_59_load_4),.def(tmp_s_fu_456_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_s_fu_456_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h30 ),.din1_WIDTH( 32 ),.CASE2( 6'h38 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_7_6_32_1_1_U146(.din0(W_44_load_4),.din1(W_52_load_4),.din2(W_60_load_4),.def(tmp_1_fu_500_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_1_fu_500_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h30 ),.din1_WIDTH( 32 ),.CASE2( 6'h38 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_7_6_32_1_1_U147(.din0(W_45_load_4),.din1(W_53_load_4),.din2(W_61_load_4),.def(tmp_10_fu_520_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_10_fu_520_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h30 ),.din1_WIDTH( 32 ),.CASE2( 6'h38 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_7_6_32_1_1_U148(.din0(W_46_load_4),.din1(W_54_load_4),.din2(W_62_load_4),.def(tmp_11_fu_540_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_11_fu_540_p9));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_7_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h28 ),.din0_WIDTH( 32 ),.CASE1( 6'h30 ),.din1_WIDTH( 32 ),.CASE2( 6'h38 ),.din2_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_7_6_32_1_1_U149(.din0(W_47_load_4),.din1(W_55_load_4),.din2(W_63_load_4),.def(tmp_12_fu_560_p7),.sel(ap_sig_allocacmp_i_2),.dout(tmp_12_fu_560_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_1372 <= tmp_1_fu_500_p9;
        tmp_7_reg_1348 <= tmp_7_fu_396_p9;
        tmp_8_reg_1353 <= tmp_8_fu_416_p9;
        tmp_9_reg_1358 <= tmp_9_fu_436_p9;
        tmp_s_reg_1363 <= tmp_s_fu_456_p9;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln126_12_fu_919_p2 = (tmp_s_reg_1363 + or_ln126_9_reg_1472);
...
assign add_ln126_17_fu_975_p2 = (C_12_reg_1429 + tmp_1_reg_1372);
assign add_ln126_18_fu_979_p2 = ($signed(add_ln126_17_fu_975_p2) + $signed(32'd2400959708));
assign add_ln126_1_fu_641_p2 = ($signed(32'd2400959708) + $signed(tmp_7_reg_1348));
...
assign lshr_ln4_fu_599_p4 = {{B_fu_146[31:27]}};
...
assign or_ln126_2_fu_633_p3 = {{trunc_ln126_fu_595_p1}, {lshr_ln4_fu_599_p4}};
...
assign tmp_1_fu_500_p7 = 'bx;
assign tmp_7_fu_396_p7 = 'bx;
assign tmp_8_fu_416_p7 = 'bx;
assign tmp_9_fu_436_p7 = 'bx;
assign tmp_s_fu_456_p7 = 'bx;
