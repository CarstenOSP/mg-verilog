...
reg   [7:0] empty_reg_434;
wire    ap_CS_fsm_state5;
reg   [7:0] SEQB_load_reg_445;
wire    ap_CS_fsm_state6;
wire   [14:0] empty_22_fu_274_p2;
reg   [14:0] empty_22_reg_450;
wire   [14:0] add_ln29_fu_287_p2;
reg   [14:0] add_ln29_reg_455;
wire   [2:0] grp_needwun_Pipeline_trace_fu_173_ap_return;
reg   [2:0] targetBlock_reg_460;
wire    ap_CS_fsm_state9;
wire   [31:0] or_ln65_4_fu_311_p3;
wire    ap_CS_fsm_state10;
wire   [31:0] or_ln65_6_fu_319_p3;
wire   [31:0] or_ln65_8_fu_327_p3;
wire   [31:0] or_ln65_s_fu_343_p5;
wire   [31:0] or_ln65_3_fu_355_p3;
wire   [31:0] or_ln65_1_fu_363_p3;
wire   [31:0] zext_ln62_fu_371_p1;
wire   [31:0] or_ln65_2_fu_385_p3;
wire   [0:0] icmp_ln83_fu_403_p2;
reg   [0:0] icmp_ln83_reg_504;
...
wire   [14:0] grp_needwun_Pipeline_init_row_fu_161_M_address1;
wire    grp_needwun_Pipeline_init_row_fu_161_M_ce1;
wire    grp_needwun_Pipeline_init_row_fu_161_M_we1;
wire   [31:0] grp_needwun_Pipeline_init_row_fu_161_M_d1;
...
wire   [14:0] grp_needwun_Pipeline_init_col_fu_167_M_address1;
wire    grp_needwun_Pipeline_init_col_fu_167_M_ce1;
wire    grp_needwun_Pipeline_init_col_fu_167_M_we1;
wire   [31:0] grp_needwun_Pipeline_init_col_fu_167_M_d1;
...
wire   [7:0] grp_needwun_Pipeline_pad_a_fu_202_alignedA_address1;
wire    grp_needwun_Pipeline_pad_a_fu_202_alignedA_ce1;
wire    grp_needwun_Pipeline_pad_a_fu_202_alignedA_we1;
wire   [7:0] grp_needwun_Pipeline_pad_a_fu_202_alignedA_d1;
...
wire   [7:0] grp_needwun_Pipeline_pad_b_fu_210_alignedB_address1;
wire    grp_needwun_Pipeline_pad_b_fu_210_alignedB_ce1;
wire    grp_needwun_Pipeline_pad_b_fu_210_alignedB_we1;
wire   [7:0] grp_needwun_Pipeline_pad_b_fu_210_alignedB_d1;
...
wire   [63:0] p_cast8_fu_256_p1;
reg   [7:0] b_idx_1_fu_114;
wire   [7:0] add_ln28_fu_293_p2;
reg    SEQB_ce0_local;
wire   [14:0] p_shl8_fu_267_p3;
wire   [14:0] p_cast_fu_264_p1;
wire   [14:0] p_shl_fu_280_p3;
wire   [14:0] zext_ln29_fu_261_p1;
wire   [29:0] grp_fu_218_p4;
wire   [28:0] grp_fu_227_p4;
wire   [0:0] tmp_fu_335_p3;
wire   [30:0] tmp_7_fu_375_p4;
wire   [23:0] tmp_5_fu_393_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_needwun_Pipeline_pad_a_fu_202_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state12) & (icmp_ln83_reg_504 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        b_idx_1_fu_114 <= add_ln28_fu_293_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        if ((targetBlock_reg_460 == 3'd0)) begin
            b_str_idx_reg_139 <= zext_ln62_fu_371_p1;
        end else if ((targetBlock_reg_460 == 3'd7)) begin
            b_str_idx_reg_139 <= or_ln65_2_fu_385_p3;
        end else if ((targetBlock_reg_460 == 3'd6)) begin
            b_str_idx_reg_139 <= or_ln65_4_fu_311_p3;
        end else if ((targetBlock_reg_460 == 3'd5)) begin
            b_str_idx_reg_139 <= or_ln65_6_fu_319_p3;
        end else if ((targetBlock_reg_460 == 3'd4)) begin
            b_str_idx_reg_139 <= or_ln65_8_fu_327_p3;
        end else if ((targetBlock_reg_460 == 3'd3)) begin
            b_str_idx_reg_139 <= or_ln65_s_fu_343_p5;
        end else if ((targetBlock_reg_460 == 3'd2)) begin
            b_str_idx_reg_139 <= or_ln65_3_fu_355_p3;
        end else if ((targetBlock_reg_460 == 3'd1)) begin
            b_str_idx_reg_139 <= or_ln65_1_fu_363_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        SEQB_load_reg_445 <= SEQB_q0;
        add_ln29_reg_455 <= add_ln29_fu_287_p2;
        empty_22_reg_450 <= empty_22_fu_274_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_needwun_Pipeline_trace_fu_173_a_str_idx_0_0_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        empty_reg_434 <= empty_fu_250_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        icmp_ln83_reg_504 <= icmp_ln83_fu_403_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        targetBlock_reg_460 <= grp_needwun_Pipeline_trace_fu_173_ap_return;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        M_address1 = grp_needwun_Pipeline_fill_in_fu_189_M_address1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        M_address1 = grp_needwun_Pipeline_init_col_fu_167_M_address1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_address1 = grp_needwun_Pipeline_init_row_fu_161_M_address1;
    end else begin
        M_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        M_ce1 = grp_needwun_Pipeline_init_col_fu_167_M_ce1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_ce1 = grp_needwun_Pipeline_init_row_fu_161_M_ce1;
    end else begin
        M_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        M_d1 = grp_needwun_Pipeline_fill_in_fu_189_M_d1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        M_d1 = grp_needwun_Pipeline_init_col_fu_167_M_d1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_d1 = grp_needwun_Pipeline_init_row_fu_161_M_d1;
    end else begin
        M_d1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        M_we1 = grp_needwun_Pipeline_init_col_fu_167_M_we1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        M_we1 = grp_needwun_Pipeline_init_row_fu_161_M_we1;
    end else begin
        M_we1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        SEQB_address0 = p_cast8_fu_256_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        alignedA_we1 = grp_needwun_Pipeline_pad_a_fu_202_alignedA_we1;
    end else begin
        alignedA_we1 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (icmp_ln83_reg_504 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (icmp_ln83_reg_504 == 1'd1))) begin
        alignedB_ce1 = grp_needwun_Pipeline_pad_b_fu_210_alignedB_ce1;
    end else begin
        alignedB_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (icmp_ln83_reg_504 == 1'd1))) begin
        alignedB_we1 = grp_needwun_Pipeline_pad_b_fu_210_alignedB_we1;
    end else begin
        alignedB_we1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((grp_needwun_Pipeline_pad_a_fu_202_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((grp_needwun_Pipeline_fill_in_fu_189_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state8))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end
        ...
        ap_ST_fsm_state12 : begin
            if (((grp_needwun_Pipeline_pad_a_fu_202_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
...
assign add_ln28_fu_293_p2 = (b_idx_1_fu_114 + 8'd1);
assign add_ln29_fu_287_p2 = (p_shl_fu_280_p3 + zext_ln29_fu_261_p1);
assign alignedA_address1 = grp_needwun_Pipeline_pad_a_fu_202_alignedA_address1;
assign alignedA_d1 = grp_needwun_Pipeline_pad_a_fu_202_alignedA_d1;
assign alignedB_address1 = grp_needwun_Pipeline_pad_b_fu_210_alignedB_address1;
assign alignedB_d1 = grp_needwun_Pipeline_pad_b_fu_210_alignedB_d1;
...
always @ (*) begin
    ap_block_state13_on_subcall_done = ((grp_needwun_Pipeline_pad_b_fu_210_ap_done == 1'b0) & (icmp_ln83_reg_504 == 1'd1));
end
assign empty_22_fu_274_p2 = (p_shl8_fu_267_p3 + p_cast_fu_264_p1);
...
assign icmp_ln83_fu_403_p2 = (($signed(tmp_5_fu_393_p4) < $signed(24'd1)) ? 1'b1 : 1'b0);
assign or_ln65_1_fu_363_p3 = {{grp_fu_227_p4}, {3'd7}};
assign or_ln65_2_fu_385_p3 = {{tmp_7_fu_375_p4}, {1'd1}};
assign or_ln65_3_fu_355_p3 = {{grp_fu_227_p4}, {3'd6}};
assign or_ln65_4_fu_311_p3 = {{grp_fu_218_p4}, {2'd2}};
assign or_ln65_6_fu_319_p3 = {{grp_fu_218_p4}, {2'd3}};
assign or_ln65_8_fu_327_p3 = {{grp_fu_227_p4}, {3'd4}};
assign or_ln65_s_fu_343_p5 = {{{{grp_fu_227_p4}, {1'd1}}, {tmp_fu_335_p3}}, {1'd1}};
assign p_cast8_fu_256_p1 = empty_fu_250_p2;
assign p_cast_fu_264_p1 = empty_reg_434;
assign p_shl8_fu_267_p3 = {{empty_reg_434}, {7'd0}};
assign p_shl_fu_280_p3 = {{b_idx_1_fu_114}, {7'd0}};
assign ptr_d0 = grp_needwun_Pipeline_fill_in_fu_189_ptr_d0;
assign tmp_5_fu_393_p4 = {{b_str_idx_reg_139[31:8]}};
assign tmp_7_fu_375_p4 = {{a_str_idx_0_0_loc_fu_118[31:1]}};
assign tmp_fu_335_p3 = a_str_idx_0_0_loc_fu_118[32'd1];
assign zext_ln29_fu_261_p1 = b_idx_1_fu_114;
assign zext_ln62_fu_371_p1 = b_str_idx_6_loc_fu_122;
endmodule 