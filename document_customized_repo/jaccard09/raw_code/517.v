...
wire   [31:0] tmp_2_fu_735_p9;
wire   [31:0] tmp_3_fu_758_p9;
wire   [31:0] tmp_4_fu_781_p9;
wire   [31:0] tmp_fu_712_p11;
wire   [31:0] tmp_3_fu_758_p11;
wire   [31:0] tmp_2_fu_735_p11;
wire   [31:0] tmp_4_fu_781_p11;
wire   [31:0] xor_ln108_1_fu_810_p2;
wire   [31:0] xor_ln108_fu_804_p2;
wire   [31:0] tmp_5_fu_826_p9;
wire   [31:0] tmp_6_fu_849_p9;
wire   [31:0] tmp_7_fu_872_p9;
wire   [31:0] tmp_8_fu_895_p9;
wire   [31:0] tmp_5_fu_826_p11;
wire   [31:0] tmp_7_fu_872_p11;
wire   [31:0] tmp_6_fu_849_p11;
wire   [31:0] tmp_8_fu_895_p11;
...
wire   [2:0] tmp_2_fu_735_p1;
wire   [2:0] tmp_2_fu_735_p3;
wire  signed [2:0] tmp_2_fu_735_p5;
wire  signed [2:0] tmp_2_fu_735_p7;
wire  signed [2:0] tmp_3_fu_758_p1;
wire   [2:0] tmp_3_fu_758_p3;
wire   [2:0] tmp_3_fu_758_p5;
wire  signed [2:0] tmp_3_fu_758_p7;
wire   [2:0] tmp_4_fu_781_p1;
wire   [2:0] tmp_4_fu_781_p3;
wire  signed [2:0] tmp_4_fu_781_p5;
wire  signed [2:0] tmp_4_fu_781_p7;
wire   [2:0] tmp_5_fu_826_p1;
wire  signed [2:0] tmp_5_fu_826_p3;
wire  signed [2:0] tmp_5_fu_826_p5;
wire   [2:0] tmp_5_fu_826_p7;
wire   [2:0] tmp_6_fu_849_p1;
wire   [2:0] tmp_6_fu_849_p3;
wire  signed [2:0] tmp_6_fu_849_p5;
wire  signed [2:0] tmp_6_fu_849_p7;
wire  signed [2:0] tmp_7_fu_872_p1;
wire   [2:0] tmp_7_fu_872_p3;
wire   [2:0] tmp_7_fu_872_p5;
wire  signed [2:0] tmp_7_fu_872_p7;
wire   [2:0] tmp_8_fu_895_p1;
wire   [2:0] tmp_8_fu_895_p3;
wire  signed [2:0] tmp_8_fu_895_p5;
wire  signed [2:0] tmp_8_fu_895_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 2'd1;
...
sparsemux_9_3_32_1_1_U7(.din0(W_q1),.din1(W_2_q1),.din2(W_4_q1),.din3(W_6_q1),.def(tmp_2_fu_735_p9),.sel(trunc_ln106_1_reg_965),.dout(tmp_2_fu_735_p11));
...
sparsemux_9_3_32_1_1_U8(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_3_fu_758_p9),.sel(trunc_ln106_1_reg_965),.dout(tmp_3_fu_758_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U9(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_4_fu_781_p9),.sel(trunc_ln106_1_reg_965),.dout(tmp_4_fu_781_p11));
...
sparsemux_9_3_32_1_1_U10(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.def(tmp_5_fu_826_p9),.sel(trunc_ln106_1_reg_965),.dout(tmp_5_fu_826_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U11(.din0(W_1_q1),.din1(W_3_q1),.din2(W_5_q1),.din3(W_7_q1),.def(tmp_6_fu_849_p9),.sel(trunc_ln106_1_reg_965),.dout(tmp_6_fu_849_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h6 ),.din0_WIDTH( 32 ),.CASE1( 3'h0 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h4 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U12(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_7_fu_872_p9),.sel(trunc_ln106_1_reg_965),.dout(tmp_7_fu_872_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U13(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.def(tmp_8_fu_895_p9),.sel(trunc_ln106_1_reg_965),.dout(tmp_8_fu_895_p11));
...
assign tmp_2_fu_735_p9 = 'bx;
assign tmp_3_fu_758_p9 = 'bx;
assign tmp_4_fu_781_p9 = 'bx;
assign tmp_5_fu_826_p9 = 'bx;
assign tmp_6_fu_849_p9 = 'bx;
assign tmp_7_fu_872_p9 = 'bx;
assign tmp_8_fu_895_p9 = 'bx;
...
assign xor_ln108_1_fu_810_p2 = (tmp_4_fu_781_p11 ^ tmp_2_fu_735_p11);
assign xor_ln108_2_fu_816_p2 = (xor_ln108_fu_804_p2 ^ xor_ln108_1_fu_810_p2);
assign xor_ln108_3_fu_918_p2 = (tmp_7_fu_872_p11 ^ tmp_5_fu_826_p11);
assign xor_ln108_4_fu_924_p2 = (tmp_8_fu_895_p11 ^ tmp_6_fu_849_p11);
assign xor_ln108_5_fu_930_p2 = (xor_ln108_4_fu_924_p2 ^ xor_ln108_3_fu_918_p2);
assign xor_ln108_fu_804_p2 = (tmp_fu_712_p11 ^ tmp_3_fu_758_p11);
