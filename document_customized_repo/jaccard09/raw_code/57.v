...
wire  signed [15:0] a_assign_7_fu_331_p17;
reg  signed [15:0] a_assign_7_reg_660;
reg  signed [15:0] a_assign_7_reg_660_pp0_iter2_reg;
reg  signed [15:0] a_assign_7_reg_660_pp0_iter3_reg;
reg  signed [15:0] a_assign_7_reg_660_pp0_iter4_reg;
reg  signed [15:0] a_assign_7_reg_660_pp0_iter5_reg;
wire  signed [15:0] a_assign_8_fu_373_p17;
reg  signed [15:0] a_assign_8_reg_668;
reg  signed [15:0] a_assign_8_reg_668_pp0_iter2_reg;
reg  signed [15:0] a_assign_8_reg_668_pp0_iter3_reg;
reg  signed [15:0] a_assign_8_reg_668_pp0_iter4_reg;
reg  signed [15:0] a_assign_8_reg_668_pp0_iter5_reg;
wire  signed [15:0] temp_fu_438_p3;
reg  signed [15:0] temp_reg_686;
wire  signed [15:0] temp_28_fu_465_p3;
reg  signed [15:0] temp_28_reg_692;
reg   [63:0] m_fu_106;
...
wire   [15:0] a_assign_7_fu_331_p15;
wire   [15:0] a_assign_8_fu_373_p15;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] a_assign_7_fu_331_p1;
wire   [2:0] a_assign_7_fu_331_p3;
wire   [2:0] a_assign_7_fu_331_p5;
wire  signed [2:0] a_assign_7_fu_331_p7;
wire  signed [2:0] a_assign_7_fu_331_p9;
wire  signed [2:0] a_assign_7_fu_331_p11;
wire  signed [2:0] a_assign_7_fu_331_p13;
wire   [2:0] a_assign_8_fu_373_p1;
wire   [2:0] a_assign_8_fu_373_p3;
wire   [2:0] a_assign_8_fu_373_p5;
wire  signed [2:0] a_assign_8_fu_373_p7;
wire  signed [2:0] a_assign_8_fu_373_p9;
wire  signed [2:0] a_assign_8_fu_373_p11;
wire  signed [2:0] a_assign_8_fu_373_p13;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_15_3_16_1_1_U964(.din0(K_i),.din1(K_1_i),.din2(K_2_i),.din3(K_3_i),.din4(K_4_i),.din5(K_5_i),.din6(K_6_i),.def(a_assign_7_fu_331_p15),.sel(trunc_ln219_fu_327_p1),.dout(a_assign_7_fu_331_p17));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_15_3_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h1 ),.din0_WIDTH( 16 ),.CASE1( 3'h2 ),.din1_WIDTH( 16 ),.CASE2( 3'h3 ),.din2_WIDTH( 16 ),.CASE3( 3'h4 ),.din3_WIDTH( 16 ),.CASE4( 3'h5 ),.din4_WIDTH( 16 ),.CASE5( 3'h6 ),.din5_WIDTH( 16 ),.CASE6( 3'h7 ),.din6_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 3 ),.dout_WIDTH( 16 ))
sparsemux_15_3_16_1_1_U965(.din0(P_2_i),.din1(P_3_i),.din2(P_4_i),.din3(P_5_i),.din4(P_6_i),.din5(P_7_i),.din6(select_ln191_reload),.def(a_assign_8_fu_373_p15),.sel(trunc_ln219_fu_327_p1),.dout(a_assign_8_fu_373_p17));
Gsm_LPC_Analysis_mac_muladd_16s_16s_15ns_31_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 16 ),.din1_WIDTH( 16 ),.din2_WIDTH( 15 ),.dout_WIDTH( 31 ))
mac_muladd_16s_16s_15ns_31_4_1_U966(.clk(ap_clk),.reset(ap_rst),.din0(a_assign_7_reg_660),.din1(grp_fu_607_p1),.din2(grp_fu_607_p2),.ce(1'b1),.dout(grp_fu_607_p3));
Gsm_LPC_Analysis_mac_muladd_16s_16s_15ns_31_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 16 ),.din1_WIDTH( 16 ),.din2_WIDTH( 15 ),.dout_WIDTH( 31 ))
mac_muladd_16s_16s_15ns_31_4_1_U967(.clk(ap_clk),.reset(ap_rst),.din0(a_assign_8_reg_668),.din1(grp_fu_615_p1),.din2(grp_fu_615_p2),.ce(1'b1),.dout(grp_fu_615_p3));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        a_assign_7_reg_660 <= a_assign_7_fu_331_p17;
        a_assign_8_reg_668 <= a_assign_8_fu_373_p17;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        a_assign_7_reg_660_pp0_iter2_reg <= a_assign_7_reg_660;
        a_assign_7_reg_660_pp0_iter3_reg <= a_assign_7_reg_660_pp0_iter2_reg;
        a_assign_7_reg_660_pp0_iter4_reg <= a_assign_7_reg_660_pp0_iter3_reg;
        a_assign_7_reg_660_pp0_iter5_reg <= a_assign_7_reg_660_pp0_iter4_reg;
        a_assign_8_reg_668_pp0_iter2_reg <= a_assign_8_reg_668;
        a_assign_8_reg_668_pp0_iter3_reg <= a_assign_8_reg_668_pp0_iter2_reg;
        a_assign_8_reg_668_pp0_iter4_reg <= a_assign_8_reg_668_pp0_iter3_reg;
        a_assign_8_reg_668_pp0_iter5_reg <= a_assign_8_reg_668_pp0_iter4_reg;
        ap_loop_exit_ready_pp0_iter3_reg <= ap_loop_exit_ready_pp0_iter2_reg;
        ap_loop_exit_ready_pp0_iter4_reg <= ap_loop_exit_ready_pp0_iter3_reg;
        ap_loop_exit_ready_pp0_iter5_reg <= ap_loop_exit_ready_pp0_iter4_reg;
        temp_28_reg_692 <= temp_28_fu_465_p3;
...
assign a_assign_7_fu_331_p15 = 'bx;
assign a_assign_8_fu_373_p15 = 'bx;
assign add_ln222_fu_367_p2 = (m_fu_106 + 64'd1);
assign add_ln39_2_fu_546_p2 = ($signed(temp_28_reg_692) + $signed(a_assign_7_reg_660_pp0_iter5_reg));
assign add_ln39_fu_482_p2 = ($signed(a_assign_8_reg_668_pp0_iter5_reg) + $signed(temp_reg_686));
...
assign icmp_ln40_3_fu_572_p2 = ((tmp_6_fu_562_p4 == 2'd1) ? 1'b1 : 1'b0);
assign icmp_ln40_fu_492_p2 = (($signed(sum_fu_486_p2) < $signed(17'd98304)) ? 1'b1 : 1'b0);
assign icmp_ln56_1_fu_419_p2 = ((a_assign_7_reg_660_pp0_iter4_reg == 16'd32768) ? 1'b1 : 1'b0);
assign icmp_ln56_2_fu_446_p2 = ((a_assign_8_reg_668_pp0_iter4_reg == 16'd32768) ? 1'b1 : 1'b0);
...
assign sext_ln39_2_fu_543_p1 = temp_28_reg_692;
assign sext_ln39_fu_476_p1 = a_assign_8_reg_668_pp0_iter5_reg;
assign sext_ln60_1_fu_473_p1 = a_assign_7_reg_660_pp0_iter5_reg;
...
assign temp_28_fu_465_p3 = ((and_ln56_1_fu_451_p2[0:0] == 1'b1) ? 16'd32767 : trunc_ln62_2_fu_456_p4);
assign temp_fu_438_p3 = ((and_ln56_fu_424_p2[0:0] == 1'b1) ? 16'd32767 : trunc_ln62_1_fu_429_p4);
assign tmp_6_fu_562_p4 = {{sum_1_fu_550_p2[16:15]}};
