...
wire   [5:0] trunc_ln18_fu_338_p1;
reg   [5:0] trunc_ln18_reg_503;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        add79_3_reg_725 <= grp_fu_168_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add79_6_reg_730 <= grp_fu_164_p_dout0;
        add79_7_reg_735 <= grp_fu_168_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        trunc_ln18_reg_503 <= trunc_ln18_fu_338_p1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        mul2_reg_640 <= grp_fu_172_p_dout0;
        mul74_1_reg_650 <= grp_fu_176_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        mul74_2_reg_670 <= grp_fu_172_p_dout0;
        mul74_3_reg_675 <= grp_fu_176_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mul74_4_reg_700 <= grp_fu_172_p_dout0;
        mul74_5_reg_705 <= grp_fu_176_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        mul74_6_reg_710 <= grp_fu_172_p_dout0;
        mul74_7_reg_715 <= grp_fu_176_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
assign grp_fu_168_p_din0 = grp_fu_250_p0;
assign grp_fu_168_p_din1 = grp_fu_250_p1;
assign grp_fu_168_p_opcode = 2'd0;
assign grp_fu_172_p_ce = 1'b1;
assign grp_fu_172_p_din0 = grp_fu_254_p0;
assign grp_fu_172_p_din1 = beta;
assign grp_fu_176_p_ce = 1'b1;
assign grp_fu_176_p_din0 = grp_fu_258_p0;
...
assign tmp_2_fu_378_p4 = {{{trunc_ln18_fu_338_p1}, {tmp_1_fu_368_p4}}, {1'd1}};
assign tmp_5_fu_424_p5 = {{{{trunc_ln18_reg_503}, {tmp_3_reg_549}}, {1'd1}}, {tmp_4_reg_555}};
assign tmp_6_fu_441_p4 = {{{trunc_ln18_reg_503}, {tmp_3_reg_549}}, {2'd3}};
assign tmp_fu_314_p3 = j_fu_72[32'd6];
assign tmp_s_fu_352_p3 = {{trunc_ln18_fu_338_p1}, {lshr_ln5_2_fu_342_p4}};
assign trunc_ln18_fu_338_p1 = select_ln29_fu_330_p3[5:0];
