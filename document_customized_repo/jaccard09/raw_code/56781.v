...
reg   [3:0] select_ln113_reg_770;
wire   [2:0] trunc_ln114_fu_527_p1;
reg   [2:0] trunc_ln114_reg_776;
reg   [2:0] trunc_ln114_reg_776_pp0_iter2_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter3_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter4_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter5_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter6_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter7_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter8_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter9_reg;
reg   [2:0] trunc_ln114_reg_776_pp0_iter10_reg;
wire   [3:0] lshr_ln_fu_531_p4;
reg   [3:0] lshr_ln_reg_781;
wire   [2:0] empty_fu_577_p1;
reg   [2:0] empty_reg_826;
wire   [63:0] tmp_36_fu_613_p19;
reg   [63:0] tmp_36_reg_871;
reg   [63:0] tmp_36_reg_871_pp0_iter3_reg;
wire   [6:0] add_ln115_fu_652_p2;
reg   [6:0] add_ln115_reg_876;
reg   [6:0] add_ln115_reg_876_pp0_iter3_reg;
reg   [6:0] add_ln115_reg_876_pp0_iter4_reg;
reg   [6:0] add_ln115_reg_876_pp0_iter5_reg;
reg   [6:0] add_ln115_reg_876_pp0_iter6_reg;
reg   [6:0] add_ln115_reg_876_pp0_iter7_reg;
reg   [6:0] add_ln115_reg_876_pp0_iter8_reg;
reg   [6:0] add_ln115_reg_876_pp0_iter9_reg;
reg   [6:0] add_ln115_reg_876_pp0_iter10_reg;
wire   [63:0] tmp_35_fu_690_p19;
reg   [63:0] tmp_35_reg_881;
reg   [63:0] mul_i5_reg_886;
wire   [63:0] zext_ln112_fu_541_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] p_cast38_fu_591_p1;
wire   [63:0] zext_ln115_fu_729_p1;
reg   [6:0] j_fu_124;
wire   [6:0] add_ln114_fu_553_p2;
wire    ap_loop_init;
reg   [3:0] i_fu_128;
...
wire   [11:0] zext_ln113_fu_569_p1;
wire   [11:0] arrayidx10_sum226_fu_572_p2;
wire   [8:0] tmp_s_fu_581_p4;
wire   [63:0] tmp_36_fu_613_p17;
wire   [6:0] zext_ln112_1_fu_610_p1;
wire   [6:0] p_udiv5_fu_603_p3;
wire   [63:0] tmp_35_fu_690_p2;
wire   [63:0] tmp_35_fu_690_p4;
wire   [63:0] tmp_35_fu_690_p6;
wire   [63:0] tmp_35_fu_690_p8;
wire   [63:0] tmp_35_fu_690_p10;
wire   [63:0] tmp_35_fu_690_p12;
wire   [63:0] tmp_35_fu_690_p14;
wire   [63:0] tmp_35_fu_690_p16;
wire   [63:0] tmp_35_fu_690_p17;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_36_fu_613_p1;
wire   [2:0] tmp_36_fu_613_p3;
wire   [2:0] tmp_36_fu_613_p5;
wire   [2:0] tmp_36_fu_613_p7;
wire  signed [2:0] tmp_36_fu_613_p9;
wire  signed [2:0] tmp_36_fu_613_p11;
wire  signed [2:0] tmp_36_fu_613_p13;
wire  signed [2:0] tmp_36_fu_613_p15;
wire   [2:0] tmp_35_fu_690_p1;
wire   [2:0] tmp_35_fu_690_p3;
wire   [2:0] tmp_35_fu_690_p5;
wire   [2:0] tmp_35_fu_690_p7;
wire  signed [2:0] tmp_35_fu_690_p9;
wire  signed [2:0] tmp_35_fu_690_p11;
wire  signed [2:0] tmp_35_fu_690_p13;
wire  signed [2:0] tmp_35_fu_690_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_64_1_1_x_U666(.din0(oracle_activations1_q0),.din1(oracle_activations1_1_q0),.din2(oracle_activations1_2_q0),.din3(oracle_activations1_3_q0),.din4(oracle_activations1_4_q0),.din5(oracle_activations1_5_q0),.din6(oracle_activations1_6_q0),.din7(oracle_activations1_7_q0),.def(tmp_36_fu_613_p17),.sel(trunc_ln114_reg_776),.dout(tmp_36_fu_613_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_x_U667(.din0(tmp_35_fu_690_p2),.din1(tmp_35_fu_690_p4),.din2(tmp_35_fu_690_p6),.din3(tmp_35_fu_690_p8),.din4(tmp_35_fu_690_p10),.din5(tmp_35_fu_690_p12),.din6(tmp_35_fu_690_p14),.din7(tmp_35_fu_690_p16),.def(tmp_35_fu_690_p17),.sel(empty_reg_826),.dout(tmp_35_fu_690_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            j_fu_124 <= add_ln114_fu_553_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_ln115_reg_876 <= add_ln115_fu_652_p2;
        add_ln115_reg_876_pp0_iter10_reg <= add_ln115_reg_876_pp0_iter9_reg;
        add_ln115_reg_876_pp0_iter3_reg <= add_ln115_reg_876;
        add_ln115_reg_876_pp0_iter4_reg <= add_ln115_reg_876_pp0_iter3_reg;
        add_ln115_reg_876_pp0_iter5_reg <= add_ln115_reg_876_pp0_iter4_reg;
        add_ln115_reg_876_pp0_iter6_reg <= add_ln115_reg_876_pp0_iter5_reg;
        add_ln115_reg_876_pp0_iter7_reg <= add_ln115_reg_876_pp0_iter6_reg;
        add_ln115_reg_876_pp0_iter8_reg <= add_ln115_reg_876_pp0_iter7_reg;
        add_ln115_reg_876_pp0_iter9_reg <= add_ln115_reg_876_pp0_iter8_reg;
        ...
        empty_reg_826 <= empty_fu_577_p1;
        mul_i5_reg_886 <= grp_fu_8806_p_dout0;
        tmp_35_reg_881 <= tmp_35_fu_690_p19;
        tmp_36_reg_871 <= tmp_36_fu_613_p19;
        tmp_36_reg_871_pp0_iter3_reg <= tmp_36_reg_871;
        trunc_ln114_reg_776_pp0_iter10_reg <= trunc_ln114_reg_776_pp0_iter9_reg;
        trunc_ln114_reg_776_pp0_iter2_reg <= trunc_ln114_reg_776;
        trunc_ln114_reg_776_pp0_iter3_reg <= trunc_ln114_reg_776_pp0_iter2_reg;
        trunc_ln114_reg_776_pp0_iter4_reg <= trunc_ln114_reg_776_pp0_iter3_reg;
        trunc_ln114_reg_776_pp0_iter5_reg <= trunc_ln114_reg_776_pp0_iter4_reg;
        trunc_ln114_reg_776_pp0_iter6_reg <= trunc_ln114_reg_776_pp0_iter5_reg;
        trunc_ln114_reg_776_pp0_iter7_reg <= trunc_ln114_reg_776_pp0_iter6_reg;
        trunc_ln114_reg_776_pp0_iter8_reg <= trunc_ln114_reg_776_pp0_iter7_reg;
        trunc_ln114_reg_776_pp0_iter9_reg <= trunc_ln114_reg_776_pp0_iter8_reg;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln_reg_781 <= {{select_ln112_fu_505_p3[6:3]}};
        select_ln113_reg_770 <= select_ln113_fu_519_p3;
        trunc_ln114_reg_776 <= trunc_ln114_fu_527_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd7))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1) & (trunc_ln114_reg_776_pp0_iter10_reg == 3'd0))) begin
...
assign add_ln114_fu_553_p2 = (select_ln112_fu_505_p3 + 7'd1);
assign add_ln115_fu_652_p2 = (zext_ln112_1_fu_610_p1 + p_udiv5_fu_603_p3);
...
assign arrayidx10_sum226_fu_572_p2 = (zext_ln113_fu_569_p1 + phi_mul40);
assign delta_weights1_1_address0 = zext_ln115_fu_729_p1;
...
assign delta_weights1_2_address0 = zext_ln115_fu_729_p1;
...
assign delta_weights1_3_address0 = zext_ln115_fu_729_p1;
...
assign delta_weights1_4_address0 = zext_ln115_fu_729_p1;
...
assign delta_weights1_5_address0 = zext_ln115_fu_729_p1;
...
assign delta_weights1_6_address0 = zext_ln115_fu_729_p1;
...
assign delta_weights1_7_address0 = zext_ln115_fu_729_p1;
...
assign delta_weights1_address0 = zext_ln115_fu_729_p1;
...
assign empty_fu_577_p1 = arrayidx10_sum226_fu_572_p2[2:0];
assign grp_fu_8806_p_ce = 1'b1;
assign grp_fu_8806_p_din0 = tmp_35_reg_881;
assign grp_fu_8806_p_din1 = tmp_36_reg_871_pp0_iter3_reg;
...
assign lshr_ln_fu_531_p4 = {{select_ln112_fu_505_p3[6:3]}};
assign oracle_activations1_1_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_1_ce0 = oracle_activations1_1_ce0_local;
assign oracle_activations1_2_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_2_ce0 = oracle_activations1_2_ce0_local;
assign oracle_activations1_3_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_3_ce0 = oracle_activations1_3_ce0_local;
assign oracle_activations1_4_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_4_ce0 = oracle_activations1_4_ce0_local;
assign oracle_activations1_5_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_5_ce0 = oracle_activations1_5_ce0_local;
assign oracle_activations1_6_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_6_ce0 = oracle_activations1_6_ce0_local;
assign oracle_activations1_7_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_7_ce0 = oracle_activations1_7_ce0_local;
assign oracle_activations1_address0 = zext_ln112_fu_541_p1;
assign oracle_activations1_ce0 = oracle_activations1_ce0_local;
assign p_cast38_fu_591_p1 = tmp_s_fu_581_p4;
assign p_udiv5_fu_603_p3 = {{select_ln113_reg_770}, {3'd0}};
...
assign tmp_35_fu_690_p10 = training_data_4_q0;
assign tmp_35_fu_690_p12 = training_data_5_q0;
assign tmp_35_fu_690_p14 = training_data_6_q0;
assign tmp_35_fu_690_p16 = training_data_7_q0;
assign tmp_35_fu_690_p17 = 'bx;
assign tmp_35_fu_690_p2 = training_data_0_q0;
assign tmp_35_fu_690_p4 = training_data_1_q0;
assign tmp_35_fu_690_p6 = training_data_2_q0;
assign tmp_35_fu_690_p8 = training_data_3_q0;
assign tmp_36_fu_613_p17 = 'bx;
assign tmp_s_fu_581_p4 = {{arrayidx10_sum226_fu_572_p2[11:3]}};
assign training_data_0_address0 = p_cast38_fu_591_p1;
assign training_data_0_ce0 = training_data_0_ce0_local;
assign training_data_1_address0 = p_cast38_fu_591_p1;
assign training_data_1_ce0 = training_data_1_ce0_local;
assign training_data_2_address0 = p_cast38_fu_591_p1;
assign training_data_2_ce0 = training_data_2_ce0_local;
assign training_data_3_address0 = p_cast38_fu_591_p1;
assign training_data_3_ce0 = training_data_3_ce0_local;
assign training_data_4_address0 = p_cast38_fu_591_p1;
assign training_data_4_ce0 = training_data_4_ce0_local;
assign training_data_5_address0 = p_cast38_fu_591_p1;
assign training_data_5_ce0 = training_data_5_ce0_local;
assign training_data_6_address0 = p_cast38_fu_591_p1;
assign training_data_6_ce0 = training_data_6_ce0_local;
assign training_data_7_address0 = p_cast38_fu_591_p1;
assign training_data_7_ce0 = training_data_7_ce0_local;
assign trunc_ln114_fu_527_p1 = select_ln112_fu_505_p3[2:0];
assign zext_ln112_1_fu_610_p1 = lshr_ln_reg_781;
assign zext_ln112_fu_541_p1 = lshr_ln_fu_531_p4;
assign zext_ln113_fu_569_p1 = select_ln113_reg_770;
assign zext_ln115_fu_729_p1 = add_ln115_reg_876_pp0_iter10_reg;
endmodule 