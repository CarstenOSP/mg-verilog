...
wire   [63:0] zext_ln32_fu_80_p1;
reg   [6:0] i_fu_36;
wire   [6:0] add_ln32_fu_74_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i_1;
wire   [31:0] bitcast_ln33_fu_90_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln32_fu_68_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_36 <= add_ln32_fu_74_p2;
...
always @ (*) begin
    if (((icmp_ln32_fu_68_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln32_fu_74_p2 = (ap_sig_allocacmp_i_1 + 7'd1);
...
assign bitcast_ln33_fu_90_p1 = buff_y_out_q0;
assign buff_y_out_address0 = zext_ln32_fu_80_p1;
assign buff_y_out_ce0 = buff_y_out_ce0_local;
assign icmp_ln32_fu_68_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign y_out_din = bitcast_ln33_fu_90_p1;
assign y_out_write = y_out_write_local;
assign zext_ln32_fu_80_p1 = ap_sig_allocacmp_i_1;
endmodule 