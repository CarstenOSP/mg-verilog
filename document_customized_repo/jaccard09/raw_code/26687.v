...
wire   [63:0] tmp_62_fu_628_p11;
reg   [63:0] tmp_62_reg_824;
wire   [63:0] tmp_63_fu_651_p11;
reg   [63:0] tmp_63_reg_829;
...
wire   [63:0] tmp_62_fu_628_p9;
wire   [63:0] tmp_63_fu_651_p9;
...
wire   [2:0] tmp_62_fu_628_p1;
wire   [2:0] tmp_62_fu_628_p3;
wire  signed [2:0] tmp_62_fu_628_p5;
wire  signed [2:0] tmp_62_fu_628_p7;
wire   [2:0] tmp_63_fu_651_p1;
wire   [2:0] tmp_63_fu_651_p3;
wire  signed [2:0] tmp_63_fu_651_p5;
wire  signed [2:0] tmp_63_fu_651_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_64_1_1_U449(.din0(activations1_q0),.din1(activations1_1_q0),.din2(activations1_2_q0),.din3(activations1_3_q0),.din4(activations1_4_q0),.din5(activations1_5_q0),.din6(activations1_6_q0),.din7(activations1_7_q0),.def(tmp_s_fu_589_p17),.sel(trunc_ln93_reg_717),.dout(tmp_s_fu_589_p19));
...
sparsemux_9_3_64_1_1_U450(.din0(oracle_activations2_q0),.din1(oracle_activations2_2_q0),.din2(oracle_activations2_4_q0),.din3(oracle_activations2_6_q0),.def(tmp_62_fu_628_p9),.sel(trunc_ln94_reg_762),.dout(tmp_62_fu_628_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h2 ),.din1_WIDTH( 64 ),.CASE2( 3'h4 ),.din2_WIDTH( 64 ),.CASE3( 3'h6 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_9_3_64_1_1_U451(.din0(oracle_activations2_1_q0),.din1(oracle_activations2_3_q0),.din2(oracle_activations2_5_q0),.din3(oracle_activations2_7_q0),.def(tmp_63_fu_651_p9),.sel(trunc_ln94_reg_762),.dout(tmp_63_fu_651_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_62_reg_824 <= tmp_62_fu_628_p11;
        tmp_63_reg_829 <= tmp_63_fu_651_p11;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul_1_i1_reg_842 <= grp_fu_4209_p_dout0;
...
assign grp_fu_2684_p_din1 = tmp_62_reg_824;
assign grp_fu_4209_p_ce = 1'b1;
assign grp_fu_4209_p_din0 = tmp_s_reg_818;
assign grp_fu_4209_p_din1 = tmp_63_reg_829;
...
assign tmp_62_fu_628_p9 = 'bx;
assign tmp_63_fu_651_p9 = 'bx;
