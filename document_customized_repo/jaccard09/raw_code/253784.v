...
wire   [7:0] grp_kernel_atax_node0_Pipeline_label_2_fu_80_v356_0_address0;
...
wire   [7:0] grp_kernel_atax_node0_Pipeline_label_2_fu_80_v356_0_address1;
...
wire   [7:0] grp_kernel_atax_node0_Pipeline_label_2_fu_80_v356_1_address0;
...
wire   [7:0] grp_kernel_atax_node0_Pipeline_label_2_fu_80_v356_1_address1;
...
reg   [8:0] grp_kernel_atax_node2_fu_88_v175;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        v349_fu_72 <= v349_4_fu_135_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        tmp_reg_186 <= {{v349_3_reg_176[8:1]}};
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        grp_kernel_atax_node1_fu_106_v4 = v349_1_reg_191;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        grp_kernel_atax_node1_fu_106_v4 = v349_3_reg_176;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        grp_kernel_atax_node2_fu_88_v175 = v349_1_reg_191;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_kernel_atax_node2_fu_88_v175 = v349_3_reg_176;
    end else begin
        grp_kernel_atax_node2_fu_88_v175 = 'bx;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_0_ce0 = grp_kernel_atax_node2_fu_88_v353_0_ce0;
    end else begin
        v353_0_ce0 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_0_ce1 = grp_kernel_atax_node2_fu_88_v353_0_ce1;
    end else begin
        v353_0_ce1 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_1_ce0 = grp_kernel_atax_node2_fu_88_v353_1_ce0;
    end else begin
        v353_1_ce0 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_1_ce1 = grp_kernel_atax_node2_fu_88_v353_1_ce1;
    end else begin
        v353_1_ce1 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_2_ce0 = grp_kernel_atax_node2_fu_88_v353_2_ce0;
    end else begin
        v353_2_ce0 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_2_ce1 = grp_kernel_atax_node2_fu_88_v353_2_ce1;
    end else begin
        v353_2_ce1 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_3_ce0 = grp_kernel_atax_node2_fu_88_v353_3_ce0;
    end else begin
        v353_3_ce0 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v353_3_ce1 = grp_kernel_atax_node2_fu_88_v353_3_ce1;
    end else begin
        v353_3_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v355_ce0 = grp_kernel_atax_node2_fu_88_v355_ce0;
    end else begin
        v355_ce0 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v355_ce1 = grp_kernel_atax_node2_fu_88_v355_ce1;
    end else begin
        v355_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v358_ce0 = grp_kernel_atax_node2_fu_88_v358_ce0;
    end else begin
        v358_ce0 = 1'b0;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state4))) begin
        v358_we0 = grp_kernel_atax_node2_fu_88_v358_we0;
    end else begin
        v358_we0 = 1'b0;
    end
end
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (grp_kernel_atax_node2_fu_88_ap_done == 1'b1))) begin
...
assign icmp_ln476_fu_129_p2 = ((v349_fu_72 < 9'd390) ? 1'b1 : 1'b0);
assign v349_1_fu_155_p3 = {{tmp_reg_186}, {1'd1}};
assign v349_4_fu_135_p2 = (v349_fu_72 + 9'd2);
