...
reg   [11:0] indvar_flatten28_fu_74;
...
#0 j_fu_66 = 7'd0;
#0 i_fu_70 = 7'd0;
#0 indvar_flatten28_fu_74 = 12'd0;
#0 ap_done_reg = 1'b0;
end
syrk_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U43(.clk(ap_clk),.reset(ap_rst),.din0(select_ln32_3_reg_493),.din1(mul74_1_reg_488),.ce(1'b1),.dout(grp_fu_204_p2));
syrk_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U45(.clk(ap_clk),.reset(ap_rst),.din0(select_ln32_2_reg_473),.din1(beta),.ce(1'b1),.dout(grp_fu_212_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln29_fu_234_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten28_fu_74 <= add_ln29_1_fu_240_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten28_fu_74 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul1_reg_478 <= grp_fu_252_p_dout0;
        mul74_1_reg_488 <= grp_fu_212_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten28_load = indvar_flatten28_fu_74;
    end
end
always @ (*) begin
...
assign add_ln29_1_fu_240_p2 = (ap_sig_allocacmp_indvar_flatten28_load + 12'd1);
...
assign grp_fu_248_p_din1 = mul1_reg_478;
assign grp_fu_248_p_opcode = 2'd0;
assign grp_fu_252_p_ce = 1'b1;
assign grp_fu_252_p_din0 = select_ln32_reg_468;
assign grp_fu_252_p_din1 = beta;
assign icmp_ln29_fu_234_p2 = ((ap_sig_allocacmp_indvar_flatten28_load == 12'd2048) ? 1'b1 : 1'b0);
...
assign tmp_6_fu_305_p3 = {{trunc_ln30_fu_287_p1}, {lshr_ln5_2_fu_295_p4}};
...
assign zext_ln32_fu_313_p1 = tmp_6_fu_305_p3;
endmodule 