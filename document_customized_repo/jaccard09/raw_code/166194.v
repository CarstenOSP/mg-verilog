...
main_graph_v11523_RAM_S2P_BRAM_1R1W_memcore main_graph_v11523_RAM_S2P_BRAM_1R1W_memcore_U (.ce0      ( buf_ce0[i] ),.address0 ( buf_a0[i] ),.q0       ( buf_q0[i] ),.ce1      ( buf_ce1[i] ),.we1      ( buf_we1[i] ),.address1 ( buf_a1[i] ),.d1       ( buf_d1[i] ),.clk      ( clk ),.reset    ( reset ));
    end
endgenerate
generate
