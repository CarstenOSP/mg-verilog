...
wire   [0:0] first_iter_2_fu_292_p2;
reg   [0:0] first_iter_2_reg_468;
wire   [3:0] lshr_ln6_4_fu_298_p4;
reg   [3:0] lshr_ln6_4_reg_472;
reg   [5:0] tmp2_addr_reg_497;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [5:0] tmp2_addr_reg_497_pp0_iter1_reg;
reg   [31:0] buff_x_load_reg_512;
reg   [31:0] buff_x_1_load_reg_517;
reg   [31:0] buff_x_2_load_reg_532;
reg   [31:0] buff_x_3_load_reg_537;
reg   [31:0] arrayidx67_promoted_reg_542;
reg   [31:0] buff_B_load_reg_547;
reg   [31:0] buff_B_1_load_reg_552;
reg   [31:0] buff_B_load_1_reg_557;
reg   [31:0] buff_B_1_load_1_reg_562;
reg   [0:0] tmp_2_reg_572;
wire    ap_block_pp0_stage28_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln6_fu_308_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln31_fu_341_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln33_fu_363_p1;
wire   [63:0] zext_ln33_1_fu_378_p1;
reg   [6:0] j_fu_68;
wire   [6:0] add_ln32_fu_397_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_2_fu_72;
wire   [6:0] select_ln31_fu_330_p3;
reg   [10:0] indvar_flatten15_fu_76;
wire   [10:0] add_ln31_1_fu_267_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten15_load;
...
wire   [6:0] add_ln31_fu_324_p2;
wire   [5:0] empty_fu_337_p1;
wire   [4:0] lshr_ln6_5_fu_346_p4;
wire   [10:0] tmp_s_fu_355_p3;
wire   [10:0] tmp_1_fu_369_p4;
...
#0 j_fu_68 = 7'd0;
#0 i_2_fu_72 = 7'd0;
#0 indvar_flatten15_fu_76 = 11'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        if ((1'b1 == ap_condition_759)) begin
            add6815_fu_80 <= arrayidx67_promoted_reg_542;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add6815_fu_80 <= reg_237;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_2_fu_72 <= 7'd0;
    end else if (((icmp_ln31_reg_453 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_2_fu_72 <= select_ln31_fu_330_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_261_p2 == 1'd0))) begin
            indvar_flatten15_fu_76 <= add_ln31_1_fu_267_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten15_fu_76 <= 11'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_68 <= 7'd0;
    end else if (((icmp_ln31_reg_453 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_fu_68 <= add_ln32_fu_397_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        arrayidx67_promoted_reg_542 <= tmp2_q0;
        buff_B_1_load_1_reg_562 <= buff_B_1_q0;
        buff_B_1_load_reg_552 <= buff_B_1_q1;
        buff_B_load_1_reg_557 <= buff_B_q0;
        buff_B_load_reg_547 <= buff_B_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp2_addr_reg_497 <= zext_ln31_fu_341_p1;
        tmp2_addr_reg_497_pp0_iter1_reg <= tmp2_addr_reg_497;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_2_reg_468 <= first_iter_2_fu_292_p2;
        icmp_ln31_reg_453 <= icmp_ln31_fu_261_p2;
        lshr_ln6_4_reg_472 <= {{select_ln6_fu_284_p3[5:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_2_reg_572 <= add_ln32_fu_397_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln31_reg_453 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten15_load = 11'd0;
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage10) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
            ...
            grp_fu_209_p0 = buff_B_1_load_1_reg_562;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_209_p0 = buff_B_load_1_reg_557;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_209_p0 = buff_B_1_load_reg_552;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_209_p0 = buff_B_load_reg_547;
        end else begin
            grp_fu_209_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_address0_local = tmp2_addr_reg_497_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp2_address0_local = zext_ln31_fu_341_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_572 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_we0_local = 1'b1;
    end else begin
        tmp2_we0_local = 1'b0;
    end
...
assign add_ln31_1_fu_267_p2 = (ap_sig_allocacmp_indvar_flatten15_load + 11'd1);
assign add_ln31_fu_324_p2 = (i_2_fu_72 + 7'd1);
assign add_ln32_fu_397_p2 = (select_ln6_reg_462 + 7'd4);
...
always @ (*) begin
    ap_condition_759 = ((icmp_ln31_reg_453 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_2_reg_468 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_B_1_address0 = zext_ln33_1_fu_378_p1;
assign buff_B_1_address1 = zext_ln33_fu_363_p1;
assign buff_B_1_ce0 = buff_B_1_ce0_local;
assign buff_B_1_ce1 = buff_B_1_ce1_local;
assign buff_B_address0 = zext_ln33_1_fu_378_p1;
assign buff_B_address1 = zext_ln33_fu_363_p1;
...
assign empty_fu_337_p1 = select_ln31_fu_330_p3[5:0];
assign first_iter_2_fu_292_p2 = ((select_ln6_fu_284_p3 == 7'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln31_fu_261_p2 = ((ap_sig_allocacmp_indvar_flatten15_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln6_4_fu_298_p4 = {{select_ln6_fu_284_p3[5:2]}};
assign lshr_ln6_5_fu_346_p4 = {{select_ln6_reg_462[5:1]}};
assign select_ln31_fu_330_p3 = ((tmp_reg_457[0:0] == 1'b1) ? add_ln31_fu_324_p2 : i_2_fu_72);
...
assign tmp2_d0 = reg_237;
assign tmp2_we0 = tmp2_we0_local;
assign tmp_1_fu_369_p4 = {{{empty_fu_337_p1}, {lshr_ln6_4_reg_472}}, {1'd1}};
assign tmp_fu_276_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_s_fu_355_p3 = {{empty_fu_337_p1}, {lshr_ln6_5_fu_346_p4}};
assign zext_ln31_fu_341_p1 = select_ln31_fu_330_p3;
assign zext_ln33_1_fu_378_p1 = tmp_1_fu_369_p4;
assign zext_ln33_fu_363_p1 = tmp_s_fu_355_p3;
assign zext_ln6_fu_308_p1 = lshr_ln6_4_fu_298_p4;
endmodule 