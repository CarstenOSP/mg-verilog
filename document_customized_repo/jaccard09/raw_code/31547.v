...
sparsemux_17_4_64_1_1_x_U687(.din0(oracle_activations2_q0),.din1(oracle_activations2_2_q0),.din2(oracle_activations2_4_q0),.din3(oracle_activations2_6_q0),.din4(oracle_activations2_8_q0),.din5(oracle_activations2_10_q0),.din6(oracle_activations2_12_q0),.din7(oracle_activations2_14_q0),.def(tmp_62_fu_1052_p17),.sel(trunc_ln94_reg_1266),.dout(tmp_62_fu_1052_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_4_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h2 ),.din1_WIDTH( 64 ),.CASE2( 4'h4 ),.din2_WIDTH( 64 ),.CASE3( 4'h6 ),.din3_WIDTH( 64 ),.CASE4( 4'h8 ),.din4_WIDTH( 64 ),.CASE5( 4'hA ),.din5_WIDTH( 64 ),.CASE6( 4'hC ),.din6_WIDTH( 64 ),.CASE7( 4'hE ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_17_4_64_1_1_x_U688(.din0(oracle_activations2_1_q0),.din1(oracle_activations2_3_q0),.din2(oracle_activations2_5_q0),.din3(oracle_activations2_7_q0),.din4(oracle_activations2_9_q0),.din5(oracle_activations2_11_q0),.din6(oracle_activations2_13_q0),.din7(oracle_activations2_15_q0),.def(tmp_63_fu_1091_p17),.sel(trunc_ln94_reg_1266),.dout(tmp_63_fu_1091_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul_1_i1_reg_1390 <= grp_fu_5637_p_dout0;
...
assign grp_fu_5637_p_din0 = tmp_s_reg_1362;
assign grp_fu_5637_p_din1 = tmp_63_reg_1373;
