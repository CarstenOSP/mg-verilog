module sha_stream_sha_transform_Pipeline_trans_lp6 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_13_reload,B_5_reload,E_13_reload,D_13_reload,E_6_reload,W_address0,W_ce0,W_q0,W_2_address0,W_2_ce0,W_2_q0,W_4_address0,W_4_ce0,W_4_q0,W_6_address0,W_6_ce0,W_6_q0,W_8_address0,W_8_ce0,W_8_q0,W_10_address0,W_10_ce0,W_10_q0,W_12_address0,W_12_ce0,W_12_q0,W_14_address0,W_14_ce0,W_14_q0,W_1_address0,W_1_ce0,W_1_q0,W_3_address0,W_3_ce0,W_3_q0,W_5_address0,W_5_ce0,W_5_q0,W_7_address0,W_7_ce0,W_7_q0,W_9_address0,W_9_ce0,W_9_q0,W_11_address0,W_11_ce0,W_11_q0,W_13_address0,W_13_ce0,W_13_q0,W_15_address0,W_15_ce0,W_15_q0,A_15_out,A_15_out_ap_vld,B_8_out,B_8_out_ap_vld,C_11_out,C_11_out_ap_vld,D_15_out,D_15_out_ap_vld,E_8_out,E_8_out_ap_vld); 
...
wire   [31:0] tmp_9_fu_497_p19;
reg   [31:0] tmp_9_reg_932;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [3:0] tmp_9_fu_497_p1;
wire   [3:0] tmp_9_fu_497_p3;
wire   [3:0] tmp_9_fu_497_p5;
wire   [3:0] tmp_9_fu_497_p7;
wire  signed [3:0] tmp_9_fu_497_p9;
wire  signed [3:0] tmp_9_fu_497_p11;
wire  signed [3:0] tmp_9_fu_497_p13;
wire  signed [3:0] tmp_9_fu_497_p15;
...
sparsemux_17_4_32_1_1_U113(.din0(W_q0),.din1(W_2_q0),.din2(W_4_q0),.din3(W_6_q0),.din4(W_8_q0),.din5(W_10_q0),.din6(W_12_q0),.din7(W_14_q0),.def(tmp_9_fu_497_p17),.sel(trunc_ln128_fu_494_p1),.dout(tmp_9_fu_497_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h2 ),.din1_WIDTH( 32 ),.CASE2( 4'h4 ),.din2_WIDTH( 32 ),.CASE3( 4'h6 ),.din3_WIDTH( 32 ),.CASE4( 4'h8 ),.din4_WIDTH( 32 ),.CASE5( 4'hA ),.din5_WIDTH( 32 ),.CASE6( 4'hC ),.din6_WIDTH( 32 ),.CASE7( 4'hE ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_17_4_32_1_1_U114(.din0(W_1_q0),.din1(W_3_q0),.din2(W_5_q0),.din3(W_7_q0),.din4(W_9_q0),.din5(W_11_q0),.din6(W_13_q0),.din7(W_15_q0),.def(tmp_s_fu_537_p17),.sel(trunc_ln128_fu_494_p1),.dout(tmp_s_fu_537_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_9_reg_932 <= tmp_9_fu_497_p19;
...
assign A_15_out = B_1_fu_136;
assign B_8_out = B_fu_132;
assign C_11_out = E_2_fu_144;
...
assign D_15_out = E_1_fu_128;
assign E_8_out = E_fu_124;
...
assign add_ln130_1_fu_622_p2 = ($signed(tmp_9_reg_932) + $signed(32'd3395469782));
assign add_ln130_2_fu_627_p2 = (add_ln130_1_fu_622_p2 + or_ln1_fu_614_p3);
assign add_ln130_4_fu_759_p2 = (E_1_load_reg_942 + xor_ln130_3_reg_962);
assign add_ln130_5_fu_744_p2 = ($signed(tmp_s_reg_937) + $signed(32'd3395469782));
...
assign lshr_ln100_3_fu_460_p4 = {{ap_sig_allocacmp_i_1[6:4]}};
assign lshr_ln130_1_fu_649_p4 = {{B_fu_132[31:2]}};
assign lshr_ln130_3_fu_696_p4 = {{B_1_fu_136[31:2]}};
assign lshr_ln6_fu_593_p4 = {{B_1_fu_136[31:27]}};
assign or_ln130_2_fu_738_p3 = {{trunc_ln130_2_reg_952}, {lshr_ln130_2_reg_957}};
assign or_ln1_fu_614_p3 = {{trunc_ln130_fu_589_p1}, {lshr_ln6_fu_593_p4}};
...
assign zext_ln100_fu_470_p1 = lshr_ln100_3_fu_460_p4;
endmodule 