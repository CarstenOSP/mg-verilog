...
wire   [14:0] empty_36_fu_285_p2;
reg   [14:0] empty_36_reg_462;
...
wire   [30:0] tmp_s_fu_383_p4;
wire   [23:0] tmp_18_fu_402_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_needwun_Pipeline_pad_a_fu_202_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln83_reg_476 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        empty_36_reg_462 <= empty_36_fu_285_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        SEQB_address0 = p_cast9_fu_256_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state11 : begin
            if (((grp_needwun_Pipeline_pad_a_fu_202_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state11))) begin
...
always @ (*) begin
    ap_block_state12_on_subcall_done = ((grp_needwun_Pipeline_pad_b_fu_210_ap_done == 1'b0) & (icmp_ln83_reg_476 == 1'd1));
end
assign empty_36_fu_285_p2 = (p_shl8_fu_278_p3 + p_cast_fu_275_p1);
...
assign icmp_ln83_fu_412_p2 = (($signed(tmp_18_fu_402_p4) < $signed(24'd1)) ? 1'b1 : 1'b0);
assign or_ln65_1_fu_369_p3 = {{grp_fu_227_p4}, {3'd7}};
assign or_ln65_2_fu_393_p3 = {{tmp_s_fu_383_p4}, {1'd1}};
...
assign p_cast9_fu_256_p1 = empty_fu_250_p2;
...
assign tmp_18_fu_402_p4 = {{ap_phi_mux_b_str_idx_phi_fu_142_p16[31:8]}};
assign tmp_fu_339_p3 = a_str_idx_0_0_loc_fu_118[32'd1];
assign tmp_s_fu_383_p4 = {{a_str_idx_0_0_loc_fu_118[31:1]}};
