module gesummv_gesummv_Pipeline_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,tmp1_address0,tmp1_ce0,tmp1_q0,tmp1_1_address0,tmp1_1_ce0,tmp1_1_q0,tmp1_2_address0,tmp1_2_ce0,tmp1_2_q0,tmp1_3_address0,tmp1_3_ce0,tmp1_3_q0,tmp2_address0,tmp2_ce0,tmp2_q0,tmp2_1_address0,tmp2_1_ce0,tmp2_1_q0,buff_y_out_address0,buff_y_out_ce0,buff_y_out_we0,buff_y_out_d0,grp_fu_2991_p_din0,grp_fu_2991_p_din1,grp_fu_2991_p_opcode,grp_fu_2991_p_dout0,grp_fu_2991_p_ce); 
...
wire   [31:0] tmp_fu_224_p11;
reg   [31:0] tmp_reg_308;
wire   [31:0] select_ln38_fu_248_p3;
reg   [31:0] select_ln38_reg_313;
reg   [31:0] add2_reg_318;
wire   [63:0] zext_ln6_2_fu_205_p1;
...
wire   [4:0] lshr_ln6_5_fu_179_p4;
wire   [3:0] lshr_ln6_6_fu_195_p4;
wire   [31:0] tmp_fu_224_p9;
wire   [1:0] tmp_fu_224_p10;
wire   [0:0] trunc_ln37_1_fu_221_p1;
reg    ap_done_reg;
...
wire   [1:0] tmp_fu_224_p1;
wire   [1:0] tmp_fu_224_p3;
wire  signed [1:0] tmp_fu_224_p5;
wire  signed [1:0] tmp_fu_224_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U1687(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_fu_224_p9),.sel(tmp_fu_224_p10),.dout(tmp_fu_224_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        select_ln38_reg_313 <= select_ln38_fu_248_p3;
        tmp_reg_308 <= tmp_fu_224_p11;
    end
end
always @ (*) begin
...
assign grp_fu_2991_p_din0 = tmp_reg_308;
assign grp_fu_2991_p_din1 = select_ln38_reg_313;
assign grp_fu_2991_p_opcode = 2'd0;
assign icmp_ln37_fu_167_p2 = ((ap_sig_allocacmp_i_2 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_5_fu_179_p4 = {{ap_sig_allocacmp_i_2[5:1]}};
assign lshr_ln6_6_fu_195_p4 = {{ap_sig_allocacmp_i_2[5:2]}};
assign select_ln38_fu_248_p3 = ((trunc_ln37_1_fu_221_p1[0:0] == 1'b1) ? tmp2_1_q0 : tmp2_q0);
assign tmp1_1_address0 = zext_ln6_2_fu_205_p1;
assign tmp1_1_ce0 = tmp1_1_ce0_local;
assign tmp1_2_address0 = zext_ln6_2_fu_205_p1;
assign tmp1_2_ce0 = tmp1_2_ce0_local;
assign tmp1_3_address0 = zext_ln6_2_fu_205_p1;
assign tmp1_3_ce0 = tmp1_3_ce0_local;
assign tmp1_address0 = zext_ln6_2_fu_205_p1;
...
assign tmp_fu_224_p10 = i_2_reg_267[1:0];
assign tmp_fu_224_p9 = 'bx;
assign trunc_ln37_1_fu_221_p1 = i_2_reg_267[0:0];
assign zext_ln37_fu_256_p1 = i_2_reg_267_pp0_iter8_reg;
assign zext_ln6_2_fu_205_p1 = lshr_ln6_6_fu_195_p4;
