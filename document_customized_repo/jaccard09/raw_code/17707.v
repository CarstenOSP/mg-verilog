...
sparsemux_17_3_32_1_1_U38(.din0(sum_0_q0),.din1(sum_1_q0),.din2(sum_2_q0),.din3(sum_3_q0),.din4(sum_4_q0),.din5(sum_5_q0),.din6(sum_6_q0),.din7(sum_7_q0),.def(tmp_fu_400_p17),.sel(trunc_ln15_reg_484),.dout(tmp_fu_400_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        lshr_ln4_reg_544 <= {{add_ln25_fu_357_p2[6:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        lshr_ln2_reg_489 <= {{radixID_fu_94[6:3]}};
...
assign lshr_ln3_fu_331_p4 = {{add_ln26_fu_325_p2[10:3]}};
...
assign zext_ln23_fu_346_p1 = lshr_ln2_reg_489;
assign zext_ln25_fu_445_p1 = lshr_ln4_reg_544;
assign zext_ln27_1_fu_395_p1 = or_ln_fu_388_p3;
assign zext_ln27_fu_341_p1 = lshr_ln3_fu_331_p4;
always @ (posedge ap_clk) begin
