...
wire   [0:0] first_iter_1_fu_549_p2;
reg   [0:0] first_iter_1_reg_846;
...
wire   [2:0] lshr_ln6_6_fu_581_p4;
reg   [2:0] lshr_ln6_6_reg_895;
wire   [31:0] tmp_1_fu_613_p19;
reg   [31:0] tmp_1_reg_940;
...
reg   [11:0] indvar_flatten10_fu_126;
...
wire   [2:0] tmp_1_fu_613_p1;
wire   [2:0] tmp_1_fu_613_p3;
wire   [2:0] tmp_1_fu_613_p5;
wire   [2:0] tmp_1_fu_613_p7;
wire  signed [2:0] tmp_1_fu_613_p9;
wire  signed [2:0] tmp_1_fu_613_p11;
wire  signed [2:0] tmp_1_fu_613_p13;
wire  signed [2:0] tmp_1_fu_613_p15;
...
#0 j_fu_118 = 7'd0;
#0 i_2_fu_122 = 7'd0;
#0 indvar_flatten10_fu_126 = 12'd0;
...
sparsemux_17_3_32_1_1_U65(.din0(tmp2_q0),.din1(tmp2_1_q0),.din2(tmp2_2_q0),.din3(tmp2_3_q0),.din4(tmp2_4_q0),.din5(tmp2_5_q0),.din6(tmp2_6_q0),.din7(tmp2_7_q0),.def(tmp_1_fu_613_p17),.sel(trunc_ln31_reg_850),.dout(tmp_1_fu_613_p19));
...
sparsemux_9_3_32_1_1_U66(.din0(buff_x_q0),.din1(buff_x_2_q0),.din2(buff_x_4_q0),.din3(buff_x_6_q0),.def(tmp_4_fu_673_p9),.sel(trunc_ln32_fu_652_p1),.dout(tmp_4_fu_673_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U67(.din0(buff_x_1_q0),.din1(buff_x_3_q0),.din2(buff_x_5_q0),.din3(buff_x_7_q0),.def(tmp_6_fu_697_p9),.sel(trunc_ln32_fu_652_p1),.dout(tmp_6_fu_697_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U68(.din0(buff_B_q0),.din1(buff_B_2_q0),.din2(buff_B_4_q0),.din3(buff_B_6_q0),.def(tmp_3_fu_721_p9),.sel(trunc_ln32_reg_945),.dout(tmp_3_fu_721_p11));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U69(.din0(buff_B_1_q0),.din1(buff_B_3_q0),.din2(buff_B_5_q0),.din3(buff_B_7_q0),.def(tmp_5_fu_744_p9),.sel(trunc_ln32_reg_945),.dout(tmp_5_fu_744_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_497_p2 == 1'd0))) begin
            indvar_flatten10_fu_126 <= add_ln31_1_fu_503_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten10_fu_126 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        j_fu_118 <= add_ln32_fu_775_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        empty_reg_841 <= empty_fu_545_p1;
        first_iter_1_reg_846 <= first_iter_1_fu_549_p2;
        icmp_ln31_reg_831 <= icmp_ln31_fu_497_p2;
        lshr_ln6_6_reg_895 <= {{select_ln6_fu_529_p3[5:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul62_1_reg_1011 <= grp_fu_1035_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage11_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        mul65_1_reg_1021 <= grp_fu_1035_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10)) | ((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6)))) begin
        reg_460 <= grp_fu_1035_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        reg_466 <= grp_fu_1031_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_1_reg_940 <= tmp_1_fu_613_p19;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage14_11001) & (1'b1 == ap_CS_fsm_pp0_stage14))) begin
        tmp_2_reg_1026 <= add_ln32_fu_775_p2[32'd6];
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten10_load = indvar_flatten10_fu_126;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd2) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd3) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd4) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd5) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd6) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd7) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (tmp_2_reg_1026 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (trunc_ln31_reg_850_pp0_iter1_reg == 3'd0) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp2_we0_local = 1'b1;
    end else begin
        tmp2_we0_local = 1'b0;
    end
...
assign add_ln31_1_fu_503_p2 = (ap_sig_allocacmp_indvar_flatten10_load + 12'd1);
...
always @ (*) begin
    ap_condition_895 = ((icmp_ln31_reg_831 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_1_reg_846 == 1'd1));
end
...
assign first_iter_1_fu_549_p2 = ((select_ln6_fu_529_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_1031_p_ce = 1'b1;
assign grp_fu_1031_p_din0 = grp_fu_452_p0;
assign grp_fu_1031_p_din1 = grp_fu_452_p1;
assign grp_fu_1031_p_opcode = 2'd0;
assign grp_fu_1035_p_ce = 1'b1;
assign grp_fu_1035_p_din0 = grp_fu_456_p0;
assign grp_fu_1035_p_din1 = grp_fu_456_p1;
assign icmp_ln31_fu_497_p2 = ((ap_sig_allocacmp_indvar_flatten10_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_2_fu_559_p4 = {{select_ln31_fu_537_p3[5:3]}};
assign lshr_ln6_6_fu_581_p4 = {{select_ln6_fu_529_p3[5:3]}};
assign select_ln31_fu_537_p3 = ((tmp_fu_521_p3[0:0] == 1'b1) ? add_ln31_fu_515_p2 : ap_sig_allocacmp_i_2_load);
assign select_ln6_fu_529_p3 = ((tmp_fu_521_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
...
assign tmp_1_fu_613_p17 = 'bx;
assign tmp_3_fu_721_p9 = 'bx;
assign tmp_4_fu_673_p9 = 'bx;
assign tmp_5_fu_744_p9 = 'bx;
assign tmp_6_fu_697_p9 = 'bx;
assign tmp_fu_521_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_s_fu_655_p3 = {{empty_reg_841}, {lshr_ln6_6_reg_895}};
...
assign zext_ln6_1_fu_591_p1 = lshr_ln6_6_fu_581_p4;
