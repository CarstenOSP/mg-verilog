...
sparsemux_17_3_32_1_1_U1072(.din0(v9_fu_347_p2),.din1(v9_fu_347_p4),.din2(v9_fu_347_p6),.din3(v9_fu_347_p8),.din4(v9_fu_347_p10),.din5(v9_fu_347_p12),.din6(v9_fu_347_p14),.din7(v9_fu_347_p16),.def(v9_fu_347_p17),.sel(trunc_ln29_s_reg_421),.dout(v9_fu_347_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln29_s_reg_421 <= {{ap_sig_allocacmp_v8_2[9:7]}};
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln33_fu_255_p2 = (ap_sig_allocacmp_v8_2 + 11'd1);
assign add_ln35_s_fu_297_p3 = {{tmp_71_fu_287_p4}, {ap_sig_allocacmp_v8_2}};
...
assign icmp_ln33_fu_249_p2 = ((ap_sig_allocacmp_v8_2 == 11'd1024) ? 1'b1 : 1'b0);
assign tmp_71_fu_287_p4 = {{v5_4[12:1]}};
assign trunc_ln33_fu_261_p1 = ap_sig_allocacmp_v8_2[6:0];
