...
wire   [31:0] tmp_4_fu_377_p19;
reg   [31:0] tmp_4_reg_647;
reg   [31:0] E_40_reg_652;
reg   [31:0] D_23_reg_658;
...
reg   [31:0] C_33_fu_124;
wire   [31:0] C_2_fu_474_p3;
reg   [31:0] A_20_fu_128;
wire   [31:0] A_23_fu_527_p2;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_4_fu_377_p1;
wire   [2:0] tmp_4_fu_377_p3;
wire   [2:0] tmp_4_fu_377_p5;
wire   [2:0] tmp_4_fu_377_p7;
wire  signed [2:0] tmp_4_fu_377_p9;
wire  signed [2:0] tmp_4_fu_377_p11;
wire  signed [2:0] tmp_4_fu_377_p13;
wire  signed [2:0] tmp_4_fu_377_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U21(.din0(W_q0),.din1(W_1_q0),.din2(W_2_q0),.din3(W_3_q0),.din4(W_4_q0),.din5(W_5_q0),.din6(W_6_q0),.din7(W_7_q0),.def(tmp_4_fu_377_p17),.sel(trunc_ln100_reg_602),.dout(tmp_4_fu_377_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        D_23_reg_658 <= C_33_fu_124;
        E_40_reg_652 <= D_20_fu_120;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_4_reg_647 <= tmp_4_fu_377_p19;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln116_reg_598_pp0_iter2_reg == 1'd0))) begin
        ap_sig_allocacmp_B_2_load = A_20_fu_128;
    end else begin
...
assign A_23_fu_527_p2 = (add_ln118_2_reg_663 + add_ln118_fu_521_p2);
assign B_2_out = B_2_fu_112;
assign B_39_out = A_20_fu_128;
assign C_2_fu_474_p3 = {{trunc_ln118_1_fu_460_p1}, {lshr_ln118_1_fu_464_p4}};
assign D_39_out = D_23_reg_658;
assign E_2_out = E_2_fu_108;
assign E_39_out = E_40_reg_652;
...
assign add_ln118_1_fu_449_p2 = (tmp_4_reg_647 + 32'd1518500249);
...
assign and_ln118_1_fu_437_p2 = (xor_ln118_fu_425_p2 & D_20_fu_120);
assign and_ln118_fu_431_p2 = (ap_sig_allocacmp_B_2_load & C_33_fu_124);
...
assign lshr_ln3_fu_503_p4 = {{A_20_fu_128[31:27]}};
