module sha_stream_sha_transform_Pipeline_trans_lp3 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A,B,C,D,E,W_address0,W_ce0,W_q0,W_4_address0,W_4_ce0,W_4_q0,W_8_address0,W_8_ce0,W_8_q0,W_12_address0,W_12_ce0,W_12_q0,W_1_address0,W_1_ce0,W_1_q0,W_5_address0,W_5_ce0,W_5_q0,W_9_address0,W_9_ce0,W_9_q0,W_13_address0,W_13_ce0,W_13_q0,W_2_address0,W_2_ce0,W_2_q0,W_6_address0,W_6_ce0,W_6_q0,W_10_address0,W_10_ce0,W_10_q0,W_14_address0,W_14_ce0,W_14_q0,W_3_address0,W_3_ce0,W_3_q0,W_7_address0,W_7_ce0,W_7_q0,W_11_address0,W_11_ce0,W_11_q0,W_15_address0,W_15_ce0,W_15_q0,A_21_out,A_21_out_ap_vld,B_1_out,B_1_out_ap_vld,C_21_out,C_21_out_ap_vld,D_21_out,D_21_out_ap_vld,E_1_out,E_1_out_ap_vld); 
...
reg   [31:0] E_14_load_reg_1126;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] E_15_load_reg_1131;
...
wire   [31:0] tmp_10_fu_567_p11;
reg   [31:0] tmp_10_reg_1157;
wire   [31:0] tmp_11_fu_591_p11;
reg   [31:0] tmp_11_reg_1162;
wire   [31:0] tmp_12_fu_615_p11;
reg   [31:0] tmp_12_reg_1167;
wire   [31:0] temp_8_fu_669_p2;
reg   [31:0] temp_8_reg_1172;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [31:0] C_14_fu_674_p3;
reg   [31:0] C_14_reg_1178;
...
reg   [31:0] E_1_fu_114;
wire   [31:0] E_18_fu_773_p3;
wire    ap_loop_init;
wire    ap_block_pp0_stage1;
reg   [31:0] E_14_fu_118;
wire   [31:0] D_9_fu_833_p3;
reg   [31:0] E_15_fu_122;
wire   [31:0] C_5_fu_877_p3;
reg   [31:0] B_1_fu_126;
wire   [31:0] B_18_fu_904_p2;
reg   [31:0] B_14_fu_130;
wire   [31:0] A_11_fu_959_p2;
...
wire   [31:0] tmp_10_fu_567_p9;
wire   [31:0] tmp_11_fu_591_p9;
wire   [31:0] tmp_12_fu_615_p9;
...
wire   [3:0] tmp_10_fu_567_p1;
wire   [3:0] tmp_10_fu_567_p3;
wire  signed [3:0] tmp_10_fu_567_p5;
wire  signed [3:0] tmp_10_fu_567_p7;
wire   [3:0] tmp_11_fu_591_p1;
wire   [3:0] tmp_11_fu_591_p3;
wire  signed [3:0] tmp_11_fu_591_p5;
wire  signed [3:0] tmp_11_fu_591_p7;
wire   [3:0] tmp_12_fu_615_p1;
wire   [3:0] tmp_12_fu_615_p3;
wire  signed [3:0] tmp_12_fu_615_p5;
wire  signed [3:0] tmp_12_fu_615_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 5'd1;
...
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U40(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.def(tmp_10_fu_567_p9),.sel(trunc_ln116_fu_490_p1),.dout(tmp_10_fu_567_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U41(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.def(tmp_11_fu_591_p9),.sel(trunc_ln116_fu_490_p1),.dout(tmp_11_fu_591_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U42(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.def(tmp_12_fu_615_p9),.sel(trunc_ln116_fu_490_p1),.dout(tmp_12_fu_615_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        C_14_reg_1178 <= C_14_fu_674_p3;
        add_ln118_4_reg_1189 <= add_ln118_4_fu_730_p2;
        add_ln118_5_reg_1184 <= add_ln118_5_fu_725_p2;
        lshr_ln118_3_reg_1199 <= {{B_14_fu_130[31:2]}};
        lshr_ln118_5_reg_1209 <= {{temp_8_fu_669_p2[31:2]}};
        temp_8_reg_1172 <= temp_8_fu_669_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        E_14_load_reg_1126 <= E_14_fu_118;
        E_15_load_reg_1131 <= E_15_fu_122;
        add_ln118_1_reg_1137 <= add_ln118_1_fu_541_p2;
        add_ln118_reg_1142 <= add_ln118_fu_547_p2;
        lshr_ln118_1_reg_1152 <= {{B_1_fu_126[31:2]}};
        tmp_10_reg_1157 <= tmp_10_fu_567_p11;
        tmp_11_reg_1162 <= tmp_11_fu_591_p11;
        tmp_12_reg_1167 <= tmp_12_fu_615_p11;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        lshr_ln118_6_reg_1234 <= {{B_18_fu_904_p2[31:27]}};
...
assign A_11_fu_959_p2 = (add_ln118_14_reg_1239 + add_ln118_12_fu_955_p2);
assign A_21_out = B_14_fu_130;
assign B_18_fu_904_p2 = (add_ln118_8_reg_1219 + add_ln118_10_fu_900_p2);
assign B_1_out = B_1_fu_126;
assign C_14_fu_674_p3 = {{trunc_ln118_1_reg_1147}, {lshr_ln118_1_reg_1152}};
assign C_21_out = E_15_fu_122;
assign C_5_fu_877_p3 = {{trunc_ln118_7_fu_863_p1}, {lshr_ln118_7_fu_867_p4}};
assign D_21_out = E_14_fu_118;
assign D_9_fu_833_p3 = {{trunc_ln118_5_reg_1204}, {lshr_ln118_5_reg_1209}};
assign E_18_fu_773_p3 = {{trunc_ln118_3_reg_1194}, {lshr_ln118_3_reg_1199}};
...
assign add_ln118_10_fu_900_p2 = (add_ln118_9_reg_1214 + E_15_load_reg_1131);
assign add_ln118_12_fu_955_p2 = (C_14_reg_1178 + or_ln118_5_reg_1224);
assign add_ln118_13_fu_944_p2 = (tmp_12_reg_1167 + 32'd1518500249);
...
assign add_ln118_5_fu_725_p2 = (tmp_10_reg_1157 + 32'd1518500249);
assign add_ln118_6_fu_764_p2 = (add_ln118_5_reg_1184 + E_14_load_reg_1126);
assign add_ln118_8_fu_827_p2 = (or_ln118_7_fu_814_p3 + or_ln118_3_fu_808_p2);
assign add_ln118_9_fu_822_p2 = (tmp_11_reg_1162 + 32'd1518500249);
assign add_ln118_fu_547_p2 = (or_ln118_fu_535_p2 + E_1_fu_114);
assign and_ln118_1_fu_529_p2 = (xor_ln118_fu_517_p2 & E_14_fu_118);
assign and_ln118_2_fu_700_p2 = (C_14_fu_674_p3 & B_14_fu_130);
assign and_ln118_3_fu_706_p2 = (xor_ln118_1_fu_694_p2 & E_15_load_reg_1131);
assign and_ln118_4_fu_798_p2 = (temp_8_reg_1172 & E_18_fu_773_p3);
assign and_ln118_5_fu_803_p2 = (xor_ln118_2_fu_793_p2 & C_14_reg_1178);
assign and_ln118_6_fu_845_p2 = (temp_9_fu_768_p2 & D_9_fu_833_p3);
assign and_ln118_7_fu_851_p2 = (xor_ln118_3_fu_839_p2 & E_18_fu_773_p3);
assign and_ln118_fu_523_p2 = (E_15_fu_122 & B_1_fu_126);
...
assign lshr_ln118_2_fu_684_p4 = {{temp_8_fu_669_p2[31:27]}};
assign lshr_ln118_4_fu_783_p4 = {{temp_9_fu_768_p2[31:27]}};
assign lshr_ln118_7_fu_867_p4 = {{temp_9_fu_768_p2[31:2]}};
assign lshr_ln3_fu_646_p4 = {{B_14_fu_130[31:27]}};
...
assign temp_8_fu_669_p2 = (add_ln118_reg_1142 + add_ln118_2_fu_664_p2);
assign temp_9_fu_768_p2 = (add_ln118_4_reg_1189 + add_ln118_6_fu_764_p2);
assign tmp_10_fu_567_p9 = 'bx;
assign tmp_11_fu_591_p9 = 'bx;
assign tmp_12_fu_615_p9 = 'bx;
...
assign trunc_ln118_2_fu_680_p1 = temp_8_fu_669_p2[26:0];
assign trunc_ln118_3_fu_736_p1 = B_14_fu_130[1:0];
assign trunc_ln118_4_fu_779_p1 = temp_9_fu_768_p2[26:0];
assign trunc_ln118_5_fu_750_p1 = temp_8_fu_669_p2[1:0];
assign trunc_ln118_6_fu_909_p1 = B_18_fu_904_p2[26:0];
assign trunc_ln118_7_fu_863_p1 = temp_9_fu_768_p2[1:0];
assign trunc_ln118_fu_642_p1 = B_14_fu_130[26:0];
assign xor_ln118_1_fu_694_p2 = (32'd4294967295 ^ B_14_fu_130);
assign xor_ln118_2_fu_793_p2 = (temp_8_reg_1172 ^ 32'd4294967295);
assign xor_ln118_3_fu_839_p2 = (temp_9_fu_768_p2 ^ 32'd4294967295);
