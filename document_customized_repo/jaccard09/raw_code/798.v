module sha_stream_sha_transform_Pipeline_trans_lp6 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,A_13_reload,B_5_reload,E_13_reload,D_13_reload,E_6_reload,W_address0,W_ce0,W_q0,W_address1,W_ce1,W_q1,A_15_out,A_15_out_ap_vld,B_8_out,B_8_out_ap_vld,C_11_out,C_11_out_ap_vld,D_15_out,D_15_out_ap_vld,E_8_out,E_8_out_ap_vld); 
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln128_fu_223_p2 == 1'd1))) begin
...
assign A_15_out = B_1_fu_88;
assign B_8_out = B_fu_84;
assign C_11_out = E_2_fu_96;
...
assign D_15_out = E_1_fu_80;
assign E_8_out = E_fu_76;
...
assign add_ln130_1_fu_300_p2 = ($signed(or_ln2_fu_292_p3) + $signed(32'd3395469782));
...
assign or_ln2_fu_292_p3 = {{trunc_ln130_fu_278_p1}, {lshr_ln3_fu_282_p4}};
...
assign zext_ln100_fu_252_p1 = or_ln3_fu_244_p3;
