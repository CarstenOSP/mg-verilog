...
reg   [12:0] indvar_flatten35_fu_92;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_1_fu_337_p1;
wire   [2:0] tmp_1_fu_337_p3;
wire   [2:0] tmp_1_fu_337_p5;
wire   [2:0] tmp_1_fu_337_p7;
wire  signed [2:0] tmp_1_fu_337_p9;
wire  signed [2:0] tmp_1_fu_337_p11;
wire  signed [2:0] tmp_1_fu_337_p13;
wire  signed [2:0] tmp_1_fu_337_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_84 = 7'd0;
#0 i_fu_88 = 7'd0;
#0 indvar_flatten35_fu_92 = 13'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U65(.din0(buff_C_out_q0),.din1(buff_C_out_1_q0),.din2(buff_C_out_2_q0),.din3(buff_C_out_3_q0),.din4(buff_C_out_4_q0),.din5(buff_C_out_5_q0),.din6(buff_C_out_6_q0),.din7(buff_C_out_7_q0),.def(tmp_1_fu_337_p17),.sel(trunc_ln39_1_reg_405),.dout(tmp_1_fu_337_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln38_fu_226_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten35_fu_92 <= add_ln38_1_fu_232_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten35_fu_92 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_1_reg_454 <= tmp_1_fu_337_p19;
    end
end
always @ (*) begin
...
assign add_ln38_1_fu_232_p2 = (ap_sig_allocacmp_indvar_flatten35_load + 13'd1);
...
assign bitcast_ln41_fu_376_p1 = tmp_1_reg_454;
...
assign icmp_ln38_fu_226_p2 = ((ap_sig_allocacmp_indvar_flatten35_load == 13'd4096) ? 1'b1 : 1'b0);
