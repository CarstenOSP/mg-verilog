...
wire   [0:0] trunc_ln26_1_fu_243_p1;
reg   [0:0] trunc_ln26_1_reg_340;
wire   [4:0] lshr_ln5_6_fu_263_p4;
reg   [4:0] lshr_ln5_6_reg_355;
reg   [4:0] lshr_ln5_6_reg_355_pp0_iter2_reg;
reg   [4:0] lshr_ln5_6_reg_355_pp0_iter3_reg;
reg   [4:0] lshr_ln5_6_reg_355_pp0_iter4_reg;
...
reg   [4:0] buff_y_out_addr_reg_386_pp0_iter9_reg;
reg   [4:0] buff_y_out_addr_reg_386_pp0_iter10_reg;
reg   [4:0] buff_y_out_addr_reg_386_pp0_iter11_reg;
reg   [4:0] buff_y_out_addr_reg_386_pp0_iter12_reg;
reg   [4:0] buff_y_out_addr_reg_386_pp0_iter13_reg;
...
reg   [4:0] buff_y_out_1_addr_reg_392_pp0_iter9_reg;
reg   [4:0] buff_y_out_1_addr_reg_392_pp0_iter10_reg;
reg   [4:0] buff_y_out_1_addr_reg_392_pp0_iter11_reg;
reg   [4:0] buff_y_out_1_addr_reg_392_pp0_iter12_reg;
reg   [4:0] buff_y_out_1_addr_reg_392_pp0_iter13_reg;
...
wire   [63:0] zext_ln5_fu_257_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln28_fu_281_p1;
wire   [63:0] zext_ln5_1_fu_310_p1;
reg   [6:0] j_fu_54;
wire   [6:0] add_ln27_fu_287_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_58;
wire   [6:0] select_ln26_fu_231_p3;
reg   [11:0] indvar_flatten7_fu_62;
...
wire   [6:0] add_ln26_fu_209_p2;
wire   [4:0] lshr_ln5_2_fu_247_p4;
wire   [6:0] select_ln5_fu_223_p3;
wire   [5:0] trunc_ln26_fu_239_p1;
wire   [10:0] tmp_9_fu_273_p3;
reg    ap_done_reg;
...
#0 j_fu_54 = 7'd0;
#0 i_fu_58 = 7'd0;
#0 indvar_flatten7_fu_62 = 12'd0;
#0 ap_done_reg = 1'b0;
end
atax_fadd_32ns_32ns_32_7_full_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_1_U15(.clk(ap_clk),.reset(ap_rst),.din0(buff_y_out_1_load_reg_413),.din1(mul57_1_reg_408),.ce(1'b1),.dout(grp_fu_156_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U17(.clk(ap_clk),.reset(ap_rst),.din0(buff_A_1_load_reg_381),.din1(tmp_1_reg_370),.ce(1'b1),.dout(grp_fu_164_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln26_fu_186_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten7_fu_62 <= add_ln26_1_fu_192_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten7_fu_62 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            j_fu_54 <= add_ln27_fu_287_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add1_reg_418 <= grp_fu_318_p_dout0;
        add58_1_reg_423 <= grp_fu_156_p2;
        ...
        buff_y_out_1_addr_reg_392_pp0_iter10_reg <= buff_y_out_1_addr_reg_392_pp0_iter9_reg;
        buff_y_out_1_addr_reg_392_pp0_iter11_reg <= buff_y_out_1_addr_reg_392_pp0_iter10_reg;
        buff_y_out_1_addr_reg_392_pp0_iter12_reg <= buff_y_out_1_addr_reg_392_pp0_iter11_reg;
        buff_y_out_1_addr_reg_392_pp0_iter13_reg <= buff_y_out_1_addr_reg_392_pp0_iter12_reg;
        buff_y_out_1_addr_reg_392_pp0_iter6_reg <= buff_y_out_1_addr_reg_392;
        ...
        buff_y_out_1_addr_reg_392_pp0_iter9_reg <= buff_y_out_1_addr_reg_392_pp0_iter8_reg;
        buff_y_out_addr_reg_386 <= zext_ln5_1_fu_310_p1;
        buff_y_out_addr_reg_386_pp0_iter10_reg <= buff_y_out_addr_reg_386_pp0_iter9_reg;
        buff_y_out_addr_reg_386_pp0_iter11_reg <= buff_y_out_addr_reg_386_pp0_iter10_reg;
        buff_y_out_addr_reg_386_pp0_iter12_reg <= buff_y_out_addr_reg_386_pp0_iter11_reg;
        buff_y_out_addr_reg_386_pp0_iter13_reg <= buff_y_out_addr_reg_386_pp0_iter12_reg;
        buff_y_out_addr_reg_386_pp0_iter6_reg <= buff_y_out_addr_reg_386;
        ...
        buff_y_out_addr_reg_386_pp0_iter9_reg <= buff_y_out_addr_reg_386_pp0_iter8_reg;
        lshr_ln5_6_reg_355_pp0_iter2_reg <= lshr_ln5_6_reg_355;
        lshr_ln5_6_reg_355_pp0_iter3_reg <= lshr_ln5_6_reg_355_pp0_iter2_reg;
        lshr_ln5_6_reg_355_pp0_iter4_reg <= lshr_ln5_6_reg_355_pp0_iter3_reg;
        mul1_reg_403 <= grp_fu_322_p_dout0;
        mul57_1_reg_408 <= grp_fu_164_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln5_6_reg_355 <= {{select_ln5_fu_223_p3[5:1]}};
        trunc_ln26_1_reg_340 <= trunc_ln26_1_fu_243_p1;
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln26_1_fu_192_p2 = (ap_sig_allocacmp_indvar_flatten7_load + 12'd1);
assign add_ln26_fu_209_p2 = (i_fu_58 + 7'd1);
assign add_ln27_fu_287_p2 = (select_ln5_fu_223_p3 + 7'd2);
...
assign buff_A_1_address0 = zext_ln28_fu_281_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_address0 = zext_ln28_fu_281_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_y_out_1_address0 = buff_y_out_1_addr_reg_392_pp0_iter13_reg;
...
assign buff_y_out_address0 = buff_y_out_addr_reg_386_pp0_iter13_reg;
...
assign grp_fu_318_p_din0 = buff_y_out_load_reg_398;
assign grp_fu_318_p_din1 = mul1_reg_403;
assign grp_fu_318_p_opcode = 2'd0;
assign grp_fu_322_p_ce = 1'b1;
assign grp_fu_322_p_din0 = buff_A_load_reg_376;
assign grp_fu_322_p_din1 = tmp_1_reg_370;
assign icmp_ln26_fu_186_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_247_p4 = {{select_ln26_fu_231_p3[5:1]}};
assign lshr_ln5_6_fu_263_p4 = {{select_ln5_fu_223_p3[5:1]}};
assign select_ln26_fu_231_p3 = ((tmp_fu_215_p3[0:0] == 1'b1) ? add_ln26_fu_209_p2 : i_fu_58);
assign select_ln5_fu_223_p3 = ((tmp_fu_215_p3[0:0] == 1'b1) ? 7'd0 : j_fu_54);
assign tmp1_1_address0 = zext_ln5_fu_257_p1;
assign tmp1_1_ce0 = tmp1_1_ce0_local;
assign tmp1_address0 = zext_ln5_fu_257_p1;
assign tmp1_ce0 = tmp1_ce0_local;
assign tmp_1_fu_303_p3 = ((trunc_ln26_1_reg_340[0:0] == 1'b1) ? tmp1_1_q0 : tmp1_q0);
assign tmp_9_fu_273_p3 = {{trunc_ln26_fu_239_p1}, {lshr_ln5_6_fu_263_p4}};
assign tmp_fu_215_p3 = j_fu_54[32'd6];
assign trunc_ln26_1_fu_243_p1 = select_ln26_fu_231_p3[0:0];
assign trunc_ln26_fu_239_p1 = select_ln26_fu_231_p3[5:0];
assign zext_ln28_fu_281_p1 = tmp_9_fu_273_p3;
assign zext_ln5_1_fu_310_p1 = lshr_ln5_6_reg_355_pp0_iter4_reg;
assign zext_ln5_fu_257_p1 = lshr_ln5_2_fu_247_p4;
endmodule 