...
output  [1:0] grp_fu_4148_p_opcode;
...
reg   [0:0] tmp_2_reg_1059;
reg   [0:0] tmp_2_reg_1059_pp0_iter1_reg;
wire   [31:0] tmp_fu_744_p11;
reg   [31:0] tmp_reg_1063;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
reg   [31:0] buff_A_load_reg_1068;
wire   [31:0] tmp_69_fu_767_p11;
reg   [31:0] tmp_69_reg_1073;
reg   [31:0] buff_A_1_load_reg_1078;
wire   [31:0] tmp_70_fu_790_p11;
reg   [31:0] tmp_70_reg_1083;
reg   [31:0] buff_A_2_load_reg_1088;
wire   [31:0] tmp_71_fu_813_p11;
reg   [31:0] tmp_71_reg_1093;
reg   [31:0] buff_A_3_load_reg_1098;
wire   [31:0] tmp_72_fu_836_p11;
reg   [31:0] tmp_72_reg_1103;
...
wire   [63:0] tmp_141_cast_fu_629_p1;
...
wire   [9:0] tmp_s_fu_621_p3;
wire   [4:0] lshr_ln10_4_fu_637_p4;
wire   [8:0] tmp_100_fu_647_p3;
wire   [3:0] lshr_ln10_5_fu_667_p4;
wire   [9:0] tmp_101_fu_677_p3;
wire   [8:0] tmp_102_fu_693_p4;
wire   [31:0] tmp_fu_744_p9;
wire    ap_block_pp0_stage2;
wire   [31:0] tmp_69_fu_767_p9;
wire   [31:0] tmp_70_fu_790_p9;
wire   [31:0] tmp_71_fu_813_p9;
wire   [31:0] tmp_72_fu_836_p9;
reg    ap_done_reg;
...
wire   [1:0] tmp_69_fu_767_p1;
wire   [1:0] tmp_69_fu_767_p3;
wire  signed [1:0] tmp_69_fu_767_p5;
wire  signed [1:0] tmp_69_fu_767_p7;
wire   [1:0] tmp_70_fu_790_p1;
wire   [1:0] tmp_70_fu_790_p3;
wire  signed [1:0] tmp_70_fu_790_p5;
wire  signed [1:0] tmp_70_fu_790_p7;
wire   [1:0] tmp_71_fu_813_p1;
wire   [1:0] tmp_71_fu_813_p3;
wire  signed [1:0] tmp_71_fu_813_p5;
wire  signed [1:0] tmp_71_fu_813_p7;
wire   [1:0] tmp_72_fu_836_p1;
wire   [1:0] tmp_72_fu_836_p3;
wire  signed [1:0] tmp_72_fu_836_p5;
wire  signed [1:0] tmp_72_fu_836_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 29'd1;
...
sparsemux_9_2_32_1_1_U555(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_fu_744_p9),.sel(trunc_ln33_1_reg_930),.dout(tmp_fu_744_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U556(.din0(buff_B_q1),.din1(buff_B_2_q1),.din2(buff_B_4_q1),.din3(buff_B_6_q1),.def(tmp_69_fu_767_p9),.sel(trunc_ln33_1_reg_930),.dout(tmp_69_fu_767_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U557(.din0(buff_B_1_q1),.din1(buff_B_3_q1),.din2(buff_B_5_q1),.din3(buff_B_7_q1),.def(tmp_70_fu_790_p9),.sel(trunc_ln33_1_reg_930),.dout(tmp_70_fu_790_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U558(.din0(buff_B_q0),.din1(buff_B_2_q0),.din2(buff_B_4_q0),.din3(buff_B_6_q0),.def(tmp_71_fu_813_p9),.sel(trunc_ln33_1_reg_930),.dout(tmp_71_fu_813_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U559(.din0(buff_B_1_q0),.din1(buff_B_3_q0),.din2(buff_B_5_q0),.din3(buff_B_7_q0),.def(tmp_72_fu_836_p9),.sel(trunc_ln33_1_reg_930),.dout(tmp_72_fu_836_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_fu_114 <= select_ln32_fu_568_p3;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp_69_reg_1073 <= tmp_69_fu_767_p11;
        tmp_70_reg_1083 <= tmp_70_fu_790_p11;
        tmp_71_reg_1093 <= tmp_71_fu_813_p11;
        tmp_72_reg_1103 <= tmp_72_fu_836_p11;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp1_1_addr_1_reg_944 <= tmp_141_cast_fu_629_p1;
        tmp1_1_addr_1_reg_944_pp0_iter1_reg <= tmp1_1_addr_1_reg_944;
        tmp1_2_addr_1_reg_949 <= tmp_141_cast_fu_629_p1;
        tmp1_2_addr_1_reg_949_pp0_iter1_reg <= tmp1_2_addr_1_reg_949;
        tmp1_3_addr_reg_954 <= tmp_141_cast_fu_629_p1;
        tmp1_3_addr_reg_954_pp0_iter1_reg <= tmp1_3_addr_reg_954;
        tmp1_addr_1_reg_939 <= tmp_141_cast_fu_629_p1;
        tmp1_addr_1_reg_939_pp0_iter1_reg <= tmp1_addr_1_reg_939;
        tmp_2_reg_1059 <= add_ln34_fu_715_p2[32'd6];
        tmp_2_reg_1059_pp0_iter1_reg <= tmp_2_reg_1059;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul_1_reg_1118 <= grp_fu_4152_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        mul_2_reg_1123 <= grp_fu_4152_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        mul_3_reg_1128 <= grp_fu_4152_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul_reg_1108 <= grp_fu_4152_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
            grp_fu_434_p1 = tmp_72_reg_1103;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_434_p1 = tmp_71_reg_1093;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_434_p1 = tmp_70_reg_1083;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_434_p1 = tmp_69_reg_1073;
        end else begin
            grp_fu_434_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        tmp1_1_address0_local = tmp_141_cast_fu_629_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_1059_pp0_iter1_reg == 1'd1) & (trunc_ln33_1_reg_930_pp0_iter1_reg == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        tmp1_2_address0_local = tmp_141_cast_fu_629_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_1059_pp0_iter1_reg == 1'd1) & (trunc_ln33_1_reg_930_pp0_iter1_reg == 2'd2) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        tmp1_3_address0_local = tmp_141_cast_fu_629_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_1059_pp0_iter1_reg == 1'd1) & (trunc_ln33_1_reg_930_pp0_iter1_reg == 2'd3) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        tmp1_address0_local = tmp_141_cast_fu_629_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_1059_pp0_iter1_reg == 1'd1) & (trunc_ln33_1_reg_930_pp0_iter1_reg == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        tmp1_we0_local = 1'b1;
    end else begin
        tmp1_we0_local = 1'b0;
    end
...
assign add_ln32_fu_529_p2 = (i_fu_114 + 7'd1);
...
assign grp_fu_4148_p_din0 = grp_fu_430_p0;
assign grp_fu_4148_p_din1 = grp_fu_430_p1;
assign grp_fu_4148_p_opcode = 2'd0;
assign grp_fu_4152_p_ce = 1'b1;
assign grp_fu_4152_p_din0 = grp_fu_434_p0;
assign grp_fu_4152_p_din1 = grp_fu_434_p1;
...
assign select_ln32_fu_568_p3 = ((icmp_ln33_reg_918[0:0] == 1'b1) ? add_ln32_fu_529_p2 : i_fu_114);
...
assign tmp_100_fu_647_p3 = {{lshr_ln10_4_fu_637_p4}, {lshr_ln10_2_fu_611_p4}};
assign tmp_101_fu_677_p3 = {{trunc_ln33_fu_575_p1}, {lshr_ln10_5_fu_667_p4}};
assign tmp_102_fu_693_p4 = {{{lshr_ln10_5_fu_667_p4}, {1'd1}}, {lshr_ln10_2_fu_611_p4}};
assign tmp_141_cast_fu_629_p1 = tmp_s_fu_621_p3;
assign tmp_1_fu_549_p3 = k_fu_102[32'd6];
assign tmp_69_fu_767_p9 = 'bx;
assign tmp_70_fu_790_p9 = 'bx;
assign tmp_71_fu_813_p9 = 'bx;
assign tmp_72_fu_836_p9 = 'bx;
assign tmp_fu_744_p9 = 'bx;
assign tmp_s_fu_621_p3 = {{trunc_ln33_fu_575_p1}, {lshr_ln10_2_fu_611_p4}};
assign trunc_ln33_1_fu_607_p1 = select_ln33_fu_593_p3[1:0];
assign trunc_ln33_fu_575_p1 = select_ln32_fu_568_p3[5:0];
assign xor_ln34_fu_557_p2 = (tmp_1_fu_549_p3 ^ 1'd1);
assign zext_ln35_1_fu_685_p1 = tmp_101_fu_677_p3;
assign zext_ln35_2_fu_703_p1 = tmp_102_fu_693_p4;
assign zext_ln35_fu_655_p1 = tmp_100_fu_647_p3;
endmodule 