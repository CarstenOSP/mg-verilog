...
reg    ap_ready_int;
reg   [10:0] v25_3_reg_539;
wire    ap_block_pp0_stage0_11001;
reg   [10:0] v25_3_reg_539_pp0_iter1_reg;
wire   [0:0] tmp_fu_336_p3;
wire   [31:0] v26_fu_410_p19;
reg   [31:0] v26_reg_630;
wire    ap_block_pp0_stage1_11001;
wire   [31:0] v26_3_fu_450_p19;
reg   [31:0] v26_3_reg_635;
...
reg   [9:0] v2_addr_4_reg_645;
reg   [9:0] v2_addr_4_reg_645_pp0_iter3_reg;
reg   [9:0] v2_addr_4_reg_645_pp0_iter4_reg;
reg   [9:0] v2_addr_4_reg_645_pp0_iter5_reg;
reg   [9:0] v2_addr_4_reg_645_pp0_iter6_reg;
reg   [9:0] v2_addr_4_reg_645_pp0_iter7_reg;
reg   [31:0] v27_reg_650;
reg   [31:0] v2_load_reg_655;
reg   [31:0] v2_load_4_reg_660;
wire   [31:0] v28_fu_516_p1;
reg   [31:0] v27_3_reg_670;
wire   [31:0] v28_4_fu_520_p1;
reg   [31:0] v29_reg_680;
reg   [31:0] v29_3_reg_685;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln55_3_fu_348_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln56_3_fu_378_p1;
...
wire   [2:0] v26_3_fu_450_p1;
wire   [2:0] v26_3_fu_450_p3;
wire   [2:0] v26_3_fu_450_p5;
wire   [2:0] v26_3_fu_450_p7;
wire  signed [2:0] v26_3_fu_450_p9;
wire  signed [2:0] v26_3_fu_450_p11;
wire  signed [2:0] v26_3_fu_450_p13;
wire  signed [2:0] v26_3_fu_450_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 2'd1;
...
sparsemux_17_3_32_1_1_U182(.din0(v3_q1),.din1(v3_1_q1),.din2(v3_2_q1),.din3(v3_3_q1),.din4(v3_4_q1),.din5(v3_5_q1),.din6(v3_6_q1),.din7(v3_7_q1),.def(v26_fu_410_p17),.sel(v26_fu_410_p18),.dout(v26_fu_410_p19));
(* dissolve_hierarchy = "yes" *) SgdLR_sw_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U183(.din0(v3_q0),.din1(v3_1_q0),.din2(v3_2_q0),.din3(v3_3_q0),.din4(v3_4_q0),.din5(v3_5_q0),.din6(v3_6_q0),.din7(v3_7_q0),.def(v26_3_fu_450_p17),.sel(v26_3_fu_450_p18),.dout(v26_3_fu_450_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        v26_3_reg_635 <= v26_3_fu_450_p19;
        v26_reg_630 <= v26_fu_410_p19;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_546 <= ap_sig_allocacmp_v25_3[32'd10];
        v25_3_reg_539 <= ap_sig_allocacmp_v25_3;
        v25_3_reg_539_pp0_iter1_reg <= v25_3_reg_539;
        v2_addr_4_reg_645[9 : 1] <= zext_ln56_fu_511_p1[9 : 1];
        v2_addr_4_reg_645_pp0_iter3_reg[9 : 1] <= v2_addr_4_reg_645[9 : 1];
        v2_addr_4_reg_645_pp0_iter4_reg[9 : 1] <= v2_addr_4_reg_645_pp0_iter3_reg[9 : 1];
        v2_addr_4_reg_645_pp0_iter5_reg[9 : 1] <= v2_addr_4_reg_645_pp0_iter4_reg[9 : 1];
        v2_addr_4_reg_645_pp0_iter6_reg[9 : 1] <= v2_addr_4_reg_645_pp0_iter5_reg[9 : 1];
        v2_addr_4_reg_645_pp0_iter7_reg[9 : 1] <= v2_addr_4_reg_645_pp0_iter6_reg[9 : 1];
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v27_3_reg_670 <= grp_fu_1060_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v27_reg_650 <= grp_fu_1060_p_dout0;
        v2_load_4_reg_660 <= v2_q0;
        v2_load_reg_655 <= v2_q1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v29_3_reg_685 <= grp_fu_467_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v29_reg_680 <= grp_fu_467_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v2_address0_local = v2_addr_4_reg_645_pp0_iter7_reg;
...
assign add_ln55_fu_390_p2 = (ap_sig_allocacmp_v25_3 + 11'd2);
...
assign bitcast_ln60_3_fu_528_p1 = v29_3_reg_685;
assign bitcast_ln60_fu_524_p1 = v29_reg_680;
assign grp_fu_1060_p_ce = 1'b1;
assign grp_fu_1060_p_din0 = grp_fu_323_p0;
assign grp_fu_1060_p_din1 = 32'd3345637376;
assign grp_fu_467_p_ce = 1'b1;
assign grp_fu_467_p_din0 = grp_fu_319_p0;
assign grp_fu_467_p_din1 = grp_fu_319_p1;
assign grp_fu_467_p_opcode = 2'd0;
assign or_ln55_4_fu_503_p3 = {{tmp_s_fu_494_p4}, {1'd1}};
assign or_ln56_4_fu_370_p3 = {{tmp_2_fu_360_p4}, {1'd1}};
assign tmp_2_fu_360_p4 = {{ap_sig_allocacmp_v25_3[6:1]}};
assign tmp_fu_336_p3 = ap_sig_allocacmp_v25_3[32'd10];
assign tmp_s_fu_494_p4 = {{v25_3_reg_539_pp0_iter1_reg[9:1]}};
assign trunc_ln55_fu_344_p1 = ap_sig_allocacmp_v25_3[6:0];
assign v26_3_fu_450_p17 = 'bx;
assign v26_3_fu_450_p18 = {{v25_3_reg_539[9:7]}};
assign v26_fu_410_p17 = 'bx;
assign v26_fu_410_p18 = {{v25_3_reg_539[9:7]}};
assign v28_4_fu_520_p1 = v2_load_4_reg_660;
assign v28_fu_516_p1 = v2_load_reg_655;
assign v2_address0 = v2_address0_local;
assign v2_address1 = v2_address1_local;
assign v2_ce0 = v2_ce0_local;
assign v2_ce1 = v2_ce1_local;
assign v2_d0 = bitcast_ln60_3_fu_528_p1;
assign v2_d1 = bitcast_ln60_fu_524_p1;
assign v2_we0 = v2_we0_local;
assign v2_we1 = v2_we1_local;
assign v3_1_address0 = zext_ln56_3_fu_378_p1;
assign v3_1_address1 = zext_ln55_3_fu_348_p1;
assign v3_1_ce0 = v3_1_ce0_local;
assign v3_1_ce1 = v3_1_ce1_local;
assign v3_2_address0 = zext_ln56_3_fu_378_p1;
assign v3_2_address1 = zext_ln55_3_fu_348_p1;
assign v3_2_ce0 = v3_2_ce0_local;
assign v3_2_ce1 = v3_2_ce1_local;
assign v3_3_address0 = zext_ln56_3_fu_378_p1;
assign v3_3_address1 = zext_ln55_3_fu_348_p1;
assign v3_3_ce0 = v3_3_ce0_local;
assign v3_3_ce1 = v3_3_ce1_local;
assign v3_4_address0 = zext_ln56_3_fu_378_p1;
assign v3_4_address1 = zext_ln55_3_fu_348_p1;
assign v3_4_ce0 = v3_4_ce0_local;
assign v3_4_ce1 = v3_4_ce1_local;
assign v3_5_address0 = zext_ln56_3_fu_378_p1;
assign v3_5_address1 = zext_ln55_3_fu_348_p1;
assign v3_5_ce0 = v3_5_ce0_local;
assign v3_5_ce1 = v3_5_ce1_local;
assign v3_6_address0 = zext_ln56_3_fu_378_p1;
assign v3_6_address1 = zext_ln55_3_fu_348_p1;
assign v3_6_ce0 = v3_6_ce0_local;
assign v3_6_ce1 = v3_6_ce1_local;
assign v3_7_address0 = zext_ln56_3_fu_378_p1;
assign v3_7_address1 = zext_ln55_3_fu_348_p1;
assign v3_7_ce0 = v3_7_ce0_local;
assign v3_7_ce1 = v3_7_ce1_local;
assign v3_address0 = zext_ln56_3_fu_378_p1;
assign v3_address1 = zext_ln55_3_fu_348_p1;
assign v3_ce0 = v3_ce0_local;
assign v3_ce1 = v3_ce1_local;
assign zext_ln55_3_fu_348_p1 = trunc_ln55_fu_344_p1;
assign zext_ln55_fu_490_p1 = v25_3_reg_539_pp0_iter1_reg;
assign zext_ln56_3_fu_378_p1 = or_ln56_4_fu_370_p3;
assign zext_ln56_fu_511_p1 = or_ln55_4_fu_503_p3;
always @ (posedge ap_clk) begin
    v2_addr_4_reg_645[0] <= 1'b1;
    v2_addr_4_reg_645_pp0_iter3_reg[0] <= 1'b1;
    v2_addr_4_reg_645_pp0_iter4_reg[0] <= 1'b1;
    v2_addr_4_reg_645_pp0_iter5_reg[0] <= 1'b1;
    v2_addr_4_reg_645_pp0_iter6_reg[0] <= 1'b1;
    v2_addr_4_reg_645_pp0_iter7_reg[0] <= 1'b1;
end
endmodule 