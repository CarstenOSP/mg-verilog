...
wire   [31:0] tmp_fu_245_p11;
reg   [31:0] tmp_reg_350;
reg   [31:0] bucket_3_load_reg_355;
...
wire   [10:0] shl_ln_fu_189_p3;
wire   [10:0] add_ln26_fu_197_p2;
wire   [8:0] lshr_ln3_fu_203_p4;
wire   [6:0] add_ln27_fu_218_p2;
wire   [4:0] lshr_ln27_1_fu_224_p4;
wire   [31:0] tmp_fu_245_p9;
wire   [1:0] tmp_fu_245_p10;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_fu_245_p1;
wire  signed [1:0] tmp_fu_245_p3;
wire  signed [1:0] tmp_fu_245_p5;
wire   [1:0] tmp_fu_245_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_9_2_32_1_1_U22(.din0(sum_0_q0),.din1(sum_1_q0),.din2(sum_2_q0),.din3(sum_3_q0),.def(tmp_fu_245_p9),.sel(tmp_fu_245_p10),.dout(tmp_fu_245_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        bucket_3_load_reg_355 <= bucket_3_q0;
        tmp_reg_350 <= tmp_fu_245_p11;
...
assign add_ln26_fu_197_p2 = ($signed(shl_ln_fu_189_p3) + $signed(11'd2047));
assign add_ln27_1_fu_286_p2 = (bucket_3_load_reg_355 + tmp_reg_350);
...
assign lshr_ln2_fu_269_p4 = {{radixID_1_reg_311[6:2]}};
assign lshr_ln3_fu_203_p4 = {{add_ln26_fu_197_p2[10:2]}};
assign shl_ln_fu_189_p3 = {{trunc_ln25_1_fu_185_p1}, {4'd0}};
