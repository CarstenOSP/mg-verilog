...
wire   [63:0] tmp_193_fu_121_p7;
wire   [63:0] tmp_193_fu_121_p9;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_193_fu_121_p1;
wire   [1:0] tmp_193_fu_121_p3;
wire  signed [1:0] tmp_193_fu_121_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 7'd1;
...
sparsemux_7_2_64_1_1_U994(.din0(activations3_load_2),.din1(activations3_1_load_2),.din2(activations3_2_load_2),.def(tmp_193_fu_121_p7),.sel(ap_sig_allocacmp_i_8),.dout(tmp_193_fu_121_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        sum_fu_54 <= grp_fu_11177_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_194_reg_226 <= grp_fu_11481_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ap_sig_allocacmp_sum_load = grp_fu_11177_p_dout0;
    end else begin
...
assign bitcast_ln9_fu_141_p1 = tmp_193_fu_121_p9;
assign grp_fu_11177_p_ce = 1'b1;
assign grp_fu_11177_p_din0 = ap_sig_allocacmp_sum_load;
assign grp_fu_11177_p_din1 = tmp_194_reg_226;
assign grp_fu_11177_p_opcode = 2'd0;
assign grp_fu_11481_p_ce = 1'b1;
assign grp_fu_11481_p_din0 = 64'd0;
assign grp_fu_11481_p_din1 = bitcast_ln9_1_fu_174_p1;
assign icmp_ln8_fu_109_p2 = ((ap_sig_allocacmp_i_8 == 2'd3) ? 1'b1 : 1'b0);
assign sum_out = sum_fu_54;
assign tmp_193_fu_121_p7 = 'bx;
