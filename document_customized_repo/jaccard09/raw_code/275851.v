module backprop_backprop_Pipeline_label_13 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_22156,mux_case_12052,mux_case_01948,v18_i,v18_o,v18_o_ap_vld,v18_2_i,v18_2_o,v18_2_o_ap_vld,v18_1_i,v18_1_o,v18_1_o_ap_vld,v116_2_out,v116_2_out_ap_vld,mux_case_12050_out,mux_case_12050_out_ap_vld,v116_out,v116_out_ap_vld,grp_fu_2112_p_din0,grp_fu_2112_p_din1,grp_fu_2112_p_opcode,grp_fu_2112_p_dout0,grp_fu_2112_p_ce,grp_fu_2116_p_din0,grp_fu_2116_p_din1,grp_fu_2116_p_opcode,grp_fu_2116_p_dout0,grp_fu_2116_p_ce,grp_fu_2120_p_din0,grp_fu_2120_p_din1,grp_fu_2120_p_dout0,grp_fu_2120_p_ce,grp_fu_4845_p_din0,grp_fu_4845_p_din1,grp_fu_4845_p_dout0,grp_fu_4845_p_ce,grp_fu_4849_p_din0,grp_fu_4849_p_din1,grp_fu_4849_p_dout0,grp_fu_4849_p_ce); 
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_22156;
input  [63:0] mux_case_12052;
input  [63:0] mux_case_01948;
input  [63:0] v18_i;
output  [63:0] v18_o;
output   v18_o_ap_vld;
input  [63:0] v18_2_i;
...
output  [63:0] mux_case_12050_out;
output   mux_case_12050_out_ap_vld;
...
output  [63:0] grp_fu_2116_p_din0;
output  [63:0] grp_fu_2116_p_din1;
output  [0:0] grp_fu_2116_p_opcode;
input  [63:0] grp_fu_2116_p_dout0;
...
output  [63:0] grp_fu_4845_p_din0;
output  [63:0] grp_fu_4845_p_din1;
input  [63:0] grp_fu_4845_p_dout0;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v74_reg_361 <= grp_fu_2112_p_dout0;
        v75_reg_366 <= grp_fu_2120_p_dout0;
        v77_reg_373 <= grp_fu_4849_p_dout0;
        v78_reg_378 <= grp_fu_2116_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
        mux_case_12050_out_ap_vld = 1'b1;
    end else begin
        mux_case_12050_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((icmp_ln139_reg_336_pp0_iter86_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter87_reg == 1'b1))) begin
...
assign grp_fu_2112_p_din0 = 64'd4607182418800017408;
assign grp_fu_2112_p_din1 = v73_reg_340;
assign grp_fu_2112_p_opcode = 2'd1;
assign grp_fu_2116_p_ce = 1'b1;
assign grp_fu_2116_p_din0 = v77_reg_373;
assign grp_fu_2116_p_din1 = 64'd4607182418800017408;
assign grp_fu_2116_p_opcode = 2'd0;
assign grp_fu_2120_p_ce = 1'b1;
assign grp_fu_2120_p_din0 = v73_reg_340_pp0_iter8_reg;
assign grp_fu_2120_p_din1 = v74_reg_361;
assign grp_fu_4845_p_ce = 1'b1;
assign grp_fu_4845_p_din0 = 64'd4607182418800017408;
assign grp_fu_4845_p_din1 = v78_reg_378;
assign grp_fu_4849_p_ce = 1'b1;
assign grp_fu_4849_p_din0 = 64'd0;
assign grp_fu_4849_p_din1 = v76_fu_275_p1;
assign icmp_ln139_fu_210_p2 = ((ap_sig_allocacmp_v72_1 == 2'd3) ? 1'b1 : 1'b0);
assign mux_case_12050_out = mux_case_12050_fu_74;
