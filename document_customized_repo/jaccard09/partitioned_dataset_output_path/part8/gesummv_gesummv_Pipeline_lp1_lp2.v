...
wire   [1:0] trunc_ln25_fu_379_p1;
reg   [1:0] trunc_ln25_reg_548;
reg   [1:0] trunc_ln25_reg_548_pp0_iter1_reg;
reg   [3:0] tmp1_addr_reg_553;
reg   [3:0] tmp1_addr_reg_553_pp0_iter1_reg;
reg   [3:0] tmp1_1_addr_reg_558;
reg   [3:0] tmp1_1_addr_reg_558_pp0_iter1_reg;
reg   [3:0] tmp1_2_addr_reg_563;
reg   [3:0] tmp1_2_addr_reg_563_pp0_iter1_reg;
reg   [3:0] tmp1_3_addr_reg_568;
reg   [3:0] tmp1_3_addr_reg_568_pp0_iter1_reg;
wire   [3:0] lshr_ln6_3_fu_401_p4;
reg   [3:0] lshr_ln6_3_reg_573;
...
reg   [31:0] buff_A_load_reg_643;
reg   [31:0] buff_A_1_load_reg_648;
reg   [31:0] buff_A_2_load_reg_653;
reg   [31:0] buff_A_3_load_reg_658;
reg   [0:0] tmp_2_reg_668;
wire    ap_block_pp0_stage28_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln6_1_fu_393_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln6_fu_411_p1;
wire   [63:0] zext_ln27_fu_458_p1;
wire    ap_block_pp0_stage1;
reg   [6:0] j_fu_84;
wire   [6:0] add_ln26_fu_474_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_1_fu_88;
wire   [6:0] select_ln25_fu_361_p3;
reg   [6:0] ap_sig_allocacmp_i_1_load;
reg   [10:0] indvar_flatten_fu_92;
wire   [10:0] add_ln25_1_fu_327_p2;
...
wire   [0:0] tmp_1_fu_345_p3;
wire   [6:0] add_ln25_fu_339_p2;
wire   [3:0] lshr_ln6_1_fu_383_p4;
wire   [31:0] tmp_fu_429_p9;
wire   [9:0] tmp_6_fu_452_p3;
...
sparsemux_9_2_32_1_1_U20(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_fu_429_p9),.sel(trunc_ln25_reg_548),.dout(tmp_fu_429_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln25_fu_321_p2 == 1'd0))) begin
            i_1_fu_88 <= select_ln25_fu_361_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln25_fu_321_p2 == 1'd0))) begin
            indvar_flatten_fu_92 <= add_ln25_1_fu_327_p2;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_84 <= 7'd0;
    end else if (((icmp_ln25_reg_530 == 1'd0) & (1'b0 == ap_block_pp0_stage28_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        j_fu_84 <= add_ln26_fu_474_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        buff_A_1_load_reg_648 <= buff_A_1_q0;
        buff_A_2_load_reg_653 <= buff_A_2_q0;
        buff_A_3_load_reg_658 <= buff_A_3_q0;
        buff_A_load_reg_643 <= buff_A_q0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln25_reg_530 <= icmp_ln25_fu_321_p2;
        lshr_ln6_3_reg_573 <= {{select_ln6_fu_353_p3[5:2]}};
        select_ln6_reg_534 <= select_ln6_fu_353_p3;
        tmp1_1_addr_reg_558 <= zext_ln6_1_fu_393_p1;
        tmp1_1_addr_reg_558_pp0_iter1_reg <= tmp1_1_addr_reg_558;
        tmp1_2_addr_reg_563 <= zext_ln6_1_fu_393_p1;
        tmp1_2_addr_reg_563_pp0_iter1_reg <= tmp1_2_addr_reg_563;
        tmp1_3_addr_reg_568 <= zext_ln6_1_fu_393_p1;
        tmp1_3_addr_reg_568_pp0_iter1_reg <= tmp1_3_addr_reg_568;
        tmp1_addr_reg_553 <= zext_ln6_1_fu_393_p1;
        tmp1_addr_reg_553_pp0_iter1_reg <= tmp1_addr_reg_553;
        trunc_ln25_reg_548 <= trunc_ln25_fu_379_p1;
        trunc_ln25_reg_548_pp0_iter1_reg <= trunc_ln25_reg_548;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage28_11001) & (1'b1 == ap_CS_fsm_pp0_stage28))) begin
        tmp_2_reg_668 <= add_ln26_fu_474_p2[32'd6];
    end
end
always @ (*) begin
    if (((icmp_ln25_reg_530 == 1'd1) & (1'b0 == ap_block_pp0_stage10_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage10) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
            ...
            grp_fu_266_p0 = buff_A_3_load_reg_658;
        end else if (((1'b0 == ap_block_pp0_stage5) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
            grp_fu_266_p0 = buff_A_2_load_reg_653;
        end else if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_266_p0 = buff_A_1_load_reg_648;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_266_p0 = buff_A_load_reg_643;
        end else begin
            grp_fu_266_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_1_address0_local = tmp1_1_addr_reg_558_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp1_1_address0_local = zext_ln6_1_fu_393_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_668 == 1'd1) & (trunc_ln25_reg_548_pp0_iter1_reg == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_2_address0_local = tmp1_2_addr_reg_563_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp1_2_address0_local = zext_ln6_1_fu_393_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_668 == 1'd1) & (trunc_ln25_reg_548_pp0_iter1_reg == 2'd2) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_3_address0_local = tmp1_3_addr_reg_568_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp1_3_address0_local = zext_ln6_1_fu_393_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_668 == 1'd1) & (trunc_ln25_reg_548_pp0_iter1_reg == 2'd3) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_address0_local = tmp1_addr_reg_553_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp1_address0_local = zext_ln6_1_fu_393_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage10_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_2_reg_668 == 1'd1) & (trunc_ln25_reg_548_pp0_iter1_reg == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        tmp1_we0_local = 1'b1;
    end else begin
        tmp1_we0_local = 1'b0;
    end
...
assign add_ln25_1_fu_327_p2 = (ap_sig_allocacmp_indvar_flatten_load + 11'd1);
assign add_ln25_fu_339_p2 = (ap_sig_allocacmp_i_1_load + 7'd1);
assign add_ln26_fu_474_p2 = (select_ln6_reg_534 + 7'd4);
...
always @ (*) begin
    ap_condition_836 = ((icmp_ln25_reg_530 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (first_iter_0_reg_544 == 1'd1));
end
assign ap_done = ap_done_sig;
assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage10;
assign ap_ready = ap_ready_sig;
assign buff_A_1_address0 = zext_ln27_fu_458_p1;
assign buff_A_1_ce0 = buff_A_1_ce0_local;
assign buff_A_2_address0 = zext_ln27_fu_458_p1;
assign buff_A_2_ce0 = buff_A_2_ce0_local;
assign buff_A_3_address0 = zext_ln27_fu_458_p1;
assign buff_A_3_ce0 = buff_A_3_ce0_local;
assign buff_A_address0 = zext_ln27_fu_458_p1;
assign buff_A_ce0 = buff_A_ce0_local;
assign buff_x_1_address0 = zext_ln6_fu_411_p1;
assign buff_x_1_ce0 = buff_x_1_ce0_local;
assign buff_x_2_address0 = zext_ln6_fu_411_p1;
assign buff_x_2_ce0 = buff_x_2_ce0_local;
assign buff_x_3_address0 = zext_ln6_fu_411_p1;
assign buff_x_3_ce0 = buff_x_3_ce0_local;
assign buff_x_address0 = zext_ln6_fu_411_p1;
assign buff_x_ce0 = buff_x_ce0_local;
assign empty_fu_369_p1 = select_ln25_fu_361_p3[5:0];
...
assign icmp_ln25_fu_321_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln6_1_fu_383_p4 = {{select_ln25_fu_361_p3[5:2]}};
assign lshr_ln6_3_fu_401_p4 = {{select_ln6_fu_353_p3[5:2]}};
assign select_ln25_fu_361_p3 = ((tmp_1_fu_345_p3[0:0] == 1'b1) ? add_ln25_fu_339_p2 : ap_sig_allocacmp_i_1_load);
assign select_ln6_fu_353_p3 = ((tmp_1_fu_345_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign tmp1_1_address0 = tmp1_1_address0_local;
assign tmp1_1_ce0 = tmp1_1_ce0_local;
assign tmp1_1_d0 = reg_294;
assign tmp1_1_we0 = tmp1_1_we0_local;
assign tmp1_2_address0 = tmp1_2_address0_local;
assign tmp1_2_ce0 = tmp1_2_ce0_local;
assign tmp1_2_d0 = reg_294;
assign tmp1_2_we0 = tmp1_2_we0_local;
assign tmp1_3_address0 = tmp1_3_address0_local;
assign tmp1_3_ce0 = tmp1_3_ce0_local;
assign tmp1_3_d0 = reg_294;
assign tmp1_3_we0 = tmp1_3_we0_local;
assign tmp1_address0 = tmp1_address0_local;
assign tmp1_ce0 = tmp1_ce0_local;
assign tmp1_d0 = reg_294;
assign tmp1_we0 = tmp1_we0_local;
assign tmp_1_fu_345_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_6_fu_452_p3 = {{empty_reg_539}, {lshr_ln6_3_reg_573}};
assign tmp_fu_429_p9 = 'bx;
assign trunc_ln25_fu_379_p1 = select_ln25_fu_361_p3[1:0];
assign zext_ln27_fu_458_p1 = tmp_6_fu_452_p3;
assign zext_ln6_1_fu_393_p1 = lshr_ln6_1_fu_383_p4;
assign zext_ln6_fu_411_p1 = lshr_ln6_3_fu_401_p4;
endmodule 
