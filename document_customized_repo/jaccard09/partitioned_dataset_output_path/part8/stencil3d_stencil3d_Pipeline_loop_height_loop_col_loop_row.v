...
wire   [4:0] indvars_iv_next19_dup_fu_599_p2;
reg   [4:0] indvars_iv_next19_dup_reg_1042;
wire   [3:0] k_2_mid2_fu_611_p3;
reg   [3:0] k_2_mid2_reg_1047;
...
reg   [1:0] lshr_ln2_reg_1061;
wire   [4:0] select_ln37_fu_667_p3;
reg   [4:0] select_ln37_reg_1070;
wire   [9:0] empty_10_fu_701_p2;
reg   [9:0] empty_10_reg_1075;
wire   [4:0] empty_11_fu_740_p3;
reg   [4:0] empty_11_reg_1100;
reg   [31:0] tmp_5_reg_1165;
wire   [31:0] tmp_9_fu_866_p11;
reg   [31:0] tmp_9_reg_1210;
wire   [31:0] tmp_s_fu_889_p11;
...
wire    ap_loop_init;
reg   [4:0] j_fu_102;
reg   [8:0] indvar_flatten20_fu_106;
wire   [8:0] select_ln37_1_fu_639_p3;
reg   [4:0] i_fu_110;
reg   [13:0] indvar_flatten35_fu_114;
...
wire   [4:0] indvars_iv_next3347_fu_585_p2;
wire   [0:0] empty_fu_605_p2;
wire   [8:0] add_ln37_fu_633_p2;
wire  signed [5:0] tmp2_cast_cast_fu_679_p3;
wire   [9:0] tmp2_cast_cast_cast_fu_687_p1;
wire   [9:0] tmp_1_fu_672_p3;
wire  signed [9:0] tmp3_cast_fu_697_p1;
wire   [9:0] empty_9_fu_691_p2;
wire   [11:0] add_ln5_fu_713_p3;
wire   [4:0] indvars_iv_next1954_fu_728_p2;
wire   [4:0] indvars_iv_next19_mid1_fu_662_p2;
wire   [4:0] select_ln11_1_fu_733_p3;
wire   [4:0] tmp4_fu_707_p2;
wire   [11:0] add_ln8_fu_747_p4;
wire   [1:0] lshr_ln3_fu_768_p4;
wire   [11:0] add_ln44_1_fu_778_p4;
wire   [3:0] add_ln45_fu_795_p2;
wire   [1:0] lshr_ln4_fu_800_p4;
wire   [11:0] add_ln45_1_fu_810_p4;
wire   [11:0] add_ln6_fu_837_p3;
wire   [11:0] add_ln7_fu_851_p4;
wire   [31:0] tmp_9_fu_866_p9;
wire   [31:0] tmp_s_fu_889_p9;
wire   [11:0] add_ln4_fu_912_p4;
...
wire  signed [1:0] tmp_9_fu_866_p1;
wire   [1:0] tmp_9_fu_866_p3;
wire   [1:0] tmp_9_fu_866_p5;
wire  signed [1:0] tmp_9_fu_866_p7;
wire   [1:0] tmp_s_fu_889_p1;
wire  signed [1:0] tmp_s_fu_889_p3;
wire  signed [1:0] tmp_s_fu_889_p5;
wire   [1:0] tmp_s_fu_889_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
#0 k_fu_98 = 4'd0;
#0 j_fu_102 = 5'd0;
#0 indvar_flatten20_fu_106 = 9'd0;
#0 i_fu_110 = 5'd0;
#0 indvar_flatten35_fu_114 = 14'd0;
#0 ap_done_reg = 1'b0;
end
stencil3d_mul_32s_32s_32_2_1 #(.ID( 1 ),.NUM_STAGE( 2 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
mul_32s_32s_32_2_1_U26(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_442_p0),.din1(grp_fu_442_p1),.ce(1'b1),.dout(grp_fu_442_p2));
...
sparsemux_9_2_32_1_1_U27(.din0(orig_0_q0),.din1(orig_1_q0),.din2(orig_2_q0),.din3(orig_3_q0),.def(grp_fu_446_p9),.sel(grp_fu_446_p10),.dout(grp_fu_446_p11));
(* dissolve_hierarchy = "yes" *) stencil3d_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U28(.din0(orig_0_q1),.din1(orig_1_q1),.din2(orig_2_q1),.din3(orig_3_q1),.def(grp_fu_469_p9),.sel(trunc_ln38_reg_1053),.dout(grp_fu_469_p11));
...
sparsemux_9_2_32_1_1_x_U29(.din0(orig_0_q1),.din1(orig_1_q1),.din2(orig_2_q1),.din3(orig_3_q1),.def(tmp_9_fu_866_p9),.sel(trunc_ln38_reg_1053),.dout(tmp_9_fu_866_p11));
...
sparsemux_9_2_32_1_1_x_U30(.din0(orig_0_q1),.din1(orig_1_q1),.din2(orig_2_q1),.din3(orig_3_q1),.def(tmp_s_fu_889_p9),.sel(trunc_ln38_reg_1053),.dout(tmp_s_fu_889_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten20_fu_106 <= 9'd0;
    end else if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln36_fu_532_p2 == 1'd0))) begin
        indvar_flatten20_fu_106 <= select_ln37_1_fu_639_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten35_fu_114 <= 14'd0;
    end else if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln36_fu_532_p2 == 1'd0))) begin
        indvar_flatten35_fu_114 <= add_ln36_fu_538_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        indvars_iv_next19_dup_reg_1042 <= indvars_iv_next19_dup_fu_599_p2;
        j_load_reg_1010 <= j_fu_102;
        k_2_mid2_reg_1047 <= k_2_mid2_fu_611_p3;
        lshr_ln2_reg_1061 <= {{k_2_mid2_fu_611_p3[3:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        empty_10_reg_1075 <= empty_10_fu_701_p2;
        empty_11_reg_1100 <= empty_11_fu_740_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_5_reg_1165 <= grp_fu_446_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_9_reg_1210 <= tmp_9_fu_866_p11;
        tmp_s_reg_1215 <= tmp_s_fu_889_p11;
    end
end
always @ (*) begin
...
assign add_ln36_fu_538_p2 = (indvar_flatten35_fu_114 + 14'd1);
assign add_ln37_fu_633_p2 = (indvar_flatten20_fu_106 + 9'd1);
assign add_ln44_1_fu_778_p4 = {{{select_ln36_reg_1032}, {select_ln37_fu_667_p3}}, {lshr_ln3_fu_768_p4}};
assign add_ln44_fu_763_p2 = (k_2_mid2_reg_1047 + 4'd1);
assign add_ln45_1_fu_810_p4 = {{{select_ln36_reg_1032}, {select_ln37_fu_667_p3}}, {lshr_ln4_fu_800_p4}};
assign add_ln45_fu_795_p2 = ($signed(k_2_mid2_reg_1047) + $signed(4'd15));
assign add_ln48_1_fu_942_p2 = (add_ln48_fu_937_p2 + reg_492);
assign add_ln48_2_fu_927_p2 = (tmp_9_reg_1210 + tmp_s_reg_1215);
...
assign add_ln48_fu_937_p2 = (tmp_5_reg_1165 + reg_496);
assign add_ln4_fu_912_p4 = {{{select_ln36_reg_1032}, {select_ln37_reg_1070}}, {lshr_ln2_reg_1061}};
assign add_ln5_fu_713_p3 = {{empty_9_fu_691_p2}, {lshr_ln2_reg_1061}};
assign add_ln6_fu_837_p3 = {{empty_10_reg_1075}, {lshr_ln2_reg_1061}};
assign add_ln7_fu_851_p4 = {{{select_ln36_reg_1032}, {empty_11_reg_1100}}, {lshr_ln2_reg_1061}};
assign add_ln8_fu_747_p4 = {{{select_ln36_reg_1032}, {tmp4_fu_707_p2}}, {lshr_ln2_reg_1061}};
...
assign empty_10_fu_701_p2 = ($signed(tmp3_cast_fu_697_p1) + $signed(tmp_1_fu_672_p3));
assign empty_11_fu_740_p3 = ((and_ln11_reg_1026[0:0] == 1'b1) ? indvars_iv_next19_mid1_fu_662_p2 : select_ln11_1_fu_733_p3);
assign empty_9_fu_691_p2 = (tmp2_cast_cast_cast_fu_687_p1 + tmp_1_fu_672_p3);
assign empty_fu_605_p2 = (icmp_ln37_fu_553_p2 | and_ln11_fu_579_p2);
assign grp_fu_446_p9 = 'bx;
assign grp_fu_469_p9 = 'bx;
assign icmp_ln36_fu_532_p2 = ((indvar_flatten35_fu_114 == 14'd12600) ? 1'b1 : 1'b0);
assign icmp_ln37_fu_553_p2 = ((indvar_flatten20_fu_106 == 9'd420) ? 1'b1 : 1'b0);
assign icmp_ln38_fu_573_p2 = ((k_fu_98 == 4'd15) ? 1'b1 : 1'b0);
assign indvars_iv_next1954_fu_728_p2 = (j_load_reg_1010 + 5'd1);
assign indvars_iv_next19_dup_fu_599_p2 = (select_ln11_fu_559_p3 + 5'd1);
assign indvars_iv_next19_mid1_fu_662_p2 = (select_ln11_reg_1020 + 5'd2);
assign indvars_iv_next3347_fu_585_p2 = (i_fu_110 + 5'd1);
assign k_2_mid2_fu_611_p3 = ((empty_fu_605_p2[0:0] == 1'b1) ? 4'd1 : k_fu_98);
assign lshr_ln3_fu_768_p4 = {{add_ln44_fu_763_p2[3:2]}};
assign lshr_ln4_fu_800_p4 = {{add_ln45_fu_795_p2[3:2]}};
...
assign select_ln11_1_fu_733_p3 = ((icmp_ln37_reg_1015[0:0] == 1'b1) ? 5'd2 : indvars_iv_next1954_fu_728_p2);
assign select_ln11_fu_559_p3 = ((icmp_ln37_fu_553_p2[0:0] == 1'b1) ? 5'd1 : j_fu_102);
assign select_ln36_fu_591_p3 = ((icmp_ln37_fu_553_p2[0:0] == 1'b1) ? indvars_iv_next3347_fu_585_p2 : i_fu_110);
assign select_ln37_1_fu_639_p3 = ((icmp_ln37_fu_553_p2[0:0] == 1'b1) ? 9'd1 : add_ln37_fu_633_p2);
assign select_ln37_fu_667_p3 = ((and_ln11_reg_1026[0:0] == 1'b1) ? indvars_iv_next19_dup_reg_1042 : select_ln11_reg_1020);
...
assign tmp2_cast_cast_cast_fu_687_p1 = $unsigned(tmp2_cast_cast_fu_679_p3);
assign tmp2_cast_cast_fu_679_p3 = {{1'd1}, {select_ln37_fu_667_p3}};
assign tmp3_cast_fu_697_p1 = tmp2_cast_cast_fu_679_p3;
assign tmp4_fu_707_p2 = ($signed(select_ln37_fu_667_p3) + $signed(5'd31));
assign tmp_1_fu_672_p3 = {{select_ln36_reg_1032}, {5'd0}};
assign tmp_9_fu_866_p9 = 'bx;
assign tmp_s_fu_889_p9 = 'bx;
assign trunc_ln38_fu_619_p1 = k_2_mid2_fu_611_p3[1:0];
assign xor_ln11_fu_567_p2 = (icmp_ln37_fu_553_p2 ^ 1'd1);
assign zext_ln39_fu_919_p1 = add_ln4_fu_912_p4;
assign zext_ln40_fu_720_p1 = add_ln5_fu_713_p3;
assign zext_ln41_fu_843_p1 = add_ln6_fu_837_p3;
assign zext_ln42_fu_858_p1 = add_ln7_fu_851_p4;
assign zext_ln43_fu_755_p1 = add_ln8_fu_747_p4;
