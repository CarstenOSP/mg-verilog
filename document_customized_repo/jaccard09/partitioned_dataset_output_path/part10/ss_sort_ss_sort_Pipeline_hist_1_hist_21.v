...
wire   [9:0] thr_add52_fu_356_p2;
reg   [9:0] thr_add52_reg_586;
...
reg   [31:0] bucket_3_load_7_reg_656;
...
sparsemux_9_2_32_1_1_U16(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.def(tmp_2_fu_436_p9),.sel(empty_23_reg_551),.dout(tmp_2_fu_436_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        bucket_3_load_7_reg_656 <= bucket_3_q0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        thr_add52_reg_586 <= thr_add52_fu_356_p2;
...
assign add_ln58_2_fu_497_p2 = (bucket_3_load_7_reg_656 + 32'd1);
...
assign thr_add52_fu_356_p2 = (blockID_1_cast_cast3_fu_353_p1 + 10'd1);
...
assign zext_ln55_fu_370_p1 = thr_add52_reg_586;
always @ (posedge ap_clk) begin
