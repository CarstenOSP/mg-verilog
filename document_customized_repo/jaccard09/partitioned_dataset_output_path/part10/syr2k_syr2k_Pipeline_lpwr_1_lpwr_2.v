...
reg   [12:0] indvar_flatten44_fu_76;
wire   [12:0] add_ln52_1_fu_164_p2;
reg   [12:0] ap_sig_allocacmp_indvar_flatten44_load;
...
wire   [3:0] lshr_ln5_6_fu_217_p4;
wire   [9:0] tmp_s_fu_227_p3;
wire   [31:0] tmp_6_fu_265_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_6_fu_265_p1;
wire   [1:0] tmp_6_fu_265_p3;
wire  signed [1:0] tmp_6_fu_265_p5;
wire  signed [1:0] tmp_6_fu_265_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_68 = 7'd0;
#0 i_fu_72 = 7'd0;
#0 indvar_flatten44_fu_76 = 13'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_9_2_32_1_1_U597(.din0(buff_D_out_q0),.din1(buff_D_out_1_q0),.din2(buff_D_out_2_q0),.din3(buff_D_out_3_q0),.def(tmp_6_fu_265_p9),.sel(trunc_ln53_1_reg_317),.dout(tmp_6_fu_265_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln52_fu_158_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten44_fu_76 <= add_ln52_1_fu_164_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten44_fu_76 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_6_reg_346 <= tmp_6_fu_265_p11;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_indvar_flatten44_load = 13'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten44_load = indvar_flatten44_fu_76;
    end
end
always @ (*) begin
...
assign add_ln52_1_fu_164_p2 = (ap_sig_allocacmp_indvar_flatten44_load + 13'd1);
...
assign bitcast_ln55_fu_288_p1 = tmp_6_reg_346;
...
assign icmp_ln52_fu_158_p2 = ((ap_sig_allocacmp_indvar_flatten44_load == 13'd4096) ? 1'b1 : 1'b0);
...
assign lshr_ln5_6_fu_217_p4 = {{select_ln5_fu_193_p3[5:2]}};
...
assign tmp_6_fu_265_p9 = 'bx;
assign tmp_s_fu_227_p3 = {{trunc_ln53_fu_209_p1}, {lshr_ln5_6_fu_217_p4}};
