...
module backprop_backprop_Pipeline_VITIS_LOOP_11_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_24966,mux_case_14862,mux_case_04758,activations3_load,activations3_1_load,activations3_2_load,sum_reload,mux_case_24964_out,mux_case_24964_out_ap_vld,mux_case_14860_out,mux_case_14860_out_ap_vld,mux_case_04756_out,mux_case_04756_out_ap_vld,grp_fu_4820_p_din0,grp_fu_4820_p_din1,grp_fu_4820_p_dout0,grp_fu_4820_p_ce,grp_fu_4824_p_din0,grp_fu_4824_p_din1,grp_fu_4824_p_dout0,grp_fu_4824_p_ce);  
...
sparsemux_7_2_64_1_1_U868(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_s_fu_187_p7),.sel(ap_sig_allocacmp_i_16),.dout(tmp_s_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_04756_fu_68 <= grp_fu_4820_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_14860_fu_72 <= grp_fu_4820_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            mux_case_24964_fu_76 <= grp_fu_4820_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_63_reg_328 <= grp_fu_4824_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_4820_p_din0 = tmp_63_reg_328;
assign grp_fu_4820_p_din1 = sum_reload;
assign grp_fu_4824_p_ce = 1'b1;
assign grp_fu_4824_p_din0 = 64'd0;
assign grp_fu_4824_p_din1 = bitcast_ln12_1_fu_240_p1;
