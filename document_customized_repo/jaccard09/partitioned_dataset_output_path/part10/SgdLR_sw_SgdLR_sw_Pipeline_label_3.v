...
fmul_32ns_32ns_32_4_max_dsp_1_U25(.clk(ap_clk),.reset(ap_rst),.din0(v22),.din1(grp_fu_178_p1),.ce(1'b1),.dout(grp_fu_178_p2));
...
assign grp_fu_368_p_din1 = grp_fu_174_p1;
assign or_ln1_fu_327_p3 = {{tmp_s_reg_398_pp0_iter2_reg}, {1'd1}};
