...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln83_reg_620 == 1'd1) & (1'b1 == ap_CS_fsm_state11) & (grp_needwun_Pipeline_pad_a_fu_402_ap_done == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (grp_needwun_Pipeline_trace_fu_316_a_str_idx_0_0_out_ap_vld == 1'b1))) begin
        a_str_idx_0_0_loc_fu_178 <= grp_needwun_Pipeline_trace_fu_316_a_str_idx_0_0_out;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (grp_needwun_Pipeline_trace_fu_316_b_str_idx_6_out_ap_vld == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state11 : begin
            if (((1'b1 == ap_CS_fsm_state11) & (grp_needwun_Pipeline_pad_a_fu_402_ap_done == 1'b1))) begin
...
assign icmp_ln83_fu_560_p2 = (($signed(tmp_66_fu_550_p4) < $signed(24'd1)) ? 1'b1 : 1'b0);
...
assign tmp_66_fu_550_p4 = {{b_str_idx_reg_186[31:8]}};
