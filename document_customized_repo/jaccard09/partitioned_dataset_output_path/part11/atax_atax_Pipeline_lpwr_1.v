...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_fu_242_p1;
wire   [2:0] tmp_fu_242_p3;
wire   [2:0] tmp_fu_242_p5;
wire   [2:0] tmp_fu_242_p7;
wire  signed [2:0] tmp_fu_242_p9;
wire  signed [2:0] tmp_fu_242_p11;
wire  signed [2:0] tmp_fu_242_p13;
wire  signed [2:0] tmp_fu_242_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U52(.din0(buff_y_out_q0),.din1(buff_y_out_1_q0),.din2(buff_y_out_2_q0),.din3(buff_y_out_3_q0),.din4(buff_y_out_4_q0),.din5(buff_y_out_5_q0),.din6(buff_y_out_6_q0),.din7(buff_y_out_7_q0),.def(tmp_fu_242_p17),.sel(trunc_ln32_reg_296),.dout(tmp_fu_242_p19));
...
assign bitcast_ln33_fu_281_p1 = tmp_reg_341;
