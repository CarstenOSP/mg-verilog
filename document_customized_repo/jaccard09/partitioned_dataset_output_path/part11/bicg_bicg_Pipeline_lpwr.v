...
module bicg_bicg_Pipeline_lpwr (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,s_out_din,s_out_full_n,s_out_write,q_out_din,q_out_full_n,q_out_write,buff_s_out_address0,buff_s_out_ce0,buff_s_out_q0,buff_q_out_address0,buff_q_out_ce0,buff_q_out_q0,buff_q_out_1_address0,buff_q_out_1_ce0,buff_q_out_1_q0);  
...
wire   [31:0] select_ln37_fu_151_p3;
reg   [31:0] select_ln37_reg_200;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        select_ln37_reg_200 <= select_ln37_fu_151_p3;
    end
end
always @ (*) begin
...
assign bitcast_ln36_fu_159_p1 = buff_s_out_q0;
assign bitcast_ln37_fu_164_p1 = select_ln37_reg_200;
assign buff_q_out_1_address0 = zext_ln5_fu_133_p1;
assign buff_q_out_1_ce0 = buff_q_out_1_ce0_local;
assign buff_q_out_address0 = zext_ln5_fu_133_p1;
assign buff_q_out_ce0 = buff_q_out_ce0_local;
assign buff_s_out_address0 = zext_ln35_fu_144_p1;
assign buff_s_out_ce0 = buff_s_out_ce0_local;
assign icmp_ln35_fu_111_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_123_p4 = {{ap_sig_allocacmp_i_1[5:1]}};
assign q_out_din = bitcast_ln37_fu_164_p1;
assign q_out_write = q_out_write_local;
assign s_out_din = bitcast_ln36_fu_159_p1;
assign s_out_write = s_out_write_local;
assign select_ln37_fu_151_p3 = ((trunc_ln35_fu_148_p1[0:0] == 1'b1) ? buff_q_out_1_q0 : buff_q_out_q0);
assign trunc_ln35_fu_148_p1 = i_1_reg_175[0:0];
assign zext_ln35_fu_144_p1 = i_1_reg_175;
assign zext_ln5_fu_133_p1 = lshr_ln5_2_fu_123_p4;
endmodule 
