...
wire   [31:0] tmp_2_fu_485_p19;
reg   [31:0] tmp_2_reg_651;
...
wire   [31:0] tmp_3_fu_524_p19;
reg   [31:0] tmp_3_reg_709;
...
wire   [31:0] tmp_2_fu_485_p17;
wire   [31:0] tmp_3_fu_524_p17;
reg    ap_done_reg;
...
wire   [2:0] tmp_2_fu_485_p1;
wire   [2:0] tmp_2_fu_485_p3;
wire   [2:0] tmp_2_fu_485_p5;
wire   [2:0] tmp_2_fu_485_p7;
wire  signed [2:0] tmp_2_fu_485_p9;
wire  signed [2:0] tmp_2_fu_485_p11;
wire  signed [2:0] tmp_2_fu_485_p13;
wire  signed [2:0] tmp_2_fu_485_p15;
wire   [2:0] tmp_3_fu_524_p1;
wire   [2:0] tmp_3_fu_524_p3;
wire   [2:0] tmp_3_fu_524_p5;
wire   [2:0] tmp_3_fu_524_p7;
wire  signed [2:0] tmp_3_fu_524_p9;
wire  signed [2:0] tmp_3_fu_524_p11;
wire  signed [2:0] tmp_3_fu_524_p13;
wire  signed [2:0] tmp_3_fu_524_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U401(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.din4(buff_B_4_q0),.din5(buff_B_5_q0),.din6(buff_B_6_q0),.din7(buff_B_7_q0),.def(tmp_2_fu_485_p17),.sel(trunc_ln30_1_reg_593),.dout(tmp_2_fu_485_p19));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U402(.din0(buff_C_out_q1),.din1(buff_C_out_1_q1),.din2(buff_C_out_2_q1),.din3(buff_C_out_3_q1),.din4(buff_C_out_4_q1),.din5(buff_C_out_5_q1),.din6(buff_C_out_6_q1),.din7(buff_C_out_7_q1),.def(tmp_3_fu_524_p17),.sel(trunc_ln30_1_reg_593_pp0_iter5_reg),.dout(tmp_3_fu_524_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_2_reg_651 <= tmp_2_fu_485_p19;
        tmp_3_reg_709 <= tmp_3_fu_524_p19;
...
assign tmp_2_fu_485_p17 = 'bx;
assign tmp_3_fu_524_p17 = 'bx;
