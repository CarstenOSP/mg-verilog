...
module ss_sort_ss_sort_Pipeline_update_1_update_21 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,b_address0,b_ce0,b_q0,zext_ln63,bucket_address0,bucket_ce0,bucket_we0,bucket_d0,bucket_address1,bucket_ce1,bucket_q1,a_address0,a_ce0,a_we0,a_d0);  
...
wire   [9:0] add_ln68_1_fu_185_p2;
reg   [9:0] add_ln68_1_reg_377;
wire   [9:0] select_ln68_fu_202_p3;
reg   [9:0] select_ln68_reg_382;
wire    ap_block_pp0_stage1_11001;
reg   [9:0] select_ln68_reg_382_pp0_iter1_reg;
reg   [31:0] b_load_reg_392;
reg   [31:0] b_load_reg_392_pp0_iter2_reg;
...
wire   [63:0] zext_ln72_1_fu_309_p1;
...
reg   [11:0] indvar_flatten6_fu_76;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln68_fu_161_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten6_fu_76 <= add_ln68_fu_167_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten6_fu_76 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_ln68_1_reg_377 <= add_ln68_1_fu_185_p2;
        addr_cmp_reg_409 <= addr_cmp_fu_282_p2;
        b_load_reg_392 <= b_q0;
        b_load_reg_392_pp0_iter2_reg <= b_load_reg_392;
...
assign a_address0 = zext_ln72_1_fu_309_p1;
assign a_ce0 = a_ce0_local;
assign a_d0 = b_load_reg_392_pp0_iter2_reg;
assign a_we0 = a_we0_local;
assign add_ln68_1_fu_185_p2 = (ap_sig_allocacmp_blockID_load + 10'd1);
assign add_ln68_fu_167_p2 = (ap_sig_allocacmp_indvar_flatten6_load + 12'd1);
assign add_ln69_fu_234_p2 = (select_ln65_fu_196_p3 + 3'd1);
assign add_ln70_1_fu_268_p2 = (zext_ln68_fu_258_p1 + shl_ln70_1_fu_261_p3);
assign add_ln70_fu_223_p2 = (zext_ln69_fu_219_p1 + tmp_1_fu_211_p3);
...
assign ashr_ln70_fu_250_p2 = $signed(b_load_reg_392) >>> zext_ln63_cast_reg_352;
assign b_address0 = zext_ln70_fu_229_p1;
...
assign icmp_ln68_fu_161_p2 = ((ap_sig_allocacmp_indvar_flatten6_load == 12'd2048) ? 1'b1 : 1'b0);
...
assign select_ln68_fu_202_p3 = ((icmp_ln69_reg_371[0:0] == 1'b1) ? add_ln68_1_reg_377 : blockID_load_reg_366);
assign shl_ln70_1_fu_261_p3 = {{trunc_ln70_reg_398}, {9'd0}};
assign tmp_1_fu_211_p3 = {{empty_fu_207_p1}, {2'd0}};
...
assign zext_ln72_1_fu_309_p1 = reuse_select_reg_414;
