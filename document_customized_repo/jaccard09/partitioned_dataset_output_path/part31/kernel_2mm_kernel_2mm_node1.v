...
wire   [0:0] empty_48_fu_775_p2;
reg   [0:0] empty_48_reg_1275;
...
wire   [63:0] p_cast1028_fu_524_p1;
wire   [63:0] p_cast_fu_569_p1;
wire   [63:0] p_cast1029_fu_574_p1;
wire   [63:0] p_cast1030_fu_599_p1;
wire   [63:0] p_cast1031_fu_604_p1;
wire   [63:0] p_cast1032_fu_609_p1;
wire   [63:0] p_cast1033_fu_614_p1;
wire   [63:0] p_cast1034_fu_619_p1;
wire   [63:0] p_cast1035_fu_624_p1;
...
wire   [7:0] empty_22_fu_464_p2;
wire   [7:0] empty_25_fu_484_p2;
wire   [7:0] empty_28_fu_504_p2;
wire   [14:0] grp_fu_781_p3;
wire   [7:0] empty_35_fu_529_p2;
wire   [7:0] empty_38_fu_549_p2;
wire   [14:0] grp_fu_789_p3;
wire   [14:0] grp_fu_797_p3;
wire   [7:0] empty_41_fu_579_p2;
...
ama_addmuladd_8ns_3ns_7ns_7ns_15_4_1_U64(.clk(ap_clk),.reset(ap_rst),.din0(v115_reg_284),.din1(grp_fu_813_p1),.din2(grp_fu_813_p2),.din3(grp_fu_813_p3),.ce(1'b1),.dout(grp_fu_813_p4));
kernel_2mm_mac_muladd_8ns_7ns_7ns_15_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 8 ),.din1_WIDTH( 7 ),.din2_WIDTH( 7 ),.dout_WIDTH( 15 ))
mac_muladd_8ns_7ns_7ns_15_4_1_U65(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_823_p0),.din1(grp_fu_823_p1),.din2(grp_fu_823_p2),.ce(1'b1),.dout(grp_fu_823_p3));
kernel_2mm_mac_muladd_8ns_7ns_7ns_15_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 8 ),.din1_WIDTH( 7 ),.din2_WIDTH( 7 ),.dout_WIDTH( 15 ))
mac_muladd_8ns_7ns_7ns_15_4_1_U66(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_831_p0),.din1(grp_fu_831_p1),.din2(grp_fu_831_p2),.ce(1'b1),.dout(grp_fu_831_p3));
kernel_2mm_mac_muladd_8ns_7ns_7ns_15_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 8 ),.din1_WIDTH( 7 ),.din2_WIDTH( 7 ),.dout_WIDTH( 15 ))
mac_muladd_8ns_7ns_7ns_15_4_1_U67(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_839_p0),.din1(grp_fu_839_p1),.din2(grp_fu_839_p2),.ce(1'b1),.dout(grp_fu_839_p3));
...
ama_addmuladd_8ns_4ns_7ns_7ns_15_4_1_U68(.clk(ap_clk),.reset(ap_rst),.din0(v115_reg_284),.din1(grp_fu_847_p1),.din2(grp_fu_847_p2),.din3(grp_fu_847_p3),.ce(1'b1),.dout(grp_fu_847_p4));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        empty_48_reg_1275 <= empty_48_fu_775_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        ...
        v22_reg_1230 <= grp_fu_348_p2;
        v23_reg_1240 <= grp_fu_352_p2;
        v24_reg_1250 <= grp_fu_356_p2;
        v25_reg_1260 <= grp_fu_360_p2;
        v26_reg_1270 <= grp_fu_364_p2;
        v_reg_1190 <= grp_fu_172_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        tmp_1_reg_954 <= {{empty_25_fu_484_p2[7:2]}};
        tmp_reg_944 <= {{empty_22_fu_464_p2[7:2]}};
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        tmp_2_reg_964 <= {{empty_28_fu_504_p2[7:2]}};
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        tmp_3_reg_984 <= {{empty_35_fu_529_p2[7:2]}};
        tmp_4_reg_994 <= {{empty_38_fu_549_p2[7:2]}};
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        tmp_5_reg_1029 <= {{empty_41_fu_579_p2[7:2]}};
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        v226_0_address0_local = p_cast1034_fu_619_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        v226_0_address0_local = p_cast1032_fu_609_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        v226_0_address0_local = p_cast1030_fu_599_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        v226_0_address0_local = p_cast1029_fu_574_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        v226_0_address0_local = p_cast1028_fu_524_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        v226_0_address1_local = p_cast1035_fu_624_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        v226_0_address1_local = p_cast1033_fu_614_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        v226_0_address1_local = p_cast1031_fu_604_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        v226_1_address0_local = p_cast1034_fu_619_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        v226_1_address0_local = p_cast1032_fu_609_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        v226_1_address0_local = p_cast1030_fu_599_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        v226_1_address0_local = p_cast1029_fu_574_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        v226_1_address0_local = p_cast1028_fu_524_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        v226_1_address1_local = p_cast1035_fu_624_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        v226_1_address1_local = p_cast1033_fu_614_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        v226_1_address1_local = p_cast1031_fu_604_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
...
assign empty_22_fu_464_p2 = (v115_reg_284 + 8'd1);
assign empty_25_fu_484_p2 = (v115_reg_284 + 8'd2);
assign empty_28_fu_504_p2 = (v115_reg_284 + 8'd3);
assign empty_34_fu_716_p2 = (lshr_ln1_fu_669_p4 + 6'd1);
assign empty_35_fu_529_p2 = (v115_reg_284 + 8'd5);
assign empty_38_fu_549_p2 = (v115_reg_284 + 8'd6);
assign empty_41_fu_579_p2 = (v115_reg_284 + 8'd7);
assign empty_47_fu_759_p2 = (lshr_ln1_fu_669_p4 + 6'd2);
assign empty_48_fu_775_p2 = ((trunc_ln169_reg_1179 == 2'd3) ? 1'b1 : 1'b0);
assign grp_fu_164_p_ce = grp_fu_1280_ce;
assign grp_fu_164_p_din0 = grp_kernel_2mm_node1_Pipeline_label_5_fu_296_grp_fu_1280_p_din0;
assign grp_fu_164_p_din1 = grp_kernel_2mm_node1_Pipeline_label_5_fu_296_grp_fu_1280_p_din1;
assign grp_fu_164_p_opcode = 2'd0;
assign grp_fu_168_p_ce = grp_fu_1284_ce;
assign grp_fu_168_p_din0 = grp_kernel_2mm_node1_Pipeline_label_5_fu_296_grp_fu_1284_p_din0;
assign grp_fu_168_p_din1 = grp_kernel_2mm_node1_Pipeline_label_5_fu_296_grp_fu_1284_p_din1;
...
assign grp_fu_348_p0 = v165_v_reg_1069;
assign grp_fu_352_p0 = v176_v_reg_1094;
assign grp_fu_356_p0 = v187_v_reg_1099;
assign grp_fu_360_p0 = v198_v_reg_1124;
assign grp_fu_364_p0 = v209_v_reg_1129;
...
assign mul_ln225_fu_726_p00 = empty_34_fu_716_p2;
...
assign mul_ln277_fu_769_p00 = empty_47_fu_759_p2;
assign mul_ln277_fu_769_p1 = 14'd190;
assign p_cast1028_fu_524_p1 = grp_fu_781_p3;
assign p_cast1029_fu_574_p1 = grp_fu_797_p3;
assign p_cast1030_fu_599_p1 = grp_fu_805_p3;
assign p_cast1031_fu_604_p1 = grp_fu_813_p4;
assign p_cast1032_fu_609_p1 = grp_fu_823_p3;
assign p_cast1033_fu_614_p1 = grp_fu_831_p3;
assign p_cast1034_fu_619_p1 = grp_fu_839_p3;
assign p_cast1035_fu_624_p1 = grp_fu_847_p4;
