...
sparsemux_9_2_8_1_1_x_U62(.din0(buf_0_q1),.din1(buf_1_q1),.din2(buf_2_q1),.din3(buf_3_q1),.def(tmp_3_fu_212_p9),.sel(trunc_ln66_reg_260_pp0_iter1_reg),.dout(tmp_3_fu_212_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln6_reg_265 <= {{add_ln66_fu_160_p2[3:2]}};
...
assign add_ln66_fu_160_p2 = ($signed(ap_sig_allocacmp_i_5) + $signed(5'd31));
...
assign icmp_ln66_fu_150_p2 = ((ap_sig_allocacmp_i_5 == 5'd0) ? 1'b1 : 1'b0);
...
assign trunc_ln66_fu_156_p1 = ap_sig_allocacmp_i_5[1:0];
assign xor_ln66_fu_235_p2 = (trunc_ln66_2_reg_275 ^ tmp_3_fu_212_p11);
assign zext_ln66_1_fu_185_p1 = lshr_ln6_reg_265;
