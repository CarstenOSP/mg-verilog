...
module aes256_encrypt_ecb_aes_subBytes_Pipeline_glog (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,select_ln63,i_3_out,i_3_out_ap_vld,ap_return);  
...
assign icmp_ln26_fu_90_p2 = ((ap_sig_allocacmp_atb_8 == select_ln63) ? 1'b1 : 1'b0);
