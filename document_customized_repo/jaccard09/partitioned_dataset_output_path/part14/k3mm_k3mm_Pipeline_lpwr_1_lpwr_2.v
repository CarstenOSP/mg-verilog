...
reg   [12:0] indvar_flatten554_fu_76;
...
wire   [3:0] lshr_ln10_7_fu_216_p4;
...
#0 j_fu_68 = 7'd0;
#0 i_fu_72 = 7'd0;
#0 indvar_flatten554_fu_76 = 13'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_9_2_32_1_1_U1498(.din0(buff_E_out_q0),.din1(buff_E_out_1_q0),.din2(buff_E_out_2_q0),.din3(buff_E_out_3_q0),.def(tmp_1_fu_258_p9),.sel(trunc_ln57_1_reg_310),.dout(tmp_1_fu_258_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln56_fu_157_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten554_fu_76 <= add_ln56_1_fu_163_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten554_fu_76 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        tmp_1_reg_335 <= tmp_1_fu_258_p11;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_indvar_flatten554_load = indvar_flatten554_fu_76;
    end
end
always @ (*) begin
...
assign add_ln56_1_fu_163_p2 = (ap_sig_allocacmp_indvar_flatten554_load + 13'd1);
...
assign bitcast_ln58_fu_281_p1 = tmp_1_reg_335;
...
assign icmp_ln56_fu_157_p2 = ((ap_sig_allocacmp_indvar_flatten554_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln57_fu_186_p2 = ((j_fu_68 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln10_7_fu_216_p4 = {{select_ln10_fu_192_p3[5:2]}};
...
assign tmp_s_fu_226_p3 = {{trunc_ln57_fu_208_p1}, {lshr_ln10_7_fu_216_p4}};
