...
output  [1:0] grp_fu_13830_p_opcode;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v120_fu_78 <= grp_fu_13830_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v117_1_reg_596 <= grp_fu_13848_p_dout0;
        v2_load_1_reg_601 <= v2_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        v119_1_reg_616 <= grp_fu_13848_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage15_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
        v121_2_reg_621 <= grp_fu_13830_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
assign bitcast_ln196_2_fu_372_p1 = grp_fu_13830_p_dout0;
assign bitcast_ln196_fu_334_p1 = grp_fu_13830_p_dout0;
assign grp_fu_13830_p_ce = 1'b1;
assign grp_fu_13830_p_din0 = grp_fu_191_p0;
assign grp_fu_13830_p_din1 = grp_fu_191_p1;
assign grp_fu_13830_p_opcode = grp_fu_191_opcode;
assign grp_fu_13848_p_ce = 1'b1;
assign grp_fu_13848_p_din0 = grp_fu_196_p0;
assign grp_fu_13848_p_din1 = grp_fu_196_p1;
assign icmp_ln192_fu_265_p2 = ((or_ln3_fu_257_p3 == 2'd3) ? 1'b1 : 1'b0);
assign icmp_ln193_fu_286_p2 = ((v111_1_reg_484 == 2'd2) ? 1'b1 : 1'b0);
assign or_ln3_fu_257_p3 = {{tmp_fu_249_p3}, {1'd1}};
...
assign v122_out = grp_fu_13830_p_dout0;
