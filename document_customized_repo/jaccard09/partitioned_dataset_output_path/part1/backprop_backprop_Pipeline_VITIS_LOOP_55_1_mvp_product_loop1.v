...
wire   [63:0] tmp_s_fu_826_p19;
reg   [63:0] tmp_s_reg_1397;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
wire   [63:0] tmp_89_fu_865_p19;
reg   [63:0] tmp_89_reg_1402;
wire   [63:0] tmp_90_fu_936_p19;
reg   [63:0] tmp_90_reg_1407;
wire   [63:0] tmp_91_fu_975_p19;
reg   [63:0] tmp_91_reg_1412;
...
wire   [63:0] tmp_s_fu_826_p2;
wire   [63:0] tmp_s_fu_826_p4;
wire   [63:0] tmp_s_fu_826_p6;
wire   [63:0] tmp_s_fu_826_p8;
wire   [63:0] tmp_s_fu_826_p10;
wire   [63:0] tmp_s_fu_826_p12;
wire   [63:0] tmp_s_fu_826_p14;
wire   [63:0] tmp_s_fu_826_p16;
wire   [63:0] tmp_s_fu_826_p17;
wire   [63:0] tmp_89_fu_865_p17;
wire   [63:0] tmp_90_fu_936_p2;
wire   [63:0] tmp_90_fu_936_p4;
wire   [63:0] tmp_90_fu_936_p6;
wire   [63:0] tmp_90_fu_936_p8;
wire   [63:0] tmp_90_fu_936_p10;
wire   [63:0] tmp_90_fu_936_p12;
wire   [63:0] tmp_90_fu_936_p14;
wire   [63:0] tmp_90_fu_936_p16;
wire   [63:0] tmp_90_fu_936_p17;
wire   [63:0] tmp_91_fu_975_p17;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [3:0] tmp_s_fu_826_p1;
wire   [3:0] tmp_s_fu_826_p3;
wire   [3:0] tmp_s_fu_826_p5;
wire   [3:0] tmp_s_fu_826_p7;
wire  signed [3:0] tmp_s_fu_826_p9;
wire  signed [3:0] tmp_s_fu_826_p11;
wire  signed [3:0] tmp_s_fu_826_p13;
wire  signed [3:0] tmp_s_fu_826_p15;
wire   [3:0] tmp_89_fu_865_p1;
wire   [3:0] tmp_89_fu_865_p3;
wire   [3:0] tmp_89_fu_865_p5;
wire   [3:0] tmp_89_fu_865_p7;
wire  signed [3:0] tmp_89_fu_865_p9;
wire  signed [3:0] tmp_89_fu_865_p11;
wire  signed [3:0] tmp_89_fu_865_p13;
wire  signed [3:0] tmp_89_fu_865_p15;
wire   [3:0] tmp_90_fu_936_p1;
wire   [3:0] tmp_90_fu_936_p3;
wire   [3:0] tmp_90_fu_936_p5;
wire   [3:0] tmp_90_fu_936_p7;
wire  signed [3:0] tmp_90_fu_936_p9;
wire  signed [3:0] tmp_90_fu_936_p11;
wire  signed [3:0] tmp_90_fu_936_p13;
wire  signed [3:0] tmp_90_fu_936_p15;
wire   [3:0] tmp_91_fu_975_p1;
wire   [3:0] tmp_91_fu_975_p3;
wire   [3:0] tmp_91_fu_975_p5;
wire   [3:0] tmp_91_fu_975_p7;
wire  signed [3:0] tmp_91_fu_975_p9;
wire  signed [3:0] tmp_91_fu_975_p11;
wire  signed [3:0] tmp_91_fu_975_p13;
wire  signed [3:0] tmp_91_fu_975_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 16'd1;
...
sparsemux_17_4_64_1_1_x_U436(.din0(tmp_s_fu_826_p2),.din1(tmp_s_fu_826_p4),.din2(tmp_s_fu_826_p6),.din3(tmp_s_fu_826_p8),.din4(tmp_s_fu_826_p10),.din5(tmp_s_fu_826_p12),.din6(tmp_s_fu_826_p14),.din7(tmp_s_fu_826_p16),.def(tmp_s_fu_826_p17),.sel(trunc_ln57_reg_1229),.dout(tmp_s_fu_826_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_4_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h2 ),.din1_WIDTH( 64 ),.CASE2( 4'h4 ),.din2_WIDTH( 64 ),.CASE3( 4'h6 ),.din3_WIDTH( 64 ),.CASE4( 4'h8 ),.din4_WIDTH( 64 ),.CASE5( 4'hA ),.din5_WIDTH( 64 ),.CASE6( 4'hC ),.din6_WIDTH( 64 ),.CASE7( 4'hE ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_17_4_64_1_1_x_U437(.din0(activations2_q0),.din1(activations2_2_q0),.din2(activations2_4_q0),.din3(activations2_6_q0),.din4(activations2_8_q0),.din5(activations2_10_q0),.din6(activations2_12_q0),.din7(activations2_14_q0),.def(tmp_89_fu_865_p17),.sel(trunc_ln57_reg_1229),.dout(tmp_89_fu_865_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_4_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h2 ),.din1_WIDTH( 64 ),.CASE2( 4'h4 ),.din2_WIDTH( 64 ),.CASE3( 4'h6 ),.din3_WIDTH( 64 ),.CASE4( 4'h8 ),.din4_WIDTH( 64 ),.CASE5( 4'hA ),.din5_WIDTH( 64 ),.CASE6( 4'hC ),.din6_WIDTH( 64 ),.CASE7( 4'hE ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_17_4_64_1_1_x_U438(.din0(tmp_90_fu_936_p2),.din1(tmp_90_fu_936_p4),.din2(tmp_90_fu_936_p6),.din3(tmp_90_fu_936_p8),.din4(tmp_90_fu_936_p10),.din5(tmp_90_fu_936_p12),.din6(tmp_90_fu_936_p14),.din7(tmp_90_fu_936_p16),.def(tmp_90_fu_936_p17),.sel(trunc_ln57_reg_1229),.dout(tmp_90_fu_936_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_4_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h2 ),.din1_WIDTH( 64 ),.CASE2( 4'h4 ),.din2_WIDTH( 64 ),.CASE3( 4'h6 ),.din3_WIDTH( 64 ),.CASE4( 4'h8 ),.din4_WIDTH( 64 ),.CASE5( 4'hA ),.din5_WIDTH( 64 ),.CASE6( 4'hC ),.din6_WIDTH( 64 ),.CASE7( 4'hE ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_17_4_64_1_1_x_U439(.din0(activations2_1_q0),.din1(activations2_3_q0),.din2(activations2_5_q0),.din3(activations2_7_q0),.din4(activations2_9_q0),.din5(activations2_11_q0),.din6(activations2_13_q0),.din7(activations2_15_q0),.def(tmp_91_fu_975_p17),.sel(trunc_ln57_reg_1229),.dout(tmp_91_fu_975_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_89_reg_1402 <= tmp_89_fu_865_p19;
        tmp_90_reg_1407 <= tmp_90_fu_936_p19;
        tmp_91_reg_1412 <= tmp_91_fu_975_p19;
        tmp_s_reg_1397 <= tmp_s_fu_826_p19;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage15_11001) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
        tmp_8_reg_1432 <= add_ln57_fu_1067_p2[32'd6];
    end
end
always @ (*) begin
...
always @ (*) begin
    ...
    end else if ((((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage15)))) begin
        activations3_10_out_o = select_ln55_fu_1046_p3;
    end else if ((~(select_ln55_3_reg_1225_pp0_iter1_reg == 2'd1) & ~(select_ln55_3_reg_1225_pp0_iter1_reg == 2'd0) & (1'b0 == ap_block_pp0_stage8) & (tmp_8_reg_1432 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
...
always @ (*) begin
    if ((((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15_11001) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15_11001) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage15)) | (~(select_ln55_3_reg_1225_pp0_iter1_reg == 2'd1) & ~(select_ln55_3_reg_1225_pp0_iter1_reg == 2'd0) & (1'b0 == ap_block_pp0_stage8_11001) & (tmp_8_reg_1432 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ...
    end else if (((~(select_ln55_3_reg_1225 == 2'd0) & ~(select_ln55_3_reg_1225 == 2'd1) & (icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage15)))) begin
        activations3_8_out_o = select_ln55_2_fu_1060_p3;
    end else if (((1'b0 == ap_block_pp0_stage8) & (tmp_8_reg_1432 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (select_ln55_3_reg_1225_pp0_iter1_reg == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
...
always @ (*) begin
    if (((~(select_ln55_3_reg_1225 == 2'd0) & ~(select_ln55_3_reg_1225 == 2'd1) & (icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15_11001) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15_11001) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((1'b0 == ap_block_pp0_stage8_11001) & (tmp_8_reg_1432 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (select_ln55_3_reg_1225_pp0_iter1_reg == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage8)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ...
    end else if (((~(select_ln55_3_reg_1225 == 2'd0) & ~(select_ln55_3_reg_1225 == 2'd1) & (icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage15)))) begin
        activations3_9_out_o = select_ln55_1_fu_1053_p3;
    end else if (((1'b0 == ap_block_pp0_stage8) & (tmp_8_reg_1432 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (select_ln55_3_reg_1225_pp0_iter1_reg == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
...
always @ (*) begin
    if (((~(select_ln55_3_reg_1225 == 2'd0) & ~(select_ln55_3_reg_1225 == 2'd1) & (icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15_11001) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((icmp_ln55_reg_1208 == 1'd0) & (1'b0 == ap_block_pp0_stage15_11001) & (tmp_8_fu_1072_p3 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (select_ln55_3_reg_1225 == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage15)) | ((1'b0 == ap_block_pp0_stage8_11001) & (tmp_8_reg_1432 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (select_ln55_3_reg_1225_pp0_iter1_reg == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage8)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_614_p0 = tmp_90_reg_1407;
        end else if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
            grp_fu_614_p0 = tmp_s_reg_1397;
        end else begin
            grp_fu_614_p0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_614_p1 = tmp_91_reg_1412;
        end else if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
            grp_fu_614_p1 = tmp_89_reg_1402;
        end else begin
            grp_fu_614_p1 = 'bx;
        end
    end else begin
...
assign tmp_89_fu_865_p17 = 'bx;
assign tmp_8_fu_1072_p3 = add_ln57_fu_1067_p2[32'd6];
assign tmp_90_fu_936_p10 = weights3_9_q0;
assign tmp_90_fu_936_p12 = weights3_11_q0;
assign tmp_90_fu_936_p14 = weights3_13_q0;
assign tmp_90_fu_936_p16 = weights3_15_q0;
assign tmp_90_fu_936_p17 = 'bx;
assign tmp_90_fu_936_p2 = weights3_1_q0;
assign tmp_90_fu_936_p4 = weights3_3_q0;
assign tmp_90_fu_936_p6 = weights3_5_q0;
assign tmp_90_fu_936_p8 = weights3_7_q0;
assign tmp_91_fu_975_p17 = 'bx;
assign tmp_fu_692_p3 = ap_sig_allocacmp_i_load[32'd6];
assign tmp_s_fu_826_p10 = weights3_8_q0;
assign tmp_s_fu_826_p12 = weights3_10_q0;
assign tmp_s_fu_826_p14 = weights3_12_q0;
assign tmp_s_fu_826_p16 = weights3_14_q0;
assign tmp_s_fu_826_p17 = 'bx;
assign tmp_s_fu_826_p2 = weights3_0_q0;
assign tmp_s_fu_826_p4 = weights3_2_q0;
assign tmp_s_fu_826_p6 = weights3_4_q0;
assign tmp_s_fu_826_p8 = weights3_6_q0;
