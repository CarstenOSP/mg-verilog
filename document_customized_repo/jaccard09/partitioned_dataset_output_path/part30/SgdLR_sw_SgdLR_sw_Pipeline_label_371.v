...
reg    v3_7_we0_local;
reg    v3_7_ce0_local;
wire   [22:0] add_ln51_s_fu_249_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln48_s_reg_303 <= {{ap_sig_allocacmp_v19_8[9:7]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_v19_8 = v19_fu_78;
    end
end
always @ (*) begin
...
assign add_ln47_fu_229_p2 = (ap_sig_allocacmp_v19_8 + 11'd1);
assign add_ln51_s_fu_249_p3 = {{lshr_ln28_3}, {ap_sig_allocacmp_v19_8}};
...
assign grp_fu_5105_p_din0 = v22_20;
assign grp_fu_5105_p_din1 = v23_fu_267_p1;
assign icmp_ln47_fu_223_p2 = ((ap_sig_allocacmp_v19_8 == 11'd1024) ? 1'b1 : 1'b0);
assign trunc_ln47_fu_235_p1 = ap_sig_allocacmp_v19_8[6:0];
...
assign zext_ln51_fu_257_p1 = add_ln51_s_fu_249_p3;
endmodule 
