...
wire   [1:0] trunc_ln28_1_fu_440_p1;
reg   [1:0] trunc_ln28_1_reg_707;
reg   [1:0] trunc_ln28_1_reg_707_pp0_iter1_reg;
reg   [1:0] trunc_ln28_1_reg_707_pp0_iter2_reg;
reg   [3:0] lshr_ln5_1_reg_712;
wire   [0:0] icmp_ln30_1_fu_502_p2;
reg   [0:0] icmp_ln30_1_reg_757;
reg   [0:0] icmp_ln30_1_reg_757_pp0_iter1_reg;
reg   [0:0] icmp_ln30_1_reg_757_pp0_iter2_reg;
wire   [31:0] tmp_2_fu_526_p11;
reg   [31:0] tmp_2_reg_761;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3_11001;
wire   [31:0] tmp_3_fu_550_p11;
reg   [31:0] tmp_3_reg_766;
reg   [31:0] mul_reg_771;
wire    ap_block_pp0_stage7_11001;
reg   [9:0] tmp1_addr_reg_776;
reg   [9:0] tmp1_addr_reg_776_pp0_iter2_reg;
reg   [9:0] tmp1_1_addr_reg_781;
reg   [9:0] tmp1_1_addr_reg_781_pp0_iter2_reg;
reg   [9:0] tmp1_2_addr_reg_786;
reg   [9:0] tmp1_2_addr_reg_786_pp0_iter2_reg;
reg   [9:0] tmp1_3_addr_reg_791;
reg   [9:0] tmp1_3_addr_reg_791_pp0_iter2_reg;
reg   [31:0] mul3_reg_796;
wire    ap_CS_fsm_pp0_stage4;
wire    ap_block_pp0_stage4_11001;
reg   [31:0] add_reg_806;
reg    ap_enable_reg_pp0_iter0_reg;
wire    ap_block_pp0_stage3_subdone;
wire   [63:0] zext_ln31_fu_472_p1;
wire    ap_block_pp0_stage2;
wire   [63:0] zext_ln31_1_fu_488_p1;
wire   [63:0] tmp_8_cast_fu_580_p1;
reg   [6:0] k_fu_88;
wire   [6:0] add_ln30_fu_496_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage1;
reg   [6:0] j_fu_92;
wire   [6:0] select_ln28_fu_423_p3;
...
wire   [9:0] tmp_10_fu_464_p3;
wire   [5:0] empty_11_fu_430_p1;
wire   [9:0] tmp_11_fu_480_p3;
wire   [31:0] tmp_2_fu_526_p9;
wire   [1:0] trunc_ln30_fu_523_p1;
wire   [31:0] tmp_3_fu_550_p9;
wire   [9:0] tmp_8_fu_574_p3;
...
wire   [1:0] tmp_2_fu_526_p1;
wire   [1:0] tmp_2_fu_526_p3;
wire  signed [1:0] tmp_2_fu_526_p5;
wire  signed [1:0] tmp_2_fu_526_p7;
wire   [1:0] tmp_3_fu_550_p1;
wire   [1:0] tmp_3_fu_550_p3;
wire  signed [1:0] tmp_3_fu_550_p5;
wire  signed [1:0] tmp_3_fu_550_p7;
...
sparsemux_9_2_32_1_1_U43(.din0(buff_A0_q0),.din1(buff_A0_1_q0),.din2(buff_A0_2_q0),.din3(buff_A0_3_q0),.def(tmp_2_fu_526_p9),.sel(trunc_ln30_fu_523_p1),.dout(tmp_2_fu_526_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U44(.din0(buff_B0_q0),.din1(buff_B0_1_q0),.din2(buff_B0_2_q0),.din3(buff_B0_3_q0),.def(tmp_3_fu_550_p9),.sel(trunc_ln30_fu_523_p1),.dout(tmp_3_fu_550_p11));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U45(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_fu_588_p9),.sel(trunc_ln28_1_reg_707_pp0_iter1_reg),.dout(tmp_fu_588_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_fu_100 <= select_ln27_fu_395_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        k_fu_88 <= add_ln30_fu_496_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        add_reg_806 <= grp_fu_364_p_dout0;
        first_iter_1_reg_703 <= first_iter_1_fu_434_p2;
        first_iter_1_reg_703_pp0_iter1_reg <= first_iter_1_reg_703;
        icmp_ln30_1_reg_757 <= icmp_ln30_1_fu_502_p2;
        icmp_ln30_1_reg_757_pp0_iter1_reg <= icmp_ln30_1_reg_757;
        icmp_ln30_1_reg_757_pp0_iter2_reg <= icmp_ln30_1_reg_757_pp0_iter1_reg;
        k_mid2_reg_698 <= k_mid2_fu_416_p3;
        lshr_ln5_1_reg_712 <= {{select_ln28_fu_423_p3[5:2]}};
        tmp1_1_addr_reg_781 <= tmp_8_cast_fu_580_p1;
        tmp1_1_addr_reg_781_pp0_iter2_reg <= tmp1_1_addr_reg_781;
        tmp1_2_addr_reg_786 <= tmp_8_cast_fu_580_p1;
        tmp1_2_addr_reg_786_pp0_iter2_reg <= tmp1_2_addr_reg_786;
        tmp1_3_addr_reg_791 <= tmp_8_cast_fu_580_p1;
        tmp1_3_addr_reg_791_pp0_iter2_reg <= tmp1_3_addr_reg_791;
        tmp1_addr_reg_776 <= tmp_8_cast_fu_580_p1;
        tmp1_addr_reg_776_pp0_iter2_reg <= tmp1_addr_reg_776;
        trunc_ln28_1_reg_707 <= trunc_ln28_1_fu_440_p1;
        trunc_ln28_1_reg_707_pp0_iter1_reg <= trunc_ln28_1_reg_707;
        trunc_ln28_1_reg_707_pp0_iter2_reg <= trunc_ln28_1_reg_707_pp0_iter1_reg;
        trunc_ln28_reg_693 <= trunc_ln28_fu_402_p1;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        mul3_reg_796 <= grp_fu_368_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul_reg_771 <= grp_fu_368_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp_2_reg_761 <= tmp_2_fu_526_p11;
        tmp_3_reg_766 <= tmp_3_fu_550_p11;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp1_1_address0_local = tmp1_1_addr_reg_781_pp0_iter2_reg;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp1_1_address0_local = tmp_8_cast_fu_580_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln30_1_reg_757_pp0_iter2_reg == 1'd1) & (trunc_ln28_1_reg_707_pp0_iter2_reg == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp1_2_address0_local = tmp1_2_addr_reg_786_pp0_iter2_reg;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp1_2_address0_local = tmp_8_cast_fu_580_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln30_1_reg_757_pp0_iter2_reg == 1'd1) & (trunc_ln28_1_reg_707_pp0_iter2_reg == 2'd2) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp1_3_address0_local = tmp1_3_addr_reg_791_pp0_iter2_reg;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp1_3_address0_local = tmp_8_cast_fu_580_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln30_1_reg_757_pp0_iter2_reg == 1'd1) & (trunc_ln28_1_reg_707_pp0_iter2_reg == 2'd3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp1_address0_local = tmp1_addr_reg_776_pp0_iter2_reg;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp1_address0_local = tmp_8_cast_fu_580_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln30_1_reg_757_pp0_iter2_reg == 1'd1) & (trunc_ln28_1_reg_707_pp0_iter2_reg == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        tmp1_we0_local = 1'b1;
    end else begin
        tmp1_we0_local = 1'b0;
    end
...
assign add_ln27_fu_382_p2 = (i_fu_100 + 7'd1);
assign add_ln28_1_fu_352_p2 = (indvar_flatten9_fu_96 + 14'd1);
assign add_ln28_fu_406_p2 = (select_ln5_fu_388_p3 + 7'd1);
assign add_ln30_fu_496_p2 = (k_mid2_fu_416_p3 + 7'd1);
...
assign buff_A0_1_address0 = zext_ln31_fu_472_p1;
assign buff_A0_1_ce0 = buff_A0_1_ce0_local;
assign buff_A0_2_address0 = zext_ln31_fu_472_p1;
assign buff_A0_2_ce0 = buff_A0_2_ce0_local;
assign buff_A0_3_address0 = zext_ln31_fu_472_p1;
assign buff_A0_3_ce0 = buff_A0_3_ce0_local;
assign buff_A0_address0 = zext_ln31_fu_472_p1;
assign buff_A0_ce0 = buff_A0_ce0_local;
assign buff_B0_1_address0 = zext_ln31_1_fu_488_p1;
assign buff_B0_1_ce0 = buff_B0_1_ce0_local;
assign buff_B0_2_address0 = zext_ln31_1_fu_488_p1;
assign buff_B0_2_ce0 = buff_B0_2_ce0_local;
assign buff_B0_3_address0 = zext_ln31_1_fu_488_p1;
assign buff_B0_3_ce0 = buff_B0_3_ce0_local;
assign buff_B0_address0 = zext_ln31_1_fu_488_p1;
assign buff_B0_ce0 = buff_B0_ce0_local;
assign empty_10_fu_412_p2 = (icmp_ln28_reg_680 | and_ln5_reg_687);
assign empty_11_fu_430_p1 = select_ln28_fu_423_p3[5:0];
...
assign grp_fu_364_p_din1 = mul3_reg_796;
...
assign icmp_ln30_1_fu_502_p2 = ((add_ln30_fu_496_p2 == 7'd64) ? 1'b1 : 1'b0);
...
assign select_ln27_fu_395_p3 = ((icmp_ln28_reg_680[0:0] == 1'b1) ? add_ln27_fu_382_p2 : i_fu_100);
assign select_ln28_1_fu_358_p3 = ((icmp_ln28_fu_328_p2[0:0] == 1'b1) ? 14'd1 : add_ln28_1_fu_352_p2);
assign select_ln28_fu_423_p3 = ((and_ln5_reg_687[0:0] == 1'b1) ? add_ln28_fu_406_p2 : select_ln5_fu_388_p3);
assign select_ln5_fu_388_p3 = ((icmp_ln28_reg_680[0:0] == 1'b1) ? 7'd0 : j_fu_92);
assign tmp1_1_address0 = tmp1_1_address0_local;
assign tmp1_1_ce0 = tmp1_1_ce0_local;
assign tmp1_1_d0 = add_reg_806;
assign tmp1_1_we0 = tmp1_1_we0_local;
assign tmp1_2_address0 = tmp1_2_address0_local;
assign tmp1_2_ce0 = tmp1_2_ce0_local;
assign tmp1_2_d0 = add_reg_806;
assign tmp1_2_we0 = tmp1_2_we0_local;
assign tmp1_3_address0 = tmp1_3_address0_local;
assign tmp1_3_ce0 = tmp1_3_ce0_local;
assign tmp1_3_d0 = add_reg_806;
assign tmp1_3_we0 = tmp1_3_we0_local;
assign tmp1_address0 = tmp1_address0_local;
assign tmp1_ce0 = tmp1_ce0_local;
assign tmp1_d0 = add_reg_806;
assign tmp1_we0 = tmp1_we0_local;
assign tmp_10_fu_464_p3 = {{trunc_ln28_fu_402_p1}, {lshr_ln5_3_fu_454_p4}};
assign tmp_11_fu_480_p3 = {{empty_11_fu_430_p1}, {lshr_ln5_3_fu_454_p4}};
assign tmp_2_fu_526_p9 = 'bx;
assign tmp_3_fu_550_p9 = 'bx;
assign tmp_8_cast_fu_580_p1 = tmp_8_fu_574_p3;
assign tmp_8_fu_574_p3 = {{trunc_ln28_reg_693}, {lshr_ln5_1_reg_712}};
assign tmp_fu_588_p9 = 'bx;
assign trunc_ln28_1_fu_440_p1 = select_ln28_fu_423_p3[1:0];
assign trunc_ln28_fu_402_p1 = select_ln27_fu_395_p3[5:0];
assign trunc_ln30_fu_523_p1 = k_mid2_reg_698[1:0];
assign xor_ln5_fu_334_p2 = (icmp_ln28_fu_328_p2 ^ 1'd1);
assign zext_ln31_1_fu_488_p1 = tmp_11_fu_480_p3;
assign zext_ln31_fu_472_p1 = tmp_10_fu_464_p3;
endmodule 
