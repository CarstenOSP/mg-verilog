...
dmul_64ns_64ns_64_7_max_dsp_1_U3031(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1261_p0),.din1(grp_fu_1261_p1),.ce(1'b1),.dout(grp_fu_1261_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U3032(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_1265_p0),.din1(grp_fu_1265_p1),.ce(1'b1),.dout(grp_fu_1265_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U3033(.clk(ap_clk),.reset(ap_rst),.din0(reg_1369),.din1(v138_reg_3905),.ce(1'b1),.dout(grp_fu_1269_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        lshr_ln_reg_3895 <= {{v130_1_reg_2855_pp0_iter15_reg[5:1]}};
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter16 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7) & (1'b0 == ap_block_pp0_stage7_11001))) begin
        v136_126_reg_3910 <= grp_fu_20075_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_20075_p_din0 = grp_fu_1257_p0;
assign grp_fu_20075_p_din1 = grp_fu_1257_p1;
assign grp_fu_20075_p_opcode = 2'd0;
assign grp_fu_38355_p_ce = 1'b1;
assign grp_fu_38355_p_din0 = grp_fu_1252_p0;
assign grp_fu_38355_p_din1 = grp_fu_1252_p1;
...
assign or_ln4_fu_1428_p3 = {{empty_fu_1411_p1}, {6'd1}};
...
assign zext_ln218_1_fu_2523_p1 = lshr_ln_reg_3895;
...
assign zext_ln222_fu_1436_p1 = or_ln4_fu_1428_p3;
endmodule 
