...
wire   [31:0] j_fu_98_p2;
reg   [31:0] j_reg_135;
wire   [10:0] add9_fu_108_p2;
reg   [10:0] add9_reg_140;
...
wire   [10:0] trunc_ln5_fu_104_p1;
wire   [10:0] empty_fu_94_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add9_reg_140 <= add9_fu_108_p2;
        j_reg_135 <= j_fu_98_p2;
    end
end
always @ (*) begin
...
assign add9_fu_108_p2 = (trunc_ln5_fu_104_p1 + empty_fu_94_p1);
...
assign empty_fu_94_p1 = stop[10:0];
...
assign j_fu_98_p2 = (m + 32'd1);
assign trunc_ln5_fu_104_p1 = j_fu_98_p2[10:0];
endmodule 
