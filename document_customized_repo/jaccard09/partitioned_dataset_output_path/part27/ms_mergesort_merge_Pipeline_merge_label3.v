...
wire   [31:0] i_66_fu_264_p2;
reg   [31:0] i_66_reg_389;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln21_reg_385 == 1'd0))) begin
        ap_sig_allocacmp_i = i_66_reg_389;
    end else begin
        ap_sig_allocacmp_i = i_12_fu_58;
    end
end
always @ (*) begin
...
assign i_66_fu_264_p2 = (i_reg_336 + 32'd1);
