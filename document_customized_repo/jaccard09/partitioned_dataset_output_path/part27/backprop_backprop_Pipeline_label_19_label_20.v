...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_0410437_reload;
input  [63:0] mux_case_1411441_reload;
input  [63:0] mux_case_2412445_reload;
input  [8:0] mul_ln168;
output  [8:0] v7_address0;
output   v7_ce0;
input  [63:0] v7_q0;
input  [63:0] mux_case_0413449_reload;
input  [63:0] mux_case_1414454_reload;
...
reg   [0:0] icmp_ln190_reg_3940;
reg    ap_condition_exit_pp0_iter0_stage7;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln190_fu_2127_p2;
reg   [0:0] icmp_ln190_reg_3940_pp0_iter1_reg;
reg   [0:0] icmp_ln190_reg_3940_pp0_iter2_reg;
reg   [0:0] icmp_ln190_reg_3940_pp0_iter3_reg;
reg   [1:0] v111_load_reg_3944;
wire   [0:0] icmp_ln192_fu_2142_p2;
reg   [0:0] icmp_ln192_reg_3949;
reg   [0:0] icmp_ln192_reg_3949_pp0_iter1_reg;
reg   [0:0] icmp_ln192_reg_3949_pp0_iter2_reg;
reg   [0:0] icmp_ln192_reg_3949_pp0_iter3_reg;
wire   [1:0] select_ln190_fu_2156_p3;
reg   [1:0] select_ln190_reg_3956;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
reg   [1:0] select_ln190_reg_3956_pp0_iter1_reg;
wire   [6:0] select_ln190_2_fu_2168_p3;
reg   [6:0] select_ln190_2_reg_3962;
reg   [6:0] select_ln190_2_reg_3962_pp0_iter1_reg;
reg   [6:0] select_ln190_2_reg_3962_pp0_iter2_reg;
wire   [7:0] add_ln199_fu_2215_p2;
reg   [7:0] add_ln199_reg_3972;
wire   [0:0] icmp_ln192_1_fu_2227_p2;
reg   [0:0] icmp_ln192_1_reg_3977;
reg   [0:0] icmp_ln192_1_reg_3977_pp0_iter1_reg;
reg   [0:0] icmp_ln192_1_reg_3977_pp0_iter2_reg;
reg   [0:0] icmp_ln192_1_reg_3977_pp0_iter3_reg;
reg   [0:0] icmp_ln192_1_reg_3977_pp0_iter4_reg;
reg   [63:0] v7_load_reg_3981;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [63:0] v118_fu_2243_p387;
reg   [63:0] v118_reg_3986;
reg   [63:0] v118_reg_3986_pp0_iter1_reg;
wire   [63:0] v112_fu_2826_p9;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3_11001;
wire   [63:0] v113_fu_2843_p1;
wire   [0:0] xor_ln196_fu_2859_p2;
reg   [0:0] xor_ln196_reg_4001;
wire   [62:0] trunc_ln196_fu_2865_p1;
reg   [62:0] trunc_ln196_reg_4006;
wire   [63:0] v116_fu_2869_p9;
reg   [63:0] v116_reg_4011;
wire   [63:0] v115_fu_2891_p1;
reg   [63:0] v117_reg_4021;
reg   [63:0] v119_reg_4026;
wire   [63:0] select_ln190_1_fu_2899_p3;
reg   [5:0] v8_addr_reg_4036;
reg   [5:0] v8_addr_reg_4036_pp0_iter4_reg;
reg   [63:0] v123_reg_4046;
reg   [63:0] v122_reg_4051;
reg   [63:0] v124_reg_4056;
wire    ap_block_pp0_stage7_11001;
reg    ap_enable_reg_pp0_iter0_reg;
wire    ap_block_pp0_stage0_subdone;
wire   [63:0] zext_ln194_fu_2210_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln190_fu_2907_p1;
reg   [63:0] v120_fu_848;
wire    ap_loop_init;
reg   [1:0] v111_fu_852;
wire   [1:0] add_ln192_fu_2221_p2;
reg   [1:0] ap_sig_allocacmp_v111_load;
wire    ap_block_pp0_stage0;
reg   [6:0] v110_fu_856;
reg   [7:0] indvar_flatten19_fu_860;
wire   [7:0] add_ln190_fu_2133_p2;
...
reg   [63:0] grp_fu_2100_p0;
reg   [63:0] grp_fu_2100_p1;
wire    ap_block_pp0_stage2;
wire   [6:0] add_ln190_1_fu_2162_p2;
wire   [5:0] trunc_ln192_fu_2179_p1;
wire   [7:0] p_shl_fu_2183_p3;
wire   [7:0] zext_ln192_fu_2175_p1;
wire   [8:0] zext_ln192_2_fu_2201_p1;
wire   [8:0] add_ln194_fu_2205_p2;
wire   [7:0] zext_ln192_1_fu_2197_p1;
wire   [7:0] sub_ln192_fu_2191_p2;
wire   [63:0] v118_fu_2243_p385;
wire   [63:0] v112_fu_2826_p7;
wire   [63:0] bitcast_ln196_fu_2847_p1;
wire   [0:0] bit_sel9_fu_2851_p3;
wire   [63:0] v116_fu_2869_p7;
wire   [63:0] xor_ln7_fu_2885_p3;
reg   [1:0] grp_fu_2096_opcode;
...
wire   [1:0] v112_fu_2826_p1;
wire   [1:0] v112_fu_2826_p3;
wire  signed [1:0] v112_fu_2826_p5;
wire   [1:0] v116_fu_2869_p1;
wire   [1:0] v116_fu_2869_p3;
wire  signed [1:0] v116_fu_2869_p5;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 8'd1;
...
#0 v111_fu_852 = 2'd0;
#0 v110_fu_856 = 7'd0;
#0 indvar_flatten19_fu_860 = 8'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_385_8_64_1_1_U366(.din0(empty_36),.din1(empty_37),.din2(empty_38),.din3(empty_39),.din4(empty_40),.din5(empty_41),.din6(empty_42),.din7(empty_43),.din8(empty_44),.din9(empty_45),.din10(empty_46),.din11(empty_47),.din12(empty_48),.din13(empty_49),.din14(empty_50),.din15(empty_51),.din16(empty_52),.din17(empty_53),.din18(empty_54),.din19(empty_55),.din20(empty_56),.din21(empty_57),.din22(empty_58),.din23(empty_59),.din24(empty_60),.din25(empty_61),.din26(empty_62),.din27(empty_63),.din28(empty_64),.din29(empty_65),.din30(empty_66),.din31(empty_67),.din32(empty_68),.din33(empty_69),.din34(empty_70),.din35(empty_71),.din36(empty_72),.din37(empty_73),.din38(empty_74),.din39(empty_75),.din40(empty_76),.din41(empty_77),.din42(empty_78),.din43(empty_79),.din44(empty_80),.din45(empty_81),.din46(empty_82),.din47(empty_83),.din48(empty_84),.din49(empty_85),.din50(empty_86),.din51(empty_87),.din52(empty_88),.din53(empty_89),.din54(empty_90),.din55(empty_91),.din56(empty_92),.din57(empty_93),.din58(empty_94),.din59(empty_95),.din60(empty_96),.din61(empty_97),.din62(empty_98),.din63(empty_99),.din64(empty_100),.din65(empty_101),.din66(empty_102),.din67(empty_103),.din68(empty_104),.din69(empty_105),.din70(empty_106),.din71(empty_107),.din72(empty_108),.din73(empty_109),.din74(empty_110),.din75(empty_111),.din76(empty_112),.din77(empty_113),.din78(empty_114),.din79(empty_115),.din80(empty_116),.din81(empty_117),.din82(empty_118),.din83(empty_119),.din84(empty_120),.din85(empty_121),.din86(empty_122),.din87(empty_123),.din88(empty_124),.din89(empty_125),.din90(empty_126),.din91(empty_127),.din92(empty_128),.din93(empty_129),.din94(empty_130),.din95(empty_131),.din96(empty_132),.din97(empty_133),.din98(empty_134),.din99(empty_135),.din100(empty_136),.din101(empty_137),.din102(empty_138),.din103(empty_139),.din104(empty_140),.din105(empty_141),.din106(empty_142),.din107(empty_143),.din108(empty_144),.din109(empty_145),.din110(empty_146),.din111(empty_147),.din112(empty_148),.din113(empty_149),.din114(empty_150),.din115(empty_151),.din116(empty_152),.din117(empty_153),.din118(empty_154),.din119(empty_155),.din120(empty_156),.din121(empty_157),.din122(empty_158),.din123(empty_159),.din124(empty_160),.din125(empty_161),.din126(empty_162),.din127(empty_163),.din128(empty_164),.din129(empty_165),.din130(empty_166),.din131(empty_167),.din132(empty_168),.din133(empty_169),.din134(empty_170),.din135(empty_171),.din136(empty_172),.din137(empty_173),.din138(empty_174),.din139(empty_175),.din140(empty_176),.din141(empty_177),.din142(empty_178),.din143(empty_179),.din144(empty_180),.din145(empty_181),.din146(empty_182),.din147(empty_183),.din148(empty_184),.din149(empty_185),.din150(empty_186),.din151(empty_187),.din152(empty_188),.din153(empty_189),.din154(empty_190),.din155(empty_191),.din156(empty_192),.din157(empty_193),.din158(empty_194),.din159(empty_195),.din160(empty_196),.din161(empty_197),.din162(empty_198),.din163(empty_199),.din164(empty_200),.din165(empty_201),.din166(empty_202),.din167(empty_203),.din168(empty_204),.din169(empty_205),.din170(empty_206),.din171(empty_207),.din172(empty_208),.din173(empty_209),.din174(empty_210),.din175(empty_211),.din176(empty_212),.din177(empty_213),.din178(empty_214),.din179(empty_215),.din180(empty_216),.din181(empty_217),.din182(empty_218),.din183(empty_219),.din184(empty_220),.din185(empty_221),.din186(empty_222),.din187(empty_223),.din188(empty_224),.din189(empty_225),.din190(empty_226),.din191(empty),.def(v118_fu_2243_p385),.sel(add_ln199_reg_3972),.dout(v118_fu_2243_p387));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U367(.din0(mux_case_0410437_reload),.din1(mux_case_1411441_reload),.din2(mux_case_2412445_reload),.def(v112_fu_2826_p7),.sel(select_ln190_reg_3956),.dout(v112_fu_2826_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U368(.din0(mux_case_0413449_reload),.din1(mux_case_1414454_reload),.din2(v75_reload),.def(v116_fu_2869_p7),.sel(select_ln190_reg_3956_pp0_iter1_reg),.dout(v116_fu_2869_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln190_fu_2127_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten19_fu_860 <= add_ln190_fu_2133_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten19_fu_860 <= 8'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v110_fu_856 <= 7'd0;
    end else if (((icmp_ln190_reg_3940 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v110_fu_856 <= select_ln190_2_fu_2168_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v111_fu_852 <= add_ln192_fu_2221_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            v120_fu_848 <= grp_fu_7753_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add_ln199_reg_3972 <= add_ln199_fu_2215_p2;
        icmp_ln192_1_reg_3977 <= icmp_ln192_1_fu_2227_p2;
        icmp_ln192_1_reg_3977_pp0_iter1_reg <= icmp_ln192_1_reg_3977;
        icmp_ln192_1_reg_3977_pp0_iter2_reg <= icmp_ln192_1_reg_3977_pp0_iter1_reg;
        icmp_ln192_1_reg_3977_pp0_iter3_reg <= icmp_ln192_1_reg_3977_pp0_iter2_reg;
        icmp_ln192_1_reg_3977_pp0_iter4_reg <= icmp_ln192_1_reg_3977_pp0_iter3_reg;
        select_ln190_2_reg_3962 <= select_ln190_2_fu_2168_p3;
        select_ln190_2_reg_3962_pp0_iter1_reg <= select_ln190_2_reg_3962;
        select_ln190_2_reg_3962_pp0_iter2_reg <= select_ln190_2_reg_3962_pp0_iter1_reg;
        select_ln190_reg_3956 <= select_ln190_fu_2156_p3;
        select_ln190_reg_3956_pp0_iter1_reg <= select_ln190_reg_3956;
        v8_addr_reg_4036 <= zext_ln190_fu_2907_p1;
        v8_addr_reg_4036_pp0_iter4_reg <= v8_addr_reg_4036;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln190_reg_3940 <= icmp_ln190_fu_2127_p2;
        icmp_ln190_reg_3940_pp0_iter1_reg <= icmp_ln190_reg_3940;
        icmp_ln190_reg_3940_pp0_iter2_reg <= icmp_ln190_reg_3940_pp0_iter1_reg;
        icmp_ln190_reg_3940_pp0_iter3_reg <= icmp_ln190_reg_3940_pp0_iter2_reg;
        icmp_ln192_reg_3949 <= icmp_ln192_fu_2142_p2;
        icmp_ln192_reg_3949_pp0_iter1_reg <= icmp_ln192_reg_3949;
        icmp_ln192_reg_3949_pp0_iter2_reg <= icmp_ln192_reg_3949_pp0_iter1_reg;
        icmp_ln192_reg_3949_pp0_iter3_reg <= icmp_ln192_reg_3949_pp0_iter2_reg;
        v111_load_reg_3944 <= ap_sig_allocacmp_v111_load;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        trunc_ln196_reg_4006 <= trunc_ln196_fu_2865_p1;
        v116_reg_4011 <= v116_fu_2869_p9;
        v118_reg_3986 <= v118_fu_2243_p387;
        v118_reg_3986_pp0_iter1_reg <= v118_reg_3986;
        v123_reg_4046 <= v16_q0;
        v7_load_reg_3981 <= v7_q0;
        xor_ln196_reg_4001 <= xor_ln196_fu_2859_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v117_reg_4021 <= grp_fu_7757_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v119_reg_4026 <= grp_fu_7757_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v122_reg_4051 <= grp_fu_7753_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        v124_reg_4056 <= grp_fu_7757_p_dout0;
    end
end
always @ (*) begin
    if (((icmp_ln190_reg_3940 == 1'd1) & (1'b0 == ap_block_pp0_stage7_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
...
always @ (*) begin
    if (((icmp_ln190_reg_3940_pp0_iter3_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten19_load = indvar_flatten19_fu_860;
    end
end
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_v111_load = v111_fu_852;
    end
end
always @ (*) begin
    if (((icmp_ln190_reg_3940 == 1'd0) & (1'b0 == ap_block_pp0_stage3_00001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_2096_opcode = 2'd1;
    end else if (((1'b0 == ap_block_pp0_stage1_00001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_2096_opcode = 2'd0;
    end else begin
        grp_fu_2096_opcode = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_2096_p0 = select_ln190_1_fu_2899_p3;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_2096_p0 = v112_fu_2826_p9;
    end else begin
        grp_fu_2096_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_2096_p1 = v119_reg_4026;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_2096_p1 = v113_fu_2843_p1;
    end else begin
        grp_fu_2096_p1 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_2100_p0 = v122_reg_4051;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_2100_p0 = v117_reg_4021;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_2100_p0 = v115_fu_2891_p1;
    end else begin
        grp_fu_2100_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_2100_p1 = v123_reg_4046;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_2100_p1 = v118_reg_3986_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        grp_fu_2100_p1 = v116_reg_4011;
    end else begin
        grp_fu_2100_p1 = 'bx;
    end
end
...
always @ (*) begin
    if (((icmp_ln192_1_reg_3977_pp0_iter4_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v8_we0_local = 1'b1;
    end else begin
        v8_we0_local = 1'b0;
    end
...
assign add_ln190_1_fu_2162_p2 = (v110_fu_856 + 7'd1);
assign add_ln190_fu_2133_p2 = (ap_sig_allocacmp_indvar_flatten19_load + 8'd1);
assign add_ln192_fu_2221_p2 = (select_ln190_fu_2156_p3 + 2'd1);
assign add_ln194_fu_2205_p2 = (zext_ln192_2_fu_2201_p1 + mul_ln168);
assign add_ln199_fu_2215_p2 = (zext_ln192_1_fu_2197_p1 + sub_ln192_fu_2191_p2);
...
assign bit_sel9_fu_2851_p3 = bitcast_ln196_fu_2847_p1[64'd63];
assign bitcast_ln196_fu_2847_p1 = grp_fu_7753_p_dout0;
assign grp_fu_7753_p_ce = 1'b1;
assign grp_fu_7753_p_din0 = grp_fu_2096_p0;
assign grp_fu_7753_p_din1 = grp_fu_2096_p1;
assign grp_fu_7753_p_opcode = grp_fu_2096_opcode;
assign grp_fu_7757_p_ce = 1'b1;
assign grp_fu_7757_p_din0 = grp_fu_2100_p0;
assign grp_fu_7757_p_din1 = grp_fu_2100_p1;
assign icmp_ln190_fu_2127_p2 = ((ap_sig_allocacmp_indvar_flatten19_load == 8'd192) ? 1'b1 : 1'b0);
assign icmp_ln192_1_fu_2227_p2 = ((add_ln192_fu_2221_p2 == 2'd3) ? 1'b1 : 1'b0);
assign icmp_ln192_fu_2142_p2 = ((ap_sig_allocacmp_v111_load == 2'd3) ? 1'b1 : 1'b0);
assign p_shl_fu_2183_p3 = {{trunc_ln192_fu_2179_p1}, {2'd0}};
assign select_ln190_1_fu_2899_p3 = ((icmp_ln192_reg_3949_pp0_iter3_reg[0:0] == 1'b1) ? 64'd0 : v120_fu_848);
assign select_ln190_2_fu_2168_p3 = ((icmp_ln192_reg_3949[0:0] == 1'b1) ? add_ln190_1_fu_2162_p2 : v110_fu_856);
assign select_ln190_fu_2156_p3 = ((icmp_ln192_reg_3949[0:0] == 1'b1) ? 2'd0 : v111_load_reg_3944);
assign sub_ln192_fu_2191_p2 = (p_shl_fu_2183_p3 - zext_ln192_fu_2175_p1);
assign trunc_ln192_fu_2179_p1 = select_ln190_2_fu_2168_p3[5:0];
assign trunc_ln196_fu_2865_p1 = bitcast_ln196_fu_2847_p1[62:0];
assign v112_fu_2826_p7 = 'bx;
assign v113_fu_2843_p1 = v7_load_reg_3981;
assign v115_fu_2891_p1 = xor_ln7_fu_2885_p3;
assign v116_fu_2869_p7 = 'bx;
assign v118_fu_2243_p385 = 'bx;
assign v16_address0 = zext_ln190_fu_2907_p1;
assign v16_ce0 = v16_ce0_local;
assign v7_address0 = zext_ln194_fu_2210_p1;
assign v7_ce0 = v7_ce0_local;
assign v8_address0 = v8_addr_reg_4036_pp0_iter4_reg;
assign v8_ce0 = v8_ce0_local;
assign v8_d0 = v124_reg_4056;
assign v8_we0 = v8_we0_local;
assign xor_ln196_fu_2859_p2 = (bit_sel9_fu_2851_p3 ^ 1'd1);
assign xor_ln7_fu_2885_p3 = {{xor_ln196_reg_4001}, {trunc_ln196_reg_4006}};
assign zext_ln190_fu_2907_p1 = select_ln190_2_reg_3962_pp0_iter2_reg;
assign zext_ln192_1_fu_2197_p1 = select_ln190_fu_2156_p3;
assign zext_ln192_2_fu_2201_p1 = select_ln190_fu_2156_p3;
assign zext_ln192_fu_2175_p1 = select_ln190_2_fu_2168_p3;
assign zext_ln194_fu_2210_p1 = add_ln194_fu_2205_p2;
endmodule 
