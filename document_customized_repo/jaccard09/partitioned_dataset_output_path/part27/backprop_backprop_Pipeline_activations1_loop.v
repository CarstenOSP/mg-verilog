...
wire   [2:0] trunc_ln104_fu_352_p1;
reg   [2:0] trunc_ln104_reg_565;
wire   [63:0] tmp_s_fu_409_p11;
reg   [63:0] tmp_s_reg_653;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1_11001;
wire   [63:0] tmp_81_fu_448_p11;
reg   [63:0] tmp_81_reg_658;
wire   [63:0] tmp_82_fu_471_p11;
reg   [63:0] tmp_82_reg_663;
wire   [63:0] tmp_83_fu_510_p11;
reg   [63:0] tmp_83_reg_668;
reg   [63:0] mul8_i3_reg_673;
wire    ap_block_pp0_stage8_11001;
wire    ap_CS_fsm_pp0_stage9;
wire    ap_block_pp0_stage9_11001;
reg   [63:0] mul8_1_i3_reg_683;
reg   [63:0] add11_i3_reg_688;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln101_fu_366_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln105_fu_386_p1;
reg   [63:0] add113_i_fu_94;
wire    ap_block_pp0_stage8;
wire    ap_loop_init;
wire    ap_block_pp0_stage9;
reg   [6:0] j_fu_98;
wire   [6:0] add_ln104_fu_398_p2;
...
wire   [8:0] add_ln3_fu_378_p3;
wire   [63:0] tmp_s_fu_409_p9;
wire   [63:0] tmp_81_fu_448_p2;
wire   [63:0] tmp_81_fu_448_p4;
wire   [63:0] tmp_81_fu_448_p6;
wire   [63:0] tmp_81_fu_448_p8;
wire   [63:0] tmp_81_fu_448_p9;
wire   [63:0] tmp_82_fu_471_p9;
wire   [63:0] tmp_83_fu_510_p2;
wire   [63:0] tmp_83_fu_510_p4;
wire   [63:0] tmp_83_fu_510_p6;
wire   [63:0] tmp_83_fu_510_p8;
wire   [63:0] tmp_83_fu_510_p9;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_s_fu_409_p1;
wire   [2:0] tmp_s_fu_409_p3;
wire  signed [2:0] tmp_s_fu_409_p5;
wire  signed [2:0] tmp_s_fu_409_p7;
wire   [2:0] tmp_81_fu_448_p1;
wire   [2:0] tmp_81_fu_448_p3;
wire  signed [2:0] tmp_81_fu_448_p5;
wire  signed [2:0] tmp_81_fu_448_p7;
wire   [2:0] tmp_82_fu_471_p1;
wire   [2:0] tmp_82_fu_471_p3;
wire  signed [2:0] tmp_82_fu_471_p5;
wire  signed [2:0] tmp_82_fu_471_p7;
wire   [2:0] tmp_83_fu_510_p1;
wire   [2:0] tmp_83_fu_510_p3;
wire  signed [2:0] tmp_83_fu_510_p5;
wire  signed [2:0] tmp_83_fu_510_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 16'd1;
#0 ap_enable_reg_pp0_iter1 = 1'b0;
#0 ap_enable_reg_pp0_iter0_reg = 1'b0;
#0 add113_i_fu_94 = 64'd0;
#0 j_fu_98 = 7'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_9_3_64_1_1_U477(.din0(oracle_activations2_q0),.din1(oracle_activations2_2_q0),.din2(oracle_activations2_4_q0),.din3(oracle_activations2_6_q0),.def(tmp_s_fu_409_p9),.sel(trunc_ln104_reg_565),.dout(tmp_s_fu_409_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h2 ),.din1_WIDTH( 64 ),.CASE2( 3'h4 ),.din2_WIDTH( 64 ),.CASE3( 3'h6 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_9_3_64_1_1_U478(.din0(tmp_81_fu_448_p2),.din1(tmp_81_fu_448_p4),.din2(tmp_81_fu_448_p6),.din3(tmp_81_fu_448_p8),.def(tmp_81_fu_448_p9),.sel(trunc_ln104_reg_565),.dout(tmp_81_fu_448_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h2 ),.din1_WIDTH( 64 ),.CASE2( 3'h4 ),.din2_WIDTH( 64 ),.CASE3( 3'h6 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_9_3_64_1_1_U479(.din0(oracle_activations2_1_q0),.din1(oracle_activations2_3_q0),.din2(oracle_activations2_5_q0),.din3(oracle_activations2_7_q0),.def(tmp_82_fu_471_p9),.sel(trunc_ln104_reg_565),.dout(tmp_82_fu_471_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h2 ),.din1_WIDTH( 64 ),.CASE2( 3'h4 ),.din2_WIDTH( 64 ),.CASE3( 3'h6 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_9_3_64_1_1_U480(.din0(tmp_83_fu_510_p2),.din1(tmp_83_fu_510_p4),.din2(tmp_83_fu_510_p6),.din3(tmp_83_fu_510_p8),.def(tmp_83_fu_510_p9),.sel(trunc_ln104_reg_565),.dout(tmp_83_fu_510_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add11_i3_reg_688 <= grp_fu_4181_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        mul8_1_i3_reg_683 <= grp_fu_2684_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        mul8_i3_reg_673 <= grp_fu_2684_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_81_reg_658 <= tmp_81_fu_448_p11;
        tmp_82_reg_663 <= tmp_82_fu_471_p11;
        tmp_83_reg_668 <= tmp_83_fu_510_p11;
        tmp_s_reg_653 <= tmp_s_fu_409_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_561 <= ap_sig_allocacmp_j_3[32'd6];
        trunc_ln104_reg_565 <= trunc_ln104_fu_352_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_323_p0 = add11_i3_reg_688;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_323_p0 = add113_i_fu_94;
    end else begin
        grp_fu_323_p0 = 'bx;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_323_p1 = mul8_1_i3_reg_683;
    end else if (((1'b0 == ap_block_pp0_stage9) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
        grp_fu_323_p1 = mul8_i3_reg_673;
    end else begin
        grp_fu_323_p1 = 'bx;
    end
end
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_327_p1 = tmp_83_reg_668;
        end else if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
            grp_fu_327_p1 = tmp_81_reg_658;
        end else begin
            grp_fu_327_p1 = 'bx;
        end
    end else begin
...
assign add113_i_out = add113_i_fu_94;
assign add_ln104_fu_398_p2 = (ap_sig_allocacmp_j_3 + 7'd2);
assign add_ln3_fu_378_p3 = {{i_25}, {lshr_ln_fu_356_p4}};
...
assign lshr_ln_fu_356_p4 = {{ap_sig_allocacmp_j_3[5:3]}};
assign oracle_activations2_1_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_1_ce0 = oracle_activations2_1_ce0_local;
assign oracle_activations2_2_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_2_ce0 = oracle_activations2_2_ce0_local;
assign oracle_activations2_3_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_3_ce0 = oracle_activations2_3_ce0_local;
assign oracle_activations2_4_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_4_ce0 = oracle_activations2_4_ce0_local;
assign oracle_activations2_5_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_5_ce0 = oracle_activations2_5_ce0_local;
assign oracle_activations2_6_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_6_ce0 = oracle_activations2_6_ce0_local;
assign oracle_activations2_7_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_7_ce0 = oracle_activations2_7_ce0_local;
assign oracle_activations2_address0 = zext_ln101_fu_366_p1;
assign oracle_activations2_ce0 = oracle_activations2_ce0_local;
assign tmp_81_fu_448_p2 = weights2_0_q0;
assign tmp_81_fu_448_p4 = weights2_2_q0;
assign tmp_81_fu_448_p6 = weights2_4_q0;
assign tmp_81_fu_448_p8 = weights2_6_q0;
assign tmp_81_fu_448_p9 = 'bx;
assign tmp_82_fu_471_p9 = 'bx;
assign tmp_83_fu_510_p2 = weights2_1_q0;
assign tmp_83_fu_510_p4 = weights2_3_q0;
assign tmp_83_fu_510_p6 = weights2_5_q0;
assign tmp_83_fu_510_p8 = weights2_7_q0;
assign tmp_83_fu_510_p9 = 'bx;
assign tmp_fu_344_p3 = ap_sig_allocacmp_j_3[32'd6];
assign tmp_s_fu_409_p9 = 'bx;
assign trunc_ln104_fu_352_p1 = ap_sig_allocacmp_j_3[2:0];
assign weights2_0_address0 = zext_ln105_fu_386_p1;
assign weights2_0_ce0 = weights2_0_ce0_local;
assign weights2_1_address0 = zext_ln105_fu_386_p1;
assign weights2_1_ce0 = weights2_1_ce0_local;
assign weights2_2_address0 = zext_ln105_fu_386_p1;
assign weights2_2_ce0 = weights2_2_ce0_local;
assign weights2_3_address0 = zext_ln105_fu_386_p1;
assign weights2_3_ce0 = weights2_3_ce0_local;
assign weights2_4_address0 = zext_ln105_fu_386_p1;
assign weights2_4_ce0 = weights2_4_ce0_local;
assign weights2_5_address0 = zext_ln105_fu_386_p1;
assign weights2_5_ce0 = weights2_5_ce0_local;
assign weights2_6_address0 = zext_ln105_fu_386_p1;
assign weights2_6_ce0 = weights2_6_ce0_local;
assign weights2_7_address0 = zext_ln105_fu_386_p1;
assign weights2_7_ce0 = weights2_7_ce0_local;
assign zext_ln101_fu_366_p1 = lshr_ln_fu_356_p4;
assign zext_ln105_fu_386_p1 = add_ln3_fu_378_p3;
endmodule 
