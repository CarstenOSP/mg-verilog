...
reg   [6:0] phi_urem184_fu_60;
wire   [6:0] select_ln105_fu_250_p3;
wire    ap_loop_init;
reg   [13:0] phi_mul182_fu_64;
wire   [13:0] add_ln105_1_fu_178_p2;
reg   [13:0] ap_sig_allocacmp_phi_mul182_load;
reg   [6:0] v49_fu_68;
...
#0 phi_urem184_fu_60 = 7'd0;
#0 phi_mul182_fu_64 = 14'd0;
#0 v49_fu_68 = 7'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U114(.din0(v19_q1),.din1(v19_1_q1),.din2(v19_2_q1),.def(v50_fu_218_p7),.sel(v50_fu_218_p8),.dout(v50_fu_218_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln105_fu_158_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            phi_mul182_fu_64 <= add_ln105_1_fu_178_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            phi_mul182_fu_64 <= 14'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v52_reg_334 <= grp_fu_4365_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_phi_mul182_load = 14'd0;
    end else begin
        ap_sig_allocacmp_phi_mul182_load = phi_mul182_fu_64;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln105_1_fu_178_p2 = (ap_sig_allocacmp_phi_mul182_load + 14'd171);
assign add_ln105_2_fu_238_p2 = (phi_urem184_fu_60 + 7'd1);
...
assign grp_fu_4365_p_din0 = v50_reg_319;
assign grp_fu_4365_p_din1 = v51_fu_263_p1;
...
assign tmp_fu_184_p4 = {{ap_sig_allocacmp_phi_mul182_load[13:9]}};
assign trunc_ln105_fu_214_p1 = phi_urem184_fu_60[1:0];
...
assign v50_fu_218_p8 = phi_urem184_fu_60[1:0];
