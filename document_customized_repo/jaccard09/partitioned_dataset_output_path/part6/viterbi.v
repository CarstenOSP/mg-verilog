...
wire   [7:0] grp_viterbi_Pipeline_L_end_fu_283_min_s_8_out;
wire    grp_viterbi_Pipeline_L_end_fu_283_min_s_8_out_ap_vld;
...
wire   [7:0] grp_viterbi_Pipeline_L_state_fu_297_min_s_18_out;
wire    grp_viterbi_Pipeline_L_state_fu_297_min_s_18_out_ap_vld;
...
llike_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_address0),.ce0(llike_ce0),.we0(llike_we0),.d0(llike_d0),.q0(llike_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_address1),.ce1(llike_ce1),.q1(llike_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
llike_1_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_1_address0),.ce0(llike_1_ce0),.we0(llike_1_we0),.d0(llike_1_d0),.q0(llike_1_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_1_address1),.ce1(llike_1_ce1),.q1(llike_1_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
llike_2_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_2_address0),.ce0(llike_2_ce0),.we0(llike_2_we0),.d0(llike_2_d0),.q0(llike_2_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_2_address1),.ce1(llike_2_ce1),.q1(llike_2_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
llike_3_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_3_address0),.ce0(llike_3_ce0),.we0(llike_3_we0),.d0(llike_3_d0),.q0(llike_3_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_3_address1),.ce1(llike_3_ce1),.q1(llike_3_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
llike_4_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_4_address0),.ce0(llike_4_ce0),.we0(llike_4_we0),.d0(llike_4_d0),.q0(llike_4_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_4_address1),.ce1(llike_4_ce1),.q1(llike_4_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
llike_5_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_5_address0),.ce0(llike_5_ce0),.we0(llike_5_we0),.d0(llike_5_d0),.q0(llike_5_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_5_address1),.ce1(llike_5_ce1),.q1(llike_5_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
llike_6_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_6_address0),.ce0(llike_6_ce0),.we0(llike_6_we0),.d0(llike_6_d0),.q0(llike_6_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_6_address1),.ce1(llike_6_ce1),.q1(llike_6_q1));
viterbi_llike_RAM_1WNR_AUTO_1R1W #(.DataWidth( 64 ),.AddressRange( 1120 ),.AddressWidth( 11 ))
llike_7_U(.clk(ap_clk),.reset(ap_rst),.address0(llike_7_address0),.ce0(llike_7_ce0),.we0(llike_7_we0),.d0(llike_7_d0),.q0(llike_7_q0),.address1(grp_viterbi_Pipeline_L_timestep_L_curr_state_fu_259_llike_7_address1),.ce1(llike_7_ce1),.q1(llike_7_q1));
...
viterbi_viterbi_Pipeline_L_end grp_viterbi_Pipeline_L_end_fu_283(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_viterbi_Pipeline_L_end_fu_283_ap_start),.ap_done(grp_viterbi_Pipeline_L_end_fu_283_ap_done),.ap_idle(grp_viterbi_Pipeline_L_end_fu_283_ap_idle),.ap_ready(grp_viterbi_Pipeline_L_end_fu_283_ap_ready),.min_p(reg_323),.llike_1_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_1_address0),.llike_1_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_1_ce0),.llike_1_q0(llike_1_q0),.llike_2_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_2_address0),.llike_2_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_2_ce0),.llike_2_q0(llike_2_q0),.llike_3_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_3_address0),.llike_3_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_3_ce0),.llike_3_q0(llike_3_q0),.llike_4_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_4_address0),.llike_4_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_4_ce0),.llike_4_q0(llike_4_q0),.llike_5_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_5_address0),.llike_5_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_5_ce0),.llike_5_q0(llike_5_q0),.llike_6_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_6_address0),.llike_6_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_6_ce0),.llike_6_q0(llike_6_q0),.llike_7_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_7_address0),.llike_7_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_7_ce0),.llike_7_q0(llike_7_q0),.llike_address0(grp_viterbi_Pipeline_L_end_fu_283_llike_address0),.llike_ce0(grp_viterbi_Pipeline_L_end_fu_283_llike_ce0),.llike_q0(llike_q0),.min_s_8_out(grp_viterbi_Pipeline_L_end_fu_283_min_s_8_out),.min_s_8_out_ap_vld(grp_viterbi_Pipeline_L_end_fu_283_min_s_8_out_ap_vld),.grp_fu_584_p_din0(grp_viterbi_Pipeline_L_end_fu_283_grp_fu_584_p_din0),.grp_fu_584_p_din1(grp_viterbi_Pipeline_L_end_fu_283_grp_fu_584_p_din1),.grp_fu_584_p_opcode(grp_viterbi_Pipeline_L_end_fu_283_grp_fu_584_p_opcode),.grp_fu_584_p_dout0(grp_fu_584_p2),.grp_fu_584_p_ce(grp_viterbi_Pipeline_L_end_fu_283_grp_fu_584_p_ce));
viterbi_viterbi_Pipeline_L_state grp_viterbi_Pipeline_L_state_fu_297(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_viterbi_Pipeline_L_state_fu_297_ap_start),.ap_done(grp_viterbi_Pipeline_L_state_fu_297_ap_done),.ap_idle(grp_viterbi_Pipeline_L_state_fu_297_ap_idle),.ap_ready(grp_viterbi_Pipeline_L_state_fu_297_ap_ready),.min_p_163(min_p_162_reg_579),.t_1(trunc_ln50_reg_518),.llike_1_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_1_address0),.llike_1_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_1_ce0),.llike_1_q0(llike_1_q0),.llike_2_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_2_address0),.llike_2_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_2_ce0),.llike_2_q0(llike_2_q0),.llike_3_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_3_address0),.llike_3_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_3_ce0),.llike_3_q0(llike_3_q0),.llike_4_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_4_address0),.llike_4_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_4_ce0),.llike_4_q0(llike_4_q0),.llike_5_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_5_address0),.llike_5_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_5_ce0),.llike_5_q0(llike_5_q0),.llike_6_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_6_address0),.llike_6_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_6_ce0),.llike_6_q0(llike_6_q0),.llike_7_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_7_address0),.llike_7_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_7_ce0),.llike_7_q0(llike_7_q0),.zext_ln52_2(lshr_ln52_1_reg_554),.transition_0_address0(grp_viterbi_Pipeline_L_state_fu_297_transition_0_address0),.transition_0_ce0(grp_viterbi_Pipeline_L_state_fu_297_transition_0_ce0),.transition_0_q0(transition_0_q0),.transition_0_address1(grp_viterbi_Pipeline_L_state_fu_297_transition_0_address1),.transition_0_ce1(grp_viterbi_Pipeline_L_state_fu_297_transition_0_ce1),.transition_0_q1(transition_0_q1),.transition_1_address0(grp_viterbi_Pipeline_L_state_fu_297_transition_1_address0),.transition_1_ce0(grp_viterbi_Pipeline_L_state_fu_297_transition_1_ce0),.transition_1_q0(transition_1_q0),.transition_1_address1(grp_viterbi_Pipeline_L_state_fu_297_transition_1_address1),.transition_1_ce1(grp_viterbi_Pipeline_L_state_fu_297_transition_1_ce1),.transition_1_q1(transition_1_q1),.empty(trunc_ln52_reg_548),.zext_ln52_3(tmp_s_reg_534),.llike_address0(grp_viterbi_Pipeline_L_state_fu_297_llike_address0),.llike_ce0(grp_viterbi_Pipeline_L_state_fu_297_llike_ce0),.llike_q0(llike_q0),.min_s_18_out(grp_viterbi_Pipeline_L_state_fu_297_min_s_18_out),.min_s_18_out_ap_vld(grp_viterbi_Pipeline_L_state_fu_297_min_s_18_out_ap_vld),.grp_fu_319_p_din0(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_319_p_din0),.grp_fu_319_p_din1(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_319_p_din1),.grp_fu_319_p_opcode(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_319_p_opcode),.grp_fu_319_p_dout0(grp_fu_319_p2),.grp_fu_319_p_ce(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_319_p_ce),.grp_fu_584_p_din0(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_584_p_din0),.grp_fu_584_p_din1(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_584_p_din1),.grp_fu_584_p_opcode(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_584_p_opcode),.grp_fu_584_p_dout0(grp_fu_584_p2),.grp_fu_584_p_ce(grp_viterbi_Pipeline_L_state_fu_297_grp_fu_584_p_ce));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state22)) begin
        min_p_162_reg_579 <= grp_fu_319_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_state_fu_297_min_s_18_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state24))) begin
        min_s_18_loc_fu_86 <= grp_viterbi_Pipeline_L_state_fu_297_min_s_18_out;
    end
end
always @ (posedge ap_clk) begin
    if (((grp_viterbi_Pipeline_L_end_fu_283_min_s_8_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state10))) begin
        min_s_8_loc_fu_90 <= grp_viterbi_Pipeline_L_end_fu_283_min_s_8_out;
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        path_1_d0_local = min_s_18_loc_fu_86;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        path_1_d0_local = min_s_8_loc_fu_90;
    end else begin
        path_1_d0_local = 'bx;
    end
end
...
assign path_0_d0 = min_s_18_loc_fu_86;
