...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done == 1'b1) & (trunc_ln148_fu_504_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state14)) | ((icmp_ln148_fu_498_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state7)) | ((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_445_p2 == 1'd0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state14 : begin
            if (((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done == 1'b1) & (trunc_ln148_fu_504_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state14))) begin
                ap_NS_fsm = ap_ST_fsm_state17;
            end else if (((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done == 1'b1) & (trunc_ln148_fu_504_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state14))) begin
...
assign buf_1_d1 = reg_401;
assign buf_1_we1 = buf_1_we1_local;
assign buf_2_d1 = reg_411;
assign buf_2_we1 = buf_2_we1_local;
assign buf_3_d1 = reg_421;
...
assign i_18_fu_517_p2 = (i_11_fu_108 + 4'd1);
