...
sparsemux_17_3_32_1_1_U2034(.din0(buff_q_out_q0),.din1(buff_q_out_1_q0),.din2(buff_q_out_2_q0),.din3(buff_q_out_3_q0),.din4(buff_q_out_4_q0),.din5(buff_q_out_5_q0),.din6(buff_q_out_6_q0),.din7(buff_q_out_7_q0),.def(tmp_fu_269_p17),.sel(tmp_fu_269_p18),.dout(tmp_fu_269_p19));
...
assign bitcast_ln37_fu_314_p1 = tmp_reg_380;
...
assign tmp_fu_269_p18 = i_1_reg_325[2:0];
