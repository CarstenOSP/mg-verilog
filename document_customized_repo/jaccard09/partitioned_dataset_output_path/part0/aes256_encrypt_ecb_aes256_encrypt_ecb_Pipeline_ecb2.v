...
module aes256_encrypt_ecb_aes256_encrypt_ecb_Pipeline_ecb2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,p_partset113_reload,ctx5_out,ctx5_out_ap_vld,grp_aes_expandEncKey_fu_293_p_din1,grp_aes_expandEncKey_fu_293_p_din2,grp_aes_expandEncKey_fu_293_p_din3,grp_aes_expandEncKey_fu_293_p_dout0_0,grp_aes_expandEncKey_fu_293_p_dout0_1,grp_aes_expandEncKey_fu_293_p_ce,grp_aes_expandEncKey_fu_293_p_start,grp_aes_expandEncKey_fu_293_p_ready,grp_aes_expandEncKey_fu_293_p_done,grp_aes_expandEncKey_fu_293_p_idle);  
...
wire   [0:0] icmp_ln137_fu_95_p2;
wire    ap_block_pp0_stage1_11001;
reg   [767:0] ctx_ret_reg_171;
reg   [7:0] rcon_reg_176;
reg    ap_enable_reg_pp0_iter0_reg;
wire    grp_aes_expandEncKey_fu_65_ap_ready;
reg    grp_aes_expandEncKey_fu_65_ap_start_reg;
wire    ap_block_pp0_stage1_ignoreCallOp100;
reg   [2:0] i_1_fu_40;
wire   [2:0] add_ln137_fu_101_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_i;
wire    ap_block_pp0_stage0;
reg   [7:0] rcon_0_fu_44;
...
#0 grp_aes_expandEncKey_fu_65_ap_start_reg = 1'b0;
#0 i_1_fu_40 = 3'd0;
#0 rcon_0_fu_44 = 8'd0;
#0 ctx5_fu_48 = 768'd0;
#0 ap_done_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_aes_expandEncKey_fu_65_ap_start_reg <= 1'b0;
    end else begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln137_fu_95_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
            grp_aes_expandEncKey_fu_65_ap_start_reg <= 1'b1;
        end else if ((grp_aes_expandEncKey_fu_65_ap_ready == 1'b1)) begin
            grp_aes_expandEncKey_fu_65_ap_start_reg <= 1'b0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ctx5_fu_48 <= p_partset113_reload;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ctx5_fu_48 <= ctx_ret_reg_171;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln137_fu_95_p2 == 1'd0))) begin
            i_1_fu_40 <= add_ln137_fu_101_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        rcon_0_fu_44 <= rcon_reg_176;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ctx_ret_reg_171 <= grp_aes_expandEncKey_fu_293_p_dout0_0;
        icmp_ln137_reg_162 <= icmp_ln137_fu_95_p2;
        rcon_reg_176 <= grp_aes_expandEncKey_fu_293_p_dout0_1;
    end
end
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln137_reg_162 == 1'd1) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ap_sig_allocacmp_ctx5_load_1 = ctx_ret_reg_171;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ap_sig_allocacmp_rcon_0_load = rcon_reg_176;
    end else begin
        ap_sig_allocacmp_rcon_0_load = rcon_0_fu_44;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (ap_loop_exit_ready == 1'b1) & (icmp_ln137_reg_162 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
...
assign add_ln137_fu_101_p2 = ($signed(ap_sig_allocacmp_i) + $signed(3'd7));
...
assign grp_aes_expandEncKey_fu_293_p_din1 = ap_sig_allocacmp_ctx5_load_1;
assign grp_aes_expandEncKey_fu_293_p_din2 = 10'd512;
assign grp_aes_expandEncKey_fu_293_p_din3 = ap_sig_allocacmp_rcon_0_load;
assign grp_aes_expandEncKey_fu_293_p_start = grp_aes_expandEncKey_fu_65_ap_start_reg;
assign grp_aes_expandEncKey_fu_65_ap_ready = grp_aes_expandEncKey_fu_293_p_ready;
assign icmp_ln137_fu_95_p2 = ((ap_sig_allocacmp_i == 3'd0) ? 1'b1 : 1'b0);
endmodule 
