...
module backprop_backprop_Pipeline_label_19_label_20 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_01951_reload,mux_case_12055_reload,mux_case_22159_reload,mul_ln168,v7_address0,v7_ce0,v7_q0,mux_case_02263_reload,mux_case_12367_reload,mux_case_22471_reload,v2_address0,v2_ce0,v2_q0,v8_address0,v8_ce0,v8_we0,v8_d0,v16_address0,v16_ce0,v16_q0,grp_fu_4472_p_din0,grp_fu_4472_p_din1,grp_fu_4472_p_opcode,grp_fu_4472_p_dout0,grp_fu_4472_p_ce,grp_fu_4480_p_din0,grp_fu_4480_p_din1,grp_fu_4480_p_dout0,grp_fu_4480_p_ce);  
...
reg   [6:0] v110_fu_92;
reg   [7:0] indvar_flatten19_fu_96;
...
#0 v111_fu_88 = 2'd0;
#0 v110_fu_92 = 7'd0;
#0 indvar_flatten19_fu_96 = 8'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U213(.din0(mux_case_01951_reload),.din1(mux_case_12055_reload),.din2(mux_case_22159_reload),.def(v112_fu_287_p7),.sel(select_ln190_reg_516),.dout(v112_fu_287_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U214(.din0(mux_case_02263_reload),.din1(mux_case_12367_reload),.din2(mux_case_22471_reload),.def(v116_fu_385_p7),.sel(select_ln190_reg_516_pp0_iter1_reg),.dout(v116_fu_385_p9));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln190_fu_224_p2 == 1'd0))) begin
            indvar_flatten19_fu_96 <= add_ln190_fu_230_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten19_fu_96 <= 8'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            v120_fu_84 <= grp_fu_4472_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten19_load = indvar_flatten19_fu_96;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln190_fu_230_p2 = (ap_sig_allocacmp_indvar_flatten19_load + 8'd1);
...
assign bitcast_ln196_fu_363_p1 = grp_fu_4472_p_dout0;
assign grp_fu_4472_p_ce = 1'b1;
assign grp_fu_4472_p_din0 = grp_fu_193_p0;
assign grp_fu_4472_p_din1 = grp_fu_193_p1;
assign grp_fu_4472_p_opcode = grp_fu_193_opcode;
assign grp_fu_4480_p_ce = 1'b1;
assign grp_fu_4480_p_din0 = grp_fu_197_p0;
assign grp_fu_4480_p_din1 = grp_fu_197_p1;
assign icmp_ln190_fu_224_p2 = ((ap_sig_allocacmp_indvar_flatten19_load == 8'd192) ? 1'b1 : 1'b0);
