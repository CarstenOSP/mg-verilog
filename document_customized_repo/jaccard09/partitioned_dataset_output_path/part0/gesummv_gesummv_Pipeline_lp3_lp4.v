...
reg   [0:0] first_iter_1_reg_800;
reg   [0:0] first_iter_1_reg_800_pp0_iter1_reg;
wire   [2:0] lshr_ln6_6_fu_507_p4;
reg   [2:0] lshr_ln6_6_reg_804;
...
reg   [12:0] indvar_flatten10_fu_120;
wire   [12:0] add_ln31_1_fu_478_p2;
reg   [12:0] ap_sig_allocacmp_indvar_flatten10_load;
...
#0 j_fu_112 = 7'd0;
#0 i_2_fu_116 = 7'd0;
#0 indvar_flatten10_fu_120 = 13'd0;
...
sparsemux_17_3_32_1_1_U65(.din0(buff_x_q0),.din1(buff_x_1_q0),.din2(buff_x_2_q0),.din3(buff_x_3_q0),.din4(buff_x_4_q0),.din5(buff_x_5_q0),.din6(buff_x_6_q0),.din7(buff_x_7_q0),.def(tmp_4_fu_590_p17),.sel(tmp_4_fu_590_p18),.dout(tmp_4_fu_590_p19));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U66(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.din4(buff_B_4_q0),.din5(buff_B_5_q0),.din6(buff_B_6_q0),.din7(buff_B_7_q0),.def(tmp_3_fu_651_p17),.sel(trunc_ln32_reg_859),.dout(tmp_3_fu_651_p19));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U67(.din0(tmp2_q0),.din1(tmp2_1_q0),.din2(tmp2_2_q0),.din3(tmp2_3_q0),.din4(tmp2_4_q0),.din5(tmp2_5_q0),.din6(tmp2_6_q0),.din7(tmp2_7_q0),.def(tmp_1_fu_701_p17),.sel(trunc_ln31_reg_849),.dout(tmp_1_fu_701_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        if (((ap_enable_reg_pp0_iter1 == 1'b1) & (first_iter_1_reg_800_pp0_iter1_reg == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_472_p2 == 1'd0))) begin
            indvar_flatten10_fu_120 <= add_ln31_1_fu_478_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten10_fu_120 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        j_fu_112 <= add_ln32_fu_630_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add2_reg_978 <= grp_fu_1031_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        first_iter_1_reg_800 <= first_iter_1_fu_501_p2;
        first_iter_1_reg_800_pp0_iter1_reg <= first_iter_1_reg_800;
        ...
        lshr_ln6_6_reg_804 <= {{select_ln6_fu_493_p3[5:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul2_reg_918 <= grp_fu_1035_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        mul3_reg_968 <= grp_fu_1035_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten10_load = 13'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten10_load = indvar_flatten10_fu_120;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln31_1_fu_478_p2 = (ap_sig_allocacmp_indvar_flatten10_load + 13'd1);
...
assign first_iter_1_fu_501_p2 = ((select_ln6_fu_493_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_1031_p_ce = 1'b1;
assign grp_fu_1031_p_din0 = add6815_fu_124;
assign grp_fu_1031_p_din1 = mul3_reg_968;
assign grp_fu_1031_p_opcode = 2'd0;
assign grp_fu_1035_p_ce = 1'b1;
assign grp_fu_1035_p_din0 = grp_fu_450_p0;
assign grp_fu_1035_p_din1 = grp_fu_450_p1;
assign icmp_ln31_fu_472_p2 = ((ap_sig_allocacmp_indvar_flatten10_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln32_1_fu_635_p2 = ((add_ln32_fu_630_p2 == 7'd64) ? 1'b1 : 1'b0);
assign icmp_ln32_fu_487_p2 = ((ap_sig_allocacmp_j_load == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_6_fu_507_p4 = {{select_ln6_fu_493_p3[5:3]}};
assign select_ln31_fu_543_p3 = ((icmp_ln32_reg_789[0:0] == 1'b1) ? add_ln31_fu_537_p2 : i_2_fu_116);
assign select_ln6_fu_493_p3 = ((icmp_ln32_fu_487_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
...
assign tmp_8_fu_571_p3 = {{empty_fu_550_p1}, {lshr_ln6_6_reg_804}};
assign trunc_ln31_fu_554_p1 = select_ln31_fu_543_p3[2:0];
assign trunc_ln32_fu_568_p1 = select_ln6_reg_794[2:0];
assign zext_ln33_fu_578_p1 = tmp_8_fu_571_p3;
assign zext_ln6_1_fu_517_p1 = lshr_ln6_6_fu_507_p4;
