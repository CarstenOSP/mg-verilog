...
wire   [3:0] lshr_ln6_2_fu_167_p4;
wire   [31:0] tmp_s_fu_197_p9;
wire   [1:0] tmp_s_fu_197_p10;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_s_fu_197_p1;
wire   [1:0] tmp_s_fu_197_p3;
wire  signed [1:0] tmp_s_fu_197_p5;
wire  signed [1:0] tmp_s_fu_197_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_2_32_1_1_U13390(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.def(tmp_s_fu_197_p9),.sel(tmp_s_fu_197_p10),.dout(tmp_s_fu_197_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_s_reg_272 <= tmp_s_fu_197_p11;
    end
end
always @ (*) begin
...
assign bitcast_ln36_fu_221_p1 = buff_x1_q0;
assign bitcast_ln37_fu_226_p1 = tmp_s_reg_272;
assign buff_x1_address0 = zext_ln35_fu_190_p1;
assign buff_x1_ce0 = buff_x1_ce0_local;
assign buff_x2_1_address0 = zext_ln6_fu_177_p1;
assign buff_x2_1_ce0 = buff_x2_1_ce0_local;
assign buff_x2_2_address0 = zext_ln6_fu_177_p1;
assign buff_x2_2_ce0 = buff_x2_2_ce0_local;
assign buff_x2_3_address0 = zext_ln6_fu_177_p1;
assign buff_x2_3_ce0 = buff_x2_3_ce0_local;
assign buff_x2_address0 = zext_ln6_fu_177_p1;
assign buff_x2_ce0 = buff_x2_ce0_local;
assign icmp_ln35_fu_155_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_2_fu_167_p4 = {{ap_sig_allocacmp_i_1[5:2]}};
assign tmp_s_fu_197_p10 = i_1_reg_237[1:0];
assign tmp_s_fu_197_p9 = 'bx;
assign x1_out_din = bitcast_ln36_fu_221_p1;
assign x1_out_write = x1_out_write_local;
assign x2_out_din = bitcast_ln37_fu_226_p1;
assign x2_out_write = x2_out_write_local;
assign zext_ln35_fu_190_p1 = i_1_reg_237;
assign zext_ln6_fu_177_p1 = lshr_ln6_2_fu_167_p4;
endmodule 
