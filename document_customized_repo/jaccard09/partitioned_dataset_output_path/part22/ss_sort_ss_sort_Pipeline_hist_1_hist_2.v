...
wire   [31:0] tmp_s_fu_466_p19;
reg   [31:0] tmp_s_reg_705;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_s_fu_466_p1;
wire   [2:0] tmp_s_fu_466_p3;
wire   [2:0] tmp_s_fu_466_p5;
wire   [2:0] tmp_s_fu_466_p7;
wire  signed [2:0] tmp_s_fu_466_p9;
wire  signed [2:0] tmp_s_fu_466_p11;
wire  signed [2:0] tmp_s_fu_466_p13;
wire  signed [2:0] tmp_s_fu_466_p15;
...
sparsemux_17_3_32_1_1_U9(.din0(a_0_q0),.din1(a_1_q0),.din2(a_2_q0),.din3(a_3_q0),.din4(a_4_q0),.din5(a_5_q0),.din6(a_6_q0),.din7(a_7_q0),.def(tmp_s_fu_466_p17),.sel(trunc_ln57_reg_660),.dout(tmp_s_fu_466_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp_s_reg_705 <= tmp_s_fu_466_p19;
    end
end
always @ (*) begin
...
assign add_ln56_fu_416_p2 = (zext_ln55_fu_413_p1 + tmp_2_fu_406_p3);
...
assign ashr_ln57_fu_508_p2 = $signed(tmp_s_reg_705) >>> zext_ln50_cast_reg_624;
assign blockID_cast6_cast10_fu_505_p1 = empty_reg_649;
...
assign bucket_indx_fu_524_p2 = (or_ln57_1_fu_516_p3 + blockID_cast6_cast10_fu_505_p1);
...
assign tmp_2_fu_406_p3 = {{empty_reg_649}, {2'd0}};
assign tmp_s_fu_466_p17 = 'bx;
