...
sparsemux_9_4_8_1_1_U70(.din0(buf_0_i),.din1(buf_4_i),.din2(buf_8_i),.din3(buf_12_i),.def(a_fu_314_p9),.sel(trunc_ln100_fu_310_p1),.dout(a_fu_314_p11));
(* dissolve_hierarchy = "yes" *) aes256_encrypt_ecb_sparsemux_9_4_8_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 8 ),.CASE1( 4'h4 ),.din1_WIDTH( 8 ),.CASE2( 4'h8 ),.din2_WIDTH( 8 ),.CASE3( 4'hC ),.din3_WIDTH( 8 ),.def_WIDTH( 8 ),.sel_WIDTH( 4 ),.dout_WIDTH( 8 ))
sparsemux_9_4_8_1_1_U71(.din0(buf_1_i),.din1(buf_5_i),.din2(buf_9_i),.din3(buf_13_i),.def(b_fu_338_p9),.sel(trunc_ln100_fu_310_p1),.dout(b_fu_338_p11));
(* dissolve_hierarchy = "yes" *) aes256_encrypt_ecb_sparsemux_9_4_8_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 8 ),.CASE1( 4'h4 ),.din1_WIDTH( 8 ),.CASE2( 4'h8 ),.din2_WIDTH( 8 ),.CASE3( 4'hC ),.din3_WIDTH( 8 ),.def_WIDTH( 8 ),.sel_WIDTH( 4 ),.dout_WIDTH( 8 ))
sparsemux_9_4_8_1_1_U72(.din0(buf_2_i),.din1(buf_6_i),.din2(buf_10_i),.din3(buf_14_i),.def(c_fu_362_p9),.sel(trunc_ln100_fu_310_p1),.dout(c_fu_362_p11));
(* dissolve_hierarchy = "yes" *) aes256_encrypt_ecb_sparsemux_9_4_8_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 8 ),.CASE1( 4'h4 ),.din1_WIDTH( 8 ),.CASE2( 4'h8 ),.din2_WIDTH( 8 ),.CASE3( 4'hC ),.din3_WIDTH( 8 ),.def_WIDTH( 8 ),.sel_WIDTH( 4 ),.dout_WIDTH( 8 ))
sparsemux_9_4_8_1_1_U73(.din0(buf_3_i),.din1(buf_7_i),.din2(buf_11_i),.din3(buf_15_i),.def(d_fu_386_p9),.sel(trunc_ln100_fu_310_p1),.dout(d_fu_386_p11));
...
assign add_ln100_fu_616_p2 = (ap_sig_allocacmp_i_5 + 5'd4);
...
assign select_ln55_1_fu_498_p3 = ((tmp_20_fu_478_p3[0:0] == 1'b1) ? xor_ln55_1_fu_492_p2 : shl_ln55_1_fu_486_p2);
assign select_ln55_2_fu_548_p3 = ((tmp_21_fu_528_p3[0:0] == 1'b1) ? xor_ln55_2_fu_542_p2 : shl_ln55_2_fu_536_p2);
assign select_ln55_3_fu_598_p3 = ((tmp_22_fu_578_p3[0:0] == 1'b1) ? xor_ln55_3_fu_592_p2 : shl_ln55_3_fu_586_p2);
assign select_ln55_fu_448_p3 = ((tmp_19_fu_428_p3[0:0] == 1'b1) ? xor_ln55_fu_442_p2 : shl_ln55_fu_436_p2);
...
assign tmp_19_fu_428_p3 = xor_ln103_fu_410_p2[32'd7];
assign tmp_20_fu_478_p3 = xor_ln104_2_fu_472_p2[32'd7];
assign tmp_21_fu_528_p3 = xor_ln105_fu_522_p2[32'd7];
assign tmp_22_fu_578_p3 = xor_ln105_3_fu_572_p2[32'd7];
assign tmp_fu_302_p3 = ap_sig_allocacmp_i_5[32'd4];
assign trunc_ln100_fu_310_p1 = ap_sig_allocacmp_i_5[3:0];
