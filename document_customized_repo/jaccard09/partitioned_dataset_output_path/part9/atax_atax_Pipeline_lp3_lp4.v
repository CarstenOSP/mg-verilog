...
wire   [4:0] lshr_ln5_6_fu_308_p4;
reg   [4:0] lshr_ln5_6_reg_448;
reg   [4:0] lshr_ln5_6_reg_448_pp0_iter1_reg;
wire   [3:0] tmp_5_fu_332_p4;
reg   [3:0] tmp_5_reg_463;
reg   [3:0] tmp_5_reg_463_pp0_iter1_reg;
reg   [3:0] tmp_5_reg_463_pp0_iter2_reg;
wire   [31:0] tmp_1_fu_368_p3;
reg   [31:0] tmp_1_reg_478;
...
wire   [10:0] tmp_4_fu_318_p3;
wire   [10:0] tmp_6_fu_342_p4;
wire   [4:0] or_ln1_fu_390_p3;
reg    ap_done_reg;
...
fadd_32ns_32ns_32_7_full_dsp_1_U15(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_206_p0),.din1(grp_fu_206_p1),.ce(1'b1),.dout(grp_fu_206_p2));
atax_fmul_32ns_32ns_32_4_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 32 ),.din1_WIDTH( 32 ),.dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U17(.clk(ap_clk),.reset(ap_rst),.din0(grp_fu_214_p0),.din1(tmp_1_reg_478),.ce(1'b1),.dout(grp_fu_214_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        indvar_flatten7_fu_72 <= add_ln26_1_fu_242_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            j_fu_64 <= add_ln27_fu_375_p2;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add1_reg_564 <= grp_fu_318_p_dout0;
        add58_1_reg_569 <= grp_fu_206_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add58_2_reg_574 <= grp_fu_318_p_dout0;
        add58_3_reg_579 <= grp_fu_206_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln5_6_reg_448 <= {{select_ln5_fu_268_p3[5:1]}};
        lshr_ln5_6_reg_448_pp0_iter1_reg <= lshr_ln5_6_reg_448;
        select_ln5_reg_428 <= select_ln5_fu_268_p3;
        tmp_5_reg_463 <= {{select_ln5_fu_268_p3[5:2]}};
        tmp_5_reg_463_pp0_iter1_reg <= tmp_5_reg_463;
        tmp_5_reg_463_pp0_iter2_reg <= tmp_5_reg_463_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        mul57_2_reg_544 <= grp_fu_322_p_dout0;
        mul57_3_reg_549 <= grp_fu_214_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mul1_reg_524 <= grp_fu_322_p_dout0;
        mul57_1_reg_539 <= grp_fu_214_p2;
    end
end
always @ (*) begin
...
assign add_ln26_1_fu_242_p2 = (indvar_flatten7_fu_72 + 11'd1);
...
assign grp_fu_318_p_din0 = grp_fu_202_p0;
assign grp_fu_318_p_din1 = grp_fu_202_p1;
assign grp_fu_318_p_opcode = 2'd0;
assign grp_fu_322_p_ce = 1'b1;
assign grp_fu_322_p_din0 = grp_fu_210_p0;
assign grp_fu_322_p_din1 = tmp_1_reg_478;
assign icmp_ln26_fu_236_p2 = ((indvar_flatten7_fu_72 == 11'd1024) ? 1'b1 : 1'b0);
assign lshr_ln5_2_fu_292_p4 = {{select_ln26_fu_276_p3[5:1]}};
assign lshr_ln5_6_fu_308_p4 = {{select_ln5_fu_268_p3[5:1]}};
assign or_ln1_fu_390_p3 = {{tmp_5_reg_463_pp0_iter2_reg}, {1'd1}};
assign select_ln26_fu_276_p3 = ((tmp_fu_260_p3[0:0] == 1'b1) ? add_ln26_fu_254_p2 : i_fu_68);
assign select_ln5_fu_268_p3 = ((tmp_fu_260_p3[0:0] == 1'b1) ? 7'd0 : j_fu_64);
assign tmp1_1_address0 = zext_ln5_fu_302_p1;
assign tmp1_1_ce0 = tmp1_1_ce0_local;
assign tmp1_address0 = zext_ln5_fu_302_p1;
assign tmp1_ce0 = tmp1_ce0_local;
assign tmp_1_fu_368_p3 = ((trunc_ln26_1_reg_433[0:0] == 1'b1) ? tmp1_1_q0 : tmp1_q0);
assign tmp_4_fu_318_p3 = {{trunc_ln26_fu_284_p1}, {lshr_ln5_6_fu_308_p4}};
assign tmp_5_fu_332_p4 = {{select_ln5_fu_268_p3[5:2]}};
assign tmp_6_fu_342_p4 = {{{trunc_ln26_fu_284_p1}, {tmp_5_fu_332_p4}}, {1'd1}};
assign tmp_fu_260_p3 = j_fu_64[32'd6];
assign trunc_ln26_1_fu_288_p1 = select_ln26_fu_276_p3[0:0];
assign trunc_ln26_fu_284_p1 = select_ln26_fu_276_p3[5:0];
assign zext_ln28_1_fu_326_p1 = tmp_4_fu_318_p3;
assign zext_ln28_2_fu_352_p1 = tmp_6_fu_342_p4;
assign zext_ln28_fu_397_p1 = or_ln1_fu_390_p3;
assign zext_ln5_1_fu_385_p1 = lshr_ln5_6_reg_448_pp0_iter1_reg;
