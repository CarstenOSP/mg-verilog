...
wire   [11:0] p_udiv5_fu_176_p2;
reg   [11:0] p_udiv5_reg_242;
...
wire   [63:0] grp_ellpack_Pipeline_ellpack_2_fu_96_sum_1_out;
wire    grp_ellpack_Pipeline_ellpack_2_fu_96_sum_1_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        p_udiv5_reg_242 <= p_udiv5_fu_176_p2;
...
always @ (*) begin
    if (((trunc_ln13_reg_233 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (*) begin
    if (((trunc_ln13_reg_233 == 1'd1) & (1'b1 == ap_CS_fsm_state6))) begin
...
assign bitcast_ln19_fu_189_p1 = grp_ellpack_Pipeline_ellpack_2_fu_96_sum_1_out;
...
assign p_udiv5_fu_176_p2 = (p_shl_fu_172_p1 + zext_ln13_fu_151_p1);
