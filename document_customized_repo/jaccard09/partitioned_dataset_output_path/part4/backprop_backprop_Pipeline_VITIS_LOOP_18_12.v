...
output  [63:0] grp_fu_4820_p_din0;
output  [63:0] grp_fu_4820_p_din1;
input  [63:0] grp_fu_4820_p_dout0;
output   grp_fu_4820_p_ce;
output  [63:0] grp_fu_4824_p_din0;
output  [63:0] grp_fu_4824_p_din1;
...
sparsemux_7_2_64_1_1_U849(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_s_fu_222_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_s_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        dactivations3_reg_366 <= grp_fu_4692_p_dout0;
        ...
        tmp_15_reg_373 <= grp_fu_4824_p_dout0;
...
always @ (*) begin
    if (((i_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_1_o = grp_fu_4820_p_dout0;
    end else begin
...
always @ (*) begin
    if ((~(i_reg_332_pp0_iter87_reg == 2'd0) & ~(i_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_2_o = grp_fu_4820_p_dout0;
    end else begin
...
always @ (*) begin
    if (((i_reg_332_pp0_iter87_reg == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_o = grp_fu_4820_p_dout0;
    end else begin
...
assign grp_fu_4568_p_din0 = tmp_15_reg_373;
assign grp_fu_4568_p_din1 = 64'd4607182418800017408;
assign grp_fu_4568_p_opcode = 2'd0;
assign grp_fu_4692_p_ce = 1'b1;
assign grp_fu_4692_p_din0 = tmp_s_reg_340_pp0_iter8_reg;
assign grp_fu_4692_p_din1 = sub_i1_reg_361;
assign grp_fu_4820_p_ce = 1'b1;
assign grp_fu_4820_p_din0 = 64'd4607182418800017408;
assign grp_fu_4820_p_din1 = add_i2_reg_378;
assign grp_fu_4824_p_ce = 1'b1;
assign grp_fu_4824_p_din0 = 64'd0;
assign grp_fu_4824_p_din1 = bitcast_ln20_1_fu_275_p1;
