...
output  [31:0] D_50_out;
output   D_50_out_ap_vld;
...
wire   [31:0] tmp_1_fu_839_p19;
reg   [31:0] tmp_1_reg_1520;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [4:0] tmp_s_fu_761_p1;
wire   [4:0] tmp_s_fu_761_p3;
wire   [4:0] tmp_s_fu_761_p5;
wire   [4:0] tmp_s_fu_761_p7;
wire  signed [4:0] tmp_s_fu_761_p9;
wire  signed [4:0] tmp_s_fu_761_p11;
wire  signed [4:0] tmp_s_fu_761_p13;
wire  signed [4:0] tmp_s_fu_761_p15;
wire   [4:0] tmp_1_fu_839_p1;
wire   [4:0] tmp_1_fu_839_p3;
wire   [4:0] tmp_1_fu_839_p5;
wire   [4:0] tmp_1_fu_839_p7;
wire  signed [4:0] tmp_1_fu_839_p9;
wire  signed [4:0] tmp_1_fu_839_p11;
wire  signed [4:0] tmp_1_fu_839_p13;
wire  signed [4:0] tmp_1_fu_839_p15;
...
sparsemux_17_5_32_1_1_U191(.din0(W_q0),.din1(W_4_q0),.din2(W_8_q0),.din3(W_12_q0),.din4(W_16_q0),.din5(W_20_q0),.din6(W_24_q0),.din7(W_28_q0),.def(tmp_s_fu_761_p17),.sel(trunc_ln128_fu_758_p1),.dout(tmp_s_fu_761_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U192(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.din4(W_17_q0),.din5(W_21_q0),.din6(W_25_q0),.din7(W_29_q0),.def(tmp_1_fu_839_p17),.sel(trunc_ln128_fu_758_p1),.dout(tmp_1_fu_839_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U193(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.din4(W_18_q0),.din5(W_22_q0),.din6(W_26_q0),.din7(W_30_q0),.def(tmp_2_fu_879_p17),.sel(trunc_ln128_fu_758_p1),.dout(tmp_2_fu_879_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_U194(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.din4(W_19_q0),.din5(W_23_q0),.din6(W_27_q0),.din7(W_31_q0),.def(tmp_3_fu_919_p17),.sel(trunc_ln128_fu_758_p1),.dout(tmp_3_fu_919_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_1_reg_1520 <= tmp_1_fu_839_p19;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln128_reg_1325 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        D_50_out_ap_vld = 1'b1;
    end else begin
        D_50_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln128_reg_1325 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign A_50_out = B_1_fu_168;
assign B_35_out = B_fu_164;
...
assign D_50_out = E_1_fu_160;
assign E_32_out = E_fu_156;
...
assign add_ln130_1_fu_813_p2 = ($signed(tmp_s_fu_761_p19) + $signed(32'd3395469782));
assign add_ln130_2_fu_984_p2 = (add_ln130_1_reg_1500 + or_ln2_fu_976_p3);
assign add_ln130_4_fu_1038_p2 = (or_ln130_2_fu_1025_p3 + xor_ln130_3_fu_1020_p2);
assign add_ln130_5_fu_1033_p2 = ($signed(tmp_1_reg_1520) + $signed(32'd3395469782));
...
assign or_ln2_fu_976_p3 = {{trunc_ln130_fu_962_p1}, {lshr_ln6_fu_966_p4}};
...
assign tmp_1_fu_839_p17 = 'bx;
assign tmp_2_fu_879_p17 = 'bx;
assign tmp_3_fu_919_p17 = 'bx;
assign tmp_s_fu_761_p17 = 'bx;
