...
module sha_stream_sha_transform_Pipeline_trans_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,B_24_reload,B_4_reload,D_24_reload,E_24_reload,E_4_reload,W_address0,W_ce0,W_q0,W_address1,W_ce1,W_q1,W_1_address0,W_1_ce0,W_1_q0,W_1_address1,W_1_ce1,W_1_q1,E_25_out,E_25_out_ap_vld,B_25_out,B_25_out_ap_vld,D_27_out,D_27_out_ap_vld,A_27_out,A_27_out_ap_vld,C_30_out,C_30_out_ap_vld);  
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        B_5_fu_104 <= temp_12_reg_1437;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            B_fu_112 <= B_24_reload;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        E_5_fu_96 <= C_14_fu_987_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_fu_100 <= E_24_reload;
    end else if (((icmp_ln124_reg_1200 == 1'd0) & (1'b0 == ap_block_pp0_stage9_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        lshr_ln126_1_reg_1236 <= {{B_5_fu_104[31:2]}};
...
assign A_27_out = (add_ln126_13_reg_1362 + add_ln126_14_fu_763_p2);
...
assign C_30_out = {{trunc_ln126_7_reg_1344}, {lshr_ln126_7_reg_1349}};
assign D_27_out = D_reg_1331;
...
assign add_ln126_fu_537_p2 = (reg_267 + E_5_fu_96);
...
assign and_ln126_fu_433_p2 = (or_ln126_fu_427_p2 & B_5_fu_104);
...
assign trunc_ln126_1_fu_471_p1 = B_5_fu_104[1:0];
