...
reg   [61:0] tmp_s_fu_626_p4;
wire   [62:0] tmp_1_fu_636_p3;
wire  signed [63:0] sext_ln75_fu_644_p1;
reg   [63:0] tmp_5_fu_648_p3;
...
wire   [0:0] tmp_9_fu_703_p17;
wire   [0:0] tmp_9_fu_703_p19;
...
wire   [2:0] tmp_9_fu_703_p1;
wire   [2:0] tmp_9_fu_703_p3;
wire   [2:0] tmp_9_fu_703_p5;
wire   [2:0] tmp_9_fu_703_p7;
wire  signed [2:0] tmp_9_fu_703_p9;
wire  signed [2:0] tmp_9_fu_703_p11;
wire  signed [2:0] tmp_9_fu_703_p13;
wire  signed [2:0] tmp_9_fu_703_p15;
...
sparsemux_17_3_1_1_1_U37(.din0(1'd0),.din1(1'd1),.din2(1'd1),.din3(1'd0),.din4(1'd0),.din5(1'd1),.din6(1'd1),.din7(1'd0),.def(tmp_9_fu_703_p17),.sel(k_1_reg_1542),.dout(tmp_9_fu_703_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ...
        tmp_4_reg_1616 <= {{x_fu_987_p3[62:56]}};
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        tmp_3_reg_1553 <= {{Mx_bits_2_fu_590_p3[123:63]}};
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state21)) begin
        ...
        tmp_7_reg_1727 <= {{grp_fu_435_p2[97:56]}};
        tmp_8_reg_1737 <= {{grp_fu_439_p2[97:63]}};
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state29)) begin
        ...
        tmp_6_reg_1809 <= {{grp_fu_447_p2[77:63]}};
    end
end
always @ (posedge ap_clk) begin
...
assign A_fu_1023_p3 = {{sin_basis_reg_1587}, {tmp_4_reg_1616}};
...
assign Mx_zeros_fu_656_p1 = tmp_5_fu_648_p3[6:0];
...
assign cos_basis_fu_756_p3 = ((do_cos[0:0] == 1'b1) ? xor_ln242_fu_742_p2 : tmp_9_fu_703_p19);
...
assign grp_fu_423_p00 = tmp_8_reg_1737;
...
assign grp_fu_427_p00 = tmp_7_reg_1727;
...
assign out_bits_6_fu_1247_p3 = {{tmp_6_reg_1809}, {17'd65536}};
...
assign sext_ln75_fu_644_p1 = $signed(tmp_1_fu_636_p3);
...
assign sin_basis_fu_748_p3 = ((do_cos[0:0] == 1'b1) ? tmp_9_fu_703_p19 : xor_ln242_fu_742_p2);
...
always @ (t_fu_619_p3) begin
    for (ap_tvar_int_0 = 62 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 61 - 0) begin
            tmp_s_fu_626_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_s_fu_626_p4[ap_tvar_int_0] = t_fu_619_p3[61 - ap_tvar_int_0];
        end
    end
end
...
assign xor_ln242_fu_742_p2 = (tmp_9_fu_703_p19 ^ 1'd1);
