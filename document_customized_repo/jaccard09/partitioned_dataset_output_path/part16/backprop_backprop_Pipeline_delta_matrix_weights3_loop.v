...
reg   [6:0] i_8_reg_742;
reg   [6:0] i_8_reg_742_pp0_iter1_reg;
reg   [6:0] i_8_reg_742_pp0_iter2_reg;
reg   [6:0] i_8_reg_742_pp0_iter3_reg;
reg   [6:0] i_8_reg_742_pp0_iter4_reg;
reg   [6:0] i_8_reg_742_pp0_iter5_reg;
reg   [6:0] i_8_reg_742_pp0_iter6_reg;
reg   [6:0] i_8_reg_742_pp0_iter7_reg;
...
dmul_64ns_64ns_64_7_max_dsp_1_U376(.clk(ap_clk),.reset(ap_rst),.din0(tmp_51_reg_804),.din1(p_reload),.ce(1'b1),.dout(grp_fu_480_p2));
...
sparsemux_9_3_64_1_1_U377(.din0(activations2_q0),.din1(activations2_2_q0),.din2(activations2_4_q0),.din3(activations2_6_q0),.def(tmp_s_fu_536_p9),.sel(trunc_ln73_fu_533_p1),.dout(tmp_s_fu_536_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h2 ),.din1_WIDTH( 64 ),.CASE2( 3'h4 ),.din2_WIDTH( 64 ),.CASE3( 3'h6 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_9_3_64_1_1_U378(.din0(activations2_1_q0),.din1(activations2_3_q0),.din2(activations2_5_q0),.din3(activations2_7_q0),.def(tmp_51_fu_560_p9),.sel(trunc_ln73_fu_533_p1),.dout(tmp_51_fu_560_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_8_reg_742 <= ap_sig_allocacmp_i_8;
        i_8_reg_742_pp0_iter1_reg <= i_8_reg_742;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_8_reg_742_pp0_iter2_reg <= i_8_reg_742_pp0_iter1_reg;
        i_8_reg_742_pp0_iter3_reg <= i_8_reg_742_pp0_iter2_reg;
        i_8_reg_742_pp0_iter4_reg <= i_8_reg_742_pp0_iter3_reg;
        i_8_reg_742_pp0_iter5_reg <= i_8_reg_742_pp0_iter4_reg;
        i_8_reg_742_pp0_iter6_reg <= i_8_reg_742_pp0_iter5_reg;
        i_8_reg_742_pp0_iter7_reg <= i_8_reg_742_pp0_iter6_reg;
        lshr_ln1_reg_819 <= {{sub_ln75_fu_598_p2[7:3]}};
        mul_16_i_reg_832 <= grp_fu_4241_p_dout0;
        mul_1_1_i_reg_856 <= grp_fu_4253_p_dout0;
        mul_1_2_i_reg_864 <= grp_fu_480_p2;
        mul_1_i_reg_848 <= grp_fu_4249_p_dout0;
        mul_2_i_reg_840 <= grp_fu_4245_p_dout0;
        mul_i3_reg_824 <= grp_fu_4237_p_dout0;
...
assign add_ln73_fu_522_p2 = (ap_sig_allocacmp_i_8 + 7'd2);
...
assign grp_fu_4237_p_din1 = p_reload86;
assign grp_fu_4241_p_ce = 1'b1;
assign grp_fu_4241_p_din0 = tmp_s_reg_797;
assign grp_fu_4241_p_din1 = p_reload85;
assign grp_fu_4245_p_ce = 1'b1;
assign grp_fu_4245_p_din0 = tmp_s_reg_797;
assign grp_fu_4245_p_din1 = p_reload;
assign grp_fu_4249_p_ce = 1'b1;
assign grp_fu_4249_p_din0 = tmp_51_reg_804;
assign grp_fu_4249_p_din1 = p_reload86;
assign grp_fu_4253_p_ce = 1'b1;
assign grp_fu_4253_p_din0 = tmp_51_reg_804;
assign grp_fu_4253_p_din1 = p_reload85;
...
assign lshr_ln_fu_500_p4 = {{ap_sig_allocacmp_i_8[5:3]}};
...
assign tmp_fu_492_p3 = ap_sig_allocacmp_i_8[32'd6];
assign tmp_s_fu_536_p9 = 'bx;
assign trunc_ln73_fu_533_p1 = i_8_reg_742[2:0];
assign trunc_ln75_fu_587_p1 = i_8_reg_742_pp0_iter7_reg[5:0];
...
assign zext_ln75_fu_584_p1 = i_8_reg_742_pp0_iter7_reg;
endmodule 
