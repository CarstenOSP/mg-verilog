...
output  [1:0] grp_fu_26811_p_opcode;
...
sparsemux_9_2_64_1_1_U4306(.din0(v9_q0),.din1(v9_1_q0),.din2(v9_2_q0),.din3(v9_3_q0),.def(v162_fu_340_p9),.sel(v162_fu_340_p10),.dout(v162_fu_340_p11));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U4307(.din0(v164_fu_412_p2),.din1(v164_fu_412_p4),.din2(v164_fu_412_p6),.din3(v164_fu_412_p8),.din4(v164_fu_412_p10),.din5(v164_fu_412_p12),.din6(v164_fu_412_p14),.din7(v164_fu_412_p16),.def(v164_fu_412_p17),.sel(trunc_ln265_1_reg_501_pp0_iter1_reg),.dout(v164_fu_412_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v159_fu_102 <= grp_fu_26811_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v163_reg_576 <= grp_fu_26828_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v165_reg_586 <= grp_fu_26811_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v166_reg_593 <= grp_fu_26828_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ap_sig_allocacmp_v159_load_1 = grp_fu_26811_p_dout0;
    end else begin
...
assign grp_fu_26811_p_din0 = grp_fu_273_p0;
assign grp_fu_26811_p_din1 = grp_fu_273_p1;
assign grp_fu_26811_p_opcode = grp_fu_273_opcode;
assign grp_fu_26828_p_ce = 1'b1;
assign grp_fu_26828_p_din0 = grp_fu_277_p0;
assign grp_fu_26828_p_din1 = grp_fu_277_p1;
assign icmp_ln264_fu_295_p2 = ((ap_sig_allocacmp_v160_1 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln_fu_301_p4 = {{ap_sig_allocacmp_v160_1[5:2]}};
...
assign zext_ln265_fu_311_p1 = lshr_ln_fu_301_p4;
endmodule 
