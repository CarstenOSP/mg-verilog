...
wire   [11:0] tmp_21_fu_378_p5;
wire   [3:0] tmp_22_fu_415_p4;
wire   [11:0] tmp_23_fu_424_p5;
wire   [11:0] tmp_24_fu_440_p5;
wire   [11:0] tmp_25_fu_473_p5;
wire   [11:0] tmp_26_fu_488_p7;
wire   [11:0] tmp_28_fu_516_p5;
wire   [11:0] tmp_29_fu_531_p5;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_fu_341_p3 == 1'd0))) begin
            v60_1_fu_92 <= add_ln98_fu_395_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        lshr_ln98_1_reg_621 <= {{v60_reg_600[5:3]}};
        tmp_9_reg_640 <= v60_reg_600[32'd1];
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
        reg_317 <= grp_fu_402_p_dout0;
        reg_325 <= grp_fu_406_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v102_reg_817 <= grp_fu_410_p_dout0;
        v108_reg_822 <= grp_fu_414_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        v66_reg_742 <= grp_fu_410_p_dout0;
        v69_reg_762 <= v58_1_q0;
        v72_reg_747 <= grp_fu_414_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v78_reg_797 <= grp_fu_410_p_dout0;
        v84_reg_802 <= grp_fu_414_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v90_reg_807 <= grp_fu_410_p_dout0;
        v96_reg_812 <= grp_fu_414_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_402_p_din0 = grp_fu_293_p0;
assign grp_fu_402_p_din1 = grp_fu_293_p1;
assign grp_fu_402_p_opcode = 2'd0;
assign grp_fu_406_p_ce = 1'b1;
assign grp_fu_406_p_din0 = grp_fu_297_p0;
assign grp_fu_406_p_din1 = grp_fu_297_p1;
assign grp_fu_406_p_opcode = 2'd0;
assign grp_fu_410_p_ce = 1'b1;
assign grp_fu_410_p_din0 = grp_fu_301_p0;
assign grp_fu_410_p_din1 = v65_1;
assign grp_fu_414_p_ce = 1'b1;
assign grp_fu_414_p_din0 = grp_fu_305_p0;
assign grp_fu_414_p_din1 = v65_1;
assign tmp_20_fu_368_p4 = {{ap_sig_allocacmp_v60[5:1]}};
assign tmp_21_fu_378_p5 = {{{{tmp_20_fu_368_p4}, {1'd1}}, {tmp_27}}, {1'd1}};
assign tmp_22_fu_415_p4 = {{v60_reg_600[5:2]}};
assign tmp_23_fu_424_p5 = {{{{tmp_22_fu_415_p4}, {2'd2}}, {tmp_27}}, {1'd1}};
assign tmp_24_fu_440_p5 = {{{{tmp_22_fu_415_p4}, {2'd3}}, {tmp_27}}, {1'd1}};
assign tmp_25_fu_473_p5 = {{{{lshr_ln98_1_reg_621}, {3'd4}}, {tmp_27}}, {1'd1}};
assign tmp_26_fu_488_p7 = {{{{{{lshr_ln98_1_reg_621}, {1'd1}}, {tmp_9_reg_640}}, {1'd1}}, {tmp_27}}, {1'd1}};
assign tmp_28_fu_516_p5 = {{{{lshr_ln98_1_reg_621}, {3'd6}}, {tmp_27}}, {1'd1}};
assign tmp_29_fu_531_p5 = {{{{lshr_ln98_1_reg_621}, {3'd7}}, {tmp_27}}, {1'd1}};
assign tmp_fu_341_p3 = ap_sig_allocacmp_v60[32'd6];
assign tmp_s_fu_353_p4 = {{{trunc_ln98_fu_349_p1}, {tmp_27}}, {1'd1}};
...
assign zext_ln145_fu_526_p1 = tmp_28_fu_516_p5;
assign zext_ln152_fu_541_p1 = tmp_29_fu_531_p5;
assign zext_ln98_fu_546_p1 = lshr_ln98_1_reg_621;
endmodule 
