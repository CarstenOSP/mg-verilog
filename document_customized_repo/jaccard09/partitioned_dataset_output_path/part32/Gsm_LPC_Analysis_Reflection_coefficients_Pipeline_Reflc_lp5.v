...
module Gsm_LPC_Analysis_Reflection_coefficients_Pipeline_Reflc_lp5 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,empty_33,zext_ln202,empty,LARc_address0,LARc_ce0,LARc_we0,LARc_d0);  
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            idx159_fu_42 <= add_ln202_fu_107_p2;
        end
    end
end
always @ (posedge ap_clk) begin
...
assign add_ln202_fu_107_p2 = (idx159_fu_42 + 32'd1);
...
assign trunc_ln202_fu_113_p1 = idx159_fu_42[2:0];
