...
sparsemux_9_2_32_1_1_U988(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.def(tmp_4_fu_197_p9),.sel(tmp_4_fu_197_p10),.dout(tmp_4_fu_197_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_4_reg_272 <= tmp_4_fu_197_p11;
    end
end
always @ (*) begin
...
assign bitcast_ln37_fu_226_p1 = tmp_4_reg_272;
