...
module backprop_backprop_Pipeline_VITIS_LOOP_11_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_2977994,mux_case_1976990,mux_case_0975986,activations3_load,activations3_1_load,activations3_2_load,sum_reload,mux_case_2977992_out,mux_case_2977992_out_ap_vld,mux_case_1976988_out,mux_case_1976988_out_ap_vld,mux_case_0975984_out,mux_case_0975984_out_ap_vld,grp_fu_25549_p_din0,grp_fu_25549_p_din1,grp_fu_25549_p_dout0,grp_fu_25549_p_ce,grp_fu_25553_p_din0,grp_fu_25553_p_din1,grp_fu_25553_p_dout0,grp_fu_25553_p_ce);  
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_2977994;
input  [63:0] mux_case_1976990;
input  [63:0] mux_case_0975986;
input  [63:0] activations3_load;
input  [63:0] activations3_1_load;
input  [63:0] activations3_2_load;
input  [63:0] sum_reload;
output  [63:0] mux_case_2977992_out;
output   mux_case_2977992_out_ap_vld;
output  [63:0] mux_case_1976988_out;
output   mux_case_1976988_out_ap_vld;
output  [63:0] mux_case_0975984_out;
output   mux_case_0975984_out_ap_vld;
...
reg ap_idle;
reg mux_case_2977992_out_ap_vld;
reg mux_case_1976988_out_ap_vld;
reg mux_case_0975984_out_ap_vld;
...
reg   [1:0] i_reg_305;
reg   [1:0] i_reg_305_pp0_iter1_reg;
reg   [1:0] i_reg_305_pp0_iter2_reg;
reg   [1:0] i_reg_305_pp0_iter3_reg;
reg   [1:0] i_reg_305_pp0_iter4_reg;
reg   [1:0] i_reg_305_pp0_iter5_reg;
reg   [1:0] i_reg_305_pp0_iter6_reg;
reg   [1:0] i_reg_305_pp0_iter7_reg;
reg   [1:0] i_reg_305_pp0_iter8_reg;
reg   [1:0] i_reg_305_pp0_iter9_reg;
reg   [1:0] i_reg_305_pp0_iter10_reg;
reg   [1:0] i_reg_305_pp0_iter11_reg;
reg   [1:0] i_reg_305_pp0_iter12_reg;
reg   [1:0] i_reg_305_pp0_iter13_reg;
reg   [1:0] i_reg_305_pp0_iter14_reg;
reg   [1:0] i_reg_305_pp0_iter15_reg;
reg   [1:0] i_reg_305_pp0_iter16_reg;
reg   [1:0] i_reg_305_pp0_iter17_reg;
reg   [1:0] i_reg_305_pp0_iter18_reg;
reg   [1:0] i_reg_305_pp0_iter19_reg;
reg   [1:0] i_reg_305_pp0_iter20_reg;
reg   [1:0] i_reg_305_pp0_iter21_reg;
reg   [1:0] i_reg_305_pp0_iter22_reg;
reg   [1:0] i_reg_305_pp0_iter23_reg;
reg   [1:0] i_reg_305_pp0_iter24_reg;
reg   [1:0] i_reg_305_pp0_iter25_reg;
reg   [1:0] i_reg_305_pp0_iter26_reg;
reg   [1:0] i_reg_305_pp0_iter27_reg;
reg   [1:0] i_reg_305_pp0_iter28_reg;
reg   [1:0] i_reg_305_pp0_iter29_reg;
reg   [1:0] i_reg_305_pp0_iter30_reg;
reg   [1:0] i_reg_305_pp0_iter31_reg;
reg   [1:0] i_reg_305_pp0_iter32_reg;
reg   [1:0] i_reg_305_pp0_iter33_reg;
reg   [1:0] i_reg_305_pp0_iter34_reg;
reg   [1:0] i_reg_305_pp0_iter35_reg;
reg   [1:0] i_reg_305_pp0_iter36_reg;
reg   [1:0] i_reg_305_pp0_iter37_reg;
reg   [1:0] i_reg_305_pp0_iter38_reg;
reg   [1:0] i_reg_305_pp0_iter39_reg;
reg   [1:0] i_reg_305_pp0_iter40_reg;
reg   [1:0] i_reg_305_pp0_iter41_reg;
reg   [1:0] i_reg_305_pp0_iter42_reg;
reg   [1:0] i_reg_305_pp0_iter43_reg;
reg   [1:0] i_reg_305_pp0_iter44_reg;
reg   [1:0] i_reg_305_pp0_iter45_reg;
reg   [1:0] i_reg_305_pp0_iter46_reg;
reg   [1:0] i_reg_305_pp0_iter47_reg;
reg   [1:0] i_reg_305_pp0_iter48_reg;
reg   [1:0] i_reg_305_pp0_iter49_reg;
reg   [1:0] i_reg_305_pp0_iter50_reg;
reg   [1:0] i_reg_305_pp0_iter51_reg;
reg   [1:0] i_reg_305_pp0_iter52_reg;
reg   [1:0] i_reg_305_pp0_iter53_reg;
reg   [1:0] i_reg_305_pp0_iter54_reg;
reg   [1:0] i_reg_305_pp0_iter55_reg;
reg   [1:0] i_reg_305_pp0_iter56_reg;
reg   [1:0] i_reg_305_pp0_iter57_reg;
reg   [1:0] i_reg_305_pp0_iter58_reg;
reg   [1:0] i_reg_305_pp0_iter59_reg;
reg   [1:0] i_reg_305_pp0_iter60_reg;
reg   [1:0] i_reg_305_pp0_iter61_reg;
reg   [1:0] i_reg_305_pp0_iter62_reg;
reg   [1:0] i_reg_305_pp0_iter63_reg;
reg   [1:0] i_reg_305_pp0_iter64_reg;
reg   [1:0] i_reg_305_pp0_iter65_reg;
reg   [1:0] i_reg_305_pp0_iter66_reg;
reg   [1:0] i_reg_305_pp0_iter67_reg;
reg   [1:0] i_reg_305_pp0_iter68_reg;
reg   [1:0] i_reg_305_pp0_iter69_reg;
reg   [1:0] i_reg_305_pp0_iter70_reg;
reg   [1:0] i_reg_305_pp0_iter71_reg;
reg   [1:0] i_reg_305_pp0_iter72_reg;
reg   [1:0] i_reg_305_pp0_iter73_reg;
reg   [1:0] i_reg_305_pp0_iter74_reg;
reg   [1:0] i_reg_305_pp0_iter75_reg;
reg   [1:0] i_reg_305_pp0_iter76_reg;
reg   [1:0] i_reg_305_pp0_iter77_reg;
reg   [1:0] i_reg_305_pp0_iter78_reg;
reg   [1:0] i_reg_305_pp0_iter79_reg;
...
reg   [63:0] mux_case_0975984_fu_68;
...
reg   [63:0] mux_case_1976988_fu_72;
reg   [63:0] mux_case_2977992_fu_76;
...
#0 i_12_fu_64 = 2'd0;
#0 mux_case_0975984_fu_68 = 64'd0;
#0 mux_case_1976988_fu_72 = 64'd0;
#0 mux_case_2977992_fu_76 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U2181(.din0(activations3_load),.din1(activations3_1_load),.din2(activations3_2_load),.def(tmp_20_fu_187_p7),.sel(ap_sig_allocacmp_i),.dout(tmp_20_fu_187_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_0975984_fu_68 <= mux_case_0975986;
        end else if (((i_reg_305_pp0_iter79_reg == 2'd0) & (ap_enable_reg_pp0_iter80 == 1'b1))) begin
            mux_case_0975984_fu_68 <= grp_fu_25549_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_1976988_fu_72 <= mux_case_1976990;
        end else if (((i_reg_305_pp0_iter79_reg == 2'd1) & (ap_enable_reg_pp0_iter80 == 1'b1))) begin
            mux_case_1976988_fu_72 <= grp_fu_25549_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_2977992_fu_76 <= mux_case_2977994;
        end else if ((1'b1 == ap_condition_1192)) begin
            mux_case_2977992_fu_76 <= grp_fu_25549_p_dout0;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_reg_305_pp0_iter10_reg <= i_reg_305_pp0_iter9_reg;
        i_reg_305_pp0_iter11_reg <= i_reg_305_pp0_iter10_reg;
        i_reg_305_pp0_iter12_reg <= i_reg_305_pp0_iter11_reg;
        i_reg_305_pp0_iter13_reg <= i_reg_305_pp0_iter12_reg;
        i_reg_305_pp0_iter14_reg <= i_reg_305_pp0_iter13_reg;
        i_reg_305_pp0_iter15_reg <= i_reg_305_pp0_iter14_reg;
        i_reg_305_pp0_iter16_reg <= i_reg_305_pp0_iter15_reg;
        i_reg_305_pp0_iter17_reg <= i_reg_305_pp0_iter16_reg;
        i_reg_305_pp0_iter18_reg <= i_reg_305_pp0_iter17_reg;
        i_reg_305_pp0_iter19_reg <= i_reg_305_pp0_iter18_reg;
        i_reg_305_pp0_iter20_reg <= i_reg_305_pp0_iter19_reg;
        i_reg_305_pp0_iter21_reg <= i_reg_305_pp0_iter20_reg;
        i_reg_305_pp0_iter22_reg <= i_reg_305_pp0_iter21_reg;
        i_reg_305_pp0_iter23_reg <= i_reg_305_pp0_iter22_reg;
        i_reg_305_pp0_iter24_reg <= i_reg_305_pp0_iter23_reg;
        i_reg_305_pp0_iter25_reg <= i_reg_305_pp0_iter24_reg;
        i_reg_305_pp0_iter26_reg <= i_reg_305_pp0_iter25_reg;
        i_reg_305_pp0_iter27_reg <= i_reg_305_pp0_iter26_reg;
        i_reg_305_pp0_iter28_reg <= i_reg_305_pp0_iter27_reg;
        i_reg_305_pp0_iter29_reg <= i_reg_305_pp0_iter28_reg;
        i_reg_305_pp0_iter2_reg <= i_reg_305_pp0_iter1_reg;
        i_reg_305_pp0_iter30_reg <= i_reg_305_pp0_iter29_reg;
        i_reg_305_pp0_iter31_reg <= i_reg_305_pp0_iter30_reg;
        i_reg_305_pp0_iter32_reg <= i_reg_305_pp0_iter31_reg;
        i_reg_305_pp0_iter33_reg <= i_reg_305_pp0_iter32_reg;
        i_reg_305_pp0_iter34_reg <= i_reg_305_pp0_iter33_reg;
        i_reg_305_pp0_iter35_reg <= i_reg_305_pp0_iter34_reg;
        i_reg_305_pp0_iter36_reg <= i_reg_305_pp0_iter35_reg;
        i_reg_305_pp0_iter37_reg <= i_reg_305_pp0_iter36_reg;
        i_reg_305_pp0_iter38_reg <= i_reg_305_pp0_iter37_reg;
        i_reg_305_pp0_iter39_reg <= i_reg_305_pp0_iter38_reg;
        i_reg_305_pp0_iter3_reg <= i_reg_305_pp0_iter2_reg;
        i_reg_305_pp0_iter40_reg <= i_reg_305_pp0_iter39_reg;
        i_reg_305_pp0_iter41_reg <= i_reg_305_pp0_iter40_reg;
        i_reg_305_pp0_iter42_reg <= i_reg_305_pp0_iter41_reg;
        i_reg_305_pp0_iter43_reg <= i_reg_305_pp0_iter42_reg;
        i_reg_305_pp0_iter44_reg <= i_reg_305_pp0_iter43_reg;
        i_reg_305_pp0_iter45_reg <= i_reg_305_pp0_iter44_reg;
        i_reg_305_pp0_iter46_reg <= i_reg_305_pp0_iter45_reg;
        i_reg_305_pp0_iter47_reg <= i_reg_305_pp0_iter46_reg;
        i_reg_305_pp0_iter48_reg <= i_reg_305_pp0_iter47_reg;
        i_reg_305_pp0_iter49_reg <= i_reg_305_pp0_iter48_reg;
        i_reg_305_pp0_iter4_reg <= i_reg_305_pp0_iter3_reg;
        i_reg_305_pp0_iter50_reg <= i_reg_305_pp0_iter49_reg;
        i_reg_305_pp0_iter51_reg <= i_reg_305_pp0_iter50_reg;
        i_reg_305_pp0_iter52_reg <= i_reg_305_pp0_iter51_reg;
        i_reg_305_pp0_iter53_reg <= i_reg_305_pp0_iter52_reg;
        i_reg_305_pp0_iter54_reg <= i_reg_305_pp0_iter53_reg;
        i_reg_305_pp0_iter55_reg <= i_reg_305_pp0_iter54_reg;
        i_reg_305_pp0_iter56_reg <= i_reg_305_pp0_iter55_reg;
        i_reg_305_pp0_iter57_reg <= i_reg_305_pp0_iter56_reg;
        i_reg_305_pp0_iter58_reg <= i_reg_305_pp0_iter57_reg;
        i_reg_305_pp0_iter59_reg <= i_reg_305_pp0_iter58_reg;
        i_reg_305_pp0_iter5_reg <= i_reg_305_pp0_iter4_reg;
        i_reg_305_pp0_iter60_reg <= i_reg_305_pp0_iter59_reg;
        i_reg_305_pp0_iter61_reg <= i_reg_305_pp0_iter60_reg;
        i_reg_305_pp0_iter62_reg <= i_reg_305_pp0_iter61_reg;
        i_reg_305_pp0_iter63_reg <= i_reg_305_pp0_iter62_reg;
        i_reg_305_pp0_iter64_reg <= i_reg_305_pp0_iter63_reg;
        i_reg_305_pp0_iter65_reg <= i_reg_305_pp0_iter64_reg;
        i_reg_305_pp0_iter66_reg <= i_reg_305_pp0_iter65_reg;
        i_reg_305_pp0_iter67_reg <= i_reg_305_pp0_iter66_reg;
        i_reg_305_pp0_iter68_reg <= i_reg_305_pp0_iter67_reg;
        i_reg_305_pp0_iter69_reg <= i_reg_305_pp0_iter68_reg;
        i_reg_305_pp0_iter6_reg <= i_reg_305_pp0_iter5_reg;
        i_reg_305_pp0_iter70_reg <= i_reg_305_pp0_iter69_reg;
        i_reg_305_pp0_iter71_reg <= i_reg_305_pp0_iter70_reg;
        i_reg_305_pp0_iter72_reg <= i_reg_305_pp0_iter71_reg;
        i_reg_305_pp0_iter73_reg <= i_reg_305_pp0_iter72_reg;
        i_reg_305_pp0_iter74_reg <= i_reg_305_pp0_iter73_reg;
        i_reg_305_pp0_iter75_reg <= i_reg_305_pp0_iter74_reg;
        i_reg_305_pp0_iter76_reg <= i_reg_305_pp0_iter75_reg;
        i_reg_305_pp0_iter77_reg <= i_reg_305_pp0_iter76_reg;
        i_reg_305_pp0_iter78_reg <= i_reg_305_pp0_iter77_reg;
        i_reg_305_pp0_iter79_reg <= i_reg_305_pp0_iter78_reg;
        i_reg_305_pp0_iter7_reg <= i_reg_305_pp0_iter6_reg;
        i_reg_305_pp0_iter8_reg <= i_reg_305_pp0_iter7_reg;
        i_reg_305_pp0_iter9_reg <= i_reg_305_pp0_iter8_reg;
        ...
        tmp_21_reg_328 <= grp_fu_25553_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_i = i_12_fu_64;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter79_reg == 1'b1) & (icmp_ln11_reg_309_pp0_iter78_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_0975984_out_ap_vld = 1'b1;
    end else begin
        mux_case_0975984_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter79_reg == 1'b1) & (icmp_ln11_reg_309_pp0_iter78_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_1976988_out_ap_vld = 1'b1;
    end else begin
        mux_case_1976988_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((ap_loop_exit_ready_pp0_iter79_reg == 1'b1) & (icmp_ln11_reg_309_pp0_iter78_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_2977992_out_ap_vld = 1'b1;
    end else begin
        mux_case_2977992_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    case (ap_CS_fsm)
...
assign add_ln11_fu_181_p2 = (ap_sig_allocacmp_i + 2'd1);
...
always @ (*) begin
    ap_condition_1192 = (~(i_reg_305_pp0_iter79_reg == 2'd1) & ~(i_reg_305_pp0_iter79_reg == 2'd0) & (ap_enable_reg_pp0_iter80 == 1'b1));
end
...
assign grp_fu_25549_p_din0 = tmp_21_reg_328;
assign grp_fu_25549_p_din1 = sum_reload;
assign grp_fu_25553_p_ce = 1'b1;
assign grp_fu_25553_p_din0 = 64'd0;
assign grp_fu_25553_p_din1 = bitcast_ln12_1_fu_240_p1;
assign icmp_ln11_fu_175_p2 = ((ap_sig_allocacmp_i == 2'd3) ? 1'b1 : 1'b0);
assign mux_case_0975984_out = mux_case_0975984_fu_68;
assign mux_case_1976988_out = mux_case_1976988_fu_72;
assign mux_case_2977992_out = mux_case_2977992_fu_76;
