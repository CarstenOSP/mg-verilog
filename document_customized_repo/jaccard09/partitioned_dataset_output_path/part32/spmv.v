...
reg    out_r_we0_local;
wire   [63:0] bitcast_ln20_fu_147_p1;
reg    out_r_ce0_local;
reg   [4:0] ap_NS_fsm;
...
spmv_spmv_Pipeline_spmv_2 grp_spmv_Pipeline_spmv_2_fu_94(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_spmv_Pipeline_spmv_2_fu_94_ap_start),.ap_done(grp_spmv_Pipeline_spmv_2_fu_94_ap_done),.ap_idle(grp_spmv_Pipeline_spmv_2_fu_94_ap_idle),.ap_ready(grp_spmv_Pipeline_spmv_2_fu_94_ap_ready),.sext_ln16(tmp_begin_reg_183),.wide_trip_count(tmp_end_reg_188),.val_r_address0(grp_spmv_Pipeline_spmv_2_fu_94_val_r_address0),.val_r_ce0(grp_spmv_Pipeline_spmv_2_fu_94_val_r_ce0),.val_r_q0(val_r_q0),.cols_address0(grp_spmv_Pipeline_spmv_2_fu_94_cols_address0),.cols_ce0(grp_spmv_Pipeline_spmv_2_fu_94_cols_ce0),.cols_q0(cols_q0),.vec_address0(grp_spmv_Pipeline_spmv_2_fu_94_vec_address0),.vec_ce0(grp_spmv_Pipeline_spmv_2_fu_94_vec_ce0),.vec_q0(vec_q0),.sum_out(grp_spmv_Pipeline_spmv_2_fu_94_sum_out),.sum_out_ap_vld(grp_spmv_Pipeline_spmv_2_fu_94_sum_out_ap_vld));
...
assign bitcast_ln20_fu_147_p1 = grp_spmv_Pipeline_spmv_2_fu_94_sum_out;
...
assign out_r_d0 = bitcast_ln20_fu_147_p1;
