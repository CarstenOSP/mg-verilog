...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_11_reg_779 <= v68_reg_722[32'd1];
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        reg_318 <= grp_fu_472_p_dout0;
        reg_323 <= grp_fu_476_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v100_reg_931 <= grp_fu_484_p_dout0;
        v92_reg_926 <= grp_fu_480_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v101_reg_996 <= grp_fu_476_p_dout0;
        v93_reg_991 <= grp_fu_472_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v108_reg_971 <= grp_fu_480_p_dout0;
        v116_reg_976 <= grp_fu_484_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v124_reg_981 <= grp_fu_480_p_dout0;
        v132_reg_986 <= grp_fu_484_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v125_reg_1001 <= grp_fu_472_p_dout0;
        v133_reg_1006 <= grp_fu_476_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v73_reg_861 <= v65_0_q1;
        v76_reg_866 <= grp_fu_480_p_dout0;
        v81_reg_906 <= v65_1_q1;
        v84_reg_871 <= grp_fu_484_p_dout0;
...
assign grp_fu_472_p_din0 = grp_fu_294_p0;
assign grp_fu_472_p_din1 = grp_fu_294_p1;
assign grp_fu_472_p_opcode = 2'd0;
assign grp_fu_476_p_ce = 1'b1;
assign grp_fu_476_p_din0 = grp_fu_298_p0;
assign grp_fu_476_p_din1 = grp_fu_298_p1;
assign grp_fu_476_p_opcode = 2'd0;
assign grp_fu_480_p_ce = 1'b1;
assign grp_fu_480_p_din0 = grp_fu_302_p0;
assign grp_fu_480_p_din1 = grp_fu_302_p1;
assign grp_fu_484_p_ce = 1'b1;
assign grp_fu_484_p_din0 = grp_fu_306_p0;
assign grp_fu_484_p_din1 = grp_fu_306_p1;
...
assign or_ln152_1_fu_585_p4 = {{{tmp_10_reg_769}, {1'd1}}, {tmp_11_reg_779}};
assign or_ln170_1_fu_599_p3 = {{tmp_10_reg_769}, {2'd3}};
assign tmp_12_fu_487_p4 = {{{v67}, {tmp_10_reg_769}}, {3'd4}};
assign tmp_17_fu_500_p6 = {{{{{v67}, {tmp_10_reg_769}}, {1'd1}}, {tmp_11_reg_779}}, {1'd1}};
...
assign v70_out = v66_3_fu_100;
assign v71_fu_469_p3 = ((icmp_ln115_reg_749[0:0] == 1'b1) ? v69 : v66_3_fu_100);
