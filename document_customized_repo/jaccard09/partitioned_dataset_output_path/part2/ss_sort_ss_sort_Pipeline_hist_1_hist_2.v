...
wire   [31:0] tmp_1_fu_466_p19;
reg   [31:0] tmp_1_reg_705;
...
wire   [31:0] tmp_2_fu_551_p19;
reg   [31:0] tmp_2_reg_755;
...
wire  signed [2:0] tmp_2_fu_551_p1;
wire   [2:0] tmp_2_fu_551_p3;
wire   [2:0] tmp_2_fu_551_p5;
wire   [2:0] tmp_2_fu_551_p7;
wire   [2:0] tmp_2_fu_551_p9;
wire  signed [2:0] tmp_2_fu_551_p11;
wire  signed [2:0] tmp_2_fu_551_p13;
wire  signed [2:0] tmp_2_fu_551_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_17_3_32_1_1_U9(.din0(a_0_q0),.din1(a_1_q0),.din2(a_2_q0),.din3(a_3_q0),.din4(a_4_q0),.din5(a_5_q0),.din6(a_6_q0),.din7(a_7_q0),.def(tmp_1_fu_466_p17),.sel(trunc_ln57_reg_660),.dout(tmp_1_fu_466_p19));
...
sparsemux_17_3_32_1_1_U10(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.din4(bucket_4_q0),.din5(bucket_5_q0),.din6(bucket_6_q0),.din7(bucket_7_q0),.def(tmp_2_fu_551_p17),.sel(empty_22_reg_655_pp0_iter1_reg),.dout(tmp_2_fu_551_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_1_reg_705 <= tmp_1_fu_466_p19;
        tmp_2_reg_755 <= tmp_2_fu_551_p19;
    end
end
always @ (*) begin
...
assign add_ln58_fu_590_p2 = (tmp_2_reg_755 + 32'd1);
...
assign ashr_ln57_fu_508_p2 = $signed(tmp_1_reg_705) >>> zext_ln63_cast_reg_624;
assign blockID_cast6_cast11_fu_505_p1 = empty_reg_649;
...
assign bucket_indx_fu_524_p2 = (or_ln57_1_fu_516_p3 + blockID_cast6_cast11_fu_505_p1);
