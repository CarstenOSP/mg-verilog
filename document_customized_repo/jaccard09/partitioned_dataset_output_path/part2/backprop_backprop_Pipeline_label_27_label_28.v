...
output  [1:0] grp_fu_8254_p_opcode;
...
#0 v149_fu_104 = 7'd0;
#0 v146_fu_108 = 4'd0;
#0 indvar_flatten20_fu_112 = 10'd0;
#0 ap_done_reg = 1'b0;
end
backprop_urem_10ns_8ns_10_14_1 #(.ID( 1 ),.NUM_STAGE( 14 ),.din0_WIDTH( 10 ),.din1_WIDTH( 8 ),.dout_WIDTH( 10 ))
urem_10ns_8ns_10_14_1_U1459(.clk(ap_clk),.reset(ap_rst),.din0(add_ln249_reg_537),.din1(grp_fu_340_p1),.ce(1'b1),.dout(grp_fu_340_p2));
backprop_mul_10ns_12ns_21_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.din0_WIDTH( 10 ),.din1_WIDTH( 12 ),.dout_WIDTH( 21 ))
mul_10ns_12ns_21_1_1_U1460(.din0(mul_ln249_fu_348_p0),.din1(mul_ln249_fu_348_p1),.dout(mul_ln249_fu_348_p2));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_3_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 64 ),.CASE1( 3'h1 ),.din1_WIDTH( 64 ),.CASE2( 3'h2 ),.din2_WIDTH( 64 ),.CASE3( 3'h3 ),.din3_WIDTH( 64 ),.CASE4( 3'h4 ),.din4_WIDTH( 64 ),.CASE5( 3'h5 ),.din5_WIDTH( 64 ),.CASE6( 3'h6 ),.din6_WIDTH( 64 ),.CASE7( 3'h7 ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 3 ),.dout_WIDTH( 64 ))
sparsemux_17_3_64_1_1_U1461(.din0(v153_fu_426_p2),.din1(v153_fu_426_p4),.din2(v153_fu_426_p6),.din3(v153_fu_426_p8),.din4(v153_fu_426_p10),.din5(v153_fu_426_p12),.din6(v153_fu_426_p14),.din7(v153_fu_426_p16),.def(v153_fu_426_p17),.sel(trunc_ln249_1_reg_544_pp0_iter1_reg),.dout(v153_fu_426_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        indvar_flatten20_fu_112 <= add_ln243_reg_522;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v148_fu_100 <= grp_fu_8254_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v152_reg_559 <= grp_fu_8266_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v154_reg_609 <= grp_fu_8254_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v155_reg_616 <= grp_fu_8266_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v148_load_1 = grp_fu_8254_p_dout0;
    end else begin
...
assign add_ln243_fu_278_p2 = (ap_sig_allocacmp_indvar_flatten20_load + 10'd1);
...
assign grp_fu_8254_p_din0 = grp_fu_240_p0;
assign grp_fu_8254_p_din1 = grp_fu_240_p1;
assign grp_fu_8254_p_opcode = grp_fu_240_opcode;
assign grp_fu_8266_p_ce = 1'b1;
assign grp_fu_8266_p_din0 = grp_fu_244_p0;
assign grp_fu_8266_p_din1 = grp_fu_244_p1;
assign icmp_ln243_fu_272_p2 = ((ap_sig_allocacmp_indvar_flatten20_load == 10'd832) ? 1'b1 : 1'b0);
