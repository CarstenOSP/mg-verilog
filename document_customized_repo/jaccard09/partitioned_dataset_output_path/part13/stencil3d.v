...
wire   [5:0] tmp_25_fu_472_p3;
reg   [5:0] tmp_25_reg_531;
...
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_done;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_idle;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_ready;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_address0;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_ce0;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_we0;
wire   [31:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_d0;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_address1;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_ce1;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_we1;
wire   [31:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_d1;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_address0;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_ce0;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_we0;
wire   [31:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_d0;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_address1;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_ce1;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_we1;
wire   [31:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_d1;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_address0;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_ce0;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_address1;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_ce1;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_address0;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_ce0;
wire   [9:0] grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_address1;
wire    grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_ce1;
...
reg    grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start_reg;
reg    grp_stencil3d_Pipeline_loop_col_fu_331_ap_start_reg;
wire   [0:0] icmp_ln36_fu_414_p2;
wire    ap_CS_fsm_state8;
reg   [4:0] i_2_fu_124;
wire   [4:0] indvars_iv_next897_fu_428_p2;
reg    C_ce1_local;
reg    C_ce0_local;
wire   [9:0] tmp_20_fu_420_p3;
wire   [9:0] empty_fu_434_p2;
wire   [9:0] empty_34_fu_440_p2;
wire   [0:0] empty_35_fu_468_p1;
reg   [7:0] ap_NS_fsm;
...
#0 grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state5)) begin
            grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start_reg <= 1'b1;
        end else if ((grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_ready == 1'b1)) begin
            grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start_reg <= 1'b0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        i_2_fu_124 <= indvars_iv_next897_fu_428_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        i_reg_513 <= i_2_fu_124;
        tmp_25_reg_531[5] <= tmp_25_fu_472_p3[5];
        tmp_2_reg_521 <= {{empty_fu_434_p2[9:5]}};
        tmp_4_reg_526 <= {{empty_34_fu_440_p2[9:5]}};
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
...
always @ (*) begin
    if ((grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_0_address0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_address0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_0_address1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_address1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_0_ce0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_ce0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_0_ce1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_0_ce1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_15_address0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_address0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_15_address1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_address1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_15_ce0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_ce0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        orig_15_ce1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_orig_15_ce1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        orig_15_ce1 = grp_stencil3d_Pipeline_col_bound_height_fu_223_orig_15_ce1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_0_address1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_address1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_0_ce1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_ce1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_0_d0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_d0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_0_d1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_d1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_0_we0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_we0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_0_we1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_0_we1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_address0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_address0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_address1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_address1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        sol_15_address1 = grp_stencil3d_Pipeline_col_bound_height_fu_223_sol_15_address1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_ce0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_ce0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_ce1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_ce1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_d0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_d0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_d1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_d1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_we0 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_we0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        sol_15_we1 = grp_stencil3d_Pipeline_row_bound_height_fu_291_sol_15_we1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state6))) begin
...
assign empty_34_fu_440_p2 = ($signed(tmp_20_fu_420_p3) + $signed(10'd992));
assign empty_35_fu_468_p1 = i_2_fu_124[0:0];
assign empty_fu_434_p2 = (tmp_20_fu_420_p3 + 10'd32);
...
assign grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start = grp_stencil3d_Pipeline_row_bound_height_fu_291_ap_start_reg;
assign icmp_ln36_fu_414_p2 = ((i_2_fu_124 == 5'd31) ? 1'b1 : 1'b0);
assign indvars_iv_next897_fu_428_p2 = (i_2_fu_124 + 5'd1);
assign tmp_20_fu_420_p3 = {{i_2_fu_124}, {5'd0}};
assign tmp_25_fu_472_p3 = {{empty_35_fu_468_p1}, {5'd0}};
always @ (posedge ap_clk) begin
    tmp_25_reg_531[4:0] <= 5'b00000;
end
endmodule 
