...
module forward_ama_addmuladd_5ns_4ns_4ns_4ns_9_4_1_DSP48_0 (input clk,input rst,input ce,input  [5 - 1:0] in0,input  [4 - 1:0] in1,input  [4 - 1:0] in2,input  [4 - 1:0] in3,output [9 - 1:0]  dout);  
