...
wire   [0:0] icmp_ln113_fu_302_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [3:0] select_ln113_fu_342_p3;
reg   [3:0] select_ln113_reg_502;
reg   [3:0] select_ln113_reg_502_pp0_iter1_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter2_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter3_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter4_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter5_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter6_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter7_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter8_reg;
reg   [3:0] select_ln113_reg_502_pp0_iter9_reg;
...
reg   [3:0] lshr_ln_reg_508_pp0_iter3_reg;
reg   [3:0] lshr_ln_reg_508_pp0_iter4_reg;
reg   [3:0] lshr_ln_reg_508_pp0_iter5_reg;
reg   [3:0] lshr_ln_reg_508_pp0_iter6_reg;
reg   [3:0] lshr_ln_reg_508_pp0_iter7_reg;
reg   [3:0] lshr_ln_reg_508_pp0_iter8_reg;
reg   [3:0] lshr_ln_reg_508_pp0_iter9_reg;
wire   [1:0] empty_fu_397_p1;
reg   [1:0] empty_reg_533;
reg   [63:0] oracle_activations1_load_reg_558;
reg   [63:0] oracle_activations1_load_reg_558_pp0_iter2_reg;
reg   [63:0] oracle_activations1_1_load_reg_563;
reg   [63:0] oracle_activations1_1_load_reg_563_pp0_iter2_reg;
reg   [63:0] oracle_activations1_2_load_reg_568;
reg   [63:0] oracle_activations1_2_load_reg_568_pp0_iter2_reg;
reg   [63:0] oracle_activations1_3_load_reg_573;
reg   [63:0] oracle_activations1_3_load_reg_573_pp0_iter2_reg;
wire   [63:0] tmp_27_fu_435_p11;
reg   [63:0] tmp_27_reg_578;
reg   [63:0] mul_i5_reg_586;
reg   [63:0] mul_1_i2_reg_591;
reg   [63:0] mul_2_i2_reg_596;
reg   [63:0] mul_3_i2_reg_601;
wire   [63:0] zext_ln112_fu_360_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] p_cast_fu_411_p1;
wire   [63:0] zext_ln115_fu_464_p1;
reg   [6:0] j_fu_94;
...
reg   [7:0] indvar_flatten19_fu_102;
wire   [7:0] add_ln113_fu_308_p2;
...
wire   [3:0] add_ln113_1_fu_336_p2;
wire   [6:0] select_ln112_fu_328_p3;
wire   [11:0] zext_ln113_fu_389_p1;
wire   [11:0] arrayidx10_sum_fu_392_p2;
wire   [9:0] tmp_s_fu_401_p4;
wire   [63:0] tmp_27_fu_435_p2;
wire   [63:0] tmp_27_fu_435_p4;
wire   [63:0] tmp_27_fu_435_p6;
wire   [63:0] tmp_27_fu_435_p8;
wire   [63:0] tmp_27_fu_435_p9;
wire   [7:0] add_ln6_fu_458_p3;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_27_fu_435_p1;
wire   [1:0] tmp_27_fu_435_p3;
wire  signed [1:0] tmp_27_fu_435_p5;
wire  signed [1:0] tmp_27_fu_435_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_94 = 7'd0;
#0 i_fu_98 = 4'd0;
#0 indvar_flatten19_fu_102 = 8'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U319(.din0(tmp_27_fu_435_p2),.din1(tmp_27_fu_435_p4),.din2(tmp_27_fu_435_p6),.din3(tmp_27_fu_435_p8),.def(tmp_27_fu_435_p9),.sel(empty_reg_533),.dout(tmp_27_fu_435_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln113_fu_302_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_98 <= select_ln113_fu_342_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln113_fu_302_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten19_fu_102 <= add_ln113_fu_308_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten19_fu_102 <= 8'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        empty_reg_533 <= empty_fu_397_p1;
        lshr_ln_reg_508 <= {{select_ln112_fu_328_p3[5:2]}};
        lshr_ln_reg_508_pp0_iter1_reg <= lshr_ln_reg_508;
        oracle_activations1_1_load_reg_563 <= oracle_activations1_1_q0;
        oracle_activations1_2_load_reg_568 <= oracle_activations1_2_q0;
        oracle_activations1_3_load_reg_573 <= oracle_activations1_3_q0;
        oracle_activations1_load_reg_558 <= oracle_activations1_q0;
        select_ln113_reg_502 <= select_ln113_fu_342_p3;
        select_ln113_reg_502_pp0_iter1_reg <= select_ln113_reg_502;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln_reg_508_pp0_iter3_reg <= lshr_ln_reg_508_pp0_iter2_reg;
        lshr_ln_reg_508_pp0_iter4_reg <= lshr_ln_reg_508_pp0_iter3_reg;
        lshr_ln_reg_508_pp0_iter5_reg <= lshr_ln_reg_508_pp0_iter4_reg;
        lshr_ln_reg_508_pp0_iter6_reg <= lshr_ln_reg_508_pp0_iter5_reg;
        lshr_ln_reg_508_pp0_iter7_reg <= lshr_ln_reg_508_pp0_iter6_reg;
        lshr_ln_reg_508_pp0_iter8_reg <= lshr_ln_reg_508_pp0_iter7_reg;
        lshr_ln_reg_508_pp0_iter9_reg <= lshr_ln_reg_508_pp0_iter8_reg;
        mul_1_i2_reg_591 <= grp_fu_3523_p_dout0;
        mul_2_i2_reg_596 <= grp_fu_3527_p_dout0;
        mul_3_i2_reg_601 <= grp_fu_3531_p_dout0;
        mul_i5_reg_586 <= grp_fu_2070_p_dout0;
        oracle_activations1_1_load_reg_563_pp0_iter2_reg <= oracle_activations1_1_load_reg_563;
        oracle_activations1_2_load_reg_568_pp0_iter2_reg <= oracle_activations1_2_load_reg_568;
        oracle_activations1_3_load_reg_573_pp0_iter2_reg <= oracle_activations1_3_load_reg_573;
        oracle_activations1_load_reg_558_pp0_iter2_reg <= oracle_activations1_load_reg_558;
        select_ln113_reg_502_pp0_iter2_reg <= select_ln113_reg_502_pp0_iter1_reg;
        select_ln113_reg_502_pp0_iter3_reg <= select_ln113_reg_502_pp0_iter2_reg;
        select_ln113_reg_502_pp0_iter4_reg <= select_ln113_reg_502_pp0_iter3_reg;
        select_ln113_reg_502_pp0_iter5_reg <= select_ln113_reg_502_pp0_iter4_reg;
        select_ln113_reg_502_pp0_iter6_reg <= select_ln113_reg_502_pp0_iter5_reg;
        select_ln113_reg_502_pp0_iter7_reg <= select_ln113_reg_502_pp0_iter6_reg;
        select_ln113_reg_502_pp0_iter8_reg <= select_ln113_reg_502_pp0_iter7_reg;
        select_ln113_reg_502_pp0_iter9_reg <= select_ln113_reg_502_pp0_iter8_reg;
        tmp_27_reg_578 <= tmp_27_fu_435_p11;
    end
end
always @ (*) begin
    if (((icmp_ln113_fu_302_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln113_1_fu_336_p2 = (ap_sig_allocacmp_i_load + 4'd1);
assign add_ln113_fu_308_p2 = (ap_sig_allocacmp_indvar_flatten19_load + 8'd1);
assign add_ln114_fu_368_p2 = (select_ln112_fu_328_p3 + 7'd4);
assign add_ln6_fu_458_p3 = {{select_ln113_reg_502_pp0_iter9_reg}, {lshr_ln_reg_508_pp0_iter9_reg}};
...
assign delta_weights1_1_address0 = zext_ln115_fu_464_p1;
assign delta_weights1_1_ce0 = delta_weights1_1_ce0_local;
assign delta_weights1_1_d0 = mul_1_i2_reg_591;
assign delta_weights1_1_we0 = delta_weights1_1_we0_local;
assign delta_weights1_2_address0 = zext_ln115_fu_464_p1;
assign delta_weights1_2_ce0 = delta_weights1_2_ce0_local;
assign delta_weights1_2_d0 = mul_2_i2_reg_596;
assign delta_weights1_2_we0 = delta_weights1_2_we0_local;
assign delta_weights1_3_address0 = zext_ln115_fu_464_p1;
assign delta_weights1_3_ce0 = delta_weights1_3_ce0_local;
assign delta_weights1_3_d0 = mul_3_i2_reg_601;
assign delta_weights1_3_we0 = delta_weights1_3_we0_local;
assign delta_weights1_address0 = zext_ln115_fu_464_p1;
assign delta_weights1_ce0 = delta_weights1_ce0_local;
assign delta_weights1_d0 = mul_i5_reg_586;
...
assign grp_fu_2070_p_din0 = tmp_27_reg_578;
assign grp_fu_2070_p_din1 = oracle_activations1_load_reg_558_pp0_iter2_reg;
assign grp_fu_3523_p_ce = 1'b1;
assign grp_fu_3523_p_din0 = tmp_27_reg_578;
assign grp_fu_3523_p_din1 = oracle_activations1_1_load_reg_563_pp0_iter2_reg;
assign grp_fu_3527_p_ce = 1'b1;
assign grp_fu_3527_p_din0 = tmp_27_reg_578;
assign grp_fu_3527_p_din1 = oracle_activations1_2_load_reg_568_pp0_iter2_reg;
assign grp_fu_3531_p_ce = 1'b1;
assign grp_fu_3531_p_din0 = tmp_27_reg_578;
assign grp_fu_3531_p_din1 = oracle_activations1_3_load_reg_573_pp0_iter2_reg;
assign icmp_ln113_fu_302_p2 = ((ap_sig_allocacmp_indvar_flatten19_load == 8'd208) ? 1'b1 : 1'b0);
assign lshr_ln_fu_350_p4 = {{select_ln112_fu_328_p3[5:2]}};
assign oracle_activations1_1_address0 = zext_ln112_fu_360_p1;
assign oracle_activations1_1_ce0 = oracle_activations1_1_ce0_local;
assign oracle_activations1_2_address0 = zext_ln112_fu_360_p1;
assign oracle_activations1_2_ce0 = oracle_activations1_2_ce0_local;
assign oracle_activations1_3_address0 = zext_ln112_fu_360_p1;
assign oracle_activations1_3_ce0 = oracle_activations1_3_ce0_local;
assign oracle_activations1_address0 = zext_ln112_fu_360_p1;
assign oracle_activations1_ce0 = oracle_activations1_ce0_local;
assign p_cast_fu_411_p1 = tmp_s_fu_401_p4;
assign select_ln112_fu_328_p3 = ((tmp_fu_320_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);
assign select_ln113_fu_342_p3 = ((tmp_fu_320_p3[0:0] == 1'b1) ? add_ln113_1_fu_336_p2 : ap_sig_allocacmp_i_load);
assign tmp_27_fu_435_p2 = training_data_0_q0;
assign tmp_27_fu_435_p4 = training_data_1_q0;
assign tmp_27_fu_435_p6 = training_data_2_q0;
assign tmp_27_fu_435_p8 = training_data_3_q0;
assign tmp_27_fu_435_p9 = 'bx;
assign tmp_fu_320_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_s_fu_401_p4 = {{arrayidx10_sum_fu_392_p2[11:2]}};
assign training_data_0_address0 = p_cast_fu_411_p1;
assign training_data_0_ce0 = training_data_0_ce0_local;
assign training_data_1_address0 = p_cast_fu_411_p1;
assign training_data_1_ce0 = training_data_1_ce0_local;
assign training_data_2_address0 = p_cast_fu_411_p1;
assign training_data_2_ce0 = training_data_2_ce0_local;
assign training_data_3_address0 = p_cast_fu_411_p1;
assign training_data_3_ce0 = training_data_3_ce0_local;
assign zext_ln112_fu_360_p1 = lshr_ln_fu_350_p4;
assign zext_ln113_fu_389_p1 = select_ln113_reg_502;
assign zext_ln115_fu_464_p1 = add_ln6_fu_458_p3;
endmodule 
