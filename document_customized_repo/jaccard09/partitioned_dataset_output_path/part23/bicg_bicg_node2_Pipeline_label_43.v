...
reg   [31:0] reg_304;
reg   [6:0] v68_reg_636;
wire   [4:0] lshr_ln113_1_fu_346_p4;
reg   [4:0] lshr_ln113_1_reg_654;
...
wire   [63:0] zext_ln119_2_fu_341_p1;
...
wire   [4:0] or_ln135_1_fu_554_p3;
wire   [4:0] or_ln153_1_fu_577_p4;
wire   [4:0] or_ln171_1_fu_591_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        lshr_ln113_1_reg_654 <= {{ap_sig_allocacmp_v68[5:1]}};
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        reg_299 <= grp_fu_289_p_dout0;
        reg_304 <= grp_fu_293_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v100_reg_838 <= grp_fu_301_p_dout0;
        v105_reg_843 <= v65_0_q1;
        v113_reg_848 <= v65_1_q1;
        v121_reg_853 <= v65_0_q0;
        v129_reg_858 <= v65_1_q0;
        v92_reg_833 <= grp_fu_297_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v101_reg_888 <= grp_fu_293_p_dout0;
        v93_reg_883 <= grp_fu_289_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v108_reg_863 <= grp_fu_297_p_dout0;
        v116_reg_868 <= grp_fu_301_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v124_reg_873 <= grp_fu_297_p_dout0;
        v132_reg_878 <= grp_fu_301_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v125_reg_893 <= grp_fu_289_p_dout0;
        v133_reg_898 <= grp_fu_293_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v73_reg_773 <= v65_0_q1;
        v76_reg_778 <= grp_fu_297_p_dout0;
        v81_reg_818 <= v65_1_q1;
        v84_reg_783 <= grp_fu_301_p_dout0;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            ...
            v138_address1_local = zext_ln119_2_fu_341_p1;
        end else begin
...
assign add_ln119_fu_335_p2 = (zext_ln119_1 + zext_ln119_fu_331_p1);
...
assign grp_fu_289_p_din0 = grp_fu_275_p0;
assign grp_fu_289_p_din1 = grp_fu_275_p1;
assign grp_fu_289_p_opcode = 2'd0;
assign grp_fu_293_p_ce = 1'b1;
assign grp_fu_293_p_din0 = grp_fu_279_p0;
assign grp_fu_293_p_din1 = grp_fu_279_p1;
assign grp_fu_293_p_opcode = 2'd0;
assign grp_fu_297_p_ce = 1'b1;
assign grp_fu_297_p_din0 = grp_fu_283_p0;
assign grp_fu_297_p_din1 = grp_fu_283_p1;
assign grp_fu_301_p_ce = 1'b1;
assign grp_fu_301_p_din0 = grp_fu_287_p0;
assign grp_fu_301_p_din1 = grp_fu_287_p1;
assign icmp_ln115_fu_373_p2 = ((v68_reg_636 == 7'd0) ? 1'b1 : 1'b0);
assign lshr_ln113_1_fu_346_p4 = {{ap_sig_allocacmp_v68[5:1]}};
assign or_ln135_1_fu_554_p3 = {{tmp_1_reg_669}, {1'd1}};
assign or_ln153_1_fu_577_p4 = {{{tmp_4_reg_700}, {1'd1}}, {tmp_6_reg_713}};
assign or_ln171_1_fu_591_p3 = {{tmp_4_reg_700}, {2'd3}};
assign tmp_1_fu_378_p4 = {{v68_reg_636[5:2]}};
assign tmp_2_fu_387_p5 = {{{{tmp_24}, {1'd1}}, {tmp_1_fu_378_p4}}, {2'd2}};
assign tmp_3_fu_403_p5 = {{{{tmp_24}, {1'd1}}, {tmp_1_fu_378_p4}}, {2'd3}};
assign tmp_4_fu_441_p4 = {{v68_reg_636[5:3]}};
assign tmp_5_fu_450_p5 = {{{{tmp_24}, {1'd1}}, {tmp_4_fu_441_p4}}, {3'd4}};
assign tmp_6_fu_466_p3 = v68_reg_636[32'd1];
assign tmp_7_fu_473_p7 = {{{{{{tmp_24}, {1'd1}}, {tmp_4_fu_441_p4}}, {1'd1}}, {tmp_6_fu_466_p3}}, {1'd1}};
assign tmp_8_fu_509_p5 = {{{{tmp_24}, {1'd1}}, {tmp_4_reg_700}}, {3'd6}};
assign tmp_9_fu_524_p5 = {{{{tmp_24}, {1'd1}}, {tmp_4_reg_700}}, {3'd7}};
assign tmp_s_fu_356_p5 = {{{{tmp_24}, {1'd1}}, {lshr_ln113_1_fu_346_p4}}, {1'd1}};
