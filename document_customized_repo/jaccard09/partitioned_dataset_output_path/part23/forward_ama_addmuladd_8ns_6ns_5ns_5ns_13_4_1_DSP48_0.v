...
module forward_ama_addmuladd_8ns_6ns_5ns_5ns_13_4_1_DSP48_0 (input clk,input rst,input ce,input  [8 - 1:0] in0,input  [6 - 1:0] in1,input  [5 - 1:0] in2,input  [5 - 1:0] in3,output [13 - 1:0]  dout);  
