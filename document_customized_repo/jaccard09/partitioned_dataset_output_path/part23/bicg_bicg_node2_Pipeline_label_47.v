...
reg   [0:0] tmp_192_reg_1244;
reg   [0:0] tmp_192_reg_1244_pp0_iter1_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter2_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter3_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter4_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter5_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter6_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter7_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter8_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter9_reg;
reg   [0:0] tmp_192_reg_1244_pp0_iter10_reg;
reg   [2:0] lshr_ln113_5_reg_1248;
reg   [2:0] lshr_ln113_5_reg_1248_pp0_iter1_reg;
reg   [2:0] lshr_ln113_5_reg_1248_pp0_iter2_reg;
...
sparsemux_17_3_32_1_1_U514(.din0(empty_140),.din1(empty_141),.din2(empty_142),.din3(empty_143),.din4(empty_144),.din5(empty_145),.din6(empty_146),.din7(empty_147),.def(v75_fu_856_p17),.sel(v75_fu_856_p18),.dout(v75_fu_856_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U515(.din0(empty_148),.din1(empty_149),.din2(empty_150),.din3(empty_151),.din4(empty_152),.din5(empty_153),.din6(empty_154),.din7(empty_155),.def(v83_fu_896_p17),.sel(v83_fu_896_p18),.dout(v83_fu_896_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U516(.din0(empty_156),.din1(empty_157),.din2(empty_158),.din3(empty_159),.din4(empty_160),.din5(empty_161),.din6(empty_162),.din7(empty_163),.def(v91_fu_936_p17),.sel(v91_fu_936_p18),.dout(v91_fu_936_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U517(.din0(empty_164),.din1(empty_165),.din2(empty_166),.din3(empty_167),.din4(empty_168),.din5(empty_169),.din6(empty_170),.din7(empty_171),.def(v99_fu_976_p17),.sel(v99_fu_976_p18),.dout(v99_fu_976_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U518(.din0(empty_172),.din1(empty_173),.din2(empty_174),.din3(empty_175),.din4(empty_176),.din5(empty_177),.din6(empty_178),.din7(empty_179),.def(v107_fu_1016_p17),.sel(v107_fu_1016_p18),.dout(v107_fu_1016_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U519(.din0(empty_180),.din1(empty_181),.din2(empty_182),.din3(empty_183),.din4(empty_184),.din5(empty_185),.din6(empty_186),.din7(empty_187),.def(v115_fu_1056_p17),.sel(v115_fu_1056_p18),.dout(v115_fu_1056_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U520(.din0(empty_188),.din1(empty_189),.din2(empty_190),.din3(empty_191),.din4(empty_192),.din5(empty_193),.din6(empty_194),.din7(empty_195),.def(v123_fu_1096_p17),.sel(v123_fu_1096_p18),.dout(v123_fu_1096_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U521(.din0(empty_196),.din1(empty_197),.din2(empty_198),.din3(empty_199),.din4(empty_200),.din5(empty_201),.din6(empty_202),.din7(empty),.def(v131_fu_1136_p17),.sel(v131_fu_1136_p18),.dout(v131_fu_1136_p19));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln113_5_reg_1248_pp0_iter2_reg <= lshr_ln113_5_reg_1248_pp0_iter1_reg;
        tmp_192_reg_1244_pp0_iter10_reg <= tmp_192_reg_1244_pp0_iter9_reg;
        tmp_192_reg_1244_pp0_iter2_reg <= tmp_192_reg_1244_pp0_iter1_reg;
        tmp_192_reg_1244_pp0_iter3_reg <= tmp_192_reg_1244_pp0_iter2_reg;
        tmp_192_reg_1244_pp0_iter4_reg <= tmp_192_reg_1244_pp0_iter3_reg;
        tmp_192_reg_1244_pp0_iter5_reg <= tmp_192_reg_1244_pp0_iter4_reg;
        tmp_192_reg_1244_pp0_iter6_reg <= tmp_192_reg_1244_pp0_iter5_reg;
        tmp_192_reg_1244_pp0_iter7_reg <= tmp_192_reg_1244_pp0_iter6_reg;
        tmp_192_reg_1244_pp0_iter8_reg <= tmp_192_reg_1244_pp0_iter7_reg;
        tmp_192_reg_1244_pp0_iter9_reg <= tmp_192_reg_1244_pp0_iter8_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln113_5_reg_1248 <= {{ap_sig_allocacmp_v68[5:3]}};
        lshr_ln113_5_reg_1248_pp0_iter1_reg <= lshr_ln113_5_reg_1248;
        tmp_192_reg_1244 <= ap_sig_allocacmp_v68[32'd6];
        tmp_192_reg_1244_pp0_iter1_reg <= tmp_192_reg_1244;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter11_reg == 1'b1) & (tmp_192_reg_1244_pp0_iter10_reg == 1'd1))) begin
...
assign v70_5_out = v66_fu_208;
assign v71_fu_1190_p3 = ((icmp_ln115_reg_1253[0:0] == 1'b1) ? v69_5 : v66_fu_208);
...
assign zext_ln113_fu_1209_p1 = lshr_ln113_5_reg_1248_pp0_iter2_reg;
endmodule 
