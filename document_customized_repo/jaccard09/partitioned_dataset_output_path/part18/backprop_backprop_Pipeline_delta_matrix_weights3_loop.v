...
wire   [63:0] tmp_73_fu_960_p19;
reg   [63:0] tmp_73_reg_1289;
...
wire   [3:0] tmp_73_fu_960_p1;
wire   [3:0] tmp_73_fu_960_p3;
wire   [3:0] tmp_73_fu_960_p5;
wire   [3:0] tmp_73_fu_960_p7;
wire  signed [3:0] tmp_73_fu_960_p9;
wire  signed [3:0] tmp_73_fu_960_p11;
wire  signed [3:0] tmp_73_fu_960_p13;
wire  signed [3:0] tmp_73_fu_960_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_4_64_1_1_x_U566(.din0(activations2_q0),.din1(activations2_2_q0),.din2(activations2_4_q0),.din3(activations2_6_q0),.din4(activations2_8_q0),.din5(activations2_10_q0),.din6(activations2_12_q0),.din7(activations2_14_q0),.def(tmp_s_fu_920_p17),.sel(trunc_ln73_fu_917_p1),.dout(tmp_s_fu_920_p19));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_17_4_64_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 64 ),.CASE1( 4'h2 ),.din1_WIDTH( 64 ),.CASE2( 4'h4 ),.din2_WIDTH( 64 ),.CASE3( 4'h6 ),.din3_WIDTH( 64 ),.CASE4( 4'h8 ),.din4_WIDTH( 64 ),.CASE5( 4'hA ),.din5_WIDTH( 64 ),.CASE6( 4'hC ),.din6_WIDTH( 64 ),.CASE7( 4'hE ),.din7_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 4 ),.dout_WIDTH( 64 ))
sparsemux_17_4_64_1_1_x_U567(.din0(activations2_1_q0),.din1(activations2_3_q0),.din2(activations2_5_q0),.din3(activations2_7_q0),.din4(activations2_9_q0),.din5(activations2_11_q0),.din6(activations2_13_q0),.din7(activations2_15_q0),.def(tmp_73_fu_960_p17),.sel(trunc_ln73_fu_917_p1),.dout(tmp_73_fu_960_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_73_reg_1289 <= tmp_73_fu_960_p19;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        mul_16_i_reg_1308 <= grp_fu_5637_p_dout0;
        mul_1_1_i_reg_1344 <= grp_fu_5649_p_dout0;
        mul_1_2_i_reg_1356 <= grp_fu_5653_p_dout0;
        mul_1_i_reg_1332 <= grp_fu_5645_p_dout0;
        mul_2_i_reg_1320 <= grp_fu_5641_p_dout0;
        mul_i3_reg_1296 <= grp_fu_5633_p_dout0;
...
assign grp_fu_5633_p_din0 = tmp_s_reg_1282;
assign grp_fu_5633_p_din1 = p_reload86;
assign grp_fu_5637_p_ce = 1'b1;
assign grp_fu_5637_p_din0 = tmp_s_reg_1282;
assign grp_fu_5637_p_din1 = p_reload85;
assign grp_fu_5641_p_ce = 1'b1;
assign grp_fu_5641_p_din0 = tmp_s_reg_1282;
assign grp_fu_5641_p_din1 = p_reload;
assign grp_fu_5645_p_ce = 1'b1;
assign grp_fu_5645_p_din0 = tmp_73_reg_1289;
assign grp_fu_5645_p_din1 = p_reload86;
assign grp_fu_5649_p_ce = 1'b1;
assign grp_fu_5649_p_din0 = tmp_73_reg_1289;
assign grp_fu_5649_p_din1 = p_reload85;
assign grp_fu_5653_p_ce = 1'b1;
assign grp_fu_5653_p_din0 = tmp_73_reg_1289;
assign grp_fu_5653_p_din1 = p_reload;
