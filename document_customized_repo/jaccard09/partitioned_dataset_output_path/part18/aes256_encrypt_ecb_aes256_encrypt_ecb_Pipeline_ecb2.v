...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ctx_ret_reg_167 <= grp_aes_expandEncKey_fu_412_p_dout0_0;
        icmp_ln137_reg_158 <= icmp_ln137_fu_91_p2;
        rcon_reg_172 <= grp_aes_expandEncKey_fu_412_p_dout0_1;
    end
end
always @ (*) begin
...
assign grp_aes_expandEncKey_fu_412_p_din1 = ap_sig_allocacmp_ctx5_load_1;
assign grp_aes_expandEncKey_fu_412_p_din2 = 10'd512;
assign grp_aes_expandEncKey_fu_412_p_din3 = ap_sig_allocacmp_rcon_0_load;
assign grp_aes_expandEncKey_fu_412_p_start = grp_aes_expandEncKey_fu_63_ap_start_reg;
assign grp_aes_expandEncKey_fu_63_ap_ready = grp_aes_expandEncKey_fu_412_p_ready;
