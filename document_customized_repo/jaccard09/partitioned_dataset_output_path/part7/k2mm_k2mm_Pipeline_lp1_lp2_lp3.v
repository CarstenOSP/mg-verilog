...
wire   [63:0] tmp_68_cast_fu_650_p1;
...
wire   [0:0] empty_26_fu_600_p2;
wire   [6:0] add_ln28_fu_594_p2;
wire   [5:0] trunc_ln28_fu_590_p1;
wire   [2:0] lshr_ln6_1_fu_632_p4;
wire   [8:0] tmp_68_fu_642_p3;
wire   [5:0] trunc_ln28_1_fu_611_p1;
wire   [8:0] tmp_69_fu_662_p3;
wire   [2:0] lshr_ln6_3_fu_682_p4;
wire   [8:0] tmp_71_fu_692_p3;
...
sparsemux_17_3_32_1_1_U595(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.din4(tmp1_4_q0),.din5(tmp1_5_q0),.din6(tmp1_6_q0),.din7(tmp1_7_q0),.def(tmp_fu_739_p17),.sel(trunc_ln28_2_reg_950),.dout(tmp_fu_739_p19));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U596(.din0(buff_A_q0),.din1(buff_A_1_q0),.din2(buff_A_2_q0),.din3(buff_A_3_q0),.din4(buff_A_4_q0),.din5(buff_A_5_q0),.din6(buff_A_6_q0),.din7(buff_A_7_q0),.def(tmp_65_fu_781_p17),.sel(tmp_65_fu_781_p18),.dout(tmp_65_fu_781_p19));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U597(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.din4(buff_B_4_q0),.din5(buff_B_5_q0),.din6(buff_B_6_q0),.din7(buff_B_7_q0),.def(tmp_66_fu_821_p17),.sel(trunc_ln28_2_reg_950),.dout(tmp_66_fu_821_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        add_reg_1110 <= grp_fu_4190_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        mul3_reg_1100 <= grp_fu_4194_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul_reg_1095 <= grp_fu_4194_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_1_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_2_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_3_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_4_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_5_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_6_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_7_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        tmp1_address0_local = tmp_68_cast_fu_650_p1;
    end else begin
...
assign empty_26_fu_600_p2 = (icmp_ln28_reg_928 | and_ln6_reg_935);
assign first_iter_1_fu_622_p2 = ((k_mid2_fu_604_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_4190_p_ce = 1'b1;
assign grp_fu_4190_p_din0 = empty_fu_140;
assign grp_fu_4190_p_din1 = mul3_reg_1100;
assign grp_fu_4190_p_opcode = 2'd0;
assign grp_fu_4194_p_ce = 1'b1;
assign grp_fu_4194_p_din0 = grp_fu_466_p0;
assign grp_fu_4194_p_din1 = grp_fu_466_p1;
...
assign k_mid2_fu_604_p3 = ((empty_26_fu_600_p2[0:0] == 1'b1) ? 7'd0 : k_load_reg_923);
assign lshr_ln6_1_fu_632_p4 = {{select_ln28_fu_615_p3[5:3]}};
assign lshr_ln6_3_fu_682_p4 = {{k_mid2_fu_604_p3[5:3]}};
...
assign tmp_68_cast_fu_650_p1 = tmp_68_fu_642_p3;
assign tmp_68_fu_642_p3 = {{trunc_ln28_fu_590_p1}, {lshr_ln6_1_fu_632_p4}};
assign tmp_69_fu_662_p3 = {{trunc_ln28_1_fu_611_p1}, {lshr_ln6_1_fu_632_p4}};
assign tmp_71_fu_692_p3 = {{trunc_ln28_fu_590_p1}, {lshr_ln6_3_fu_682_p4}};
...
assign zext_ln30_1_fu_700_p1 = tmp_71_fu_692_p3;
assign zext_ln30_fu_670_p1 = tmp_69_fu_662_p3;
endmodule 
