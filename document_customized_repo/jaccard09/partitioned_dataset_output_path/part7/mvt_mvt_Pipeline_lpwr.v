...
sparsemux_17_3_32_1_1_U1952(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.din4(buff_x2_4_q0),.din5(buff_x2_5_q0),.din6(buff_x2_6_q0),.din7(buff_x2_7_q0),.def(tmp_s_fu_269_p17),.sel(tmp_s_fu_269_p18),.dout(tmp_s_fu_269_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_s_reg_380 <= tmp_s_fu_269_p19;
    end
end
always @ (*) begin
...
assign bitcast_ln37_fu_314_p1 = tmp_s_reg_380;
