...
wire   [63:0] grp_bfs_Pipeline_loop_neighbors_fu_156_q_in_29_out;
wire    grp_bfs_Pipeline_loop_neighbors_fu_156_q_in_29_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        q_in_fu_70 <= 64'd2;
    end else if (((1'b1 == ap_CS_fsm_state5) & (grp_bfs_Pipeline_loop_neighbors_fu_156_q_in_29_out_ap_vld == 1'b1))) begin
        q_in_fu_70 <= grp_bfs_Pipeline_loop_neighbors_fu_156_q_in_29_out;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
