...
sparsemux_17_3_32_1_1_U489(.din0(buff_s_out_q0),.din1(buff_s_out_1_q0),.din2(buff_s_out_2_q0),.din3(buff_s_out_3_q0),.din4(buff_s_out_4_q0),.din5(buff_s_out_5_q0),.din6(buff_s_out_6_q0),.din7(buff_s_out_7_q0),.def(tmp_8_fu_269_p17),.sel(tmp_8_fu_269_p18),.dout(tmp_8_fu_269_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_8_reg_375 <= tmp_8_fu_269_p19;
    end
end
always @ (*) begin
...
assign bitcast_ln36_fu_309_p1 = tmp_8_reg_375;
...
assign lshr_ln5_2_fu_235_p4 = {{ap_sig_allocacmp_i_1[5:3]}};
