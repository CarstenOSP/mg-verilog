...
reg   [0:0] targetBlock_reg_284;
wire    ap_CS_fsm_state8;
wire   [31:0] or_ln4_fu_254_p3;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_needwun_Pipeline_pad_a_fu_213_ap_done == 1'b1) & (icmp_ln83_reg_296 == 1'd1) & (1'b1 == ap_CS_fsm_state11))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        if ((targetBlock_reg_284 == 1'd1)) begin
            b_str_idx_reg_98 <= b_str_idx_4_loc_fu_94;
        end else if ((targetBlock_reg_284 == 1'd0)) begin
            b_str_idx_reg_98 <= or_ln4_fu_254_p3;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        icmp_ln83_reg_296 <= icmp_ln83_fu_272_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        targetBlock_reg_284 <= grp_needwun_Pipeline_trace_fu_168_ap_return;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln83_reg_296 == 1'd1) & (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state11 : begin
            if (((grp_needwun_Pipeline_pad_a_fu_213_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state11))) begin
...
assign M_0_address1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_0_address1;
assign M_1_address1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_1_address1;
assign M_2_address1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_2_address1;
assign M_3_address1 = grp_needwun_Pipeline_fill_out_fill_in_fu_132_M_3_address1;
...
always @ (*) begin
    ap_block_state12_on_subcall_done = ((grp_needwun_Pipeline_pad_b_fu_227_ap_done == 1'b0) & (icmp_ln83_reg_296 == 1'd1));
end
...
assign icmp_ln83_fu_272_p2 = (($signed(tmp_fu_262_p4) < $signed(24'd1)) ? 1'b1 : 1'b0);
assign or_ln4_fu_254_p3 = {{tmp_s_fu_244_p4}, {1'd1}};
...
assign tmp_fu_262_p4 = {{b_str_idx_reg_98[31:8]}};
assign tmp_s_fu_244_p4 = {{b_str_idx_4_loc_fu_94[31:1]}};
endmodule 
