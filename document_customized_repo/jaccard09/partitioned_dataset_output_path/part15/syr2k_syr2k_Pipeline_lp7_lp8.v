...
wire   [31:0] tmp_s_fu_705_p19;
reg   [31:0] tmp_s_reg_959;
wire   [31:0] tmp_2_fu_744_p19;
reg   [31:0] tmp_2_reg_964;
wire   [31:0] tmp_3_fu_783_p19;
reg   [31:0] tmp_3_reg_1009;
...
reg   [12:0] indvar_flatten37_fu_136;
...
wire   [2:0] lshr_ln5_4_fu_651_p4;
wire   [8:0] tmp_4_fu_661_p3;
wire   [31:0] tmp_s_fu_705_p17;
wire   [31:0] tmp_2_fu_744_p17;
wire   [31:0] tmp_3_fu_783_p17;
reg    ap_done_reg;
...
wire   [2:0] tmp_s_fu_705_p1;
wire   [2:0] tmp_s_fu_705_p3;
wire   [2:0] tmp_s_fu_705_p5;
wire   [2:0] tmp_s_fu_705_p7;
wire  signed [2:0] tmp_s_fu_705_p9;
wire  signed [2:0] tmp_s_fu_705_p11;
wire  signed [2:0] tmp_s_fu_705_p13;
wire  signed [2:0] tmp_s_fu_705_p15;
wire   [2:0] tmp_2_fu_744_p1;
wire   [2:0] tmp_2_fu_744_p3;
wire   [2:0] tmp_2_fu_744_p5;
wire   [2:0] tmp_2_fu_744_p7;
wire  signed [2:0] tmp_2_fu_744_p9;
wire  signed [2:0] tmp_2_fu_744_p11;
wire  signed [2:0] tmp_2_fu_744_p13;
wire  signed [2:0] tmp_2_fu_744_p15;
wire   [2:0] tmp_3_fu_783_p1;
wire   [2:0] tmp_3_fu_783_p3;
wire   [2:0] tmp_3_fu_783_p5;
wire   [2:0] tmp_3_fu_783_p7;
wire  signed [2:0] tmp_3_fu_783_p9;
wire  signed [2:0] tmp_3_fu_783_p11;
wire  signed [2:0] tmp_3_fu_783_p13;
wire  signed [2:0] tmp_3_fu_783_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_128 = 7'd0;
#0 i_fu_132 = 7'd0;
#0 indvar_flatten37_fu_136 = 13'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U331(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.din4(tmp1_4_q0),.din5(tmp1_5_q0),.din6(tmp1_6_q0),.din7(tmp1_7_q0),.def(tmp_s_fu_705_p17),.sel(trunc_ln46_1_reg_852),.dout(tmp_s_fu_705_p19));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U332(.din0(tmp2_q0),.din1(tmp2_1_q0),.din2(tmp2_2_q0),.din3(tmp2_3_q0),.din4(tmp2_4_q0),.din5(tmp2_5_q0),.din6(tmp2_6_q0),.din7(tmp2_7_q0),.def(tmp_2_fu_744_p17),.sel(trunc_ln46_1_reg_852),.dout(tmp_2_fu_744_p19));
(* dissolve_hierarchy = "yes" *) syr2k_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U333(.din0(buff_C_q0),.din1(buff_C_1_q0),.din2(buff_C_2_q0),.din3(buff_C_3_q0),.din4(buff_C_4_q0),.din5(buff_C_5_q0),.din6(buff_C_6_q0),.din7(buff_C_7_q0),.def(tmp_3_fu_783_p17),.sel(trunc_ln46_1_reg_852_pp0_iter4_reg),.dout(tmp_3_fu_783_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln45_fu_592_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten37_fu_136 <= add_ln45_1_fu_598_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten37_fu_136 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        add3_reg_1024 <= grp_fu_648_p_dout0;
        ...
        mul4_reg_1019 <= grp_fu_644_p_dout0;
        tmp_2_reg_964 <= tmp_2_fu_744_p19;
        tmp_3_reg_1009 <= tmp_3_fu_783_p19;
        tmp_s_reg_959 <= tmp_s_fu_705_p19;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten37_load = indvar_flatten37_fu_136;
    end
end
always @ (*) begin
...
assign add_ln45_1_fu_598_p2 = (ap_sig_allocacmp_indvar_flatten37_load + 13'd1);
...
assign grp_fu_640_p_din0 = tmp_s_reg_959;
assign grp_fu_640_p_din1 = tmp_2_reg_964;
assign grp_fu_640_p_opcode = 2'd0;
assign grp_fu_644_p_ce = 1'b1;
assign grp_fu_644_p_din0 = tmp_3_reg_1009;
assign grp_fu_644_p_din1 = beta;
assign grp_fu_648_p_ce = 1'b1;
assign grp_fu_648_p_din0 = add2_reg_1014;
assign grp_fu_648_p_din1 = mul4_reg_1019;
assign grp_fu_648_p_opcode = 2'd0;
assign icmp_ln45_fu_592_p2 = ((ap_sig_allocacmp_indvar_flatten37_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln46_fu_621_p2 = ((j_fu_128 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln5_4_fu_651_p4 = {{select_ln5_fu_627_p3[5:3]}};
...
assign tmp_2_fu_744_p17 = 'bx;
assign tmp_3_fu_783_p17 = 'bx;
assign tmp_4_fu_661_p3 = {{trunc_ln46_fu_643_p1}, {lshr_ln5_4_fu_651_p4}};
...
assign zext_ln48_fu_669_p1 = tmp_4_fu_661_p3;
always @ (posedge ap_clk) begin
