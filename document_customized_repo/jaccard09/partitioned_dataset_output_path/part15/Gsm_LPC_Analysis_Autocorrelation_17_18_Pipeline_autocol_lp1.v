...
wire   [15:0] temp_94_fu_1534_p3;
reg   [15:0] temp_94_reg_2946;
wire   [15:0] temp_80_fu_1618_p3;
reg   [15:0] temp_80_reg_2952;
wire   [15:0] temp_95_fu_1702_p3;
reg   [15:0] temp_95_reg_2958;
wire   [15:0] temp_82_fu_1786_p3;
reg   [15:0] temp_82_reg_2964;
wire   [15:0] temp_96_fu_1870_p3;
reg   [15:0] temp_96_reg_2970;
wire   [15:0] temp_84_fu_1954_p3;
reg   [15:0] temp_84_reg_2976;
wire   [15:0] temp_97_fu_2038_p3;
reg   [15:0] temp_97_reg_2982;
wire   [15:0] temp_86_fu_2122_p3;
reg   [15:0] temp_86_reg_2988;
wire   [15:0] temp_98_fu_2206_p3;
reg   [15:0] temp_98_reg_2994;
wire   [15:0] temp_88_fu_2290_p3;
reg   [15:0] temp_88_reg_3000;
wire   [15:0] temp_99_fu_2374_p3;
reg   [15:0] temp_99_reg_3006;
wire   [15:0] temp_90_fu_2458_p3;
reg   [15:0] temp_90_reg_3012;
wire   [15:0] temp_100_fu_2542_p3;
reg   [15:0] temp_100_reg_3018;
wire   [15:0] temp_92_fu_2626_p3;
reg   [15:0] temp_92_reg_3024;
wire   [15:0] temp_101_fu_2710_p3;
reg   [15:0] temp_101_reg_3030;
reg   [15:0] temp_101_reg_3030_pp0_iter1_reg;
...
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U2(.din0(s_1_load),.din1(s_17_load),.din2(s_33_load),.din3(s_49_load),.din4(s_65_load),.din5(s_81_load),.din6(s_97_load),.din7(s_113_load),.din8(s_129_load),.din9(s_145_load),.def(a_assign_2_fu_1458_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_2_fu_1458_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U3(.din0(s_2_load),.din1(s_18_load),.din2(s_34_load),.din3(s_50_load),.din4(s_66_load),.din5(s_82_load),.din6(s_98_load),.din7(s_114_load),.din8(s_130_load),.din9(s_146_load),.def(a_assign_3_fu_1542_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_3_fu_1542_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U4(.din0(s_3_load),.din1(s_19_load),.din2(s_35_load),.din3(s_51_load),.din4(s_67_load),.din5(s_83_load),.din6(s_99_load),.din7(s_115_load),.din8(s_131_load),.din9(s_147_load),.def(a_assign_4_fu_1626_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_4_fu_1626_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U5(.din0(s_4_load),.din1(s_20_load),.din2(s_36_load),.din3(s_52_load),.din4(s_68_load),.din5(s_84_load),.din6(s_100_load),.din7(s_116_load),.din8(s_132_load),.din9(s_148_load),.def(a_assign_5_fu_1710_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_5_fu_1710_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U6(.din0(s_5_load),.din1(s_21_load),.din2(s_37_load),.din3(s_53_load),.din4(s_69_load),.din5(s_85_load),.din6(s_101_load),.din7(s_117_load),.din8(s_133_load),.din9(s_149_load),.def(a_assign_6_fu_1794_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_6_fu_1794_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U7(.din0(s_6_load),.din1(s_22_load),.din2(s_38_load),.din3(s_54_load),.din4(s_70_load),.din5(s_86_load),.din6(s_102_load),.din7(s_118_load),.din8(s_134_load),.din9(s_150_load),.def(a_assign_7_fu_1878_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_7_fu_1878_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U8(.din0(s_7_load),.din1(s_23_load),.din2(s_39_load),.din3(s_55_load),.din4(s_71_load),.din5(s_87_load),.din6(s_103_load),.din7(s_119_load),.din8(s_135_load),.din9(s_151_load),.def(a_assign_8_fu_1962_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_8_fu_1962_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U9(.din0(s_8_load),.din1(s_24_load),.din2(s_40_load),.din3(s_56_load),.din4(s_72_load),.din5(s_88_load),.din6(s_104_load),.din7(s_120_load),.din8(s_136_load),.din9(s_152_load),.def(a_assign_9_fu_2046_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_9_fu_2046_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
sparsemux_21_8_16_1_1_U10(.din0(s_9_load),.din1(s_25_load),.din2(s_41_load),.din3(s_57_load),.din4(s_73_load),.din5(s_89_load),.din6(s_105_load),.din7(s_121_load),.din8(s_137_load),.din9(s_153_load),.def(a_assign_1_fu_2130_p21),.sel(ap_sig_allocacmp_k_3),.dout(a_assign_1_fu_2130_p23));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_21_8_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 8'h0 ),.din0_WIDTH( 16 ),.CASE1( 8'h10 ),.din1_WIDTH( 16 ),.CASE2( 8'h20 ),.din2_WIDTH( 16 ),.CASE3( 8'h30 ),.din3_WIDTH( 16 ),.CASE4( 8'h40 ),.din4_WIDTH( 16 ),.CASE5( 8'h50 ),.din5_WIDTH( 16 ),.CASE6( 8'h60 ),.din6_WIDTH( 16 ),.CASE7( 8'h70 ),.din7_WIDTH( 16 ),.CASE8( 8'h80 ),.din8_WIDTH( 16 ),.CASE9( 8'h90 ),.din9_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 8 ),.dout_WIDTH( 16 ))
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        temp_100_reg_3018 <= temp_100_fu_2542_p3;
        temp_101_reg_3030 <= temp_101_fu_2710_p3;
        temp_101_reg_3030_pp0_iter1_reg <= temp_101_reg_3030;
        temp_80_reg_2952 <= temp_80_fu_1618_p3;
        temp_82_reg_2964 <= temp_82_fu_1786_p3;
        temp_84_reg_2976 <= temp_84_fu_1954_p3;
        temp_86_reg_2988 <= temp_86_fu_2122_p3;
        temp_88_reg_3000 <= temp_88_fu_2290_p3;
        temp_90_reg_3012 <= temp_90_fu_2458_p3;
        temp_92_reg_3024 <= temp_92_fu_2626_p3;
        temp_94_reg_2946 <= temp_94_fu_1534_p3;
        temp_95_reg_2958 <= temp_95_fu_1702_p3;
        temp_96_reg_2970 <= temp_96_fu_1870_p3;
        temp_97_reg_2982 <= temp_97_fu_2038_p3;
        temp_98_reg_2994 <= temp_98_fu_2206_p3;
        temp_99_reg_3006 <= temp_99_fu_2374_p3;
...
assign icmp_ln58_10_fu_2831_p2 = (($signed(temp_88_reg_3000) > $signed(smax_15_fu_2825_p3)) ? 1'b1 : 1'b0);
assign icmp_ln58_11_fu_2843_p2 = (($signed(temp_99_reg_3006) > $signed(smax_16_reg_3066)) ? 1'b1 : 1'b0);
assign icmp_ln58_12_fu_2853_p2 = (($signed(temp_90_reg_3012) > $signed(smax_18_fu_2847_p3)) ? 1'b1 : 1'b0);
assign icmp_ln58_13_fu_2875_p2 = (($signed(temp_100_reg_3018) > $signed(smax_19_reg_3072)) ? 1'b1 : 1'b0);
assign icmp_ln58_14_fu_2885_p2 = (($signed(temp_92_reg_3024) > $signed(smax_21_fu_2879_p3)) ? 1'b1 : 1'b0);
assign icmp_ln58_15_fu_2897_p2 = (($signed(temp_101_reg_3030_pp0_iter1_reg) > $signed(smax_22_reg_3078)) ? 1'b1 : 1'b0);
assign icmp_ln58_1_fu_2733_p2 = (($signed(temp_94_reg_2946) > $signed(smax_1_reg_3036)) ? 1'b1 : 1'b0);
assign icmp_ln58_2_fu_2743_p2 = (($signed(temp_80_reg_2952) > $signed(smax_3_fu_2737_p3)) ? 1'b1 : 1'b0);
assign icmp_ln58_3_fu_2755_p2 = (($signed(temp_95_reg_2958) > $signed(smax_4_reg_3042)) ? 1'b1 : 1'b0);
assign icmp_ln58_4_fu_2765_p2 = (($signed(temp_82_reg_2964) > $signed(smax_6_fu_2759_p3)) ? 1'b1 : 1'b0);
assign icmp_ln58_5_fu_2777_p2 = (($signed(temp_96_reg_2970) > $signed(smax_7_reg_3048)) ? 1'b1 : 1'b0);
assign icmp_ln58_6_fu_2787_p2 = (($signed(temp_84_reg_2976) > $signed(smax_9_fu_2781_p3)) ? 1'b1 : 1'b0);
assign icmp_ln58_7_fu_2799_p2 = (($signed(temp_97_reg_2982) > $signed(smax_10_reg_3054)) ? 1'b1 : 1'b0);
assign icmp_ln58_8_fu_2809_p2 = (($signed(temp_86_reg_2988) > $signed(smax_12_fu_2803_p3)) ? 1'b1 : 1'b0);
assign icmp_ln58_9_fu_2821_p2 = (($signed(temp_98_reg_2994) > $signed(smax_13_reg_3060)) ? 1'b1 : 1'b0);
...
assign smax_10_fu_2792_p3 = ((icmp_ln58_6_fu_2787_p2[0:0] == 1'b1) ? temp_84_reg_2976 : smax_9_fu_2781_p3);
assign smax_12_fu_2803_p3 = ((icmp_ln58_7_fu_2799_p2[0:0] == 1'b1) ? temp_97_reg_2982 : smax_10_reg_3054);
assign smax_13_fu_2814_p3 = ((icmp_ln58_8_fu_2809_p2[0:0] == 1'b1) ? temp_86_reg_2988 : smax_12_fu_2803_p3);
assign smax_15_fu_2825_p3 = ((icmp_ln58_9_fu_2821_p2[0:0] == 1'b1) ? temp_98_reg_2994 : smax_13_reg_3060);
assign smax_16_fu_2836_p3 = ((icmp_ln58_10_fu_2831_p2[0:0] == 1'b1) ? temp_88_reg_3000 : smax_15_fu_2825_p3);
assign smax_18_fu_2847_p3 = ((icmp_ln58_11_fu_2843_p2[0:0] == 1'b1) ? temp_99_reg_3006 : smax_16_reg_3066);
assign smax_19_fu_2858_p3 = ((icmp_ln58_12_fu_2853_p2[0:0] == 1'b1) ? temp_90_reg_3012 : smax_18_fu_2847_p3);
assign smax_1_fu_2726_p3 = ((icmp_ln58_fu_2721_p2[0:0] == 1'b1) ? temp_reg_2940 : ap_sig_allocacmp_smax_load_1);
assign smax_21_fu_2879_p3 = ((icmp_ln58_13_fu_2875_p2[0:0] == 1'b1) ? temp_100_reg_3018 : smax_19_reg_3072);
assign smax_22_fu_2890_p3 = ((icmp_ln58_14_fu_2885_p2[0:0] == 1'b1) ? temp_92_reg_3024 : smax_21_fu_2879_p3);
assign smax_24_fu_2901_p3 = ((icmp_ln58_15_fu_2897_p2[0:0] == 1'b1) ? temp_101_reg_3030_pp0_iter1_reg : smax_22_reg_3078);
assign smax_3_fu_2737_p3 = ((icmp_ln58_1_fu_2733_p2[0:0] == 1'b1) ? temp_94_reg_2946 : smax_1_reg_3036);
assign smax_4_fu_2748_p3 = ((icmp_ln58_2_fu_2743_p2[0:0] == 1'b1) ? temp_80_reg_2952 : smax_3_fu_2737_p3);
assign smax_6_fu_2759_p3 = ((icmp_ln58_3_fu_2755_p2[0:0] == 1'b1) ? temp_95_reg_2958 : smax_4_reg_3042);
assign smax_7_fu_2770_p3 = ((icmp_ln58_4_fu_2765_p2[0:0] == 1'b1) ? temp_82_reg_2964 : smax_6_fu_2759_p3);
assign smax_9_fu_2781_p3 = ((icmp_ln58_5_fu_2777_p2[0:0] == 1'b1) ? temp_96_reg_2970 : smax_7_reg_3048);
...
assign temp_100_fu_2542_p3 = ((tmp_52_fu_2514_p3[0:0] == 1'b1) ? select_ln69_13_fu_2534_p3 : a_assign_13_fu_2466_p23);
assign temp_101_fu_2710_p3 = ((tmp_54_fu_2682_p3[0:0] == 1'b1) ? select_ln69_15_fu_2702_p3 : a_assign_15_fu_2634_p23);
assign temp_80_fu_1618_p3 = ((tmp_41_fu_1590_p3[0:0] == 1'b1) ? select_ln69_2_fu_1610_p3 : a_assign_3_fu_1542_p23);
assign temp_82_fu_1786_p3 = ((tmp_43_fu_1758_p3[0:0] == 1'b1) ? select_ln69_4_fu_1778_p3 : a_assign_5_fu_1710_p23);
assign temp_84_fu_1954_p3 = ((tmp_45_fu_1926_p3[0:0] == 1'b1) ? select_ln69_6_fu_1946_p3 : a_assign_7_fu_1878_p23);
assign temp_86_fu_2122_p3 = ((tmp_47_fu_2094_p3[0:0] == 1'b1) ? select_ln69_8_fu_2114_p3 : a_assign_9_fu_2046_p23);
assign temp_88_fu_2290_p3 = ((tmp_49_fu_2262_p3[0:0] == 1'b1) ? select_ln69_10_fu_2282_p3 : a_assign_10_fu_2214_p23);
assign temp_90_fu_2458_p3 = ((tmp_51_fu_2430_p3[0:0] == 1'b1) ? select_ln69_12_fu_2450_p3 : a_assign_12_fu_2382_p23);
assign temp_92_fu_2626_p3 = ((tmp_53_fu_2598_p3[0:0] == 1'b1) ? select_ln69_14_fu_2618_p3 : a_assign_14_fu_2550_p23);
assign temp_94_fu_1534_p3 = ((tmp_40_fu_1506_p3[0:0] == 1'b1) ? select_ln69_1_fu_1526_p3 : a_assign_2_fu_1458_p23);
assign temp_95_fu_1702_p3 = ((tmp_42_fu_1674_p3[0:0] == 1'b1) ? select_ln69_3_fu_1694_p3 : a_assign_4_fu_1626_p23);
assign temp_96_fu_1870_p3 = ((tmp_44_fu_1842_p3[0:0] == 1'b1) ? select_ln69_5_fu_1862_p3 : a_assign_6_fu_1794_p23);
assign temp_97_fu_2038_p3 = ((tmp_46_fu_2010_p3[0:0] == 1'b1) ? select_ln69_7_fu_2030_p3 : a_assign_8_fu_1962_p23);
assign temp_98_fu_2206_p3 = ((tmp_48_fu_2178_p3[0:0] == 1'b1) ? select_ln69_9_fu_2198_p3 : a_assign_1_fu_2130_p23);
assign temp_99_fu_2374_p3 = ((tmp_50_fu_2346_p3[0:0] == 1'b1) ? select_ln69_11_fu_2366_p3 : a_assign_11_fu_2298_p23);
assign temp_fu_1450_p3 = ((tmp_fu_1422_p3[0:0] == 1'b1) ? select_ln69_fu_1442_p3 : a_assign_s_fu_1374_p23);
assign tmp_40_fu_1506_p3 = a_assign_2_fu_1458_p23[32'd15];
assign tmp_41_fu_1590_p3 = a_assign_3_fu_1542_p23[32'd15];
assign tmp_42_fu_1674_p3 = a_assign_4_fu_1626_p23[32'd15];
assign tmp_43_fu_1758_p3 = a_assign_5_fu_1710_p23[32'd15];
assign tmp_44_fu_1842_p3 = a_assign_6_fu_1794_p23[32'd15];
assign tmp_45_fu_1926_p3 = a_assign_7_fu_1878_p23[32'd15];
assign tmp_46_fu_2010_p3 = a_assign_8_fu_1962_p23[32'd15];
assign tmp_47_fu_2094_p3 = a_assign_9_fu_2046_p23[32'd15];
assign tmp_48_fu_2178_p3 = a_assign_1_fu_2130_p23[32'd15];
