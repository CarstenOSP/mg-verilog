...
module k2mm_k2mm_Pipeline_lp7_lp8 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_D_address0,buff_D_ce0,buff_D_q0,buff_D_address1,buff_D_ce1,buff_D_q1,buff_E_out_address0,buff_E_out_ce0,buff_E_out_we0,buff_E_out_d0,buff_E_out_address1,buff_E_out_ce1,buff_E_out_we1,buff_E_out_d1,tmp2_address0,tmp2_ce0,tmp2_q0,tmp2_address1,tmp2_ce1,tmp2_q1,beta,grp_fu_1145_p_din0,grp_fu_1145_p_din1,grp_fu_1145_p_opcode,grp_fu_1145_p_dout0,grp_fu_1145_p_ce,grp_fu_1153_p_din0,grp_fu_1153_p_din1,grp_fu_1153_p_opcode,grp_fu_1153_p_dout0,grp_fu_1153_p_ce,grp_fu_1149_p_din0,grp_fu_1149_p_din1,grp_fu_1149_p_dout0,grp_fu_1149_p_ce,grp_fu_1157_p_din0,grp_fu_1157_p_din1,grp_fu_1157_p_dout0,grp_fu_1157_p_ce);  
...
output  [1:0] grp_fu_1153_p_opcode;
...
output  [31:0] grp_fu_1157_p_din0;
output  [31:0] grp_fu_1157_p_din1;
input  [31:0] grp_fu_1157_p_dout0;
...
reg   [11:0] indvar_flatten547_fu_66;
wire   [11:0] add_ln43_1_fu_191_p2;
reg   [11:0] ap_sig_allocacmp_indvar_flatten547_load;
...
#0 j_fu_58 = 7'd0;
#0 i_fu_62 = 7'd0;
#0 indvar_flatten547_fu_66 = 12'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln43_fu_185_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten547_fu_66 <= add_ln43_1_fu_191_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten547_fu_66 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add127_1_reg_416 <= grp_fu_1153_p_dout0;
        add2_reg_411 <= grp_fu_1145_p_dout0;
        ...
        mul126_1_reg_406 <= grp_fu_1157_p_dout0;
        mul3_reg_396 <= grp_fu_1149_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_1_reg_344 <= {{select_ln6_fu_217_p3[5:1]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten547_load = 12'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten547_load = indvar_flatten547_fu_66;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln43_1_fu_191_p2 = (ap_sig_allocacmp_indvar_flatten547_load + 12'd1);
assign add_ln43_fu_203_p2 = (ap_sig_allocacmp_i_load + 7'd1);
assign add_ln44_fu_247_p2 = (select_ln6_fu_217_p3 + 7'd2);
assign add_ln45_fu_278_p2 = (tmp_s_fu_268_p3 + zext_ln45_fu_275_p1);
...
assign grp_fu_1145_p_din0 = empty_reg_391;
assign grp_fu_1145_p_din1 = mul3_reg_396;
assign grp_fu_1145_p_opcode = 2'd0;
assign grp_fu_1149_p_ce = 1'b1;
assign grp_fu_1149_p_din0 = buff_D_load_reg_371;
assign grp_fu_1149_p_din1 = beta;
assign grp_fu_1153_p_ce = 1'b1;
assign grp_fu_1153_p_din0 = empty_11_reg_401;
assign grp_fu_1153_p_din1 = mul126_1_reg_406;
assign grp_fu_1153_p_opcode = 2'd0;
assign grp_fu_1157_p_ce = 1'b1;
assign grp_fu_1157_p_din0 = buff_D_load_1_reg_376;
assign grp_fu_1157_p_din1 = beta;
assign icmp_ln43_fu_185_p2 = ((ap_sig_allocacmp_indvar_flatten547_load == 12'd2048) ? 1'b1 : 1'b0);
...
assign tmp_2_fu_289_p4 = {{{trunc_ln45_reg_338}, {tmp_1_reg_344}}, {1'd1}};
assign tmp_fu_209_p3 = ap_sig_allocacmp_j_load[32'd6];
assign tmp_s_fu_268_p3 = {{trunc_ln45_reg_338}, {6'd0}};
assign trunc_ln45_fu_233_p1 = select_ln43_fu_225_p3[5:0];
assign zext_ln45_1_fu_297_p1 = tmp_2_fu_289_p4;
