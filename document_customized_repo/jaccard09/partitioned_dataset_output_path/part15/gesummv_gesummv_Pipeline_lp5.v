...
wire   [31:0] tmp_4_fu_479_p19;
reg   [31:0] tmp_4_reg_694;
wire   [31:0] tmp_5_fu_518_p19;
...
wire   [31:0] tmp_4_fu_479_p17;
wire   [31:0] tmp_5_fu_518_p17;
reg    ap_done_reg;
...
wire   [2:0] tmp_4_fu_479_p1;
wire   [2:0] tmp_4_fu_479_p3;
wire   [2:0] tmp_4_fu_479_p5;
wire   [2:0] tmp_4_fu_479_p7;
wire  signed [2:0] tmp_4_fu_479_p9;
wire  signed [2:0] tmp_4_fu_479_p11;
wire  signed [2:0] tmp_4_fu_479_p13;
wire  signed [2:0] tmp_4_fu_479_p15;
wire   [2:0] tmp_5_fu_518_p1;
wire   [2:0] tmp_5_fu_518_p3;
wire   [2:0] tmp_5_fu_518_p5;
wire   [2:0] tmp_5_fu_518_p7;
wire  signed [2:0] tmp_5_fu_518_p9;
wire  signed [2:0] tmp_5_fu_518_p11;
wire  signed [2:0] tmp_5_fu_518_p13;
wire  signed [2:0] tmp_5_fu_518_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U340(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.din4(tmp1_4_q0),.din5(tmp1_5_q0),.din6(tmp1_6_q0),.din7(tmp1_7_q0),.def(tmp_4_fu_479_p17),.sel(trunc_ln37_reg_568),.dout(tmp_4_fu_479_p19));
(* dissolve_hierarchy = "yes" *) gesummv_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U341(.din0(tmp2_q0),.din1(tmp2_1_q0),.din2(tmp2_2_q0),.din3(tmp2_3_q0),.din4(tmp2_4_q0),.din5(tmp2_5_q0),.din6(tmp2_6_q0),.din7(tmp2_7_q0),.def(tmp_5_fu_518_p17),.sel(trunc_ln37_reg_568),.dout(tmp_5_fu_518_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_4_reg_694 <= tmp_4_fu_479_p19;
        tmp_5_reg_699 <= tmp_5_fu_518_p19;
...
assign grp_fu_2299_p_din0 = tmp_4_reg_694;
assign grp_fu_2299_p_din1 = tmp_5_reg_699;
...
assign tmp_4_fu_479_p17 = 'bx;
assign tmp_5_fu_518_p17 = 'bx;
