...
module backprop_backprop_Pipeline_VITIS_LOOP_18_12 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,dactivations3_2,dactivations3_1,dactivations3,activations3_i,activations3_o,activations3_o_ap_vld,activations3_2_i,activations3_2_o,activations3_2_o_ap_vld,activations3_1_i,activations3_1_o,activations3_1_o_ap_vld,dactivations3_5_out,dactivations3_5_out_ap_vld,dactivations3_4_out,dactivations3_4_out_ap_vld,dactivations3_3_out,dactivations3_3_out_ap_vld,grp_fu_12037_p_din0,grp_fu_12037_p_din1,grp_fu_12037_p_opcode,grp_fu_12037_p_dout0,grp_fu_12037_p_ce,grp_fu_12041_p_din0,grp_fu_12041_p_din1,grp_fu_12041_p_opcode,grp_fu_12041_p_dout0,grp_fu_12041_p_ce,grp_fu_12293_p_din0,grp_fu_12293_p_din1,grp_fu_12293_p_dout0,grp_fu_12293_p_ce,grp_fu_12549_p_din0,grp_fu_12549_p_din1,grp_fu_12549_p_dout0,grp_fu_12549_p_ce,grp_fu_12553_p_din0,grp_fu_12553_p_din1,grp_fu_12553_p_dout0,grp_fu_12553_p_ce);  
...
output  [63:0] grp_fu_12549_p_din0;
output  [63:0] grp_fu_12549_p_din1;
input  [63:0] grp_fu_12549_p_dout0;
output   grp_fu_12549_p_ce;
output  [63:0] grp_fu_12553_p_din0;
output  [63:0] grp_fu_12553_p_din1;
input  [63:0] grp_fu_12553_p_dout0;
output   grp_fu_12553_p_ce;
reg ap_idle;
...
sparsemux_7_2_64_1_1_U1569(.din0(activations3_i),.din1(activations3_1_i),.din2(activations3_2_i),.def(tmp_s_fu_222_p7),.sel(ap_sig_allocacmp_i_15),.dout(tmp_s_fu_222_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_i2_reg_378 <= grp_fu_12041_p_dout0;
        ...
        dactivations3_6_reg_366 <= grp_fu_12293_p_dout0;
        ...
        sub_i1_reg_361 <= grp_fu_12037_p_dout0;
        tmp_17_reg_373 <= grp_fu_12553_p_dout0;
...
always @ (*) begin
    if (((i_15_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_1_o = grp_fu_12549_p_dout0;
    end else begin
...
always @ (*) begin
    if ((~(i_15_reg_332_pp0_iter87_reg == 2'd0) & ~(i_15_reg_332_pp0_iter87_reg == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_2_o = grp_fu_12549_p_dout0;
    end else begin
...
always @ (*) begin
    if (((i_15_reg_332_pp0_iter87_reg == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter88 == 1'b1))) begin
        activations3_o = grp_fu_12549_p_dout0;
    end else begin
...
always @ (*) begin
    ap_condition_1278 = (~(i_15_reg_332_pp0_iter15_reg == 2'd0) & ~(i_15_reg_332_pp0_iter15_reg == 2'd1) & (ap_enable_reg_pp0_iter16 == 1'b1));
end
...
assign grp_fu_12037_p_din0 = 64'd4607182418800017408;
assign grp_fu_12037_p_din1 = tmp_s_reg_340;
assign grp_fu_12037_p_opcode = 2'd1;
assign grp_fu_12041_p_ce = 1'b1;
assign grp_fu_12041_p_din0 = tmp_17_reg_373;
assign grp_fu_12041_p_din1 = 64'd4607182418800017408;
assign grp_fu_12041_p_opcode = 2'd0;
assign grp_fu_12293_p_ce = 1'b1;
assign grp_fu_12293_p_din0 = tmp_s_reg_340_pp0_iter8_reg;
assign grp_fu_12293_p_din1 = sub_i1_reg_361;
assign grp_fu_12549_p_ce = 1'b1;
assign grp_fu_12549_p_din0 = 64'd4607182418800017408;
assign grp_fu_12549_p_din1 = add_i2_reg_378;
assign grp_fu_12553_p_ce = 1'b1;
assign grp_fu_12553_p_din0 = 64'd0;
assign grp_fu_12553_p_din1 = bitcast_ln20_1_fu_275_p1;
