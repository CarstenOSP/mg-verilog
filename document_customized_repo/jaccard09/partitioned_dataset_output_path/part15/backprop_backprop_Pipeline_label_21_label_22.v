...
module backprop_backprop_Pipeline_label_21_label_22 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v20_address0,v20_ce0,v20_q0,v20_1_address0,v20_1_ce0,v20_1_q0,v8_address0,v8_ce0,v8_q0,v8_1_address0,v8_1_ce0,v8_1_q0,v11_address0,v11_ce0,v11_we0,v11_d0,grp_fu_21179_p_din0,grp_fu_21179_p_din1,grp_fu_21179_p_dout0,grp_fu_21179_p_ce);  
...
reg   [12:0] indvar_flatten19_fu_58;
...
#0 v127_fu_50 = 7'd0;
#0 v125_fu_54 = 7'd0;
#0 indvar_flatten19_fu_58 = 13'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln210_fu_149_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten19_fu_58 <= add_ln210_fu_155_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten19_fu_58 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v129_reg_366 <= grp_fu_21179_p_dout0;
    end
end
always @ (*) begin
...
assign add_ln210_fu_155_p2 = (ap_sig_allocacmp_indvar_flatten19_load + 13'd1);
assign add_ln212_fu_262_p2 = (select_ln210_fu_178_p3 + 7'd1);
assign add_ln215_fu_256_p2 = (zext_ln212_fu_232_p1 + tmp_s_fu_224_p3);
...
assign grp_fu_21179_p_din0 = v126_reg_356;
assign grp_fu_21179_p_din1 = v128_reg_361;
assign icmp_ln210_fu_149_p2 = ((ap_sig_allocacmp_indvar_flatten19_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln212_fu_172_p2 = ((v127_fu_50 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln1_fu_240_p4 = {{select_ln210_fu_178_p3[5:1]}};
assign lshr_ln_fu_204_p4 = {{select_ln210_1_fu_192_p3[5:1]}};
...
assign tmp_s_fu_224_p3 = {{empty_fu_220_p1}, {6'd0}};
...
assign zext_ln210_fu_214_p1 = lshr_ln_fu_204_p4;
assign zext_ln212_1_fu_250_p1 = lshr_ln1_fu_240_p4;
