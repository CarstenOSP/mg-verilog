...
module k2mm_k2mm_Pipeline_lp7_lp8 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,buff_D_address0,buff_D_ce0,buff_D_q0,buff_D_1_address0,buff_D_1_ce0,buff_D_1_q0,buff_D_2_address0,buff_D_2_ce0,buff_D_2_q0,buff_D_3_address0,buff_D_3_ce0,buff_D_3_q0,buff_D_4_address0,buff_D_4_ce0,buff_D_4_q0,buff_D_5_address0,buff_D_5_ce0,buff_D_5_q0,buff_D_6_address0,buff_D_6_ce0,buff_D_6_q0,buff_D_7_address0,buff_D_7_ce0,buff_D_7_q0,buff_E_out_address0,buff_E_out_ce0,buff_E_out_we0,buff_E_out_d0,buff_E_out_1_address0,buff_E_out_1_ce0,buff_E_out_1_we0,buff_E_out_1_d0,buff_E_out_2_address0,buff_E_out_2_ce0,buff_E_out_2_we0,buff_E_out_2_d0,buff_E_out_3_address0,buff_E_out_3_ce0,buff_E_out_3_we0,buff_E_out_3_d0,buff_E_out_4_address0,buff_E_out_4_ce0,buff_E_out_4_we0,buff_E_out_4_d0,buff_E_out_5_address0,buff_E_out_5_ce0,buff_E_out_5_we0,buff_E_out_5_d0,buff_E_out_6_address0,buff_E_out_6_ce0,buff_E_out_6_we0,buff_E_out_6_d0,buff_E_out_7_address0,buff_E_out_7_ce0,buff_E_out_7_we0,buff_E_out_7_d0,tmp2_address0,tmp2_ce0,tmp2_q0,tmp2_1_address0,tmp2_1_ce0,tmp2_1_q0,tmp2_2_address0,tmp2_2_ce0,tmp2_2_q0,tmp2_3_address0,tmp2_3_ce0,tmp2_3_q0,tmp2_4_address0,tmp2_4_ce0,tmp2_4_q0,tmp2_5_address0,tmp2_5_ce0,tmp2_5_q0,tmp2_6_address0,tmp2_6_ce0,tmp2_6_q0,tmp2_7_address0,tmp2_7_ce0,tmp2_7_q0,beta,grp_fu_4190_p_din0,grp_fu_4190_p_din1,grp_fu_4190_p_opcode,grp_fu_4190_p_dout0,grp_fu_4190_p_ce,grp_fu_4198_p_din0,grp_fu_4198_p_din1,grp_fu_4198_p_opcode,grp_fu_4198_p_dout0,grp_fu_4198_p_ce,grp_fu_4194_p_din0,grp_fu_4194_p_din1,grp_fu_4194_p_dout0,grp_fu_4194_p_ce,grp_fu_4202_p_din0,grp_fu_4202_p_din1,grp_fu_4202_p_dout0,grp_fu_4202_p_ce);  
...
wire   [31:0] tmp_1_fu_625_p11;
reg   [31:0] tmp_1_reg_820;
reg   [31:0] mul3_reg_825;
wire   [31:0] tmp_3_fu_648_p11;
reg   [31:0] tmp_3_reg_830;
...
wire   [2:0] lshr_ln6_4_fu_533_p4;
wire   [8:0] tmp_s_fu_543_p3;
wire   [31:0] tmp_2_fu_579_p9;
wire   [31:0] tmp_4_fu_602_p9;
wire   [31:0] tmp_1_fu_625_p9;
wire   [31:0] tmp_3_fu_648_p9;
reg    ap_done_reg;
...
wire   [2:0] tmp_2_fu_579_p1;
wire   [2:0] tmp_2_fu_579_p3;
wire  signed [2:0] tmp_2_fu_579_p5;
wire  signed [2:0] tmp_2_fu_579_p7;
wire   [2:0] tmp_4_fu_602_p1;
wire   [2:0] tmp_4_fu_602_p3;
wire  signed [2:0] tmp_4_fu_602_p5;
wire  signed [2:0] tmp_4_fu_602_p7;
wire   [2:0] tmp_1_fu_625_p1;
wire   [2:0] tmp_1_fu_625_p3;
wire  signed [2:0] tmp_1_fu_625_p5;
wire  signed [2:0] tmp_1_fu_625_p7;
wire   [2:0] tmp_3_fu_648_p1;
wire   [2:0] tmp_3_fu_648_p3;
wire  signed [2:0] tmp_3_fu_648_p5;
wire  signed [2:0] tmp_3_fu_648_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_9_3_32_1_1_U1349(.din0(buff_D_q0),.din1(buff_D_2_q0),.din2(buff_D_4_q0),.din3(buff_D_6_q0),.def(tmp_2_fu_579_p9),.sel(trunc_ln44_1_reg_702),.dout(tmp_2_fu_579_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U1350(.din0(buff_D_1_q0),.din1(buff_D_3_q0),.din2(buff_D_5_q0),.din3(buff_D_7_q0),.def(tmp_4_fu_602_p9),.sel(trunc_ln44_1_reg_702),.dout(tmp_4_fu_602_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U1351(.din0(tmp2_q0),.din1(tmp2_2_q0),.din2(tmp2_4_q0),.din3(tmp2_6_q0),.def(tmp_1_fu_625_p9),.sel(trunc_ln44_1_reg_702_pp0_iter5_reg),.dout(tmp_1_fu_625_p11));
(* dissolve_hierarchy = "yes" *) k2mm_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U1352(.din0(tmp2_1_q0),.din1(tmp2_3_q0),.din2(tmp2_5_q0),.din3(tmp2_7_q0),.def(tmp_3_fu_648_p9),.sel(trunc_ln44_1_reg_702_pp0_iter5_reg),.dout(tmp_3_fu_648_p11));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add127_1_reg_848 <= grp_fu_4198_p_dout0;
        add2_reg_840 <= grp_fu_4190_p_dout0;
        ...
        mul126_1_reg_835 <= grp_fu_4202_p_dout0;
        mul3_reg_825 <= grp_fu_4194_p_dout0;
        tmp_1_reg_820 <= tmp_1_fu_625_p11;
        tmp_2_reg_770 <= tmp_2_fu_579_p11;
        tmp_3_reg_830 <= tmp_3_fu_648_p11;
        tmp_4_reg_775 <= tmp_4_fu_602_p11;
...
assign grp_fu_4190_p_din0 = tmp_1_reg_820;
assign grp_fu_4190_p_din1 = mul3_reg_825;
assign grp_fu_4190_p_opcode = 2'd0;
assign grp_fu_4194_p_ce = 1'b1;
assign grp_fu_4194_p_din0 = tmp_2_reg_770;
assign grp_fu_4194_p_din1 = beta;
assign grp_fu_4198_p_ce = 1'b1;
assign grp_fu_4198_p_din0 = tmp_3_reg_830;
assign grp_fu_4198_p_din1 = mul126_1_reg_835;
assign grp_fu_4198_p_opcode = 2'd0;
assign grp_fu_4202_p_ce = 1'b1;
assign grp_fu_4202_p_din0 = tmp_4_reg_775;
assign grp_fu_4202_p_din1 = beta;
assign icmp_ln43_fu_472_p2 = ((ap_sig_allocacmp_indvar_flatten37_load == 12'd2048) ? 1'b1 : 1'b0);
assign lshr_ln6_4_fu_533_p4 = {{select_ln6_fu_509_p3[5:3]}};
...
assign tmp_1_fu_625_p9 = 'bx;
assign tmp_2_fu_579_p9 = 'bx;
assign tmp_3_fu_648_p9 = 'bx;
assign tmp_4_fu_602_p9 = 'bx;
assign tmp_fu_501_p3 = j_fu_108[32'd6];
assign tmp_s_fu_543_p3 = {{trunc_ln44_fu_525_p1}, {lshr_ln6_4_fu_533_p4}};
