...
wire   [31:0] tmp_s_fu_586_p19;
reg   [31:0] tmp_s_reg_843;
wire    ap_block_pp0_stage2_11001;
reg   [31:0] tmp_s_reg_843_pp0_iter1_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_s_fu_586_p1;
wire   [2:0] tmp_s_fu_586_p3;
wire   [2:0] tmp_s_fu_586_p5;
wire   [2:0] tmp_s_fu_586_p7;
wire  signed [2:0] tmp_s_fu_586_p9;
wire  signed [2:0] tmp_s_fu_586_p11;
wire  signed [2:0] tmp_s_fu_586_p13;
wire  signed [2:0] tmp_s_fu_586_p15;
...
sparsemux_17_3_32_1_1_x_U90(.din0(a_0_q0),.din1(a_1_q0),.din2(a_2_q0),.din3(a_3_q0),.din4(a_4_q0),.din5(a_5_q0),.din6(a_6_q0),.din7(a_7_q0),.def(tmp_s_fu_586_p17),.sel(trunc_ln70_reg_798),.dout(tmp_s_fu_586_p19));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_17_3_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_x_U91(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.din4(bucket_4_q0),.din5(bucket_5_q0),.din6(bucket_6_q0),.din7(bucket_7_q0),.def(tmp_4_fu_675_p17),.sel(trunc_ln72_reg_856),.dout(tmp_4_fu_675_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        lshr_ln72_1_reg_915 <= {{tmp_4_fu_675_p19[10:3]}};
        tmp_4_reg_906 <= tmp_4_fu_675_p19;
        tmp_s_reg_843 <= tmp_s_fu_586_p19;
        tmp_s_reg_843_pp0_iter1_reg <= tmp_s_reg_843;
...
assign add_ln70_fu_544_p2 = (zext_ln69_fu_541_p1 + tmp_3_fu_534_p3);
