...
wire   [31:0] tmp_2_fu_1076_p11;
reg   [31:0] tmp_2_reg_1732;
...
wire   [31:0] tmp_4_fu_1261_p11;
reg   [31:0] tmp_4_reg_1902;
wire   [31:0] tmp_5_fu_1285_p11;
reg   [31:0] tmp_5_reg_1907;
wire   [31:0] tmp_6_fu_1309_p11;
reg   [31:0] tmp_6_reg_1912;
wire   [31:0] tmp_8_fu_1333_p11;
reg   [31:0] tmp_8_reg_1918;
...
wire   [31:0] tmp_2_fu_1076_p9;
wire   [31:0] tmp_3_fu_1100_p9;
wire   [31:0] tmp_1_fu_1052_p11;
wire   [31:0] tmp_3_fu_1100_p11;
...
wire   [31:0] tmp_4_fu_1261_p9;
wire   [31:0] tmp_5_fu_1285_p9;
wire   [31:0] tmp_6_fu_1309_p9;
wire   [31:0] tmp_8_fu_1333_p9;
wire   [31:0] tmp_7_fu_1357_p9;
wire   [31:0] tmp_7_fu_1357_p11;
wire   [31:0] xor_ln108_4_fu_1384_p2;
wire   [31:0] xor_ln108_3_fu_1380_p2;
wire   [31:0] tmp_9_fu_1399_p9;
wire   [31:0] tmp_s_fu_1422_p9;
wire   [31:0] tmp_9_fu_1399_p11;
wire   [31:0] tmp_s_fu_1422_p11;
...
wire  signed [3:0] tmp_1_fu_1052_p1;
wire  signed [3:0] tmp_1_fu_1052_p3;
wire   [3:0] tmp_1_fu_1052_p5;
wire   [3:0] tmp_1_fu_1052_p7;
wire   [3:0] tmp_2_fu_1076_p1;
wire   [3:0] tmp_2_fu_1076_p3;
wire  signed [3:0] tmp_2_fu_1076_p5;
wire  signed [3:0] tmp_2_fu_1076_p7;
wire   [3:0] tmp_3_fu_1100_p1;
wire   [3:0] tmp_3_fu_1100_p3;
wire  signed [3:0] tmp_3_fu_1100_p5;
wire  signed [3:0] tmp_3_fu_1100_p7;
wire   [3:0] tmp_4_fu_1261_p1;
wire  signed [3:0] tmp_4_fu_1261_p3;
wire  signed [3:0] tmp_4_fu_1261_p5;
wire   [3:0] tmp_4_fu_1261_p7;
wire  signed [3:0] tmp_5_fu_1285_p1;
wire  signed [3:0] tmp_5_fu_1285_p3;
wire   [3:0] tmp_5_fu_1285_p5;
wire   [3:0] tmp_5_fu_1285_p7;
wire   [3:0] tmp_6_fu_1309_p1;
wire   [3:0] tmp_6_fu_1309_p3;
wire  signed [3:0] tmp_6_fu_1309_p5;
wire  signed [3:0] tmp_6_fu_1309_p7;
wire   [3:0] tmp_8_fu_1333_p1;
wire  signed [3:0] tmp_8_fu_1333_p3;
wire  signed [3:0] tmp_8_fu_1333_p5;
wire   [3:0] tmp_8_fu_1333_p7;
wire   [3:0] tmp_7_fu_1357_p1;
wire   [3:0] tmp_7_fu_1357_p3;
wire  signed [3:0] tmp_7_fu_1357_p5;
wire  signed [3:0] tmp_7_fu_1357_p7;
wire  signed [3:0] tmp_9_fu_1399_p1;
wire  signed [3:0] tmp_9_fu_1399_p3;
wire   [3:0] tmp_9_fu_1399_p5;
wire   [3:0] tmp_9_fu_1399_p7;
wire  signed [3:0] tmp_s_fu_1422_p1;
wire   [3:0] tmp_s_fu_1422_p3;
wire   [3:0] tmp_s_fu_1422_p5;
wire  signed [3:0] tmp_s_fu_1422_p7;
...
sparsemux_9_4_32_1_1_U7(.din0(W_q1),.din1(W_4_q1),.din2(W_8_q1),.din3(W_12_q1),.def(tmp_1_fu_1052_p9),.sel(trunc_ln106_1_fu_996_p1),.dout(tmp_1_fu_1052_p11));
...
sparsemux_9_4_32_1_1_U8(.din0(W_2_q1),.din1(W_6_q1),.din2(W_10_q1),.din3(W_14_q1),.def(tmp_2_fu_1076_p9),.sel(trunc_ln106_1_fu_996_p1),.dout(tmp_2_fu_1076_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U9(.din0(W_q0),.din1(W_4_q0),.din2(W_8_q0),.din3(W_12_q0),.def(tmp_3_fu_1100_p9),.sel(trunc_ln106_1_fu_996_p1),.dout(tmp_3_fu_1100_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h4 ),.din0_WIDTH( 32 ),.CASE1( 4'h8 ),.din1_WIDTH( 32 ),.CASE2( 4'hC ),.din2_WIDTH( 32 ),.CASE3( 4'h0 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U10(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.def(tmp_4_fu_1261_p9),.sel(trunc_ln106_1_fu_996_p1),.dout(tmp_4_fu_1261_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h8 ),.din0_WIDTH( 32 ),.CASE1( 4'hC ),.din1_WIDTH( 32 ),.CASE2( 4'h0 ),.din2_WIDTH( 32 ),.CASE3( 4'h4 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U11(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.def(tmp_5_fu_1285_p9),.sel(trunc_ln106_1_fu_996_p1),.dout(tmp_5_fu_1285_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U12(.din0(W_3_q1),.din1(W_7_q1),.din2(W_11_q1),.din3(W_15_q1),.def(tmp_6_fu_1309_p9),.sel(trunc_ln106_1_fu_996_p1),.dout(tmp_6_fu_1309_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h4 ),.din0_WIDTH( 32 ),.CASE1( 4'h8 ),.din1_WIDTH( 32 ),.CASE2( 4'hC ),.din2_WIDTH( 32 ),.CASE3( 4'h0 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U13(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.def(tmp_8_fu_1333_p9),.sel(trunc_ln106_1_fu_996_p1),.dout(tmp_8_fu_1333_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h0 ),.din0_WIDTH( 32 ),.CASE1( 4'h4 ),.din1_WIDTH( 32 ),.CASE2( 4'h8 ),.din2_WIDTH( 32 ),.CASE3( 4'hC ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U14(.din0(W_1_q1),.din1(W_5_q1),.din2(W_9_q1),.din3(W_13_q1),.def(tmp_7_fu_1357_p9),.sel(trunc_ln106_1_reg_1723),.dout(tmp_7_fu_1357_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h8 ),.din0_WIDTH( 32 ),.CASE1( 4'hC ),.din1_WIDTH( 32 ),.CASE2( 4'h0 ),.din2_WIDTH( 32 ),.CASE3( 4'h4 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
sparsemux_9_4_32_1_1_U15(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.def(tmp_9_fu_1399_p9),.sel(trunc_ln106_1_reg_1723),.dout(tmp_9_fu_1399_p11));
...
sparsemux_9_4_32_1_1_U16(.din0(W_q1),.din1(W_4_q1),.din2(W_8_q1),.din3(W_12_q1),.def(tmp_s_fu_1422_p9),.sel(trunc_ln106_1_reg_1723),.dout(tmp_s_fu_1422_p11));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_9_4_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 4'h8 ),.din0_WIDTH( 32 ),.CASE1( 4'hC ),.din1_WIDTH( 32 ),.CASE2( 4'h0 ),.din2_WIDTH( 32 ),.CASE3( 4'h4 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 4 ),.dout_WIDTH( 32 ))
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_2_reg_1732 <= tmp_2_fu_1076_p11;
        tmp_4_reg_1902 <= tmp_4_fu_1261_p11;
        tmp_5_reg_1907 <= tmp_5_fu_1285_p11;
        tmp_6_reg_1912 <= tmp_6_fu_1309_p11;
        tmp_8_reg_1918 <= tmp_8_fu_1333_p11;
...
assign tmp_2_fu_1076_p9 = 'bx;
assign tmp_3_fu_1100_p9 = 'bx;
assign tmp_4_fu_1261_p9 = 'bx;
assign tmp_5_fu_1285_p9 = 'bx;
assign tmp_6_fu_1309_p9 = 'bx;
assign tmp_7_fu_1357_p9 = 'bx;
assign tmp_8_fu_1333_p9 = 'bx;
assign tmp_9_fu_1399_p9 = 'bx;
assign tmp_fu_1028_p9 = 'bx;
assign tmp_s_fu_1422_p9 = 'bx;
assign trunc_ln106_1_fu_996_p1 = i_3_reg_1548[3:0];
assign trunc_ln106_fu_800_p1 = ap_sig_allocacmp_i_3[5:0];
assign xor_ln108_10_fu_1511_p2 = (tmp_6_reg_1912 ^ tmp_11_fu_1488_p11);
assign xor_ln108_11_fu_1522_p2 = (xor_ln108_9_fu_1516_p2 ^ xor_ln108_2_reg_1737);
assign xor_ln108_1_fu_1124_p2 = (tmp_3_fu_1100_p11 ^ tmp_1_fu_1052_p11);
assign xor_ln108_2_fu_1136_p2 = (xor_ln108_fu_1130_p2 ^ tmp_fu_1028_p11);
assign xor_ln108_3_fu_1380_p2 = (tmp_6_reg_1912 ^ tmp_4_reg_1902);
assign xor_ln108_4_fu_1384_p2 = (tmp_7_fu_1357_p11 ^ tmp_5_reg_1907);
assign xor_ln108_5_fu_1389_p2 = (xor_ln108_4_fu_1384_p2 ^ xor_ln108_3_fu_1380_p2);
assign xor_ln108_6_fu_1445_p2 = (tmp_9_fu_1399_p11 ^ tmp_2_reg_1732);
assign xor_ln108_7_fu_1450_p2 = (tmp_s_fu_1422_p11 ^ tmp_8_reg_1918);
...
assign xor_ln108_fu_1130_p2 = (xor_ln108_1_fu_1124_p2 ^ tmp_2_fu_1076_p11);
