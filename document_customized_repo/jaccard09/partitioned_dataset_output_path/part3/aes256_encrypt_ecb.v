...
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_done;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_idle;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_ready;
wire   [3:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_address0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_ce0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_we0;
wire   [7:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_d0;
wire   [3:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_address1;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_ce1;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_we1;
wire   [7:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_d1;
...
reg    grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start_reg;
...
#0 grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start_reg = 1'b0;
...
aes256_encrypt_ecb_aes256_encrypt_ecb_Pipeline_mix grp_aes256_encrypt_ecb_Pipeline_mix_fu_273(.ap_clk(ap_clk),.ap_rst(ap_rst),.ap_start(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start),.ap_done(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_done),.ap_idle(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_idle),.ap_ready(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_ready),.buf_r_address0(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_address0),.buf_r_ce0(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_ce0),.buf_r_we0(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_we0),.buf_r_d0(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_d0),.buf_r_q0(buf_r_q0),.buf_r_address1(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_address1),.buf_r_ce1(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_ce1),.buf_r_we1(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_we1),.buf_r_d1(grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_d1),.buf_r_q1(buf_r_q1));
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state22)) begin
            grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start_reg <= 1'b1;
        end else if ((grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_ready == 1'b1)) begin
            grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start_reg <= 1'b0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_done == 1'b1) & (trunc_ln148_fu_471_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state23)) | ((icmp_ln148_fu_465_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8)) | ((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_413_p2 == 1'd0)))) begin
...
always @ (*) begin
    if ((grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state41)) begin
        ...
        buf_r_address0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_address0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state41)) begin
        ...
        buf_r_address1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_address1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state41)) begin
        ...
        buf_r_ce0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_ce0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state27))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state41)) begin
        ...
        buf_r_d0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_d0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state27))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state23)) begin
        buf_r_d1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_d1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state41)) begin
        ...
        buf_r_we0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_buf_r_we0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state27))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state23 : begin
            if (((grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_done == 1'b1) & (trunc_ln148_fu_471_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state23))) begin
                ap_NS_fsm = ap_ST_fsm_state26;
            end else if (((grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_done == 1'b1) & (trunc_ln148_fu_471_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state23))) begin
...
assign grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start = grp_aes256_encrypt_ecb_Pipeline_mix_fu_273_ap_start_reg;
...
assign i_19_fu_484_p2 = (i_10_fu_110 + 4'd1);
assign icmp_ln142_fu_413_p2 = ((i_6_fu_94 == 3'd0) ? 1'b1 : 1'b0);
assign icmp_ln148_fu_465_p2 = ((i_10_fu_110 == 4'd14) ? 1'b1 : 1'b0);
...
assign trunc_ln148_fu_471_p1 = i_10_fu_110[0:0];
endmodule 
