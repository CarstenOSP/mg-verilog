...
wire   [0:0] icmp_ln15_fu_2468_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [6:0] select_ln6_fu_2503_p3;
reg   [6:0] select_ln6_reg_2848;
reg   [6:0] select_ln6_reg_2848_pp0_iter2_reg;
wire   [6:0] select_ln15_fu_2511_p3;
reg   [6:0] select_ln15_reg_2854;
wire   [5:0] trunc_ln15_fu_2519_p1;
reg   [5:0] trunc_ln15_reg_2859;
wire   [5:0] trunc_ln16_fu_2523_p1;
reg   [5:0] trunc_ln16_reg_2865;
wire   [1:0] trunc_ln16_1_fu_2527_p1;
reg   [1:0] trunc_ln16_1_reg_2869;
reg   [1:0] trunc_ln16_1_reg_2869_pp0_iter2_reg;
reg   [3:0] lshr_ln6_reg_2873;
wire   [63:0] zext_ln17_1_fu_2640_p1;
reg   [63:0] zext_ln17_1_reg_2878;
reg   [9:0] buff_D_addr_reg_2904;
reg   [9:0] buff_D_1_addr_reg_2909;
reg   [9:0] buff_D_2_addr_reg_2914;
reg   [9:0] buff_D_3_addr_reg_2919;
wire   [63:0] zext_ln15_fu_2557_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln20_fu_2654_p1;
wire   [63:0] zext_ln16_fu_2670_p1;
reg   [6:0] j_fu_472;
wire   [6:0] add_ln16_fu_2541_p2;
wire    ap_loop_init;
reg   [6:0] i_fu_476;
reg   [12:0] indvar_flatten_fu_480;
wire   [12:0] add_ln15_1_fu_2474_p2;
...
wire   [31:0] bitcast_ln17_fu_2737_p1;
reg    buff_A_ce0_local;
reg    buff_B_we0_local;
wire   [31:0] bitcast_ln18_fu_2742_p1;
reg    buff_B_ce0_local;
reg    buff_C_62_we0_local;
reg    ap_predicate_pred1805_state4;
wire   [31:0] bitcast_ln19_fu_2747_p1;
...
wire   [31:0] bitcast_ln20_fu_2815_p1;
...
wire   [0:0] icmp_ln16_fu_2497_p2;
wire   [6:0] add_ln15_fu_2491_p2;
wire   [11:0] tmp_3_fu_2624_p3;
wire   [11:0] zext_ln17_fu_2631_p1;
wire   [11:0] add_ln17_fu_2634_p2;
wire   [9:0] tmp_4_fu_2648_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_fu_476 <= select_ln15_fu_2511_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln15_fu_2468_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten_fu_480 <= add_ln15_1_fu_2474_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln6_reg_2873 <= {{select_ln6_fu_2503_p3[5:2]}};
        select_ln15_reg_2854 <= select_ln15_fu_2511_p3;
        select_ln6_reg_2848 <= select_ln6_fu_2503_p3;
        trunc_ln15_reg_2859 <= trunc_ln15_fu_2519_p1;
        trunc_ln16_1_reg_2869 <= trunc_ln16_1_fu_2527_p1;
        trunc_ln16_reg_2865 <= trunc_ln16_fu_2523_p1;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ap_predicate_pred1805_state4 <= (trunc_ln15_reg_2859 == 6'd62);
        ap_predicate_pred1814_state4 <= (trunc_ln15_reg_2859 == 6'd61);
        ap_predicate_pred1822_state4 <= (trunc_ln15_reg_2859 == 6'd60);
        ap_predicate_pred1830_state4 <= (trunc_ln15_reg_2859 == 6'd59);
        ap_predicate_pred1838_state4 <= (trunc_ln15_reg_2859 == 6'd58);
        ap_predicate_pred1846_state4 <= (trunc_ln15_reg_2859 == 6'd57);
        ap_predicate_pred1854_state4 <= (trunc_ln15_reg_2859 == 6'd56);
        ap_predicate_pred1862_state4 <= (trunc_ln15_reg_2859 == 6'd55);
        ap_predicate_pred1870_state4 <= (trunc_ln15_reg_2859 == 6'd54);
        ap_predicate_pred1878_state4 <= (trunc_ln15_reg_2859 == 6'd53);
        ap_predicate_pred1886_state4 <= (trunc_ln15_reg_2859 == 6'd52);
        ap_predicate_pred1894_state4 <= (trunc_ln15_reg_2859 == 6'd51);
        ap_predicate_pred1902_state4 <= (trunc_ln15_reg_2859 == 6'd50);
        ap_predicate_pred1910_state4 <= (trunc_ln15_reg_2859 == 6'd49);
        ap_predicate_pred1918_state4 <= (trunc_ln15_reg_2859 == 6'd48);
        ap_predicate_pred1926_state4 <= (trunc_ln15_reg_2859 == 6'd47);
        ap_predicate_pred1934_state4 <= (trunc_ln15_reg_2859 == 6'd46);
        ap_predicate_pred1942_state4 <= (trunc_ln15_reg_2859 == 6'd45);
        ap_predicate_pred1950_state4 <= (trunc_ln15_reg_2859 == 6'd44);
        ap_predicate_pred1958_state4 <= (trunc_ln15_reg_2859 == 6'd43);
        ap_predicate_pred1966_state4 <= (trunc_ln15_reg_2859 == 6'd42);
        ap_predicate_pred1974_state4 <= (trunc_ln15_reg_2859 == 6'd41);
        ap_predicate_pred1982_state4 <= (trunc_ln15_reg_2859 == 6'd40);
        ap_predicate_pred1990_state4 <= (trunc_ln15_reg_2859 == 6'd39);
        ap_predicate_pred1998_state4 <= (trunc_ln15_reg_2859 == 6'd38);
        ap_predicate_pred2006_state4 <= (trunc_ln15_reg_2859 == 6'd37);
        ap_predicate_pred2014_state4 <= (trunc_ln15_reg_2859 == 6'd36);
        ap_predicate_pred2022_state4 <= (trunc_ln15_reg_2859 == 6'd35);
        ap_predicate_pred2030_state4 <= (trunc_ln15_reg_2859 == 6'd34);
        ap_predicate_pred2038_state4 <= (trunc_ln15_reg_2859 == 6'd33);
        ap_predicate_pred2046_state4 <= (trunc_ln15_reg_2859 == 6'd32);
        ap_predicate_pred2054_state4 <= (trunc_ln15_reg_2859 == 6'd31);
        ap_predicate_pred2062_state4 <= (trunc_ln15_reg_2859 == 6'd30);
        ap_predicate_pred2070_state4 <= (trunc_ln15_reg_2859 == 6'd29);
        ap_predicate_pred2078_state4 <= (trunc_ln15_reg_2859 == 6'd28);
        ap_predicate_pred2086_state4 <= (trunc_ln15_reg_2859 == 6'd27);
        ap_predicate_pred2094_state4 <= (trunc_ln15_reg_2859 == 6'd26);
        ap_predicate_pred2102_state4 <= (trunc_ln15_reg_2859 == 6'd25);
        ap_predicate_pred2110_state4 <= (trunc_ln15_reg_2859 == 6'd24);
        ap_predicate_pred2118_state4 <= (trunc_ln15_reg_2859 == 6'd23);
        ap_predicate_pred2126_state4 <= (trunc_ln15_reg_2859 == 6'd22);
        ap_predicate_pred2134_state4 <= (trunc_ln15_reg_2859 == 6'd21);
        ap_predicate_pred2142_state4 <= (trunc_ln15_reg_2859 == 6'd20);
        ap_predicate_pred2150_state4 <= (trunc_ln15_reg_2859 == 6'd19);
        ap_predicate_pred2158_state4 <= (trunc_ln15_reg_2859 == 6'd18);
        ap_predicate_pred2166_state4 <= (trunc_ln15_reg_2859 == 6'd17);
        ap_predicate_pred2174_state4 <= (trunc_ln15_reg_2859 == 6'd16);
        ap_predicate_pred2182_state4 <= (trunc_ln15_reg_2859 == 6'd15);
        ap_predicate_pred2190_state4 <= (trunc_ln15_reg_2859 == 6'd14);
        ap_predicate_pred2198_state4 <= (trunc_ln15_reg_2859 == 6'd13);
        ap_predicate_pred2206_state4 <= (trunc_ln15_reg_2859 == 6'd12);
        ap_predicate_pred2214_state4 <= (trunc_ln15_reg_2859 == 6'd11);
        ap_predicate_pred2222_state4 <= (trunc_ln15_reg_2859 == 6'd10);
        ap_predicate_pred2230_state4 <= (trunc_ln15_reg_2859 == 6'd9);
        ap_predicate_pred2238_state4 <= (trunc_ln15_reg_2859 == 6'd8);
        ap_predicate_pred2246_state4 <= (trunc_ln15_reg_2859 == 6'd7);
        ap_predicate_pred2254_state4 <= (trunc_ln15_reg_2859 == 6'd6);
        ap_predicate_pred2262_state4 <= (trunc_ln15_reg_2859 == 6'd5);
        ap_predicate_pred2270_state4 <= (trunc_ln15_reg_2859 == 6'd4);
        ap_predicate_pred2278_state4 <= (trunc_ln15_reg_2859 == 6'd3);
        ap_predicate_pred2286_state4 <= (trunc_ln15_reg_2859 == 6'd2);
        ap_predicate_pred2294_state4 <= (trunc_ln15_reg_2859 == 6'd1);
        ap_predicate_pred2302_state4 <= (trunc_ln15_reg_2859 == 6'd0);
        ap_predicate_pred2310_state4 <= (trunc_ln15_reg_2859 == 6'd63);
        buff_D_1_addr_reg_2909 <= zext_ln20_fu_2654_p1;
        buff_D_2_addr_reg_2914 <= zext_ln20_fu_2654_p1;
        buff_D_3_addr_reg_2919 <= zext_ln20_fu_2654_p1;
        buff_D_addr_reg_2904 <= zext_ln20_fu_2654_p1;
        select_ln6_reg_2848_pp0_iter2_reg <= select_ln6_reg_2848;
        trunc_ln16_1_reg_2869_pp0_iter2_reg <= trunc_ln16_1_reg_2869;
        zext_ln17_1_reg_2878[11 : 0] <= zext_ln17_1_fu_2640_p1[11 : 0];
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((icmp_ln15_fu_2468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln16_1_reg_2869 == 2'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln16_1_reg_2869 == 2'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln16_1_reg_2869 == 2'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln16_1_reg_2869 == 2'd0))) begin
...
assign A_address0 = zext_ln17_1_fu_2640_p1;
assign A_ce0 = A_ce0_local;
assign B_address0 = zext_ln17_1_fu_2640_p1;
assign B_ce0 = B_ce0_local;
assign C_address0 = zext_ln17_1_fu_2640_p1;
assign C_ce0 = C_ce0_local;
assign D_address0 = zext_ln17_1_fu_2640_p1;
assign D_ce0 = D_ce0_local;
assign add_ln15_1_fu_2474_p2 = (ap_sig_allocacmp_indvar_flatten_load + 13'd1);
assign add_ln15_fu_2491_p2 = (i_fu_476 + 7'd1);
assign add_ln16_fu_2541_p2 = (select_ln6_fu_2503_p3 + 7'd1);
assign add_ln17_fu_2634_p2 = (tmp_3_fu_2624_p3 + zext_ln17_fu_2631_p1);
