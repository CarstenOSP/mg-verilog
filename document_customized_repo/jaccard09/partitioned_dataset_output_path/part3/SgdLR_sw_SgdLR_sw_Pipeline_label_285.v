...
module SgdLR_sw_SgdLR_sw_Pipeline_label_285 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v2_address0,v2_ce0,v2_q0,empty,v0_0_address0,v0_0_ce0,v0_0_q0,v0_1_address0,v0_1_ce0,v0_1_q0,v6_91_out,v6_91_out_ap_vld,grp_fu_2207_p_din0,grp_fu_2207_p_din1,grp_fu_2207_p_opcode,grp_fu_2207_p_dout0,grp_fu_2207_p_ce,grp_fu_5635_p_din0,grp_fu_5635_p_din1,grp_fu_5635_p_dout0,grp_fu_5635_p_ce);  
...
wire   [63:0] add_ln35_3_fu_163_p2;
...
urem_64ns_23ns_64_68_1_U1078(.clk(ap_clk),.reset(ap_rst),.din0(add_ln35_reg_225),.din1(grp_fu_158_p1),.ce(1'b1),.dout(grp_fu_158_p2));
...
assign add_ln33_fu_137_p2 = (ap_sig_allocacmp_v8_3 + 11'd1);
assign add_ln35_3_fu_163_p2 = ($signed(add_ln35_reg_225) + $signed(64'd18446744073707247616));
...
assign icmp_ln35_fu_168_p2 = ((add_ln35_3_fu_163_p2 < 64'd2304000) ? 1'b1 : 1'b0);
...
assign v6_91_out = v12_fu_50;
assign v9_fu_181_p1 = v2_load_reg_241;
assign zext_ln33_fu_143_p1 = ap_sig_allocacmp_v8_3;
always @ (posedge ap_clk) begin
