...
reg   [3:0] v20_addr_1_reg_1126;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter1_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter2_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter3_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter4_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter5_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter6_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter7_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter8_reg;
reg   [3:0] v20_addr_1_reg_1126_pp0_iter9_reg;
reg   [3:0] v20_1_addr_1_reg_1132;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter1_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter2_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter3_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter4_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter5_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter6_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter7_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter8_reg;
reg   [3:0] v20_1_addr_1_reg_1132_pp0_iter9_reg;
reg   [3:0] v20_2_addr_1_reg_1138;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter1_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter2_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter3_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter4_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter5_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter6_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter7_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter8_reg;
reg   [3:0] v20_2_addr_1_reg_1138_pp0_iter9_reg;
reg   [3:0] v20_3_addr_1_reg_1144;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter1_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter2_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter3_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter4_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter5_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter6_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter7_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter8_reg;
reg   [3:0] v20_3_addr_1_reg_1144_pp0_iter9_reg;
...
sparsemux_129_6_64_1_1_U52(.din0(empty_51),.din1(empty_52),.din2(empty_53),.din3(empty_54),.din4(empty_55),.din5(empty_56),.din6(empty_57),.din7(empty_58),.din8(empty_59),.din9(empty_60),.din10(empty_61),.din11(empty_62),.din12(empty_63),.din13(empty_64),.din14(empty_65),.din15(empty_66),.din16(empty_67),.din17(empty_68),.din18(empty_69),.din19(empty_70),.din20(empty_71),.din21(empty_72),.din22(empty_73),.din23(empty_74),.din24(empty_75),.din25(empty_76),.din26(empty_77),.din27(empty_78),.din28(empty_79),.din29(empty_80),.din30(empty_81),.din31(empty_82),.din32(empty_83),.din33(empty_84),.din34(empty_85),.din35(empty_86),.din36(empty_87),.din37(empty_88),.din38(empty_89),.din39(empty_90),.din40(empty_91),.din41(empty_92),.din42(empty_93),.din43(empty_94),.din44(empty_95),.din45(empty_96),.din46(empty_97),.din47(empty_98),.din48(empty_99),.din49(empty_100),.din50(empty_101),.din51(empty_102),.din52(empty_103),.din53(empty_104),.din54(empty_105),.din55(empty_106),.din56(empty_107),.din57(empty_108),.din58(empty_109),.din59(empty_110),.din60(empty_111),.din61(empty_112),.din62(empty_113),.din63(empty),.def(v32_fu_818_p129),.sel(v32_fu_818_p130),.dout(v32_fu_818_p131));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_9_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.CASE3( 2'h3 ),.din3_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_9_2_64_1_1_U53(.din0(v20_q1),.din1(v20_1_q1),.din2(v20_2_q1),.din3(v20_3_q1),.def(v31_fu_1087_p9),.sel(trunc_ln77_reg_1121),.dout(v31_fu_1087_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v20_1_addr_1_reg_1132 <= zext_ln77_fu_810_p1;
        v20_1_addr_1_reg_1132_pp0_iter1_reg <= v20_1_addr_1_reg_1132;
        v20_2_addr_1_reg_1138 <= zext_ln77_fu_810_p1;
        v20_2_addr_1_reg_1138_pp0_iter1_reg <= v20_2_addr_1_reg_1138;
        v20_3_addr_1_reg_1144 <= zext_ln77_fu_810_p1;
        v20_3_addr_1_reg_1144_pp0_iter1_reg <= v20_3_addr_1_reg_1144;
        v20_addr_1_reg_1126 <= zext_ln77_fu_810_p1;
        v20_addr_1_reg_1126_pp0_iter1_reg <= v20_addr_1_reg_1126;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v20_1_addr_1_reg_1132_pp0_iter2_reg <= v20_1_addr_1_reg_1132_pp0_iter1_reg;
        v20_1_addr_1_reg_1132_pp0_iter3_reg <= v20_1_addr_1_reg_1132_pp0_iter2_reg;
        v20_1_addr_1_reg_1132_pp0_iter4_reg <= v20_1_addr_1_reg_1132_pp0_iter3_reg;
        v20_1_addr_1_reg_1132_pp0_iter5_reg <= v20_1_addr_1_reg_1132_pp0_iter4_reg;
        v20_1_addr_1_reg_1132_pp0_iter6_reg <= v20_1_addr_1_reg_1132_pp0_iter5_reg;
        v20_1_addr_1_reg_1132_pp0_iter7_reg <= v20_1_addr_1_reg_1132_pp0_iter6_reg;
        v20_1_addr_1_reg_1132_pp0_iter8_reg <= v20_1_addr_1_reg_1132_pp0_iter7_reg;
        v20_1_addr_1_reg_1132_pp0_iter9_reg <= v20_1_addr_1_reg_1132_pp0_iter8_reg;
        v20_2_addr_1_reg_1138_pp0_iter2_reg <= v20_2_addr_1_reg_1138_pp0_iter1_reg;
        v20_2_addr_1_reg_1138_pp0_iter3_reg <= v20_2_addr_1_reg_1138_pp0_iter2_reg;
        v20_2_addr_1_reg_1138_pp0_iter4_reg <= v20_2_addr_1_reg_1138_pp0_iter3_reg;
        v20_2_addr_1_reg_1138_pp0_iter5_reg <= v20_2_addr_1_reg_1138_pp0_iter4_reg;
        v20_2_addr_1_reg_1138_pp0_iter6_reg <= v20_2_addr_1_reg_1138_pp0_iter5_reg;
        v20_2_addr_1_reg_1138_pp0_iter7_reg <= v20_2_addr_1_reg_1138_pp0_iter6_reg;
        v20_2_addr_1_reg_1138_pp0_iter8_reg <= v20_2_addr_1_reg_1138_pp0_iter7_reg;
        v20_2_addr_1_reg_1138_pp0_iter9_reg <= v20_2_addr_1_reg_1138_pp0_iter8_reg;
        v20_3_addr_1_reg_1144_pp0_iter2_reg <= v20_3_addr_1_reg_1144_pp0_iter1_reg;
        v20_3_addr_1_reg_1144_pp0_iter3_reg <= v20_3_addr_1_reg_1144_pp0_iter2_reg;
        v20_3_addr_1_reg_1144_pp0_iter4_reg <= v20_3_addr_1_reg_1144_pp0_iter3_reg;
        v20_3_addr_1_reg_1144_pp0_iter5_reg <= v20_3_addr_1_reg_1144_pp0_iter4_reg;
        v20_3_addr_1_reg_1144_pp0_iter6_reg <= v20_3_addr_1_reg_1144_pp0_iter5_reg;
        v20_3_addr_1_reg_1144_pp0_iter7_reg <= v20_3_addr_1_reg_1144_pp0_iter6_reg;
        v20_3_addr_1_reg_1144_pp0_iter8_reg <= v20_3_addr_1_reg_1144_pp0_iter7_reg;
        v20_3_addr_1_reg_1144_pp0_iter9_reg <= v20_3_addr_1_reg_1144_pp0_iter8_reg;
        v20_addr_1_reg_1126_pp0_iter2_reg <= v20_addr_1_reg_1126_pp0_iter1_reg;
        v20_addr_1_reg_1126_pp0_iter3_reg <= v20_addr_1_reg_1126_pp0_iter2_reg;
        v20_addr_1_reg_1126_pp0_iter4_reg <= v20_addr_1_reg_1126_pp0_iter3_reg;
        v20_addr_1_reg_1126_pp0_iter5_reg <= v20_addr_1_reg_1126_pp0_iter4_reg;
        v20_addr_1_reg_1126_pp0_iter6_reg <= v20_addr_1_reg_1126_pp0_iter5_reg;
        v20_addr_1_reg_1126_pp0_iter7_reg <= v20_addr_1_reg_1126_pp0_iter6_reg;
        v20_addr_1_reg_1126_pp0_iter8_reg <= v20_addr_1_reg_1126_pp0_iter7_reg;
        v20_addr_1_reg_1126_pp0_iter9_reg <= v20_addr_1_reg_1126_pp0_iter8_reg;
        v33_reg_1160 <= grp_fu_3324_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_3324_p_din0 = v31_reg_1155;
assign grp_fu_3324_p_din1 = v32_reg_1150_pp0_iter1_reg;
...
assign v20_1_address0 = v20_1_addr_1_reg_1132_pp0_iter9_reg;
...
assign v20_2_address0 = v20_2_addr_1_reg_1138_pp0_iter9_reg;
...
assign v20_3_address0 = v20_3_addr_1_reg_1144_pp0_iter9_reg;
...
assign v20_address0 = v20_addr_1_reg_1126_pp0_iter9_reg;
