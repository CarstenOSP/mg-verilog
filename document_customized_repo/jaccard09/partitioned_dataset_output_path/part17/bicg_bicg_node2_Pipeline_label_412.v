...
wire   [0:0] tmp_832_fu_832_p3;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [0:0] tmp_832_reg_1248;
reg   [0:0] tmp_832_reg_1248_pp0_iter1_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter2_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter3_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter4_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter5_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter6_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter7_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter8_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter9_reg;
reg   [0:0] tmp_832_reg_1248_pp0_iter10_reg;
...
sparsemux_17_6_32_1_1_U1108(.din0(empty_768),.din1(empty_769),.din2(empty_770),.din3(empty_771),.din4(empty_772),.din5(empty_773),.din6(empty_774),.din7(empty_775),.def(v75_fu_860_p17),.sel(trunc_ln112_fu_840_p1),.dout(v75_fu_860_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U1109(.din0(empty_776),.din1(empty_777),.din2(empty_778),.din3(empty_779),.din4(empty_780),.din5(empty_781),.din6(empty_782),.din7(empty_783),.def(v83_fu_900_p17),.sel(trunc_ln112_fu_840_p1),.dout(v83_fu_900_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U1110(.din0(empty_784),.din1(empty_785),.din2(empty_786),.din3(empty_787),.din4(empty_788),.din5(empty_789),.din6(empty_790),.din7(empty_791),.def(v91_fu_940_p17),.sel(trunc_ln112_fu_840_p1),.dout(v91_fu_940_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U1111(.din0(empty_792),.din1(empty_793),.din2(empty_794),.din3(empty_795),.din4(empty_796),.din5(empty_797),.din6(empty_798),.din7(empty_799),.def(v99_fu_980_p17),.sel(trunc_ln112_fu_840_p1),.dout(v99_fu_980_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U1112(.din0(empty_800),.din1(empty_801),.din2(empty_802),.din3(empty_803),.din4(empty_804),.din5(empty_805),.din6(empty_806),.din7(empty_807),.def(v107_fu_1020_p17),.sel(trunc_ln112_fu_840_p1),.dout(v107_fu_1020_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U1113(.din0(empty_808),.din1(empty_809),.din2(empty_810),.din3(empty_811),.din4(empty_812),.din5(empty_813),.din6(empty_814),.din7(empty_815),.def(v115_fu_1060_p17),.sel(trunc_ln112_fu_840_p1),.dout(v115_fu_1060_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U1114(.din0(empty_816),.din1(empty_817),.din2(empty_818),.din3(empty_819),.din4(empty_820),.din5(empty_821),.din6(empty_822),.din7(empty_823),.def(v123_fu_1100_p17),.sel(trunc_ln112_fu_840_p1),.dout(v123_fu_1100_p19));
(* dissolve_hierarchy = "yes" *) bicg_sparsemux_17_6_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 6'h0 ),.din0_WIDTH( 32 ),.CASE1( 6'h8 ),.din1_WIDTH( 32 ),.CASE2( 6'h10 ),.din2_WIDTH( 32 ),.CASE3( 6'h18 ),.din3_WIDTH( 32 ),.CASE4( 6'h20 ),.din4_WIDTH( 32 ),.CASE5( 6'h28 ),.din5_WIDTH( 32 ),.CASE6( 6'h30 ),.din6_WIDTH( 32 ),.CASE7( 6'h38 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 6 ),.dout_WIDTH( 32 ))
sparsemux_17_6_32_1_1_U1115(.din0(empty_824),.din1(empty_825),.din2(empty_826),.din3(empty_827),.din4(empty_828),.din5(empty_829),.din6(empty_830),.din7(empty),.def(v131_fu_1140_p17),.sel(trunc_ln112_fu_840_p1),.dout(v131_fu_1140_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((tmp_832_fu_832_p3 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_832_reg_1248_pp0_iter10_reg <= tmp_832_reg_1248_pp0_iter9_reg;
        tmp_832_reg_1248_pp0_iter2_reg <= tmp_832_reg_1248_pp0_iter1_reg;
        tmp_832_reg_1248_pp0_iter3_reg <= tmp_832_reg_1248_pp0_iter2_reg;
        tmp_832_reg_1248_pp0_iter4_reg <= tmp_832_reg_1248_pp0_iter3_reg;
        tmp_832_reg_1248_pp0_iter5_reg <= tmp_832_reg_1248_pp0_iter4_reg;
        tmp_832_reg_1248_pp0_iter6_reg <= tmp_832_reg_1248_pp0_iter5_reg;
        tmp_832_reg_1248_pp0_iter7_reg <= tmp_832_reg_1248_pp0_iter6_reg;
        tmp_832_reg_1248_pp0_iter8_reg <= tmp_832_reg_1248_pp0_iter7_reg;
        tmp_832_reg_1248_pp0_iter9_reg <= tmp_832_reg_1248_pp0_iter8_reg;
        ...
        v85_1_reg_1447 <= grp_fu_27567_p_dout0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_832_reg_1248 <= ap_sig_allocacmp_v68[32'd6];
        tmp_832_reg_1248_pp0_iter1_reg <= tmp_832_reg_1248;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
        ...
        v81_1_reg_1407 <= v65_1_q1;
        v89_reg_1412 <= v65_2_q1;
        v97_reg_1417 <= v65_3_q1;
    end
end
always @ (*) begin
    if (((tmp_832_fu_832_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter11_reg == 1'b1) & (tmp_832_reg_1248_pp0_iter10_reg == 1'd1))) begin
...
assign grp_fu_27567_p_din0 = v81_1_reg_1407;
...
assign tmp_832_fu_832_p3 = ap_sig_allocacmp_v68[32'd6];
...
assign v65_1_d0 = v85_1_reg_1447;
...
assign v70_26_out = v66_fu_208;
assign v71_fu_1194_p3 = ((icmp_ln115_reg_1257[0:0] == 1'b1) ? v69_11 : v66_fu_208);
