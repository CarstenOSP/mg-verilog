...
reg   [6:0] i_8_reg_524;
reg   [6:0] i_8_reg_524_pp0_iter1_reg;
reg   [6:0] i_8_reg_524_pp0_iter2_reg;
reg   [6:0] i_8_reg_524_pp0_iter3_reg;
reg   [6:0] i_8_reg_524_pp0_iter4_reg;
reg   [6:0] i_8_reg_524_pp0_iter5_reg;
reg   [6:0] i_8_reg_524_pp0_iter6_reg;
reg   [6:0] i_8_reg_524_pp0_iter7_reg;
wire   [63:0] tmp_103_fu_357_p3;
reg   [63:0] tmp_103_reg_555;
wire   [63:0] tmp_104_fu_365_p3;
reg   [63:0] tmp_104_reg_562;
...
dmul_64ns_64ns_64_7_max_dsp_1_U234(.clk(ap_clk),.reset(ap_rst),.din0(tmp_103_reg_555),.din1(p_reload86),.ce(1'b1),.dout(grp_fu_279_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U235(.clk(ap_clk),.reset(ap_rst),.din0(tmp_103_reg_555),.din1(p_reload85),.ce(1'b1),.dout(grp_fu_283_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U236(.clk(ap_clk),.reset(ap_rst),.din0(tmp_103_reg_555),.din1(p_reload),.ce(1'b1),.dout(grp_fu_287_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U237(.clk(ap_clk),.reset(ap_rst),.din0(tmp_104_reg_562),.din1(p_reload86),.ce(1'b1),.dout(grp_fu_291_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U238(.clk(ap_clk),.reset(ap_rst),.din0(tmp_104_reg_562),.din1(p_reload85),.ce(1'b1),.dout(grp_fu_295_p2));
backprop_dmul_64ns_64ns_64_7_max_dsp_1 #(.ID( 1 ),.NUM_STAGE( 7 ),.din0_WIDTH( 64 ),.din1_WIDTH( 64 ),.dout_WIDTH( 64 ))
dmul_64ns_64ns_64_7_max_dsp_1_U239(.clk(ap_clk),.reset(ap_rst),.din0(tmp_104_reg_562),.din1(p_reload),.ce(1'b1),.dout(grp_fu_299_p2));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_8_reg_524 <= ap_sig_allocacmp_i_8;
        i_8_reg_524_pp0_iter1_reg <= i_8_reg_524;
        icmp_ln75_reg_569 <= icmp_ln75_fu_373_p2;
        tmp_103_reg_555 <= tmp_103_fu_357_p3;
        tmp_104_reg_562 <= tmp_104_fu_365_p3;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        i_8_reg_524_pp0_iter2_reg <= i_8_reg_524_pp0_iter1_reg;
        i_8_reg_524_pp0_iter3_reg <= i_8_reg_524_pp0_iter2_reg;
        i_8_reg_524_pp0_iter4_reg <= i_8_reg_524_pp0_iter3_reg;
        i_8_reg_524_pp0_iter5_reg <= i_8_reg_524_pp0_iter4_reg;
        i_8_reg_524_pp0_iter6_reg <= i_8_reg_524_pp0_iter5_reg;
        i_8_reg_524_pp0_iter7_reg <= i_8_reg_524_pp0_iter6_reg;
...
assign add_ln73_fu_337_p2 = (ap_sig_allocacmp_i_8 + 7'd2);
...
assign empty_91_fu_437_p2 = (sub_ln75_reg_573 + 8'd3);
...
assign lshr_ln75_2_fu_442_p4 = {{empty_91_fu_437_p2[7:2]}};
assign lshr_ln75_3_fu_463_p4 = {{add_ln75_1_fu_458_p2[7:2]}};
assign lshr_ln_fu_319_p4 = {{ap_sig_allocacmp_i_8[5:2]}};
assign p_shl_fu_385_p3 = {{trunc_ln75_fu_382_p1}, {2'd0}};
assign sub_ln75_fu_393_p2 = (p_shl_fu_385_p3 - zext_ln75_fu_379_p1);
assign tmp_103_fu_357_p3 = ((empty_fu_351_p2[0:0] == 1'b1) ? activations2_2_q0 : activations2_q0);
assign tmp_104_fu_365_p3 = ((empty_fu_351_p2[0:0] == 1'b1) ? activations2_3_q0 : activations2_1_q0);
assign tmp_fu_311_p3 = ap_sig_allocacmp_i_8[32'd6];
assign trunc_ln73_fu_348_p1 = i_8_reg_524[1:0];
assign trunc_ln75_fu_382_p1 = i_8_reg_524_pp0_iter7_reg[5:0];
...
assign zext_ln75_fu_379_p1 = i_8_reg_524_pp0_iter7_reg;
endmodule 
