...
wire  signed [15:0] a_assign_4_fu_321_p17;
reg  signed [15:0] a_assign_4_reg_604;
reg  signed [15:0] a_assign_4_reg_604_pp0_iter2_reg;
reg  signed [15:0] a_assign_4_reg_604_pp0_iter3_reg;
reg  signed [15:0] a_assign_4_reg_604_pp0_iter4_reg;
wire  signed [15:0] a_assign_5_fu_363_p17;
reg  signed [15:0] a_assign_5_reg_611;
reg  signed [15:0] a_assign_5_reg_611_pp0_iter2_reg;
reg  signed [15:0] a_assign_5_reg_611_pp0_iter3_reg;
reg  signed [15:0] a_assign_5_reg_611_pp0_iter4_reg;
...
wire   [15:0] a_assign_4_fu_321_p15;
wire   [15:0] a_assign_5_fu_363_p15;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] a_assign_4_fu_321_p1;
wire   [2:0] a_assign_4_fu_321_p3;
wire   [2:0] a_assign_4_fu_321_p5;
wire  signed [2:0] a_assign_4_fu_321_p7;
wire  signed [2:0] a_assign_4_fu_321_p9;
wire  signed [2:0] a_assign_4_fu_321_p11;
wire  signed [2:0] a_assign_4_fu_321_p13;
wire   [2:0] a_assign_5_fu_363_p1;
wire   [2:0] a_assign_5_fu_363_p3;
wire   [2:0] a_assign_5_fu_363_p5;
wire  signed [2:0] a_assign_5_fu_363_p7;
wire  signed [2:0] a_assign_5_fu_363_p9;
wire  signed [2:0] a_assign_5_fu_363_p11;
wire  signed [2:0] a_assign_5_fu_363_p13;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_15_3_16_1_1_U1069(.din0(K_i),.din1(K_1_i),.din2(K_2_i),.din3(K_3_i),.din4(K_4_i),.din5(K_5_i),.din6(K_6_i),.def(a_assign_4_fu_321_p15),.sel(trunc_ln219_fu_317_p1),.dout(a_assign_4_fu_321_p17));
(* dissolve_hierarchy = "yes" *) Gsm_LPC_Analysis_sparsemux_15_3_16_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h1 ),.din0_WIDTH( 16 ),.CASE1( 3'h2 ),.din1_WIDTH( 16 ),.CASE2( 3'h3 ),.din2_WIDTH( 16 ),.CASE3( 3'h4 ),.din3_WIDTH( 16 ),.CASE4( 3'h5 ),.din4_WIDTH( 16 ),.CASE5( 3'h6 ),.din5_WIDTH( 16 ),.CASE6( 3'h7 ),.din6_WIDTH( 16 ),.def_WIDTH( 16 ),.sel_WIDTH( 3 ),.dout_WIDTH( 16 ))
sparsemux_15_3_16_1_1_U1070(.din0(P_2_i),.din1(P_3_i),.din2(P_4_i),.din3(P_5_i),.din4(P_6_i),.din5(P_7_i),.din6(select_ln191_reload),.def(a_assign_5_fu_363_p15),.sel(trunc_ln219_fu_317_p1),.dout(a_assign_5_fu_363_p17));
Gsm_LPC_Analysis_mac_muladd_16s_16s_15ns_31_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 16 ),.din1_WIDTH( 16 ),.din2_WIDTH( 15 ),.dout_WIDTH( 31 ))
mac_muladd_16s_16s_15ns_31_4_1_U1071(.clk(ap_clk),.reset(ap_rst),.din0(a_assign_4_reg_604),.din1(grp_fu_557_p1),.din2(grp_fu_557_p2),.ce(1'b1),.dout(grp_fu_557_p3));
Gsm_LPC_Analysis_mac_muladd_16s_16s_15ns_31_4_1 #(.ID( 1 ),.NUM_STAGE( 4 ),.din0_WIDTH( 16 ),.din1_WIDTH( 16 ),.din2_WIDTH( 15 ),.dout_WIDTH( 31 ))
mac_muladd_16s_16s_15ns_31_4_1_U1072(.clk(ap_clk),.reset(ap_rst),.din0(a_assign_5_reg_611),.din1(grp_fu_565_p1),.din2(grp_fu_565_p2),.ce(1'b1),.dout(grp_fu_565_p3));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        a_assign_4_reg_604 <= a_assign_4_fu_321_p17;
        a_assign_5_reg_611 <= a_assign_5_fu_363_p17;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        a_assign_4_reg_604_pp0_iter2_reg <= a_assign_4_reg_604;
        a_assign_4_reg_604_pp0_iter3_reg <= a_assign_4_reg_604_pp0_iter2_reg;
        a_assign_4_reg_604_pp0_iter4_reg <= a_assign_4_reg_604_pp0_iter3_reg;
        a_assign_5_reg_611_pp0_iter2_reg <= a_assign_5_reg_611;
        a_assign_5_reg_611_pp0_iter3_reg <= a_assign_5_reg_611_pp0_iter2_reg;
        a_assign_5_reg_611_pp0_iter4_reg <= a_assign_5_reg_611_pp0_iter3_reg;
...
assign a_assign_4_fu_321_p15 = 'bx;
assign a_assign_5_fu_363_p15 = 'bx;
assign add_ln222_fu_357_p2 = (m_fu_102 + 64'd1);
assign add_ln39_2_fu_474_p2 = ($signed(temp_1_fu_461_p4) + $signed(a_assign_4_reg_604_pp0_iter4_reg));
assign add_ln39_fu_428_p2 = ($signed(a_assign_5_reg_611_pp0_iter4_reg) + $signed(temp_fu_412_p4));
...
assign icmp_ln40_3_fu_501_p2 = ((tmp_1_fu_491_p4 == 2'd1) ? 1'b1 : 1'b0);
...
assign sext_ln39_2_fu_470_p1 = temp_1_fu_461_p4;
assign sext_ln39_fu_421_p1 = a_assign_5_reg_611_pp0_iter4_reg;
assign sext_ln60_1_fu_409_p1 = a_assign_4_reg_604_pp0_iter4_reg;
...
assign temp_1_fu_461_p1 = grp_fu_565_p3;
assign temp_1_fu_461_p4 = {{temp_1_fu_461_p1[30:15]}};
assign temp_fu_412_p1 = grp_fu_557_p3;
assign temp_fu_412_p4 = {{temp_fu_412_p1[30:15]}};
assign tmp_1_fu_491_p4 = {{sum_1_fu_479_p2[16:15]}};
