...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((grp_kernel_atax_node1_Pipeline_label_0_fu_57_ap_done == 1'b0) | (v350_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state3)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
