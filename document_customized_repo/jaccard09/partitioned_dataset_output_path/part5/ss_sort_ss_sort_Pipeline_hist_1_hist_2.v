...
reg   [7:0] bucket_7_addr_19_reg_963;
reg   [7:0] lshr_ln52_1_reg_968;
wire   [31:0] tmp_s_fu_678_p19;
reg   [31:0] tmp_s_reg_973;
...
reg   [31:0] bucket_7_load_20_reg_1048;
...
wire   [2:0] tmp_1_fu_568_p1;
wire   [2:0] tmp_1_fu_568_p3;
wire  signed [2:0] tmp_1_fu_568_p5;
wire  signed [2:0] tmp_1_fu_568_p7;
wire  signed [2:0] tmp_s_fu_678_p1;
wire   [2:0] tmp_s_fu_678_p3;
wire   [2:0] tmp_s_fu_678_p5;
wire   [2:0] tmp_s_fu_678_p7;
wire   [2:0] tmp_s_fu_678_p9;
wire  signed [2:0] tmp_s_fu_678_p11;
wire  signed [2:0] tmp_s_fu_678_p13;
wire  signed [2:0] tmp_s_fu_678_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 6'd1;
...
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_9_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h2 ),.din1_WIDTH( 32 ),.CASE2( 3'h4 ),.din2_WIDTH( 32 ),.CASE3( 3'h6 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_9_3_32_1_1_U10(.din0(a_1_q0),.din1(a_3_q0),.din2(a_5_q0),.din3(a_7_q0),.def(tmp_1_fu_568_p9),.sel(trunc_ln57_reg_862),.dout(tmp_1_fu_568_p11));
...
sparsemux_17_3_32_1_1_U11(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.din4(bucket_4_q0),.din5(bucket_5_q0),.din6(bucket_6_q0),.din7(bucket_7_q0),.def(tmp_s_fu_678_p17),.sel(empty_25_reg_852),.dout(tmp_s_fu_678_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        bucket_7_addr_19_reg_963 <= zext_ln52_fu_634_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        bucket_7_load_20_reg_1048 <= bucket_7_q0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        tmp_1_reg_913 <= tmp_1_fu_568_p11;
        tmp_reg_908 <= tmp_fu_545_p11;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        tmp_s_reg_973 <= tmp_s_fu_678_p19;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        ...
        bucket_7_address0_local = bucket_7_addr_19_reg_963;
    end else if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
assign add_ln56_fu_502_p2 = (zext_ln55_fu_499_p1 + tmp_3_fu_492_p3);
assign add_ln58_2_fu_793_p2 = (bucket_0_load_5_reg_1053 + 32'd1);
assign add_ln58_3_fu_787_p2 = (bucket_7_load_20_reg_1048 + 32'd1);
...
assign add_ln58_fu_727_p2 = (tmp_s_reg_973 + 32'd1);
...
assign ashr_ln57_1_fu_646_p2 = $signed(tmp_1_reg_913) >>> zext_ln50_cast_reg_820;
...
assign select_ln52_fu_452_p3 = ((tmp_2_fu_444_p3[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_i_1_load);
assign select_ln54_fu_466_p3 = ((tmp_2_fu_444_p3[0:0] == 1'b1) ? add_ln54_2_fu_460_p2 : ap_sig_allocacmp_blockID_load);
...
assign tmp_1_fu_568_p9 = 'bx;
assign tmp_2_fu_444_p3 = ap_sig_allocacmp_i_1_load[32'd2];
assign tmp_3_fu_492_p3 = {{empty_reg_846}, {2'd0}};
assign tmp_fu_545_p9 = 'bx;
assign tmp_s_fu_678_p17 = 'bx;
