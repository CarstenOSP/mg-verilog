...
module ss_sort_ss_sort_Pipeline_update_1_update_2 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,b_0_address0,b_0_ce0,b_0_we0,b_0_d0,b_7_address0,b_7_ce0,b_7_we0,b_7_d0,b_6_address0,b_6_ce0,b_6_we0,b_6_d0,b_5_address0,b_5_ce0,b_5_we0,b_5_d0,b_4_address0,b_4_ce0,b_4_we0,b_4_d0,b_3_address0,b_3_ce0,b_3_we0,b_3_d0,b_2_address0,b_2_ce0,b_2_we0,b_2_d0,b_1_address0,b_1_ce0,b_1_we0,b_1_d0,a_0_address0,a_0_ce0,a_0_q0,a_1_address0,a_1_ce0,a_1_q0,a_2_address0,a_2_ce0,a_2_q0,a_3_address0,a_3_ce0,a_3_q0,a_4_address0,a_4_ce0,a_4_q0,a_5_address0,a_5_ce0,a_5_q0,a_6_address0,a_6_ce0,a_6_q0,a_7_address0,a_7_ce0,a_7_q0,zext_ln63,bucket_0_address0,bucket_0_ce0,bucket_0_we0,bucket_0_d0,bucket_0_q0,bucket_1_address0,bucket_1_ce0,bucket_1_we0,bucket_1_d0,bucket_1_q0,bucket_2_address0,bucket_2_ce0,bucket_2_we0,bucket_2_d0,bucket_2_q0,bucket_3_address0,bucket_3_ce0,bucket_3_we0,bucket_3_d0,bucket_3_q0,bucket_4_address0,bucket_4_ce0,bucket_4_we0,bucket_4_d0,bucket_4_q0,bucket_5_address0,bucket_5_ce0,bucket_5_we0,bucket_5_d0,bucket_5_q0,bucket_6_address0,bucket_6_ce0,bucket_6_we0,bucket_6_d0,bucket_6_q0,bucket_7_address0,bucket_7_ce0,bucket_7_we0,bucket_7_d0,bucket_7_q0);  
...
wire   [31:0] tmp_fu_586_p19;
reg   [31:0] tmp_reg_843;
wire    ap_block_pp0_stage2_11001;
reg   [31:0] tmp_reg_843_pp0_iter1_reg;
wire   [2:0] trunc_ln72_fu_650_p1;
reg   [2:0] trunc_ln72_reg_856;
reg   [7:0] lshr_ln5_reg_861;
...
wire   [31:0] tmp_1_fu_675_p19;
reg   [31:0] tmp_1_reg_906;
wire   [2:0] trunc_ln72_2_fu_714_p1;
reg   [2:0] trunc_ln72_2_reg_911;
reg   [7:0] lshr_ln72_1_reg_915;
reg    ap_enable_reg_pp0_iter0_reg;
wire    ap_block_pp0_stage0_subdone;
wire   [63:0] zext_ln70_fu_564_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln72_2_fu_664_p1;
wire   [63:0] zext_ln72_fu_728_p1;
...
wire   [9:0] add_ln68_2_fu_506_p2;
wire   [10:0] zext_ln69_fu_541_p1;
wire   [10:0] tmp_8_fu_534_p3;
wire   [10:0] add_ln70_fu_544_p2;
wire   [7:0] lshr_ln4_fu_554_p4;
wire   [31:0] tmp_fu_586_p17;
wire    ap_block_pp0_stage2;
wire   [31:0] ashr_ln70_fu_628_p2;
wire   [1:0] trunc_ln70_2_fu_632_p1;
wire   [10:0] zext_ln68_fu_625_p1;
wire   [10:0] shl_ln_fu_636_p3;
wire   [10:0] add_ln70_1_fu_644_p2;
wire   [31:0] tmp_1_fu_675_p17;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_fu_586_p1;
wire   [2:0] tmp_fu_586_p3;
wire   [2:0] tmp_fu_586_p5;
wire   [2:0] tmp_fu_586_p7;
wire  signed [2:0] tmp_fu_586_p9;
wire  signed [2:0] tmp_fu_586_p11;
wire  signed [2:0] tmp_fu_586_p13;
wire  signed [2:0] tmp_fu_586_p15;
wire   [2:0] tmp_1_fu_675_p1;
wire   [2:0] tmp_1_fu_675_p3;
wire   [2:0] tmp_1_fu_675_p5;
wire   [2:0] tmp_1_fu_675_p7;
wire  signed [2:0] tmp_1_fu_675_p9;
wire  signed [2:0] tmp_1_fu_675_p11;
wire  signed [2:0] tmp_1_fu_675_p13;
wire  signed [2:0] tmp_1_fu_675_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
sparsemux_17_3_32_1_1_U68(.din0(a_0_q0),.din1(a_1_q0),.din2(a_2_q0),.din3(a_3_q0),.din4(a_4_q0),.din5(a_5_q0),.din6(a_6_q0),.din7(a_7_q0),.def(tmp_fu_586_p17),.sel(trunc_ln70_reg_798),.dout(tmp_fu_586_p19));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_17_3_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_U69(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.din4(bucket_4_q0),.din5(bucket_5_q0),.din6(bucket_6_q0),.din7(bucket_7_q0),.def(tmp_1_fu_675_p17),.sel(trunc_ln72_reg_856),.dout(tmp_1_fu_675_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln68_fu_474_p2 == 1'd0))) begin
            indvar_flatten_fu_130 <= add_ln68_fu_480_p2;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        bucket_0_addr_reg_866 <= zext_ln72_2_fu_664_p1;
        bucket_1_addr_reg_871 <= zext_ln72_2_fu_664_p1;
        bucket_2_addr_reg_876 <= zext_ln72_2_fu_664_p1;
        bucket_3_addr_reg_881 <= zext_ln72_2_fu_664_p1;
        bucket_4_addr_reg_886 <= zext_ln72_2_fu_664_p1;
        bucket_5_addr_reg_891 <= zext_ln72_2_fu_664_p1;
        bucket_6_addr_reg_896 <= zext_ln72_2_fu_664_p1;
        bucket_7_addr_reg_901 <= zext_ln72_2_fu_664_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln5_reg_861 <= {{add_ln70_1_fu_644_p2[10:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        lshr_ln72_1_reg_915 <= {{tmp_1_fu_675_p19[10:3]}};
        tmp_1_reg_906 <= tmp_1_fu_675_p19;
        tmp_reg_843 <= tmp_fu_586_p19;
        tmp_reg_843_pp0_iter1_reg <= tmp_reg_843;
        trunc_ln72_2_reg_911 <= trunc_ln72_2_fu_714_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_0_we0_local = 1'b1;
    end else begin
        b_0_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_1_we0_local = 1'b1;
    end else begin
        b_1_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_2_we0_local = 1'b1;
    end else begin
        b_2_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_3_we0_local = 1'b1;
    end else begin
        b_3_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd4) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_4_we0_local = 1'b1;
    end else begin
        b_4_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd5) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_5_we0_local = 1'b1;
    end else begin
        b_5_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd6) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_6_we0_local = 1'b1;
    end else begin
        b_6_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln72_2_reg_911 == 3'd7) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_7_we0_local = 1'b1;
    end else begin
        b_7_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_0_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_1_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_2_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_3_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_4_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_5_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_6_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_7_address0_local = zext_ln72_2_fu_664_p1;
    end else begin
...
assign a_0_address0 = zext_ln70_fu_564_p1;
assign a_0_ce0 = a_0_ce0_local;
assign a_1_address0 = zext_ln70_fu_564_p1;
assign a_1_ce0 = a_1_ce0_local;
assign a_2_address0 = zext_ln70_fu_564_p1;
assign a_2_ce0 = a_2_ce0_local;
assign a_3_address0 = zext_ln70_fu_564_p1;
assign a_3_ce0 = a_3_ce0_local;
assign a_4_address0 = zext_ln70_fu_564_p1;
assign a_4_ce0 = a_4_ce0_local;
assign a_5_address0 = zext_ln70_fu_564_p1;
assign a_5_ce0 = a_5_ce0_local;
assign a_6_address0 = zext_ln70_fu_564_p1;
assign a_6_ce0 = a_6_ce0_local;
assign a_7_address0 = zext_ln70_fu_564_p1;
assign a_7_ce0 = a_7_ce0_local;
assign add_ln68_2_fu_506_p2 = (ap_sig_allocacmp_blockID_load + 10'd1);
assign add_ln68_fu_480_p2 = (ap_sig_allocacmp_indvar_flatten_load + 12'd1);
assign add_ln69_fu_576_p2 = (select_ln65_reg_782 + 3'd1);
assign add_ln70_1_fu_644_p2 = (zext_ln68_fu_625_p1 + shl_ln_fu_636_p3);
assign add_ln70_fu_544_p2 = (zext_ln69_fu_541_p1 + tmp_8_fu_534_p3);
assign add_ln73_fu_739_p2 = (tmp_1_reg_906 + 32'd1);
...
assign ashr_ln70_fu_628_p2 = $signed(tmp_reg_843) >>> zext_ln63_cast_reg_773;
assign b_0_address0 = zext_ln72_fu_728_p1;
assign b_0_ce0 = b_0_ce0_local;
assign b_0_d0 = tmp_reg_843_pp0_iter1_reg;
assign b_0_we0 = b_0_we0_local;
assign b_1_address0 = zext_ln72_fu_728_p1;
assign b_1_ce0 = b_1_ce0_local;
assign b_1_d0 = tmp_reg_843_pp0_iter1_reg;
assign b_1_we0 = b_1_we0_local;
assign b_2_address0 = zext_ln72_fu_728_p1;
assign b_2_ce0 = b_2_ce0_local;
assign b_2_d0 = tmp_reg_843_pp0_iter1_reg;
assign b_2_we0 = b_2_we0_local;
assign b_3_address0 = zext_ln72_fu_728_p1;
assign b_3_ce0 = b_3_ce0_local;
assign b_3_d0 = tmp_reg_843_pp0_iter1_reg;
assign b_3_we0 = b_3_we0_local;
assign b_4_address0 = zext_ln72_fu_728_p1;
assign b_4_ce0 = b_4_ce0_local;
assign b_4_d0 = tmp_reg_843_pp0_iter1_reg;
assign b_4_we0 = b_4_we0_local;
assign b_5_address0 = zext_ln72_fu_728_p1;
assign b_5_ce0 = b_5_ce0_local;
assign b_5_d0 = tmp_reg_843_pp0_iter1_reg;
assign b_5_we0 = b_5_we0_local;
assign b_6_address0 = zext_ln72_fu_728_p1;
assign b_6_ce0 = b_6_ce0_local;
assign b_6_d0 = tmp_reg_843_pp0_iter1_reg;
assign b_6_we0 = b_6_we0_local;
assign b_7_address0 = zext_ln72_fu_728_p1;
assign b_7_ce0 = b_7_ce0_local;
assign b_7_d0 = tmp_reg_843_pp0_iter1_reg;
...
assign icmp_ln68_fu_474_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 12'd2048) ? 1'b1 : 1'b0);
assign icmp_ln69_fu_492_p2 = ((ap_sig_allocacmp_i_load == 3'd4) ? 1'b1 : 1'b0);
assign lshr_ln4_fu_554_p4 = {{add_ln70_fu_544_p2[10:3]}};
assign select_ln65_fu_498_p3 = ((icmp_ln69_fu_492_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_i_load);
assign select_ln68_fu_512_p3 = ((icmp_ln69_fu_492_p2[0:0] == 1'b1) ? add_ln68_2_fu_506_p2 : ap_sig_allocacmp_blockID_load);
assign shl_ln_fu_636_p3 = {{trunc_ln70_2_fu_632_p1}, {9'd0}};
assign tmp_1_fu_675_p17 = 'bx;
assign tmp_8_fu_534_p3 = {{empty_reg_793}, {2'd0}};
assign tmp_fu_586_p17 = 'bx;
assign trunc_ln70_2_fu_632_p1 = ashr_ln70_fu_628_p2[1:0];
assign trunc_ln70_fu_550_p1 = add_ln70_fu_544_p2[2:0];
assign trunc_ln72_2_fu_714_p1 = tmp_1_fu_675_p19[2:0];
...
assign zext_ln70_fu_564_p1 = lshr_ln4_fu_554_p4;
assign zext_ln72_2_fu_664_p1 = lshr_ln5_reg_861;
assign zext_ln72_fu_728_p1 = lshr_ln72_1_reg_915;
always @ (posedge ap_clk) begin
