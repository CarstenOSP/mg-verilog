...
module aes256_encrypt_ecb (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,ctx_i,ctx_o,ctx_o_ap_vld,k_0_address0,k_0_ce0,k_0_q0,k_1_address0,k_1_ce0,k_1_q0,k_2_address0,k_2_ce0,k_2_q0,k_3_address0,k_3_ce0,k_3_q0,buf_0_address0,buf_0_ce0,buf_0_we0,buf_0_d0,buf_0_q0,buf_0_address1,buf_0_ce1,buf_0_q1,buf_1_address0,buf_1_ce0,buf_1_we0,buf_1_d0,buf_1_q0,buf_1_address1,buf_1_ce1,buf_1_we1,buf_1_d1,buf_1_q1,buf_2_address0,buf_2_ce0,buf_2_we0,buf_2_d0,buf_2_q0,buf_2_address1,buf_2_ce1,buf_2_we1,buf_2_d1,buf_2_q1,buf_3_address0,buf_3_ce0,buf_3_we0,buf_3_d0,buf_3_q0,buf_3_address1,buf_3_ce1,buf_3_we1,buf_3_d1,buf_3_q1);  
...
wire   [0:0] trunc_ln148_fu_507_p1;
reg   [0:0] trunc_ln148_reg_657;
...
reg   [767:0] grp_aes_expandEncKey_fu_273_ctx_read;
...
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_start;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_idle;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_ready;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_address0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_ce0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_we0;
wire   [7:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_d0;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_address1;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_ce1;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_address0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_ce0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_we0;
wire   [7:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_d0;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_address1;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_ce1;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_address0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_ce0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_we0;
wire   [7:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_d0;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_address1;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_ce1;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_address0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_ce0;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_we0;
wire   [7:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_d0;
wire   [1:0] grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_address1;
wire    grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_ce1;
...
reg   [2:0] i_6_fu_92;
wire   [2:0] add_ln142_fu_474_p2;
wire    ap_CS_fsm_state5;
reg   [7:0] rcon_0_fu_96;
reg   [3:0] i_10_fu_108;
wire   [3:0] i_17_fu_520_p2;
...
#0 grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_start_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_aes_expandEncKey_fu_273_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_449_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state14)) begin
            grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_start_reg <= 1'b1;
        end else if ((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_ready == 1'b1)) begin
            grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_start_reg <= 1'b0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done == 1'b1) & (trunc_ln148_fu_507_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state15)) | ((icmp_ln148_fu_501_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8)) | ((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_449_p2 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((icmp_ln148_fu_501_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((icmp_ln148_fu_501_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8)))) begin
...
always @ (posedge ap_clk) begin
    if (((grp_aes_expandEncKey_fu_273_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        ctx5_fu_100 <= grp_aes_expandEncKey_fu_273_ap_return_0;
    end else if (((grp_aes256_encrypt_ecb_Pipeline_ecb1_fu_258_p_partset113_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        ctx5_fu_100 <= grp_aes256_encrypt_ecb_Pipeline_ecb1_fu_258_p_partset113_out_o;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        empty_fu_112 <= grp_aes256_encrypt_ecb_Pipeline_cpkey_fu_283_p_partset410_out;
    end else if (((1'b0 == ap_block_state17_on_subcall_done) & (trunc_ln148_reg_657 == 1'd0) & (1'b1 == ap_CS_fsm_state17))) begin
        empty_fu_112 <= reg_430;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_449_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_449_p2 == 1'd1))) begin
        ...
        rcon_1_fu_116 <= reg_391;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state8))) begin
        reg_379 <= ctx_i;
    end
end
always @ (posedge ap_clk) begin
    if ((((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_449_p2 == 1'd1)) | ((1'b1 == ap_CS_fsm_state3) & (icmp_ln142_fu_449_p2 == 1'd0)))) begin
        reg_385 <= ctx5_fu_100;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state16) | (1'b1 == ap_CS_fsm_state4))) begin
        reg_391 <= grp_aes_expandEncKey_fu_273_ap_return_1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state8))) begin
        reg_395 <= rcon_1_fu_116;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state19) | (1'b1 == ap_CS_fsm_state16))) begin
        reg_430 <= grp_aes_expandEncKey_fu_273_ap_return_0;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        trunc_ln148_reg_657 <= trunc_ln148_fu_507_p1;
    end
end
...
always @ (*) begin
    if ((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((grp_aes256_encrypt_ecb_Pipeline_addkey2_fu_347_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state25))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    ...
    end else if (((trunc_ln148_reg_657 == 1'd1) & (1'b1 == ap_CS_fsm_state17))) begin
        buf_0_address0 = grp_aes256_encrypt_ecb_Pipeline_addkey_fu_334_buf_0_address0;
    end else if (((trunc_ln148_reg_657 == 1'd0) & (1'b1 == ap_CS_fsm_state17))) begin
        buf_0_address0 = grp_aes256_encrypt_ecb_Pipeline_addkey1_fu_321_buf_0_address0;
    end else if ((1'b1 == ap_CS_fsm_state15)) begin
        buf_0_address0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_address0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_0_ce1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_ce1;
    end else begin
        buf_0_ce1 = 1'b0;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_0_d0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_d0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_0_we0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_0_we0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_1_address0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_address0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state23) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state21) | (1'b1 == ap_CS_fsm_state11))) begin
        buf_1_address0_local = 64'd3;
    end else if (((1'b1 == ap_CS_fsm_state20) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state22) | (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_1_address1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_address1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_1_ce0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_ce0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state23) | (1'b1 == ap_CS_fsm_state20) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state22) | (1'b1 == ap_CS_fsm_state12) | (1'b1 == ap_CS_fsm_state21) | (1'b1 == ap_CS_fsm_state11))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_1_ce1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_1_d0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_d0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_1_we0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_1_we0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state23) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state22) | (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_2_address0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_address0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_2_address1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_address1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_2_ce0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_ce0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_2_ce1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_2_d0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_d0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_2_we0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_2_we0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_3_address0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_address0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_3_address1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_address1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_3_ce0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_ce0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_3_ce1 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_3_d0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_d0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        ...
        buf_3_we0 = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_buf_3_we0;
    end else if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_state19_on_subcall_done) & (1'b1 == ap_CS_fsm_state19)) | ((grp_aes_expandEncKey_fu_273_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state16)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) | ((1'b0 == ap_block_state19_on_subcall_done) & (1'b1 == ap_CS_fsm_state19)) | ((grp_aes_expandEncKey_fu_273_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state16)))) begin
        ctx_o_ap_vld = 1'b1;
    end else begin
        ctx_o_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state19) | (1'b1 == ap_CS_fsm_state16))) begin
        grp_aes_expandEncKey_fu_273_ctx_read = reg_379;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_aes_expandEncKey_fu_273_ctx_read = reg_385;
    end else begin
        grp_aes_expandEncKey_fu_273_ctx_read = 'bx;
    end
end
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state19) | (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state19) | (1'b1 == ap_CS_fsm_state16))) begin
        grp_aes_expandEncKey_fu_273_rc_read = reg_395;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((grp_aes256_encrypt_ecb_Pipeline_cpkey_fu_283_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state6))) begin
        ...
        ap_ST_fsm_state8 : begin
            if (((icmp_ln148_fu_501_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
        ...
        ap_ST_fsm_state9 : begin
            if (((grp_aes_subBytes_fu_297_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        ...
        ap_ST_fsm_state15 : begin
            if (((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done == 1'b1) & (trunc_ln148_fu_507_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state15))) begin
                ap_NS_fsm = ap_ST_fsm_state18;
            end else if (((grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_done == 1'b1) & (trunc_ln148_fu_507_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state15))) begin
...
assign add_ln142_fu_474_p2 = ($signed(i_6_fu_92) + $signed(3'd7));
...
always @ (*) begin
    ap_block_state17_on_subcall_done = (((grp_aes256_encrypt_ecb_Pipeline_addkey_fu_334_ap_done == 1'b0) & (trunc_ln148_reg_657 == 1'd1)) | ((grp_aes256_encrypt_ecb_Pipeline_addkey1_fu_321_ap_done == 1'b0) & (trunc_ln148_reg_657 == 1'd0)));
end
always @ (*) begin
    ap_block_state19_on_subcall_done = ((grp_aes_subBytes_fu_297_ap_done == 1'b0) | (grp_aes_expandEncKey_fu_273_ap_done == 1'b0));
end
assign buf_1_d1 = reg_405;
assign buf_1_we1 = buf_1_we1_local;
assign buf_2_d1 = reg_415;
assign buf_2_we1 = buf_2_we1_local;
assign buf_3_d1 = reg_425;
...
assign grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_start = grp_aes256_encrypt_ecb_Pipeline_mix_fu_309_ap_start_reg;
...
assign i_17_fu_520_p2 = (i_10_fu_108 + 4'd1);
assign icmp_ln142_fu_449_p2 = ((i_6_fu_92 == 3'd0) ? 1'b1 : 1'b0);
assign icmp_ln148_fu_501_p2 = ((i_10_fu_108 == 4'd14) ? 1'b1 : 1'b0);
...
assign trunc_ln148_fu_507_p1 = i_10_fu_108[0:0];
endmodule 
