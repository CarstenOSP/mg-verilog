...
module backprop_backprop_Pipeline_label_27_label_28 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v12_address0,v12_ce0,v12_q0,v0_address0,v0_ce0,v0_we0,v0_d0,v0_q0,v150_out,v150_out_ap_vld,grp_fu_2112_p_din0,grp_fu_2112_p_din1,grp_fu_2112_p_opcode,grp_fu_2112_p_dout0,grp_fu_2112_p_ce,grp_fu_2120_p_din0,grp_fu_2120_p_din1,grp_fu_2120_p_dout0,grp_fu_2120_p_ce);  
...
reg   [9:0] indvar_flatten27_fu_68;
...
#0 v149_fu_60 = 7'd0;
#0 v146_fu_64 = 4'd0;
#0 indvar_flatten27_fu_68 = 10'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln243_fu_136_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten27_fu_68 <= add_ln243_fu_142_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten27_fu_68 <= 10'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        v148_fu_56 <= grp_fu_2112_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        v152_reg_304 <= grp_fu_2120_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v154_reg_319 <= grp_fu_2112_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v155_reg_326 <= grp_fu_2120_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_indvar_flatten27_load = indvar_flatten27_fu_68;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage4) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ap_sig_allocacmp_v148_load_1 = grp_fu_2112_p_dout0;
    end else begin
...
assign add_ln243_fu_142_p2 = (ap_sig_allocacmp_indvar_flatten27_load + 10'd1);
assign add_ln247_fu_214_p2 = (select_ln244_reg_278 + 7'd1);
assign add_ln249_fu_202_p2 = (zext_ln247_fu_199_p1 + tmp_8_fu_192_p3);
...
assign grp_fu_2112_p_din0 = grp_fu_104_p0;
assign grp_fu_2112_p_din1 = grp_fu_104_p1;
assign grp_fu_2112_p_opcode = grp_fu_104_opcode;
assign grp_fu_2120_p_ce = 1'b1;
assign grp_fu_2120_p_din0 = grp_fu_108_p0;
assign grp_fu_2120_p_din1 = grp_fu_108_p1;
assign icmp_ln243_fu_136_p2 = ((ap_sig_allocacmp_indvar_flatten27_load == 10'd832) ? 1'b1 : 1'b0);
...
assign tmp_8_fu_192_p3 = {{select_ln243_reg_284}, {6'd0}};
