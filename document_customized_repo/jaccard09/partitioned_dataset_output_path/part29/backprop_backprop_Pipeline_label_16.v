...
module backprop_backprop_Pipeline_label_16 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,mux_case_2118195,mux_case_1117191,mux_case_0116187,mux_case_034330_reload,mux_case_135334_reload,mux_case_236338_reload,empty,v7_address0,v7_ce0,v7_q0,v107_reload,mux_case_138346_reload,v107_3_reload,mux_case_2118193_out,mux_case_2118193_out_ap_vld,mux_case_1117189_out,mux_case_1117189_out_ap_vld,mux_case_0116185_out,mux_case_0116185_out_ap_vld,grp_fu_2545_p_din0,grp_fu_2545_p_din1,grp_fu_2545_p_opcode,grp_fu_2545_p_dout0,grp_fu_2545_p_ce,grp_fu_2553_p_din0,grp_fu_2553_p_din1,grp_fu_2553_p_dout0,grp_fu_2553_p_ce);  
...
output   ap_idle;
output   ap_ready;
input  [63:0] mux_case_2118195;
input  [63:0] mux_case_1117191;
input  [63:0] mux_case_0116187;
input  [63:0] mux_case_034330_reload;
input  [63:0] mux_case_135334_reload;
input  [63:0] mux_case_236338_reload;
input  [8:0] empty;
output  [8:0] v7_address0;
output   v7_ce0;
input  [63:0] v7_q0;
input  [63:0] v107_reload;
input  [63:0] mux_case_138346_reload;
input  [63:0] v107_3_reload;
output  [63:0] mux_case_2118193_out;
output   mux_case_2118193_out_ap_vld;
output  [63:0] mux_case_1117189_out;
output   mux_case_1117189_out_ap_vld;
output  [63:0] mux_case_0116185_out;
output   mux_case_0116185_out_ap_vld;
...
reg ap_idle;
reg mux_case_2118193_out_ap_vld;
reg mux_case_1117189_out_ap_vld;
reg mux_case_0116185_out_ap_vld;
...
reg   [63:0] mux_case_0116185_fu_82;
...
reg   [63:0] mux_case_1117189_fu_86;
reg   [63:0] mux_case_2118193_fu_90;
...
#0 v93_fu_78 = 2'd0;
#0 mux_case_0116185_fu_82 = 64'd0;
#0 mux_case_1117189_fu_86 = 64'd0;
#0 mux_case_2118193_fu_90 = 64'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U172(.din0(mux_case_034330_reload),.din1(mux_case_135334_reload),.din2(mux_case_236338_reload),.def(v94_fu_251_p7),.sel(v93_1_reg_403_pp0_iter1_reg),.dout(v94_fu_251_p9));
(* dissolve_hierarchy = "yes" *) backprop_sparsemux_7_2_64_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 64 ),.CASE1( 2'h1 ),.din1_WIDTH( 64 ),.CASE2( 2'h2 ),.din2_WIDTH( 64 ),.def_WIDTH( 64 ),.sel_WIDTH( 2 ),.dout_WIDTH( 64 ))
sparsemux_7_2_64_1_1_U173(.din0(v107_reload),.din1(mux_case_138346_reload),.din2(v107_3_reload),.def(v98_fu_294_p7),.sel(v93_1_reg_403_pp0_iter8_reg),.dout(v98_fu_294_p9));
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            mux_case_2118193_fu_90 <= mux_case_2118195;
        end else if ((1'b1 == ap_condition_519)) begin
            mux_case_2118193_fu_90 <= v13_reg_453;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        v13_reg_453 <= grp_fu_2553_p_dout0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln168_reg_409_pp0_iter15_reg == 1'd1))) begin
        mux_case_0116185_out_ap_vld = 1'b1;
    end else begin
        mux_case_0116185_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln168_reg_409_pp0_iter15_reg == 1'd1))) begin
        mux_case_1117189_out_ap_vld = 1'b1;
    end else begin
        mux_case_1117189_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter16_reg == 1'b1) & (icmp_ln168_reg_409_pp0_iter15_reg == 1'd1))) begin
        mux_case_2118193_out_ap_vld = 1'b1;
    end else begin
        mux_case_2118193_out_ap_vld = 1'b0;
    end
end
always @ (*) begin
...
assign bitcast_ln172_fu_272_p1 = grp_fu_2545_p_dout0;
assign grp_fu_2545_p_ce = 1'b1;
assign grp_fu_2545_p_din0 = v94_fu_251_p9;
assign grp_fu_2545_p_din1 = v95_fu_268_p1;
assign grp_fu_2545_p_opcode = 2'd1;
assign grp_fu_2553_p_ce = 1'b1;
assign grp_fu_2553_p_din0 = v97_fu_316_p1;
assign grp_fu_2553_p_din1 = v98_reg_443;
assign icmp_ln168_fu_219_p2 = ((ap_sig_allocacmp_v93_1 == 2'd3) ? 1'b1 : 1'b0);
assign mux_case_0116185_out = mux_case_0116185_fu_82;
assign mux_case_1117189_out = mux_case_1117189_fu_86;
assign mux_case_2118193_out = mux_case_2118193_fu_90;
