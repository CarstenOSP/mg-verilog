...
wire   [31:0] tmp_5_fu_579_p11;
reg   [31:0] tmp_5_reg_816;
wire   [31:0] tmp_6_fu_602_p11;
reg   [31:0] tmp_6_reg_821;
wire   [31:0] tmp_7_fu_625_p11;
reg   [31:0] tmp_7_reg_826;
wire   [31:0] tmp_8_fu_648_p11;
reg   [31:0] tmp_8_reg_831;
...
reg   [10:0] indvar_flatten13_fu_120;
...
wire   [31:0] tmp_5_fu_579_p9;
wire   [31:0] tmp_6_fu_602_p9;
wire   [31:0] tmp_7_fu_625_p9;
wire   [31:0] tmp_8_fu_648_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_5_fu_579_p1;
wire   [1:0] tmp_5_fu_579_p3;
wire  signed [1:0] tmp_5_fu_579_p5;
wire  signed [1:0] tmp_5_fu_579_p7;
wire   [1:0] tmp_6_fu_602_p1;
wire   [1:0] tmp_6_fu_602_p3;
wire  signed [1:0] tmp_6_fu_602_p5;
wire  signed [1:0] tmp_6_fu_602_p7;
wire   [1:0] tmp_7_fu_625_p1;
wire   [1:0] tmp_7_fu_625_p3;
wire  signed [1:0] tmp_7_fu_625_p5;
wire  signed [1:0] tmp_7_fu_625_p7;
wire   [1:0] tmp_8_fu_648_p1;
wire   [1:0] tmp_8_fu_648_p3;
wire  signed [1:0] tmp_8_fu_648_p5;
wire  signed [1:0] tmp_8_fu_648_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
#0 j_fu_112 = 7'd0;
#0 i_fu_116 = 7'd0;
#0 indvar_flatten13_fu_120 = 11'd0;
#0 ap_done_reg = 1'b0;
end
...
sparsemux_9_2_32_1_1_U339(.din0(buff_C_out_q0),.din1(buff_C_out_1_q0),.din2(buff_C_out_2_q0),.din3(buff_C_out_3_q0),.def(tmp_5_fu_579_p9),.sel(trunc_ln38_reg_712),.dout(tmp_5_fu_579_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U340(.din0(buff_C_out_4_q0),.din1(buff_C_out_5_q0),.din2(buff_C_out_6_q0),.din3(buff_C_out_7_q0),.def(tmp_6_fu_602_p9),.sel(trunc_ln38_reg_712),.dout(tmp_6_fu_602_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U341(.din0(buff_C_out_8_q0),.din1(buff_C_out_9_q0),.din2(buff_C_out_10_q0),.din3(buff_C_out_11_q0),.def(tmp_7_fu_625_p9),.sel(trunc_ln38_reg_712),.dout(tmp_7_fu_625_p11));
(* dissolve_hierarchy = "yes" *) syrk_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U342(.din0(buff_C_out_12_q0),.din1(buff_C_out_13_q0),.din2(buff_C_out_14_q0),.din3(buff_C_out_15_q0),.def(tmp_8_fu_648_p9),.sel(trunc_ln38_reg_712),.dout(tmp_8_fu_648_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln38_fu_382_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten13_fu_120 <= add_ln38_1_fu_388_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten13_fu_120 <= 11'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_5_reg_816 <= tmp_5_fu_579_p11;
        tmp_6_reg_821 <= tmp_6_fu_602_p11;
        tmp_7_reg_826 <= tmp_7_fu_625_p11;
        tmp_8_reg_831 <= tmp_8_fu_648_p11;
    end
end
always @ (*) begin
...
assign add_ln38_1_fu_388_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 11'd1);
...
assign bitcast_ln41_1_fu_675_p1 = tmp_6_reg_821;
assign bitcast_ln41_2_fu_679_p1 = tmp_7_reg_826;
assign bitcast_ln41_3_fu_683_p1 = tmp_8_reg_831;
assign bitcast_ln41_fu_671_p1 = tmp_5_reg_816;
...
assign icmp_ln38_fu_382_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 11'd1024) ? 1'b1 : 1'b0);
...
assign lshr_ln5_6_fu_439_p4 = {{select_ln5_fu_419_p3[5:2]}};
assign or_ln39_1_fu_525_p4 = {{{lshr_ln5_6_fu_439_p4}, {1'd1}}, {trunc_ln39_fu_521_p1}};
assign or_ln39_2_fu_545_p3 = {{lshr_ln5_6_fu_439_p4}, {2'd3}};
...
assign tmp_1_fu_459_p3 = {{tmp_s_fu_449_p4}, {lshr_ln5_6_fu_439_p4}};
assign tmp_2_fu_493_p4 = {{select_ln5_fu_419_p3[5:1]}};
assign tmp_5_fu_579_p9 = 'bx;
assign tmp_6_fu_602_p9 = 'bx;
assign tmp_7_fu_625_p9 = 'bx;
assign tmp_8_fu_648_p9 = 'bx;
assign tmp_fu_411_p3 = j_fu_112[32'd6];
assign tmp_s_fu_449_p4 = {{select_ln38_fu_427_p3[5:2]}};
...
assign zext_ln41_fu_467_p1 = tmp_1_fu_459_p3;
endmodule 
