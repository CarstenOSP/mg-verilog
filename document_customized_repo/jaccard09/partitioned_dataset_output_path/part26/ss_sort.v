...
wire    grp_local_scan_fu_121_ap_start;
wire    grp_local_scan_fu_121_ap_done;
wire    grp_local_scan_fu_121_ap_idle;
wire    grp_local_scan_fu_121_ap_ready;
wire   [10:0] grp_local_scan_fu_121_bucket_address0;
wire    grp_local_scan_fu_121_bucket_ce0;
wire    grp_local_scan_fu_121_bucket_we0;
wire   [31:0] grp_local_scan_fu_121_bucket_d0;
wire   [10:0] grp_local_scan_fu_121_bucket_address1;
wire    grp_local_scan_fu_121_bucket_ce1;
wire    grp_local_scan_fu_121_bucket_we1;
wire   [31:0] grp_local_scan_fu_121_bucket_d1;
...
wire   [6:0] grp_ss_sort_Pipeline_sum_1_fu_127_sum_address1;
wire    grp_ss_sort_Pipeline_sum_1_fu_127_sum_ce1;
wire    grp_ss_sort_Pipeline_sum_1_fu_127_sum_we1;
wire   [31:0] grp_ss_sort_Pipeline_sum_1_fu_127_sum_d1;
wire   [10:0] grp_ss_sort_Pipeline_sum_1_fu_127_bucket_address0;
wire    grp_ss_sort_Pipeline_sum_1_fu_127_bucket_ce0;
wire   [10:0] grp_ss_sort_Pipeline_sum_1_fu_127_bucket_address1;
wire    grp_ss_sort_Pipeline_sum_1_fu_127_bucket_ce1;
wire    grp_last_step_scan_fu_135_ap_start;
wire    grp_last_step_scan_fu_135_ap_done;
wire    grp_last_step_scan_fu_135_ap_idle;
wire    grp_last_step_scan_fu_135_ap_ready;
wire   [10:0] grp_last_step_scan_fu_135_bucket_address0;
wire    grp_last_step_scan_fu_135_bucket_ce0;
wire    grp_last_step_scan_fu_135_bucket_we0;
wire   [31:0] grp_last_step_scan_fu_135_bucket_d0;
wire   [10:0] grp_last_step_scan_fu_135_bucket_address1;
wire    grp_last_step_scan_fu_135_bucket_ce1;
wire    grp_last_step_scan_fu_135_bucket_we1;
wire   [31:0] grp_last_step_scan_fu_135_bucket_d1;
wire   [6:0] grp_last_step_scan_fu_135_sum_address0;
wire    grp_last_step_scan_fu_135_sum_ce0;
wire   [6:0] grp_last_step_scan_fu_135_sum_address1;
wire    grp_last_step_scan_fu_135_sum_ce1;
...
reg    grp_local_scan_fu_121_ap_start_reg;
wire    ap_CS_fsm_state7;
wire    ap_CS_fsm_state8;
reg    grp_ss_sort_Pipeline_sum_1_fu_127_ap_start_reg;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state10;
reg    grp_last_step_scan_fu_135_ap_start_reg;
...
#0 grp_local_scan_fu_121_ap_start_reg = 1'b0;
#0 grp_ss_sort_Pipeline_sum_1_fu_127_ap_start_reg = 1'b0;
#0 grp_last_step_scan_fu_135_ap_start_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_last_step_scan_fu_135_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state11)) begin
            grp_last_step_scan_fu_135_ap_start_reg <= 1'b1;
        end else if ((grp_last_step_scan_fu_135_ap_ready == 1'b1)) begin
            grp_last_step_scan_fu_135_ap_start_reg <= 1'b0;
        end
    end
end
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_local_scan_fu_121_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state7)) begin
            grp_local_scan_fu_121_ap_start_reg <= 1'b1;
        end else if ((grp_local_scan_fu_121_ap_ready == 1'b1)) begin
            grp_local_scan_fu_121_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        trunc_ln63_reg_212 <= trunc_ln63_fu_181_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((grp_last_step_scan_fu_135_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((grp_local_scan_fu_121_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        bucket_address0 = grp_last_step_scan_fu_135_bucket_address0;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        bucket_address0 = grp_ss_sort_Pipeline_sum_1_fu_127_bucket_address0;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_address0 = grp_local_scan_fu_121_bucket_address0;
...
always @ (*) begin
    if (((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        bucket_address1 = grp_last_step_scan_fu_135_bucket_address1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        bucket_address1 = grp_ss_sort_Pipeline_sum_1_fu_127_bucket_address1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_address1 = grp_local_scan_fu_121_bucket_address1;
    end else begin
        bucket_address1 = 'bx;
    end
end
always @ (*) begin
    if (((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        bucket_ce0 = grp_last_step_scan_fu_135_bucket_ce0;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        bucket_ce0 = grp_ss_sort_Pipeline_sum_1_fu_127_bucket_ce0;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_ce0 = grp_local_scan_fu_121_bucket_ce0;
    end else if ((((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state5)) | ((valid_buffer_reg_80 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (*) begin
    if (((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        bucket_ce1 = grp_last_step_scan_fu_135_bucket_ce1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        bucket_ce1 = grp_ss_sort_Pipeline_sum_1_fu_127_bucket_ce1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_ce1 = grp_local_scan_fu_121_bucket_ce1;
    end else begin
        bucket_ce1 = 1'b0;
    end
end
always @ (*) begin
    if (((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        bucket_d0 = grp_last_step_scan_fu_135_bucket_d0;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_d0 = grp_local_scan_fu_121_bucket_d0;
    end else if ((((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state5)) | ((valid_buffer_reg_80 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        bucket_d1 = grp_last_step_scan_fu_135_bucket_d1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_d1 = grp_local_scan_fu_121_bucket_d1;
    end else begin
        bucket_d1 = 'bx;
    end
end
always @ (*) begin
    if (((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        bucket_we0 = grp_last_step_scan_fu_135_bucket_we0;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_we0 = grp_local_scan_fu_121_bucket_we0;
    end else if ((((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state5)) | ((valid_buffer_reg_80 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        bucket_we1 = grp_last_step_scan_fu_135_bucket_we1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        bucket_we1 = grp_local_scan_fu_121_bucket_we1;
    end else begin
        bucket_we1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        sum_address0 = grp_last_step_scan_fu_135_sum_address0;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        sum_address1 = grp_last_step_scan_fu_135_sum_address1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        sum_address1 = grp_ss_sort_Pipeline_sum_1_fu_127_sum_address1;
    end else begin
        sum_address1 = 'bx;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        sum_ce0 = grp_last_step_scan_fu_135_sum_ce0;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        sum_ce1 = grp_last_step_scan_fu_135_sum_ce1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        sum_ce1 = grp_ss_sort_Pipeline_sum_1_fu_127_sum_ce1;
    end else begin
        sum_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        sum_we1 = grp_ss_sort_Pipeline_sum_1_fu_127_sum_we1;
    end else begin
        sum_we1 = 1'b0;
    end
end
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (grp_local_scan_fu_121_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state12 : begin
            if (((valid_buffer_reg_80 == 1'd1) & (1'b1 == ap_CS_fsm_state12) & (grp_last_step_scan_fu_135_ap_done == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state15;
            end else if (((valid_buffer_reg_80 == 1'd0) & (1'b1 == ap_CS_fsm_state12) & (grp_last_step_scan_fu_135_ap_done == 1'b1))) begin
...
assign exp_3_fu_184_p2 = (exp_fu_62 + 6'd2);
assign grp_hist_fu_111_ap_start = grp_hist_fu_111_ap_start_reg;
assign grp_last_step_scan_fu_135_ap_start = grp_last_step_scan_fu_135_ap_start_reg;
assign grp_local_scan_fu_121_ap_start = grp_local_scan_fu_121_ap_start_reg;
...
assign sum_d1 = grp_ss_sort_Pipeline_sum_1_fu_127_sum_d1;
