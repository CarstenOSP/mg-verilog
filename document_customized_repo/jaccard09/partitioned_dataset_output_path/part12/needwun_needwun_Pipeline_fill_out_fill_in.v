...
wire   [7:0] tmp_s_fu_1479_p19;
reg   [7:0] tmp_s_reg_2215;
...
wire   [31:0] tmp_7_fu_1871_p19;
reg   [31:0] tmp_7_reg_2454;
...
wire   [11:0] ptr_6_addr_1_gep_fu_874_p3;
wire   [11:0] ptr_5_addr_1_gep_fu_883_p3;
wire   [11:0] ptr_4_addr_1_gep_fu_892_p3;
wire   [11:0] ptr_3_addr_1_gep_fu_901_p3;
wire   [11:0] ptr_2_addr_1_gep_fu_910_p3;
wire   [11:0] ptr_1_addr_1_gep_fu_919_p3;
wire   [11:0] ptr_0_addr_1_gep_fu_928_p3;
wire   [11:0] ptr_7_addr_1_gep_fu_937_p3;
wire   [11:0] ptr_6_addr_gep_fu_946_p3;
wire   [11:0] ptr_5_addr_gep_fu_955_p3;
wire   [11:0] ptr_4_addr_gep_fu_964_p3;
wire   [11:0] ptr_3_addr_gep_fu_973_p3;
wire   [11:0] ptr_2_addr_gep_fu_982_p3;
wire   [11:0] ptr_1_addr_gep_fu_991_p3;
wire   [11:0] ptr_0_addr_gep_fu_1000_p3;
wire   [11:0] ptr_7_addr_gep_fu_1009_p3;
...
wire   [14:0] b_idx_1_cast7_fu_1402_p1;
wire   [7:0] tmp_2_fu_1440_p17;
wire   [7:0] tmp_s_fu_1479_p17;
...
wire   [2:0] tmp_s_fu_1479_p1;
wire   [2:0] tmp_s_fu_1479_p3;
wire   [2:0] tmp_s_fu_1479_p5;
wire   [2:0] tmp_s_fu_1479_p7;
wire  signed [2:0] tmp_s_fu_1479_p9;
wire  signed [2:0] tmp_s_fu_1479_p11;
wire  signed [2:0] tmp_s_fu_1479_p13;
wire  signed [2:0] tmp_s_fu_1479_p15;
...
wire   [2:0] tmp_7_fu_1871_p1;
wire   [2:0] tmp_7_fu_1871_p3;
wire   [2:0] tmp_7_fu_1871_p5;
wire   [2:0] tmp_7_fu_1871_p7;
wire  signed [2:0] tmp_7_fu_1871_p9;
wire  signed [2:0] tmp_7_fu_1871_p11;
wire  signed [2:0] tmp_7_fu_1871_p13;
wire  signed [2:0] tmp_7_fu_1871_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 6'd1;
...
sparsemux_17_3_8_1_1_U18(.din0(SEQA_0_q0),.din1(SEQA_1_q0),.din2(SEQA_2_q0),.din3(SEQA_3_q0),.din4(SEQA_4_q0),.din5(SEQA_5_q0),.din6(SEQA_6_q0),.din7(SEQA_7_q0),.def(tmp_s_fu_1479_p17),.sel(trunc_ln29_1_reg_2105),.dout(tmp_s_fu_1479_p19));
(* dissolve_hierarchy = "yes" *) needwun_sparsemux_17_3_8_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h1 ),.din0_WIDTH( 8 ),.CASE1( 3'h2 ),.din1_WIDTH( 8 ),.CASE2( 3'h3 ),.din2_WIDTH( 8 ),.CASE3( 3'h4 ),.din3_WIDTH( 8 ),.CASE4( 3'h5 ),.din4_WIDTH( 8 ),.CASE5( 3'h6 ),.din5_WIDTH( 8 ),.CASE6( 3'h7 ),.din6_WIDTH( 8 ),.CASE7( 3'h0 ),.din7_WIDTH( 8 ),.def_WIDTH( 8 ),.sel_WIDTH( 3 ),.dout_WIDTH( 8 ))
...
sparsemux_17_3_32_1_1_U23(.din0(M_0_q1),.din1(M_1_q1),.din2(M_2_q1),.din3(M_3_q1),.din4(M_4_q1),.din5(M_5_q1),.din6(M_6_q1),.din7(M_7_q1),.def(tmp_7_fu_1871_p17),.sel(trunc_ln39_reg_2225),.dout(tmp_7_fu_1871_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_s_reg_2215 <= tmp_s_fu_1479_p19;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_6_reg_2095 <= {{empty_fu_1346_p2[6:3]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        tmp_7_reg_2454 <= tmp_7_fu_1871_p19;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1652)) begin
            ...
            ptr_0_address0_local = ptr_0_addr_gep_fu_1000_p3;
        end else if ((1'b1 == ap_condition_1630)) begin
            ptr_0_address0_local = ptr_0_addr_1_gep_fu_928_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1676)) begin
            ...
            ptr_1_address0_local = ptr_1_addr_gep_fu_991_p3;
        end else if ((1'b1 == ap_condition_1660)) begin
            ptr_1_address0_local = ptr_1_addr_1_gep_fu_919_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1700)) begin
            ...
            ptr_2_address0_local = ptr_2_addr_gep_fu_982_p3;
        end else if ((1'b1 == ap_condition_1684)) begin
            ptr_2_address0_local = ptr_2_addr_1_gep_fu_910_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1724)) begin
            ...
            ptr_3_address0_local = ptr_3_addr_gep_fu_973_p3;
        end else if ((1'b1 == ap_condition_1708)) begin
            ptr_3_address0_local = ptr_3_addr_1_gep_fu_901_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1748)) begin
            ...
            ptr_4_address0_local = ptr_4_addr_gep_fu_964_p3;
        end else if ((1'b1 == ap_condition_1732)) begin
            ptr_4_address0_local = ptr_4_addr_1_gep_fu_892_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1772)) begin
            ...
            ptr_5_address0_local = ptr_5_addr_gep_fu_955_p3;
        end else if ((1'b1 == ap_condition_1756)) begin
            ptr_5_address0_local = ptr_5_addr_1_gep_fu_883_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1796)) begin
            ...
            ptr_6_address0_local = ptr_6_addr_gep_fu_946_p3;
        end else if ((1'b1 == ap_condition_1780)) begin
            ptr_6_address0_local = ptr_6_addr_1_gep_fu_874_p3;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_1820)) begin
            ...
            ptr_7_address0_local = ptr_7_addr_gep_fu_1009_p3;
        end else if ((1'b1 == ap_condition_1804)) begin
            ptr_7_address0_local = ptr_7_addr_1_gep_fu_937_p3;
...
assign b_idx_1_cast7_fu_1402_p1 = select_ln28_reg_2084;
assign empty_20_fu_1423_p2 = (p_shl_fu_1416_p3 + b_idx_1_cast7_fu_1402_p1);
...
assign icmp_ln30_1_fu_1675_p2 = ((tmp_s_reg_2215 == tmp_fu_1528_p19) ? 1'b1 : 1'b0);
...
assign tmp_7_fu_1871_p17 = 'bx;
assign tmp_fu_1528_p17 = 'bx;
assign tmp_s_fu_1479_p17 = 'bx;
...
assign up_1_fu_1989_p2 = ($signed(tmp_7_reg_2454) + $signed(32'd4294967295));
