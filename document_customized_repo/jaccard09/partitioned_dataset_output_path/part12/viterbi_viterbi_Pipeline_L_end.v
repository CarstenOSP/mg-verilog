...
module viterbi_viterbi_Pipeline_L_end (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,min_p,llike_address0,llike_ce0,llike_q0,llike_1_address0,llike_1_ce0,llike_1_q0,llike_2_address0,llike_2_ce0,llike_2_q0,llike_3_address0,llike_3_ce0,llike_3_q0,min_s_out,min_s_out_ap_vld,grp_fu_582_p_din0,grp_fu_582_p_din1,grp_fu_582_p_opcode,grp_fu_582_p_dout0,grp_fu_582_p_ce);  
...
wire   [11:0] tmp_279_cast_fu_189_p3;
...
sparsemux_9_2_64_1_1_U26(.din0(llike_q0),.din1(llike_1_q0),.din2(llike_2_q0),.din3(llike_3_q0),.def(p_fu_208_p9),.sel(p_fu_208_p10),.dout(p_fu_208_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_444 <= grp_fu_582_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
assign and_ln42_fu_321_p2 = (tmp_2_reg_444 & or_ln42_fu_311_p2);
...
assign grp_fu_582_p_din0 = p_reg_416;
assign grp_fu_582_p_din1 = min_p_1_fu_74;
...
assign tmp_279_cast_fu_189_p3 = {{8'd139}, {tmp_s_fu_179_p4}};
...
assign zext_ln41_fu_197_p1 = tmp_279_cast_fu_189_p3;
