...
reg   [5:0] buff_x2_addr_reg_316;
reg   [5:0] buff_x2_addr_reg_316_pp0_iter1_reg;
wire   [0:0] trunc_ln29_1_fu_206_p1;
reg   [0:0] trunc_ln29_1_reg_321;
wire   [0:0] icmp_ln30_1_fu_245_p2;
reg   [0:0] icmp_ln30_1_reg_341;
reg   [0:0] icmp_ln30_1_reg_341_pp0_iter1_reg;
reg   [31:0] buff_x2_load_reg_345;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_pp0_stage2_11001;
wire   [31:0] select_ln31_fu_261_p3;
reg   [31:0] select_ln31_reg_350;
reg   [31:0] buff_y2_load_reg_355;
...
wire    ap_loop_init;
reg   [6:0] i_fu_50;
wire   [6:0] select_ln29_fu_187_p3;
reg   [12:0] indvar_flatten16_fu_54;
...
wire   [6:0] select_ln6_fu_175_p3;
wire   [6:0] add_ln29_fu_163_p2;
wire   [5:0] trunc_ln29_fu_183_p1;
wire   [4:0] lshr_ln6_1_fu_210_p4;
wire   [10:0] tmp_7_fu_225_p3;
...
#0 j_fu_46 = 7'd0;
#0 i_fu_50 = 7'd0;
#0 indvar_flatten16_fu_54 = 13'd0;
#0 empty_fu_58 = 32'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        if ((1'b1 == ap_condition_411)) begin
            empty_fu_58 <= buff_x2_load_reg_345;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        i_fu_50 <= select_ln29_fu_187_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln29_fu_140_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten16_fu_54 <= add_ln29_1_fu_146_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten16_fu_54 <= 13'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        add1_reg_370 <= grp_fu_127_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_x2_addr_reg_316 <= zext_ln29_fu_201_p1;
        buff_x2_addr_reg_316_pp0_iter1_reg <= buff_x2_addr_reg_316;
        ...
        trunc_ln29_1_reg_321 <= trunc_ln29_1_fu_206_p1;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        buff_x2_load_reg_345 <= buff_x2_q0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        buff_y2_load_reg_355 <= buff_y2_q0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul1_reg_360 <= grp_fu_131_p_dout0;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_indvar_flatten16_load = indvar_flatten16_fu_54;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        buff_x2_address0_local = buff_x2_addr_reg_316_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        buff_x2_address0_local = zext_ln29_fu_201_p1;
    end else begin
...
assign add_ln29_1_fu_146_p2 = (ap_sig_allocacmp_indvar_flatten16_load + 13'd1);
assign add_ln29_fu_163_p2 = (i_fu_50 + 7'd1);
assign add_ln30_fu_239_p2 = (select_ln6_fu_175_p3 + 7'd1);
...
assign buff_x2_d0 = add1_reg_370;
assign buff_x2_we0 = buff_x2_we0_local;
assign buff_y2_address0 = zext_ln30_fu_220_p1;
assign buff_y2_ce0 = buff_y2_ce0_local;
assign first_iter_2_fu_195_p2 = ((select_ln6_fu_175_p3 == 7'd0) ? 1'b1 : 1'b0);
assign grp_fu_127_p_ce = 1'b1;
assign grp_fu_127_p_din0 = empty_fu_58;
assign grp_fu_127_p_din1 = mul1_reg_360;
assign grp_fu_127_p_opcode = 2'd0;
assign grp_fu_131_p_ce = 1'b1;
assign grp_fu_131_p_din0 = select_ln31_reg_350;
assign grp_fu_131_p_din1 = buff_y2_load_reg_355;
assign icmp_ln29_fu_140_p2 = ((ap_sig_allocacmp_indvar_flatten16_load == 13'd4096) ? 1'b1 : 1'b0);
assign icmp_ln30_1_fu_245_p2 = ((add_ln30_fu_239_p2 == 7'd64) ? 1'b1 : 1'b0);
assign icmp_ln30_fu_169_p2 = ((j_fu_46 == 7'd64) ? 1'b1 : 1'b0);
assign lshr_ln6_1_fu_210_p4 = {{select_ln29_fu_187_p3[5:1]}};
assign select_ln29_fu_187_p3 = ((icmp_ln30_fu_169_p2[0:0] == 1'b1) ? add_ln29_fu_163_p2 : i_fu_50);
assign select_ln31_fu_261_p3 = ((trunc_ln29_1_reg_321[0:0] == 1'b1) ? buff_A_1_q0 : buff_A_q0);
assign select_ln6_fu_175_p3 = ((icmp_ln30_fu_169_p2[0:0] == 1'b1) ? 7'd0 : j_fu_46);
assign tmp_7_fu_225_p3 = {{trunc_ln29_fu_183_p1}, {lshr_ln6_1_fu_210_p4}};
assign trunc_ln29_1_fu_206_p1 = select_ln29_fu_187_p3[0:0];
assign trunc_ln29_fu_183_p1 = select_ln6_fu_175_p3[5:0];
assign zext_ln29_fu_201_p1 = select_ln29_fu_187_p3;
assign zext_ln30_fu_220_p1 = select_ln6_fu_175_p3;
assign zext_ln31_fu_233_p1 = tmp_7_fu_225_p3;
endmodule 
