...
wire   [6:0] add_ln8_fu_187_p2;
reg   [6:0] add_ln8_reg_270;
wire    ap_CS_fsm_state2;
wire   [5:0] trunc_ln8_fu_193_p1;
reg   [5:0] trunc_ln8_reg_275;
wire   [6:0] add_ln9_fu_203_p2;
reg   [6:0] add_ln9_reg_284;
wire    ap_CS_fsm_state3;
wire   [1:0] trunc_ln9_fu_209_p1;
reg   [1:0] trunc_ln9_reg_289;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln9_fu_197_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_78 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln9_fu_197_p2 == 1'd1))) begin
        i_fu_78 <= add_ln8_reg_270;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        j_reg_138 <= add_ln9_reg_284;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln8_fu_181_p2 == 1'd0))) begin
        j_reg_138 <= 7'd0;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        add_ln8_reg_270 <= add_ln8_fu_187_p2;
        trunc_ln8_reg_275 <= trunc_ln8_fu_193_p1;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln9_reg_284 <= add_ln9_fu_203_p2;
        lshr_ln_reg_294 <= {{j_reg_138[5:2]}};
        trunc_ln9_reg_289 <= trunc_ln9_fu_209_p1;
    end
end
always @ (*) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln8_fu_181_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (trunc_ln9_reg_289 == 2'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (trunc_ln9_reg_289 == 2'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (trunc_ln9_reg_289 == 2'd2))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (trunc_ln9_reg_289 == 2'd3))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln9_fu_197_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
...
assign add_ln1_fu_232_p3 = {{trunc_ln8_reg_275}, {lshr_ln_reg_294}};
assign add_ln8_fu_187_p2 = (i_fu_78 + 7'd1);
assign add_ln9_fu_203_p2 = (j_reg_138 + 7'd1);
assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];
assign ap_CS_fsm_state2 = ap_CS_fsm[32'd1];
assign ap_CS_fsm_state3 = ap_CS_fsm[32'd2];
assign ap_CS_fsm_state4 = ap_CS_fsm[32'd3];
assign ap_CS_fsm_state5 = ap_CS_fsm[32'd4];
assign bitcast_ln17_fu_246_p1 = grp_gemm_Pipeline_inner_fu_149_sum_out;
assign grp_gemm_Pipeline_inner_fu_149_ap_start = grp_gemm_Pipeline_inner_fu_149_ap_start_reg;
assign icmp_ln8_fu_181_p2 = ((i_fu_78 == 7'd64) ? 1'b1 : 1'b0);
assign icmp_ln9_fu_197_p2 = ((j_reg_138 == 7'd64) ? 1'b1 : 1'b0);
...
assign prod_0_address0 = zext_ln17_fu_238_p1;
assign prod_0_ce0 = prod_0_ce0_local;
assign prod_0_d0 = bitcast_ln17_fu_246_p1;
assign prod_0_we0 = prod_0_we0_local;
assign prod_1_address0 = zext_ln17_fu_238_p1;
assign prod_1_ce0 = prod_1_ce0_local;
assign prod_1_d0 = bitcast_ln17_fu_246_p1;
assign prod_1_we0 = prod_1_we0_local;
assign prod_2_address0 = zext_ln17_fu_238_p1;
assign prod_2_ce0 = prod_2_ce0_local;
assign prod_2_d0 = bitcast_ln17_fu_246_p1;
assign prod_2_we0 = prod_2_we0_local;
assign prod_3_address0 = zext_ln17_fu_238_p1;
assign prod_3_ce0 = prod_3_ce0_local;
assign prod_3_d0 = bitcast_ln17_fu_246_p1;
assign prod_3_we0 = prod_3_we0_local;
assign trunc_ln8_fu_193_p1 = i_fu_78[5:0];
assign trunc_ln9_fu_209_p1 = j_reg_138[1:0];
assign zext_ln17_fu_238_p1 = add_ln1_fu_232_p3;
endmodule 
