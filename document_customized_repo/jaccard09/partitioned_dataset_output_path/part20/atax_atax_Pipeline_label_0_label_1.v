...
module atax_atax_Pipeline_label_0_label_1 (ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,v124_address0,v124_ce0,v124_q0,v124_1_address0,v124_1_ce0,v124_1_q0,v124_2_address0,v124_2_ce0,v124_2_q0,v124_3_address0,v124_3_ce0,v124_3_q0,v113_address0,v113_ce0,v113_q0,v113_address1,v113_ce1,v113_q1,v116_address0,v116_ce0,v116_we0,v116_d0,v116_q0,v116_address1,v116_ce1,v116_we1,v116_d1,v116_q1,grp_fu_128_p_din0,grp_fu_128_p_din1,grp_fu_128_p_opcode,grp_fu_128_p_dout0,grp_fu_128_p_ce,grp_fu_132_p_din0,grp_fu_132_p_din1,grp_fu_132_p_dout0,grp_fu_132_p_ce);  
...
wire   [11:0] tmp_116_fu_566_p4;
wire   [5:0] or_ln2_fu_579_p4;
wire   [5:0] or_ln3_fu_592_p3;
wire   [0:0] icmp_ln31_fu_607_p2;
wire   [11:0] tmp_118_fu_619_p5;
wire   [11:0] tmp_119_fu_633_p4;
wire   [5:0] or_ln4_fu_646_p4;
wire   [11:0] tmp_121_fu_669_p5;
wire   [11:0] tmp_122_fu_683_p6;
wire   [11:0] tmp_123_fu_704_p5;
wire   [11:0] tmp_124_fu_718_p4;
wire   [5:0] or_ln5_fu_780_p5;
wire   [5:0] or_ln6_fu_803_p4;
wire   [5:0] or_ln7_fu_816_p3;
reg    ap_done_reg;
...
sparsemux_9_2_32_1_1_U78(.din0(v124_q0),.din1(v124_1_q0),.din2(v124_2_q0),.din3(v124_3_q0),.def(v6_fu_529_p9),.sel(trunc_ln27_reg_929),.dout(v6_fu_529_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_117_reg_970 <= {{select_ln26_fu_406_p3[5:2]}};
        tmp_120_reg_986 <= {{select_ln26_fu_406_p3[5:3]}};
        tmp_120_reg_986_pp0_iter1_reg <= tmp_120_reg_986;
        tmp_45_reg_1004 <= select_ln26_fu_406_p3[32'd1];
        tmp_45_reg_1004_pp0_iter1_reg <= tmp_45_reg_1004;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        ...
        v47_reg_1231 <= grp_fu_132_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        v11_reg_1130 <= grp_fu_132_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        v17_reg_1145 <= grp_fu_132_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v23_reg_1160 <= grp_fu_132_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v29_reg_1175 <= grp_fu_132_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v35_reg_1190 <= grp_fu_132_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        v36_reg_1256 <= grp_fu_128_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v41_reg_1210 <= grp_fu_132_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        v42_reg_1261 <= grp_fu_128_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        v48_reg_1266 <= grp_fu_128_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
        v53_reg_1246 <= grp_fu_132_p_dout0;
    end
end
always @ (*) begin
...
assign grp_fu_128_p_din0 = grp_fu_326_p0;
assign grp_fu_128_p_din1 = grp_fu_326_p1;
assign grp_fu_128_p_opcode = 2'd0;
assign grp_fu_132_p_ce = 1'b1;
assign grp_fu_132_p_din0 = grp_fu_330_p0;
assign grp_fu_132_p_din1 = v3_reg_1045;
...
assign or_ln2_fu_579_p4 = {{{tmp_117_reg_970}, {1'd1}}, {trunc_ln46_reg_978}};
assign or_ln3_fu_592_p3 = {{tmp_117_reg_970}, {2'd3}};
assign or_ln4_fu_646_p4 = {{{tmp_120_reg_986}, {1'd1}}, {trunc_ln60_reg_998}};
assign or_ln5_fu_780_p5 = {{{{tmp_120_reg_986_pp0_iter1_reg}, {1'd1}}, {tmp_45_reg_1004_pp0_iter1_reg}}, {1'd1}};
assign or_ln6_fu_803_p4 = {{{tmp_120_reg_986_pp0_iter1_reg}, {2'd3}}, {trunc_ln46_reg_978_pp0_iter1_reg}};
assign or_ln7_fu_816_p3 = {{tmp_120_reg_986_pp0_iter1_reg}, {3'd7}};
assign or_ln_fu_463_p3 = {{tmp_s_fu_453_p4}, {1'd1}};
assign select_ln26_fu_406_p3 = ((tmp_44_fu_398_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_v49_load);
assign select_ln27_fu_414_p3 = ((tmp_44_fu_398_p3[0:0] == 1'b1) ? add_ln27_fu_392_p2 : ap_sig_allocacmp_v4_load);
assign tmp_116_fu_566_p4 = {{{trunc_ln33_reg_917}, {tmp_s_reg_959}}, {1'd1}};
assign tmp_118_fu_619_p5 = {{{{trunc_ln33_reg_917}, {tmp_117_reg_970}}, {1'd1}}, {trunc_ln46_reg_978}};
assign tmp_119_fu_633_p4 = {{{trunc_ln33_reg_917}, {tmp_117_reg_970}}, {2'd3}};
assign tmp_121_fu_669_p5 = {{{{trunc_ln33_reg_917}, {tmp_120_reg_986}}, {1'd1}}, {trunc_ln60_reg_998}};
assign tmp_122_fu_683_p6 = {{{{{trunc_ln33_reg_917}, {tmp_120_reg_986}}, {1'd1}}, {tmp_45_reg_1004}}, {1'd1}};
assign tmp_123_fu_704_p5 = {{{{trunc_ln33_reg_917}, {tmp_120_reg_986}}, {2'd3}}, {trunc_ln46_reg_978}};
assign tmp_124_fu_718_p4 = {{{trunc_ln33_reg_917}, {tmp_120_reg_986}}, {3'd7}};
assign tmp_44_fu_398_p3 = ap_sig_allocacmp_v49_load[32'd6];
...
assign zext_ln40_fu_574_p1 = tmp_116_fu_566_p4;
assign zext_ln46_fu_587_p1 = or_ln2_fu_579_p4;
assign zext_ln47_fu_628_p1 = tmp_118_fu_619_p5;
assign zext_ln53_fu_599_p1 = or_ln3_fu_592_p3;
assign zext_ln54_fu_641_p1 = tmp_119_fu_633_p4;
assign zext_ln60_fu_654_p1 = or_ln4_fu_646_p4;
assign zext_ln61_fu_678_p1 = tmp_121_fu_669_p5;
assign zext_ln67_fu_790_p1 = or_ln5_fu_780_p5;
assign zext_ln68_fu_694_p1 = tmp_122_fu_683_p6;
assign zext_ln74_fu_811_p1 = or_ln6_fu_803_p4;
assign zext_ln75_fu_713_p1 = tmp_123_fu_704_p5;
assign zext_ln82_fu_823_p1 = or_ln7_fu_816_p3;
assign zext_ln83_fu_726_p1 = tmp_124_fu_718_p4;
always @ (posedge ap_clk) begin
