...
wire   [31:0] tmp_9_fu_586_p19;
reg   [31:0] tmp_9_reg_843;
wire    ap_block_pp0_stage2_11001;
reg   [31:0] tmp_9_reg_843_pp0_iter1_reg;
...
wire   [31:0] tmp_s_fu_675_p19;
reg   [31:0] tmp_s_reg_906;
...
reg   [11:0] indvar_flatten20_fu_130;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_9_fu_586_p1;
wire   [2:0] tmp_9_fu_586_p3;
wire   [2:0] tmp_9_fu_586_p5;
wire   [2:0] tmp_9_fu_586_p7;
wire  signed [2:0] tmp_9_fu_586_p9;
wire  signed [2:0] tmp_9_fu_586_p11;
wire  signed [2:0] tmp_9_fu_586_p13;
wire  signed [2:0] tmp_9_fu_586_p15;
wire   [2:0] tmp_s_fu_675_p1;
wire   [2:0] tmp_s_fu_675_p3;
wire   [2:0] tmp_s_fu_675_p5;
wire   [2:0] tmp_s_fu_675_p7;
wire  signed [2:0] tmp_s_fu_675_p9;
wire  signed [2:0] tmp_s_fu_675_p11;
wire  signed [2:0] tmp_s_fu_675_p13;
wire  signed [2:0] tmp_s_fu_675_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 3'd1;
...
#0 indvar_flatten20_fu_130 = 12'd0;
#0 ap_done_reg = 1'b0;
end
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_17_3_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_x_U112(.din0(b_0_q0),.din1(b_1_q0),.din2(b_2_q0),.din3(b_3_q0),.din4(b_4_q0),.din5(b_5_q0),.din6(b_6_q0),.din7(b_7_q0),.def(tmp_9_fu_586_p17),.sel(trunc_ln70_reg_798),.dout(tmp_9_fu_586_p19));
(* dissolve_hierarchy = "yes" *) ss_sort_sparsemux_17_3_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 3'h0 ),.din0_WIDTH( 32 ),.CASE1( 3'h1 ),.din1_WIDTH( 32 ),.CASE2( 3'h2 ),.din2_WIDTH( 32 ),.CASE3( 3'h3 ),.din3_WIDTH( 32 ),.CASE4( 3'h4 ),.din4_WIDTH( 32 ),.CASE5( 3'h5 ),.din5_WIDTH( 32 ),.CASE6( 3'h6 ),.din6_WIDTH( 32 ),.CASE7( 3'h7 ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 3 ),.dout_WIDTH( 32 ))
sparsemux_17_3_32_1_1_x_U113(.din0(bucket_0_q0),.din1(bucket_1_q0),.din2(bucket_2_q0),.din3(bucket_3_q0),.din4(bucket_4_q0),.din5(bucket_5_q0),.din6(bucket_6_q0),.din7(bucket_7_q0),.def(tmp_s_fu_675_p17),.sel(trunc_ln72_reg_856),.dout(tmp_s_fu_675_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln68_fu_474_p2 == 1'd0))) begin
            indvar_flatten20_fu_130 <= add_ln68_fu_480_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten20_fu_130 <= 12'd0;
        end
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        lshr_ln72_3_reg_915 <= {{tmp_s_fu_675_p19[10:3]}};
        tmp_9_reg_843 <= tmp_9_fu_586_p19;
        tmp_9_reg_843_pp0_iter1_reg <= tmp_9_reg_843;
        tmp_s_reg_906 <= tmp_s_fu_675_p19;
...
assign ashr_ln70_fu_628_p2 = $signed(tmp_9_reg_843) >>> zext_ln63_cast_reg_773;
...
assign icmp_ln68_fu_474_p2 = ((ap_sig_allocacmp_indvar_flatten20_load == 12'd2048) ? 1'b1 : 1'b0);
...
assign tmp_1_fu_534_p3 = {{empty_reg_793}, {2'd0}};
assign tmp_9_fu_586_p17 = 'bx;
assign tmp_s_fu_675_p17 = 'bx;
assign trunc_ln70_1_fu_632_p1 = ashr_ln70_fu_628_p2[1:0];
assign trunc_ln70_fu_550_p1 = add_ln70_fu_544_p2[2:0];
assign trunc_ln72_1_fu_714_p1 = tmp_s_fu_675_p19[2:0];
