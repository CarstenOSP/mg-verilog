...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) & (grp_syrk_Pipeline_lpwr_1_lpwr_2_fu_378_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (grp_syrk_Pipeline_lp4_lp5_fu_356_ap_done == 1'b1))) begin
