...
output  [31:0] grp_fu_82014_p_din0;
output  [31:0] grp_fu_82014_p_din1;
output  [1:0] grp_fu_82014_p_opcode;
input  [31:0] grp_fu_82014_p_dout0;
output   grp_fu_82014_p_ce;
output  [31:0] grp_fu_82018_p_din0;
output  [31:0] grp_fu_82018_p_din1;
input  [31:0] grp_fu_82018_p_dout0;
output   grp_fu_82018_p_ce;
reg ap_idle;
...
reg   [9:0] tmp1_3_addr_reg_816;
reg   [9:0] tmp1_3_addr_reg_816_pp0_iter1_reg;
wire   [0:0] icmp_ln35_1_fu_577_p2;
reg   [0:0] icmp_ln35_1_reg_861;
reg   [0:0] tmp_1041_reg_887;
reg   [0:0] tmp_1041_reg_887_pp0_iter1_reg;
...
wire   [31:0] tmp_65_fu_670_p11;
reg   [31:0] tmp_65_reg_901;
wire   [31:0] select_ln35_1_fu_693_p3;
reg   [31:0] select_ln35_1_reg_906;
wire   [31:0] tmp_66_fu_700_p11;
reg   [31:0] tmp_66_reg_911;
...
wire   [63:0] tmp_68_cast_fu_523_p1;
...
wire   [9:0] tmp_68_fu_515_p3;
wire   [5:0] trunc_ln33_1_fu_483_p1;
wire   [9:0] tmp_69_fu_531_p3;
wire   [3:0] lshr_ln10_3_fu_551_p4;
wire   [9:0] tmp_71_fu_561_p3;
wire   [1:0] trunc_ln34_fu_547_p1;
wire   [4:0] tmp_72_fu_583_p4;
wire   [9:0] tmp_73_fu_593_p4;
wire   [31:0] tmp_fu_640_p9;
wire    ap_block_pp0_stage2;
wire   [31:0] tmp_65_fu_670_p9;
wire   [31:0] tmp_66_fu_700_p9;
reg    ap_done_reg;
...
wire   [1:0] tmp_65_fu_670_p1;
wire   [1:0] tmp_65_fu_670_p3;
wire  signed [1:0] tmp_65_fu_670_p5;
wire  signed [1:0] tmp_65_fu_670_p7;
wire   [1:0] tmp_66_fu_700_p1;
wire   [1:0] tmp_66_fu_700_p3;
wire  signed [1:0] tmp_66_fu_700_p5;
wire  signed [1:0] tmp_66_fu_700_p7;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 15'd1;
...
sparsemux_9_2_32_1_1_U299(.din0(tmp1_q0),.din1(tmp1_1_q0),.din2(tmp1_2_q0),.din3(tmp1_3_q0),.def(tmp_fu_640_p9),.sel(trunc_ln33_2_reg_794),.dout(tmp_fu_640_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U300(.din0(buff_B_q1),.din1(buff_B_1_q1),.din2(buff_B_2_q1),.din3(buff_B_3_q1),.def(tmp_65_fu_670_p9),.sel(trunc_ln33_2_reg_794),.dout(tmp_65_fu_670_p11));
(* dissolve_hierarchy = "yes" *) k3mm_sparsemux_9_2_32_1_1 #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 2'h0 ),.din0_WIDTH( 32 ),.CASE1( 2'h1 ),.din1_WIDTH( 32 ),.CASE2( 2'h2 ),.din2_WIDTH( 32 ),.CASE3( 2'h3 ),.din3_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 2 ),.dout_WIDTH( 32 ))
sparsemux_9_2_32_1_1_U301(.din0(buff_B_q0),.din1(buff_B_1_q0),.din2(buff_B_2_q0),.din3(buff_B_3_q0),.def(tmp_66_fu_700_p9),.sel(trunc_ln33_2_reg_794),.dout(tmp_66_fu_700_p11));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        i_1_fu_104 <= select_ln32_fu_458_p3;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp1_1_addr_1_reg_806 <= tmp_68_cast_fu_523_p1;
        tmp1_1_addr_1_reg_806_pp0_iter1_reg <= tmp1_1_addr_1_reg_806;
        tmp1_2_addr_1_reg_811 <= tmp_68_cast_fu_523_p1;
        tmp1_2_addr_1_reg_811_pp0_iter1_reg <= tmp1_2_addr_1_reg_811;
        tmp1_3_addr_reg_816 <= tmp_68_cast_fu_523_p1;
        tmp1_3_addr_reg_816_pp0_iter1_reg <= tmp1_3_addr_reg_816;
        tmp1_addr_1_reg_801 <= tmp_68_cast_fu_523_p1;
        tmp1_addr_1_reg_801_pp0_iter1_reg <= tmp1_addr_1_reg_801;
        tmp_1041_reg_887 <= add_ln34_fu_611_p2[32'd6];
        tmp_1041_reg_887_pp0_iter1_reg <= tmp_1041_reg_887;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7))) begin
        mul_1_reg_926 <= grp_fu_82018_p_dout0;
    end
end
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        mul_reg_916 <= grp_fu_82018_p_dout0;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        tmp_65_reg_901 <= tmp_65_fu_670_p11;
        tmp_66_reg_911 <= tmp_66_fu_700_p11;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage4) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            grp_fu_324_p1 = tmp_66_reg_911;
        end else if (((1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
            grp_fu_324_p1 = tmp_65_reg_901;
        end else begin
            grp_fu_324_p1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        tmp1_1_address0_local = tmp_68_cast_fu_523_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1041_reg_887_pp0_iter1_reg == 1'd1) & (trunc_ln33_2_reg_794_pp0_iter1_reg == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        tmp1_2_address0_local = tmp_68_cast_fu_523_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1041_reg_887_pp0_iter1_reg == 1'd1) & (trunc_ln33_2_reg_794_pp0_iter1_reg == 2'd2) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        tmp1_3_address0_local = tmp1_3_addr_reg_816_pp0_iter1_reg;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp1_3_address0_local = tmp_68_cast_fu_523_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1041_reg_887_pp0_iter1_reg == 1'd1) & (trunc_ln33_2_reg_794_pp0_iter1_reg == 2'd3) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        tmp1_address0_local = tmp_68_cast_fu_523_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1041_reg_887_pp0_iter1_reg == 1'd1) & (trunc_ln33_2_reg_794_pp0_iter1_reg == 2'd0) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        tmp1_we0_local = 1'b1;
    end else begin
        tmp1_we0_local = 1'b0;
    end
...
assign add_ln32_fu_419_p2 = (i_1_fu_104 + 7'd1);
...
assign grp_fu_82014_p_ce = 1'b1;
assign grp_fu_82014_p_din0 = grp_fu_320_p0;
assign grp_fu_82014_p_din1 = grp_fu_320_p1;
assign grp_fu_82014_p_opcode = 2'd0;
assign grp_fu_82018_p_ce = 1'b1;
assign grp_fu_82018_p_din0 = grp_fu_324_p0;
assign grp_fu_82018_p_din1 = grp_fu_324_p1;
...
assign select_ln32_fu_458_p3 = ((icmp_ln33_reg_782[0:0] == 1'b1) ? add_ln32_fu_419_p2 : i_1_fu_104);
...
assign tmp_1040_fu_439_p3 = k_fu_92[32'd6];
assign tmp_65_fu_670_p9 = 'bx;
assign tmp_66_fu_700_p9 = 'bx;
assign tmp_68_cast_fu_523_p1 = tmp_68_fu_515_p3;
assign tmp_68_fu_515_p3 = {{trunc_ln33_fu_465_p1}, {lshr_ln10_1_fu_505_p4}};
assign tmp_69_fu_531_p3 = {{trunc_ln33_1_fu_483_p1}, {lshr_ln10_1_fu_505_p4}};
assign tmp_71_fu_561_p3 = {{trunc_ln33_fu_465_p1}, {lshr_ln10_3_fu_551_p4}};
assign tmp_72_fu_583_p4 = {{k_mid2_fu_475_p3[5:1]}};
assign tmp_73_fu_593_p4 = {{{tmp_72_fu_583_p4}, {1'd1}}, {lshr_ln10_1_fu_505_p4}};
...
assign xor_ln34_fu_447_p2 = (tmp_1040_fu_439_p3 ^ 1'd1);
assign zext_ln35_1_fu_569_p1 = tmp_71_fu_561_p3;
assign zext_ln35_2_fu_603_p1 = tmp_73_fu_593_p4;
assign zext_ln35_fu_539_p1 = tmp_69_fu_531_p3;
endmodule 
