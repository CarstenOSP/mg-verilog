...
wire   [31:0] tmp_2_fu_269_p17;
wire   [2:0] tmp_2_fu_269_p18;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_2_fu_269_p1;
wire   [2:0] tmp_2_fu_269_p3;
wire   [2:0] tmp_2_fu_269_p5;
wire   [2:0] tmp_2_fu_269_p7;
wire  signed [2:0] tmp_2_fu_269_p9;
wire  signed [2:0] tmp_2_fu_269_p11;
wire  signed [2:0] tmp_2_fu_269_p13;
wire  signed [2:0] tmp_2_fu_269_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 1'd1;
...
sparsemux_17_3_32_1_1_U1888(.din0(buff_x2_q0),.din1(buff_x2_1_q0),.din2(buff_x2_2_q0),.din3(buff_x2_3_q0),.din4(buff_x2_4_q0),.din5(buff_x2_5_q0),.din6(buff_x2_6_q0),.din7(buff_x2_7_q0),.def(tmp_2_fu_269_p17),.sel(tmp_2_fu_269_p18),.dout(tmp_2_fu_269_p19));
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_2_reg_380 <= tmp_2_fu_269_p19;
    end
end
always @ (*) begin
...
assign bitcast_ln37_fu_314_p1 = tmp_2_reg_380;
...
assign tmp_2_fu_269_p17 = 'bx;
assign tmp_2_fu_269_p18 = i_1_reg_325[2:0];
