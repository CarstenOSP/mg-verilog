...
reg   [31:0] E_load_reg_1485;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] E_7_load_reg_1490;
...
wire   [31:0] tmp_3_fu_835_p19;
reg   [31:0] tmp_3_reg_1516;
wire   [31:0] tmp_4_fu_875_p19;
reg   [31:0] tmp_4_reg_1521;
wire   [31:0] tmp_5_fu_915_p19;
...
reg   [31:0] E_6_fu_154;
wire   [31:0] C_7_fu_1087_p3;
wire    ap_loop_init;
wire    ap_block_pp0_stage1;
reg   [31:0] E_fu_158;
wire   [31:0] C_8_fu_1117_p3;
reg   [31:0] B_fu_162;
wire   [31:0] temp_3_fu_1182_p2;
reg   [31:0] B_6_fu_166;
wire   [31:0] temp_4_fu_1238_p2;
wire    ap_block_pp0_stage2;
reg   [31:0] E_7_fu_170;
wire   [31:0] C_6_fu_1149_p3;
reg   [5:0] i_2_fu_174;
...
wire   [31:0] tmp_3_fu_835_p17;
wire   [31:0] tmp_4_fu_875_p17;
wire   [31:0] tmp_5_fu_915_p17;
...
wire   [4:0] tmp_3_fu_835_p1;
wire   [4:0] tmp_3_fu_835_p3;
wire   [4:0] tmp_3_fu_835_p5;
wire   [4:0] tmp_3_fu_835_p7;
wire  signed [4:0] tmp_3_fu_835_p9;
wire  signed [4:0] tmp_3_fu_835_p11;
wire  signed [4:0] tmp_3_fu_835_p13;
wire  signed [4:0] tmp_3_fu_835_p15;
wire   [4:0] tmp_4_fu_875_p1;
wire   [4:0] tmp_4_fu_875_p3;
wire   [4:0] tmp_4_fu_875_p5;
wire   [4:0] tmp_4_fu_875_p7;
wire  signed [4:0] tmp_4_fu_875_p9;
wire  signed [4:0] tmp_4_fu_875_p11;
wire  signed [4:0] tmp_4_fu_875_p13;
wire  signed [4:0] tmp_4_fu_875_p15;
wire   [4:0] tmp_5_fu_915_p1;
wire   [4:0] tmp_5_fu_915_p3;
wire   [4:0] tmp_5_fu_915_p5;
wire   [4:0] tmp_5_fu_915_p7;
wire  signed [4:0] tmp_5_fu_915_p9;
wire  signed [4:0] tmp_5_fu_915_p11;
wire  signed [4:0] tmp_5_fu_915_p13;
wire  signed [4:0] tmp_5_fu_915_p15;
wire    ap_ce_reg;
initial begin
#0 ap_CS_fsm = 5'd1;
...
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_x_U91(.din0(W_1_q0),.din1(W_5_q0),.din2(W_9_q0),.din3(W_13_q0),.din4(W_17_q0),.din5(W_21_q0),.din6(W_25_q0),.din7(W_29_q0),.def(tmp_3_fu_835_p17),.sel(trunc_ln120_fu_754_p1),.dout(tmp_3_fu_835_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_x_U92(.din0(W_2_q0),.din1(W_6_q0),.din2(W_10_q0),.din3(W_14_q0),.din4(W_18_q0),.din5(W_22_q0),.din6(W_26_q0),.din7(W_30_q0),.def(tmp_4_fu_875_p17),.sel(trunc_ln120_fu_754_p1),.dout(tmp_4_fu_875_p19));
(* dissolve_hierarchy = "yes" *) sha_stream_sparsemux_17_5_32_1_1_x #(.ID( 1 ),.NUM_STAGE( 1 ),.CASE0( 5'h0 ),.din0_WIDTH( 32 ),.CASE1( 5'h4 ),.din1_WIDTH( 32 ),.CASE2( 5'h8 ),.din2_WIDTH( 32 ),.CASE3( 5'hC ),.din3_WIDTH( 32 ),.CASE4( 5'h10 ),.din4_WIDTH( 32 ),.CASE5( 5'h14 ),.din5_WIDTH( 32 ),.CASE6( 5'h18 ),.din6_WIDTH( 32 ),.CASE7( 5'h1C ),.din7_WIDTH( 32 ),.def_WIDTH( 32 ),.sel_WIDTH( 5 ),.dout_WIDTH( 32 ))
sparsemux_17_5_32_1_1_x_U93(.din0(W_3_q0),.din1(W_7_q0),.din2(W_11_q0),.din3(W_15_q0),.din4(W_19_q0),.din5(W_23_q0),.din6(W_27_q0),.din7(W_31_q0),.def(tmp_5_fu_915_p17),.sel(trunc_ln120_fu_754_p1),.dout(tmp_5_fu_915_p19));
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        B_6_fu_166 <= A_17_reload;
    end else if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        B_6_fu_166 <= temp_4_fu_1238_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        B_fu_162 <= temp_3_fu_1182_p2;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_6_fu_154 <= E_1_reload;
        ...
        E_6_fu_154 <= C_7_fu_1087_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_7_fu_170 <= C_17_reload;
    end else if (((icmp_ln120_reg_1321 == 1'd1) & (1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        E_7_fu_170 <= C_6_fu_1149_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        E_fu_158 <= D_17_reload;
    end else if (((icmp_ln120_reg_1321 == 1'd1) & (1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        E_fu_158 <= C_8_fu_1117_p3;
    end
end
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        lshr_ln122_3_reg_1557 <= {{B_6_fu_166[31:2]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        E_7_load_reg_1490 <= E_7_fu_170;
        E_load_reg_1485 <= E_fu_158;
        add_ln122_1_reg_1496 <= add_ln122_1_fu_809_p2;
        add_ln122_reg_1501 <= add_ln122_fu_815_p2;
        lshr_ln122_1_reg_1511 <= {{B_fu_162[31:2]}};
        tmp_3_reg_1516 <= tmp_3_fu_835_p19;
        tmp_4_reg_1521 <= tmp_4_fu_875_p19;
        tmp_5_reg_1526 <= tmp_5_fu_915_p19;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        lshr_ln122_4_reg_1582 <= {{temp_2_fu_1082_p2[31:27]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        lshr_ln122_6_reg_1602 <= {{temp_3_fu_1182_p2[31:27]}};
...
assign A_19_out = B_6_fu_166;
assign B_6_out = B_fu_162;
assign C_19_out = E_7_fu_170;
assign C_6_fu_1149_p3 = {{trunc_ln122_7_fu_1135_p1}, {lshr_ln122_7_fu_1139_p4}};
assign C_7_fu_1087_p3 = {{trunc_ln122_3_reg_1552}, {lshr_ln122_3_reg_1557}};
assign C_8_fu_1117_p3 = {{trunc_ln122_5_reg_1567}, {lshr_ln122_5_reg_1572}};
assign C_fu_990_p3 = {{trunc_ln122_1_reg_1506}, {lshr_ln122_1_reg_1511}};
assign D_19_out = E_fu_158;
assign E_6_out = E_6_fu_154;
...
assign add_ln122_10_fu_1059_p2 = (add_ln122_9_fu_1054_p2 + E_7_load_reg_1490);
assign add_ln122_12_fu_1234_p2 = (C_reg_1536 + xor_ln122_7_reg_1592);
assign add_ln122_13_fu_1223_p2 = (tmp_5_reg_1526 + 32'd1859775393);
...
assign add_ln122_5_fu_1029_p2 = (tmp_3_reg_1516 + 32'd1859775393);
assign add_ln122_6_fu_1078_p2 = (add_ln122_5_reg_1542 + E_load_reg_1485);
assign add_ln122_8_fu_1178_p2 = (add_ln122_10_reg_1562 + xor_ln122_5_reg_1587);
assign add_ln122_9_fu_1054_p2 = (tmp_4_reg_1521 + 32'd1859775393);
assign add_ln122_fu_815_p2 = (xor_ln122_1_fu_803_p2 + E_6_fu_154);
...
assign lshr_ln122_7_fu_1139_p4 = {{temp_2_fu_1082_p2[31:2]}};
assign lshr_ln4_fu_962_p4 = {{B_6_fu_166[31:27]}};
...
assign temp_2_fu_1082_p2 = (add_ln122_4_reg_1547 + add_ln122_6_fu_1078_p2);
assign temp_3_fu_1182_p2 = (add_ln122_8_fu_1178_p2 + or_ln122_4_fu_1172_p3);
assign temp_4_fu_1238_p2 = (add_ln122_14_reg_1607 + add_ln122_12_fu_1234_p2);
assign temp_fu_985_p2 = (add_ln122_reg_1501 + add_ln122_2_fu_980_p2);
assign tmp_3_fu_835_p17 = 'bx;
assign tmp_4_fu_875_p17 = 'bx;
assign tmp_5_fu_915_p17 = 'bx;
...
assign trunc_ln122_3_fu_1040_p1 = B_6_fu_166[1:0];
assign trunc_ln122_4_fu_1093_p1 = temp_2_fu_1082_p2[26:0];
assign trunc_ln122_5_fu_1064_p1 = temp_fu_985_p2[1:0];
assign trunc_ln122_6_fu_1188_p1 = temp_3_fu_1182_p2[26:0];
assign trunc_ln122_7_fu_1135_p1 = temp_2_fu_1082_p2[1:0];
assign trunc_ln122_fu_958_p1 = B_6_fu_166[26:0];
assign xor_ln122_1_fu_803_p2 = (xor_ln122_fu_797_p2 ^ E_7_fu_170);
assign xor_ln122_2_fu_1010_p2 = (C_fu_990_p3 ^ B_6_fu_166);
assign xor_ln122_3_fu_1016_p2 = (xor_ln122_2_fu_1010_p2 ^ E_7_load_reg_1490);
assign xor_ln122_4_fu_1107_p2 = (temp_reg_1531 ^ C_7_fu_1087_p3);
assign xor_ln122_5_fu_1112_p2 = (xor_ln122_4_fu_1107_p2 ^ C_reg_1536);
assign xor_ln122_6_fu_1123_p2 = (temp_2_fu_1082_p2 ^ C_7_fu_1087_p3);
assign xor_ln122_7_fu_1129_p2 = (xor_ln122_6_fu_1123_p2 ^ C_8_fu_1117_p3);
assign xor_ln122_fu_797_p2 = (E_fu_158 ^ B_fu_162);
