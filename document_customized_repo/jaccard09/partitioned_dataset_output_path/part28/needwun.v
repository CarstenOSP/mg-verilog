...
reg   [7:0] empty_reg_306;
wire    ap_CS_fsm_state5;
reg   [7:0] SEQB_load_reg_317;
wire    ap_CS_fsm_state6;
wire   [14:0] empty_52_fu_208_p2;
reg   [14:0] empty_52_reg_322;
wire   [14:0] add_ln29_fu_221_p2;
reg   [14:0] add_ln29_reg_327;
wire   [0:0] grp_needwun_Pipeline_trace_fu_125_ap_return;
reg   [0:0] targetBlock_reg_332;
wire    ap_CS_fsm_state9;
wire   [31:0] or_ln65_1_fu_253_p3;
wire    ap_CS_fsm_state10;
wire   [31:0] zext_ln62_fu_261_p1;
wire   [0:0] icmp_ln83_fu_275_p2;
reg   [0:0] icmp_ln83_reg_346;
...
wire   [63:0] p_cast8_fu_190_p1;
reg   [7:0] b_idx_1_fu_78;
wire   [7:0] add_ln28_fu_227_p2;
reg    SEQB_ce0_local;
wire   [14:0] p_shl1_fu_201_p3;
wire   [14:0] p_cast_fu_198_p1;
wire   [14:0] p_shl_fu_214_p3;
wire   [14:0] zext_ln29_fu_195_p1;
wire   [30:0] tmp_5_fu_243_p4;
wire   [23:0] tmp_fu_265_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((grp_needwun_Pipeline_pad_a_fu_154_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state12) & (icmp_ln83_reg_346 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        b_idx_1_fu_78 <= add_ln28_fu_227_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        if ((targetBlock_reg_332 == 1'd1)) begin
            b_str_idx_reg_103 <= zext_ln62_fu_261_p1;
        end else if ((targetBlock_reg_332 == 1'd0)) begin
            b_str_idx_reg_103 <= or_ln65_1_fu_253_p3;
        end
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        SEQB_load_reg_317 <= SEQB_q0;
        add_ln29_reg_327 <= add_ln29_fu_221_p2;
        empty_52_reg_322 <= empty_52_fu_208_p2;
    end
end
always @ (posedge ap_clk) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        empty_reg_306 <= empty_fu_184_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        icmp_ln83_reg_346 <= icmp_ln83_fu_275_p2;
    end
end
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        targetBlock_reg_332 <= grp_needwun_Pipeline_trace_fu_125_ap_return;
    end
end
always @ (*) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        SEQB_address0 = p_cast8_fu_190_p1;
    end
end
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (icmp_ln83_reg_346 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state12 : begin
            if (((grp_needwun_Pipeline_pad_a_fu_154_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
...
assign add_ln28_fu_227_p2 = (b_idx_1_fu_78 + 8'd1);
assign add_ln29_fu_221_p2 = (p_shl_fu_214_p3 + zext_ln29_fu_195_p1);
...
always @ (*) begin
    ap_block_state13_on_subcall_done = ((grp_needwun_Pipeline_pad_b_fu_162_ap_done == 1'b0) & (icmp_ln83_reg_346 == 1'd1));
end
assign empty_52_fu_208_p2 = (p_shl1_fu_201_p3 + p_cast_fu_198_p1);
...
assign icmp_ln83_fu_275_p2 = (($signed(tmp_fu_265_p4) < $signed(24'd1)) ? 1'b1 : 1'b0);
assign or_ln65_1_fu_253_p3 = {{tmp_5_fu_243_p4}, {1'd1}};
assign p_cast8_fu_190_p1 = empty_fu_184_p2;
assign p_cast_fu_198_p1 = empty_reg_306;
assign p_shl1_fu_201_p3 = {{empty_reg_306}, {7'd0}};
assign p_shl_fu_214_p3 = {{b_idx_1_fu_78}, {7'd0}};
assign ptr_d0 = grp_needwun_Pipeline_fill_in_fu_141_ptr_d0;
assign tmp_5_fu_243_p4 = {{a_str_idx_0_0_loc_fu_82[31:1]}};
assign tmp_fu_265_p4 = {{b_str_idx_reg_103[31:8]}};
assign zext_ln29_fu_195_p1 = b_idx_1_fu_78;
assign zext_ln62_fu_261_p1 = b_str_idx_6_loc_fu_86;
endmodule 
